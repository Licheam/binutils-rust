...
extern "C" {
    ...
    fn search_list_append(_: *mut Search_List, _: *const libc::c_char);
    static mut create_annotation_files: bool;
    static mut src_search_list: Search_List;
    static mut bb_annotate_all_lines: bool;
    static mut bb_table_length: libc::c_int;
    static mut bb_min_calls: libc::c_ulong;
    fn print_annotated_source();
    fn print_exec_counts();
    fn cg_assemble() -> *mut *mut Sym;
    fn cg_print(_: *mut *mut Sym);
    fn cg_print_index();
    fn cg_print_file_ordering();
    fn cg_print_function_ordering();
    static mut core_bfd: *mut bfd;
    fn core_init(_: *const libc::c_char);
    fn core_get_text_space(_: *mut bfd);
    fn core_create_function_syms();
    fn core_create_line_syms();
    fn core_create_syms_from(_: *const libc::c_char);
    static mut gmon_input: libc::c_int;
    fn gmon_out_read(_: *const libc::c_char);
    fn gmon_out_write(_: *const libc::c_char);
    fn hist_assign_samples();
    fn hist_print();
    fn sym_id_add(_: *const libc::c_char, _: Table_Id);
    fn sym_id_parse();
...
pub type Table_Id = libc::c_uint;
pub const NUM_TABLES: Table_Id = 12;
pub const EXCL_EXEC: Table_Id = 11;
pub const INCL_EXEC: Table_Id = 10;
pub const EXCL_ANNO: Table_Id = 9;
pub const INCL_ANNO: Table_Id = 8;
pub const EXCL_TIME: Table_Id = 7;
pub const INCL_TIME: Table_Id = 6;
pub const EXCL_FLAT: Table_Id = 5;
pub const INCL_FLAT: Table_Id = 4;
pub const EXCL_ARCS: Table_Id = 3;
pub const INCL_ARCS: Table_Id = 2;
pub const EXCL_GRAPH: Table_Id = 1;
pub const INCL_GRAPH: Table_Id = 0;
...
#[no_mangle]
pub static mut whoami: *const libc::c_char = 0 as *const libc::c_char;
#[no_mangle]
pub static mut function_mapping_file: *const libc::c_char = 0 as *const libc::c_char;
#[no_mangle]
pub static mut a_out_name: *const libc::c_char = b"a.out\0" as *const u8
    as *const libc::c_char;
#[no_mangle]
pub static mut hz: libc::c_long = 0 as libc::c_int as libc::c_long;
#[no_mangle]
pub static mut debug_level: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut output_style: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut output_width: libc::c_int = 80 as libc::c_int;
#[no_mangle]
pub static mut bsd_style_output: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut demangle: bool = 1 as libc::c_int != 0;
#[no_mangle]
pub static mut ignore_direct_calls: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut ignore_static_funcs: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut ignore_zeros: bool = 1 as libc::c_int != 0;
#[no_mangle]
pub static mut line_granularity: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut print_descriptions: bool = 1 as libc::c_int != 0;
#[no_mangle]
pub static mut print_path: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut ignore_non_functions: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut inline_file_names: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut file_format: File_Format = FF_AUTO;
#[no_mangle]
pub static mut first_output: bool = 1 as libc::c_int != 0;
#[no_mangle]
pub unsafe extern "C" fn done(mut status: libc::c_int) -> ! {
    exit(status);
}
...
static mut external_symbol_table: *const libc::c_char = 0 as *const libc::c_char;
#[no_mangle]
pub static mut copyright: [libc::c_char; 88] = unsafe {
    *::core::mem::transmute::<
        &[u8; 88],
        &mut [libc::c_char; 88],
    >(
...
static mut gmon_name: *mut libc::c_char = b"gmon.out\0" as *const u8
    as *const libc::c_char as *mut libc::c_char;
static mut default_excluded_list: [*mut libc::c_char; 7] = [
    b"_gprof_mcount\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"mcount\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"_mcount\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"__mcount\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"__mcount_internal\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"__mcleanup\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    0 as *const libc::c_char as *mut libc::c_char,
];
static mut long_options: [option; 42] = [
    {
        let mut init = option {
    ...
    {
        let mut init = option {
            name: b"no-static\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'a' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"ignore-non-functions\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'D' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"external-symbol-table\0" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = option {
            name: b"annotated-source\0" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = option {
            name: b"no-annotated-source\0" as *const u8 as *const libc::c_char,
            has_arg: 2 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'J' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"flat-profile\0" as *const u8 as *const libc::c_char,
            has_arg: 2 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'p' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"no-flat-profile\0" as *const u8 as *const libc::c_char,
            has_arg: 2 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'P' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"no-graph\0" as *const u8 as *const libc::c_char,
            has_arg: 2 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'Q' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"exec-counts\0" as *const u8 as *const libc::c_char,
            has_arg: 2 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'C' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"no-exec-counts\0" as *const u8 as *const libc::c_char,
            has_arg: 2 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'Z' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"function-ordering\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'r' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"file-ordering\0" as *const u8 as *const libc::c_char,
            has_arg: 1 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'R' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"file-info\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'i' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"all-lines\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'x' as i32,
        };
    ...
    },
    {
        let mut init = option {
            ...
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 150 as libc::c_int + 1 as libc::c_int,
        };
        init
    },
    {
        let mut init = option {
            name: b"directory-path\0" as *const u8 as *const libc::c_char,
            has_arg: 1 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'I' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"display-unused-functions\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'z' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"inline-file-names\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 150 as libc::c_int + 2 as libc::c_int,
        };
        init
    },
    {
    ...
    {
        let mut init = option {
            name: b"print-path\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'L' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"separate-files\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'y' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"static-call-graph\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'c' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"table-length\0" as *const u8 as *const libc::c_char,
            has_arg: 1 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 't' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"no-time\0" as *const u8 as *const libc::c_char,
            has_arg: 1 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'N' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"file-format\0" as *const u8 as *const libc::c_char,
            has_arg: 1 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'O' as i32,
        };
...
unsafe fn main_0(
    ...
    let mut cg: *mut *mut Sym = 0 as *mut *mut Sym;
    let mut ch: libc::c_int = 0;
    let mut user_specified: libc::c_int = 0 as libc::c_int;
    setlocale(0 as libc::c_int, b"\0" as *const u8 as *const libc::c_char);
    bindtextdomain(
        b"gprof\0" as *const u8 as *const libc::c_char,
        b"/usr/local/share/locale\0" as *const u8 as *const libc::c_char,
    );
    textdomain(b"gprof\0" as *const u8 as *const libc::c_char);
    ...
    loop {
        ch = getopt_long(
            argc,
            argv,
            b"aA::bBcC::d::De:E:f:F:hiI:J::k:lLm:n:N:O:p::P::q::Q::rR:sS:t:Tvw:xyzZ::\0"
                as *const u8 as *const libc::c_char,
        ...
        match ch {
            97 => {
                ignore_static_funcs = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            65 => {
                if !optarg.is_null() {
                    sym_id_add(optarg, INCL_ANNO);
                }
                output_style |= (1 as libc::c_int) << 4 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 4 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            98 => {
                print_descriptions = 0 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            66 => {
                output_style |= (1 as libc::c_int) << 1 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 1 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            99 => {
                ignore_direct_calls = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            67 => {
                if !optarg.is_null() {
                ...
                output_style |= (1 as libc::c_int) << 3 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 3 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            100 => {
                if !optarg.is_null() {
                    debug_level |= atoi(optarg);
                    debug_level |= (1 as libc::c_int) << 0 as libc::c_int;
                } else {
                    debug_level = !(0 as libc::c_int);
                }
                if debug_level & (1 as libc::c_int) << 0 as libc::c_int != 0 {
                    printf(
                        b"[main] debug-level=0x%x\n\0" as *const u8
                            as *const libc::c_char,
                        debug_level,
                    );
                }
            ...
            68 => {
                ignore_non_functions = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            69 => {
                sym_id_add(optarg, EXCL_TIME);
                current_block_141 = 9419201906517892546;
            }
            101 => {
                current_block_141 = 9419201906517892546;
            }
            70 => {
                ...
                current_block_141 = 16506370412324142836;
            }
            102 => {
                current_block_141 = 16506370412324142836;
            }
            ...
            105 => {
                output_style |= (1 as libc::c_int) << 5 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 5 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            73 => {
                search_list_append(&mut src_search_list, optarg);
                current_block_141 = 92352228884877657;
            }
            74 => {
                if !optarg.is_null() {
            ...
            108 => {
                line_granularity = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            76 => {
                print_path = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            109 => {
                bb_min_calls = strtoul(
                    optarg,
                    0 as *mut libc::c_void as *mut *mut libc::c_char,
                    10 as libc::c_int,
                );
            ...
            112 => {
                ...
                output_style |= (1 as libc::c_int) << 0 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 0 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            80 => {
                if !optarg.is_null() {
            ...
            114 => {
                output_style |= (1 as libc::c_int) << 6 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 6 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            82 => {
                output_style |= (1 as libc::c_int) << 7 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 7 as libc::c_int;
            ...
            115 => {
                output_style |= (1 as libc::c_int) << 2 as libc::c_int;
                user_specified |= (1 as libc::c_int) << 2 as libc::c_int;
                current_block_141 = 92352228884877657;
            }
            83 => {
            ...
            116 => {
                ...
                if bb_table_length < 0 as libc::c_int {
                    bb_table_length = 0 as libc::c_int;
                }
                current_block_141 = 92352228884877657;
            }
            84 => {
                bsd_style_output = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            118 => {
                printf(
                ...
                printf(
                    dcgettext(
                        b"gprof\0" as *const u8 as *const libc::c_char,
                        b"Based on BSD gprof, copyright 1983 Regents of the University of California.\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
                printf(
                    dcgettext(
                        b"gprof\0" as *const u8 as *const libc::c_char,
                        b"This program is free software.  This program has absolutely no warranty.\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
            ...
            119 => {
                ...
                if output_width < 1 as libc::c_int {
                    output_width = 1 as libc::c_int;
                }
                current_block_141 = 92352228884877657;
            }
            120 => {
                bb_annotate_all_lines = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            121 => {
                create_annotation_files = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            122 => {
                ignore_zeros = 0 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            90 => {
                if !optarg.is_null() {
            ...
            151 => {
                demangle = 0 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            152 => {
                inline_file_names = 1 as libc::c_int != 0;
                current_block_141 = 92352228884877657;
            }
            _ => {
    ...
    if user_specified & (1 as libc::c_int) << 6 as libc::c_int != 0
        && user_specified & (1 as libc::c_int) << 7 as libc::c_int != 0
    {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: Only one of --function-ordering and --file-ordering may be specified.\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
    ...
    if output_style & (1 as libc::c_int) << 2 as libc::c_int != 0 {
        line_granularity = 1 as libc::c_int != 0;
    }
    str = getenv(b"GPROF_PATH\0" as *const u8 as *const libc::c_char);
    if !str.is_null() {
        search_list_append(&mut src_search_list, str);
    }
    if optind < argc {
        let fresh0 = optind;
        optind = optind + 1;
        a_out_name = *argv.offset(fresh0 as isize);
    }
    if optind < argc {
        let fresh1 = optind;
        optind = optind + 1;
        gmon_name = *argv.offset(fresh1 as isize);
    }
    sp = &mut *default_excluded_list.as_mut_ptr().offset(0 as libc::c_int as isize)
    ...
    if !external_symbol_table.is_null() {
    ...
    sym_id_parse();
    if file_format as libc::c_uint == FF_PROF as libc::c_int as libc::c_uint {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: sorry, file format `prof' is not yet supported\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
        ...
        loop {
            ...
            if optind < argc {
                gmon_name = *argv.offset(optind as isize);
            }
            let fresh2 = optind;
            optind = optind + 1;
            if !(fresh2 < argc) {
    ...
    if output_style == 0 as libc::c_int {
        if gmon_input
    ...
    if output_style & (1 as libc::c_int) << 2 as libc::c_int != 0 {
        gmon_out_write(b"gmon.sum\0" as *const u8 as *const libc::c_char);
    }
    if gmon_input & (1 as libc::c_int) << 0 as libc::c_int != 0 {
        hist_assign_samples();
    }
    ...
    if output_style & (1 as libc::c_int) << 0 as libc::c_int != 0
        && gmon_input & (1 as libc::c_int) << 0 as libc::c_int == 0
    {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: gmon.out file is missing histogram\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
    ...
    if output_style & (1 as libc::c_int) << 1 as libc::c_int != 0
        && gmon_input & (1 as libc::c_int) << 1 as libc::c_int == 0
    {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: gmon.out file is missing call-graph data\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
    ...
    if !cg.is_null() && output_style & (1 as libc::c_int) << 1 as libc::c_int != 0
        && bsd_style_output as libc::c_int != 0
    {
        cg_print(cg);
    }
    if output_style & (1 as libc::c_int) << 0 as libc::c_int != 0 {
    ...
    if output_style & (1 as libc::c_int) << 3 as libc::c_int != 0 {
        print_exec_counts();
    }
    if output_style & (1 as libc::c_int) << 4 as libc::c_int != 0 {
        print_annotated_source();
    }
    if output_style & (1 as libc::c_int) << 6 as libc::c_int != 0 {
        cg_print_function_ordering();
    }
    if output_style & (1 as libc::c_int) << 7 as libc::c_int != 0 {
