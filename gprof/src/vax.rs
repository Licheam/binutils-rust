extern "C" {
    ...
    static mut core_text_sect: *mut asection;
    static mut core_text_space: *mut libc::c_void;
    fn hist_check_address(address: libc::c_uint) -> libc::c_int;
}
...
pub type opermodes = libc::c_uint;
pub const longreldef: opermodes = 20;
pub const longrel: opermodes = 19;
pub const wordreldef: opermodes = 18;
pub const wordrel: opermodes = 17;
pub const bytereldef: opermodes = 16;
pub const byterel: opermodes = 15;
pub const absolute: opermodes = 14;
pub const immediate: opermodes = 13;
pub const longdispdef: opermodes = 12;
pub const longdisp: opermodes = 11;
pub const worddispdef: opermodes = 10;
pub const worddisp: opermodes = 9;
pub const bytedispdef: opermodes = 8;
pub const bytedisp: opermodes = 7;
pub const autoincdef: opermodes = 6;
pub const autoinc: opermodes = 5;
pub const autodec: opermodes = 4;
pub const regdef: opermodes = 3;
pub const reg: opermodes = 2;
pub const indexed: opermodes = 1;
pub const literal: opermodes = 0;
pub type operandenum = opermodes;
static mut indirectchild: Sym = Sym {
    addr: 0,
    end_addr: 0,
    name: 0 as *const libc::c_char,
    file: 0 as *const Source_File as *mut Source_File,
    line_num: 0,
    ...
    bb_addr: [0; 10],
    bb_calls: [0; 10],
    next: 0 as *const sym as *mut sym,
    prev: 0 as *const sym as *mut sym,
    ...
    cg: C2RustUnnamed_5 {
        ...
        cyc: C2RustUnnamed_6 {
            num: 0,
            head: 0 as *const sym as *mut sym,
            next: 0 as *const sym as *mut sym,
        },
        parents: 0 as *const arc as *mut arc,
        children: 0 as *const arc as *mut arc,
    },
};
unsafe extern "C" fn vax_operandmode(mut modep: *mut libc::c_uchar) -> operandenum {
    let mut usesreg: libc::c_int = *modep as libc::c_int & 0xf as libc::c_int;
    match *modep as libc::c_int >> 4 as libc::c_int & 0xf as libc::c_int {
        0 | 1 | 2 | 3 => return literal,
        4 => return indexed,
        5 => return reg,
        6 => return regdef,
        7 => return autodec,
        8 => {
            return (if usesreg != 0xf as libc::c_int {
                autoinc as libc::c_int
            } else {
                immediate as libc::c_int
            }) as operandenum;
        }
        9 => {
            return (if usesreg != 0xf as libc::c_int {
                autoincdef as libc::c_int
            } else {
        ...
        10 => {
            return (if usesreg != 0xf as libc::c_int {
                bytedisp as libc::c_int
            } else {
                byterel as libc::c_int
            }) as operandenum;
        }
        11 => {
            return (if usesreg != 0xf as libc::c_int {
                bytedispdef as libc::c_int
            } else {
                bytereldef as libc::c_int
            }) as operandenum;
        }
        12 => {
            return (if usesreg != 0xf as libc::c_int {
                worddisp as libc::c_int
            } else {
                wordrel as libc::c_int
            }) as operandenum;
        }
        13 => {
            return (if usesreg != 0xf as libc::c_int {
                worddispdef as libc::c_int
            } else {
                wordreldef as libc::c_int
            }) as operandenum;
        }
        14 => {
            return (if usesreg != 0xf as libc::c_int {
                longdisp as libc::c_int
            } else {
                longrel as libc::c_int
            }) as operandenum;
        }
        15 => {
            return (if usesreg != 0xf as libc::c_int {
                longdispdef as libc::c_int
            } else {
                longreldef as libc::c_int
            }) as operandenum;
        }
        _ => {}
    }
...
unsafe extern "C" fn vax_operandname(mut mode: operandenum) -> *mut libc::c_char {
    match mode as libc::c_uint {
        0 => return b"literal\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        1 => return b"indexed\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        2 => {
            return b"register\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        3 => {
            return b"register deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        4 => {
            return b"autodecrement\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        5 => {
            return b"autoincrement\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        6 => {
            return b"autoincrement deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        7 => {
            return b"byte displacement\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        8 => {
            return b"byte displacement deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        15 => {
            return b"byte relative\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        16 => {
            return b"byte relative deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        9 => {
            return b"word displacement\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        10 => {
            return b"word displacement deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        17 => {
            return b"word relative\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        18 => {
            return b"word relative deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        13 => {
            return b"immediate\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        14 => {
            return b"absolute\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        11 => {
            return b"long displacement\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        12 => {
            return b"long displacement deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        19 => {
            return b"long relative\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        20 => {
            return b"long relative deferred\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        _ => {}
    }
...
unsafe extern "C" fn vax_operandlength(mut modep: *mut libc::c_uchar) -> libc::c_long {
    match vax_operandmode(modep) as libc::c_uint {
        0 | 2 | 3 | 4 | 5 | 6 => return 1 as libc::c_int as libc::c_long,
        7 | 8 | 15 | 16 => return 2 as libc::c_int as libc::c_long,
        9 | 10 | 17 | 18 => return 3 as libc::c_int as libc::c_long,
        13 | 14 | 11 | 12 | 19 | 20 => return 5 as libc::c_int as libc::c_long,
        1 => {
            return 1 as libc::c_int as libc::c_long
                + vax_operandlength(modep.offset(1 as libc::c_int as isize));
        }
        _ => {}
    }
    abort();
}
unsafe extern "C" fn vax_offset(mut modep: *mut libc::c_uchar) -> bfd_signed_vma {
    let mut mode: operandenum = vax_operandmode(modep);
    modep = modep.offset(1);
    modep;
    match mode as libc::c_uint {
        15 => {
            return 1 as libc::c_int as libc::c_long
                + ((*(modep as *const libc::c_uchar) as bfd_signed_vma
        ...
        17 => {
            return 2 as libc::c_int as libc::c_long
                + (Some(
                    ((*(*core_bfd).xvec).bfd_getx_signed_16)
                        .expect("non-null function pointer"),
                ))
                    .expect("non-null function pointer")(modep as *const libc::c_void);
        }
        19 => {
            return 4 as libc::c_int as libc::c_long
                + (Some(
                    ((*(*core_bfd).xvec).bfd_getx_signed_32)
                        .expect("non-null function pointer"),
                ))
                    .expect("non-null function pointer")(modep as *const libc::c_void);
        }
        _ => {
            fprintf(
                stderr,
                b"[reladdr] not relative address\n\0" as *const u8 as *const libc::c_char,
            );
...
#[no_mangle]
pub unsafe extern "C" fn vax_find_call(
    mut parent: *mut Sym,
    mut p_lowpc: bfd_vma,
    mut p_highpc: bfd_vma,
) {
    let mut current_block: u64;
    let mut instructp: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut length: libc::c_long = 0;
    let mut child: *mut Sym = 0 as *mut Sym;
    let mut mode: operandenum = literal;
    let mut firstmode: operandenum = literal;
    let mut pc: bfd_vma = 0;
    let mut destpc: bfd_vma = 0;
    static mut inited: bool = 0 as libc::c_int != 0;
    if !inited {
        inited = 1 as libc::c_int != 0;
        sym_init(&mut indirectchild);
        indirectchild.cg.prop.fract = 1.0f64;
        indirectchild.cg.cyc.head = &mut indirectchild;
    }
    if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
        printf(
            b"[findcall] %s: 0x%lx to 0x%lx\n\0" as *const u8 as *const libc::c_char,
            (*parent).name,
            p_lowpc,
            p_highpc,
        );
    ...
    while pc < p_highpc {
        ...
        instructp = (core_text_space as *mut libc::c_uchar)
            .offset(pc as isize)
            .offset(-((*core_text_sect).vma as isize));
        if *instructp as libc::c_int & 0xff as libc::c_int == 0xfb as libc::c_int {
            if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                printf(
                    b"[findcall]\t0x%lx:calls\0" as *const u8 as *const libc::c_char,
                    pc,
                );
            }
            firstmode = vax_operandmode(instructp.offset(length as isize));
            match firstmode as libc::c_uint {
                0 | 13 => {
                    length += vax_operandlength(instructp.offset(length as isize));
                    mode = vax_operandmode(instructp.offset(length as isize));
                    if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                        printf(
                            b"\tfirst operand is %s\0" as *const u8
                                as *const libc::c_char,
                            vax_operandname(firstmode),
                        );
                        printf(
                            b"\tsecond operand is %s\n\0" as *const u8
                                as *const libc::c_char,
                    ...
                    match mode as libc::c_uint {
                        3 | 8 | 10 | 12 | 16 | 18 | 20 => {
                            current_block = 984170810754156115;
                            match current_block {
                                17964382471063087788 => {
                                    destpc = pc
                                        .wrapping_add(
                                            vax_offset(instructp.offset(length as isize))
                                                as libc::c_ulong,
                                        );
                                    if hist_check_address(destpc as libc::c_uint) != 0 {
                                        child = sym_lookup(&mut symtab, destpc);
                                        if !child.is_null() {
                                            if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0
                                            {
                                                printf(
                                                    b"[findcall]\tdestpc 0x%lx\0" as *const u8
                                                        as *const libc::c_char,
                                                    destpc,
                                                );
                                                printf(
                                                    b" child->name %s\0" as *const u8 as *const libc::c_char,
                                                    (*child).name,
                                                );
                                                printf(
                                                    b" child->addr 0x%lx\n\0" as *const u8
                                            ...
                                            if (*child).addr == destpc {
                                                arc_add(parent, child, 0 as libc::c_int as libc::c_ulong);
                                                length
                                                    += vax_operandlength(instructp.offset(length as isize));
                                                current_block = 2868539653012386629;
                                            } else {
                                                current_block = 11865723085565127604;
                                            }
                                        } else {
                                            current_block = 11865723085565127604;
                                        }
                        ...
                        15 | 17 | 19 => {
                            current_block = 17964382471063087788;
                            match current_block {
                                17964382471063087788 => {
                                    destpc = pc
                                        .wrapping_add(
        ...
        pc = (pc as libc::c_ulong).wrapping_add(length as libc::c_ulong) as bfd_vma
            as bfd_vma;
    }
}
