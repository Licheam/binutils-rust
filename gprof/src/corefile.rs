extern "C" {
    ...
    static mut ignore_non_functions: bool;
    fn bfd_openr(filename: *const libc::c_char, target: *const libc::c_char) -> *mut bfd;
    static mut ignore_static_funcs: bool;
    static mut ignore_direct_calls: bool;
    static mut debug_level: libc::c_int;
    static mut a_out_name: *const libc::c_char;
    static mut function_mapping_file: *const libc::c_char;
    ...
    fn source_file_lookup_path(_: *const libc::c_char) -> *mut Source_File;
    static mut symtab: Sym_Table;
    fn sym_init(_: *mut Sym);
    fn symtab_finalize(_: *mut Sym_Table);
    fn sym_lookup(_: *mut Sym_Table, _: bfd_vma) -> *mut Sym;
    fn hist_clip_symbol_address(p_lowpc: *mut bfd_vma, p_highpc: *mut bfd_vma);
    static _sch_istable: [libc::c_ushort; 256];
    fn i386_find_call(_: *mut Sym, _: bfd_vma, _: bfd_vma);
    fn alpha_find_call(_: *mut Sym, _: bfd_vma, _: bfd_vma);
    fn vax_find_call(_: *mut Sym, _: bfd_vma, _: bfd_vma);
    fn sparc_find_call(_: *mut Sym, _: bfd_vma, _: bfd_vma);
    fn mips_find_call(_: *mut Sym, _: bfd_vma, _: bfd_vma);
    fn aarch64_find_call(_: *mut Sym, _: bfd_vma, _: bfd_vma);
}
...
pub struct sym {
    ...
    pub next: *mut sym,
    pub prev: *mut sym,
    pub hist: C2RustUnnamed_8,
    pub cg: C2RustUnnamed_5,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_5 {
    ...
    pub print_flag: bool,
    pub prop: C2RustUnnamed_7,
    pub cyc: C2RustUnnamed_6,
    pub parents: *mut arc,
...
pub const _sch_isdigit: C2RustUnnamed_9 = 4;
pub type C2RustUnnamed_9 = libc::c_uint;
pub const _sch_isbasic: C2RustUnnamed_9 = 3088;
pub const _sch_iscppsp: C2RustUnnamed_9 = 3072;
pub const _sch_isgraph: C2RustUnnamed_9 = 172;
pub const _sch_isidnum: C2RustUnnamed_9 = 516;
pub const _sch_isalnum: C2RustUnnamed_9 = 140;
pub const _sch_isalpha: C2RustUnnamed_9 = 136;
pub const _sch_isnvsp: C2RustUnnamed_9 = 2048;
pub const _sch_isvsp: C2RustUnnamed_9 = 1024;
pub const _sch_isidst: C2RustUnnamed_9 = 512;
pub const _sch_isxdigit: C2RustUnnamed_9 = 256;
pub const _sch_isupper: C2RustUnnamed_9 = 128;
pub const _sch_isspace: C2RustUnnamed_9 = 64;
pub const _sch_ispunct: C2RustUnnamed_9 = 32;
pub const _sch_isprint: C2RustUnnamed_9 = 16;
pub const _sch_islower: C2RustUnnamed_9 = 8;
pub const _sch_iscntrl: C2RustUnnamed_9 = 2;
pub const _sch_isblank: C2RustUnnamed_9 = 1;
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn find_call(
    mut parent: *mut Sym,
    mut p_lowpc: bfd_vma,
    mut p_highpc: bfd_vma,
) {
    if core_text_space.is_null() {
        return;
    }
    hist_clip_symbol_address(&mut p_lowpc, &mut p_highpc);
    match bfd_get_arch(core_bfd) as libc::c_uint {
        8 => {
        ...
        _ => {
            fprintf(
                ...
                dcgettext(
                    ...
                    b"%s: -c not supported on architecture %s\n\0" as *const u8
            ...
            ignore_direct_calls = 0 as libc::c_int != 0;
        }
    };
}
#[no_mangle]
pub static mut symbol_map: *mut function_map = 0 as *const function_map
    as *mut function_map;
#[no_mangle]
pub static mut symbol_map_count: libc::c_uint = 0;
#[no_mangle]
pub static mut core_bfd: *mut bfd = 0 as *const bfd as *mut bfd;
#[no_mangle]
pub static mut core_text_sect: *mut asection = 0 as *const asection as *mut asection;
#[no_mangle]
pub static mut core_text_space: *mut libc::c_void = 0 as *const libc::c_void
    as *mut libc::c_void;
#[no_mangle]
pub static mut offset_to_code: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn core_init(mut aout_name: *const libc::c_char) {
    let mut core_sym_bytes: libc::c_int = 0;
    let mut synthsyms: *mut asymbol = 0 as *mut asymbol;
    let mut synth_count: libc::c_long = 0;
    core_bfd = bfd_openr(aout_name, 0 as *const libc::c_char);
    if core_bfd.is_null() {
        perror(aout_name);
        done(1 as libc::c_int);
    }
    (*core_bfd).flags |= 0x8000 as libc::c_int as libc::c_uint;
    if !bfd_check_format(core_bfd, bfd_object) {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: %s: not in executable format\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
    ...
    core_text_sect = bfd_get_section_by_name(
        core_bfd,
        b".text\0" as *const u8 as *const libc::c_char,
    );
    if core_text_sect.is_null() {
        core_text_sect = bfd_get_section_by_name(
            core_bfd,
        ...
        if core_text_sect.is_null() {
            fprintf(
                ...
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: can't find .text section in %s\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
    ...
    core_sym_bytes = (Some(
        ((*(*core_bfd).xvec)._bfd_get_symtab_upper_bound)
            .expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(core_bfd) as libc::c_int;
    if core_sym_bytes < 0 as libc::c_int {
        fprintf(
            stderr,
    ...
    core_syms = xmalloc(core_sym_bytes as size_t) as *mut *mut asymbol;
    core_num_syms = (Some(
        ((*(*core_bfd).xvec)._bfd_canonicalize_symtab)
            .expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(core_bfd, core_syms) as libc::c_int;
    if core_num_syms < 0 as libc::c_int {
        fprintf(
            stderr,
            b"%s: %s: %s\n\0" as *const u8 as *const libc::c_char,
            whoami,
    ...
    synth_count = (Some(
        ((*(*core_bfd).xvec)._bfd_get_synthetic_symtab)
            .expect("non-null function pointer"),
    ))
        .expect(
        ...
        core_bfd,
        core_num_syms as libc::c_long,
        core_syms,
        0 as libc::c_int as libc::c_long,
        0 as *mut *mut bfd_symbol,
        &mut synthsyms,
    );
    if synth_count > 0 as libc::c_int as libc::c_long {
        let mut symp: *mut *mut asymbol = 0 as *mut *mut asymbol;
        let mut new_size: libc::c_long = 0;
        let mut i: libc::c_long = 0;
        new_size = ((core_num_syms as libc::c_long + synth_count
            + 1 as libc::c_int as libc::c_long) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut asymbol>() as libc::c_ulong)
            as libc::c_long;
        core_syms = xrealloc(core_syms as *mut libc::c_void, new_size as size_t)
            as *mut *mut asymbol;
        symp = core_syms.offset(core_num_syms as isize);
        core_num_syms = (core_num_syms as libc::c_long + synth_count) as libc::c_int;
    ...
    min_insn_size = 1 as libc::c_int;
    offset_to_code = 0 as libc::c_int;
    match bfd_get_arch(core_bfd) as libc::c_uint {
        3 => {
            offset_to_code = 2 as libc::c_int;
        }
        31 => {
            min_insn_size = 4 as libc::c_int;
        }
        _ => {}
    }
    if !function_mapping_file.is_null() {
        read_function_mappings(function_mapping_file);
    }
}
#[no_mangle]
pub unsafe extern "C" fn core_get_text_space(mut cbfd: *mut bfd) {
    ...
    if core_text_space.is_null() {
        fprintf(
            ...
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: ran out room for %lu bytes of text space\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
    ...
    if !bfd_get_section_contents(
        ...
        bfd_perror(b"bfd_get_section_contents\0" as *const u8 as *const libc::c_char);
        free(core_text_space);
        core_text_space = 0 as *mut libc::c_void;
    }
    if core_text_space.is_null() {
        fprintf(
            stderr,
...
#[no_mangle]
pub unsafe extern "C" fn core_create_function_syms() {
    let mut min_vma: bfd_vma = !(0 as libc::c_int as bfd_vma);
    let mut max_vma: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut cxxclass: libc::c_int = 0;
    let mut i: libc::c_long = 0;
    let mut found: *mut function_map = 0 as *mut function_map;
    let mut core_has_func_syms: libc::c_int = 0 as libc::c_int;
    match (*(*core_bfd).xvec).flavour as libc::c_uint {
        2 | 3 | 4 | 5 | 10 => {
            core_has_func_syms = 1 as libc::c_int;
        }
        _ => {}
    }
    symtab.len = 0 as libc::c_int as libc::c_uint;
    i = 0 as libc::c_int as libc::c_long;
    while i < core_num_syms as libc::c_long {
        if !(core_sym_class(*core_syms.offset(i as isize)) == 0) {
            if symbol_map_count != 0 as libc::c_int as libc::c_uint {
                found = bsearch(
                    (**core_syms.offset(i as isize)).name as *const libc::c_void,
                    symbol_map as *const libc::c_void,
            ...
            if found.is_null() || (*found).is_first() as libc::c_int != 0 {
                symtab.len = (symtab.len).wrapping_add(1);
                symtab.len;
            }
        }
        i += 1;
    ...
    if symtab.len == 0 as libc::c_int as libc::c_uint {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: file `%s' has no symbols\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
            a_out_name,
    ...
    while i < core_num_syms as libc::c_long {
        ...
        cxxclass = core_sym_class(*core_syms.offset(i as isize));
        if cxxclass == 0 {
            if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
                printf(
                    b"[core_create_function_syms] rejecting: 0x%lx %s\n\0" as *const u8
                        as *const libc::c_char,
                    (**core_syms.offset(i as isize)).value,
                    (**core_syms.offset(i as isize)).name,
                );
            }
        } else {
            if symbol_map_count != 0 as libc::c_int as libc::c_uint {
            ...
            if !(!found.is_null() && (*found).is_first() == 0) {
                sym_init(symtab.limit);
                sym_sec = (**core_syms.offset(i as isize)).section;
                (*symtab.limit).addr = (**core_syms.offset(i as isize)).value;
                if !sym_sec.is_null() {
                    (*symtab.limit)
                        .addr = ((*symtab.limit).addr as libc::c_ulong)
                        .wrapping_add(bfd_section_vma(sym_sec)) as bfd_vma as bfd_vma;
                }
                if !found.is_null() {
                    (*symtab.limit).name = (*found).file_name;
                    (*symtab.limit).set_mapped(1 as libc::c_int as libc::c_uint);
                } else {
                    (*symtab.limit).name = (**core_syms.offset(i as isize)).name;
                    (*symtab.limit).set_mapped(0 as libc::c_int as libc::c_uint);
                }
                let mut filename: *const libc::c_char = 0 as *const libc::c_char;
                let mut func_name: *const libc::c_char = 0 as *const libc::c_char;
                if get_src_info(
                    (*symtab.limit).addr,
                    &mut filename,
                    &mut func_name,
                    &mut (*symtab.limit).line_num,
                ) {
                    (*symtab.limit).file = source_file_lookup_path(filename);
                }
                (*symtab.limit)
                    .set_is_func(
                        (core_has_func_syms == 0
                            || (**core_syms.offset(i as isize)).flags
                                & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint
                                != 0 as libc::c_int as libc::c_uint) as libc::c_int
                            as libc::c_uint,
                    );
                (*symtab.limit).set_is_bb_head(1 as libc::c_int as libc::c_uint);
                if cxxclass == 't' as i32 {
                    (*symtab.limit).set_is_static(1 as libc::c_int as libc::c_uint);
                }
                min_vma = if (*symtab.limit).addr < min_vma {
                    (*symtab.limit).addr
                } else {
                    min_vma
                };
                if !sym_sec.is_null() {
                    max_vma = if (bfd_section_vma(sym_sec))
                        .wrapping_add(bfd_section_size(sym_sec))
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong) > max_vma
                    {
                    ...
                    max_vma = if (*symtab.limit).addr > max_vma {
                        (*symtab.limit).addr
                    } else {
                        max_vma
                    };
                ...
                if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
                    printf(
                        b"[core_create_function_syms] %ld %s 0x%lx\n\0" as *const u8
                            as *const libc::c_char,
                        (symtab.limit).offset_from(symtab.base) as libc::c_long,
                        (*symtab.limit).name,
                        (*symtab.limit).addr,
                    );
                }
                symtab.limit = (symtab.limit).offset(1);
                symtab.limit;
            }
        }
        i += 1;
    ...
    symtab.len = (symtab.limit).offset_from(symtab.base) as libc::c_long as libc::c_uint;
    symtab_finalize(&mut symtab);
}
#[no_mangle]
pub unsafe extern "C" fn core_create_line_syms() {
    let mut prev_name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut prev_filename: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut prev_name_len: libc::c_uint = 0;
    let mut prev_filename_len: libc::c_uint = 0;
    let mut vma: bfd_vma = 0;
    let mut min_vma: bfd_vma = !(0 as libc::c_int as bfd_vma);
    let mut max_vma: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut prev: *mut Sym = 0 as *mut Sym;
    let mut dummy: Sym = Sym {
        addr: 0,
        end_addr: 0,
        name: 0 as *const libc::c_char,
        file: 0 as *mut Source_File,
        line_num: 0,
        is_func_is_static_is_bb_head_mapped_has_been_placed: [0; 1],
        c2rust_padding: [0; 3],
        ncalls: 0,
        nuses: 0,
        bb_addr: [0; 10],
        ...
        cg: C2RustUnnamed_5 {
            ...
            parents: 0 as *mut arc,
            children: 0 as *mut arc,
        },
    };
    let mut sym: *mut Sym = 0 as *mut Sym;
    let mut filename: *const libc::c_char = 0 as *const libc::c_char;
    let mut prev_line_num: libc::c_int = 0;
    let mut ltab: Sym_Table = Sym_Table {
        len: 0,
        base: 0 as *const Sym as *mut Sym,
        limit: 0 as *const Sym as *mut Sym,
    };
    let mut vma_high: bfd_vma = 0;
    core_create_function_syms();
    prev_name_len = 1024 as libc::c_int as libc::c_uint;
    prev_filename_len = 1024 as libc::c_int as libc::c_uint;
    prev_name = xmalloc(prev_name_len as size_t) as *mut libc::c_char;
    prev_filename = xmalloc(prev_filename_len as size_t) as *mut libc::c_char;
    ltab.len = 0 as libc::c_int as libc::c_uint;
    prev_line_num = 0 as libc::c_int;
    vma_high = ((*core_text_sect).vma).wrapping_add(bfd_section_size(core_text_sect));
    vma = (*core_text_sect).vma;
    while vma < vma_high {
        let mut len: libc::c_uint = 0;
        if !(!get_src_info(vma, &mut filename, &mut dummy.name, &mut dummy.line_num)
            || prev_line_num == dummy.line_num && !prev_name.is_null()
                && strcmp(prev_name, dummy.name) == 0 as libc::c_int
                && filename_cmp(prev_filename, filename) == 0 as libc::c_int)
        {
            ltab.len = (ltab.len).wrapping_add(1);
            ltab.len;
            prev_line_num = dummy.line_num;
            len = strlen(dummy.name) as libc::c_uint;
            if len >= prev_name_len {
                prev_name_len = len.wrapping_add(1024 as libc::c_int as libc::c_uint);
                free(prev_name as *mut libc::c_void);
                prev_name = xmalloc(prev_name_len as size_t) as *mut libc::c_char;
            }
            strcpy(prev_name, dummy.name);
            len = strlen(filename) as libc::c_uint;
            if len >= prev_filename_len {
                prev_filename_len = len
                    .wrapping_add(1024 as libc::c_int as libc::c_uint);
                free(prev_filename as *mut libc::c_void);
                prev_filename = xmalloc(prev_filename_len as size_t)
                    as *mut libc::c_char;
            }
            strcpy(prev_filename, filename);
            min_vma = if vma < min_vma { vma } else { min_vma };
            max_vma = if vma > max_vma { vma } else { max_vma };
        }
        vma = (vma as libc::c_ulong).wrapping_add(min_insn_size as libc::c_ulong)
            as bfd_vma as bfd_vma;
    }
    free(prev_name as *mut libc::c_void);
    free(prev_filename as *mut libc::c_void);
    ltab.len = (ltab.len).wrapping_add(symtab.len);
    ltab
        .base = xmalloc(
        (ltab.len as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<Sym>() as libc::c_ulong),
    ) as *mut Sym;
    ...
    while vma < vma_high {
        ...
        if !(!get_src_info(
            ...
            &mut filename,
            &mut (*ltab.limit).name,
            &mut (*ltab.limit).line_num,
        )
            || !prev.is_null() && (*prev).line_num == (*ltab.limit).line_num
                && strcmp((*prev).name, (*ltab.limit).name) == 0 as libc::c_int
                && filename_cmp((*(*prev).file).name, filename) == 0 as libc::c_int)
        {
            (*ltab.limit).name = xstrdup((*ltab.limit).name);
            (*ltab.limit).file = source_file_lookup_path(filename);
            (*ltab.limit).addr = vma;
            if !prev.is_null() && (*ltab.limit).file == (*prev).file
                && strcmp((*ltab.limit).name, (*prev).name) == 0 as libc::c_int
            {
                (*ltab.limit).set_is_static((*prev).is_static());
            } else {
                sym = sym_lookup(&mut symtab, (*ltab.limit).addr);
                if !sym.is_null() {
                    (*ltab.limit).set_is_static((*sym).is_static());
                }
            }
            prev = ltab.limit;
            if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
                printf(
                    b"[core_create_line_syms] %lu %s 0x%lx\n\0" as *const u8
                        as *const libc::c_char,
                    (ltab.limit).offset_from(ltab.base) as libc::c_long as libc::c_ulong,
                    (*ltab.limit).name,
                    (*ltab.limit).addr,
                );
            }
            ltab.limit = (ltab.limit).offset(1);
            ltab.limit;
        }
        vma = (vma as libc::c_ulong).wrapping_add(min_insn_size as libc::c_ulong)
            as bfd_vma as bfd_vma;
    ...
    memcpy(
        ltab.limit as *mut libc::c_void,
        symtab.base as *const libc::c_void,
        (symtab.len as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<Sym>() as libc::c_ulong),
    );
    ltab.limit = (ltab.limit).offset(symtab.len as isize);
    if (ltab.limit).offset_from(ltab.base) as libc::c_long as libc::c_uint != ltab.len {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: somebody miscounted: ltab.len=%d instead of %ld\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
            ltab.len,
            (ltab.limit).offset_from(ltab.base) as libc::c_long,
        );
        done(1 as libc::c_int);
    }
    symtab_finalize(&mut ltab);
    free(symtab.base as *mut libc::c_void);
    symtab = ltab;
}
#[no_mangle]
pub unsafe extern "C" fn core_create_syms_from(mut sym_table_file: *const libc::c_char) {
    let mut type_0: libc::c_char = 0;
    let mut min_vma: bfd_vma = !(0 as libc::c_int as bfd_vma);
    let mut max_vma: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut f: *mut FILE = 0 as *mut FILE;
    f = fopen(sym_table_file, b"r\0" as *const u8 as *const libc::c_char);
    if f.is_null() {
        fprintf(
            stderr,
            dcgettext(
    ...
    } else if symtab.len == (1 as libc::c_uint).wrapping_neg() {
        fprintf(
            stderr,
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: file `%s' has too many symbols\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
    ...
    while feof(f) == 0
        && !(fgets(buf.as_mut_ptr(), 1024 as libc::c_int - 1 as libc::c_int, f))
            .is_null()
    {
        if sscanf(
            buf.as_mut_ptr(),
            b"%1023s %c %1023s\0" as *const u8 as *const libc::c_char,
            address.as_mut_ptr(),
        ...
        if type_0 as libc::c_int != 't' as i32 && type_0 as libc::c_int != 'T' as i32 {
            continue;
        }
        sym_init(symtab.limit);
        sscanf(
            ...
            &mut (*symtab.limit).addr as *mut bfd_vma,
        );
        (*symtab.limit)
            .name = xmalloc(
            (strlen(name.as_mut_ptr())).wrapping_add(1 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        strcpy((*symtab.limit).name as *mut libc::c_char, name.as_mut_ptr());
        (*symtab.limit).set_mapped(0 as libc::c_int as libc::c_uint);
        (*symtab.limit).set_is_func(1 as libc::c_int as libc::c_uint);
        (*symtab.limit).set_is_bb_head(1 as libc::c_int as libc::c_uint);
        (*symtab.limit)
            .set_is_static(
                (type_0 as libc::c_int == 't' as i32) as libc::c_int as libc::c_uint,
            );
        min_vma = if (*symtab.limit).addr < min_vma {
            (*symtab.limit).addr
        } else {
...
static mut core_num_syms: libc::c_int = 0;
static mut core_syms: *mut *mut asymbol = 0 as *const *mut asymbol as *mut *mut asymbol;
static mut min_insn_size: libc::c_int = 0;
unsafe extern "C" fn read_function_mappings(mut filename: *const libc::c_char) {
    ...
    while feof(file) == 0 {
        ...
        if strncmp(
            dummy.as_mut_ptr(),
            b"No symbols in \0" as *const u8 as *const libc::c_char,
            14 as libc::c_int as libc::c_ulong,
        ) == 0
        {
            matches = fscanf(file, b"\n\0" as *const u8 as *const libc::c_char);
            if matches == -(1 as libc::c_int) {
                parse_error(filename);
            }
        } else {
            matches = fscanf(
    ...
    symbol_map = xmalloc(
        (count as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<function_map>() as libc::c_ulong),
    ) as *mut function_map;
    rewind(file);
    count = 0 as libc::c_int;
    while feof(file) == 0 {
        let mut matches_0: libc::c_int = 0;
        ...
        {
            matches_0 = fscanf(file, b"\n\0" as *const u8 as *const libc::c_char);
            if matches_0 == -(1 as libc::c_int) {
                parse_error(filename);
            }
        } else {
            let ref mut fresh1 = (*symbol_map.offset(count as isize)).file_name;
            *fresh1 = xmalloc(
                (strlen(dummy.as_mut_ptr()))
                    .wrapping_add(1 as libc::c_int as libc::c_ulong),
            ) as *mut libc::c_char;
            strcpy((*symbol_map.offset(count as isize)).file_name, dummy.as_mut_ptr());
            matches_0 = fscanf(
                file,
                b"%1023[^\n]\n\0" as *const u8 as *const libc::c_char,
                dummy.as_mut_ptr(),
            ...
            tmp = (strrchr(dummy.as_mut_ptr(), ' ' as i32))
                .offset(1 as libc::c_int as isize);
            let ref mut fresh2 = (*symbol_map.offset(count as isize)).function_name;
            *fresh2 = xmalloc(
                (strlen(tmp)).wrapping_add(1 as libc::c_int as libc::c_ulong),
            ) as *mut libc::c_char;
            strcpy((*symbol_map.offset(count as isize)).function_name, tmp);
            count += 1;
            count;
        }
    }
    symbol_map_count = count as libc::c_uint;
    i = 0 as libc::c_int as libc::c_uint;
    while i < symbol_map_count {
        if i == 0 as libc::c_int as libc::c_uint
            || filename_cmp(
                (*symbol_map.offset(i as isize)).file_name,
                (*symbol_map
                    .offset(i.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize))
                    .file_name,
            ) != 0
        {
            let ref mut fresh3 = *symbol_map.offset(i as isize);
            (*fresh3).set_is_first(1 as libc::c_int as libc::c_uint);
        }
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn core_sym_class(mut sym: *mut asymbol) -> libc::c_int {
    ...
    let mut sym_prefix: libc::c_char = 0;
    ...
    if ignore_static_funcs as libc::c_int != 0
        && (*sym).flags & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint != 0
    {
        if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
            printf(
                b"[core_sym_class] %s: not a function\n\0" as *const u8
                    as *const libc::c_char,
                (*sym).name,
            );
        }
    ...
    (Some(
        ((*(*core_bfd).xvec)._bfd_get_symbol_info).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(core_bfd, sym, &mut syminfo);
    i = syminfo.type_0 as libc::c_int;
    if i == 'T' as i32 {
        return i;
    }
    if i == 'W' as i32 {
    ...
    if i != 't' as i32 {
        if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
            printf(
                b"[core_sym_class] %s is of class %c\n\0" as *const u8
                    as *const libc::c_char,
                (*sym).name,
                i,
            );
    ...
    if ((*sym).name).is_null()
        || *((*sym).name).offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32
    {
        return 0 as libc::c_int;
    }
    name_0 = (*sym).name;
    while *name_0 != 0 {
        ...
        while *name_0 as libc::c_int == '.' as i32 {
            let mut digit_seen: libc::c_int = 0 as libc::c_int;
            if strlen(name_0) > strlen(b".clone.\0" as *const u8 as *const libc::c_char)
                && strncmp(
                    name_0,
                    b".clone.\0" as *const u8 as *const libc::c_char,
                    strlen(b".clone.\0" as *const u8 as *const libc::c_char),
                ) == 0 as libc::c_int
            {
                name_0 = name_0
                    .offset(
            ...
            } else if strlen(name_0)
                > strlen(b".constprop.\0" as *const u8 as *const libc::c_char)
                && strncmp(
                    name_0,
                    b".constprop.\0" as *const u8 as *const libc::c_char,
                    strlen(b".constprop.\0" as *const u8 as *const libc::c_char),
                ) == 0 as libc::c_int
            {
                name_0 = name_0
            ...
            name_0;
            while *name_0 != 0 {
                if digit_seen != 0 && *name_0 as libc::c_int == '.' as i32 {
                    break;
                }
                if _sch_istable[(*name_0 as libc::c_int & 0xff as libc::c_int) as usize]
                    as libc::c_int
                    & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
                {
                    digit_seen = 1 as libc::c_int;
                } else {
                    return 0 as libc::c_int
                }
                name_0 = name_0.offset(1);
    ...
    if sym_prefix as libc::c_int != 0
        && sym_prefix as libc::c_int
            != *((*sym).name).offset(0 as libc::c_int as isize) as libc::c_int
        || strncmp(
            (*sym).name,
            b"__gnu_compiled\0" as *const u8 as *const libc::c_char,
            14 as libc::c_int as libc::c_ulong,
        ) == 0
        || strncmp(
            (*sym).name,
            b"___gnu_compiled\0" as *const u8 as *const libc::c_char,
            15 as libc::c_int as libc::c_ulong,
        ) == 0
    {
        return 0 as libc::c_int;
    }
    if ignore_non_functions as libc::c_int != 0
...
unsafe extern "C" fn get_src_info(
    mut addr: bfd_vma,
    mut filename: *mut *const libc::c_char,
    mut name_0: *mut *const libc::c_char,
    mut line_num: *mut libc::c_int,
) -> bool {
    let mut fname: *const libc::c_char = 0 as *const libc::c_char;
    let mut func_name: *const libc::c_char = 0 as *const libc::c_char;
    let mut l: libc::c_int = 0 as libc::c_int;
    if (Some(
        ((*(*core_bfd).xvec)._bfd_find_nearest_line).expect("non-null function pointer"),
    ))
        .expect(
            "non-null function pointer",
        )(
        ...
        core_syms,
        core_text_sect,
        addr.wrapping_sub((*core_text_sect).vma),
        &mut fname,
        &mut func_name,
        &mut l as *mut libc::c_int as *mut libc::c_uint,
        0 as *mut libc::c_uint,
    ) as libc::c_int != 0 && !fname.is_null() && !func_name.is_null() && l != 0
    {
        if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
            printf(
                b"[get_src_info] 0x%lx -> %s:%d (%s)\n\0" as *const u8
                    as *const libc::c_char,
                addr,
                fname,
                l,
        ...
        *line_num = l;
        ...
        if debug_level & (1 as libc::c_int) << 7 as libc::c_int != 0 {
            printf(
                b"[get_src_info] no info for 0x%lx (%s:%d,%s)\n\0" as *const u8
                    as *const libc::c_char,
                addr,
                if !fname.is_null() {
                    fname
...
unsafe extern "C" fn parse_error(mut filename: *const libc::c_char) {
    fprintf(
        stderr,
        dcgettext(
            b"gprof\0" as *const u8 as *const libc::c_char,
            b"%s: unable to parse mapping file %s.\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
        whoami,
...
unsafe extern "C" fn cmp_symbol_map(
    ...
    return strcmp(
        (*(l as *mut function_map)).function_name,
        (*(r as *mut function_map)).function_name,
    );
}
static mut buf: [libc::c_char; 1024] = [0; 1024];
static mut address: [libc::c_char; 1024] = [0; 1024];
static mut name: [libc::c_char; 1024] = [0; 1024];
unsafe extern "C" fn num_of_syms_in(mut f: *mut FILE) -> libc::c_uint {
    let mut type_0: libc::c_char = 0;
            ...
            .is_null()
    {
        ...
        ) == 3 as libc::c_int
        {
            if type_0 as libc::c_int == 't' as i32 || type_0 as libc::c_int == 'T' as i32
            {
                ...
                {
                    return (1 as libc::c_uint).wrapping_neg();
                }
            }
        }
    }
...
unsafe extern "C" fn search_mapped_symbol(
    mut l: *const libc::c_void,
    mut r: *const libc::c_void,
) -> libc::c_int {
    return strcmp(l as *const libc::c_char, (*(r as *const function_map)).function_name);
}
