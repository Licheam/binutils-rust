...
static mut indirect_child: Sym = Sym {
    addr: 0,
    end_addr: 0,
...
#[no_mangle]
pub unsafe extern "C" fn alpha_find_call(
    mut parent: *mut Sym,
    mut p_lowpc: bfd_vma,
    mut p_highpc: bfd_vma,
) {
    let mut pc: bfd_vma = 0;
    let mut dest_pc: bfd_vma = 0;
    let mut insn: libc::c_uint = 0;
    let mut child: *mut Sym = 0 as *mut Sym;
    if (indirect_child.name).is_null() {
        sym_init(&mut indirect_child);
        indirect_child
            .name = dcgettext(
            b"gprof\0" as *const u8 as *const libc::c_char,
            b"<indirect child>\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        );
        indirect_child.cg.prop.fract = 1.0f64;
        indirect_child.cg.cyc.head = &mut indirect_child;
    }
    if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
        printf(
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"[find_call] %s: 0x%lx to 0x%lx\n\0" as *const u8
    ...
    pc = p_lowpc.wrapping_add(3 as libc::c_int as libc::c_ulong)
    ...
    while pc < p_highpc {
        insn = (Some(
            ...
            (core_text_space as *mut libc::c_uchar)
                .offset(pc as isize)
                .offset(-((*core_text_sect).vma as isize)) as *const libc::c_void,
        ) as libc::c_uint;
        match insn & (0x3f as libc::c_uint) << 26 as libc::c_int {
            1744830464 => {
                if insn & ((3 as libc::c_int) << 14 as libc::c_int) as libc::c_uint
                    == (1 as libc::c_uint) << 14 as libc::c_int
                    || insn & ((3 as libc::c_int) << 14 as libc::c_int) as libc::c_uint
                        == (3 as libc::c_uint) << 14 as libc::c_int
                {
                    if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                        printf(
                            dcgettext(
                                b"gprof\0" as *const u8 as *const libc::c_char,
                                b"[find_call] 0x%lx: jsr%s <indirect_child>\n\0"
                                ...
                                == (1 as libc::c_uint) << 14 as libc::c_int
                            {
                                ...
                                b"_coroutine\0" as *const u8 as *const libc::c_char
                            },
                        );
                    }
                    arc_add(
            ...
            3489660928 => {
                if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                    printf(
                        dcgettext(
                            b"gprof\0" as *const u8 as *const libc::c_char,
                            b"[find_call] 0x%lx: bsr\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        pc,
                ...
                dest_pc = pc
                    ...
                    .wrapping_add(
                        (((insn & 0x1fffff as libc::c_int as libc::c_uint)
                            as bfd_signed_vma ^ 0x100000 as libc::c_int as libc::c_long)
                            - 0x100000 as libc::c_int as libc::c_long) as libc::c_ulong,
                    );
                if hist_check_address(dest_pc as libc::c_uint) != 0 {
                    child = sym_lookup(&mut symtab, dest_pc);
                    if !child.is_null() {
                        if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                            printf(
                                b" 0x%lx\t; name=%s, addr=0x%lx\0" as *const u8
                                    as *const libc::c_char,
                                dest_pc,
                                (*child).name,
                                (*child).addr,
                        ...
                        if (*child).addr == dest_pc
                            || (*child).addr
                                == dest_pc.wrapping_sub(8 as libc::c_int as libc::c_ulong)
                        {
                            if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0
                            {
                            ...
                            current_block_37 = 5720623009719927633;
                        } else {
                            current_block_37 = 1538046216550696469;
                        }
                    } else {
                        current_block_37 = 1538046216550696469;
                    }
        ...
        pc = (pc as libc::c_ulong).wrapping_add(4 as libc::c_int as libc::c_ulong)
