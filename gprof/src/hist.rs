extern "C" {
    ...
    static mut core_bfd: *mut bfd;
    static mut offset_to_code: libc::c_int;
    ...
    fn gmon_io_read(ifp: *mut FILE, buf: *mut libc::c_char, n: size_t) -> libc::c_int;
...
pub const GMON_TAG_BB_COUNT: C2RustUnnamed_9 = 2;
pub const GMON_TAG_CG_ARC: C2RustUnnamed_9 = 1;
pub const GMON_TAG_TIME_HIST: C2RustUnnamed_9 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct histogram {
    pub lowpc: bfd_vma,
    pub highpc: bfd_vma,
    pub num_bins: libc::c_uint,
    pub sample: *mut libc::c_int,
}
pub const EXCL_FLAT: C2RustUnnamed_11 = 5;
pub const INCL_FLAT: C2RustUnnamed_11 = 4;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_10 {
    pub prefix: libc::c_char,
    pub scale: libc::c_double,
}
pub type C2RustUnnamed_11 = libc::c_uint;
pub const NUM_TABLES: C2RustUnnamed_11 = 12;
pub const EXCL_EXEC: C2RustUnnamed_11 = 11;
pub const INCL_EXEC: C2RustUnnamed_11 = 10;
pub const EXCL_ANNO: C2RustUnnamed_11 = 9;
pub const INCL_ANNO: C2RustUnnamed_11 = 8;
pub const EXCL_TIME: C2RustUnnamed_11 = 7;
pub const INCL_TIME: C2RustUnnamed_11 = 6;
pub const EXCL_ARCS: C2RustUnnamed_11 = 3;
pub const INCL_ARCS: C2RustUnnamed_11 = 2;
pub const EXCL_GRAPH: C2RustUnnamed_11 = 1;
pub const INCL_GRAPH: C2RustUnnamed_11 = 0;
#[no_mangle]
pub static mut histograms: *mut histogram = 0 as *const histogram as *mut histogram;
#[no_mangle]
pub static mut num_histograms: libc::c_uint = 0;
#[no_mangle]
pub static mut hist_scale: libc::c_double = 0.;
#[no_mangle]
pub unsafe extern "C" fn hist_read_rec(
    mut ifp: *mut FILE,
    mut filename: *const libc::c_char,
) {
    let mut lowpc: bfd_vma = 0;
    let mut highpc: bfd_vma = 0;
    let mut n_record: histogram = histogram {
        lowpc: 0,
        highpc: 0,
        num_bins: 0,
        sample: 0 as *mut libc::c_int,
    };
    let mut record: *mut histogram = 0 as *mut histogram;
    let mut existing_record: *mut histogram = 0 as *mut histogram;
    let mut i: libc::c_uint = 0;
    read_histogram_header(
        &mut n_record,
        ifp,
        filename,
        (num_histograms == 0 as libc::c_int as libc::c_uint) as libc::c_int,
    );
    existing_record = find_histogram(n_record.lowpc, n_record.highpc);
    if !existing_record.is_null() {
        record = existing_record;
    } else {
        lowpc = n_record.lowpc;
        highpc = n_record.highpc;
        hist_clip_symbol_address(&mut lowpc, &mut highpc);
        if lowpc != highpc {
            fprintf(
                stderr,
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: overlapping histogram records\n\0" as *const u8
        ...
        histograms = xrealloc(
            histograms as *mut libc::c_void,
            (::core::mem::size_of::<histogram>() as libc::c_ulong)
                .wrapping_mul(
                    num_histograms.wrapping_add(1 as libc::c_int as libc::c_uint)
                        as libc::c_ulong,
                ),
        ) as *mut histogram;
        memcpy(
            histograms.offset(num_histograms as isize) as *mut libc::c_void,
            &mut n_record as *mut histogram as *const libc::c_void,
            ::core::mem::size_of::<histogram>() as libc::c_ulong,
        );
        record = &mut *histograms.offset(num_histograms as isize) as *mut histogram;
        num_histograms = num_histograms.wrapping_add(1);
        num_histograms;
        (*record)
            .sample = xmalloc(
            ((*record).num_bins as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<libc::c_int>() as libc::c_ulong),
        ) as *mut libc::c_int;
        memset(
            (*record).sample as *mut libc::c_void,
            0 as libc::c_int,
            ((*record).num_bins as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<libc::c_int>() as libc::c_ulong),
        );
    ...
    if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
        printf(
            b"[hist_read_rec] n_lowpc 0x%lx n_highpc 0x%lx ncnt %u\n\0" as *const u8
                as *const libc::c_char,
            (*record).lowpc,
            (*record).highpc,
            (*record).num_bins,
    ...
    while i < (*record).num_bins {
        let mut count: UNIT = [0; 2];
        if fread(
            &mut *count.as_mut_ptr().offset(0 as libc::c_int as isize)
                as *mut libc::c_uchar as *mut libc::c_void,
            ::core::mem::size_of::<UNIT>() as libc::c_ulong,
        ...
        ) != 1 as libc::c_int as libc::c_ulong
        {
            fprintf(
                ...
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: %s: unexpected EOF after reading %u of %u samples\n\0"
        ...
        let ref mut fresh0 = *((*record).sample).offset(i as isize);
        *fresh0 = (*fresh0 as libc::c_ulong)
            .wrapping_add(
                (Some(
                    ((*(*core_bfd).xvec).bfd_getx16).expect("non-null function pointer"),
                ))
                    .expect(
                        "non-null function pointer",
                    )(
                    &mut *count.as_mut_ptr().offset(0 as libc::c_int as isize)
                        as *mut libc::c_uchar as *mut bfd_byte as *const libc::c_void,
                ),
            ) as libc::c_int as libc::c_int;
        if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
            printf(
                b"[hist_read_rec] 0x%lx: %u\n\0" as *const u8 as *const libc::c_char,
                ((*record).lowpc)
                    .wrapping_add(
                        (i as libc::c_ulong)
                            .wrapping_mul(
                                ((*record).highpc).wrapping_sub((*record).lowpc),
                            )
                            .wrapping_div((*record).num_bins as libc::c_ulong),
                    ),
                *((*record).sample).offset(i as isize),
            );
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn hist_write_hist(
    mut ofp: *mut FILE,
    mut filename: *const libc::c_char,
) {
    let mut count: UNIT = [0; 2];
    ...
    while r < num_histograms {
        let mut record: *mut histogram = &mut *histograms.offset(r as isize)
            as *mut histogram;
        if gmon_io_write_8(ofp, GMON_TAG_TIME_HIST as libc::c_int as libc::c_uint) != 0
            || gmon_io_write_vma(ofp, (*record).lowpc) != 0
            || gmon_io_write_vma(ofp, (*record).highpc) != 0
            || gmon_io_write_32(ofp, (*record).num_bins) != 0
            || gmon_io_write_32(ofp, hz as libc::c_uint) != 0
            || gmon_io_write(
                ofp,
                hist_dimension.as_mut_ptr(),
                15 as libc::c_int as size_t,
            ) != 0
            || gmon_io_write(ofp, &mut hist_dimension_abbrev, 1 as libc::c_int as size_t)
                != 0
        {
            perror(filename);
            done(1 as libc::c_int);
        ...
        i = 0 as libc::c_int as libc::c_uint;
        while i < (*record).num_bins {
            (Some(((*(*core_bfd).xvec).bfd_putx16).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(
                *((*record).sample).offset(i as isize) as bfd_vma,
                &mut *count.as_mut_ptr().offset(0 as libc::c_int as isize)
                    as *mut libc::c_uchar as *mut bfd_byte as *mut libc::c_void,
            );
            if fwrite(
                &mut *count.as_mut_ptr().offset(0 as libc::c_int as isize)
...
#[no_mangle]
pub unsafe extern "C" fn hist_assign_samples() {
    let mut i: libc::c_uint = 0;
    scale_and_align_entries();
    i = 0 as libc::c_int as libc::c_uint;
    while i < num_histograms {
        hist_assign_samples_1(&mut *histograms.offset(i as isize));
        i = i.wrapping_add(1);
        i;
    }
}
#[no_mangle]
pub unsafe extern "C" fn hist_print() {
    let mut time_sorted_syms: *mut *mut Sym = 0 as *mut *mut Sym;
    let mut top_dog: *mut Sym = 0 as *mut Sym;
    let mut sym: *mut Sym = 0 as *mut Sym;
    let mut sym_index: libc::c_uint = 0;
    let mut log_scale: libc::c_uint = 0;
    let mut top_time: libc::c_double = 0.;
    ...
    while sym_index < symtab.len {
        let ref mut fresh1 = *time_sorted_syms.offset(sym_index as isize);
    ...
    if bsd_style_output {
        log_scale = 5 as libc::c_int as libc::c_uint;
    } else {
        log_scale = 0 as libc::c_int as libc::c_uint;
        top_dog = 0 as *mut Sym;
        top_time = 0.0f64;
        sym_index = 0 as libc::c_int as libc::c_uint;
        while sym_index < symtab.len {
            sym = *time_sorted_syms.offset(sym_index as isize);
            if (*sym).ncalls != 0 as libc::c_int as libc::c_ulong {
                let mut call_time: libc::c_double = 0.;
                call_time = ((*sym).hist.time + (*sym).cg.child_time)
                    / (*sym).ncalls as libc::c_double;
        ...
        if !top_dog.is_null() && (*top_dog).ncalls != 0 as libc::c_int as libc::c_ulong
            && top_time > 0.0f64
        {
            top_time /= hz as libc::c_double;
            log_scale = 0 as libc::c_int as libc::c_uint;
            while (log_scale as libc::c_ulong)
                < (::core::mem::size_of::<[C2RustUnnamed_10; 11]>() as libc::c_ulong)
                    .wrapping_div(
                        ::core::mem::size_of::<C2RustUnnamed_10>() as libc::c_ulong,
                    )
            {
                let mut scaled_value: libc::c_double = SItab[log_scale as usize].scale
                    * top_time;
                if scaled_value >= 1.0f64 && scaled_value < 1000.0f64 {
                    break;
                }
                log_scale = log_scale.wrapping_add(1);
                log_scale;
            }
        }
    }
    print_header(SItab[log_scale as usize].prefix as libc::c_int);
    sym_index = 0 as libc::c_int as libc::c_uint;
    while sym_index < symtab.len {
        addr = (**time_sorted_syms.offset(sym_index as isize)).addr;
        if !(sym_lookup(
            &mut *syms.as_mut_ptr().offset(INCL_FLAT as libc::c_int as isize),
            addr,
        ))
            .is_null()
            || syms[INCL_FLAT as libc::c_int as usize].len
                == 0 as libc::c_int as libc::c_uint
                && (sym_lookup(
                    &mut *syms.as_mut_ptr().offset(EXCL_FLAT as libc::c_int as isize),
                    addr,
                ))
                    .is_null()
        {
            print_line(
                *time_sorted_syms.offset(sym_index as isize),
                SItab[log_scale as usize].scale,
            );
        }
        sym_index = sym_index.wrapping_add(1);
        sym_index;
    }
    free(time_sorted_syms as *mut libc::c_void);
    if print_descriptions as libc::c_int != 0 && !bsd_style_output {
        flat_blurb(stdout);
    }
}
#[no_mangle]
pub unsafe extern "C" fn hist_check_address(mut address: libc::c_uint) -> libc::c_int {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < num_histograms {
        if (*histograms.offset(i as isize)).lowpc <= address as libc::c_ulong
            && (address as libc::c_ulong) < (*histograms.offset(i as isize)).highpc
        {
...
#[no_mangle]
pub unsafe extern "C" fn hist_clip_symbol_address(
    mut p_lowpc: *mut bfd_vma,
    mut p_highpc: *mut bfd_vma,
) {
    let mut i: libc::c_uint = 0;
    let mut found: libc::c_int = 0 as libc::c_int;
    if num_histograms == 0 as libc::c_int as libc::c_uint {
        *p_highpc = *p_lowpc;
        return;
    }
    i = 0 as libc::c_int as libc::c_uint;
    while i < num_histograms {
        let mut common_low: bfd_vma = 0;
        let mut common_high: bfd_vma = 0;
        common_low = if (*histograms.offset(i as isize)).lowpc > *p_lowpc {
            (*histograms.offset(i as isize)).lowpc
        } else {
            *p_lowpc
        };
        common_high = if (*histograms.offset(i as isize)).highpc < *p_highpc {
            (*histograms.offset(i as isize)).highpc
        } else {
            *p_highpc
        };
        if common_low < common_high {
            if found != 0 {
                fprintf(
                    ...
                    dcgettext(
                        b"gprof\0" as *const u8 as *const libc::c_char,
                        b"%s: found a symbol that covers several histogram records\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    whoami,
...
unsafe extern "C" fn scale_and_align_entries() {
    let mut sym: *mut Sym = 0 as *mut Sym;
    let mut bin_of_entry: bfd_vma = 0;
    let mut bin_of_code: bfd_vma = 0;
    sym = symtab.base;
    while sym < symtab.limit {
        let mut r: *mut histogram = find_histogram_for_pc((*sym).addr);
        (*sym)
            .hist
            .scaled_addr = ((*sym).addr)
            .wrapping_div(::core::mem::size_of::<UNIT>() as libc::c_ulong);
        if !r.is_null() {
            bin_of_entry = (((*sym).hist.scaled_addr).wrapping_sub((*r).lowpc)
                as libc::c_double / hist_scale) as bfd_vma;
            bin_of_code = (((*sym).hist.scaled_addr)
                .wrapping_add(
                    (offset_to_code as libc::c_ulong)
                        .wrapping_div(::core::mem::size_of::<UNIT>() as libc::c_ulong),
                )
                .wrapping_sub((*r).lowpc) as libc::c_double / hist_scale) as bfd_vma;
            if bin_of_entry < bin_of_code {
                if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
                    printf(
                        b"[scale_and_align_entries] pushing 0x%lx to 0x%lx\n\0"
                            as *const u8 as *const libc::c_char,
                ...
                (*sym)
                    .hist
                    .scaled_addr = ((*sym).hist.scaled_addr as libc::c_ulong)
                    .wrapping_add(
                        (offset_to_code as libc::c_ulong)
                            .wrapping_div(
                                ::core::mem::size_of::<UNIT>() as libc::c_ulong,
...
unsafe extern "C" fn print_header(mut prefix: libc::c_int) {
    let mut unit: [libc::c_char; 64] = [0; 64];
    sprintf(
        unit.as_mut_ptr(),
        dcgettext(
            b"gprof\0" as *const u8 as *const libc::c_char,
            b"%c%c/call\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        prefix,
        hist_dimension_abbrev as libc::c_int,
    );
    if bsd_style_output {
        printf(
            dcgettext(
        ...
        if total_time > 0.0f64 {
            printf(
                ...
                100.0f64 / total_time,
                total_time / hz as libc::c_double,
                hist_dimension.as_mut_ptr(),
            );
        }
    } else {
    ...
    printf(
        b"%5.5s %10.10s %8.8s %8.8s %8.8s %8.8s  %-8.8s\n\0" as *const u8
            as *const libc::c_char,
        b"%  \0" as *const u8 as *const libc::c_char,
        dcgettext(
            b"gprof\0" as *const u8 as *const libc::c_char,
            b"cumulative\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        dcgettext(
            b"gprof\0" as *const u8 as *const libc::c_char,
    ...
    printf(
        b"%5.5s %9.9s  %8.8s %8.8s %8.8s %8.8s  %-8.8s\n\0" as *const u8
            as *const libc::c_char,
        dcgettext(
            b"gprof\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn print_line(mut sym: *mut Sym, mut scale: libc::c_double) {
    if ignore_zeros as libc::c_int != 0
        && (*sym).ncalls == 0 as libc::c_int as libc::c_ulong
        && (*sym).hist.time == 0 as libc::c_int as libc::c_double
    {
        return;
    }
    ...
    if bsd_style_output {
        printf(
            b"%5.1f %10.2f %8.2f\0" as *const u8 as *const libc::c_char,
            if total_time > 0.0f64 {
                100 as libc::c_int as libc::c_double * (*sym).hist.time / total_time
            } else {
                0.0f64
            },
            accum_time / hz as libc::c_double,
            (*sym).hist.time / hz as libc::c_double,
        );
    } else {
        printf(
            b"%6.2f %9.2f %8.2f\0" as *const u8 as *const libc::c_char,
            if total_time > 0.0f64 {
                100 as libc::c_int as libc::c_double * (*sym).hist.time / total_time
            } else {
                0.0f64
    ...
    if (*sym).ncalls != 0 as libc::c_int as libc::c_ulong {
        printf(
            b" %8lu %8.2f %8.2f  \0" as *const u8 as *const libc::c_char,
            (*sym).ncalls,
            scale * (*sym).hist.time / hz as libc::c_double
                / (*sym).ncalls as libc::c_double,
            scale * ((*sym).hist.time + (*sym).cg.child_time) / hz as libc::c_double
                / (*sym).ncalls as libc::c_double,
        );
    } else {
        printf(
            b" %8.8s %8.8s %8.8s  \0" as *const u8 as *const libc::c_char,
            b"\0" as *const u8 as *const libc::c_char,
            b"\0" as *const u8 as *const libc::c_char,
            b"\0" as *const u8 as *const libc::c_char,
        );
...
unsafe extern "C" fn find_histogram(
    mut lowpc: bfd_vma,
    mut highpc: bfd_vma,
) -> *mut histogram {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < num_histograms {
        if (*histograms.offset(i as isize)).lowpc == lowpc
            && (*histograms.offset(i as isize)).highpc == highpc
        {
            return &mut *histograms.offset(i as isize) as *mut histogram;
        }
        i = i.wrapping_add(1);
        i;
    }
    return 0 as *mut histogram;
}
unsafe extern "C" fn find_histogram_for_pc(mut pc: bfd_vma) -> *mut histogram {
    let mut i: libc::c_uint = 0;
    i = 0 as libc::c_int as libc::c_uint;
    while i < num_histograms {
        if (*histograms.offset(i as isize)).lowpc <= pc
            && pc < (*histograms.offset(i as isize)).highpc
        {
            return &mut *histograms.offset(i as isize) as *mut histogram;
        }
        i = i.wrapping_add(1);
...
static mut hist_dimension: [libc::c_char; 16] = unsafe {
    *::core::mem::transmute::<
        &[u8; 16],
        &mut [libc::c_char; 16],
    >(b"seconds\0\0\0\0\0\0\0\0\0")
};
static mut hist_dimension_abbrev: libc::c_char = 's' as i32 as libc::c_char;
static mut accum_time: libc::c_double = 0.;
static mut total_time: libc::c_double = 0.;
#[no_mangle]
pub static mut SItab: [C2RustUnnamed_10; 11] = [
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'T' as i32 as libc::c_char,
            scale: 1e-12f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'G' as i32 as libc::c_char,
            scale: 1e-09f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'M' as i32 as libc::c_char,
            scale: 1e-06f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'K' as i32 as libc::c_char,
            scale: 1e-03f64,
        };
        init
    },
    ...
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'u' as i32 as libc::c_char,
            scale: 1e+06f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'n' as i32 as libc::c_char,
            scale: 1e+09f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'p' as i32 as libc::c_char,
            scale: 1e+12f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'f' as i32 as libc::c_char,
            scale: 1e+15f64,
        };
        init
    },
    {
        let mut init = C2RustUnnamed_10 {
            prefix: 'a' as i32 as libc::c_char,
            scale: 1e+18f64,
        };
        init
    },
];
unsafe extern "C" fn read_histogram_header(
    mut record: *mut histogram,
    mut ifp: *mut FILE,
    mut filename: *const libc::c_char,
    mut first: libc::c_int,
) {
    let mut profrate: libc::c_uint = 0;
    let mut n_hist_dimension: [libc::c_char; 15] = [0; 15];
    let mut n_hist_dimension_abbrev: libc::c_char = 0;
    let mut n_hist_scale: libc::c_double = 0.;
    if gmon_io_read_vma(ifp, &mut (*record).lowpc) != 0
        || gmon_io_read_vma(ifp, &mut (*record).highpc) != 0
        || gmon_io_read_32(ifp, &mut (*record).num_bins) != 0
        || gmon_io_read_32(ifp, &mut profrate) != 0
        || gmon_io_read(ifp, n_hist_dimension.as_mut_ptr(), 15 as libc::c_int as size_t)
            != 0
        || gmon_io_read(ifp, &mut n_hist_dimension_abbrev, 1 as libc::c_int as size_t)
            != 0
    {
        fprintf(
            stderr,
    ...
    n_hist_scale = ((*record).highpc)
        .wrapping_sub((*record).lowpc)
        .wrapping_div(::core::mem::size_of::<UNIT>() as libc::c_ulong) as libc::c_double
        / (*record).num_bins as libc::c_double;
    if first != 0 {
        hz = profrate as libc::c_long;
        memcpy(
            hist_dimension.as_mut_ptr() as *mut libc::c_void,
            n_hist_dimension.as_mut_ptr() as *const libc::c_void,
        ...
        ) != 0 as libc::c_int
        {
            fprintf(
                ...
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: dimension unit changed between histogram records\n%s: from '%s'\n%s: to '%s'\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
        ...
        if n_hist_dimension_abbrev as libc::c_int != hist_dimension_abbrev as libc::c_int
        {
            fprintf(
                stderr,
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: dimension abbreviation changed between histogram records\n%s: from '%c'\n%s: to '%c'\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
                ...
                hist_dimension_abbrev as libc::c_int,
                whoami,
                n_hist_dimension_abbrev as libc::c_int,
            );
            done(1 as libc::c_int);
        }
        if fabs(hist_scale - n_hist_scale) > 0.000001f64 {
            fprintf(
                stderr,
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: different scales in histogram records\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
...
unsafe extern "C" fn hist_assign_samples_1(mut r: *mut histogram) {
    let mut bin_low_pc: bfd_vma = 0;
    let mut bin_high_pc: bfd_vma = 0;
    let mut sym_low_pc: bfd_vma = 0;
    let mut sym_high_pc: bfd_vma = 0;
    let mut overlap: bfd_vma = 0;
    let mut addr: bfd_vma = 0;
    let mut bin_count: libc::c_uint = 0;
    let mut i: libc::c_uint = 0;
    let mut j: libc::c_uint = 0;
    let mut k: libc::c_uint = 0;
    let mut count_time: libc::c_double = 0.;
    let mut credit: libc::c_double = 0.;
    let mut lowpc: bfd_vma = ((*r).lowpc)
        .wrapping_div(::core::mem::size_of::<UNIT>() as libc::c_ulong);
    i = 0 as libc::c_int as libc::c_uint;
    k = 1 as libc::c_int as libc::c_uint;
    while i < (*r).num_bins {
        bin_count = *((*r).sample).offset(i as isize) as libc::c_uint;
        if !(bin_count == 0) {
            bin_low_pc = lowpc
                .wrapping_add((hist_scale * i as libc::c_double) as bfd_vma);
            bin_high_pc = lowpc
                .wrapping_add(
                    (hist_scale
                        * i.wrapping_add(1 as libc::c_int as libc::c_uint)
                            as libc::c_double) as bfd_vma,
                );
            count_time = bin_count as libc::c_double;
            if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
                printf(
                    b"[assign_samples] bin_low_pc=0x%lx, bin_high_pc=0x%lx, bin_count=%u\n\0"
                        as *const u8 as *const libc::c_char,
                    (::core::mem::size_of::<UNIT>() as libc::c_ulong)
                        .wrapping_mul(bin_low_pc),
                    (::core::mem::size_of::<UNIT>() as libc::c_ulong)
                        .wrapping_mul(bin_high_pc),
                    bin_count,
                );
            }
            total_time += count_time;
            j = k.wrapping_sub(1 as libc::c_int as libc::c_uint);
            while j < symtab.len {
                sym_low_pc = (*(symtab.base).offset(j as isize)).hist.scaled_addr;
                sym_high_pc = (*(symtab.base)
                ...
                if !(bin_low_pc >= sym_high_pc) {
                    overlap = (if bin_high_pc < sym_high_pc {
                        bin_high_pc
                    } else {
                        sym_high_pc
                    })
                    ...
                    if overlap > 0 as libc::c_int as libc::c_ulong {
                        if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
                            printf(
                                b"[assign_samples] [0x%lx,0x%lx) %s gets %f ticks %ld overlap\n\0"
                                    as *const u8 as *const libc::c_char,
                                (*(symtab.base).offset(j as isize)).addr,
                                (::core::mem::size_of::<UNIT>() as libc::c_ulong)
                                    .wrapping_mul(sym_high_pc),
                                (*(symtab.base).offset(j as isize)).name,
                                overlap as libc::c_double * count_time / hist_scale,
                                overlap as libc::c_long,
                            );
                        }
                        addr = (*(symtab.base).offset(j as isize)).addr;
                        credit = overlap as libc::c_double * count_time / hist_scale;
                        if !(sym_lookup(
                            &mut *syms
                                .as_mut_ptr()
                                .offset(INCL_FLAT as libc::c_int as isize),
                            addr,
                        ))
                            .is_null()
                            || syms[INCL_FLAT as libc::c_int as usize].len
                                ...
                                && (sym_lookup(
                                    &mut *syms
                                        .as_mut_ptr()
                                        .offset(EXCL_FLAT as libc::c_int as isize),
                                    addr,
                                ))
                                    .is_null()
                        {
                            (*(symtab.base).offset(j as isize)).hist.time += credit;
                        } else {
                            total_time -= credit;
                        }
                    }
