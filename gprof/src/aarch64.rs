...
#[no_mangle]
pub unsafe extern "C" fn aarch64_find_call(
    mut parent: *mut Sym,
    mut p_lowpc: bfd_vma,
    ...
    while pc < p_highpc {
        ...
        if insn & 0x7c000000 as libc::c_int as libc::c_uint
            == 0x14000000 as libc::c_int as libc::c_uint
        {
            if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                printf(
                    b"[find_call] 0x%lx: bl\0" as *const u8 as *const libc::c_char,
                    pc,
                );
            }
            offset = (insn as bfd_vma & 0x3ffffff as libc::c_int as libc::c_ulong
                ^ 0x2000000 as libc::c_int as libc::c_ulong)
                .wrapping_sub(0x2000000 as libc::c_int as libc::c_ulong)
                << 2 as libc::c_int;
            dest_pc = pc.wrapping_add(offset);
            if hist_check_address(dest_pc as libc::c_uint) != 0 {
                ...
                if !child.is_null() {
                    ...
                    if (*child).addr == dest_pc {
                        ...
                        current_block_21 = 12124785117276362961;
                    }
                } else {
                    current_block_21 = 12124785117276362961;
                }
