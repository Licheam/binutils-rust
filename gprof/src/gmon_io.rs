extern "C" {
    ...
    fn bfd_get_sign_extend_vma(abfd: *mut bfd) -> libc::c_int;
    static mut whoami: *const libc::c_char;
    static mut hz: libc::c_long;
    static mut debug_level: libc::c_int;
    static mut output_style: libc::c_int;
    static mut file_format: File_Format;
    static mut first_output: bool;
    fn done(status: libc::c_int) -> !;
    static mut symtab: Sym_Table;
    fn bb_read_rec(_: *mut FILE, _: *const libc::c_char);
    fn bb_write_blocks(_: *mut FILE, _: *const libc::c_char);
    static mut core_bfd: *mut bfd;
    fn cg_tally(_: bfd_vma, _: bfd_vma, _: libc::c_ulong);
    fn cg_read_rec(_: *mut FILE, _: *const libc::c_char);
    fn cg_write_arcs(_: *mut FILE, _: *const libc::c_char);
    fn hertz() -> libc::c_int;
    static mut histograms: *mut histogram;
    static mut num_histograms: libc::c_uint;
    static mut hist_scale: libc::c_double;
    fn hist_read_rec(_: *mut FILE, _: *const libc::c_char);
    fn hist_write_hist(_: *mut FILE, _: *const libc::c_char);
...
pub const FF_PROF: File_Format = 4;
pub const FF_BSD44: File_Format = 3;
pub const FF_BSD: File_Format = 2;
pub const FF_MAGIC: File_Format = 1;
pub const FF_AUTO: File_Format = 0;
...
pub type Arc = arc;
pub const ptr_signed: gmon_ptr_signedness = 0;
pub type gmon_ptr_signedness = libc::c_uint;
pub const ptr_unsigned: gmon_ptr_signedness = 1;
pub const ptr_64bit: gmon_ptr_size = 1;
pub const ptr_32bit: gmon_ptr_size = 0;
pub type gmon_ptr_size = libc::c_uint;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[repr(C)]
pub struct gmon_hdr {
    pub cookie: [libc::c_char; 4],
    pub version: [libc::c_char; 4],
    pub spare: [libc::c_char; 12],
}
pub type C2RustUnnamed_9 = libc::c_uint;
#[no_mangle]
pub static mut gmon_input: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut gmon_file_version: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn gmon_io_read_vma(
    mut ifp: *mut FILE,
    mut valp: *mut bfd_vma,
) -> libc::c_int {
    let mut val32: libc::c_uint = 0;
    let mut val64: libc::c_ulong = 0;
    match gmon_get_ptr_size() as libc::c_uint {
        0 => {
            if gmon_io_read_32(ifp, &mut val32) != 0 {
                return 1 as libc::c_int;
            }
            if gmon_get_ptr_signedness() as libc::c_uint
                == ptr_signed as libc::c_int as libc::c_uint
            {
                *valp = val32 as libc::c_int as bfd_vma;
            } else {
                *valp = val32 as bfd_vma;
            }
        }
        1 => {
            if gmon_io_read_64(ifp, &mut val64) != 0 {
                return 1 as libc::c_int;
            }
            if gmon_get_ptr_signedness() as libc::c_uint
                == ptr_signed as libc::c_int as libc::c_uint
            {
                *valp = val64 as libc::c_long as bfd_vma;
            } else {
                *valp = val64;
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn gmon_io_read_32(
    mut ifp: *mut FILE,
    mut valp: *mut libc::c_uint,
) -> libc::c_int {
    ...
    *valp = (Some(((*(*core_bfd).xvec).bfd_getx32).expect("non-null function pointer")))
        .expect("non-null function pointer")(buf.as_mut_ptr() as *const libc::c_void)
        as libc::c_uint;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn gmon_io_read(
    mut ifp: *mut FILE,
    mut buf: *mut libc::c_char,
    mut n: size_t,
) -> libc::c_int {
    if fread(buf as *mut libc::c_void, 1 as libc::c_int as libc::c_ulong, n, ifp) != n {
        return 1 as libc::c_int;
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn gmon_io_write_vma(
    mut ofp: *mut FILE,
    mut val: bfd_vma,
) -> libc::c_int {
    match gmon_get_ptr_size() as libc::c_uint {
        0 => {
            if gmon_io_write_32(ofp, val as libc::c_uint) != 0 {
                return 1 as libc::c_int;
            }
        }
        1 => {
            if gmon_io_write_64(ofp, val) != 0 {
                return 1 as libc::c_int;
            }
        }
        _ => {}
...
#[no_mangle]
pub unsafe extern "C" fn gmon_io_write_32(
    mut ofp: *mut FILE,
    mut val: libc::c_uint,
) -> libc::c_int {
    let mut buf: [libc::c_char; 4] = [0; 4];
    (Some(((*(*core_bfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(val as bfd_vma, buf.as_mut_ptr() as *mut libc::c_void);
    if fwrite(
...
#[no_mangle]
pub unsafe extern "C" fn gmon_io_write_8(
    mut ofp: *mut FILE,
    mut val: libc::c_uint,
) -> libc::c_int {
    let mut buf: [libc::c_char; 1] = [0; 1];
    *(buf.as_mut_ptr()
        as *mut libc::c_uchar) = (val & 0xff as libc::c_int as libc::c_uint)
        as libc::c_uchar;
    if fwrite(
        buf.as_mut_ptr() as *const libc::c_void,
        1 as libc::c_int as libc::c_ulong,
...
#[no_mangle]
pub unsafe extern "C" fn gmon_io_write(
    mut ofp: *mut FILE,
    mut buf: *mut libc::c_char,
    mut n: size_t,
) -> libc::c_int {
    if fwrite(buf as *const libc::c_void, 1 as libc::c_int as libc::c_ulong, n, ofp) != n
    {
        return 1 as libc::c_int;
    }
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn gmon_out_read(mut filename: *const libc::c_char) {
    let mut current_block: u64;
    let mut ifp: *mut FILE = 0 as *mut FILE;
    let mut ghdr: gmon_hdr = gmon_hdr {
        cookie: [0; 4],
        version: [0; 4],
        spare: [0; 12],
    };
    let mut tag: libc::c_uchar = 0;
    let mut nhist: libc::c_int = 0 as libc::c_int;
    let mut narcs: libc::c_int = 0 as libc::c_int;
    let mut nbbs: libc::c_int = 0 as libc::c_int;
    if strcmp(filename, b"-\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int {
        ifp = stdin;
    } else {
        ifp = fopen(filename, b"r\0" as *const u8 as *const libc::c_char);
        if ifp.is_null() {
            perror(filename);
    ...
    if fread(
        &mut ghdr as *mut gmon_hdr as *mut libc::c_void,
        ::core::mem::size_of::<gmon_hdr>() as libc::c_ulong,
        1 as libc::c_int as libc::c_ulong,
        ifp,
    ) != 1 as libc::c_int as libc::c_ulong
    {
        fprintf(
            ...
            dcgettext(
                ...
                b"%s: file too short to be a gmon file\n\0" as *const u8
    ...
    if file_format as libc::c_uint == FF_MAGIC as libc::c_int as libc::c_uint
        || file_format as libc::c_uint == FF_AUTO as libc::c_int as libc::c_uint
            && strncmp(
                &mut *(ghdr.cookie).as_mut_ptr().offset(0 as libc::c_int as isize),
                b"gmon\0" as *const u8 as *const libc::c_char,
                4 as libc::c_int as libc::c_ulong,
            ) == 0
    {
        if file_format as libc::c_uint == FF_MAGIC as libc::c_int as libc::c_uint
            ...
            ) != 0
        {
            fprintf(
                ...
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: file `%s' has bad magic cookie\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
        ...
        gmon_file_version = (Some(
            ((*(*core_bfd).xvec).bfd_getx32).expect("non-null function pointer"),
        ))
            .expect(
                "non-null function pointer",
            )((ghdr.version).as_mut_ptr() as *mut bfd_byte as *const libc::c_void)
            as libc::c_int;
        if gmon_file_version != 1 as libc::c_int && gmon_file_version != 0 as libc::c_int
        {
            fprintf(
                stderr,
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: file `%s' has unsupported version %d\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
        ...
        while fread(
            &mut tag as *mut libc::c_uchar as *mut libc::c_void,
        ...
        ) == 1 as libc::c_int as libc::c_ulong
        {
            match tag as libc::c_int {
                0 => {
                    nhist += 1;
                    nhist;
                    gmon_input |= (1 as libc::c_int) << 0 as libc::c_int;
                    hist_read_rec(ifp, filename);
                }
                1 => {
                    narcs += 1;
                    narcs;
                    gmon_input |= (1 as libc::c_int) << 1 as libc::c_int;
                    cg_read_rec(ifp, filename);
                }
                2 => {
                    nbbs += 1;
                    nbbs;
                    gmon_input |= (1 as libc::c_int) << 2 as libc::c_int;
                ...
                _ => {
                    fprintf(
                        ...
                        dcgettext(
                            b"gprof\0" as *const u8 as *const libc::c_char,
                            b"%s: %s: found bad tag %d (file corrupted?)\n\0"
    ...
    } else if file_format as libc::c_uint == FF_AUTO as libc::c_int as libc::c_uint
        || file_format as libc::c_uint == FF_BSD as libc::c_int as libc::c_uint
        || file_format as libc::c_uint == FF_BSD44 as libc::c_int as libc::c_uint
    {
        let mut i: libc::c_uint = 0;
        let mut samp_bytes: libc::c_int = 0;
        let mut header_size: libc::c_int = 0 as libc::c_int;
        let mut count: libc::c_ulong = 0;
        let mut from_pc: bfd_vma = 0;
        let mut self_pc: bfd_vma = 0;
        let mut raw_bin_count: UNIT = [0; 2];
        let mut tmp: hdr = hdr {
            low_pc: 0,
            high_pc: 0,
            ncnt: 0,
        ...
        let mut hist_num_bins: libc::c_uint = 0;
        gmon_input = (1 as libc::c_int) << 0 as libc::c_int
            | (1 as libc::c_int) << 1 as libc::c_int;
        if fseek(ifp, 0 as libc::c_int as libc::c_long, 0 as libc::c_int)
            < 0 as libc::c_int
        {
            perror(filename);
            done(1 as libc::c_int);
        }
        if gmon_io_read_vma(ifp, &mut tmp.low_pc) != 0
            || gmon_io_read_vma(ifp, &mut tmp.high_pc) != 0
            || gmon_io_read_32(ifp, &mut tmp.ncnt) != 0
        {
            current_block = 6818991070797048005;
        } else if gmon_io_read_32(ifp, &mut version) != 0 {
            current_block = 6818991070797048005;
        } else {
            if version == 0x51879 as libc::c_int as libc::c_uint {
                let mut profrate: libc::c_uint = 0;
                if gmon_io_read_32(ifp, &mut profrate) != 0 {
                    current_block = 6818991070797048005;
                } else {
                    if histograms.is_null() {
                        hz = profrate as libc::c_long;
                    } else if hz != profrate as libc::c_int as libc::c_long {
                        fprintf(
                            stderr,
                            dcgettext(
                                b"gprof\0" as *const u8 as *const libc::c_char,
                                b"%s: profiling rate incompatible with first gmon file\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            filename,
                    ...
                    match gmon_get_ptr_size() as libc::c_uint {
                        0 => {
                            header_size = 4 as libc::c_int + 4 as libc::c_int
                                + 4 as libc::c_int + 4 as libc::c_int + 4 as libc::c_int
                                + 3 as libc::c_int * 4 as libc::c_int;
                        }
                        1 => {
                            header_size = 8 as libc::c_int + 8 as libc::c_int
                                + 4 as libc::c_int + 4 as libc::c_int + 4 as libc::c_int
                                + 3 as libc::c_int * 4 as libc::c_int;
                        }
                        _ => {}
                ...
                if file_format as libc::c_uint == FF_BSD44 as libc::c_int as libc::c_uint
                {
                    fprintf(
                        stderr,
                        dcgettext(
            ...
            match current_block {
                6818991070797048005 => {}
                _ => {
                    if fseek(ifp, header_size as libc::c_long, 0 as libc::c_int)
                        < 0 as libc::c_int
                    {
                        perror(filename);
                        done(1 as libc::c_int);
                    }
                    samp_bytes = (tmp.ncnt).wrapping_sub(header_size as libc::c_uint)
                        as libc::c_int;
                    hist_num_bins = (samp_bytes as libc::c_ulong)
                        .wrapping_div(::core::mem::size_of::<UNIT>() as libc::c_ulong)
                        as libc::c_uint;
                    if !histograms.is_null()
                        && (tmp.low_pc != (*histograms).lowpc
                            ...
                            || hist_num_bins != (*histograms).num_bins)
                    {
                        fprintf(
                            ...
                            dcgettext(
                                b"gprof\0" as *const u8 as *const libc::c_char,
                                b"%s: incompatible with first gmon file\n\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            filename,
                    ...
                    if histograms.is_null() {
                        num_histograms = 1 as libc::c_int as libc::c_uint;
                        histograms = xmalloc(
                        ...
                        hist_scale = (tmp.high_pc)
                            .wrapping_sub(tmp.low_pc)
                            .wrapping_div(
                                ::core::mem::size_of::<UNIT>() as libc::c_ulong,
                            ) as libc::c_double / hist_num_bins as libc::c_double;
                        (*histograms)
                            .sample = xmalloc(
                            (hist_num_bins as libc::c_ulong)
                                .wrapping_mul(
                                    ::core::mem::size_of::<libc::c_int>() as libc::c_ulong,
                                ),
                        ) as *mut libc::c_int;
                        memset(
                            (*histograms).sample as *mut libc::c_void,
                            0 as libc::c_int,
                            (hist_num_bins as libc::c_ulong)
                                .wrapping_mul(
                                    ::core::mem::size_of::<libc::c_int>() as libc::c_ulong,
                    ...
                    if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
                        printf(
                            b"[gmon_out_read] lowpc 0x%lx highpc 0x%lx ncnt %d\n\0"
                                as *const u8 as *const libc::c_char,
                            tmp.low_pc,
                            tmp.high_pc,
                            tmp.ncnt,
                        ...
                        printf(
                            b"[gmon_out_read] samp_bytes %d hist_num_bins %d\n\0"
                                as *const u8 as *const libc::c_char,
                            samp_bytes,
                            hist_num_bins,
                        );
                    }
                    if samp_bytes < 0 as libc::c_int
                        || (*histograms).lowpc > (*histograms).highpc
                    {
                        fprintf(
                            stderr,
                            dcgettext(
                                b"gprof\0" as *const u8 as *const libc::c_char,
                                b"%s: file '%s' does not appear to be in gmon.out format\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            whoami,
                    ...
                    while i < hist_num_bins {
                        if fread(
                            raw_bin_count.as_mut_ptr() as *mut libc::c_void,
                            ::core::mem::size_of::<UNIT>() as libc::c_ulong,
                            1 as libc::c_int as libc::c_ulong,
                            ifp,
                        ) != 1 as libc::c_int as libc::c_ulong
                        {
                            ...
                            fprintf(
                                ...
                                dcgettext(
                                    b"gprof\0" as *const u8 as *const libc::c_char,
                                    b"%s: unexpected EOF after reading %d/%d bins\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                whoami,
                        ...
                        let ref mut fresh0 = *((*histograms).sample).offset(i as isize);
                        *fresh0 = (*fresh0 as libc::c_ulong)
                            .wrapping_add(
                                (Some(
                                    ((*(*core_bfd).xvec).bfd_getx16)
                                        .expect("non-null function pointer"),
                                ))
                                    .expect(
                                        "non-null function pointer",
                                    )(
                                    raw_bin_count.as_mut_ptr() as *mut bfd_byte
                    ...
                    while gmon_read_raw_arc(ifp, &mut from_pc, &mut self_pc, &mut count)
                        == 0 as libc::c_int
                    {
                        narcs += 1;
                        narcs;
                        if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
                            printf(
                                b"[gmon_out_read] frompc 0x%lx selfpc 0x%lx count %lu\n\0"
                                    as *const u8 as *const libc::c_char,
                                from_pc,
                                self_pc,
                                count,
                    ...
                    if hz == 0 as libc::c_int as libc::c_long {
                        hz = hertz() as libc::c_long;
                        if hz == 0 as libc::c_int as libc::c_long {
                            hz = 1 as libc::c_int as libc::c_long;
                            fprintf(
                                stderr,
                                dcgettext(
                                    b"gprof\0" as *const u8 as *const libc::c_char,
                                    b"time is in ticks, not seconds\n\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                            );
        ...
        fprintf(
            ...
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"%s: don't know how to deal with file format %d\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            whoami,
            file_format as libc::c_uint,
        );
        done(1 as libc::c_int);
    }
    if ifp != stdin {
    ...
    if output_style & (1 as libc::c_int) << 5 as libc::c_int != 0 {
        printf(
            dcgettext(
                b"gprof\0" as *const u8 as *const libc::c_char,
                b"File `%s' (version %d) contains:\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            filename,
        ...
        printf(
            if nhist == 1 as libc::c_int {
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"\t%d histogram record\n\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            } else {
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"\t%d histogram records\n\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            },
            nhist,
        ...
        printf(
            if narcs == 1 as libc::c_int {
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"\t%d call-graph record\n\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            } else {
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"\t%d call-graph records\n\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            },
            narcs,
        ...
        printf(
            if nbbs == 1 as libc::c_int {
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"\t%d basic-block count record\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                )
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn gmon_out_write(mut filename: *const libc::c_char) {
    ...
    ofp = fopen(filename, b"w\0" as *const u8 as *const libc::c_char);
    if ofp.is_null() {
        perror(filename);
        done(1 as libc::c_int);
    }
    if file_format as libc::c_uint == FF_AUTO as libc::c_int as libc::c_uint
        || file_format as libc::c_uint == FF_MAGIC as libc::c_int as libc::c_uint
    {
        memcpy(
            &mut *(ghdr.cookie).as_mut_ptr().offset(0 as libc::c_int as isize)
                as *mut libc::c_char as *mut libc::c_void,
            b"gmon\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        );
        (Some(((*(*core_bfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
            ...
            (ghdr.version).as_mut_ptr() as *mut bfd_byte as *mut libc::c_void,
        );
        if fwrite(
            &mut ghdr as *mut gmon_hdr as *const libc::c_void,
            ::core::mem::size_of::<gmon_hdr>() as libc::c_ulong,
            1 as libc::c_int as libc::c_ulong,
            ofp,
        ) != 1 as libc::c_int as libc::c_ulong
        ...
        if gmon_input & (1 as libc::c_int) << 0 as libc::c_int != 0 {
            hist_write_hist(ofp, filename);
        }
        if gmon_input & (1 as libc::c_int) << 1 as libc::c_int != 0 {
            cg_write_arcs(ofp, filename);
        }
        if gmon_input & (1 as libc::c_int) << 2 as libc::c_int != 0 {
            bb_write_blocks(ofp, filename);
        }
    } else if file_format as libc::c_uint == FF_BSD as libc::c_int as libc::c_uint
        || file_format as libc::c_uint == FF_BSD44 as libc::c_int as libc::c_uint
    {
        let mut raw_bin_count: UNIT = [0; 2];
        let mut i: libc::c_uint = 0;
        let mut hdrsize: libc::c_uint = 0;
        let mut padsize: libc::c_uint = 0;
        let mut pad: [libc::c_char; 12] = [0; 12];
        let mut arc: *mut Arc = 0 as *mut Arc;
        let mut sym: *mut Sym = 0 as *mut Sym;
        memset(
            pad.as_mut_ptr() as *mut libc::c_void,
            0 as libc::c_int,
            ::core::mem::size_of::<[libc::c_char; 12]>() as libc::c_ulong,
        );
        hdrsize = 0 as libc::c_int as libc::c_uint;
        if file_format as libc::c_uint == FF_BSD44 as libc::c_int as libc::c_uint
            || hz != hertz() as libc::c_long
        {
            padsize = (3 as libc::c_int * 4 as libc::c_int) as libc::c_uint;
            match gmon_get_ptr_size() as libc::c_uint {
                0 => {
                    hdrsize = (4 as libc::c_int + 4 as libc::c_int + 4 as libc::c_int
                        + 4 as libc::c_int + 4 as libc::c_int
                        + 3 as libc::c_int * 4 as libc::c_int) as libc::c_uint;
                }
                1 => {
                    hdrsize = (8 as libc::c_int + 8 as libc::c_int + 4 as libc::c_int
                        + 4 as libc::c_int + 4 as libc::c_int
                        + 3 as libc::c_int * 4 as libc::c_int) as libc::c_uint;
                }
                _ => {}
            ...
            padsize = 0 as libc::c_int as libc::c_uint;
            match gmon_get_ptr_size() as libc::c_uint {
                0 => {
                    hdrsize = (4 as libc::c_int + 4 as libc::c_int + 4 as libc::c_int)
                        as libc::c_uint;
        ...
        if gmon_io_write_vma(ofp, (*histograms).lowpc) != 0
            || gmon_io_write_vma(ofp, (*histograms).highpc) != 0
            || gmon_io_write_32(
                ofp,
                ((*histograms).num_bins as libc::c_ulong)
                    .wrapping_mul(::core::mem::size_of::<UNIT>() as libc::c_ulong)
                    .wrapping_add(hdrsize as libc::c_ulong) as libc::c_uint,
            ) != 0
        {
            perror(filename);
            done(1 as libc::c_int);
        ...
        if file_format as libc::c_uint == FF_BSD44 as libc::c_int as libc::c_uint
            || hz != hertz() as libc::c_long
        {
            if gmon_io_write_32(ofp, 0x51879 as libc::c_int as libc::c_uint) != 0
        ...
        if padsize != 0 as libc::c_int as libc::c_uint
            && fwrite(
        ...
        i = 0 as libc::c_int as libc::c_uint;
        while i < (*histograms).num_bins {
            (Some(((*(*core_bfd).xvec).bfd_putx16).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(
                *((*histograms).sample).offset(i as isize) as bfd_vma,
                &mut *raw_bin_count.as_mut_ptr().offset(0 as libc::c_int as isize)
        ...
        while sym < symtab.limit {
            ...
            while !arc.is_null() {
                ...
                if debug_level & (1 as libc::c_int) << 6 as libc::c_int != 0 {
                    printf(
                        b"[dumpsum] frompc 0x%lx selfpc 0x%lx count %lu\n\0" as *const u8
                            as *const libc::c_char,
                        (*(*arc).parent).addr,
                        (*(*arc).child).addr,
                        (*arc).count,
...
unsafe extern "C" fn gmon_get_ptr_size() -> gmon_ptr_size {
    let mut size: libc::c_int = 0;
    size = bfd_get_arch_size(core_bfd);
    if size == -(1 as libc::c_int) {
        size = bfd_arch_bits_per_address(core_bfd) as libc::c_int;
    }
    match size {
        32 => return ptr_32bit,
        64 => return ptr_64bit,
        _ => {
            fprintf(
                ...
                dcgettext(
                    b"gprof\0" as *const u8 as *const libc::c_char,
                    b"%s: address size has unexpected value of %u\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                whoami,
...
unsafe extern "C" fn gmon_get_ptr_signedness() -> gmon_ptr_signedness {
    let mut sext: libc::c_int = 0;
    sext = bfd_get_sign_extend_vma(core_bfd);
    if sext == -(1 as libc::c_int) {
        return ptr_unsigned;
    }
    return (if sext != 0 {
        ptr_signed as libc::c_int
    } else {
        ptr_unsigned as libc::c_int
    }) as gmon_ptr_signedness;
}
unsafe extern "C" fn gmon_io_read_64(
    mut ifp: *mut FILE,
    mut valp: *mut libc::c_ulong,
) -> libc::c_int {
    ...
    *valp = (Some(((*(*core_bfd).xvec).bfd_getx64).expect("non-null function pointer")))
        .expect("non-null function pointer")(buf.as_mut_ptr() as *const libc::c_void);
    return 0 as libc::c_int;
}
unsafe extern "C" fn gmon_io_write_64(
    mut ofp: *mut FILE,
    mut val: libc::c_ulong,
) -> libc::c_int {
    let mut buf: [libc::c_char; 8] = [0; 8];
    (Some(((*(*core_bfd).xvec).bfd_putx64).expect("non-null function pointer")))
        .expect("non-null function pointer")(val, buf.as_mut_ptr() as *mut libc::c_void);
    if fwrite(
        buf.as_mut_ptr() as *const libc::c_void,
        1 as libc::c_int as libc::c_ulong,
        8 as libc::c_int as libc::c_ulong,
...
unsafe extern "C" fn gmon_read_raw_arc(
    mut ifp: *mut FILE,
    mut fpc: *mut bfd_vma,
    mut spc: *mut bfd_vma,
    mut cnt: *mut libc::c_ulong,
) -> libc::c_int {
    let mut cnt64: libc::c_ulong = 0;
    let mut cnt32: libc::c_uint = 0;
    if gmon_io_read_vma(ifp, fpc) != 0 || gmon_io_read_vma(ifp, spc) != 0 {
        return 1 as libc::c_int;
    }
    match gmon_get_ptr_size() as libc::c_uint {
        0 => {
            if gmon_io_read_32(ifp, &mut cnt32) != 0 {
                return 1 as libc::c_int;
            }
            *cnt = cnt32 as libc::c_ulong;
        }
        1 => {
            if gmon_io_read_64(ifp, &mut cnt64) != 0 {
                return 1 as libc::c_int;
            }
            *cnt = cnt64;
        }
...
unsafe extern "C" fn gmon_write_raw_arc(
    mut ofp: *mut FILE,
    mut fpc: bfd_vma,
    mut spc: bfd_vma,
    mut cnt: libc::c_ulong,
) -> libc::c_int {
    if gmon_io_write_vma(ofp, fpc) != 0 || gmon_io_write_vma(ofp, spc) != 0 {
        return 1 as libc::c_int;
    }
    match gmon_get_ptr_size() as libc::c_uint {
        0 => {
            if gmon_io_write_32(ofp, cnt as libc::c_uint) != 0 {
                return 1 as libc::c_int;
            }
        }
        1 => {
            if gmon_io_write_64(ofp, cnt) != 0 {
                return 1 as libc::c_int;
            }
        }
        _ => {}
