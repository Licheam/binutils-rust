...
#[no_mangle]
pub unsafe extern "C" fn mips_find_call(
    mut parent: *mut Sym,
    mut p_lowpc: bfd_vma,
    ...
    pc = p_lowpc;
    while pc < p_highpc {
        op = (Some(((*(*core_bfd).xvec).bfd_getx32).expect("non-null function pointer")))
            .expect(
        ...
        if op & 0xfc000000 as libc::c_uint == 0xc000000 as libc::c_int as libc::c_uint {
            if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                printf(
                    dcgettext(
                        b"gprof\0" as *const u8 as *const libc::c_char,
                        b"[find_call] 0x%lx: jal\0" as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    pc,
                );
            }
            offset = ((op & 0x3ffffff as libc::c_int as libc::c_uint)
                << 2 as libc::c_int) as libc::c_int;
            dest_pc = pc & !(0xfffffff as libc::c_int as bfd_vma)
            ...
            if hist_check_address(dest_pc as libc::c_uint) != 0 {
                ...
                if !child.is_null() {
                    ...
                    if (*child).addr == dest_pc {
                        ...
                        current_block_39 = 13109137661213826276;
                    } else {
                        current_block_39 = 3437258052017859086;
                    }
                } else {
                    current_block_39 = 3437258052017859086;
                }
        ...
        } else if op & 0xfc00f83f as libc::c_uint
            == 0xf809 as libc::c_int as libc::c_uint
        {
            if debug_level & (1 as libc::c_int) << 8 as libc::c_int != 0 {
                printf(
                    dcgettext(
                        b"gprof\0" as *const u8 as *const libc::c_char,
                        b"[find_call] 0x%lx: jalr\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    pc,
            ...
            arc_add(parent, &mut indirect_child, 0 as libc::c_int as libc::c_ulong);
        }
