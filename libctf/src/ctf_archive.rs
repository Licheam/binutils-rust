...
extern "C" {
    ...
    fn ctf_symsect_endianness(_: *mut ctf_dict_t, little_endian: libc::c_int);
    fn memcpy(
        _: *mut libc::c_void,
        _: *const libc::c_void,
        _: libc::c_ulong,
    ...
    fn ctf_lookup_by_symbol_name(_: *mut ctf_dict_t, _: *const libc::c_char) -> ctf_id_t;
    fn ctf_lookup_by_symbol(_: *mut ctf_dict_t, _: libc::c_ulong) -> ctf_id_t;
    ...
    fn ctf_write(_: *mut ctf_dict_t, _: libc::c_int) -> libc::c_int;
    fn ctf_compress_write(fp: *mut ctf_dict_t, fd: libc::c_int) -> libc::c_int;
    fn ctf_serialize(_: *mut ctf_dict_t) -> libc::c_int;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_archive_modent {
    pub name_offset: uint64_t,
    pub ctf_offset: uint64_t,
}
pub type ctf_archive_modent_t = ctf_archive_modent;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_dict {
...
pub type ctf_archive_raw_member_f = unsafe extern "C" fn(
    *const libc::c_char,
    *const libc::c_void,
    size_t,
    *mut libc::c_void,
...
static mut enosym: ctf_dict_t = ctf_dict_t {
    ctf_dictops: 0 as *const ctf_dictops_t,
    ctf_header: 0 as *const ctf_header as *mut ctf_header,
    ctf_openflags: 0,
    ctf_data: ctf_sect_t {
    ...
    ctf_symhash: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_symhash_latest: 0,
    ctf_prov_strtab: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_syn_ext_strtab: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_data_mmapped: 0 as *const libc::c_void as *mut libc::c_void,
    ctf_data_mmapped_len: 0,
    ctf_structs: ctf_names_t {
        ctn_readonly: 0 as *const ctf_hash_t as *mut ctf_hash_t,
        ctn_writable: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    },
    ...
    ctf_lookups: [ctf_lookup_t {
        ...
        ctl_len: 0,
        ctl_hash: 0 as *const ctf_names_t as *mut ctf_names_t,
    }; 5],
    ctf_str: [ctf_strs_t {
        cts_strs: 0 as *const libc::c_char,
        cts_len: 0,
    }; 2],
    ctf_str_atoms: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_str_pending_ref: 0 as *const ctf_dynset_t as *mut ctf_dynset_t,
    ctf_str_num_refs: 0,
    ctf_str_prov_offset: 0,
    ctf_base: 0 as *const libc::c_uchar as *mut libc::c_uchar,
    ctf_dynbase: 0 as *const libc::c_uchar as *mut libc::c_uchar,
    ctf_buf: 0 as *const libc::c_uchar as *mut libc::c_uchar,
    ctf_size: 0,
    ctf_sxlate: 0 as *const uint32_t as *mut uint32_t,
    ctf_nsyms: 0,
    ctf_txlate: 0 as *const uint32_t as *mut uint32_t,
    ctf_ptrtab: 0 as *const uint32_t as *mut uint32_t,
    ctf_ptrtab_len: 0,
    ctf_pptrtab: 0 as *const uint32_t as *mut uint32_t,
    ctf_pptrtab_len: 0,
    ctf_pptrtab_typemax: 0,
    ctf_funcidx_names: 0 as *const uint32_t as *mut uint32_t,
    ctf_objtidx_names: 0 as *const uint32_t as *mut uint32_t,
    ctf_nfuncidx: 0,
    ctf_funcidx_sxlate: 0 as *const uint32_t as *mut uint32_t,
    ctf_objtidx_sxlate: 0 as *const uint32_t as *mut uint32_t,
    ctf_nobjtidx: 0,
    ctf_objthash: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_funchash: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_dynsyms: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_dynsymidx: 0 as *const *mut ctf_link_sym_t as *mut *mut ctf_link_sym_t,
    ctf_dynsymmax: 0,
    ctf_in_flight_dynsyms: ctf_list_t {
        l_prev: 0 as *const ctf_list as *mut ctf_list,
        l_next: 0 as *const ctf_list as *mut ctf_list,
    },
    ctf_vars: 0 as *const ctf_varent as *mut ctf_varent,
    ctf_nvars: 0,
    ctf_typemax: 0,
    ctf_dmodel: 0 as *const ctf_dmodel_t,
    ctf_cuname: 0 as *const libc::c_char,
    ctf_dyncuname: 0 as *const libc::c_char as *mut libc::c_char,
    ctf_parent: 0 as *const ctf_dict as *mut ctf_dict,
    ctf_parent_unreffed: 0,
    ctf_parlabel: 0 as *const libc::c_char,
    ctf_parname: 0 as *const libc::c_char,
    ctf_dynparname: 0 as *const libc::c_char as *mut libc::c_char,
    ctf_parmax: 0,
    ctf_refcnt: 0,
    ctf_flags: 0,
    ctf_errno: 0,
    ctf_version: 0,
    ctf_dthash: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_dtdefs: ctf_list_t {
        l_prev: 0 as *const ctf_list as *mut ctf_list,
        l_next: 0 as *const ctf_list as *mut ctf_list,
    },
    ctf_dvhash: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ...
    ctf_snapshots: 0,
    ctf_snapshot_lu: 0,
    ctf_archive: 0 as *const ctf_archive_t as *mut ctf_archive_t,
    ctf_errs_warnings: ctf_list_t {
        l_prev: 0 as *const ctf_list as *mut ctf_list,
        l_next: 0 as *const ctf_list as *mut ctf_list,
    },
    ctf_link_inputs: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_link_outputs: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_link_type_mapping: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_link_in_cu_mapping: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_link_out_cu_mapping: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_link_flags: 0,
    ctf_link_memb_name_changer: None,
    ctf_link_memb_name_changer_arg: 0 as *const libc::c_void as *mut libc::c_void,
    ctf_link_variable_filter: None,
    ctf_link_variable_filter_arg: 0 as *const libc::c_void as *mut libc::c_void,
    ctf_add_processing: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
    ctf_dedup_atoms: 0 as *const ctf_dynset_t as *mut ctf_dynset_t,
    ctf_dedup_atoms_alloc: 0 as *const ctf_dynset_t as *mut ctf_dynset_t,
    ctf_dedup: ctf_dedup_t {
        cd_link_flags: 0,
        cd_id_to_dict_t: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_decorated_names: [0 as *const ctf_dynhash_t as *mut ctf_dynhash_t; 4],
        cd_name_counts: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_type_hashes: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_struct_origin: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_citers: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_output_mapping: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_output_first_gid: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_output_mapping_guard: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_emission_struct_members: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_conflicting_types: 0 as *const ctf_dynset_t as *mut ctf_dynset_t,
        cd_input_nums: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_output_emission_hashes: 0 as *const ctf_dynhash_t as *mut ctf_dynhash_t,
        cd_output_emission_conflicted_forwards: 0 as *const ctf_dynhash_t
            as *mut ctf_dynhash_t,
        cd_output: 0 as *const ctf_dict_t as *mut ctf_dict_t,
    },
    ctf_tmp_typeslice: 0 as *const libc::c_char as *mut libc::c_char,
    ctf_tmp_typeslicelen: 0,
    ctf_specific: 0 as *const libc::c_void as *mut libc::c_void,
};
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_write_fd(
    mut fd: libc::c_int,
    mut ctf_dicts: *mut *mut ctf_dict_t,
    mut ctf_dict_cnt: size_t,
    mut names: *mut *const libc::c_char,
    mut threshold: size_t,
) -> libc::c_int {
    let mut current_block: u64;
    let mut errmsg: *const libc::c_char = 0 as *const libc::c_char;
    let mut archdr: *mut ctf_archive = 0 as *mut ctf_archive;
    let mut i: size_t = 0;
    let mut dummy: libc::c_char = 0 as libc::c_int as libc::c_char;
    let mut headersz: size_t = 0;
    let mut namesz: ssize_t = 0;
    let mut ctf_startoffs: size_t = 0;
    let mut nametbl: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut np: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut nameoffs: off_t = 0;
    let mut modent: *mut ctf_archive_modent = 0 as *mut ctf_archive_modent;
    ctf_dprintf(
        b"Writing CTF archive with %lu files\n\0" as *const u8 as *const libc::c_char,
        ctf_dict_cnt,
    );
    headersz = (::core::mem::size_of::<ctf_archive>() as libc::c_ulong)
        .wrapping_add(
            ctf_dict_cnt
                .wrapping_mul(::core::mem::size_of::<uint64_t>() as libc::c_ulong)
                .wrapping_mul(2 as libc::c_int as libc::c_ulong),
        );
    ctf_dprintf(b"headersz is %lu\n\0" as *const u8 as *const libc::c_char, headersz);
    ctf_startoffs = headersz;
    if lseek(
        fd,
        ctf_startoffs.wrapping_sub(1 as libc::c_int as libc::c_ulong) as __off_t,
        0 as libc::c_int,
    ) < 0 as libc::c_int as libc::c_long
    {
        errmsg = b"ctf_arc_write(): cannot extend file while writing\0" as *const u8
    ...
    ) < 0 as libc::c_int as libc::c_long
    {
        ...
        archdr = arc_mmap_header(fd, headersz) as *mut ctf_archive;
        if archdr.is_null() {
            errmsg = b"ctf_arc_write(): cannot mmap\0" as *const u8
                as *const libc::c_char;
        } else {
            (*archdr)
                .ctfa_magic = __uint64_identity(0x8b47f2a4d7623eeb as libc::c_ulong);
            (*archdr).ctfa_ndicts = __uint64_identity(ctf_dict_cnt);
            (*archdr).ctfa_ctfs = __uint64_identity(ctf_startoffs);
            if ctf_dict_cnt > 0 as libc::c_int as libc::c_ulong {
                (*archdr)
                    .ctfa_model = __uint64_identity(
                    ctf_getmodel(*ctf_dicts.offset(0 as libc::c_int as isize))
                        as __uint64_t,
                );
            }
            i = 0 as libc::c_int as size_t;
            namesz = 0 as libc::c_int as ssize_t;
            while i < __uint64_identity((*archdr).ctfa_ndicts) {
                namesz = (namesz as libc::c_ulong)
                    .wrapping_add(
            ...
            nametbl = malloc(namesz as libc::c_ulong) as *mut libc::c_char;
            if nametbl.is_null() {
                errmsg = b"ctf_arc_write(): error writing named CTF to archive\0"
                    as *const u8 as *const libc::c_char;
                current_block = 8672881611927510111;
            } else {
                i = 0 as libc::c_int as size_t;
                namesz = 0 as libc::c_int as ssize_t;
                modent = (archdr as *mut libc::c_char)
                    .offset(
                        ::core::mem::size_of::<ctf_archive>() as libc::c_ulong as isize,
                    ) as *mut ctf_archive_modent_t;
                loop {
                    if !(i < __uint64_identity((*archdr).ctfa_ndicts)) {
                        current_block = 18377268871191777778;
                        break;
                    }
                    let mut off: off_t = 0;
                    strcpy(
                        &mut *nametbl.offset(namesz as isize),
                        *names.offset(i as isize),
                    );
                    off = arc_write_one_ctf(
                        *ctf_dicts.offset(i as isize),
                        fd,
                        threshold,
                    );
                    if off < 0 as libc::c_int as libc::c_long
                        && off > -(1000 as libc::c_int) as libc::c_long
                    {
                        errmsg = b"ctf_arc_write(): cannot determine file position while writing to archive\0"
                            as *const u8 as *const libc::c_char;
                        current_block = 15481616853916407353;
                        break;
                    } else if off < 0 as libc::c_int as libc::c_long {
                        errmsg = b"ctf_arc_write(): cannot write CTF file to archive\0"
                            as *const u8 as *const libc::c_char;
                        *__errno_location() = (off * -(1 as libc::c_int) as libc::c_long)
                            as libc::c_int;
                        current_block = 15481616853916407353;
                        break;
                    } else {
                        (*modent).name_offset = __uint64_identity(namesz as __uint64_t);
                        (*modent)
                            .ctf_offset = __uint64_identity(
                            (off as libc::c_ulong).wrapping_sub(ctf_startoffs),
                        );
                        namesz = (namesz as libc::c_ulong)
                            .wrapping_add(
                                (strlen(*names.offset(i as isize)))
                ...
                match current_block {
                    18377268871191777778 => {
                        ctf_qsort_r(
                            (archdr as *mut libc::c_char)
                                .offset(
                                    ::core::mem::size_of::<ctf_archive>() as libc::c_ulong
                                        as isize,
                                ) as *mut ctf_archive_modent_t as *mut libc::c_void,
                            __uint64_identity((*archdr).ctfa_ndicts),
                            ::core::mem::size_of::<ctf_archive_modent>()
                                as libc::c_ulong,
                            Some(
                                sort_modent_by_name
                        ...
                        if nameoffs < 0 as libc::c_int as libc::c_long {
                            errmsg = b"ctf_arc_write(): cannot get current file position in archive\0"
                                as *const u8 as *const libc::c_char;
                            current_block = 15481616853916407353;
                        } else {
                            (*archdr)
                                .ctfa_names = __uint64_identity(nameoffs as __uint64_t);
                            np = nametbl;
                            loop {
                                if !(namesz > 0 as libc::c_int as libc::c_long) {
                                ...
                                len = write(
                                    fd,
                                    np as *const libc::c_void,
                                    namesz as size_t,
                                );
                                if len < 0 as libc::c_int as libc::c_long {
                                    errmsg = b"ctf_arc_write(): cannot write name table to archive\0"
                                        as *const u8 as *const libc::c_char;
                                    current_block = 15481616853916407353;
                                    break;
                                } else {
                                    namesz -= len;
                                    np = np.offset(len as isize);
                                }
                            }
                            match current_block {
                                15481616853916407353 => {}
                                _ => {
                                    free(nametbl as *mut libc::c_void);
                                    if arc_mmap_writeout(
                                        fd,
                                        archdr as *mut libc::c_void,
                                        headersz,
                                        &mut errmsg,
                                    ) < 0 as libc::c_int
                                    {
                                        current_block = 8672881611927510111;
                                    } else if arc_mmap_unmap(
                                        archdr as *mut libc::c_void,
                                        headersz,
                                        &mut errmsg,
                                    ) < 0 as libc::c_int
                                    {
                                        current_block = 16307250575702588101;
                                    } else {
    ...
    ctf_err_warn(
        if ctf_dict_cnt > 0 as libc::c_int as libc::c_ulong {
            *ctf_dicts.offset(0 as libc::c_int as isize)
        } else {
            0 as *mut ctf_dict_t
        },
        0 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_write(
    ...
    if fd < 0 as libc::c_int {
        ctf_err_warn(
            ...
            *__errno_location(),
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"ctf_arc_write(): cannot create %s\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            file,
        ...
        if err < 0 as libc::c_int {
            ctf_err_warn(
                ...
                *__errno_location(),
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"ctf_arc_write(): cannot close after writing to archive\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
...
unsafe extern "C" fn arc_write_one_ctf(
    mut f: *mut ctf_dict_t,
    mut fd: libc::c_int,
    mut threshold: size_t,
) -> off_t {
    let mut off: off_t = 0;
    let mut end_off: off_t = 0;
    let mut ctfsz: uint64_t = 0 as libc::c_int as uint64_t;
    let mut ctfszp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut ctfsz_len: size_t = 0;
    let mut writefn: Option::<
        unsafe extern "C" fn(*mut ctf_dict_t, libc::c_int) -> libc::c_int,
    > = None;
    if ctf_serialize(f) < 0 as libc::c_int {
        return ((*f).ctf_errno * -(1 as libc::c_int)) as off_t;
    }
    off = lseek(fd, 0 as libc::c_int as __off_t, 1 as libc::c_int);
    if off < 0 as libc::c_int as libc::c_long {
        return (*__errno_location() * -(1 as libc::c_int)) as off_t;
    }
    if (*f).ctf_size > threshold {
        writefn = Some(
            ctf_compress_write
                as unsafe extern "C" fn(*mut ctf_dict_t, libc::c_int) -> libc::c_int,
        );
    } else {
        writefn = Some(
            ctf_write
    ...
    ctfsz_len = ::core::mem::size_of::<uint64_t>() as libc::c_ulong;
    ctfszp = &mut ctfsz as *mut uint64_t as *mut libc::c_char;
    while ctfsz_len > 0 as libc::c_int as libc::c_ulong {
        let mut writelen: ssize_t = write(fd, ctfszp as *const libc::c_void, ctfsz_len);
        if writelen < 0 as libc::c_int as libc::c_long {
            return (*__errno_location() * -(1 as libc::c_int)) as off_t;
        }
        ctfsz_len = (ctfsz_len as libc::c_ulong).wrapping_sub(writelen as libc::c_ulong)
            as size_t as size_t;
        ctfszp = ctfszp.offset(writelen as isize);
    }
    if writefn.expect("non-null function pointer")(f, fd) != 0 as libc::c_int {
        return ((*f).ctf_errno * -(1 as libc::c_int)) as off_t;
    }
    end_off = lseek(fd, 0 as libc::c_int as __off_t, 1 as libc::c_int);
    if end_off < 0 as libc::c_int as libc::c_long {
        return (*__errno_location() * -(1 as libc::c_int)) as off_t;
    }
    ctfsz = __uint64_identity((end_off - off) as __uint64_t);
    if lseek(fd, off, 0 as libc::c_int) < 0 as libc::c_int as libc::c_long {
        return (*__errno_location() * -(1 as libc::c_int)) as off_t;
    }
    ctfsz_len = ::core::mem::size_of::<uint64_t>() as libc::c_ulong;
    ctfszp = &mut ctfsz as *mut uint64_t as *mut libc::c_char;
    while ctfsz_len > 0 as libc::c_int as libc::c_ulong {
        let mut writelen_0: ssize_t = write(
            fd,
            ctfszp as *const libc::c_void,
            ctfsz_len,
        );
        if writelen_0 < 0 as libc::c_int as libc::c_long {
            return (*__errno_location() * -(1 as libc::c_int)) as off_t;
        }
        ctfsz_len = (ctfsz_len as libc::c_ulong)
            .wrapping_sub(writelen_0 as libc::c_ulong) as size_t as size_t;
        ctfszp = ctfszp.offset(writelen_0 as isize);
    }
    end_off = end_off + (8 as libc::c_int - 1 as libc::c_int) as libc::c_long
        & !(8 as libc::c_int - 1 as libc::c_int) as libc::c_long;
    if lseek(fd, end_off, 0 as libc::c_int) < 0 as libc::c_int as libc::c_long {
        return (*__errno_location() * -(1 as libc::c_int)) as off_t;
    }
    return off;
}
unsafe extern "C" fn sort_modent_by_name(
    mut one: *const libc::c_void,
    mut two: *const libc::c_void,
    mut n: *mut libc::c_void,
) -> libc::c_int {
    let mut a: *const ctf_archive_modent = one as *const ctf_archive_modent;
    let mut b: *const ctf_archive_modent = two as *const ctf_archive_modent;
    let mut nametbl: *mut libc::c_char = n as *mut libc::c_char;
    return strcmp(
        &mut *nametbl
            .offset(
                (__uint64_identity
                    as unsafe extern "C" fn(__uint64_t) -> __uint64_t)((*a).name_offset)
                    as isize,
            ),
        &mut *nametbl
            .offset(
                (__uint64_identity
                    as unsafe extern "C" fn(__uint64_t) -> __uint64_t)((*b).name_offset)
                    as isize,
            ),
    );
}
unsafe extern "C" fn search_modent_by_name(
    mut key: *const libc::c_void,
    mut ent: *const libc::c_void,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut k: *const libc::c_char = key as *const libc::c_char;
    let mut v: *const ctf_archive_modent = ent as *const ctf_archive_modent;
    let mut search_nametbl: *const libc::c_char = arg as *const libc::c_char;
    return strcmp(
        k,
        &*search_nametbl
            .offset(
                (__uint64_identity
                    as unsafe extern "C" fn(__uint64_t) -> __uint64_t)((*v).name_offset)
                    as isize,
            ),
    );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_new_archive_internal(
    mut is_archive: libc::c_int,
    mut unmap_on_close: libc::c_int,
    mut arc: *mut ctf_archive,
    ...
    let mut arci: *mut ctf_archive_internal = 0 as *mut ctf_archive_internal;
    arci = calloc(
        1 as libc::c_int as libc::c_ulong,
        ::core::mem::size_of::<ctf_archive_internal>() as libc::c_ulong,
    ) as *mut ctf_archive_internal;
    if arci.is_null() {
        if is_archive != 0 {
            if unmap_on_close != 0 {
        ...
        return ctf_set_open_errno(errp, *__errno_location())
            as *mut ctf_archive_internal;
    }
    ...
    if !symsect.is_null() {
        memcpy(
            &mut (*arci).ctfi_symsect as *mut ctf_sect_t as *mut libc::c_void,
    ...
    if !strsect.is_null() {
        memcpy(
            &mut (*arci).ctfi_strsect as *mut ctf_sect_t as *mut libc::c_void,
            strsect as *const libc::c_void,
            ::core::mem::size_of::<ctf_sect>() as libc::c_ulong,
        );
    }
    (*arci).ctfi_free_symsect = 0 as libc::c_int;
    (*arci).ctfi_free_strsect = 0 as libc::c_int;
    (*arci).ctfi_unmap_on_close = unmap_on_close;
    (*arci).ctfi_symsect_little_endian = -(1 as libc::c_int);
    return arci;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_symsect_endianness(
    mut arc: *mut ctf_archive_t,
    mut little_endian: libc::c_int,
) {
    (*arc).ctfi_symsect_little_endian = (little_endian != 0) as libc::c_int;
    if (*arc).ctfi_is_archive == 0 {
        ctf_symsect_endianness((*arc).ctfi_dict, (*arc).ctfi_symsect_little_endian);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_bufpreamble(
    mut ctfsect: *const ctf_sect_t,
) -> *const ctf_preamble_t {
    if (*ctfsect).cts_size > ::core::mem::size_of::<uint64_t>() as libc::c_ulong
        && __uint64_identity(*((*ctfsect).cts_data as *mut uint64_t))
            == 0x8b47f2a4d7623eeb as libc::c_ulong
    {
        let mut arc: *mut ctf_archive = (*ctfsect).cts_data as *mut ctf_archive;
        return (arc as *mut libc::c_char)
            .offset(__uint64_identity((*arc).ctfa_ctfs) as isize)
            .offset(::core::mem::size_of::<uint64_t>() as libc::c_ulong as isize)
            as *const ctf_preamble_t;
    } else {
        return (*ctfsect).cts_data as *const ctf_preamble_t
    };
}
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_bufopen(
    mut ctfsect: *const ctf_sect_t,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    mut errp: *mut libc::c_int,
) -> *mut ctf_archive_t {
    let mut arc: *mut ctf_archive = 0 as *mut ctf_archive;
    let mut is_archive: libc::c_int = 0;
    let mut fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    if (*ctfsect).cts_size > ::core::mem::size_of::<uint64_t>() as libc::c_ulong
        && __uint64_identity(*((*ctfsect).cts_data as *mut uint64_t))
            == 0x8b47f2a4d7623eeb as libc::c_ulong
    {
        is_archive = 1 as libc::c_int;
        arc = (*ctfsect).cts_data as *mut ctf_archive;
    } else {
        is_archive = 0 as libc::c_int;
        ...
        if fp.is_null() {
            ctf_err_warn(
                ...
                *errp,
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"ctf_arc_bufopen(): cannot open CTF\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            return 0 as *mut ctf_archive_t;
        }
    }
    return ctf_new_archive_internal(
        is_archive,
        0 as libc::c_int,
        arc,
        fp,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_open_internal(
    ...
    if fd < 0 as libc::c_int {
        errmsg = b"ctf_arc_open(): cannot open %s\0" as *const u8 as *const libc::c_char;
    } else {
        if fstat(fd, &mut s) < 0 as libc::c_int {
            errmsg = b"ctf_arc_open(): cannot stat %s\0" as *const u8
                as *const libc::c_char;
        } else {
            arc = arc_mmap_file(fd, s.st_size as size_t) as *mut ctf_archive;
            if arc.is_null() {
                errmsg = b"ctf_arc_open(): cannot read in %s\0" as *const u8
                    as *const libc::c_char;
            } else if __uint64_identity((*arc).ctfa_magic)
                != 0x8b47f2a4d7623eeb as libc::c_ulong
            {
                errmsg = b"ctf_arc_open(): %s: invalid magic number\0" as *const u8
                    as *const libc::c_char;
                *__errno_location() = ECTF_FMT as libc::c_int;
                arc_mmap_unmap(
                ...
                (*arc).ctfa_magic = s.st_size as uint64_t;
                close(fd);
                return arc;
            }
        }
    ...
    return 0 as *mut ctf_archive;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_close_internal(mut arc: *mut ctf_archive) {
    if arc.is_null() {
        return;
    }
    arc_mmap_unmap(
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_close(mut arc: *mut ctf_archive_t) {
    if arc.is_null() {
        return;
    }
    if (*arc).ctfi_is_archive != 0 {
        if (*arc).ctfi_unmap_on_close != 0 {
            ctf_arc_close_internal((*arc).ctfi_archive);
        }
    } else {
        ctf_dict_close((*arc).ctfi_dict);
    }
    free((*arc).ctfi_symdicts as *mut libc::c_void);
    free((*arc).ctfi_symnamedicts as *mut libc::c_void);
    ctf_dynhash_destroy((*arc).ctfi_dicts);
    if (*arc).ctfi_free_symsect != 0 {
        free((*arc).ctfi_symsect.cts_data as *mut libc::c_void);
    }
    if (*arc).ctfi_free_strsect != 0 {
        free((*arc).ctfi_strsect.cts_data as *mut libc::c_void);
    }
    free((*arc).ctfi_data);
    if ((*arc).ctfi_bfd_close).is_some() {
        ((*arc).ctfi_bfd_close).expect("non-null function pointer")(arc);
    }
    free(arc as *mut libc::c_void);
}
unsafe extern "C" fn ctf_dict_open_internal(
    mut arc: *const ctf_archive,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    ...
    let mut modent: *mut ctf_archive_modent = 0 as *mut ctf_archive_modent;
    let mut search_nametbl: *const libc::c_char = 0 as *const libc::c_char;
    if name.is_null() {
        name = _CTF_SECTION.as_ptr();
    }
    ctf_dprintf(
        b"ctf_dict_open_internal(%s): opening\n\0" as *const u8 as *const libc::c_char,
        name,
    );
    modent = (arc as *mut libc::c_char)
        .offset(::core::mem::size_of::<ctf_archive>() as libc::c_ulong as isize)
        as *mut ctf_archive_modent_t;
    search_nametbl = (arc as *const libc::c_char)
        .offset(__uint64_identity((*arc).ctfa_names) as isize);
    modent = bsearch_r(
        name as *const libc::c_void,
        modent as *const libc::c_void,
        __uint64_identity((*arc).ctfa_ndicts),
        ::core::mem::size_of::<ctf_archive_modent>() as libc::c_ulong,
        Some(
        ...
        search_nametbl as *mut libc::c_void,
    ) as *mut ctf_archive_modent;
    if modent.is_null() {
        if !errp.is_null() {
            *errp = ECTF_ARNNAME as libc::c_int;
        }
        return 0 as *mut ctf_dict_t;
    }
    return ctf_dict_open_by_offset(
        arc,
        symsect,
        strsect,
        __uint64_identity((*modent).ctf_offset),
        little_endian,
        errp,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dict_open_sections(
    mut arc: *const ctf_archive_t,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    mut name: *const libc::c_char,
    mut errp: *mut libc::c_int,
    ...
    if (*arc).ctfi_is_archive != 0 {
        let mut ret: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
        ret = ctf_dict_open_internal(
            (*arc).ctfi_archive,
            symsect,
            strsect,
            name,
        ...
        if !ret.is_null() {
            (*ret).ctf_archive = arc as *mut ctf_archive_t;
            ctf_arc_import_parent(arc, ret);
        }
        return ret;
    }
    if !name.is_null() && strcmp(name, _CTF_SECTION.as_ptr()) != 0 as libc::c_int {
        if !errp.is_null() {
            *errp = ECTF_ARNNAME as libc::c_int;
        }
        return 0 as *mut ctf_dict_t;
    }
    (*(*arc).ctfi_dict).ctf_archive = arc as *mut ctf_archive_t;
    (*(*arc).ctfi_dict).ctf_refcnt = ((*(*arc).ctfi_dict).ctf_refcnt).wrapping_add(1);
    (*(*arc).ctfi_dict).ctf_refcnt;
    return (*arc).ctfi_dict;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dict_open(
    mut arc: *const ctf_archive_t,
    mut name: *const libc::c_char,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    let mut symsect: *const ctf_sect_t = &(*arc).ctfi_symsect;
    let mut strsect: *const ctf_sect_t = &(*arc).ctfi_strsect;
    if ((*symsect).cts_name).is_null() {
        symsect = 0 as *const ctf_sect_t;
    }
    if ((*strsect).cts_name).is_null() {
        strsect = 0 as *const ctf_sect_t;
    }
    return ctf_dict_open_sections(arc, symsect, strsect, name, errp);
}
unsafe extern "C" fn ctf_cached_dict_close(mut fp: *mut libc::c_void) {
    ctf_dict_close(fp as *mut ctf_dict_t);
}
unsafe extern "C" fn ctf_dict_open_cached(
    mut arc: *mut ctf_archive_t,
    mut name: *const libc::c_char,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    ...
    if !((*arc).ctfi_dicts).is_null()
        && {
            fp = ctf_dynhash_lookup((*arc).ctfi_dicts, name as *const libc::c_void)
                as *mut ctf_dict_t;
            !fp.is_null()
        }
    {
    ...
    dupname = strdup(name);
    if !(fp.is_null() || dupname.is_null()) {
        if ((*arc).ctfi_dicts).is_null() {
            (*arc)
                .ctfi_dicts = ctf_dynhash_create(
                Some(
                    ctf_hash_string
            ...
            if ((*arc).ctfi_dicts).is_null() {
                current_block = 12046352863571236408;
            } else {
        ...
        match current_block {
            ...
            _ => {
                ...
                ) < 0 as libc::c_int)
                {
                    (*fp).ctf_refcnt = ((*fp).ctf_refcnt).wrapping_add(1);
                    (*fp).ctf_refcnt;
                    if ((*arc).ctfi_crossdict_cache).is_null() {
    ...
    if !errp.is_null() {
        *errp = 12 as libc::c_int;
    }
    return 0 as *mut ctf_dict_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_flush_caches(mut wrapper: *mut ctf_archive_t) {
    free((*wrapper).ctfi_symdicts as *mut libc::c_void);
    free((*wrapper).ctfi_symnamedicts as *mut libc::c_void);
    ctf_dynhash_destroy((*wrapper).ctfi_dicts);
    (*wrapper).ctfi_symdicts = 0 as *mut *mut ctf_dict_t;
    (*wrapper).ctfi_symnamedicts = 0 as *mut ctf_dynhash_t;
    (*wrapper).ctfi_dicts = 0 as *mut ctf_dynhash_t;
    (*wrapper).ctfi_crossdict_cache = 0 as *mut ctf_dict_t;
}
unsafe extern "C" fn ctf_dict_open_by_offset(
    mut arc: *const ctf_archive,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    mut offset: size_t,
    ...
    let mut fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    ctf_dprintf(
        b"ctf_dict_open_by_offset(%lu): opening\n\0" as *const u8 as *const libc::c_char,
        offset,
    );
    memset(
        &mut ctfsect as *mut ctf_sect_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<ctf_sect_t>() as libc::c_ulong,
    );
    offset = (offset as libc::c_ulong).wrapping_add(__uint64_identity((*arc).ctfa_ctfs))
        as size_t as size_t;
    ctfsect.cts_name = _CTF_SECTION.as_ptr();
    ctfsect
        .cts_size = __uint64_identity(
        *((arc as *mut libc::c_char).offset(offset as isize) as *mut uint64_t),
    );
    ctfsect.cts_entsize = 1 as libc::c_int as size_t;
    ctfsect
        .cts_data = (arc as *mut libc::c_char)
        .offset(offset as isize)
        .offset(::core::mem::size_of::<uint64_t>() as libc::c_ulong as isize)
        as *mut libc::c_void;
    fp = ctf_bufopen(&mut ctfsect, symsect, strsect, errp);
    if !fp.is_null() {
        ctf_setmodel(fp, __uint64_identity((*arc).ctfa_model) as libc::c_int);
        if little_endian >= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_open_by_name(
    mut arc: *const ctf_archive_t,
    mut name: *const libc::c_char,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_open_by_name_sections(
    mut arc: *const ctf_archive_t,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    mut name: *const libc::c_char,
...
unsafe extern "C" fn ctf_arc_import_parent(
    mut arc: *const ctf_archive_t,
    mut fp: *mut ctf_dict_t,
) {
    if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        && !((*fp).ctf_parname).is_null() && ((*fp).ctf_parent).is_null()
    {
        let mut parent: *mut ctf_dict_t = ctf_dict_open_cached(
            arc as *mut ctf_archive_t,
            (*fp).ctf_parname,
            0 as *mut libc::c_int,
        );
        if !parent.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_archive_count(mut wrapper: *const ctf_archive_t) -> size_t {
    if (*wrapper).ctfi_is_archive == 0 {
        return 1 as libc::c_int as size_t;
    }
    return (*(*wrapper).ctfi_archive).ctfa_ndicts;
}
unsafe extern "C" fn ctf_arc_lookup_sym_or_name(
    mut wrapper: *mut ctf_archive_t,
    mut symidx: libc::c_ulong,
    mut symname: *const libc::c_char,
    mut typep: *mut ctf_id_t,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    let mut local_err: libc::c_int = 0;
    let mut local_errp: *mut libc::c_int = 0 as *mut libc::c_int;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut current_block: u64;
    let mut fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut fpkey: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut type_0: ctf_id_t = 0;
    if (*wrapper).ctfi_is_archive == 0 {
        if symname.is_null() {
            type_0 = ctf_lookup_by_symbol((*wrapper).ctfi_dict, symidx);
            ...
            type_0 = ctf_lookup_by_symbol_name((*wrapper).ctfi_dict, symname);
            if type_0 == -(1 as libc::c_long) as ctf_id_t {
                if !errp.is_null() {
                    *errp = ctf_errno((*wrapper).ctfi_dict);
                }
        ...
        (*(*wrapper).ctfi_dict)
            .ctf_refcnt = ((*(*wrapper).ctfi_dict).ctf_refcnt).wrapping_add(1);
        (*(*wrapper).ctfi_dict).ctf_refcnt;
        return (*wrapper).ctfi_dict;
    }
    if ((*wrapper).ctfi_symsect.cts_name).is_null()
        || ((*wrapper).ctfi_symsect.cts_data).is_null()
        || (*wrapper).ctfi_symsect.cts_size == 0 as libc::c_int as libc::c_ulong
        || (*wrapper).ctfi_symsect.cts_entsize == 0 as libc::c_int as libc::c_ulong
    {
        if !errp.is_null() {
            *errp = ECTF_NOSYMTAB as libc::c_int;
        }
        return 0 as *mut ctf_dict_t;
    }
    if ((*wrapper).ctfi_symdicts).is_null() {
        (*wrapper)
            .ctfi_symdicts = calloc(
            ((*wrapper).ctfi_symsect.cts_size)
                .wrapping_div((*wrapper).ctfi_symsect.cts_entsize),
    ...
    if ((*wrapper).ctfi_symnamedicts).is_null() {
        (*wrapper)
            .ctfi_symnamedicts = ctf_dynhash_create(
            Some(
                ctf_hash_string
                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
            ),
    ...
    if !symname.is_null()
        && ctf_dynhash_lookup_kv(
            (*wrapper).ctfi_symnamedicts,
            symname as *const libc::c_void,
            0 as *mut *const libc::c_void,
            &mut fpkey,
        ) != 0
        || symname.is_null()
            && !(*((*wrapper).ctfi_symdicts).offset(symidx as isize)).is_null()
    {
        if !symname.is_null() {
            fp = fpkey as *mut ctf_dict_t;
        } else {
            fp = *((*wrapper).ctfi_symdicts).offset(symidx as isize);
        }
        if fp == &mut enosym as *mut ctf_dict_t {
            current_block = 17132958095514762844;
        } else {
            if !symname.is_null() {
                type_0 = ctf_lookup_by_symbol_name(fp, symname);
                if type_0 == -(1 as libc::c_long) as ctf_id_t {
                    current_block = 5988856603069087332;
                } else {
                    current_block = 14832935472441733737;
                }
            } else {
                type_0 = ctf_lookup_by_symbol(fp, symidx);
                if type_0 == -(1 as libc::c_long) as ctf_id_t {
                    current_block = 5988856603069087332;
                } else {
                    current_block = 14832935472441733737;
        ...
        local_err = 0;
        local_errp = 0 as *mut libc::c_int;
        i = 0 as *mut ctf_next_t;
        name = 0 as *const libc::c_char;
        if !errp.is_null() {
            local_errp = errp;
        } else {
            local_errp = &mut local_err;
        }
        loop {
            fp = ctf_archive_next(
                wrapper,
            ...
            if symname.is_null() {
                type_0 = ctf_lookup_by_symbol(fp, symidx);
                if type_0 != -(1 as libc::c_long) as ctf_id_t {
                    let ref mut fresh0 = *((*wrapper).ctfi_symdicts)
                        .offset(symidx as isize);
                    *fresh0 = fp;
                }
            } else {
                type_0 = ctf_lookup_by_symbol_name(fp, symname);
            ...
            if ctf_errno(fp) != ECTF_NOTYPEDAT as libc::c_int {
                if !errp.is_null() {
                    *errp = ctf_errno(fp);
                }
                ctf_next_destroy(i);
        ...
        if *local_errp != ECTF_NEXT_END as libc::c_int {
            ctf_next_destroy(i);
            return 0 as *mut ctf_dict_t;
        }
        *local_errp = 0 as libc::c_int;
        current_block = 5988856603069087332;
    }
    match current_block {
        5988856603069087332 => {
            if symname.is_null() {
                let ref mut fresh1 = *((*wrapper).ctfi_symdicts).offset(symidx as isize);
                *fresh1 = &mut enosym;
            } else {
                let mut tmp_0: *mut libc::c_char = 0 as *mut libc::c_char;
                tmp_0 = strdup(symname);
                if !tmp_0.is_null() {
                    if ctf_dynhash_insert(
                        (*wrapper).ctfi_symnamedicts,
                        tmp_0 as *mut libc::c_void,
                        &mut enosym as *mut ctf_dict_t as *mut libc::c_void,
                    ) < 0 as libc::c_int
                    {
    ...
    if !errp.is_null() {
        *errp = ECTF_NOTYPEDAT as libc::c_int;
    }
    if !typep.is_null() {
        *typep = -(1 as libc::c_long) as ctf_id_t;
    }
    return 0 as *mut ctf_dict_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_lookup_symbol(
    mut wrapper: *mut ctf_archive_t,
    mut symidx: libc::c_ulong,
    mut typep: *mut ctf_id_t,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    return ctf_arc_lookup_sym_or_name(
        wrapper,
        symidx,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_lookup_symbol_name(
    mut wrapper: *mut ctf_archive_t,
    mut symname: *const libc::c_char,
    mut typep: *mut ctf_id_t,
    mut errp: *mut libc::c_int,
...
unsafe extern "C" fn ctf_archive_raw_iter_internal(
    mut arc: *const ctf_archive,
    mut func: Option::<ctf_archive_raw_member_f>,
    mut data: *mut libc::c_void,
) -> libc::c_int {
    let mut rc: libc::c_int = 0;
    let mut i: size_t = 0;
    let mut modent: *mut ctf_archive_modent = 0 as *mut ctf_archive_modent;
    let mut nametbl: *const libc::c_char = 0 as *const libc::c_char;
    modent = (arc as *mut libc::c_char)
        .offset(::core::mem::size_of::<ctf_archive>() as libc::c_ulong as isize)
        as *mut ctf_archive_modent_t;
    nametbl = (arc as *const libc::c_char)
        .offset(__uint64_identity((*arc).ctfa_names) as isize);
    i = 0 as libc::c_int as size_t;
    while i < __uint64_identity((*arc).ctfa_ndicts) {
        let mut name: *const libc::c_char = 0 as *const libc::c_char;
        ...
        name = &*nametbl
            .offset(
                (__uint64_identity
                    as unsafe extern "C" fn(
                        __uint64_t,
                    ) -> __uint64_t)((*modent.offset(i as isize)).name_offset) as isize,
            ) as *const libc::c_char;
        fp = (arc as *mut libc::c_char)
            .offset(__uint64_identity((*arc).ctfa_ctfs) as isize)
            .offset(__uint64_identity((*modent.offset(i as isize)).ctf_offset) as isize);
        rc = func
            .expect(
                "non-null function pointer",
            )(
            name,
            fp.offset(::core::mem::size_of::<uint64_t>() as libc::c_ulong as isize)
                as *mut libc::c_void,
            __uint64_identity(*(fp as *mut uint64_t)),
            data,
        );
...
#[no_mangle]
pub unsafe extern "C" fn ctf_archive_raw_iter(
    mut arc: *const ctf_archive_t,
    mut func: Option::<ctf_archive_raw_member_f>,
    mut data: *mut libc::c_void,
) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_archive_iter(
    mut arc: *const ctf_archive_t,
    mut func: Option::<ctf_archive_member_f>,
    mut data: *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    ...
    let mut err: libc::c_int = 0;
    loop {
        fp = ctf_archive_next(arc, &mut i, &mut name, 0 as libc::c_int, &mut err);
        if fp.is_null() {
            break;
        }
        let mut rc: libc::c_int = 0;
        rc = func.expect("non-null function pointer")(fp, name, data);
        if rc != 0 as libc::c_int {
            ctf_dict_close(fp);
            ctf_next_destroy(i);
            return rc;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_archive_next(
    mut wrapper: *const ctf_archive_t,
    mut it: *mut *mut ctf_next_t,
    mut name: *mut *const libc::c_char,
    mut skip_parent: libc::c_int,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    let mut f: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut i: *mut ctf_next_t = *it;
    let mut arc: *mut ctf_archive = 0 as *mut ctf_archive;
    let mut modent: *mut ctf_archive_modent = 0 as *mut ctf_archive_modent;
    let mut nametbl: *const libc::c_char = 0 as *const libc::c_char;
    let mut name_: *const libc::c_char = 0 as *const libc::c_char;
    if i.is_null() {
        i = ctf_next_create();
        if i.is_null() {
            if !errp.is_null() {
    ...
    {
        if !errp.is_null() {
            *errp = ECTF_NEXT_WRONGFUN as libc::c_int;
        }
        return 0 as *mut ctf_dict_t;
    }
    if wrapper != (*i).cu.ctn_arc {
        if !errp.is_null() {
            *errp = ECTF_NEXT_WRONGFP as libc::c_int;
        }
        return 0 as *mut ctf_dict_t;
    }
    if (*wrapper).ctfi_is_archive == 0 && (*i).ctn_n == 0 as libc::c_int as libc::c_uint
    {
    ...
    loop {
        if (*wrapper).ctfi_is_archive == 0
            || (*i).ctn_n as libc::c_ulong >= __uint64_identity((*arc).ctfa_ndicts)
        {
            ctf_next_destroy(i);
            *it = 0 as *mut ctf_next_t;
            if !errp.is_null() {
                *errp = ECTF_NEXT_END as libc::c_int;
            }
            return 0 as *mut ctf_dict_t;
        }
        modent = (arc as *mut libc::c_char)
        ...
        name_ = &*nametbl
            .offset(
                (__uint64_identity
                    as unsafe extern "C" fn(
                        __uint64_t,
                    ) -> __uint64_t)((*modent.offset((*i).ctn_n as isize)).name_offset)
                    as isize,
            ) as *const libc::c_char;
        (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
        (*i).ctn_n;
        if !(skip_parent != 0
            && strcmp(name_, _CTF_SECTION.as_ptr()) == 0 as libc::c_int)
        {
            break;
        }
    }
    ...
    f = ctf_dict_open_cached(wrapper as *mut ctf_archive_t, name_, errp);
    return f;
}
unsafe extern "C" fn arc_mmap_header(
    mut fd: libc::c_int,
    mut headersz: size_t,
) -> *mut libc::c_void {
    let mut hdr: *mut libc::c_void = 0 as *mut libc::c_void;
    hdr = mmap(
    ...
    if hdr == -(1 as libc::c_int) as *mut libc::c_void {
        return 0 as *mut libc::c_void;
    }
    return hdr;
}
unsafe extern "C" fn arc_mmap_file(
    mut fd: libc::c_int,
    mut size: size_t,
) -> *mut libc::c_void {
    let mut arc: *mut libc::c_void = 0 as *mut libc::c_void;
    arc = mmap(
        0 as *mut libc::c_void,
        size,
        0x1 as libc::c_int | 0x2 as libc::c_int,
    ...
    if arc == -(1 as libc::c_int) as *mut libc::c_void {
        return 0 as *mut libc::c_void;
    }
    return arc;
}
unsafe extern "C" fn arc_mmap_writeout(
    mut fd: libc::c_int,
    mut header: *mut libc::c_void,
    mut headersz: size_t,
    mut errmsg: *mut *const libc::c_char,
) -> libc::c_int {
    if msync(header, headersz, 1 as libc::c_int) < 0 as libc::c_int {
        if !errmsg.is_null() {
            *errmsg = b"arc_mmap_writeout(): cannot sync after writing to %s: %s\0"
                as *const u8 as *const libc::c_char;
        }
...
unsafe extern "C" fn arc_mmap_unmap(
    mut header: *mut libc::c_void,
    mut headersz: size_t,
    mut errmsg: *mut *const libc::c_char,
) -> libc::c_int {
    if munmap(header, headersz) < 0 as libc::c_int {
        if !errmsg.is_null() {
            *errmsg = b"arc_mmap_munmap(): cannot unmap after writing to %s: %s\0"
                as *const u8 as *const libc::c_char;
        }
        return -(1 as libc::c_int);
    }
