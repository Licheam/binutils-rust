...
extern "C" {
    ...
    fn ctf_type_aname(_: *mut ctf_dict_t, _: ctf_id_t) -> *mut libc::c_char;
    ...
    fn ctf_member_count(_: *mut ctf_dict_t, _: ctf_id_t) -> libc::c_int;
    fn ctf_enum_next(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
        _: *mut *mut ctf_next_t,
    ...
    fn ctf_type_iter_all(
        _: *mut ctf_dict_t,
        _: Option::<ctf_type_all_f>,
        _: *mut libc::c_void,
    ) -> libc::c_int;
    fn ctf_label_iter(
        _: *mut ctf_dict_t,
        _: Option::<ctf_label_f>,
        _: *mut libc::c_void,
    ) -> libc::c_int;
    fn ctf_variable_iter(
        _: *mut ctf_dict_t,
        _: Option::<ctf_variable_f>,
        _: *mut libc::c_void,
    ) -> libc::c_int;
    fn ctf_set_errno(_: *mut ctf_dict_t, _: libc::c_int) -> libc::c_ulong;
    fn strdup(_: *const libc::c_char) -> *mut libc::c_char;
    fn strlen(_: *const libc::c_char) -> libc::c_ulong;
    fn ctf_str_append_noerr(
        _: *mut libc::c_char,
        _: *const libc::c_char,
    ) -> *mut libc::c_char;
...
pub type ctf_label_f = unsafe extern "C" fn(
    *const libc::c_char,
    *const ctf_lblinfo_t,
    *mut libc::c_void,
) -> libc::c_int;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_dump_state {
    pub cds_sect: ctf_sect_names_t,
    pub cds_fp: *mut ctf_dict_t,
    pub cds_current: *mut ctf_dump_item_t,
    pub cds_items: ctf_list_t,
}
pub type ctf_dump_item_t = ctf_dump_item;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_dump_item {
    pub cdi_list: ctf_list_t,
    pub cdi_item: *mut libc::c_char,
}
...
pub type ctf_dump_membstate_t = ctf_dump_membstate;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_dump_membstate {
    pub cdm_str: *mut *mut libc::c_char,
    pub cdm_fp: *mut ctf_dict_t,
    pub cdm_toplevel_indent: *const libc::c_char,
}
unsafe extern "C" fn ctf_dump_append(
    mut state: *mut ctf_dump_state_t,
    mut str: *mut libc::c_char,
) -> libc::c_int {
    let mut cdi: *mut ctf_dump_item_t = 0 as *mut ctf_dump_item_t;
    cdi = malloc(::core::mem::size_of::<ctf_dump_item>() as libc::c_ulong)
        as *mut ctf_dump_item_t;
    if cdi.is_null() {
        return ctf_set_errno((*state).cds_fp, 12 as libc::c_int) as libc::c_int;
    }
    (*cdi).cdi_item = str;
    ctf_list_append(&mut (*state).cds_items, cdi as *mut libc::c_void);
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_dump_free(mut state: *mut ctf_dump_state_t) {
    let mut cdi: *mut ctf_dump_item_t = 0 as *mut ctf_dump_item_t;
    let mut next_cdi: *mut ctf_dump_item_t = 0 as *mut ctf_dump_item_t;
    if state.is_null() {
        return;
    }
    cdi = (*(&mut (*state).cds_items as *mut ctf_list_t)).l_next as *mut libc::c_void
        as *mut ctf_dump_item_t;
    while !cdi.is_null() {
        free((*cdi).cdi_item as *mut libc::c_void);
        next_cdi = (*(cdi as *mut ctf_list_t)).l_next as *mut libc::c_void
            as *mut ctf_dump_item_t;
        free(cdi as *mut libc::c_void);
        cdi = next_cdi;
    }
}
unsafe extern "C" fn ctf_dump_format_type(
    mut fp: *mut ctf_dict_t,
    mut id: ctf_id_t,
    mut flag: libc::c_int,
) -> *mut libc::c_char {
    let mut current_block: u64;
    let mut new_id: ctf_id_t = 0;
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut bit: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    loop {
        ...
        let mut unsliced_kind: libc::c_int = 0;
        let mut size: ssize_t = 0;
        let mut align: ssize_t = 0;
        let mut nonroot_leader: *const libc::c_char = b"\0" as *const u8
            as *const libc::c_char;
        let mut nonroot_trailer: *const libc::c_char = b"\0" as *const u8
            as *const libc::c_char;
        let mut idstr: *const libc::c_char = b"\0" as *const u8 as *const libc::c_char;
        id = new_id;
        if flag == 0 as libc::c_int {
            nonroot_leader = b"{\0" as *const u8 as *const libc::c_char;
            nonroot_trailer = b"}\0" as *const u8 as *const libc::c_char;
        }
        ...
        if buf.is_null() {
            ...
            {
                ctf_set_errno(fp, ECTF_NONREPRESENTABLE as libc::c_int);
                str = ctf_str_append_noerr(
                    str,
                    b" (type not represented in CTF)\0" as *const u8
                        as *const libc::c_char,
                );
                return str;
            }
            current_block = 14150919057420303621;
            break;
        } else {
            if flag & 0x8 as libc::c_int != 0 {
                idstr = b"ID \0" as *const u8 as *const libc::c_char;
            }
            if asprintf(
                &mut bit as *mut *mut libc::c_char,
                b"%s%s0x%lx: (kind %i) \0" as *const u8 as *const libc::c_char,
                nonroot_leader,
                idstr,
                id,
                ctf_type_kind(fp, id),
            ...
            {
                current_block = 11931645988758819799;
                break;
            }
            str = ctf_str_append_noerr(str, bit);
            free(bit as *mut libc::c_void);
            bit = 0 as *mut libc::c_char;
            ...
            if unsliced_kind != 8 as libc::c_int
                && ctf_type_encoding(fp, id, &mut ep) == 0 as libc::c_int
            {
                if ep.cte_bits as ssize_t
                    != ctf_type_size(fp, id) * 8 as libc::c_int as libc::c_long
                    && flag & 0x4 as libc::c_int != 0
                {
                    if asprintf(
                        &mut bit as *mut *mut libc::c_char,
                ...
                if ep.cte_bits as ssize_t
                    != ctf_type_size(fp, id) * 8 as libc::c_int as libc::c_long
                    || ep.cte_offset != 0 as libc::c_int as libc::c_uint
                {
                    let mut slice: *const libc::c_char = b"\0" as *const u8
                        as *const libc::c_char;
                    if unsliced_kind == 14 as libc::c_int {
                        slice = b"slice \0" as *const u8 as *const libc::c_char;
                    }
                    if asprintf(
                        &mut bit as *mut *mut libc::c_char,
                        b" [%s0x%x:0x%x]\0" as *const u8 as *const libc::c_char,
                        slice,
                        ep.cte_offset,
                        ep.cte_bits,
                    ) < 0 as libc::c_int
                ...
                if asprintf(
                    &mut bit as *mut *mut libc::c_char,
                    b" (format 0x%x)\0" as *const u8 as *const libc::c_char,
                    ep.cte_format,
                ) < 0 as libc::c_int
                {
                    current_block = 11931645988758819799;
            ...
            if kind != 5 as libc::c_int && size >= 0 as libc::c_int as libc::c_long {
                if asprintf(
                    &mut bit as *mut *mut libc::c_char,
                    b" (size 0x%lx)\0" as *const u8 as *const libc::c_char,
            ...
            if align >= 0 as libc::c_int as libc::c_long {
                if asprintf(
                    &mut bit as *mut *mut libc::c_char,
                    b" (aligned at 0x%lx)\0" as *const u8 as *const libc::c_char,
            ...
            if *nonroot_trailer.offset(0 as libc::c_int as isize) as libc::c_int
                != 0 as libc::c_int
            {
            ...
            if kind == 4 as libc::c_int {
                if ctf_array_info(fp, id, &mut ar) < 0 as libc::c_int {
                    current_block = 14150919057420303621;
                    break;
                }
            ...
            if new_id != -(1 as libc::c_long) as ctf_id_t {
                str = ctf_str_append_noerr(
                    str,
    ...
    match current_block {
        7343950298149844727 => {
            if ctf_errno(fp) != ECTF_NOTREF as libc::c_int {
                free(str as *mut libc::c_void);
                return 0 as *mut libc::c_char;
            }
            return str;
        }
        11931645988758819799 => {
    ...
    ctf_err_warn(
        ...
        dcgettext(
            ...
            b"cannot format name dumping type 0x%lx\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
        id,
...
unsafe extern "C" fn ctf_dump_header_strfield(
    mut fp: *mut ctf_dict_t,
    mut state: *mut ctf_dump_state_t,
...
unsafe extern "C" fn ctf_dump_header_sectfield(
    mut fp: *mut ctf_dict_t,
    mut state: *mut ctf_dump_state_t,
    mut sect: *const libc::c_char,
    mut off: uint32_t,
    mut nextoff: uint32_t,
) -> libc::c_int {
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    if nextoff.wrapping_sub(off) != 0 {
        if asprintf(
            &mut str as *mut *mut libc::c_char,
            b"%s:\t0x%lx -- 0x%lx (0x%lx bytes)\n\0" as *const u8 as *const libc::c_char,
            sect,
            off as libc::c_ulong,
            nextoff.wrapping_sub(1 as libc::c_int as libc::c_uint) as libc::c_ulong,
            nextoff.wrapping_sub(off) as libc::c_ulong,
        ) < 0 as libc::c_int
        {
            return ctf_set_errno(fp, *__errno_location()) as libc::c_int
        } else {
...
unsafe extern "C" fn ctf_dump_header(
    mut fp: *mut ctf_dict_t,
    mut state: *mut ctf_dump_state_t,
) -> libc::c_int {
    let mut current_block: u64;
    ...
    let mut hp: *const ctf_header_t = (*fp).ctf_header;
    let mut vertab: [*const libc::c_char; 6] = [
        0 as *const libc::c_char,
        b"CTF_VERSION_1\0" as *const u8 as *const libc::c_char,
        b"CTF_VERSION_1_UPGRADED_3 (latest format, version 1 type boundaries)\0"
            as *const u8 as *const libc::c_char,
        b"CTF_VERSION_2\0" as *const u8 as *const libc::c_char,
        b"CTF_VERSION_3\0" as *const u8 as *const libc::c_char,
        0 as *const libc::c_char,
    ];
    ...
    if !(asprintf(
        &mut str as *mut *mut libc::c_char,
        b"Magic number: 0x%x\n\0" as *const u8 as *const libc::c_char,
        (*hp).cth_preamble.ctp_magic as libc::c_int,
    ) < 0 as libc::c_int)
    {
        ctf_dump_append(state, str);
        if (*hp).cth_preamble.ctp_version as libc::c_int <= 4 as libc::c_int {
            verstr = vertab[(*hp).cth_preamble.ctp_version as usize];
        }
        if verstr.is_null() {
            verstr = b"(not a valid version)\0" as *const u8 as *const libc::c_char;
        }
        if !(asprintf(
            &mut str as *mut *mut libc::c_char,
            b"Version: %i (%s)\n\0" as *const u8 as *const libc::c_char,
            (*hp).cth_preamble.ctp_version as libc::c_int,
            verstr,
        ) < 0 as libc::c_int)
        {
            ctf_dump_append(state, str);
            if (*fp).ctf_openflags as libc::c_int > 0 as libc::c_int {
                if asprintf(
                    &mut flagstr as *mut *mut libc::c_char,
                    b"%s%s%s%s%s%s%s\0" as *const u8 as *const libc::c_char,
                    (if (*fp).ctf_openflags as libc::c_int & 0x1 as libc::c_int != 0 {
                        b"CTF_F_COMPRESS\0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    }),
                    (if (*fp).ctf_openflags as libc::c_int & 0x1 as libc::c_int != 0
                        && (*fp).ctf_openflags as libc::c_int & !(0x1 as libc::c_int)
                            != 0
                    {
                        b", \0" as *const u8 as *const libc::c_char
                    } else {
                    ...
                    (if (*fp).ctf_openflags as libc::c_int & 0x2 as libc::c_int != 0 {
                        b"CTF_F_NEWFUNCINFO\0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    }),
                    (if (*fp).ctf_openflags as libc::c_int
                        & (0x1 as libc::c_int | 0x2 as libc::c_int) != 0
                        && (*fp).ctf_openflags as libc::c_int
                            & !(0x1 as libc::c_int | 0x2 as libc::c_int) != 0
                    {
                        b", \0" as *const u8 as *const libc::c_char
                    } else {
                    ...
                    (if (*fp).ctf_openflags as libc::c_int & 0x4 as libc::c_int != 0 {
                        b"CTF_F_IDXSORTED\0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    }),
                    (if (*fp).ctf_openflags as libc::c_int
                    ...
                    (if (*fp).ctf_openflags as libc::c_int & 0x8 as libc::c_int != 0 {
                        b"CTF_F_DYNSTR\0" as *const u8 as *const libc::c_char
                    } else {
                        b"\0" as *const u8 as *const libc::c_char
                    }),
                ) < 0 as libc::c_int
                {
                    current_block = 11310892097851681726;
                } else if asprintf(
                    &mut str as *mut *mut libc::c_char,
                    b"Flags: 0x%x (%s)\0" as *const u8 as *const libc::c_char,
                    (*fp).ctf_openflags as libc::c_int,
                    flagstr,
                ) < 0 as libc::c_int
                {
            ...
            match current_block {
                11310892097851681726 => {}
                _ => {
                    if !(ctf_dump_header_strfield(
                        fp,
                        state,
                        b"Parent label\0" as *const u8 as *const libc::c_char,
                        (*hp).cth_parlabel,
                    ) < 0 as libc::c_int)
                    {
                        if !(ctf_dump_header_strfield(
                            fp,
                            state,
                            b"Parent name\0" as *const u8 as *const libc::c_char,
                            (*hp).cth_parname,
                        ) < 0 as libc::c_int)
                        {
                            if !(ctf_dump_header_strfield(
                                fp,
                                state,
                                b"Compilation unit name\0" as *const u8
                                    as *const libc::c_char,
                                (*hp).cth_cuname,
                            ) < 0 as libc::c_int)
                            {
                                if !(ctf_dump_header_sectfield(
                                    fp,
                                    state,
                                    b"Label section\0" as *const u8 as *const libc::c_char,
                                    (*hp).cth_lbloff,
                                    (*hp).cth_objtoff,
                                ) < 0 as libc::c_int)
                                {
                                    if !(ctf_dump_header_sectfield(
                                        fp,
                                        state,
                                        b"Data object section\0" as *const u8
                                            as *const libc::c_char,
                                        (*hp).cth_objtoff,
                                        (*hp).cth_funcoff,
                                    ) < 0 as libc::c_int)
                                    {
                                        if !(ctf_dump_header_sectfield(
                                            fp,
                                            state,
                                            b"Function info section\0" as *const u8
                                                as *const libc::c_char,
                                            (*hp).cth_funcoff,
                                            (*hp).cth_objtidxoff,
                                        ) < 0 as libc::c_int)
                                        {
                                            if !(ctf_dump_header_sectfield(
                                                fp,
                                                state,
                                                b"Object index section\0" as *const u8
                                                    as *const libc::c_char,
                                                (*hp).cth_objtidxoff,
                                                (*hp).cth_funcidxoff,
                                            ) < 0 as libc::c_int)
                                            {
                                                if !(ctf_dump_header_sectfield(
                                                    fp,
                                                    state,
                                                    b"Function index section\0" as *const u8
                                                        as *const libc::c_char,
                                                    (*hp).cth_funcidxoff,
                                                    (*hp).cth_varoff,
                                                ) < 0 as libc::c_int)
                                                {
                                                    if !(ctf_dump_header_sectfield(
                                                        fp,
                                                        state,
                                                        b"Variable section\0" as *const u8 as *const libc::c_char,
                                                        (*hp).cth_varoff,
                                                        (*hp).cth_typeoff,
                                                    ) < 0 as libc::c_int)
                                                    {
                                                        if !(ctf_dump_header_sectfield(
                                                            fp,
                                                            state,
                                                            b"Type section\0" as *const u8 as *const libc::c_char,
                                                            (*hp).cth_typeoff,
                                                            (*hp).cth_stroff,
                                                        ) < 0 as libc::c_int)
                                                        {
                                                            if !(ctf_dump_header_sectfield(
                                                                fp,
                                                                state,
                                                                b"String section\0" as *const u8 as *const libc::c_char,
                                                                (*hp).cth_stroff,
                                                                ((*hp).cth_stroff)
                                                                    .wrapping_add((*hp).cth_strlen)
...
unsafe extern "C" fn ctf_dump_label(
    mut name: *const libc::c_char,
    mut info: *const ctf_lblinfo_t,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut typestr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut state: *mut ctf_dump_state_t = arg as *mut ctf_dump_state_t;
    if asprintf(
        &mut str as *mut *mut libc::c_char,
    ...
    {
        return ctf_set_errno((*state).cds_fp, *__errno_location()) as libc::c_int;
    }
    ...
    free(typestr as *mut libc::c_void);
    ctf_dump_append(state, str);
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_dump_objts(
    mut fp: *mut ctf_dict_t,
    mut state: *mut ctf_dump_state_t,
    ...
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    if functions != 0 && !((*fp).ctf_funcidx_names).is_null()
        || functions == 0 && !((*fp).ctf_objtidx_names).is_null()
    {
        str = ctf_str_append_noerr(
            str,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"Section is indexed.\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    } else if ((*fp).ctf_symtab.cts_data).is_null() {
        str = ctf_str_append_noerr(
            str,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
    ...
    loop {
        id = ctf_symbol_next(fp, &mut i, &mut name, functions);
        ...
        if !name.is_null() {
            ...
            str = xstrdup(b"\0" as *const u8 as *const libc::c_char);
        }
        typestr = ctf_dump_format_type(
            (*state).cds_fp,
            id,
...
unsafe extern "C" fn ctf_dump_var(
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
...
unsafe extern "C" fn ctf_dump_member(
    mut name: *const libc::c_char,
    mut id: ctf_id_t,
    ...
    let mut state: *mut ctf_dump_membstate_t = arg as *mut ctf_dump_membstate_t;
    let mut typestr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut bit: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if !(asprintf(
        ...
        (*state).cdm_toplevel_indent,
        (depth - 1 as libc::c_int) * 4 as libc::c_int,
        b"\0" as *const u8 as *const libc::c_char,
    ) < 0 as libc::c_int)
    {
        *(*state).cdm_str = ctf_str_append_noerr(*(*state).cdm_str, bit);
        ...
        typestr = ctf_dump_format_type(
            (*state).cdm_fp,
            id,
            1 as libc::c_int | 0x4 as libc::c_int | 0x8 as libc::c_int,
        );
        if typestr.is_null() {
            return -(1 as libc::c_int);
        }
    ...
    free(typestr as *mut libc::c_void);
    free(bit as *mut libc::c_void);
    return ctf_set_errno((*state).cdm_fp, *__errno_location()) as libc::c_int;
}
unsafe extern "C" fn type_hex_digits(mut id: ctf_id_t) -> libc::c_int {
    let mut i: libc::c_int = 0 as libc::c_int;
    if id == 0 as libc::c_int as libc::c_ulong {
        return 1 as libc::c_int;
    }
    while id > 0 as libc::c_int as libc::c_ulong {
        id >>= 4 as libc::c_int;
        i += 1;
        i;
    }
...
unsafe extern "C" fn ctf_dump_type(
    mut id: ctf_id_t,
    mut flag: libc::c_int,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    ...
    let mut state: *mut ctf_dump_state_t = arg as *mut ctf_dump_state_t;
    let mut membstate: ctf_dump_membstate_t = {
        let mut init = ctf_dump_membstate {
            cdm_str: &mut str,
            cdm_fp: (*state).cds_fp,
            cdm_toplevel_indent: 0 as *const libc::c_char,
        };
        init
    };
    if asprintf(
        &mut indent as *mut *mut libc::c_char,
        b"    %*s\0" as *const u8 as *const libc::c_char,
        type_hex_digits(id),
        b"\0" as *const u8 as *const libc::c_char,
    ) < 0 as libc::c_int
    ...
    str = ctf_dump_format_type((*state).cds_fp, id, flag | 0x2 as libc::c_int);
    if !str.is_null() {
        str = ctf_str_append_noerr(str, b"\n\0" as *const u8 as *const libc::c_char);
        membstate.cdm_toplevel_indent = indent;
        if ctf_type_kind((*state).cds_fp, id) == 6 as libc::c_int
            || ctf_type_kind((*state).cds_fp, id) == 7 as libc::c_int
        {
            if ctf_type_visit(
                (*state).cds_fp,
                id,
                ...
                &mut membstate as *mut ctf_dump_membstate_t as *mut libc::c_void,
            ) < 0 as libc::c_int
            {
                if id == 0 as libc::c_int as libc::c_ulong
                    || ctf_errno((*state).cds_fp) == ECTF_NONREPRESENTABLE as libc::c_int
                {
                    ctf_dump_append(state, str);
                    return 0 as libc::c_int;
                }
                ctf_err_warn(
                    (*state).cds_fp,
                    1 as libc::c_int,
                    ctf_errno((*state).cds_fp),
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"cannot visit members dumping type 0x%lx\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    id,
                );
                current_block = 9177023737932634030;
            } else {
        ...
        match current_block {
            9177023737932634030 => {}
            _ => {
                if ctf_type_kind((*state).cds_fp, id) == 8 as libc::c_int {
                    let mut enum_count: libc::c_int = ctf_member_count(
                        (*state).cds_fp,
                        id,
                    );
                    let mut it: *mut ctf_next_t = 0 as *mut ctf_next_t;
                    let mut i: libc::c_int = 0 as libc::c_int;
                    let mut enumerand: *const libc::c_char = 0 as *const libc::c_char;
                    let mut bit: *mut libc::c_char = 0 as *mut libc::c_char;
                    let mut value: libc::c_int = 0;
                    loop {
                        enumerand = ctf_enum_next(
                            (*state).cds_fp,
                            id,
                            &mut it,
                            &mut value,
                        );
                        if enumerand.is_null() {
                            current_block = 15768484401365413375;
                            break;
                        }
                        i += 1;
                        i;
                        if i > 5 as libc::c_int && i < enum_count - 4 as libc::c_int {
                            continue;
                        }
                        ...
                        ) < 0 as libc::c_int
                        {
                            ...
                            str = ctf_str_append_noerr(str, bit);
                            free(bit as *mut libc::c_void);
                            if i == 5 as libc::c_int && enum_count > 10 as libc::c_int {
                                str = ctf_str_append_noerr(str, indent);
                                str = ctf_str_append_noerr(
                                    str,
                                    b"...\n\0" as *const u8 as *const libc::c_char,
                    ...
                    match current_block {
                        9177023737932634030 => {}
                        _ => {
                            if ctf_errno((*state).cds_fp) != ECTF_NEXT_END as libc::c_int
                            {
                                ctf_err_warn(
                                    (*state).cds_fp,
                                    1 as libc::c_int,
                                    ...
                                    dcgettext(
                                        b"libctf\0" as *const u8 as *const libc::c_char,
                                        b"cannot visit enumerands dumping type 0x%lx\0" as *const u8
                                            as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    id,
    ...
    free(indent as *mut libc::c_void);
    free(str as *mut libc::c_void);
    return ctf_set_errno((*state).cds_fp, err) as libc::c_int;
}
unsafe extern "C" fn ctf_dump_str(
    mut fp: *mut ctf_dict_t,
    mut state: *mut ctf_dump_state_t,
) -> libc::c_int {
    let mut s: *const libc::c_char = (*fp).ctf_str[0 as libc::c_int as usize].cts_strs;
    while s
        < ((*fp).ctf_str[0 as libc::c_int as usize].cts_strs)
            .offset((*fp).ctf_str[0 as libc::c_int as usize].cts_len as isize)
    {
        let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
        if asprintf(
            &mut str as *mut *mut libc::c_char,
            b"0x%lx: %s\0" as *const u8 as *const libc::c_char,
            s.offset_from((*fp).ctf_str[0 as libc::c_int as usize].cts_strs)
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dump(
    mut fp: *mut ctf_dict_t,
    mut statep: *mut *mut ctf_dump_state_t,
    mut sect: ctf_sect_names_t,
    mut func: Option::<ctf_dump_decorate_f>,
    mut arg: *mut libc::c_void,
) -> *mut libc::c_char {
    let mut current_block: u64;
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut line: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut state: *mut ctf_dump_state_t = 0 as *mut ctf_dump_state_t;
    if (*statep).is_null() {
        *statep = malloc(::core::mem::size_of::<ctf_dump_state>() as libc::c_ulong)
            as *mut ctf_dump_state_t;
        if (*statep).is_null() {
            ctf_set_errno(fp, 12 as libc::c_int);
            current_block = 16864422708244877135;
        } else {
            state = *statep;
            memset(
                state as *mut libc::c_void,
                0 as libc::c_int,
                ::core::mem::size_of::<ctf_dump_state>() as libc::c_ulong,
            );
            (*state).cds_fp = fp;
            (*state).cds_sect = sect;
            match sect as libc::c_uint {
                ...
                1 => {
                    ...
                    {
                        if ctf_errno(fp) != ECTF_NOLABELDATA as libc::c_int {
                            current_block = 16864422708244877135;
                        } else {
                            ctf_set_errno(fp, 0 as libc::c_int);
                            current_block = 4068382217303356765;
                ...
                2 => {
                    if ctf_dump_objts(fp, state, 0 as libc::c_int) < 0 as libc::c_int {
                        current_block = 16864422708244877135;
                    } else {
                        current_block = 4068382217303356765;
                    }
                ...
                3 => {
                    if ctf_dump_objts(fp, state, 1 as libc::c_int) < 0 as libc::c_int {
                        current_block = 16864422708244877135;
                    } else {
                        current_block = 4068382217303356765;
                    }
                ...
                _ => {
                    ctf_set_errno(fp, ECTF_DUMPSECTUNKNOWN as libc::c_int);
                    current_block = 16864422708244877135;
                }
            }
        }
        ...
        state = *statep;
        if (*state).cds_sect as libc::c_uint != sect as libc::c_uint {
            ctf_set_errno(fp, ECTF_DUMPSECTCHANGED as libc::c_int);
            current_block = 16864422708244877135;
        } else {
            current_block = 4068382217303356765;
        }
    ...
    match current_block {
        4068382217303356765 => {
            if ((*state).cds_current).is_null() {
                (*state)
                    .cds_current = (*(&mut (*state).cds_items as *mut ctf_list_t)).l_next
                    as *mut libc::c_void as *mut ctf_dump_item_t;
            } else {
                (*state)
                    .cds_current = (*((*state).cds_current as *mut ctf_list_t)).l_next
                    as *mut libc::c_void as *mut ctf_dump_item_t;
            }
            if !((*state).cds_current).is_null() {
                if func.is_some() {
                    ...
                    line = (*(*state).cds_current).cdi_item;
                    while !line.is_null() && *line as libc::c_int != 0 {
                        let mut nline: *mut libc::c_char = line;
                        ...
                        ret = func.expect("non-null function pointer")(sect, line, arg);
    ...
    ctf_set_errno(fp, 0 as libc::c_int);
    *statep = 0 as *mut ctf_dump_state_t;
    return 0 as *mut libc::c_char;
}
