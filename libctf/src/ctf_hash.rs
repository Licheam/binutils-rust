...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_dynhash {
    pub htab: *mut htab,
    pub key_free: ctf_hash_free_fun,
    pub value_free: ctf_hash_free_fun,
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_type_id_key {
    pub ctii_input_num: libc::c_int,
    pub ctii_type: ctf_id_t,
}
pub type ctf_type_id_key_t = ctf_type_id_key;
pub type ctf_hash_fun = Option::<
    unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
>;
pub type ctf_helem_t = ctf_helem;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_helem {
    pub key: *mut libc::c_void,
    pub value: *mut libc::c_void,
    pub owner: *mut ctf_dynhash_t,
}
...
>;
pub type ctf_hash_iter_remove_f = Option::<
    unsafe extern "C" fn(
        *mut libc::c_void,
        *mut libc::c_void,
        *mut libc::c_void,
...
>;
pub type ctf_traverse_cb_arg_t = ctf_traverse_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_traverse_cb_arg {
    pub fun: ctf_hash_iter_f,
    pub arg: *mut libc::c_void,
}
pub type ctf_traverse_remove_cb_arg_t = ctf_traverse_remove_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_traverse_remove_cb_arg {
    pub htab: *mut htab,
    pub fun: ctf_hash_iter_remove_f,
    pub arg: *mut libc::c_void,
}
pub type ctf_traverse_find_cb_arg_t = ctf_traverse_find_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_traverse_find_cb_arg {
    pub fun: ctf_hash_iter_find_f,
    pub arg: *mut libc::c_void,
    pub found_key: *mut libc::c_void,
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_integer(mut ptr: *const libc::c_void) -> libc::c_uint {
    let mut hep: *mut ctf_helem_t = ptr as *mut ctf_helem_t;
    return htab_hash_pointer.expect("non-null function pointer")((*hep).key);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_eq_integer(
    mut a: *const libc::c_void,
    mut b: *const libc::c_void,
) -> libc::c_int {
    let mut hep_a: *mut ctf_helem_t = a as *mut ctf_helem_t;
    let mut hep_b: *mut ctf_helem_t = b as *mut ctf_helem_t;
    return htab_eq_pointer
        .expect("non-null function pointer")((*hep_a).key, (*hep_b).key);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_string(mut ptr: *const libc::c_void) -> libc::c_uint {
    let mut hep: *mut ctf_helem_t = ptr as *mut ctf_helem_t;
    return htab_hash_string((*hep).key);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_eq_string(
    mut a: *const libc::c_void,
    mut b: *const libc::c_void,
) -> libc::c_int {
    let mut hep_a: *mut ctf_helem_t = a as *mut ctf_helem_t;
    let mut hep_b: *mut ctf_helem_t = b as *mut ctf_helem_t;
    return (strcmp(
        (*hep_a).key as *const libc::c_char,
        (*hep_b).key as *const libc::c_char,
    ) == 0) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_type_key(
    mut ptr: *const libc::c_void,
) -> libc::c_uint {
    let mut hep: *mut ctf_helem_t = ptr as *mut ctf_helem_t;
    let mut k: *mut ctf_link_type_key_t = (*hep).key as *mut ctf_link_type_key_t;
    return (htab_hash_pointer
        .expect("non-null function pointer")((*k).cltk_fp as *const libc::c_void))
        .wrapping_add(
            (59 as libc::c_int as libc::c_uint)
                .wrapping_mul(
                    htab_hash_pointer
                        ...
                        )((*k).cltk_idx as *mut libc::c_void),
                ),
        );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_eq_type_key(
    mut a: *const libc::c_void,
    mut b: *const libc::c_void,
) -> libc::c_int {
    let mut hep_a: *mut ctf_helem_t = a as *mut ctf_helem_t;
    let mut hep_b: *mut ctf_helem_t = b as *mut ctf_helem_t;
    let mut key_a: *mut ctf_link_type_key_t = (*hep_a).key as *mut ctf_link_type_key_t;
    let mut key_b: *mut ctf_link_type_key_t = (*hep_b).key as *mut ctf_link_type_key_t;
    return ((*key_a).cltk_fp == (*key_b).cltk_fp
        && (*key_a).cltk_idx == (*key_b).cltk_idx) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_type_id_key(
    mut ptr: *const libc::c_void,
) -> libc::c_uint {
    let mut hep: *mut ctf_helem_t = ptr as *mut ctf_helem_t;
    let mut k: *mut ctf_type_id_key_t = (*hep).key as *mut ctf_type_id_key_t;
    return (htab_hash_pointer
        .expect(
            "non-null function pointer",
        )((*k).ctii_input_num as uintptr_t as *mut libc::c_void))
        .wrapping_add(
            (59 as libc::c_int as libc::c_uint)
                .wrapping_mul(
                    htab_hash_pointer
                        .expect(
                            "non-null function pointer",
                        )((*k).ctii_type as *mut libc::c_void),
                ),
        );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_eq_type_id_key(
    mut a: *const libc::c_void,
    mut b: *const libc::c_void,
) -> libc::c_int {
    let mut hep_a: *mut ctf_helem_t = a as *mut ctf_helem_t;
    let mut hep_b: *mut ctf_helem_t = b as *mut ctf_helem_t;
    let mut key_a: *mut ctf_type_id_key_t = (*hep_a).key as *mut ctf_type_id_key_t;
    let mut key_b: *mut ctf_type_id_key_t = (*hep_b).key as *mut ctf_type_id_key_t;
    return ((*key_a).ctii_input_num == (*key_b).ctii_input_num
        && (*key_a).ctii_type == (*key_b).ctii_type) as libc::c_int;
}
unsafe extern "C" fn ctf_dynhash_item_free(mut item: *mut libc::c_void) {
    let mut helem: *mut ctf_helem_t = item as *mut ctf_helem_t;
    if ((*(*helem).owner).key_free).is_some() && !((*helem).key).is_null() {
        ((*(*helem).owner).key_free).expect("non-null function pointer")((*helem).key);
    }
    if ((*(*helem).owner).value_free).is_some() && !((*helem).value).is_null() {
        ((*(*helem).owner).value_free)
            .expect("non-null function pointer")((*helem).value);
    }
    free(helem as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_create(
    mut hash_fun: ctf_hash_fun,
    mut eq_fun: ctf_hash_eq_fun,
    mut key_free: ctf_hash_free_fun,
    mut value_free: ctf_hash_free_fun,
) -> *mut ctf_dynhash_t {
    let mut dynhash: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut del: htab_del = Some(
        ctf_dynhash_item_free as unsafe extern "C" fn(*mut libc::c_void) -> (),
    );
    if key_free.is_some() || value_free.is_some() {
        dynhash = malloc(::core::mem::size_of::<ctf_dynhash_t>() as libc::c_ulong)
            as *mut ctf_dynhash_t;
    } else {
        dynhash = malloc(8 as libc::c_ulong) as *mut ctf_dynhash_t;
    }
    if dynhash.is_null() {
        return 0 as *mut ctf_dynhash_t;
    }
    if key_free.is_none() && value_free.is_none() {
        del = Some(free as unsafe extern "C" fn(*mut libc::c_void) -> ());
    }
    (*dynhash)
        .htab = htab_create_alloc(
        7 as libc::c_int as size_t,
        ::core::mem::transmute::<ctf_hash_fun, htab_hash>(hash_fun),
        eq_fun,
        del,
        Some(xcalloc as unsafe extern "C" fn(size_t, size_t) -> *mut libc::c_void),
        Some(free as unsafe extern "C" fn(*mut libc::c_void) -> ()),
    );
    if ((*dynhash).htab).is_null() {
        free(dynhash as *mut libc::c_void);
        return 0 as *mut ctf_dynhash_t;
    }
    if key_free.is_some() || value_free.is_some() {
...
unsafe extern "C" fn ctf_hashtab_lookup(
    mut htab: *mut htab,
    mut key: *const libc::c_void,
    mut insert: insert_option,
) -> *mut *mut ctf_helem_t {
    let mut tmp: ctf_helem_t = {
        let mut init = ctf_helem {
            key: key as *mut libc::c_void,
            value: 0 as *mut libc::c_void,
            owner: 0 as *mut ctf_dynhash_t,
        };
        init
    };
    return htab_find_slot(
        htab,
        &mut tmp as *mut ctf_helem_t as *const libc::c_void,
        insert,
    ) as *mut *mut ctf_helem_t;
}
unsafe extern "C" fn ctf_hashtab_insert(
    mut htab: *mut htab,
    ...
    let mut slot: *mut *mut ctf_helem_t = 0 as *mut *mut ctf_helem_t;
    slot = ctf_hashtab_lookup(htab, key, INSERT);
    if slot.is_null() {
        *__errno_location() = 12 as libc::c_int;
        return 0 as *mut ctf_helem_t;
    }
    if (*slot).is_null() {
        if key_free.is_some() || value_free.is_some() {
            *slot = malloc(::core::mem::size_of::<ctf_helem_t>() as libc::c_ulong)
                as *mut ctf_helem_t;
        } else {
            *slot = malloc(16 as libc::c_ulong) as *mut ctf_helem_t;
        }
        if (*slot).is_null() {
            return 0 as *mut ctf_helem_t;
        }
        ...
        if key_free.is_some() {
            key_free.expect("non-null function pointer")(key);
        }
        if value_free.is_some() {
            value_free.expect("non-null function pointer")((**slot).value);
        }
    }
    (**slot).value = value;
    return *slot;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_insert(
    mut hp: *mut ctf_dynhash_t,
    mut key: *mut libc::c_void,
    mut value: *mut libc::c_void,
) -> libc::c_int {
    let mut slot: *mut ctf_helem_t = 0 as *mut ctf_helem_t;
    let mut key_free: ctf_hash_free_fun = None;
    let mut value_free: ctf_hash_free_fun = None;
    if (*(*hp).htab).del_f
        == Some(ctf_dynhash_item_free as unsafe extern "C" fn(*mut libc::c_void) -> ())
    {
        key_free = (*hp).key_free;
        value_free = (*hp).value_free;
    }
    slot = ctf_hashtab_insert((*hp).htab, key, value, key_free, value_free);
    if slot.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_remove(
    mut hp: *mut ctf_dynhash_t,
    mut key: *const libc::c_void,
) {
    let mut hep: ctf_helem_t = {
        let mut init = ctf_helem {
            key: key as *mut libc::c_void,
            value: 0 as *mut libc::c_void,
            owner: 0 as *mut ctf_dynhash_t,
    ...
    htab_remove_elt((*hp).htab, &mut hep as *mut ctf_helem_t as *const libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_empty(mut hp: *mut ctf_dynhash_t) {
    htab_empty((*hp).htab);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_elements(mut hp: *mut ctf_dynhash_t) -> size_t {
    return htab_elements((*hp).htab);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_lookup(
    mut hp: *mut ctf_dynhash_t,
    mut key: *const libc::c_void,
) -> *mut libc::c_void {
    let mut slot: *mut *mut ctf_helem_t = 0 as *mut *mut ctf_helem_t;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_lookup_kv(
    mut hp: *mut ctf_dynhash_t,
    mut key: *const libc::c_void,
    mut orig_key: *mut *const libc::c_void,
...
unsafe extern "C" fn ctf_hashtab_traverse(
    mut slot: *mut *mut libc::c_void,
    mut arg_: *mut libc::c_void,
) -> libc::c_int {
    let mut helem: *mut ctf_helem_t = *(slot as *mut *mut ctf_helem_t);
    let mut arg: *mut ctf_traverse_cb_arg_t = arg_ as *mut ctf_traverse_cb_arg_t;
    ((*arg).fun)
        .expect("non-null function pointer")((*helem).key, (*helem).value, (*arg).arg);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_iter(
    mut hp: *mut ctf_dynhash_t,
    mut fun: ctf_hash_iter_f,
    mut arg_: *mut libc::c_void,
) {
    let mut arg: ctf_traverse_cb_arg_t = {
        let mut init = ctf_traverse_cb_arg {
            fun: fun,
            arg: arg_,
        };
        init
    ...
    htab_traverse(
        ...
        &mut arg as *mut ctf_traverse_cb_arg_t as *mut libc::c_void,
    );
}
unsafe extern "C" fn ctf_hashtab_traverse_find(
    mut slot: *mut *mut libc::c_void,
    mut arg_: *mut libc::c_void,
) -> libc::c_int {
    let mut helem: *mut ctf_helem_t = *(slot as *mut *mut ctf_helem_t);
    let mut arg: *mut ctf_traverse_find_cb_arg_t = arg_
        as *mut ctf_traverse_find_cb_arg_t;
    if ((*arg).fun)
        .expect("non-null function pointer")((*helem).key, (*helem).value, (*arg).arg)
        != 0
    {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_iter_find(
    mut hp: *mut ctf_dynhash_t,
    mut fun: ctf_hash_iter_find_f,
    mut arg_: *mut libc::c_void,
) -> *mut libc::c_void {
    let mut arg: ctf_traverse_find_cb_arg_t = {
        let mut init = ctf_traverse_find_cb_arg {
            fun: fun,
            arg: arg_,
            found_key: 0 as *mut libc::c_void,
        };
        init
    };
    htab_traverse(
        ...
        &mut arg as *mut ctf_traverse_find_cb_arg_t as *mut libc::c_void,
    );
    return arg.found_key;
}
unsafe extern "C" fn ctf_hashtab_traverse_remove(
    mut slot: *mut *mut libc::c_void,
    mut arg_: *mut libc::c_void,
) -> libc::c_int {
    let mut helem: *mut ctf_helem_t = *(slot as *mut *mut ctf_helem_t);
    let mut arg: *mut ctf_traverse_remove_cb_arg_t = arg_
        as *mut ctf_traverse_remove_cb_arg_t;
    if ((*arg).fun)
        .expect("non-null function pointer")((*helem).key, (*helem).value, (*arg).arg)
        != 0
    {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_iter_remove(
    mut hp: *mut ctf_dynhash_t,
    mut fun: ctf_hash_iter_remove_f,
    mut arg_: *mut libc::c_void,
) {
    let mut arg: ctf_traverse_remove_cb_arg_t = {
        let mut init = ctf_traverse_remove_cb_arg {
            htab: (*hp).htab,
            fun: fun,
            arg: arg_,
        };
    ...
    htab_traverse(
        ...
        &mut arg as *mut ctf_traverse_remove_cb_arg_t as *mut libc::c_void,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_next(
    mut h: *mut ctf_dynhash_t,
    mut it: *mut *mut ctf_next_t,
    mut key: *mut *mut libc::c_void,
    mut value: *mut *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = *it;
    let mut slot: *mut ctf_helem_t = 0 as *mut ctf_helem_t;
    if i.is_null() {
        let mut size: size_t = htab_size((*h).htab);
        if (size as ssize_t) < 0 as libc::c_int as libc::c_long {
    ...
    {
        return ECTF_NEXT_WRONGFUN as libc::c_int;
    }
    if h != (*i).cu.ctn_h as *mut ctf_dynhash_t {
        return ECTF_NEXT_WRONGFP as libc::c_int;
    }
    if !((*i).ctn_n as ssize_t == (*i).ctn_size) {
        while ((*i).ctn_n as ssize_t) < (*i).ctn_size
            && ((*(*i).u.ctn_hash_slot).is_null()
                || *(*i).u.ctn_hash_slot == 1 as libc::c_int as *mut libc::c_void)
        {
            (*i).u.ctn_hash_slot = ((*i).u.ctn_hash_slot).offset(1);
            (*i).u.ctn_hash_slot;
            (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
            (*i).ctn_n;
        }
        if !((*i).ctn_n as ssize_t == (*i).ctn_size) {
            slot = *(*i).u.ctn_hash_slot as *mut ctf_helem_t;
            if !key.is_null() {
                *key = (*slot).key;
            }
            if !value.is_null() {
    ...
    *it = 0 as *mut ctf_next_t;
    return ECTF_NEXT_END as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_sort_by_name(
    mut one: *const ctf_next_hkv_t,
    mut two: *const ctf_next_hkv_t,
    mut unused: *mut libc::c_void,
) -> libc::c_int {
    return strcmp(
        (*one).hkv_key as *mut libc::c_char,
        (*two).hkv_key as *mut libc::c_char,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_next_sorted(
    mut h: *mut ctf_dynhash_t,
    mut it: *mut *mut ctf_next_t,
    mut key: *mut *mut libc::c_void,
    mut value: *mut *mut libc::c_void,
    mut sort_fun: ctf_hash_sort_f,
    mut sort_arg: *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = *it;
    if sort_fun.is_none() {
    ...
    if i.is_null() {
        let mut els: size_t = ctf_dynhash_elements(h);
        let mut accum_i: *mut ctf_next_t = 0 as *mut ctf_next_t;
        let mut key_0: *mut libc::c_void = 0 as *mut libc::c_void;
        let mut value_0: *mut libc::c_void = 0 as *mut libc::c_void;
        let mut err: libc::c_int = 0;
        let mut walk: *mut ctf_next_hkv_t = 0 as *mut ctf_next_hkv_t;
        if (els as ssize_t) < 0 as libc::c_int as libc::c_long {
            return 33 as libc::c_int;
        }
        i = ctf_next_create();
        if i.is_null() {
        ...
        (*i)
            .u
            .ctn_sorted_hkv = calloc(
            els,
            ::core::mem::size_of::<ctf_next_hkv_t>() as libc::c_ulong,
        ) as *mut ctf_next_hkv_t;
        if ((*i).u.ctn_sorted_hkv).is_null() {
            ctf_next_destroy(i);
            return 12 as libc::c_int;
        }
        ...
        (*i).cu.ctn_h = h;
        loop {
            err = ctf_dynhash_next(h, &mut accum_i, &mut key_0, &mut value_0);
            if !(err == 0 as libc::c_int) {
                break;
            }
            (*walk).hkv_key = key_0;
            (*walk).hkv_value = value_0;
            walk = walk.offset(1);
            walk;
        }
        ...
        if sort_fun.is_some() {
            ctf_qsort_r(
                (*i).u.ctn_sorted_hkv as *mut libc::c_void,
                els,
                ::core::mem::size_of::<ctf_next_hkv_t>() as libc::c_ulong,
                ::core::mem::transmute::<
                    ctf_hash_sort_f,
    ...
    if !key.is_null() {
        *key = (*((*i).u.ctn_sorted_hkv).offset((*i).ctn_n as isize)).hkv_key;
    }
    if !value.is_null() {
        *value = (*((*i).u.ctn_sorted_hkv).offset((*i).ctn_n as isize)).hkv_value;
    }
    (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
    (*i).ctn_n;
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynhash_destroy(mut hp: *mut ctf_dynhash_t) {
    if !hp.is_null() {
        htab_delete((*hp).htab);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_create(
    mut hash_fun: htab_hash,
    mut eq_fun: htab_eq,
    mut key_free: ctf_hash_free_fun,
) -> *mut ctf_dynset_t {
...
unsafe extern "C" fn key_to_internal(mut key: *const libc::c_void) -> *mut libc::c_void {
    if key.is_null() {
        return -(64 as libc::c_int) as uintptr_t as *mut libc::c_void
    } else if key == 1 as libc::c_int as *mut libc::c_void as *const libc::c_void {
        return -(63 as libc::c_int) as uintptr_t as *mut libc::c_void
    }
    return key as *mut libc::c_void;
}
unsafe extern "C" fn internal_to_key(
    mut internal: *const libc::c_void,
) -> *mut libc::c_void {
    if internal
        == -(64 as libc::c_int) as uintptr_t as *mut libc::c_void as *const libc::c_void
    {
        return 0 as *mut libc::c_void
    } else if internal
        == -(63 as libc::c_int) as uintptr_t as *mut libc::c_void as *const libc::c_void
    {
        return 1 as libc::c_int as *mut libc::c_void
    }
    return internal as *mut libc::c_void;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_insert(
    mut hp: *mut ctf_dynset_t,
    mut key: *mut libc::c_void,
) -> libc::c_int {
    let mut htab: *mut htab = hp as *mut htab;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_remove(
    mut hp: *mut ctf_dynset_t,
    mut key: *const libc::c_void,
) {
    htab_remove_elt(hp as *mut htab, key_to_internal(key));
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_destroy(mut hp: *mut ctf_dynset_t) {
    if !hp.is_null() {
        htab_delete(hp as *mut htab);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_lookup(
    mut hp: *mut ctf_dynset_t,
    mut key: *const libc::c_void,
) -> *mut libc::c_void {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_elements(mut hp: *mut ctf_dynset_t) -> size_t {
    return htab_elements(hp as *mut htab);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_exists(
    mut hp: *mut ctf_dynset_t,
    mut key: *const libc::c_void,
    mut orig_key: *mut *const libc::c_void,
) -> libc::c_int {
    ...
    if !orig_key.is_null() && !slot.is_null() {
        *orig_key = internal_to_key(*slot);
    }
    return (slot != 0 as *mut libc::c_void as *mut *mut libc::c_void) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_lookup_any(
    mut hp: *mut ctf_dynset_t,
) -> *mut libc::c_void {
    let mut htab: *mut htab = hp as *mut htab;
    let mut slot: *mut *mut libc::c_void = (*htab).entries;
    let mut limit: *mut *mut libc::c_void = slot.offset(htab_size(htab) as isize);
    while slot < limit
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dynset_next(
    mut hp: *mut ctf_dynset_t,
    mut it: *mut *mut ctf_next_t,
    mut key: *mut *mut libc::c_void,
) -> libc::c_int {
    let mut htab: *mut htab = hp as *mut htab;
    let mut i: *mut ctf_next_t = *it;
    let mut slot: *mut libc::c_void = 0 as *mut libc::c_void;
    if i.is_null() {
        let mut size: size_t = htab_size(htab);
        if (size as ssize_t) < 0 as libc::c_int as libc::c_long {
            return 33 as libc::c_int;
        }
        i = ctf_next_create();
    ...
    if hp != (*i).cu.ctn_s as *mut ctf_dynset_t {
        return ECTF_NEXT_WRONGFP as libc::c_int;
    }
    if !((*i).ctn_n as ssize_t == (*i).ctn_size) {
        while ((*i).ctn_n as ssize_t) < (*i).ctn_size
...
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_create(
    mut nelems: libc::c_ulong,
    mut hash_fun: ctf_hash_fun,
    mut eq_fun: ctf_hash_eq_fun,
) -> *mut ctf_hash_t {
    return htab_create_alloc(
...
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_size(mut hp: *const ctf_hash_t) -> uint32_t {
    return htab_elements(hp as *mut htab) as uint32_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_insert_type(
    mut hp: *mut ctf_hash_t,
    mut fp: *mut ctf_dict_t,
    mut type_0: uint32_t,
    mut name: uint32_t,
) -> libc::c_int {
    let mut str: *const libc::c_char = ctf_strraw(fp, name);
    if type_0 == 0 as libc::c_int as libc::c_uint {
        return 22 as libc::c_int;
    }
    if str.is_null() && name >> 31 as libc::c_int == 1 as libc::c_int as libc::c_uint
        && ((*fp).ctf_syn_ext_strtab).is_null()
        && ((*fp).ctf_str[(name >> 31 as libc::c_int) as usize].cts_strs).is_null()
    {
        return ECTF_STRTAB as libc::c_int;
    }
    if str.is_null() {
        return ECTF_BADNAME as libc::c_int;
    }
    if *str.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32 {
        return 0 as libc::c_int;
    }
    if !(ctf_hashtab_insert(
        hp as *mut htab,
        str as *mut libc::c_char as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_define_type(
    mut hp: *mut ctf_hash_t,
    mut fp: *mut ctf_dict_t,
    mut type_0: uint32_t,
    mut name: uint32_t,
) -> libc::c_int {
    return ctf_hash_insert_type(hp, fp, type_0, name);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_lookup_type(
    mut hp: *mut ctf_hash_t,
    mut fp: *mut ctf_dict_t,
    mut key: *const libc::c_char,
) -> ctf_id_t {
    let mut slot: *mut *mut ctf_helem_t = 0 as *mut *mut ctf_helem_t;
    slot = ctf_hashtab_lookup(hp as *mut htab, key as *const libc::c_void, NO_INSERT);
    if !slot.is_null() {
        return (**slot).value as uintptr_t;
    }
    return 0 as libc::c_int as ctf_id_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_hash_destroy(mut hp: *mut ctf_hash_t) {
    if !hp.is_null() {
        htab_delete(hp as *mut htab);
    }
}
