...
#[no_mangle]
pub unsafe extern "C" fn ctf_list_append(
    mut lp: *mut ctf_list_t,
    mut newp: *mut libc::c_void,
) {
    let mut p: *mut ctf_list_t = (*lp).l_prev;
    let mut q: *mut ctf_list_t = newp as *mut ctf_list_t;
    (*lp).l_prev = q;
    (*q).l_prev = p;
    (*q).l_next = 0 as *mut ctf_list;
    if !p.is_null() {
        (*p).l_next = q;
    } else {
        (*lp).l_next = q;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_list_prepend(
    mut lp: *mut ctf_list_t,
    mut newp: *mut libc::c_void,
) {
    let mut p: *mut ctf_list_t = newp as *mut ctf_list_t;
    let mut q: *mut ctf_list_t = (*lp).l_next;
    (*lp).l_next = p;
    (*p).l_prev = 0 as *mut ctf_list;
    (*p).l_next = q;
    if !q.is_null() {
        (*q).l_prev = p;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_list_delete(
    mut lp: *mut ctf_list_t,
    mut existing: *mut libc::c_void,
) {
    let mut p: *mut ctf_list_t = existing as *mut ctf_list_t;
    if !((*p).l_prev).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_list_empty_p(mut lp: *mut ctf_list_t) -> libc::c_int {
    return (((*lp).l_next).is_null() && ((*lp).l_prev).is_null()) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_list_splice(
    mut lp: *mut ctf_list_t,
    mut append: *mut ctf_list_t,
) {
    if ctf_list_empty_p(append) != 0 {
        return;
    }
    if !((*lp).l_prev).is_null() {
    ...
    (*append).l_next = 0 as *mut ctf_list;
    (*append).l_prev = 0 as *mut ctf_list;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_elf32_to_link_sym(
    mut fp: *mut ctf_dict_t,
    mut dst: *mut ctf_link_sym_t,
    mut src: *const Elf32_Sym,
    mut symidx: uint32_t,
) -> *mut ctf_link_sym_t {
    let mut tmp: Elf32_Sym = Elf32_Sym {
        st_name: 0,
        st_value: 0,
        st_size: 0,
        st_info: 0,
    ...
    let mut needs_flipping: libc::c_int = 0 as libc::c_int;
    if (*fp).ctf_symsect_little_endian == 0 {
        needs_flipping = 1 as libc::c_int;
    }
    memcpy(
        &mut tmp as *mut Elf32_Sym as *mut libc::c_void,
        src as *const libc::c_void,
        ::core::mem::size_of::<Elf32_Sym>() as libc::c_ulong,
    );
    if needs_flipping != 0 {
        match ::core::mem::size_of::<Elf32_Word>() as libc::c_ulong {
            2 => {
                tmp.st_name = __bswap_16(tmp.st_name as __uint16_t) as Elf32_Word;
            }
            4 => {
                tmp.st_name = __bswap_32(tmp.st_name);
            }
            8 => {
                tmp.st_name = __bswap_64(tmp.st_name as __uint64_t) as Elf32_Word;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<Elf32_Word>() as libc::c_ulong {
            2 => {
                tmp.st_size = __bswap_16(tmp.st_size as __uint16_t) as Elf32_Word;
            }
            4 => {
                tmp.st_size = __bswap_32(tmp.st_size);
            }
            8 => {
                tmp.st_size = __bswap_64(tmp.st_size as __uint64_t) as Elf32_Word;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<Elf32_Section>() as libc::c_ulong {
            2 => {
                tmp.st_shndx = __bswap_16(tmp.st_shndx);
            }
            4 => {
                tmp.st_shndx = __bswap_32(tmp.st_shndx as __uint32_t) as Elf32_Section;
            }
            8 => {
                tmp.st_shndx = __bswap_64(tmp.st_shndx as __uint64_t) as Elf32_Section;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<Elf32_Addr>() as libc::c_ulong {
            2 => {
                tmp.st_value = __bswap_16(tmp.st_value as __uint16_t) as Elf32_Addr;
            }
            4 => {
                tmp.st_value = __bswap_32(tmp.st_value);
            }
            8 => {
                tmp.st_value = __bswap_64(tmp.st_value as __uint64_t) as Elf32_Addr;
            }
            1 | _ => {}
        }
    }
    if (tmp.st_name as libc::c_ulong) < (*fp).ctf_str[1 as libc::c_int as usize].cts_len
    {
        (*dst)
            .st_name = ((*fp).ctf_str[1 as libc::c_int as usize].cts_strs)
            .offset(tmp.st_name as isize);
    } else {
        (*dst).st_name = _CTF_NULLSTR.as_ptr();
    }
    (*dst).st_nameidx_set = 0 as libc::c_int;
    (*dst).st_symidx = symidx;
    (*dst).st_shndx = tmp.st_shndx as uint32_t;
    (*dst).st_type = (tmp.st_info as libc::c_int & 0xf as libc::c_int) as uint32_t;
    (*dst).st_value = tmp.st_value;
    return dst;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_elf64_to_link_sym(
    mut fp: *mut ctf_dict_t,
    mut dst: *mut ctf_link_sym_t,
    mut src: *const Elf64_Sym,
    mut symidx: uint32_t,
) -> *mut ctf_link_sym_t {
    let mut tmp: Elf64_Sym = Elf64_Sym {
        st_name: 0,
        st_info: 0,
        st_other: 0,
        st_shndx: 0,
    ...
    memcpy(
        &mut tmp as *mut Elf64_Sym as *mut libc::c_void,
        src as *const libc::c_void,
        ::core::mem::size_of::<Elf64_Sym>() as libc::c_ulong,
    );
    if needs_flipping != 0 {
        match ::core::mem::size_of::<Elf64_Word>() as libc::c_ulong {
            2 => {
                tmp.st_name = __bswap_16(tmp.st_name as __uint16_t) as Elf64_Word;
            }
            4 => {
                tmp.st_name = __bswap_32(tmp.st_name);
            }
            8 => {
                tmp.st_name = __bswap_64(tmp.st_name as __uint64_t) as Elf64_Word;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<Elf64_Xword>() as libc::c_ulong {
            2 => {
                tmp.st_size = __bswap_16(tmp.st_size as __uint16_t) as Elf64_Xword;
            }
            4 => {
                tmp.st_size = __bswap_32(tmp.st_size as __uint32_t) as Elf64_Xword;
            }
            8 => {
                tmp.st_size = __bswap_64(tmp.st_size);
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<Elf64_Section>() as libc::c_ulong {
            2 => {
                tmp.st_shndx = __bswap_16(tmp.st_shndx);
            }
            4 => {
                tmp.st_shndx = __bswap_32(tmp.st_shndx as __uint32_t) as Elf64_Section;
            }
            8 => {
                tmp.st_shndx = __bswap_64(tmp.st_shndx as __uint64_t) as Elf64_Section;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<Elf64_Addr>() as libc::c_ulong {
            2 => {
                tmp.st_value = __bswap_16(tmp.st_value as __uint16_t) as Elf64_Addr;
            }
            4 => {
                tmp.st_value = __bswap_32(tmp.st_value as __uint32_t) as Elf64_Addr;
            }
            8 => {
                tmp.st_value = __bswap_64(tmp.st_value);
            }
            1 | _ => {}
        }
    }
    ...
    (*dst).st_shndx = tmp.st_shndx as uint32_t;
    (*dst).st_type = (tmp.st_info as libc::c_int & 0xf as libc::c_int) as uint32_t;
    if (tmp.st_value != 0 as libc::c_int as libc::c_ulong
        && tmp.st_value as uint32_t == 0 as libc::c_int as libc::c_uint) as libc::c_int
        as libc::c_long != 0
    {
        (*dst).st_value = 1 as libc::c_int as uint32_t;
    } else {
        (*dst).st_value = tmp.st_value as uint32_t;
    }
    return dst;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_str_append(
    mut s: *mut libc::c_char,
    mut append: *const libc::c_char,
) -> *mut libc::c_char {
    let mut s_len: size_t = 0 as libc::c_int as size_t;
    if append.is_null() {
        return s;
    }
    if !s.is_null() {
    ...
    let mut append_len: size_t = strlen(append);
    s = realloc(
        s as *mut libc::c_void,
        s_len.wrapping_add(append_len).wrapping_add(1 as libc::c_int as libc::c_ulong),
    ) as *mut libc::c_char;
    if s.is_null() {
        return 0 as *mut libc::c_char;
    }
    memcpy(
        s.offset(s_len as isize) as *mut libc::c_void,
        append as *const libc::c_void,
        append_len,
    );
    *s.offset(s_len.wrapping_add(append_len) as isize) = '\0' as i32 as libc::c_char;
    return s;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_str_append_noerr(
    mut s: *mut libc::c_char,
    mut append: *const libc::c_char,
) -> *mut libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_realloc(
    mut fp: *mut ctf_dict_t,
    ...
    if (*fp).ctf_str_num_refs > 0 as libc::c_int as libc::c_ulong {
        ctf_dprintf(
            b"%p: attempt to realloc() string table with %lu active refs\n\0"
...
#[no_mangle]
pub unsafe extern "C" fn ctf_set_open_errno(
...
#[no_mangle]
pub unsafe extern "C" fn ctf_set_errno(
    mut fp: *mut ctf_dict_t,
    mut err: libc::c_int,
) -> libc::c_ulong {
    (*fp).ctf_errno = err;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_next_create() -> *mut ctf_next_t {
    return calloc(
        1 as libc::c_int as libc::c_ulong,
        ::core::mem::size_of::<ctf_next>() as libc::c_ulong,
    ) as *mut ctf_next_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_next_destroy(mut i: *mut ctf_next_t) {
    if i.is_null() {
        return;
    }
    if (*i).ctn_iter_fun
    ...
    {
        free((*i).u.ctn_sorted_hkv as *mut libc::c_void);
    }
    if !((*i).ctn_next).is_null() {
        ctf_next_destroy((*i).ctn_next);
    }
    free(i as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_next_copy(mut i: *mut ctf_next_t) -> *mut ctf_next_t {
    let mut i2: *mut ctf_next_t = 0 as *mut ctf_next_t;
    i2 = ctf_next_create();
    if i2.is_null() {
        return 0 as *mut ctf_next_t;
    }
    memcpy(
        i2 as *mut libc::c_void,
    ...
    {
        let mut els: size_t = ctf_dynhash_elements((*i).cu.ctn_h as *mut ctf_dynhash_t);
        (*i2)
            .u
        ...
        if ((*i2).u.ctn_sorted_hkv).is_null() {
            free(i2 as *mut libc::c_void);
            return 0 as *mut ctf_next_t;
        }
        memcpy(
            (*i2).u.ctn_sorted_hkv as *mut libc::c_void,
            (*i).u.ctn_sorted_hkv as *const libc::c_void,
            els.wrapping_mul(::core::mem::size_of::<ctf_next_hkv_t>() as libc::c_ulong),
        );
    }
    return i2;
}
