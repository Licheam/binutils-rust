...
pub struct C2RustUnnamed_7 {
    pub ctf_errstrECTF_FMT: [libc::c_char; 34],
    pub ctf_errstrECTF_BFDERR: [libc::c_char; 11],
    pub ctf_errstrECTF_CTFVERS: [libc::c_char; 40],
    pub ctf_errstrECTF_BFD_AMBIGUOUS: [libc::c_char; 22],
    pub ctf_errstrECTF_SYMTAB: [libc::c_char; 38],
    pub ctf_errstrECTF_SYMBAD: [libc::c_char; 39],
    pub ctf_errstrECTF_STRBAD: [libc::c_char; 39],
    pub ctf_errstrECTF_CORRUPT: [libc::c_char; 41],
    pub ctf_errstrECTF_NOCTFDATA: [libc::c_char; 32],
    pub ctf_errstrECTF_NOCTFBUF: [libc::c_char; 34],
    pub ctf_errstrECTF_NOSYMTAB: [libc::c_char; 43],
    pub ctf_errstrECTF_NOPARENT: [libc::c_char; 42],
    pub ctf_errstrECTF_DMODEL: [libc::c_char; 21],
    pub ctf_errstrECTF_LINKADDEDLATE: [libc::c_char; 29],
    pub ctf_errstrECTF_ZALLOC: [libc::c_char; 43],
    pub ctf_errstrECTF_DECOMPRESS: [libc::c_char; 31],
    pub ctf_errstrECTF_STRTAB: [libc::c_char; 40],
    pub ctf_errstrECTF_BADNAME: [libc::c_char; 31],
    pub ctf_errstrECTF_BADID: [libc::c_char; 25],
    pub ctf_errstrECTF_NOTSOU: [libc::c_char; 31],
    pub ctf_errstrECTF_NOTENUM: [libc::c_char; 21],
    pub ctf_errstrECTF_NOTSUE: [libc::c_char; 38],
    pub ctf_errstrECTF_NOTINTFP: [libc::c_char; 40],
    pub ctf_errstrECTF_NOTARRAY: [libc::c_char; 22],
    pub ctf_errstrECTF_NOTREF: [libc::c_char; 38],
    pub ctf_errstrECTF_NAMELEN: [libc::c_char; 39],
    pub ctf_errstrECTF_NOTYPE: [libc::c_char; 37],
    pub ctf_errstrECTF_SYNTAX: [libc::c_char; 27],
    pub ctf_errstrECTF_NOTFUNC: [libc::c_char; 46],
    pub ctf_errstrECTF_NOFUNCDAT: [libc::c_char; 48],
    pub ctf_errstrECTF_NOTDATA: [libc::c_char; 52],
    pub ctf_errstrECTF_NOTYPEDAT: [libc::c_char; 42],
    pub ctf_errstrECTF_NOLABEL: [libc::c_char; 38],
    pub ctf_errstrECTF_NOLABELDATA: [libc::c_char; 34],
    pub ctf_errstrECTF_NOTSUP: [libc::c_char; 23],
    pub ctf_errstrECTF_NOENUMNAM: [libc::c_char; 29],
    pub ctf_errstrECTF_NOMEMBNAM: [libc::c_char; 23],
    pub ctf_errstrECTF_RDONLY: [libc::c_char; 28],
    pub ctf_errstrECTF_DTFULL: [libc::c_char; 44],
    pub ctf_errstrECTF_FULL: [libc::c_char; 23],
    pub ctf_errstrECTF_DUPLICATE: [libc::c_char; 35],
    pub ctf_errstrECTF_CONFLICT: [libc::c_char; 37],
    pub ctf_errstrECTF_OVERROLLBACK: [libc::c_char; 40],
    pub ctf_errstrECTF_COMPRESS: [libc::c_char; 29],
    pub ctf_errstrECTF_ARCREATE: [libc::c_char; 28],
    pub ctf_errstrECTF_ARNNAME: [libc::c_char; 31],
    pub ctf_errstrECTF_SLICEOVERFLOW: [libc::c_char; 45],
    pub ctf_errstrECTF_DUMPSECTUNKNOWN: [libc::c_char; 32],
    pub ctf_errstrECTF_DUMPSECTCHANGED: [libc::c_char; 35],
    pub ctf_errstrECTF_NOTYET: [libc::c_char; 29],
    pub ctf_errstrECTF_INTERNAL: [libc::c_char; 35],
    pub ctf_errstrECTF_NONREPRESENTABLE: [libc::c_char; 31],
    pub ctf_errstrECTF_NEXT_END: [libc::c_char; 18],
    pub ctf_errstrECTF_NEXT_WRONGFUN: [libc::c_char; 33],
    pub ctf_errstrECTF_NEXT_WRONGFP: [libc::c_char; 41],
    pub ctf_errstrECTF_FLAGS: [libc::c_char; 45],
    pub ctf_errstrECTF_NEEDSBFD: [libc::c_char; 46],
    pub ctf_errstrECTF_INCOMPLETE: [libc::c_char; 29],
    pub ctf_errstrECTF_NONAME: [libc::c_char; 29],
}
static mut _ctf_errlist: _ctf_errlist_t = unsafe {
    _ctf_errlist_t {
        c2rust_unnamed: {
            let mut init = C2RustUnnamed_7 {
                ctf_errstrECTF_FMT: *::core::mem::transmute::<
                    &[u8; 34],
                    &mut [libc::c_char; 34],
                >(b"File is not in CTF or ELF format.\0"),
                ctf_errstrECTF_BFDERR: *::core::mem::transmute::<
                    &[u8; 11],
                    &mut [libc::c_char; 11],
                >(b"BFD error.\0"),
                ctf_errstrECTF_CTFVERS: *::core::mem::transmute::<
                    &[u8; 40],
                    &mut [libc::c_char; 40],
                >(b"CTF dict version is too new for libctf.\0"),
                ctf_errstrECTF_BFD_AMBIGUOUS: *::core::mem::transmute::<
                    &[u8; 22],
                    &mut [libc::c_char; 22],
                >(b"Ambiguous BFD target.\0"),
                ctf_errstrECTF_SYMTAB: *::core::mem::transmute::<
                    &[u8; 38],
                    &mut [libc::c_char; 38],
                >(b"Symbol table uses invalid entry size.\0"),
                ctf_errstrECTF_SYMBAD: *::core::mem::transmute::<
                    &[u8; 39],
                    &mut [libc::c_char; 39],
                >(b"Symbol table data buffer is not valid.\0"),
                ctf_errstrECTF_STRBAD: *::core::mem::transmute::<
                    &[u8; 39],
                    &mut [libc::c_char; 39],
                >(b"String table data buffer is not valid.\0"),
                ctf_errstrECTF_CORRUPT: *::core::mem::transmute::<
                    &[u8; 41],
                    &mut [libc::c_char; 41],
                >(b"File data structure corruption detected.\0"),
                ctf_errstrECTF_NOCTFDATA: *::core::mem::transmute::<
                    &[u8; 32],
                    &mut [libc::c_char; 32],
                >(b"File does not contain CTF data.\0"),
                ctf_errstrECTF_NOCTFBUF: *::core::mem::transmute::<
                    &[u8; 34],
                    &mut [libc::c_char; 34],
                >(b"Buffer does not contain CTF data.\0"),
                ctf_errstrECTF_NOSYMTAB: *::core::mem::transmute::<
                    &[u8; 43],
                    &mut [libc::c_char; 43],
                >(b"Symbol table information is not available.\0"),
                ctf_errstrECTF_NOPARENT: *::core::mem::transmute::<
                    &[u8; 42],
                    &mut [libc::c_char; 42],
                >(b"The parent CTF dictionary is unavailable.\0"),
                ctf_errstrECTF_DMODEL: *::core::mem::transmute::<
                    &[u8; 21],
                    &mut [libc::c_char; 21],
                >(b"Data model mismatch.\0"),
                ctf_errstrECTF_LINKADDEDLATE: *::core::mem::transmute::<
                    &[u8; 29],
                    &mut [libc::c_char; 29],
                >(b"File added to link too late.\0"),
                ctf_errstrECTF_ZALLOC: *::core::mem::transmute::<
                    &[u8; 43],
                    &mut [libc::c_char; 43],
                >(b"Failed to allocate (de)compression buffer.\0"),
                ctf_errstrECTF_DECOMPRESS: *::core::mem::transmute::<
                    &[u8; 31],
                    &mut [libc::c_char; 31],
                >(b"Failed to decompress CTF data.\0"),
                ctf_errstrECTF_STRTAB: *::core::mem::transmute::<
                    &[u8; 40],
                    &mut [libc::c_char; 40],
                >(b"External string table is not available.\0"),
                ctf_errstrECTF_BADNAME: *::core::mem::transmute::<
                    &[u8; 31],
                    &mut [libc::c_char; 31],
                >(b"String name offset is corrupt.\0"),
                ctf_errstrECTF_BADID: *::core::mem::transmute::<
                    &[u8; 25],
                    &mut [libc::c_char; 25],
                >(b"Invalid type identifier.\0"),
                ctf_errstrECTF_NOTSOU: *::core::mem::transmute::<
                    &[u8; 31],
                    &mut [libc::c_char; 31],
                >(b"Type is not a struct or union.\0"),
                ctf_errstrECTF_NOTENUM: *::core::mem::transmute::<
                    &[u8; 21],
                    &mut [libc::c_char; 21],
                >(b"Type is not an enum.\0"),
                ctf_errstrECTF_NOTSUE: *::core::mem::transmute::<
                    &[u8; 38],
                    &mut [libc::c_char; 38],
                >(b"Type is not a struct, union, or enum.\0"),
                ctf_errstrECTF_NOTINTFP: *::core::mem::transmute::<
                    &[u8; 40],
                    &mut [libc::c_char; 40],
                >(b"Type is not an integer, float, or enum.\0"),
                ctf_errstrECTF_NOTARRAY: *::core::mem::transmute::<
                    &[u8; 22],
                    &mut [libc::c_char; 22],
                >(b"Type is not an array.\0"),
                ctf_errstrECTF_NOTREF: *::core::mem::transmute::<
                    &[u8; 38],
                    &mut [libc::c_char; 38],
                >(b"Type does not reference another type.\0"),
                ctf_errstrECTF_NAMELEN: *::core::mem::transmute::<
                    &[u8; 39],
                    &mut [libc::c_char; 39],
                >(b"Buffer is too small to hold type name.\0"),
                ctf_errstrECTF_NOTYPE: *::core::mem::transmute::<
                    &[u8; 37],
                    &mut [libc::c_char; 37],
                >(b"No type found corresponding to name.\0"),
                ctf_errstrECTF_SYNTAX: *::core::mem::transmute::<
                    &[u8; 27],
                    &mut [libc::c_char; 27],
                >(b"Syntax error in type name.\0"),
                ctf_errstrECTF_NOTFUNC: *::core::mem::transmute::<
                    &[u8; 46],
                    &mut [libc::c_char; 46],
                >(b"Symbol table entry or type is not a function.\0"),
                ctf_errstrECTF_NOFUNCDAT: *::core::mem::transmute::<
                    &[u8; 48],
                    &mut [libc::c_char; 48],
                >(b"No function information available for function.\0"),
                ctf_errstrECTF_NOTDATA: *::core::mem::transmute::<
                    &[u8; 52],
                    &mut [libc::c_char; 52],
                >(b"Symbol table entry does not refer to a data object.\0"),
                ctf_errstrECTF_NOTYPEDAT: *::core::mem::transmute::<
                    &[u8; 42],
                    &mut [libc::c_char; 42],
                >(b"No type information available for symbol.\0"),
                ctf_errstrECTF_NOLABEL: *::core::mem::transmute::<
                    &[u8; 38],
                    &mut [libc::c_char; 38],
                >(b"No label found corresponding to name.\0"),
                ctf_errstrECTF_NOLABELDATA: *::core::mem::transmute::<
                    &[u8; 34],
                    &mut [libc::c_char; 34],
                >(b"File does not contain any labels.\0"),
                ctf_errstrECTF_NOTSUP: *::core::mem::transmute::<
                    &[u8; 23],
                    &mut [libc::c_char; 23],
                >(b"Feature not supported.\0"),
                ctf_errstrECTF_NOENUMNAM: *::core::mem::transmute::<
                    &[u8; 29],
                    &mut [libc::c_char; 29],
                >(b"Enum element name not found.\0"),
                ctf_errstrECTF_NOMEMBNAM: *::core::mem::transmute::<
                    &[u8; 23],
                    &mut [libc::c_char; 23],
                >(b"Member name not found.\0"),
                ctf_errstrECTF_RDONLY: *::core::mem::transmute::<
                    &[u8; 28],
                    &mut [libc::c_char; 28],
                >(b"CTF container is read-only.\0"),
                ctf_errstrECTF_DTFULL: *::core::mem::transmute::<
                    &[u8; 44],
                    &mut [libc::c_char; 44],
                >(b"CTF type is full (no more members allowed).\0"),
                ctf_errstrECTF_FULL: *::core::mem::transmute::<
                    &[u8; 23],
                    &mut [libc::c_char; 23],
                >(b"CTF container is full.\0"),
                ctf_errstrECTF_DUPLICATE: *::core::mem::transmute::<
                    &[u8; 35],
                    &mut [libc::c_char; 35],
                >(b"Duplicate member or variable name.\0"),
                ctf_errstrECTF_CONFLICT: *::core::mem::transmute::<
                    &[u8; 37],
                    &mut [libc::c_char; 37],
                >(b"Conflicting type is already defined.\0"),
                ctf_errstrECTF_OVERROLLBACK: *::core::mem::transmute::<
                    &[u8; 40],
                    &mut [libc::c_char; 40],
                >(b"Attempt to roll back past a ctf_update.\0"),
                ctf_errstrECTF_COMPRESS: *::core::mem::transmute::<
                    &[u8; 29],
                    &mut [libc::c_char; 29],
                >(b"Failed to compress CTF data.\0"),
                ctf_errstrECTF_ARCREATE: *::core::mem::transmute::<
                    &[u8; 28],
                    &mut [libc::c_char; 28],
                >(b"Error creating CTF archive.\0"),
                ctf_errstrECTF_ARNNAME: *::core::mem::transmute::<
                    &[u8; 31],
                    &mut [libc::c_char; 31],
                >(b"Name not found in CTF archive.\0"),
                ctf_errstrECTF_SLICEOVERFLOW: *::core::mem::transmute::<
                    &[u8; 45],
                    &mut [libc::c_char; 45],
                >(b"Overflow of type bitness or offset in slice.\0"),
                ctf_errstrECTF_DUMPSECTUNKNOWN: *::core::mem::transmute::<
                    &[u8; 32],
                    &mut [libc::c_char; 32],
                >(b"Unknown section number in dump.\0"),
                ctf_errstrECTF_DUMPSECTCHANGED: *::core::mem::transmute::<
                    &[u8; 35],
                    &mut [libc::c_char; 35],
                >(b"Section changed in middle of dump.\0"),
                ctf_errstrECTF_NOTYET: *::core::mem::transmute::<
                    &[u8; 29],
                    &mut [libc::c_char; 29],
                >(b"Feature not yet implemented.\0"),
                ctf_errstrECTF_INTERNAL: *::core::mem::transmute::<
                    &[u8; 35],
                    &mut [libc::c_char; 35],
                >(b"Internal error: assertion failure.\0"),
                ctf_errstrECTF_NONREPRESENTABLE: *::core::mem::transmute::<
                    &[u8; 31],
                    &mut [libc::c_char; 31],
                >(b"Type not representable in CTF.\0"),
                ctf_errstrECTF_NEXT_END: *::core::mem::transmute::<
                    &[u8; 18],
                    &mut [libc::c_char; 18],
                >(b"End of iteration.\0"),
                ctf_errstrECTF_NEXT_WRONGFUN: *::core::mem::transmute::<
                    &[u8; 33],
                    &mut [libc::c_char; 33],
                >(b"Wrong iteration function called.\0"),
                ctf_errstrECTF_NEXT_WRONGFP: *::core::mem::transmute::<
                    &[u8; 41],
                    &mut [libc::c_char; 41],
                >(b"Iteration entity changed in mid-iterate.\0"),
                ctf_errstrECTF_FLAGS: *::core::mem::transmute::<
                    &[u8; 45],
                    &mut [libc::c_char; 45],
                >(b"CTF header contains flags unknown to libctf.\0"),
                ctf_errstrECTF_NEEDSBFD: *::core::mem::transmute::<
                    &[u8; 46],
                    &mut [libc::c_char; 46],
                >(b"This feature needs a libctf with BFD support.\0"),
                ctf_errstrECTF_INCOMPLETE: *::core::mem::transmute::<
                    &[u8; 29],
                    &mut [libc::c_char; 29],
                >(b"Type is not a complete type.\0"),
                ctf_errstrECTF_NONAME: *::core::mem::transmute::<
                    &[u8; 29],
                    &mut [libc::c_char; 29],
                >(b"Type name must not be empty.\0"),
            };
            init
        },
    }
};
static mut _ctf_erridx: [libc::c_uint; 59] = [
    0 as libc::c_ulong as libc::c_uint,
    34 as libc::c_ulong as libc::c_uint,
    45 as libc::c_ulong as libc::c_uint,
    85 as libc::c_ulong as libc::c_uint,
    107 as libc::c_ulong as libc::c_uint,
    145 as libc::c_ulong as libc::c_uint,
    184 as libc::c_ulong as libc::c_uint,
    223 as libc::c_ulong as libc::c_uint,
    264 as libc::c_ulong as libc::c_uint,
    296 as libc::c_ulong as libc::c_uint,
    330 as libc::c_ulong as libc::c_uint,
    373 as libc::c_ulong as libc::c_uint,
    415 as libc::c_ulong as libc::c_uint,
    436 as libc::c_ulong as libc::c_uint,
    465 as libc::c_ulong as libc::c_uint,
    508 as libc::c_ulong as libc::c_uint,
    539 as libc::c_ulong as libc::c_uint,
    579 as libc::c_ulong as libc::c_uint,
    610 as libc::c_ulong as libc::c_uint,
    635 as libc::c_ulong as libc::c_uint,
    666 as libc::c_ulong as libc::c_uint,
    687 as libc::c_ulong as libc::c_uint,
    725 as libc::c_ulong as libc::c_uint,
    765 as libc::c_ulong as libc::c_uint,
    787 as libc::c_ulong as libc::c_uint,
    825 as libc::c_ulong as libc::c_uint,
    864 as libc::c_ulong as libc::c_uint,
    901 as libc::c_ulong as libc::c_uint,
    928 as libc::c_ulong as libc::c_uint,
    974 as libc::c_ulong as libc::c_uint,
    1022 as libc::c_ulong as libc::c_uint,
    1074 as libc::c_ulong as libc::c_uint,
    1116 as libc::c_ulong as libc::c_uint,
    1154 as libc::c_ulong as libc::c_uint,
    1188 as libc::c_ulong as libc::c_uint,
    1211 as libc::c_ulong as libc::c_uint,
    1240 as libc::c_ulong as libc::c_uint,
    1263 as libc::c_ulong as libc::c_uint,
    1291 as libc::c_ulong as libc::c_uint,
    1335 as libc::c_ulong as libc::c_uint,
    1358 as libc::c_ulong as libc::c_uint,
    1393 as libc::c_ulong as libc::c_uint,
    1430 as libc::c_ulong as libc::c_uint,
    1470 as libc::c_ulong as libc::c_uint,
    1499 as libc::c_ulong as libc::c_uint,
    1527 as libc::c_ulong as libc::c_uint,
    1558 as libc::c_ulong as libc::c_uint,
    1603 as libc::c_ulong as libc::c_uint,
    1635 as libc::c_ulong as libc::c_uint,
    1670 as libc::c_ulong as libc::c_uint,
    1699 as libc::c_ulong as libc::c_uint,
    1734 as libc::c_ulong as libc::c_uint,
    1765 as libc::c_ulong as libc::c_uint,
    1783 as libc::c_ulong as libc::c_uint,
    1816 as libc::c_ulong as libc::c_uint,
    1857 as libc::c_ulong as libc::c_uint,
    1902 as libc::c_ulong as libc::c_uint,
    1948 as libc::c_ulong as libc::c_uint,
    1977 as libc::c_ulong as libc::c_uint,
];
#[no_mangle]
pub unsafe extern "C" fn ctf_errmsg(mut error: libc::c_int) -> *const libc::c_char {
    let mut str: *const libc::c_char = 0 as *const libc::c_char;
    if error >= 1000 as libc::c_int
        && (error - 1000 as libc::c_int)
            < ECTF_NONAME as libc::c_int - 1000 as libc::c_int + 1 as libc::c_int
    {
        str = (_ctf_errlist.str_0)
            .as_ptr()
            .offset(_ctf_erridx[(error - 1000 as libc::c_int) as usize] as isize);
    } else {
        str = strerror(error) as *const libc::c_char;
    }
    return if !str.is_null() {
        dcgettext(b"libctf\0" as *const u8 as *const libc::c_char, str, 5 as libc::c_int)
    } else {
        dcgettext(
...
#[no_mangle]
pub unsafe extern "C" fn ctf_errno(mut fp: *mut ctf_dict_t) -> libc::c_int {
    return (*fp).ctf_errno;
}
