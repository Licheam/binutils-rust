...
extern "C" {
    ...
    fn ctf_next_create() -> *mut ctf_next_t;
    ...
    fn ctf_decl_fini(_: *mut ctf_decl_t);
    fn ctf_decl_buf(cd: *mut ctf_decl_t) -> *mut libc::c_char;
    fn ctf_decl_sprintf(_: *mut ctf_decl_t, _: *const libc::c_char, _: ...);
    fn ctf_strptr(_: *mut ctf_dict_t, _: uint32_t) -> *const libc::c_char;
    fn ctf_decl_push(_: *mut ctf_decl_t, _: *mut ctf_dict_t, _: ctf_id_t);
    fn ctf_decl_init(_: *mut ctf_decl_t);
    ...
    fn ctf_dtd_lookup(_: *const ctf_dict_t, _: ctf_id_t) -> *mut ctf_dtdef_t;
...
pub type ctf_visit_f = unsafe extern "C" fn(
    *const libc::c_char,
    ctf_id_t,
    libc::c_ulong,
    libc::c_int,
...
pub type ctf_variable_f = unsafe extern "C" fn(
    *const libc::c_char,
    ctf_id_t,
    *mut libc::c_void,
) -> libc::c_int;
pub type ctf_type_f = unsafe extern "C" fn(ctf_id_t, *mut libc::c_void) -> libc::c_int;
pub type ctf_type_all_f = unsafe extern "C" fn(
    ctf_id_t,
    libc::c_int,
    *mut libc::c_void,
) -> libc::c_int;
...
pub type ctf_decl_t = ctf_decl;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_decl {
    pub cd_nodes: [ctf_list_t; 4],
    pub cd_order: [libc::c_int; 4],
    pub cd_qualp: ctf_decl_prec_t,
    pub cd_ordp: ctf_decl_prec_t,
    pub cd_buf: *mut libc::c_char,
    pub cd_err: libc::c_int,
    pub cd_enomem: libc::c_int,
}
pub type ctf_decl_prec_t = libc::c_uint;
pub const CTF_PREC_MAX: ctf_decl_prec_t = 4;
pub const CTF_PREC_FUNCTION: ctf_decl_prec_t = 3;
pub const CTF_PREC_ARRAY: ctf_decl_prec_t = 2;
pub const CTF_PREC_POINTER: ctf_decl_prec_t = 1;
pub const CTF_PREC_BASE: ctf_decl_prec_t = 0;
pub type ctf_decl_node_t = ctf_decl_node;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_decl_node {
    pub cd_list: ctf_list_t,
    pub cd_type: ctf_id_t,
    pub cd_kind: uint32_t,
    pub cd_n: uint32_t,
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_isparent(
    mut fp: *mut ctf_dict_t,
    mut id: ctf_id_t,
) -> libc::c_int {
    return (id <= (*fp).ctf_parmax as libc::c_ulong) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_ischild(
    mut fp: *mut ctf_dict_t,
    mut id: ctf_id_t,
) -> libc::c_int {
    return (id > (*fp).ctf_parmax as libc::c_ulong) as libc::c_int;
}
unsafe extern "C" fn ctf_struct_member(
    mut fp: *mut ctf_dict_t,
    mut dst: *mut ctf_lmember_t,
    mut tp: *const ctf_type_t,
    mut vlen: *mut libc::c_uchar,
    mut vbytes: size_t,
    mut n: size_t,
) -> libc::c_int {
    if ctf_assert_internal(
        fp,
        b"ctf-types.c\0" as *const u8 as *const libc::c_char,
        44 as libc::c_int as size_t,
        b"n < LCTF_INFO_VLEN (fp, tp->ctt_info)\0" as *const u8 as *const libc::c_char,
        (n
            < ((*(*fp).ctf_dictops).ctfo_get_vlen)
    ...
    if (*tp).c2rust_unnamed.ctt_size == 0xffffffff as libc::c_uint {
        let mut lmp: *mut ctf_lmember_t = vlen as *mut ctf_lmember_t;
        if ctf_assert_internal(
            fp,
            b"ctf-types.c\0" as *const u8 as *const libc::c_char,
            52 as libc::c_int as size_t,
            b"(n + 1) * sizeof (ctf_lmember_t) <= vbytes\0" as *const u8
                as *const libc::c_char,
            (n
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<ctf_lmember_t>() as libc::c_ulong)
                <= vbytes) as libc::c_int,
        ) as libc::c_long == 0
        {
            return -(1 as libc::c_int);
        }
        memcpy(
            ...
            &mut *lmp.offset(n as isize) as *mut ctf_lmember_t as *const libc::c_void,
            ::core::mem::size_of::<ctf_lmember_t>() as libc::c_ulong,
        );
    } else {
        let mut mp: *mut ctf_member_t = vlen as *mut ctf_member_t;
        (*dst).ctlm_name = (*mp.offset(n as isize)).ctm_name;
        (*dst).ctlm_type = (*mp.offset(n as isize)).ctm_type;
        (*dst).ctlm_offsetlo = (*mp.offset(n as isize)).ctm_offset;
        (*dst).ctlm_offsethi = 0 as libc::c_int as uint32_t;
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_member_iter(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut func: Option::<ctf_member_f>,
    ...
    loop {
        ...
        rc = func
            ...
            )(name, membtype, offset as libc::c_ulong, arg);
        if rc != 0 as libc::c_int {
            ctf_next_destroy(i);
            return rc;
        }
    }
    if ctf_errno(fp) != ECTF_NEXT_END as libc::c_int {
        return -(1 as libc::c_int);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_member_next(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut it: *mut *mut ctf_next_t,
    mut name: *mut *const libc::c_char,
    mut membtype: *mut ctf_id_t,
    mut flags: libc::c_int,
) -> ssize_t {
    let mut ofp: *mut ctf_dict_t = fp;
    let mut kind: uint32_t = 0;
    let mut offset: ssize_t = 0;
    let mut max_vlen: uint32_t = 0;
    let mut i: *mut ctf_next_t = *it;
    if i.is_null() {
        ...
        type_0 = ctf_type_resolve(fp, type_0);
        if type_0 == -(1 as libc::c_long) as ctf_id_t {
            return -(1 as libc::c_int) as ssize_t;
        }
        tp = ctf_lookup_by_id(&mut fp, type_0);
        if tp.is_null() {
            return -(1 as libc::c_int) as ssize_t;
        }
        i = ctf_next_create();
        if i.is_null() {
            return ctf_set_errno(ofp, 12 as libc::c_int) as ssize_t;
        }
        (*i).cu.ctn_fp = ofp;
        (*i).ctn_tp = tp;
        ...
        {
            ctf_next_destroy(i);
            return ctf_set_errno(ofp, ECTF_NOTSOU as libc::c_int) as ssize_t;
        }
        dtd = ctf_dynamic_type(fp, type_0);
        if !dtd.is_null() {
            (*i).u.ctn_vlen = (*dtd).dtd_vlen;
            (*i).ctn_size = (*dtd).dtd_vlen_alloc as ssize_t;
        } else {
            let mut vlen: libc::c_ulong = ((*(*fp).ctf_dictops).ctfo_get_vlen)
                .expect("non-null function pointer")((*tp).ctt_info) as libc::c_ulong;
            (*i).u.ctn_vlen = (tp as *mut libc::c_uchar).offset(increment as isize);
            (*i)
                .ctn_size = ((*(*fp).ctf_dictops).ctfo_get_vbytes)
                .expect(
                    "non-null function pointer",
                )(fp, kind as libc::c_ushort, size, vlen);
        }
        (*i)
            .ctn_iter_fun = ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(
                    *mut ctf_dict_t,
                    ctf_id_t,
        ...
        (*i).ctn_n = 0 as libc::c_int as uint32_t;
        *it = i;
    }
    ...
    {
        return ctf_set_errno(ofp, ECTF_NEXT_WRONGFUN as libc::c_int) as ssize_t;
    }
    if ofp != (*i).cu.ctn_fp as *mut ctf_dict_t {
        return ctf_set_errno(ofp, ECTF_NEXT_WRONGFP as libc::c_int) as ssize_t;
    }
    fp = ctf_get_dict(ofp, type_0);
    if fp.is_null() {
        return ctf_set_errno(ofp, ECTF_NOPARENT as libc::c_int) as ssize_t;
    }
    max_vlen = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*(*i).ctn_tp).ctt_info);
    while !((*i).ctn_type == 0) {
        let mut ret: ssize_t = ctf_member_next(
            fp,
            (*i).ctn_type,
            &mut (*i).ctn_next,
            name,
        ...
        if ctf_errno(fp) != ECTF_NEXT_END as libc::c_int {
            ctf_next_destroy(i);
            *it = 0 as *mut ctf_next_t;
            (*i).ctn_type = 0 as libc::c_int as ctf_id_t;
            return ret;
        }
        if ctf_assert_internal(
            fp,
            ...
            b"(i->ctn_next == NULL)\0" as *const u8 as *const libc::c_char,
            ((*i).ctn_next).is_null() as libc::c_int,
        ) as libc::c_long == 0
        {
            return -(1 as libc::c_int) as ssize_t;
        }
    ...
    let mut memb: ctf_lmember_t = ctf_lmember_t {
        ctlm_name: 0,
        ctlm_offsethi: 0,
        ctlm_type: 0,
        ctlm_offsetlo: 0,
    ...
    if (*i).ctn_n == max_vlen {
        ctf_next_destroy(i);
        *it = 0 as *mut ctf_next_t;
        return ctf_set_errno(ofp, ECTF_NEXT_END as libc::c_int) as ssize_t;
    } else {
        if ctf_struct_member(
            fp,
            &mut memb,
            (*i).ctn_tp,
            (*i).u.ctn_vlen,
            (*i).ctn_size as size_t,
            (*i).ctn_n as size_t,
        ) < 0 as libc::c_int
        {
            return -(1 as libc::c_int) as ssize_t;
        ...
        if !membtype.is_null() {
            *membtype = memb.ctlm_type as ctf_id_t;
        }
        offset = ((memb.ctlm_offsethi as uint64_t) << 32 as libc::c_int
            | memb.ctlm_offsetlo as libc::c_ulong) as ssize_t;
        if *membname.offset(0 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
            && (ctf_type_kind(fp, memb.ctlm_type as ctf_id_t) == 6 as libc::c_int
                || ctf_type_kind(fp, memb.ctlm_type as ctf_id_t) == 7 as libc::c_int)
        {
            (*i).ctn_type = memb.ctlm_type as ctf_id_t;
        }
        (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
        (*i).ctn_n;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_enum_iter(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut func: Option::<ctf_enum_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    ...
    loop {
        name = ctf_enum_next(fp, type_0, &mut i, &mut val);
        if name.is_null() {
            break;
        }
        let mut rc: libc::c_int = 0;
        rc = func.expect("non-null function pointer")(name, val, arg);
        if rc != 0 as libc::c_int {
            ctf_next_destroy(i);
            return rc;
        }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_enum_next(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut it: *mut *mut ctf_next_t,
    ...
    if i.is_null() {
        let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
        let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
        type_0 = ctf_type_resolve_unsliced(fp, type_0);
        if type_0 == -(1 as libc::c_long) as ctf_id_t {
        ...
        i = ctf_next_create();
        if i.is_null() {
            ctf_set_errno(ofp, 12 as libc::c_int);
            return 0 as *const libc::c_char;
        }
        (*i).cu.ctn_fp = ofp;
        ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, &mut (*i).ctn_increment);
        kind = ((*(*fp).ctf_dictops).ctfo_get_kind)
            .expect("non-null function pointer")((*tp).ctt_info);
        if kind != 8 as libc::c_int as libc::c_uint {
            ctf_next_destroy(i);
            ctf_set_errno(ofp, ECTF_NOTENUM as libc::c_int);
            return 0 as *const libc::c_char;
        }
        dtd = ctf_dynamic_type(fp, type_0);
        (*i)
        ...
        (*i)
            .ctn_n = ((*(*fp).ctf_dictops).ctfo_get_vlen)
            .expect("non-null function pointer")((*tp).ctt_info);
        if dtd.is_null() {
            (*i)
                .u
                .ctn_en = (tp as uintptr_t)
                .wrapping_add((*i).ctn_increment as libc::c_ulong) as *const ctf_enum_t;
        } else {
            (*i).u.ctn_en = (*dtd).dtd_vlen as *const ctf_enum_t;
        }
        *it = i;
    }
    if ::core::mem::transmute::<
    ...
    {
        ctf_set_errno(ofp, ECTF_NEXT_WRONGFUN as libc::c_int);
        return 0 as *const libc::c_char;
    }
    if ofp != (*i).cu.ctn_fp as *mut ctf_dict_t {
        ctf_set_errno(ofp, ECTF_NEXT_WRONGFP as libc::c_int);
        return 0 as *const libc::c_char;
    }
    fp = ctf_get_dict(ofp, type_0);
    if fp.is_null() {
        ctf_set_errno(ofp, ECTF_NOPARENT as libc::c_int);
        return 0 as *const libc::c_char;
    }
    if (*i).ctn_n == 0 as libc::c_int as libc::c_uint {
        ctf_next_destroy(i);
        *it = 0 as *mut ctf_next_t;
        ctf_set_errno(ofp, ECTF_NEXT_END as libc::c_int);
        return 0 as *const libc::c_char;
    } else {
        ...
        (*i).u.ctn_en = ((*i).u.ctn_en).offset(1);
        (*i).u.ctn_en;
        (*i).ctn_n = ((*i).ctn_n).wrapping_sub(1);
        (*i).ctn_n;
        return name;
    };
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_iter(
    mut fp: *mut ctf_dict_t,
    mut func: Option::<ctf_type_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut type_0: ctf_id_t = 0;
    loop {
        type_0 = ctf_type_next(fp, &mut i, 0 as *mut libc::c_int, 0 as libc::c_int);
        if !(type_0 != -(1 as libc::c_long) as ctf_id_t) {
            break;
        }
        let mut rc: libc::c_int = 0;
        rc = func.expect("non-null function pointer")(type_0, arg);
        if rc != 0 as libc::c_int {
            ctf_next_destroy(i);
            return rc;
        }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_iter_all(
    mut fp: *mut ctf_dict_t,
    mut func: Option::<ctf_type_all_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut type_0: ctf_id_t = 0;
    ...
    loop {
        type_0 = ctf_type_next(fp, &mut i, &mut flag, 1 as libc::c_int);
        if !(type_0 != -(1 as libc::c_long) as ctf_id_t) {
            break;
        }
        let mut rc: libc::c_int = 0;
        rc = func.expect("non-null function pointer")(type_0, flag, arg);
        if rc != 0 as libc::c_int {
            ctf_next_destroy(i);
            return rc;
        }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_next(
    mut fp: *mut ctf_dict_t,
    mut it: *mut *mut ctf_next_t,
    mut flag: *mut libc::c_int,
    mut want_hidden: libc::c_int,
) -> ctf_id_t {
    let mut i: *mut ctf_next_t = *it;
    if i.is_null() {
        i = ctf_next_create();
        ...
        (*i).cu.ctn_fp = fp;
        (*i).ctn_type = 1 as libc::c_int as ctf_id_t;
        (*i)
            .ctn_iter_fun = ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(
    ...
    {
        return ctf_set_errno(fp, ECTF_NEXT_WRONGFUN as libc::c_int);
    }
    if fp != (*i).cu.ctn_fp as *mut ctf_dict_t {
        return ctf_set_errno(fp, ECTF_NEXT_WRONGFP as libc::c_int);
    }
    while (*i).ctn_type <= (*fp).ctf_typemax {
        let mut tp: *const ctf_type_t = if (*fp).ctf_flags
            & 0x2 as libc::c_int as libc::c_uint != 0
        {
            ...
            ((*fp).ctf_buf as uintptr_t)
                .wrapping_add(
                    *((*fp).ctf_txlate).offset((*i).ctn_type as isize) as libc::c_ulong,
                ) as *mut ctf_type_t
        };
        if want_hidden == 0
            && ((*(*fp).ctf_dictops).ctfo_get_root)
                .expect("non-null function pointer")((*tp).ctt_info) == 0
        {
            (*i).ctn_type = ((*i).ctn_type).wrapping_add(1);
            (*i).ctn_type;
        } else {
            if !flag.is_null() {
                *flag = ((*(*fp).ctf_dictops).ctfo_get_root)
                    .expect("non-null function pointer")((*tp).ctt_info) as libc::c_int;
            }
            return if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0 {
                let fresh0 = (*i).ctn_type;
                (*i).ctn_type = ((*i).ctn_type).wrapping_add(1);
                fresh0
                    | ((*fp).ctf_parmax).wrapping_add(1 as libc::c_int as libc::c_uint)
                        as libc::c_ulong
            } else {
                let fresh1 = (*i).ctn_type;
                (*i).ctn_type = ((*i).ctn_type).wrapping_add(1);
                fresh1
            };
        }
    ...
    ctf_next_destroy(i);
    *it = 0 as *mut ctf_next_t;
    return ctf_set_errno(fp, ECTF_NEXT_END as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_variable_iter(
    mut fp: *mut ctf_dict_t,
    mut func: Option::<ctf_variable_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut type_0: ctf_id_t = 0;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    loop {
        type_0 = ctf_variable_next(fp, &mut i, &mut name);
        if !(type_0 != -(1 as libc::c_long) as ctf_id_t) {
            break;
        }
        let mut rc: libc::c_int = 0;
        rc = func.expect("non-null function pointer")(name, type_0, arg);
        if rc != 0 as libc::c_int {
            ctf_next_destroy(i);
            return rc;
        }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_variable_next(
    mut fp: *mut ctf_dict_t,
    mut it: *mut *mut ctf_next_t,
    mut name: *mut *const libc::c_char,
) -> ctf_id_t {
    let mut i: *mut ctf_next_t = *it;
    if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        && ((*fp).ctf_parent).is_null()
    {
        return ctf_set_errno(fp, ECTF_NOPARENT as libc::c_int);
    }
    if i.is_null() {
        i = ctf_next_create();
        if i.is_null() {
        ...
        if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0 {
            (*i)
                .u
                .ctn_dvd = (*(&mut (*fp).ctf_dvdefs as *mut ctf_list_t)).l_next
                as *mut libc::c_void as *const ctf_dvdef_t;
        }
        *it = i;
    }
    if ::core::mem::transmute::<
    ...
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        if !((*i).ctn_n as libc::c_ulong >= (*fp).ctf_nvars) {
            *name = ctf_strptr(
                fp,
                (*((*fp).ctf_vars).offset((*i).ctn_n as isize)).ctv_name,
            );
            let fresh2 = (*i).ctn_n;
            (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
            return (*((*fp).ctf_vars).offset(fresh2 as isize)).ctv_type as ctf_id_t;
        }
    } else {
        let mut id: ctf_id_t = 0;
        if !((*i).u.ctn_dvd).is_null() {
            *name = (*(*i).u.ctn_dvd).dvd_name;
            id = (*(*i).u.ctn_dvd).dvd_type;
            (*i)
                .u
                .ctn_dvd = (*((*i).u.ctn_dvd as *mut ctf_list_t)).l_next
                as *mut libc::c_void as *const ctf_dvdef_t;
            return id;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_resolve(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> ctf_id_t {
    let mut prev: ctf_id_t = type_0;
    let mut otype: ctf_id_t = type_0;
    let mut ofp: *mut ctf_dict_t = fp;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    if type_0 == 0 as libc::c_int as libc::c_ulong {
        return ctf_set_errno(ofp, ECTF_NONREPRESENTABLE as libc::c_int);
    }
    loop {
        tp = ctf_lookup_by_id(&mut fp, type_0);
        if tp.is_null() {
        ...
        match ((*(*fp).ctf_dictops).ctfo_get_kind)
            .expect("non-null function pointer")((*tp).ctt_info)
        {
            10 | 11 | 12 | 13 => {
                if (*tp).c2rust_unnamed.ctt_type as libc::c_ulong == type_0
                    || (*tp).c2rust_unnamed.ctt_type as libc::c_ulong == otype
                    || (*tp).c2rust_unnamed.ctt_type as libc::c_ulong == prev
                {
                    ctf_err_warn(
                        ofp,
                        0 as libc::c_int,
                        ...
                        dcgettext(
                            ...
                            b"type %lx cycle detected\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        otype,
                    );
                    return ctf_set_errno(ofp, ECTF_CORRUPT as libc::c_int);
                }
                prev = type_0;
                type_0 = (*tp).c2rust_unnamed.ctt_type as ctf_id_t;
            }
            0 => return ctf_set_errno(ofp, ECTF_NONREPRESENTABLE as libc::c_int),
            _ => return type_0,
        }
        if type_0 == 0 as libc::c_int as libc::c_ulong {
            return ctf_set_errno(ofp, ECTF_NONREPRESENTABLE as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_resolve_unsliced(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> ctf_id_t {
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    ...
    if ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info)
        == 14 as libc::c_int as libc::c_uint
    {
        return ctf_type_reference(fp, type_0);
    }
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_get_dict(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> *mut ctf_dict_t {
    if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        && type_0 <= (*fp).ctf_parmax as libc::c_ulong
    {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_by_rawname(
    mut fp: *mut ctf_dict_t,
    mut kind: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_by_rawhash(
    mut fp: *mut ctf_dict_t,
    mut np: *mut ctf_names_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    let mut id: ctf_id_t = 0;
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0 {
        id = ctf_dynhash_lookup((*np).ctn_writable, name as *const libc::c_void)
            as uintptr_t;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_aname(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> *mut libc::c_char {
    let mut current_block: u64;
    let mut cd: ctf_decl_t = ctf_decl_t {
        cd_nodes: [ctf_list_t {
        ...
        cd_ordp: CTF_PREC_BASE,
        cd_buf: 0 as *mut libc::c_char,
        cd_err: 0,
        cd_enomem: 0,
    };
    let mut cdp: *mut ctf_decl_node_t = 0 as *mut ctf_decl_node_t;
    let mut prec: ctf_decl_prec_t = CTF_PREC_BASE;
    let mut lp: ctf_decl_prec_t = CTF_PREC_BASE;
    let mut rp: ctf_decl_prec_t = CTF_PREC_BASE;
    let mut ptr: libc::c_int = 0;
    let mut arr: libc::c_int = 0;
    let mut k: uint32_t = 0;
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    if fp.is_null() && type_0 == -(1 as libc::c_long) as ctf_id_t {
        return 0 as *mut libc::c_char;
    }
    ctf_decl_init(&mut cd);
    ctf_decl_push(&mut cd, fp, type_0);
    if cd.cd_err != 0 as libc::c_int {
        ctf_decl_fini(&mut cd);
        ctf_set_errno(fp, cd.cd_err);
        return 0 as *mut libc::c_char;
    }
    ptr = (cd.cd_order[CTF_PREC_POINTER as libc::c_int as usize]
        > CTF_PREC_POINTER as libc::c_int) as libc::c_int;
    arr = (cd.cd_order[CTF_PREC_ARRAY as libc::c_int as usize]
        > CTF_PREC_ARRAY as libc::c_int) as libc::c_int;
    rp = (if arr != 0 {
        CTF_PREC_ARRAY as libc::c_int
    } else if ptr != 0 {
        CTF_PREC_POINTER as libc::c_int
    } else {
        -(1 as libc::c_int)
    }) as ctf_decl_prec_t;
    lp = (if ptr != 0 {
    ...
    k = 3 as libc::c_int as uint32_t;
    prec = CTF_PREC_BASE;
    while (prec as libc::c_uint) < CTF_PREC_MAX as libc::c_int as libc::c_uint {
        cdp = (*(&mut *(cd.cd_nodes).as_mut_ptr().offset(prec as isize)
            as *mut ctf_list_t))
            .l_next as *mut libc::c_void as *mut ctf_decl_node_t;
        while !cdp.is_null() {
            let mut rfp: *mut ctf_dict_t = fp;
            let mut tp: *const ctf_type_t = ctf_lookup_by_id(&mut rfp, (*cdp).cd_type);
            let mut name: *const libc::c_char = ctf_strptr(rfp, (*tp).ctt_name);
            if k != 3 as libc::c_int as libc::c_uint
                && k != 4 as libc::c_int as libc::c_uint
            {
                ctf_decl_sprintf(
                    &mut cd as *mut ctf_decl_t,
                    b" \0" as *const u8 as *const libc::c_char,
                );
            }
            if lp as libc::c_uint == prec as libc::c_uint {
                ctf_decl_sprintf(
                    &mut cd as *mut ctf_decl_t,
                    b"(\0" as *const u8 as *const libc::c_char,
                );
                lp = 4294967295 as ctf_decl_prec_t;
            }
            match (*cdp).cd_kind {
                1 | 2 | 10 => {
                ...
                5 => {
                    ...
                    let mut argv: *mut ctf_id_t = 0 as *mut ctf_id_t;
                    if ctf_func_type_info(rfp, (*cdp).cd_type, &mut fi)
                        < 0 as libc::c_int
                    {
                        current_block = 9319336480614459542;
                    } else {
                        argv = calloc(
                            fi.ctc_argc as libc::c_ulong,
                            ::core::mem::size_of::<*mut ctf_id_t>() as libc::c_ulong,
                        ) as *mut ctf_id_t;
                        if argv.is_null() {
                            ctf_set_errno(rfp, *__errno_location());
                            current_block = 9319336480614459542;
                        ...
                        ) < 0 as libc::c_int
                        {
                            ...
                            loop {
                                if !(i < fi.ctc_argc as libc::c_ulong) {
                                    current_block = 4567019141635105728;
                                    break;
                                }
                                let mut arg: *mut libc::c_char = ctf_type_aname(
                                    rfp,
                                ...
                                if i
                                    < (fi.ctc_argc)
                                        ...
                                        as libc::c_ulong
                                    || fi.ctc_flags & 0x1 as libc::c_int as libc::c_uint != 0
                                {
                                    ctf_decl_sprintf(
                                        &mut cd as *mut ctf_decl_t,
                                        b", \0" as *const u8 as *const libc::c_char,
                            ...
                            match current_block {
                                9319336480614459542 => {}
                                _ => {
                                    if fi.ctc_flags & 0x1 as libc::c_int as libc::c_uint != 0 {
                                        ctf_decl_sprintf(
                                            &mut cd as *mut ctf_decl_t,
                                            b"...\0" as *const u8 as *const libc::c_char,
                                        );
                ...
                6 => {
                    ctf_decl_sprintf(
                        &mut cd as *mut ctf_decl_t,
                        b"struct %s\0" as *const u8 as *const libc::c_char,
                        name,
                    );
                }
                7 => {
                    ctf_decl_sprintf(
                        &mut cd as *mut ctf_decl_t,
                        b"union %s\0" as *const u8 as *const libc::c_char,
                        name,
                    );
                }
                8 => {
                    ctf_decl_sprintf(
                        &mut cd as *mut ctf_decl_t,
                        b"enum %s\0" as *const u8 as *const libc::c_char,
                        name,
                    );
                }
                9 => {
                    match ctf_type_kind_forwarded(fp, (*cdp).cd_type) {
                        6 => {
                            ctf_decl_sprintf(
                                &mut cd as *mut ctf_decl_t,
                                b"struct %s\0" as *const u8 as *const libc::c_char,
                ...
                0 => {
                        ...
                        == '\0' as i32
                    {
                        ctf_decl_sprintf(
                            ...
                            dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"(nonrepresentable type)\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                        );
                        ...
                        ctf_decl_sprintf(
                            ...
                            dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"(nonrepresentable type %s)\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            name,
            ...
            k = (*cdp).cd_kind;
            cdp = (*(cdp as *mut ctf_list_t)).l_next as *mut libc::c_void
                as *mut ctf_decl_node_t;
        }
        if rp as libc::c_uint == prec as libc::c_uint {
            ctf_decl_sprintf(
                &mut cd as *mut ctf_decl_t,
                b")\0" as *const u8 as *const libc::c_char,
            );
    ...
    buf = ctf_decl_buf(&mut cd);
    ctf_decl_fini(&mut cd);
    return buf;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_lname(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut buf: *mut libc::c_char,
    mut len: size_t,
) -> ssize_t {
    let mut str: *mut libc::c_char = ctf_type_aname(fp, type_0);
    let mut slen: size_t = 0;
    if str.is_null() {
        return -(1 as libc::c_long) as ctf_id_t as ssize_t;
    }
    slen = strlen(str);
    snprintf(buf, len, b"%s\0" as *const u8 as *const libc::c_char, str);
    free(str as *mut libc::c_void);
    if slen >= len {
        ctf_set_errno(fp, ECTF_NAMELEN as libc::c_int);
    }
    return slen as ssize_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_name(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut buf: *mut libc::c_char,
    mut len: size_t,
) -> *mut libc::c_char {
    let mut rv: ssize_t = ctf_type_lname(fp, type_0, buf, len);
    return if rv >= 0 as libc::c_int as libc::c_long && (rv as size_t) < len {
        buf
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_name_raw(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> *const libc::c_char {
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    ...
    if (*tp).ctt_name == 0 as libc::c_int as libc::c_uint {
        return b"\0" as *const u8 as *const libc::c_char;
    }
    return ctf_strraw(fp, (*tp).ctt_name);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_aname_raw(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> *mut libc::c_char {
    let mut name: *const libc::c_char = ctf_type_name_raw(fp, type_0);
    if !name.is_null() {
        return strdup(name);
    }
    return 0 as *mut libc::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_size(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> ssize_t {
    let mut ofp: *mut ctf_dict_t = fp;
    ...
    match ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info)
    {
        3 => return (*(*fp).ctf_dmodel).ctd_pointer as ssize_t,
        5 => return 0 as libc::c_int as ssize_t,
        8 => return (*(*fp).ctf_dmodel).ctd_int as ssize_t,
        4 => {
            size = ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, 0 as *mut ssize_t);
            if size > 0 as libc::c_int as libc::c_long {
                return size;
            }
            if ctf_array_info(ofp, type_0, &mut ar) < 0 as libc::c_int
                || {
                    size = ctf_type_size(ofp, ar.ctr_contents);
                    size < 0 as libc::c_int as libc::c_long
                }
            {
                return -(1 as libc::c_int) as ssize_t;
            }
            return size * ar.ctr_nelems as libc::c_long;
        }
        9 => return ctf_set_errno(ofp, ECTF_INCOMPLETE as libc::c_int) as ssize_t,
        _ => return ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, 0 as *mut ssize_t),
    };
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_align(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> ssize_t {
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    ...
    kind = ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info) as libc::c_int;
    match kind {
        3 | 5 => return (*(*fp).ctf_dmodel).ctd_pointer as ssize_t,
        4 => {
            let mut r: ctf_arinfo_t = ctf_arinfo_t {
                ctr_contents: 0,
                ctr_index: 0,
                ctr_nelems: 0,
            };
            if ctf_array_info(ofp, type_0, &mut r) < 0 as libc::c_int {
                return -(1 as libc::c_int) as ssize_t;
            }
            return ctf_type_align(ofp, r.ctr_contents);
        }
        6 | 7 => {
            let mut align: size_t = 0 as libc::c_int as size_t;
            let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
            let mut vlen: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
            let mut i: uint32_t = 0 as libc::c_int as uint32_t;
            let mut n: uint32_t = ((*(*fp).ctf_dictops).ctfo_get_vlen)
                .expect("non-null function pointer")((*tp).ctt_info);
            let mut size: ssize_t = 0;
            let mut increment: ssize_t = 0;
            ...
            if !dtd.is_null() {
                vlen = (*dtd).dtd_vlen;
                vbytes = (*dtd).dtd_vlen_alloc as ssize_t;
            } else {
                vlen = (tp as *mut libc::c_uchar).offset(increment as isize);
                vbytes = ((*(*fp).ctf_dictops).ctfo_get_vbytes)
                    .expect(
                        "non-null function pointer",
                    )(fp, kind as libc::c_ushort, size, n as size_t);
            }
            if kind == 6 as libc::c_int {
                n = if n < 1 as libc::c_int as libc::c_uint {
                    n
                } else {
            ...
            while n != 0 as libc::c_int as libc::c_uint {
                ...
                let mut am: ssize_t = ctf_type_align(ofp, memb.ctlm_type as ctf_id_t);
                align = if align > am as size_t { align } else { am as size_t };
                n = n.wrapping_sub(1);
                n;
                i = i.wrapping_add(1);
                i;
            }
            return align as ssize_t;
        }
        8 => return (*(*fp).ctf_dmodel).ctd_int as ssize_t,
        9 => return ctf_set_errno(ofp, ECTF_INCOMPLETE as libc::c_int) as ssize_t,
        _ => return ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, 0 as *mut ssize_t),
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_kind_unsliced(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> libc::c_int {
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    ...
    return ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_kind(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> libc::c_int {
    let mut kind: libc::c_int = 0;
    kind = ctf_type_kind_unsliced(fp, type_0);
    if kind < 0 as libc::c_int {
        return -(1 as libc::c_int);
    }
    if kind == 14 as libc::c_int {
        type_0 = ctf_type_reference(fp, type_0);
        if type_0 == -(1 as libc::c_long) as ctf_id_t {
            return -(1 as libc::c_int);
        }
        kind = ctf_type_kind_unsliced(fp, type_0);
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_kind_forwarded(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> libc::c_int {
    let mut kind: libc::c_int = 0;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    kind = ctf_type_kind(fp, type_0);
    if kind < 0 as libc::c_int {
        return -(1 as libc::c_int);
    }
    ...
    return (*tp).c2rust_unnamed.ctt_type as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_reference(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> ctf_id_t {
    let mut ofp: *mut ctf_dict_t = fp;
    ...
    match ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info)
    {
        3 | 10 | 11 | 12 | 13 => return (*tp).c2rust_unnamed.ctt_type as ctf_id_t,
        14 => {
            let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
            let mut sp: *const ctf_slice_t = 0 as *const ctf_slice_t;
            dtd = ctf_dynamic_type(ofp, type_0);
            if dtd.is_null() {
                let mut increment: ssize_t = 0;
                ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, &mut increment);
                sp = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
                    as *const ctf_slice_t;
            } else {
                sp = (*dtd).dtd_vlen as *const ctf_slice_t;
            }
            return (*sp).cts_type as ctf_id_t;
        }
        _ => return ctf_set_errno(ofp, ECTF_NOTREF as libc::c_int),
    };
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_pointer(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> ctf_id_t {
    let mut ofp: *mut ctf_dict_t = fp;
    let mut ntype: ctf_id_t = 0;
    if (ctf_lookup_by_id(&mut fp, type_0)).is_null() {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    ntype = *((*fp).ctf_ptrtab)
        .offset((type_0 & (*fp).ctf_parmax as libc::c_ulong) as isize) as ctf_id_t;
    if ntype != 0 as libc::c_int as libc::c_ulong {
        return if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0 {
            ntype
                | ((*fp).ctf_parmax).wrapping_add(1 as libc::c_int as libc::c_uint)
                    as libc::c_ulong
    ...
    type_0 = ctf_type_resolve(fp, type_0);
    if type_0 == -(1 as libc::c_long) as ctf_id_t {
        return ctf_set_errno(ofp, ECTF_NOTYPE as libc::c_int);
    }
    if (ctf_lookup_by_id(&mut fp, type_0)).is_null() {
        return ctf_set_errno(ofp, ECTF_NOTYPE as libc::c_int);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_encoding(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut ep: *mut ctf_encoding_t,
) -> libc::c_int {
    let mut ofp: *mut ctf_dict_t = fp;
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut increment: ssize_t = 0;
    let mut vlen: *const libc::c_uchar = 0 as *const libc::c_uchar;
    ...
    if !dtd.is_null() {
        ...
        ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, &mut increment);
        vlen = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
    ...
    {
        1 => {
            data = *(vlen as *const uint32_t);
            (*ep).cte_format = (data & 0xff000000 as libc::c_uint) >> 24 as libc::c_int;
            (*ep)
                .cte_offset = (data & 0xff0000 as libc::c_int as libc::c_uint)
                >> 16 as libc::c_int;
            (*ep).cte_bits = data & 0xffff as libc::c_int as libc::c_uint;
        }
        2 => {
            data = *(vlen as *const uint32_t);
            (*ep).cte_format = (data & 0xff000000 as libc::c_uint) >> 24 as libc::c_int;
        ...
        8 => {
            (*ep).cte_format = 0x1 as libc::c_int as uint32_t;
            (*ep).cte_offset = 0 as libc::c_int as uint32_t;
            (*ep).cte_bits = 0 as libc::c_int as uint32_t;
        }
        14 => {
            let mut slice: *const ctf_slice_t = 0 as *const ctf_slice_t;
            let mut underlying_en: ctf_encoding_t = ctf_encoding_t {
                cte_format: 0,
                cte_offset: 0,
                cte_bits: 0,
            };
            let mut underlying: ctf_id_t = 0;
            slice = vlen as *mut ctf_slice_t;
            underlying = ctf_type_resolve(fp, (*slice).cts_type as ctf_id_t);
            if ctf_type_encoding(fp, underlying, &mut underlying_en) < 0 as libc::c_int {
                return -(1 as libc::c_int);
            }
            (*ep).cte_format = underlying_en.cte_format;
            (*ep).cte_offset = (*slice).cts_offset as uint32_t;
            (*ep).cte_bits = (*slice).cts_bits as uint32_t;
        }
        _ => return ctf_set_errno(ofp, ECTF_NOTINTFP as libc::c_int) as libc::c_int,
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_type_cmp(
    mut lfp: *mut ctf_dict_t,
    mut ltype: ctf_id_t,
    mut rfp: *mut ctf_dict_t,
    mut rtype: ctf_id_t,
) -> libc::c_int {
    ...
    if ltype <= (*lfp).ctf_parmax as libc::c_ulong && !((*lfp).ctf_parent).is_null() {
        lfp = (*lfp).ctf_parent;
    }
    if rtype <= (*rfp).ctf_parmax as libc::c_ulong && !((*rfp).ctf_parent).is_null() {
        rfp = (*rfp).ctf_parent;
    }
    if lfp < rfp {
        return -(1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_compat(
    mut lfp: *mut ctf_dict_t,
    mut ltype: ctf_id_t,
    mut rfp: *mut ctf_dict_t,
    mut rtype: ctf_id_t,
) -> libc::c_int {
    let mut ltp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut rtp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut le: ctf_encoding_t = ctf_encoding_t {
        cte_format: 0,
        cte_offset: 0,
        cte_bits: 0,
    };
    let mut re: ctf_encoding_t = ctf_encoding_t {
        cte_format: 0,
        cte_offset: 0,
        cte_bits: 0,
    };
    let mut la: ctf_arinfo_t = ctf_arinfo_t {
        ctr_contents: 0,
        ctr_index: 0,
        ctr_nelems: 0,
    };
    let mut ra: ctf_arinfo_t = ctf_arinfo_t {
        ctr_contents: 0,
        ctr_index: 0,
        ctr_nelems: 0,
    };
    let mut lkind: uint32_t = 0;
    let mut rkind: uint32_t = 0;
    let mut same_names: libc::c_int = 0 as libc::c_int;
    if ctf_type_cmp(lfp, ltype, rfp, rtype) == 0 as libc::c_int {
        return 1 as libc::c_int;
    }
    ltype = ctf_type_resolve(lfp, ltype);
    lkind = ctf_type_kind(lfp, ltype) as uint32_t;
    rtype = ctf_type_resolve(rfp, rtype);
    rkind = ctf_type_kind(rfp, rtype) as uint32_t;
    ltp = ctf_lookup_by_id(&mut lfp, ltype);
    rtp = ctf_lookup_by_id(&mut rfp, rtype);
    if !ltp.is_null() && !rtp.is_null() {
        same_names = (strcmp(
            ctf_strptr(lfp, (*ltp).ctt_name),
            ctf_strptr(rfp, (*rtp).ctt_name),
        ) == 0 as libc::c_int) as libc::c_int;
    }
    if lkind == 8 as libc::c_int as libc::c_uint
        && rkind == 1 as libc::c_int as libc::c_uint
        || rkind == 8 as libc::c_int as libc::c_uint
            && lkind == 1 as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int;
    }
    if lkind != rkind {
    ...
    match lkind {
        1 | 2 => {
            memset(
                &mut le as *mut ctf_encoding_t as *mut libc::c_void,
                0 as libc::c_int,
                ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
            );
            memset(
                &mut re as *mut ctf_encoding_t as *mut libc::c_void,
                0 as libc::c_int,
                ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
            );
            return (ctf_type_encoding(lfp, ltype, &mut le) == 0 as libc::c_int
                && ctf_type_encoding(rfp, rtype, &mut re) == 0 as libc::c_int
                && memcmp(
                    &mut le as *mut ctf_encoding_t as *const libc::c_void,
                    &mut re as *mut ctf_encoding_t as *const libc::c_void,
                    ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
                ) == 0 as libc::c_int) as libc::c_int;
        }
        3 => {
            return ctf_type_compat(
                lfp,
                ctf_type_reference(lfp, ltype),
                rfp,
                ctf_type_reference(rfp, rtype),
            );
        }
        4 => {
            return (ctf_array_info(lfp, ltype, &mut la) == 0 as libc::c_int
                && ctf_array_info(rfp, rtype, &mut ra) == 0 as libc::c_int
                && la.ctr_nelems == ra.ctr_nelems
                && ctf_type_compat(lfp, la.ctr_contents, rfp, ra.ctr_contents) != 0
                && ctf_type_compat(lfp, la.ctr_index, rfp, ra.ctr_index) != 0)
                as libc::c_int;
        }
        6 | 7 => {
            return (same_names != 0
                && ctf_type_size(lfp, ltype) == ctf_type_size(rfp, rtype)) as libc::c_int;
        }
        8 => {
            let mut lencoded: libc::c_int = 0;
            let mut rencoded: libc::c_int = 0;
            lencoded = ctf_type_encoding(lfp, ltype, &mut le);
            rencoded = ctf_type_encoding(rfp, rtype, &mut re);
            if lencoded != rencoded
                || lencoded == 0 as libc::c_int
                    && memcmp(
                        &mut le as *mut ctf_encoding_t as *const libc::c_void,
                        &mut re as *mut ctf_encoding_t as *const libc::c_void,
                        ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_member_count(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> libc::c_int {
    let mut ofp: *mut ctf_dict_t = fp;
    ...
    {
        return ctf_set_errno(ofp, ECTF_NOTSUE as libc::c_int) as libc::c_int;
    }
    return ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*tp).ctt_info) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_member_info(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut name: *const libc::c_char,
    mut mip: *mut ctf_membinfo_t,
) -> libc::c_int {
    let mut ofp: *mut ctf_dict_t = fp;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    ...
    if kind != 6 as libc::c_int as libc::c_uint
        && kind != 7 as libc::c_int as libc::c_uint
    {
        return ctf_set_errno(ofp, ECTF_NOTSOU as libc::c_int) as libc::c_int;
    }
    n = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*tp).ctt_info);
    dtd = ctf_dynamic_type(fp, type_0);
    if !dtd.is_null() {
        vlen = (*dtd).dtd_vlen;
    ...
    while n != 0 as libc::c_int as libc::c_uint {
        ...
        let mut membname: *const libc::c_char = 0 as *const libc::c_char;
        if ctf_struct_member(fp, &mut memb, tp, vlen, vbytes as size_t, i as size_t)
            < 0 as libc::c_int
        {
            return -(1 as libc::c_int);
        }
        ...
        if *membname.offset(0 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
            && (ctf_type_kind(fp, memb.ctlm_type as ctf_id_t) == 6 as libc::c_int
                || ctf_type_kind(fp, memb.ctlm_type as ctf_id_t) == 7 as libc::c_int)
            && ctf_member_info(fp, memb.ctlm_type as ctf_id_t, name, mip)
                == 0 as libc::c_int
        {
            return 0 as libc::c_int;
        }
        if strcmp(membname, name) == 0 as libc::c_int {
            (*mip).ctm_type = memb.ctlm_type as ctf_id_t;
            (*mip)
                .ctm_offset = (memb.ctlm_offsethi as uint64_t) << 32 as libc::c_int
                | memb.ctlm_offsetlo as libc::c_ulong;
            return 0 as libc::c_int;
        }
        n = n.wrapping_sub(1);
        n;
    ...
    return ctf_set_errno(ofp, ECTF_NOMEMBNAM as libc::c_int) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_array_info(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut arp: *mut ctf_arinfo_t,
) -> libc::c_int {
    let mut ofp: *mut ctf_dict_t = fp;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut ap: *const ctf_array_t = 0 as *const ctf_array_t;
    ...
    {
        return ctf_set_errno(ofp, ECTF_NOTARRAY as libc::c_int) as libc::c_int;
    }
    dtd = ctf_dynamic_type(ofp, type_0);
    if !dtd.is_null() {
        ap = (*dtd).dtd_vlen as *const ctf_array_t;
    } else {
        ctf_get_ctt_size(fp, tp, 0 as *mut ssize_t, &mut increment);
        ap = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
            as *const ctf_array_t;
    }
    (*arp).ctr_contents = (*ap).cta_contents as ctf_id_t;
    (*arp).ctr_index = (*ap).cta_index as ctf_id_t;
    (*arp).ctr_nelems = (*ap).cta_nelems;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_enum_name(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    ...
    let mut ofp: *mut ctf_dict_t = fp;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut ep: *const ctf_enum_t = 0 as *const ctf_enum_t;
    let mut dtd: *const ctf_dtdef_t = 0 as *const ctf_dtdef_t;
    let mut increment: ssize_t = 0;
    let mut n: uint32_t = 0;
    type_0 = ctf_type_resolve_unsliced(fp, type_0);
    ...
    dtd = ctf_dynamic_type(ofp, type_0);
    if dtd.is_null() {
        ep = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
            as *const ctf_enum_t;
    } else {
        ep = (*dtd).dtd_vlen as *const ctf_enum_t;
    }
    n = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*tp).ctt_info);
    while n != 0 as libc::c_int as libc::c_uint {
    ...
    ctf_set_errno(ofp, ECTF_NOENUMNAM as libc::c_int);
    return 0 as *const libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_enum_value(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut name: *const libc::c_char,
    ...
    n = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*tp).ctt_info);
    while n != 0 as libc::c_int as libc::c_uint {
        if strcmp(ctf_strptr(fp, (*ep).cte_name), name) == 0 as libc::c_int {
            if !valp.is_null() {
                *valp = (*ep).cte_value;
            }
            return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_func_type_info(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut fip: *mut ctf_funcinfo_t,
) -> libc::c_int {
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut kind: uint32_t = 0;
    let mut args: *const uint32_t = 0 as *const uint32_t;
    let mut dtd: *const ctf_dtdef_t = 0 as *const ctf_dtdef_t;
    let mut size: ssize_t = 0;
    let mut increment: ssize_t = 0;
    type_0 = ctf_type_resolve(fp, type_0);
    ...
    kind = ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info);
    if kind != 5 as libc::c_int as libc::c_uint {
        return ctf_set_errno(fp, ECTF_NOTFUNC as libc::c_int) as libc::c_int;
    }
    (*fip).ctc_return = (*tp).c2rust_unnamed.ctt_type as ctf_id_t;
    (*fip).ctc_flags = 0 as libc::c_int as uint32_t;
    (*fip)
        .ctc_argc = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*tp).ctt_info);
    dtd = ctf_dynamic_type(fp, type_0);
    if dtd.is_null() {
        args = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
            as *mut uint32_t;
    } else {
        args = (*dtd).dtd_vlen as *mut uint32_t;
    }
    if (*fip).ctc_argc != 0 as libc::c_int as libc::c_uint
        && *args
            .offset(
                ((*fip).ctc_argc).wrapping_sub(1 as libc::c_int as libc::c_uint) as isize,
            ) == 0 as libc::c_int as libc::c_uint
    {
        (*fip).ctc_flags |= 0x1 as libc::c_int as libc::c_uint;
        (*fip).ctc_argc = ((*fip).ctc_argc).wrapping_sub(1);
        (*fip).ctc_argc;
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_func_type_args(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut argc: uint32_t,
    mut argv: *mut ctf_id_t,
) -> libc::c_int {
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut args: *const uint32_t = 0 as *const uint32_t;
    let mut dtd: *const ctf_dtdef_t = 0 as *const ctf_dtdef_t;
    let mut size: ssize_t = 0;
    let mut increment: ssize_t = 0;
    let mut f: ctf_funcinfo_t = ctf_funcinfo_t {
        ctc_return: 0,
        ctc_argc: 0,
        ctc_flags: 0,
    };
    if ctf_func_type_info(fp, type_0, &mut f) < 0 as libc::c_int {
        return -(1 as libc::c_int);
    }
    type_0 = ctf_type_resolve(fp, type_0);
    if type_0 == -(1 as libc::c_long) as ctf_id_t {
    ...
    argc = if argc < f.ctc_argc { argc } else { f.ctc_argc };
    while argc != 0 as libc::c_int as libc::c_uint {
        let fresh3 = args;
        args = args.offset(1);
        let fresh4 = argv;
        argv = argv.offset(1);
        *fresh4 = *fresh3 as ctf_id_t;
        argc = argc.wrapping_sub(1);
        argc;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_type_rvisit(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut func: Option::<ctf_visit_f>,
    mut arg: *mut libc::c_void,
    mut name: *const libc::c_char,
    ...
    rc = func.expect("non-null function pointer")(name, otype, offset, depth, arg);
    if rc != 0 as libc::c_int {
        return rc;
    }
    kind = ((*(*fp).ctf_dictops).ctfo_get_kind)
    ...
    while n != 0 as libc::c_int as libc::c_uint {
        ...
        rc = ctf_type_rvisit(
            fp,
            memb.ctlm_type as ctf_id_t,
            func,
            arg,
            ctf_strptr(fp, memb.ctlm_name),
            offset
                .wrapping_add(
                    (memb.ctlm_offsethi as uint64_t) << 32 as libc::c_int
                        | memb.ctlm_offsetlo as libc::c_ulong,
                ),
...
#[no_mangle]
pub unsafe extern "C" fn ctf_type_visit(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut func: Option::<ctf_visit_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    return ctf_type_rvisit(
        fp,
        type_0,
        func,
        arg,
