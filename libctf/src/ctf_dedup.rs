...
extern "C" {
    ...
    fn ctf_import_unref(fp: *mut ctf_dict_t, pfp: *mut ctf_dict_t) -> libc::c_int;
    static _CTF_SECTION: [libc::c_char; 0];
    fn ctf_strraw(_: *mut ctf_dict_t, _: uint32_t) -> *const libc::c_char;
    fn ctf_link_input_name(_: *mut ctf_dict_t) -> *const libc::c_char;
    fn ctf_type_kind_unsliced(_: *mut ctf_dict_t, _: ctf_id_t) -> libc::c_int;
    ...
    fn ctf_next_destroy(_: *mut ctf_next_t);
    fn ctf_dict_close(_: *mut ctf_dict_t);
    fn ctf_cuname(_: *mut ctf_dict_t) -> *const libc::c_char;
    fn ctf_cuname_set(_: *mut ctf_dict_t, _: *const libc::c_char) -> libc::c_int;
    fn ctf_parent_name_set(_: *mut ctf_dict_t, _: *const libc::c_char) -> libc::c_int;
    fn ctf_type_isparent(_: *mut ctf_dict_t, _: ctf_id_t) -> libc::c_int;
    fn ctf_errno(_: *mut ctf_dict_t) -> libc::c_int;
    fn ctf_errmsg(_: libc::c_int) -> *const libc::c_char;
    fn ctf_func_type_info(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
        _: *mut ctf_funcinfo_t,
    ) -> libc::c_int;
    fn ctf_func_type_args(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
        _: uint32_t,
        _: *mut ctf_id_t,
    ) -> libc::c_int;
    fn ctf_type_name_raw(_: *mut ctf_dict_t, _: ctf_id_t) -> *const libc::c_char;
    fn ctf_type_size(_: *mut ctf_dict_t, _: ctf_id_t) -> ssize_t;
    fn ctf_type_kind(_: *mut ctf_dict_t, _: ctf_id_t) -> libc::c_int;
    fn ctf_type_kind_forwarded(_: *mut ctf_dict_t, _: ctf_id_t) -> libc::c_int;
    fn ctf_type_reference(_: *mut ctf_dict_t, _: ctf_id_t) -> ctf_id_t;
    fn ctf_type_encoding(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
        _: *mut ctf_encoding_t,
    ) -> libc::c_int;
    fn ctf_array_info(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
    ...
    fn ctf_type_next(
        ...
        _: *mut *mut ctf_next_t,
        flag: *mut libc::c_int,
        want_hidden: libc::c_int,
    ) -> ctf_id_t;
    fn ctf_add_array(
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: *const ctf_arinfo_t,
    ) -> ctf_id_t;
    fn ctf_add_enum(_: *mut ctf_dict_t, _: uint32_t, _: *const libc::c_char) -> ctf_id_t;
    fn ctf_add_forward(
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: *const libc::c_char,
    ...
    fn ctf_add_struct_sized(
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: *const libc::c_char,
        _: size_t,
    ) -> ctf_id_t;
    fn ctf_add_union_sized(
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: *const libc::c_char,
        _: size_t,
    ...
    fn ctf_add_enumerator(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
        _: *const libc::c_char,
        _: libc::c_int,
    ) -> libc::c_int;
    fn ctf_add_member_offset(
        _: *mut ctf_dict_t,
        _: ctf_id_t,
        _: *const libc::c_char,
        _: ctf_id_t,
    ...
    static mut htab_eq_pointer: htab_eq;
    ...
    fn ctf_lookup_by_id(_: *mut *mut ctf_dict_t, _: ctf_id_t) -> *const ctf_type_t;
    fn ctf_lookup_by_rawname(
        _: *mut ctf_dict_t,
        _: libc::c_int,
        _: *const libc::c_char,
    ) -> ctf_id_t;
    fn ctf_hash_integer(ptr: *const libc::c_void) -> libc::c_uint;
    fn ctf_hash_string(ptr: *const libc::c_void) -> libc::c_uint;
    fn ctf_hash_eq_integer(
        _: *const libc::c_void,
        _: *const libc::c_void,
    ) -> libc::c_int;
    ...
    fn ctf_dynhash_lookup_kv(
        _: *mut ctf_dynhash_t,
        key: *const libc::c_void,
        orig_key: *mut *const libc::c_void,
        value: *mut *mut libc::c_void,
    ) -> libc::c_int;
    fn ctf_dynhash_destroy(_: *mut ctf_dynhash_t);
    fn ctf_dynhash_iter_find(
        _: *mut ctf_dynhash_t,
        _: ctf_hash_iter_find_f,
        _: *mut libc::c_void,
    ) -> *mut libc::c_void;
    fn ctf_dynhash_next(
        _: *mut ctf_dynhash_t,
    ...
    fn ctf_dynset_create(
        _: htab_hash,
        _: htab_eq,
        _: ctf_hash_free_fun,
    ) -> *mut ctf_dynset_t;
    fn ctf_dynset_insert(_: *mut ctf_dynset_t, _: *mut libc::c_void) -> libc::c_int;
    fn ctf_dynset_destroy(_: *mut ctf_dynset_t);
    fn ctf_dynset_exists(
        _: *mut ctf_dynset_t,
        key: *const libc::c_void,
        orig_key: *mut *const libc::c_void,
    ) -> libc::c_int;
    ...
    fn ctf_dynset_lookup_any(_: *mut ctf_dynset_t) -> *mut libc::c_void;
    fn ctf_sha1_fini(_: *mut ctf_sha1_t, _: *mut libc::c_char) -> *mut libc::c_char;
    fn ctf_dynamic_type(_: *const ctf_dict_t, _: ctf_id_t) -> *mut ctf_dtdef_t;
    fn ctf_add_encoded(
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: *const libc::c_char,
...
pub struct ctf_encoding {
    pub cte_format: uint32_t,
    pub cte_offset: uint32_t,
    pub cte_bits: uint32_t,
}
...
pub struct ctf_funcinfo {
    ...
    pub ctc_argc: uint32_t,
    pub ctc_flags: uint32_t,
}
pub type ctf_funcinfo_t = ctf_funcinfo;
pub type C2RustUnnamed_6 = libc::c_uint;
pub const ECTF_NONAME: C2RustUnnamed_6 = 1058;
pub const ECTF_INCOMPLETE: C2RustUnnamed_6 = 1057;
pub const ECTF_NEEDSBFD: C2RustUnnamed_6 = 1056;
pub const ECTF_FLAGS: C2RustUnnamed_6 = 1055;
pub const ECTF_NEXT_WRONGFP: C2RustUnnamed_6 = 1054;
pub const ECTF_NEXT_WRONGFUN: C2RustUnnamed_6 = 1053;
pub const ECTF_NEXT_END: C2RustUnnamed_6 = 1052;
pub const ECTF_NONREPRESENTABLE: C2RustUnnamed_6 = 1051;
pub const ECTF_INTERNAL: C2RustUnnamed_6 = 1050;
pub const ECTF_NOTYET: C2RustUnnamed_6 = 1049;
pub const ECTF_DUMPSECTCHANGED: C2RustUnnamed_6 = 1048;
pub const ECTF_DUMPSECTUNKNOWN: C2RustUnnamed_6 = 1047;
pub const ECTF_SLICEOVERFLOW: C2RustUnnamed_6 = 1046;
pub const ECTF_ARNNAME: C2RustUnnamed_6 = 1045;
pub const ECTF_ARCREATE: C2RustUnnamed_6 = 1044;
pub const ECTF_COMPRESS: C2RustUnnamed_6 = 1043;
pub const ECTF_OVERROLLBACK: C2RustUnnamed_6 = 1042;
pub const ECTF_CONFLICT: C2RustUnnamed_6 = 1041;
pub const ECTF_DUPLICATE: C2RustUnnamed_6 = 1040;
pub const ECTF_FULL: C2RustUnnamed_6 = 1039;
pub const ECTF_DTFULL: C2RustUnnamed_6 = 1038;
pub const ECTF_RDONLY: C2RustUnnamed_6 = 1037;
pub const ECTF_NOMEMBNAM: C2RustUnnamed_6 = 1036;
pub const ECTF_NOENUMNAM: C2RustUnnamed_6 = 1035;
pub const ECTF_NOTSUP: C2RustUnnamed_6 = 1034;
pub const ECTF_NOLABELDATA: C2RustUnnamed_6 = 1033;
pub const ECTF_NOLABEL: C2RustUnnamed_6 = 1032;
pub const ECTF_NOTYPEDAT: C2RustUnnamed_6 = 1031;
pub const ECTF_NOTDATA: C2RustUnnamed_6 = 1030;
pub const ECTF_NOFUNCDAT: C2RustUnnamed_6 = 1029;
pub const ECTF_NOTFUNC: C2RustUnnamed_6 = 1028;
pub const ECTF_SYNTAX: C2RustUnnamed_6 = 1027;
pub const ECTF_NOTYPE: C2RustUnnamed_6 = 1026;
pub const ECTF_NAMELEN: C2RustUnnamed_6 = 1025;
pub const ECTF_NOTREF: C2RustUnnamed_6 = 1024;
pub const ECTF_NOTARRAY: C2RustUnnamed_6 = 1023;
pub const ECTF_NOTINTFP: C2RustUnnamed_6 = 1022;
pub const ECTF_NOTSUE: C2RustUnnamed_6 = 1021;
pub const ECTF_NOTENUM: C2RustUnnamed_6 = 1020;
pub const ECTF_NOTSOU: C2RustUnnamed_6 = 1019;
pub const ECTF_BADID: C2RustUnnamed_6 = 1018;
pub const ECTF_BADNAME: C2RustUnnamed_6 = 1017;
pub const ECTF_STRTAB: C2RustUnnamed_6 = 1016;
pub const ECTF_DECOMPRESS: C2RustUnnamed_6 = 1015;
pub const ECTF_ZALLOC: C2RustUnnamed_6 = 1014;
pub const ECTF_LINKADDEDLATE: C2RustUnnamed_6 = 1013;
pub const ECTF_DMODEL: C2RustUnnamed_6 = 1012;
pub const ECTF_NOPARENT: C2RustUnnamed_6 = 1011;
pub const ECTF_NOSYMTAB: C2RustUnnamed_6 = 1010;
pub const ECTF_NOCTFBUF: C2RustUnnamed_6 = 1009;
pub const ECTF_NOCTFDATA: C2RustUnnamed_6 = 1008;
pub const ECTF_CORRUPT: C2RustUnnamed_6 = 1007;
pub const ECTF_STRBAD: C2RustUnnamed_6 = 1006;
pub const ECTF_SYMBAD: C2RustUnnamed_6 = 1005;
pub const ECTF_SYMTAB: C2RustUnnamed_6 = 1004;
pub const ECTF_BFD_AMBIGUOUS: C2RustUnnamed_6 = 1003;
pub const ECTF_CTFVERS: C2RustUnnamed_6 = 1002;
pub const ECTF_BFDERR: C2RustUnnamed_6 = 1001;
pub const ECTF_FMT: C2RustUnnamed_6 = 1000;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_next {
...
pub type ctf_hash_iter_find_f = Option::<
    unsafe extern "C" fn(
        *mut libc::c_void,
        *mut libc::c_void,
        *mut libc::c_void,
...
>;
pub type ctf_dedup_type_counter_t = ctf_dedup_type_counter;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_dedup_type_counter {
    pub fp: *mut ctf_dict_t,
    pub inputs: *mut *mut ctf_dict_t,
    pub num_non_forwards: libc::c_int,
}
pub type ctf_sort_om_cb_arg_t = ctf_sort_om_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_sort_om_cb_arg {
    pub inputs: *mut *mut ctf_dict_t,
    pub ninputs: uint32_t,
    pub d: *mut ctf_dedup_t,
}
#[inline]
unsafe extern "C" fn ctf_forwardable_kind(mut kind: libc::c_int) -> libc::c_int {
    return (kind == 6 as libc::c_int || kind == 7 as libc::c_int
        || kind == 8 as libc::c_int) as libc::c_int;
}
#[inline]
...
#[inline]
unsafe extern "C" fn ctf_dynset_cinsert(
    mut h: *mut ctf_dynset_t,
    mut k: *const libc::c_void,
) -> libc::c_int {
    return ctf_dynset_insert(h, k as *mut libc::c_void);
}
#[inline]
unsafe extern "C" fn ctf_dynset_cnext(
    mut h: *mut ctf_dynset_t,
    mut it: *mut *mut ctf_next_t,
    mut key: *mut *const libc::c_void,
) -> libc::c_int {
    return ctf_dynset_next(h, it, key as *mut *mut libc::c_void);
}
#[inline]
unsafe extern "C" fn ctf_sha1_init(mut sha1: *mut ctf_sha1_t) {
    sha1_init_ctx(sha1);
}
#[inline]
unsafe extern "C" fn ctf_sha1_add(
...
unsafe extern "C" fn make_set_element(
    mut set: *mut ctf_dynhash_t,
    mut key: *const libc::c_void,
) -> *mut ctf_dynset_t {
    let mut element: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    element = ctf_dynhash_lookup(set, key) as *mut ctf_dynset_t;
    if element.is_null() {
        element = ctf_dynset_create(
            Some(
                htab_hash_string
        ...
        if element.is_null() {
            return 0 as *mut ctf_dynset_t;
        }
        if ctf_dynhash_insert(
            set,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dedup_atoms_init(mut fp: *mut ctf_dict_t) -> libc::c_int {
    if !((*fp).ctf_dedup_atoms).is_null() {
        return 0 as libc::c_int;
    }
    if ((*fp).ctf_dedup_atoms_alloc).is_null() {
        (*fp)
            .ctf_dedup_atoms_alloc = ctf_dynset_create(
            Some(
                htab_hash_string
                    as unsafe extern "C" fn(*const libc::c_void) -> hashval_t,
            ),
...
unsafe extern "C" fn intern(
    ...
    let mut foo: *const libc::c_void = 0 as *const libc::c_void;
    if atom.is_null() {
        return 0 as *const libc::c_char;
    }
    if ctf_dynset_exists((*fp).ctf_dedup_atoms, atom as *const libc::c_void, &mut foo)
        == 0
    {
        if ctf_dynset_insert((*fp).ctf_dedup_atoms, atom as *mut libc::c_void)
            < 0 as libc::c_int
        {
            ctf_set_errno(fp, 12 as libc::c_int);
            return 0 as *const libc::c_char;
        }
        foo = atom as *const libc::c_void;
    } else {
        free(atom as *mut libc::c_void);
    }
    return foo as *const libc::c_char;
}
unsafe extern "C" fn ctf_decorate_type_name(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
    mut kind: libc::c_int,
) -> *const libc::c_char {
    let mut current_block: u64;
    let mut d: *mut ctf_dedup_t = &mut (*fp).ctf_dedup;
    ...
    match kind {
        6 => {
            k = b"s \0" as *const u8 as *const libc::c_char;
            i = 0 as libc::c_int as size_t;
        }
        7 => {
            k = b"u \0" as *const u8 as *const libc::c_char;
            i = 1 as libc::c_int as size_t;
        }
        8 => {
            k = b"e \0" as *const u8 as *const libc::c_char;
            i = 2 as libc::c_int as size_t;
        }
        _ => {
            k = b"\0" as *const u8 as *const libc::c_char;
            i = 3 as libc::c_int as size_t;
        }
    }
    ret = ctf_dynhash_lookup(
        (*d).cd_decorated_names[i as usize],
    ...
    if ret.is_null() {
        ...
        str = malloc(
            (strlen(name))
                .wrapping_add(strlen(k))
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        if str.is_null() {
            current_block = 7341840474467762762;
        } else {
            p = stpcpy(str, k);
            strcpy(p, name);
            ret = intern(fp, str);
...
#[inline]
unsafe extern "C" fn ctf_dedup_sha1_add(
    mut sha1: *mut ctf_sha1_t,
    mut buf: *const libc::c_void,
    mut len: size_t,
    mut description: *const libc::c_char,
    mut depth: libc::c_ulong,
) {
    ctf_sha1_add(sha1, buf, len);
}
unsafe extern "C" fn ctf_dedup_is_stub(
    mut name: *const libc::c_char,
    mut kind: libc::c_int,
    mut fwdkind: libc::c_int,
    mut flags: libc::c_int,
) -> libc::c_int {
    return (flags & 0x1 as libc::c_int != 0 && !name.is_null()
        && (kind == 6 as libc::c_int || kind == 7 as libc::c_int
            || kind == 9 as libc::c_int
                && (fwdkind == 6 as libc::c_int || fwdkind == 7 as libc::c_int)))
        as libc::c_int;
}
unsafe extern "C" fn ctf_dedup_record_origin(
    mut fp: *mut ctf_dict_t,
    mut input_num: libc::c_int,
    mut decorated: *const libc::c_char,
    mut id: *mut libc::c_void,
) -> libc::c_int {
    let mut d: *mut ctf_dedup_t = &mut (*fp).ctf_dedup;
    let mut origin: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut populate_origin: libc::c_int = 0 as libc::c_int;
    if ctf_dynhash_lookup_kv(
        (*d).cd_struct_origin,
        decorated as *const libc::c_void,
        0 as *mut *const libc::c_void,
        &mut origin,
    ) != 0
    {
        if (origin as uint64_t >> 32 as libc::c_int) as libc::c_int != input_num
            && (origin as uint64_t >> 32 as libc::c_int) as libc::c_int
                != -(1 as libc::c_int)
        {
            populate_origin = 1 as libc::c_int;
            origin = ((-(1 as libc::c_int) as uint64_t) << 32 as libc::c_int
                | -(1 as libc::c_int) as libc::c_ulong) as *mut libc::c_void;
        }
    } else {
        populate_origin = 1 as libc::c_int;
        origin = id;
    }
    if populate_origin != 0 {
        if ctf_dynhash_cinsert(
            (*d).cd_struct_origin,
            decorated as *const libc::c_void,
            origin,
        ) < 0 as libc::c_int
...
unsafe extern "C" fn ctf_dedup_rhash_type(
    mut fp: *mut ctf_dict_t,
    mut input: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut parents: *mut uint32_t,
    mut input_num: libc::c_int,
    mut type_0: ctf_id_t,
    mut type_id: *mut libc::c_void,
    mut tp: *const ctf_type_t,
    mut name: *const libc::c_char,
    mut decorated: *const libc::c_char,
    mut kind: libc::c_int,
    ...
    let mut hash: ctf_sha1_t = ctf_sha1_t {
        A: 0,
        B: 0,
        C: 0,
        D: 0,
    ...
    let mut child_type: ctf_id_t = 0;
    let mut hashbuf: [libc::c_char; 41] = [0; 41];
    let mut hval: *const libc::c_char = 0 as *const libc::c_char;
    let mut whaterr: *const libc::c_char = 0 as *const libc::c_char;
    let mut err: libc::c_int = 0 as libc::c_int;
    let mut citer: *const libc::c_char = 0 as *const libc::c_char;
    let mut citers: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    if ctf_dedup_is_stub(name, kind, (*tp).c2rust_unnamed.ctt_type as libc::c_int, flags)
        != 0
    {
        ctf_sha1_init(&mut hash);
        ctf_dedup_sha1_add(
            &mut hash,
            decorated as *const libc::c_void,
            (strlen(decorated)).wrapping_add(1 as libc::c_int as libc::c_ulong),
            b"decorated struct/union/forward name\0" as *const u8 as *const libc::c_char,
            depth,
        );
        ctf_sha1_fini(&mut hash, hashbuf.as_mut_ptr());
        hval = intern(fp, strdup(hashbuf.as_mut_ptr()));
        if hval.is_null() {
            ctf_err_warn(
                fp,
                0 as libc::c_int,
                ...
                dcgettext(
                    ...
                    b"%s (%i): out of memory during forwarding-stub hashing for type with GID %p\0"
        ...
        if (*d).cd_link_flags & 0x1 as libc::c_int != 0
            && ctf_dedup_record_origin(fp, input_num, decorated, type_id)
                < 0 as libc::c_int
        {
            return 0 as *const libc::c_char;
        }
    ...
    if !decorated.is_null()
        && (ctf_forwardable_kind(kind) != 0 || kind != 9 as libc::c_int)
    {
        if (*d).cd_link_flags & 0x1 as libc::c_int != 0
            && ctf_dedup_record_origin(fp, input_num, decorated, type_id)
                < 0 as libc::c_int
    ...
    ctf_dedup_sha1_add(
        &mut hash,
        &mut kind as *mut libc::c_int as *const libc::c_void,
    ...
    match kind {
        ...
        9 => {
            ctf_dedup_sha1_add(
                &mut hash,
                &(*tp).c2rust_unnamed.ctt_type as *const uint32_t as *const libc::c_void,
                ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                b"forwarded kind\0" as *const u8 as *const libc::c_char,
                depth,
            );
            current_block = 1425453989644512380;
        }
        1 | 2 => {
            let mut ep: ctf_encoding_t = ctf_encoding_t {
                cte_format: 0,
                cte_offset: 0,
                cte_bits: 0,
            };
            memset(
                &mut ep as *mut ctf_encoding_t as *mut libc::c_void,
                0 as libc::c_int,
                ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
            );
            ctf_dedup_sha1_add(
                &mut hash,
                &(*tp).c2rust_unnamed.ctt_size as *const uint32_t as *const libc::c_void,
                ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                b"size\0" as *const u8 as *const libc::c_char,
                depth,
            );
            if ctf_type_encoding(input, type_0, &mut ep) < 0 as libc::c_int {
                whaterr = b"error getting encoding\0" as *const u8
                    as *const libc::c_char;
                current_block = 1045305474589143846;
            } else {
                ctf_dedup_sha1_add(
                    &mut hash,
                    &mut ep as *mut ctf_encoding_t as *const libc::c_void,
                    ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
        ...
        10 | 11 | 12 | 13 | 3 => {
            child_type = ctf_type_reference(input, type_0);
            hval = ctf_dedup_hash_type(
                fp,
                input,
                inputs,
                parents,
            ...
            if hval.is_null() {
                whaterr = b"error doing referenced type hashing\0" as *const u8
                    as *const libc::c_char;
                current_block = 3768493925581638608;
            } else {
                ctf_dedup_sha1_add(
                    &mut hash,
                    hval as *const libc::c_void,
                    (strlen(hval)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                    b"referenced type\0" as *const u8 as *const libc::c_char,
                    depth,
                );
                citer = hval;
                current_block = 1425453989644512380;
        ...
        14 => {
            let mut slice: *const ctf_slice_t = 0 as *const ctf_slice_t;
            let mut dtd: *const ctf_dtdef_t = 0 as *const ctf_dtdef_t;
            let mut size: ssize_t = 0;
            let mut increment: ssize_t = 0;
            child_type = ctf_type_reference(input, type_0);
            ctf_get_ctt_size(input, tp, &mut size, &mut increment);
            ctf_dedup_sha1_add(
                &mut hash,
                &mut size as *mut ssize_t as *const libc::c_void,
            ...
            if hval.is_null() {
                whaterr = b"error doing slice-referenced type hashing\0" as *const u8
                    as *const libc::c_char;
                current_block = 3768493925581638608;
            } else {
                ctf_dedup_sha1_add(
                    ...
                    hval as *const libc::c_void,
                    (strlen(hval)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                    b"sliced type\0" as *const u8 as *const libc::c_char,
                    depth,
                );
                citer = hval;
                dtd = ctf_dynamic_type(input, type_0);
                if !dtd.is_null() {
                    slice = (*dtd).dtd_vlen as *mut ctf_slice_t;
                } else {
                    slice = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
                        as *mut ctf_slice_t;
                }
                ctf_dedup_sha1_add(
                    &mut hash,
                    &(*slice).cts_offset as *const libc::c_ushort as *const libc::c_void,
                    ::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong,
                    b"slice offset\0" as *const u8 as *const libc::c_char,
                    depth,
                );
                ctf_dedup_sha1_add(
                    &mut hash,
                    &(*slice).cts_bits as *const libc::c_ushort as *const libc::c_void,
                    ::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong,
                    b"slice bits\0" as *const u8 as *const libc::c_char,
                    depth,
                );
                current_block = 1425453989644512380;
            }
        ...
        4 => {
            let mut ar: ctf_arinfo_t = ctf_arinfo_t {
                ctr_contents: 0,
                ctr_index: 0,
                ctr_nelems: 0,
            };
            if ctf_array_info(input, type_0, &mut ar) < 0 as libc::c_int {
                whaterr = b"error getting array info\0" as *const u8
                    as *const libc::c_char;
                current_block = 1045305474589143846;
            } else {
                hval = ctf_dedup_hash_type(
                ...
                if hval.is_null() {
                    whaterr = b"error doing array contents type hashing\0" as *const u8
                        as *const libc::c_char;
                    current_block = 3768493925581638608;
                } else {
                    ctf_dedup_sha1_add(
                        ...
                        hval as *const libc::c_void,
                        (strlen(hval)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                        b"array contents\0" as *const u8 as *const libc::c_char,
                        depth,
                    );
                    whaterr = b"error updating citers\0" as *const u8
                        as *const libc::c_char;
                    if citers.is_null() {
                        citers = ctf_dynset_create(
                            Some(
                                htab_hash_string
                                    as unsafe extern "C" fn(*const libc::c_void) -> hashval_t,
                            ),
                        ...
                        if citers.is_null() {
                            current_block = 5408167697864139036;
                        } else {
                    ...
                    match current_block {
                        5408167697864139036 => {}
                        _ => {
                            if ctf_dynset_cinsert(citers, hval as *const libc::c_void)
                                < 0 as libc::c_int
                            {
                                current_block = 5408167697864139036;
                            } else {
                                ...
                                if hval.is_null() {
                                    whaterr = b"error doing array index type hashing\0"
                                        as *const u8 as *const libc::c_char;
                                    current_block = 3768493925581638608;
                                } else {
                                    ctf_dedup_sha1_add(
                                        ...
                                        (strlen(hval))
                                            .wrapping_add(1 as libc::c_int as libc::c_ulong),
                                        b"array index\0" as *const u8 as *const libc::c_char,
                                        depth,
                                    );
                                    ctf_dedup_sha1_add(
                                        &mut hash,
                                        &mut ar.ctr_nelems as *mut uint32_t as *const libc::c_void,
                                        ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                                        b"element count\0" as *const u8 as *const libc::c_char,
                                        depth,
                                    );
                                    whaterr = b"error updating citers\0" as *const u8
                                        as *const libc::c_char;
        ...
        5 => {
            let mut fi: ctf_funcinfo_t = ctf_funcinfo_t {
                ctc_return: 0,
                ctc_argc: 0,
                ctc_flags: 0,
            };
            let mut args: *mut ctf_id_t = 0 as *mut ctf_id_t;
            let mut j: uint32_t = 0;
            if ctf_func_type_info(input, type_0, &mut fi) < 0 as libc::c_int {
                whaterr = b"error getting func type info\0" as *const u8
                    as *const libc::c_char;
                current_block = 1045305474589143846;
            } else {
                hval = ctf_dedup_hash_type(
                ...
                if hval.is_null() {
                    whaterr = b"error getting func return type\0" as *const u8
                        as *const libc::c_char;
                    current_block = 3768493925581638608;
                } else {
                    ctf_dedup_sha1_add(
                        ...
                        hval as *const libc::c_void,
                        (strlen(hval)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                        b"func return\0" as *const u8 as *const libc::c_char,
                        depth,
                    );
                    ctf_dedup_sha1_add(
                        &mut hash,
                        &mut fi.ctc_argc as *mut uint32_t as *const libc::c_void,
                        ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                        b"func argc\0" as *const u8 as *const libc::c_char,
                        depth,
                    );
                    ctf_dedup_sha1_add(
                        &mut hash,
                        &mut fi.ctc_flags as *mut uint32_t as *const libc::c_void,
                        ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                        b"func flags\0" as *const u8 as *const libc::c_char,
                        depth,
                    );
                    whaterr = b"error updating citers\0" as *const u8
                        as *const libc::c_char;
                    ...
                    match current_block {
                        ...
                        _ => {
                                ...
                                < 0 as libc::c_int
                            {
                                ...
                                args = calloc(
                                    fi.ctc_argc as libc::c_ulong,
                                    ::core::mem::size_of::<ctf_id_t>() as libc::c_ulong,
                                ) as *mut ctf_id_t;
                                if args.is_null() {
                                    err = 12 as libc::c_int;
                                    whaterr = b"error doing memory allocation\0" as *const u8
                                        as *const libc::c_char;
                                    current_block = 3768493925581638608;
                                } else if ctf_func_type_args(
                                    input,
                                    type_0,
                                    fi.ctc_argc,
                                    args,
                                ) < 0 as libc::c_int
                                {
                                    ...
                                    whaterr = b"error getting func arg type\0" as *const u8
                                        as *const libc::c_char;
                                    current_block = 1045305474589143846;
                                } else {
                                    ...
                                    loop {
                                        ...
                                        if hval.is_null() {
                                            free(args as *mut libc::c_void);
                                            whaterr = b"error doing func arg type hashing\0"
                                                as *const u8 as *const libc::c_char;
                                            current_block = 3768493925581638608;
                                            break;
                                        } else {
                                            ctf_dedup_sha1_add(
                                                ...
                                                (strlen(hval))
                                                    .wrapping_add(1 as libc::c_int as libc::c_ulong),
                                                b"func arg type\0" as *const u8 as *const libc::c_char,
                                                depth,
                                            );
                                            whaterr = b"error updating citers\0" as *const u8
                                                as *const libc::c_char;
        ...
        8 => {
            ...
            ctf_dedup_sha1_add(
                ...
                &(*tp).c2rust_unnamed.ctt_size as *const uint32_t as *const libc::c_void,
                ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                b"enum size\0" as *const u8 as *const libc::c_char,
                depth,
            );
            loop {
                ename = ctf_enum_next(input, type_0, &mut i, &mut val);
                if ename.is_null() {
                    break;
                }
                ctf_dedup_sha1_add(
                    ...
                    (strlen(ename)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                    b"enumerator\0" as *const u8 as *const libc::c_char,
                    depth,
                );
                ctf_dedup_sha1_add(
                    &mut hash,
                    ...
                    b"enumerand\0" as *const u8 as *const libc::c_char,
                    depth,
                );
            }
            if ctf_errno(input) != ECTF_NEXT_END as libc::c_int {
                whaterr = b"error doing enum member iteration\0" as *const u8
                    as *const libc::c_char;
                current_block = 1045305474589143846;
            } else {
                current_block = 1425453989644512380;
        ...
        6 | 7 => {
            ...
            let mut mname: *const libc::c_char = 0 as *const libc::c_char;
            let mut membtype: ctf_id_t = 0;
            let mut size_0: ssize_t = 0;
            ctf_get_ctt_size(input, tp, &mut size_0, 0 as *mut ssize_t);
            ctf_dedup_sha1_add(
                &mut hash,
                &mut size_0 as *mut ssize_t as *const libc::c_void,
                ::core::mem::size_of::<ssize_t>() as libc::c_ulong,
                b"struct size\0" as *const u8 as *const libc::c_char,
                depth,
            );
            loop {
                offset = ctf_member_next(
                    input,
                    type_0,
                    &mut i,
                    &mut mname,
                ...
                if mname.is_null() {
                    mname = b"\0" as *const u8 as *const libc::c_char;
                }
                ctf_dedup_sha1_add(
                    &mut hash,
                    mname as *const libc::c_void,
                    (strlen(mname)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                ...
                if hval.is_null() {
                    whaterr = b"error doing struct/union member type hashing\0"
                        as *const u8 as *const libc::c_char;
                    current_block = 2261717864538194302;
                    break;
                } else {
                    ctf_dedup_sha1_add(
                        &mut hash,
                        hval as *const libc::c_void,
                        (strlen(hval)).wrapping_add(1 as libc::c_int as libc::c_ulong),
                        b"member hash\0" as *const u8 as *const libc::c_char,
                        depth,
                    );
                    ctf_dedup_sha1_add(
                        &mut hash,
                        &mut offset as *mut ssize_t as *const libc::c_void,
                        ::core::mem::size_of::<ssize_t>() as libc::c_ulong,
                        b"member offset\0" as *const u8 as *const libc::c_char,
                        depth,
                    );
                    whaterr = b"error updating citers\0" as *const u8
                        as *const libc::c_char;
            ...
            match current_block {
                ...
                _ => {
                    match current_block {
                        ...
                        _ => {
                            if ctf_errno(input) != ECTF_NEXT_END as libc::c_int {
                                whaterr = b"error doing struct/union member iteration\0"
                                    as *const u8 as *const libc::c_char;
                                current_block = 1045305474589143846;
                            } else {
                                current_block = 1425453989644512380;
        ...
        _ => {
            whaterr = b"error: unknown type kind\0" as *const u8 as *const libc::c_char;
            current_block = 3768493925581638608;
        }
    }
    match current_block {
        1425453989644512380 => {
            ...
            hval = intern(fp, strdup(hashbuf.as_mut_ptr()));
            if hval.is_null() {
                whaterr = b"cannot intern hash\0" as *const u8 as *const libc::c_char;
                current_block = 5408167697864139036;
            } else {
                whaterr = b"error tracking citers\0" as *const u8 as *const libc::c_char;
                if !citer.is_null() {
                    let mut citer_hashes: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
                    citer_hashes = make_set_element(
                        (*d).cd_citers,
                        citer as *const libc::c_void,
                    );
                    if citer_hashes.is_null() {
                        current_block = 5408167697864139036;
                    } else if ctf_dynset_cinsert(
                        citer_hashes,
                        hval as *const libc::c_void,
                    ) < 0 as libc::c_int
                    {
                ...
                } else if !citers.is_null() {
                    let mut k: *const libc::c_void = 0 as *const libc::c_void;
                    loop {
                        err = ctf_dynset_cnext(citers, &mut i, &mut k);
                        if !(err == 0 as libc::c_int) {
                            current_block = 7293850626974290116;
                            break;
                        }
                        let mut citer_hashes_0: *mut ctf_dynset_t = 0
                            as *mut ctf_dynset_t;
                        citer = k as *const libc::c_char;
                        citer_hashes_0 = make_set_element(
                            (*d).cd_citers,
                            citer as *const libc::c_void,
                        );
                        if citer_hashes_0.is_null() {
                            current_block = 5408167697864139036;
                            break;
                        }
                        if ctf_dynset_exists(
                            citer_hashes_0,
                            hval as *const libc::c_void,
                            0 as *mut *const libc::c_void,
                        ) != 0
    ...
    match current_block {
        5408167697864139036 => {
            ctf_set_errno(fp, *__errno_location());
            ctf_err_warn(
                fp,
                0 as libc::c_int,
                0 as libc::c_int,
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"%s (%i): %s: during type hashing for type %lx, kind %i\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ctf_link_input_name(input),
        ...
        _ => {
            ctf_sha1_fini(&mut hash, 0 as *mut libc::c_char);
            ctf_err_warn(
                fp,
                0 as libc::c_int,
                err,
...
unsafe extern "C" fn ctf_dedup_hash_type(
    mut fp: *mut ctf_dict_t,
    mut input: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut parents: *mut uint32_t,
    ...
    let mut type_id: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut hval: *const libc::c_char = 0 as *const libc::c_char;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut whaterr: *const libc::c_char = 0 as *const libc::c_char;
    let mut decorated: *const libc::c_char = 0 as *const libc::c_char;
    let mut kind: uint32_t = 0;
    let mut fwdkind: uint32_t = 0;
    depth = depth.wrapping_add(1);
    depth;
    if type_0 == 0 as libc::c_int as libc::c_ulong {
        return b"00000000000000000000\0" as *const u8 as *const libc::c_char;
    }
    type_id = ((input_num as uint64_t) << 32 as libc::c_int | type_0)
        as *mut libc::c_void;
    tp = ctf_lookup_by_id(&mut input, type_0);
    if tp.is_null() {
        ...
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"%s (%i): lookup failure for type %lx: flags %x\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            ctf_link_input_name(input),
    ...
    kind = ((*(*input).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*tp).ctt_info);
    name = ctf_strraw(input, (*tp).ctt_name);
    if (*tp).ctt_name == 0 as libc::c_int as libc::c_uint || name.is_null()
    ...
    fwdkind = kind;
    if !name.is_null() {
        if kind == 9 as libc::c_int as libc::c_uint {
            fwdkind = (*tp).c2rust_unnamed.ctt_type;
        }
        decorated = ctf_decorate_type_name(fp, name, fwdkind as libc::c_int);
        if decorated.is_null() {
            return 0 as *const libc::c_char;
        }
    }
    if ctf_dedup_is_stub(name, kind as libc::c_int, fwdkind as libc::c_int, flags) == 0 {
        hval = ctf_dynhash_lookup((*d).cd_type_hashes, type_id) as *const libc::c_char;
        if !hval.is_null() {
            populate_fun
                .expect(
                    "non-null function pointer",
                )(fp, input, inputs, input_num, type_0, type_id, decorated, hval);
            return hval;
        }
    }
    hval = ctf_dedup_rhash_type(
        fp,
        input,
        inputs,
        parents,
    ...
    if ctf_dedup_is_stub(name, kind as libc::c_int, fwdkind as libc::c_int, flags) == 0 {
        if ctf_dynhash_cinsert((*d).cd_type_hashes, type_id, hval as *const libc::c_void)
            < 0 as libc::c_int
        {
            whaterr = b"error hash caching\0" as *const u8 as *const libc::c_char;
            ctf_set_errno(fp, *__errno_location());
            current_block = 7582715272598172990;
        } else if populate_fun
            .expect(
                "non-null function pointer",
            )(fp, input, inputs, input_num, type_0, type_id, decorated, hval)
            < 0 as libc::c_int
        {
            whaterr = b"error calling population function\0" as *const u8
                as *const libc::c_char;
            current_block = 7582715272598172990;
        } else {
        ...
        match current_block {
            ...
            _ => {
                ctf_err_warn(
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"%s (%i): %s: during type hashing, type %lx, kind %i\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    ctf_link_input_name(input),
...
unsafe extern "C" fn ctf_dedup_populate_mappings(
    mut fp: *mut ctf_dict_t,
    mut input: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut input_num: libc::c_int,
    mut type_0: ctf_id_t,
    mut id: *mut libc::c_void,
    mut decorated_name: *const libc::c_char,
    mut hval: *const libc::c_char,
) -> libc::c_int {
    let mut d: *mut ctf_dedup_t = &mut (*fp).ctf_dedup;
    let mut type_ids: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    let mut name_counts: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut count: libc::c_long = 0;
    type_ids = ctf_dynhash_lookup((*d).cd_output_mapping, hval as *const libc::c_void)
        as *mut ctf_dynset_t;
    if type_ids.is_null() {
        if ctf_dynhash_cinsert((*d).cd_output_first_gid, hval as *const libc::c_void, id)
            < 0 as libc::c_int
        {
            return ctf_set_errno(fp, *__errno_location()) as libc::c_int;
        }
        type_ids = ctf_dynset_create(htab_hash_pointer, htab_eq_pointer, None);
        if type_ids.is_null() {
            return ctf_set_errno(fp, *__errno_location()) as libc::c_int;
        }
        if ctf_dynhash_insert(
            (*d).cd_output_mapping,
            hval as *mut libc::c_void,
            type_ids as *mut libc::c_void,
        ) < 0 as libc::c_int
        {
    ...
    if ctf_dynset_exists(type_ids, id, 0 as *mut *const libc::c_void) == 0
        && ctf_dynset_insert(type_ids, id) < 0 as libc::c_int
    {
        return ctf_set_errno(fp, *__errno_location()) as libc::c_int;
    }
    if decorated_name.is_null() {
        return 0 as libc::c_int;
    }
    hval = ctf_dynhash_lookup((*d).cd_type_hashes, id) as *const libc::c_char;
    name_counts = ctf_dynhash_lookup(
        (*d).cd_name_counts,
        decorated_name as *const libc::c_void,
    ) as *mut ctf_dynhash_t;
    if name_counts.is_null() {
        name_counts = ctf_dynhash_create(
            Some(
                ctf_hash_string
        ...
        if ctf_dynhash_cinsert(
            (*d).cd_name_counts,
            decorated_name as *const libc::c_void,
            name_counts as *const libc::c_void,
        ) < 0 as libc::c_int
        {
    ...
    count = ctf_dynhash_lookup(name_counts, hval as *const libc::c_void) as uintptr_t
        as libc::c_long;
    if ctf_dynhash_cinsert(
        name_counts,
        hval as *const libc::c_void,
        (count + 1 as libc::c_int as libc::c_long) as uintptr_t as *const libc::c_void,
    ) < 0 as libc::c_int
    {
        return ctf_set_errno(fp, *__errno_location()) as libc::c_int;
    }
...
unsafe extern "C" fn ctf_dedup_mark_conflicting_hash(
    mut fp: *mut ctf_dict_t,
    mut hval: *const libc::c_char,
) -> libc::c_int {
    let mut d: *mut ctf_dedup_t = &mut (*fp).ctf_dedup;
    ...
    ctf_dprintf(
        b"Marking %s as conflicted\n\0" as *const u8 as *const libc::c_char,
        hval,
    );
    if ctf_dynset_cinsert((*d).cd_conflicting_types, hval as *const libc::c_void)
        < 0 as libc::c_int
    {
        ctf_dprintf(
            b"Out of memory marking %s as conflicted\n\0" as *const u8
                as *const libc::c_char,
            hval,
        );
        ctf_set_errno(fp, *__errno_location());
    ...
    citers = ctf_dynhash_lookup((*d).cd_citers, hval as *const libc::c_void)
        as *mut ctf_dynset_t;
    if citers.is_null() {
        return 0 as libc::c_int;
    }
    loop {
        ...
        let mut hv: *const libc::c_char = k as *const libc::c_char;
        if ctf_dynset_exists(
            (*d).cd_conflicting_types,
            hv as *const libc::c_void,
            0 as *mut *const libc::c_void,
        ) != 0
        {
            continue;
        }
        if ctf_dedup_mark_conflicting_hash(fp, hv) < 0 as libc::c_int {
            ctf_next_destroy(i);
            return -(1 as libc::c_int);
        }
    }
...
unsafe extern "C" fn ctf_dedup_hash_kind(
    mut fp: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    ...
    if ctf_assert_internal(
        fp,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        1357 as libc::c_int as size_t,
        b"ctf_dynhash_elements (d->cd_output_mapping) > 0\0" as *const u8
            as *const libc::c_char,
        (ctf_dynhash_elements((*d).cd_output_mapping)
            > 0 as libc::c_int as libc::c_ulong) as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int);
    }
    type_ids = ctf_dynhash_lookup((*d).cd_output_mapping, hash as *const libc::c_void)
        as *mut ctf_dynset_t;
    if type_ids.is_null() {
        ctf_dprintf(
            b"Looked up type kind by nonexistent hash %s.\n\0" as *const u8
                as *const libc::c_char,
            hash,
        );
        return ctf_set_errno(fp, ECTF_INTERNAL as libc::c_int) as libc::c_int;
    }
    ...
    if ctf_assert_internal(
        ...
        !id.is_null() as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int);
    }
    return ctf_type_kind_unsliced(
        *inputs.offset((id as uint64_t >> 32 as libc::c_int) as libc::c_int as isize),
        (id as uint64_t as libc::c_ulonglong
            & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t,
    );
}
unsafe extern "C" fn ctf_dedup_count_types(
    mut key_: *mut libc::c_void,
    mut value: *mut libc::c_void,
    mut arg_: *mut libc::c_void,
) -> libc::c_int {
    let mut hval: *const libc::c_char = key_ as *const libc::c_char;
    let mut kind: libc::c_int = 0;
    let mut arg: *mut ctf_dedup_type_counter_t = arg_ as *mut ctf_dedup_type_counter_t;
    kind = ctf_dedup_hash_kind((*arg).fp, (*arg).inputs, hval);
    if kind != 9 as libc::c_int {
        (*arg).num_non_forwards += 1;
        (*arg).num_non_forwards;
        ctf_dprintf(
            b"Counting hash %s: kind %i: num_non_forwards is %i\n\0" as *const u8
                as *const libc::c_char,
            hval,
            kind,
            (*arg).num_non_forwards,
    ...
    if (*arg).num_non_forwards > 1 as libc::c_int {
        return 1 as libc::c_int;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_dedup_detect_name_ambiguity(
    mut fp: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
) -> libc::c_int {
    let mut current_block: u64;
    ...
    let mut whaterr: *const libc::c_char = 0 as *const libc::c_char;
    's_13: loop {
        err = ctf_dynhash_next((*d).cd_name_counts, &mut i, &mut k, &mut v);
        if !(err == 0 as libc::c_int) {
            current_block = 10891380440665537214;
            break;
        }
        let mut decorated: *const libc::c_char = k as *const libc::c_char;
        let mut name_counts: *mut ctf_dynhash_t = v as *mut ctf_dynhash_t;
        let mut j: *mut ctf_next_t = 0 as *mut ctf_next_t;
        if *decorated.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
            && *decorated.offset(1 as libc::c_int as isize) as libc::c_int == ' ' as i32
        {
            let mut counters: ctf_dedup_type_counter_t = {
                let mut init = ctf_dedup_type_counter {
                    fp: fp,
                    inputs: inputs,
                    num_non_forwards: 0 as libc::c_int,
                };
                init
            };
            let mut counts: *mut ctf_dynhash_t = v as *mut ctf_dynhash_t;
            ctf_dynhash_iter_find(
                counts,
                Some(
                ...
                &mut counters as *mut ctf_dedup_type_counter_t as *mut libc::c_void,
            );
            if ctf_errno(fp) == ECTF_INTERNAL as libc::c_int {
                current_block = 2701292247398252667;
                break;
            }
            if !(counters.num_non_forwards > 1 as libc::c_int) {
                continue;
            }
            let mut hval_: *const libc::c_void = 0 as *const libc::c_void;
            loop {
                ...
                let mut hval: *const libc::c_char = hval_ as *const libc::c_char;
                let mut type_ids: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
                let mut id: *mut libc::c_void = 0 as *mut libc::c_void;
                let mut kind: libc::c_int = 0;
                type_ids = ctf_dynhash_lookup(
                    (*d).cd_output_mapping,
                    hval as *const libc::c_void,
                ) as *mut ctf_dynset_t;
                if type_ids.is_null() {
                ...
                kind = ctf_type_kind(
                    *inputs
                        .offset(
                            (id as uint64_t >> 32 as libc::c_int) as libc::c_int as isize,
                        ),
                    (id as uint64_t as libc::c_ulonglong
                        & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t,
                );
                if kind != 9 as libc::c_int {
                    ctf_dprintf(
                        b"Marking %p, with hash %s, conflicting: one of many non-forward GIDs for %s\n\0"
                            as *const u8 as *const libc::c_char,
                        id,
                        hval,
            ...
            whaterr = b"error marking conflicting structs/unions\0" as *const u8
                as *const libc::c_char;
            current_block = 17675898535909567486;
            break;
        } else {
            let mut key: *const libc::c_void = 0 as *const libc::c_void;
            let mut count: *const libc::c_void = 0 as *const libc::c_void;
            let mut hval_0: *const libc::c_char = 0 as *const libc::c_char;
            let mut max_hcount: libc::c_long = -(1 as libc::c_int) as libc::c_long;
            let mut max_hval: *const libc::c_char = 0 as *const libc::c_char;
            if ctf_dynhash_elements(name_counts) <= 1 as libc::c_int as libc::c_ulong {
                continue;
            }
            loop {
                err = ctf_dynhash_cnext(name_counts, &mut j, &mut key, &mut count);
                if !(err == 0 as libc::c_int) {
                    break;
                }
                hval_0 = key as *const libc::c_char;
                if count as uintptr_t as libc::c_long > max_hcount {
                    max_hcount = count as uintptr_t as libc::c_long;
                    max_hval = hval_0;
                }
            }
            if err != ECTF_NEXT_END as libc::c_int {
                whaterr = b"error finding commonest conflicting type\0" as *const u8
                    as *const libc::c_char;
                current_block = 17675898535909567486;
                break;
            } else {
                loop {
                    ...
                    hval_0 = key as *const libc::c_char;
                    if strcmp(max_hval, hval_0) == 0 as libc::c_int {
                        continue;
                    }
                    ctf_dprintf(
                        b"Marking %s, an uncommon hash for %s, conflicting\n\0"
                            as *const u8 as *const libc::c_char,
                        hval_0,
                        k as *const libc::c_char,
                    );
                    if !(ctf_dedup_mark_conflicting_hash(fp, hval_0) < 0 as libc::c_int)
                    {
                        continue;
                    }
                    whaterr = b"error marking hashes as conflicting\0" as *const u8
                        as *const libc::c_char;
                    current_block = 11468016139594100206;
                    break 's_13;
                }
                if !(err != ECTF_NEXT_END as libc::c_int) {
                    continue;
                }
                whaterr = b"marking uncommon conflicting types\0" as *const u8
                    as *const libc::c_char;
                current_block = 17675898535909567486;
                break;
            }
    ...
    match current_block {
        10891380440665537214 => {
            if err != ECTF_NEXT_END as libc::c_int {
                whaterr = b"scanning for ambiguous names\0" as *const u8
                    as *const libc::c_char;
            } else {
                return 0 as libc::c_int
            }
        }
        11468016139594100206 => {
            ctf_next_destroy(i);
            ctf_err_warn(
                fp,
                0 as libc::c_int,
    ...
    ctf_err_warn(
        ...
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"iteration failed: %s\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn ctf_dedup_init(mut fp: *mut ctf_dict_t) -> libc::c_int {
    let mut current_block: u64;
    let mut d: *mut ctf_dedup_t = &mut (*fp).ctf_dedup;
    let mut i: size_t = 0;
    if !(ctf_dedup_atoms_init(fp) < 0 as libc::c_int) {
        i = 0 as libc::c_int as size_t;
        loop {
            ...
            (*d)
                .cd_decorated_names[i
                as usize] = ctf_dynhash_create(
                Some(
                    ctf_hash_string
                        as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                ),
            ...
            if ((*d).cd_decorated_names[i as usize]).is_null() {
                current_block = 17967612148000464215;
                break;
            }
            i = i.wrapping_add(1);
            i;
        ...
        match current_block {
            17967612148000464215 => {}
            _ => {
                (*d)
                    .cd_name_counts = ctf_dynhash_create(
                    Some(
                        ctf_hash_string
                            as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                    ),
                    ...
                    None,
                    ::core::mem::transmute::<
                        Option::<unsafe extern "C" fn(*mut ctf_dynhash_t) -> ()>,
                        ctf_hash_free_fun,
                    >(
                        Some(
                            ctf_dynhash_destroy
                                as unsafe extern "C" fn(*mut ctf_dynhash_t) -> (),
                        ),
                    ),
                );
                if !((*d).cd_name_counts).is_null() {
                    (*d)
                        .cd_type_hashes = ctf_dynhash_create(
                        Some(
                            ctf_hash_integer
                                as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                        ),
                    ...
                    if !((*d).cd_type_hashes).is_null() {
                        (*d)
                            .cd_struct_origin = ctf_dynhash_create(
                            Some(
                                ctf_hash_string
                                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                            ),
                        ...
                        if !((*d).cd_struct_origin).is_null() {
                            (*d)
                                .cd_citers = ctf_dynhash_create(
                                Some(
                                    ctf_hash_string
                                        as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                                ),
                                ...
                                None,
                                ::core::mem::transmute::<
                                    Option::<unsafe extern "C" fn(*mut ctf_dynset_t) -> ()>,
                                    ctf_hash_free_fun,
                                >(
                                    Some(
                                        ctf_dynset_destroy
                                            as unsafe extern "C" fn(*mut ctf_dynset_t) -> (),
                                    ),
                                ),
                            );
                            if !((*d).cd_citers).is_null() {
                                (*d)
                                    .cd_output_mapping = ctf_dynhash_create(
                                    Some(
                                        ctf_hash_string
                                            as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                                    ),
                                ...
                                if !((*d).cd_output_mapping).is_null() {
                                    (*d)
                                        .cd_output_first_gid = ctf_dynhash_create(
                                        Some(
                                            ctf_hash_string
                                                as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                                        ),
                                    ...
                                    if !((*d).cd_output_first_gid).is_null() {
                                        (*d)
                                            .cd_input_nums = ctf_dynhash_create(
                                            Some(
                                                ctf_hash_integer
                                                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                                            ),
                                        ...
                                        if !((*d).cd_input_nums).is_null() {
                                            (*d)
                                                .cd_emission_struct_members = ctf_dynhash_create(
                                                Some(
                                                    ctf_hash_integer
                                                        as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                                                ),
                                            ...
                                            if !((*d).cd_emission_struct_members).is_null() {
                                                (*d)
                                                    .cd_conflicting_types = ctf_dynset_create(
                                                    Some(
                                                        htab_hash_string
                                                            as unsafe extern "C" fn(*const libc::c_void) -> hashval_t,
                                                    ),
                                                ...
                                                if !((*d).cd_conflicting_types).is_null() {
                                                    return 0 as libc::c_int;
                                                }
                                            }
                                        }
    ...
    ctf_err_warn(
        ...
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"ctf_dedup_init: cannot initialize: out of memory\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dedup_fini(
    mut fp: *mut ctf_dict_t,
    mut outputs: *mut *mut ctf_dict_t,
    mut noutputs: uint32_t,
) {
    let mut d: *mut ctf_dedup_t = &mut (*fp).ctf_dedup;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < 4 as libc::c_int as libc::c_ulong {
        ctf_dynhash_destroy((*d).cd_decorated_names[i as usize]);
        i = i.wrapping_add(1);
        i;
    }
    ...
    if !outputs.is_null() {
        i = 0 as libc::c_int as size_t;
        while i < noutputs as libc::c_ulong {
            let mut od: *mut ctf_dedup_t = &mut (**outputs.offset(i as isize)).ctf_dedup;
...
unsafe extern "C" fn ctf_dedup_multiple_input_dicts(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut hval: *const libc::c_char,
) -> libc::c_int {
    let mut d: *mut ctf_dedup_t = &mut (*output).ctf_dedup;
    let mut type_ids: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut id: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut found: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut relative_found: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut type_id: *const libc::c_char = 0 as *const libc::c_char;
    let mut input_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut input_id: ctf_id_t = 0;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut decorated: *const libc::c_char = 0 as *const libc::c_char;
    let mut fwdkind: libc::c_int = 0;
    ...
    if ctf_assert_internal(
        ...
        b"type_ids\0" as *const u8 as *const libc::c_char,
        !type_ids.is_null() as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int);
    }
    loop {
        err = ctf_dynset_next(type_ids, &mut i, &mut id);
        if !(err == 0 as libc::c_int) {
            break;
        }
        let mut fp: *mut ctf_dict_t = *inputs
            .offset((id as uint64_t >> 32 as libc::c_int) as libc::c_int as isize);
        if fp == found || fp == relative_found {
            continue;
        }
        if found.is_null() {
            found = fp;
        } else if relative_found.is_null()
    ...
    if err != ECTF_NEXT_END as libc::c_int && err != 0 as libc::c_int {
        ctf_err_warn(
            output,
            0 as libc::c_int,
            err,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"iteration error propagating conflictedness\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        return ctf_set_errno(output, err) as libc::c_int;
    }
    if multiple != 0 {
        return multiple;
    }
    type_id = ctf_dynset_lookup_any(type_ids) as *const libc::c_char;
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        1779 as libc::c_int as size_t,
        b"type_id\0" as *const u8 as *const libc::c_char,
        !type_id.is_null() as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int);
    }
    input_fp = *inputs
        .offset((type_id as uint64_t >> 32 as libc::c_int) as libc::c_int as isize);
    input_id = (type_id as uint64_t as libc::c_ulonglong
        & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t;
    fwdkind = ctf_type_kind_forwarded(input_fp, input_id);
    name = ctf_type_name_raw(input_fp, input_id);
    if (fwdkind == 6 as libc::c_int || fwdkind == 7 as libc::c_int)
        && *name.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
    {
        let mut origin: *const libc::c_void = 0 as *const libc::c_void;
        decorated = ctf_decorate_type_name(output, name, fwdkind);
        if decorated.is_null() {
            return -(1 as libc::c_int);
        }
        origin = ctf_dynhash_lookup(
            (*d).cd_struct_origin,
            decorated as *const libc::c_void,
        );
        if !origin.is_null()
...
unsafe extern "C" fn ctf_dedup_conflictify_unshared(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
) -> libc::c_int {
    let mut current_block: u64;
    ...
    let mut err: libc::c_int = 0;
    let mut k: *const libc::c_void = 0 as *const libc::c_void;
    let mut to_mark: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    to_mark = ctf_dynset_create(
    ...
    if to_mark.is_null() {
        ctf_set_errno(output, *__errno_location());
        current_block = 14098838988056647344;
    } else {
        loop {
            err = ctf_dynhash_cnext(
                (*d).cd_output_mapping,
            ...
            let mut hval: *const libc::c_char = k as *const libc::c_char;
            let mut conflicting: libc::c_int = 0;
            conflicting = (ctf_dedup_multiple_input_dicts(output, inputs, hval) == 0)
                as libc::c_int;
            if conflicting < 0 as libc::c_int {
                current_block = 14098838988056647344;
                break;
            }
            if !(conflicting != 0) {
            ...
            if ctf_dynset_cinsert(to_mark, hval as *const libc::c_void)
                < 0 as libc::c_int
            {
                current_block = 14098838988056647344;
                break;
        ...
        match current_block {
            14098838988056647344 => {}
            _ => {
                if err != ECTF_NEXT_END as libc::c_int {
                    current_block = 6579192685878826812;
                } else {
                    loop {
                        err = ctf_dynset_cnext(to_mark, &mut i, &mut k);
                        if !(err == 0 as libc::c_int) {
                            current_block = 1856101646708284338;
                            break;
                        }
                        let mut hval_0: *const libc::c_char = k as *const libc::c_char;
                        if ctf_dedup_mark_conflicting_hash(output, hval_0)
                            < 0 as libc::c_int
                        {
                            current_block = 14098838988056647344;
                            break;
    ...
    ctf_err_warn(
        ...
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"conflictifying unshared types\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    return ctf_set_errno(output, err) as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dedup(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    mut cu_mapped: libc::c_int,
) -> libc::c_int {
    let mut current_block: u64;
    let mut d: *mut ctf_dedup_t = &mut (*output).ctf_dedup;
    let mut i: size_t = 0;
    let mut it: *mut ctf_next_t = 0 as *mut ctf_next_t;
    if ctf_dedup_init(output) < 0 as libc::c_int {
        return -(1 as libc::c_int);
    }
    i = 0 as libc::c_int as size_t;
    loop {
        if !(i < ninputs as libc::c_ulong) {
        ...
        ctf_dprintf(
            b"Input %i: %s\n\0" as *const u8 as *const libc::c_char,
            i as libc::c_int,
            ctf_link_input_name(*inputs.offset(i as isize)),
        );
        if ctf_dynhash_insert(
            (*d).cd_input_nums,
            *inputs.offset(i as isize) as *mut libc::c_void,
        ...
        ) < 0 as libc::c_int
        {
            ...
            ctf_err_warn(
                ...
                *__errno_location(),
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"ctf_dedup: cannot initialize: %s\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ctf_errmsg(*__errno_location()),
            );
            current_block = 8232513602864086521;
            break;
        } else {
            i = i.wrapping_add(1);
            i;
    ...
    match current_block {
        14523784380283086299 => {
            ...
            if cu_mapped != 0 {
                (*d).cd_link_flags &= !(0x1 as libc::c_int);
            }
            ctf_dprintf(
                b"Computing type hashes\n\0" as *const u8 as *const libc::c_char,
            );
            i = 0 as libc::c_int as size_t;
            's_58: loop {
                if !(i < ninputs as libc::c_ulong) {
                ...
                let mut id: ctf_id_t = 0;
                loop {
                    id = ctf_type_next(
                        *inputs.offset(i as isize),
                        &mut it,
                        0 as *mut libc::c_int,
                        1 as libc::c_int,
                    );
                    if !(id != -(1 as libc::c_long) as ctf_id_t) {
                        break;
                    }
                    if (ctf_dedup_hash_type(
                        output,
                        *inputs.offset(i as isize),
                        inputs,
                        parents,
                ...
                if ctf_errno(*inputs.offset(i as isize)) != ECTF_NEXT_END as libc::c_int
                {
                    ctf_set_errno(output, ctf_errno(*inputs.offset(i as isize)));
                    ctf_err_warn(
                        output,
                        0 as libc::c_int,
                        0 as libc::c_int,
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"iteration failure computing type hashes\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            match current_block {
                ...
                _ => {
                    ctf_dprintf(
                        b"Detecting type name ambiguity\n\0" as *const u8
                            as *const libc::c_char,
                    );
                    if !(ctf_dedup_detect_name_ambiguity(output, inputs)
                        < 0 as libc::c_int)
                    {
                        if (*d).cd_link_flags & 0x1 as libc::c_int != 0 {
                            ctf_dprintf(
                                b"Conflictifying unshared types\n\0" as *const u8
                                    as *const libc::c_char,
                            );
    ...
    ctf_dedup_fini(output, 0 as *mut *mut ctf_dict_t, 0 as libc::c_int as uint32_t);
    return -(1 as libc::c_int);
}
unsafe extern "C" fn ctf_dedup_rwalk_one_output_mapping(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    mut already_visited: *mut ctf_dynset_t,
    mut visited: libc::c_int,
    mut type_id: *mut libc::c_void,
    mut hval: *const libc::c_char,
    mut visit_fun: Option::<
        unsafe extern "C" fn(
            *const libc::c_char,
            *mut ctf_dict_t,
            *mut *mut ctf_dict_t,
    ...
    let mut input_num: libc::c_int = 0;
    let mut type_0: ctf_id_t = 0;
    let mut ret: libc::c_int = 0;
    let mut whaterr: *const libc::c_char = 0 as *const libc::c_char;
    input_num = (type_id as uint64_t >> 32 as libc::c_int) as libc::c_int;
    fp = *inputs.offset(input_num as isize);
    type_0 = (type_id as uint64_t as libc::c_ulonglong
        & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t;
    ctf_dprintf(
        b"%lu: Starting walk over type %s, %i/%lx (%p), from %s, kind %i\n\0"
            as *const u8 as *const libc::c_char,
        depth,
        hval,
        input_num,
        ...
        ctf_type_kind_unsliced(fp, type_0),
    );
    if visited != 0 {
        return visit_fun
            .expect(
    ...
    match ctf_type_kind_unsliced(fp, type_0) {
        0 | 9 | 1 | 2 | 8 => {
            current_block = 17958840340921835115;
        }
        10 | 11 | 12 | 13 | 3 | 14 => {
            let mut type_id_0: *mut libc::c_void = 0 as *mut libc::c_void;
            let mut hashval: *const libc::c_char = 0 as *const libc::c_char;
            let mut cited_type_input_num: libc::c_int = input_num;
            if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
                && ctf_type_reference(fp, type_0) <= (*fp).ctf_parmax as libc::c_ulong
            {
                cited_type_input_num = *parents.offset(input_num as isize)
                    as libc::c_int;
            }
            type_id_0 = ((cited_type_input_num as uint64_t) << 32 as libc::c_int
                | ctf_type_reference(fp, type_0)) as *mut libc::c_void;
            if ctf_type_reference(fp, type_0) == 0 as libc::c_int as libc::c_ulong {
                ctf_dprintf(
                    b"Walking: unimplemented type\n\0" as *const u8
                        as *const libc::c_char,
                );
                current_block = 17958840340921835115;
            } else {
                ctf_dprintf(
                    b"Looking up ID %i/%lx in type hashes\n\0" as *const u8
                        as *const libc::c_char,
                    cited_type_input_num,
                    ctf_type_reference(fp, type_0),
                );
                hashval = ctf_dynhash_lookup((*d).cd_type_hashes, type_id_0)
                    as *const libc::c_char;
                if ctf_assert_internal(
                    output,
                    b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
                    2088 as libc::c_int as size_t,
                    b"hashval\0" as *const u8 as *const libc::c_char,
                    !hashval.is_null() as libc::c_int,
                ) as libc::c_long == 0
                {
                    whaterr = b"error looking up ID in type hashes\0" as *const u8
                        as *const libc::c_char;
                    current_block = 5089512885889216561;
                } else {
                    ctf_dprintf(
                        b"ID %i/%lx has hash %s\n\0" as *const u8 as *const libc::c_char,
                        cited_type_input_num,
                        ctf_type_reference(fp, type_0),
                        hashval,
                    );
                    ret = ctf_dedup_rwalk_output_mapping(
                        output,
                        inputs,
                        ninputs,
                        parents,
                    ...
                    if ret < 0 as libc::c_int {
                        whaterr = b"error during referenced type walk\0" as *const u8
                            as *const libc::c_char;
                        current_block = 5089512885889216561;
                    } else {
                        current_block = 17958840340921835115;
        ...
        4 => {
            ...
            if ctf_array_info(fp, type_0, &mut ar) < 0 as libc::c_int {
                whaterr = b"error during array info lookup\0" as *const u8
                    as *const libc::c_char;
                current_block = 6338900945105027321;
            } else {
                let mut type_id_1: *mut libc::c_void = 0 as *mut libc::c_void;
                let mut hashval_0: *const libc::c_char = 0 as *const libc::c_char;
                let mut cited_type_input_num_0: libc::c_int = input_num;
                if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
                    && ar.ctr_contents <= (*fp).ctf_parmax as libc::c_ulong
                {
                    cited_type_input_num_0 = *parents.offset(input_num as isize)
                        as libc::c_int;
                }
                type_id_1 = ((cited_type_input_num_0 as uint64_t) << 32 as libc::c_int
                    | ar.ctr_contents) as *mut libc::c_void;
                if ar.ctr_contents == 0 as libc::c_int as libc::c_ulong {
                    ctf_dprintf(
                        b"Walking: unimplemented type\n\0" as *const u8
                            as *const libc::c_char,
                    );
                    ...
                    ctf_dprintf(
                        b"Looking up ID %i/%lx in type hashes\n\0" as *const u8
                            as *const libc::c_char,
                        cited_type_input_num_0,
                        ar.ctr_contents,
                    );
                    hashval_0 = ctf_dynhash_lookup((*d).cd_type_hashes, type_id_1)
                        as *const libc::c_char;
                    if ctf_assert_internal(
                        output,
                        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
                        2102 as libc::c_int as size_t,
                        b"hashval\0" as *const u8 as *const libc::c_char,
                        !hashval_0.is_null() as libc::c_int,
                    ) as libc::c_long == 0
                    {
                        whaterr = b"error looking up ID in type hashes\0" as *const u8
                            as *const libc::c_char;
                        ...
                        if ret < 0 as libc::c_int {
                            whaterr = b"error during array contents type walk\0"
                                as *const u8 as *const libc::c_char;
                            current_block = 5089512885889216561;
                        } else {
                            current_block = 10891380440665537214;
                ...
                match current_block {
                    5089512885889216561 => {}
                    _ => {
                        let mut type_id_2: *mut libc::c_void = 0 as *mut libc::c_void;
                        let mut hashval_1: *const libc::c_char = 0
                            as *const libc::c_char;
                        let mut cited_type_input_num_1: libc::c_int = input_num;
                        if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
                            && ar.ctr_index <= (*fp).ctf_parmax as libc::c_ulong
                        {
                            cited_type_input_num_1 = *parents.offset(input_num as isize)
                                as libc::c_int;
                        }
                        type_id_2 = ((cited_type_input_num_1 as uint64_t)
                            << 32 as libc::c_int | ar.ctr_index) as *mut libc::c_void;
                        if ar.ctr_index == 0 as libc::c_int as libc::c_ulong {
                            ctf_dprintf(
                                b"Walking: unimplemented type\n\0" as *const u8
                                    as *const libc::c_char,
                            );
                            ...
                            ctf_dprintf(
                                b"Looking up ID %i/%lx in type hashes\n\0" as *const u8
                                    as *const libc::c_char,
                                cited_type_input_num_1,
                                ar.ctr_index,
                            );
                            hashval_1 = ctf_dynhash_lookup(
                                (*d).cd_type_hashes,
                                type_id_2,
                            ) as *const libc::c_char;
                            if ctf_assert_internal(
                                output,
                                b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
                                2104 as libc::c_int as size_t,
                                b"hashval\0" as *const u8 as *const libc::c_char,
                                !hashval_1.is_null() as libc::c_int,
                            ) as libc::c_long == 0
                            {
                                whaterr = b"error looking up ID in type hashes\0"
                                    as *const u8 as *const libc::c_char;
                                current_block = 5089512885889216561;
                            } else {
                                ctf_dprintf(
                                ...
                                if ret < 0 as libc::c_int {
                                    whaterr = b"error during array index type walk\0"
                                        as *const u8 as *const libc::c_char;
                                    current_block = 5089512885889216561;
                                } else {
                                    current_block = 17958840340921835115;
        ...
        5 => {
            ...
            let mut args: *mut ctf_id_t = 0 as *mut ctf_id_t;
            let mut j: uint32_t = 0;
            if ctf_func_type_info(fp, type_0, &mut fi) < 0 as libc::c_int {
                whaterr = b"error during func type info lookup\0" as *const u8
                    as *const libc::c_char;
                current_block = 6338900945105027321;
            } else {
                let mut type_id_3: *mut libc::c_void = 0 as *mut libc::c_void;
                let mut hashval_2: *const libc::c_char = 0 as *const libc::c_char;
                let mut cited_type_input_num_2: libc::c_int = input_num;
                if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
                    && fi.ctc_return <= (*fp).ctf_parmax as libc::c_ulong
                {
                    cited_type_input_num_2 = *parents.offset(input_num as isize)
                        as libc::c_int;
                }
                type_id_3 = ((cited_type_input_num_2 as uint64_t) << 32 as libc::c_int
                    | fi.ctc_return) as *mut libc::c_void;
                if fi.ctc_return == 0 as libc::c_int as libc::c_ulong {
                    ctf_dprintf(
                        b"Walking: unimplemented type\n\0" as *const u8
                            as *const libc::c_char,
                    );
                    ...
                    ctf_dprintf(
                        b"Looking up ID %i/%lx in type hashes\n\0" as *const u8
                            as *const libc::c_char,
                        cited_type_input_num_2,
                        fi.ctc_return,
                    );
                    hashval_2 = ctf_dynhash_lookup((*d).cd_type_hashes, type_id_3)
                        as *const libc::c_char;
                    if ctf_assert_internal(
                        output,
                        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
                        2121 as libc::c_int as size_t,
                        b"hashval\0" as *const u8 as *const libc::c_char,
                        !hashval_2.is_null() as libc::c_int,
                    ) as libc::c_long == 0
                    {
                        whaterr = b"error looking up ID in type hashes\0" as *const u8
                            as *const libc::c_char;
                        ...
                        if ret < 0 as libc::c_int {
                            whaterr = b"error during func return type walk\0"
                                as *const u8 as *const libc::c_char;
                            current_block = 5089512885889216561;
                        } else {
                            current_block = 15462640364611497761;
                    ...
                    _ => {
                        ...
                        if args.is_null() {
                            whaterr = b"error doing memory allocation\0" as *const u8
                                as *const libc::c_char;
                            current_block = 6338900945105027321;
                        } else if ctf_func_type_args(fp, type_0, fi.ctc_argc, args)
                            < 0 as libc::c_int
                        {
                            whaterr = b"error doing func arg type lookup\0" as *const u8
                                as *const libc::c_char;
                            free(args as *mut libc::c_void);
                            current_block = 6338900945105027321;
                        } else {
                            ...
                            loop {
                                ...
                                let mut type_id_4: *mut libc::c_void = 0
                                    as *mut libc::c_void;
                                let mut hashval_3: *const libc::c_char = 0
                                    as *const libc::c_char;
                                let mut cited_type_input_num_3: libc::c_int = input_num;
                                if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
                                    && *args.offset(j as isize)
                                        <= (*fp).ctf_parmax as libc::c_ulong
                                {
                                    cited_type_input_num_3 = *parents.offset(input_num as isize)
                                        as libc::c_int;
                                }
                                type_id_4 = ((cited_type_input_num_3 as uint64_t)
                                    << 32 as libc::c_int | *args.offset(j as isize))
                                    as *mut libc::c_void;
                                if *args.offset(j as isize)
                                    == 0 as libc::c_int as libc::c_ulong
                                {
                                    ctf_dprintf(
                                        b"Walking: unimplemented type\n\0" as *const u8
                                    ...
                                    ctf_dprintf(
                                        b"Looking up ID %i/%lx in type hashes\n\0" as *const u8
                                            as *const libc::c_char,
                                        cited_type_input_num_3,
                                        *args.offset(j as isize),
                                    );
                                    hashval_3 = ctf_dynhash_lookup(
                                        (*d).cd_type_hashes,
                                        type_id_4,
                                    ) as *const libc::c_char;
                                    if ctf_assert_internal(
                                        output,
                                        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
                                        2138 as libc::c_int as size_t,
                                        b"hashval\0" as *const u8 as *const libc::c_char,
                                        !hashval_3.is_null() as libc::c_int,
                                    ) as libc::c_long == 0
                                    {
                                        whaterr = b"error looking up ID in type hashes\0"
                                            as *const u8 as *const libc::c_char;
                                        current_block = 13874140270210604043;
                                        break;
                                    } else {
                                        ctf_dprintf(
                                            b"ID %i/%lx has hash %s\n\0" as *const u8
                                        ...
                                        if ret < 0 as libc::c_int {
                                            whaterr = b"error during Func arg type walk\0" as *const u8
                                                as *const libc::c_char;
                                            current_block = 13874140270210604043;
                                            break;
                                        }
        ...
        _ => {
            whaterr = b"CTF dict corruption: unknown type kind\0" as *const u8
                as *const libc::c_char;
            current_block = 6338900945105027321;
        }
    }
    match current_block {
        6338900945105027321 => {
            ...
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"%s in input file %s at type ID %lx\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                dcgettext(
...
unsafe extern "C" fn ctf_dedup_rwalk_output_mapping(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    ...
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut err: libc::c_int = 0;
    let mut visited: libc::c_int = 1 as libc::c_int;
    let mut type_ids: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    let mut id: *mut libc::c_void = 0 as *mut libc::c_void;
    depth = depth.wrapping_add(1);
    depth;
    ...
    if type_ids.is_null() {
        ctf_err_warn(
            output,
            0 as libc::c_int,
            ECTF_INTERNAL as libc::c_int,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"looked up type kind by nonexistent hash %s\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            hval,
        );
        return ctf_set_errno(output, ECTF_INTERNAL as libc::c_int) as libc::c_int;
    }
    if ctf_dynset_exists(
        already_visited,
        hval as *const libc::c_void,
    ...
    ) == 0
    {
        ...
        if ctf_dynset_cinsert(already_visited, hval as *const libc::c_void)
            < 0 as libc::c_int
        {
            ctf_err_warn(
                output,
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"out of memory tracking already-visited types\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            return ctf_set_errno(output, 12 as libc::c_int) as libc::c_int;
        }
    }
    if ctf_dynset_exists(
        (*d).cd_conflicting_types,
    ...
    ) == 0
    {
        ...
        return ctf_dedup_rwalk_one_output_mapping(
            output,
            inputs,
            ninputs,
            parents,
    ...
    if err != ECTF_NEXT_END as libc::c_int {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"cannot walk conflicted type\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        return ctf_set_errno(output, err) as libc::c_int;
...
unsafe extern "C" fn sort_output_mapping(
    mut one: *const ctf_next_hkv_t,
    mut two: *const ctf_next_hkv_t,
    mut arg_: *mut libc::c_void,
) -> libc::c_int {
    let mut arg: *mut ctf_sort_om_cb_arg_t = arg_ as *mut ctf_sort_om_cb_arg_t;
    let mut d: *mut ctf_dedup_t = (*arg).d;
    let mut one_hval: *const libc::c_char = (*one).hkv_key as *const libc::c_char;
    let mut two_hval: *const libc::c_char = (*two).hkv_key as *const libc::c_char;
    let mut one_gid: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut two_gid: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut one_ninput: uint32_t = 0;
    let mut two_ninput: uint32_t = 0;
    let mut one_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut two_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut one_type: ctf_id_t = 0;
    let mut two_type: ctf_id_t = 0;
    one_gid = ctf_dynhash_lookup(
        (*d).cd_output_first_gid,
        one_hval as *const libc::c_void,
    );
    two_gid = ctf_dynhash_lookup(
        (*d).cd_output_first_gid,
        two_hval as *const libc::c_void,
    );
    one_ninput = (one_gid as uint64_t >> 32 as libc::c_int) as libc::c_int as uint32_t;
    two_ninput = (two_gid as uint64_t >> 32 as libc::c_int) as libc::c_int as uint32_t;
    one_type = (one_gid as uint64_t as libc::c_ulonglong
        & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t;
    two_type = (two_gid as uint64_t as libc::c_ulonglong
        & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t;
    if one_ninput < (*arg).ninputs && two_ninput < (*arg).ninputs {} else {
        __assert_fail(
            b"one_ninput < arg->ninputs && two_ninput < arg->ninputs\0" as *const u8
                as *const libc::c_char,
            b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 80],
            >(
                b"int sort_output_mapping(const ctf_next_hkv_t *, const ctf_next_hkv_t *, void *)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    one_fp = *((*arg).inputs).offset(one_ninput as isize);
    two_fp = *((*arg).inputs).offset(two_ninput as isize);
    if (*one_fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint == 0
        && (*two_fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
    {
        return -(1 as libc::c_int)
    } else if (*one_fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        && (*two_fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint == 0
    {
        return 1 as libc::c_int
    }
    ...
    if one_type != two_type {} else {
        __assert_fail(
            b"one_type != two_type\0" as *const u8 as *const libc::c_char,
            b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn ctf_dedup_walk_output_mapping(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    ...
    let mut current_block: u64;
    let mut already_visited: *mut ctf_dynset_t = 0 as *mut ctf_dynset_t;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut sort_arg: ctf_sort_om_cb_arg_t = ctf_sort_om_cb_arg_t {
        inputs: 0 as *mut *mut ctf_dict_t,
        ninputs: 0,
        d: 0 as *mut ctf_dedup_t,
    };
    let mut err: libc::c_int = 0;
    let mut k: *mut libc::c_void = 0 as *mut libc::c_void;
    already_visited = ctf_dynset_create(
        Some(htab_hash_string as unsafe extern "C" fn(*const libc::c_void) -> hashval_t),
        Some(
            htab_eq_string
                as unsafe extern "C" fn(
    ...
    if already_visited.is_null() {
        return ctf_set_errno(output, 12 as libc::c_int) as libc::c_int;
    }
    sort_arg.inputs = inputs;
    sort_arg.ninputs = ninputs;
    sort_arg.d = &mut (*output).ctf_dedup;
    loop {
        err = ctf_dynhash_next_sorted(
            (*output).ctf_dedup.cd_output_mapping,
            &mut i,
            &mut k,
            ...
            &mut sort_arg as *mut ctf_sort_om_cb_arg_t as *mut libc::c_void,
        );
        if !(err == 0 as libc::c_int) {
        ...
        let mut hval: *const libc::c_char = k as *const libc::c_char;
        err = ctf_dedup_rwalk_output_mapping(
            output,
            inputs,
            ninputs,
            parents,
        ...
        ctf_next_destroy(i);
        current_block = 7092985498146382744;
        break;
    }
    match current_block {
        1394248824506584008 => {
            if err != ECTF_NEXT_END as libc::c_int {
                ctf_err_warn(
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"cannot recurse over output mapping\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
...
unsafe extern "C" fn ctf_dedup_maybe_synthesize_forward(
    mut output: *mut ctf_dict_t,
    mut target: *mut ctf_dict_t,
    mut input: *mut ctf_dict_t,
    mut id: ctf_id_t,
    mut hval: *const libc::c_char,
) -> ctf_id_t {
    let mut od: *mut ctf_dedup_t = &mut (*output).ctf_dedup;
    let mut td: *mut ctf_dedup_t = &mut (*target).ctf_dedup;
    let mut kind: libc::c_int = 0;
    let mut fwdkind: libc::c_int = 0;
    let mut name: *const libc::c_char = ctf_type_name_raw(input, id);
    let mut decorated: *const libc::c_char = 0 as *const libc::c_char;
    let mut v: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut emitted_forward: ctf_id_t = 0;
    if ctf_dynset_exists(
        (*od).cd_conflicting_types,
        hval as *const libc::c_void,
        0 as *mut *const libc::c_void,
    ) == 0 || (*target).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        || *name.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32
        || {
            kind = ctf_type_kind_unsliced(input, id);
            kind != 6 as libc::c_int && kind != 7 as libc::c_int
                && kind != 9 as libc::c_int
        }
    {
        return 0 as libc::c_int as ctf_id_t;
    }
    fwdkind = ctf_type_kind_forwarded(input, id);
    ctf_dprintf(
        b"Using synthetic forward for conflicted struct/union with hval %s\n\0"
            as *const u8 as *const libc::c_char,
        hval,
    );
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        2420 as libc::c_int as size_t,
        b"name\0" as *const u8 as *const libc::c_char,
        !name.is_null() as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    decorated = ctf_decorate_type_name(output, name, fwdkind);
    if decorated.is_null() {
        return -(1 as libc::c_long) as ctf_id_t;
    ...
    if ctf_dynhash_lookup_kv(
        (*td).cd_output_emission_conflicted_forwards,
        decorated as *const libc::c_void,
        0 as *mut *const libc::c_void,
        &mut v,
    ) == 0
    {
        emitted_forward = ctf_add_forward(
            target,
            1 as libc::c_int as uint32_t,
            name,
            fwdkind as uint32_t,
        );
        if emitted_forward == -(1 as libc::c_long) as ctf_id_t {
        ...
        if ctf_dynhash_cinsert(
            (*td).cd_output_emission_conflicted_forwards,
            decorated as *const libc::c_void,
            emitted_forward as *mut libc::c_void,
        ) < 0 as libc::c_int
        {
            ctf_set_errno(output, 12 as libc::c_int);
            return -(1 as libc::c_long) as ctf_id_t;
        }
    } else {
        emitted_forward = v as uintptr_t;
    }
    ctf_dprintf(
        b"Cross-TU conflicted struct: passing back forward, %lx\n\0" as *const u8
            as *const libc::c_char,
        emitted_forward,
    );
    return emitted_forward;
}
unsafe extern "C" fn ctf_dedup_id_to_target(
    mut output: *mut ctf_dict_t,
    mut target: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    ...
    let mut od: *mut ctf_dedup_t = &mut (*output).ctf_dedup;
    let mut td: *mut ctf_dedup_t = &mut (*target).ctf_dedup;
    let mut err_fp: *mut ctf_dict_t = input;
    let mut hval: *const libc::c_char = 0 as *const libc::c_char;
    let mut target_id: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut emitted_forward: ctf_id_t = 0;
    if id == -(1 as libc::c_long) as ctf_id_t {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    ...
    ctf_dprintf(
        b"Mapping %i/%lx to target %p (%s)\n\0" as *const u8 as *const libc::c_char,
        input_num,
        id,
        target as *mut libc::c_void,
        ctf_link_input_name(target),
    );
    if (*input).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        && id <= (*input).ctf_parmax as libc::c_ulong
    {
        if ctf_assert_internal(
            output,
            b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
            2504 as libc::c_int as size_t,
            b"parents[input_num] <= ninputs\0" as *const u8 as *const libc::c_char,
            (*parents.offset(input_num as isize) <= ninputs) as libc::c_int,
        ) as libc::c_long == 0
        {
            return -(1 as libc::c_int) as ctf_id_t;
        }
        input = *inputs.offset(*parents.offset(input_num as isize) as isize);
        input_num = *parents.offset(input_num as isize) as libc::c_int;
    }
    hval = ctf_dynhash_lookup(
        (*od).cd_type_hashes,
        ((input_num as uint64_t) << 32 as libc::c_int | id) as *mut libc::c_void,
    ) as *const libc::c_char;
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        2513 as libc::c_int as size_t,
        b"hval && td->cd_output_emission_hashes\0" as *const u8 as *const libc::c_char,
        (!hval.is_null() && !((*td).cd_output_emission_hashes).is_null()) as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int) as ctf_id_t;
    }
    emitted_forward = ctf_dedup_maybe_synthesize_forward(
        output,
        target,
        input,
        id,
    ...
    match emitted_forward {
        ...
        18446744073709551615 => {
            ...
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"cannot add synthetic forward for type %i/%lx\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                input_num,
        ...
        _ => return emitted_forward,
    }
    ctf_dprintf(
        b"Looking up %i/%lx, hash %s, in target\n\0" as *const u8 as *const libc::c_char,
        input_num,
        id,
        hval,
    );
    target_id = ctf_dynhash_lookup(
        (*td).cd_output_emission_hashes,
        hval as *const libc::c_void,
    );
    if target_id.is_null() {
        ctf_dprintf(
            b"Checking shared parent for target\n\0" as *const u8 as *const libc::c_char,
        );
        if ctf_assert_internal(
            output,
            b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
            2547 as libc::c_int as size_t,
            b"(target != output) && (target->ctf_flags & LCTF_CHILD)\0" as *const u8
                as *const libc::c_char,
            (target != output
                && (*target).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0)
                as libc::c_int,
        ) as libc::c_long == 0
        {
            return -(1 as libc::c_int) as ctf_id_t;
    ...
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        2567 as libc::c_int as size_t,
        b"target_id\0" as *const u8 as *const libc::c_char,
        !target_id.is_null() as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int) as ctf_id_t;
    }
    return target_id as uintptr_t;
}
unsafe extern "C" fn ctf_dedup_emit_type(
    mut hval: *const libc::c_char,
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    mut already_visited: libc::c_int,
    mut input: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut id: *mut libc::c_void,
    ...
    let mut current_block: u64;
    let mut d: *mut ctf_dedup_t = &mut (*output).ctf_dedup;
    let mut kind: libc::c_int = ctf_type_kind_unsliced(input, type_0);
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut target: *mut ctf_dict_t = output;
    let mut real_input: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut input_num: libc::c_int = (id as uint64_t >> 32 as libc::c_int)
        as libc::c_int;
    let mut output_num: libc::c_int = -(1 as libc::c_int) as uint32_t as libc::c_int;
    let mut cu_mapped: libc::c_int = *(arg as *mut libc::c_int);
    let mut isroot: libc::c_int = 1 as libc::c_int;
    let mut is_conflicting: libc::c_int = 0;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut new_type: ctf_id_t = 0;
    let mut ref_0: ctf_id_t = 0;
    let mut maybe_dup: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    let mut ep: ctf_encoding_t = ctf_encoding_t {
        cte_format: 0,
        cte_offset: 0,
        cte_bits: 0,
    };
    let mut errtype: *const libc::c_char = 0 as *const libc::c_char;
    let mut emission_hashed: libc::c_int = 0 as libc::c_int;
    if already_visited != 0 {
        return 0 as libc::c_int;
    }
    ctf_dprintf(
        b"%i: Emitting type with hash %s from %s: determining target\n\0" as *const u8
            as *const libc::c_char,
        depth,
        hval,
        ctf_link_input_name(input),
    );
    is_conflicting = ctf_dynset_exists(
        (*d).cd_conflicting_types,
        hval as *const libc::c_void,
        0 as *mut *const libc::c_void,
    );
    if is_conflicting != 0 && cu_mapped == 0 {
        ctf_dprintf(
            b"%i: Type %s in %i/%lx is conflicted: inserting into per-CU target.\n\0"
                as *const u8 as *const libc::c_char,
            depth,
            hval,
            input_num,
        ...
        if !((*input).ctf_dedup.cd_output).is_null() {
            target = (*input).ctf_dedup.cd_output;
        } else {
            let mut err: libc::c_int = 0;
            target = ctf_create(&mut err);
            if target.is_null() {
                ctf_err_warn(
                    output,
                    0 as libc::c_int,
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"cannot create per-CU CTF archive for CU %s\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    ctf_link_input_name(input),
            ...
            if !(ctf_cuname(input)).is_null() {
                ctf_cuname_set(target, ctf_cuname(input));
            } else {
                ctf_cuname_set(
                    target,
                    b"unnamed-CU\0" as *const u8 as *const libc::c_char,
                );
            }
            ctf_parent_name_set(target, _CTF_SECTION.as_ptr());
            (*input).ctf_dedup.cd_output = target;
        }
        output_num = input_num;
    }
    real_input = input;
    tp = ctf_lookup_by_id(&mut real_input, type_0);
    if tp.is_null() {
        ctf_err_warn(
            output,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"%s: lookup failure for type %lx\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            ctf_link_input_name(real_input),
            type_0,
        );
        return ctf_set_errno(output, ctf_errno(input)) as libc::c_int;
    }
    name = ctf_strraw(real_input, (*tp).ctt_name);
    if cu_mapped != 0 && is_conflicting != 0 {
        isroot = 0 as libc::c_int;
    } else if !name.is_null()
        && {
            maybe_dup = ctf_lookup_by_rawname(target, kind, name);
            maybe_dup != 0 as libc::c_int as libc::c_ulong
        }
    {
        if ctf_type_kind(target, maybe_dup) != 9 as libc::c_int {
            isroot = 0 as libc::c_int;
        }
    }
    ctf_dprintf(
        b"%i: Emitting type with hash %s (%s), into target %i/%p\n\0" as *const u8
            as *const libc::c_char,
        depth,
        hval,
        if !name.is_null() { name } else { b"\0" as *const u8 as *const libc::c_char },
        input_num,
        target as *mut libc::c_void,
    );
    if ((*target).ctf_dedup.cd_output_emission_hashes).is_null() {
        (*target)
            .ctf_dedup
            .cd_output_emission_hashes = ctf_dynhash_create(
            Some(
                ctf_hash_string
                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
            ),
        ...
        if ((*target).ctf_dedup.cd_output_emission_hashes).is_null() {
            current_block = 877253358106363691;
        } else {
    ...
    match current_block {
        1118134448028020070 => {
            if ((*target).ctf_dedup.cd_output_emission_conflicted_forwards).is_null() {
                (*target)
                    .ctf_dedup
                    .cd_output_emission_conflicted_forwards = ctf_dynhash_create(
                    Some(
                        ctf_hash_string
                            as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                    ),
                ...
                _ => {
                    match kind {
                        0 => {
                            ...
                            new_type = ctf_add_unknown(target, isroot as uint32_t, name);
                            if new_type == -(1 as libc::c_long) as ctf_id_t {
                                current_block = 18086856651616107867;
                            } else {
                        ...
                        9 => {
                            ...
                            new_type = ctf_add_forward(
                                target,
                                isroot as uint32_t,
                                name,
                                ctf_type_kind_forwarded(input, type_0) as uint32_t,
                            );
                            if new_type == -(1 as libc::c_long) as ctf_id_t {
                                current_block = 18086856651616107867;
                            } else {
                        ...
                        2 | 1 => {
                            errtype = dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"float/int\0" as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            );
                            if ctf_type_encoding(input, type_0, &mut ep)
                                < 0 as libc::c_int
                            {
                                current_block = 7914954514168855204;
                            } else {
                                new_type = ctf_add_encoded(
                                    target,
                                    isroot as uint32_t,
                                    name,
                                    &mut ep,
                        ...
                        8 => {
                            ...
                            new_type = ctf_add_enum(target, isroot as uint32_t, name);
                            if new_type == -(1 as libc::c_long) as ctf_id_t {
                                current_block = 7914954514168855204;
                            } else {
                                loop {
                                    name = ctf_enum_next(input, type_0, &mut i, &mut val);
                                    if name.is_null() {
                                        break;
                                    }
                                    if ctf_add_enumerator(target, new_type, name, val)
                                        < 0 as libc::c_int
                                    {
                                        ctf_err_warn(
                                            target,
                                            ...
                                            dcgettext(
                                                b"libctf\0" as *const u8 as *const libc::c_char,
                                                b"%s (%i): cannot add enumeration value %s from input type %lx\0"
                                                    as *const u8 as *const libc::c_char,
                                                5 as libc::c_int,
                                            ),
                                            ctf_link_input_name(input),
                        ...
                        10 => {
                            ...
                            ref_0 = ctf_type_reference(input, type_0);
                            ref_0 = ctf_dedup_id_to_target(
                                output,
                                target,
                                inputs,
                                ninputs,
                            ...
                            if ref_0 == -(1 as libc::c_long) as ctf_id_t {
                                current_block = 7914954514168855204;
                            } else {
                                new_type = ctf_add_typedef(
                                    target,
                                    isroot as uint32_t,
                                    name,
                                    ref_0,
                        ...
                        11 | 12 | 13 | 3 => {
                            errtype = dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"pointer or cvr-qual\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            );
                            ref_0 = ctf_type_reference(input, type_0);
                        ...
                        4 => {
                            ...
                            errtype = dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"array info\0" as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            );
                            if ctf_array_info(input, type_0, &mut ar) < 0 as libc::c_int
                            {
                                ...
                                ar
                                    .ctr_contents = ctf_dedup_id_to_target(
                                    output,
                                    target,
                                    inputs,
                                    ninputs,
                                ...
                                ar
                                    .ctr_index = ctf_dedup_id_to_target(
                                    output,
                                    target,
                                    inputs,
                                    ninputs,
                                ...
                                if ar.ctr_contents == -(1 as libc::c_long) as ctf_id_t
                                    || ar.ctr_index == -(1 as libc::c_long) as ctf_id_t
                                {
                                    current_block = 7914954514168855204;
                                } else {
                                    new_type = ctf_add_array(
                                        target,
                                        isroot as uint32_t,
                                        &mut ar,
                                    );
                        ...
                        5 => {
                            ...
                            if ctf_func_type_info(input, type_0, &mut fi)
                                < 0 as libc::c_int
                            {
                                current_block = 7914954514168855204;
                            } else {
                                fi
                                    .ctc_return = ctf_dedup_id_to_target(
                                    output,
                                    target,
                                    inputs,
                                    ninputs,
                                ...
                                if fi.ctc_return == -(1 as libc::c_long) as ctf_id_t {
                                    current_block = 7914954514168855204;
                                } else {
                                    args = calloc(
                                        fi.ctc_argc as libc::c_ulong,
                                    ...
                                    if args.is_null() {
                                        ctf_set_errno(input, 12 as libc::c_int);
                                        current_block = 7914954514168855204;
                                    } else {
                                        errtype = dcgettext(
                                            b"libctf\0" as *const u8 as *const libc::c_char,
                                            b"function args\0" as *const u8 as *const libc::c_char,
                                            5 as libc::c_int,
                                        );
                                        if ctf_func_type_args(input, type_0, fi.ctc_argc, args)
                                            < 0 as libc::c_int
                                        {
                                            free(args as *mut libc::c_void);
                                            current_block = 7914954514168855204;
                        ...
                        6 | 7 => {
                            let mut size: size_t = ctf_type_size(input, type_0)
                                as size_t;
                            let mut out_id: *mut libc::c_void = 0 as *mut libc::c_void;
                            errtype = dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"structure/union\0" as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            );
                            if kind == 6 as libc::c_int {
                                new_type = ctf_add_struct_sized(
                                    target,
                                    isroot as uint32_t,
                                    name,
                                    size,
                            ...
                            if new_type == -(1 as libc::c_long) as ctf_id_t {
                                ...
                                out_id = ((output_num as uint64_t) << 32 as libc::c_int
                                    | new_type) as *mut libc::c_void;
                                ctf_dprintf(
                                    b"%i: Noting need to emit members of %p -> %p\n\0"
                                        as *const u8 as *const libc::c_char,
                                    depth,
                                    id,
                                    out_id,
                                ...
                                {
                                    ctf_set_errno(target, *__errno_location());
                                    current_block = 18086856651616107867;
                                } else {
                                    current_block = 5706507068631705000;
                                }
                        ...
                        _ => {
                            ctf_err_warn(
                                ...
                                dcgettext(
                                    b"libctf\0" as *const u8 as *const libc::c_char,
                                    b"%s: unknown type kind for input type %lx\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                ctf_link_input_name(input),
                            ...
                            return ctf_set_errno(output, ECTF_CORRUPT as libc::c_int)
                                as libc::c_int;
                        }
                    }
                    match current_block {
                        18086856651616107867 => {
                            ctf_err_warn(
                                output,
                                0 as libc::c_int,
                                ctf_errno(target),
                                dcgettext(
                                    b"libctf\0" as *const u8 as *const libc::c_char,
                                    b"%s (%i): while emitting deduplicated %s, error emitting target type from input type %lx\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                ctf_link_input_name(input),
                        ...
                        7914954514168855204 => {
                            ctf_err_warn(
                                ...
                                dcgettext(
                                    b"libctf\0" as *const u8 as *const libc::c_char,
                                    b"%s (%i): while emitting deduplicated %s, error getting input type %lx\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                ctf_link_input_name(input),
                        ...
                        _ => {
                            if emission_hashed == 0
                                && new_type != 0 as libc::c_int as libc::c_ulong
                                && ctf_dynhash_cinsert(
                                    (*target).ctf_dedup.cd_output_emission_hashes,
                                    hval as *const libc::c_void,
                                    new_type as *mut libc::c_void,
                                ) < 0 as libc::c_int
                            {
                                ctf_err_warn(
                                    ...
                                    dcgettext(
                                        b"libctf\0" as *const u8 as *const libc::c_char,
                                        b"out of memory tracking deduplicated global type IDs\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                );
                                return ctf_set_errno(output, 12 as libc::c_int)
                                    as libc::c_int;
                            }
                            if emission_hashed == 0
                                && new_type != 0 as libc::c_int as libc::c_ulong
                            {
                                ctf_dprintf(
                                    b"%i: Inserted %s, %i/%lx -> %lx into emission hash for target %p (%s)\n\0"
                                        as *const u8 as *const libc::c_char,
                                    depth,
                                    hval,
                                    input_num,
    ...
    ctf_err_warn(
        ...
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"out of memory creating emission-tracking hashes\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
unsafe extern "C" fn ctf_dedup_emit_struct_members(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    ...
    let mut d: *mut ctf_dedup_t = &mut (*output).ctf_dedup;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut input_id: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut target_id: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut err: libc::c_int = 0;
    let mut err_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut input_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut input_num: libc::c_int = 0;
    let mut err_type: ctf_id_t = 0;
    's_15: loop {
        ...
        let mut j: *mut ctf_next_t = 0 as *mut ctf_next_t;
        let mut target: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
        let mut target_num: uint32_t = 0;
        let mut input_type: ctf_id_t = 0;
        let mut target_type: ctf_id_t = 0;
        let mut offset: ssize_t = 0;
        let mut membtype: ctf_id_t = 0;
        let mut name: *const libc::c_char = 0 as *const libc::c_char;
        input_num = (input_id as uint64_t >> 32 as libc::c_int) as libc::c_int;
        input_fp = *inputs.offset(input_num as isize);
        input_type = (input_id as uint64_t as libc::c_ulonglong
            & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t;
        target_num = (target_id as uint64_t >> 32 as libc::c_int) as libc::c_int
            as uint32_t;
        if target_num == -(1 as libc::c_int) as uint32_t {
            target = output;
        } else {
            target = (**inputs.offset(target_num as isize)).ctf_dedup.cd_output;
            if ctf_assert_internal(
                output,
                b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
                2978 as libc::c_int as size_t,
                b"target\0" as *const u8 as *const libc::c_char,
                !target.is_null() as libc::c_int,
            ) as libc::c_long == 0
            {
                err_fp = output;
                err_type = input_type;
                current_block = 18446591923551505263;
                break;
            }
        }
        target_type = (target_id as uint64_t as libc::c_ulonglong
            & !(0xffffffff00000000 as libc::c_ulonglong)) as ctf_id_t;
        loop {
            offset = ctf_member_next(
                input_fp,
            ...
            membtype = ctf_dedup_id_to_target(
                output,
                target,
                inputs,
                ninputs,
            ...
            if membtype == -(1 as libc::c_long) as ctf_id_t {
                ctf_next_destroy(j);
                current_block = 18446591923551505263;
                break 's_15;
            } else {
        ...
        if !(ctf_errno(input_fp) != ECTF_NEXT_END as libc::c_int) {
            continue;
        }
        err = ctf_errno(input_fp);
        ctf_next_destroy(i);
        current_block = 18069051083215034444;
        break;
    }
    match current_block {
        4068382217303356765 => {
        ...
        18446591923551505263 => {
            ...
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"%s (%i): error emitting members for structure type %lx\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ctf_link_input_name(input_fp),
                input_num,
                err_type,
            );
            return ctf_set_errno(output, ctf_errno(err_fp)) as libc::c_int;
        }
        _ => {}
    }
    ctf_err_warn(
        ...
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"iteration failure emitting structure members\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dedup_emit(
    mut output: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: uint32_t,
    mut parents: *mut uint32_t,
    mut noutputs: *mut uint32_t,
    mut cu_mapped: libc::c_int,
) -> *mut *mut ctf_dict_t {
    let mut num_outputs: size_t = 1 as libc::c_int as size_t;
    let mut outputs: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut walk: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut i: size_t = 0;
    ctf_dprintf(b"Triggering emission.\n\0" as *const u8 as *const libc::c_char);
    if ctf_dedup_walk_output_mapping(
        output,
        inputs,
        ninputs,
        parents,
        ...
        &mut cu_mapped as *mut libc::c_int as *mut libc::c_void,
    ) < 0 as libc::c_int
    {
        return 0 as *mut *mut ctf_dict_t;
    }
    ctf_dprintf(b"Populating struct members.\n\0" as *const u8 as *const libc::c_char);
    if ctf_dedup_emit_struct_members(output, inputs, ninputs, parents) < 0 as libc::c_int
    {
        return 0 as *mut *mut ctf_dict_t;
    }
    i = 0 as libc::c_int as size_t;
    while i < ninputs as libc::c_ulong {
        if !((**inputs.offset(i as isize)).ctf_dedup.cd_output).is_null() {
            num_outputs = num_outputs.wrapping_add(1);
            num_outputs;
        }
        i = i.wrapping_add(1);
        i;
    ...
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        3072 as libc::c_int as size_t,
        b"!cu_mapped || (cu_mapped && num_outputs == 1)\0" as *const u8
            as *const libc::c_char,
        (cu_mapped == 0
            || cu_mapped != 0 && num_outputs == 1 as libc::c_int as libc::c_ulong)
            as libc::c_int,
    ) as libc::c_long == 0
    {
        return 0 as *mut *mut ctf_dict_t;
    ...
    outputs = calloc(
        num_outputs,
        ::core::mem::size_of::<*mut ctf_dict_t>() as libc::c_ulong,
    ) as *mut *mut ctf_dict_t;
    if outputs.is_null() {
        ctf_err_warn(
            output,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"out of memory allocating link outputs array\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    *noutputs = num_outputs as uint32_t;
    walk = outputs;
    *walk = output;
    (*output).ctf_refcnt = ((*output).ctf_refcnt).wrapping_add(1);
    (*output).ctf_refcnt;
    walk = walk.offset(1);
    walk;
    i = 0 as libc::c_int as size_t;
    while i < ninputs as libc::c_ulong {
        if !((**inputs.offset(i as isize)).ctf_dedup.cd_output).is_null() {
            *walk = (**inputs.offset(i as isize)).ctf_dedup.cd_output;
            let ref mut fresh0 = (**inputs.offset(i as isize)).ctf_dedup.cd_output;
            *fresh0 = 0 as *mut ctf_dict_t;
            walk = walk.offset(1);
            walk;
        }
        i = i.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dedup_type_mapping(
    mut fp: *mut ctf_dict_t,
    mut src_fp: *mut ctf_dict_t,
    mut src_type: ctf_id_t,
) -> ctf_id_t {
    let mut output: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut d: *mut ctf_dedup_t = 0 as *mut ctf_dedup_t;
    let mut input_num: libc::c_int = 0;
    let mut num_ptr: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut type_ptr: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut found: libc::c_int = 0;
    let mut hval: *const libc::c_char = 0 as *const libc::c_char;
    if !((*fp).ctf_dedup.cd_type_hashes).is_null() {
        output = fp;
    } else if !((*fp).ctf_parent).is_null()
        && !((*(*fp).ctf_parent).ctf_dedup.cd_type_hashes).is_null()
    {
        output = (*fp).ctf_parent;
    } else {
        ctf_set_errno(fp, ECTF_INTERNAL as libc::c_int);
        ctf_err_warn(
            fp,
            0 as libc::c_int,
            ECTF_INTERNAL as libc::c_int,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"dict %p passed to ctf_dedup_type_mapping is not a deduplicated output\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            fp as *mut libc::c_void,
    ...
    if !((*src_fp).ctf_parent).is_null() && ctf_type_isparent(src_fp, src_type) != 0 {
        src_fp = (*src_fp).ctf_parent;
    }
    d = &mut (*output).ctf_dedup;
    found = ctf_dynhash_lookup_kv(
        (*d).cd_input_nums,
        src_fp as *const libc::c_void,
        0 as *mut *const libc::c_void,
        &mut num_ptr,
    );
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        3143 as libc::c_int as size_t,
        b"found != 0\0" as *const u8 as *const libc::c_char,
        (found != 0 as libc::c_int) as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    input_num = num_ptr as uintptr_t as libc::c_int;
    hval = ctf_dynhash_lookup(
        (*d).cd_type_hashes,
        ((input_num as uint64_t) << 32 as libc::c_int | src_type) as *mut libc::c_void,
    ) as *const libc::c_char;
    if ctf_assert_internal(
        output,
        b"ctf-dedup.c\0" as *const u8 as *const libc::c_char,
        3150 as libc::c_int as size_t,
        b"hval != NULL\0" as *const u8 as *const libc::c_char,
        !hval.is_null() as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    if !((*fp).ctf_dedup.cd_output_emission_hashes).is_null() {
        if ctf_dynhash_lookup_kv(
            (*fp).ctf_dedup.cd_output_emission_hashes,
            hval as *const libc::c_void,
            0 as *mut *const libc::c_void,
            &mut type_ptr,
        ) != 0
        {
            return type_ptr as uintptr_t;
        }
    }
    if !((*fp).ctf_parent).is_null() {
        let mut pfp: *mut ctf_dict_t = (*fp).ctf_parent;
        if !((*pfp).ctf_dedup.cd_output_emission_hashes).is_null() {
            if ctf_dynhash_lookup_kv(
                (*pfp).ctf_dedup.cd_output_emission_hashes,
                hval as *const libc::c_void,
                0 as *mut *const libc::c_void,
                &mut type_ptr,
            ) != 0
