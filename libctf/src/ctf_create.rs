...
extern "C" {
    ...
    fn ctf_type_resolve(_: *mut ctf_dict_t, _: ctf_id_t) -> ctf_id_t;
    fn ctf_type_size(_: *mut ctf_dict_t, _: ctf_id_t) -> ssize_t;
    fn ctf_type_align(_: *mut ctf_dict_t, _: ctf_id_t) -> ssize_t;
    ...
    fn ctf_list_append(_: *mut ctf_list_t, _: *mut libc::c_void);
    ...
    fn ctf_type_resolve_unsliced(_: *mut ctf_dict_t, _: ctf_id_t) -> ctf_id_t;
    ...
    fn ctf_dynhash_empty(_: *mut ctf_dynhash_t);
    fn ctf_hash_eq_type_key(
        _: *const libc::c_void,
        _: *const libc::c_void,
    ) -> libc::c_int;
    fn ctf_hash_type_key(ptr: *const libc::c_void) -> libc::c_uint;
    ...
    fn ctf_set_ctl_hashes(_: *mut ctf_dict_t);
    fn ctf_bufopen_internal(
        _: *const ctf_sect_t,
        _: *const ctf_sect_t,
        _: *const ctf_sect_t,
        _: *mut ctf_dynhash_t,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_snapshot_id {
    pub dtd_id: libc::c_ulong,
    pub snapshot_id: libc::c_ulong,
}
pub type ctf_snapshot_id_t = ctf_snapshot_id;
...
pub type ctf_member_f = unsafe extern "C" fn(
    *const libc::c_char,
    ctf_id_t,
    libc::c_ulong,
    *mut libc::c_void,
) -> libc::c_int;
pub type ctf_enum_f = unsafe extern "C" fn(
    *const libc::c_char,
    libc::c_int,
    *mut libc::c_void,
) -> libc::c_int;
...
pub type ctf_link_type_key_t = ctf_link_type_key;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_link_type_key {
    pub cltk_fp: *mut ctf_dict_t,
    pub cltk_idx: ctf_id_t,
}
...
>;
pub type ctf_bundle_t = ctf_bundle;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_bundle {
    pub ctb_dict: *mut ctf_dict_t,
    pub ctb_type: ctf_id_t,
    pub ctb_dtd: *mut ctf_dtdef_t,
}
#[inline]
...
unsafe extern "C" fn ctf_grow_ptrtab(mut fp: *mut ctf_dict_t) -> libc::c_int {
    let mut new_ptrtab_len: size_t = (*fp).ctf_ptrtab_len;
    if ((*fp).ctf_ptrtab).is_null() {
        new_ptrtab_len = 1024 as libc::c_int as size_t;
    } else if ((*fp).ctf_typemax).wrapping_add(2 as libc::c_int as libc::c_ulong)
        > (*fp).ctf_ptrtab_len
    {
        new_ptrtab_len = ((*fp).ctf_ptrtab_len as libc::c_double * 1.25f64) as size_t;
    }
    if new_ptrtab_len != (*fp).ctf_ptrtab_len {
        let mut new_ptrtab: *mut uint32_t = 0 as *mut uint32_t;
        new_ptrtab = realloc(
            (*fp).ctf_ptrtab as *mut libc::c_void,
            new_ptrtab_len
                .wrapping_mul(::core::mem::size_of::<uint32_t>() as libc::c_ulong),
        ) as *mut uint32_t;
        if new_ptrtab.is_null() {
            return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
        }
        (*fp).ctf_ptrtab = new_ptrtab;
        memset(
            ((*fp).ctf_ptrtab).offset((*fp).ctf_ptrtab_len as isize)
                as *mut libc::c_void,
            0 as libc::c_int,
            new_ptrtab_len
                .wrapping_sub((*fp).ctf_ptrtab_len)
                .wrapping_mul(::core::mem::size_of::<uint32_t>() as libc::c_ulong),
        );
...
unsafe extern "C" fn ctf_grow_vlen(
    mut fp: *mut ctf_dict_t,
    mut dtd: *mut ctf_dtdef_t,
    mut vlen: size_t,
) -> libc::c_int {
    let mut old: *mut libc::c_uchar = (*dtd).dtd_vlen;
    if (*dtd).dtd_vlen_alloc > vlen {
        return 0 as libc::c_int;
    }
    (*dtd)
        .dtd_vlen = realloc(
        (*dtd).dtd_vlen as *mut libc::c_void,
        ((*dtd).dtd_vlen_alloc).wrapping_mul(2 as libc::c_int as libc::c_ulong),
    ) as *mut libc::c_uchar;
    ...
    memset(
        ((*dtd).dtd_vlen).offset((*dtd).dtd_vlen_alloc as isize) as *mut libc::c_void,
        0 as libc::c_int,
        (*dtd).dtd_vlen_alloc,
    );
    (*dtd)
        .dtd_vlen_alloc = ((*dtd).dtd_vlen_alloc as libc::c_ulong)
        .wrapping_mul(2 as libc::c_int as libc::c_ulong) as size_t as size_t;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_create(mut errp: *mut libc::c_int) -> *mut ctf_dict_t {
    static mut hdr: ctf_header_t = {
        let mut init = ctf_header {
            cth_preamble: {
                let mut init = ctf_preamble {
                    ctp_magic: 0xdff2 as libc::c_int as libc::c_ushort,
                    ctp_version: 4 as libc::c_int as libc::c_uchar,
                    ctp_flags: 0 as libc::c_int as libc::c_uchar,
                };
                init
            },
            cth_parlabel: 0,
    ...
    let mut dthash: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut dvhash: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut structs: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut unions: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut enums: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut names: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut objthash: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut funchash: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    let mut cts: ctf_sect_t = ctf_sect_t {
    ...
    libctf_init_debug();
    dthash = ctf_dynhash_create(
        Some(
            ctf_hash_integer as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
        ),
        Some(
            ctf_hash_eq_integer
    ...
    if dthash.is_null() {
        ctf_set_open_errno(errp, 11 as libc::c_int);
    } else {
        dvhash = ctf_dynhash_create(
            Some(
                ctf_hash_string
        ...
        if dvhash.is_null() {
            ...
            if structs.is_null() || unions.is_null() || enums.is_null()
                || names.is_null()
            {
                ctf_set_open_errno(errp, 11 as libc::c_int);
            } else {
                cts.cts_name = _CTF_SECTION.as_ptr();
                cts.cts_data = &hdr as *const ctf_header_t as *const libc::c_void;
                cts.cts_size = ::core::mem::size_of::<ctf_header_t>() as libc::c_ulong;
                cts.cts_entsize = 1 as libc::c_int as size_t;
                fp = ctf_bufopen_internal(
                    &mut cts,
                    0 as *const ctf_sect_t,
                    0 as *const ctf_sect_t,
                ...
                if !fp.is_null() {
                    ...
                    (*fp).ctf_dtoldid = 0 as libc::c_int as libc::c_ulong;
                    (*fp).ctf_snapshots = 1 as libc::c_int as libc::c_ulong;
                    (*fp).ctf_snapshot_lu = 0 as libc::c_int as libc::c_ulong;
                    (*fp).ctf_flags |= 0x4 as libc::c_int as libc::c_uint;
                    ctf_set_ctl_hashes(fp);
                    ctf_setmodel(fp, 2 as libc::c_int);
                    if ctf_grow_ptrtab(fp) < 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_update(mut fp: *mut ctf_dict_t) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_name_table(
    mut fp: *mut ctf_dict_t,
    mut kind: libc::c_int,
) -> *mut ctf_names_t {
    match kind {
        6 => return &mut (*fp).ctf_structs,
        7 => return &mut (*fp).ctf_unions,
        8 => return &mut (*fp).ctf_enums,
        _ => return &mut (*fp).ctf_names,
    };
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dtd_insert(
    mut fp: *mut ctf_dict_t,
    mut dtd: *mut ctf_dtdef_t,
    mut flag: libc::c_int,
    mut kind: libc::c_int,
    ...
    if ctf_dynhash_insert(
        (*fp).ctf_dthash,
        (*dtd).dtd_type as *mut libc::c_void,
        dtd as *mut libc::c_void,
    ) < 0 as libc::c_int
    {
        ctf_set_errno(fp, 12 as libc::c_int);
        return -(1 as libc::c_int);
    }
    if flag == 1 as libc::c_int && (*dtd).dtd_data.ctt_name != 0
        && {
    ...
    {
        if ctf_dynhash_insert(
            (*ctf_name_table(fp, kind)).ctn_writable,
            name as *mut libc::c_char as *mut libc::c_void,
            (*dtd).dtd_type as *mut libc::c_void,
        ) < 0 as libc::c_int
        {
            ctf_dynhash_remove((*fp).ctf_dthash, (*dtd).dtd_type as *mut libc::c_void);
            ctf_set_errno(fp, 12 as libc::c_int);
            return -(1 as libc::c_int);
        }
    }
    ctf_list_append(&mut (*fp).ctf_dtdefs, dtd as *mut libc::c_void);
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dtd_delete(
    mut fp: *mut ctf_dict_t,
    mut dtd: *mut ctf_dtdef_t,
) {
    let mut kind: libc::c_int = ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*dtd).dtd_data.ctt_info) as libc::c_int;
    let mut vlen: size_t = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*dtd).dtd_data.ctt_info) as size_t;
    let mut name_kind: libc::c_int = kind;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    ctf_dynhash_remove((*fp).ctf_dthash, (*dtd).dtd_type as *mut libc::c_void);
    match kind {
        6 | 7 => {
            let mut memb: *mut ctf_lmember_t = (*dtd).dtd_vlen as *mut ctf_lmember_t;
            let mut i: size_t = 0;
            i = 0 as libc::c_int as size_t;
            while i < vlen {
                ctf_str_remove_ref(
                    fp,
                    ctf_strraw(fp, (*memb.offset(i as isize)).ctlm_name),
                    &mut (*memb.offset(i as isize)).ctlm_name,
                );
                i = i.wrapping_add(1);
                i;
            }
        ...
        8 => {
            let mut en: *mut ctf_enum_t = (*dtd).dtd_vlen as *mut ctf_enum_t;
            let mut i_0: size_t = 0;
            i_0 = 0 as libc::c_int as size_t;
            while i_0 < vlen {
                ctf_str_remove_ref(
                    fp,
                    ctf_strraw(fp, (*en.offset(i_0 as isize)).cte_name),
                    &mut (*en.offset(i_0 as isize)).cte_name,
                );
        ...
        9 => {
            name_kind = (*dtd).dtd_data.c2rust_unnamed.ctt_type as libc::c_int;
        }
        _ => {}
    }
    free((*dtd).dtd_vlen as *mut libc::c_void);
    (*dtd).dtd_vlen_alloc = 0 as libc::c_int as size_t;
    if (*dtd).dtd_data.ctt_name != 0
        && {
            name = ctf_strraw(fp, (*dtd).dtd_data.ctt_name);
            !name.is_null()
        }
        && ((*(*fp).ctf_dictops).ctfo_get_root)
            .expect("non-null function pointer")((*dtd).dtd_data.ctt_info) != 0
    {
        ctf_dynhash_remove(
            (*ctf_name_table(fp, name_kind)).ctn_writable,
            name as *const libc::c_void,
        );
        ctf_str_remove_ref(fp, name, &mut (*dtd).dtd_data.ctt_name);
    }
    ctf_list_delete(&mut (*fp).ctf_dtdefs, dtd as *mut libc::c_void);
    free(dtd as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dtd_lookup(
    mut fp: *const ctf_dict_t,
    mut type_0: ctf_id_t,
) -> *mut ctf_dtdef_t {
    return ctf_dynhash_lookup((*fp).ctf_dthash, type_0 as *mut libc::c_void)
        as *mut ctf_dtdef_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dynamic_type(
    mut fp: *const ctf_dict_t,
    mut id: ctf_id_t,
) -> *mut ctf_dtdef_t {
    let mut idx: ctf_id_t = 0;
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        return 0 as *mut ctf_dtdef_t;
    }
    if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
        && id <= (*fp).ctf_parmax as libc::c_ulong
    {
        fp = (*fp).ctf_parent;
    }
    idx = id & (*fp).ctf_parmax as libc::c_ulong;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_dvd_insert(
    mut fp: *mut ctf_dict_t,
    mut dvd: *mut ctf_dvdef_t,
) -> libc::c_int {
    if ctf_dynhash_insert(
        (*fp).ctf_dvhash,
        (*dvd).dvd_name as *mut libc::c_void,
        dvd as *mut libc::c_void,
    ) < 0 as libc::c_int
    {
        ctf_set_errno(fp, 12 as libc::c_int);
        return -(1 as libc::c_int);
    }
    ctf_list_append(&mut (*fp).ctf_dvdefs, dvd as *mut libc::c_void);
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dvd_delete(
    mut fp: *mut ctf_dict_t,
    mut dvd: *mut ctf_dvdef_t,
) {
    ctf_dynhash_remove((*fp).ctf_dvhash, (*dvd).dvd_name as *const libc::c_void);
    free((*dvd).dvd_name as *mut libc::c_void);
    ctf_list_delete(&mut (*fp).ctf_dvdefs, dvd as *mut libc::c_void);
    free(dvd as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dvd_lookup(
    mut fp: *const ctf_dict_t,
    mut name: *const libc::c_char,
) -> *mut ctf_dvdef_t {
    return ctf_dynhash_lookup((*fp).ctf_dvhash, name as *const libc::c_void)
        as *mut ctf_dvdef_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_discard(mut fp: *mut ctf_dict_t) -> libc::c_int {
    let mut last_update: ctf_snapshot_id_t = {
        let mut init = ctf_snapshot_id {
            dtd_id: (*fp).ctf_dtoldid,
            snapshot_id: ((*fp).ctf_snapshot_lu)
...
#[no_mangle]
pub unsafe extern "C" fn ctf_snapshot(mut fp: *mut ctf_dict_t) -> ctf_snapshot_id_t {
    let mut snapid: ctf_snapshot_id_t = ctf_snapshot_id_t {
        dtd_id: 0,
        snapshot_id: 0,
    };
    snapid.dtd_id = (*fp).ctf_typemax;
    let fresh0 = (*fp).ctf_snapshots;
    (*fp).ctf_snapshots = ((*fp).ctf_snapshots).wrapping_add(1);
    snapid.snapshot_id = fresh0;
    return snapid;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_rollback(
    mut fp: *mut ctf_dict_t,
    mut id: ctf_snapshot_id_t,
) -> libc::c_int {
    ...
    if (*fp).ctf_snapshot_lu >= id.snapshot_id {
        return ctf_set_errno(fp, ECTF_OVERROLLBACK as libc::c_int) as libc::c_int;
    }
    ...
    while !dtd.is_null() {
        ...
        ntd = (*(dtd as *mut ctf_list_t)).l_next as *mut libc::c_void
            as *mut ctf_dtdef_t;
        if !((*dtd).dtd_type & (*fp).ctf_parmax as libc::c_ulong <= id.dtd_id) {
            kind = ((*(*fp).ctf_dictops).ctfo_get_kind)
                .expect("non-null function pointer")((*dtd).dtd_data.ctt_info)
                as libc::c_int;
            if kind == 9 as libc::c_int {
                kind = (*dtd).dtd_data.c2rust_unnamed.ctt_type as libc::c_int;
            }
            if (*dtd).dtd_data.ctt_name != 0
                && {
                    name = ctf_strraw(fp, (*dtd).dtd_data.ctt_name);
...
unsafe extern "C" fn ctf_add_generic(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut kind: libc::c_int,
    mut vlen: size_t,
    mut rp: *mut *mut ctf_dtdef_t,
) -> ctf_id_t {
    let mut current_block: u64;
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0;
    if flag != 0 as libc::c_int as libc::c_uint
        && flag != 1 as libc::c_int as libc::c_uint
    {
        return ctf_set_errno(fp, 22 as libc::c_int);
    }
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        return ctf_set_errno(fp, ECTF_RDONLY as libc::c_int);
    }
    if (if 1 as libc::c_int != 0 {
        (*fp).ctf_typemax
            | ((*fp).ctf_parmax).wrapping_add(1 as libc::c_int as libc::c_uint)
                as libc::c_ulong
    } else {
        (*fp).ctf_typemax
    }) >= 0xfffffffe as libc::c_uint as libc::c_ulong
    {
        return ctf_set_errno(fp, ECTF_FULL as libc::c_int);
    }
    if (if 1 as libc::c_int != 0 {
        (*fp).ctf_typemax
            | ((*fp).ctf_parmax).wrapping_add(1 as libc::c_int as libc::c_uint)
        ...
        (*fp).ctf_typemax
    }) == (0x7fffffff as libc::c_int - 1 as libc::c_int) as libc::c_ulong
    {
        return ctf_set_errno(fp, ECTF_FULL as libc::c_int);
    }
    if ctf_grow_ptrtab(fp) < 0 as libc::c_int {
    ...
    dtd = calloc(
        ...
        ::core::mem::size_of::<ctf_dtdef_t>() as libc::c_ulong,
    ) as *mut ctf_dtdef_t;
    if dtd.is_null() {
        return ctf_set_errno(fp, 11 as libc::c_int);
    }
    (*dtd).dtd_vlen_alloc = vlen;
    if vlen > 0 as libc::c_int as libc::c_ulong {
        (*dtd)
            .dtd_vlen = calloc(1 as libc::c_int as libc::c_ulong, vlen)
            as *mut libc::c_uchar;
        if ((*dtd).dtd_vlen).is_null() {
            current_block = 6126782666873260718;
        } else {
            current_block = 2979737022853876585;
        }
    } else {
        (*dtd).dtd_vlen = 0 as *mut libc::c_uchar;
        current_block = 2979737022853876585;
    }
    match current_block {
        2979737022853876585 => {
            (*fp).ctf_typemax = ((*fp).ctf_typemax).wrapping_add(1);
            type_0 = (*fp).ctf_typemax;
            type_0 = if (*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0 {
                type_0
                    | ((*fp).ctf_parmax).wrapping_add(1 as libc::c_int as libc::c_uint)
                        as libc::c_ulong
            } else {
            ...
            (*dtd)
                .dtd_data
                .ctt_name = ctf_str_add_pending(fp, name, &mut (*dtd).dtd_data.ctt_name);
            (*dtd).dtd_type = type_0;
            if (*dtd).dtd_data.ctt_name == 0 as libc::c_int as libc::c_uint
                && !name.is_null()
                && *name.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
            {
                current_block = 6126782666873260718;
            } else if ctf_dtd_insert(fp, dtd, flag as libc::c_int, kind)
                < 0 as libc::c_int
            {
...
unsafe extern "C" fn clp2(mut x: size_t) -> size_t {
    x = x.wrapping_sub(1);
    x;
    x |= x >> 1 as libc::c_int;
    x |= x >> 2 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_encoded(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut ep: *const ctf_encoding_t,
    mut kind: uint32_t,
) -> ctf_id_t {
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0;
    let mut encoding: uint32_t = 0;
    if ep.is_null() {
        return ctf_set_errno(fp, 22 as libc::c_int);
    }
    if name.is_null()
        || *name.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32
    {
        return ctf_set_errno(fp, ECTF_NONAME as libc::c_int);
    }
    if ctf_assert_internal(
        fp,
        b"ctf-create.c\0" as *const u8 as *const libc::c_char,
        540 as libc::c_int as size_t,
        b"kind == CTF_K_INTEGER || kind == CTF_K_FLOAT\0" as *const u8
            as *const libc::c_char,
        (kind == 1 as libc::c_int as libc::c_uint
            || kind == 2 as libc::c_int as libc::c_uint) as libc::c_int,
    ) as libc::c_long == 0
    {
        return -(1 as libc::c_int) as ctf_id_t;
    }
    type_0 = ctf_add_generic(
        fp,
        flag,
        name,
        kind as libc::c_int,
    ...
    if type_0 == -(1 as libc::c_long) as ctf_id_t {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    (*dtd)
        .dtd_data
        .ctt_info = kind << 26 as libc::c_int
        | ((if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int) as libc::c_uint
        | (0 as libc::c_int & 0xffffff as libc::c_int) as libc::c_uint;
    (*dtd)
        .dtd_data
        .c2rust_unnamed
        .ctt_size = clp2(
        (((*ep).cte_bits).wrapping_neg() & -(8 as libc::c_int) as libc::c_uint)
            .wrapping_neg()
            .wrapping_div(8 as libc::c_int as libc::c_uint) as size_t,
    ) as uint32_t;
    match kind {
        1 => {
            encoding = (*ep).cte_format << 24 as libc::c_int
                | (*ep).cte_offset << 16 as libc::c_int | (*ep).cte_bits;
        }
        2 => {
            encoding = (*ep).cte_format << 24 as libc::c_int
                | (*ep).cte_offset << 16 as libc::c_int | (*ep).cte_bits;
    ...
    memcpy(
        (*dtd).dtd_vlen as *mut libc::c_void,
        &mut encoding as *mut uint32_t as *const libc::c_void,
        ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
    );
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_reftype(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ref_0: ctf_id_t,
    mut kind: uint32_t,
    ...
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0;
    let mut tmp: *mut ctf_dict_t = fp;
    let mut child: libc::c_int = ((*fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint)
        as libc::c_int;
    if ref_0 == -(1 as libc::c_long) as ctf_id_t
        || ref_0 > 0xfffffffe as libc::c_uint as libc::c_ulong
    {
        return ctf_set_errno(fp, 22 as libc::c_int);
    }
    if ref_0 != 0 as libc::c_int as libc::c_ulong
        && (ctf_lookup_by_id(&mut tmp, ref_0)).is_null()
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    type_0 = ctf_add_generic(
    ...
    (*dtd)
        ...
        | ((if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int) as libc::c_uint
        | (0 as libc::c_int & 0xffffff as libc::c_int) as libc::c_uint;
    (*dtd).dtd_data.c2rust_unnamed.ctt_type = ref_0 as uint32_t;
    if kind != 3 as libc::c_int as libc::c_uint {
        return type_0;
    }
    let mut type_idx: uint32_t = (type_0 & (*fp).ctf_parmax as libc::c_ulong)
        as uint32_t;
    let mut ref_idx: uint32_t = (ref_0 & (*fp).ctf_parmax as libc::c_ulong) as uint32_t;
    if (ref_0 > (*fp).ctf_parmax as libc::c_ulong) as libc::c_int == child
        && (ref_idx as libc::c_ulong) < (*fp).ctf_typemax
    {
        *((*fp).ctf_ptrtab).offset(ref_idx as isize) = type_idx;
    }
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_slice(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ref_0: ctf_id_t,
    mut ep: *const ctf_encoding_t,
    ...
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut slice: ctf_slice_t = ctf_slice_t {
        cts_type: 0,
        cts_offset: 0,
        cts_bits: 0,
    };
    let mut resolved_ref: ctf_id_t = ref_0;
    let mut type_0: ctf_id_t = 0;
    let mut kind: libc::c_int = 0;
    ...
    if (*ep).cte_bits > 255 as libc::c_int as libc::c_uint
        || (*ep).cte_offset > 255 as libc::c_int as libc::c_uint
    {
        return ctf_set_errno(fp, ECTF_SLICEOVERFLOW as libc::c_int);
    }
    if ref_0 == -(1 as libc::c_long) as ctf_id_t
        || ref_0 > 0xfffffffe as libc::c_uint as libc::c_ulong
    {
    ...
    if ref_0 != 0 as libc::c_int as libc::c_ulong
        && {
            tp = ctf_lookup_by_id(&mut tmp, ref_0);
            tp.is_null()
        }
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    resolved_ref = ctf_type_resolve_unsliced(tmp, ref_0);
    kind = ctf_type_kind_unsliced(tmp, resolved_ref);
    if kind != 1 as libc::c_int && kind != 2 as libc::c_int && kind != 8 as libc::c_int
        && ref_0 != 0 as libc::c_int as libc::c_ulong
    {
        return ctf_set_errno(fp, ECTF_NOTINTFP as libc::c_int);
    }
    type_0 = ctf_add_generic(
        fp,
        flag,
        0 as *const libc::c_char,
        14 as libc::c_int,
        ::core::mem::size_of::<ctf_slice_t>() as libc::c_ulong,
        &mut dtd,
    );
    if type_0 == -(1 as libc::c_long) as ctf_id_t {
        return -(1 as libc::c_long) as ctf_id_t;
    ...
    memset(
        &mut slice as *mut ctf_slice_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<ctf_slice_t>() as libc::c_ulong,
    );
    (*dtd)
        .dtd_data
        .ctt_info = ((14 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd)
        .dtd_data
        .c2rust_unnamed
    ...
    slice.cts_type = ref_0 as uint32_t;
    slice.cts_bits = (*ep).cte_bits as libc::c_ushort;
    slice.cts_offset = (*ep).cte_offset as libc::c_ushort;
    memcpy(
        (*dtd).dtd_vlen as *mut libc::c_void,
        &mut slice as *mut ctf_slice_t as *const libc::c_void,
        ::core::mem::size_of::<ctf_slice_t>() as libc::c_ulong,
    );
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_integer(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut ep: *const ctf_encoding_t,
) -> ctf_id_t {
    return ctf_add_encoded(fp, flag, name, ep, 1 as libc::c_int as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_float(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut ep: *const ctf_encoding_t,
) -> ctf_id_t {
    return ctf_add_encoded(fp, flag, name, ep, 2 as libc::c_int as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_pointer(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ref_0: ctf_id_t,
) -> ctf_id_t {
    return ctf_add_reftype(fp, flag, ref_0, 3 as libc::c_int as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_array(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut arp: *const ctf_arinfo_t,
) -> ctf_id_t {
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut cta: ctf_array_t = ctf_array_t {
        cta_contents: 0,
        cta_index: 0,
        cta_nelems: 0,
    };
    ...
    if (*arp).ctr_contents != 0 as libc::c_int as libc::c_ulong
        && (ctf_lookup_by_id(&mut tmp, (*arp).ctr_contents)).is_null()
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    tmp = fp;
    if (ctf_lookup_by_id(&mut tmp, (*arp).ctr_index)).is_null() {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    if ctf_type_kind(fp, (*arp).ctr_index) == 9 as libc::c_int {
        ctf_err_warn(
            fp,
            1 as libc::c_int,
            ECTF_INCOMPLETE as libc::c_int,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"ctf_add_array: index type %lx is incomplete\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*arp).ctr_contents,
        );
        return ctf_set_errno(fp, ECTF_INCOMPLETE as libc::c_int);
    }
    type_0 = ctf_add_generic(
        fp,
        flag,
        0 as *const libc::c_char,
        4 as libc::c_int,
        ::core::mem::size_of::<ctf_array_t>() as libc::c_ulong,
        &mut dtd,
    );
    if type_0 == -(1 as libc::c_long) as ctf_id_t {
        return -(1 as libc::c_long) as ctf_id_t;
    ...
    memset(
        &mut cta as *mut ctf_array_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<ctf_array_t>() as libc::c_ulong,
    );
    (*dtd)
        .dtd_data
        .ctt_info = ((4 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_size = 0 as libc::c_int as uint32_t;
    cta.cta_contents = (*arp).ctr_contents as uint32_t;
    cta.cta_index = (*arp).ctr_index as uint32_t;
    cta.cta_nelems = (*arp).ctr_nelems;
    memcpy(
        (*dtd).dtd_vlen as *mut libc::c_void,
        &mut cta as *mut ctf_array_t as *const libc::c_void,
        ::core::mem::size_of::<ctf_array_t>() as libc::c_ulong,
    );
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_set_array(
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut arp: *const ctf_arinfo_t,
) -> libc::c_int {
    let mut dtd: *mut ctf_dtdef_t = ctf_dtd_lookup(fp, type_0);
    let mut vlen: *mut ctf_array_t = 0 as *mut ctf_array_t;
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        return ctf_set_errno(fp, ECTF_RDONLY as libc::c_int) as libc::c_int;
    }
    if dtd.is_null()
        || ((*(*fp).ctf_dictops).ctfo_get_kind)
            .expect("non-null function pointer")((*dtd).dtd_data.ctt_info)
            != 4 as libc::c_int as libc::c_uint
    {
        return ctf_set_errno(fp, ECTF_BADID as libc::c_int) as libc::c_int;
    }
    vlen = (*dtd).dtd_vlen as *mut ctf_array_t;
    (*fp).ctf_flags |= 0x4 as libc::c_int as libc::c_uint;
    (*vlen).cta_contents = (*arp).ctr_contents as uint32_t;
    (*vlen).cta_index = (*arp).ctr_index as uint32_t;
    (*vlen).cta_nelems = (*arp).ctr_nelems;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_function(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ctc: *const ctf_funcinfo_t,
    mut argv: *const ctf_id_t,
) -> ctf_id_t {
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0;
    let mut vlen: uint32_t = 0;
    let mut vdat: *mut uint32_t = 0 as *mut uint32_t;
    let mut tmp: *mut ctf_dict_t = fp;
    let mut initial_vlen: size_t = 0;
    let mut i: size_t = 0;
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        return ctf_set_errno(fp, ECTF_RDONLY as libc::c_int);
    }
    if ctc.is_null()
        || (*ctc).ctc_flags & !(0x1 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        || (*ctc).ctc_argc != 0 as libc::c_int as libc::c_uint && argv.is_null()
    {
        return ctf_set_errno(fp, 22 as libc::c_int);
    }
    vlen = (*ctc).ctc_argc;
    if (*ctc).ctc_flags & 0x1 as libc::c_int as libc::c_uint != 0 {
        vlen = vlen.wrapping_add(1);
        vlen;
    }
    if (*ctc).ctc_return != 0 as libc::c_int as libc::c_ulong
        && (ctf_lookup_by_id(&mut tmp, (*ctc).ctc_return)).is_null()
    {
        return -(1 as libc::c_long) as ctf_id_t;
    }
    if vlen > 0xffffff as libc::c_int as libc::c_uint {
        return ctf_set_errno(fp, 75 as libc::c_int);
    }
    initial_vlen = (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
        .wrapping_mul(
            vlen.wrapping_add(vlen & 1 as libc::c_int as libc::c_uint) as libc::c_ulong,
        );
    type_0 = ctf_add_generic(
        fp,
        flag,
    ...
    vdat = (*dtd).dtd_vlen as *mut uint32_t;
    i = 0 as libc::c_int as size_t;
    while i < (*ctc).ctc_argc as libc::c_ulong {
        tmp = fp;
        if *argv.offset(i as isize) != 0 as libc::c_int as libc::c_ulong
            && (ctf_lookup_by_id(&mut tmp, *argv.offset(i as isize))).is_null()
        {
            return -(1 as libc::c_long) as ctf_id_t;
        }
        *vdat.offset(i as isize) = *argv.offset(i as isize) as uint32_t;
        i = i.wrapping_add(1);
        i;
    }
    (*dtd)
        .dtd_data
        .ctt_info = ((5 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int) as libc::c_uint
        | vlen & 0xffffff as libc::c_int as libc::c_uint;
    (*dtd).dtd_data.c2rust_unnamed.ctt_type = (*ctc).ctc_return as uint32_t;
    if (*ctc).ctc_flags & 0x1 as libc::c_int as libc::c_uint != 0 {
        *vdat
            .offset(
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_struct_sized(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut size: size_t,
    ...
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    let mut initial_vlen: size_t = (::core::mem::size_of::<ctf_lmember_t>()
        as libc::c_ulong)
        .wrapping_mul(16 as libc::c_int as libc::c_ulong);
    if !name.is_null() {
        type_0 = ctf_lookup_by_rawname(fp, 6 as libc::c_int, name);
    }
    if type_0 != 0 as libc::c_int as libc::c_ulong
        && ctf_type_kind(fp, type_0) == 9 as libc::c_int
    {
        dtd = ctf_dtd_lookup(fp, type_0);
    } else {
        type_0 = ctf_add_generic(
            fp,
            flag,
    ...
    if (*dtd).dtd_vlen_alloc == 0 as libc::c_int as libc::c_ulong {
        (*dtd)
            .dtd_vlen = calloc(1 as libc::c_int as libc::c_ulong, initial_vlen)
            as *mut libc::c_uchar;
        if ((*dtd).dtd_vlen).is_null() {
            return ctf_set_errno(fp, 12 as libc::c_int);
        }
        (*dtd).dtd_vlen_alloc = initial_vlen;
    }
    (*dtd)
        .dtd_data
        .ctt_info = ((6 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_size = 0xffffffff as libc::c_uint;
    (*dtd).dtd_data.ctt_lsizehi = (size >> 32 as libc::c_int) as uint32_t;
    (*dtd).dtd_data.ctt_lsizelo = size as uint32_t;
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_struct(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    return ctf_add_struct_sized(fp, flag, name, 0 as libc::c_int as size_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_union_sized(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut size: size_t,
    ...
    let mut initial_vlen: size_t = (::core::mem::size_of::<ctf_lmember_t>()
        ...
        .wrapping_mul(16 as libc::c_int as libc::c_ulong);
    if !name.is_null() {
        type_0 = ctf_lookup_by_rawname(fp, 7 as libc::c_int, name);
    }
    if type_0 != 0 as libc::c_int as libc::c_ulong
        && ctf_type_kind(fp, type_0) == 9 as libc::c_int
    {
    ...
    (*dtd)
        .dtd_data
        .ctt_info = ((7 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_size = 0xffffffff as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_union(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    return ctf_add_union_sized(fp, flag, name, 0 as libc::c_int as size_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_enum(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    let mut initial_vlen: size_t = (::core::mem::size_of::<ctf_enum_t>()
        as libc::c_ulong)
        .wrapping_mul(16 as libc::c_int as libc::c_ulong);
    if !name.is_null() {
        type_0 = ctf_lookup_by_rawname(fp, 8 as libc::c_int, name);
    }
    if type_0 != 0 as libc::c_int as libc::c_ulong
        && ctf_type_kind(fp, type_0) == 9 as libc::c_int
    {
    ...
    (*dtd)
        .dtd_data
        .ctt_info = ((8 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_size = (*(*fp).ctf_dmodel).ctd_int as uint32_t;
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_enum_encoded(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut ep: *const ctf_encoding_t,
    ...
    if type_0 != 0 as libc::c_int as libc::c_ulong {
        if ctf_type_kind(fp, type_0) != 9 as libc::c_int
            && ctf_type_kind_unsliced(fp, type_0) != 8 as libc::c_int
        {
            return ctf_set_errno(fp, ECTF_NOTINTFP as libc::c_int);
        }
    } else {
        type_0 = ctf_add_enum(fp, flag, name);
        if type_0 == -(1 as libc::c_long) as ctf_id_t {
            return -(1 as libc::c_long) as ctf_id_t;
        }
    }
    return ctf_add_slice(fp, flag, type_0, ep);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_forward(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut kind: uint32_t,
    ...
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut type_0: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    if ctf_forwardable_kind(kind as libc::c_int) == 0 {
        return ctf_set_errno(fp, ECTF_NOTSUE as libc::c_int);
    }
    if name.is_null()
        || *name.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32
    {
    ...
    type_0 = ctf_lookup_by_rawname(fp, kind as libc::c_int, name);
    if type_0 != 0 {
        return type_0;
    }
    type_0 = ctf_add_generic(
    ...
    (*dtd)
        .dtd_data
        .ctt_info = ((9 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_type = kind;
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_unknown(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    ...
    if !name.is_null()
        ...
        && flag == 1 as libc::c_int as libc::c_uint
        && {
            type_0 = ctf_lookup_by_rawname(fp, 0 as libc::c_int, name);
            type_0 != 0
        }
    {
        if ctf_type_kind(fp, type_0) == 0 as libc::c_int {
            return type_0
        } else {
            ctf_err_warn(
                fp,
                1 as libc::c_int,
                ECTF_CONFLICT as libc::c_int,
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"ctf_add_unknown: cannot add unknown type named %s: type of this name already defined\0"
            ...
            return ctf_set_errno(fp, ECTF_CONFLICT as libc::c_int);
        }
    }
    type_0 = ctf_add_generic(
        fp,
    ...
    (*dtd)
        .dtd_data
        .ctt_info = ((0 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_type = 0 as libc::c_int as uint32_t;
    return type_0;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_typedef(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut name: *const libc::c_char,
    mut ref_0: ctf_id_t,
    ...
    (*dtd)
        .dtd_data
        .ctt_info = ((10 as libc::c_int) << 26 as libc::c_int
        | (if flag != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int | 0 as libc::c_int & 0xffffff as libc::c_int)
        as uint32_t;
    (*dtd).dtd_data.c2rust_unnamed.ctt_type = ref_0 as uint32_t;
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_volatile(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ref_0: ctf_id_t,
) -> ctf_id_t {
    return ctf_add_reftype(fp, flag, ref_0, 11 as libc::c_int as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_const(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ref_0: ctf_id_t,
) -> ctf_id_t {
    return ctf_add_reftype(fp, flag, ref_0, 12 as libc::c_int as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_restrict(
    mut fp: *mut ctf_dict_t,
    mut flag: uint32_t,
    mut ref_0: ctf_id_t,
) -> ctf_id_t {
    return ctf_add_reftype(fp, flag, ref_0, 13 as libc::c_int as uint32_t);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_enumerator(
    mut fp: *mut ctf_dict_t,
    mut enid: ctf_id_t,
    mut name: *const libc::c_char,
    mut value: libc::c_int,
) -> libc::c_int {
    let mut dtd: *mut ctf_dtdef_t = ctf_dtd_lookup(fp, enid);
    let mut old_vlen: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut en: *mut ctf_enum_t = 0 as *mut ctf_enum_t;
    let mut i: size_t = 0;
    let mut kind: uint32_t = 0;
    let mut vlen: uint32_t = 0;
    let mut root: uint32_t = 0;
    if name.is_null() {
    ...
    kind = ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*dtd).dtd_data.ctt_info);
    root = ((*(*fp).ctf_dictops).ctfo_get_root)
        .expect("non-null function pointer")((*dtd).dtd_data.ctt_info);
    vlen = ((*(*fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*dtd).dtd_data.ctt_info);
    if kind != 8 as libc::c_int as libc::c_uint {
        return ctf_set_errno(fp, ECTF_NOTENUM as libc::c_int) as libc::c_int;
    }
    if vlen == 0xffffff as libc::c_int as libc::c_uint {
        return ctf_set_errno(fp, ECTF_DTFULL as libc::c_int) as libc::c_int;
    }
    ...
    if ctf_grow_vlen(
        ...
        (::core::mem::size_of::<ctf_enum_t>() as libc::c_ulong)
            .wrapping_mul(
                vlen.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong,
            ),
    ) < 0 as libc::c_int
    {
        return -(1 as libc::c_int);
    }
    en = (*dtd).dtd_vlen as *mut ctf_enum_t;
    if (*dtd).dtd_vlen != old_vlen {
        let mut move_0: ptrdiff_t = ((*dtd).dtd_vlen as *mut libc::c_schar)
            .offset_from(old_vlen as *mut libc::c_schar) as libc::c_long;
        i = 0 as libc::c_int as size_t;
        while i < vlen as libc::c_ulong {
            ctf_str_move_pending(fp, &mut (*en.offset(i as isize)).cte_name, move_0);
            i = i.wrapping_add(1);
            i;
        }
    }
    i = 0 as libc::c_int as size_t;
    while i < vlen as libc::c_ulong {
        if strcmp(ctf_strptr(fp, (*en.offset(i as isize)).cte_name), name)
            == 0 as libc::c_int
        {
            return ctf_set_errno(fp, ECTF_DUPLICATE as libc::c_int) as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
    }
    (*en.offset(i as isize))
        .cte_name = ctf_str_add_pending(
        fp,
        name,
        &mut (*en.offset(i as isize)).cte_name,
    );
    (*en.offset(i as isize)).cte_value = value;
    if (*en.offset(i as isize)).cte_name == 0 as libc::c_int as libc::c_uint
        && !name.is_null()
        && *name.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
    {
        return -(1 as libc::c_int);
    ...
    (*dtd)
        .dtd_data
        .ctt_info = kind << 26 as libc::c_int
        | ((if root != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
            << 25 as libc::c_int) as libc::c_uint
        | vlen.wrapping_add(1 as libc::c_int as libc::c_uint)
            & 0xffffff as libc::c_int as libc::c_uint;
    (*fp).ctf_flags |= 0x4 as libc::c_int as libc::c_uint;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_member_offset(
    mut fp: *mut ctf_dict_t,
    mut souid: ctf_id_t,
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
    mut bit_offset: libc::c_ulong,
) -> libc::c_int {
    let mut dtd: *mut ctf_dtdef_t = ctf_dtd_lookup(fp, souid);
    let mut msize: ssize_t = 0;
    let mut malign: ssize_t = 0;
    let mut ssize: ssize_t = 0;
    let mut kind: uint32_t = 0;
    let mut vlen: uint32_t = 0;
    let mut root: uint32_t = 0;
    let mut i: size_t = 0;
    let mut is_incomplete: libc::c_int = 0 as libc::c_int;
    let mut old_vlen: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut memb: *mut ctf_lmember_t = 0 as *mut ctf_lmember_t;
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        return ctf_set_errno(fp, ECTF_RDONLY as libc::c_int) as libc::c_int;
    }
    if dtd.is_null() {
    ...
    {
        return ctf_set_errno(fp, ECTF_NOTSOU as libc::c_int) as libc::c_int;
    }
    if vlen == 0xffffff as libc::c_int as libc::c_uint {
        return ctf_set_errno(fp, ECTF_DTFULL as libc::c_int) as libc::c_int;
    }
    ...
    memb = (*dtd).dtd_vlen as *mut ctf_lmember_t;
    if (*dtd).dtd_vlen != old_vlen {
        let mut move_0: ptrdiff_t = ((*dtd).dtd_vlen as *mut libc::c_schar)
            .offset_from(old_vlen as *mut libc::c_schar) as libc::c_long;
        i = 0 as libc::c_int as size_t;
        while i < vlen as libc::c_ulong {
            ctf_str_move_pending(fp, &mut (*memb.offset(i as isize)).ctlm_name, move_0);
            i = i.wrapping_add(1);
            i;
        }
    }
    if !name.is_null() {
        i = 0 as libc::c_int as size_t;
        while i < vlen as libc::c_ulong {
            if strcmp(ctf_strptr(fp, (*memb.offset(i as isize)).ctlm_name), name)
                == 0 as libc::c_int
            {
                return ctf_set_errno(fp, ECTF_DUPLICATE as libc::c_int) as libc::c_int;
            }
    ...
    msize = ctf_type_size(fp, type_0);
    if msize < 0 as libc::c_int as libc::c_long
        || {
            malign = ctf_type_align(fp, type_0);
            malign < 0 as libc::c_int as libc::c_long
        }
    {
        msize = 0 as libc::c_int as ssize_t;
        malign = 0 as libc::c_int as ssize_t;
        if ctf_errno(fp) == ECTF_NONREPRESENTABLE as libc::c_int {
            ctf_set_errno(fp, 0 as libc::c_int);
        } else if ctf_errno(fp) == ECTF_INCOMPLETE as libc::c_int {
            is_incomplete = 1 as libc::c_int;
        } else {
            return -(1 as libc::c_int)
        }
    }
    (*memb.offset(vlen as isize))
        .ctlm_name = ctf_str_add_pending(
        fp,
        name,
        &mut (*memb.offset(vlen as isize)).ctlm_name,
    );
    (*memb.offset(vlen as isize)).ctlm_type = type_0 as uint32_t;
    if (*memb.offset(vlen as isize)).ctlm_name == 0 as libc::c_int as libc::c_uint
        && !name.is_null()
        && *name.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
    {
        return -(1 as libc::c_int);
    ...
    {
        if bit_offset == -(1 as libc::c_int) as libc::c_ulong {
            let mut ltype: ctf_id_t = ctf_type_resolve(
                fp,
                (*memb
                    .offset(
                        vlen.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize,
                    ))
                    .ctlm_type as ctf_id_t,
            );
            let mut off: size_t = ((*memb
                .offset(vlen.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize))
                .ctlm_offsethi as uint64_t) << 32 as libc::c_int
                | (*memb
                    .offset(
                        vlen.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize,
                    ))
                    .ctlm_offsetlo as libc::c_ulong;
            let mut linfo: ctf_encoding_t = ctf_encoding_t {
                cte_format: 0,
                cte_offset: 0,
                cte_bits: 0,
            };
            let mut lsize: ssize_t = 0;
            if ltype == -(1 as libc::c_long) as ctf_id_t {
                return -(1 as libc::c_int);
            }
            if is_incomplete != 0 {
                ctf_err_warn(
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"ctf_add_member_offset: cannot add member %s of incomplete type %lx to struct %lx without specifying explicit offset\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    if !name.is_null() {
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"(unnamed member)\0" as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ) as *const libc::c_char
                    },
                    type_0,
                ...
                return ctf_set_errno(fp, ECTF_INCOMPLETE as libc::c_int) as libc::c_int;
            }
            if ctf_type_encoding(fp, ltype, &mut linfo) == 0 as libc::c_int {
                off = (off as libc::c_ulong)
                    .wrapping_add(linfo.cte_bits as libc::c_ulong) as size_t as size_t;
            } else {
                lsize = ctf_type_size(fp, ltype);
                if lsize > 0 as libc::c_int as libc::c_long {
                    off = (off as libc::c_ulong)
                        .wrapping_add(
                            (lsize * 8 as libc::c_int as libc::c_long) as libc::c_ulong,
                        ) as size_t as size_t;
                } else if lsize == -(1 as libc::c_int) as libc::c_long
                    && ctf_errno(fp) == ECTF_INCOMPLETE as libc::c_int
                {
                    let mut lname: *const libc::c_char = ctf_strraw(
                        fp,
                        (*memb
                            .offset(
                                vlen.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize,
                    ...
                    ctf_err_warn(
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"ctf_add_member_offset: cannot add member %s of type %lx to struct %lx without specifying explicit offset after member %s of type %lx, which is an incomplete type\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        if !name.is_null() {
                    ...
                    == 0 as libc::c_int
            {
                ...
                off.wrapping_add((8 as libc::c_int - 1 as libc::c_int) as libc::c_ulong)
                    .wrapping_div(8 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(8 as libc::c_int as libc::c_ulong)
            })
                .wrapping_div(8 as libc::c_int as libc::c_ulong);
            off = if 0 != 0
                && (if malign > 1 as libc::c_int as libc::c_long {
                    malign
                } else {
            ...
            (*memb.offset(vlen as isize))
                .ctlm_offsethi = (off.wrapping_mul(8 as libc::c_int as libc::c_ulong)
                >> 32 as libc::c_int) as uint32_t;
            (*memb.offset(vlen as isize))
                .ctlm_offsetlo = off.wrapping_mul(8 as libc::c_int as libc::c_ulong)
                as uint32_t;
            ssize = off.wrapping_add(msize as libc::c_ulong) as ssize_t;
        } else {
            (*memb.offset(vlen as isize))
                .ctlm_offsethi = (bit_offset >> 32 as libc::c_int) as uint32_t;
            (*memb.offset(vlen as isize)).ctlm_offsetlo = bit_offset as uint32_t;
            ssize = ctf_get_ctt_size(
                fp,
                &mut (*dtd).dtd_data,
                0 as *mut ssize_t,
                0 as *mut ssize_t,
            ...
            ssize = if ssize
                > (bit_offset as libc::c_int / 8 as libc::c_int) as libc::c_long + msize
            {
                ssize
            } else {
                (bit_offset as libc::c_int / 8 as libc::c_int) as libc::c_long + msize
        ...
        (*memb.offset(vlen as isize)).ctlm_offsethi = 0 as libc::c_int as uint32_t;
        (*memb.offset(vlen as isize)).ctlm_offsetlo = 0 as libc::c_int as uint32_t;
        ssize = ctf_get_ctt_size(
            fp,
            &mut (*dtd).dtd_data,
            0 as *mut ssize_t,
        ...
        ssize = if ssize > msize { ssize } else { msize };
    }
    (*dtd).dtd_data.c2rust_unnamed.ctt_size = 0xffffffff as libc::c_uint;
    (*dtd).dtd_data.ctt_lsizehi = (ssize as uint64_t >> 32 as libc::c_int) as uint32_t;
    (*dtd).dtd_data.ctt_lsizelo = ssize as uint32_t;
    (*dtd)
        .dtd_data
        .ctt_info = kind << 26 as libc::c_int
        | ((if root != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_member_encoded(
    mut fp: *mut ctf_dict_t,
    mut souid: ctf_id_t,
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
    mut bit_offset: libc::c_ulong,
    encoding: ctf_encoding_t,
) -> libc::c_int {
    let mut dtd: *mut ctf_dtdef_t = ctf_dtd_lookup(fp, type_0);
    let mut kind: libc::c_int = ((*(*fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*dtd).dtd_data.ctt_info) as libc::c_int;
    let mut otype: libc::c_int = type_0 as libc::c_int;
    if kind != 1 as libc::c_int && kind != 2 as libc::c_int && kind != 8 as libc::c_int {
        return ctf_set_errno(fp, ECTF_NOTINTFP as libc::c_int) as libc::c_int;
    }
    type_0 = ctf_add_slice(
        fp,
        0 as libc::c_int as uint32_t,
        otype as ctf_id_t,
        &encoding,
    ...
    return ctf_add_member_offset(fp, souid, name, type_0, bit_offset);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_member(
    mut fp: *mut ctf_dict_t,
    mut souid: ctf_id_t,
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
) -> libc::c_int {
    return ctf_add_member_offset(
        fp,
        souid,
        name,
        type_0,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_variable(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
    mut ref_0: ctf_id_t,
) -> libc::c_int {
    ...
    if !(ctf_dvd_lookup(fp, name)).is_null() {
        return ctf_set_errno(fp, ECTF_DUPLICATE as libc::c_int) as libc::c_int;
    }
    if (ctf_lookup_by_id(&mut tmp, ref_0)).is_null() {
        return -(1 as libc::c_int);
    }
    if ctf_type_resolve(fp, ref_0) == -(1 as libc::c_long) as ctf_id_t
        && ctf_errno(fp) == ECTF_NONREPRESENTABLE as libc::c_int
    {
        return -(1 as libc::c_int);
    }
    dvd = malloc(::core::mem::size_of::<ctf_dvdef_t>() as libc::c_ulong)
        as *mut ctf_dvdef_t;
    if dvd.is_null() {
    ...
    if ctf_dvd_insert(fp, dvd) < 0 as libc::c_int {
        free((*dvd).dvd_name as *mut libc::c_void);
        free(dvd as *mut libc::c_void);
        return -(1 as libc::c_int);
    }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_funcobjt_sym(
    mut fp: *mut ctf_dict_t,
    ...
    let mut tmp: *mut ctf_dict_t = fp;
    let mut dupname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut h: *mut ctf_dynhash_t = if is_function != 0 {
        (*fp).ctf_funchash
    } else {
        (*fp).ctf_objthash
    };
    ...
    if !(ctf_dynhash_lookup((*fp).ctf_objthash, name as *const libc::c_void)).is_null()
        || !(ctf_dynhash_lookup((*fp).ctf_funchash, name as *const libc::c_void))
            .is_null()
    {
        return ctf_set_errno(fp, ECTF_DUPLICATE as libc::c_int) as libc::c_int;
    }
    if (ctf_lookup_by_id(&mut tmp, id)).is_null() {
        return -(1 as libc::c_int);
    }
    if is_function != 0 && ctf_type_kind(fp, id) != 5 as libc::c_int {
        return ctf_set_errno(fp, ECTF_NOTFUNC as libc::c_int) as libc::c_int;
    }
    dupname = strdup(name);
    if dupname.is_null() {
        return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
    }
    if ctf_dynhash_insert(h, dupname as *mut libc::c_void, id as *mut libc::c_void)
        < 0 as libc::c_int
    {
        free(dupname as *mut libc::c_void);
        return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_objt_sym(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
    mut id: ctf_id_t,
) -> libc::c_int {
    return ctf_add_funcobjt_sym(fp, 0 as libc::c_int, name, id);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_add_func_sym(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
    mut id: ctf_id_t,
) -> libc::c_int {
    return ctf_add_funcobjt_sym(fp, 1 as libc::c_int, name, id);
}
unsafe extern "C" fn enumcmp(
    mut name: *const libc::c_char,
    mut value: libc::c_int,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut ctb: *mut ctf_bundle_t = arg as *mut ctf_bundle_t;
    let mut bvalue: libc::c_int = 0;
    if ctf_enum_value((*ctb).ctb_dict, (*ctb).ctb_type, name, &mut bvalue)
        < 0 as libc::c_int
    {
        ctf_err_warn(
            (*ctb).ctb_dict,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"conflict due to enum %s iteration error\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
    ...
    if value != bvalue {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"conflict due to enum value change: %i versus %i\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            value,
...
unsafe extern "C" fn enumadd(
    mut name: *const libc::c_char,
    mut value: libc::c_int,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut ctb: *mut ctf_bundle_t = arg as *mut ctf_bundle_t;
    return (ctf_add_enumerator((*ctb).ctb_dict, (*ctb).ctb_type, name, value)
        < 0 as libc::c_int) as libc::c_int;
}
unsafe extern "C" fn membcmp(
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
    ...
    let mut ctb: *mut ctf_bundle_t = arg as *mut ctf_bundle_t;
    let mut ctm: ctf_membinfo_t = ctf_membinfo_t {
        ctm_type: 0,
        ctm_offset: 0,
    };
    ...
    if ctf_member_info((*ctb).ctb_dict, (*ctb).ctb_type, name, &mut ctm)
        < 0 as libc::c_int
    {
        ctf_err_warn(
            (*ctb).ctb_dict,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"conflict due to struct member %s iteration error\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
    ...
    if ctm.ctm_offset != offset {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"conflict due to struct member %s offset change: %lx versus %lx\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
...
unsafe extern "C" fn ctf_add_type_mapping(
    mut src_fp: *mut ctf_dict_t,
    mut src_type: ctf_id_t,
    mut dst_fp: *mut ctf_dict_t,
    mut dst_type: ctf_id_t,
) {
    if src_type <= (*src_fp).ctf_parmax as libc::c_ulong
        && !((*src_fp).ctf_parent).is_null()
    {
        src_fp = (*src_fp).ctf_parent;
    }
    src_type = src_type & (*src_fp).ctf_parmax as libc::c_ulong;
    if dst_type <= (*dst_fp).ctf_parmax as libc::c_ulong
        && !((*dst_fp).ctf_parent).is_null()
    {
        dst_fp = (*dst_fp).ctf_parent;
    }
    dst_type = dst_type & (*dst_fp).ctf_parmax as libc::c_ulong;
    if ((*dst_fp).ctf_link_type_mapping).is_null() {
        let mut f: ctf_hash_fun = Some(
            ctf_hash_type_key
                as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
        );
        let mut e: ctf_hash_eq_fun = Some(
        ...
        (*dst_fp)
            .ctf_link_type_mapping = ctf_dynhash_create(
            f,
            e,
            Some(free as unsafe extern "C" fn(*mut libc::c_void) -> ()),
            None,
    ...
    let mut key: *mut ctf_link_type_key_t = 0 as *mut ctf_link_type_key_t;
    key = calloc(
        1 as libc::c_int as libc::c_ulong,
        ::core::mem::size_of::<ctf_link_type_key>() as libc::c_ulong,
    ) as *mut ctf_link_type_key_t;
    if key.is_null() {
        return;
    }
    (*key).cltk_fp = src_fp;
    ...
    ctf_dynhash_insert(
        ...
        dst_type as *mut libc::c_void,
    );
}
unsafe extern "C" fn ctf_type_mapping(
    mut src_fp: *mut ctf_dict_t,
    mut src_type: ctf_id_t,
    mut dst_fp: *mut *mut ctf_dict_t,
) -> ctf_id_t {
    let mut key: ctf_link_type_key_t = ctf_link_type_key_t {
        cltk_fp: 0 as *mut ctf_dict_t,
        cltk_idx: 0,
    };
    let mut target_fp: *mut ctf_dict_t = *dst_fp;
    let mut dst_type: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    if src_type <= (*src_fp).ctf_parmax as libc::c_ulong
        && !((*src_fp).ctf_parent).is_null()
    {
        src_fp = (*src_fp).ctf_parent;
    ...
    key.cltk_fp = src_fp;
    key.cltk_idx = src_type;
    if !((*target_fp).ctf_link_type_mapping).is_null() {
        dst_type = ctf_dynhash_lookup(
            (*target_fp).ctf_link_type_mapping,
            &mut key as *mut ctf_link_type_key_t as *const libc::c_void,
        ) as uintptr_t;
    }
    if dst_type != 0 as libc::c_int as libc::c_ulong {
        dst_type = if !((*target_fp).ctf_parent).is_null() {
            dst_type
                | ((*target_fp).ctf_parmax)
    ...
    if !((*target_fp).ctf_parent).is_null() {
...
unsafe extern "C" fn ctf_add_type_internal(
    mut dst_fp: *mut ctf_dict_t,
    mut src_fp: *mut ctf_dict_t,
    mut src_type: ctf_id_t,
    mut proc_tracking_fp: *mut ctf_dict_t,
) -> ctf_id_t {
    let mut dst_type: ctf_id_t = -(1 as libc::c_long) as ctf_id_t;
    let mut dst_kind: uint32_t = 0 as libc::c_int as uint32_t;
    let mut tmp_fp: *mut ctf_dict_t = dst_fp;
    let mut tmp: ctf_id_t = 0;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut kind: uint32_t = 0;
    let mut forward_kind: uint32_t = 0;
    let mut flag: uint32_t = 0;
    let mut vlen: uint32_t = 0;
    let mut src_tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut dst_tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut src: ctf_bundle_t = ctf_bundle_t {
        ctb_dict: 0 as *mut ctf_dict_t,
        ctb_type: 0,
        ctb_dtd: 0 as *mut ctf_dtdef_t,
    };
    let mut dst: ctf_bundle_t = ctf_bundle_t {
        ctb_dict: 0 as *mut ctf_dict_t,
        ctb_type: 0,
        ctb_dtd: 0 as *mut ctf_dtdef_t,
    };
    let mut src_en: ctf_encoding_t = ctf_encoding_t {
        cte_format: 0,
        cte_offset: 0,
        cte_bits: 0,
    };
    let mut dst_en: ctf_encoding_t = ctf_encoding_t {
        cte_format: 0,
        cte_offset: 0,
        cte_bits: 0,
    };
    let mut src_ar: ctf_arinfo_t = ctf_arinfo_t {
        ctr_contents: 0,
        ctr_index: 0,
        ctr_nelems: 0,
    };
    let mut dst_ar: ctf_arinfo_t = ctf_arinfo_t {
        ctr_contents: 0,
        ctr_index: 0,
        ctr_nelems: 0,
    };
    let mut ctc: ctf_funcinfo_t = ctf_funcinfo_t {
        ctc_return: 0,
        ctc_argc: 0,
        ctc_flags: 0,
    };
    let mut orig_src_type: ctf_id_t = src_type;
    if (*dst_fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {
        return ctf_set_errno(dst_fp, ECTF_RDONLY as libc::c_int);
    }
    src_tp = ctf_lookup_by_id(&mut src_fp, src_type);
    if src_tp.is_null() {
        return ctf_set_errno(dst_fp, ctf_errno(src_fp));
    }
    if ctf_type_resolve(src_fp, src_type) == -(1 as libc::c_long) as ctf_id_t
        && ctf_errno(src_fp) == ECTF_NONREPRESENTABLE as libc::c_int
    {
        return ctf_set_errno(dst_fp, ECTF_NONREPRESENTABLE as libc::c_int);
    }
    name = ctf_strptr(src_fp, (*src_tp).ctt_name);
    kind = ((*(*src_fp).ctf_dictops).ctfo_get_kind)
        .expect("non-null function pointer")((*src_tp).ctt_info);
    flag = ((*(*src_fp).ctf_dictops).ctfo_get_root)
        .expect("non-null function pointer")((*src_tp).ctt_info);
    vlen = ((*(*src_fp).ctf_dictops).ctfo_get_vlen)
        .expect("non-null function pointer")((*src_tp).ctt_info);
    tmp = ctf_type_mapping(src_fp, src_type, &mut tmp_fp);
    if tmp != 0 as libc::c_int as libc::c_ulong {
        if !(ctf_dynhash_lookup(
            (*proc_tracking_fp).ctf_add_processing,
            src_type as *mut libc::c_void,
        ))
            .is_null()
        {
            return tmp;
        }
        if ctf_type_kind_unsliced(tmp_fp, tmp) == kind as libc::c_int {
            if kind == 6 as libc::c_int as libc::c_uint
                || kind == 7 as libc::c_int as libc::c_uint
                || kind == 8 as libc::c_int as libc::c_uint
            {
                dst_tp = ctf_lookup_by_id(&mut tmp_fp, dst_type);
                if !dst_tp.is_null() {
                    if vlen
                        == ((*(*tmp_fp).ctf_dictops).ctfo_get_vlen)
                            .expect("non-null function pointer")((*dst_tp).ctt_info)
                    {
                        return tmp;
                    }
                }
    ...
    if kind == 9 as libc::c_int as libc::c_uint {
        forward_kind = (*src_tp).c2rust_unnamed.ctt_type;
    }
    if flag & 1 as libc::c_int as libc::c_uint != 0
        && *name.offset(0 as libc::c_int as isize) as libc::c_int != '\0' as i32
        && {
            tmp = ctf_lookup_by_rawname(dst_fp, forward_kind as libc::c_int, name);
            tmp != 0 as libc::c_int as libc::c_ulong
        }
    {
        dst_type = tmp;
        dst_kind = ctf_type_kind_unsliced(dst_fp, dst_type) as uint32_t;
    }
    if dst_type != -(1 as libc::c_long) as ctf_id_t && dst_kind != kind {
        if kind == 9 as libc::c_int as libc::c_uint
            && (dst_kind == 8 as libc::c_int as libc::c_uint
                || dst_kind == 6 as libc::c_int as libc::c_uint
                || dst_kind == 7 as libc::c_int as libc::c_uint)
        {
            ctf_add_type_mapping(src_fp, src_type, dst_fp, dst_type);
            return dst_type;
        }
        if dst_kind != 9 as libc::c_int as libc::c_uint
            || kind != 8 as libc::c_int as libc::c_uint
                && kind != 6 as libc::c_int as libc::c_uint
                && kind != 7 as libc::c_int as libc::c_uint
        {
            ctf_err_warn(
                dst_fp,
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"ctf_add_type: conflict for type %s: kinds differ, new: %i; old (ID %lx): %i\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                name,
            ...
            return ctf_set_errno(dst_fp, ECTF_CONFLICT as libc::c_int);
        }
    }
    if kind == 1 as libc::c_int as libc::c_uint
        || kind == 2 as libc::c_int as libc::c_uint
        || kind == 14 as libc::c_int as libc::c_uint
    {
        if ctf_type_encoding(src_fp, src_type, &mut src_en) != 0 as libc::c_int {
            return ctf_set_errno(dst_fp, ctf_errno(src_fp));
        }
        if dst_type != -(1 as libc::c_long) as ctf_id_t {
            let mut fp: *mut ctf_dict_t = dst_fp;
            dst_tp = ctf_lookup_by_id(&mut fp, dst_type);
            if dst_tp.is_null() {
                return -(1 as libc::c_long) as ctf_id_t;
            }
            if ctf_type_encoding(dst_fp, dst_type, &mut dst_en) != 0 as libc::c_int {
                return -(1 as libc::c_long) as ctf_id_t;
            }
            if ((*(*fp).ctf_dictops).ctfo_get_root)
                .expect("non-null function pointer")((*dst_tp).ctt_info)
                & 1 as libc::c_int as libc::c_uint != 0
            {
                if memcmp(
                    &mut src_en as *mut ctf_encoding_t as *const libc::c_void,
                    &mut dst_en as *mut ctf_encoding_t as *const libc::c_void,
                    ::core::mem::size_of::<ctf_encoding_t>() as libc::c_ulong,
                ) == 0 as libc::c_int
                {
                    if kind != 14 as libc::c_int as libc::c_uint {
                        ctf_add_type_mapping(src_fp, src_type, dst_fp, dst_type);
                        return dst_type;
                    }
                } else {
    ...
    src.ctb_dtd = 0 as *mut ctf_dtdef_t;
    dst.ctb_dict = dst_fp;
    dst.ctb_type = dst_type;
    dst.ctb_dtd = 0 as *mut ctf_dtdef_t;
    if ctf_dynhash_insert(
        (*proc_tracking_fp).ctf_add_processing,
        src_type as *mut libc::c_void,
    ...
    {
        return ctf_set_errno(dst_fp, 12 as libc::c_int);
    }
    match kind {
        1 => {
            dst_type = ctf_add_integer(dst_fp, flag, name, &mut src_en);
        }
        2 => {
            dst_type = ctf_add_float(dst_fp, flag, name, &mut src_en);
        }
        14 => {
            src_type = ctf_type_reference(src_fp, src_type);
            src_type = ctf_add_type_internal(dst_fp, src_fp, src_type, proc_tracking_fp);
            if src_type == -(1 as libc::c_long) as ctf_id_t {
                return -(1 as libc::c_long) as ctf_id_t;
            }
            dst_type = ctf_add_slice(dst_fp, flag, src_type, &mut src_en);
        }
        3 | 11 | 12 | 13 => {
            src_type = ctf_type_reference(src_fp, src_type);
            src_type = ctf_add_type_internal(dst_fp, src_fp, src_type, proc_tracking_fp);
        ...
        4 => {
            if ctf_array_info(src_fp, src_type, &mut src_ar) != 0 as libc::c_int {
                return ctf_set_errno(dst_fp, ctf_errno(src_fp));
            }
            src_ar
                .ctr_contents = ctf_add_type_internal(
                dst_fp,
                src_fp,
                src_ar.ctr_contents,
                proc_tracking_fp,
            ...
            src_ar
                .ctr_index = ctf_add_type_internal(
                dst_fp,
                src_fp,
                src_ar.ctr_index,
                proc_tracking_fp,
            ...
            if src_ar.ctr_contents == -(1 as libc::c_long) as ctf_id_t
                || src_ar.ctr_index == -(1 as libc::c_long) as ctf_id_t
            {
                return -(1 as libc::c_long) as ctf_id_t;
            }
            if dst_type != -(1 as libc::c_long) as ctf_id_t {
                if ctf_array_info(dst_fp, dst_type, &mut dst_ar) != 0 as libc::c_int {
                    return -(1 as libc::c_long) as ctf_id_t;
                }
                if memcmp(
                    &mut src_ar as *mut ctf_arinfo_t as *const libc::c_void,
                    &mut dst_ar as *mut ctf_arinfo_t as *const libc::c_void,
                    ::core::mem::size_of::<ctf_arinfo_t>() as libc::c_ulong,
                ) != 0
                {
                    ctf_err_warn(
                        dst_fp,
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"conflict for type %s against ID %lx: array info differs, old %lx/%lx/%x; new: %lx/%lx/%x\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        name,
                ...
                dst_type = ctf_add_array(dst_fp, flag, &mut src_ar);
            }
        }
        5 => {
            ctc
                .ctc_return = ctf_add_type_internal(
                dst_fp,
                src_fp,
                (*src_tp).c2rust_unnamed.ctt_type as ctf_id_t,
                proc_tracking_fp,
            );
            ctc.ctc_argc = 0 as libc::c_int as uint32_t;
            ctc.ctc_flags = 0 as libc::c_int as uint32_t;
            if ctc.ctc_return == -(1 as libc::c_long) as ctf_id_t {
                return -(1 as libc::c_long) as ctf_id_t;
            }
            dst_type = ctf_add_function(dst_fp, flag, &mut ctc, 0 as *const ctf_id_t);
        }
        6 | 7 => {
            let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
            let mut offset: ssize_t = 0;
            let mut membname: *const libc::c_char = 0 as *const libc::c_char;
            let mut src_membtype: ctf_id_t = 0;
            if dst_type != -(1 as libc::c_long) as ctf_id_t
                && kind != 9 as libc::c_int as libc::c_uint
                && dst_kind != 9 as libc::c_int as libc::c_uint
            {
                if ctf_type_size(src_fp, src_type) != ctf_type_size(dst_fp, dst_type) {
                    ctf_err_warn(
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"conflict for type %s against ID %lx: union size differs, old %li, new %li\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        name,
                ...
                if ctf_member_iter(
                    ...
                    &mut dst as *mut ctf_bundle_t as *mut libc::c_void,
                ) != 0
                {
                    ctf_err_warn(
                        dst_fp,
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"conflict for type %s against ID %lx: members differ, see above\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        name,
                ...
                dst_type = ctf_add_struct_sized(
                    dst_fp,
                    flag,
                    name,
                    ctf_type_size(src_fp, src_type) as size_t,
                );
                if dst_type == -(1 as libc::c_long) as ctf_id_t {
                    return -(1 as libc::c_long) as ctf_id_t;
                }
                ...
                loop {
                    ...
                    let mut dst_0: *mut ctf_dict_t = dst_fp;
                    let mut dst_membtype: ctf_id_t = ctf_type_mapping(
                        src_fp,
                        src_membtype,
                        &mut dst_0,
                    );
                    if dst_membtype == 0 as libc::c_int as libc::c_ulong {
                        dst_membtype = ctf_add_type_internal(
                            dst_fp,
                            src_fp,
                            src_membtype,
                            proc_tracking_fp,
                        );
                        if dst_membtype == -(1 as libc::c_long) as ctf_id_t {
                            if ctf_errno(dst_fp) != ECTF_NONREPRESENTABLE as libc::c_int
                            {
                                ctf_next_destroy(i);
                                break;
                            }
                ...
                if ctf_errno(src_fp) != ECTF_NEXT_END as libc::c_int {
                    return -(1 as libc::c_long) as ctf_id_t;
                }
            }
        }
                ...
                && dst_kind != 9 as libc::c_int as libc::c_uint
            {
                if ctf_enum_iter(
                    ...
                    || ctf_enum_iter(
                        ...
                        &mut src as *mut ctf_bundle_t as *mut libc::c_void,
                    ) != 0
                {
                    ctf_err_warn(
                        dst_fp,
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"conflict for enum %s against ID %lx: members differ, see above\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        name,
                ...
                dst.ctb_type = dst_type;
                if dst.ctb_type == -(1 as libc::c_long) as ctf_id_t
                    || ctf_enum_iter(
                        src_fp,
                        src_type,
                        Some(
        ...
        _ => return ctf_set_errno(dst_fp, ECTF_CORRUPT as libc::c_int),
    }
    if dst_type != -(1 as libc::c_long) as ctf_id_t {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_add_type(
    mut dst_fp: *mut ctf_dict_t,
    mut src_fp: *mut ctf_dict_t,
    mut src_type: ctf_id_t,
) -> ctf_id_t {
    let mut id: ctf_id_t = 0;
    if ((*src_fp).ctf_add_processing).is_null() {
        (*src_fp)
            .ctf_add_processing = ctf_dynhash_create(
            Some(
                ctf_hash_integer
                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
            ),
