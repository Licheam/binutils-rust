...
extern "C" {
    ...
    fn ctf_arc_close(_: *mut ctf_archive_t);
    fn ctf_symtab_skippable(sym: *mut ctf_link_sym_t) -> libc::c_int;
    fn ctf_list_delete(_: *mut ctf_list_t, _: *mut libc::c_void);
    fn ctf_dynset_destroy(_: *mut ctf_dynset_t);
    fn ctf_dynhash_destroy(_: *mut ctf_dynhash_t);
    fn ctf_dvd_delete(_: *mut ctf_dict_t, _: *mut ctf_dvdef_t);
    fn ctf_hash_destroy(_: *mut ctf_hash_t);
    fn ctf_dtd_delete(_: *mut ctf_dict_t, _: *mut ctf_dtdef_t);
    fn strlen(_: *const libc::c_char) -> libc::c_ulong;
    fn ctf_hash_size(_: *const ctf_hash_t) -> uint32_t;
    fn dcgettext(
        __domainname: *const libc::c_char,
        __msgid: *const libc::c_char,
        __category: libc::c_int,
    ) -> *mut libc::c_char;
    fn ctf_hash_insert_type(
        _: *mut ctf_hash_t,
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: uint32_t,
    ) -> libc::c_int;
    fn ctf_name_table(_: *mut ctf_dict_t, _: libc::c_int) -> *mut ctf_names_t;
    fn ctf_hash_lookup_type(
        _: *mut ctf_hash_t,
        _: *mut ctf_dict_t,
        _: *const libc::c_char,
    ) -> ctf_id_t;
    fn ctf_hash_define_type(
        _: *mut ctf_hash_t,
        _: *mut ctf_dict_t,
        _: uint32_t,
        _: uint32_t,
    ...
    fn ctf_strptr(_: *mut ctf_dict_t, _: uint32_t) -> *const libc::c_char;
    fn ctf_dedup_fini(_: *mut ctf_dict_t, _: *mut *mut ctf_dict_t, _: uint32_t);
    fn ctf_str_free_atoms(_: *mut ctf_dict_t);
    fn ctf_str_create_atoms(_: *mut ctf_dict_t) -> libc::c_int;
    fn ctf_set_errno(_: *mut ctf_dict_t, _: libc::c_int) -> libc::c_ulong;
    fn ctf_set_open_errno(_: *mut libc::c_int, _: libc::c_int) -> *mut libc::c_void;
    fn libctf_init_debug();
    fn ctf_dprintf(_: *const libc::c_char, _: ...);
    fn ctf_munmap(_: *mut libc::c_void, _: size_t);
    fn ctf_err_warn(
        _: *mut ctf_dict_t,
    ...
    fn ctf_elf32_to_link_sym(
        fp: *mut ctf_dict_t,
        dst: *mut ctf_link_sym_t,
        src: *const Elf32_Sym,
        symidx: uint32_t,
    ) -> *mut ctf_link_sym_t;
    fn ctf_elf64_to_link_sym(
        fp: *mut ctf_dict_t,
        dst: *mut ctf_link_sym_t,
        src: *const Elf64_Sym,
        symidx: uint32_t,
    ) -> *mut ctf_link_sym_t;
    fn ctf_err_warn_to_open(_: *mut ctf_dict_t);
    fn __assert_fail(
...
pub type ctf_header_v2_t = ctf_header_v2;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct ctf_lblent {
    pub ctl_label: uint32_t,
    pub ctl_type: uint32_t,
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_stype_v1 {
    pub ctt_name: uint32_t,
    pub ctt_info: libc::c_ushort,
    pub c2rust_unnamed: C2RustUnnamed,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union C2RustUnnamed {
    pub ctt_size: libc::c_ushort,
    pub ctt_type: libc::c_ushort,
}
pub type ctf_stype_v1_t = ctf_stype_v1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_type_v1 {
    pub ctt_name: uint32_t,
    pub ctt_info: libc::c_ushort,
...
pub type ctf_type_v1_t = ctf_type_v1;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_array_v1 {
    pub cta_contents: libc::c_ushort,
    pub cta_index: libc::c_ushort,
    pub cta_nelems: uint32_t,
}
pub type ctf_array_v1_t = ctf_array_v1;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_member_v1 {
    pub ctm_name: uint32_t,
    pub ctm_type: libc::c_ushort,
    pub ctm_offset: libc::c_ushort,
}
pub type ctf_member_v1_t = ctf_member_v1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_lmember_v1 {
    pub ctlm_name: uint32_t,
    pub ctlm_type: libc::c_ushort,
    pub ctlm_pad: libc::c_ushort,
    pub ctlm_offsethi: uint32_t,
    pub ctlm_offsetlo: uint32_t,
}
pub type ctf_lmember_v1_t = ctf_lmember_v1;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct bfd {
    ...
    pub link: C2RustUnnamed_4,
    pub tdata: C2RustUnnamed_3,
...
pub struct bfd_section {
    ...
    pub map_head: C2RustUnnamed_6,
    pub map_tail: C2RustUnnamed_6,
...
pub const ECTF_NONAME: C2RustUnnamed_9 = 1058;
pub const ECTF_INCOMPLETE: C2RustUnnamed_9 = 1057;
pub const ECTF_NEEDSBFD: C2RustUnnamed_9 = 1056;
pub const ECTF_FLAGS: C2RustUnnamed_9 = 1055;
pub const ECTF_NEXT_WRONGFP: C2RustUnnamed_9 = 1054;
pub const ECTF_NEXT_WRONGFUN: C2RustUnnamed_9 = 1053;
pub const ECTF_NEXT_END: C2RustUnnamed_9 = 1052;
pub const ECTF_NONREPRESENTABLE: C2RustUnnamed_9 = 1051;
pub const ECTF_INTERNAL: C2RustUnnamed_9 = 1050;
pub const ECTF_NOTYET: C2RustUnnamed_9 = 1049;
pub const ECTF_DUMPSECTCHANGED: C2RustUnnamed_9 = 1048;
pub const ECTF_DUMPSECTUNKNOWN: C2RustUnnamed_9 = 1047;
pub const ECTF_SLICEOVERFLOW: C2RustUnnamed_9 = 1046;
pub const ECTF_ARNNAME: C2RustUnnamed_9 = 1045;
pub const ECTF_ARCREATE: C2RustUnnamed_9 = 1044;
pub const ECTF_COMPRESS: C2RustUnnamed_9 = 1043;
pub const ECTF_OVERROLLBACK: C2RustUnnamed_9 = 1042;
pub const ECTF_CONFLICT: C2RustUnnamed_9 = 1041;
pub const ECTF_DUPLICATE: C2RustUnnamed_9 = 1040;
pub const ECTF_FULL: C2RustUnnamed_9 = 1039;
pub const ECTF_DTFULL: C2RustUnnamed_9 = 1038;
pub const ECTF_RDONLY: C2RustUnnamed_9 = 1037;
pub const ECTF_NOMEMBNAM: C2RustUnnamed_9 = 1036;
pub const ECTF_NOENUMNAM: C2RustUnnamed_9 = 1035;
pub const ECTF_NOTSUP: C2RustUnnamed_9 = 1034;
pub const ECTF_NOLABELDATA: C2RustUnnamed_9 = 1033;
pub const ECTF_NOLABEL: C2RustUnnamed_9 = 1032;
pub const ECTF_NOTYPEDAT: C2RustUnnamed_9 = 1031;
pub const ECTF_NOTDATA: C2RustUnnamed_9 = 1030;
pub const ECTF_NOFUNCDAT: C2RustUnnamed_9 = 1029;
pub const ECTF_NOTFUNC: C2RustUnnamed_9 = 1028;
pub const ECTF_SYNTAX: C2RustUnnamed_9 = 1027;
pub const ECTF_NOTYPE: C2RustUnnamed_9 = 1026;
pub const ECTF_NAMELEN: C2RustUnnamed_9 = 1025;
pub const ECTF_NOTREF: C2RustUnnamed_9 = 1024;
pub const ECTF_NOTARRAY: C2RustUnnamed_9 = 1023;
pub const ECTF_NOTINTFP: C2RustUnnamed_9 = 1022;
pub const ECTF_NOTSUE: C2RustUnnamed_9 = 1021;
pub const ECTF_NOTENUM: C2RustUnnamed_9 = 1020;
pub const ECTF_NOTSOU: C2RustUnnamed_9 = 1019;
pub const ECTF_BADID: C2RustUnnamed_9 = 1018;
pub const ECTF_BADNAME: C2RustUnnamed_9 = 1017;
pub const ECTF_STRTAB: C2RustUnnamed_9 = 1016;
pub const ECTF_DECOMPRESS: C2RustUnnamed_9 = 1015;
pub const ECTF_ZALLOC: C2RustUnnamed_9 = 1014;
pub const ECTF_LINKADDEDLATE: C2RustUnnamed_9 = 1013;
pub const ECTF_DMODEL: C2RustUnnamed_9 = 1012;
pub const ECTF_NOPARENT: C2RustUnnamed_9 = 1011;
pub const ECTF_NOSYMTAB: C2RustUnnamed_9 = 1010;
pub const ECTF_NOCTFBUF: C2RustUnnamed_9 = 1009;
pub const ECTF_NOCTFDATA: C2RustUnnamed_9 = 1008;
pub const ECTF_CORRUPT: C2RustUnnamed_9 = 1007;
pub const ECTF_STRBAD: C2RustUnnamed_9 = 1006;
pub const ECTF_SYMBAD: C2RustUnnamed_9 = 1005;
pub const ECTF_SYMTAB: C2RustUnnamed_9 = 1004;
pub const ECTF_BFD_AMBIGUOUS: C2RustUnnamed_9 = 1003;
pub const ECTF_CTFVERS: C2RustUnnamed_9 = 1002;
pub const ECTF_BFDERR: C2RustUnnamed_9 = 1001;
pub const ECTF_FMT: C2RustUnnamed_9 = 1000;
...
pub type ctf_err_warning_t = ctf_err_warning;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_err_warning {
    pub cew_list: ctf_list_t,
    pub cew_is_warning: libc::c_int,
    pub cew_text: *mut libc::c_char,
}
pub type ctf_in_flight_dynsym_t = ctf_in_flight_dynsym;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_in_flight_dynsym {
    pub cid_list: ctf_list_t,
    pub cid_sym: ctf_link_sym_t,
}
...
#[inline]
unsafe extern "C" fn ctf_get_ctt_size(
    mut fp: *const ctf_dict_t,
    mut tp: *const ctf_type_t,
    mut sizep: *mut ssize_t,
    mut incrementp: *mut ssize_t,
) -> ssize_t {
    return ((*(*fp).ctf_dictops).ctfo_get_ctt_size)
        .expect("non-null function pointer")(fp, tp, sizep, incrementp);
}
static mut _libctf_models: [ctf_dmodel_t; 3] = [
    {
        let mut init = ctf_dmodel {
            ctd_name: b"ILP32\0" as *const u8 as *const libc::c_char,
            ctd_code: 1 as libc::c_int,
            ctd_pointer: 4 as libc::c_int as size_t,
            ctd_char: 1 as libc::c_int as size_t,
            ctd_short: 2 as libc::c_int as size_t,
            ctd_int: 4 as libc::c_int as size_t,
            ctd_long: 4 as libc::c_int as size_t,
        };
        init
    },
    {
        let mut init = ctf_dmodel {
            ctd_name: b"LP64\0" as *const u8 as *const libc::c_char,
            ctd_code: 2 as libc::c_int,
            ctd_pointer: 8 as libc::c_int as size_t,
            ctd_char: 1 as libc::c_int as size_t,
            ctd_short: 2 as libc::c_int as size_t,
            ctd_int: 4 as libc::c_int as size_t,
            ctd_long: 8 as libc::c_int as size_t,
        };
        init
    },
    {
        let mut init = ctf_dmodel {
            ctd_name: 0 as *const libc::c_char,
            ctd_code: 0 as libc::c_int,
            ctd_pointer: 0 as libc::c_int as size_t,
            ctd_char: 0 as libc::c_int as size_t,
            ctd_short: 0 as libc::c_int as size_t,
            ctd_int: 0 as libc::c_int as size_t,
            ctd_long: 0 as libc::c_int as size_t,
        };
        init
    },
];
#[no_mangle]
pub static mut _CTF_SECTION: [libc::c_char; 5] = unsafe {
    *::core::mem::transmute::<&[u8; 5], &[libc::c_char; 5]>(b".ctf\0")
};
#[no_mangle]
pub static mut _CTF_NULLSTR: [libc::c_char; 1] = unsafe {
    *::core::mem::transmute::<&[u8; 1], &[libc::c_char; 1]>(b"\0")
};
unsafe extern "C" fn get_kind_v1(mut info: uint32_t) -> uint32_t {
    return (info & 0xf800 as libc::c_int as libc::c_uint) >> 11 as libc::c_int;
}
unsafe extern "C" fn get_root_v1(mut info: uint32_t) -> uint32_t {
    return (info & 0x400 as libc::c_int as libc::c_uint) >> 10 as libc::c_int;
}
unsafe extern "C" fn get_vlen_v1(mut info: uint32_t) -> uint32_t {
    return info & 0x3ff as libc::c_int as libc::c_uint;
}
unsafe extern "C" fn get_kind_v2(mut info: uint32_t) -> uint32_t {
    return (info & 0xfc000000 as libc::c_uint) >> 26 as libc::c_int;
}
unsafe extern "C" fn get_root_v2(mut info: uint32_t) -> uint32_t {
    return (info & 0x2000000 as libc::c_int as libc::c_uint) >> 25 as libc::c_int;
}
unsafe extern "C" fn get_vlen_v2(mut info: uint32_t) -> uint32_t {
    return info & 0xffffff as libc::c_int as libc::c_uint;
}
#[inline]
unsafe extern "C" fn get_ctt_size_common(
    mut fp: *const ctf_dict_t,
    mut tp: *const ctf_type_t,
    mut sizep: *mut ssize_t,
    mut incrementp: *mut ssize_t,
    mut lsize: size_t,
    mut csize: size_t,
    mut ctf_type_size: size_t,
    mut ctf_stype_size: size_t,
    mut ctf_lsize_sent: size_t,
) -> ssize_t {
    let mut size: ssize_t = 0;
    let mut increment: ssize_t = 0;
    if csize == ctf_lsize_sent {
        size = lsize as ssize_t;
        increment = ctf_type_size as ssize_t;
    } else {
        size = csize as ssize_t;
        increment = ctf_stype_size as ssize_t;
    }
    if !sizep.is_null() {
        *sizep = size;
    }
    if !incrementp.is_null() {
        *incrementp = increment;
    }
    return size;
}
unsafe extern "C" fn get_ctt_size_v1(
    mut fp: *const ctf_dict_t,
    mut tp: *const ctf_type_t,
    mut sizep: *mut ssize_t,
    mut incrementp: *mut ssize_t,
) -> ssize_t {
    let mut t1p: *mut ctf_type_v1_t = tp as *mut ctf_type_v1_t;
    return get_ctt_size_common(
        fp,
        tp,
        sizep,
        incrementp,
        ((*t1p).ctt_lsizehi as uint64_t) << 32 as libc::c_int
            | (*t1p).ctt_lsizelo as libc::c_ulong,
        (*t1p).c2rust_unnamed.ctt_size as size_t,
        ::core::mem::size_of::<ctf_type_v1_t>() as libc::c_ulong,
        ::core::mem::size_of::<ctf_stype_v1_t>() as libc::c_ulong,
        0xffff as libc::c_int as size_t,
    );
}
unsafe extern "C" fn get_ctt_size_v2_unconverted(
    mut fp: *const ctf_dict_t,
    mut tp: *const ctf_type_t,
    mut sizep: *mut ssize_t,
    mut incrementp: *mut ssize_t,
    ...
    return get_ctt_size_common(
        ...
        ((*t1p).ctt_lsizehi as uint64_t) << 32 as libc::c_int
            | (*t1p).ctt_lsizelo as libc::c_ulong,
        (*t1p).c2rust_unnamed.ctt_size as size_t,
        ::core::mem::size_of::<ctf_type_t>() as libc::c_ulong,
        ::core::mem::size_of::<ctf_stype_t>() as libc::c_ulong,
        0xffffffff as libc::c_uint as size_t,
    );
}
unsafe extern "C" fn get_ctt_size_v2(
    mut fp: *const ctf_dict_t,
    mut tp: *const ctf_type_t,
    mut sizep: *mut ssize_t,
    mut incrementp: *mut ssize_t,
    ...
    return get_ctt_size_common(
        ...
        sizep,
        incrementp,
        ((*tp).ctt_lsizehi as uint64_t) << 32 as libc::c_int
            | (*tp).ctt_lsizelo as libc::c_ulong,
        (*tp).c2rust_unnamed.ctt_size as size_t,
        ::core::mem::size_of::<ctf_type_t>() as libc::c_ulong,
        ::core::mem::size_of::<ctf_stype_t>() as libc::c_ulong,
        0xffffffff as libc::c_uint as size_t,
    );
}
unsafe extern "C" fn get_vbytes_common(
    ...
    match kind as libc::c_int {
        1 | 2 => return ::core::mem::size_of::<uint32_t>() as libc::c_ulong as ssize_t,
        14 => return ::core::mem::size_of::<ctf_slice_t>() as libc::c_ulong as ssize_t,
        8 => {
            return (::core::mem::size_of::<ctf_enum_t>() as libc::c_ulong)
                .wrapping_mul(vlen) as ssize_t;
        }
        9 | 0 | 3 | 10 | 11 | 12 | 13 => return 0 as libc::c_int as ssize_t,
        _ => {
            ctf_set_errno(fp, ECTF_CORRUPT as libc::c_int);
            ctf_err_warn(
                fp,
                0 as libc::c_int,
                0 as libc::c_int,
                dcgettext(
                    ...
                    b"detected invalid CTF kind: %x\0" as *const u8
...
unsafe extern "C" fn get_vbytes_v1(
    mut fp: *mut ctf_dict_t,
    mut kind: libc::c_ushort,
    mut size: ssize_t,
    mut vlen: size_t,
    ...
    match kind as libc::c_int {
        4 => return ::core::mem::size_of::<ctf_array_v1_t>() as libc::c_ulong as ssize_t,
        5 => {
            return (::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong)
                .wrapping_mul(
                    vlen.wrapping_add(vlen & 1 as libc::c_int as libc::c_ulong),
                ) as ssize_t;
        }
        6 | 7 => {
            if size < 8192 as libc::c_int as libc::c_long {
                return (::core::mem::size_of::<ctf_member_v1_t>() as libc::c_ulong)
                    .wrapping_mul(vlen) as ssize_t
            } else {
                return (::core::mem::size_of::<ctf_lmember_v1_t>() as libc::c_ulong)
                    .wrapping_mul(vlen) as ssize_t
            }
        }
        _ => {}
...
unsafe extern "C" fn get_vbytes_v2(
    mut fp: *mut ctf_dict_t,
    mut kind: libc::c_ushort,
    mut size: ssize_t,
    mut vlen: size_t,
    ...
    match kind as libc::c_int {
        4 => return ::core::mem::size_of::<ctf_array_t>() as libc::c_ulong as ssize_t,
        5 => {
        ...
        6 | 7 => {
            if size < 536870912 as libc::c_int as libc::c_long {
                return (::core::mem::size_of::<ctf_member_t>() as libc::c_ulong)
                    .wrapping_mul(vlen) as ssize_t
            } else {
                return (::core::mem::size_of::<ctf_lmember_t>() as libc::c_ulong)
                    .wrapping_mul(vlen) as ssize_t
            }
        }
        _ => {}
...
static mut ctf_dictops: [ctf_dictops_t; 5] = unsafe {
    [
        {
            let mut init = ctf_dictops {
                ctfo_get_kind: None,
                ctfo_get_root: None,
                ctfo_get_vlen: None,
                ctfo_get_ctt_size: None,
                ctfo_get_vbytes: None,
            };
            init
        },
        {
            let mut init = ctf_dictops {
                ctfo_get_kind: Some(
                    get_kind_v1 as unsafe extern "C" fn(uint32_t) -> uint32_t,
                ),
                ctfo_get_root: Some(
                    get_root_v1 as unsafe extern "C" fn(uint32_t) -> uint32_t,
                ),
                ctfo_get_vlen: Some(
                    get_vlen_v1 as unsafe extern "C" fn(uint32_t) -> uint32_t,
                ),
                ctfo_get_ctt_size: Some(
                    get_ctt_size_v1
        ...
        },
        {
            let mut init = ctf_dictops {
                ctfo_get_kind: Some(
                    get_kind_v2 as unsafe extern "C" fn(uint32_t) -> uint32_t,
                ),
                ctfo_get_root: Some(
                    get_root_v2 as unsafe extern "C" fn(uint32_t) -> uint32_t,
                ),
                ctfo_get_vlen: Some(
                    get_vlen_v2 as unsafe extern "C" fn(uint32_t) -> uint32_t,
                ),
                ctfo_get_ctt_size: Some(
                    get_ctt_size_v2
                        as unsafe extern "C" fn(
...
unsafe extern "C" fn init_symtab(
    mut fp: *mut ctf_dict_t,
    mut hp: *const ctf_header_t,
    mut sp: *const ctf_sect_t,
) -> libc::c_int {
    let mut symp: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut skip_func_info: libc::c_int = 0 as libc::c_int;
    let mut i: libc::c_int = 0;
    let mut xp: *mut uint32_t = (*fp).ctf_sxlate;
    let mut xend: *mut uint32_t = xp.offset((*fp).ctf_nsyms as isize);
    let mut objtoff: uint32_t = (*hp).cth_objtoff;
    let mut funcoff: uint32_t = (*hp).cth_funcoff;
    if (*hp).cth_preamble.ctp_flags as libc::c_int & 0x2 as libc::c_int == 0 {
        skip_func_info = 1 as libc::c_int;
    }
    if (*hp).cth_objtidxoff < (*hp).cth_funcidxoff {
        (*fp)
            .ctf_objtidx_names = ((*fp).ctf_buf).offset((*hp).cth_objtidxoff as isize)
            as *mut uint32_t;
    }
    if (*hp).cth_funcidxoff < (*hp).cth_varoff && skip_func_info == 0 {
        (*fp)
            .ctf_funcidx_names = ((*fp).ctf_buf).offset((*hp).cth_funcidxoff as isize)
            as *mut uint32_t;
    }
    if !((*fp).ctf_objtidx_names).is_null() && !((*fp).ctf_funcidx_names).is_null()
        || sp.is_null() || ((*sp).cts_data).is_null()
    {
        return 0 as libc::c_int;
    }
    i = 0 as libc::c_int;
    symp = (*sp).cts_data as *const libc::c_uchar;
    while xp < xend {
        let mut sym: ctf_link_sym_t = ctf_link_sym_t {
            st_name: 0 as *const libc::c_char,
            st_nameidx: 0,
            st_nameidx_set: 0,
            st_symidx: 0,
            st_shndx: 0,
        ...
        match (*sp).cts_entsize {
            24 => {
                let mut symp64: *const Elf64_Sym = symp as uintptr_t as *mut Elf64_Sym;
                ctf_elf64_to_link_sym(fp, &mut sym, symp64, i as uint32_t);
            }
            16 => {
                let mut symp32: *const Elf32_Sym = symp as uintptr_t as *mut Elf32_Sym;
                ctf_elf32_to_link_sym(fp, &mut sym, symp32, i as uint32_t);
            }
            _ => return ECTF_SYMTAB as libc::c_int,
        }
        if ctf_symtab_skippable(&mut sym) != 0 {
            *xp = (1 as libc::c_uint).wrapping_neg();
        } else {
            match sym.st_type {
                1 => {
                    if !((*fp).ctf_objtidx_names).is_null()
                        || objtoff >= (*hp).cth_funcoff
                    {
                        *xp = (1 as libc::c_uint).wrapping_neg();
                    } else {
                        *xp = objtoff;
                        objtoff = (objtoff as libc::c_ulong)
                            .wrapping_add(
                ...
                2 => {
                    if !((*fp).ctf_funcidx_names).is_null()
                        || funcoff >= (*hp).cth_objtidxoff || skip_func_info != 0
                    {
                        *xp = (1 as libc::c_uint).wrapping_neg();
                    } else {
                        *xp = funcoff;
                        funcoff = (funcoff as libc::c_ulong)
                            .wrapping_add(
                                ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
                            ) as uint32_t as uint32_t;
                    }
        ...
        xp = xp.offset(1);
        xp;
        symp = symp.offset((*sp).cts_entsize as isize);
        i += 1;
        i;
    }
    ctf_dprintf(
        b"loaded %lu symtab entries\n\0" as *const u8 as *const libc::c_char,
        (*fp).ctf_nsyms,
    );
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_set_base(
    mut fp: *mut ctf_dict_t,
    mut hp: *const ctf_header_t,
    ...
    (*fp)
        .ctf_buf = base
        .offset(((*fp).ctf_buf).offset_from((*fp).ctf_base) as libc::c_long as isize);
    (*fp).ctf_base = base;
    (*fp)
        .ctf_vars = ((*fp).ctf_buf as *const libc::c_char)
        .offset((*hp).cth_varoff as isize) as *mut ctf_varent_t;
    (*fp)
        .ctf_nvars = (((*hp).cth_typeoff).wrapping_sub((*hp).cth_varoff)
        as libc::c_ulong)
        .wrapping_div(::core::mem::size_of::<ctf_varent_t>() as libc::c_ulong);
    (*fp)
        .ctf_str[0 as libc::c_int as usize]
        .cts_strs = ((*fp).ctf_buf as *const libc::c_char)
        .offset((*hp).cth_stroff as isize);
    (*fp).ctf_str[0 as libc::c_int as usize].cts_len = (*hp).cth_strlen as size_t;
    if (*hp).cth_parlabel != 0 as libc::c_int as libc::c_uint {
        (*fp).ctf_parlabel = ctf_strptr(fp, (*hp).cth_parlabel);
    }
    if (*hp).cth_parname != 0 as libc::c_int as libc::c_uint {
        (*fp).ctf_parname = ctf_strptr(fp, (*hp).cth_parname);
    }
    if (*hp).cth_cuname != 0 as libc::c_int as libc::c_uint {
        (*fp).ctf_cuname = ctf_strptr(fp, (*hp).cth_cuname);
    }
    if !((*fp).ctf_cuname).is_null() {
        ctf_dprintf(
            b"ctf_set_base: CU name %s\n\0" as *const u8 as *const libc::c_char,
            (*fp).ctf_cuname,
        );
    }
    if !((*fp).ctf_parname).is_null() {
        ctf_dprintf(
            b"ctf_set_base: parent name %s (label %s)\n\0" as *const u8
                as *const libc::c_char,
            (*fp).ctf_parname,
            if !((*fp).ctf_parlabel).is_null() {
                (*fp).ctf_parlabel
            } else {
...
unsafe extern "C" fn ctf_set_version(
    mut fp: *mut ctf_dict_t,
    mut cth: *mut ctf_header_t,
    mut ctf_version: libc::c_int,
) {
    (*fp).ctf_version = ctf_version;
    (*cth).cth_preamble.ctp_version = ctf_version as libc::c_uchar;
    (*fp)
        .ctf_dictops = &*ctf_dictops.as_ptr().offset(ctf_version as isize)
        as *const ctf_dictops_t;
}
unsafe extern "C" fn upgrade_header(mut hp: *mut ctf_header_t) {
    let mut oldhp: *mut ctf_header_v2_t = hp as *mut ctf_header_v2_t;
    ...
    (*hp).cth_cuname = 0 as libc::c_int as uint32_t;
}
unsafe extern "C" fn upgrade_types_v1(
    mut fp: *mut ctf_dict_t,
    mut cth: *mut ctf_header_t,
) -> libc::c_int {
    let mut tbuf: *const ctf_type_v1_t = 0 as *const ctf_type_v1_t;
    let mut tend: *const ctf_type_v1_t = 0 as *const ctf_type_v1_t;
    let mut ctf_base: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut old_ctf_base: *mut libc::c_uchar = (*fp).ctf_dynbase;
    let mut t2buf: *mut ctf_type_t = 0 as *mut ctf_type_t;
    let mut increase: ssize_t = 0 as libc::c_int as ssize_t;
    let mut size: ssize_t = 0;
    let mut increment: ssize_t = 0;
    let mut v2increment: ssize_t = 0;
    let mut vbytes: ssize_t = 0;
    let mut v2bytes: ssize_t = 0;
    let mut tp: *const ctf_type_v1_t = 0 as *const ctf_type_v1_t;
    let mut t2p: *mut ctf_type_t = 0 as *mut ctf_type_t;
    tbuf = ((*fp).ctf_buf).offset((*cth).cth_typeoff as isize) as *mut ctf_type_v1_t;
    tend = ((*fp).ctf_buf).offset((*cth).cth_stroff as isize) as *mut ctf_type_v1_t;
    tp = tbuf;
    while tp < tend {
        let mut kind: libc::c_ushort = (((*tp).ctt_info as libc::c_int
            & 0xf800 as libc::c_int) >> 11 as libc::c_int) as libc::c_ushort;
        let mut vlen: libc::c_ulong = ((*tp).ctt_info as libc::c_int
            & 0x3ff as libc::c_int) as libc::c_ulong;
        size = get_ctt_size_v1(
            fp,
            tp as *const ctf_type_t,
            0 as *mut ssize_t,
            &mut increment,
        );
        vbytes = get_vbytes_v1(fp, kind, size, vlen);
        get_ctt_size_v2_unconverted(
            fp,
            tp as *const ctf_type_t,
            0 as *mut ssize_t,
            &mut v2increment,
        ...
        if vbytes < 0 as libc::c_int as libc::c_long
            || size < 0 as libc::c_int as libc::c_long
        {
            return ECTF_CORRUPT as libc::c_int;
        }
        increase += v2increment - increment;
        increase += v2bytes - vbytes;
        tp = (tp as uintptr_t)
            .wrapping_add(increment as libc::c_ulong)
            .wrapping_add(vbytes as libc::c_ulong) as *mut ctf_type_v1_t;
    }
    ctf_base = malloc(((*fp).ctf_size).wrapping_add(increase as libc::c_ulong))
        as *mut libc::c_uchar;
    if ctf_base.is_null() {
        return ECTF_ZALLOC as libc::c_int;
    }
    memcpy(
        ctf_base as *mut libc::c_void,
        (*fp).ctf_buf as *const libc::c_void,
        (*cth).cth_typeoff as libc::c_ulong,
    );
    memcpy(
        ctf_base.offset((*cth).cth_stroff as isize).offset(increase as isize)
            as *mut libc::c_void,
        ((*fp).ctf_buf).offset((*cth).cth_stroff as isize) as *const libc::c_void,
        (*cth).cth_strlen as libc::c_ulong,
    );
    memset(
        ctf_base.offset((*cth).cth_typeoff as isize) as *mut libc::c_void,
        0 as libc::c_int,
        (((*cth).cth_stroff).wrapping_sub((*cth).cth_typeoff) as libc::c_long + increase)
            as libc::c_ulong,
    );
    (*cth).cth_stroff = ((*cth).cth_stroff as libc::c_long + increase) as uint32_t;
    (*fp)
        .ctf_size = ((*fp).ctf_size as libc::c_ulong)
        .wrapping_add(increase as libc::c_ulong) as size_t as size_t;
    if (*cth).cth_stroff >= (*cth).cth_typeoff {} else {
        __assert_fail(
            b"cth->cth_stroff >= cth->cth_typeoff\0" as *const u8 as *const libc::c_char,
            b"ctf-open.c\0" as *const u8 as *const libc::c_char,
            492 as libc::c_int as libc::c_uint,
            (*::core::mem::transmute::<
                &[u8; 51],
                &[libc::c_char; 51],
            >(b"int upgrade_types_v1(ctf_dict_t *, ctf_header_t *)\0"))
                .as_ptr(),
        );
    }
    'c_13799: {
        if (*cth).cth_stroff >= (*cth).cth_typeoff {} else {
            __assert_fail(
                b"cth->cth_stroff >= cth->cth_typeoff\0" as *const u8
                    as *const libc::c_char,
                b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                492 as libc::c_int as libc::c_uint,
                (*::core::mem::transmute::<
    ...
    t2buf = ((*fp).ctf_buf).offset((*cth).cth_typeoff as isize) as *mut ctf_type_t;
    tp = tbuf;
    t2p = t2buf;
    while tp < tend {
        let mut kind_0: libc::c_ushort = (((*tp).ctt_info as libc::c_int
            & 0xf800 as libc::c_int) >> 11 as libc::c_int) as libc::c_ushort;
        let mut isroot: libc::c_int = ((*tp).ctt_info as libc::c_int
            & 0x400 as libc::c_int) >> 10 as libc::c_int;
        let mut vlen_0: libc::c_ulong = ((*tp).ctt_info as libc::c_int
            & 0x3ff as libc::c_int) as libc::c_ulong;
        let mut v2size: ssize_t = 0;
        let mut vdata: *mut libc::c_void = 0 as *mut libc::c_void;
        let mut v2data: *mut libc::c_void = 0 as *mut libc::c_void;
        size = get_ctt_size_v1(
            fp,
            tp as *const ctf_type_t,
            0 as *mut ssize_t,
        ...
        vbytes = get_vbytes_v1(fp, kind_0, size, vlen_0);
        (*t2p).ctt_name = (*tp).ctt_name;
        (*t2p)
            .ctt_info = (((kind_0 as libc::c_int) << 26 as libc::c_int
            | (if isroot != 0 { 1 as libc::c_int } else { 0 as libc::c_int })
                << 25 as libc::c_int) as libc::c_ulong
            | vlen_0 & 0xffffff as libc::c_int as libc::c_ulong) as uint32_t;
        match kind_0 as libc::c_int {
            5 | 9 | 10 | 3 | 11 | 12 | 13 => {
                (*t2p)
                    .c2rust_unnamed
                    .ctt_type = (*tp).c2rust_unnamed.ctt_type as uint32_t;
            }
            1 | 2 | 4 | 6 | 7 | 8 | 0 => {
                if size as size_t <= 0xfffffffe as libc::c_uint as libc::c_ulong {
                    (*t2p).c2rust_unnamed.ctt_size = size as uint32_t;
                } else {
                    (*t2p)
                        .ctt_lsizehi = (size as uint64_t >> 32 as libc::c_int)
                        as uint32_t;
                    (*t2p).ctt_lsizelo = size as uint32_t;
                }
            }
            _ => {}
        }
        v2size = get_ctt_size_v2(fp, t2p, 0 as *mut ssize_t, &mut v2increment);
        v2bytes = get_vbytes_v2(fp, kind_0, v2size, vlen_0);
        if size == v2size {} else {
            __assert_fail(
                b"size == v2size\0" as *const u8 as *const libc::c_char,
                b"ctf-open.c\0" as *const u8 as *const libc::c_char,
        ...
        vdata = (tp as uintptr_t).wrapping_add(increment as libc::c_ulong)
            as *mut libc::c_void;
        v2data = (t2p as uintptr_t).wrapping_add(v2increment as libc::c_ulong)
            as *mut libc::c_void;
        let mut current_block_73: u64;
        match kind_0 as libc::c_int {
            4 => {
                let mut ap: *const ctf_array_v1_t = vdata as *const ctf_array_v1_t;
                let mut a2p: *mut ctf_array_t = v2data as *mut ctf_array_t;
                (*a2p).cta_contents = (*ap).cta_contents as uint32_t;
                (*a2p).cta_index = (*ap).cta_index as uint32_t;
                (*a2p).cta_nelems = (*ap).cta_nelems;
                current_block_73 = 9437375157805982253;
            }
            6 | 7 => {
                let mut tmp: ctf_member_t = ctf_member_t {
                    ctm_name: 0,
                    ctm_offset: 0,
                    ctm_type: 0,
                };
                let mut m1: *const ctf_member_v1_t = vdata as *const ctf_member_v1_t;
                let mut lm1: *const ctf_lmember_v1_t = m1 as *const ctf_lmember_v1_t;
                let mut m2: *mut ctf_member_t = v2data as *mut ctf_member_t;
                let mut lm2: *mut ctf_lmember_t = m2 as *mut ctf_lmember_t;
                let mut i: libc::c_ulong = 0;
                i = vlen_0;
                while i != 0 as libc::c_int as libc::c_ulong {
                    let mut offset: size_t = 0;
                    if size < 8192 as libc::c_int as libc::c_long {
                        offset = (*m1).ctm_offset as size_t;
                        tmp.ctm_name = (*m1).ctm_name;
                        tmp.ctm_type = (*m1).ctm_type as uint32_t;
                    } else {
                        offset = ((*lm1).ctlm_offsethi as uint64_t) << 32 as libc::c_int
                            | (*lm1).ctlm_offsetlo as libc::c_ulong;
                        tmp.ctm_name = (*lm1).ctlm_name;
                        tmp.ctm_type = (*lm1).ctlm_type as uint32_t;
                    }
                    if size < 536870912 as libc::c_int as libc::c_long {
                        (*m2).ctm_name = tmp.ctm_name;
                        (*m2).ctm_type = tmp.ctm_type;
                        (*m2).ctm_offset = offset as uint32_t;
                    } else {
                        (*lm2).ctlm_name = tmp.ctm_name;
                        (*lm2).ctlm_type = tmp.ctm_type;
                        (*lm2).ctlm_offsethi = (offset >> 32 as libc::c_int) as uint32_t;
                        (*lm2).ctlm_offsetlo = offset as uint32_t;
                    }
                    i = i.wrapping_sub(1);
                    i;
                    m1 = m1.offset(1);
            ...
            5 => {
                ...
                let mut a1: *mut libc::c_ushort = vdata as *mut libc::c_ushort;
                let mut a2: *mut uint32_t = v2data as *mut uint32_t;
                i_0 = vlen_0;
                ...
                current_block_73 = 920940167358725791;
            }
            _ => {
                current_block_73 = 920940167358725791;
            }
        ...
        match current_block_73 {
            920940167358725791 => {
                if vbytes == v2bytes {} else {
                    __assert_fail(
                        b"vbytes == v2bytes\0" as *const u8 as *const libc::c_char,
                        b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                ...
                memcpy(v2data, vdata, vbytes as libc::c_ulong);
            }
            _ => {}
        }
        tp = (tp as uintptr_t)
            .wrapping_add(increment as libc::c_ulong)
            .wrapping_add(vbytes as libc::c_ulong) as *mut ctf_type_v1_t;
        t2p = (t2p as uintptr_t)
            .wrapping_add(v2increment as libc::c_ulong)
            .wrapping_add(v2bytes as libc::c_ulong) as *mut ctf_type_t;
    }
    if (t2p as size_t).wrapping_sub((*fp).ctf_buf as size_t)
        == (*cth).cth_stroff as libc::c_ulong
    {} else {
        __assert_fail(
            b"(size_t) t2p - (size_t) fp->ctf_buf == cth->cth_stroff\0" as *const u8
                as *const libc::c_char,
            b"ctf-open.c\0" as *const u8 as *const libc::c_char,
    ...
    ctf_set_version(fp, cth, 2 as libc::c_int);
    free(old_ctf_base as *mut libc::c_void);
    return 0 as libc::c_int;
}
unsafe extern "C" fn upgrade_types(
    mut fp: *mut ctf_dict_t,
    mut cth: *mut ctf_header_t,
) -> libc::c_int {
    let mut current_block_2: u64;
    match (*cth).cth_preamble.ctp_version as libc::c_int {
        1 => {
            upgrade_types_v1(fp, cth);
            current_block_2 = 8807741245303312811;
        }
        2 => {
            current_block_2 = 8807741245303312811;
        }
        3 | _ => {
            current_block_2 = 17778012151635330486;
        }
    }
    match current_block_2 {
        8807741245303312811 => {
            (*fp).ctf_parmax = 0x7fff as libc::c_int as uint32_t;
        }
        _ => {}
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn init_types(
    mut fp: *mut ctf_dict_t,
    mut cth: *mut ctf_header_t,
) -> libc::c_int {
    let mut tbuf: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut tend: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut pop: [libc::c_ulong; 64] = [
    ...
    let mut tp: *const ctf_type_t = 0 as *const ctf_type_t;
    let mut id: uint32_t = 0;
    let mut xp: *mut uint32_t = 0 as *mut uint32_t;
    let mut child: libc::c_int = ((*cth).cth_parname != 0 as libc::c_int as libc::c_uint)
        as libc::c_int;
    let mut nlstructs: libc::c_int = 0 as libc::c_int;
    let mut nlunions: libc::c_int = 0 as libc::c_int;
    let mut err: libc::c_int = 0;
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint == 0 {} else {
        __assert_fail(
            b"!(fp->ctf_flags & LCTF_RDWR)\0" as *const u8 as *const libc::c_char,
            b"ctf-open.c\0" as *const u8 as *const libc::c_char,
            696 as libc::c_int as libc::c_uint,
            (*::core::mem::transmute::<
                &[u8; 45],
                &[libc::c_char; 45],
            >(b"int init_types(ctf_dict_t *, ctf_header_t *)\0"))
                .as_ptr(),
        );
    }
    'c_14203: {
    ...
    if ((*fp).ctf_version == 1 as libc::c_int) as libc::c_int as libc::c_long != 0 {
        let mut err_0: libc::c_int = 0;
        err_0 = upgrade_types(fp, cth);
        if err_0 != 0 as libc::c_int {
            return err_0;
        }
    }
    tbuf = ((*fp).ctf_buf).offset((*cth).cth_typeoff as isize) as *mut ctf_type_t;
    tend = ((*fp).ctf_buf).offset((*cth).cth_stroff as isize) as *mut ctf_type_t;
    tp = tbuf;
    while tp < tend {
        let mut kind: libc::c_ushort = ((*(*fp).ctf_dictops).ctfo_get_kind)
            .expect("non-null function pointer")((*tp).ctt_info) as libc::c_ushort;
        let mut vlen: libc::c_ulong = ((*(*fp).ctf_dictops).ctfo_get_vlen)
            .expect("non-null function pointer")((*tp).ctt_info) as libc::c_ulong;
        let mut size: ssize_t = 0;
        let mut increment: ssize_t = 0;
        let mut vbytes: ssize_t = 0;
        ctf_get_ctt_size(fp, tp, &mut size, &mut increment);
        vbytes = ((*(*fp).ctf_dictops).ctfo_get_vbytes)
            .expect("non-null function pointer")(fp, kind, size, vlen);
        if vbytes < 0 as libc::c_int as libc::c_long {
            return ECTF_CORRUPT as libc::c_int;
        }
        if kind as libc::c_int == 9 as libc::c_int {
            pop[(*tp).c2rust_unnamed.ctt_type
                as usize] = (pop[(*tp).c2rust_unnamed.ctt_type as usize])
                .wrapping_add(1);
            pop[(*tp).c2rust_unnamed.ctt_type as usize];
        }
        tp = (tp as uintptr_t)
            .wrapping_add(increment as libc::c_ulong)
            .wrapping_add(vbytes as libc::c_ulong) as *mut ctf_type_t;
        pop[kind as usize] = (pop[kind as usize]).wrapping_add(1);
        pop[kind as usize];
        (*fp).ctf_typemax = ((*fp).ctf_typemax).wrapping_add(1);
        (*fp).ctf_typemax;
    }
    if child != 0 {
        ctf_dprintf(
            b"CTF dict %p is a child\n\0" as *const u8 as *const libc::c_char,
            fp as *mut libc::c_void,
        );
        (*fp).ctf_flags |= 0x1 as libc::c_int as libc::c_uint;
    } else {
        ctf_dprintf(
            b"CTF dict %p is a parent\n\0" as *const u8 as *const libc::c_char,
            fp as *mut libc::c_void,
        );
    }
    (*fp)
        .ctf_structs
        .ctn_readonly = ctf_hash_create(
        pop[6 as libc::c_int as usize],
        Some(
            ctf_hash_string as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
        ),
        Some(
            ctf_hash_eq_string
                as unsafe extern "C" fn(
    ...
    if ((*fp).ctf_structs.ctn_readonly).is_null() {
        return 12 as libc::c_int;
    }
    (*fp)
        .ctf_unions
        .ctn_readonly = ctf_hash_create(
        pop[7 as libc::c_int as usize],
        Some(
            ctf_hash_string as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
        ),
        Some(
    ...
    if ((*fp).ctf_unions.ctn_readonly).is_null() {
        return 12 as libc::c_int;
    }
    (*fp)
        .ctf_enums
        .ctn_readonly = ctf_hash_create(
        pop[8 as libc::c_int as usize],
        Some(
            ctf_hash_string as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
        ),
        Some(
    ...
    if ((*fp).ctf_enums.ctn_readonly).is_null() {
        return 12 as libc::c_int;
    }
    (*fp)
        .ctf_names
        .ctn_readonly = ctf_hash_create(
        (pop[0 as libc::c_int as usize])
            .wrapping_add(pop[1 as libc::c_int as usize])
            .wrapping_add(pop[2 as libc::c_int as usize])
            .wrapping_add(pop[5 as libc::c_int as usize])
            .wrapping_add(pop[10 as libc::c_int as usize])
            .wrapping_add(pop[3 as libc::c_int as usize])
            .wrapping_add(pop[11 as libc::c_int as usize])
            .wrapping_add(pop[12 as libc::c_int as usize])
            .wrapping_add(pop[13 as libc::c_int as usize]),
        Some(
            ctf_hash_string as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
        ),
        Some(
    ...
    if ((*fp).ctf_names.ctn_readonly).is_null() {
        return 12 as libc::c_int;
    }
    (*fp)
        .ctf_txlate = malloc(
        (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
            .wrapping_mul(
                ((*fp).ctf_typemax).wrapping_add(1 as libc::c_int as libc::c_ulong),
            ),
    ) as *mut uint32_t;
    (*fp)
        .ctf_ptrtab_len = ((*fp).ctf_typemax)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
    (*fp)
        .ctf_ptrtab = malloc(
        (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
            .wrapping_mul((*fp).ctf_ptrtab_len),
    ) as *mut uint32_t;
    if ((*fp).ctf_txlate).is_null() || ((*fp).ctf_ptrtab).is_null() {
        return 12 as libc::c_int;
    }
    xp = (*fp).ctf_txlate;
    let fresh0 = xp;
    ...
    *fresh0 = 0 as libc::c_int as uint32_t;
    memset(
        (*fp).ctf_txlate as *mut libc::c_void,
        0 as libc::c_int,
        (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
            .wrapping_mul(
                ((*fp).ctf_typemax).wrapping_add(1 as libc::c_int as libc::c_ulong),
    ...
    memset(
        (*fp).ctf_ptrtab as *mut libc::c_void,
        0 as libc::c_int,
        (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
            .wrapping_mul(
                ((*fp).ctf_typemax).wrapping_add(1 as libc::c_int as libc::c_ulong),
    ...
    id = 1 as libc::c_int as uint32_t;
    tp = tbuf;
    while tp < tend {
        let mut kind_0: libc::c_ushort = ((*(*fp).ctf_dictops).ctfo_get_kind)
            .expect("non-null function pointer")((*tp).ctt_info) as libc::c_ushort;
        let mut isroot: libc::c_ushort = ((*(*fp).ctf_dictops).ctfo_get_root)
            .expect("non-null function pointer")((*tp).ctt_info) as libc::c_ushort;
        let mut vlen_0: libc::c_ulong = ((*(*fp).ctf_dictops).ctfo_get_vlen)
            .expect("non-null function pointer")((*tp).ctt_info) as libc::c_ulong;
        let mut size_0: ssize_t = 0;
        let mut increment_0: ssize_t = 0;
        let mut vbytes_0: ssize_t = 0;
        let mut name: *const libc::c_char = 0 as *const libc::c_char;
        ctf_get_ctt_size(fp, tp, &mut size_0, &mut increment_0);
        name = ctf_strptr(fp, (*tp).ctt_name);
        vbytes_0 = ((*(*fp).ctf_dictops).ctfo_get_vbytes)
            .expect("non-null function pointer")(fp, kind_0, size_0, vlen_0);
        let mut current_block_79: u64;
        match kind_0 as libc::c_int {
            0 | 1 | 2 => {
                if ctf_hash_lookup_type((*fp).ctf_names.ctn_readonly, fp, name)
                    == 0 as libc::c_int as libc::c_ulong || isroot as libc::c_int != 0
                {
                    err = ctf_hash_define_type(
                        (*fp).ctf_names.ctn_readonly,
                        fp,
                        if child != 0 {
                            id
                                | ((*fp).ctf_parmax)
                ...
                current_block_79 = 54079586644752974;
            }
            4 | 14 => {
                current_block_79 = 54079586644752974;
            }
            ...
            6 => {
                if size_0 >= 536870912 as libc::c_int as libc::c_long {
                    nlstructs += 1;
                    nlstructs;
                }
                if isroot == 0 {
            ...
            9 => {
                let mut np: *mut ctf_names_t = ctf_name_table(
                    fp,
                    (*tp).c2rust_unnamed.ctt_type as libc::c_int,
                );
                if isroot == 0 {
                    current_block_79 = 54079586644752974;
                } else {
                    if ctf_hash_lookup_type((*np).ctn_readonly, fp, name)
                        == 0 as libc::c_int as libc::c_ulong
                    {
                        err = ctf_hash_insert_type(
                            (*np).ctn_readonly,
            ...
            3 => {
                if ((*tp).c2rust_unnamed.ctt_type > (*fp).ctf_parmax) as libc::c_int
                    == child
                    && ((*tp).c2rust_unnamed.ctt_type & (*fp).ctf_parmax)
                        as libc::c_ulong <= (*fp).ctf_typemax
                {
                    *((*fp).ctf_ptrtab)
                        .offset(
                            ((*tp).c2rust_unnamed.ctt_type & (*fp).ctf_parmax) as isize,
                        ) = id;
                }
                current_block_79 = 741310737142315995;
            }
            11 | 12 | 13 => {
                current_block_79 = 741310737142315995;
            }
            _ => {
                ctf_err_warn(
                    fp,
                    0 as libc::c_int,
                    ECTF_CORRUPT as libc::c_int,
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"init_types(): unhandled CTF kind: %x\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    kind_0 as libc::c_int,
                );
                return ECTF_CORRUPT as libc::c_int;
            }
        }
        ...
        *xp = (tp as uintptr_t).wrapping_sub((*fp).ctf_buf as uintptr_t) as uint32_t;
        tp = (tp as uintptr_t)
            .wrapping_add(increment_0 as libc::c_ulong)
            .wrapping_add(vbytes_0 as libc::c_ulong) as *mut ctf_type_t;
        xp = xp.offset(1);
        xp;
    ...
    ctf_dprintf(
        b"%lu total types processed\n\0" as *const u8 as *const libc::c_char,
        (*fp).ctf_typemax,
    );
    ctf_dprintf(
        b"%u enum names hashed\n\0" as *const u8 as *const libc::c_char,
        ctf_hash_size((*fp).ctf_enums.ctn_readonly),
    );
    ctf_dprintf(
        b"%u struct names hashed (%d long)\n\0" as *const u8 as *const libc::c_char,
        ctf_hash_size((*fp).ctf_structs.ctn_readonly),
        nlstructs,
    );
    ctf_dprintf(
        b"%u union names hashed (%d long)\n\0" as *const u8 as *const libc::c_char,
        ctf_hash_size((*fp).ctf_unions.ctn_readonly),
        nlunions,
    );
    ctf_dprintf(
        b"%u base type names hashed\n\0" as *const u8 as *const libc::c_char,
        ctf_hash_size((*fp).ctf_names.ctn_readonly),
    );
    return 0 as libc::c_int;
}
unsafe extern "C" fn flip_header(mut cth: *mut ctf_header_t) {
    match ::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong {
        2 => {
            (*cth).cth_preamble.ctp_magic = __bswap_16((*cth).cth_preamble.ctp_magic);
        }
        4 => {
            (*cth)
                .cth_preamble
                .ctp_magic = __bswap_32((*cth).cth_preamble.ctp_magic as __uint32_t)
                as libc::c_ushort;
        }
        8 => {
            (*cth)
                .cth_preamble
                .ctp_magic = __bswap_64((*cth).cth_preamble.ctp_magic as __uint64_t)
                as libc::c_ushort;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<libc::c_uchar>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_preamble
                .ctp_version = __bswap_16((*cth).cth_preamble.ctp_version as __uint16_t)
                as libc::c_uchar;
        }
        4 => {
            (*cth)
                .cth_preamble
                .ctp_version = __bswap_32((*cth).cth_preamble.ctp_version as __uint32_t)
                as libc::c_uchar;
        }
        8 => {
            (*cth)
                .cth_preamble
                .ctp_version = __bswap_64((*cth).cth_preamble.ctp_version as __uint64_t)
                as libc::c_uchar;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<libc::c_uchar>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_preamble
                .ctp_flags = __bswap_16((*cth).cth_preamble.ctp_flags as __uint16_t)
                as libc::c_uchar;
        }
        4 => {
            (*cth)
                .cth_preamble
                .ctp_flags = __bswap_32((*cth).cth_preamble.ctp_flags as __uint32_t)
                as libc::c_uchar;
        }
        8 => {
            (*cth)
                .cth_preamble
                .ctp_flags = __bswap_64((*cth).cth_preamble.ctp_flags as __uint64_t)
                as libc::c_uchar;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_parlabel = __bswap_16((*cth).cth_parlabel as __uint16_t)
                as uint32_t;
        }
        4 => {
            (*cth).cth_parlabel = __bswap_32((*cth).cth_parlabel);
        }
        8 => {
            (*cth)
                .cth_parlabel = __bswap_64((*cth).cth_parlabel as __uint64_t)
                as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_parname = __bswap_16((*cth).cth_parname as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_parname = __bswap_32((*cth).cth_parname);
        }
        8 => {
            (*cth)
                .cth_parname = __bswap_64((*cth).cth_parname as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth).cth_cuname = __bswap_16((*cth).cth_cuname as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_cuname = __bswap_32((*cth).cth_cuname);
        }
        8 => {
            (*cth).cth_cuname = __bswap_64((*cth).cth_cuname as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_objtoff = __bswap_16((*cth).cth_objtoff as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_objtoff = __bswap_32((*cth).cth_objtoff);
        }
        8 => {
            (*cth)
                .cth_objtoff = __bswap_64((*cth).cth_objtoff as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_funcoff = __bswap_16((*cth).cth_funcoff as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_funcoff = __bswap_32((*cth).cth_funcoff);
        }
        8 => {
            (*cth)
                .cth_funcoff = __bswap_64((*cth).cth_funcoff as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_objtidxoff = __bswap_16((*cth).cth_objtidxoff as __uint16_t)
                as uint32_t;
        }
        4 => {
            (*cth).cth_objtidxoff = __bswap_32((*cth).cth_objtidxoff);
        }
        8 => {
            (*cth)
                .cth_objtidxoff = __bswap_64((*cth).cth_objtidxoff as __uint64_t)
                as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_funcidxoff = __bswap_16((*cth).cth_funcidxoff as __uint16_t)
                as uint32_t;
        }
        4 => {
            (*cth).cth_funcidxoff = __bswap_32((*cth).cth_funcidxoff);
        }
        8 => {
            (*cth)
                .cth_funcidxoff = __bswap_64((*cth).cth_funcidxoff as __uint64_t)
                as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth).cth_varoff = __bswap_16((*cth).cth_varoff as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_varoff = __bswap_32((*cth).cth_varoff);
        }
        8 => {
            (*cth).cth_varoff = __bswap_64((*cth).cth_varoff as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth)
                .cth_typeoff = __bswap_16((*cth).cth_typeoff as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_typeoff = __bswap_32((*cth).cth_typeoff);
        }
        8 => {
            (*cth)
                .cth_typeoff = __bswap_64((*cth).cth_typeoff as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth).cth_stroff = __bswap_16((*cth).cth_stroff as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_stroff = __bswap_32((*cth).cth_stroff);
        }
        8 => {
            (*cth).cth_stroff = __bswap_64((*cth).cth_stroff as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    }
    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
        2 => {
            (*cth).cth_strlen = __bswap_16((*cth).cth_strlen as __uint16_t) as uint32_t;
        }
        4 => {
            (*cth).cth_strlen = __bswap_32((*cth).cth_strlen);
        }
        8 => {
            (*cth).cth_strlen = __bswap_64((*cth).cth_strlen as __uint64_t) as uint32_t;
        }
        1 | _ => {}
    };
}
unsafe extern "C" fn flip_lbls(mut start: *mut libc::c_void, mut len: size_t) {
    let mut lbl: *mut ctf_lblent_t = start as *mut ctf_lblent_t;
    let mut i: ssize_t = 0;
    i = len.wrapping_div(::core::mem::size_of::<ctf_lblent>() as libc::c_ulong)
        as ssize_t;
    while i > 0 as libc::c_int as libc::c_long {
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*lbl)
                    .ctl_label = __bswap_16((*lbl).ctl_label as __uint16_t) as uint32_t;
            }
            4 => {
                (*lbl).ctl_label = __bswap_32((*lbl).ctl_label);
            }
            8 => {
                (*lbl)
                    .ctl_label = __bswap_64((*lbl).ctl_label as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*lbl).ctl_type = __bswap_16((*lbl).ctl_type as __uint16_t) as uint32_t;
            }
            4 => {
                (*lbl).ctl_type = __bswap_32((*lbl).ctl_type);
            }
            8 => {
                (*lbl).ctl_type = __bswap_64((*lbl).ctl_type as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        lbl = lbl.offset(1);
...
unsafe extern "C" fn flip_objts(mut start: *mut libc::c_void, mut len: size_t) {
    let mut obj: *mut uint32_t = start as *mut uint32_t;
    let mut i: ssize_t = 0;
    i = len.wrapping_div(::core::mem::size_of::<uint32_t>() as libc::c_ulong) as ssize_t;
    while i > 0 as libc::c_int as libc::c_long {
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                *obj = __bswap_16(*obj as __uint16_t) as uint32_t;
            }
            4 => {
                *obj = __bswap_32(*obj);
            }
            8 => {
                *obj = __bswap_64(*obj as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        obj = obj.offset(1);
...
unsafe extern "C" fn flip_vars(mut start: *mut libc::c_void, mut len: size_t) {
    let mut var: *mut ctf_varent_t = start as *mut ctf_varent_t;
    let mut i: ssize_t = 0;
    i = len.wrapping_div(::core::mem::size_of::<ctf_varent>() as libc::c_ulong)
        as ssize_t;
    while i > 0 as libc::c_int as libc::c_long {
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*var).ctv_name = __bswap_16((*var).ctv_name as __uint16_t) as uint32_t;
            }
            4 => {
                (*var).ctv_name = __bswap_32((*var).ctv_name);
            }
            8 => {
                (*var).ctv_name = __bswap_64((*var).ctv_name as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*var).ctv_type = __bswap_16((*var).ctv_type as __uint16_t) as uint32_t;
            }
            4 => {
                (*var).ctv_type = __bswap_32((*var).ctv_type);
            }
            8 => {
                (*var).ctv_type = __bswap_64((*var).ctv_type as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        var = var.offset(1);
...
unsafe extern "C" fn flip_types(
    mut fp: *mut ctf_dict_t,
    mut start: *mut libc::c_void,
    mut len: size_t,
) -> libc::c_int {
    let mut t: *mut ctf_type_t = start as *mut ctf_type_t;
    while (t as uintptr_t) < (start as uintptr_t).wrapping_add(len) {
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*t).ctt_name = __bswap_16((*t).ctt_name as __uint16_t) as uint32_t;
            }
            4 => {
                (*t).ctt_name = __bswap_32((*t).ctt_name);
            }
            8 => {
                (*t).ctt_name = __bswap_64((*t).ctt_name as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*t).ctt_info = __bswap_16((*t).ctt_info as __uint16_t) as uint32_t;
            }
            4 => {
                (*t).ctt_info = __bswap_32((*t).ctt_info);
            }
            8 => {
                (*t).ctt_info = __bswap_64((*t).ctt_info as __uint64_t) as uint32_t;
            }
            1 | _ => {}
        }
        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
            2 => {
                (*t)
                    .c2rust_unnamed
                    .ctt_size = __bswap_16((*t).c2rust_unnamed.ctt_size as __uint16_t)
                    as uint32_t;
            }
            4 => {
                (*t).c2rust_unnamed.ctt_size = __bswap_32((*t).c2rust_unnamed.ctt_size);
            }
            8 => {
                (*t)
                    .c2rust_unnamed
                    .ctt_size = __bswap_64((*t).c2rust_unnamed.ctt_size as __uint64_t)
                    as uint32_t;
            }
            1 | _ => {}
        }
        let mut kind: uint32_t = ((*t).ctt_info & 0xfc000000 as libc::c_uint)
            >> 26 as libc::c_int;
        let mut size: size_t = (*t).c2rust_unnamed.ctt_size as size_t;
        let mut vlen: uint32_t = (*t).ctt_info & 0xffffff as libc::c_int as libc::c_uint;
        let mut vbytes: size_t = get_vbytes_v2(
            fp,
            kind as libc::c_ushort,
            size as ssize_t,
            vlen as size_t,
        ) as size_t;
        if (size == 0xffffffff as libc::c_uint as libc::c_ulong) as libc::c_int
            as libc::c_long != 0
        {
            match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                2 => {
                    (*t)
                        .ctt_lsizehi = __bswap_16((*t).ctt_lsizehi as __uint16_t)
                        as uint32_t;
                }
                4 => {
                    (*t).ctt_lsizehi = __bswap_32((*t).ctt_lsizehi);
                }
                8 => {
                    (*t)
                        .ctt_lsizehi = __bswap_64((*t).ctt_lsizehi as __uint64_t)
                        as uint32_t;
                }
                1 | _ => {}
            }
            match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                2 => {
                    (*t)
                        .ctt_lsizelo = __bswap_16((*t).ctt_lsizelo as __uint16_t)
                        as uint32_t;
                }
                4 => {
                    (*t).ctt_lsizelo = __bswap_32((*t).ctt_lsizelo);
                }
                8 => {
                    (*t)
                        .ctt_lsizelo = __bswap_64((*t).ctt_lsizelo as __uint64_t)
                        as uint32_t;
                }
                1 | _ => {}
            }
            size = ((*t).ctt_lsizehi as uint64_t) << 32 as libc::c_int
                | (*t).ctt_lsizelo as libc::c_ulong;
            t = (t as uintptr_t)
        ...
        match kind {
            9 | 0 | 3 | 10 | 11 | 12 | 13 => {
                if vbytes == 0 as libc::c_int as libc::c_ulong {} else {
                    __assert_fail(
                        b"vbytes == 0\0" as *const u8 as *const libc::c_char,
                        b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                        1069 as libc::c_int as libc::c_uint,
                        (*::core::mem::transmute::<
                            &[u8; 45],
                            &[libc::c_char; 45],
                        >(b"int flip_types(ctf_dict_t *, void *, size_t)\0"))
                            .as_ptr(),
                    );
                }
                'c_15960: {
            ...
            1 | 2 => {
                let mut item: *mut uint32_t = t as *mut uint32_t;
                match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                    2 => {
                        *item = __bswap_16(*item as __uint16_t) as uint32_t;
                    }
                    4 => {
                        *item = __bswap_32(*item);
                    }
                    8 => {
                        *item = __bswap_64(*item as __uint64_t) as uint32_t;
                    }
                    1 | _ => {}
                }
            }
            5 => {
                let mut item_0: *mut uint32_t = t as *mut uint32_t;
                let mut i: ssize_t = 0;
                i = vlen as ssize_t;
                while i > 0 as libc::c_int as libc::c_long {
                    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                        2 => {
                            *item_0 = __bswap_16(*item_0 as __uint16_t) as uint32_t;
                        }
                        4 => {
                            *item_0 = __bswap_32(*item_0);
                        }
                        8 => {
                            *item_0 = __bswap_64(*item_0 as __uint64_t) as uint32_t;
                        }
                        1 | _ => {}
                    }
                    item_0 = item_0.offset(1);
                    item_0;
                    i -= 1;
                    i;
                }
            ...
            4 => {
                let mut a: *mut ctf_array_t = t as *mut ctf_array_t;
                if vbytes == ::core::mem::size_of::<ctf_array_t>() as libc::c_ulong
                {} else {
                    __assert_fail(
                        b"vbytes == sizeof (ctf_array_t)\0" as *const u8
                            as *const libc::c_char,
                        b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                ...
                match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                    2 => {
                        (*a)
                            .cta_contents = __bswap_16((*a).cta_contents as __uint16_t)
                            as uint32_t;
                    }
                    4 => {
                        (*a).cta_contents = __bswap_32((*a).cta_contents);
                    }
                    8 => {
                        (*a)
                            .cta_contents = __bswap_64((*a).cta_contents as __uint64_t)
                            as uint32_t;
                    }
                    1 | _ => {}
                }
                match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                    2 => {
                        (*a)
                            .cta_index = __bswap_16((*a).cta_index as __uint16_t)
                            as uint32_t;
                    }
                    4 => {
                        (*a).cta_index = __bswap_32((*a).cta_index);
                    }
                    8 => {
                        (*a)
                            .cta_index = __bswap_64((*a).cta_index as __uint64_t)
                            as uint32_t;
                    }
                    1 | _ => {}
                }
                match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                    2 => {
                        (*a)
                            .cta_nelems = __bswap_16((*a).cta_nelems as __uint16_t)
                            as uint32_t;
                    }
                    4 => {
                        (*a).cta_nelems = __bswap_32((*a).cta_nelems);
                    }
                    8 => {
                        (*a)
                            .cta_nelems = __bswap_64((*a).cta_nelems as __uint64_t)
                            as uint32_t;
                    }
                    1 | _ => {}
                }
            ...
            14 => {
                let mut s: *mut ctf_slice_t = t as *mut ctf_slice_t;
                if vbytes == ::core::mem::size_of::<ctf_slice_t>() as libc::c_ulong
                {} else {
                    __assert_fail(
                        b"vbytes == sizeof (ctf_slice_t)\0" as *const u8
                            as *const libc::c_char,
                        b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                ...
                match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                    2 => {
                        (*s)
                            .cts_type = __bswap_16((*s).cts_type as __uint16_t)
                            as uint32_t;
                    }
                    4 => {
                        (*s).cts_type = __bswap_32((*s).cts_type);
                    }
                    8 => {
                        (*s)
                            .cts_type = __bswap_64((*s).cts_type as __uint64_t)
                            as uint32_t;
                    }
                    1 | _ => {}
                }
                match ::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong {
                    2 => {
                        (*s).cts_offset = __bswap_16((*s).cts_offset);
                    }
                    4 => {
                        (*s)
                            .cts_offset = __bswap_32((*s).cts_offset as __uint32_t)
                            as libc::c_ushort;
                    }
                    8 => {
                        (*s)
                            .cts_offset = __bswap_64((*s).cts_offset as __uint64_t)
                            as libc::c_ushort;
                    }
                    1 | _ => {}
                }
                match ::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong {
                    2 => {
                        (*s).cts_bits = __bswap_16((*s).cts_bits);
                    }
                    4 => {
                        (*s)
                            .cts_bits = __bswap_32((*s).cts_bits as __uint32_t)
                            as libc::c_ushort;
                    }
                    8 => {
                        (*s)
                            .cts_bits = __bswap_64((*s).cts_bits as __uint64_t)
                            as libc::c_ushort;
                    }
                    1 | _ => {}
                }
            ...
            6 | 7 => {
                if (size >= 536870912 as libc::c_int as libc::c_ulong) as libc::c_int
                    as libc::c_long != 0
                {
                    let mut lm: *mut ctf_lmember_t = t as *mut ctf_lmember_t;
                    let mut i_0: ssize_t = 0;
                    i_0 = vlen as ssize_t;
                    while i_0 > 0 as libc::c_int as libc::c_long {
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*lm)
                                    .ctlm_name = __bswap_16((*lm).ctlm_name as __uint16_t)
                                    as uint32_t;
                            }
                            4 => {
                                (*lm).ctlm_name = __bswap_32((*lm).ctlm_name);
                            }
                            8 => {
                                (*lm)
                                    .ctlm_name = __bswap_64((*lm).ctlm_name as __uint64_t)
                                    as uint32_t;
                            }
                            1 | _ => {}
                        }
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*lm)
                                    .ctlm_offsethi = __bswap_16(
                                    (*lm).ctlm_offsethi as __uint16_t,
                                ) as uint32_t;
                            }
                            4 => {
                                (*lm).ctlm_offsethi = __bswap_32((*lm).ctlm_offsethi);
                            }
                            8 => {
                                (*lm)
                                    .ctlm_offsethi = __bswap_64(
                                    (*lm).ctlm_offsethi as __uint64_t,
                                ) as uint32_t;
                            }
                            1 | _ => {}
                        }
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*lm)
                                    .ctlm_type = __bswap_16((*lm).ctlm_type as __uint16_t)
                                    as uint32_t;
                            }
                            4 => {
                                (*lm).ctlm_type = __bswap_32((*lm).ctlm_type);
                            }
                            8 => {
                                (*lm)
                                    .ctlm_type = __bswap_64((*lm).ctlm_type as __uint64_t)
                                    as uint32_t;
                            }
                            1 | _ => {}
                        }
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*lm)
                                    .ctlm_offsetlo = __bswap_16(
                                    (*lm).ctlm_offsetlo as __uint16_t,
                                ) as uint32_t;
                            }
                            4 => {
                                (*lm).ctlm_offsetlo = __bswap_32((*lm).ctlm_offsetlo);
                            }
                            8 => {
                                (*lm)
                                    .ctlm_offsetlo = __bswap_64(
                                    (*lm).ctlm_offsetlo as __uint64_t,
                                ) as uint32_t;
                            }
                            1 | _ => {}
                        }
                    ...
                    let mut m: *mut ctf_member_t = t as *mut ctf_member_t;
                    let mut i_1: ssize_t = 0;
                    i_1 = vlen as ssize_t;
                    while i_1 > 0 as libc::c_int as libc::c_long {
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*m)
                                    .ctm_name = __bswap_16((*m).ctm_name as __uint16_t)
                                    as uint32_t;
                            }
                            4 => {
                                (*m).ctm_name = __bswap_32((*m).ctm_name);
                            }
                            8 => {
                                (*m)
                                    .ctm_name = __bswap_64((*m).ctm_name as __uint64_t)
                                    as uint32_t;
                            }
                            1 | _ => {}
                        }
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*m)
                                    .ctm_offset = __bswap_16((*m).ctm_offset as __uint16_t)
                                    as uint32_t;
                            }
                            4 => {
                                (*m).ctm_offset = __bswap_32((*m).ctm_offset);
                            }
                            8 => {
                                (*m)
                                    .ctm_offset = __bswap_64((*m).ctm_offset as __uint64_t)
                                    as uint32_t;
                            }
                            1 | _ => {}
                        }
                        match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                            2 => {
                                (*m)
                                    .ctm_type = __bswap_16((*m).ctm_type as __uint16_t)
                                    as uint32_t;
                            }
                            4 => {
                                (*m).ctm_type = __bswap_32((*m).ctm_type);
                            }
                            8 => {
                                (*m)
                                    .ctm_type = __bswap_64((*m).ctm_type as __uint64_t)
                                    as uint32_t;
                            }
                            1 | _ => {}
                        }
            ...
            8 => {
                let mut item_1: *mut ctf_enum_t = t as *mut ctf_enum_t;
                let mut i_2: ssize_t = 0;
                i_2 = vlen as ssize_t;
                while i_2 > 0 as libc::c_int as libc::c_long {
                    match ::core::mem::size_of::<uint32_t>() as libc::c_ulong {
                        2 => {
                            (*item_1)
                                .cte_name = __bswap_16((*item_1).cte_name as __uint16_t)
                                as uint32_t;
                        }
                        4 => {
                            (*item_1).cte_name = __bswap_32((*item_1).cte_name);
                        }
                        8 => {
                            (*item_1)
                                .cte_name = __bswap_64((*item_1).cte_name as __uint64_t)
                                as uint32_t;
                        }
                        1 | _ => {}
                    }
                    match ::core::mem::size_of::<int32_t>() as libc::c_ulong {
                        2 => {
                            (*item_1)
                                .cte_value = __bswap_16((*item_1).cte_value as __uint16_t)
                                as int32_t;
                        }
                        4 => {
                            (*item_1)
                                .cte_value = __bswap_32((*item_1).cte_value as __uint32_t)
                                as int32_t;
                        }
                        8 => {
                            (*item_1)
                                .cte_value = __bswap_64((*item_1).cte_value as __uint64_t)
                                as int32_t;
                        }
                        1 | _ => {}
                    }
                    item_1 = item_1.offset(1);
                    item_1;
                    i_2 -= 1;
                    i_2;
                }
            ...
            _ => {
                ctf_err_warn(
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"unhandled CTF kind in endianness conversion: %x\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    kind,
        ...
        t = (t as uintptr_t).wrapping_add(vbytes) as *mut ctf_type_t;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn flip_ctf(
    mut fp: *mut ctf_dict_t,
    mut cth: *mut ctf_header_t,
    mut buf: *mut libc::c_uchar,
) -> libc::c_int {
    flip_lbls(
        buf.offset((*cth).cth_lbloff as isize) as *mut libc::c_void,
        ((*cth).cth_objtoff).wrapping_sub((*cth).cth_lbloff) as size_t,
    );
    flip_objts(
        buf.offset((*cth).cth_objtoff as isize) as *mut libc::c_void,
        ((*cth).cth_funcoff).wrapping_sub((*cth).cth_objtoff) as size_t,
    );
    flip_objts(
        buf.offset((*cth).cth_funcoff as isize) as *mut libc::c_void,
        ((*cth).cth_objtidxoff).wrapping_sub((*cth).cth_funcoff) as size_t,
    );
    flip_objts(
        buf.offset((*cth).cth_objtidxoff as isize) as *mut libc::c_void,
        ((*cth).cth_funcidxoff).wrapping_sub((*cth).cth_objtidxoff) as size_t,
    );
    flip_objts(
        buf.offset((*cth).cth_funcidxoff as isize) as *mut libc::c_void,
        ((*cth).cth_varoff).wrapping_sub((*cth).cth_funcidxoff) as size_t,
    );
    flip_vars(
        buf.offset((*cth).cth_varoff as isize) as *mut libc::c_void,
        ((*cth).cth_typeoff).wrapping_sub((*cth).cth_varoff) as size_t,
    );
    return flip_types(
        fp,
        buf.offset((*cth).cth_typeoff as isize) as *mut libc::c_void,
        ((*cth).cth_stroff).wrapping_sub((*cth).cth_typeoff) as size_t,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_set_ctl_hashes(mut fp: *mut ctf_dict_t) {
    (*fp)
        .ctf_lookups[0 as libc::c_int as usize]
        .ctl_prefix = b"struct\0" as *const u8 as *const libc::c_char;
    (*fp)
        .ctf_lookups[0 as libc::c_int as usize]
        .ctl_len = strlen((*fp).ctf_lookups[0 as libc::c_int as usize].ctl_prefix);
    (*fp).ctf_lookups[0 as libc::c_int as usize].ctl_hash = &mut (*fp).ctf_structs;
    (*fp)
        .ctf_lookups[1 as libc::c_int as usize]
        .ctl_prefix = b"union\0" as *const u8 as *const libc::c_char;
    (*fp)
        .ctf_lookups[1 as libc::c_int as usize]
        .ctl_len = strlen((*fp).ctf_lookups[1 as libc::c_int as usize].ctl_prefix);
    (*fp).ctf_lookups[1 as libc::c_int as usize].ctl_hash = &mut (*fp).ctf_unions;
    (*fp)
        .ctf_lookups[2 as libc::c_int as usize]
        .ctl_prefix = b"enum\0" as *const u8 as *const libc::c_char;
    (*fp)
        .ctf_lookups[2 as libc::c_int as usize]
        .ctl_len = strlen((*fp).ctf_lookups[2 as libc::c_int as usize].ctl_prefix);
    (*fp).ctf_lookups[2 as libc::c_int as usize].ctl_hash = &mut (*fp).ctf_enums;
    (*fp).ctf_lookups[3 as libc::c_int as usize].ctl_prefix = _CTF_NULLSTR.as_ptr();
    (*fp)
        .ctf_lookups[3 as libc::c_int as usize]
        .ctl_len = strlen((*fp).ctf_lookups[3 as libc::c_int as usize].ctl_prefix);
    (*fp).ctf_lookups[3 as libc::c_int as usize].ctl_hash = &mut (*fp).ctf_names;
    (*fp).ctf_lookups[4 as libc::c_int as usize].ctl_prefix = 0 as *const libc::c_char;
    (*fp).ctf_lookups[4 as libc::c_int as usize].ctl_len = 0 as libc::c_int as size_t;
    (*fp).ctf_lookups[4 as libc::c_int as usize].ctl_hash = 0 as *mut ctf_names_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_simple_open(
    mut ctfsect: *const libc::c_char,
    mut ctfsect_size: size_t,
    mut symsect: *const libc::c_char,
    mut symsect_size: size_t,
    mut symsect_entsize: size_t,
    mut strsect: *const libc::c_char,
    mut strsect_size: size_t,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    return ctf_simple_open_internal(
        ctfsect,
        ctfsect_size,
        symsect,
        symsect_size,
        ...
        strsect,
        strsect_size,
        0 as *mut ctf_dynhash_t,
        0 as libc::c_int,
        errp,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ctf_simple_open_internal(
    mut ctfsect: *const libc::c_char,
    mut ctfsect_size: size_t,
    mut symsect: *const libc::c_char,
    mut symsect_size: size_t,
    ...
    mut strsect: *const libc::c_char,
    mut strsect_size: size_t,
    mut syn_strtab: *mut ctf_dynhash_t,
    mut writable: libc::c_int,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    let mut skeleton: ctf_sect_t = ctf_sect_t {
        cts_name: 0 as *const libc::c_char,
        cts_data: 0 as *const libc::c_void,
        cts_size: 0,
        cts_entsize: 0,
    };
    let mut ctf_sect: ctf_sect_t = ctf_sect_t {
        cts_name: 0 as *const libc::c_char,
        cts_data: 0 as *const libc::c_void,
        cts_size: 0,
        cts_entsize: 0,
    };
    let mut sym_sect: ctf_sect_t = ctf_sect_t {
        cts_name: 0 as *const libc::c_char,
        cts_data: 0 as *const libc::c_void,
        cts_size: 0,
        cts_entsize: 0,
    };
    let mut str_sect: ctf_sect_t = ctf_sect_t {
        cts_name: 0 as *const libc::c_char,
        cts_data: 0 as *const libc::c_void,
        cts_size: 0,
        cts_entsize: 0,
    };
    let mut ctfsectp: *mut ctf_sect_t = 0 as *mut ctf_sect_t;
    let mut symsectp: *mut ctf_sect_t = 0 as *mut ctf_sect_t;
    let mut strsectp: *mut ctf_sect_t = 0 as *mut ctf_sect_t;
    skeleton.cts_name = _CTF_SECTION.as_ptr();
    skeleton.cts_entsize = 1 as libc::c_int as size_t;
    if !ctfsect.is_null() {
        memcpy(
            &mut ctf_sect as *mut ctf_sect_t as *mut libc::c_void,
            &mut skeleton as *mut ctf_sect_t as *const libc::c_void,
            ::core::mem::size_of::<ctf_sect>() as libc::c_ulong,
        );
        ctf_sect.cts_data = ctfsect as *const libc::c_void;
        ctf_sect.cts_size = ctfsect_size;
        ctfsectp = &mut ctf_sect;
    }
    if !symsect.is_null() {
        memcpy(
            &mut sym_sect as *mut ctf_sect_t as *mut libc::c_void,
            &mut skeleton as *mut ctf_sect_t as *const libc::c_void,
            ::core::mem::size_of::<ctf_sect>() as libc::c_ulong,
        );
        sym_sect.cts_data = symsect as *const libc::c_void;
        sym_sect.cts_size = symsect_size;
        sym_sect.cts_entsize = symsect_entsize;
        symsectp = &mut sym_sect;
    }
    if !strsect.is_null() {
        memcpy(
            &mut str_sect as *mut ctf_sect_t as *mut libc::c_void,
            &mut skeleton as *mut ctf_sect_t as *const libc::c_void,
            ::core::mem::size_of::<ctf_sect>() as libc::c_ulong,
        );
        str_sect.cts_data = strsect as *const libc::c_void;
        str_sect.cts_size = strsect_size;
        strsectp = &mut str_sect;
    }
    return ctf_bufopen_internal(
        ctfsectp,
        symsectp,
        strsectp,
        syn_strtab,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_bufopen(
    mut ctfsect: *const ctf_sect_t,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    mut errp: *mut libc::c_int,
) -> *mut ctf_dict_t {
    return ctf_bufopen_internal(
        ctfsect,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_bufopen_internal(
    mut ctfsect: *const ctf_sect_t,
    mut symsect: *const ctf_sect_t,
    mut strsect: *const ctf_sect_t,
    mut syn_strtab: *mut ctf_dynhash_t,
    ...
    let mut pp: *const ctf_preamble_t = 0 as *const ctf_preamble_t;
    let mut hdrsz: size_t = ::core::mem::size_of::<ctf_header_t>() as libc::c_ulong;
    let mut hp: *mut ctf_header_t = 0 as *mut ctf_header_t;
    let mut fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut foreign_endian: libc::c_int = 0 as libc::c_int;
    let mut err: libc::c_int = 0;
    libctf_init_debug();
    if ctfsect.is_null()
        || !symsect.is_null() && (strsect.is_null() && syn_strtab.is_null())
    {
        return ctf_set_open_errno(errp, 22 as libc::c_int) as *mut ctf_dict_t;
    }
    if !symsect.is_null()
        && (*symsect).cts_entsize != ::core::mem::size_of::<Elf32_Sym>() as libc::c_ulong
        && (*symsect).cts_entsize != ::core::mem::size_of::<Elf64_Sym>() as libc::c_ulong
    {
        return ctf_set_open_errno(errp, ECTF_SYMTAB as libc::c_int) as *mut ctf_dict_t;
    }
    if !symsect.is_null() && ((*symsect).cts_data).is_null() {
        return ctf_set_open_errno(errp, ECTF_SYMBAD as libc::c_int) as *mut ctf_dict_t;
    }
    if !strsect.is_null() && ((*strsect).cts_data).is_null() {
        return ctf_set_open_errno(errp, ECTF_STRBAD as libc::c_int) as *mut ctf_dict_t;
    }
    if (*ctfsect).cts_size < ::core::mem::size_of::<ctf_preamble_t>() as libc::c_ulong {
        return ctf_set_open_errno(errp, ECTF_NOCTFBUF as libc::c_int) as *mut ctf_dict_t;
    }
    pp = (*ctfsect).cts_data as *const ctf_preamble_t;
    ctf_dprintf(
        b"ctf_bufopen: magic=0x%x version=%u\n\0" as *const u8 as *const libc::c_char,
        (*pp).ctp_magic as libc::c_int,
        (*pp).ctp_version as libc::c_int,
    );
    if ((*pp).ctp_magic as libc::c_int != 0xdff2 as libc::c_int) as libc::c_int
        as libc::c_long != 0
    {
        if (*pp).ctp_magic as libc::c_int
            == __bswap_16(0xdff2 as libc::c_int as __uint16_t) as libc::c_int
        {
            if (*pp).ctp_version as libc::c_int != 4 as libc::c_int {
                return ctf_set_open_errno(errp, ECTF_CTFVERS as libc::c_int)
                    as *mut ctf_dict_t;
            }
            foreign_endian = 1 as libc::c_int;
        } else {
            return ctf_set_open_errno(errp, ECTF_NOCTFBUF as libc::c_int)
                as *mut ctf_dict_t
        }
    }
    if (((*pp).ctp_version as libc::c_int) < 1 as libc::c_int
        || (*pp).ctp_version as libc::c_int > 4 as libc::c_int) as libc::c_int
        as libc::c_long != 0
    {
        return ctf_set_open_errno(errp, ECTF_CTFVERS as libc::c_int) as *mut ctf_dict_t;
    }
    if !symsect.is_null() && ((*pp).ctp_version as libc::c_int) < 3 as libc::c_int {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ECTF_NOTSUP as libc::c_int,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"ctf_bufopen: CTF version %d symsect not supported\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*pp).ctp_version as libc::c_int,
        );
        return ctf_set_open_errno(errp, ECTF_NOTSUP as libc::c_int) as *mut ctf_dict_t;
    }
    if ((*pp).ctp_version as libc::c_int) < 4 as libc::c_int {
        hdrsz = ::core::mem::size_of::<ctf_header_v2_t>() as libc::c_ulong;
    }
    if ((*pp).ctp_flags as libc::c_int
        > 0x1 as libc::c_int | 0x2 as libc::c_int | 0x4 as libc::c_int
            | 0x8 as libc::c_int) as libc::c_int as libc::c_long != 0
    {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ECTF_FLAGS as libc::c_int,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"ctf_bufopen: invalid header flags: %x\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*pp).ctp_flags as libc::c_uint,
        );
        return ctf_set_open_errno(errp, ECTF_FLAGS as libc::c_int) as *mut ctf_dict_t;
    }
    if (*ctfsect).cts_size < hdrsz {
        return ctf_set_open_errno(errp, ECTF_NOCTFBUF as libc::c_int) as *mut ctf_dict_t;
    }
    fp = malloc(::core::mem::size_of::<ctf_dict_t>() as libc::c_ulong)
        as *mut ctf_dict_t;
    if fp.is_null() {
        return ctf_set_open_errno(errp, 12 as libc::c_int) as *mut ctf_dict_t;
    }
    memset(
        fp as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if writable != 0 {
        (*fp).ctf_flags |= 0x2 as libc::c_int as libc::c_uint;
    }
    (*fp)
        .ctf_header = malloc(::core::mem::size_of::<ctf_header>() as libc::c_ulong)
        as *mut ctf_header;
    if ((*fp).ctf_header).is_null() {
        free(fp as *mut libc::c_void);
        return ctf_set_open_errno(errp, 12 as libc::c_int) as *mut ctf_dict_t;
    }
    hp = (*fp).ctf_header;
    memcpy(hp as *mut libc::c_void, (*ctfsect).cts_data, hdrsz);
    if ((*pp).ctp_version as libc::c_int) < 4 as libc::c_int {
        upgrade_header(hp);
    }
    if foreign_endian != 0 {
    ...
    (*fp).ctf_size = ((*hp).cth_stroff).wrapping_add((*hp).cth_strlen) as size_t;
    ctf_dprintf(
        b"ctf_bufopen: uncompressed size=%lu\n\0" as *const u8 as *const libc::c_char,
        (*fp).ctf_size,
    );
    if (*hp).cth_lbloff as libc::c_ulong > (*fp).ctf_size
        || (*hp).cth_objtoff as libc::c_ulong > (*fp).ctf_size
        || (*hp).cth_funcoff as libc::c_ulong > (*fp).ctf_size
        || (*hp).cth_objtidxoff as libc::c_ulong > (*fp).ctf_size
        || (*hp).cth_funcidxoff as libc::c_ulong > (*fp).ctf_size
        || (*hp).cth_typeoff as libc::c_ulong > (*fp).ctf_size
        || (*hp).cth_stroff as libc::c_ulong > (*fp).ctf_size
    {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"header offset exceeds CTF size\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        return ctf_set_open_errno(errp, ECTF_CORRUPT as libc::c_int) as *mut ctf_dict_t;
    }
    if (*hp).cth_lbloff > (*hp).cth_objtoff || (*hp).cth_objtoff > (*hp).cth_funcoff
        ...
        || (*hp).cth_varoff > (*hp).cth_typeoff || (*hp).cth_typeoff > (*hp).cth_stroff
    {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"overlapping CTF sections\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        return ctf_set_open_errno(errp, ECTF_CORRUPT as libc::c_int) as *mut ctf_dict_t;
    }
    if (*hp).cth_lbloff & 3 as libc::c_int as libc::c_uint != 0
        || (*hp).cth_objtoff & 2 as libc::c_int as libc::c_uint != 0
        || (*hp).cth_funcoff & 2 as libc::c_int as libc::c_uint != 0
        || (*hp).cth_objtidxoff & 2 as libc::c_int as libc::c_uint != 0
        || (*hp).cth_funcidxoff & 2 as libc::c_int as libc::c_uint != 0
        || (*hp).cth_varoff & 3 as libc::c_int as libc::c_uint != 0
        || (*hp).cth_typeoff & 3 as libc::c_int as libc::c_uint != 0
    {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"CTF sections not properly aligned\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if ((*hp).cth_funcidxoff).wrapping_sub((*hp).cth_objtidxoff)
        != 0 as libc::c_int as libc::c_uint
        && ((*hp).cth_funcidxoff).wrapping_sub((*hp).cth_objtidxoff)
            != ((*hp).cth_funcoff).wrapping_sub((*hp).cth_objtoff)
    {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"Object index section exists is neither empty nor the same length as the object section: %u versus %u bytes\0"
    ...
    if ((*hp).cth_varoff).wrapping_sub((*hp).cth_funcidxoff)
        != 0 as libc::c_int as libc::c_uint
        && ((*hp).cth_varoff).wrapping_sub((*hp).cth_funcidxoff)
            != ((*hp).cth_objtidxoff).wrapping_sub((*hp).cth_funcoff)
    {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"Function index section exists is neither empty nor the same length as the function section: %u versus %u bytes\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            ((*hp).cth_objtidxoff).wrapping_sub((*hp).cth_funcoff),
    ...
    if (*hp).cth_preamble.ctp_flags as libc::c_int & 0x1 as libc::c_int != 0 {
        let mut srclen: size_t = 0;
        let mut dstlen: uLongf = 0;
        let mut src: *const libc::c_void = 0 as *const libc::c_void;
        let mut rc: libc::c_int = 0 as libc::c_int;
        (*fp).ctf_base = malloc((*fp).ctf_size) as *mut libc::c_uchar;
        if ((*fp).ctf_base).is_null() {
            err = ECTF_ZALLOC as libc::c_int;
            current_block = 8367087252958135675;
        } else {
            ...
            src = ((*ctfsect).cts_data as *mut libc::c_uchar).offset(hdrsz as isize)
                as *const libc::c_void;
            srclen = ((*ctfsect).cts_size).wrapping_sub(hdrsz);
            dstlen = (*fp).ctf_size;
            (*fp).ctf_buf = (*fp).ctf_base;
            rc = uncompress((*fp).ctf_base, &mut dstlen, src as *const Bytef, srclen);
            if rc != 0 as libc::c_int {
                ctf_err_warn(
                    0 as *mut ctf_dict_t,
                    0 as libc::c_int,
                    ECTF_DECOMPRESS as libc::c_int,
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"zlib inflate err: %s\0" as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    zError(rc),
                );
                err = ECTF_DECOMPRESS as libc::c_int;
                current_block = 8367087252958135675;
            } else if dstlen != (*fp).ctf_size {
                ctf_err_warn(
                    0 as *mut ctf_dict_t,
                    0 as libc::c_int,
                    ECTF_CORRUPT as libc::c_int,
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"zlib inflate short: got %lu of %lu bytes\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    dstlen,
                ...
                err = ECTF_CORRUPT as libc::c_int;
                current_block = 8367087252958135675;
            } else {
                current_block = 4746626699541760585;
            }
        }
    } else if foreign_endian != 0 {
        (*fp).ctf_base = malloc((*fp).ctf_size) as *mut libc::c_uchar;
        if ((*fp).ctf_base).is_null() {
            err = ECTF_ZALLOC as libc::c_int;
            current_block = 8367087252958135675;
            ...
            (*fp).ctf_dynbase = (*fp).ctf_base;
            memcpy(
                (*fp).ctf_base as *mut libc::c_void,
                ((*ctfsect).cts_data as *mut libc::c_uchar).offset(hdrsz as isize)
                    as *const libc::c_void,
                (*fp).ctf_size,
            );
            (*fp).ctf_buf = (*fp).ctf_base;
        ...
        (*fp).ctf_base = (*ctfsect).cts_data as *mut libc::c_uchar;
        (*fp).ctf_dynbase = 0 as *mut libc::c_uchar;
        (*fp).ctf_buf = ((*fp).ctf_base).offset(hdrsz as isize);
        current_block = 4746626699541760585;
    }
    match current_block {
        4746626699541760585 => {
            ctf_set_version(fp, hp, (*hp).cth_preamble.ctp_version as libc::c_int);
            if ctf_str_create_atoms(fp) < 0 as libc::c_int {
                err = 12 as libc::c_int;
            } else {
                (*fp).ctf_parmax = 0x7fffffff as libc::c_int as uint32_t;
                memcpy(
                    &mut (*fp).ctf_data as *mut ctf_sect_t as *mut libc::c_void,
                    ctfsect as *const libc::c_void,
                    ::core::mem::size_of::<ctf_sect_t>() as libc::c_ulong,
                );
                if !symsect.is_null() {
                    memcpy(
                        &mut (*fp).ctf_symtab as *mut ctf_sect_t as *mut libc::c_void,
                        symsect as *const libc::c_void,
                        ::core::mem::size_of::<ctf_sect_t>() as libc::c_ulong,
                    );
                    memcpy(
                        &mut (*fp).ctf_strtab as *mut ctf_sect_t as *mut libc::c_void,
                        strsect as *const libc::c_void,
                        ::core::mem::size_of::<ctf_sect_t>() as libc::c_ulong,
                    );
                }
                if !((*fp).ctf_data.cts_name).is_null() {
                    (*fp).ctf_data.cts_name = strdup((*fp).ctf_data.cts_name);
                    if ((*fp).ctf_data.cts_name).is_null() {
                        err = 12 as libc::c_int;
                        current_block = 8367087252958135675;
                    } else {
                ...
                match current_block {
                    8367087252958135675 => {}
                    _ => {
                        if !((*fp).ctf_symtab.cts_name).is_null() {
                            (*fp)
                                .ctf_symtab
                                .cts_name = strdup((*fp).ctf_symtab.cts_name);
                            if ((*fp).ctf_symtab.cts_name).is_null() {
                                err = 12 as libc::c_int;
                                current_block = 8367087252958135675;
                            } else {
                        ...
                        match current_block {
                            8367087252958135675 => {}
                            _ => {
                                if !((*fp).ctf_strtab.cts_name).is_null() {
                                    (*fp)
                                        .ctf_strtab
                                        .cts_name = strdup((*fp).ctf_strtab.cts_name);
                                    if ((*fp).ctf_strtab.cts_name).is_null() {
                                        err = 12 as libc::c_int;
                                        current_block = 8367087252958135675;
                                    } else {
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                        if ((*fp).ctf_data.cts_name).is_null() {
                                            (*fp).ctf_data.cts_name = _CTF_NULLSTR.as_ptr();
                                        }
                                        if ((*fp).ctf_symtab.cts_name).is_null() {
                                            (*fp).ctf_symtab.cts_name = _CTF_NULLSTR.as_ptr();
                                        }
                                        if ((*fp).ctf_strtab.cts_name).is_null() {
                                            (*fp).ctf_strtab.cts_name = _CTF_NULLSTR.as_ptr();
                                        }
                                        if !strsect.is_null() {
                                            (*fp)
                                                .ctf_str[1 as libc::c_int as usize]
                                                .cts_strs = (*strsect).cts_data as *const libc::c_char;
                                            (*fp)
                                                .ctf_str[1 as libc::c_int as usize]
                                            ...
                                            }
                                        {
                                            ...
                                            {
                                                (*fp).ctf_refcnt = 1 as libc::c_int as uint32_t;
                                                return fp;
                                            }
                                            err = init_types(fp, hp);
                                            if !(err != 0 as libc::c_int) {
                                                (*fp).ctf_symsect_little_endian = 1 as libc::c_int;
                                                if !symsect.is_null() {
                                                    (*fp)
                                                        .ctf_nsyms = ((*symsect).cts_size)
                                                        .wrapping_div((*symsect).cts_entsize);
                                                    (*fp)
                                                        .ctf_sxlate = malloc(
                                                        ((*fp).ctf_nsyms)
                                                            .wrapping_mul(
                                                ...
                                                match current_block {
                                                    8367087252958135675 => {}
                                                    _ => {
                                                        err = init_symtab(fp, hp, symsect);
                                                        if !(err != 0 as libc::c_int) {
                                                            ctf_set_ctl_hashes(fp);
                                                            if !symsect.is_null() {
                                                                if (*symsect).cts_entsize
                                                                    == ::core::mem::size_of::<Elf64_Sym>() as libc::c_ulong
                                                                {
                                                                    ctf_setmodel(fp, 2 as libc::c_int);
                                                                } else {
                                                                    ctf_setmodel(fp, 1 as libc::c_int);
                                                                }
                                                            } else {
                                                                ctf_setmodel(fp, 2 as libc::c_int);
                                                            }
    ...
    ctf_dict_close(fp);
    return 0 as *mut ctf_dict_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_ref(mut fp: *mut ctf_dict_t) {
    (*fp).ctf_refcnt = ((*fp).ctf_refcnt).wrapping_add(1);
    (*fp).ctf_refcnt;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_dict_close(mut fp: *mut ctf_dict_t) {
    let mut dtd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut ntd: *mut ctf_dtdef_t = 0 as *mut ctf_dtdef_t;
    let mut dvd: *mut ctf_dvdef_t = 0 as *mut ctf_dvdef_t;
    let mut nvd: *mut ctf_dvdef_t = 0 as *mut ctf_dvdef_t;
    let mut did: *mut ctf_in_flight_dynsym_t = 0 as *mut ctf_in_flight_dynsym_t;
    let mut nid: *mut ctf_in_flight_dynsym_t = 0 as *mut ctf_in_flight_dynsym_t;
    let mut err: *mut ctf_err_warning_t = 0 as *mut ctf_err_warning_t;
    let mut nerr: *mut ctf_err_warning_t = 0 as *mut ctf_err_warning_t;
    if fp.is_null() {
        return;
    }
    ctf_dprintf(
        b"ctf_dict_close(%p) refcnt=%u\n\0" as *const u8 as *const libc::c_char,
        fp as *mut libc::c_void,
        (*fp).ctf_refcnt,
    );
    if (*fp).ctf_refcnt > 1 as libc::c_int as libc::c_uint {
        (*fp).ctf_refcnt = ((*fp).ctf_refcnt).wrapping_sub(1);
        (*fp).ctf_refcnt;
        return;
    }
    if (*fp).ctf_refcnt == 0 as libc::c_int as libc::c_uint {
        return;
    }
    (*fp).ctf_refcnt = ((*fp).ctf_refcnt).wrapping_sub(1);
    (*fp).ctf_refcnt;
    free((*fp).ctf_dyncuname as *mut libc::c_void);
    free((*fp).ctf_dynparname as *mut libc::c_void);
    if !((*fp).ctf_parent).is_null() && (*fp).ctf_parent_unreffed == 0 {
        ctf_dict_close((*fp).ctf_parent);
    }
    dtd = (*(&mut (*fp).ctf_dtdefs as *mut ctf_list_t)).l_next as *mut libc::c_void
        as *mut ctf_dtdef_t;
    while !dtd.is_null() {
        ntd = (*(dtd as *mut ctf_list_t)).l_next as *mut libc::c_void
            as *mut ctf_dtdef_t;
    ...
    free((*fp).ctf_funcidx_sxlate as *mut libc::c_void);
    free((*fp).ctf_objtidx_sxlate as *mut libc::c_void);
    ctf_dynhash_destroy((*fp).ctf_objthash);
    ctf_dynhash_destroy((*fp).ctf_funchash);
    free((*fp).ctf_dynsymidx as *mut libc::c_void);
    ctf_dynhash_destroy((*fp).ctf_dynsyms);
    did = (*(&mut (*fp).ctf_in_flight_dynsyms as *mut ctf_list_t)).l_next
        as *mut libc::c_void as *mut ctf_in_flight_dynsym_t;
    while !did.is_null() {
        nid = (*(did as *mut ctf_list_t)).l_next as *mut libc::c_void
            as *mut ctf_in_flight_dynsym_t;
        ctf_list_delete(&mut (*fp).ctf_in_flight_dynsyms, did as *mut libc::c_void);
        free(did as *mut libc::c_void);
        did = nid;
    }
    ctf_str_free_atoms(fp);
    free((*fp).ctf_tmp_typeslice as *mut libc::c_void);
    if (*fp).ctf_data.cts_name != _CTF_NULLSTR.as_ptr() {
        free((*fp).ctf_data.cts_name as *mut libc::c_char as *mut libc::c_void);
    }
    if (*fp).ctf_symtab.cts_name != _CTF_NULLSTR.as_ptr() {
        free((*fp).ctf_symtab.cts_name as *mut libc::c_char as *mut libc::c_void);
    }
    if (*fp).ctf_strtab.cts_name != _CTF_NULLSTR.as_ptr() {
        free((*fp).ctf_strtab.cts_name as *mut libc::c_char as *mut libc::c_void);
    } else if !((*fp).ctf_data_mmapped).is_null() {
        ctf_munmap((*fp).ctf_data_mmapped, (*fp).ctf_data_mmapped_len);
    }
    free((*fp).ctf_dynbase as *mut libc::c_void);
    ...
    ctf_dedup_fini(fp, 0 as *mut *mut ctf_dict_t, 0 as libc::c_int as uint32_t);
    ctf_dynset_destroy((*fp).ctf_dedup_atoms_alloc);
    err = (*(&mut (*fp).ctf_errs_warnings as *mut ctf_list_t)).l_next
        as *mut libc::c_void as *mut ctf_err_warning_t;
    while !err.is_null() {
        nerr = (*(err as *mut ctf_list_t)).l_next as *mut libc::c_void
            as *mut ctf_err_warning_t;
        ctf_list_delete(&mut (*fp).ctf_errs_warnings, err as *mut libc::c_void);
        free((*err).cew_text as *mut libc::c_void);
        free(err as *mut libc::c_void);
        err = nerr;
    }
    free((*fp).ctf_sxlate as *mut libc::c_void);
    free((*fp).ctf_txlate as *mut libc::c_void);
    free((*fp).ctf_ptrtab as *mut libc::c_void);
    free((*fp).ctf_pptrtab as *mut libc::c_void);
    free((*fp).ctf_header as *mut libc::c_void);
    free(fp as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_file_close(mut fp: *mut ctf_file_t) {
    ctf_dict_close(fp);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_close(mut arc: *mut ctf_archive_t) {
    ctf_arc_close(arc);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_get_arc(mut fp: *const ctf_dict_t) -> *mut ctf_archive_t {
    return (*fp).ctf_archive;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_getdatasect(mut fp: *const ctf_dict_t) -> ctf_sect_t {
    return (*fp).ctf_data;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_getsymsect(mut fp: *const ctf_dict_t) -> ctf_sect_t {
    return (*fp).ctf_symtab;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_getstrsect(mut fp: *const ctf_dict_t) -> ctf_sect_t {
    return (*fp).ctf_strtab;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_symsect_endianness(
    mut fp: *mut ctf_dict_t,
    mut little_endian: libc::c_int,
) {
    let mut old_endianness: libc::c_int = (*fp).ctf_symsect_little_endian;
    (*fp).ctf_symsect_little_endian = (little_endian != 0) as libc::c_int;
    if old_endianness != (*fp).ctf_symsect_little_endian && !((*fp).ctf_sxlate).is_null()
        && !((*fp).ctf_symtab.cts_data).is_null()
    {
        if init_symtab(fp, (*fp).ctf_header, &mut (*fp).ctf_symtab) == 0 as libc::c_int
        {} else {
            __assert_fail(
                b"init_symtab (fp, fp->ctf_header, &fp->ctf_symtab) == 0\0" as *const u8
                    as *const libc::c_char,
                b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                ...
                (*::core::mem::transmute::<
                    &[u8; 47],
                    &[libc::c_char; 47],
                >(b"void ctf_symsect_endianness(ctf_dict_t *, int)\0"))
                    .as_ptr(),
            );
        }
        'c_8458: {
            if init_symtab(fp, (*fp).ctf_header, &mut (*fp).ctf_symtab)
                == 0 as libc::c_int
            {} else {
                __assert_fail(
                    b"init_symtab (fp, fp->ctf_header, &fp->ctf_symtab) == 0\0"
                        as *const u8 as *const libc::c_char,
                    b"ctf-open.c\0" as *const u8 as *const libc::c_char,
                    1862 as libc::c_int as libc::c_uint,
                    (*::core::mem::transmute::<
...
#[no_mangle]
pub unsafe extern "C" fn ctf_parent_dict(mut fp: *mut ctf_dict_t) -> *mut ctf_dict_t {
    return (*fp).ctf_parent;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_parent_file(mut fp: *mut ctf_dict_t) -> *mut ctf_dict_t {
    return ctf_parent_dict(fp);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_parent_name(
    mut fp: *mut ctf_dict_t,
) -> *const libc::c_char {
    return (*fp).ctf_parname;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_parent_name_set(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
) -> libc::c_int {
    if !((*fp).ctf_dynparname).is_null() {
        free((*fp).ctf_dynparname as *mut libc::c_void);
    }
    (*fp).ctf_dynparname = strdup(name);
    if ((*fp).ctf_dynparname).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_cuname(mut fp: *mut ctf_dict_t) -> *const libc::c_char {
    return (*fp).ctf_cuname;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_cuname_set(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
) -> libc::c_int {
    if !((*fp).ctf_dyncuname).is_null() {
        free((*fp).ctf_dyncuname as *mut libc::c_void);
    }
    (*fp).ctf_dyncuname = strdup(name);
    if ((*fp).ctf_dyncuname).is_null() {
        return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_import(
    mut fp: *mut ctf_dict_t,
    mut pfp: *mut ctf_dict_t,
) -> libc::c_int {
    if fp.is_null() || fp == pfp
        || !pfp.is_null() && (*pfp).ctf_refcnt == 0 as libc::c_int as libc::c_uint
    {
        return ctf_set_errno(fp, 22 as libc::c_int) as libc::c_int;
    }
    if !pfp.is_null() && (*pfp).ctf_dmodel != (*fp).ctf_dmodel {
        return ctf_set_errno(fp, ECTF_DMODEL as libc::c_int) as libc::c_int;
    }
    if !((*fp).ctf_parent).is_null() && (*fp).ctf_parent_unreffed == 0 {
        ctf_dict_close((*fp).ctf_parent);
    }
    (*fp).ctf_parent = 0 as *mut ctf_dict;
    free((*fp).ctf_pptrtab as *mut libc::c_void);
    (*fp).ctf_pptrtab = 0 as *mut uint32_t;
    (*fp).ctf_pptrtab_len = 0 as libc::c_int as size_t;
    (*fp).ctf_pptrtab_typemax = 0 as libc::c_int as uint32_t;
    if !pfp.is_null() {
        let mut err: libc::c_int = 0;
        if ((*fp).ctf_parname).is_null() {
        ...
        (*fp).ctf_flags |= 0x1 as libc::c_int as libc::c_uint;
        (*pfp).ctf_refcnt = ((*pfp).ctf_refcnt).wrapping_add(1);
        (*pfp).ctf_refcnt;
        (*fp).ctf_parent_unreffed = 0 as libc::c_int;
    }
    (*fp).ctf_parent = pfp;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_import_unref(
    mut fp: *mut ctf_dict_t,
    mut pfp: *mut ctf_dict_t,
) -> libc::c_int {
    if fp.is_null() || fp == pfp
...
#[no_mangle]
pub unsafe extern "C" fn ctf_setmodel(
    mut fp: *mut ctf_dict_t,
    mut model: libc::c_int,
) -> libc::c_int {
    let mut dp: *const ctf_dmodel_t = 0 as *const ctf_dmodel_t;
    dp = _libctf_models.as_ptr();
    while !((*dp).ctd_name).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_getmodel(mut fp: *mut ctf_dict_t) -> libc::c_int {
    return (*(*fp).ctf_dmodel).ctd_code;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_setspecific(
    mut fp: *mut ctf_dict_t,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_getspecific(mut fp: *mut ctf_dict_t) -> *mut libc::c_void {
