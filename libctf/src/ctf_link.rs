...
extern "C" {
    ...
    fn ctf_archive_count(_: *const ctf_archive_t) -> size_t;
    fn ctf_dict_close(_: *mut ctf_dict_t);
    fn ctf_arc_write_fd(
        _: libc::c_int,
        _: *mut *mut ctf_dict_t,
        _: size_t,
    ...
    fn ctf_symbol_next(
        ...
        functions: libc::c_int,
    ) -> ctf_id_t;
    fn ctf_variable_next(
        _: *mut ctf_dict_t,
        _: *mut *mut ctf_next_t,
        _: *mut *const libc::c_char,
    ) -> ctf_id_t;
    ...
    fn ctf_dedup_type_mapping(
        fp: *mut ctf_dict_t,
        src_fp: *mut ctf_dict_t,
        src_type: ctf_id_t,
    ) -> ctf_id_t;
    ...
    fn ctf_dedup_emit(
        ...
        _: *mut *mut ctf_dict_t,
        ninputs: uint32_t,
        parents: *mut uint32_t,
        noutputs: *mut uint32_t,
        cu_mapped: libc::c_int,
    ) -> *mut *mut ctf_dict_t;
    fn ctf_dedup(
        _: *mut ctf_dict_t,
        _: *mut *mut ctf_dict_t,
    ...
    fn ctf_list_splice(_: *mut ctf_list_t, _: *mut ctf_list_t);
    fn ctf_new_archive_internal(
        is_archive: libc::c_int,
        unmap_on_close: libc::c_int,
        _: *mut ctf_archive,
        _: *mut ctf_dict_t,
        symsect: *const ctf_sect_t,
        strsect: *const ctf_sect_t,
        errp: *mut libc::c_int,
    ) -> *mut ctf_archive_internal;
    fn strcmp(_: *const libc::c_char, _: *const libc::c_char) -> libc::c_int;
    fn ctf_dedup_atoms_init(_: *mut ctf_dict_t) -> libc::c_int;
    fn ctf_str_add_external(
        _: *mut ctf_dict_t,
        _: *const libc::c_char,
        offset: uint32_t,
    ) -> libc::c_int;
    fn ctf_dynhash_iter(_: *mut ctf_dynhash_t, _: ctf_hash_iter_f, _: *mut libc::c_void);
...
pub type ctf_link_input_t = ctf_link_input;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_link_input {
    pub clin_filename: *const libc::c_char,
    pub clin_arc: *mut ctf_archive_t,
    pub clin_fp: *mut ctf_dict_t,
    pub n: libc::c_int,
}
...
>;
pub type link_sort_inputs_cb_arg_t = link_sort_inputs_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct link_sort_inputs_cb_arg {
    pub is_cu_mapped: libc::c_int,
...
>;
pub type ctf_link_strtab_string_f = unsafe extern "C" fn(
    *mut uint32_t,
    *mut libc::c_void,
) -> *const libc::c_char;
pub type ctf_link_out_string_cb_arg_t = ctf_link_out_string_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_link_out_string_cb_arg {
    pub str_0: *const libc::c_char,
    pub offset: uint32_t,
    pub err: libc::c_int,
}
pub type ctf_hash_iter_f = Option::<
...
pub type ctf_name_list_accum_cb_arg_t = ctf_name_list_accum_cb_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_name_list_accum_cb_arg {
    pub names: *mut *mut libc::c_char,
    pub fp: *mut ctf_dict_t,
    pub files: *mut *mut ctf_dict_t,
    pub i: size_t,
    pub dynames: *mut *mut libc::c_char,
    pub ndynames: size_t,
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link_input_name(
    mut fp: *mut ctf_dict_t,
) -> *const libc::c_char {
    if !((*fp).ctf_parent).is_null() && !((*(*fp).ctf_parent).ctf_cuname).is_null() {
        return (*(*fp).ctf_parent).ctf_cuname
    } else if !((*fp).ctf_cuname).is_null() {
        return (*fp).ctf_cuname
    } else {
        return b"(unnamed)\0" as *const u8 as *const libc::c_char
    };
}
unsafe extern "C" fn ctf_unnamed_cuname(mut fp: *mut ctf_dict_t) -> *const libc::c_char {
    let mut cuname: *const libc::c_char = ctf_cuname(fp);
    if cuname.is_null() {
        cuname = b"unnamed-CU\0" as *const u8 as *const libc::c_char;
    }
    return cuname;
}
unsafe extern "C" fn ctf_link_input_close(mut input: *mut libc::c_void) {
    let mut i: *mut ctf_link_input_t = input as *mut ctf_link_input_t;
    if !((*i).clin_arc).is_null() {
        ctf_arc_close((*i).clin_arc);
    }
    free(i as *mut libc::c_void);
}
unsafe extern "C" fn ctf_link_add_ctf_internal(
    mut fp: *mut ctf_dict_t,
    mut ctf: *mut ctf_archive_t,
    mut fp_input: *mut ctf_dict_t,
    mut name: *const libc::c_char,
) -> libc::c_int {
    let mut input: *mut ctf_link_input_t = 0 as *mut ctf_link_input_t;
    let mut dupname: *mut libc::c_char = 0 as *mut libc::c_char;
    input = calloc(
        1 as libc::c_int as libc::c_ulong,
        ::core::mem::size_of::<ctf_link_input_t>() as libc::c_ulong,
    ) as *mut ctf_link_input_t;
    if !input.is_null() {
        dupname = strdup(name);
        if !dupname.is_null() {
            (*input).clin_arc = ctf;
            ...
            (*input).n = ctf_dynhash_elements((*fp).ctf_link_inputs) as libc::c_int;
            if !(ctf_dynhash_insert(
                (*fp).ctf_link_inputs,
                dupname as *mut libc::c_void,
...
unsafe extern "C" fn ctf_link_add(
    mut fp: *mut ctf_dict_t,
    mut ctf: *mut ctf_archive_t,
    mut name: *const libc::c_char,
    ...
    if !buf.is_null() {
        return ctf_set_errno(fp, ECTF_NOTYET as libc::c_int) as libc::c_int;
    }
    if !(!ctf.is_null() && !name.is_null() && buf.is_null()
        || !name.is_null() && buf.is_null() && ctf.is_null()
        || !buf.is_null() && !name.is_null() && ctf.is_null())
    {
        return ctf_set_errno(fp, 22 as libc::c_int) as libc::c_int;
    }
    if buf.is_null() && ctf.is_null() && !name.is_null() {
        return ctf_set_errno(fp, ECTF_NEEDSBFD as libc::c_int) as libc::c_int;
    }
    if !((*fp).ctf_link_outputs).is_null() {
        return ctf_set_errno(fp, ECTF_LINKADDEDLATE as libc::c_int) as libc::c_int;
    }
    if ((*fp).ctf_link_inputs).is_null() {
        (*fp)
            .ctf_link_inputs = ctf_dynhash_create(
            Some(
                ctf_hash_string
            ...
            Some(ctf_link_input_close as unsafe extern "C" fn(*mut libc::c_void) -> ()),
        );
    }
    if ((*fp).ctf_link_inputs).is_null() {
        return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
    }
    return ctf_link_add_ctf_internal(fp, ctf, 0 as *mut ctf_dict_t, name);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_link_add_ctf(
    mut fp: *mut ctf_dict_t,
    mut ctf: *mut ctf_archive_t,
    mut name: *const libc::c_char,
) -> libc::c_int {
...
unsafe extern "C" fn ctf_link_lazy_open(
    mut fp: *mut ctf_dict_t,
    mut input: *mut ctf_link_input_t,
) -> ssize_t {
    let mut count: size_t = 0;
    let mut err: libc::c_int = 0;
    if !((*input).clin_arc).is_null() {
        return ctf_archive_count((*input).clin_arc) as ssize_t;
    }
    if !((*input).clin_fp).is_null() {
        return 1 as libc::c_int as ssize_t;
    }
    ctf_err_warn(
        fp,
        0 as libc::c_int,
        ECTF_NEEDSBFD as libc::c_int,
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"cannot open %s lazily\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        (*input).clin_filename,
    );
    ctf_set_errno(fp, ECTF_NEEDSBFD as libc::c_int);
    return -(1 as libc::c_int) as ssize_t;
}
unsafe extern "C" fn ctf_create_per_cu(
    mut fp: *mut ctf_dict_t,
    mut cu_name: *const libc::c_char,
) -> *mut ctf_dict_t {
    let mut current_block: u64;
    let mut cu_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut ctf_name: *const libc::c_char = 0 as *const libc::c_char;
    let mut dynname: *mut libc::c_char = 0 as *mut libc::c_char;
    if !((*fp).ctf_link_in_cu_mapping).is_null() {
        ctf_name = ctf_dynhash_lookup(
            (*fp).ctf_link_in_cu_mapping,
            cu_name as *const libc::c_void,
    ...
    cu_fp = ctf_dynhash_lookup((*fp).ctf_link_outputs, ctf_name as *const libc::c_void)
        as *mut ctf_dict_t;
    if cu_fp.is_null() {
        let mut err: libc::c_int = 0;
        cu_fp = ctf_create(&mut err);
        if cu_fp.is_null() {
            ctf_err_warn(
                fp,
                0 as libc::c_int,
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"cannot create per-CU CTF archive for input CU %s\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                cu_name,
        ...
        dynname = strdup(ctf_name);
        if dynname.is_null() {
            current_block = 6006624610325220004;
        } else if ctf_dynhash_insert(
            (*fp).ctf_link_outputs,
            dynname as *mut libc::c_void,
            cu_fp as *mut libc::c_void,
        ) < 0 as libc::c_int
        {
            current_block = 6006624610325220004;
        } else {
            ...
            ctf_parent_name_set(cu_fp, _CTF_SECTION.as_ptr());
            current_block = 8236137900636309791;
        }
        match current_block {
            8236137900636309791 => {}
            _ => {
                free(dynname as *mut libc::c_void);
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link_add_cu_mapping(
    mut fp: *mut ctf_dict_t,
    ...
    let mut one_out: *mut ctf_dynhash_t = 0 as *mut ctf_dynhash_t;
    if ((*fp).ctf_link_in_cu_mapping).is_null() {
        (*fp)
            .ctf_link_in_cu_mapping = ctf_dynhash_create(
            Some(
                ctf_hash_string
                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
            ),
    ...
    if ((*fp).ctf_link_in_cu_mapping).is_null() {
        current_block = 4620520697212334608;
    } else {
        if ((*fp).ctf_link_out_cu_mapping).is_null() {
            (*fp)
                .ctf_link_out_cu_mapping = ctf_dynhash_create(
                Some(
                    ctf_hash_string
                        as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
                ),
        ...
        if ((*fp).ctf_link_out_cu_mapping).is_null() {
            ...
            if f.is_null() || t.is_null() {
                ...
                if err < 0 as libc::c_int {
                    ctf_set_errno(fp, err);
                    current_block = 354293717548722952;
                } else {
                    f = strdup(from);
                    t = strdup(to);
                    if f.is_null() || t.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link_set_memb_name_changer(
    mut fp: *mut ctf_dict_t,
    mut changer: Option::<ctf_link_memb_name_changer_f>,
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link_set_variable_filter(
    mut fp: *mut ctf_dict_t,
    mut filter: Option::<ctf_link_variable_filter_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
...
unsafe extern "C" fn check_variable(
    ...
    mut fp: *mut ctf_dict_t,
    mut type_0: ctf_id_t,
    mut out_dvd: *mut *mut ctf_dvdef_t,
) -> libc::c_int {
    let mut dvd: *mut ctf_dvdef_t = 0 as *mut ctf_dvdef_t;
    dvd = ctf_dynhash_lookup((*fp).ctf_dvhash, name as *const libc::c_void)
        as *mut ctf_dvdef_t;
    *out_dvd = dvd;
    if dvd.is_null() {
        return 1 as libc::c_int;
    }
    if (*dvd).dvd_type != type_0 {
        ctf_dprintf(
            b"Inexpressible duplicate variable %s skipped.\n\0" as *const u8
                as *const libc::c_char,
            name,
        );
    }
...
unsafe extern "C" fn ctf_link_one_variable(
    mut fp: *mut ctf_dict_t,
    mut in_fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
    mut cu_mapped: libc::c_int,
) -> libc::c_int {
    let mut per_cu_out_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
    let mut dst_type: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    let mut dvd: *mut ctf_dvdef_t = 0 as *mut ctf_dvdef_t;
    if ((*fp).ctf_link_variable_filter).is_some() {
        let mut farg: *mut libc::c_void = (*fp).ctf_link_variable_filter_arg;
        if ((*fp).ctf_link_variable_filter)
            .expect("non-null function pointer")(in_fp, name, type_0, farg) != 0
        {
            return 0 as libc::c_int;
        }
    }
    dst_type = ctf_dedup_type_mapping(fp, in_fp, type_0);
    ...
    if dst_type != 0 as libc::c_int as libc::c_ulong {
        if ctf_assert_internal(
            fp,
            b"ctf-link.c\0" as *const u8 as *const libc::c_char,
            455 as libc::c_int as size_t,
            b"ctf_type_isparent (fp, dst_type)\0" as *const u8 as *const libc::c_char,
            (ctf_type_isparent(fp, dst_type) != 0) as libc::c_int,
        ) as libc::c_long == 0
        {
            return -(1 as libc::c_int);
        }
        if check_variable(name, fp, dst_type, &mut dvd) != 0 {
            if ctf_add_variable(fp, name, dst_type) < 0 as libc::c_int {
                return -(1 as libc::c_int);
            }
            return 0 as libc::c_int;
        }
        if !dvd.is_null() && (*dvd).dvd_type == dst_type {
            return 0 as libc::c_int;
        }
    }
    if cu_mapped != 0 {
        ctf_dprintf(
            b"Variable %s in input file %s depends on a type %lx hidden due to conflicts: skipped.\n\0"
    ...
    per_cu_out_fp = ctf_create_per_cu(fp, ctf_unnamed_cuname(in_fp));
    if per_cu_out_fp.is_null() {
        return -(1 as libc::c_int);
    }
    if dst_type == 0 as libc::c_int as libc::c_ulong {
        dst_type = ctf_dedup_type_mapping(per_cu_out_fp, in_fp, type_0);
        if dst_type == -(1 as libc::c_long) as ctf_id_t {
            return -(1 as libc::c_int);
        }
        if dst_type == 0 as libc::c_int as libc::c_ulong {
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"type %lx for variable %s in input file %s not found: skipped\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                type_0,
    ...
    if check_variable(name, per_cu_out_fp, dst_type, &mut dvd) != 0 {
        if ctf_add_variable(per_cu_out_fp, name, dst_type) < 0 as libc::c_int {
            return ctf_set_errno(fp, ctf_errno(per_cu_out_fp)) as libc::c_int;
        }
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_link_sort_inputs(
    mut one: *const ctf_next_hkv_t,
    mut two: *const ctf_next_hkv_t,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    let mut input_1: *mut ctf_link_input_t = 0 as *mut ctf_link_input_t;
    let mut input_2: *mut ctf_link_input_t = 0 as *mut ctf_link_input_t;
    let mut cu_mapped: *mut link_sort_inputs_cb_arg_t = arg
        as *mut link_sort_inputs_cb_arg_t;
    if cu_mapped.is_null() || (*cu_mapped).is_cu_mapped == 0 {
        input_1 = (*one).hkv_value as *mut ctf_link_input_t;
        input_2 = (*two).hkv_value as *mut ctf_link_input_t;
    } else {
        let mut name_1: *const libc::c_char = (*one).hkv_key as *const libc::c_char;
        let mut name_2: *const libc::c_char = (*two).hkv_key as *const libc::c_char;
        input_1 = ctf_dynhash_lookup(
            (*(*cu_mapped).fp).ctf_link_inputs,
            name_1 as *const libc::c_void,
        ) as *mut ctf_link_input_t;
        input_2 = ctf_dynhash_lookup(
            (*(*cu_mapped).fp).ctf_link_inputs,
            name_2 as *const libc::c_void,
        ) as *mut ctf_link_input_t;
        if input_1.is_null() {
            return -(1 as libc::c_int);
        }
...
unsafe extern "C" fn ctf_link_deduplicating_count_inputs(
    mut fp: *mut ctf_dict_t,
    mut cu_names: *mut ctf_dynhash_t,
    mut only_one_input: *mut *mut ctf_link_input_t,
) -> ssize_t {
    let mut inputs: *mut ctf_dynhash_t = (*fp).ctf_link_inputs;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut name: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut input: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut one_input: *mut ctf_link_input_t = 0 as *mut ctf_link_input_t;
    let mut one_name: *const libc::c_char = 0 as *const libc::c_char;
    let mut count: ssize_t = 0 as libc::c_int as ssize_t;
    let mut narcs: ssize_t = 0 as libc::c_int as ssize_t;
    let mut err: libc::c_int = 0;
    if !cu_names.is_null() {
        inputs = cu_names;
    }
    loop {
        err = ctf_dynhash_next(inputs, &mut i, &mut name, &mut input);
        if !(err == 0 as libc::c_int) {
            break;
        }
        let mut one_count: ssize_t = 0;
        one_name = name as *const libc::c_char;
        if !cu_names.is_null() {
            one_input = ctf_dynhash_lookup(
                (*fp).ctf_link_inputs,
                one_name as *const libc::c_void,
            ) as *mut ctf_link_input_t;
        } else {
            one_input = input as *mut ctf_link_input_t;
        }
        if one_input.is_null() {
            continue;
        }
        one_count = ctf_link_lazy_open(fp, one_input);
        if one_count < 0 as libc::c_int as libc::c_long {
            ctf_next_destroy(i);
            return -(1 as libc::c_int) as ssize_t;
        }
        count += one_count;
    ...
    if err != ECTF_NEXT_END as libc::c_int {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"iteration error counting deduplicating CTF link inputs\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if narcs == 1 as libc::c_int as libc::c_long {
        if !only_one_input.is_null() {
            *only_one_input = one_input;
        }
    } else if !only_one_input.is_null() {
        *only_one_input = 0 as *mut ctf_link_input_t;
    }
    return count;
}
unsafe extern "C" fn ctf_link_deduplicating_open_inputs(
    mut fp: *mut ctf_dict_t,
    mut cu_names: *mut ctf_dynhash_t,
    mut ninputs: ssize_t,
    mut parents: *mut *mut uint32_t,
) -> *mut *mut ctf_dict_t {
    let mut current_block: u64;
    let mut inputs: *mut ctf_dynhash_t = (*fp).ctf_link_inputs;
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut name: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut input: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut sort_arg: link_sort_inputs_cb_arg_t = link_sort_inputs_cb_arg_t {
        is_cu_mapped: 0,
        fp: 0 as *mut ctf_dict_t,
    };
    let mut dedup_inputs: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut walk: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut parents_: *mut uint32_t = 0 as *mut uint32_t;
    let mut err: libc::c_int = 0;
    if !cu_names.is_null() {
        inputs = cu_names;
    }
    dedup_inputs = calloc(
        ninputs as libc::c_ulong,
        ::core::mem::size_of::<*mut ctf_dict_t>() as libc::c_ulong,
    ) as *mut *mut ctf_dict_t;
    if dedup_inputs.is_null() {
        current_block = 7641514015779017827;
    } else {
        parents_ = calloc(
            ninputs as libc::c_ulong,
        ...
        if parents_.is_null() {
            ...
            walk = dedup_inputs;
            sort_arg
                .is_cu_mapped = (cu_names
                != 0 as *mut libc::c_void as *mut ctf_dynhash_t) as libc::c_int;
            sort_arg.fp = fp;
            loop {
                err = ctf_dynhash_next_sorted(
                    ...
                    &mut sort_arg as *mut link_sort_inputs_cb_arg_t as *mut libc::c_void,
                );
                if !(err == 0 as libc::c_int) {
                    current_block = 17184638872671510253;
                    break;
                }
                let mut one_name: *const libc::c_char = name as *const libc::c_char;
                let mut one_input: *mut ctf_link_input_t = 0 as *mut ctf_link_input_t;
                let mut one_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
                let mut parent_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
                let mut parent_i: uint32_t = 0;
                ...
                if one_input.is_null()
                    || ((*one_input).clin_arc).is_null()
                        && ((*one_input).clin_fp).is_null()
                {
                    continue;
                }
                if !((*one_input).clin_fp).is_null() {
                    *parents_
                        .offset(
                            walk.offset_from(dedup_inputs) as libc::c_long as isize,
                        ) = walk.offset_from(dedup_inputs) as libc::c_long as uint32_t;
                    *walk = (*one_input).clin_fp;
                    walk = walk.offset(1);
                    walk;
                } else {
                    parent_fp = ctf_dict_open(
                        (*one_input).clin_arc,
                        _CTF_SECTION.as_ptr(),
                        &mut err,
                    );
                    if parent_fp.is_null() {
                        if err != ECTF_NOMEMBNAM as libc::c_int {
                            ctf_next_destroy(i);
                            ctf_set_errno(fp, err);
                            current_block = 6111259810970238577;
                            break;
                        }
                    } else {
                        *walk = parent_fp;
                        parent_i = walk.offset_from(dedup_inputs) as libc::c_long
                            as uint32_t;
                        walk = walk.offset(1);
                        walk;
                    }
                    loop {
                        one_fp = ctf_archive_next(
                            (*one_input).clin_arc,
                            &mut j,
                        ...
                        if (*one_fp).ctf_flags & 0x1 as libc::c_int as libc::c_uint != 0
                        {
                            ...
                            if !parent_fp.is_null() {
                                ...
                                *parents_
                                    .offset(
                                        walk.offset_from(dedup_inputs) as libc::c_long as isize,
                                    ) = walk.offset_from(dedup_inputs) as libc::c_long
                                    as uint32_t;
                            }
                        }
                        *walk = one_fp;
                    ...
                    ctf_next_destroy(i);
                    current_block = 2150798033590089605;
                    break;
                }
            }
            match current_block {
    ...
    free(dedup_inputs as *mut libc::c_void);
    free(parents_ as *mut libc::c_void);
    ctf_err_warn(
        fp,
        0 as libc::c_int,
        0 as libc::c_int,
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"error in deduplicating CTF link input allocation\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
unsafe extern "C" fn ctf_link_deduplicating_close_inputs(
    mut fp: *mut ctf_dict_t,
    mut cu_names: *mut ctf_dynhash_t,
    ...
    while i < ninputs {
        ctf_dict_close(*inputs.offset(i as isize));
        i += 1;
        i;
    }
    if !cu_names.is_null() {
        loop {
            ...
            ctf_dynhash_remove(
                (*fp).ctf_link_inputs,
                name as *const libc::c_char as *const libc::c_void,
            );
        }
        if err != ECTF_NEXT_END as libc::c_int {
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"iteration error in deduplicating link input freeing\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
...
unsafe extern "C" fn ctf_link_deduplicating_variables(
    mut fp: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: size_t,
    mut cu_mapped: libc::c_int,
    ...
    while i < ninputs {
        ...
        loop {
            type_0 = ctf_variable_next(*inputs.offset(i as isize), &mut it, &mut name);
            if !(type_0 != -(1 as libc::c_long) as ctf_id_t) {
                break;
            }
            if ctf_link_one_variable(
                fp,
        ...
        if ctf_errno(*inputs.offset(i as isize)) != ECTF_NEXT_END as libc::c_int {
            return ctf_set_errno(fp, ctf_errno(*inputs.offset(i as isize)))
                as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn check_sym(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
    mut type_0: ctf_id_t,
    mut functions: libc::c_int,
) -> libc::c_int {
    let mut thishash: *mut ctf_dynhash_t = if functions != 0 {
        (*fp).ctf_funchash
    } else {
        (*fp).ctf_objthash
    };
    let mut thathash: *mut ctf_dynhash_t = if functions != 0 {
        (*fp).ctf_objthash
    } else {
        (*fp).ctf_funchash
    };
    ...
    if value as uintptr_t == type_0 {
        return 0 as libc::c_int;
    }
    return -(1 as libc::c_int);
}
unsafe extern "C" fn ctf_link_deduplicating_one_symtypetab(
    mut fp: *mut ctf_dict_t,
    ...
    let mut type_0: ctf_id_t = 0;
    loop {
        type_0 = ctf_symbol_next(input, &mut it, &mut name, functions);
        if !(type_0 != -(1 as libc::c_long) as ctf_id_t) {
            break;
        }
        let mut dst_type: ctf_id_t = 0;
        let mut per_cu_out_fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
        let mut sym: libc::c_int = 0;
        dst_type = ctf_dedup_type_mapping(fp, input, type_0);
        if dst_type == -(1 as libc::c_long) as ctf_id_t {
            return -(1 as libc::c_int);
        }
        if dst_type != 0 as libc::c_int as libc::c_ulong {
            if ctf_assert_internal(
                ...
                b"ctf_type_isparent (fp, dst_type)\0" as *const u8
                    as *const libc::c_char,
                (ctf_type_isparent(fp, dst_type) != 0) as libc::c_int,
            ) as libc::c_long == 0
            {
            ...
            if sym > 0 as libc::c_int {
                if ctf_add_funcobjt_sym(fp, functions, name, dst_type) < 0 as libc::c_int
                {
                    return -(1 as libc::c_int);
                }
                continue;
        ...
        if cu_mapped != 0 {
            ctf_dprintf(
                b"Symbol %s in input file %s depends on a type %lx hidden due to conflicts: skipped.\n\0"
                    as *const u8 as *const libc::c_char,
                name,
            ...
            per_cu_out_fp = ctf_create_per_cu(fp, ctf_unnamed_cuname(input));
            if per_cu_out_fp.is_null() {
                return -(1 as libc::c_int);
            }
            if dst_type == 0 as libc::c_int as libc::c_ulong {
                dst_type = ctf_dedup_type_mapping(per_cu_out_fp, input, type_0);
                if dst_type == -(1 as libc::c_long) as ctf_id_t {
                    return -(1 as libc::c_int);
                }
                if dst_type == 0 as libc::c_int as libc::c_ulong {
                    ctf_err_warn(
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"type %lx for symbol %s in input file %s not found: skipped\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        type_0,
            ...
            if sym > 0 as libc::c_int {
                if ctf_add_funcobjt_sym(per_cu_out_fp, functions, name, dst_type)
                    < 0 as libc::c_int
                {
                    return -(1 as libc::c_int);
                }
                ...
                ctf_err_warn(
                    fp,
                    0 as libc::c_int,
                    ECTF_DUPLICATE as libc::c_int,
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"symbol %s in input file %s found conflicting even when trying in per-CU dict.\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    name,
    ...
    if ctf_errno(input) != ECTF_NEXT_END as libc::c_int {
        ...
        ctf_err_warn(
            ...
            if functions != 0 {
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"iterating over function symbols\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                )
            } else {
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"iterating over data symbols\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                )
            },
        );
...
unsafe extern "C" fn ctf_link_deduplicating_syms(
    mut fp: *mut ctf_dict_t,
    mut inputs: *mut *mut ctf_dict_t,
    mut ninputs: size_t,
    mut cu_mapped: libc::c_int,
...
unsafe extern "C" fn ctf_link_deduplicating_per_cu(
    mut fp: *mut ctf_dict_t,
) -> libc::c_int {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut err: libc::c_int = 0;
    let mut out_cu: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut in_cus: *mut libc::c_void = 0 as *mut libc::c_void;
    loop {
        err = ctf_dynhash_next(
            (*fp).ctf_link_out_cu_mapping,
            &mut i,
        ...
        let mut out_name: *const libc::c_char = out_cu as *const libc::c_char;
        let mut in_0: *mut ctf_dynhash_t = in_cus as *mut ctf_dynhash_t;
        let mut out: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
        let mut inputs: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
        let mut outputs: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
        let mut in_arc: *mut ctf_archive_t = 0 as *mut ctf_archive_t;
        let mut ninputs: ssize_t = 0;
        let mut only_input: *mut ctf_link_input_t = 0 as *mut ctf_link_input_t;
        let mut noutputs: uint32_t = 0;
        let mut parents: *mut uint32_t = 0 as *mut uint32_t;
        ninputs = ctf_link_deduplicating_count_inputs(fp, in_0, &mut only_input);
        if !(ninputs == -(1 as libc::c_int) as libc::c_long) {
            if ninputs == 0 as libc::c_int as libc::c_long {
                continue;
            }
            if labs(ninputs) > 0xfffffffe as libc::c_uint as libc::c_long {
                ctf_err_warn(
                    fp,
                    0 as libc::c_int,
                    27 as libc::c_int,
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"too many inputs in deduplicating link: %li\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    ninputs,
                );
                ctf_set_errno(fp, 27 as libc::c_int);
            } else if !only_input.is_null()
                && ninputs == 1 as libc::c_int as libc::c_long
            {
                let mut ai: *mut ctf_next_t = 0 as *mut ctf_next_t;
                let mut err_0: libc::c_int = 0;
                (*only_input)
                    .clin_fp = ctf_archive_next(
                    (*only_input).clin_arc,
                    &mut ai,
                    0 as *mut *const libc::c_char,
                    0 as libc::c_int,
                ...
                if ((*only_input).clin_fp).is_null() {
                    ctf_err_warn(
                        ...
                        dcgettext(
                            b"libctf\0" as *const u8 as *const libc::c_char,
                            b"cannot open archive %s in CU-mapped CTF link\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*only_input).clin_filename,
                    );
                    ctf_set_errno(fp, err_0);
                } else {
                    ctf_next_destroy(ai);
                    if !(strcmp((*only_input).clin_filename, out_name)
                        != 0 as libc::c_int)
                    {
                        continue;
                    }
                    ctf_cuname_set((*only_input).clin_fp, out_name);
                    if ctf_link_add_ctf_internal(
                        fp,
                        (*only_input).clin_arc,
                        (*only_input).clin_fp,
                        out_name,
                    ) < 0 as libc::c_int
                    {
                        ctf_err_warn(
                            ...
                            dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"cannot add intermediate files to link\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                        );
                    } else {
                        (*only_input).clin_arc = 0 as *mut ctf_archive_t;
                        (*only_input).clin_fp = 0 as *mut ctf_dict_t;
                        ctf_dynhash_remove(
                            (*fp).ctf_link_inputs,
                            (*only_input).clin_filename as *const libc::c_void,
                        );
                        continue;
                    }
                }
            } else {
                inputs = ctf_link_deduplicating_open_inputs(
                    fp,
                    in_0,
                    ninputs,
                    &mut parents,
                ...
                if inputs.is_null() {
                    ...
                    if out.is_null() {
                        ctf_err_warn(
                            ...
                            dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"cannot create per-CU CTF archive for %s\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            out_name,
                        ...
                        ) < 0 as libc::c_int
                        {
                            ...
                            ctf_err_warn(
                                ...
                                dcgettext(
                                    b"libctf\0" as *const u8 as *const libc::c_char,
                                    b"CU-mapped deduplication failed for %s\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                out_name,
                            ...
                            if outputs.is_null() {
                                ...
                                ctf_err_warn(
                                    ...
                                    dcgettext(
                                        b"libctf\0" as *const u8 as *const libc::c_char,
                                        b"CU-mapped deduplicating link type emission failed for %s\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    out_name,
                                ...
                                if ctf_assert_internal(
                                    ...
                                    b"noutputs == 1\0" as *const u8 as *const libc::c_char,
                                    (noutputs == 1 as libc::c_int as libc::c_uint)
                                        as libc::c_int,
                                ) as libc::c_long == 0
                                {
                                    let mut j: size_t = 0;
                                    j = 1 as libc::c_int as size_t;
                                    while j < noutputs as libc::c_ulong {
                                        ctf_dict_close(*outputs.offset(j as isize));
                                        j = j.wrapping_add(1);
                                        j;
                                    }
                                } else if (*fp).ctf_link_flags & 0x8 as libc::c_int == 0
                                    && ctf_link_deduplicating_variables(
                                        out,
                                        inputs,
                                        ninputs as size_t,
                                        1 as libc::c_int,
                                    ) < 0 as libc::c_int
                                {
                                    ...
                                    ctf_err_warn(
                                        ...
                                        dcgettext(
                                            b"libctf\0" as *const u8 as *const libc::c_char,
                                            b"CU-mapped deduplicating link variable emission failed for %s\0"
                                                as *const u8 as *const libc::c_char,
                                            5 as libc::c_int,
                                        ),
                                        out_name,
                                    ...
                                    if ctf_link_deduplicating_close_inputs(
                                        fp,
                                        in_0,
                                        inputs,
                                        ninputs,
                                    ...
                                    {
                                        free(inputs as *mut libc::c_void);
                                        free(parents as *mut libc::c_void);
                                    } else {
                                        free(inputs as *mut libc::c_void);
                                        free(parents as *mut libc::c_void);
                                        ctf_list_splice(
                                            &mut (*fp).ctf_errs_warnings,
                                            &mut (**outputs.offset(0 as libc::c_int as isize))
                                                .ctf_errs_warnings,
                                        );
                                        in_arc = ctf_new_archive_internal(
                                            0 as libc::c_int,
                                            0 as libc::c_int,
                                            0 as *mut ctf_archive,
                                            *outputs.offset(0 as libc::c_int as isize),
                                        ...
                                        if in_arc.is_null() {
                                            ctf_set_errno(fp, err);
                                        } else if ctf_link_add_ctf_internal(
                                            fp,
                                            in_arc,
                                            0 as *mut ctf_dict_t,
                                            ctf_cuname(*outputs.offset(0 as libc::c_int as isize)),
                                        ) < 0 as libc::c_int
                                        {
                                            ctf_err_warn(
                                                fp,
                                            ...
                                            ctf_dict_close(out);
                                            free(outputs as *mut libc::c_void);
                                            continue;
                                        }
                                    }
                                    ctf_list_splice(
                                    ...
                                    ctf_dict_close(*outputs.offset(0 as libc::c_int as isize));
                                    free(outputs as *mut libc::c_void);
                                    ctf_next_destroy(i);
                                    return -(1 as libc::c_int);
                                }
                ...
                ctf_link_deduplicating_close_inputs(fp, in_0, inputs, ninputs);
                ctf_dict_close(out);
                free(inputs as *mut libc::c_void);
                free(parents as *mut libc::c_void);
            }
    ...
    if err != ECTF_NEXT_END as libc::c_int {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"iteration error in CU-mapped deduplicating link\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
unsafe extern "C" fn ctf_link_deduplicating(mut fp: *mut ctf_dict_t) {
    let mut current_block: u64;
    let mut i: size_t = 0;
    let mut inputs: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut outputs: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    ...
    if ctf_dedup_atoms_init(fp) < 0 as libc::c_int {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"allocating CTF dedup atoms table\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if !((*fp).ctf_link_out_cu_mapping).is_null()
        && ctf_link_deduplicating_per_cu(fp) < 0 as libc::c_int
    {
        return;
    }
    ninputs = ctf_link_deduplicating_count_inputs(
        fp,
        0 as *mut ctf_dynhash_t,
        0 as *mut *mut ctf_link_input_t,
    );
    if ninputs < 0 as libc::c_int as libc::c_long {
        return;
    }
    ...
    if ninputs == 1 as libc::c_int as libc::c_long
        && !(ctf_cuname(*inputs.offset(0 as libc::c_int as isize))).is_null()
    {
        ctf_cuname_set(fp, ctf_cuname(*inputs.offset(0 as libc::c_int as isize)));
    }
    if ctf_dedup(fp, inputs, ninputs as uint32_t, parents, 0 as libc::c_int)
        < 0 as libc::c_int
    {
        ctf_err_warn(
            fp,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"deduplication failed for %s\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        ...
        if outputs.is_null() {
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"deduplicating link type emission failed for %s\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ctf_link_input_name(fp),
            );
        } else if ctf_assert_internal(
            fp,
            b"ctf-link.c\0" as *const u8 as *const libc::c_char,
            1270 as libc::c_int as size_t,
            b"outputs[0] == fp\0" as *const u8 as *const libc::c_char,
            (*outputs.offset(0 as libc::c_int as isize) == fp) as libc::c_int,
        ) as libc::c_long == 0
        {
            i = 1 as libc::c_int as size_t;
            while i < noutputs as libc::c_ulong {
                ctf_dict_close(*outputs.offset(i as isize));
                i = i.wrapping_add(1);
                i;
            }
        } else {
            ...
            loop {
                ...
                if i == 0 as libc::c_int as libc::c_ulong {
                    ...
                    dynname = strdup(ctf_cuname(*outputs.offset(i as isize)));
                    if dynname.is_null() {
                        current_block = 13117786329553180827;
                    } else if ctf_dynhash_insert(
                        (*fp).ctf_link_outputs,
                        dynname as *mut libc::c_void,
                        *outputs.offset(i as isize) as *mut libc::c_void,
                    ) < 0 as libc::c_int
                    {
                        current_block = 13117786329553180827;
                    } else {
                    ...
                    match current_block {
                        ...
                        _ => {
                            ...
                            ctf_err_warn(
                                ...
                                dcgettext(
                                    b"libctf\0" as *const u8 as *const libc::c_char,
                                    b"out of memory allocating link outputs\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                            );
                            ...
                            current_block = 5038898151108138287;
                            break;
                        }
                    }
                }
            ...
            match current_block {
                5038898151108138287 => {}
                _ => {
                    if (*fp).ctf_link_flags & 0x8 as libc::c_int == 0
                        && ctf_link_deduplicating_variables(
                            fp,
                            inputs,
                            ninputs as size_t,
                        ...
                        ) < 0 as libc::c_int
                    {
                        ctf_err_warn(
                            ...
                            dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"deduplicating link variable emission failed for %s\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            ctf_link_input_name(fp),
                        );
                        current_block = 6382487679675297213;
                    } else if ctf_link_deduplicating_syms(
                        fp,
                        inputs,
                        ninputs as size_t,
                        0 as libc::c_int,
                    ) < 0 as libc::c_int
                    {
                        ctf_err_warn(
                            ...
                            dcgettext(
                                b"libctf\0" as *const u8 as *const libc::c_char,
                                b"deduplicating link symbol emission failed for %s\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            ctf_link_input_name(fp),
                        ...
                        ninputs = 0 as libc::c_int as ssize_t;
                    ...
                    match current_block {
                        ...
                        _ => {
                            ...
                            while i < noutputs as libc::c_ulong {
                                ctf_dynhash_remove(
                                    (*fp).ctf_link_outputs,
                                    ctf_cuname(*outputs.offset(i as isize))
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link(
    mut fp: *mut ctf_dict_t,
    ...
    if ((*fp).ctf_link_outputs).is_null() {
        (*fp)
            .ctf_link_outputs = ctf_dynhash_create(
            Some(
                ctf_hash_string
                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
            ),
            ...
            Some(free as unsafe extern "C" fn(*mut libc::c_void) -> ()),
            ::core::mem::transmute::<
                Option::<unsafe extern "C" fn(*mut ctf_dict_t) -> ()>,
                ctf_hash_free_fun,
            >(Some(ctf_dict_close as unsafe extern "C" fn(*mut ctf_dict_t) -> ())),
        );
    }
    if ((*fp).ctf_link_outputs).is_null() {
        return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
    }
    (*fp).ctf_flags |= 0x8 as libc::c_int as libc::c_uint;
    if !((*fp).ctf_link_out_cu_mapping).is_null() && flags & 0x4 as libc::c_int != 0 {
        ...
        loop {
            ...
            let mut to: *const libc::c_char = v as *const libc::c_char;
            if (ctf_create_per_cu(fp, to)).is_null() {
                (*fp).ctf_flags &= !(0x8 as libc::c_int) as libc::c_uint;
                ctf_next_destroy(i);
                return -(1 as libc::c_int);
            }
        ...
        if err != ECTF_NEXT_END as libc::c_int {
            ...
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"iteration error creating empty CUs\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
    ...
    (*fp).ctf_flags &= !(0x8 as libc::c_int) as libc::c_uint;
    if ctf_errno(fp) != 0 as libc::c_int
        && ctf_errno(fp) != ECTF_NOCTFDATA as libc::c_int
    {
        return -(1 as libc::c_int);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn ctf_link_intern_extern_string(
    mut key: *mut libc::c_void,
    mut value: *mut libc::c_void,
    mut arg_: *mut libc::c_void,
) {
    let mut fp: *mut ctf_dict_t = value as *mut ctf_dict_t;
    let mut arg: *mut ctf_link_out_string_cb_arg_t = arg_
        as *mut ctf_link_out_string_cb_arg_t;
    (*fp).ctf_flags |= 0x4 as libc::c_int as libc::c_uint;
    if ctf_str_add_external(fp, (*arg).str_0, (*arg).offset) == 0 {
        (*arg).err = 12 as libc::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ctf_link_add_strtab(
    mut fp: *mut ctf_dict_t,
    mut add_string: Option::<ctf_link_strtab_string_f>,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    ...
    loop {
        str = add_string.expect("non-null function pointer")(&mut offset, arg);
        if str.is_null() {
            break;
        }
        let mut iter_arg: ctf_link_out_string_cb_arg_t = {
            let mut init = ctf_link_out_string_cb_arg {
                str_0: str,
                offset: offset,
                err: 0 as libc::c_int,
            };
        ...
        (*fp).ctf_flags |= 0x4 as libc::c_int as libc::c_uint;
        if ctf_str_add_external(fp, str, offset) == 0 {
            err = 12 as libc::c_int;
        }
        ctf_dynhash_iter(
            (*fp).ctf_link_outputs,
            ...
            &mut iter_arg as *mut ctf_link_out_string_cb_arg_t as *mut libc::c_void,
        );
        if iter_arg.err != 0 {
            err = iter_arg.err;
        }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link_add_linker_symbol(
    mut fp: *mut ctf_dict_t,
    mut sym: *mut ctf_link_sym_t,
) -> libc::c_int {
    let mut cid: *mut ctf_in_flight_dynsym_t = 0 as *mut ctf_in_flight_dynsym_t;
    if ctf_errno(fp) == 12 as libc::c_int {
        return -(12 as libc::c_int);
    }
    if ctf_symtab_skippable(sym) != 0 {
        return 0 as libc::c_int;
    }
    if (*sym).st_type != 1 as libc::c_int as libc::c_uint
        && (*sym).st_type != 2 as libc::c_int as libc::c_uint
    {
        return 0 as libc::c_int;
    }
    cid = malloc(::core::mem::size_of::<ctf_in_flight_dynsym_t>() as libc::c_ulong)
    ...
    if cid.is_null() {
        ...
        (*cid).cid_sym = *sym;
        ctf_list_append(&mut (*fp).ctf_in_flight_dynsyms, cid as *mut libc::c_void);
        return 0 as libc::c_int;
    };
}
#[no_mangle]
pub unsafe extern "C" fn ctf_link_shuffle_syms(mut fp: *mut ctf_dict_t) -> libc::c_int {
    let mut current_block: u64;
    ...
    let mut name_: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut sym_: *mut libc::c_void = 0 as *mut libc::c_void;
    if ((*fp).ctf_dynsyms).is_null() {
        (*fp)
            .ctf_dynsyms = ctf_dynhash_create(
            Some(
                ctf_hash_string
                    as unsafe extern "C" fn(*const libc::c_void) -> libc::c_uint,
            ),
    ...
    loop {
        ...
        let mut new_sym: *mut ctf_link_sym_t = 0 as *mut ctf_link_sym_t;
        nid = (*(did as *mut ctf_list_t)).l_next as *mut libc::c_void
            as *mut ctf_in_flight_dynsym_t;
        ctf_list_delete(&mut (*fp).ctf_in_flight_dynsyms, did as *mut libc::c_void);
        if ((*did).cid_sym.st_name).is_null() {
            let mut off: uint32_t = ((*did).cid_sym.st_nameidx
                | ((1 as libc::c_int as libc::c_uint) << 31 as libc::c_int)
                    as libc::c_ulong) as uint32_t;
            (*did).cid_sym.st_name = ctf_strraw(fp, off);
            (*did).cid_sym.st_nameidx_set = 0 as libc::c_int;
            if ctf_assert_internal(
                fp,
                b"ctf-link.c\0" as *const u8 as *const libc::c_char,
                1547 as libc::c_int as size_t,
                b"did->cid_sym.st_name != NULL\0" as *const u8 as *const libc::c_char,
                !((*did).cid_sym.st_name).is_null() as libc::c_int,
            ) as libc::c_long == 0
            {
                return -(ECTF_INTERNAL as libc::c_int);
            }
        }
        if ctf_symtab_skippable(&mut (*did).cid_sym) == 0 {
            ctf_dprintf(
                b"symbol from linker: %s (%x)\n\0" as *const u8 as *const libc::c_char,
                (*did).cid_sym.st_name,
                (*did).cid_sym.st_symidx,
            );
            new_sym = malloc(::core::mem::size_of::<ctf_link_sym_t>() as libc::c_ulong)
                as *mut ctf_link_sym_t;
            if new_sym.is_null() {
                current_block = 1777184080569693979;
            } else {
                memcpy(
                    new_sym as *mut libc::c_void,
                    &mut (*did).cid_sym as *mut ctf_link_sym_t as *const libc::c_void,
                    ::core::mem::size_of::<ctf_link_sym_t>() as libc::c_ulong,
                );
                if ctf_dynhash_cinsert(
                    (*fp).ctf_dynsyms,
                    (*new_sym).st_name as *const libc::c_void,
                    new_sym as *const libc::c_void,
                ) < 0 as libc::c_int
                {
                    current_block = 1777184080569693979;
                } else {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    free(new_sym as *mut libc::c_void);
                    current_block = 3673680990739534216;
                    break;
                }
            }
        }
    ...
    match current_block {
        10043043949733653460 => {
            if ctf_dynhash_elements((*fp).ctf_dynsyms) == 0 {
                ctf_dprintf(
                    b"No symbols: not a final link.\n\0" as *const u8
                        as *const libc::c_char,
                );
                ctf_dynhash_destroy((*fp).ctf_dynsyms);
                (*fp).ctf_dynsyms = 0 as *mut ctf_dynhash_t;
            ...
            (*fp)
                .ctf_dynsymidx = calloc(
                ((*fp).ctf_dynsymmax).wrapping_add(1 as libc::c_int as libc::c_uint)
                    as libc::c_ulong,
                ::core::mem::size_of::<*mut ctf_link_sym_t>() as libc::c_ulong,
            ) as *mut *mut ctf_link_sym_t;
            if !((*fp).ctf_dynsymidx).is_null() {
                loop {
                    err = ctf_dynhash_next(
                        (*fp).ctf_dynsyms,
                        &mut i,
                    ...
                    let mut name: *const libc::c_char = 0 as *const libc::c_char;
                    name = name;
                    let mut symp: *mut ctf_link_sym_t = sym_ as *mut ctf_link_sym_t;
                    if ctf_assert_internal(
                        fp,
                        b"ctf-link.c\0" as *const u8 as *const libc::c_char,
                        1600 as libc::c_int as size_t,
                        b"symp->st_symidx <= fp->ctf_dynsymmax\0" as *const u8
                            as *const libc::c_char,
                        ((*symp).st_symidx <= (*fp).ctf_dynsymmax) as libc::c_int,
                    ) as libc::c_long == 0
                    {
                        ctf_next_destroy(i);
                        err = ctf_errno(fp);
                        ...
                        let ref mut fresh0 = *((*fp).ctf_dynsymidx)
                            .offset((*symp).st_symidx as isize);
                        *fresh0 = symp;
                    }
                }
                match current_block {
                    ...
                    _ => {
                        if err != ECTF_NEXT_END as libc::c_int {
                            ctf_err_warn(
                                ...
                                dcgettext(
                                    b"libctf\0" as *const u8 as *const libc::c_char,
                                    b"error iterating over shuffled symbols\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                            );
    ...
    (*fp).ctf_dynsymmax = 0 as libc::c_int as uint32_t;
    ctf_set_errno(fp, err);
    return -err;
}
unsafe extern "C" fn ctf_accumulate_archive_names(
    mut key: *mut libc::c_void,
    mut value: *mut libc::c_void,
    mut arg_: *mut libc::c_void,
) {
    ...
    let mut files: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut arg: *mut ctf_name_list_accum_cb_arg_t = arg_
        as *mut ctf_name_list_accum_cb_arg_t;
    (*arg).i = ((*arg).i).wrapping_add(1);
    names = realloc(
        (*arg).names as *mut libc::c_void,
        (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
            .wrapping_mul((*arg).i),
    ) as *mut *mut libc::c_char;
    if names.is_null() {
        (*arg).i = ((*arg).i).wrapping_sub(1);
        (*arg).i;
        ctf_set_errno((*arg).fp, 12 as libc::c_int);
        return;
    }
    files = realloc(
        (*arg).files as *mut libc::c_void,
        (::core::mem::size_of::<*mut ctf_dict_t>() as libc::c_ulong)
            .wrapping_mul((*arg).i),
    ) as *mut *mut ctf_dict_t;
    if files.is_null() {
    ...
    if ((*fp).ctf_link_memb_name_changer).is_some() {
        let mut dynames: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
        let mut dyname: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut nc_arg: *mut libc::c_void = (*fp).ctf_link_memb_name_changer_arg;
        dyname = ((*fp).ctf_link_memb_name_changer)
            .expect("non-null function pointer")(fp, name, nc_arg);
        if !dyname.is_null() {
            (*arg).ndynames = ((*arg).ndynames).wrapping_add(1);
            dynames = realloc(
                (*arg).dynames as *mut libc::c_void,
                (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
                    .wrapping_mul((*arg).ndynames),
            ) as *mut *mut libc::c_char;
            if dynames.is_null() {
                (*arg).ndynames = ((*arg).ndynames).wrapping_sub(1);
                (*arg).ndynames;
                ctf_set_errno((*arg).fp, 12 as libc::c_int);
                return;
            }
            (*arg).dynames = dynames;
            name = dyname as *const libc::c_char;
        }
    }
    (*arg).names = names;
    let ref mut fresh1 = *((*arg).names)
        .offset(((*arg).i).wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize);
    *fresh1 = name as *mut libc::c_char;
    (*arg).files = files;
    let ref mut fresh2 = *((*arg).files)
        .offset(((*arg).i).wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize);
    *fresh2 = fp;
}
unsafe extern "C" fn ctf_change_parent_name(
    mut key: *mut libc::c_void,
    mut value: *mut libc::c_void,
    mut arg: *mut libc::c_void,
) {
    let mut fp: *mut ctf_dict_t = value as *mut ctf_dict_t;
    let mut name: *const libc::c_char = arg as *const libc::c_char;
    ctf_parent_name_set(fp, name);
}
unsafe extern "C" fn ctf_link_warn_outdated_inputs(mut fp: *mut ctf_dict_t) {
    let mut i: *mut ctf_next_t = 0 as *mut ctf_next_t;
    let mut name_: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut ifp_: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut err: libc::c_int = 0;
    loop {
        err = ctf_dynhash_next((*fp).ctf_link_inputs, &mut i, &mut name_, &mut ifp_);
        if !(err == 0 as libc::c_int) {
            break;
        }
        let mut name: *const libc::c_char = name_ as *const libc::c_char;
        let mut ifp: *mut ctf_dict_t = ifp_ as *mut ctf_dict_t;
        if (*(*ifp).ctf_header).cth_preamble.ctp_flags as libc::c_int
            & 0x2 as libc::c_int == 0
            && ((*(*ifp).ctf_header).cth_varoff)
                .wrapping_sub((*(*ifp).ctf_header).cth_funcoff)
                > 0 as libc::c_int as libc::c_uint
        {
            ctf_err_warn(
                ...
                dcgettext(
                    b"libctf\0" as *const u8 as *const libc::c_char,
                    b"linker input %s has CTF func info but uses an old, unreleased func info format: this func info section will be dropped.\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                name,
    ...
    if err != ECTF_NEXT_END as libc::c_int {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"error checking for outdated inputs\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
#[no_mangle]
pub unsafe extern "C" fn ctf_link_write(
    mut fp: *mut ctf_dict_t,
    mut size: *mut size_t,
    mut threshold: size_t,
) -> *mut libc::c_uchar {
    let mut current_block: u64;
    let mut arg: ctf_name_list_accum_cb_arg_t = ctf_name_list_accum_cb_arg_t {
        names: 0 as *mut *mut libc::c_char,
        fp: 0 as *mut ctf_dict_t,
        files: 0 as *mut *mut ctf_dict_t,
        i: 0,
        dynames: 0 as *mut *mut libc::c_char,
        ndynames: 0,
    };
    let mut names: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    let mut transformed_name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut files: *mut *mut ctf_dict_t = 0 as *mut *mut ctf_dict_t;
    let mut f: *mut FILE = 0 as *mut FILE;
    let mut i: size_t = 0;
    let mut err: libc::c_int = 0;
    let mut fsize: libc::c_long = 0;
    let mut errloc: *const libc::c_char = 0 as *const libc::c_char;
    let mut buf: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    memset(
        &mut arg as *mut ctf_name_list_accum_cb_arg_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<ctf_name_list_accum_cb_arg_t>() as libc::c_ulong,
    );
    arg.fp = fp;
    (*fp).ctf_flags |= 0x8 as libc::c_int as libc::c_uint;
    ...
    if !((*fp).ctf_link_outputs).is_null() {
        ...
        if ctf_errno(fp) < 0 as libc::c_int {
            errloc = b"hash creation\0" as *const u8 as *const libc::c_char;
            current_block = 2219782988658378004;
        } else {
    ...
    match current_block {
        1917311967535052937 => {
            if arg.i == 0 as libc::c_int as libc::c_ulong {
                let mut ret: *mut libc::c_uchar = ctf_write_mem(fp, size, threshold);
                (*fp).ctf_flags &= !(0x8 as libc::c_int) as libc::c_uint;
                return ret;
            }
            names = realloc(
                ...
                (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
                    .wrapping_mul(
                        (arg.i).wrapping_add(1 as libc::c_int as libc::c_ulong),
                    ),
            ) as *mut *mut libc::c_char;
            if names.is_null() {
                errloc = b"name reallocation\0" as *const u8 as *const libc::c_char;
                current_block = 6286570896226390410;
            } else {
                arg.names = names;
                memmove(
                    &mut *(arg.names).offset(1 as libc::c_int as isize)
                        as *mut *mut libc::c_char as *mut libc::c_void,
                    arg.names as *const libc::c_void,
                    (::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
                        .wrapping_mul(arg.i),
                );
                let ref mut fresh3 = *(arg.names).offset(0 as libc::c_int as isize);
                *fresh3 = _CTF_SECTION.as_ptr() as *mut libc::c_char;
                if ((*fp).ctf_link_memb_name_changer).is_some() {
                    let mut nc_arg: *mut libc::c_void = (*fp)
                        .ctf_link_memb_name_changer_arg;
                    transformed_name = ((*fp).ctf_link_memb_name_changer)
                        .expect(
                            "non-null function pointer",
                        )(fp, _CTF_SECTION.as_ptr(), nc_arg);
                    if !transformed_name.is_null() {
                        let ref mut fresh4 = *(arg.names)
                            .offset(0 as libc::c_int as isize);
                        *fresh4 = transformed_name;
                        ctf_dynhash_iter(
                            (*fp).ctf_link_outputs,
                            Some(
                            ...
                            transformed_name as *mut libc::c_void,
                        );
                    }
                }
                i = 0 as libc::c_int as size_t;
                while i < arg.i {
                    (**(arg.files).offset(i as isize))
                        .ctf_link_flags = (*fp).ctf_link_flags;
                    let ref mut fresh5 = (**(arg.files).offset(i as isize)).ctf_flags;
                    *fresh5 |= 0x8 as libc::c_int as libc::c_uint;
                    i = i.wrapping_add(1);
                    i;
                }
                files = realloc(
                    arg.files as *mut libc::c_void,
                    (::core::mem::size_of::<*mut ctf_dict>() as libc::c_ulong)
                        .wrapping_mul(
                            (arg.i).wrapping_add(1 as libc::c_int as libc::c_ulong),
                        ),
                ) as *mut *mut ctf_dict_t;
                if files.is_null() {
                    errloc = b"ctf_dict reallocation\0" as *const u8
                        as *const libc::c_char;
                    current_block = 6286570896226390410;
                } else {
                    arg.files = files;
                    memmove(
                        &mut *(arg.files).offset(1 as libc::c_int as isize)
                            as *mut *mut ctf_dict_t as *mut libc::c_void,
                        arg.files as *const libc::c_void,
                        (::core::mem::size_of::<*mut ctf_dict_t>() as libc::c_ulong)
                            .wrapping_mul(arg.i),
                    );
                    let ref mut fresh6 = *(arg.files).offset(0 as libc::c_int as isize);
                    *fresh6 = fp;
                    f = tmpfile();
                    if f.is_null() {
                        errloc = b"tempfile creation\0" as *const u8
                            as *const libc::c_char;
                        current_block = 6286570896226390410;
                    } else {
                        err = ctf_arc_write_fd(
                            fileno(f),
                            arg.files,
                            (arg.i).wrapping_add(1 as libc::c_int as libc::c_ulong),
                            arg.names as *mut *const libc::c_char,
                            threshold,
                        );
                        if err < 0 as libc::c_int {
                            errloc = b"archive writing\0" as *const u8
                                as *const libc::c_char;
                            ctf_set_errno(fp, err);
                            current_block = 2219782988658378004;
                        } else {
                            ...
                            {
                                errloc = b"seeking to end\0" as *const u8
                                    as *const libc::c_char;
                            } else {
                                fsize = ftell(f);
                                if fsize < 0 as libc::c_int as libc::c_long {
                                    errloc = b"filesize determination\0" as *const u8
                                        as *const libc::c_char;
                                } else if fseek(
                                    f,
                                    0 as libc::c_int as libc::c_long,
                                ...
                                {
                                    errloc = b"filepos resetting\0" as *const u8
                                        as *const libc::c_char;
                                } else {
                                    buf = malloc(fsize as libc::c_ulong) as *mut libc::c_uchar;
                                    if buf.is_null() {
                                        errloc = b"CTF archive buffer allocation\0" as *const u8
                                            as *const libc::c_char;
                                    } else {
                                        loop {
                                            if !(feof(f) == 0
                                            ...
                                            errloc = b"reading archive from temporary file\0"
                                                as *const u8 as *const libc::c_char;
                                            current_block = 6286570896226390410;
                                            break;
                                        }
                                        match current_block {
                                            6286570896226390410 => {}
                                            _ => {
                                                *size = fsize as size_t;
                                                free(arg.names as *mut libc::c_void);
                                                free(arg.files as *mut libc::c_void);
                                                free(transformed_name as *mut libc::c_void);
                                                if arg.ndynames != 0 {
                                                    let mut i_0: size_t = 0;
                                                    i_0 = 0 as libc::c_int as size_t;
                                                    while i_0 < arg.ndynames {
                                                        free(
                                                            *(arg.dynames).offset(i_0 as isize) as *mut libc::c_void,
                                                        );
                                                        i_0 = i_0.wrapping_add(1);
                                                        i_0;
                                                    }
                                                    free(arg.dynames as *mut libc::c_void);
                                                }
                                                fclose(f);
                                                return buf;
                                            }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    i = 0 as libc::c_int as size_t;
                    while i < arg.i {
                        let ref mut fresh7 = (**(arg.files).offset(i as isize))
                            .ctf_flags;
                        *fresh7 &= !(0x8 as libc::c_int) as libc::c_uint;
                        i = i.wrapping_add(1);
                        i;
                    }
                }
    ...
    if arg.ndynames != 0 {
        ...
        while i_1 < arg.ndynames {
            free(*(arg.dynames).offset(i_1 as isize) as *mut libc::c_void);
    ...
    ctf_err_warn(
        ...
        dcgettext(
            b"libctf\0" as *const u8 as *const libc::c_char,
            b"cannot write archive in link: %s failure\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
        errloc,
