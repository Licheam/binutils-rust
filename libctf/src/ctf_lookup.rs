...
extern "C" {
    ...
    static _CTF_NULLSTR: [libc::c_char; 0];
    ...
    fn ctf_get_dict(fp: *mut ctf_dict_t, type_0: ctf_id_t) -> *mut ctf_dict_t;
    fn __assert_fail(
...
>;
pub type ctf_lookup_idx_key_t = ctf_lookup_idx_key;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_lookup_idx_key {
    pub clik_fp: *mut ctf_dict_t,
    pub clik_name: *const libc::c_char,
    pub clik_names: *mut uint32_t,
}
pub type ctf_symidx_sort_arg_cb_t = ctf_symidx_sort_arg_cb;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ctf_symidx_sort_arg_cb {
    pub fp: *mut ctf_dict_t,
    pub names: *mut uint32_t,
}
pub const _ISspace: C2RustUnnamed_9 = 8192;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct qual {
    pub q_name: *const libc::c_char,
    pub q_len: size_t,
}
...
unsafe extern "C" fn grow_pptrtab(
    mut fp: *mut ctf_dict_t,
    mut new_len: size_t,
) -> libc::c_int {
    let mut new_pptrtab: *mut uint32_t = 0 as *mut uint32_t;
    new_pptrtab = realloc(
        (*fp).ctf_pptrtab as *mut libc::c_void,
        (::core::mem::size_of::<uint32_t>() as libc::c_ulong).wrapping_mul(new_len),
    ) as *mut uint32_t;
    if new_pptrtab.is_null() {
        return ctf_set_errno(fp, 12 as libc::c_int) as libc::c_int;
    }
    (*fp).ctf_pptrtab = new_pptrtab;
    memset(
        ((*fp).ctf_pptrtab).offset((*fp).ctf_pptrtab_len as isize) as *mut libc::c_void,
        0 as libc::c_int,
        (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
            .wrapping_mul(new_len.wrapping_sub((*fp).ctf_pptrtab_len)),
    );
    (*fp).ctf_pptrtab_len = new_len;
    return 0 as libc::c_int;
}
unsafe extern "C" fn refresh_pptrtab(
    mut fp: *mut ctf_dict_t,
    mut pfp: *mut ctf_dict_t,
) -> libc::c_int {
    let mut i: uint32_t = 0;
    i = (*fp).ctf_pptrtab_typemax;
    while i as libc::c_ulong <= (*fp).ctf_typemax {
        let mut type_0: ctf_id_t = (if 1 as libc::c_int != 0 {
            i | ((*fp).ctf_parmax).wrapping_add(1 as libc::c_int as libc::c_uint)
        } else {
            i
        }) as ctf_id_t;
        let mut reffed_type: ctf_id_t = 0;
        if !(ctf_type_kind(fp, type_0) != 3 as libc::c_int) {
            reffed_type = ctf_type_reference(fp, type_0);
            if reffed_type <= (*fp).ctf_parmax as libc::c_ulong {
                let mut idx: uint32_t = (reffed_type & (*fp).ctf_parmax as libc::c_ulong)
                    as uint32_t;
                if idx as libc::c_ulong <= (*pfp).ctf_typemax {
                    if idx as libc::c_ulong >= (*fp).ctf_pptrtab_len
                        && grow_pptrtab(fp, (*pfp).ctf_ptrtab_len) < 0 as libc::c_int
                    {
                        return -(1 as libc::c_int);
                    }
                    *((*fp).ctf_pptrtab).offset(idx as isize) = i;
                }
            }
        }
        i = i.wrapping_add(1);
    ...
    (*fp).ctf_pptrtab_typemax = (*fp).ctf_typemax as uint32_t;
    return 0 as libc::c_int;
}
unsafe extern "C" fn isqualifier(
    mut s: *const libc::c_char,
    mut len: size_t,
) -> libc::c_int {
    static mut qhash: [qual; 21] = [
        {
            let mut init = qual {
                q_name: b"static\0" as *const u8 as *const libc::c_char,
                q_len: 6 as libc::c_int as size_t,
            };
            init
        },
        {
            let mut init = qual {
                q_name: b"\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = qual {
                q_name: b"volatile\0" as *const u8 as *const libc::c_char,
                q_len: 8 as libc::c_int as size_t,
            };
            init
        },
        {
        ...
        {
            let mut init = qual {
                q_name: b"auto\0" as *const u8 as *const libc::c_char,
                q_len: 4 as libc::c_int as size_t,
            };
            init
        },
        {
            let mut init = qual {
                q_name: b"extern\0" as *const u8 as *const libc::c_char,
                q_len: 6 as libc::c_int as size_t,
            };
            init
        },
        ...
        {
            let mut init = qual {
                q_name: b"const\0" as *const u8 as *const libc::c_char,
                q_len: 5 as libc::c_int as size_t,
            };
            init
        },
        {
            let mut init = qual {
                q_name: b"register\0" as *const u8 as *const libc::c_char,
                q_len: 8 as libc::c_int as size_t,
            };
            init
        },
        ...
        {
            let mut init = qual {
                q_name: b"restrict\0" as *const u8 as *const libc::c_char,
                q_len: 8 as libc::c_int as size_t,
            };
            init
        },
        {
            let mut init = qual {
                q_name: b"_Restrict\0" as *const u8 as *const libc::c_char,
                q_len: 9 as libc::c_int as size_t,
            };
            init
        },
    ];
    let mut h: libc::c_int = *s
        .offset(len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
        as libc::c_int + len as libc::c_int - 105 as libc::c_int;
    let mut qp: *const qual = 0 as *const qual;
    if h < 0 as libc::c_int
        || h as size_t
            >= (::core::mem::size_of::<[qual; 21]>() as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<qual>() as libc::c_ulong)
    {
        return 0 as libc::c_int;
    }
    qp = &*qhash.as_ptr().offset(h as isize) as *const qual;
    return (len == (*qp).q_len
        && strncmp((*qp).q_name, s, (*qp).q_len) == 0 as libc::c_int) as libc::c_int;
}
unsafe extern "C" fn ctf_lookup_by_name_internal(
    mut fp: *mut ctf_dict_t,
    mut child: *mut ctf_dict_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    let mut current_block: u64;
    static mut delimiters: [libc::c_char; 8] = unsafe {
        *::core::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b" \t\n\r\x0B\x0C*\0")
    };
    let mut lp: *const ctf_lookup_t = 0 as *const ctf_lookup_t;
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
    let mut q: *const libc::c_char = 0 as *const libc::c_char;
    let mut end: *const libc::c_char = 0 as *const libc::c_char;
    let mut type_0: ctf_id_t = 0 as libc::c_int as ctf_id_t;
    let mut ntype: ctf_id_t = 0;
    let mut ptype: ctf_id_t = 0;
    if name.is_null() {
        return ctf_set_errno(fp, 22 as libc::c_int);
    }
    p = name;
    end = name.offset(strlen(name) as isize);
    's_19: loop {
        ...
        q = strpbrk(p.offset(1 as libc::c_int as isize), delimiters.as_ptr());
        if q.is_null() {
            q = end;
        }
        if *p as libc::c_int == '*' as i32 {
            let mut idx: uint32_t = (type_0 & (*fp).ctf_parmax as libc::c_ulong)
                as uint32_t;
            let mut in_child: libc::c_int = 0 as libc::c_int;
            ntype = -(1 as libc::c_long) as ctf_id_t;
            if !child.is_null() && idx as libc::c_ulong <= (*child).ctf_pptrtab_len {
                ntype = *((*child).ctf_pptrtab).offset(idx as isize) as ctf_id_t;
                if ntype != 0 {
                    in_child = 1 as libc::c_int;
                } else {
                    ntype = -(1 as libc::c_long) as ctf_id_t;
                }
            }
            if ntype == -(1 as libc::c_long) as ctf_id_t {
                ntype = *((*fp).ctf_ptrtab).offset(idx as isize) as ctf_id_t;
            ...
            if ntype == -(1 as libc::c_long) as ctf_id_t {
                if !child.is_null() {
                    ntype = ctf_type_resolve_unsliced(child, type_0);
                } else {
                    ntype = ctf_type_resolve_unsliced(fp, type_0);
                }
                if ntype == -(1 as libc::c_long) as ctf_id_t {
                    current_block = 282963868010494666;
                    break;
                }
                idx = (ntype & (*fp).ctf_parmax as libc::c_ulong) as uint32_t;
                ntype = -(1 as libc::c_long) as ctf_id_t;
                if !child.is_null() && idx as libc::c_ulong <= (*child).ctf_pptrtab_len {
                    ntype = *((*child).ctf_pptrtab).offset(idx as isize) as ctf_id_t;
                    if ntype != 0 {
            ...
            if in_child != 0 {
                fp = child;
                child = 0 as *mut ctf_dict_t;
            }
            q = p.offset(1 as libc::c_int as isize);
        } else if !(isqualifier(p, q.offset_from(p) as libc::c_long as size_t) != 0) {
            lp = ((*fp).ctf_lookups).as_mut_ptr();
            while !((*lp).ctl_prefix).is_null() {
                if (*((*lp).ctl_prefix).offset(0 as libc::c_int as isize) as libc::c_int
                    == '\0' as i32
                    || strncmp(
                        p,
                        (*lp).ctl_prefix,
                    ...
                    && q.offset_from(p) as libc::c_long as size_t >= (*lp).ctl_len
                {
                    p = p.offset((*lp).ctl_len as isize);
                    ...
                    if (*fp).ctf_tmp_typeslicelen
                        >= (q.offset_from(p) as libc::c_long as size_t)
                            .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    {
                        memcpy(
                            (*fp).ctf_tmp_typeslice as *mut libc::c_void,
                            p as *const libc::c_void,
                            q.offset_from(p) as libc::c_long as size_t,
                        );
                        *((*fp).ctf_tmp_typeslice)
                            .offset(
                                q.offset_from(p) as libc::c_long as size_t as isize,
                            ) = '\0' as i32 as libc::c_char;
                    } else {
                        free((*fp).ctf_tmp_typeslice as *mut libc::c_void);
                        (*fp)
                            .ctf_tmp_typeslice = xstrndup(
                            p,
                            q.offset_from(p) as libc::c_long as size_t,
                        );
                        if ((*fp).ctf_tmp_typeslice).is_null() {
                            ctf_set_errno(fp, 12 as libc::c_int);
                            return -(1 as libc::c_long) as ctf_id_t;
                        }
                    }
                    type_0 = ctf_lookup_by_rawhash(
                        fp,
                        (*lp).ctl_hash,
                        (*fp).ctf_tmp_typeslice,
                    );
    ...
    match current_block {
        282963868010494666 => {
            ctf_set_errno(fp, ECTF_NOTYPE as libc::c_int);
            if !((*fp).ctf_parent).is_null() {
                if ((*fp).ctf_pptrtab_typemax as libc::c_ulong) < (*fp).ctf_typemax {
                    if refresh_pptrtab(fp, (*fp).ctf_parent) < 0 as libc::c_int {
                        return -(1 as libc::c_int) as ctf_id_t;
                    }
                }
                ptype = ctf_lookup_by_name_internal((*fp).ctf_parent, fp, name);
                if ptype != -(1 as libc::c_long) as ctf_id_t {
                    return ptype;
                }
        ...
        _ => {
            if *p as libc::c_int != '\0' as i32
                || type_0 == 0 as libc::c_int as libc::c_ulong
            {
                return ctf_set_errno(fp, ECTF_SYNTAX as libc::c_int);
            }
            return type_0;
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_by_name(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    return ctf_lookup_by_name_internal(fp, 0 as *mut ctf_dict_t, name);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_by_id(
    mut fpp: *mut *mut ctf_dict_t,
    mut type_0: ctf_id_t,
) -> *const ctf_type_t {
    let mut fp: *mut ctf_dict_t = *fpp;
    let mut idx: ctf_id_t = 0;
    fp = ctf_get_dict(fp, type_0);
    if fp.is_null() {
        ctf_set_errno(*fpp, ECTF_NOPARENT as libc::c_int);
        return 0 as *const ctf_type_t;
    }
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0 {
        ...
        if !dtd.is_null() {
            *fpp = fp;
            return &mut (*dtd).dtd_data;
        }
        ctf_set_errno(*fpp, ECTF_BADID as libc::c_int);
        return 0 as *const ctf_type_t;
    }
    idx = type_0 & (*fp).ctf_parmax as libc::c_ulong;
    if idx > 0 as libc::c_int as libc::c_ulong && idx <= (*fp).ctf_typemax {
        *fpp = fp;
        return if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0 {
            &mut (*(ctf_dtd_lookup
            ...
            ((*fp).ctf_buf as uintptr_t)
                .wrapping_add(*((*fp).ctf_txlate).offset(idx as isize) as libc::c_ulong)
                as *mut ctf_type_t
        };
    }
    ctf_set_errno(*fpp, ECTF_BADID as libc::c_int);
...
unsafe extern "C" fn ctf_lookup_var(
    mut key_: *const libc::c_void,
    mut lookup_: *const libc::c_void,
) -> libc::c_int {
    let mut key: *const ctf_lookup_idx_key_t = key_ as *const ctf_lookup_idx_key_t;
    let mut lookup: *const ctf_varent_t = lookup_ as *const ctf_varent_t;
    return strcmp((*key).clik_name, ctf_strptr((*key).clik_fp, (*lookup).ctv_name));
}
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_variable(
    mut fp: *mut ctf_dict_t,
    mut name: *const libc::c_char,
) -> ctf_id_t {
    let mut ent: *mut ctf_varent_t = 0 as *mut ctf_varent_t;
    let mut key: ctf_lookup_idx_key_t = {
        let mut init = ctf_lookup_idx_key {
            clik_fp: fp,
            clik_name: name,
            clik_names: 0 as *mut uint32_t,
        };
        init
    };
    ent = bsearch(
        &mut key as *mut ctf_lookup_idx_key_t as *const libc::c_void,
        (*fp).ctf_vars as *const libc::c_void,
        (*fp).ctf_nvars,
    ...
    if ent.is_null() {
        ...
        return ctf_set_errno(fp, ECTF_NOTYPEDAT as libc::c_int);
    }
    return (*ent).ctv_type as ctf_id_t;
}
unsafe extern "C" fn sort_symidx_by_name(
    mut one_: *const libc::c_void,
    mut two_: *const libc::c_void,
    mut arg_: *mut libc::c_void,
) -> libc::c_int {
    let mut one: *const uint32_t = one_ as *const uint32_t;
    let mut two: *const uint32_t = two_ as *const uint32_t;
    let mut arg: *mut ctf_symidx_sort_arg_cb_t = arg_ as *mut ctf_symidx_sort_arg_cb_t;
    return strcmp(
        ctf_strptr((*arg).fp, *((*arg).names).offset(*one as isize)),
        ctf_strptr((*arg).fp, *((*arg).names).offset(*two as isize)),
    );
}
unsafe extern "C" fn ctf_symidx_sort(
    mut fp: *mut ctf_dict_t,
    mut idx: *mut uint32_t,
    mut nidx: *mut size_t,
    mut len: size_t,
) -> *mut uint32_t {
    let mut sorted: *mut uint32_t = 0 as *mut uint32_t;
    let mut i: size_t = 0;
    sorted = malloc(len) as *mut uint32_t;
    if sorted.is_null() {
        ctf_set_errno(fp, 12 as libc::c_int);
        return 0 as *mut uint32_t;
    }
    *nidx = len.wrapping_div(::core::mem::size_of::<uint32_t>() as libc::c_ulong);
    i = 0 as libc::c_int as size_t;
    while i < *nidx {
        *sorted.offset(i as isize) = i as uint32_t;
        i = i.wrapping_add(1);
        i;
    }
    if (*(*fp).ctf_header).cth_preamble.ctp_flags as libc::c_int & 0x4 as libc::c_int
        == 0
    {
        let mut arg: ctf_symidx_sort_arg_cb_t = {
            let mut init = ctf_symidx_sort_arg_cb {
                fp: fp,
                names: idx,
            };
            init
        ...
        ctf_dprintf(
            b"Index section unsorted: sorting.\0" as *const u8 as *const libc::c_char,
        );
        ctf_qsort_r(
            ...
            *nidx,
            ...
            &mut arg as *mut ctf_symidx_sort_arg_cb_t as *mut libc::c_void,
        );
        (*(*fp).ctf_header)
            .cth_preamble
            .ctp_flags = ((*(*fp).ctf_header).cth_preamble.ctp_flags as libc::c_int
            | 0x4 as libc::c_int) as libc::c_uchar;
    }
    return sorted;
}
unsafe extern "C" fn ctf_lookup_symbol_name(
    mut fp: *mut ctf_dict_t,
    mut symidx: libc::c_ulong,
) -> *const libc::c_char {
    let mut sp: *const ctf_sect_t = &mut (*fp).ctf_symtab;
    ...
    if !((*fp).ctf_dynsymidx).is_null() {
        ...
        if !(symidx > (*fp).ctf_dynsymmax as libc::c_ulong) {
            let mut symp: *mut ctf_link_sym_t = *((*fp).ctf_dynsymidx)
        ...
        err = ECTF_NOSYMTAB as libc::c_int;
        if !((*sp).cts_data).is_null() {
            if !(symidx >= (*fp).ctf_nsyms) {
                match (*sp).cts_entsize {
                    24 => {
                        let mut symp_0: *const Elf64_Sym = ((*sp).cts_data
                            as *mut Elf64_Sym)
                            .offset(symidx as isize);
                        ctf_elf64_to_link_sym(fp, &mut sym, symp_0, symidx as uint32_t);
                    }
                    16 => {
                        let mut symp_1: *const Elf32_Sym = ((*sp).cts_data
                            as *mut Elf32_Sym)
                            .offset(symidx as isize);
                        ctf_elf32_to_link_sym(fp, &mut sym, symp_1, symidx as uint32_t);
                    }
                    _ => {
                        ctf_set_errno(fp, ECTF_SYMTAB as libc::c_int);
                        return _CTF_NULLSTR.as_ptr();
                    }
                }
                if sym.st_nameidx_set == 0 {} else {
                    __assert_fail(
                        b"!sym.st_nameidx_set\0" as *const u8 as *const libc::c_char,
                        b"ctf-lookup.c\0" as *const u8 as *const libc::c_char,
                        513 as libc::c_int as libc::c_uint,
                        (*::core::mem::transmute::<
                            &[u8; 64],
                            &[libc::c_char; 64],
                        >(
                            b"const char *ctf_lookup_symbol_name(ctf_dict_t *, unsigned long)\0",
                        ))
                            .as_ptr(),
                    );
                }
...
unsafe extern "C" fn ctf_lookup_symbol_idx(
    mut fp: *mut ctf_dict_t,
    ...
    let mut known_idx: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut err: libc::c_int = 0;
    let mut cache: *mut ctf_dict_t = fp;
    if !((*fp).ctf_dynsyms).is_null() {
        err = 22 as libc::c_int;
        let mut symp: *mut ctf_link_sym_t = 0 as *mut ctf_link_sym_t;
        symp = ctf_dynhash_lookup((*fp).ctf_dynsyms, symname as *const libc::c_void)
            as *mut ctf_link_sym_t;
        if !symp.is_null() {
            return (*symp).st_symidx as libc::c_ulong;
        }
    } else {
        err = ECTF_NOSYMTAB as libc::c_int;
        if !((*sp).cts_data).is_null() {
            if !((*fp).ctf_archive).is_null()
                && !((*(*fp).ctf_archive).ctfi_crossdict_cache).is_null()
            {
                cache = (*(*fp).ctf_archive).ctfi_crossdict_cache;
            }
            if ((*cache).ctf_symhash).is_null() {
                (*cache)
                    .ctf_symhash = ctf_dynhash_create(
                    Some(
                        ctf_hash_string
                ...
                if ((*cache).ctf_symhash).is_null() {
                    current_block = 2545561551164568745;
                } else {
            ...
            match current_block {
                13109137661213826276 => {
                    ...
                    {
                        return known_idx as uintptr_t;
                    }
                    loop {
                        if !((*cache).ctf_symhash_latest
                            < ((*sp).cts_size).wrapping_div((*sp).cts_entsize))
                        {
                        ...
                        match (*sp).cts_entsize {
                            24 => {
                                let mut symp_0: *mut Elf64_Sym = (*sp).cts_data
                                    as *mut Elf64_Sym;
                                ctf_elf64_to_link_sym(
                                    fp,
                                    &mut sym,
                                    &mut *symp_0.offset((*cache).ctf_symhash_latest as isize),
                                    (*cache).ctf_symhash_latest as uint32_t,
                                );
                                if ctf_dynhash_lookup_kv(
                                    (*cache).ctf_symhash,
                                    sym.st_name as *const libc::c_void,
                                    0 as *mut *const libc::c_void,
                                ...
                                ) == 0
                                {
                                    if ctf_dynhash_cinsert(
                                        (*cache).ctf_symhash,
                                        sym.st_name as *const libc::c_void,
                                        (*cache).ctf_symhash_latest as *const libc::c_void,
                                    ) < 0 as libc::c_int
                                    {
                                        current_block = 2545561551164568745;
                                        break;
                                ...
                                if strcmp(sym.st_name, symname) == 0 as libc::c_int {
                                    let fresh0 = (*cache).ctf_symhash_latest;
                                    (*cache)
                                        .ctf_symhash_latest = ((*cache).ctf_symhash_latest)
                                        .wrapping_add(1);
                                    return fresh0;
                                }
                            }
                            16 => {
                                let mut symp_1: *mut Elf32_Sym = (*sp).cts_data
                                    as *mut Elf32_Sym;
                                ctf_elf32_to_link_sym(
                                    fp,
                                    &mut sym,
                                    &mut *symp_1.offset((*cache).ctf_symhash_latest as isize),
                                    (*cache).ctf_symhash_latest as uint32_t,
                                );
                                if ctf_dynhash_lookup_kv(
                                    (*cache).ctf_symhash,
                                ...
                                if strcmp(sym.st_name, symname) == 0 as libc::c_int {
                                    let fresh1 = (*cache).ctf_symhash_latest;
                                    (*cache)
                                        .ctf_symhash_latest = ((*cache).ctf_symhash_latest)
                                        .wrapping_add(1);
                                    return fresh1;
                    ...
                    match current_block {
                        2545561551164568745 => {}
                        _ => return -(1 as libc::c_int) as libc::c_ulong,
                    }
                }
                _ => {}
            }
            ...
            ctf_err_warn(
                ...
                dcgettext(
                    ...
                    b"cannot allocate memory for symbol lookup hashtab\0" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn ctf_symbol_next(
    mut fp: *mut ctf_dict_t,
    ...
    if (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0 {
        let mut dynh: *mut ctf_dynhash_t = if functions != 0 {
            (*fp).ctf_funchash
        } else {
            (*fp).ctf_objthash
        };
        let mut dyn_name: *mut libc::c_void = 0 as *mut libc::c_void;
        let mut dyn_value: *mut libc::c_void = 0 as *mut libc::c_void;
        if dynh.is_null() {
            ctf_next_destroy(i);
            return ctf_set_errno(fp, ECTF_NEXT_END as libc::c_int);
        }
        err = ctf_dynhash_next(dynh, &mut (*i).ctn_next, &mut dyn_name, &mut dyn_value);
        if err != 0 as libc::c_int {
            ctf_next_destroy(i);
            *it = 0 as *mut ctf_next_t;
            return ctf_set_errno(fp, err);
        }
        *name = dyn_name as *const libc::c_char;
        sym = dyn_value as uintptr_t;
    } else {
        if functions == 0 && !((*fp).ctf_objtidx_names).is_null()
            || functions != 0 && !((*fp).ctf_funcidx_names).is_null()
        {
            let mut hp: *mut ctf_header_t = (*fp).ctf_header;
            let mut idx: *mut uint32_t = if functions != 0 {
                (*fp).ctf_funcidx_names
            } else {
                (*fp).ctf_objtidx_names
            };
            let mut tab: *mut uint32_t = 0 as *mut uint32_t;
            let mut len: size_t = 0;
            if functions != 0 {
                len = (((*hp).cth_varoff).wrapping_sub((*hp).cth_funcidxoff)
                    as libc::c_ulong)
                    .wrapping_div(::core::mem::size_of::<uint32_t>() as libc::c_ulong);
                tab = ((*fp).ctf_buf).offset((*hp).cth_funcoff as isize)
                    as *mut uint32_t;
            } else {
                len = (((*hp).cth_funcidxoff).wrapping_sub((*hp).cth_objtidxoff)
                    as libc::c_ulong)
                    .wrapping_div(::core::mem::size_of::<uint32_t>() as libc::c_ulong);
                tab = ((*fp).ctf_buf).offset((*hp).cth_objtoff as isize)
                    as *mut uint32_t;
            }
            loop {
                if (*i).ctn_n as libc::c_ulong >= len {
                    current_block = 14373262988611756694;
                    break;
                }
                *name = ctf_strptr(fp, *idx.offset((*i).ctn_n as isize));
                let fresh2 = (*i).ctn_n;
                (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
                sym = *tab.offset(fresh2 as isize) as ctf_id_t;
                if !(sym == (1 as libc::c_uint).wrapping_neg() as libc::c_ulong
                    || sym == 0 as libc::c_int as libc::c_ulong)
                {
            ...
            while ((*i).ctn_n as libc::c_ulong) < (*fp).ctf_nsyms {
                let mut hp_0: *mut ctf_header_t = (*fp).ctf_header;
                if !(*((*fp).ctf_sxlate).offset((*i).ctn_n as isize)
                    == (1 as libc::c_uint).wrapping_neg())
                {
                    sym = *(((*fp).ctf_buf as uintptr_t)
                        .wrapping_add(
                            *((*fp).ctf_sxlate).offset((*i).ctn_n as isize)
                                as libc::c_ulong,
                        ) as *mut uint32_t) as ctf_id_t;
                    if !(sym == 0 as libc::c_int as libc::c_ulong) {
                        if functions != 0 {
                            if *((*fp).ctf_sxlate).offset((*i).ctn_n as isize)
                                >= (*hp_0).cth_funcoff
                                && *((*fp).ctf_sxlate).offset((*i).ctn_n as isize)
                        ...
                        } else if *((*fp).ctf_sxlate).offset((*i).ctn_n as isize)
                            >= (*hp_0).cth_objtoff
                            && *((*fp).ctf_sxlate).offset((*i).ctn_n as isize)
                                < (*hp_0).cth_funcoff
                        {
            ...
            if (*i).ctn_n as libc::c_ulong >= (*fp).ctf_nsyms {
                current_block = 14373262988611756694;
            } else {
                let fresh3 = (*i).ctn_n;
                (*i).ctn_n = ((*i).ctn_n).wrapping_add(1);
                *name = ctf_lookup_symbol_name(fp, fresh3 as libc::c_ulong);
                current_block = 12997042908615822766;
            }
        }
        match current_block {
...
unsafe extern "C" fn ctf_lookup_idx_name(
    mut key_: *const libc::c_void,
    mut idx_: *const libc::c_void,
) -> libc::c_int {
    let mut key: *const ctf_lookup_idx_key_t = key_ as *const ctf_lookup_idx_key_t;
    let mut idx: *const uint32_t = idx_ as *const uint32_t;
    return strcmp(
        (*key).clik_name,
        ctf_strptr((*key).clik_fp, *((*key).clik_names).offset(*idx as isize)),
    );
}
unsafe extern "C" fn ctf_try_lookup_indexed(
    mut fp: *mut ctf_dict_t,
    mut symidx: libc::c_ulong,
    mut symname: *const libc::c_char,
    mut is_function: libc::c_int,
) -> ctf_id_t {
    let mut hp: *mut ctf_header = (*fp).ctf_header;
    let mut symtypetab: *mut uint32_t = 0 as *mut uint32_t;
    let mut names: *mut uint32_t = 0 as *mut uint32_t;
    let mut sxlate: *mut uint32_t = 0 as *mut uint32_t;
    let mut nidx: size_t = 0;
    if symname.is_null() {
        symname = ctf_lookup_symbol_name(fp, symidx);
    }
    ctf_dprintf(
        b"Looking up type of object with symtab idx %lx or name %s in indexed symtypetab\n\0"
            as *const u8 as *const libc::c_char,
        symidx,
        symname,
    );
    if *symname.offset(0 as libc::c_int as isize) as libc::c_int == '\0' as i32 {
        return -(1 as libc::c_int) as ctf_id_t;
    }
    if is_function != 0 {
        if ((*fp).ctf_funcidx_sxlate).is_null() {
            (*fp)
                .ctf_funcidx_sxlate = ctf_symidx_sort(
                fp,
                ((*fp).ctf_buf).offset((*hp).cth_funcidxoff as isize) as *mut uint32_t,
                &mut (*fp).ctf_nfuncidx,
                ((*hp).cth_varoff).wrapping_sub((*hp).cth_funcidxoff) as size_t,
            );
            if ((*fp).ctf_funcidx_sxlate).is_null() {
                ctf_err_warn(
                    fp,
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"cannot sort function symidx\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
        ...
        symtypetab = ((*fp).ctf_buf).offset((*hp).cth_funcoff as isize) as *mut uint32_t;
        sxlate = (*fp).ctf_funcidx_sxlate;
        names = (*fp).ctf_funcidx_names;
        nidx = (*fp).ctf_nfuncidx;
    } else {
        if ((*fp).ctf_objtidx_sxlate).is_null() {
            (*fp)
                .ctf_objtidx_sxlate = ctf_symidx_sort(
                fp,
                ((*fp).ctf_buf).offset((*hp).cth_objtidxoff as isize) as *mut uint32_t,
                &mut (*fp).ctf_nobjtidx,
                ((*hp).cth_funcidxoff).wrapping_sub((*hp).cth_objtidxoff) as size_t,
            );
            if ((*fp).ctf_objtidx_sxlate).is_null() {
                ctf_err_warn(
                    fp,
                    ...
                    dcgettext(
                        b"libctf\0" as *const u8 as *const libc::c_char,
                        b"cannot sort object symidx\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
        ...
        symtypetab = ((*fp).ctf_buf).offset((*hp).cth_objtoff as isize) as *mut uint32_t;
    ...
    let mut idx: *mut uint32_t = 0 as *mut uint32_t;
    idx = bsearch(
        &mut key as *mut ctf_lookup_idx_key_t as *const libc::c_void,
        sxlate as *const libc::c_void,
        nidx,
        ::core::mem::size_of::<uint32_t>() as libc::c_ulong,
        Some(
            ctf_lookup_idx_name
    ...
    if idx.is_null() {
        ctf_dprintf(
            b"%s not found in idx\n\0" as *const u8 as *const libc::c_char,
            symname,
        );
        return 0 as libc::c_int as ctf_id_t;
    }
    if idx.offset_from(sxlate) as libc::c_long > nidx as ptrdiff_t {
        return ctf_set_errno(fp, ECTF_CORRUPT as libc::c_int);
    }
    ctf_dprintf(
        b"Symbol %lx (%s) is of type %x\n\0" as *const u8 as *const libc::c_char,
        symidx,
        symname,
        *symtypetab.offset(*idx as isize),
    );
    return *symtypetab.offset(*idx as isize) as ctf_id_t;
}
unsafe extern "C" fn ctf_lookup_by_sym_or_name(
    mut fp: *mut ctf_dict_t,
    mut symidx: libc::c_ulong,
    mut symname: *const libc::c_char,
) -> ctf_id_t {
    ...
    if !((*fp).ctf_dynsymidx).is_null() {
        let mut sym: *const ctf_link_sym_t = 0 as *const ctf_link_sym_t;
        if !symname.is_null() {
            ctf_dprintf(
                b"Looking up type of object with symname %s in writable dict symtypetab\n\0"
                    as *const u8 as *const libc::c_char,
                symname,
            );
        } else {
            ctf_dprintf(
                b"Looking up type of object with symtab idx %lx in writable dict symtypetab\n\0"
                    as *const u8 as *const libc::c_char,
                symidx,
            );
        }
        if ctf_assert_internal(
            ...
            ((*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0) as libc::c_int,
        ) as libc::c_long == 0
        {
            return -(1 as libc::c_long) as ctf_id_t;
        }
        if symname.is_null() {
            err = 22 as libc::c_int;
            if symidx > (*fp).ctf_dynsymmax as libc::c_ulong {
                current_block = 16564584243720044735;
            } else {
                sym = *((*fp).ctf_dynsymidx).offset(symidx as isize);
                err = ECTF_NOTYPEDAT as libc::c_int;
                if sym.is_null()
                    || (*sym).st_shndx != 1 as libc::c_int as libc::c_uint
                        && (*sym).st_shndx != 2 as libc::c_int as libc::c_uint
                {
                    current_block = 16564584243720044735;
                } else {
                    if ctf_assert_internal(
        ...
        match current_block {
            16564584243720044735 => {}
            _ => {
                if ((*fp).ctf_objthash).is_null()
                    || {
    ...
    } else if !symname.is_null()
        && (*fp).ctf_flags & 0x2 as libc::c_int as libc::c_uint != 0
    {
        if ((*fp).ctf_objthash).is_null()
            || {
                type_0 = ctf_dynhash_lookup(
        ...
        if !((*sp).cts_data).is_null() {
            err = 22 as libc::c_int;
            if !(symname.is_null() && symidx >= (*fp).ctf_nsyms) {
                if !((*fp).ctf_objtidx_names).is_null() {
                    type_0 = ctf_try_lookup_indexed(
                        fp,
                        symidx,
                        symname,
                        0 as libc::c_int,
                ...
                {
                    ctf_dprintf(
                        b"Looking up object type %lx in 1:1 dict symtypetab\n\0"
                            as *const u8 as *const libc::c_char,
                        symidx,
                    );
                    if !symname.is_null() {
                        symidx = ctf_lookup_symbol_idx(fp, symname);
                        if symidx == -(1 as libc::c_int) as libc::c_ulong {
                            current_block = 16564584243720044735;
                        } else {
                    ...
                    match current_block {
                        16564584243720044735 => {}
                        _ => {
                            if !(*((*fp).ctf_sxlate).offset(symidx as isize)
                                == (1 as libc::c_uint).wrapping_neg())
                            {
                                type_0 = *(((*fp).ctf_buf as uintptr_t)
                                    .wrapping_add(
                                        *((*fp).ctf_sxlate).offset(symidx as isize) as libc::c_ulong,
                                    ) as *mut uint32_t) as ctf_id_t;
                                if !(type_0 == 0 as libc::c_int as libc::c_ulong) {
                                    return type_0;
                                }
    ...
    if !((*fp).ctf_parent).is_null() {
        let mut ret: ctf_id_t = ctf_lookup_by_sym_or_name(
            (*fp).ctf_parent,
            symidx,
            symname,
        );
        if ret == -(1 as libc::c_long) as ctf_id_t {
            ctf_set_errno(fp, ctf_errno((*fp).ctf_parent));
        }
        return ret;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_by_symbol(
    mut fp: *mut ctf_dict_t,
    mut symidx: libc::c_ulong,
) -> ctf_id_t {
    return ctf_lookup_by_sym_or_name(fp, symidx, 0 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_lookup_by_symbol_name(
    mut fp: *mut ctf_dict_t,
    mut symname: *const libc::c_char,
) -> ctf_id_t {
    return ctf_lookup_by_sym_or_name(fp, 0 as libc::c_int as libc::c_ulong, symname);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_func_info(
    mut fp: *mut ctf_dict_t,
    mut symidx: libc::c_ulong,
    ...
    if ctf_type_kind(fp, type_0) != 5 as libc::c_int {
        return ctf_set_errno(fp, ECTF_NOTFUNC as libc::c_int) as libc::c_int;
    }
    return ctf_func_type_info(fp, type_0, fip);
}
#[no_mangle]
pub unsafe extern "C" fn ctf_func_args(
    mut fp: *mut ctf_dict_t,
    mut symidx: libc::c_ulong,
    mut argc: uint32_t,
    ...
    return ctf_func_type_args(fp, type_0, argc, argv);
}
