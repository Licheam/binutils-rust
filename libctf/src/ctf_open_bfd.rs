...
extern "C" {
    ...
    fn ctf_arc_bufpreamble(_: *const ctf_sect_t) -> *const ctf_preamble_t;
    ...
    fn ctf_mmap(length: size_t, offset: size_t, fd: libc::c_int) -> *mut libc::c_void;
    ...
    fn bfd_elf_get_str_section(_: *mut bfd, _: libc::c_uint) -> *mut libc::c_char;
}
...
pub union C2RustUnnamed_2 {
    pub indirect: C2RustUnnamed_6,
    pub data: C2RustUnnamed_5,
    pub reloc: C2RustUnnamed_3,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const ECTF_NONAME: C2RustUnnamed_22 = 1058;
pub const ECTF_INCOMPLETE: C2RustUnnamed_22 = 1057;
pub const ECTF_NEEDSBFD: C2RustUnnamed_22 = 1056;
pub const ECTF_FLAGS: C2RustUnnamed_22 = 1055;
pub const ECTF_NEXT_WRONGFP: C2RustUnnamed_22 = 1054;
pub const ECTF_NEXT_WRONGFUN: C2RustUnnamed_22 = 1053;
pub const ECTF_NEXT_END: C2RustUnnamed_22 = 1052;
pub const ECTF_NONREPRESENTABLE: C2RustUnnamed_22 = 1051;
pub const ECTF_INTERNAL: C2RustUnnamed_22 = 1050;
pub const ECTF_NOTYET: C2RustUnnamed_22 = 1049;
pub const ECTF_DUMPSECTCHANGED: C2RustUnnamed_22 = 1048;
pub const ECTF_DUMPSECTUNKNOWN: C2RustUnnamed_22 = 1047;
pub const ECTF_SLICEOVERFLOW: C2RustUnnamed_22 = 1046;
pub const ECTF_ARNNAME: C2RustUnnamed_22 = 1045;
pub const ECTF_ARCREATE: C2RustUnnamed_22 = 1044;
pub const ECTF_COMPRESS: C2RustUnnamed_22 = 1043;
pub const ECTF_OVERROLLBACK: C2RustUnnamed_22 = 1042;
pub const ECTF_CONFLICT: C2RustUnnamed_22 = 1041;
pub const ECTF_DUPLICATE: C2RustUnnamed_22 = 1040;
pub const ECTF_FULL: C2RustUnnamed_22 = 1039;
pub const ECTF_DTFULL: C2RustUnnamed_22 = 1038;
pub const ECTF_RDONLY: C2RustUnnamed_22 = 1037;
pub const ECTF_NOMEMBNAM: C2RustUnnamed_22 = 1036;
pub const ECTF_NOENUMNAM: C2RustUnnamed_22 = 1035;
pub const ECTF_NOTSUP: C2RustUnnamed_22 = 1034;
pub const ECTF_NOLABELDATA: C2RustUnnamed_22 = 1033;
pub const ECTF_NOLABEL: C2RustUnnamed_22 = 1032;
pub const ECTF_NOTYPEDAT: C2RustUnnamed_22 = 1031;
pub const ECTF_NOTDATA: C2RustUnnamed_22 = 1030;
pub const ECTF_NOFUNCDAT: C2RustUnnamed_22 = 1029;
pub const ECTF_NOTFUNC: C2RustUnnamed_22 = 1028;
pub const ECTF_SYNTAX: C2RustUnnamed_22 = 1027;
pub const ECTF_NOTYPE: C2RustUnnamed_22 = 1026;
pub const ECTF_NAMELEN: C2RustUnnamed_22 = 1025;
pub const ECTF_NOTREF: C2RustUnnamed_22 = 1024;
pub const ECTF_NOTARRAY: C2RustUnnamed_22 = 1023;
pub const ECTF_NOTINTFP: C2RustUnnamed_22 = 1022;
pub const ECTF_NOTSUE: C2RustUnnamed_22 = 1021;
pub const ECTF_NOTENUM: C2RustUnnamed_22 = 1020;
pub const ECTF_NOTSOU: C2RustUnnamed_22 = 1019;
pub const ECTF_BADID: C2RustUnnamed_22 = 1018;
pub const ECTF_BADNAME: C2RustUnnamed_22 = 1017;
pub const ECTF_STRTAB: C2RustUnnamed_22 = 1016;
pub const ECTF_DECOMPRESS: C2RustUnnamed_22 = 1015;
pub const ECTF_ZALLOC: C2RustUnnamed_22 = 1014;
pub const ECTF_LINKADDEDLATE: C2RustUnnamed_22 = 1013;
pub const ECTF_DMODEL: C2RustUnnamed_22 = 1012;
pub const ECTF_NOPARENT: C2RustUnnamed_22 = 1011;
pub const ECTF_NOSYMTAB: C2RustUnnamed_22 = 1010;
pub const ECTF_NOCTFBUF: C2RustUnnamed_22 = 1009;
pub const ECTF_NOCTFDATA: C2RustUnnamed_22 = 1008;
pub const ECTF_CORRUPT: C2RustUnnamed_22 = 1007;
pub const ECTF_STRBAD: C2RustUnnamed_22 = 1006;
pub const ECTF_SYMBAD: C2RustUnnamed_22 = 1005;
pub const ECTF_SYMTAB: C2RustUnnamed_22 = 1004;
pub const ECTF_BFD_AMBIGUOUS: C2RustUnnamed_22 = 1003;
pub const ECTF_CTFVERS: C2RustUnnamed_22 = 1002;
pub const ECTF_BFDERR: C2RustUnnamed_22 = 1001;
pub const ECTF_FMT: C2RustUnnamed_22 = 1000;
...
unsafe extern "C" fn ctf_bfdclose(mut arci: *mut ctf_archive_internal) {
    if !((*arci).ctfi_abfd).is_null() {
        if !bfd_close_all_done((*arci).ctfi_abfd) {
            ctf_err_warn(
                ...
                dcgettext(
                    ...
                    b"cannot close BFD: %s\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
...
#[no_mangle]
pub unsafe extern "C" fn ctf_bfdopen(
    mut abfd: *mut bfd,
    mut errp: *mut libc::c_int,
) -> *mut ctf_archive_t {
    let mut arc: *mut ctf_archive_t = 0 as *mut ctf_archive_t;
    let mut ctf_asect: *mut asection = 0 as *mut asection;
    ...
    libctf_init_debug();
    ctf_asect = bfd_get_section_by_name(abfd, _CTF_SECTION.as_ptr());
    if ctf_asect.is_null() {
        return ctf_set_open_errno(errp, ECTF_NOCTFDATA as libc::c_int)
            as *mut ctf_archive_t;
    }
    if !bfd_malloc_and_get_section(abfd, ctf_asect, &mut contents) {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            0 as libc::c_int,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"ctf_bfdopen(): cannot malloc CTF section: %s\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            bfd_errmsg(bfd_get_error()),
        );
        return ctf_set_open_errno(errp, ECTF_FMT as libc::c_int) as *mut ctf_archive_t;
    }
    ...
    ctfsect.cts_data = contents as *const libc::c_void;
    arc = ctf_bfdopen_ctfsect(abfd, &mut ctfsect, errp);
    if !arc.is_null() {
        (*arc).ctfi_data = ctfsect.cts_data as *mut libc::c_void;
        return arc;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ctf_bfdopen_ctfsect(
    mut abfd: *mut bfd,
    mut ctfsect: *const ctf_sect_t,
    mut errp: *mut libc::c_int,
) -> *mut ctf_archive_t {
    let mut current_block: u64;
    let mut arci: *mut ctf_archive_t = 0 as *mut ctf_archive_t;
    let mut symsectp: *mut ctf_sect_t = 0 as *mut ctf_sect_t;
    let mut strsectp: *mut ctf_sect_t = 0 as *mut ctf_sect_t;
    let mut bfderrstr: *const libc::c_char = 0 as *const libc::c_char;
    let mut strtab_alloc: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut symsect_endianness: libc::c_int = -(1 as libc::c_int);
    libctf_init_debug();
    ...
    let mut symhdr: *mut Elf_Internal_Shdr = 0 as *mut Elf_Internal_Shdr;
    let mut symcount: size_t = 0;
    let mut isymbuf: *mut Elf_Internal_Sym = 0 as *mut Elf_Internal_Sym;
    let mut symtab: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut symtab_name: *const libc::c_char = 0 as *const libc::c_char;
    let mut strtab: *const libc::c_char = 0 as *const libc::c_char;
    let mut strtab_name: *const libc::c_char = 0 as *const libc::c_char;
    let mut strsize: size_t = 0;
    let mut preamble: *const ctf_preamble_t = 0 as *const ctf_preamble_t;
    if ((*ctfsect).cts_data).is_null() {
        bfderrstr = b"CTF section is NULL\0" as *const u8 as *const libc::c_char;
    } else {
        preamble = ctf_arc_bufpreamble(ctfsect);
        if (*preamble).ctp_flags as libc::c_int & 0x8 as libc::c_int != 0 {
            symhdr = &mut (*(*abfd).tdata.elf_obj_data).dynsymtab_hdr;
            strtab_name = b".dynstr\0" as *const u8 as *const libc::c_char;
            symtab_name = b".dynsym\0" as *const u8 as *const libc::c_char;
        } else {
            symhdr = &mut (*(*abfd).tdata.elf_obj_data).symtab_hdr;
            strtab_name = b".strtab\0" as *const u8 as *const libc::c_char;
            symtab_name = b".symtab\0" as *const u8 as *const libc::c_char;
        }
        if !((*abfd).tdata.elf_obj_data).is_null() && !symhdr.is_null()
            && (*symhdr).sh_size != 0 && (*symhdr).sh_entsize != 0
        {
            symcount = ((*symhdr).sh_size).wrapping_div((*symhdr).sh_entsize);
            symtab = malloc((*symhdr).sh_size) as *mut bfd_byte;
            if symtab.is_null() {
                bfderrstr = b"cannot malloc symbol table\0" as *const u8
                    as *const libc::c_char;
                ...
                isymbuf = bfd_elf_get_elf_syms(
                    ...
                    symtab as *mut libc::c_void,
                    0 as *mut Elf_External_Sym_Shndx,
                );
                free(isymbuf as *mut libc::c_void);
                if isymbuf.is_null() {
                    bfderrstr = b"cannot read symbol table\0" as *const u8
                        as *const libc::c_char;
                    current_block = 17432813595899837216;
                } else if !((*(*abfd).tdata.elf_obj_data).elf_sect_ptr).is_null()
                    && (*symhdr).sh_link < (*(*abfd).tdata.elf_obj_data).num_elf_sections
                {
                    let mut strhdr: *mut Elf_Internal_Shdr = *((*(*abfd)
                        .tdata
                        .elf_obj_data)
                        .elf_sect_ptr)
                        .offset((*symhdr).sh_link as isize);
                    strsize = (*strhdr).sh_size;
                    if ((*strhdr).contents).is_null() {
                        strtab = bfd_elf_get_str_section(abfd, (*symhdr).sh_link);
                        if strtab.is_null() {
                            bfderrstr = b"cannot read string table\0" as *const u8
                                as *const libc::c_char;
                            current_block = 17432813595899837216;
                        } else {
                        ...
                        strtab = (*strhdr).contents as *const libc::c_char;
                        current_block = 11048769245176032998;
                    }
                } else {
                    current_block = 11048769245176032998;
            ...
            let mut str_bcontents: *mut bfd_byte = 0 as *mut bfd_byte;
            let mut str_asect: *mut asection = 0 as *mut asection;
            str_asect = bfd_get_section_by_name(abfd, strtab_name);
            if !str_asect.is_null() {
                if bfd_malloc_and_get_section(abfd, str_asect, &mut str_bcontents) {
                    strtab = str_bcontents as *const libc::c_char;
                    strtab_alloc = str_bcontents as *mut libc::c_char;
            ...
            _ => {
                match current_block {
                    11048769245176032998 => {
                        if !strtab.is_null() {
                            strsect.cts_data = strtab as *const libc::c_void;
                            strsect.cts_name = strtab_name;
                            strsect.cts_size = strsize;
                            strsectp = &mut strsect;
                        }
                        if !symtab.is_null() {
                            if (*symhdr).sh_entsize
                                == (*(*((*(*abfd).xvec).backend_data
                                    as *const elf_backend_data))
                                    .s)
                                    .sizeof_sym as libc::c_ulong
                            {} else {
                                __assert_fail(
                                    b"symhdr->sh_entsize == get_elf_backend_data (abfd)->s->sizeof_sym\0"
                                        as *const u8 as *const libc::c_char,
                                    b"ctf-open-bfd.c\0" as *const u8 as *const libc::c_char,
                                    205 as libc::c_int as libc::c_uint,
                                    (*::core::mem::transmute::<
                                        &[u8; 76],
                                        &[libc::c_char; 76],
                                    >(
                                        b"ctf_archive_t *ctf_bfdopen_ctfsect(struct bfd *, const ctf_sect_t *, int *)\0",
                                    ))
                                        .as_ptr(),
                                );
                            }
                            ...
                            symsect.cts_data = symtab as *const libc::c_void;
                            symsectp = &mut symsect;
                        }
                        symsect_endianness = bfd_little_endian(abfd) as libc::c_int;
                        arci = ctf_arc_bufopen(ctfsect, symsectp, strsectp, errp);
                        if !arci.is_null() {
                            (*arci).ctfi_free_symsect = 1 as libc::c_int;
                            if !strtab_alloc.is_null() {
                                (*arci).ctfi_free_strsect = 1 as libc::c_int;
                            }
                            if symsect_endianness > -(1 as libc::c_int) {
                ...
                free(strtab_alloc as *mut libc::c_void);
            }
        }
    }
    if !bfderrstr.is_null() {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            0 as libc::c_int,
            b"ctf_bfdopen(): %s: %s\0" as *const u8 as *const libc::c_char,
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                bfderrstr,
                5 as libc::c_int,
        ...
        ctf_set_open_errno(errp, ECTF_FMT as libc::c_int);
    }
    return 0 as *mut ctf_archive_t;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_fdopen(
    mut fd: libc::c_int,
    ...
    let mut ctfhdr: ctf_preamble_t = ctf_preamble_t {
        ctp_magic: 0,
        ctp_version: 0,
        ctp_flags: 0,
    };
    let mut arc_magic: uint64_t = 0;
    memset(
        &mut ctfhdr as *mut ctf_preamble_t as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<ctf_preamble_t>() as libc::c_ulong,
    );
    libctf_init_debug();
    if fstat(fd, &mut st) == -(1 as libc::c_int) {
        return ctf_set_open_errno(errp, *__errno_location()) as *mut ctf_archive_t;
    }
    nbytes = ctf_pread(
        fd,
        &mut ctfhdr as *mut ctf_preamble_t as *mut libc::c_void,
        ::core::mem::size_of::<ctf_preamble_t>() as libc::c_ulong as ssize_t,
        0 as libc::c_int as off_t,
    );
    if nbytes <= 0 as libc::c_int as libc::c_long {
        return ctf_set_open_errno(
            errp,
            if nbytes < 0 as libc::c_int as libc::c_long {
                *__errno_location()
            } else {
                ECTF_FMT as libc::c_int
            },
        ) as *mut ctf_archive_t;
    }
    if nbytes as size_t >= ::core::mem::size_of::<ctf_preamble_t>() as libc::c_ulong
        && (ctfhdr.ctp_magic as libc::c_int == 0xdff2 as libc::c_int
            || ctfhdr.ctp_magic as libc::c_int
                == __bswap_16(0xdff2 as libc::c_int as __uint16_t) as libc::c_int)
    {
        let mut fp: *mut ctf_dict_t = 0 as *mut ctf_dict_t;
        let mut data: *mut libc::c_void = 0 as *mut libc::c_void;
        data = ctf_mmap(st.st_size as size_t, 0 as libc::c_int as size_t, fd);
        if data.is_null() {
            return ctf_set_open_errno(errp, *__errno_location()) as *mut ctf_archive_t;
        }
        fp = ctf_simple_open(
        ...
        if fp.is_null() {
            ctf_munmap(data, st.st_size as size_t);
            return 0 as *mut ctf_archive_t;
        }
        (*fp).ctf_data_mmapped = data;
        (*fp).ctf_data_mmapped_len = st.st_size as size_t;
    ...
    nbytes = ctf_pread(
        fd,
        &mut arc_magic as *mut uint64_t as *mut libc::c_void,
        ::core::mem::size_of::<uint64_t>() as libc::c_ulong as ssize_t,
        0 as libc::c_int as off_t,
    );
    if nbytes <= 0 as libc::c_int as libc::c_long {
        return ctf_set_open_errno(
    ...
    if nbytes as size_t >= ::core::mem::size_of::<uint64_t>() as libc::c_ulong
        && __uint64_identity(arc_magic) == 0x8b47f2a4d7623eeb as libc::c_ulong
    {
        let mut arc: *mut ctf_archive = 0 as *mut ctf_archive;
        arc = ctf_arc_open_internal(filename, errp);
        if arc.is_null() {
            return 0 as *mut ctf_archive_t;
        }
        return ctf_new_archive_internal(
    ...
    nfd = dup(fd);
    if nfd < 0 as libc::c_int {
        return ctf_set_open_errno(errp, *__errno_location()) as *mut ctf_archive_t;
    }
    abfd = bfd_fdopenr(filename, target, nfd);
    if abfd.is_null() {
        ctf_err_warn(
            0 as *mut ctf_dict_t,
            0 as libc::c_int,
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"cannot open BFD from %s: %s\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            if !filename.is_null() {
                filename
    ...
    bfd_set_cacheable(abfd, 1 as libc::c_int != 0);
    if !bfd_check_format(abfd, bfd_object) {
        ctf_err_warn(
            ...
            dcgettext(
                b"libctf\0" as *const u8 as *const libc::c_char,
                b"BFD format problem in %s: %s\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            if !filename.is_null() {
                filename
        ...
        {
            return ctf_set_open_errno(errp, ECTF_BFD_AMBIGUOUS as libc::c_int)
                as *mut ctf_archive_t
        } else {
            return ctf_set_open_errno(errp, ECTF_FMT as libc::c_int)
                as *mut ctf_archive_t
        }
    }
    arci = ctf_bfdopen(abfd, errp);
    if arci.is_null() {
    ...
    (*arci)
        .ctfi_bfd_close = Some(
        ctf_bfdclose as unsafe extern "C" fn(*mut ctf_archive_internal) -> (),
    );
    (*arci).ctfi_abfd = abfd;
    return arci;
}
#[no_mangle]
pub unsafe extern "C" fn ctf_open(
    mut filename: *const libc::c_char,
    mut target: *const libc::c_char,
    mut errp: *mut libc::c_int,
) -> *mut ctf_archive_t {
...
#[no_mangle]
pub unsafe extern "C" fn ctf_arc_open(
    mut filename: *const libc::c_char,
    mut errp: *mut libc::c_int,
) -> *mut ctf_archive_t {
    return ctf_open(filename, 0 as *const libc::c_char, errp);
}
