extern "C" {
    ...
    fn _bfd_pei_swap_debugdir_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    fn _bfd_pei_write_codeview_record(
        _: *mut bfd,
        _: file_ptr,
        _: *mut CODEVIEW_INFO,
    ) -> libc::c_uint;
    fn def_file_parse(_: *const libc::c_char, _: *mut def_file) -> *mut def_file;
    static mut pe_def_file: *mut def_file;
    static mut pe_dll_export_everything: libc::c_int;
    static mut pe_dll_exclude_all_symbols: libc::c_int;
    static mut pe_dll_do_default_excludes: libc::c_int;
    static mut pe_dll_kill_ats: libc::c_int;
    static mut pe_dll_stdcall_aliases: libc::c_int;
    static mut pe_dll_warn_dup_exports: libc::c_int;
    static mut pe_dll_compat_implib: libc::c_int;
    static mut pe_dll_extra_pe_debug: libc::c_int;
    static mut pe_use_nul_prefixed_import_tables: libc::c_int;
    static mut pe_use_coff_long_section_names: libc::c_int;
    static mut pe_leading_underscore: libc::c_int;
    static mut pe_dll_enable_reloc_section: libc::c_int;
    fn pe_dll_id_target(_: *const libc::c_char);
    fn pe_dll_add_excludes(_: *const libc::c_char, _: exclude_type);
    fn pe_dll_generate_def_file(_: *const libc::c_char);
    fn pe_dll_generate_implib(
        _: *mut def_file,
        _: *const libc::c_char,
        _: *mut bfd_link_info,
    );
    fn pe_process_import_defs(_: *mut bfd, _: *mut bfd_link_info);
    fn pe_implied_import_dll(_: *const libc::c_char) -> bool;
    fn pe_dll_build_sections(_: *mut bfd, _: *mut bfd_link_info);
    fn pe_dll_fill_sections(_: *mut bfd, _: *mut bfd_link_info);
    fn pe_find_data_imports(
        _: *const libc::c_char,
        cb: Option::<
            unsafe extern "C" fn(
                *mut arelent,
    ...
    fn pe_bfd_is_dll(_: *mut bfd) -> bool;
    fn pe_output_file_set_long_section_names(_: *mut bfd);
}
...
static mut pe: internal_extra_pe_aouthdr = internal_extra_pe_aouthdr {
    Magic: 0,
...
static mut pe_subsystem: libc::c_int = 3 as libc::c_int;
static mut real_flags: flagword = 0 as libc::c_int as flagword;
static mut support_old_code: libc::c_int = 0 as libc::c_int;
static mut thumb_entry_symbol: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
...
static mut pe_enable_stdcall_fixup: libc::c_int = -(1 as libc::c_int);
static mut pe_out_def_filename: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
static mut pe_enable_auto_image_base: libc::c_int = 0 as libc::c_int;
static mut pe_auto_image_base: libc::c_ulong = 0x61500000 as libc::c_int
    as libc::c_ulong;
static mut pe_dll_search_prefix: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
unsafe extern "C" fn is_underscoring() -> libc::c_int {
    let mut u: libc::c_int = 0 as libc::c_int;
    if pe_leading_underscore != -(1 as libc::c_int) {
        return pe_leading_underscore;
    }
    if (bfd_get_target_info(
        b"pei-i386\0" as *const u8 as *const libc::c_char,
        0 as *mut bfd,
        0 as *mut bool,
        &mut u,
    ...
    {
        bfd_get_target_info(
            b"pe-i386\0" as *const u8 as *const libc::c_char,
            0 as *mut bfd,
            0 as *mut bool,
            &mut u,
            0 as *mut *const libc::c_char,
    ...
    if u == -(1 as libc::c_int) {
        ld_abort(
            b"ei386pe.c\0" as *const u8 as *const libc::c_char,
            145 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 26],
                &[libc::c_char; 26],
...
unsafe extern "C" fn gld_i386pe_before_parse() {
    is_underscoring();
    ldfile_set_output_arch(b"i386\0" as *const u8 as *const libc::c_char, bfd_arch_i386);
    ...
    *longopts = xrealloc(
        *longopts as *mut libc::c_void,
        (nl as libc::c_ulong)
            ...
            .wrapping_add(::core::mem::size_of::<[option; 70]>() as libc::c_ulong),
    ) as *mut option;
    memcpy(
        (*longopts).offset(nl as isize) as *mut libc::c_void,
        &xtra_long as *const [option; 70] as *const libc::c_void,
        ::core::mem::size_of::<[option; 70]>() as libc::c_ulong,
    );
}
...
unsafe extern "C" fn gld_i386pe_list_options(mut file: *mut FILE) {
    fprintf(
        file,
        dcgettext(
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --thumb-entry=<symbol>             Set the entry point to be Thumb <symbol>\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --enable-auto-image-base[=<address>] Automatically choose image base for DLLs\n                                       (optionally starting with address) unless\n                                       specifically set with --image-base\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --enable-extra-pe-debug            Enable verbose debug output when building\n                                       or linking to DLLs (esp. auto-import)\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --large-address-aware              Executable supports virtual addresses\n                                       greater than 2 gigabytes\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --disable-large-address-aware      Executable does not support virtual\n                                       addresses greater than 2 gigabytes\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
unsafe extern "C" fn set_pe_name(mut name: *mut libc::c_char, mut val: libc::c_long) {
    ...
    while !(init[i as usize].ptr).is_null() {
            ...
            (init[i as usize].symbol)
                .offset(
                    (if !init[i as usize].is_c_symbol
                        || is_underscoring() != 0 as libc::c_int
                    {
                        0 as libc::c_int
                    } else {
                        1 as libc::c_int
        ...
        {
            init[i as usize].value = val as libc::c_int;
    ...
    ld_abort(
        ...
        (*::core::mem::transmute::<
            &[u8; 31],
            &[libc::c_char; 31],
        >(b"void set_pe_name(char *, long)\0"))
            .as_ptr(),
    );
}
unsafe extern "C" fn set_entry_point() {
    ...
    if link_info.type_0() as libc::c_int == type_dll as libc::c_int || dll != 0 {
        entry = b"DllMainCRTStartup@12\0" as *const u8 as *const libc::c_char;
    } else {
        i = 0 as libc::c_int;
        while !(v[i as usize].entry).is_null() {
            if v[i as usize].value == pe_subsystem {
                break;
            }
            i += 1;
            i;
...
unsafe extern "C" fn set_pe_subsystem() {
        ...
        && temp_subsystem < 65536 as libc::c_int as libc::c_ulong
    {
        ...
        pe_subsystem = temp_subsystem as libc::c_int;
    } else {
        i = 0 as libc::c_int;
        while !(v[i as usize].name).is_null() {
    ...
    set_pe_name(
        ...
        pe_subsystem as libc::c_long,
    );
}
unsafe extern "C" fn set_pe_value(mut name: *mut libc::c_char) {
    let mut end: *mut libc::c_char = 0 as *mut libc::c_char;
    set_pe_name(name, strtoul(optarg, &mut end, 0 as libc::c_int) as libc::c_long);
    if end == optarg {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
...
unsafe extern "C" fn set_pe_stack_heap(
...
unsafe extern "C" fn gldi386pe_handle_option(mut optc: libc::c_int) -> bool {
    ...
    match optc {
        301 => {
            ...
            current_block_77 = 2220405792722996547;
        }
        314 => {
            set_pe_stack_heap(
        ...
        342 => {
            pe_use_nul_prefixed_import_tables = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        343 => {
            pe_leading_underscore = 0 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        344 => {
            pe_leading_underscore = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        355 => {
        ...
        317 => {
            pe_dll_export_everything = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        318 => {
        ...
        319 => {
            pe_dll_exclude_all_symbols = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        334 => {
        ...
        320 => {
            pe_dll_kill_ats = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        321 => {
            pe_dll_stdcall_aliases = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        322 => {
            pe_enable_stdcall_fixup = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        323 => {
            pe_enable_stdcall_fixup = 0 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        325 => {
            pe_dll_warn_dup_exports = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        326 => {
            pe_dll_compat_implib = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        327 => {
            pe_enable_auto_image_base = 1 as libc::c_int;
            if !optarg.is_null() && *optarg as libc::c_int != 0 {
                let mut end: *mut libc::c_char = 0 as *mut libc::c_char;
                pe_auto_image_base = strtoul(optarg, &mut end, 0 as libc::c_int);
            }
            current_block_77 = 2220405792722996547;
        }
        328 => {
            pe_enable_auto_image_base = 0 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        329 => {
        ...
        330 => {
            pe_dll_do_default_excludes = 0 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        331 => {
            link_info.pei386_auto_import = 1 as libc::c_int;
        ...
        333 => {
            pe_dll_extra_pe_debug = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        337 => {
            real_flags |= 0x20 as libc::c_int as libc::c_uint;
            current_block_77 = 2220405792722996547;
        }
        338 => {
            real_flags &= !(0x20 as libc::c_int) as libc::c_uint;
        ...
        345 => {
            pe_use_coff_long_section_names = 1 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        346 => {
            pe_use_coff_long_section_names = 0 as libc::c_int;
            current_block_77 = 2220405792722996547;
        }
        347 => {
            pe_dll_characteristics = (pe_dll_characteristics as libc::c_int
                | 0x40 as libc::c_int) as libc::c_ushort;
            current_block_77 = 9519296054275753480;
        }
        358 => {
            current_block_77 = 9519296054275753480;
        }
        359 => {
            pe_dll_enable_reloc_section = 0 as libc::c_int;
            current_block_77 = 168175818877387359;
        }
        360 => {
            current_block_77 = 168175818877387359;
        }
    ...
    match current_block_77 {
        9519296054275753480 => {
            pe_dll_enable_reloc_section = 1 as libc::c_int;
        }
        168175818877387359 => {
            pe_dll_characteristics = (pe_dll_characteristics as libc::c_int
                & !(0x40 as libc::c_int)) as libc::c_ushort;
    ...
    set_pe_name(
        b"__dll_characteristics__\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char,
        pe_dll_characteristics as libc::c_long,
    );
...
unsafe extern "C" fn compute_dll_image_base(
    mut ofile: *const libc::c_char,
) -> libc::c_ulong {
    let mut hash: libc::c_ulong = strhash(ofile);
    return pe_auto_image_base
        .wrapping_add(
            hash << 16 as libc::c_int & 0xffc0000 as libc::c_int as libc::c_ulong,
        );
}
unsafe extern "C" fn gld_i386pe_set_symbols() {
    let mut j: libc::c_int = 0;
    is_underscoring();
    if init[0 as libc::c_int as usize].inited == 0 {
        if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int {
            init[0 as libc::c_int as usize].value = 0 as libc::c_int;
            ...
            || link_info.type_0() as libc::c_int == type_dll as libc::c_int
        {
            init[0 as libc::c_int as usize]
                .value = (if pe_enable_auto_image_base != 0 {
                compute_dll_image_base(output_filename)
            } else {
                0x10000000 as libc::c_int as libc::c_ulong
            }) as libc::c_int;
        } else {
            init[0 as libc::c_int as usize].value = 0x400000 as libc::c_int;
        }
    ...
    while !(init[j as usize].ptr).is_null() {
        let mut val: libc::c_long = init[j as usize].value as libc::c_long;
        ...
        {
            *(init[j as usize].ptr as *mut libc::c_long) = val;
        } else if init[j as usize].size as libc::c_ulong
            == ::core::mem::size_of::<bfd_vma>() as libc::c_ulong
        {
            *(init[j as usize].ptr as *mut bfd_vma) = val as bfd_vma;
        } else {
            ld_abort(
                b"ei386pe.c\0" as *const u8 as *const libc::c_char,
                977 as libc::c_int,
                (*::core::mem::transmute::<
                    &[u8; 34],
                    &[libc::c_char; 34],
                >(b"void gld_i386pe_set_symbols(void)\0"))
                    .as_ptr(),
            );
        }
...
unsafe extern "C" fn gld_i386pe_after_parse() {
...
static mut pe_undef_found_sym: *mut bfd_link_hash_entry = 0 as *const bfd_link_hash_entry
    as *mut bfd_link_hash_entry;
unsafe extern "C" fn pe_undef_cdecl_match(
...
unsafe extern "C" fn change_undef(
    mut undef: *mut bfd_link_hash_entry,
    mut sym: *mut bfd_link_hash_entry,
) {
    static mut gave_warning_message: bool = 0 as libc::c_int != 0;
    (*undef).set_type_0(bfd_link_hash_defined);
    (*undef).u.def.value = (*sym).u.def.value;
    (*undef).u.def.section = (*sym).u.def.section;
    if pe_enable_stdcall_fixup == -(1 as libc::c_int) {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: warning: resolving %s by linking to %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*undef).root.string,
        ...
        if !gave_warning_message {
            ...
            gave_warning_message = 1 as libc::c_int != 0;
        }
    }
    lang_add_gc_name((*sym).root.string);
}
unsafe extern "C" fn pe_fixup_stdcalls() {
    ...
    while !undef.is_null() {
        if (*undef).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int {
            let mut name: *const libc::c_char = (*undef).root.string;
            let mut at: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut lead_at: libc::c_int = (*name as libc::c_int == '@' as i32)
                as libc::c_int;
            if lead_at != 0 {
                at = strchr(name.offset(1 as libc::c_int as isize), '@' as i32);
            } else {
                at = strchr(name, '@' as i32);
            }
            if !at.is_null() || lead_at != 0 {
                let mut cname: *mut libc::c_char = xstrdup(name);
                if lead_at != 0 {
                    *cname = '_' as i32 as libc::c_char;
                }
                if !at.is_null() {
                    *strchr(cname, '@' as i32) = 0 as libc::c_int as libc::c_char;
                }
                ...
                pe_undef_found_sym = 0 as *mut bfd_link_hash_entry;
                bfd_link_hash_traverse(
                    link_info.hash,
                    Some(
                        pe_undef_cdecl_match
...
unsafe extern "C" fn make_import_fixup(
    ...
    let mut addend: [libc::c_char; 4] = [0; 4];
    let mut _addend: bfd_vma = 0;
    if pe_dll_extra_pe_debug != 0 {
        printf(
    ...
    _addend = (Some(
        ((*(*(*s).owner).xvec).bfd_getx32).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(addend.as_mut_ptr() as *const libc::c_void);
...
unsafe extern "C" fn write_build_id(mut abfd: *mut bfd) -> bool {
    ...
    if _bfd_pei_write_codeview_record(
        abfd,
...
unsafe extern "C" fn gld_i386pe_after_open() {
    after_open_default();
    if pe_dll_extra_pe_debug != 0 {
    ...
    (*(*link_info.output_bfd).tdata.pe_obj_data).pe_opthdr = pe;
    (*(*link_info.output_bfd).tdata.pe_obj_data)
        .dll = init[1 as libc::c_int as usize].value;
    ...
    pe_process_import_defs(link_info.output_bfd, &mut link_info);
    ...
    if pe_enable_stdcall_fixup != 0 {
        pe_fixup_stdcalls();
    }
    if !(link_info.type_0() as libc::c_int == type_relocatable as libc::c_int) {
        pe_dll_build_sections(link_info.output_bfd, &mut link_info);
    }
    ...
    let mut is_2: *mut lang_input_statement_type = 0 as *mut lang_input_statement_type;
    is_2 = file_chain.head as *mut lang_input_statement_type;
    while !is_2.is_null() {
        if !((*(*is_2).the_bfd).my_archive).is_null() {
            let mut is_imp_0: libc::c_int = 0 as libc::c_int;
            let mut sec_1: *mut asection = 0 as *mut asection;
            let mut stub_sec: *mut asection = 0 as *mut asection;
            sec_1 = (*(*is_2).the_bfd).sections;
            while !sec_1.is_null() {
                if strncmp(
                    (*sec_1).name,
                    b".idata$\0" as *const u8 as *const libc::c_char,
                ...
                {
                    is_imp_0 = 1 as libc::c_int;
                }
                if (*sec_1).flags & 0x10 as libc::c_int as libc::c_uint != 0
                    && (*sec_1).reloc_count != 0
                {
                    stub_sec = sec_1;
                }
            ...
            if is_imp_0 != 0 && !stub_sec.is_null() {
                let mut symbols_0: *mut *mut asymbol = 0 as *mut *mut asymbol;
                let mut nsyms: libc::c_long = 0;
                let mut src_count: libc::c_long = 0;
                let mut blhe_0: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
                if !bfd_generic_link_read_symbols((*is_2).the_bfd) {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: %pB: could not read symbols: %E\n\0" as *const u8
                ...
                symbols_0 = bfd_get_outsymbols((*is_2).the_bfd);
                nsyms = bfd_get_symcount((*is_2).the_bfd) as libc::c_long;
                src_count = 0 as libc::c_int as libc::c_long;
                while src_count < nsyms {
                    if (*(**symbols_0.offset(src_count as isize)).section).id
                        == (*stub_sec).id
                    {
                        blhe_0 = bfd_link_hash_lookup(
                            link_info.hash,
                            (**symbols_0.offset(src_count as isize)).name,
                            0 as libc::c_int != 0,
                            0 as libc::c_int != 0,
                            1 as libc::c_int != 0,
                        );
                        if !blhe_0.is_null()
                            && (*blhe_0).type_0() as libc::c_int
                                == bfd_link_hash_defined as libc::c_int
                            && ((*blhe_0).u.undef.next).is_null()
                            && blhe_0 != (*link_info.hash).undefs_tail
                        {
                            (*stub_sec).flags |= 0x8000 as libc::c_int as libc::c_uint;
                        }
                    }
                    src_count += 1;
                    src_count;
...
unsafe extern "C" fn gld_i386pe_before_allocation() {
...
unsafe extern "C" fn gld_i386pe_unrecognized_file(
            ...
            == 0 as libc::c_int
    {
        ...
        if !pe_def_file.is_null() {
            ...
            if (*pe_def_file).is_dll == 1 as libc::c_int {
                link_info.set_type_0(type_dll);
            }
            if (*pe_def_file).base_address != -(1 as libc::c_int) as bfd_vma {
                init[0 as libc::c_int as usize]
                    .value = (*pe_def_file).base_address as libc::c_int;
                (*(*link_info.output_bfd).tdata.pe_obj_data)
                    .pe_opthdr
                    .ImageBase = init[0 as libc::c_int as usize].value as bfd_vma;
                pe
            ...
            {
                pe.SizeOfStackReserve = (*pe_def_file).stack_reserve as bfd_vma;
                if (*pe_def_file).stack_commit != -(1 as libc::c_int) {
                    pe.SizeOfStackCommit = (*pe_def_file).stack_commit as bfd_vma;
                }
            }
            if (*pe_def_file).heap_reserve != -(1 as libc::c_int)
                && saw_option(
                    b"__size_of_heap_reserve__\0" as *const u8 as *const libc::c_char
                        as *mut libc::c_char,
                ) == 0
            {
                pe.SizeOfHeapReserve = (*pe_def_file).heap_reserve as bfd_vma;
                if (*pe_def_file).heap_commit != -(1 as libc::c_int) {
                    pe.SizeOfHeapCommit = (*pe_def_file).heap_commit as bfd_vma;
                }
            }
            return 1 as libc::c_int != 0;
        }
...
unsafe extern "C" fn gld_i386pe_recognized_file(
    mut entry: *mut lang_input_statement_type,
) -> bool {
    pe_dll_id_target(b"pei-i386\0" as *const u8 as *const libc::c_char);
    if pe_bfd_is_dll((*entry).the_bfd) {
        return pe_implied_import_dll((*entry).filename);
    }
    return 0 as libc::c_int != 0;
}
unsafe extern "C" fn gld_i386pe_finish() {
    finish_default();
    ...
    {
        pe_dll_fill_sections(link_info.output_bfd, &mut link_info);
    ...
    if !pe_out_def_filename.is_null() {
...
unsafe extern "C" fn gld_i386pe_place_orphan(
    mut s: *mut asection,
...
unsafe extern "C" fn gld_i386pe_find_potential_libraries(
    mut name: *mut libc::c_char,
    mut entry: *mut lang_input_statement_type,
) -> libc::c_int {
...
unsafe extern "C" fn gld_i386pe_get_script(
    mut isfile: *mut libc::c_int,
) -> *mut libc::c_char {
    *isfile = 1 as libc::c_int;
    if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int
        && config.build_constructors as libc::c_int != 0
    {
        return b"ldscripts/i386pe.xu\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int {
        return b"ldscripts/i386pe.xr\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if !config.text_read_only {
        return b"ldscripts/i386pe.xbn\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if !config.magic_demand_paged {
        return b"ldscripts/i386pe.xn\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if link_info.pei386_auto_import == 1 as libc::c_int
        && (1 as libc::c_int != 0
            || link_info.pei386_runtime_pseudo_reloc != 2 as libc::c_int)
    {
        return b"ldscripts/i386pe.xa\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else {
        return b"ldscripts/i386pe.x\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    };
}
#[no_mangle]
pub static mut ld_i386pe_emulation: ld_emulation_xfer_struct = unsafe {
    {
        let mut init = ld_emulation_xfer_struct {
            ...
            after_parse: Some(gld_i386pe_after_parse as unsafe extern "C" fn() -> ()),
            after_open: Some(gld_i386pe_after_open as unsafe extern "C" fn() -> ()),
            ...
            before_allocation: Some(
                gld_i386pe_before_allocation as unsafe extern "C" fn() -> (),
            ),
            get_script: Some(
                gld_i386pe_get_script
                    as unsafe extern "C" fn(*mut libc::c_int) -> *mut libc::c_char,
            ),
            emulation_name: b"i386pe\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            target_name: b"pei-i386\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            finish: Some(gld_i386pe_finish as unsafe extern "C" fn() -> ()),
            ...
            set_symbols: Some(gld_i386pe_set_symbols as unsafe extern "C" fn() -> ()),
            parse_args: None,
            add_options: Some(
            ...
            handle_option: Some(
                gldi386pe_handle_option as unsafe extern "C" fn(libc::c_int) -> bool,
            ),
            ...
            list_options: Some(
                gld_i386pe_list_options as unsafe extern "C" fn(*mut FILE) -> (),
            ),
        ...
        },
        {
            let mut init = definfo {
                ...
                size: ::core::mem::size_of::<libc::c_ushort>() as libc::c_ulong
                    as libc::c_int,
                value: 0x40 as libc::c_int | 0x100 as libc::c_int,
