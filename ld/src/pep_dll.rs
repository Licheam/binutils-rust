...
#[no_mangle]
pub unsafe extern "C" fn pep_bfd_is_dll(mut abfd: *mut bfd) -> bool {
...
unsafe extern "C" fn make_singleton_name_thunk(
    ...
    (Some(((*(*abfd).xvec)._bfd_set_arch_mach).expect("non-null function pointer")))
        ...
        abfd,
        (*pep_details).bfd_arch as bfd_architecture,
    ...
    bfd_set_section_size(id4, (8 as libc::c_int * 2 as libc::c_int) as bfd_size_type);
    d4 = xmalloc((8 as libc::c_int * 2 as libc::c_int) as size_t) as *mut libc::c_uchar;
    (*id4).contents = d4;
    memset(
    ...
    bfd_set_section_contents(
        ...
        (8 as libc::c_int * 2 as libc::c_int) as bfd_size_type,
    );
...
unsafe extern "C" fn make_import_fixup_entry(
    ...
    quick_symbol(
        abfd,
        if (*pep_details).underscored as libc::c_int != 0 {
...
unsafe extern "C" fn make_import_fixup_mark(
    ...
    sprintf(buf.as_mut_ptr(), b"__fu%d_\0" as *const u8 as *const libc::c_char, fresh0);
...
unsafe extern "C" fn pe_create_runtime_relocator_reference(
    ...
    bfd_set_section_size(extern_rt_rel, 8 as libc::c_int as bfd_size_type);
    extern_rt_rel_d = xcalloc(1 as libc::c_int as size_t, 8 as libc::c_int as size_t)
        as *mut libc::c_uchar;
...
#[no_mangle]
pub unsafe extern "C" fn pep_create_import_fixup(
    mut rel: *mut arelent,
    mut s: *mut asection,
    mut addend: bfd_vma,
    mut name: *mut libc::c_char,
        ...
        || link_info.pei386_runtime_pseudo_reloc == 2 as libc::c_int
    {
        ...
        add_bfd_to_link(b, bfd_get_filename(b), &mut link_info);
        let fresh1 = runtime_pseudo_relocs_created;
...
#[no_mangle]
pub unsafe extern "C" fn pep_find_data_imports(
...
#[no_mangle]
pub static mut pep_def_file: *mut def_file = 0 as *const def_file as *mut def_file;
#[no_mangle]
pub static mut pep_dll_export_everything: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_exclude_all_symbols: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_do_default_excludes: libc::c_int = 1 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_kill_ats: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_stdcall_aliases: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_warn_dup_exports: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_compat_implib: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_dll_extra_pe_debug: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_use_nul_prefixed_import_tables: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pep_use_coff_long_section_names: libc::c_int = -(1 as libc::c_int);
#[no_mangle]
pub static mut pep_leading_underscore: libc::c_int = -(1 as libc::c_int);
#[no_mangle]
pub static mut pep_dll_enable_reloc_section: libc::c_int = 1 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn pep_dll_id_target(mut target: *const libc::c_char) {
    let mut i: libc::c_int = 0;
    i = 0 as libc::c_int;
    while !(pe_detail_list[i as usize].target_name).is_null() {
        if strcmp(pe_detail_list[i as usize].target_name, target) == 0 as libc::c_int
            || strcmp(pe_detail_list[i as usize].object_target, target)
                == 0 as libc::c_int
        {
            let mut u: libc::c_int = pep_leading_underscore;
            ...
            if u == -(1 as libc::c_int) {
                ld_abort(
                    ...
                    (*::core::mem::transmute::<
                        &[u8; 37],
                        &[libc::c_char; 37],
                    >(b"void pep_dll_id_target(const char *)\0"))
                        .as_ptr(),
                );
            }
            pe_detail_list[i as usize].underscored = u != 0 as libc::c_int;
            pep_details = pe_detail_list.as_mut_ptr().offset(i as isize);
    ...
    [
        {
            let mut init = pe_details_type {
                ...
                object_target: b"pe-x86-64\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 3 as libc::c_int as libc::c_uint,
        ...
        },
        {
            let mut init = pe_details_type {
                target_name: b"pei-x86-64\0" as *const u8 as *const libc::c_char,
                object_target: b"pe-bigobj-x86-64\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 3 as libc::c_int as libc::c_uint,
                pe_arch: 1 as libc::c_int,
                bfd_arch: bfd_arch_i386 as libc::c_int,
                underscored: 0 as libc::c_int != 0,
...
static mut autofilter_symbollist_i386: [autofilter_entry_type; 20] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 20];
static mut pep_details: *const pe_details_type = 0 as *const pe_details_type;
#[no_mangle]
pub unsafe extern "C" fn pep_dll_add_excludes(
...
static mut excludes: *mut exclude_list_struct = 0 as *const exclude_list_struct
    as *mut exclude_list_struct;
#[no_mangle]
pub unsafe extern "C" fn pep_dll_generate_def_file(
    ...
    if !pep_def_file.is_null() {
        ...
        if !((*pep_def_file).description).is_null() {
            fprintf(out, b"DESCRIPTION \0" as *const u8 as *const libc::c_char);
            quoteput((*pep_def_file).description, out, 1 as libc::c_int);
            fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
        }
        if (*pep_def_file).version_minor != -(1 as libc::c_int) {
            fprintf(
                out,
                b"VERSION %d.%d\n\0" as *const u8 as *const libc::c_char,
        ...
        } else if (*pep_def_file).version_major != -(1 as libc::c_int) {
            fprintf(
                out,
                b"VERSION %d\n\0" as *const u8 as *const libc::c_char,
                (*pep_def_file).version_major,
        ...
        if (*pep_def_file).stack_reserve != -(1 as libc::c_int)
            || (*pep_def_file).heap_reserve != -(1 as libc::c_int)
        {
            fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
        }
        if (*pep_def_file).stack_commit != -(1 as libc::c_int) {
            fprintf(
                ...
                (*pep_def_file).stack_commit,
            );
        } else if (*pep_def_file).stack_reserve != -(1 as libc::c_int) {
            fprintf(
                out,
                b"STACKSIZE 0x%x\n\0" as *const u8 as *const libc::c_char,
                (*pep_def_file).stack_reserve,
        ...
        if (*pep_def_file).heap_commit != -(1 as libc::c_int) {
            fprintf(
                ...
                (*pep_def_file).heap_commit,
            );
        } else if (*pep_def_file).heap_reserve != -(1 as libc::c_int) {
            fprintf(
                out,
                b"HEAPSIZE 0x%x\n\0" as *const u8 as *const libc::c_char,
                (*pep_def_file).heap_reserve,
        ...
        if (*pep_def_file).num_section_defs > 0 as libc::c_int {
            fprintf(out, b"\nSECTIONS\n\n\0" as *const u8 as *const libc::c_char);
            i = 0 as libc::c_int;
            while i < (*pep_def_file).num_section_defs {
                fprintf(out, b"    \0" as *const u8 as *const libc::c_char);
                quoteput(
                    (*((*pep_def_file).section_defs).offset(i as isize)).name,
                    out,
                    0 as libc::c_int,
                );
                if !((*((*pep_def_file).section_defs).offset(i as isize)).class)
                    .is_null()
                {
                    fprintf(out, b" CLASS \0" as *const u8 as *const libc::c_char);
                    quoteput(
                        (*((*pep_def_file).section_defs).offset(i as isize)).class,
                        out,
                        0 as libc::c_int,
                    );
                }
                if (*((*pep_def_file).section_defs).offset(i as isize)).flag_read != 0 {
                    fprintf(out, b" READ\0" as *const u8 as *const libc::c_char);
                }
                if (*((*pep_def_file).section_defs).offset(i as isize)).flag_write != 0 {
                    fprintf(out, b" WRITE\0" as *const u8 as *const libc::c_char);
                }
                if (*((*pep_def_file).section_defs).offset(i as isize)).flag_execute != 0
                {
                    fprintf(out, b" EXECUTE\0" as *const u8 as *const libc::c_char);
                }
                if (*((*pep_def_file).section_defs).offset(i as isize)).flag_shared != 0
                {
        ...
        if (*pep_def_file).num_exports > 0 as libc::c_int {
            fprintf(out, b"EXPORTS\n\0" as *const u8 as *const libc::c_char);
            i = 0 as libc::c_int;
            while i < (*pep_def_file).num_exports {
                let mut e: *mut def_file_export = ((*pep_def_file).exports)
                    .offset(i as isize);
                fprintf(out, b"    \0" as *const u8 as *const libc::c_char);
        ...
        if (*pep_def_file).num_imports > 0 as libc::c_int {
            fprintf(out, b"\nIMPORTS\n\n\0" as *const u8 as *const libc::c_char);
            i = 0 as libc::c_int;
            while i < (*pep_def_file).num_imports {
                let mut im: *mut def_file_import = ((*pep_def_file).imports)
                    .offset(i as isize);
                fprintf(out, b"    \0" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn pep_dll_generate_implib(
    ...
    while i < (*def).num_exports {
        ...
        if !((*((*pep_def_file).exports).offset(i as isize)).flag_private != 0) {
            let ref mut fresh2 = (*((*def).exports).offset(i as isize)).internal_name;
            *fresh2 = (*((*def).exports).offset(i as isize)).name;
                        ...
                        .offset(1 as libc::c_int as isize) as *mut asection)
            {
                ...
                match current_block_53 {
                    ...
                    _ => {
                        ...
                        (*n).archive_next = head;
                        head = n;
                        let ref mut fresh3 = (*((*def).exports).offset(i as isize))
                            .internal_name;
                        *fresh3 = internal;
                    }
                }
...
unsafe extern "C" fn make_tail(mut parent: *mut bfd) -> *mut bfd {
    ...
    bfd_set_section_size(id4, 8 as libc::c_int as bfd_size_type);
    d4 = xmalloc(8 as libc::c_int as size_t) as *mut libc::c_uchar;
    (*id4).contents = d4;
    memset(d4 as *mut libc::c_void, 0 as libc::c_int, 8 as libc::c_int as libc::c_ulong);
    bfd_set_section_size(id5, 8 as libc::c_int as bfd_size_type);
    d5 = xmalloc(8 as libc::c_int as size_t) as *mut libc::c_uchar;
    (*id5).contents = d5;
    memset(d5 as *mut libc::c_void, 0 as libc::c_int, 8 as libc::c_int as libc::c_ulong);
...
unsafe extern "C" fn quick_symbol(
    ...
    let fresh4 = symptr;
    symptr = symptr + 1;
    let ref mut fresh5 = *symtab.offset(fresh4 as isize);
    *fresh5 = sym;
}
unsafe extern "C" fn quick_section(
    ...
    let fresh6 = symptr;
    symptr = symptr + 1;
    let ref mut fresh7 = *symtab.offset(fresh6 as isize);
    *fresh7 = sym;
    (*sym).name = (*sec).name;
    (*sym).section = sec;
        ...
        match (*pep_details).pe_arch {
            1 => {
                quick_reloc(
                    ...
                    BFD_RELOC_32_PCREL as libc::c_int,
                    2 as libc::c_int,
                );
            }
            2 => {
...
unsafe extern "C" fn save_relocs(mut sec: *mut asection) {
    ...
    i = 0 as libc::c_int;
    while i < relcount {
        let ref mut fresh8 = *((*sec).orelocation).offset(i as isize);
        *fresh8 = ((*sec).relocation).offset(i as isize);
        i += 1;
        i;
    }
    let ref mut fresh9 = *((*sec).orelocation).offset(relcount as isize);
    *fresh9 = 0 as *mut reloc_cache_entry;
...
unsafe extern "C" fn quick_reloc(
    ...
    let ref mut fresh10 = (*reltab.offset(relcount as isize)).howto;
    *fresh10 = bfd_reloc_type_lookup(abfd, which_howto as bfd_reloc_code_real_type);
    let ref mut fresh11 = (*reltab.offset(relcount as isize)).sym_ptr_ptr;
    *fresh11 = symtab.offset(symidx as isize);
    relcount += 1;
    relcount;
}
...
unsafe extern "C" fn make_head(mut parent: *mut bfd) -> *mut bfd {
    ...
    if pep_use_nul_prefixed_import_tables != 0 {
        let ref mut fresh12 = *d2.offset(16 as libc::c_int as isize);
        *fresh12 = 8 as libc::c_int as libc::c_uchar;
        *d2.offset(0 as libc::c_int as isize) = *fresh12;
    }
    quick_reloc(
        abfd,
        0 as libc::c_int as bfd_size_type,
...
#[no_mangle]
pub unsafe extern "C" fn pep_process_import_defs(
    ...
    imp = (*pep_def_file).imports;
    pe_create_undef_table();
    module = (*pep_def_file).modules;
...
unsafe extern "C" fn pe_find_cdecl_alias_match(
    ...
    if !kv.is_null() {
        ...
        if (*h).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int {
            current_block = 6728762514860109505;
        } else {
    ...
    match current_block {
        17216689946888361452 => {
            if *lname.offset(0 as libc::c_int as isize) as libc::c_int == '?' as i32 {
                current_block = 13081822446274950671;
            } else if !at.is_null()
                || *lname.offset(0 as libc::c_int as isize) as libc::c_int == '@' as i32
            {
                if *lname.offset(0 as libc::c_int as isize) as libc::c_int == '@' as i32
                ...
                match current_block {
                    ...
                    _ => {
                        if *lname.offset(0 as libc::c_int as isize) as libc::c_int
                            == '_' as i32
                            && (*pep_details).underscored as libc::c_int != 0
                        {
                            *lname
                                .offset(
                                    0 as libc::c_int as isize,
...
unsafe extern "C" fn pe_undef_fill(
    ...
    if (*h).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int {
        let mut at: *mut libc::c_char = 0 as *mut libc::c_char;
        let ref mut fresh13 = (*udef_table.offset(undef_count as isize)).key;
        *fresh13 = xstrdup((*h).root.string);
        at = strchr(
        ...
        let ref mut fresh14 = (*udef_table.offset(undef_count as isize)).oname;
        *fresh14 = (*h).root.string;
        undef_count += 1;
        undef_count;
    }
    return 1 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn pep_implied_import_dll(
    ...
    num_entries = pe_get32(
        dll,
        opthdr_ofs
            .wrapping_add(92 as libc::c_int as libc::c_ulong)
            .wrapping_add((4 as libc::c_int * 4 as libc::c_int) as libc::c_ulong)
            as libc::c_int,
    ) as bfd_vma;
    ...
    export_rva = pe_get32(
        dll,
        opthdr_ofs
            .wrapping_add(96 as libc::c_int as libc::c_ulong)
            .wrapping_add((4 as libc::c_int * 4 as libc::c_int) as libc::c_ulong)
            as libc::c_int,
    ) as bfd_vma;
    ...
    if !(def_get_module(pep_def_file, dllname)).is_null() {
        if pep_dll_extra_pe_debug != 0 {
            printf(
...
#[no_mangle]
pub unsafe extern "C" fn pep_dll_build_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    ...
    {
        if pep_dll_enable_reloc_section != 0 {
            build_filler_bfd(0 as libc::c_int);
            pep_output_file_set_long_section_names(filler_bfd);
        }
        return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn pep_output_file_set_long_section_names(mut abfd: *mut bfd) {
    ...
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ...
        .expect("non-null function pointer")(abfd, pep_use_coff_long_section_names)
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
...
unsafe extern "C" fn generate_edata(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
    ...
    while i < (*pep_def_file).num_exports {
        if !(*exported_symbol_sections.offset(i as isize)).is_null()
            || (*((*pep_def_file).exports).offset(i as isize)).flag_forward
                as libc::c_int != 0
        {
            if (*((*pep_def_file).exports).offset(i as isize)).ordinal
                != -(1 as libc::c_int)
            {
                let mut ei: libc::c_int = (*((*pep_def_file).exports).offset(i as isize))
                    .ordinal - min_ordinal;
                ...
                if pi != -(1 as libc::c_int) {
                    einfo(
                        ...
                        (*((*pep_def_file).exports).offset(i as isize)).ordinal,
                        (*((*pep_def_file).exports).offset(i as isize)).name,
                        (*((*pep_def_file).exports).offset(pi as isize)).name,
                    );
                }
                *exported_symbols.offset(ei as isize) = i;
            }
            if !((*((*pep_def_file).exports).offset(i as isize)).its_name).is_null() {
                name_table_size = (name_table_size as libc::c_ulong)
                    .wrapping_add(
                        (strlen(
                            (*((*pep_def_file).exports).offset(i as isize)).its_name,
                        ))
                            .wrapping_add(1 as libc::c_int as libc::c_ulong),
                ...
                name_table_size = (name_table_size as libc::c_ulong)
                    .wrapping_add(
                        (strlen((*((*pep_def_file).exports).offset(i as isize)).name))
                            .wrapping_add(1 as libc::c_int as libc::c_ulong),
                    ) as libc::c_int as libc::c_int;
            }
        }
        if (*((*pep_def_file).exports).offset(i as isize)).flag_forward != 0 {
            name_table_size = (name_table_size as libc::c_ulong)
                .wrapping_add(
                    (strlen(
    ...
    while i < (*pep_def_file).num_exports {
                ...
                == -(1 as libc::c_int)
        {
            ...
            *exported_symbols.offset((next_ordinal - min_ordinal) as isize) = i;
            (*((*pep_def_file).exports).offset(i as isize)).ordinal = next_ordinal;
        }
        i += 1;
        i;
    }
...
unsafe extern "C" fn process_def_file_and_drectve(
    ...
    while !b.is_null() {
        ...
        if !s.is_null() {
            ...
            def_file_add_directive(pep_def_file, buf, size as libc::c_int);
            free(buf as *mut libc::c_void);
        }
        b = (*b).link.next;
    }
    if !((*pep_def_file).aligncomms).is_null() {
        let mut ac: *mut def_file_aligncomm = (*pep_def_file).aligncomms;
        while !ac.is_null() {
    ...
    if ((*info).type_0() as libc::c_int == type_pde as libc::c_int
        ...
        && (pep_dll_export_everything == 0 || pep_dll_exclude_all_symbols != 0)
    {
        return;
    }
    if (pep_dll_export_everything != 0
        || (*pep_def_file).num_exports == 0 as libc::c_int)
        && pep_dll_exclude_all_symbols == 0
    {
        b = (*info).input_bfds;
        while !b.is_null() {
            let mut symbols: *mut *mut asymbol = 0 as *mut *mut asymbol;
                ...
                if would_export {
                    ...
                    if !is_import(sn) {
                                ...
                                == bfd_link_hash_defined as libc::c_int)
                        {
                            ...
                            if auto_export(b, pep_def_file, sn) != 0 {
                                let mut is_dup: libc::c_int = 0 as libc::c_int;
    ...
    if pep_dll_kill_ats != 0 {
        i = 0 as libc::c_int;
        while i < (*pep_def_file).num_exports {
            if *((*((*pep_def_file).exports).offset(i as isize)).name)
                .offset(0 as libc::c_int as isize) as libc::c_int != '?' as i32
                && !(strchr(
                    (*((*pep_def_file).exports).offset(i as isize)).name,
                    '@' as i32,
                    ...
                    .is_null()
            {
                let mut lead_at: libc::c_int = (*(*((*pep_def_file).exports)
                    .offset(i as isize))
                ...
                let ref mut fresh15 = (*((*pep_def_file).exports).offset(i as isize))
                    .name;
                *fresh15 = tmp;
    ...
    if resort_needed {
        qsort(
            (*pep_def_file).exports as *mut libc::c_void,
            (*pep_def_file).num_exports as size_t,
    ...
    if pep_dll_stdcall_aliases != 0 {
        i = 0 as libc::c_int;
        while i < (*pep_def_file).num_exports {
            if !is_import((*((*pep_def_file).exports).offset(i as isize)).name) {
                if !(strchr(
                    (*((*pep_def_file).exports).offset(i as isize)).name,
                    '@' as i32,
                ))
                    .is_null()
                {
                    ...
                    let mut lead_at_0: libc::c_int = (*(*((*pep_def_file).exports)
                        .offset(i as isize))
                        .name as libc::c_int == '@' as i32) as libc::c_int;
                    ...
                    *strchr(tmp_0, '@' as i32) = 0 as libc::c_int as libc::c_char;
                    if auto_export(0 as *mut bfd, pep_def_file, tmp_0) != 0 {
                        def_file_add_export(
                            pep_def_file,
                            tmp_0,
                            (*((*pep_def_file).exports).offset(i as isize))
                                .internal_name,
                            -(1 as libc::c_int),
                            0 as *const libc::c_char,
                            &mut is_dup_0,
    ...
    while i < (*pep_def_file).num_exports {
            ...
            ) == 0 as libc::c_int
        {
            ...
            } else if pep_dll_warn_dup_exports != 0 {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
    ...
    (*pep_def_file).num_exports = j;
    exported_symbol_offsets = xmalloc(
        ((*pep_def_file).num_exports as libc::c_ulong)
    ...
    i = 0 as libc::c_int;
    while i < (*pep_def_file).num_exports {
        let mut int_name: *mut libc::c_char = (*((*pep_def_file).exports)
            .offset(i as isize))
            .internal_name;
                    ...
                    == bfd_link_hash_common as libc::c_int)
        {
            count_exported += 1;
            count_exported;
            if (*((*pep_def_file).exports).offset(i as isize)).flag_noname == 0 {
                count_exported_byname += 1;
                count_exported_byname;
            }
            if (*blhe).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int {
                let ref mut fresh20 = *exported_symbol_sections.offset(i as isize);
                *fresh20 = (*blhe).u.def.section;
            } else {
                let ref mut fresh21 = *exported_symbol_sections.offset(i as isize);
                *fresh21 = (*(*blhe).u.c.p).section;
            }
            if (*((*pep_def_file).exports).offset(i as isize)).ordinal
                != -(1 as libc::c_int)
            {
                if max_ordinal < (*((*pep_def_file).exports).offset(i as isize)).ordinal
                {
                    max_ordinal = (*((*pep_def_file).exports).offset(i as isize))
                        .ordinal;
                }
                if min_ordinal > (*((*pep_def_file).exports).offset(i as isize)).ordinal
                {
                    min_ordinal = (*((*pep_def_file).exports).offset(i as isize))
                        .ordinal;
                }
...
unsafe extern "C" fn auto_export(
    ...
    if pep_dll_do_default_excludes != 0 {
        ...
        afptr = (*pep_details).autofilter_symbollist;
        while !((*afptr).name).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn pep_exe_build_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    pep_dll_id_target(bfd_get_target(abfd));
...
#[no_mangle]
pub unsafe extern "C" fn pep_dll_fill_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    pep_exe_fill_sections(abfd, info);
    if !edata_s.is_null() {
...
unsafe extern "C" fn fill_edata(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
    ...
    if (*pep_def_file).version_major != -(1 as libc::c_int) {
        (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            (*pep_def_file).version_major as bfd_vma,
        ...
        (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
            ...
            (*pep_def_file).version_minor as bfd_vma,
    ...
    s = 0 as libc::c_int;
    while s < (*pep_def_file).num_exports {
        let mut ssec: *mut bfd_section = *exported_symbol_sections.offset(s as isize);
        if (*((*pep_def_file).exports).offset(s as isize)).ordinal != -(1 as libc::c_int)
            && ((*((*pep_def_file).exports).offset(s as isize)).flag_forward
                as libc::c_int != 0 || !ssec.is_null())
        {
            let mut ord: libc::c_int = (*((*pep_def_file).exports).offset(s as isize))
                .ordinal;
            if (*((*pep_def_file).exports).offset(s as isize)).flag_forward != 0 {
                (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    )(
                ...
                strcpy(
                    enamestr,
                    (*((*pep_def_file).exports).offset(s as isize)).internal_name,
                );
                enamestr = enamestr
                    .offset(
                        (strlen(
            ...
            if (*((*pep_def_file).exports).offset(s as isize)).flag_noname == 0 {
                let mut ename: *mut libc::c_char = (*((*pep_def_file).exports)
                    .offset(s as isize))
                    .name;
                if !((*((*pep_def_file).exports).offset(s as isize)).its_name).is_null()
                {
                    ename = (*((*pep_def_file).exports).offset(s as isize)).its_name;
                }
                (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                ...
                let fresh22 = hint;
                hint = hint + 1;
                (*((*pep_def_file).exports).offset(s as isize)).hint = fresh22;
            }
        }
        s += 1;
        s;
...
unsafe extern "C" fn fill_exported_offsets(
    ...
    while i < (*pep_def_file).num_exports {
        let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
        name = xmalloc(
            (strlen((*((*pep_def_file).exports).offset(i as isize)).internal_name))
                .wrapping_add(2 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        if (*pep_details).underscored as libc::c_int != 0
            && *(*((*pep_def_file).exports).offset(i as isize)).internal_name
                as libc::c_int != '@' as i32
        {
            *name = '_' as i32 as libc::c_char;
            ...
            strcpy(name, (*((*pep_def_file).exports).offset(i as isize)).internal_name);
        }
        blhe = bfd_link_hash_lookup(
            (*info).hash,
            name,
...
#[no_mangle]
pub unsafe extern "C" fn pep_exe_fill_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    pep_dll_id_target(bfd_get_target(abfd));
...
unsafe extern "C" fn generate_reloc(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
                                    ...
                                    != (*pep_details).imagebase_reloc
                            {
                                    ...
                                    == ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
                                {
                                            ...
                                            == bfd_link_hash_undefweak as libc::c_int
                                    {
                                        ...
                                        {
                                            current_block_43 = 2232869372362427478;
                                        } else {
                                                        ...
                                                        .offset(2 as libc::c_int as isize) as *mut asection
                                            {
                                                ...
                                                current_block_43 = 10758786907990354186;
                                            }
                                        }
                                    } else if blhe.is_null()
                                        || (*blhe).type_0() as libc::c_int
                                ...
                                match current_block_43 {
                                    ...
                                    _ => {
                                                ...
                                                as libc::c_int
                                        {
                                            64000 => {
                                                (*reloc_data.offset(total_relocs as isize))
                                                    .type_0 = 10 as libc::c_int as libc::c_char;
                                                total_relocs += 1;
                                                total_relocs;
                                                current_block_42 = 11441799814184323368;
                                            }
                                            32000 => {
                                                (*reloc_data.offset(total_relocs as isize))
                                            ...
                                            24002 => {
                                                        ...
                                                        == 5 as libc::c_int as libc::c_uint
                                                {
                                                    ...
                                                    current_block_42 = 14059198501229613690;
                                                }
                                            }
                                            _ => {
                                                current_block_42 = 14059198501229613690;
    ...
    while i < total_relocs {
        ...
        if this_page_0 != sec_page {
            while reloc_sz & 3 as libc::c_int as libc::c_ulong != 0 {
                let fresh23 = reloc_sz;
                reloc_sz = reloc_sz.wrapping_add(1);
                *reloc_d.offset(fresh23 as isize) = 0 as libc::c_int as libc::c_uchar;
            }
    ...
    while reloc_sz & 3 as libc::c_int as libc::c_ulong != 0 {
        let fresh24 = reloc_sz;
        reloc_sz = reloc_sz.wrapping_add(1);
        *reloc_d.offset(fresh24 as isize) = 0 as libc::c_int as libc::c_uchar;
    }
    if page_ptr != -(1 as libc::c_int) as bfd_vma {
        (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
...
unsafe extern "C" fn run_static_initializers() {
    ...
    autofilter_symbollist_i386 = [
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"DllEntryPoint\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_cygwin_dll_entry\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 18]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_cygwin_crt0_common\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_cygwin_noncygwin_dll_entry\0" as *const u8
                    as *const libc::c_char,
