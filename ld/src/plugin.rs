extern "C" {
    ...
    static mut bfd_use_reserved_id: libc::c_uint;
    ...
    fn bfd_set_arch_info(abfd: *mut bfd, arg: *const bfd_arch_info_type);
    fn bfd_get_arch_info(abfd: *mut bfd) -> *const bfd_arch_info_type;
    fn bfd_set_symtab(
        abfd: *mut bfd,
    ...
    fn bfd_get_gp_size(abfd: *mut bfd) -> libc::c_uint;
    ...
    fn bfd_plugin_open_input(_: *mut bfd, _: *mut ld_plugin_input_file) -> libc::c_int;
    fn bfd_plugin_target_p(_: *const bfd_target) -> bool;
    fn register_ld_plugin_object_p(
        object_p: Option::<unsafe extern "C" fn(*mut bfd) -> bfd_cleanup>,
    );
    fn bfd_plugin_close_file_descriptor(_: *mut bfd, _: libc::c_int);
    fn mmap(
...
pub type ld_plugin_api_version = libc::c_uint;
pub const LD_PLUGIN_API_VERSION: ld_plugin_api_version = 1;
pub type ld_plugin_output_file_type = libc::c_uint;
pub const LDPO_PIE: ld_plugin_output_file_type = 3;
pub const LDPO_DYN: ld_plugin_output_file_type = 2;
pub const LDPO_EXEC: ld_plugin_output_file_type = 1;
...
pub type ld_plugin_symbol_kind = libc::c_uint;
pub const LDPK_COMMON: ld_plugin_symbol_kind = 4;
pub const LDPK_WEAKUNDEF: ld_plugin_symbol_kind = 3;
pub const LDPK_UNDEF: ld_plugin_symbol_kind = 2;
pub const LDPK_WEAKDEF: ld_plugin_symbol_kind = 1;
pub const LDPK_DEF: ld_plugin_symbol_kind = 0;
pub type ld_plugin_symbol_visibility = libc::c_uint;
pub const LDPV_HIDDEN: ld_plugin_symbol_visibility = 3;
pub const LDPV_INTERNAL: ld_plugin_symbol_visibility = 2;
pub const LDPV_PROTECTED: ld_plugin_symbol_visibility = 1;
pub const LDPV_DEFAULT: ld_plugin_symbol_visibility = 0;
pub type ld_plugin_symbol_resolution = libc::c_uint;
pub const LDPR_PREVAILING_DEF_IRONLY_EXP: ld_plugin_symbol_resolution = 9;
pub const LDPR_RESOLVED_DYN: ld_plugin_symbol_resolution = 8;
pub const LDPR_RESOLVED_EXEC: ld_plugin_symbol_resolution = 7;
pub const LDPR_RESOLVED_IR: ld_plugin_symbol_resolution = 6;
pub const LDPR_PREEMPTED_IR: ld_plugin_symbol_resolution = 5;
pub const LDPR_PREEMPTED_REG: ld_plugin_symbol_resolution = 4;
pub const LDPR_PREVAILING_DEF_IRONLY: ld_plugin_symbol_resolution = 3;
pub const LDPR_PREVAILING_DEF: ld_plugin_symbol_resolution = 2;
pub const LDPR_UNDEF: ld_plugin_symbol_resolution = 1;
pub const LDPR_UNKNOWN: ld_plugin_symbol_resolution = 0;
...
pub type ld_plugin_onload = Option::<
    unsafe extern "C" fn(*mut ld_plugin_tv) -> ld_plugin_status,
>;
pub type plugin_arg_t = plugin_arg;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct plugin_arg {
    pub next: *mut plugin_arg,
    pub arg: *const libc::c_char,
}
pub type plugin_t = plugin;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct plugin {
    pub next: *mut plugin,
    ...
    pub args: *mut plugin_arg_t,
    pub n_args: size_t,
    pub claim_file_handler: ld_plugin_claim_file_handler,
    pub all_symbols_read_handler: ld_plugin_all_symbols_read_handler,
    pub cleanup_handler: ld_plugin_cleanup_handler,
    pub cleanup_done: bool,
}
pub type view_buffer_t = view_buffer;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct view_buffer {
    pub addr: *mut libc::c_char,
    pub filesize: size_t,
    pub offset: off_t,
}
pub type plugin_input_file_t = plugin_input_file;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct plugin_input_file {
    pub abfd: *mut bfd,
    pub ibfd: *mut bfd,
    pub view_buffer: view_buffer_t,
    pub name: *mut libc::c_char,
    pub fd: libc::c_int,
    pub use_mmap: bool,
    pub offset: off_t,
...
pub const wrapped: C2RustUnnamed_30 = 2;
pub type C2RustUnnamed_30 = libc::c_uint;
pub const wrapper: C2RustUnnamed_30 = 1;
pub const wrap_none: C2RustUnnamed_30 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct elf_symbol_type {
    pub symbol: asymbol,
    pub internal_elf_sym: Elf_Internal_Sym,
    pub tc_data: C2RustUnnamed_31,
...
#[no_mangle]
pub static mut report_plugin_symbols: bool = false;
#[no_mangle]
pub static mut no_more_claiming: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub unsafe extern "C" fn plugin_opt_plugin(mut plugin: *const libc::c_char) {
    let mut newplug: *mut plugin_t = 0 as *mut plugin_t;
    let mut curplug: *mut plugin_t = plugins_list;
    newplug = xmalloc(::core::mem::size_of::<plugin_t>() as libc::c_ulong)
        as *mut plugin_t;
    memset(
        newplug as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<plugin_t>() as libc::c_ulong,
    );
    (*newplug).name = plugin;
    (*newplug).dlhandle = dlopen(plugin, 0x2 as libc::c_int);
    if ((*newplug).dlhandle).is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: %s: error loading plugin: %s\n\0" as *const u8
    ...
    while !curplug.is_null() {
        if (*newplug).dlhandle == (*curplug).dlhandle {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %s: duplicated plugin\n\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                plugin,
            );
            free(newplug as *mut libc::c_void);
            return;
        }
        curplug = (*curplug).next;
    }
    *plugins_tail_chain_ptr = newplug;
    plugins_tail_chain_ptr = &mut (*newplug).next;
    last_plugin = newplug;
    last_plugin_args_tail_chain_ptr = &mut (*newplug).args;
}
#[no_mangle]
pub unsafe extern "C" fn plugin_opt_plugin_arg(
    mut arg: *const libc::c_char,
) -> libc::c_int {
    let mut newarg: *mut plugin_arg_t = 0 as *mut plugin_arg_t;
    if last_plugin.is_null() {
        return set_plugin_error(
            dcgettext(
                0 as *const libc::c_char,
                b"<no plugin>\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    }
    if *arg as libc::c_int == '-' as i32 {
        let mut p: *const libc::c_char = arg.offset(1 as libc::c_int as isize);
    ...
    newarg = xmalloc(::core::mem::size_of::<plugin_arg_t>() as libc::c_ulong)
        as *mut plugin_arg_t;
    (*newarg).arg = arg;
    (*newarg).next = 0 as *mut plugin_arg;
    *last_plugin_args_tail_chain_ptr = newarg;
    last_plugin_args_tail_chain_ptr = &mut (*newarg).next;
    (*last_plugin).n_args = ((*last_plugin).n_args).wrapping_add(1);
    (*last_plugin).n_args;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn plugin_load_plugins() {
    let mut my_tv: *mut ld_plugin_tv = 0 as *mut ld_plugin_tv;
    let mut max_args: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut curplug: *mut plugin_t = plugins_list;
    if curplug.is_null() {
        return;
    }
    while !curplug.is_null() {
        if (*curplug).n_args > max_args as libc::c_ulong {
            max_args = (*curplug).n_args as libc::c_uint;
        }
        curplug = (*curplug).next;
    }
    my_tv = xmalloc(
        (max_args.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong)
            .wrapping_add(tv_header_size)
            .wrapping_mul(::core::mem::size_of::<ld_plugin_tv>() as libc::c_ulong),
    ) as *mut ld_plugin_tv;
    set_tv_header(my_tv);
    curplug = plugins_list;
    while !curplug.is_null() {
        let mut rv: ld_plugin_status = LDPS_OK;
        let mut onloadfn: ld_plugin_onload = None;
        onloadfn = ::core::mem::transmute::<
            *mut libc::c_void,
            ld_plugin_onload,
        >(dlsym((*curplug).dlhandle, b"onload\0" as *const u8 as *const libc::c_char));
        if onloadfn.is_none() {
            onloadfn = ::core::mem::transmute::<
                *mut libc::c_void,
                ld_plugin_onload,
            >(
                dlsym(
                    (*curplug).dlhandle,
                    b"_onload\0" as *const u8 as *const libc::c_char,
                ),
            );
        }
        if onloadfn.is_none() {
        ...
        set_tv_plugin_args(curplug, &mut *my_tv.offset(tv_header_size as isize));
        called_plugin = curplug;
        rv = (Some(onloadfn.expect("non-null function pointer")))
            .expect("non-null function pointer")(my_tv);
        called_plugin = 0 as *mut plugin_t;
        if rv as libc::c_uint != LDPS_OK as libc::c_int as libc::c_uint {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%F%P: %s: plugin error: %d\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                (*curplug).name,
    ...
    orig_notice_all = link_info.notice_all() != 0;
    ...
    link_info.set_lto_plugin_active(1 as libc::c_int as libc::c_uint);
    link_info.callbacks = &mut plugin_callbacks;
    register_ld_plugin_object_p(
        Some(plugin_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
    );
    plugin_pagesize = getpagesize() as off_t;
}
#[no_mangle]
pub unsafe extern "C" fn plugin_error_plugin() -> *const libc::c_char {
    return if !error_plugin.is_null() {
        error_plugin
    } else {
        dcgettext(
            0 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn plugin_maybe_claim(mut entry: *mut lang_input_statement_type) {
    if !((*entry).header.type_0 as libc::c_uint
    ...
    if (plugin_object_p((*entry).the_bfd)).is_some() {
        let mut abfd: *mut bfd = (*(*entry).the_bfd).plugin_dummy_bfd;
        if ((*(*entry).the_bfd).my_archive).is_null() {
            bfd_close((*entry).the_bfd);
        }
        (*entry).the_bfd = abfd;
        ((*entry).flags).set_claimed(1 as libc::c_int as libc::c_uint);
    }
}
#[no_mangle]
pub unsafe extern "C" fn plugin_call_all_symbols_read() -> libc::c_int {
    let mut curplug: *mut plugin_t = plugins_list;
    no_more_claiming = 1 as libc::c_int != 0;
    while !curplug.is_null() {
        if ((*curplug).all_symbols_read_handler).is_some() {
            let mut rv: ld_plugin_status = LDPS_OK;
            called_plugin = curplug;
            rv = (Some(
                ((*curplug).all_symbols_read_handler).expect("non-null function pointer"),
            ))
    ...
    return if plugin_error_p() as libc::c_int != 0 {
        -(1 as libc::c_int)
    } else {
        0 as libc::c_int
    };
...
#[no_mangle]
pub unsafe extern "C" fn plugin_call_cleanup() {
    let mut curplug: *mut plugin_t = plugins_list;
    while !curplug.is_null() {
        if ((*curplug).cleanup_handler).is_some() && !(*curplug).cleanup_done {
            let mut rv: ld_plugin_status = LDPS_OK;
            (*curplug).cleanup_done = 1 as libc::c_int != 0;
            called_plugin = curplug;
            rv = (Some(((*curplug).cleanup_handler).expect("non-null function pointer")))
                .expect("non-null function pointer")();
            called_plugin = 0 as *mut plugin_t;
            if rv as libc::c_uint != LDPS_OK as libc::c_int as libc::c_uint {
                info_msg(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %s: error in plugin cleanup: %d (ignored)\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    (*curplug).name,
...
static mut plugins_list: *mut plugin_t = 0 as *const plugin_t as *mut plugin_t;
static mut plugins_tail_chain_ptr: *mut *mut plugin_t = unsafe {
    &plugins_list as *const *mut plugin_t as *mut *mut plugin_t
};
static mut last_plugin: *mut plugin_t = 0 as *const plugin_t as *mut plugin_t;
static mut last_plugin_args_tail_chain_ptr: *mut *mut plugin_arg_t = 0
    as *const *mut plugin_arg_t as *mut *mut plugin_arg_t;
static mut called_plugin: *mut plugin_t = 0 as *const plugin_t as *mut plugin_t;
static mut error_plugin: *const libc::c_char = 0 as *const libc::c_char;
static mut orig_notice_all: bool = false;
static mut orig_callbacks: *const bfd_link_callbacks = 0 as *const bfd_link_callbacks;
static mut plugin_callbacks: bfd_link_callbacks = bfd_link_callbacks {
    add_archive_element: None,
    multiple_definition: None,
    multiple_common: None,
    add_to_set: None,
    constructor: None,
    warning: None,
    undefined_symbol: None,
    reloc_overflow: None,
    reloc_dangerous: None,
    unattached_reloc: None,
    notice: None,
    einfo: None,
    info: None,
    minfo: None,
    override_segment_assignment: None,
    examine_strtab: None,
    ctf_new_symbol: None,
    ctf_new_dynsym: None,
    emit_ctf: None,
};
static mut plugin_pagesize: off_t = 0;
static mut tv_header_tags: [ld_plugin_tag; 17] = [
    LDPT_MESSAGE,
    LDPT_API_VERSION,
    LDPT_GNU_LD_VERSION,
    LDPT_LINKER_OUTPUT,
...
static mut tv_header_size: size_t = 0;
unsafe extern "C" fn plugin_notice(
    ...
    let mut orig_h: *mut bfd_link_hash_entry = h;
    if !h.is_null() {
        let mut sym_bfd: *mut bfd = 0 as *mut bfd;
        let mut ref_0: bool = 0 as libc::c_int != 0;
        if (*h).type_0() as libc::c_int == bfd_link_hash_warning as libc::c_int {
            h = (*h).u.i.link;
        }
        if !is_ir_dummy_bfd(abfd) {
                    ...
                    != 0 as libc::c_int as libc::c_uint
            {
                if (*h).type_0() as libc::c_int != bfd_link_hash_new as libc::c_int
                    || (*inh).type_0() as libc::c_int == bfd_link_hash_new as libc::c_int
                {
                    if (*abfd).flags & 0x40 as libc::c_int as libc::c_uint
                        == 0 as libc::c_int as libc::c_uint
                    {
                        (*inh).set_non_ir_ref_regular(1 as libc::c_int as libc::c_uint);
                    } else {
                        (*inh).set_non_ir_ref_dynamic(1 as libc::c_int as libc::c_uint);
                    }
                }
                if (*h).type_0() as libc::c_int != bfd_link_hash_new as libc::c_int {
                    ref_0 = 1 as libc::c_int != 0;
                }
            } else if !(flags & ((1 as libc::c_int) << 12 as libc::c_int) as libc::c_uint
                != 0 as libc::c_int as libc::c_uint)
            {
                if !(flags & ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_uint
                    != 0 as libc::c_int as libc::c_uint)
                {
                    if bfd_is_und_section(section) {
                        ...
                        if (*h).type_0() as libc::c_int
                            ...
                            && {
                                sym_bfd = (*(*(*h).u.c.p).section).owner;
                                is_ir_dummy_bfd(sym_bfd) as libc::c_int != 0
                            }
                        {
                        ...
                        ref_0 = 1 as libc::c_int != 0;
                    } else if ((*info).lto_all_symbols_read() as libc::c_int != 0
        ...
        if ref_0 {
                ...
                == 0 as libc::c_int as libc::c_uint
            {
                ...
                (*h).set_non_ir_ref_dynamic(1 as libc::c_int as libc::c_uint);
            }
        }
    }
    if orig_h.is_null() || orig_notice_all as libc::c_int != 0
        || !((*info).notice_hash).is_null()
            && !(bfd_hash_lookup(
                ...
                .is_null()
    {
        return (Some(((*orig_callbacks).notice).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(info, orig_h, inh, abfd, section, value, flags);
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn plugin_object_p(mut ibfd: *mut bfd) -> bfd_cleanup {
    let mut claimed: libc::c_int = 0;
    let mut input: *mut plugin_input_file_t = 0 as *mut plugin_input_file_t;
    let mut file: ld_plugin_input_file = ld_plugin_input_file {
    ...
    if (*ibfd).flags & 0x10000 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        return None;
    }
    if (*ibfd).plugin_format() as libc::c_int != bfd_plugin_unknown as libc::c_int {
        if (*ibfd).plugin_format() as libc::c_int == bfd_plugin_yes as libc::c_int {
            return Some(plugin_cleanup as unsafe extern "C" fn(*mut bfd) -> ())
        } else {
            return None
        }
    }
    ...
    input = bfd_alloc(
        abfd,
        ::core::mem::size_of::<plugin_input_file_t>() as libc::c_ulong,
    ) as *mut plugin_input_file_t;
    if input.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: plugin failed to allocate memory for input: %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
    ...
    if bfd_plugin_open_input(ibfd, &mut file) == 0 {
        return None;
    }
    if file.name == bfd_get_filename(ibfd) {
        file.name = plugin_strdup(abfd, file.name);
    }
    file.handle = input as *mut libc::c_void;
    (*input).abfd = abfd;
    (*input).ibfd = if !((*ibfd).my_archive).is_null() { ibfd } else { 0 as *mut bfd };
    (*input).view_buffer.addr = 0 as *mut libc::c_char;
    (*input).view_buffer.filesize = 0 as libc::c_int as size_t;
    (*input).view_buffer.offset = 0 as libc::c_int as off_t;
    (*input).fd = file.fd;
    (*input).use_mmap = 0 as libc::c_int != 0;
    ...
    if plugin_call_claim_file(&mut file, &mut claimed) != 0 {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: %s: plugin reported error claiming file\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            plugin_error_plugin(),
    ...
    if (*input).fd != -(1 as libc::c_int)
        && (claimed == 0 || !bfd_plugin_target_p((*ibfd).xvec))
    {
        release_plugin_file_descriptor(input);
    }
    if claimed != 0 {
        (*ibfd).set_plugin_format(bfd_plugin_yes);
        (*ibfd).plugin_dummy_bfd = abfd;
        bfd_make_readable(abfd);
        (*abfd).set_no_export((*ibfd).no_export());
        return Some(plugin_cleanup as unsafe extern "C" fn(*mut bfd) -> ());
    } else {
        if (*input).use_mmap {
            let mut addr: *mut libc::c_char = (*input).view_buffer.addr;
            let mut size: off_t = (*input).view_buffer.filesize as off_t;
            let mut bias: off_t = (*input).view_buffer.offset % plugin_pagesize;
            size += bias;
            addr = addr.offset(-(bias as isize));
            munmap(addr as *mut libc::c_void, size as size_t);
        }
        (*ibfd).set_plugin_format(bfd_plugin_no);
        bfd_close_all_done(abfd);
        return None;
    };
}
unsafe extern "C" fn set_plugin_error(mut plugin: *const libc::c_char) -> libc::c_int {
    error_plugin = plugin;
    return -(1 as libc::c_int);
}
unsafe extern "C" fn plugin_error_p() -> bool {
    return !error_plugin.is_null();
}
unsafe extern "C" fn plugin_get_ir_dummy_bfd(
    mut name: *const libc::c_char,
    mut srctemplate: *mut bfd,
) -> *mut bfd {
    let mut current_block: u64;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    let mut bfd_plugin_target: bool = false;
    bfd_use_reserved_id = 1 as libc::c_int as libc::c_uint;
    bfd_plugin_target = bfd_plugin_target_p((*srctemplate).xvec);
    abfd = bfd_create(
        concat(
            name,
            b" (symbol from plugin)\0" as *const u8 as *const libc::c_char,
            0 as *mut libc::c_void as *const libc::c_char,
        ),
        if bfd_plugin_target as libc::c_int != 0 {
    ...
    if !abfd.is_null() {
        (*abfd).flags
            |= (0x1000 as libc::c_int | 0x10000 as libc::c_int) as libc::c_uint;
        if bfd_make_writable(abfd) {
            if !bfd_plugin_target {
                bfd_set_arch_info(abfd, bfd_get_arch_info(srctemplate));
                bfd_set_gp_size(abfd, bfd_get_gp_size(srctemplate));
                if !(Some(
                    ((*(*abfd).xvec)._bfd_copy_private_bfd_data)
                        .expect("non-null function pointer"),
                ))
                    .expect("non-null function pointer")(srctemplate, abfd)
                {
                    current_block = 9765758728470184410;
                } else {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    flags = (0x10 as libc::c_int | 0x100 as libc::c_int
                        | 0x8 as libc::c_int | 0x1 as libc::c_int | 0x2 as libc::c_int
                        | 0x200000 as libc::c_int | 0x8000 as libc::c_int) as flagword;
                    if !(bfd_make_section_anyway_with_flags(
                        abfd,
    ...
    einfo(
        dcgettext(
            0 as *const libc::c_char,
            b"%F%P: could not create dummy IR bfd: %E\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
#[inline]
unsafe extern "C" fn is_ir_dummy_bfd(mut abfd: *const bfd) -> bool {
    return !abfd.is_null()
        && (*abfd).flags & 0x10000 as libc::c_int as libc::c_uint
            != 0 as libc::c_int as libc::c_uint;
}
unsafe extern "C" fn asymbol_from_plugin_symbol(
    mut abfd: *mut bfd,
    mut asym: *mut asymbol,
    mut ldsym: *const ld_plugin_symbol,
) -> ld_plugin_status {
    let mut flags: flagword = 0 as libc::c_int as flagword;
    let mut section: *mut bfd_section = 0 as *mut bfd_section;
    (*asym).the_bfd = abfd;
    (*asym)
        .name = if !((*ldsym).version).is_null() {
        concat(
            (*ldsym).name,
    ...
    (*asym).value = 0 as libc::c_int as symvalue;
    let mut current_block_21: u64;
    match (*ldsym).def as libc::c_int {
        1 => {
            flags = ((1 as libc::c_int) << 7 as libc::c_int) as flagword;
            current_block_21 = 11923795337831359737;
        }
        0 => {
            current_block_21 = 11923795337831359737;
        }
        3 => {
            flags = ((1 as libc::c_int) << 7 as libc::c_int) as flagword;
            current_block_21 = 3671894898333869379;
        }
        2 => {
            current_block_21 = 3671894898333869379;
        }
    ...
    match current_block_21 {
        11923795337831359737 => {
            ...
            if !((*ldsym).comdat_key).is_null() {
                let mut name: *mut libc::c_char = concat(
                ...
                if !section.is_null() {
                    ...
                    let mut sflags: flagword = 0;
                    sflags = (0x10 as libc::c_int | 0x100 as libc::c_int
                        | 0x8 as libc::c_int | 0x1 as libc::c_int | 0x2 as libc::c_int
                        | 0x200000 as libc::c_int | 0x8000 as libc::c_int
                        | 0x20000 as libc::c_int | 0 as libc::c_int) as flagword;
    ...
    if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        let mut elfsym: *mut elf_symbol_type = if (*asym).flags
            & ((1 as libc::c_int) << 21 as libc::c_int) as libc::c_uint
            == 0 as libc::c_int as libc::c_uint && !((*asym).the_bfd).is_null()
            && (*(*(*asym).the_bfd).xvec).flavour as libc::c_uint
                == bfd_target_elf_flavour as libc::c_int as libc::c_uint
            && !((*(*asym).the_bfd).tdata.elf_obj_data).is_null()
        {
            asym as *mut elf_symbol_type
        } else {
            0 as *mut elf_symbol_type
        };
        let mut visibility: libc::c_uchar = 0;
        if elfsym.is_null() {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%F%P: %s: non-ELF symbol in ELF BFD!\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                (*asym).name,
        ...
        if (*ldsym).def as libc::c_int == LDPK_COMMON as libc::c_int {
            (*elfsym).internal_elf_sym.st_shndx = (0xe as libc::c_uint).wrapping_neg();
            (*elfsym).internal_elf_sym.st_value = 1 as libc::c_int as bfd_vma;
        }
        match (*ldsym).visibility {
            0 => {
                visibility = 0 as libc::c_int as libc::c_uchar;
            }
            1 => {
                visibility = 3 as libc::c_int as libc::c_uchar;
            }
            2 => {
                visibility = 1 as libc::c_int as libc::c_uchar;
            }
            3 => {
                visibility = 2 as libc::c_int as libc::c_uchar;
            }
            _ => {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P: unknown ELF symbol visibility: %d!\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    (*ldsym).visibility,
        ...
        (*elfsym)
            ...
            | visibility as libc::c_int) as libc::c_uchar;
    }
    return LDPS_OK;
}
unsafe extern "C" fn register_claim_file(
    mut handler: ld_plugin_claim_file_handler,
) -> ld_plugin_status {
    if called_plugin.is_null() {
        info_assert(
            b"plugin.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn register_all_symbols_read(
    mut handler: ld_plugin_all_symbols_read_handler,
) -> ld_plugin_status {
    if called_plugin.is_null() {
        info_assert(
            b"plugin.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn register_cleanup(
    mut handler: ld_plugin_cleanup_handler,
) -> ld_plugin_status {
    if called_plugin.is_null() {
        info_assert(
            b"plugin.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn add_symbols(
    ...
    mut nsyms: libc::c_int,
    mut syms: *const ld_plugin_symbol,
) -> ld_plugin_status {
    let mut symptrs: *mut *mut asymbol = 0 as *mut *mut asymbol;
    let mut input: *mut plugin_input_file_t = handle as *mut plugin_input_file_t;
    let mut abfd: *mut bfd = (*input).abfd;
    ...
    while n < nsyms {
        ...
        let ref mut fresh0 = *symptrs.offset(n as isize);
        *fresh0 = bfdsym;
        rv = asymbol_from_plugin_symbol(abfd, bfdsym, syms.offset(n as isize));
        if rv as libc::c_uint != LDPS_OK as libc::c_int as libc::c_uint {
            return rv;
        }
        n += 1;
    ...
    bfd_set_symtab(abfd, symptrs, nsyms as libc::c_uint);
    return LDPS_OK;
}
unsafe extern "C" fn get_input_file(
    mut handle: *const libc::c_void,
    mut file: *mut ld_plugin_input_file,
) -> ld_plugin_status {
    let mut input: *const plugin_input_file_t = handle as *const plugin_input_file_t;
    if called_plugin.is_null() {
        info_assert(
            b"plugin.c\0" as *const u8 as *const libc::c_char,
    ...
    (*file).handle = handle as *mut libc::c_void;
    return LDPS_OK;
}
unsafe extern "C" fn get_view(
    mut handle: *const libc::c_void,
    mut viewp: *mut *const libc::c_void,
) -> ld_plugin_status {
    let mut input: *mut plugin_input_file_t = handle as *mut plugin_input_file_t;
    let mut buffer: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut size: size_t = (*input).filesize as size_t;
    let mut offset: off_t = (*input).offset;
    let mut bias: off_t = 0;
    if called_plugin.is_null() {
        info_assert(
            b"plugin.c\0" as *const u8 as *const libc::c_char,
    ...
    if size as off_t != (*input).filesize {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: unsupported input file size: %s (%ld bytes)\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*input).name,
    ...
    if !((*input).view_buffer.addr).is_null() && (*input).view_buffer.filesize == size
        && (*input).view_buffer.offset == offset
    {
        *viewp = (*input).view_buffer.addr as *const libc::c_void;
        return LDPS_OK;
    }
    ...
    offset -= bias;
    size = (size as libc::c_ulong).wrapping_add(bias as libc::c_ulong) as size_t
        as size_t;
    buffer = mmap(
    ...
    if buffer != -(1 as libc::c_int) as *mut libc::c_void as *mut libc::c_char {
        (*input).use_mmap = 1 as libc::c_int != 0;
        buffer = buffer.offset(bias as isize);
    } else {
        let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
        (*input).use_mmap = 0 as libc::c_int != 0;
        if lseek((*input).fd, offset, 0 as libc::c_int)
            < 0 as libc::c_int as libc::c_long
        {
            return LDPS_ERR;
        }
        buffer = bfd_alloc((*input).abfd, size) as *mut libc::c_char;
        if buffer.is_null() {
            return LDPS_ERR;
        }
        p = buffer;
        loop {
            let mut got: ssize_t = read((*input).fd, p as *mut libc::c_void, size);
            if got == 0 as libc::c_int as libc::c_long {
                break;
            }
            if got > 0 as libc::c_int as libc::c_long {
                p = p.offset(got as isize);
                size = (size as libc::c_ulong).wrapping_sub(got as libc::c_ulong)
                    as size_t as size_t;
    ...
    *viewp = buffer as *const libc::c_void;
    return LDPS_OK;
}
unsafe extern "C" fn release_plugin_file_descriptor(
    mut input: *mut plugin_input_file_t,
) {
    if (*input).fd != -(1 as libc::c_int) {
        bfd_plugin_close_file_descriptor((*input).ibfd, (*input).fd);
        (*input).fd = -(1 as libc::c_int);
    }
}
unsafe extern "C" fn release_input_file(
    mut handle: *const libc::c_void,
) -> ld_plugin_status {
    let mut input: *mut plugin_input_file_t = handle as *mut plugin_input_file_t;
    if called_plugin.is_null() {
...
#[inline]
unsafe extern "C" fn is_visible_from_outside(
    mut lsym: *mut ld_plugin_symbol,
    mut blhe: *mut bfd_link_hash_entry,
) -> bool {
    if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int {
        return 1 as libc::c_int != 0;
    }
    if (*blhe).non_ir_ref_dynamic() as libc::c_int != 0
        || link_info.export_dynamic() as libc::c_int != 0
        || link_info.type_0() as libc::c_int == type_dll as libc::c_int
    {
        if bfd_hide_sym_by_version(link_info.version_info, (*blhe).root.string) {
            return 0 as libc::c_int != 0;
        }
        if is_elf_hash_table(link_info.hash) {
            let mut el: *mut elf_link_hash_entry = blhe as *mut elf_link_hash_entry;
            let mut vis: libc::c_int = (*el).other() as libc::c_int & 0x3 as libc::c_int;
            return vis == 0 as libc::c_int || vis == 3 as libc::c_int;
        }
        return (*lsym).visibility == LDPV_DEFAULT as libc::c_int
            || (*lsym).visibility == LDPV_PROTECTED as libc::c_int;
    }
    return 0 as libc::c_int != 0;
}
unsafe extern "C" fn get_lto_kind(mut idx: libc::c_uint) -> *const libc::c_char {
    static mut buffer: [libc::c_char; 64] = [0; 64];
    let mut lto_kind_str: [*const libc::c_char; 5] = [
        b"DEF\0" as *const u8 as *const libc::c_char,
        b"WEAKDEF\0" as *const u8 as *const libc::c_char,
        b"UNDEF\0" as *const u8 as *const libc::c_char,
        b"WEAKUNDEF\0" as *const u8 as *const libc::c_char,
    ...
    {
        return lto_kind_str[idx as usize];
    }
    sprintf(
        buffer.as_mut_ptr(),
        dcgettext(
            0 as *const libc::c_char,
            b"unknown LTO kind value %x\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        idx,
    );
...
unsafe extern "C" fn get_lto_resolution(mut idx: libc::c_uint) -> *const libc::c_char {
    static mut buffer: [libc::c_char; 64] = [0; 64];
    static mut lto_resolution_str: [*const libc::c_char; 10] = [
        b"UNKNOWN\0" as *const u8 as *const libc::c_char,
        b"UNDEF\0" as *const u8 as *const libc::c_char,
        b"PREVAILING_DEF\0" as *const u8 as *const libc::c_char,
        b"PREVAILING_DEF_IRONLY\0" as *const u8 as *const libc::c_char,
        b"PREEMPTED_REG\0" as *const u8 as *const libc::c_char,
        b"PREEMPTED_IR\0" as *const u8 as *const libc::c_char,
        b"RESOLVED_IR\0" as *const u8 as *const libc::c_char,
        b"RESOLVED_EXEC\0" as *const u8 as *const libc::c_char,
        b"RESOLVED_DYN\0" as *const u8 as *const libc::c_char,
        b"PREVAILING_DEF_IRONLY_EXP\0" as *const u8 as *const libc::c_char,
    ];
    if (idx as libc::c_ulong)
        < (::core::mem::size_of::<[*const libc::c_char; 10]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<*const libc::c_char>() as libc::c_ulong)
    {
        return lto_resolution_str[idx as usize];
    }
    sprintf(
        buffer.as_mut_ptr(),
        dcgettext(
            0 as *const libc::c_char,
            b"unknown LTO resolution value %x\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        idx,
    );
...
unsafe extern "C" fn get_lto_visibility(mut idx: libc::c_uint) -> *const libc::c_char {
    static mut buffer: [libc::c_char; 64] = [0; 64];
    let mut lto_visibility_str: [*const libc::c_char; 4] = [
    ...
    if (idx as libc::c_ulong)
        < (::core::mem::size_of::<[*const libc::c_char; 4]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<*const libc::c_char>() as libc::c_ulong)
    {
        return lto_visibility_str[idx as usize];
    }
    sprintf(
        buffer.as_mut_ptr(),
        dcgettext(
            0 as *const libc::c_char,
            b"unknown LTO visibility value %x\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        idx,
    );
...
unsafe extern "C" fn get_symbols(
    mut handle: *const libc::c_void,
    mut nsyms: libc::c_int,
    mut syms: *mut ld_plugin_symbol,
    mut def_ironly_exp: libc::c_int,
) -> ld_plugin_status {
    let mut input: *const plugin_input_file_t = handle as *const plugin_input_file_t;
    let mut abfd: *const bfd = (*input).abfd as *const bfd;
    let mut n: libc::c_int = 0;
    if called_plugin.is_null() {
        info_assert(
            b"plugin.c\0" as *const u8 as *const libc::c_char,
    ...
    while n < nsyms {
        ...
        let mut owner_sec: *mut asection = 0 as *mut asection;
        let mut res: libc::c_int = 0;
        let mut h: *mut bfd_link_hash_entry = bfd_link_hash_lookup(
            link_info.hash,
            (*syms.offset(n as isize)).name,
            0 as libc::c_int != 0,
            0 as libc::c_int != 0,
            1 as libc::c_int != 0,
        );
        let mut wrap_status: C2RustUnnamed_30 = wrap_none;
        if (*syms.offset(n as isize)).def as libc::c_int != LDPK_UNDEF as libc::c_int
            && (*syms.offset(n as isize)).def as libc::c_int
                != LDPK_WEAKUNDEF as libc::c_int
        {
            blhe = h;
            if !blhe.is_null() && !(link_info.wrap_hash).is_null() {
                let mut unwrap: *mut bfd_link_hash_entry = unwrap_hash_lookup(
                    &mut link_info,
                    abfd as *mut bfd,
                    blhe,
                );
                if !unwrap.is_null() && unwrap != h {
                    wrap_status = wrapper;
                }
            }
        } else {
            blhe = bfd_wrapped_link_hash_lookup(
                link_info.output_bfd,
                &mut link_info,
                (*syms.offset(n as isize)).name,
                0 as libc::c_int != 0,
            ...
            if !blhe.is_null() && blhe != h {
                wrap_status = wrapped;
            }
        }
        if blhe.is_null() {
            match (*syms.offset(n as isize)).def as libc::c_int {
                2 | 3 => {
                    res = LDPR_UNDEF as libc::c_int;
                }
                0 | 1 | 4 => {
                    res = LDPR_PREVAILING_DEF_IRONLY as libc::c_int;
                }
                _ => {
                    ld_abort(
                        b"plugin.c\0" as *const u8 as *const libc::c_char,
                        ...
                        (*::core::mem::transmute::<
                            ...
                            &[libc::c_char; 85],
                        >(
                            b"enum ld_plugin_status get_symbols(const void *, int, struct ld_plugin_symbol *, int)\0",
                        ))
                            .as_ptr(),
                    );
                }
            }
        } else if (*blhe).type_0() as libc::c_int
            == bfd_link_hash_undefined as libc::c_int
            || (*blhe).type_0() as libc::c_int == bfd_link_hash_undefweak as libc::c_int
        {
            res = LDPR_UNDEF as libc::c_int;
        } else {
            if (*blhe).type_0() as libc::c_int != bfd_link_hash_defined as libc::c_int
                && (*blhe).type_0() as libc::c_int
                    != bfd_link_hash_defweak as libc::c_int
                && (*blhe).type_0() as libc::c_int != bfd_link_hash_common as libc::c_int
            {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P: %s: plugin symbol table corrupt (sym type %d)\n\0"
            ...
            owner_sec = if (*blhe).type_0() as libc::c_int
                == bfd_link_hash_common as libc::c_int
            {
                (*(*blhe).u.c.p).section
            } else {
            ...
            if (*syms.offset(n as isize)).def as libc::c_int == LDPK_UNDEF as libc::c_int
                || (*syms.offset(n as isize)).def as libc::c_int
                    == LDPK_WEAKUNDEF as libc::c_int
                || (*syms.offset(n as isize)).def as libc::c_int
                    == LDPK_COMMON as libc::c_int
            {
                if (*owner_sec).owner == link_info.output_bfd {
                    res = LDPR_RESOLVED_EXEC as libc::c_int;
                } else if (*owner_sec).owner == abfd as *mut bfd {
                    res = LDPR_PREVAILING_DEF_IRONLY as libc::c_int;
                } else if is_ir_dummy_bfd((*owner_sec).owner) {
                    res = LDPR_RESOLVED_IR as libc::c_int;
                } else if !((*owner_sec).owner).is_null()
                    && (*(*owner_sec).owner).flags & 0x40 as libc::c_int as libc::c_uint
                        != 0 as libc::c_int as libc::c_uint
                {
                    res = LDPR_RESOLVED_DYN as libc::c_int;
                } else {
                    res = LDPR_RESOLVED_EXEC as libc::c_int;
                }
            } else if (*owner_sec).owner == link_info.output_bfd {
                res = LDPR_PREEMPTED_REG as libc::c_int;
            } else if (*owner_sec).owner == abfd as *mut bfd {
                res = LDPR_PREVAILING_DEF_IRONLY as libc::c_int;
            } else if is_ir_dummy_bfd((*owner_sec).owner) {
                res = LDPR_PREEMPTED_IR as libc::c_int;
            } else {
                res = LDPR_PREEMPTED_REG as libc::c_int;
            }
            if res == LDPR_PREVAILING_DEF_IRONLY as libc::c_int {
                if (*blhe).non_ir_ref_regular() as libc::c_int != 0
                    || wrap_status as libc::c_uint
                        == wrapper as libc::c_int as libc::c_uint
                {
                    res = LDPR_PREVAILING_DEF as libc::c_int;
                } else if wrap_status as libc::c_uint
                    == wrapped as libc::c_int as libc::c_uint
                {
                    res = LDPR_RESOLVED_IR as libc::c_int;
                } else if is_visible_from_outside(&mut *syms.offset(n as isize), blhe) {
                    res = def_ironly_exp;
                }
            }
        }
        (*syms.offset(n as isize)).resolution = res;
        if report_plugin_symbols {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: symbol `%s' definition: %s, visibility: %s, resolution: %s\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
                (*syms.offset(n as isize)).name,
                get_lto_kind((*syms.offset(n as isize)).def as libc::c_uint),
                get_lto_visibility(
                    (*syms.offset(n as isize)).visibility as libc::c_uint,
                ),
                get_lto_resolution(res as libc::c_uint),
            );
        }
        n += 1;
        n;
...
unsafe extern "C" fn get_symbols_v1(
    ...
    return get_symbols(handle, nsyms, syms, LDPR_PREVAILING_DEF as libc::c_int);
}
unsafe extern "C" fn get_symbols_v2(
    mut handle: *const libc::c_void,
    mut nsyms: libc::c_int,
    mut syms: *mut ld_plugin_symbol,
) -> ld_plugin_status {
    return get_symbols(
        ...
        nsyms,
        syms,
        LDPR_PREVAILING_DEF_IRONLY_EXP as libc::c_int,
    );
}
unsafe extern "C" fn add_input_file(
    ...
    ((*is).flags).set_lto_output(1 as libc::c_int as libc::c_uint);
    return LDPS_OK;
}
unsafe extern "C" fn add_input_library(
    mut pathname: *const libc::c_char,
) -> ld_plugin_status {
    let mut is: *mut lang_input_statement_type = 0 as *mut lang_input_statement_type;
    if called_plugin.is_null() {
...
unsafe extern "C" fn set_extra_library_path(
    ...
    ldfile_add_library_path(xstrdup(path), 0 as libc::c_int != 0);
    return LDPS_OK;
}
unsafe extern "C" fn message(
    ...
    match level {
        0 => {
            vfinfo(stdout, format, args_0.as_va_list(), 0 as libc::c_int != 0);
            putchar('\n' as i32);
        }
        1 => {
            let mut newfmt: *mut libc::c_char = concat(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: warning: \0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                format,
                b"\n\0" as *const u8 as *const libc::c_char,
            ...
            vfinfo(stdout, newfmt, args_0.as_va_list(), 1 as libc::c_int != 0);
            free(newfmt as *mut libc::c_void);
        }
        3 | 2 | _ => {
            let mut newfmt_0: *mut libc::c_char = concat(
                if level == LDPL_FATAL as libc::c_int {
                ...
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: error: \0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                format,
                b"\n\0" as *const u8 as *const libc::c_char,
            ...
            fflush(stdout);
            vfinfo(stderr, newfmt_0, args_0.as_va_list(), 1 as libc::c_int != 0);
            fflush(stderr);
            free(newfmt_0 as *mut libc::c_void);
        }
    }
    return LDPS_OK;
}
static mut major: libc::c_uint = 0;
static mut minor: libc::c_uint = 0;
unsafe extern "C" fn set_tv_header(mut tv: *mut ld_plugin_tv) {
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < tv_header_size {
        (*tv.offset(i as isize)).tv_tag = tv_header_tags[i as usize];
        match (*tv.offset(i as isize)).tv_tag as libc::c_uint {
            11 => {
                let ref mut fresh1 = (*tv.offset(i as isize)).tv_u.tv_message;
                *fresh1 = Some(
                    message
                        as unsafe extern "C" fn(
                            libc::c_int,
            ...
            1 => {
                (*tv.offset(i as isize))
                    .tv_u
                    .tv_val = LD_PLUGIN_API_VERSION as libc::c_int;
            }
            17 => {
                (*tv.offset(i as isize))
                    .tv_u
                    ...
                    .wrapping_add(minor) as libc::c_int;
            }
            3 => {
                (*tv.offset(i as isize))
                    .tv_u
                    .tv_val = if link_info.type_0() as libc::c_int
                    == type_relocatable as libc::c_int
                {
                    LDPO_REL as libc::c_int
                } else if link_info.type_0() as libc::c_int == type_pde as libc::c_int {
                    LDPO_EXEC as libc::c_int
                } else if link_info.type_0() as libc::c_int == type_pie as libc::c_int {
                    LDPO_PIE as libc::c_int
                } else {
                    LDPO_DYN as libc::c_int
                };
            }
            15 => {
                let ref mut fresh2 = (*tv.offset(i as isize)).tv_u.tv_string;
                *fresh2 = output_filename;
            }
            5 => {
                let ref mut fresh3 = (*tv.offset(i as isize))
                    .tv_u
            ...
            6 => {
                let ref mut fresh4 = (*tv.offset(i as isize))
                    .tv_u
            ...
            7 => {
                let ref mut fresh5 = (*tv.offset(i as isize)).tv_u.tv_register_cleanup;
                *fresh5 = Some(
                    register_cleanup
                        as unsafe extern "C" fn(
            ...
            8 => {
                let ref mut fresh6 = (*tv.offset(i as isize)).tv_u.tv_add_symbols;
                *fresh6 = Some(
                    add_symbols
                        as unsafe extern "C" fn(
                            *mut libc::c_void,
            ...
            12 => {
                let ref mut fresh7 = (*tv.offset(i as isize)).tv_u.tv_get_input_file;
                *fresh7 = Some(
                    get_input_file
                        as unsafe extern "C" fn(
                            *const libc::c_void,
            ...
            18 => {
                let ref mut fresh8 = (*tv.offset(i as isize)).tv_u.tv_get_view;
                *fresh8 = Some(
                    get_view
                        as unsafe extern "C" fn(
                            *const libc::c_void,
            ...
            13 => {
                let ref mut fresh9 = (*tv.offset(i as isize)).tv_u.tv_release_input_file;
                *fresh9 = Some(
                    release_input_file
                        as unsafe extern "C" fn(*const libc::c_void) -> ld_plugin_status,
                );
            }
            9 => {
                let ref mut fresh10 = (*tv.offset(i as isize)).tv_u.tv_get_symbols;
                *fresh10 = Some(
                    get_symbols_v1
                        as unsafe extern "C" fn(
                            *const libc::c_void,
            ...
            25 => {
                let ref mut fresh11 = (*tv.offset(i as isize)).tv_u.tv_get_symbols;
                *fresh11 = Some(
                    get_symbols_v2
                        as unsafe extern "C" fn(
                            *const libc::c_void,
            ...
            10 => {
                let ref mut fresh12 = (*tv.offset(i as isize)).tv_u.tv_add_input_file;
                *fresh12 = Some(
                    add_input_file
                        as unsafe extern "C" fn(*const libc::c_char) -> ld_plugin_status,
                );
            }
            14 => {
                let ref mut fresh13 = (*tv.offset(i as isize)).tv_u.tv_add_input_library;
                *fresh13 = Some(
                    add_input_library
                        as unsafe extern "C" fn(*const libc::c_char) -> ld_plugin_status,
                );
            ...
            16 => {
                let ref mut fresh14 = (*tv.offset(i as isize))
                    .tv_u
...
unsafe extern "C" fn set_tv_plugin_args(
    mut plugin: *mut plugin_t,
    mut tv: *mut ld_plugin_tv,
) {
    let mut arg: *mut plugin_arg_t = (*plugin).args;
    while !arg.is_null() {
    ...
    (*tv).tv_tag = LDPT_NULL;
    (*tv).tv_u.tv_val = 0 as libc::c_int;
}
unsafe extern "C" fn plugin_call_claim_file(
    mut file: *const ld_plugin_input_file,
    mut claimed: *mut libc::c_int,
) -> libc::c_int {
    let mut curplug: *mut plugin_t = plugins_list;
    *claimed = 0 as libc::c_int;
    while !curplug.is_null() && *claimed == 0 {
        if ((*curplug).claim_file_handler).is_some() {
            let mut rv: ld_plugin_status = LDPS_OK;
            called_plugin = curplug;
            rv = (Some(
                ((*curplug).claim_file_handler).expect("non-null function pointer"),
            ))
                .expect("non-null function pointer")(file, claimed);
            called_plugin = 0 as *mut plugin_t;
            if rv as libc::c_uint != LDPS_OK as libc::c_int as libc::c_uint {
                set_plugin_error((*curplug).name);
            }
...
unsafe extern "C" fn plugin_strdup(
    mut abfd: *mut bfd,
    mut str: *const libc::c_char,
) -> *mut libc::c_char {
    let mut strlength: size_t = 0;
    let mut copy: *mut libc::c_char = 0 as *mut libc::c_char;
    strlength = (strlen(str)).wrapping_add(1 as libc::c_int as libc::c_ulong);
    copy = bfd_alloc(abfd, strlength) as *mut libc::c_char;
    if copy.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: plugin_strdup failed to allocate memory: %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            bfd_get_error() as libc::c_uint,
...
unsafe extern "C" fn run_static_initializers() {
    ...
    major = (237000000 as libc::c_int as libc::c_ulong)
        .wrapping_div(100000000 as libc::c_ulong) as libc::c_uint;
    minor = ((237000000 as libc::c_int as libc::c_ulong)
        .wrapping_div(1000000 as libc::c_ulong) as libc::c_uint)
