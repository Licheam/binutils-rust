extern "C" {
    ...
    static mut lineno: libc::c_uint;
    fn ldlex_filename() -> *const libc::c_char;
    static mut lang_statement_iteration: libc::c_int;
    fn lang_memory_region_lookup(
        _: *const libc::c_char,
        _: bool,
    ) -> *mut lang_memory_region_type;
    fn section_for_dot() -> *mut asection;
...
pub type token_code_type = libc::c_int;
...
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct definedness_hash_entry {
    pub root: bfd_hash_entry,
    pub final_sec: *mut asection,
    #[bitfield(name = "iteration", ty = "libc::c_uint", bits = "0..=7")]
    #[bitfield(name = "by_object", ty = "libc::c_uint", bits = "8..=8")]
    pub iteration_by_object: [u8; 2],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 6],
}
#[derive(Copy, Clone)]
...
#[no_mangle]
pub static mut expld: ldexp_control = ldexp_control {
    phase: lang_first_phase_enum,
    assigning_to_dot: false,
    rel_from_abs: false,
    assign_name: 0 as *const libc::c_char,
    assign_src: 0 as *const bfd_link_hash_entry as *mut bfd_link_hash_entry,
    result: etree_value_type {
        value: 0,
        str_0: 0 as *const libc::c_char as *mut libc::c_char,
        section: 0 as *const asection as *mut asection,
        valid_p: false,
    },
    dot: 0,
    dotp: 0 as *const bfd_vma as *mut bfd_vma,
    section: 0 as *const asection as *mut asection,
    dataseg: seg_align_type {
        phase: exp_seg_none,
        base: 0,
        relro_offset: 0,
        relro_end: 0,
        ...
        pagesize: 0,
        maxpagesize: 0,
        relro: exp_seg_relro_none,
        relro_start_stat: 0 as *const lang_statement_union as *mut lang_statement_union,
        relro_end_stat: 0 as *const lang_statement_union as *mut lang_statement_union,
    },
};
#[no_mangle]
pub static mut segments: *mut segment_type = 0 as *const segment_type
    as *mut segment_type;
#[no_mangle]
pub unsafe extern "C" fn exp_intop(mut value: bfd_vma) -> *mut etree_type {
    let mut new_e: *mut etree_type = stat_alloc(
        ::core::mem::size_of::<C2RustUnnamed_17>() as libc::c_ulong,
    ) as *mut etree_type;
    (*new_e).type_0.node_code = 258 as libc::c_int;
    (*new_e).type_0.filename = ldlex_filename();
    (*new_e).type_0.lineno = lineno;
    (*new_e).value.value = value;
    (*new_e).value.str_0 = 0 as *mut libc::c_char;
    (*new_e).type_0.node_class = etree_value;
    return new_e;
}
#[no_mangle]
pub unsafe extern "C" fn exp_bigintop(
    mut value: bfd_vma,
    ...
    (*new_e).type_0.lineno = lineno;
    (*new_e).value.value = value;
    (*new_e).value.str_0 = str;
    (*new_e).type_0.node_class = etree_value;
    return new_e;
}
#[no_mangle]
pub unsafe extern "C" fn exp_relop(
    mut section: *mut asection,
    mut value: bfd_vma,
) -> *mut etree_type {
    let mut new_e: *mut etree_type = stat_alloc(
        ::core::mem::size_of::<C2RustUnnamed_16>() as libc::c_ulong,
    ) as *mut etree_type;
    (*new_e).type_0.node_code = 366 as libc::c_int;
    (*new_e).type_0.filename = ldlex_filename();
    (*new_e).type_0.lineno = lineno;
    (*new_e).type_0.node_class = etree_rel;
    (*new_e).rel.section = section;
    (*new_e).rel.value = value;
    return new_e;
}
#[no_mangle]
pub unsafe extern "C" fn exp_fold_tree(
    mut tree: *mut etree_type,
    mut current_section: *mut asection,
    mut dotp: *mut bfd_vma,
) {
    expld.rel_from_abs = 0 as libc::c_int != 0;
    expld.dot = *dotp;
    expld.dotp = dotp;
...
#[no_mangle]
pub unsafe extern "C" fn exp_fold_tree_no_dot(mut tree: *mut etree_type) {
    expld.rel_from_abs = 0 as libc::c_int != 0;
    expld.dot = 0 as libc::c_int as bfd_vma;
    expld.dotp = 0 as *mut bfd_vma;
    expld
...
#[no_mangle]
pub unsafe extern "C" fn exp_binop(
    mut code: libc::c_int,
    mut lhs: *mut etree_type,
    mut rhs: *mut etree_type,
) -> *mut etree_type {
    let mut new_e: *mut etree_type = stat_alloc(
        if ::core::mem::size_of::<C2RustUnnamed_22>() as libc::c_ulong
            > ::core::mem::size_of::<C2RustUnnamed_17>() as libc::c_ulong
        {
    ...
    (*new_e).type_0.node_code = code;
    (*new_e).type_0.filename = (*lhs).type_0.filename;
    (*new_e).type_0.lineno = (*lhs).type_0.lineno;
    (*new_e).binary.lhs = lhs;
    (*new_e).binary.rhs = rhs;
    (*new_e).type_0.node_class = etree_binary;
    if (*lhs).type_0.node_class as libc::c_uint
        == etree_value as libc::c_int as libc::c_uint
        && (*rhs).type_0.node_class as libc::c_uint
            == etree_value as libc::c_int as libc::c_uint && code != 279 as libc::c_int
        && code != 292 as libc::c_int && code != 293 as libc::c_int
    {
...
#[no_mangle]
pub unsafe extern "C" fn exp_trinop(
    mut code: libc::c_int,
    mut cond: *mut etree_type,
    mut lhs: *mut etree_type,
    mut rhs: *mut etree_type,
) -> *mut etree_type {
    let mut new_e: *mut etree_type = stat_alloc(
    ...
    (*new_e).type_0.node_code = code;
    (*new_e).type_0.filename = (*cond).type_0.filename;
    (*new_e).type_0.lineno = (*cond).type_0.lineno;
    (*new_e).trinary.lhs = lhs;
    (*new_e).trinary.cond = cond;
    (*new_e).trinary.rhs = rhs;
    (*new_e).type_0.node_class = etree_trinary;
    if (*cond).type_0.node_class as libc::c_uint
        == etree_value as libc::c_int as libc::c_uint
        && (*lhs).type_0.node_class as libc::c_uint
            == etree_value as libc::c_int as libc::c_uint
        && (*rhs).type_0.node_class as libc::c_uint
            == etree_value as libc::c_int as libc::c_uint
    {
...
#[no_mangle]
pub unsafe extern "C" fn exp_unop(
    mut code: libc::c_int,
    mut child: *mut etree_type,
) -> *mut etree_type {
    let mut new_e: *mut etree_type = stat_alloc(
    ...
    (*new_e).unary.type_0.node_code = code;
    (*new_e).unary.type_0.filename = (*child).type_0.filename;
    (*new_e).unary.type_0.lineno = (*child).type_0.lineno;
    (*new_e).unary.child = child;
    (*new_e).unary.type_0.node_class = etree_unary;
    if (*child).type_0.node_class as libc::c_uint
        == etree_value as libc::c_int as libc::c_uint && code != 279 as libc::c_int
        && code != 352 as libc::c_int && code != 320 as libc::c_int
        && code != 294 as libc::c_int
    {
        exp_value_fold(new_e);
    }
    return new_e;
...
#[no_mangle]
pub unsafe extern "C" fn exp_nameop(
    mut code: libc::c_int,
    ...
    (*new_e).name.type_0.node_code = code;
    (*new_e).name.type_0.filename = ldlex_filename();
    (*new_e).name.type_0.lineno = lineno;
    (*new_e).name.name = name;
    (*new_e).name.type_0.node_class = etree_name;
    return new_e;
}
#[no_mangle]
pub unsafe extern "C" fn exp_assign(
    mut dst: *const libc::c_char,
    mut src: *mut etree_type,
    mut hidden: bool,
) -> *mut etree_type {
    return exp_assop(dst, src, etree_assign, hidden);
}
#[no_mangle]
pub unsafe extern "C" fn exp_defsym(
    mut dst: *const libc::c_char,
    mut src: *mut etree_type,
) -> *mut etree_type {
    return exp_assop(dst, src, etree_assign, 0 as libc::c_int != 0);
}
#[no_mangle]
pub unsafe extern "C" fn exp_provide(
    mut dst: *const libc::c_char,
    mut src: *mut etree_type,
    mut hidden: bool,
) -> *mut etree_type {
...
#[no_mangle]
pub unsafe extern "C" fn exp_assert(
    mut exp: *mut etree_type,
    mut message: *const libc::c_char,
) -> *mut etree_type {
    let mut n: *mut etree_type = 0 as *mut etree_type;
    n = stat_alloc(::core::mem::size_of::<C2RustUnnamed_15>() as libc::c_ulong)
        as *mut etree_type;
    (*n).assert_s.type_0.node_code = '!' as i32;
    (*n).assert_s.type_0.filename = (*exp).type_0.filename;
    (*n).assert_s.type_0.lineno = (*exp).type_0.lineno;
    (*n).assert_s.type_0.node_class = etree_assert;
    (*n).assert_s.child = exp;
    (*n).assert_s.message = message;
    return n;
}
#[no_mangle]
pub unsafe extern "C" fn exp_print_tree(mut tree: *mut etree_type) {
    let mut function_like: bool = false;
    ...
    match (*tree).type_0.node_class as libc::c_uint {
        7 => {
            minfo(b"0x%v\0" as *const u8 as *const libc::c_char, (*tree).value.value);
            return;
        }
        9 => {
            if !((*(*tree).rel.section).owner).is_null() {
                minfo(
                    b"%pB:\0" as *const u8 as *const libc::c_char,
                    (*(*tree).rel.section).owner,
                );
            }
            minfo(
                b"%s+0x%v\0" as *const u8 as *const libc::c_char,
                (*(*tree).rel.section).name,
                (*tree).rel.value,
            );
            return;
        }
        4 => {
            ...
            exp_print_token((*tree).type_0.node_code, 1 as libc::c_int);
            exp_print_tree((*tree).assign.src);
        }
        5 | 6 => {
            fprintf(
                config.map_file,
                b"PROVIDE (%s = \0" as *const u8 as *const libc::c_char,
                (*tree).assign.dst,
            );
            exp_print_tree((*tree).assign.src);
            fputc(')' as i32, config.map_file);
        }
        0 => {
            function_like = 0 as libc::c_int != 0;
            match (*tree).type_0.node_code {
                325 | 326 | 279 | 292 | 293 => {
                    function_like = 1 as libc::c_int != 0;
                }
                305 => {
                    exp_print_token((*tree).type_0.node_code, 0 as libc::c_int);
                    fputs(
            ...
            exp_print_tree((*tree).binary.lhs);
            if function_like {
                fprintf(config.map_file, b", \0" as *const u8 as *const libc::c_char);
            } else {
                exp_print_token((*tree).type_0.node_code, 1 as libc::c_int);
            }
            exp_print_tree((*tree).binary.rhs);
        ...
        2 => {
            exp_print_token((*tree).unary.type_0.node_code, 0 as libc::c_int);
            if !((*tree).unary.child).is_null() {
                fprintf(config.map_file, b" (\0" as *const u8 as *const libc::c_char);
        ...
        8 => {
            fprintf(config.map_file, b"ASSERT (\0" as *const u8 as *const libc::c_char);
        ...
        3 => {
            if (*tree).type_0.node_code == 259 as libc::c_int {
                fputs((*tree).name.name, config.map_file);
            } else {
                exp_print_token((*tree).type_0.node_code, 0 as libc::c_int);
                if !((*tree).name.name).is_null() {
                    fprintf(
                        config.map_file,
                        b" (%s)\0" as *const u8 as *const libc::c_char,
                        (*tree).name.name,
        ...
        _ => {
            info_assert(
                b"ldexp.c\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn exp_get_vma(
    mut tree: *mut etree_type,
    mut def: bfd_vma,
    ...
    if !tree.is_null() {
        ...
        if expld.result.valid_p {
            ...
            && expld.phase as libc::c_uint
                != lang_mark_phase_enum as libc::c_int as libc::c_uint
        {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%F%P:%pS: nonconstant expression for %s\n\0" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn exp_get_power(
    mut tree: *mut etree_type,
    mut name: *mut libc::c_char,
) -> libc::c_int {
    let mut x: bfd_vma = exp_get_vma(tree, -(1 as libc::c_int) as bfd_vma, name);
    let mut p2: bfd_vma = 0;
    let mut n: libc::c_int = 0;
    if x == -(1 as libc::c_int) as bfd_vma {
        return -(1 as libc::c_int);
    }
    n = 0 as libc::c_int;
    p2 = 1 as libc::c_int as bfd_vma;
    while p2 < x {
        if p2 == 0 as libc::c_int as libc::c_ulong {
            break;
        }
        n += 1;
        n;
...
#[no_mangle]
pub unsafe extern "C" fn exp_get_fill(
    mut tree: *mut etree_type,
    mut def: *mut fill_type,
    mut name: *mut libc::c_char,
) -> *mut fill_type {
    let mut fill: *mut fill_type = 0 as *mut fill_type;
    ...
    if !(expld.result.str_0).is_null()
        && {
            len = strlen(expld.result.str_0);
        ...
        }
    {
        ...
        fill = xmalloc(
            len
                ...
                .wrapping_add(::core::mem::size_of::<fill_type>() as libc::c_ulong)
        ...
        (*fill)
            ...
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(2 as libc::c_int as libc::c_ulong);
        dst = ((*fill).data).as_mut_ptr();
        s = expld.result.str_0 as *mut libc::c_uchar;
        val = 0 as libc::c_int as libc::c_uint;
        loop {
            let mut digit: libc::c_uint = 0;
            let fresh0 = s;
            s = s.offset(1);
            digit = (*fresh0 as libc::c_int - '0' as i32) as libc::c_uint;
        ...
        val = expld.result.value as libc::c_uint;
        *((*fill).data)
            .as_mut_ptr()
            .offset(
        ...
        *((*fill).data)
            ...
            ) = (val >> 0 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
            as libc::c_uchar;
        (*fill).size = 4 as libc::c_int as size_t;
    }
    return fill;
}
#[no_mangle]
pub unsafe extern "C" fn exp_get_abs_int(
    mut tree: *mut etree_type,
    mut def: libc::c_int,
    mut name: *mut libc::c_char,
) -> bfd_vma {
    if !tree.is_null() {
        ...
        if expld.result.valid_p {
            if !(expld.result.section).is_null() {
                expld
                    .result
                    .value = (expld.result.value as libc::c_ulong)
    ...
    return def as bfd_vma;
}
#[no_mangle]
pub unsafe extern "C" fn ldexp_init() {
    if !bfd_hash_table_init_n(
        &mut definedness_table,
        Some(
            definedness_newfunc
        ...
        ::core::mem::size_of::<definedness_hash_entry>() as libc::c_ulong
            as libc::c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn ldexp_finalize_syms() {
    bfd_hash_traverse(
        &mut definedness_table,
        Some(
            set_sym_sections
                as unsafe extern "C" fn(*mut bfd_hash_entry, *mut libc::c_void) -> bool,
        ),
        0 as *mut libc::c_void,
    );
}
#[no_mangle]
pub unsafe extern "C" fn ldexp_is_final_sym_absolute(
    mut h: *const bfd_link_hash_entry,
) -> bool {
    if (*h).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
        && (*h).u.def.section
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
    {
        let mut def: *const definedness_hash_entry = 0 as *const definedness_hash_entry;
        if (*h).ldscript_def() == 0 {
            return 1 as libc::c_int != 0;
        }
        def = symbol_defined((*h).root.string);
        if !def.is_null() {
            return (*def).final_sec
                == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                    as *mut asection;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn ldexp_finish() {
    bfd_hash_table_free(&mut definedness_table);
}
unsafe extern "C" fn exp_fold_tree_1(mut tree: *mut etree_type) {
    if tree.is_null() {
        memset(
            &mut expld.result as *mut etree_value_type as *mut libc::c_void,
            0 as libc::c_int,
            ::core::mem::size_of::<etree_value_type>() as libc::c_ulong,
        );
        return;
    }
    ...
    match (*tree).type_0.node_class as libc::c_uint {
        7 => {
            if expld.section
                == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                    as *mut asection && !config.sane_expr
            {
                new_abs((*tree).value.value);
            } else {
                new_number((*tree).value.value);
            }
            expld.result.str_0 = (*tree).value.str_0;
        }
        9 => {
            if expld.phase as libc::c_uint
                != lang_first_phase_enum as libc::c_int as libc::c_uint
            {
                let mut output_section: *mut asection = (*(*tree).rel.section)
                    .output_section;
                new_rel(
                    ((*tree).rel.value)
                        .wrapping_add((*(*tree).rel.section).output_offset),
                    output_section,
                );
            } else {
                memset(
        ...
        4 | 5 | 6 => {
            if *((*tree).assign.dst).offset(0 as libc::c_int as isize) as libc::c_int
                == '.' as i32
                && *((*tree).assign.dst).offset(1 as libc::c_int as isize) as libc::c_int
                    == 0 as libc::c_int
            {
                    ...
                    != etree_assign as libc::c_int as libc::c_uint
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P:%pS can not PROVIDE assignment to location counter\n\0"
                ...
                if expld.phase as libc::c_uint
                    != lang_first_phase_enum as libc::c_int as libc::c_uint
                {
                    expld.assigning_to_dot = 1 as libc::c_int != 0;
                    exp_fold_tree_1((*tree).assign.src);
                    expld.assigning_to_dot = 0 as libc::c_int != 0;
                    if expld.phase as libc::c_uint
                        == lang_mark_phase_enum as libc::c_int as libc::c_uint
                        && expld.section
                        ...
                        && !(expld.result.valid_p as libc::c_int != 0
                            && expld.result.value == 0 as libc::c_int as libc::c_ulong
                            && (is_value((*tree).assign.src, 0 as libc::c_int as bfd_vma)
                                as libc::c_int != 0
                                || is_sym_value(
                                    (*tree).assign.src,
                                    0 as libc::c_int as bfd_vma,
                                ) as libc::c_int != 0
                                || is_dot_plus_0((*tree).assign.src) as libc::c_int != 0
                                || is_align_conditional((*tree).assign.src) as libc::c_int
                                    != 0))
                    {
                        (*expld.section).flags
                                ...
                                .offset(1 as libc::c_int as isize) as *mut asection
                    {
                            ...
                            != lang_mark_phase_enum as libc::c_int as libc::c_uint
                        {
                            einfo(
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"%F%P:%pS invalid assignment to location counter\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                tree,
                    ...
                    } else if (expld.dotp).is_null() {
                        einfo(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%F%P:%pS assignment to location counter invalid outside of SECTIONS\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            tree,
                        ...
                        <= lang_allocating_phase_enum as libc::c_int as libc::c_uint
                        || expld.section
                            == &mut *_bfd_std_section
                                .as_mut_ptr()
                                .offset(2 as libc::c_int as isize) as *mut asection
                    {
                        let mut nextdot: bfd_vma = 0;
                        nextdot = expld.result.value;
                        if !(expld.result.section).is_null() {
                            nextdot = (nextdot as libc::c_ulong)
                                .wrapping_add((*expld.result.section).vma) as bfd_vma
                                as bfd_vma;
                        } else {
                            nextdot = (nextdot as libc::c_ulong)
                                .wrapping_add((*expld.section).vma) as bfd_vma as bfd_vma;
                        }
                                    ...
                                    .offset(2 as libc::c_int as isize) as *mut asection
                        {
                            einfo(
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"%F%P:%pS cannot move location counter backwards (from %V to %V)\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                tree,
                    ...
                    == etree_provide as libc::c_int as libc::c_uint
                {
                    ...
                    if h.is_null()
                        || !((*h).type_0() as libc::c_int
                            ...
                            || (*h).linker_def() as libc::c_int != 0)
                    {
                        current_block_98 = 10769842751669019566;
                    } else {
                        current_block_98 = 11626999923138678822;
                    }
                } else {
                    current_block_98 = 11626999923138678822;
                }
                match current_block_98 {
                    ...
                    _ => {
                        ...
                        expld.assign_src = 0 as *mut bfd_link_hash_entry;
                        exp_fold_tree_1((*tree).assign.src);
                        if expld.phase as libc::c_uint
                            == lang_final_phase_enum as libc::c_int as libc::c_uint
                            || expld.phase as libc::c_uint
                                == lang_fixed_phase_enum as libc::c_int as libc::c_uint
                            || !(expld.assign_name).is_null()
                        {
                            if (*tree).type_0.node_class as libc::c_uint
                                == etree_provide as libc::c_int as libc::c_uint
                            {
                                (*tree).type_0.node_class = etree_provided;
                            }
                            if h.is_null() {
                                h = bfd_link_hash_lookup(
                                    link_info.hash,
                            ...
                            if !expld.result.valid_p
                                && (*h).type_0() as libc::c_int
                                    == bfd_link_hash_new as libc::c_int
                            {
                                expld.result.value = 0 as libc::c_int as bfd_vma;
                                expld.result.section = 0 as *mut asection;
                                expld.result.valid_p = 1 as libc::c_int != 0;
                            }
                            if expld.result.valid_p {
                                if (expld.result.section).is_null() {
                                ...
                                if !update_definedness((*tree).assign.dst, h)
                                    && !(expld.assign_name).is_null()
                                {
                                    let mut warn: libc::c_uint = link_info
                                        .warn_multiple_definition();
                                    link_info
                                        .set_warn_multiple_definition(
                                    ...
                                    link_info.set_warn_multiple_definition(warn);
                                }
                                if expld.phase as libc::c_uint
                                    == lang_fixed_phase_enum as libc::c_int as libc::c_uint
                                {
                                    ...
                                    (*h)
                                        .set_linker_def(
                                            ((*tree).assign.type_0.lineno == 0) as libc::c_int
                                                as libc::c_uint,
                                        );
                                    (*h).set_ldscript_def(1 as libc::c_int as libc::c_uint);
                                    (*h).set_rel_from_abs(expld.rel_from_abs as libc::c_uint);
                                    if (*tree).assign.hidden {
                                        (Some(
                                            ...
                                            .expect(
                                                "non-null function pointer",
                                            )(link_info.output_bfd, &mut link_info, h);
                                    }
                                    if !(expld.assign_src).is_null()
                                        && expld.assign_src
                                            != -(1 as libc::c_int) as *mut bfd_link_hash_entry
                                    {
                                        (Some(
                                            ((*(*link_info.output_bfd).xvec)
                                                ._bfd_copy_link_hash_symbol_type)
                                                .expect("non-null function pointer"),
                                        ))
                                            .expect(
                                                "non-null function pointer",
                                            )(link_info.output_bfd, h, expld.assign_src);
                                        (*expld.assign_src)
...
unsafe extern "C" fn align_n(mut value: bfd_vma, mut align: bfd_vma) -> bfd_vma {
    ...
    value = value
        ...
        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
        .wrapping_div(align);
    return value.wrapping_mul(align);
}
static mut definedness_table: bfd_hash_table = bfd_hash_table {
...
unsafe extern "C" fn exp_print_token(
    mut code: token_code_type,
    mut infix_p: libc::c_int,
) {
    static mut table: [C2RustUnnamed_23; 51] = [
        {
            let mut init = C2RustUnnamed_23 {
                code: 258 as libc::c_int,
        ...
        {
            let mut init = C2RustUnnamed_23 {
                code: 359 as libc::c_int,
                name: b"LOG2CEIL\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 279 as libc::c_int,
        ...
        {
            let mut init = C2RustUnnamed_23 {
                code: 299 as libc::c_int,
                name: b"SIZEOF_HEADERS\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 307 as libc::c_int,
        ...
        {
            let mut init = C2RustUnnamed_23 {
                code: 315 as libc::c_int,
                name: b"DEFINED\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 316 as libc::c_int,
        ...
        {
            let mut init = C2RustUnnamed_23 {
                code: 317 as libc::c_int,
                name: b"SEARCH_DIR\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 318 as libc::c_int,
        ...
        {
            let mut init = C2RustUnnamed_23 {
                code: 324 as libc::c_int,
                name: b"LOADADDR\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 386 as libc::c_int,
                name: b"CONSTANT\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 352 as libc::c_int,
                name: b"ABSOLUTE\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 325 as libc::c_int,
        ...
        {
            let mut init = C2RustUnnamed_23 {
                code: 292 as libc::c_int,
                name: b"DATA_SEGMENT_ALIGN\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 293 as libc::c_int,
                name: b"DATA_SEGMENT_RELRO_END\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 294 as libc::c_int,
                name: b"DATA_SEGMENT_END\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_23 {
                code: 334 as libc::c_int,
        ...
        },
        {
            let mut init = C2RustUnnamed_23 {
                ...
                name: b"SEGMENT_START\0" as *const u8 as *const libc::c_char,
            };
            init
        },
    ];
    ...
    while (idx as libc::c_ulong)
        < (::core::mem::size_of::<[C2RustUnnamed_23; 51]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<C2RustUnnamed_23>() as libc::c_ulong)
    {
        if table[idx as usize].code == code {
            break;
        }
    ...
    if (idx as libc::c_ulong)
        < (::core::mem::size_of::<[C2RustUnnamed_23; 51]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<C2RustUnnamed_23>() as libc::c_ulong)
    {
        fputs(table[idx as usize].name, config.map_file);
    } else if code < 127 as libc::c_int {
        fputc(code, config.map_file);
    } else {
        fprintf(
            config.map_file,
            b"<code %d>\0" as *const u8 as *const libc::c_char,
            code,
        );
    }
    if infix_p != 0 {
...
unsafe extern "C" fn make_log2ceil() {
    let mut value: bfd_vma = expld.result.value;
    let mut result: bfd_vma = -(1 as libc::c_int) as bfd_vma;
    let mut round_up: bool = 0 as libc::c_int != 0;
    loop {
        result = result.wrapping_add(1);
        result;
        if value > 1 as libc::c_int as libc::c_ulong
            && value & 1 as libc::c_int as libc::c_ulong != 0
        {
            round_up = 1 as libc::c_int != 0;
        }
...
unsafe extern "C" fn new_abs(mut value: bfd_vma) {
    expld.result.valid_p = 1 as libc::c_int != 0;
    expld
        .result
        .section = &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
    ...
    expld.result.str_0 = 0 as *mut libc::c_char;
}
unsafe extern "C" fn new_number(mut value: bfd_vma) {
    expld.result.valid_p = 1 as libc::c_int != 0;
    expld.result.value = value;
    expld.result.str_0 = 0 as *mut libc::c_char;
    expld.result.section = 0 as *mut asection;
}
unsafe extern "C" fn new_rel(mut value: bfd_vma, mut section: *mut asection) {
    expld.result.valid_p = 1 as libc::c_int != 0;
    expld.result.value = value;
    expld.result.str_0 = 0 as *mut libc::c_char;
    expld.result.section = section;
}
unsafe extern "C" fn new_rel_from_abs(mut value: bfd_vma) {
    let mut s: *mut asection = expld.section;
    expld.rel_from_abs = 1 as libc::c_int != 0;
    expld.result.valid_p = 1 as libc::c_int != 0;
    expld.result.value = value.wrapping_sub((*s).vma);
    expld.result.str_0 = 0 as *mut libc::c_char;
    expld.result.section = s;
}
unsafe extern "C" fn definedness_newfunc(
    mut entry: *mut bfd_hash_entry,
    mut table: *mut bfd_hash_table,
    mut name: *const libc::c_char,
) -> *mut bfd_hash_entry {
    let mut ret: *mut definedness_hash_entry = entry as *mut definedness_hash_entry;
    if ret.is_null() {
        ret = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<definedness_hash_entry>() as libc::c_ulong
                as libc::c_uint,
        ) as *mut definedness_hash_entry;
    }
    if ret.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: bfd_hash_allocate failed creating symbol %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
    ...
    (*ret).set_by_object(0 as libc::c_int as libc::c_uint);
    (*ret).set_iteration(0 as libc::c_int as libc::c_uint);
    return &mut (*ret).root;
}
unsafe extern "C" fn symbol_defined(
    mut name: *const libc::c_char,
) -> *mut definedness_hash_entry {
...
unsafe extern "C" fn update_definedness(
    mut name: *const libc::c_char,
    mut h: *mut bfd_link_hash_entry,
) -> bool {
    let mut ret: bool = false;
    let mut defentry: *mut definedness_hash_entry = bfd_hash_lookup(
        &mut definedness_table,
        name,
        1 as libc::c_int != 0,
        0 as libc::c_int != 0,
    ...
    if defentry.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: bfd_hash_lookup failed creating symbol %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
    ...
    {
        (*defentry).set_by_object(1 as libc::c_int as libc::c_uint);
        if (*h).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
            && !((*(*h).u.def.section).output_section).is_null()
            && !bfd_is_abs_section((*h).u.def.section) && (*h).linker_def() == 0
        {
            ret = 0 as libc::c_int != 0;
        }
    }
    (*defentry).set_iteration(lang_statement_iteration as libc::c_uint);
    (*defentry)
        .final_sec = &mut *_bfd_std_section
        .as_mut_ptr()
        .offset(2 as libc::c_int as isize) as *mut asection;
    if expld.phase as libc::c_uint
        == lang_final_phase_enum as libc::c_int as libc::c_uint
        && expld.rel_from_abs as libc::c_int != 0
        && expld.result.section
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
    {
...
unsafe extern "C" fn fold_segment_end(mut seg: *mut seg_align_type) {
    if expld.phase as libc::c_uint
        == lang_first_phase_enum as libc::c_int as libc::c_uint
        || expld.section
            != &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
    ...
    } else if (*seg).phase as libc::c_uint
        == exp_seg_align_seen as libc::c_int as libc::c_uint
        || (*seg).phase as libc::c_uint
            == exp_seg_relro_seen as libc::c_int as libc::c_uint
    {
        (*seg).phase = exp_seg_end_seen;
        (*seg).end = expld.result.value;
    } else if !((*seg).phase as libc::c_uint
        == exp_seg_done as libc::c_int as libc::c_uint
        || (*seg).phase as libc::c_uint == exp_seg_adjust as libc::c_int as libc::c_uint
        || (*seg).phase as libc::c_uint
            == exp_seg_relro_adjust as libc::c_int as libc::c_uint)
    {
        expld.result.valid_p = 0 as libc::c_int != 0;
    }
}
unsafe extern "C" fn fold_unary(mut tree: *mut etree_type) {
    ...
    if expld.result.valid_p {
        match (*tree).type_0.node_code {
            ...
            33 => {
                expld.result.value = (expld.result.value == 0) as libc::c_int as bfd_vma;
            }
            45 => {
                expld.result.value = (expld.result.value).wrapping_neg();
            }
            320 => {
                if expld.phase as libc::c_uint
                    != lang_first_phase_enum as libc::c_int as libc::c_uint
            ...
            294 => {
                fold_segment_end(&mut expld.dataseg);
            }
            _ => {
                info_assert(
                    b"ldexp.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn arith_result_section(mut lhs: *const etree_value_type) {
...
unsafe extern "C" fn fold_segment_align(
    mut seg: *mut seg_align_type,
    mut lhs: *mut etree_value_type,
) {
                ...
                as *mut asection
    {
        ...
        let mut maxpage: bfd_vma = (*lhs).value;
        let mut commonpage: bfd_vma = expld.result.value;
        expld.result.value = align_n(expld.dot, maxpage);
        if (*seg).phase as libc::c_uint
            == exp_seg_relro_adjust as libc::c_int as libc::c_uint
        {
            expld.result.value = (*seg).base;
        } else if (*seg).phase as libc::c_uint
            == exp_seg_adjust as libc::c_int as libc::c_uint
        {
            if commonpage < maxpage {
                expld
                    ...
                    .wrapping_add(
                        (expld.dot)
                            .wrapping_add(commonpage)
                            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                            & maxpage.wrapping_sub(commonpage),
            ...
            expld
                ...
                .value = (expld.result.value as libc::c_ulong)
                .wrapping_add(
                    expld.dot & maxpage.wrapping_sub(1 as libc::c_int as libc::c_ulong),
                ) as bfd_vma as bfd_vma;
            if !((*seg).phase as libc::c_uint
                == exp_seg_done as libc::c_int as libc::c_uint)
            {
                if (*seg).phase as libc::c_uint
                    == exp_seg_none as libc::c_int as libc::c_uint
                {
                    (*seg).phase = exp_seg_align_seen;
                    (*seg).base = expld.result.value;
                    (*seg).pagesize = commonpage;
                    (*seg).maxpagesize = maxpage;
                    (*seg).relro_end = 0 as libc::c_int as bfd_vma;
                } else {
                    expld.result.valid_p = 0 as libc::c_int != 0;
                }
            }
...
unsafe extern "C" fn fold_segment_relro_end(
    mut seg: *mut seg_align_type,
    mut lhs: *mut etree_value_type,
) {
                ...
                as *mut asection
    {
        ...
        || (*seg).phase as libc::c_uint
            == exp_seg_relro_adjust as libc::c_int as libc::c_uint
        || (*seg).phase as libc::c_uint == exp_seg_done as libc::c_int as libc::c_uint
    {
        if (*seg).phase as libc::c_uint
            == exp_seg_align_seen as libc::c_int as libc::c_uint
            || (*seg).phase as libc::c_uint
                == exp_seg_relro_adjust as libc::c_int as libc::c_uint
        {
            (*seg).relro_end = ((*lhs).value).wrapping_add(expld.result.value);
        }
        if (*seg).phase as libc::c_uint
            == exp_seg_relro_adjust as libc::c_int as libc::c_uint
            && (*seg).relro_end
                & ((*seg).pagesize).wrapping_sub(1 as libc::c_int as libc::c_ulong) != 0
        {
            (*seg)
                .relro_end = ((*seg).relro_end as libc::c_ulong)
                .wrapping_add(
                    ((*seg).pagesize).wrapping_sub(1 as libc::c_int as libc::c_ulong),
                ) as bfd_vma as bfd_vma;
            (*seg).relro_end
                &= !((*seg).pagesize).wrapping_sub(1 as libc::c_int as libc::c_ulong);
            expld.result.value = ((*seg).relro_end).wrapping_sub(expld.result.value);
        } else {
...
unsafe extern "C" fn fold_binary(mut tree: *mut etree_type) {
    let mut lhs: etree_value_type = etree_value_type {
        value: 0,
        str_0: 0 as *const libc::c_char as *mut libc::c_char,
        section: 0 as *const asection as *mut asection,
        valid_p: false,
    ...
    if expld.result.valid_p as libc::c_int != 0
        && (*tree).type_0.node_code == 305 as libc::c_int
    {
        let mut value: bfd_vma = expld.result.value;
        let mut segment_name: *const libc::c_char = 0 as *const libc::c_char;
        let mut seg: *mut segment_type = 0 as *mut segment_type;
        segment_name = (*(*tree).binary.rhs).name.name;
        seg = segments;
        while !seg.is_null() {
            if strcmp((*seg).name, segment_name) == 0 as libc::c_int {
                if !(*seg).used && config.magic_demand_paged as libc::c_int != 0
                    && link_info.maxpagesize != 0 as libc::c_int as libc::c_ulong
                    && ((*seg).value).wrapping_rem(link_info.maxpagesize)
                        != 0 as libc::c_int as libc::c_ulong
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%P: warning: address of `%s' isn't multiple of maximum page size\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        segment_name,
    ...
    if expld.result.valid_p {
        if lhs.section != expld.result.section {
            if !(expld.result.section).is_null() && !(lhs.section).is_null() {
                make_abs();
                lhs
                    .value = (lhs.value as libc::c_ulong)
                    .wrapping_add((*lhs.section).vma) as bfd_vma as bfd_vma;
                lhs
                    .section = &mut *_bfd_std_section
                    .as_mut_ptr()
                    .offset(2 as libc::c_int as isize) as *mut asection;
            } else if (expld.result.section).is_null() {
                expld.result.section = lhs.section;
                lhs.section = 0 as *mut asection;
            }
        }
        match (*tree).type_0.node_code {
            43 => {
                expld.result.value = (lhs.value).wrapping_add(expld.result.value);
                arith_result_section(&mut lhs);
            }
            42 => {
                expld.result.value = (lhs.value).wrapping_mul(expld.result.value);
                arith_result_section(&mut lhs);
            }
            45 => {
                expld.result.value = (lhs.value).wrapping_sub(expld.result.value);
                arith_result_section(&mut lhs);
            }
            275 => {
            ...
            271 => {
                expld
                    .result
                    .value = (lhs.value == expld.result.value) as libc::c_int as bfd_vma;
                expld.result.section = 0 as *mut asection;
            }
            272 => {
                expld
            ...
            270 => {
                expld
                    .result
                    .value = (lhs.value != 0 && expld.result.value != 0) as libc::c_int
                    as bfd_vma;
                expld.result.section = 0 as *mut asection;
            }
            269 => {
            ...
            37 => {
                if expld.result.value != 0 as libc::c_int as libc::c_ulong {
                    expld
                        .result
                        .value = (lhs.value as bfd_signed_vma
                        % expld.result.value as bfd_signed_vma) as bfd_vma;
                } else if expld.phase as libc::c_uint
                    != lang_mark_phase_enum as libc::c_int as libc::c_uint
                {
                    einfo(
            ...
            292 => {
                fold_segment_align(&mut expld.dataseg, &mut lhs);
            }
            293 => {
                fold_segment_relro_end(&mut expld.dataseg, &mut lhs);
            }
            _ => {
                info_assert(
                    b"ldexp.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn fold_trinary(mut tree: *mut etree_type) {
    let mut save: *mut bfd_link_hash_entry = expld.assign_src;
...
unsafe extern "C" fn fold_name(mut tree: *mut etree_type) {
    let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut def: *mut definedness_hash_entry = 0 as *mut definedness_hash_entry;
    memset(
        &mut expld.result as *mut etree_value_type as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<etree_value_type>() as libc::c_ulong,
    ...
    match (*tree).type_0.node_code {
        299 => {
            link_info.set_load_phdrs(1 as libc::c_int as libc::c_uint);
            if expld.phase as libc::c_uint
                != lang_first_phase_enum as libc::c_int as libc::c_uint
            {
                ...
                {
                    hdr_size = ((Some(
                        ((*(*link_info.output_bfd).xvec)._bfd_sizeof_headers)
                            .expect("non-null function pointer"),
                    ))
                        .expect(
                            "non-null function pointer",
                        )(link_info.output_bfd, &mut link_info) as libc::c_uint)
                        .wrapping_div(
                            bfd_octets_per_byte(
                                link_info.output_bfd,
                                0 as *const asection,
                ...
                (!h.is_null()
                    ...
                    && ((*h).ldscript_def() == 0
                        || {
                            ...
                            def.is_null()
                        } || (*def).by_object() as libc::c_int != 0
                        || (*def).iteration() as libc::c_int
                            == lang_statement_iteration & 255 as libc::c_int))
                    as libc::c_int as bfd_vma,
            );
        }
        259 => {
            if *((*tree).name.name).offset(0 as libc::c_int as isize) as libc::c_int
                == '.' as i32
                && *((*tree).name.name).offset(1 as libc::c_int as isize) as libc::c_int
                    == 0 as libc::c_int
            {
                        ...
                        == bfd_link_hash_defweak as libc::c_int
                {
                    ...
                    if output_section.is_null() {
                            ...
                            <= lang_mark_phase_enum as libc::c_int as libc::c_uint
                        {
                            ...
                            einfo(
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"%X%P:%pS: unresolvable symbol `%s' referenced in expression\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                tree,
                        ...
                        && (expld.section
                            != &mut *_bfd_std_section
                                .as_mut_ptr()
                                .offset(2 as libc::c_int as isize) as *mut asection
                            || config.sane_expr as libc::c_int != 0)
                    {
                        new_number(
                            ((*h).u.def.value)
                    ...
                    || expld.phase as libc::c_uint
                        != lang_mark_phase_enum as libc::c_int as libc::c_uint
                        && expld.assigning_to_dot as libc::c_int != 0
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P:%pS: undefined symbol `%s' referenced in expression\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        tree,
                ...
                if (expld.assign_src).is_null() {
                    ...
                    expld.assign_src = -(1 as libc::c_int) as *mut bfd_link_hash_entry;
                }
                if !(expld.assign_name).is_null()
                    && strcmp(expld.assign_name, (*tree).name.name) == 0 as libc::c_int
                    && !(!h.is_null()
                        && ((*h).type_0() as libc::c_int
                            == bfd_link_hash_defined as libc::c_int
                            || (*h).type_0() as libc::c_int
        ...
        323 => {
                ...
                != lang_first_phase_enum as libc::c_int as libc::c_uint
            {
                ...
                if os.is_null() {
                        ...
                        == lang_final_phase_enum as libc::c_int as libc::c_uint
                    {
                        einfo(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%F%P:%pS: undefined section `%s' referenced in expression\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            tree,
                ...
                } else if (*os).processed_vma() != 0 {
                    new_rel(0 as libc::c_int as bfd_vma, (*os).bfd_section);
                }
            }
        }
        324 => {
                ...
                != lang_first_phase_enum as libc::c_int as libc::c_uint
            {
                ...
                } else if (*os_0).processed_lma() != 0 {
                    if ((*os_0).load_base).is_null() {
                        new_abs((*(*os_0).bfd_section).lma);
                    } else {
                        exp_fold_tree_1((*os_0).load_base);
                        if expld.result.valid_p {
                            make_abs();
                        }
                    }
        ...
        321 | 322 => {
            if expld.phase as libc::c_uint
                != lang_first_phase_enum as libc::c_int as libc::c_uint
            {
                let mut os_1: *mut lang_output_section_statement_type = 0
                    as *mut lang_output_section_statement_type;
                os_1 = lang_output_section_statement_lookup(
                    (*tree).name.name,
                    0 as libc::c_int,
                    0 as libc::c_int,
                );
                if os_1.is_null() {
                    ...
                    new_number(0 as libc::c_int as bfd_vma);
                } else if !((*os_1).bfd_section).is_null() {
                    let mut val: bfd_vma = 0;
                    if (*tree).type_0.node_code == 321 as libc::c_int {
                        val = ((*(*os_1).bfd_section).size)
                            .wrapping_div(
                                bfd_octets_per_byte(
                                    link_info.output_bfd,
                                    (*os_1).bfd_section,
                        ...
                        val = (1 as libc::c_int as bfd_vma)
                            << (*(*os_1).bfd_section).alignment_power;
                    }
                    new_number(val);
                } else {
                    new_number(0 as libc::c_int as bfd_vma);
        ...
        336 => {
            let mut mem: *mut lang_memory_region_type = 0
                as *mut lang_memory_region_type;
            mem = lang_memory_region_lookup((*tree).name.name, 0 as libc::c_int != 0);
            if !mem.is_null() {
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P:%pS: undefined MEMORY region `%s' referenced in expression\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    tree,
        ...
        334 => {
            let mut mem_0: *mut lang_memory_region_type = 0
                as *mut lang_memory_region_type;
            mem_0 = lang_memory_region_lookup((*tree).name.name, 0 as libc::c_int != 0);
            if !mem_0.is_null() {
                new_rel_from_abs((*mem_0).origin);
            } else {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
        ...
        386 => {
            if strcmp(
                (*tree).name.name,
                b"MAXPAGESIZE\0" as *const u8 as *const libc::c_char,
            ) == 0 as libc::c_int
            {
                new_number(link_info.maxpagesize);
            } else if strcmp(
                (*tree).name.name,
                b"COMMONPAGESIZE\0" as *const u8 as *const libc::c_char,
            ) == 0 as libc::c_int
            {
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P:%pS: unknown constant `%s' referenced in expression\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    tree,
...
unsafe extern "C" fn is_dot(mut tree: *const etree_type) -> bool {
    return (*tree).type_0.node_class as libc::c_uint
        == etree_name as libc::c_int as libc::c_uint
        && (*tree).type_0.node_code == 259 as libc::c_int
        && *((*tree).name.name).offset(0 as libc::c_int as isize) as libc::c_int
            == '.' as i32
        && *((*tree).name.name).offset(1 as libc::c_int as isize) as libc::c_int
            == 0 as libc::c_int;
}
unsafe extern "C" fn is_value(mut tree: *const etree_type, mut val: bfd_vma) -> bool {
    return (*tree).type_0.node_class as libc::c_uint
        == etree_value as libc::c_int as libc::c_uint && (*tree).value.value == val;
}
unsafe extern "C" fn is_sym_value(
    mut tree: *const etree_type,
    mut val: bfd_vma,
) -> bool {
    let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut def: *mut definedness_hash_entry = 0 as *mut definedness_hash_entry;
    return (*tree).type_0.node_class as libc::c_uint
        ...
        && (*h).u.def.section
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection && (*h).u.def.value == val;
}
unsafe extern "C" fn is_dot_ne_0(mut tree: *const etree_type) -> bool {
    return (*tree).type_0.node_class as libc::c_uint
        == etree_binary as libc::c_int as libc::c_uint
        && (*tree).type_0.node_code == 272 as libc::c_int
        && is_dot((*tree).binary.lhs) as libc::c_int != 0
        && is_value((*tree).binary.rhs, 0 as libc::c_int as bfd_vma) as libc::c_int != 0;
}
unsafe extern "C" fn is_dot_plus_0(mut tree: *const etree_type) -> bool {
    return (*tree).type_0.node_class as libc::c_uint
        == etree_binary as libc::c_int as libc::c_uint
        && (*tree).type_0.node_code == '+' as i32
        && is_dot((*tree).binary.lhs) as libc::c_int != 0
        && (is_value((*tree).binary.rhs, 0 as libc::c_int as bfd_vma) as libc::c_int != 0
            || is_sym_value((*tree).binary.rhs, 0 as libc::c_int as bfd_vma)
                as libc::c_int != 0);
}
unsafe extern "C" fn is_align_conditional(mut tree: *const etree_type) -> bool {
    if (*tree).type_0.node_class as libc::c_uint
        == etree_unary as libc::c_int as libc::c_uint
        && (*tree).type_0.node_code == 279 as libc::c_int
    {
        tree = (*tree).unary.child;
        return (*tree).type_0.node_class as libc::c_uint
            == etree_trinary as libc::c_int as libc::c_uint
            && is_dot_ne_0((*tree).trinary.cond) as libc::c_int != 0
            && is_value((*tree).trinary.rhs, 1 as libc::c_int as bfd_vma) as libc::c_int
                != 0;
    }
    return 0 as libc::c_int != 0;
}
unsafe extern "C" fn exp_value_fold(mut tree: *mut etree_type) {
    exp_fold_tree_no_dot(tree);
    if expld.result.valid_p {
        (*tree).type_0.node_code = 258 as libc::c_int;
        (*tree).value.value = expld.result.value;
        (*tree).value.str_0 = 0 as *mut libc::c_char;
        (*tree).type_0.node_class = etree_value;
    }
}
unsafe extern "C" fn exp_assop(
    mut dst: *const libc::c_char,
    mut src: *mut etree_type,
    mut class: node_tree_enum,
    mut hidden: bool,
) -> *mut etree_type {
    let mut n: *mut etree_type = 0 as *mut etree_type;
    n = stat_alloc(::core::mem::size_of::<C2RustUnnamed_20>() as libc::c_ulong)
        as *mut etree_type;
    (*n).assign.type_0.node_code = '=' as i32;
    (*n).assign.type_0.filename = (*src).type_0.filename;
    (*n).assign.type_0.lineno = (*src).type_0.lineno;
    (*n).assign.type_0.node_class = class;
    (*n).assign.src = src;
    (*n).assign.dst = dst;
            ...
            as *mut asection
    {
                    ...
                    as *mut asection
        {
            (*h)
                ...
                .wrapping_sub((*(*def).final_sec).vma) as bfd_vma as bfd_vma;
