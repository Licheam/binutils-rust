extern "C" {
    ...
    fn xmemdup(_: *const libc::c_void, _: size_t, _: size_t) -> *mut libc::c_void;
    ...
    static mut force_make_executable: bool;
    ...
    static mut version_printed: bool;
    static mut demangling: bool;
    static mut g_switch_value: libc::c_int;
    static mut output_filename: *const libc::c_char;
    static mut link_info: bfd_link_info;
    static mut overflow_cutoff_limit: libc::c_int;
    static mut error_handling_script: *mut libc::c_char;
    fn add_ysym(_: *const libc::c_char);
    fn add_wrap(_: *const libc::c_char);
    fn add_ignoresym(_: *mut bfd_link_info, _: *const libc::c_char);
    fn add_keepsyms_file(_: *const libc::c_char);
    fn einfo(_: *const libc::c_char, _: ...);
    static mut segments: *mut segment_type;
    ...
    fn lang_section_start(
        _: *const libc::c_char,
        _: *mut etree_union,
        _: *const segment_type,
    );
    ...
    fn ldlang_add_require_defined(_: *const libc::c_char);
    ...
    fn stat_alloc(_: size_t) -> *mut libc::c_void;
    fn lang_enter_group();
    fn lang_leave_group();
    ...
    fn lang_append_dynamic_list_cpp_typeinfo();
    fn lang_append_dynamic_list_cpp_new();
    fn lang_add_unique(_: *const libc::c_char);
    static mut parser_input: input_type;
    static mut lex_string: *const libc::c_char;
    fn lex_redirect(_: *const libc::c_char, _: *const libc::c_char, _: libc::c_uint);
    fn ldfile_add_arch(_: *const libc::c_char);
    fn ldfile_add_library_path(_: *const libc::c_char, cmdline: bool);
    fn ldfile_open_command_file(name: *const libc::c_char);
    fn ldfile_open_script_file(name: *const libc::c_char);
    fn ldversion(_: libc::c_int);
    fn ldemul_list_emulations(_: *mut FILE);
    fn ldemul_list_emulation_options(_: *mut FILE);
    fn ldemul_parse_args(_: libc::c_int, _: *mut *mut libc::c_char) -> bool;
    fn ldemul_add_options(
        _: libc::c_int,
        _: *mut *mut libc::c_char,
        _: libc::c_int,
        _: *mut *mut option,
    ...
    fn ldemul_handle_option(_: libc::c_int) -> bool;
    ...
    static mut report_plugin_symbols: bool;
    fn plugin_opt_plugin(plugin: *const libc::c_char);
    fn plugin_opt_plugin_arg(arg: *const libc::c_char) -> libc::c_int;
}
...
pub const symbolic_functions: symbolic_enum = 2;
pub const symbolic: symbolic_enum = 1;
pub const symbolic_unset: symbolic_enum = 0;
pub type symbolic_enum = libc::c_uint;
pub const dynamic_list: dynamic_list_enum = 2;
pub const dynamic_list_data: dynamic_list_enum = 1;
pub const dynamic_list_unset: dynamic_list_enum = 0;
pub type dynamic_list_enum = libc::c_uint;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ld_option {
    pub opt: option,
    pub shortopt: libc::c_char,
    pub arg: *const libc::c_char,
    pub doc: *const libc::c_char,
    pub control: control_enum,
}
pub type control_enum = libc::c_uint;
pub const NO_HELP: control_enum = 4;
pub const EXACTLY_TWO_DASHES: control_enum = 3;
pub const TWO_DASHES: control_enum = 2;
pub const ONE_DASH: control_enum = 1;
...
pub unsafe extern "C" fn parse_args(
    ...
    let mut ingroup: libc::c_int = 0 as libc::c_int;
    let mut default_dirlist: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut shortopts: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut longopts: *mut option = 0 as *mut option;
    let mut really_longopts: *mut option = 0 as *mut option;
    let mut last_optind: libc::c_int = 0;
    let mut opt_symbolic: symbolic_enum = symbolic_unset;
    let mut opt_dynamic_list: dynamic_list_enum = dynamic_list_unset;
    let mut export_list: *mut bfd_elf_dynamic_list = 0 as *mut bfd_elf_dynamic_list;
    shortopts = xmalloc(
        (::core::mem::size_of::<[ld_option; 187]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<ld_option>() as libc::c_ulong)
    ...
    *shortopts.offset(0 as libc::c_int as isize) = '-' as i32 as libc::c_char;
    is = 1 as libc::c_int;
    il = 0 as libc::c_int;
    irl = 0 as libc::c_int;
    ...
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[ld_option; 187]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<ld_option>() as libc::c_ulong)
    {
        if ld_options[i as usize].shortopt as libc::c_int != '\0' as i32 {
            *shortopts.offset(is as isize) = ld_options[i as usize].shortopt;
            is += 1;
            is;
            if ld_options[i as usize].opt.has_arg == 1 as libc::c_int
                || ld_options[i as usize].opt.has_arg == 2 as libc::c_int
            {
                *shortopts.offset(is as isize) = ':' as i32 as libc::c_char;
                is += 1;
                is;
                if ld_options[i as usize].opt.has_arg == 2 as libc::c_int {
                    *shortopts.offset(is as isize) = ':' as i32 as libc::c_char;
                    is += 1;
                    is;
                }
        ...
        if !(ld_options[i as usize].opt.name).is_null() {
            if ld_options[i as usize].control as libc::c_uint
                == EXACTLY_TWO_DASHES as libc::c_int as libc::c_uint
            {
                *really_longopts.offset(irl as isize) = ld_options[i as usize].opt;
                irl += 1;
                irl;
            } else {
                *longopts.offset(il as isize) = ld_options[i as usize].opt;
                il += 1;
                il;
            }
        }
    ...
    *shortopts.offset(is as isize) = '\0' as i32 as libc::c_char;
    let ref mut fresh0 = (*longopts.offset(il as isize)).name;
    *fresh0 = 0 as *const libc::c_char;
    let ref mut fresh1 = (*really_longopts.offset(irl as isize)).name;
    *fresh1 = 0 as *const libc::c_char;
    ldemul_add_options(is, &mut shortopts, il, &mut longopts, irl, &mut really_longopts);
    i = 1 as libc::c_int as libc::c_uint;
    while i < argc {
        if strcmp(*argv.offset(i as isize), b"-G\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
            && (i.wrapping_add(1 as libc::c_int as libc::c_uint) >= argc
                || _sch_istable[(*(*argv
                    ...
                    & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int == 0)
        {
            ...
            *fresh2 = b"--shared\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char;
        }
        i = i.wrapping_add(1);
        i;
    ...
    while i < argc {
                ...
                as libc::c_int != '\0' as i32
        {
            ...
            sprintf(
                n,
                b"--library=%s\0" as *const u8 as *const libc::c_char,
                (*argv.offset(i as isize)).offset(2 as libc::c_int as isize),
            );
    ...
    last_optind = -(1 as libc::c_int);
    loop {
        let mut longind: libc::c_int = 0 as libc::c_int;
        let mut optc: libc::c_int = 0;
        static mut defsym_count: libc::c_uint = 0;
        if optind != last_optind {
            if ldemul_parse_args(argc as libc::c_int, argv) {
                continue;
            }
        }
        ...
        } else if longind == 0 as libc::c_int && optc > 32 as libc::c_int
            && optc
                != *(*argv.offset(last_optind as isize))
            ...
            if !optarg.is_null() {
                einfo(
                    dcgettext(
                        ...
                        b"%F%P: Error: unable to disambiguate: %s (did you mean -%s ?)\n\0"
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: Warning: grouped short command line options are deprecated: %s\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    *argv.offset(last_optind as isize),
        ...
        match optc {
            63 => {
                ...
                opt = (::core::mem::size_of::<[ld_option; 187]>() as libc::c_ulong)
                    .wrapping_div(::core::mem::size_of::<ld_option>() as libc::c_ulong)
                    as libc::c_int;
                loop {
                    let fresh4 = opt;
                    ...
                    if !(ld_options[opt as usize].opt.has_arg == 1 as libc::c_int
                        && !(ld_options[opt as usize].opt.name).is_null()
                        && strcmp(
                            (*argv.offset(last_optind as isize))
                                .offset(
                                    ld_options[opt as usize].control as libc::c_uint as isize,
                                ),
                            ld_options[opt as usize].opt.name,
                        ) == 0 as libc::c_int)
                    {
                        continue;
                    }
                ...
                current_block_441 = 1432105280731977552;
            }
            1 => {
                lang_add_input_file(
                    optarg,
                ...
                current_block_441 = 2048458145062581641;
            }
            165 => {
                current_block_441 = 2048458145062581641;
            }
            97 => {
                if strcmp(optarg, b"archive\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                    input_flags.set_dynamic(0 as libc::c_int as libc::c_uint);
                } else if strcmp(optarg, b"shared\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                    || strcmp(optarg, b"default\0" as *const u8 as *const libc::c_char)
                        == 0 as libc::c_int
                {
            ...
            150 => {
                if !(strcmp(optarg, b"definitions\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int)
                {
                    if !(strcmp(
                        optarg,
                        b"nodefinitions\0" as *const u8 as *const libc::c_char,
                    ) == 0 as libc::c_int)
                    {
                        if !(strcmp(
                            optarg,
                            b"nosymbolic\0" as *const u8 as *const libc::c_char,
                        ) == 0 as libc::c_int)
                        {
                            if !(strcmp(
                                optarg,
                                b"pure-text\0" as *const u8 as *const libc::c_char,
                            ) == 0 as libc::c_int)
                            {
                                einfo(
                                    dcgettext(
                                        0 as *const libc::c_char,
                                        b"%F%P: unrecognized -assert option `%s'\n\0" as *const u8
                                            as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    optarg,
            ...
            152 => {
                command_line.cref = 1 as libc::c_int != 0;
            ...
            153 => {
                lex_string = optarg;
                defsym_count = defsym_count.wrapping_add(1);
                lex_redirect(
                    optarg,
                    b"--defsym\0" as *const u8 as *const libc::c_char,
                    defsym_count,
                );
                parser_input = input_defsym;
                yyparse();
                lex_string = 0 as *const libc::c_char;
                current_block_441 = 2048458145062581641;
            }
            154 => {
                demangling = 1 as libc::c_int != 0;
                if !optarg.is_null() {
                    ...
                    if style as libc::c_int == unknown_demangling as libc::c_int {
                        einfo(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%F%P: unknown demangling style `%s'\n\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            optarg,
            ...
            73 | 155 => {
                ...
                link_info.set_nointerp(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            156 => {
                link_info.set_nointerp(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            157 => {
                current_block_441 = 2048458145062581641;
            ...
            161 => {
                command_line.embedded_relocs = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            162 | 69 => {
                link_info.set_export_dynamic(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            163 => {
                link_info.set_export_dynamic(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            276 => {
                link_info.set_non_contiguous_regions(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            277 => {
                link_info
                    .set_non_contiguous_regions_warnings(
                        1 as libc::c_int as libc::c_uint,
                    );
                current_block_441 = 2048458145062581641;
            }
            101 => {
                lang_add_entry(optarg, 1 as libc::c_int != 0);
                current_block_441 = 2048458145062581641;
            }
            102 => {
                if (command_line.auxiliary_filters).is_null() {
                    command_line
                        .auxiliary_filters = xmalloc(
                        (2 as libc::c_int as libc::c_ulong)
                            .wrapping_mul(
                                ::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong,
                            ),
                    ) as *mut *mut libc::c_char;
                    let ref mut fresh5 = *(command_line.auxiliary_filters)
                        .offset(0 as libc::c_int as isize);
                    *fresh5 = optarg;
                    let ref mut fresh6 = *(command_line.auxiliary_filters)
                    ...
                    *fresh6 = 0 as *mut libc::c_char;
                    ...
                    c = 0 as libc::c_int;
                    p = command_line.auxiliary_filters;
                    while !(*p).is_null() {
                        c += 1;
                        c;
                        p = p.offset(1);
                    ...
                    command_line
                        .auxiliary_filters = xrealloc(
                        command_line.auxiliary_filters as *mut libc::c_void,
                        ((c + 2 as libc::c_int) as libc::c_ulong)
                            .wrapping_mul(
                                ::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong,
                            ),
                    ) as *mut *mut libc::c_char;
                    let ref mut fresh7 = *(command_line.auxiliary_filters)
                        .offset(c as isize);
                    *fresh7 = optarg;
                    let ref mut fresh8 = *(command_line.auxiliary_filters)
            ...
            222 => {
                command_line.force_exe_suffix = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            71 => {
                let mut end: *mut libc::c_char = 0 as *mut libc::c_char;
                g_switch_value = strtoul(optarg, &mut end, 0 as libc::c_int)
                    as libc::c_int;
                if *end != 0 {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: invalid number `%s'\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        optarg,
            ...
            223 => {
                link_info.set_gc_sections(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            225 => {
                link_info.set_print_gc_sections(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            227 => {
                link_info.set_gc_keep_exported(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            164 => {
                help();
            ...
            76 => {
                ldfile_add_library_path(optarg, 1 as libc::c_int != 0);
                current_block_441 = 2048458145062581641;
            }
            108 => {
                lang_add_input_file(
            ...
            78 => {
                ...
                config.magic_demand_paged = 0 as libc::c_int != 0;
                input_flags.set_dynamic(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            248 => {
                config.text_read_only = 1 as libc::c_int != 0;
                config.magic_demand_paged = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            110 => {
                config.text_read_only = 1 as libc::c_int != 0;
            ...
            246 => {
                link_info
                    .set_inhibit_common_definition(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            167 => {
                demangling = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            224 => {
                link_info.set_gc_sections(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            226 => {
                link_info.set_print_gc_sections(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            168 => {
                link_info.set_keep_memory(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            231 => {
            ...
            237 => {
                link_info.set_unresolved_syms_in_shared_libs(RM_IGNORE);
                current_block_441 = 2048458145062581641;
            }
            238 => {
            ...
            255 => {
                if strcmp(optarg, b"ignore-all\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                    ...
                    optarg,
                    b"report-all\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    link_info.set_unresolved_syms_in_objects(RM_DIAGNOSE);
                    link_info.set_unresolved_syms_in_shared_libs(RM_DIAGNOSE);
                    ...
                    optarg,
                    b"ignore-in-object-files\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    link_info.set_unresolved_syms_in_objects(RM_IGNORE);
                    link_info.set_unresolved_syms_in_shared_libs(RM_DIAGNOSE);
                    ...
                    optarg,
                    b"ignore-in-shared-libs\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    link_info.set_unresolved_syms_in_objects(RM_DIAGNOSE);
                    link_info.set_unresolved_syms_in_shared_libs(RM_IGNORE);
                    ...
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: bad --unresolved-symbols option: %s\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        optarg,
            ...
            256 => {
                link_info.set_warn_unresolved_syms(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            257 => {
                link_info.set_warn_unresolved_syms(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            239 => {
                link_info
            ...
            241 => {
                link_info.set_allow_undefined_version(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            242 => {
                link_info.set_create_default_symver(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            243 => {
                link_info.set_default_imported_symver(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            169 => {
                command_line.warn_mismatch = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            170 => {
                command_line.warn_search_mismatch = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            171 => {
                force_make_executable = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            247 => {
                config.only_cmd_line_lib_dirs = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            173 => {
                input_flags.set_whole_archive(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            79 => {
                link_info
                    .set_optimize(
                        (strtoul(optarg, 0 as *mut *mut libc::c_char, 0 as libc::c_int)
            ...
            111 => {
                lang_add_output(optarg, 0 as libc::c_int);
                current_block_441 = 2048458145062581641;
            }
            174 => {
            ...
            264 => {
                command_line.print_output_format = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            261 => {
            ...
            262 => {
                if plugin_opt_plugin_arg(optarg) != 0 {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: bad -plugin-opt option\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            113 => {
                link_info.set_emitrelocations(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            105 | 114 => {
                if optind == last_optind {
                    ...
                    || link_info.type_0() as libc::c_int == type_pie as libc::c_int
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: -r and %s may not be used together\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        if link_info.type_0() as libc::c_int == type_dll as libc::c_int {
                            ...
                            b"-pie\0" as *const u8 as *const libc::c_char
                        },
                    );
                }
                link_info.set_type_0(type_relocatable);
                config.build_constructors = 0 as libc::c_int != 0;
                config.magic_demand_paged = 0 as libc::c_int != 0;
                config.text_read_only = 0 as libc::c_int != 0;
                input_flags.set_dynamic(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            ...
            82 => {
                ...
                if stat(optarg, &mut s) >= 0 as libc::c_int
                        ...
                        == 0o40000 as libc::c_int as libc::c_uint)
                {
                    ...
                    current_block_441 = 9335725479824527145;
                }
            }
            179 => {
                current_block_441 = 9335725479824527145;
            ...
            180 => {
                if (command_line.rpath_link).is_null() {
                    command_line.rpath_link = xstrdup(optarg);
                } else {
                    let mut buf_0: *mut libc::c_char = 0 as *mut libc::c_char;
                    buf_0 = xmalloc(
                        (strlen(command_line.rpath_link))
                            .wrapping_add(strlen(optarg))
                            .wrapping_add(2 as libc::c_int as libc::c_ulong),
                    ) as *mut libc::c_char;
                    sprintf(
                        buf_0,
                        ...
                        config.rpath_separator as libc::c_int,
                        optarg,
                    );
                    free(command_line.rpath_link as *mut libc::c_void);
                    command_line.rpath_link = buf_0;
                }
                current_block_441 = 2048458145062581641;
            }
            176 => {
                link_info.disable_target_specific_optimizations = 2 as libc::c_int;
                current_block_441 = 2048458145062581641;
            }
            175 => {
            ...
            83 => {
                link_info.set_strip(strip_debugger);
                current_block_441 = 2048458145062581641;
            }
            115 => {
                link_info.set_strip(strip_all);
                current_block_441 = 2048458145062581641;
            }
            249 => {
                link_info.set_strip_discarded(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            250 => {
                link_info.set_strip_discarded(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            269 => {
                link_info
                    .set_prohibit_multiple_definition_absolute(
                        1 as libc::c_int as libc::c_uint,
                    );
                current_block_441 = 2048458145062581641;
            }
            181 => {
                if config.has_shared {
                    ...
                    if link_info.unresolved_syms_in_objects() as libc::c_int
                        == RM_NOT_YET_SET as libc::c_int
                    {
                        link_info.set_unresolved_syms_in_objects(RM_IGNORE);
                    }
                    if link_info.unresolved_syms_in_shared_libs() as libc::c_int
                        == RM_NOT_YET_SET as libc::c_int
                    {
                        link_info.set_unresolved_syms_in_shared_libs(RM_IGNORE);
                    }
            ...
            253 => {
                if config.has_shared {
                    ...
                    link_info.set_type_0(type_pie);
                } else {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: -pie not supported\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            104 | 182 => {
                if *optarg.offset(0 as libc::c_int as isize) as libc::c_int
                    == '\0' as i32 && !(command_line.soname).is_null()
                    && *(command_line.soname).offset(0 as libc::c_int as isize)
                        as libc::c_int != 0
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%P: SONAME must not be empty string; keeping previous one\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            183 => {
                if optarg.is_null()
                    || strcmp(
                        optarg,
                        b"descending\0" as *const u8 as *const libc::c_char,
                    ) == 0 as libc::c_int
                {
                    config.sort_common = sort_descending;
                } else if strcmp(
                    optarg,
                    b"ascending\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    ...
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: invalid common section sorting option: %s\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        optarg,
            ...
            184 => {
                if strcmp(optarg, b"name\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                ...
                ) == 0 as libc::c_int
                {
                    ...
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: invalid section sorting option: %s\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        optarg,
            ...
            185 => {
                config.stats = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            177 => {
            ...
            116 => {
                trace_files = trace_files.wrapping_add(1);
                trace_files;
                current_block_441 = 2048458145062581641;
            }
            84 => {
                ...
                yyparse();
                previous_script_handle = 0 as *mut FILE;
                current_block_441 = 2048458145062581641;
            }
            263 => {
            ...
            234 => {
                let mut optarg2: *mut libc::c_char = 0 as *mut libc::c_char;
                let mut sec_name: *mut libc::c_char = 0 as *mut libc::c_char;
                let mut len: libc::c_int = 0;
                optarg2 = strchr(optarg, '=' as i32);
                if optarg2.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: invalid argument to option \"--section-start\"\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
                }
                optarg2 = optarg2.offset(1);
                optarg2;
                if *optarg as libc::c_int == '\0' as i32
                    || *optarg2 as libc::c_int == '\0' as i32
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: missing argument(s) to option \"--section-start\"\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
                }
                len = optarg2.offset_from(optarg) as libc::c_long as libc::c_int;
                sec_name = xmalloc(len as size_t) as *mut libc::c_char;
                memcpy(
                    sec_name as *mut libc::c_void,
            ...
            189 => {
                set_segment_start(b".bss\0" as *const u8 as *const libc::c_char, optarg);
                current_block_441 = 2048458145062581641;
            }
            190 => {
                set_segment_start(
            ...
            192 => {
                set_segment_start(
                    b".text-segment\0" as *const u8 as *const libc::c_char,
                    optarg,
                );
                current_block_441 = 2048458145062581641;
            }
            193 => {
                set_segment_start(
                    b".rodata-segment\0" as *const u8 as *const libc::c_char,
                    optarg,
                );
                current_block_441 = 2048458145062581641;
            }
            194 => {
                set_segment_start(
                    b".ldata-segment\0" as *const u8 as *const libc::c_char,
                    optarg,
                );
                current_block_441 = 2048458145062581641;
            }
            195 => {
                link_info.set_traditional_format(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            188 => {
                link_info.set_task_link(1 as libc::c_int as libc::c_uint);
                current_block_441 = 8201961391312331629;
            }
            196 => {
                current_block_441 = 8201961391312331629;
            }
            117 => {
                ldlang_add_undef(optarg, 1 as libc::c_int != 0);
                current_block_441 = 2048458145062581641;
            }
            271 => {
            ...
            235 => {
                if !optarg.is_null() {
                    ...
                    config.unique_orphan_sections = 1 as libc::c_int != 0;
                }
                current_block_441 = 2048458145062581641;
            }
            197 => {
                ldversion(1 as libc::c_int);
                version_printed = 1 as libc::c_int != 0;
                verbose = 1 as libc::c_int != 0;
                overflow_cutoff_limit = -(2 as libc::c_int);
                if !optarg.is_null() {
                    let mut end_0: *mut libc::c_char = 0 as *mut libc::c_char;
                    let mut level: libc::c_int = strtoul(
                        optarg,
                        &mut end_0,
                        0 as libc::c_int,
                    ) as libc::c_int;
                    ...
                    report_plugin_symbols = level > 1 as libc::c_int;
                }
                current_block_441 = 2048458145062581641;
            }
            118 => {
                ldversion(0 as libc::c_int);
                version_printed = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            86 => {
            ...
            198 => {
                ldversion(2 as libc::c_int);
                xexit(0 as libc::c_int);
            }
            199 => {
                let mut hold_script_handle: *mut FILE = 0 as *mut FILE;
            ...
            203 => {
                ...
                if opt_dynamic_list as libc::c_uint
                    != dynamic_list_data as libc::c_int as libc::c_uint
                {
            ...
            201 => {
                let mut hold_script_handle_0: *mut FILE = 0 as *mut FILE;
                hold_script_handle_0 = saved_script_handle;
                ldfile_open_command_file(optarg);
                saved_script_handle = hold_script_handle_0;
                parser_input = input_dynamic_list;
                current_dynamic_list_p = &mut link_info.dynamic_list;
                yyparse();
                if opt_dynamic_list as libc::c_uint
                    != dynamic_list_data as libc::c_int as libc::c_uint
                {
            ...
            205 => {
                let mut expr: *mut bfd_elf_version_expr = lang_new_vers_pattern(
                    0 as *mut bfd_elf_version_expr,
                    xstrdup(optarg),
                    0 as *const libc::c_char,
                    0 as libc::c_int != 0,
                );
                lang_append_dynamic_list(&mut export_list, expr);
                current_block_441 = 2048458145062581641;
            }
            206 => {
                let mut hold_script_handle_1: *mut FILE = 0 as *mut FILE;
                hold_script_handle_1 = saved_script_handle;
                ldfile_open_command_file(optarg);
                saved_script_handle = hold_script_handle_1;
                parser_input = input_dynamic_list;
                current_dynamic_list_p = &mut export_list;
                yyparse();
                current_block_441 = 2048458145062581641;
            }
            207 => {
                config.warn_common = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            208 => {
                config.warn_constructors = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            209 => {
                config.fatal_warnings = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            210 => {
                config.fatal_warnings = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            211 => {
                config.warn_multiple_gp = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            212 => {
                config.warn_once = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            213 => {
                config.warn_section_align = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            258 => {
                link_info.set_textrel_check(textrel_check_warning);
                current_block_441 = 2048458145062581641;
            }
            259 => {
                link_info.set_warn_alternate_em(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            216 => {
                input_flags.set_whole_archive(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            217 => {
                input_flags
                    .set_add_DT_NEEDED_for_dynamic(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            218 => {
                input_flags
                    .set_add_DT_NEEDED_for_dynamic(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            219 => {
                input_flags
                    .set_add_DT_NEEDED_for_regular(1 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            220 => {
                input_flags
                    .set_add_DT_NEEDED_for_regular(0 as libc::c_int as libc::c_uint);
                current_block_441 = 2048458145062581641;
            }
            221 => {
                add_wrap(optarg);
            ...
            266 => {
                add_ignoresym(&mut link_info, optarg);
                current_block_441 = 2048458145062581641;
            }
            244 => {
                link_info.set_discard(discard_none);
                current_block_441 = 2048458145062581641;
            }
            88 => {
                link_info.set_discard(discard_l);
                current_block_441 = 2048458145062581641;
            }
            120 => {
                link_info.set_discard(discard_all);
                current_block_441 = 2048458145062581641;
            }
            89 => {
                if startswith(optarg, b"P,\0" as *const u8 as *const libc::c_char) {
                    optarg = optarg.offset(2 as libc::c_int as isize);
                }
                free(default_dirlist as *mut libc::c_void);
            ...
            214 => {
                if !optarg.is_null() {
                    config
                        .split_by_reloc = strtoul(
                        optarg,
                        0 as *mut *mut libc::c_char,
                        0 as libc::c_int,
                    ) as libc::c_uint;
                } else {
                    config.split_by_reloc = 32768 as libc::c_int as libc::c_uint;
                }
                current_block_441 = 2048458145062581641;
            }
            215 => {
                if !optarg.is_null() {
                    ...
                    config.split_by_file = 1 as libc::c_int as bfd_size_type;
                }
                current_block_441 = 2048458145062581641;
            }
            229 => {
                command_line.check_section_addresses = 1 as libc::c_int as libc::c_schar;
                current_block_441 = 2048458145062581641;
            }
            230 => {
                command_line.check_section_addresses = 0 as libc::c_int as libc::c_schar;
                current_block_441 = 2048458145062581641;
            }
            251 => {
                command_line.accept_unknown_input_arch = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            252 => {
                command_line.accept_unknown_input_arch = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            40 => {
                lang_enter_group();
            ...
            41 => {
                if ingroup == 0 {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: group ended before it began (--help for usage)\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            260 => {
                link_info.set_reduce_memory_overheads(1 as libc::c_int as libc::c_uint);
                if config.hash_table_size == 0 as libc::c_int as libc::c_ulong {
                    config.hash_table_size = 1021 as libc::c_int as libc::c_ulong;
                }
                current_block_441 = 2048458145062581641;
            }
            228 => {
                ...
                if new_size != 0 {
                    ...
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: --hash-size needs a numeric argument\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            267 => {
                input_flags
                    .pushed = xmemdup(
                    &mut input_flags as *mut lang_input_statement_flags
                        as *const libc::c_void,
                    ::core::mem::size_of::<lang_input_statement_flags>()
                        as libc::c_ulong,
                    ::core::mem::size_of::<lang_input_statement_flags>() as libc::c_ulong,
                ) as *mut lang_input_statement_flags;
                current_block_441 = 2048458145062581641;
            }
            268 => {
                if (input_flags.pushed).is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: no state pushed before popping\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
                } else {
                    let mut oldp: *mut lang_input_statement_flags = input_flags.pushed;
                    memcpy(
                        &mut input_flags as *mut lang_input_statement_flags
                            as *mut libc::c_void,
                        oldp as *const libc::c_void,
                        ::core::mem::size_of::<lang_input_statement_flags>()
                            as libc::c_ulong,
                    );
                    free(oldp as *mut libc::c_void);
                }
                current_block_441 = 2048458145062581641;
            }
            270 => {
                command_line.print_memory_usage = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            272 => {
                if strcasecmp(optarg, b"place\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                ...
                ) == 0 as libc::c_int
                {
                    ...
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: invalid argument to option \"--orphan-handling\"\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
            ...
            275 => {
                config.print_map_discarded = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            274 => {
                config.print_map_discarded = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            278 => {
            ...
            279 => {
                config.ctf_variables = 1 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            280 => {
                config.ctf_variables = 0 as libc::c_int != 0;
                current_block_441 = 2048458145062581641;
            }
            281 => {
                if strcmp(
                    optarg,
                    b"share-unconflicted\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    config.ctf_share_duplicated = 0 as libc::c_int != 0;
                } else if strcmp(
                    optarg,
                    b"share-duplicated\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                {
                    config.ctf_share_duplicated = 1 as libc::c_int != 0;
                } else {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: bad --ctf-share-types option: %s\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        optarg,
        ...
        match current_block_441 {
            8201961391312331629 => {
                ...
                link_info.set_type_0(type_relocatable);
                config.build_constructors = 1 as libc::c_int != 0;
                config.magic_demand_paged = 0 as libc::c_int != 0;
                config.text_read_only = 0 as libc::c_int != 0;
                input_flags.set_dynamic(0 as libc::c_int as libc::c_uint);
            }
            9335725479824527145 => {
                if (command_line.rpath).is_null() {
                    command_line.rpath = xstrdup(optarg);
                } else {
                    let mut rpath_len: size_t = strlen(command_line.rpath);
                    let mut optarg_len: size_t = strlen(optarg);
                    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
                    let mut cp: *mut libc::c_char = command_line.rpath;
                    while !(strncmp(optarg, cp, optarg_len) == 0 as libc::c_int
                        && (*cp.offset(optarg_len as isize) as libc::c_int
                            == 0 as libc::c_int
                            || *cp.offset(optarg_len as isize) as libc::c_int
                                == config.rpath_separator as libc::c_int))
                    {
                        cp = strchr(cp, config.rpath_separator as libc::c_int);
                        if !cp.is_null() {
                            cp = cp.offset(1);
                            cp;
                        }
                    ...
                    if cp.is_null() {
                        ...
                        free(command_line.rpath as *mut libc::c_void);
            ...
            1432105280731977552 => {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P: use the --help option for usage information\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
    ...
    free(really_longopts as *mut libc::c_void);
    free(longopts as *mut libc::c_void);
    free(shortopts as *mut libc::c_void);
    if !(config.map_filename).is_null() {
        let mut new_name: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut percent: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut res: libc::c_int = 0 as libc::c_int;
        if *(config.map_filename).offset(0 as libc::c_int as isize) as libc::c_int
            == 0 as libc::c_int
        {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: no file/directory name provided for map output; ignored\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            config.map_filename = 0 as *mut libc::c_char;
        } else if !(strcmp(
            config.map_filename,
            b"-\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int)
        {
            percent = strchr(config.map_filename, '%' as i32);
            if !percent.is_null() {
                *percent
                    .offset(
                ...
                res = asprintf(
                    ...
                    config.map_filename,
                    output_filename,
                    if *percent.offset(1 as libc::c_int as isize) as libc::c_int != 0 {
                        percent.offset(1 as libc::c_int as isize) as *const libc::c_char
                    } else {
                ...
                if stat(config.map_filename, &mut s_0) < 0 as libc::c_int {
                    if *__errno_location() != 2 as libc::c_int {
                        einfo(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%P: cannot stat linker map file: %E\n\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                        );
                    }
                } else if s_0.st_mode & 0o170000 as libc::c_int as libc::c_uint
                    == 0o40000 as libc::c_int as libc::c_uint
                {
                    let mut lastc: libc::c_char = *(config.map_filename)
                        .offset(
                            (strlen(config.map_filename))
                                .wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize,
                        );
                    res = asprintf(
                        &mut new_name as *mut *mut libc::c_char,
                        b"%s%s%s.map\0" as *const u8 as *const libc::c_char,
                        config.map_filename,
                        if lastc as libc::c_int == '/' as i32
                            || lastc as libc::c_int == '\\' as i32
                                && 0 as libc::c_int != 0
                        {
                            b"\0" as *const u8 as *const libc::c_char
                        } else {
                    ...
                    == 0o100000 as libc::c_int as libc::c_uint)
                {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%P: linker map file is not a regular file\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
        ...
        if res < 0 as libc::c_int {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P%F: cannot create name for linker map file: %E\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        } else if !new_name.is_null() {
            config.map_filename = new_name;
        }
    }
    if !(command_line.soname).is_null()
        && *(command_line.soname).offset(0 as libc::c_int as isize) as libc::c_int
            == '\0' as i32
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: SONAME must not be empty string; ignored\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        command_line.soname = 0 as *mut libc::c_char;
    }
    while ingroup != 0 {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: missing --end-group; added as last command line option\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int
        && (command_line.check_section_addresses as libc::c_int) < 0 as libc::c_int
    {
        command_line.check_section_addresses = 0 as libc::c_int as libc::c_schar;
    }
    if !export_list.is_null() {
        let mut head: *mut bfd_elf_version_expr = (*export_list).head.list;
        let mut next: *mut bfd_elf_version_expr = 0 as *mut bfd_elf_version_expr;
        if !(link_info.type_0() as libc::c_int == type_relocatable as libc::c_int)
            && (link_info.type_0() as libc::c_int == type_pde as libc::c_int
                || link_info.type_0() as libc::c_int == type_pie as libc::c_int
                || opt_symbolic as libc::c_uint
                    != symbolic_unset as libc::c_int as libc::c_uint
                || opt_dynamic_list as libc::c_uint
                    != dynamic_list_unset as libc::c_int as libc::c_uint)
        {
            ...
            free(export_list as *mut libc::c_void);
        }
    }
    let mut current_block_518: u64;
    match opt_dynamic_list as libc::c_uint {
        1 => {
            link_info.set_dynamic_data(1 as libc::c_int as libc::c_uint);
            current_block_518 = 1413647927157151628;
        }
        2 => {
            current_block_518 = 1413647927157151628;
        }
        0 | _ => {
            current_block_518 = 8145638543930014744;
        }
    }
    match current_block_518 {
        1413647927157151628 => {
            link_info.set_dynamic(1 as libc::c_int as libc::c_uint);
            opt_symbolic = symbolic_unset;
        }
        _ => {}
    }
    if link_info.type_0() as libc::c_int == type_dll as libc::c_int {
        match opt_symbolic as libc::c_uint {
            1 => {
                link_info.set_symbolic(1 as libc::c_int as libc::c_uint);
                if !(link_info.dynamic_list).is_null() {
                    let mut ent: *mut bfd_elf_version_expr = 0
                        as *mut bfd_elf_version_expr;
                    let mut next_0: *mut bfd_elf_version_expr = 0
                        as *mut bfd_elf_version_expr;
                    ent = (*link_info.dynamic_list).head.list;
                    while !ent.is_null() {
                        next_0 = (*ent).next;
                        free(ent as *mut libc::c_void);
                        ent = next_0;
                    }
                    free(link_info.dynamic_list as *mut libc::c_void);
                    link_info.dynamic_list = 0 as *mut bfd_elf_dynamic_list;
                }
            }
            2 => {
                link_info.set_dynamic(1 as libc::c_int as libc::c_uint);
    ...
    if !(link_info.type_0() as libc::c_int == type_dll as libc::c_int) {
        if !(command_line.filter_shlib).is_null() {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%F%P: -F may not be used without -shared\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
    ...
    {
        link_info.set_strip(strip_debugger);
        if link_info.discard() as libc::c_int == discard_sec_merge as libc::c_int {
            link_info.set_discard(discard_all);
        }
    }
}
unsafe extern "C" fn set_default_dirlist(mut dirlist_ptr: *mut libc::c_char) {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    loop {
        p = strchr(dirlist_ptr, ':' as i32);
        if !p.is_null() {
            *p = '\0' as i32 as libc::c_char;
        }
        if *dirlist_ptr as libc::c_int != '\0' as i32 {
            ldfile_add_library_path(dirlist_ptr, 1 as libc::c_int != 0);
        }
        if p.is_null() {
            break;
        }
        dirlist_ptr = p.offset(1 as libc::c_int as isize);
    };
}
unsafe extern "C" fn set_section_start(
    mut sect: *mut libc::c_char,
    mut valstr: *mut libc::c_char,
) {
    let mut end: *const libc::c_char = 0 as *const libc::c_char;
    let mut val: bfd_vma = bfd_scan_vma(valstr, &mut end, 16 as libc::c_int);
    if *end != 0 {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: invalid hex number `%s'\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            valstr,
        );
    }
    lang_section_start(sect, exp_intop(val), 0 as *const segment_type);
}
unsafe extern "C" fn set_segment_start(
    mut section: *const libc::c_char,
    mut valstr: *mut libc::c_char,
) {
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut end: *const libc::c_char = 0 as *const libc::c_char;
    let mut seg: *mut segment_type = 0 as *mut segment_type;
    let mut val: bfd_vma = bfd_scan_vma(valstr, &mut end, 16 as libc::c_int);
    if *end != 0 {
        einfo(
            dcgettext(
    ...
    name = section.offset(1 as libc::c_int as isize);
    seg = segments;
    while !seg.is_null() {
        if strcmp((*seg).name, name) == 0 as libc::c_int {
            (*seg).value = val;
    ...
    seg = stat_alloc(::core::mem::size_of::<segment_type>() as libc::c_ulong)
        as *mut segment_type;
    (*seg).name = name;
    (*seg).value = val;
    (*seg).used = 0 as libc::c_int != 0;
    (*seg).next = segments;
    segments = seg;
    lang_section_start(section, exp_intop(val), seg);
}
unsafe extern "C" fn help() {
    ...
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[ld_option; 187]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<ld_option>() as libc::c_ulong)
    {
        if !(ld_options[i as usize].doc).is_null() {
            let mut comma: bool = false;
            let mut j: libc::c_uint = 0;
            printf(b"  \0" as *const u8 as *const libc::c_char);
            comma = 0 as libc::c_int != 0;
            len = 2 as libc::c_int;
            j = i;
            loop {
                if ld_options[j as usize].shortopt as libc::c_int != '\0' as i32
                    && ld_options[j as usize].control as libc::c_uint
                        != NO_HELP as libc::c_int as libc::c_uint
                {
                    printf(
                        ...
                        ld_options[j as usize].shortopt as libc::c_int,
                    );
                    len
                        += (if comma as libc::c_int != 0 {
                            2 as libc::c_int
                    ...
                    if !(ld_options[j as usize].arg).is_null() {
                        if ld_options[j as usize].opt.has_arg != 2 as libc::c_int {
                            printf(b" \0" as *const u8 as *const libc::c_char);
                            len += 1;
                            len;
                        }
                ...
                if !((j as libc::c_ulong)
                    < (::core::mem::size_of::<[ld_option; 187]>() as libc::c_ulong)
                        .wrapping_div(
                            ::core::mem::size_of::<ld_option>() as libc::c_ulong,
                        ) && (ld_options[j as usize].doc).is_null())
                {
                    break;
                }
            }
            j = i;
            loop {
                if !(ld_options[j as usize].opt.name).is_null()
                    && ld_options[j as usize].control as libc::c_uint
                        != NO_HELP as libc::c_int as libc::c_uint
                {
                    let mut two_dashes: libc::c_int = (ld_options[j as usize].control
                        as libc::c_uint == TWO_DASHES as libc::c_int as libc::c_uint
                        || ld_options[j as usize].control as libc::c_uint
                            == EXACTLY_TWO_DASHES as libc::c_int as libc::c_uint)
                        as libc::c_int;
                    printf(
                        ...
                        ld_options[j as usize].opt.name,
                    );
                    len = (len as libc::c_ulong)
                        .wrapping_add(
                            (((if comma as libc::c_int != 0 {
                                ...
                                .wrapping_add(strlen(ld_options[j as usize].opt.name)),
                        ) as libc::c_int as libc::c_int;
                    if !(ld_options[j as usize].arg).is_null() {
                        printf(
                            b" %s\0" as *const u8 as *const libc::c_char,
            ...
            if len >= 30 as libc::c_int {
                printf(b"\n\0" as *const u8 as *const libc::c_char);
                len = 0 as libc::c_int;
            }
            while len < 30 as libc::c_int {
                putchar(' ' as i32);
                len += 1;
                len;
            }
    ...
    len = strlen(b"  @FILE\0" as *const u8 as *const libc::c_char) as libc::c_int;
    while len < 30 as libc::c_int {
        putchar(' ' as i32);
        len += 1;
        len;
    ...
    printf(
        dcgettext(
            0 as *const libc::c_char,
            b"%s: supported targets:\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        program_name,
    );
    ...
    pp = targets;
    while !(*pp).is_null() {
        printf(b" %s\0" as *const u8 as *const libc::c_char, *pp);
        pp = pp.offset(1);
        pp;
    }
    ...
    printf(
        dcgettext(
            0 as *const libc::c_char,
            b"%s: supported emulations: \0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        program_name,
    );
    ...
    printf(
        dcgettext(
            0 as *const libc::c_char,
            b"%s: emulation specific options:\n\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        program_name,
    );
    ...
    if (*::core::mem::transmute::<
        &[u8; 39],
        &[libc::c_char; 39],
    >(b"<https://www.sourceware.org/bugzilla/>\0"))[0 as libc::c_int as usize] != 0
    {
        printf(
            dcgettext(
                0 as *const libc::c_char,
...
static mut ld_options: [ld_option; 187] = [
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
            ...
            shortopt: 'a' as i32 as libc::c_char,
            arg: b"KEYWORD\0" as *const u8 as *const libc::c_char,
            doc: b"Shared library control for HP/UX compatibility\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'A' as i32 as libc::c_char,
            arg: b"ARCH\0" as *const u8 as *const libc::c_char,
            doc: b"Set architecture\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'b' as i32 as libc::c_char,
            arg: b"TARGET\0" as *const u8 as *const libc::c_char,
            doc: b"Specify target for following input files\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"mri-script\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'c' as i32,
                };
            ...
            shortopt: 'c' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Read MRI format linker script\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dc\0" as *const u8 as *const libc::c_char,
            ...
            shortopt: 'd' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Force common symbols to be defined\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dp\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'd' as i32,
                };
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dependency-file\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DEPENDENCY_FILE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Write dependency file\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"force-group-allocation\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_FORCE_GROUP_ALLOCATION as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Force group members out of groups\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"entry\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'e' as i32,
                };
            ...
            shortopt: 'e' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set start address\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"export-dynamic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_EXPORT_DYNAMIC as libc::c_int,
                };
                init
            },
            shortopt: 'E' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Export all dynamic symbols\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-export-dynamic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_EXPORT_DYNAMIC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Undo the effect of --export-dynamic\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"enable-non-contiguous-regions\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NON_CONTIGUOUS_REGIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Enable support of non-contiguous memory regions\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"enable-non-contiguous-regions-warnings\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NON_CONTIGUOUS_REGIONS_WARNINGS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Enable warnings when --enable-non-contiguous-regions may cause unexpected behaviour\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"EB\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_EB as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Link big-endian objects\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_EL as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Link little-endian objects\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'f' as i32 as libc::c_char,
            arg: b"SHLIB\0" as *const u8 as *const libc::c_char,
            doc: b"Auxiliary filter for shared object symbol table\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'F' as i32 as libc::c_char,
            arg: b"SHLIB\0" as *const u8 as *const libc::c_char,
            doc: b"Filter for shared object symbol table\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'g' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Ignored\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"gpsize\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'G' as i32,
                };
            ...
            doc: b"Small data size (if no size, same as --shared)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SONAME as libc::c_int,
                };
                init
            },
            shortopt: 'h' as i32 as libc::c_char,
            arg: b"FILENAME\0" as *const u8 as *const libc::c_char,
            doc: b"Set internal name of shared library\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dynamic-linker\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DYNAMIC_LINKER as libc::c_int,
                };
                init
            },
            shortopt: 'I' as i32 as libc::c_char,
            arg: b"PROGRAM\0" as *const u8 as *const libc::c_char,
            doc: b"Set PROGRAM as the dynamic linker to use\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-dynamic-linker\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_DYNAMIC_LINKER as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Produce an executable with no program interpreter header\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"library\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'l' as i32,
                };
            ...
            shortopt: 'l' as i32 as libc::c_char,
            arg: b"LIBNAME\0" as *const u8 as *const libc::c_char,
            doc: b"Search for library LIBNAME\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"library-path\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'L' as i32,
                };
            ...
            shortopt: 'L' as i32 as libc::c_char,
            arg: b"DIRECTORY\0" as *const u8 as *const libc::c_char,
            doc: b"Add DIRECTORY to library search path\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"sysroot=<DIRECTORY>\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SYSROOT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Override the default sysroot location\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'm' as i32 as libc::c_char,
            arg: b"EMULATION\0" as *const u8 as *const libc::c_char,
            doc: b"Set emulation\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"print-map\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'M' as i32,
                };
            ...
            shortopt: 'M' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print map file on standard output\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"nmagic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'n' as i32,
                };
            ...
            shortopt: 'n' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not page align data\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"omagic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'N' as i32,
                };
            ...
            shortopt: 'N' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not page align data, do not make text readonly\0" as *const u8
                as *const libc::c_char,
            control: EXACTLY_TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-omagic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_OMAGIC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Page align data, make text readonly\0" as *const u8
                as *const libc::c_char,
            control: EXACTLY_TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'o' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Set output file name\0" as *const u8 as *const libc::c_char,
            control: EXACTLY_TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'O' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Optimize output file\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"out-implib\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_OUT_IMPLIB as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Generate import library\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"PLUGIN\0" as *const u8 as *const libc::c_char,
            doc: b"Load named plugin\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"plugin-opt\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PLUGIN_OPT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ARG\0" as *const u8 as *const libc::c_char,
            doc: b"Send arg to last-loaded plugin\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"flto\0" as *const u8 as *const libc::c_char,
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Ignored for GCC LTO option compatibility\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"flto-partition=\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"fuse-ld=\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Ignored for GCC linker option compatibility\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"map-whole-files\0" as *const u8 as *const libc::c_char,
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Ignored for gold option compatibility\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-map-whole-files\0" as *const u8 as *const libc::c_char,
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Qy\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Ignored for SVR4 compatibility\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"emit-relocs\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'q' as i32,
                };
            ...
            shortopt: 'q' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Generate relocations in final output\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"relocatable\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'r' as i32,
                };
            ...
            shortopt: 'r' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Generate relocatable output\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    ...
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'R' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Just link symbols (if directory, same as --rpath)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 's' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Strip all symbols\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'S' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Strip debugging symbols\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"strip-discarded\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_STRIP_DISCARDED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Strip symbols in discarded sections\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-strip-discarded\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_STRIP_DISCARDED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not strip symbols in discarded sections\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 't' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Trace file opens\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'T' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Read linker script\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"default-script\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DEFAULT_SCRIPT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Read default linker script\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    ...
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'u' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Start with undefined reference to SYMBOL\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"require-defined\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_REQUIRE_DEFINED_SYMBOL as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Require SYMBOL be defined in the final output\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_UNIQUE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"[=SECTION]\0" as *const u8 as *const libc::c_char,
            doc: b"Don't merge input [SECTION | orphan] sections\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Ur\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_UR as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Build global constructor/destructor tables\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'v' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print version information\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'V' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print version and emulation information\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'x' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Discard all local symbols\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'X' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Discard temporary local symbols (default)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"discard-none\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DISCARD_NONE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Don't discard any local symbols\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"trace-symbol\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: 'y' as i32,
                };
            ...
            shortopt: 'y' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Trace mentions of SYMBOL\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: 'Y' as i32 as libc::c_char,
            arg: b"PATH\0" as *const u8 as *const libc::c_char,
            doc: b"Default search path for Solaris compatibility\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"start-group\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: '(' as i32,
                };
            ...
            shortopt: '(' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Start a group\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"end-group\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: ')' as i32,
                };
            ...
            shortopt: ')' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"End a group\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"accept-unknown-input-arch\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ACCEPT_UNKNOWN_INPUT_ARCH as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Accept input files whose architecture cannot be determined\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-accept-unknown-input-arch\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_ACCEPT_UNKNOWN_INPUT_ARCH as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Reject input files whose architecture is unknown\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"add-needed\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ADD_DT_NEEDED_FOR_DYNAMIC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-add-needed\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_ADD_DT_NEEDED_FOR_DYNAMIC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"as-needed\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ADD_DT_NEEDED_FOR_REGULAR as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Only set DT_NEEDED for following dynamic libs if used\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-as-needed\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_ADD_DT_NEEDED_FOR_REGULAR as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Always set DT_NEEDED for dynamic libraries mentioned on\n                                the command line\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ASSERT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"KEYWORD\0" as *const u8 as *const libc::c_char,
            doc: b"Ignored for SunOS compatibility\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Bdynamic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CALL_SHARED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Link against shared libraries\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dy\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CALL_SHARED as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"call_shared\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CALL_SHARED as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Bstatic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NON_SHARED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not link against shared libraries\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dn\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NON_SHARED as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"non_shared\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NON_SHARED as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Bno-symbolic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_SYMBOLIC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Don't bind global references locally\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Bsymbolic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SYMBOLIC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Bind global references locally\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Bsymbolic-functions\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SYMBOLIC_FUNCTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Bind global function references locally\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"check-sections\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CHECK_SECTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Check section addresses for overlaps (default)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-check-sections\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_CHECK_SECTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not check section addresses for overlaps\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"copy-dt-needed-entries\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ADD_DT_NEEDED_FOR_DYNAMIC as libc::c_int,
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Copy DT_NEEDED links mentioned inside DSOs that follow\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-copy-dt-needed-entries\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_ADD_DT_NEEDED_FOR_DYNAMIC as libc::c_int,
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not copy DT_NEEDED links mentioned inside DSOs that follow\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"cref\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CREF as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Output cross reference table\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL=EXPRESSION\0" as *const u8 as *const libc::c_char,
            doc: b"Define a symbol\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DEMANGLE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"[=STYLE]\0" as *const u8 as *const libc::c_char,
            doc: b"Demangle symbol names [using STYLE]\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"disable-multiple-abs-defs\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DISABLE_MULTIPLE_DEFS_ABS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not allow multiple definitions with symbols included\n           in filename invoked by -R or --just-symbols\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"embedded-relocs\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_EMBEDDED_RELOCS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Generate embedded relocs\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Treat warnings as errors\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-fatal-warnings\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_WARN_FATAL as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not treat warnings as errors (default)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_FINI as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Call SYMBOL at unload-time\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"force-exe-suffix\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_FORCE_EXE_SUFFIX as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Force generation of file with .exe suffix\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"gc-sections\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_GC_SECTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Remove unused sections (on some targets)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-gc-sections\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_GC_SECTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Don't remove unused sections (default)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"print-gc-sections\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PRINT_GC_SECTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"List removed unused sections on stderr\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-print-gc-sections\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_PRINT_GC_SECTIONS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not list removed unused sections\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"gc-keep-exported\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_GC_KEEP_EXPORTED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Keep exported symbols when removing unused sections\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"hash-size=<NUMBER>\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_HASH_SIZE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Set default hash table size close to <NUMBER>\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print option help\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_INIT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Call SYMBOL at load-time\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_MAP as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE/DIR\0" as *const u8 as *const libc::c_char,
            doc: b"Write a linker map to FILE or DIR/<outputname>.map\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-define-common\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_DEFINE_COMMON as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not define Common storage\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_DEMANGLE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not demangle symbol names\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-keep-memory\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_KEEP_MEMORY as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Use less memory and more disk I/O\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-undefined\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_UNDEFINED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not allow unresolved references in object files\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"allow-shlib-undefined\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ALLOW_SHLIB_UNDEFINED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Allow unresolved references in shared libraries\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-allow-shlib-undefined\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_ALLOW_SHLIB_UNDEFINED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not allow unresolved references in shared libs\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"allow-multiple-definition\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ALLOW_MULTIPLE_DEFINITION as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Allow multiple definitions\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"error-handling-script\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ERROR_HANDLING_SCRIPT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SCRIPT\0" as *const u8 as *const libc::c_char,
            doc: b"Provide a script to help with undefined symbol errors\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-undefined-version\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_UNDEFINED_VERSION as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Disallow undefined version\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"default-symver\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DEFAULT_SYMVER as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Create default symbol version\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"default-imported-symver\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DEFAULT_IMPORTED_SYMVER as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Create default symbol version for imported symbols\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-warn-mismatch\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_WARN_MISMATCH as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Don't warn about mismatched input files\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-warn-search-mismatch\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_WARN_SEARCH_MISMATCH as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Don't warn on finding an incompatible library\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-whole-archive\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_WHOLE_ARCHIVE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Turn off --whole-archive\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"noinhibit-exec\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NOINHIBIT_EXEC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Create an output file even if errors occur\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"noinhibit_exec\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NOINHIBIT_EXEC as libc::c_int,
                };
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NOSTDLIB as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Only use library directories specified on\n                                the command line\0"
                as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"oformat\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_OFORMAT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"TARGET\0" as *const u8 as *const libc::c_char,
            doc: b"Specify target of output file\0" as *const u8 as *const libc::c_char,
            control: EXACTLY_TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"print-output-format\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PRINT_OUTPUT_FORMAT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print default output format\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"print-sysroot\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PRINT_SYSROOT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print current sysroot\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"qmagic\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE as libc::c_int,
                };
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Ignored for Linux compatibility\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"reduce-memory-overheads\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Reduce memory overheads, possibly taking much longer\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"relax\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_RELAX as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Reduce code size by using target specific optimizations\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-relax\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_RELAX as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not use relaxation techniques to reduce code size\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"retain-symbols-file\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_RETAIN_SYMBOLS_FILE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Keep only symbols listed in FILE\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_RPATH as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"PATH\0" as *const u8 as *const libc::c_char,
            doc: b"Set runtime shared library search path\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"rpath-link\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_RPATH_LINK as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"PATH\0" as *const u8 as *const libc::c_char,
            doc: b"Set link time shared library search path\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SHARED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Create a shared library\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Bshareable\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SHARED as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"pie\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PIE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Create a position independent executable\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"pic-executable\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PIE as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-pie\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_PIE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Create a position dependent executable (default)\0" as *const u8
                as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"sort-common\0" as *const u8 as *const libc::c_char,
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SORT_COMMON as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"[=ascending|descending]\0" as *const u8 as *const libc::c_char,
            doc: b"Sort common symbols by alignment [in specified order]\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"sort_common\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SORT_COMMON as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"sort-section\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SORT_SECTION as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"name|alignment\0" as *const u8 as *const libc::c_char,
            doc: b"Sort sections by name or maximum alignment\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"spare-dynamic-tags\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SPARE_DYNAMIC_TAGS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"COUNT\0" as *const u8 as *const libc::c_char,
            doc: b"How many tags to reserve in .dynamic section\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"split-by-file\0" as *const u8 as *const libc::c_char,
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SPLIT_BY_FILE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"[=SIZE]\0" as *const u8 as *const libc::c_char,
            doc: b"Split output sections every SIZE octets\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"split-by-reloc\0" as *const u8 as *const libc::c_char,
                    has_arg: 2 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SPLIT_BY_RELOC as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"[=COUNT]\0" as *const u8 as *const libc::c_char,
            doc: b"Split output sections every COUNT relocs\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_STATS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Print memory usage statistics\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Display target specific options\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"task-link\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TASK_LINK as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Do task level linking\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Use same format as native linker\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"section-start\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_SECTION_START as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SECTION=ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of named section\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Tbss\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TBSS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of .bss section\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Tdata\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TDATA as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of .data section\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Ttext\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TTEXT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of .text section\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Ttext-segment\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TTEXT_SEGMENT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of text segment\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Trodata-segment\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TRODATA_SEGMENT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of rodata segment\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"Tldata-segment\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_TLDATA_SEGMENT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"ADDRESS\0" as *const u8 as *const libc::c_char,
            doc: b"Set address of ldata segment\0" as *const u8 as *const libc::c_char,
            control: ONE_DASH,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"unresolved-symbols=<method>\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_UNRESOLVED_SYMBOLS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"How to handle unresolved symbols.  <method> is:\n                                ignore-all, report-all, ignore-in-object-files,\n                                ignore-in-shared-libs\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            ...
            doc: b"Output lots of information during link\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dll-verbose\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_VERBOSE as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"version-script\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_VERSION_SCRIPT as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Read version information script\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"version-exports-section\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_VERSION_EXPORTS_SECTION as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Take export symbols list from .exports, using\n                                SYMBOL as the version.\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dynamic-list-data\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DYNAMIC_LIST_DATA as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Add data symbols to dynamic list\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dynamic-list-cpp-new\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DYNAMIC_LIST_CPP_NEW as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Use C++ operator new/delete dynamic list\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dynamic-list-cpp-typeinfo\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DYNAMIC_LIST_CPP_TYPEINFO as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Use C++ typeinfo dynamic list\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"dynamic-list\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_DYNAMIC_LIST as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Read dynamic list\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"export-dynamic-symbol\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_EXPORT_DYNAMIC_SYMBOL as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Export the specified symbol\0" as *const u8 as *const libc::c_char,
            control: EXACTLY_TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"export-dynamic-symbol-list\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_EXPORT_DYNAMIC_SYMBOL_LIST as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"FILE\0" as *const u8 as *const libc::c_char,
            doc: b"Read export dynamic symbol list\0" as *const u8
                as *const libc::c_char,
            control: EXACTLY_TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-common\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_COMMON as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn about duplicate common symbols\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-constructors\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_CONSTRUCTORS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn if global constructors/destructors are seen\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-multiple-gp\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_MULTIPLE_GP as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn if the multiple GP values are used\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-once\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_ONCE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn only once per undefined symbol\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-section-align\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_SECTION_ALIGN as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn if start of section changes due to alignment\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-textrel\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_TEXTREL as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn if output has DT_TEXTREL (default)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-shared-textrel\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_TEXTREL as libc::c_int,
                };
    ...
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-alternate-em\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_ALTERNATE_EM as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Warn if an object has alternate ELF machine code\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"warn-unresolved-symbols\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WARN_UNRESOLVED_SYMBOLS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Report unresolved symbols as warnings\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"error-unresolved-symbols\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ERROR_UNRESOLVED_SYMBOLS as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Report unresolved symbols as errors\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"whole-archive\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WHOLE_ARCHIVE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Include all objects from following archives\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
        ...
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    ...
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_WRAP as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Use wrapper functions for SYMBOL\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"ignore-unresolved-symbol\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_IGNORE_UNRESOLVED_SYMBOL as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"SYMBOL\0" as *const u8 as *const libc::c_char,
            doc: b"Unresolved SYMBOL will not cause an error or warning\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"push-state\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PUSH_STATE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Push state of flags governing input file handling\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"pop-state\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_POP_STATE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Pop state of flags governing input file handling\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"print-memory-usage\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PRINT_MEMORY_USAGE as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Report target memory usage\0" as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"orphan-handling\0" as *const u8 as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_ORPHAN_HANDLING as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: b"=MODE\0" as *const u8 as *const libc::c_char,
            doc: b"Control how orphan sections are handled.\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"print-map-discarded\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_PRINT_MAP_DISCARDED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Show discarded sections in map file output (default)\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-print-map-discarded\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_PRINT_MAP_DISCARDED as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not show discarded sections in map file output\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"ctf-variables\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CTF_VARIABLES as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Emit names and types of static variables in CTF\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"no-ctf-variables\0" as *const u8 as *const libc::c_char,
                    has_arg: 0 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_NO_CTF_VARIABLES as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"Do not emit names and types of static variables in CTF\0" as *const u8
                as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
    },
    {
        let mut init = ld_option {
            opt: {
                let mut init = option {
                    name: b"ctf-share-types=<method>\0" as *const u8
                        as *const libc::c_char,
                    has_arg: 1 as libc::c_int,
                    flag: 0 as *const libc::c_int as *mut libc::c_int,
                    val: OPTION_CTF_SHARE_TYPES as libc::c_int,
                };
                init
            },
            shortopt: '\0' as i32 as libc::c_char,
            arg: 0 as *const libc::c_char,
            doc: b"How to share CTF types between translation units.\n                                <method> is: share-unconflicted (default),\n                                             share-duplicated\0"
                as *const u8 as *const libc::c_char,
            control: TWO_DASHES,
        };
        init
...
unsafe extern "C" fn elf_shlib_list_options(mut file: *mut FILE) {
    fprintf(
        file,
        dcgettext(
            0 as *const libc::c_char,
            b"  --audit=AUDITLIB            Specify a library to use for auditing\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -Bgroup                     Selects group name lookup rules for DSO\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --disable-new-dtags         Disable new dynamic tags\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --enable-new-dtags          Enable new dynamic tags\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --eh-frame-hdr              Create .eh_frame_hdr section\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --no-eh-frame-hdr           Do not create .eh_frame_hdr section\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --exclude-libs=LIBS         Make all symbols in LIBS hidden\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --hash-style=STYLE          Set hash style to sysv/gnu/both.  Default: \0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -P AUDITLIB, --depaudit=AUDITLIB\n                              Specify a library to use for auditing dependencies\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z combreloc                Merge dynamic relocs into one section and sort\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nocombreloc              Don't merge dynamic relocs into one section\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z global                   Make symbols in DSO available for subsequently\n                                loaded objects\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z initfirst                Mark DSO to be initialized first at runtime\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z interpose                Mark object to interpose all DSOs but executable\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z unique                   Mark DSO to be loaded at most once by default, and only in the main namespace\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nounique                 Don't mark DSO as a loadable at most once\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z lazy                     Mark object lazy runtime binding (default)\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z loadfltr                 Mark object requiring immediate process\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nocopyreloc              Don't create copy relocs\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nodefaultlib             Mark object not to use default search paths\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nodelete                 Mark DSO non-deletable at runtime\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nodlopen                 Mark DSO not available to dlopen\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nodump                   Mark DSO not available to dldump\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z now                      Mark object non-lazy runtime binding\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z origin                   Mark object requiring immediate $ORIGIN\n                                processing at runtime\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z relro                    Create RELRO program header (default)\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z norelro                  Don't create RELRO program header\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z separate-code            Create separate code program header (default)\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z noseparate-code          Don't create separate code program header\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z common                   Generate common symbols with STT_COMMON type\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nocommon                 Generate common symbols with STT_OBJECT type\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    if link_info.textrel_check() as libc::c_int == textrel_check_error as libc::c_int {
        fprintf(
            file,
            dcgettext(
                0 as *const libc::c_char,
                b"  -z text                     Treat DT_TEXTREL in output as error (default)\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        ...
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"  -z text                     Treat DT_TEXTREL in output as error\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    }
    if link_info.textrel_check() as libc::c_int == textrel_check_none as libc::c_int {
        fprintf(
            file,
            dcgettext(
                0 as *const libc::c_char,
                b"  -z notext                   Don't treat DT_TEXTREL in output as error (default)\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"  -z textoff                  Don't treat DT_TEXTREL in output as error (default)\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        ...
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"  -z notext                   Don't treat DT_TEXTREL in output as error\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"  -z textoff                  Don't treat DT_TEXTREL in output as error\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
unsafe extern "C" fn elf_static_list_options(mut file: *mut FILE) {
    fprintf(
        file,
        dcgettext(
            0 as *const libc::c_char,
            b"  --build-id[=STYLE]          Generate build ID note\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z common-page-size=SIZE    Set common page size to SIZE\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z max-page-size=SIZE       Set maximum page size to SIZE\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z defs                     Report unresolved symbols in object files\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z undefs                   Ignore unresolved symbols in object files\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z muldefs                  Allow multiple definitions\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z stack-size=SIZE          Set size of stack segment\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z execstack                Mark executable as requiring executable stack\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z noexecstack              Mark executable as not requiring executable stack\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z unique-symbol            Avoid duplicated local symbol names\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nounique-symbol          Keep duplicated local symbol names (default)\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z globalaudit              Mark executable requiring global auditing\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z start-stop-gc            Enable garbage collection on __start/__stop\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z nostart-stop-gc          Don't garbage collect __start/__stop (default)\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  -z start-stop-visibility=V  Set visibility of built-in __start/__stop symbols\n                                to DEFAULT, PROTECTED, HIDDEN or INTERNAL\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
}
unsafe extern "C" fn elf_plt_unwind_list_options(mut file: *mut FILE) {
    fprintf(
        file,
        dcgettext(
            0 as *const libc::c_char,
            b"  --ld-generated-unwind-info  Generate exception handling info for PLT\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"  --no-ld-generated-unwind-info\n                              Don't generate exception handling info for PLT\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
}
unsafe extern "C" fn ld_list_options(
    mut file: *mut FILE,
    mut elf: bool,
    mut shlib: bool,
    mut plt_unwind: bool,
