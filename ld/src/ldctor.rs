extern "C" {
    ...
    fn exp_relop(_: *mut asection, _: bfd_vma) -> *mut etree_type;
...
#[repr(C)]
pub struct set_info {
    pub next: *mut set_info,
    pub h: *mut bfd_link_hash_entry,
    pub reloc: bfd_reloc_code_real_type,
    pub count: size_t,
    pub elements: *mut set_element,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct set_element {
...
#[no_mangle]
pub static mut constructor_list: lang_statement_list_type = lang_statement_list_type {
...
#[no_mangle]
pub static mut constructors_sorted: bool = false;
#[no_mangle]
pub static mut sets: *mut set_info = 0 as *const set_info as *mut set_info;
#[no_mangle]
pub unsafe extern "C" fn ldctor_add_set_entry(
    ...
    let mut p: *mut set_info = 0 as *mut set_info;
    let mut e: *mut set_element = 0 as *mut set_element;
    let mut epp: *mut *mut set_element = 0 as *mut *mut set_element;
    p = sets;
    while !p.is_null() {
        if (*p).h == h {
            break;
    ...
    if p.is_null() {
        p = xmalloc(::core::mem::size_of::<set_info>() as libc::c_ulong)
            as *mut set_info;
        (*p).next = sets;
        sets = p;
        (*p).h = h;
        (*p).reloc = reloc;
        (*p).count = 0 as libc::c_int as size_t;
        (*p).elements = 0 as *mut set_element;
    } else {
        if (*p).reloc as libc::c_uint != reloc as libc::c_uint {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: different relocs used in set %s\n\0" as *const u8
        ...
        if !((*p).elements).is_null() && !((*section).owner).is_null()
            && !((*(*(*p).elements).section).owner).is_null()
            && strcmp(
            ...
            ) != 0 as libc::c_int
        {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: different object file formats composing set %s\n\0"
    ...
    e = xmalloc(::core::mem::size_of::<set_element>() as libc::c_ulong)
        as *mut set_element;
    (*e).u.next = 0 as *mut set_element;
    (*e).name = name;
    (*e).section = section;
    (*e).value = value;
    epp = &mut (*p).elements;
...
#[no_mangle]
pub unsafe extern "C" fn ldctor_build_sets() {
    ...
    if constructors_sorted {
        ...
        while !p.is_null() {
            ...
            let mut e: *mut set_element = 0 as *mut set_element;
            let mut enext: *mut set_element = 0 as *mut set_element;
            let mut array: *mut *mut set_element = 0 as *mut *mut set_element;
            if !((*p).elements).is_null() {
                ...
                array = xmalloc(
                    (c as libc::c_ulong)
                        .wrapping_mul(
                            ::core::mem::size_of::<*mut set_element>() as libc::c_ulong,
                        ),
                ) as *mut *mut set_element;
                i = 0 as libc::c_int;
                e = (*p).elements;
                while !e.is_null() {
                ...
                e = *array.offset(0 as libc::c_int as isize);
                (*p).elements = e;
                i = 0 as libc::c_int;
                while i < c - 1 as libc::c_int {
                    let ref mut fresh1 = (**array.offset(i as isize)).u.next;
                    *fresh1 = *array.offset((i + 1 as libc::c_int) as isize);
                    i += 1;
                    i;
                }
                let ref mut fresh2 = (**array.offset(i as isize)).u.next;
                *fresh2 = 0 as *mut set_element;
                free(array as *mut libc::c_void);
            }
            p = (*p).next;
        }
    }
    lang_list_init(&mut constructor_list);
    push_stat_ptr(&mut constructor_list);
    header_printed = 0 as libc::c_int != 0;
    let mut current_block_79: u64;
    p = sets;
    while !p.is_null() {
        let mut e_0: *mut set_element = 0 as *mut set_element;
        let mut howto: *const reloc_howto_type = 0 as *const reloc_howto_type;
        let mut reloc_size: libc::c_int = 0;
        let mut size: libc::c_int = 0;
        if !((*(*p).h).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
            || (*(*p).h).type_0() as libc::c_int == bfd_link_hash_defweak as libc::c_int)
        {
            ...
            if howto.is_null() {
                if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: %s does not support reloc %s for set %s\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    ...
                    current_block_79 = 14648156034262866959;
                } else {
                    if !((*(*(*p).elements).section).owner).is_null() {
                    ...
                    if howto.is_null() {
                        if ((*(*(*p).elements).section).owner).is_null() {
                            einfo(
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"%X%P: special section %s does not support reloc %s for set %s\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                        ...
                        current_block_79 = 7427571413727699167;
                    }
                }
            } else {
                current_block_79 = 7427571413727699167;
            ...
            match current_block_79 {
                ...
                _ => {
                    reloc_size = bfd_get_reloc_size(howto) as libc::c_int;
                    match reloc_size {
                        1 => {
                            size = 286 as libc::c_int;
                        }
                        2 => {
                            size = 285 as libc::c_int;
                        }
                        4 => {
                            size = 284 as libc::c_int;
                        }
                        8 => {
                            if (*howto).complain_on_overflow() as libc::c_int
                                == complain_overflow_signed as libc::c_int
                            {
                                size = 283 as libc::c_int;
                            } else {
                                size = 282 as libc::c_int;
                            }
                        }
                        _ => {
                            einfo(
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"%X%P: unsupported size %d for set %s\n\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                    ...
                    lang_add_assignment(
                        exp_assign(
                            ...
                            exp_unop(
                                279 as libc::c_int,
                                exp_intop(reloc_size as bfd_vma),
                            ),
                            0 as libc::c_int != 0,
                        ),
                    );
                    ...
                    while !e_0.is_null() {
                        if !(config.map_file).is_null() {
                            ...
                            len = strlen((*(*p).h).root.string) as libc::c_int;
                        ...
                        if !bfd_is_abs_section((*e_0).section) {
                            (*(*e_0).section).flags
                            ...
                            == type_relocatable as libc::c_int
                        {
                            ...
                            lang_add_data(size, exp_relop((*e_0).section, (*e_0).value));
                        }
                        e_0 = (*e_0).u.next;
                    }
                    lang_add_data(size, exp_intop(0 as libc::c_int as bfd_vma));
                }
            }
        }
        p = (*p).next;
...
unsafe extern "C" fn ctor_prio(mut name: *const libc::c_char) -> libc::c_int {
    while *name as libc::c_int == '_' as i32 {
        name = name.offset(1);
        name;
    }
    if !startswith(name, b"GLOBAL_\0" as *const u8 as *const libc::c_char) {
    ...
    if *name.offset(1 as libc::c_int as isize) as libc::c_int != 'I' as i32
        && *name.offset(1 as libc::c_int as isize) as libc::c_int != 'D' as i32
    {
        return -(1 as libc::c_int);
    }
    if _sch_istable[(*name.offset(3 as libc::c_int as isize) as libc::c_int
        & 0xff as libc::c_int) as usize] as libc::c_int
        & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int == 0
    {
        return -(1 as libc::c_int);
    }
    return atoi(name.offset(3 as libc::c_int as isize));
}
unsafe extern "C" fn ctor_cmp(
    mut p1: *const libc::c_void,
    mut p2: *const libc::c_void,
) -> libc::c_int {
    let mut pe1: *const set_element = *(p1 as *mut *const set_element);
    let mut pe2: *const set_element = *(p2 as *mut *const set_element);
    let mut n1: *const libc::c_char = 0 as *const libc::c_char;
    let mut n2: *const libc::c_char = 0 as *const libc::c_char;
    let mut prio1: libc::c_int = 0;
    let mut prio2: libc::c_int = 0;
    n1 = (*pe1).name;
    if n1.is_null() {
        n1 = b"\0" as *const u8 as *const libc::c_char;
    }
    n2 = (*pe2).name;
    if n2.is_null() {
        n2 = b"\0" as *const u8 as *const libc::c_char;
    }
    prio1 = ctor_prio(n1);
    prio2 = ctor_prio(n2);
    if prio1 < prio2 {
