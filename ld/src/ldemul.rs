extern "C" {
    ...
    fn bfd_emul_get_maxpagesize(_: *const libc::c_char) -> bfd_vma;
    fn bfd_emul_get_commonpagesize(_: *const libc::c_char, _: bool) -> bfd_vma;
    ...
    static mut entry_symbol: bfd_sym_chain;
    static mut entry_from_cmdline: bool;
    static mut file_chain: lang_statement_list_type;
    fn lang_relax_sections(_: bool);
    fn ldlang_add_undef(_: *const libc::c_char, _: bool);
    fn strip_excluded_output_sections();
    fn print_one_symbol(
    ...
    static mut ld_elf_x86_64_emulation: ld_emulation_xfer_type;
    static mut ld_elf32_x86_64_emulation: ld_emulation_xfer_type;
    static mut ld_elf_i386_emulation: ld_emulation_xfer_type;
    static mut ld_elf_iamcu_emulation: ld_emulation_xfer_type;
    static mut ld_elf_l1om_emulation: ld_emulation_xfer_type;
    static mut ld_elf_k1om_emulation: ld_emulation_xfer_type;
    static mut ld_i386pep_emulation: ld_emulation_xfer_type;
    static mut ld_i386pe_emulation: ld_emulation_xfer_type;
}
...
pub type ld_emulation_xfer_type = ld_emulation_xfer_struct;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_hll(mut name: *mut libc::c_char) {
    ((*ld_emulation).hll).expect("non-null function pointer")(name);
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_syslib(mut name: *mut libc::c_char) {
    ((*ld_emulation).syslib).expect("non-null function pointer")(name);
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_after_parse() {
    ((*ld_emulation).after_parse).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_before_parse() {
    ((*ld_emulation).before_parse).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_after_open() {
    ((*ld_emulation).after_open).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_after_check_relocs() {
    ((*ld_emulation).after_check_relocs).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_before_place_orphans() {
    ((*ld_emulation).before_place_orphans).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_after_allocation() {
    ((*ld_emulation).after_allocation).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_before_allocation() {
    ((*ld_emulation).before_allocation).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_set_output_arch() {
    ((*ld_emulation).set_output_arch).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_choose_target(
    mut argc: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_choose_mode(mut target: *mut libc::c_char) {
    let mut eptr: *mut *mut ld_emulation_xfer_type = ld_emulations.as_mut_ptr();
    if *target.offset(0 as libc::c_int as isize) as libc::c_int == 'g' as i32
        && *target.offset(1 as libc::c_int as isize) as libc::c_int == 'l' as i32
        && *target.offset(2 as libc::c_int as isize) as libc::c_int == 'd' as i32
    {
        target = target.offset(3 as libc::c_int as isize);
    }
    while !(*eptr).is_null() {
        if strcmp(target, (**eptr).emulation_name) == 0 as libc::c_int {
            ld_emulation = *eptr;
            return;
        }
        eptr = eptr.offset(1);
    ...
    einfo(
        dcgettext(
            ...
            b"%P: unrecognised emulation mode: %s\n\0" as *const u8
    ...
    einfo(
        dcgettext(
            0 as *const libc::c_char,
            b"Supported emulations: \0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_list_emulations(mut f: *mut FILE) {
    let mut eptr: *mut *mut ld_emulation_xfer_type = ld_emulations.as_mut_ptr();
    ...
    while !(*eptr).is_null() {
        ...
        fprintf(f, b"%s\0" as *const u8 as *const libc::c_char, (**eptr).emulation_name);
        eptr = eptr.offset(1);
        eptr;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_list_emulation_options(mut f: *mut FILE) {
    let mut eptr: *mut *mut ld_emulation_xfer_type = 0
        as *mut *mut ld_emulation_xfer_type;
    let mut options_found: libc::c_int = 0 as libc::c_int;
    eptr = ld_emulations.as_mut_ptr();
    while !(*eptr).is_null() {
        let mut emul: *mut ld_emulation_xfer_type = *eptr;
        if ((*emul).list_options).is_some() {
            fprintf(
                f,
                b"%s: \n\0" as *const u8 as *const libc::c_char,
                (*emul).emulation_name,
            );
            ((*emul).list_options).expect("non-null function pointer")(f);
            options_found = 1 as libc::c_int;
        }
        eptr = eptr.offset(1);
        eptr;
    }
    if options_found == 0 {
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"  no emulation specific options.\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_get_script(
    mut isfile: *mut libc::c_int,
) -> *mut libc::c_char {
    return ((*ld_emulation).get_script).expect("non-null function pointer")(isfile);
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_finish() {
    ((*ld_emulation).finish).expect("non-null function pointer")();
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_set_symbols() {
    if ((*ld_emulation).set_symbols).is_some() {
        ((*ld_emulation).set_symbols).expect("non-null function pointer")();
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_create_output_section_statements() {
    if ((*ld_emulation).create_output_section_statements).is_some() {
        ((*ld_emulation).create_output_section_statements)
            .expect("non-null function pointer")();
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_place_orphan(
    mut s: *mut asection,
    mut name: *const libc::c_char,
    mut constraint: libc::c_int,
) -> *mut lang_output_section_statement_type {
    if ((*ld_emulation).place_orphan).is_some() {
        return (Some(((*ld_emulation).place_orphan).expect("non-null function pointer")))
            .expect("non-null function pointer")(s, name, constraint);
    }
    return 0 as *mut lang_output_section_statement_type;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_parse_args(
    mut argc: libc::c_int,
    mut argv: *mut *mut libc::c_char,
) -> bool {
    if ((*ld_emulation).parse_args).is_some() {
        return (Some(((*ld_emulation).parse_args).expect("non-null function pointer")))
            .expect("non-null function pointer")(argc, argv);
    }
    return 0 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_add_options(
    mut ns: libc::c_int,
    ...
    if ((*ld_emulation).add_options).is_some() {
        (Some(((*ld_emulation).add_options).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(ns, shortopts, nl, longopts, nrl, really_longopts);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_handle_option(mut optc: libc::c_int) -> bool {
    if ((*ld_emulation).handle_option).is_some() {
        return (Some(
            ((*ld_emulation).handle_option).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(optc);
    }
    return 0 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_unrecognized_file(
    mut entry: *mut lang_input_statement_type,
) -> bool {
    if ((*ld_emulation).unrecognized_file).is_some() {
        return (Some(
            ((*ld_emulation).unrecognized_file).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(entry);
    }
    return 0 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_recognized_file(
    mut entry: *mut lang_input_statement_type,
) -> bool {
    if ((*ld_emulation).recognized_file).is_some() {
        return (Some(
            ((*ld_emulation).recognized_file).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(entry);
    }
    return 0 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_open_dynamic_archive(
    mut arch: *const libc::c_char,
    mut search: *mut search_dirs_type,
    mut entry: *mut lang_input_statement_type,
) -> bool {
    if ((*ld_emulation).open_dynamic_archive).is_some() {
        return (Some(
            ((*ld_emulation).open_dynamic_archive).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(arch, search, entry);
    }
    return 0 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_default_target(
    ...
    if !from_outside.is_null() {
        return from_outside;
    }
    return (*ld_emulation).target_name;
}
#[no_mangle]
pub unsafe extern "C" fn after_parse_default() {
    if !(entry_symbol.name).is_null()
        && (link_info.type_0() as libc::c_int == type_pde as libc::c_int
            ...
            || entry_from_cmdline as libc::c_int != 0)
    {
        let mut is_vma: bool = 0 as libc::c_int != 0;
        if entry_from_cmdline {
            let mut send: *const libc::c_char = 0 as *const libc::c_char;
            bfd_scan_vma(entry_symbol.name, &mut send, 0 as libc::c_int);
            is_vma = *send as libc::c_int == '\0' as i32;
        }
        if !is_vma {
            ldlang_add_undef(entry_symbol.name, entry_from_cmdline);
        }
    }
    if link_info.maxpagesize == 0 as libc::c_int as libc::c_ulong {
        link_info.maxpagesize = bfd_emul_get_maxpagesize(default_target);
    }
    if link_info.commonpagesize == 0 as libc::c_int as libc::c_ulong {
        link_info
            .commonpagesize = bfd_emul_get_commonpagesize(
            default_target,
            link_info.relro() != 0,
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn after_open_default() {
    link_info.set_big_endian(1 as libc::c_int as libc::c_uint);
    if !bfd_big_endian(link_info.output_bfd) {
        if bfd_little_endian(link_info.output_bfd) {
            link_info.set_big_endian(0 as libc::c_int as libc::c_uint);
            ...
            == ENDIAN_BIG as libc::c_int as libc::c_uint)
        {
                ...
                == ENDIAN_LITTLE as libc::c_int as libc::c_uint
            {
                ...
                == ENDIAN_UNSET as libc::c_int as libc::c_uint
            {
                let mut s: *mut lang_input_statement_type = 0
...
#[no_mangle]
pub unsafe extern "C" fn after_check_relocs_default() {}
#[no_mangle]
pub unsafe extern "C" fn before_place_orphans_default() {}
#[no_mangle]
pub unsafe extern "C" fn after_allocation_default() {
    lang_relax_sections(0 as libc::c_int != 0);
}
#[no_mangle]
pub unsafe extern "C" fn before_allocation_default() {
    if !(link_info.type_0() as libc::c_int == type_relocatable as libc::c_int) {
        strip_excluded_output_sections();
    }
}
#[no_mangle]
pub unsafe extern "C" fn finish_default() {
    if !(link_info.type_0() as libc::c_int == type_relocatable as libc::c_int) {
        _bfd_fix_excluded_sec_syms(link_info.output_bfd, &mut link_info);
    }
}
#[no_mangle]
pub unsafe extern "C" fn set_output_arch_default() {
    (Some(
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_find_potential_libraries(
    mut name: *mut libc::c_char,
    mut entry: *mut lang_input_statement_type,
) -> libc::c_int {
    if ((*ld_emulation).find_potential_libraries).is_some() {
        return ((*ld_emulation).find_potential_libraries)
            .expect("non-null function pointer")(name, entry);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_new_vers_pattern(
    mut entry: *mut bfd_elf_version_expr,
) -> *mut bfd_elf_version_expr {
    if ((*ld_emulation).new_vers_pattern).is_some() {
        entry = (Some(
            ((*ld_emulation).new_vers_pattern).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(entry);
    }
    return entry;
...
#[no_mangle]
pub unsafe extern "C" fn ldemul_extra_map_file_text(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut mapf: *mut FILE,
) {
    if ((*ld_emulation).extra_map_file_text).is_some() {
        ((*ld_emulation).extra_map_file_text)
            .expect("non-null function pointer")(abfd, info, mapf);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_emit_ctf_early() -> libc::c_int {
    if ((*ld_emulation).emit_ctf_early).is_some() {
        return ((*ld_emulation).emit_ctf_early).expect("non-null function pointer")();
    }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_acquire_strings_for_ctf(
    mut ctf_output: *mut ctf_dict,
    mut symstrtab: *mut elf_strtab_hash,
) {
    if ((*ld_emulation).acquire_strings_for_ctf).is_some() {
        ((*ld_emulation).acquire_strings_for_ctf)
            .expect("non-null function pointer")(ctf_output, symstrtab);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_new_dynsym_for_ctf(
    mut ctf_output: *mut ctf_dict,
    mut symidx: libc::c_int,
    mut sym: *mut elf_internal_sym,
) {
    if ((*ld_emulation).new_dynsym_for_ctf).is_some() {
        ((*ld_emulation).new_dynsym_for_ctf)
            .expect("non-null function pointer")(ctf_output, symidx, sym);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ldemul_print_symbol(
    mut hash_entry: *mut bfd_link_hash_entry,
    mut ptr: *mut libc::c_void,
) -> bool {
    if ((*ld_emulation).print_symbol).is_some() {
        return ((*ld_emulation).print_symbol)
            .expect("non-null function pointer")(hash_entry, ptr);
    }
    return print_one_symbol(hash_entry, ptr);
}
#[no_mangle]
pub static mut ld_emulations: [*mut ld_emulation_xfer_type; 9] = unsafe {
    [
        &ld_elf_x86_64_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_elf32_x86_64_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_elf_i386_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_elf_iamcu_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_elf_l1om_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_elf_k1om_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_i386pep_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        &ld_i386pe_emulation as *const ld_emulation_xfer_type
            as *mut ld_emulation_xfer_type,
        0 as *const ld_emulation_xfer_type as *mut ld_emulation_xfer_type,
    ]
};
static mut ld_emulation: *mut ld_emulation_xfer_type = 0 as *const ld_emulation_xfer_type
    as *mut ld_emulation_xfer_type;
