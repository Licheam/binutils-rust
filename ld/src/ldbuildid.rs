...
#[no_mangle]
pub unsafe extern "C" fn validate_build_id_style(
    mut style: *const libc::c_char,
) -> bool {
    if strcmp(style, b"md5\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int
        || strcmp(style, b"sha1\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(style, b"uuid\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || startswith(style, b"0x\0" as *const u8 as *const libc::c_char) as libc::c_int
            != 0
    {
...
#[no_mangle]
pub unsafe extern "C" fn compute_build_id_size(
    mut style: *const libc::c_char,
) -> bfd_size_type {
    if strcmp(style, b"md5\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int
        || strcmp(style, b"uuid\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
        return (128 as libc::c_int / 8 as libc::c_int) as bfd_size_type;
    }
    if strcmp(style, b"sha1\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int {
        return (160 as libc::c_int / 8 as libc::c_int) as bfd_size_type;
    }
    if startswith(style, b"0x\0" as *const u8 as *const libc::c_char) {
        let mut size: bfd_size_type = 0 as libc::c_int as bfd_size_type;
        let mut id: *const libc::c_char = style.offset(2 as libc::c_int as isize);
        loop {
            if _sch_istable[(*id.offset(0 as libc::c_int as isize) as libc::c_int
                & 0xff as libc::c_int) as usize] as libc::c_int
                & _sch_isxdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
                && _sch_istable[(*id.offset(1 as libc::c_int as isize) as libc::c_int
                    & 0xff as libc::c_int) as usize] as libc::c_int
                    & _sch_isxdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
            {
                size = size.wrapping_add(1);
                size;
                id = id.offset(2 as libc::c_int as isize);
            } else if *id as libc::c_int == '-' as i32
                || *id as libc::c_int == ':' as i32
            {
                id = id.offset(1);
                id;
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn generate_build_id(
    mut abfd: *mut bfd,
    mut style: *const libc::c_char,
    mut checksum_contents: checksum_fn,
    mut id_bits: *mut libc::c_uchar,
    mut size: libc::c_int,
) -> bool {
    if strcmp(style, b"md5\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int {
        ...
        if !(Some(checksum_contents.expect("non-null function pointer")))
            .expect(
            ...
            ::core::mem::transmute::<
                Option::<
                    unsafe extern "C" fn(*const libc::c_void, size_t, *mut md5_ctx) -> (),
                >,
                sum_fn,
            >(
                Some(
            ...
            &mut ctx as *mut md5_ctx as *mut libc::c_void,
        )
        {
            return 0 as libc::c_int != 0;
        }
        md5_finish_ctx(&mut ctx, id_bits as *mut libc::c_void);
    } else if strcmp(style, b"sha1\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        let mut ctx_0: sha1_ctx = sha1_ctx {
            A: 0,
            B: 0,
            C: 0,
            D: 0,
        ...
        if !(Some(checksum_contents.expect("non-null function pointer")))
            ...
            &mut ctx_0 as *mut sha1_ctx as *mut libc::c_void,
        )
        {
            return 0 as libc::c_int != 0;
        }
        sha1_finish_ctx(&mut ctx_0, id_bits as *mut libc::c_void);
    } else if strcmp(style, b"uuid\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        ...
        n = read(fd, id_bits as *mut libc::c_void, size as size_t) as libc::c_int;
        close(fd);
        if n < size {
            return 0 as libc::c_int != 0;
        }
    } else if startswith(style, b"0x\0" as *const u8 as *const libc::c_char) {
        let mut id: *const libc::c_char = style.offset(2 as libc::c_int as isize);
        ...
        loop {
                    ...
                    & _sch_isxdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
            {
                ...
                *id_bits
                    .offset(
                        n_0 as isize,
                    ) = ((read_hex(*fresh0) as libc::c_int) << 4 as libc::c_int)
                    as libc::c_uchar;
                let fresh1 = id;
                id = id.offset(1);
                let fresh2 = n_0;
                n_0 = n_0.wrapping_add(1);
                let ref mut fresh3 = *id_bits.offset(fresh2 as isize);
                *fresh3 = (*fresh3 as libc::c_int | read_hex(*fresh1) as libc::c_int)
                    as libc::c_uchar;
            } else if *id as libc::c_int == '-' as i32
                || *id as libc::c_int == ':' as i32
            {
...
unsafe extern "C" fn read_hex(xdigit: libc::c_char) -> libc::c_uchar {
    if _sch_istable[(xdigit as libc::c_int & 0xff as libc::c_int) as usize]
        as libc::c_int & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int
        != 0
    {
        return (xdigit as libc::c_int - '0' as i32) as libc::c_uchar;
    }
    if _sch_istable[(xdigit as libc::c_int & 0xff as libc::c_int) as usize]
        as libc::c_int & _sch_isupper as libc::c_int as libc::c_ushort as libc::c_int
        != 0
    {
        return (xdigit as libc::c_int - 'A' as i32 + 0xa as libc::c_int)
            as libc::c_uchar;
    }
    if _sch_istable[(xdigit as libc::c_int & 0xff as libc::c_int) as usize]
