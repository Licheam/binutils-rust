extern "C" {
    ...
    fn bfd_get_unique_section_name(
        abfd: *mut bfd,
        templat: *const libc::c_char,
    ...
    fn bfd_new_link_order(_: *mut bfd, _: *mut asection) -> *mut bfd_link_order;
...
#[no_mangle]
pub unsafe extern "C" fn ldwrite() {
    ...
    if config.split_by_reloc != -(1 as libc::c_int) as libc::c_uint
        || config.split_by_file != -(1 as libc::c_int) as bfd_size_type
    {
        split_sections(link_info.output_bfd, &mut link_info);
    }
    if !(Some(
        ((*(*link_info.output_bfd).xvec)._bfd_final_link)
...
unsafe extern "C" fn build_link_order(mut statement: *mut lang_statement_union_type) {
    match (*statement).header.type_0 as libc::c_uint {
        2 => {
            ...
            if !((*output_section).owner == link_info.output_bfd) {
                info_assert(
                    b"ldwrite.c\0" as *const u8 as *const libc::c_char,
                    51 as libc::c_int as libc::c_uint,
                );
            }
            if (*output_section).flags & 0x100 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
                || (*output_section).flags & 0x2 as libc::c_int as libc::c_uint
                    != 0 as libc::c_int as libc::c_uint
                    && (*output_section).flags & 0x400 as libc::c_int as libc::c_uint
                        != 0
            {
                ...
                if link_order.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: bfd_new_link_order failed\n\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
                }
                (*link_order).type_0 = bfd_data_link_order;
                (*link_order).offset = (*statement).data_statement.output_offset;
                (*link_order)
                    .u
                    .data
                    .contents = xmalloc(8 as libc::c_int as size_t) as *mut bfd_byte;
                value = (*statement).data_statement.value;
                if !bfd_big_endian(link_info.output_bfd)
                    && !bfd_little_endian(link_info.output_bfd)
                    && link_info.big_endian() == 0
                {
                    let mut buffer: [bfd_byte; 8] = [0; 8];
                    let mut current_block_18: u64;
                    match (*statement).data_statement.type_0 {
                        282 | 283 => {
                            if ::core::mem::size_of::<bfd_vma>() as libc::c_ulong
                                >= 8 as libc::c_int as libc::c_ulong
                            {
                                bfd_putl64(value, buffer.as_mut_ptr() as *mut libc::c_void);
                                value = bfd_getb64(
                                    buffer.as_mut_ptr() as *const libc::c_void,
                                );
                                current_block_18 = 11042950489265723346;
                            } else {
                                current_block_18 = 12001691090696573354;
                            }
                        }
                        284 => {
                            current_block_18 = 12001691090696573354;
                        ...
                        285 => {
                            bfd_putl16(value, buffer.as_mut_ptr() as *mut libc::c_void);
                            value = bfd_getb16(
                                buffer.as_mut_ptr() as *const libc::c_void,
                            );
                            current_block_18 = 11042950489265723346;
                        ...
                        _ => {
                            ld_abort(
                                ...
                                (*::core::mem::transmute::<
                                    &[u8; 51],
                                    &[libc::c_char; 51],
                                >(b"void build_link_order(lang_statement_union_type *)\0"))
                                    .as_ptr(),
                            );
                        }
                    }
                    match current_block_18 {
                        12001691090696573354 => {
                            bfd_putl32(value, buffer.as_mut_ptr() as *mut libc::c_void);
                            value = bfd_getb32(
                                buffer.as_mut_ptr() as *const libc::c_void,
                            );
                        }
                ...
                match (*statement).data_statement.type_0 {
                    282 | 283 => {
                        ...
                        {
                            (Some(
                                ((*(*link_info.output_bfd).xvec).bfd_putx64)
                                    .expect("non-null function pointer"),
                            ))
                                .expect(
                                ...
                                value,
                                (*link_order).u.data.contents as *mut libc::c_void,
                            );
                        } else {
                            let mut high: bfd_vma = 0;
                            if (*statement).data_statement.type_0
                                == 282 as libc::c_int as libc::c_uint
                            {
                                high = 0 as libc::c_int as bfd_vma;
                            } else if value & 0x80000000 as libc::c_uint as libc::c_ulong
                                == 0 as libc::c_int as libc::c_ulong
                            {
                                high = 0 as libc::c_int as bfd_vma;
                            } else {
                                high = -(1 as libc::c_int) as bfd_vma;
                            }
                            (Some(
                                ((*(*link_info.output_bfd).xvec).bfd_putx32)
                                    .expect("non-null function pointer"),
                            ))
                                .expect(
                                    "non-null function pointer",
                                ...
                                ((*link_order).u.data.contents)
                                    .offset(
                                        (if link_info.big_endian() as libc::c_int != 0 {
                                            0 as libc::c_int
                                        } else {
                                            4 as libc::c_int
                                        }) as isize,
                        ...
                        (*link_order).size = 8 as libc::c_int as bfd_size_type;
                    }
                    284 => {
                        (Some(
                            ((*(*link_info.output_bfd).xvec).bfd_putx32)
                            ...
                            .expect(
                                "non-null function pointer",
                            )(value, (*link_order).u.data.contents as *mut libc::c_void);
                        (*link_order).size = 4 as libc::c_int as bfd_size_type;
                    }
                    285 => {
                        (Some(
                            ((*(*link_info.output_bfd).xvec).bfd_putx16)
                                .expect("non-null function pointer"),
                        ))
                            .expect(
                                "non-null function pointer",
                            )(value, (*link_order).u.data.contents as *mut libc::c_void);
                        (*link_order).size = 2 as libc::c_int as bfd_size_type;
                    }
                    286 => {
                        *((*link_order).u.data.contents
                            as *mut libc::c_uchar) = (value
                            & 0xff as libc::c_int as libc::c_ulong) as libc::c_uchar;
                        (*link_order).size = 1 as libc::c_int as bfd_size_type;
                    }
                    _ => {
                        ld_abort(
                            b"ldwrite.c\0" as *const u8 as *const libc::c_char,
                ...
                (*link_order).u.data.size = (*link_order).size as libc::c_uint;
            }
        }
        11 => {
            let mut rs: *mut lang_reloc_statement_type = 0
                as *mut lang_reloc_statement_type;
            let mut output_section_0: *mut asection = 0 as *mut asection;
            let mut link_order_0: *mut bfd_link_order = 0 as *mut bfd_link_order;
            rs = &mut (*statement).reloc_statement;
            output_section_0 = (*rs).output_section;
            if !((*output_section_0).owner == link_info.output_bfd) {
                info_assert(
                    b"ldwrite.c\0" as *const u8 as *const libc::c_char,
                    161 as libc::c_int as libc::c_uint,
                );
            }
            if (*output_section_0).flags & 0x100 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
                || (*output_section_0).flags & 0x2 as libc::c_int as libc::c_uint
                    != 0 as libc::c_int as libc::c_uint
                    && (*output_section_0).flags & 0x400 as libc::c_int as libc::c_uint
                        != 0
            {
                link_order_0 = bfd_new_link_order(
                    link_info.output_bfd,
                    output_section_0,
                );
                if link_order_0.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: bfd_new_link_order failed\n\0" as *const u8
                ...
                (*link_order_0).offset = (*rs).output_offset;
                (*link_order_0).size = bfd_get_reloc_size((*rs).howto) as bfd_size_type;
                (*link_order_0)
                    .u
                    .reloc
                    .p = xmalloc(
                    ::core::mem::size_of::<bfd_link_order_reloc>() as libc::c_ulong,
                ) as *mut bfd_link_order_reloc;
                (*(*link_order_0).u.reloc.p).reloc = (*rs).reloc;
                (*(*link_order_0).u.reloc.p).addend = (*rs).addend_value;
                if ((*rs).name).is_null() {
                    (*link_order_0).type_0 = bfd_section_reloc_link_order;
                    if (*(*rs).section).owner == link_info.output_bfd {
                        (*(*link_order_0).u.reloc.p).u.section = (*rs).section;
                    } else {
                        (*(*link_order_0).u.reloc.p)
                            .u
                            .section = (*(*rs).section).output_section;
                        (*(*link_order_0).u.reloc.p)
                            .addend = ((*(*link_order_0).u.reloc.p).addend
                            as libc::c_ulong)
                            .wrapping_add((*(*rs).section).output_offset) as bfd_vma
                            as bfd_vma;
                    }
                } else {
                    (*link_order_0).type_0 = bfd_symbol_reloc_link_order;
                    (*(*link_order_0).u.reloc.p).u.name = (*rs).name;
                }
            }
        }
        5 => {
            let mut i: *mut asection = (*statement).input_section.section;
            if (*i).sec_info_type() as libc::c_int != 4 as libc::c_int
                && (*i).flags & 0x8000 as libc::c_int as libc::c_uint
                    == 0 as libc::c_int as libc::c_uint
            {
                let mut output_section_1: *mut asection = (*i).output_section;
                let mut link_order_1: *mut bfd_link_order = 0 as *mut bfd_link_order;
                if !((*output_section_1).owner == link_info.output_bfd) {
                    info_assert(
                        b"ldwrite.c\0" as *const u8 as *const libc::c_char,
                        212 as libc::c_int as libc::c_uint,
                    );
                }
                if (*output_section_1).flags & 0x100 as libc::c_int as libc::c_uint
                    != 0 as libc::c_int as libc::c_uint
                    || (*output_section_1).flags & 0x2 as libc::c_int as libc::c_uint
                        != 0 as libc::c_int as libc::c_uint
                        && (*output_section_1).flags
                            & 0x400 as libc::c_int as libc::c_uint != 0
                {
                    link_order_1 = bfd_new_link_order(
                        link_info.output_bfd,
                        output_section_1,
                    );
                    if link_order_1.is_null() {
                        einfo(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%F%P: bfd_new_link_order failed\n\0" as *const u8
                    ...
                    if (*i).flags & 0x200 as libc::c_int as libc::c_uint
                        != 0 as libc::c_int as libc::c_uint
                        && (*i).flags & 0x2000 as libc::c_int as libc::c_uint
                            == 0 as libc::c_int as libc::c_uint
                    {
                        (*link_order_1).type_0 = bfd_data_link_order;
                        (*link_order_1)
                            .u
                            .data
                            .contents = b"\0" as *const u8 as *const libc::c_char
                            as *mut libc::c_uchar;
                        (*link_order_1).u.data.size = 1 as libc::c_int as libc::c_uint;
                    } else {
                        (*link_order_1).type_0 = bfd_indirect_link_order;
                        (*link_order_1).u.indirect.section = i;
                        if !((*i).output_section == output_section_1) {
                            info_assert(
                                b"ldwrite.c\0" as *const u8 as *const libc::c_char,
                    ...
                    (*link_order_1).size = (*i).size;
                    (*link_order_1).offset = (*i).output_offset;
                }
            }
        }
        10 => {
            let mut output_section_2: *mut asection = 0 as *mut asection;
            let mut link_order_2: *mut bfd_link_order = 0 as *mut bfd_link_order;
            output_section_2 = (*statement).padding_statement.output_section;
            if !((*(*statement).padding_statement.output_section).owner
                == link_info.output_bfd)
            {
                info_assert(
                    b"ldwrite.c\0" as *const u8 as *const libc::c_char,
            ...
            if (*output_section_2).flags & 0x100 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
                || (*output_section_2).flags & 0x2 as libc::c_int as libc::c_uint
                    != 0 as libc::c_int as libc::c_uint
                    && (*output_section_2).flags & 0x400 as libc::c_int as libc::c_uint
                        != 0
            {
                link_order_2 = bfd_new_link_order(
                    link_info.output_bfd,
                    output_section_2,
                );
                if link_order_2.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: bfd_new_link_order failed\n\0" as *const u8
                ...
                (*link_order_2).type_0 = bfd_data_link_order;
                (*link_order_2).size = (*statement).padding_statement.size;
                (*link_order_2).offset = (*statement).padding_statement.output_offset;
                (*link_order_2)
                    .u
                    .data
                    .contents = ((*(*statement).padding_statement.fill).data)
                    .as_mut_ptr();
                (*link_order_2)
                    .u
                    .data
                    .size = (*(*statement).padding_statement.fill).size as libc::c_uint;
            }
        }
        _ => {}
    };
}
unsafe extern "C" fn unsplittable_name(mut name: *const libc::c_char) -> bool {
    if startswith(name, b".stab\0" as *const u8 as *const libc::c_char) {
        let mut len: libc::c_uint = strlen(name) as libc::c_uint;
        if strcmp(
            &*name.offset(len.wrapping_sub(3 as libc::c_int as libc::c_uint) as isize),
            b"str\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
        {
            return 1 as libc::c_int != 0;
        }
    } else if strcmp(name, b"$GDB_STRINGS$\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        return 1 as libc::c_int != 0
    }
...
unsafe extern "C" fn clone_section(
    mut abfd: *mut bfd,
    mut s: *mut asection,
    ...
    let mut n: *mut asection = 0 as *mut asection;
    let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    len = strlen(name) as libc::c_uint;
    tname = xmalloc(len.wrapping_add(1 as libc::c_int as libc::c_uint) as size_t)
        as *mut libc::c_char;
    memcpy(
        tname as *mut libc::c_void,
    ...
    if len > 1 as libc::c_int as libc::c_uint
        && *tname.offset(len.wrapping_sub(1 as libc::c_int as libc::c_uint) as isize)
    ...
    if bfd_family_coff(abfd) as libc::c_int != 0
        && strlen(tname) > 5 as libc::c_int as libc::c_ulong
    {
        if startswith(name, b".stab\0" as *const u8 as *const libc::c_char)
            as libc::c_int != 0
            || strcmp(name, b"$GDB_SYMBOLS$\0" as *const u8 as *const libc::c_char)
                == 0 as libc::c_int
        {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%F%P: cannot create split section name for %s\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                name,
        ...
        *tname.offset(5 as libc::c_int as isize) = 0 as libc::c_int as libc::c_char;
    }
    sname = bfd_get_unique_section_name(abfd, tname, count);
    if sname.is_null()
        || {
    ...
    (*n).flags = (*s).flags;
    (*n).vma = (*s).vma;
    (*n).set_user_set_vma((*s).user_set_vma());
    (*n).lma = (*s).lma;
    (*n).size = 0 as libc::c_int as bfd_size_type;
    (*n).output_offset = (*s).output_offset;
    (*n).output_section = n;
    (*n).orelocation = 0 as *mut *mut reloc_cache_entry;
    (*n).reloc_count = 0 as libc::c_int as libc::c_uint;
    (*n).alignment_power = (*s).alignment_power;
    (Some(
        ((*(*abfd).xvec)._bfd_copy_private_section_data)
            .expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, s, abfd, n);
    return n;
}
unsafe extern "C" fn split_sections(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
    let mut original_sec: *mut asection = 0 as *mut asection;
    let mut nsecs: libc::c_int = (*abfd).section_count as libc::c_int;
    original_sec = (*abfd).sections;
    while !original_sec.is_null() && nsecs != 0 {
        let mut count: libc::c_int = 0 as libc::c_int;
        let mut lines: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        let mut relocs: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        let mut sec_size: bfd_size_type = 0 as libc::c_int as bfd_size_type;
        let mut l: *mut bfd_link_order = 0 as *mut bfd_link_order;
        let mut p: *mut bfd_link_order = 0 as *mut bfd_link_order;
        let mut vma: bfd_vma = (*original_sec).vma;
        let mut cursor: *mut asection = original_sec;
        l = 0 as *mut bfd_link_order;
        p = (*cursor).map_head.link_order;
        while !p.is_null() {
            let mut thislines: libc::c_uint = 0 as libc::c_int as libc::c_uint;
            let mut thisrelocs: libc::c_uint = 0 as libc::c_int as libc::c_uint;
            let mut thissize: bfd_size_type = 0 as libc::c_int as bfd_size_type;
            ...
            {
                thisrelocs = thisrelocs.wrapping_add(1);
                thisrelocs;
            }
            if !l.is_null()
                && (thisrelocs.wrapping_add(relocs) >= config.split_by_reloc
                    || thislines.wrapping_add(lines) >= config.split_by_reloc
                    || thissize.wrapping_add(sec_size) >= config.split_by_file)
                && !unsplittable_name((*cursor).name)
            {
                let mut shift_offset: bfd_vma = 0;
                let mut n: *mut asection = 0 as *mut asection;
                n = clone_section(abfd, cursor, (*original_sec).name, &mut count);
                (*n).map_head.link_order = p;
                (*n).map_tail.link_order = (*cursor).map_tail.link_order;
                (*cursor).map_tail.link_order = l;
                (*l).next = 0 as *mut bfd_link_order;
                l = p;
                shift_offset = (*p).offset;
                (*n).size = ((*cursor).size).wrapping_sub(shift_offset);
                (*cursor).size = shift_offset;
                vma = (vma as libc::c_ulong).wrapping_add(shift_offset) as bfd_vma
                    as bfd_vma;
                (*n).vma = vma;
                (*n).lma = (*n).vma;
                loop {
                    (*p)
                        .offset = ((*p).offset as libc::c_ulong)
                        .wrapping_sub(shift_offset) as bfd_vma as bfd_vma;
                    if (*p).type_0 as libc::c_uint
                        == bfd_indirect_link_order as libc::c_int as libc::c_uint
                    {
                ...
                l = p;
                relocs = relocs.wrapping_add(thisrelocs);
                lines = lines.wrapping_add(thislines);
                sec_size = (sec_size as libc::c_ulong).wrapping_add(thissize)
                    as bfd_size_type as bfd_size_type;
            }
            p = (*l).next;
        }
        original_sec = (*original_sec).next;
        nsecs -= 1;
        nsecs;
    }
}
