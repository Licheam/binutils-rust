extern "C" {
    ...
    static mut asneeded_list_tail: *mut *mut asneeded_minfo;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub union vfinfo_args {
    pub i: libc::c_int,
    pub l: libc::c_long,
    pub p: *mut libc::c_void,
    pub v: bfd_vma,
    pub reladdr: C2RustUnnamed_17,
    pub type_0: C2RustUnnamed_16,
}
pub type C2RustUnnamed_16 = libc::c_uint;
pub const RelAddr: C2RustUnnamed_16 = 5;
pub const Vma: C2RustUnnamed_16 = 4;
pub const Ptr: C2RustUnnamed_16 = 3;
pub const Long: C2RustUnnamed_16 = 2;
pub const Int: C2RustUnnamed_16 = 1;
pub const Bad: C2RustUnnamed_16 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub union etree_union {
    ...
    pub binary: C2RustUnnamed_25,
    pub trinary: C2RustUnnamed_24,
    pub assign: C2RustUnnamed_23,
    pub unary: C2RustUnnamed_22,
    pub name: C2RustUnnamed_21,
    pub value: C2RustUnnamed_20,
    pub rel: C2RustUnnamed_19,
    pub assert_s: C2RustUnnamed_18,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub unsafe extern "C" fn ld_abort(
    ...
    if !fn_0.is_null() {
        einfo(
            dcgettext(
                ...
                b"%P: internal error: aborting at %s:%d in %s\n\0" as *const u8
        ...
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: internal error: aborting at %s:%d\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            file,
...
#[no_mangle]
pub unsafe extern "C" fn vfinfo(
    mut fp: *mut FILE,
    mut fmt: *const libc::c_char,
    mut ap: ::core::ffi::VaList,
    mut is_warning: bool,
) {
    let mut fatal: bool = 0 as libc::c_int != 0;
    ...
    let mut args: [vfinfo_args; 9] = [vfinfo_args { i: 0 }; 9];
    arg_no = 0 as libc::c_int as libc::c_uint;
    while (arg_no as libc::c_ulong)
        < (::core::mem::size_of::<[vfinfo_args; 9]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<vfinfo_args>() as libc::c_ulong)
    {
        args[arg_no as usize].type_0 = Bad;
        arg_no = arg_no.wrapping_add(1);
        arg_no;
    }
    arg_count = 0 as libc::c_int as libc::c_uint;
    scan = fmt;
    while *scan as libc::c_int != '\0' as i32 {
        while *scan as libc::c_int != '%' as i32 && *scan as libc::c_int != '\0' as i32 {
            scan = scan.offset(1);
            scan;
        }
        if *scan as libc::c_int == '%' as i32 {
            ...
            if *scan as libc::c_int != '0' as i32
                && _sch_istable[(*scan as libc::c_int & 0xff as libc::c_int) as usize]
                    as libc::c_int
                    & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
                && *scan.offset(1 as libc::c_int as isize) as libc::c_int == '$' as i32
            {
                arg_no = (*scan as libc::c_int - '1' as i32) as libc::c_uint;
            ...
            match *fresh0 as libc::c_int {
                ...
                86 | 118 | 87 => {
                    arg_type = Vma as libc::c_int;
                }
                115 => {
                    arg_type = Ptr as libc::c_int;
                }
                112 => {
                    if *scan as libc::c_int == 'A' as i32
                        || *scan as libc::c_int == 'B' as i32
                        || *scan as libc::c_int == 'I' as i32
                        || *scan as libc::c_int == 'R' as i32
                        || *scan as libc::c_int == 'S' as i32
                        || *scan as libc::c_int == 'T' as i32
                    {
                        scan = scan.offset(1);
                        scan;
                    }
                ...
                67 | 68 | 71 | 72 => {
                    arg_type = RelAddr as libc::c_int;
                }
                100 | 117 => {
                    arg_type = Int as libc::c_int;
                }
                108 => {
                    if *scan as libc::c_int == 'd' as i32
                        || *scan as libc::c_int == 'u' as i32
                    {
                        scan = scan.offset(1);
                        scan;
            ...
            if arg_type != Bad as libc::c_int {
                if arg_no as libc::c_ulong
                    >= (::core::mem::size_of::<[vfinfo_args; 9]>() as libc::c_ulong)
                        .wrapping_div(
                            ::core::mem::size_of::<vfinfo_args>() as libc::c_ulong,
                        )
                {
                    ld_abort(
                        b"ldmisc.c\0" as *const u8 as *const libc::c_char,
                        169 as libc::c_int,
                        (*::core::mem::transmute::<
                            &[u8; 65],
                            &[libc::c_char; 65],
                        >(
                            b"void vfinfo(FILE *, const char *, struct __va_list_tag *, _Bool)\0",
                        ))
                            .as_ptr(),
                    );
                }
                args[arg_no as usize].type_0 = arg_type as C2RustUnnamed_16;
    ...
    while arg_no < arg_count {
        match args[arg_no as usize].type_0 as libc::c_uint {
            1 => {
                args[arg_no as usize].i = ap.arg::<libc::c_int>();
            }
            2 => {
                args[arg_no as usize].l = ap.arg::<libc::c_long>();
            }
            3 => {
                args[arg_no as usize].p = ap.arg::<*mut libc::c_void>();
            }
            4 => {
                args[arg_no as usize].v = ap.arg::<bfd_vma>();
            }
            5 => {
                args[arg_no as usize].reladdr.abfd = ap.arg::<*mut bfd>();
                args[arg_no as usize].reladdr.sec = ap.arg::<*mut asection>();
                args[arg_no as usize].reladdr.off = ap.arg::<bfd_vma>();
            }
            _ => {
                ld_abort(
                    b"ldmisc.c\0" as *const u8 as *const libc::c_char,
    ...
    while *fmt as libc::c_int != '\0' as i32 {
        let mut str: *const libc::c_char = fmt;
        while *fmt as libc::c_int != '%' as i32 && *fmt as libc::c_int != '\0' as i32 {
            fmt = fmt.offset(1);
            fmt;
        }
        if fmt != str {
        ...
        if *fmt as libc::c_int == '%' as i32 {
            ...
            if *fmt as libc::c_int != '0' as i32
                && _sch_istable[(*fmt as libc::c_int & 0xff as libc::c_int) as usize]
                    as libc::c_int
                    & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
                && *fmt.offset(1 as libc::c_int as isize) as libc::c_int == '$' as i32
            {
                arg_no = (*fmt as libc::c_int - '1' as i32) as libc::c_uint;
            ...
            match *fresh1 as libc::c_int {
                0 => {
                    fmt = fmt.offset(-1);
                    fmt;
                    current_block_204 = 11916866748368071042;
                }
                37 => {
                    current_block_204 = 11916866748368071042;
                }
                88 => {
                    ...
                    current_block_204 = 4888879662720751705;
                }
                86 => {
                    let mut value: bfd_vma = args[arg_no as usize].v;
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                    fprintf(fp, b"%016lx\0" as *const u8 as *const libc::c_char, value);
                    current_block_204 = 4888879662720751705;
                }
                118 => {
                    let mut buf: [libc::c_char; 100] = [0; 100];
                    let mut p: *mut libc::c_char = buf.as_mut_ptr();
                    let mut value_0: bfd_vma = args[arg_no as usize].v;
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                    sprintf(p, b"%016lx\0" as *const u8 as *const libc::c_char, value_0);
                ...
                87 => {
                    ...
                    let mut value_1: bfd_vma = 0;
                    let mut p_0: *mut libc::c_char = 0 as *mut libc::c_char;
                    let mut len: libc::c_int = 0;
                    value_1 = args[arg_no as usize].v;
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                    sprintf(
                        buf_0.as_mut_ptr(),
                    ...
                    len = strlen(p_0) as libc::c_int;
                    while len < 8 as libc::c_int {
                        putc(' ' as i32, fp);
                        len += 1;
                        len;
                    }
                    fprintf(fp, b"0x%s\0" as *const u8 as *const libc::c_char, p_0);
                    current_block_204 = 4888879662720751705;
                }
                70 => {
                    fatal = 1 as libc::c_int != 0;
                    current_block_204 = 4888879662720751705;
                }
                80 => {
                    fprintf(
                ...
                67 | 68 | 71 | 72 => {
                    static mut last_bfd: *mut bfd = 0 as *const bfd as *mut bfd;
                    static mut last_file: *mut libc::c_char = 0 as *const libc::c_char
                        as *mut libc::c_char;
                    static mut last_function: *mut libc::c_char = 0
                        as *const libc::c_char as *mut libc::c_char;
                    let mut abfd: *mut bfd = 0 as *mut bfd;
                    let mut section: *mut asection = 0 as *mut asection;
                    let mut offset: bfd_vma = 0;
                    let mut asymbols: *mut *mut asymbol = 0 as *mut *mut asymbol;
                    ...
                    let mut discard_last: bool = false;
                    let mut done: bool = false;
                    let mut last_bfd_error: bfd_error_type = bfd_get_error();
                    abfd = args[arg_no as usize].reladdr.abfd;
                    section = args[arg_no as usize].reladdr.sec;
                    offset = args[arg_no as usize].reladdr.off;
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                    if !abfd.is_null() {
                    ...
                    discard_last = 1 as libc::c_int != 0;
                    if !abfd.is_null()
                        && (Some(
                        ...
                        ) as libc::c_int != 0
                    {
                        if !functionname.is_null()
                            && (*fmt.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                == 'C' as i32
                                || *fmt.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                    == 'H' as i32)
                        {
                            if last_bfd.is_null() || last_function.is_null()
                                || last_bfd != abfd
                                || (last_file
                                    ...
                                    != (filename
                                        ...
                                        as libc::c_int
                                || !filename.is_null()
                                    && filename_cmp(last_file, filename) != 0 as libc::c_int
                                || strcmp(last_function, functionname) != 0 as libc::c_int
                            {
                                lfinfo(
                                    fp,
                                    dcgettext(
                                ...
                                last_bfd = abfd;
                                free(last_file as *mut libc::c_void);
                                last_file = 0 as *mut libc::c_char;
                                if !filename.is_null() {
                                    last_file = xstrdup(filename);
                                }
                                free(last_function as *mut libc::c_void);
                                last_function = xstrdup(functionname);
                            }
                            discard_last = 0 as libc::c_int != 0;
                        } else {
                            lfinfo(
                                fp,
                        ...
                        done = *fmt.offset(-(1 as libc::c_int) as isize) as libc::c_int
                            != 'H' as i32;
                        if !functionname.is_null()
                            && *fmt.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                == 'G' as i32
                        ...
                        lfinfo(fp, b"%pB:\0" as *const u8 as *const libc::c_char, abfd);
                        done = 0 as libc::c_int != 0;
                    }
                    if !done {
                        lfinfo(
                            fp,
                            b"(%pA+0x%v)\0" as *const u8 as *const libc::c_char,
                            section,
                            offset,
                        );
                    }
                    ...
                    if discard_last {
                        last_bfd = 0 as *mut bfd;
                        free(last_file as *mut libc::c_void);
                        last_file = 0 as *mut libc::c_char;
                        free(last_function as *mut libc::c_void);
                        last_function = 0 as *mut libc::c_char;
                    }
                    current_block_204 = 4888879662720751705;
                }
                112 => {
                    if *fmt as libc::c_int == 'A' as i32 {
                        let mut sec: *mut asection = 0 as *mut asection;
                        let mut abfd_0: *mut bfd = 0 as *mut bfd;
                        fmt = fmt.offset(1);
                        fmt;
                        sec = args[arg_no as usize].p as *mut asection;
                        arg_count = arg_count.wrapping_add(1);
                        arg_count;
                        fprintf(
                            fp,
                        ...
                        abfd_0 = (*sec).owner;
                        if !abfd_0.is_null() {
                            let mut group: *const libc::c_char = (Some(
                                ((*(*abfd_0).xvec)._bfd_group_name)
                                    .expect("non-null function pointer"),
                            ))
                                .expect("non-null function pointer")(abfd_0, sec);
                            if !group.is_null() {
                                fprintf(
                                    fp,
                                    b"[%s]\0" as *const u8 as *const libc::c_char,
                    ...
                    } else if *fmt as libc::c_int == 'B' as i32 {
                        let mut abfd_1: *mut bfd = args[arg_no as usize].p as *mut bfd;
                        fmt = fmt.offset(1);
                        fmt;
                        arg_count = arg_count.wrapping_add(1);
                        arg_count;
                        if abfd_1.is_null() {
                            fprintf(
                                fp,
                                b"%s generated\0" as *const u8 as *const libc::c_char,
                                program_name,
                            );
                        } else if !((*abfd_1).my_archive).is_null()
                            && !bfd_is_thin_archive((*abfd_1).my_archive)
                        {
                            fprintf(
                                fp,
                                b"%s(%s)\0" as *const u8 as *const libc::c_char,
                                bfd_get_filename((*abfd_1).my_archive),
                                bfd_get_filename(abfd_1),
                            );
                        } else {
                            fprintf(
                                fp,
                    ...
                    } else if *fmt as libc::c_int == 'I' as i32 {
                        let mut i: *mut lang_input_statement_type = 0
                            as *mut lang_input_statement_type;
                        fmt = fmt.offset(1);
                        fmt;
                        i = args[arg_no as usize].p as *mut lang_input_statement_type;
                        arg_count = arg_count.wrapping_add(1);
                        arg_count;
                        if !((*i).the_bfd).is_null()
                            && !((*(*i).the_bfd).my_archive).is_null()
                    ...
                    } else if *fmt as libc::c_int == 'R' as i32 {
                        let mut relent: *mut arelent = args[arg_no as usize].p
                            as *mut arelent;
                        fmt = fmt.offset(1);
                        fmt;
                        arg_count = arg_count.wrapping_add(1);
                        ...
                        lfinfo(
                            fp,
                            b"%s+0x%v (type %s)\0" as *const u8 as *const libc::c_char,
                            (**(*relent).sym_ptr_ptr).name,
                            (*relent).addend,
                            (*(*relent).howto).name,
                        );
                    } else if *fmt as libc::c_int == 'S' as i32
                        || *fmt as libc::c_int == 'U' as i32
                    {
                        let mut node: etree_type = etree_union {
                            type_0: node_type {
                                node_code: 0,
                                lineno: 0,
                                filename: 0 as *const libc::c_char,
                                node_class: etree_binary,
                            },
                        };
                        let mut tp: *mut etree_type = args[arg_no as usize].p
                            as *mut etree_type;
                        fmt = fmt.offset(1);
                        fmt;
                        arg_count = arg_count.wrapping_add(1);
                        ...
                        if tp.is_null() {
                            tp = &mut node;
                            (*tp).type_0.filename = ldlex_filename();
                            (*tp).type_0.lineno = lineno;
                        }
                        if !((*tp).type_0.filename).is_null()
                            && *fmt.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                == 'S' as i32
                        {
                            fprintf(
                        ...
                        } else if !((*tp).type_0.filename).is_null()
                            && *fmt.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                == 'U' as i32
                        {
                            fprintf(
                    ...
                    } else if *fmt as libc::c_int == 'T' as i32 {
                        let mut name: *const libc::c_char = args[arg_no as usize].p
                            as *const libc::c_char;
                        fmt = fmt.offset(1);
                        fmt;
                        arg_count = arg_count.wrapping_add(1);
                        ...
                        if name.is_null() || *name as libc::c_int == 0 as libc::c_int {
                            fprintf(
                                ...
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"no symbol\0" as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                            );
                        } else {
                            if demangling {
                                let mut demangled: *mut libc::c_char = 0
                                    as *mut libc::c_char;
                                ...
                                if !demangled.is_null() {
                                    ...
                                    current_block_204 = 12024807525273687499;
                                }
                            } else {
                                current_block_204 = 12024807525273687499;
                            }
                ...
                115 => {
                    fprintf(
                        fp,
                        b"%s\0" as *const u8 as *const libc::c_char,
                        args[arg_no as usize].p as *mut libc::c_char,
                    );
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                    current_block_204 = 4888879662720751705;
                ...
                108 => {
                    if *fmt as libc::c_int == 'd' as i32 {
                        fprintf(
                            fp,
                            b"%ld\0" as *const u8 as *const libc::c_char,
                            args[arg_no as usize].l,
                        );
                        arg_count = arg_count.wrapping_add(1);
                        arg_count;
                        fmt = fmt.offset(1);
                        fmt;
                        current_block_204 = 4888879662720751705;
                    } else if *fmt as libc::c_int == 'u' as i32 {
                        fprintf(
                            fp,
                        ...
                        current_block_204 = 2611605198902710976;
                    }
                }
                _ => {
                    current_block_204 = 2611605198902710976;
    ...
    if is_warning as libc::c_int != 0 && config.fatal_warnings as libc::c_int != 0 {
        config.make_executable = 0 as libc::c_int != 0;
    }
    if fatal {
        xexit(1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn einfo(mut fmt: *const libc::c_char, mut args: ...) {
    let mut arg: ::core::ffi::VaListImpl;
    fflush(stdout);
    arg = args.clone();
    vfinfo(stderr, fmt, arg.as_va_list(), 1 as libc::c_int != 0);
    fflush(stderr);
}
#[no_mangle]
pub unsafe extern "C" fn minfo(mut fmt: *const libc::c_char, mut args: ...) {
    if !(config.map_file).is_null() {
        let mut arg: ::core::ffi::VaListImpl;
        arg = args.clone();
        if *fmt.offset(0 as libc::c_int as isize) as libc::c_int == '%' as i32
            && *fmt.offset(1 as libc::c_int as isize) as libc::c_int == '!' as i32
            && *fmt.offset(2 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
        {
            let mut m: *mut asneeded_minfo = xmalloc(
                ::core::mem::size_of::<asneeded_minfo>() as libc::c_ulong,
            ) as *mut asneeded_minfo;
            (*m).next = 0 as *mut asneeded_minfo;
            (*m).soname = arg.arg::<*const libc::c_char>();
            (*m).ref_0 = arg.arg::<*mut bfd>();
            (*m).name = arg.arg::<*const libc::c_char>();
            *asneeded_list_tail = m;
            asneeded_list_tail = &mut (*m).next;
        } else {
            vfinfo(config.map_file, fmt, arg.as_va_list(), 0 as libc::c_int != 0);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn info_msg(mut fmt: *const libc::c_char, mut args: ...) {
    let mut arg: ::core::ffi::VaListImpl;
    arg = args.clone();
    vfinfo(stdout, fmt, arg.as_va_list(), 0 as libc::c_int != 0);
}
#[no_mangle]
pub unsafe extern "C" fn lfinfo(
    mut file: *mut FILE,
    mut fmt: *const libc::c_char,
    mut args: ...
) {
    let mut arg: ::core::ffi::VaListImpl;
    arg = args.clone();
    vfinfo(file, fmt, arg.as_va_list(), 0 as libc::c_int != 0);
}
#[no_mangle]
pub unsafe extern "C" fn info_assert(
    mut file: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn print_nl() {
    fprintf(config.map_file, b"\n\0" as *const u8 as *const libc::c_char);
}
