...
unsafe extern "C" fn gldelf_iamcu_before_parse() {
    ldfile_set_output_arch(
        b"iamcu\0" as *const u8 as *const libc::c_char,
        bfd_arch_iamcu,
    );
...
unsafe extern "C" fn gldelf_iamcu_after_open() {
    ldelf_after_open(
        0 as libc::c_int,
        0 as libc::c_int,
        1 as libc::c_int,
...
unsafe extern "C" fn gldelf_iamcu_before_allocation() {
    ldelf_before_allocation(audit, depaudit, 0 as *const libc::c_char);
}
unsafe extern "C" fn gldelf_iamcu_after_allocation() {
...
unsafe extern "C" fn gldelf_iamcu_get_script(
    ...
    *isfile = 1 as libc::c_int;
    ...
    {
        return b"ldscripts/elf_iamcu.xu\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int {
        return b"ldscripts/elf_iamcu.xr\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if !config.text_read_only {
        return b"ldscripts/elf_iamcu.xbn\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else if !config.magic_demand_paged {
        return b"ldscripts/elf_iamcu.xn\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
        ...
        && link_info.flags & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_ulong
            != 0
    {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xdwe\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xdw\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    } else if link_info.type_0() as libc::c_int == type_pie as libc::c_int
        && link_info.combreloc() as libc::c_int != 0
    {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xdce\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xdc\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    } else if link_info.type_0() as libc::c_int == type_pie as libc::c_int {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xde\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xd\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    ...
    {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xswe\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xsw\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    } else if link_info.type_0() as libc::c_int == type_dll as libc::c_int
        && link_info.combreloc() as libc::c_int != 0
    {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xsce\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xsc\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    } else if link_info.type_0() as libc::c_int == type_dll as libc::c_int {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xse\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xs\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    ...
    {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xwe\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xw\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    } else if link_info.combreloc() != 0 {
        if link_info.separate_code() != 0 {
            return b"ldscripts/elf_iamcu.xce\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        } else {
            return b"ldscripts/elf_iamcu.xc\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char
        }
    } else if link_info.separate_code() != 0 {
        return b"ldscripts/elf_iamcu.xe\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    } else {
        return b"ldscripts/elf_iamcu.x\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char
    };
}
unsafe extern "C" fn gldelf_iamcu_add_options(
    mut ns: libc::c_int,
...
unsafe extern "C" fn gldelf_iamcu_handle_option(mut optc: libc::c_int) -> bool {
    match optc {
        407 => {
...
unsafe extern "C" fn gldelf_iamcu_list_options(mut file: *mut FILE) {
    fprintf(
        file,
        dcgettext(
            0 as *const libc::c_char,
...
#[no_mangle]
pub static mut ld_elf_iamcu_emulation: ld_emulation_xfer_struct = unsafe {
    {
        let mut init = ld_emulation_xfer_struct {
            ...
            after_open: Some(gldelf_iamcu_after_open as unsafe extern "C" fn() -> ()),
            ...
            after_allocation: Some(
                gldelf_iamcu_after_allocation as unsafe extern "C" fn() -> (),
            ),
            ...
            before_allocation: Some(
                gldelf_iamcu_before_allocation as unsafe extern "C" fn() -> (),
            ),
            get_script: Some(
                gldelf_iamcu_get_script
                    as unsafe extern "C" fn(*mut libc::c_int) -> *mut libc::c_char,
            ),
            emulation_name: b"elf_iamcu\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            target_name: b"elf32-iamcu\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            ...
            handle_option: Some(
                gldelf_iamcu_handle_option as unsafe extern "C" fn(libc::c_int) -> bool,
            ),
            unrecognized_file: None,
            list_options: Some(
                gldelf_iamcu_list_options as unsafe extern "C" fn(*mut FILE) -> (),
            ),
