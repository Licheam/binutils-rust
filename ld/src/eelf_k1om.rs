...
unsafe extern "C" fn gldelf_k1om_before_parse() {
    ldfile_set_output_arch(b"k1om\0" as *const u8 as *const libc::c_char, bfd_arch_k1om);
...
unsafe extern "C" fn gldelf_k1om_after_open() {
    ldelf_after_open(
        1 as libc::c_int,
        1 as libc::c_int,
        1 as libc::c_int,
...
unsafe extern "C" fn gldelf_k1om_before_allocation() {
    ldelf_before_allocation(audit, depaudit, 0 as *const libc::c_char);
}
unsafe extern "C" fn gldelf_k1om_after_allocation() {
...
unsafe extern "C" fn gldelf_k1om_get_script(
...
unsafe extern "C" fn gldelf_k1om_add_options(
    mut ns: libc::c_int,
...
unsafe extern "C" fn gldelf_k1om_handle_option(mut optc: libc::c_int) -> bool {
    match optc {
        407 => {
...
unsafe extern "C" fn gldelf_k1om_list_options(mut file: *mut FILE) {
    fprintf(
        file,
        dcgettext(
            0 as *const libc::c_char,
...
#[no_mangle]
pub static mut ld_elf_k1om_emulation: ld_emulation_xfer_struct = unsafe {
    {
        let mut init = ld_emulation_xfer_struct {
            ...
            after_open: Some(gldelf_k1om_after_open as unsafe extern "C" fn() -> ()),
            ...
            after_allocation: Some(
                gldelf_k1om_after_allocation as unsafe extern "C" fn() -> (),
            ),
            ...
            before_allocation: Some(
                gldelf_k1om_before_allocation as unsafe extern "C" fn() -> (),
            ),
            get_script: Some(
                gldelf_k1om_get_script
                    as unsafe extern "C" fn(*mut libc::c_int) -> *mut libc::c_char,
            ),
            emulation_name: b"elf_k1om\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            target_name: b"elf64-k1om\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
            ...
            handle_option: Some(
                gldelf_k1om_handle_option as unsafe extern "C" fn(libc::c_int) -> bool,
            ),
            unrecognized_file: None,
            list_options: Some(
                gldelf_k1om_list_options as unsafe extern "C" fn(*mut FILE) -> (),
            ),
