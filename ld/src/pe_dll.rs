extern "C" {
    ...
    fn bfd_create(filename: *const libc::c_char, templ: *mut bfd) -> *mut bfd;
    ...
    fn ldexp_is_final_sym_absolute(_: *const bfd_link_hash_entry) -> bool;
    fn lang_reset_memory_regions();
    fn lang_do_assignments(_: lang_phase_type);
    fn ldlang_add_file(_: *mut lang_input_statement_type);
    fn lang_add_input_file(
        _: *const libc::c_char,
        _: lang_input_file_enum_type,
        _: *const libc::c_char,
    ) -> *mut lang_input_statement_type;
    fn lang_size_sections(_: *mut bool, _: bool);
    fn lang_add_gc_name(_: *const libc::c_char);
    fn einfo(_: *const libc::c_char, _: ...);
    fn info_msg(_: *const libc::c_char, _: ...);
    static mut verbose: bool;
    static mut link_info: bfd_link_info;
    fn track_dependency_files(_: *const libc::c_char);
    fn ldemul_after_allocation();
    fn def_file_empty() -> *mut def_file;
    fn def_file_add_export(
        _: *mut def_file,
        _: *const libc::c_char,
        _: *const libc::c_char,
        _: libc::c_int,
    ...
    fn def_file_add_import_from(
        fdef: *mut def_file,
        num_imports: libc::c_int,
        name: *const libc::c_char,
        module: *const libc::c_char,
        ordinal: libc::c_int,
        internal_name: *const libc::c_char,
        its_name: *const libc::c_char,
    ) -> libc::c_int;
    fn def_file_add_import_at(
        _: *mut def_file,
        _: libc::c_int,
        _: *const libc::c_char,
        _: *const libc::c_char,
    ...
    fn def_file_add_directive(_: *mut def_file, _: *const libc::c_char, _: libc::c_int);
    fn def_get_module(_: *mut def_file, _: *const libc::c_char) -> *mut def_file_module;
}
...
pub union etree_union {
    ...
    pub binary: C2RustUnnamed_42,
    pub trinary: C2RustUnnamed_41,
    pub assign: C2RustUnnamed_40,
    pub unary: C2RustUnnamed_39,
    pub name: C2RustUnnamed_38,
    pub value: C2RustUnnamed_37,
    pub rel: C2RustUnnamed_36,
    pub assert_s: C2RustUnnamed_35,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct pe_details_type {
    pub target_name: *const libc::c_char,
    pub object_target: *const libc::c_char,
    pub imagebase_reloc: libc::c_uint,
    pub pe_arch: libc::c_int,
    pub bfd_arch: libc::c_int,
    pub underscored: bool,
    pub autofilter_symbollist: *const autofilter_entry_type,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct autofilter_entry_type {
    pub name: *const libc::c_char,
    pub len: libc::c_int,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct exclude_list_struct {
    pub string: *mut libc::c_char,
    pub next: *mut exclude_list_struct,
...
pub struct key_value {
    ...
    pub oname: *const libc::c_char,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct reloc_data_type {
    pub vma: bfd_vma,
    pub type_0: libc::c_char,
    pub extra: libc::c_short,
    pub idx: libc::c_int,
}
#[inline]
...
#[no_mangle]
pub static mut pe_def_file: *mut def_file = 0 as *const def_file as *mut def_file;
#[no_mangle]
pub static mut pe_dll_export_everything: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_exclude_all_symbols: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_do_default_excludes: libc::c_int = 1 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_kill_ats: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_stdcall_aliases: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_warn_dup_exports: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_compat_implib: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_dll_extra_pe_debug: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_use_nul_prefixed_import_tables: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut pe_use_coff_long_section_names: libc::c_int = -(1 as libc::c_int);
#[no_mangle]
pub static mut pe_leading_underscore: libc::c_int = -(1 as libc::c_int);
#[no_mangle]
pub static mut pe_dll_enable_reloc_section: libc::c_int = 1 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn pe_dll_id_target(mut target: *const libc::c_char) {
    let mut i: libc::c_int = 0;
    i = 0 as libc::c_int;
    while !(pe_detail_list[i as usize].target_name).is_null() {
        if strcmp(pe_detail_list[i as usize].target_name, target) == 0 as libc::c_int
            || strcmp(pe_detail_list[i as usize].object_target, target)
                == 0 as libc::c_int
        {
            let mut u: libc::c_int = pe_leading_underscore;
            ...
            if u == -(1 as libc::c_int) {
                ld_abort(
                    b"pe-dll.c\0" as *const u8 as *const libc::c_char,
                    441 as libc::c_int,
                    (*::core::mem::transmute::<
                        &[u8; 36],
                        &[libc::c_char; 36],
                    >(b"void pe_dll_id_target(const char *)\0"))
                        .as_ptr(),
                );
            }
            pe_detail_list[i as usize].underscored = u != 0 as libc::c_int;
            pe_details = pe_detail_list.as_mut_ptr().offset(i as isize);
            pe_leading_underscore = if u != 0 as libc::c_int {
                1 as libc::c_int
            } else {
                0 as libc::c_int
            };
    ...
    einfo(
        dcgettext(
            ...
            b"%X%P: unsupported PEI architecture: %s\n\0" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn pe_dll_add_excludes(
    mut new_excludes: *const libc::c_char,
    type_0: exclude_type,
) {
    let mut local_copy: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut exclude_string: *mut libc::c_char = 0 as *mut libc::c_char;
    local_copy = xstrdup(new_excludes);
    exclude_string = strtok(local_copy, b",:\0" as *const u8 as *const libc::c_char);
    while !exclude_string.is_null() {
        let mut new_exclude: *mut exclude_list_struct = 0 as *mut exclude_list_struct;
        new_exclude = xmalloc(
            ::core::mem::size_of::<exclude_list_struct>() as libc::c_ulong,
        ) as *mut exclude_list_struct;
        (*new_exclude)
            .string = xmalloc(
            (strlen(exclude_string)).wrapping_add(1 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        strcpy((*new_exclude).string, exclude_string);
        (*new_exclude).type_0 = type_0;
        (*new_exclude).next = excludes;
        excludes = new_exclude;
        exclude_string = strtok(
            0 as *mut libc::c_char,
            b",:\0" as *const u8 as *const libc::c_char,
        );
    }
    free(local_copy as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn pe_dll_generate_def_file(
    mut pe_out_def_filename: *const libc::c_char,
) {
    let mut i: libc::c_int = 0;
    ...
    if out.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: can't open output def file %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            pe_out_def_filename,
    ...
    if !pe_def_file.is_null() {
        if !((*pe_def_file).name).is_null() {
            if (*pe_def_file).is_dll != 0 {
                fprintf(out, b"LIBRARY \0" as *const u8 as *const libc::c_char);
            } else {
                fprintf(out, b"NAME \0" as *const u8 as *const libc::c_char);
            }
            quoteput((*pe_def_file).name, out, 1 as libc::c_int);
            if (*(*link_info.output_bfd).tdata.pe_obj_data).pe_opthdr.ImageBase != 0 {
                fprintf(out, b" BASE=0x\0" as *const u8 as *const libc::c_char);
                fprintf(
                    out,
                    b"%016lx\0" as *const u8 as *const libc::c_char,
                    (*(*link_info.output_bfd).tdata.pe_obj_data).pe_opthdr.ImageBase,
                );
            }
            fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
        }
        if !((*pe_def_file).description).is_null() {
            fprintf(out, b"DESCRIPTION \0" as *const u8 as *const libc::c_char);
            quoteput((*pe_def_file).description, out, 1 as libc::c_int);
            fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
        }
        if (*pe_def_file).version_minor != -(1 as libc::c_int) {
            fprintf(
                out,
                b"VERSION %d.%d\n\0" as *const u8 as *const libc::c_char,
        ...
        } else if (*pe_def_file).version_major != -(1 as libc::c_int) {
            fprintf(
                out,
                b"VERSION %d\n\0" as *const u8 as *const libc::c_char,
                (*pe_def_file).version_major,
        ...
        if (*pe_def_file).stack_reserve != -(1 as libc::c_int)
            || (*pe_def_file).heap_reserve != -(1 as libc::c_int)
        {
            fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
        }
        if (*pe_def_file).stack_commit != -(1 as libc::c_int) {
            fprintf(
                out,
                b"STACKSIZE 0x%x,0x%x\n\0" as *const u8 as *const libc::c_char,
                (*pe_def_file).stack_reserve,
                (*pe_def_file).stack_commit,
            );
        } else if (*pe_def_file).stack_reserve != -(1 as libc::c_int) {
            fprintf(
                out,
                b"STACKSIZE 0x%x\n\0" as *const u8 as *const libc::c_char,
                (*pe_def_file).stack_reserve,
        ...
        if (*pe_def_file).heap_commit != -(1 as libc::c_int) {
            fprintf(
                out,
                b"HEAPSIZE 0x%x,0x%x\n\0" as *const u8 as *const libc::c_char,
                (*pe_def_file).heap_reserve,
                (*pe_def_file).heap_commit,
            );
        } else if (*pe_def_file).heap_reserve != -(1 as libc::c_int) {
            fprintf(
                out,
                b"HEAPSIZE 0x%x\n\0" as *const u8 as *const libc::c_char,
                (*pe_def_file).heap_reserve,
        ...
        if (*pe_def_file).num_section_defs > 0 as libc::c_int {
            fprintf(out, b"\nSECTIONS\n\n\0" as *const u8 as *const libc::c_char);
            i = 0 as libc::c_int;
            while i < (*pe_def_file).num_section_defs {
                fprintf(out, b"    \0" as *const u8 as *const libc::c_char);
                quoteput(
                    (*((*pe_def_file).section_defs).offset(i as isize)).name,
                    out,
                    0 as libc::c_int,
                );
                if !((*((*pe_def_file).section_defs).offset(i as isize)).class).is_null()
                {
                    fprintf(out, b" CLASS \0" as *const u8 as *const libc::c_char);
                    quoteput(
                        (*((*pe_def_file).section_defs).offset(i as isize)).class,
                        out,
                        0 as libc::c_int,
                    );
                }
                if (*((*pe_def_file).section_defs).offset(i as isize)).flag_read != 0 {
                    fprintf(out, b" READ\0" as *const u8 as *const libc::c_char);
                }
                if (*((*pe_def_file).section_defs).offset(i as isize)).flag_write != 0 {
                    fprintf(out, b" WRITE\0" as *const u8 as *const libc::c_char);
                }
                if (*((*pe_def_file).section_defs).offset(i as isize)).flag_execute != 0
                {
                    fprintf(out, b" EXECUTE\0" as *const u8 as *const libc::c_char);
                }
                if (*((*pe_def_file).section_defs).offset(i as isize)).flag_shared != 0 {
                    fprintf(out, b" SHARED\0" as *const u8 as *const libc::c_char);
                }
                fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
                i += 1;
                i;
        ...
        if (*pe_def_file).num_exports > 0 as libc::c_int {
            fprintf(out, b"EXPORTS\n\0" as *const u8 as *const libc::c_char);
            i = 0 as libc::c_int;
            while i < (*pe_def_file).num_exports {
                let mut e: *mut def_file_export = ((*pe_def_file).exports)
                    .offset(i as isize);
                fprintf(out, b"    \0" as *const u8 as *const libc::c_char);
                quoteput((*e).name, out, 0 as libc::c_int);
                if !((*e).internal_name).is_null()
                    && strcmp((*e).internal_name, (*e).name) != 0
                {
                    fprintf(out, b" = \0" as *const u8 as *const libc::c_char);
                    quoteput((*e).internal_name, out, 0 as libc::c_int);
                }
                if (*e).ordinal != -(1 as libc::c_int) {
                    fprintf(
                        out,
                ...
                if (*e).flag_private != 0 {
                    fprintf(out, b" PRIVATE\0" as *const u8 as *const libc::c_char);
                }
                if (*e).flag_constant != 0 {
                    fprintf(out, b" CONSTANT\0" as *const u8 as *const libc::c_char);
                }
                if (*e).flag_noname != 0 {
                    fprintf(out, b" NONAME\0" as *const u8 as *const libc::c_char);
                }
                if (*e).flag_data != 0 {
                    fprintf(out, b" DATA\0" as *const u8 as *const libc::c_char);
                }
                fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
                i += 1;
                i;
        ...
        if (*pe_def_file).num_imports > 0 as libc::c_int {
            fprintf(out, b"\nIMPORTS\n\n\0" as *const u8 as *const libc::c_char);
            i = 0 as libc::c_int;
            while i < (*pe_def_file).num_imports {
                let mut im: *mut def_file_import = ((*pe_def_file).imports)
                    .offset(i as isize);
                fprintf(out, b"    \0" as *const u8 as *const libc::c_char);
                if !((*im).internal_name).is_null()
                    && (((*im).name).is_null()
                        || strcmp((*im).internal_name, (*im).name) != 0)
                {
                    quoteput((*im).internal_name, out, 0 as libc::c_int);
                    fprintf(out, b" = \0" as *const u8 as *const libc::c_char);
                }
                quoteput(((*(*im).module).name).as_mut_ptr(), out, 0 as libc::c_int);
                fprintf(out, b".\0" as *const u8 as *const libc::c_char);
                if !((*im).name).is_null() {
                    quoteput((*im).name, out, 0 as libc::c_int);
                } else {
                    fprintf(
                        out,
                        b"%d\0" as *const u8 as *const libc::c_char,
                ...
                if !((*im).its_name).is_null() {
                    fprintf(out, b" == \0" as *const u8 as *const libc::c_char);
                    quoteput((*im).its_name, out, 0 as libc::c_int);
                }
                fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
                i += 1;
                i;
        ...
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"; no contents available\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    }
    if fclose(out) == -(1 as libc::c_int) {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: error closing file `%s'\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            pe_out_def_filename,
        );
...
#[no_mangle]
pub unsafe extern "C" fn pe_dll_generate_implib(
    mut def: *mut def_file,
    mut impfilename: *const libc::c_char,
    mut info: *mut bfd_link_info,
) {
    let mut i: libc::c_int = 0;
    let mut ar_head: *mut bfd = 0 as *mut bfd;
    let mut ar_tail: *mut bfd = 0 as *mut bfd;
    let mut outarch: *mut bfd = 0 as *mut bfd;
    let mut ibfd: *mut bfd = 0 as *mut bfd;
    let mut head: *mut bfd = 0 as *mut bfd;
    dll_filename = if !((*def).name).is_null() {
        (*def).name as *const libc::c_char
    } else {
        dll_name
    };
    dll_symname = xstrdup(dll_filename);
    i = 0 as libc::c_int;
    while *dll_symname.offset(i as isize) != 0 {
        if _sch_istable[(*dll_symname.offset(i as isize) as libc::c_int
            & 0xff as libc::c_int) as usize] as libc::c_int
            & _sch_isalnum as libc::c_int as libc::c_ushort as libc::c_int == 0
        {
            *dll_symname.offset(i as isize) = '_' as i32 as libc::c_char;
        }
        i += 1;
        i;
    }
    unlink_if_ordinary(impfilename);
    outarch = bfd_openw(impfilename, 0 as *const libc::c_char);
    if outarch.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: can't open .lib file: %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            impfilename,
    ...
    (*outarch).set_has_armap(1 as libc::c_int as libc::c_uint);
    ar_head = make_head(outarch);
    ibfd = (*info).input_bfds;
    while !ibfd.is_null() {
        let mut ex: *mut exclude_list_struct = 0 as *mut exclude_list_struct;
        let mut found: libc::c_char = 0;
        ex = excludes;
        found = 0 as libc::c_int as libc::c_char;
        while !ex.is_null() && found == 0 {
            if !((*ex).type_0 as libc::c_uint
                != EXCLUDEFORIMPLIB as libc::c_int as libc::c_uint)
            {
                found = (filename_cmp((*ex).string, bfd_get_filename(ibfd))
                    == 0 as libc::c_int) as libc::c_int as libc::c_char;
            }
            ex = (*ex).next;
        }
        if found != 0 {
            let mut newbfd: *mut bfd = bfd_openr(
                if !((*ibfd).my_archive).is_null() {
            ...
            if !((*ibfd).my_archive).is_null() {
                ...
                if !bfd_check_format_matches(
                    ...
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: %s(%s): can't find member in non-archive file\0"
                ...
                newbfd = 0 as *mut bfd;
                loop {
                    newbfd = bfd_openr_next_archived_file(arbfd, newbfd);
                    if newbfd.is_null() {
                        break;
                    }
                    if filename_cmp(bfd_get_filename(newbfd), bfd_get_filename(ibfd))
                        == 0 as libc::c_int
                    {
                        break;
                    }
                ...
                if newbfd.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: %s(%s): can't find member in archive\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        bfd_get_filename((*ibfd).my_archive),
    ...
    i = 0 as libc::c_int;
    while i < (*def).num_exports {
        let mut internal: *mut libc::c_char = (*((*def).exports).offset(i as isize))
            .internal_name;
        let mut n: *mut bfd = 0 as *mut bfd;
        if !((*((*pe_def_file).exports).offset(i as isize)).flag_private != 0) {
            let ref mut fresh0 = (*((*def).exports).offset(i as isize)).internal_name;
            *fresh0 = (*((*def).exports).offset(i as isize)).name;
            let mut h: *mut coff_link_hash_entry = 0 as *mut coff_link_hash_entry;
            ...
            if !(!h.is_null() && (*h).symbol_class as libc::c_int == 106 as libc::c_int
                        ...
                        .offset(1 as libc::c_int as isize) as *mut asection)
            {
                if (*pe_details).underscored as libc::c_int != 0
                    && *internal.offset(0 as libc::c_int as isize) as libc::c_int
                        != '@' as i32
                {
                    ...
                    if !h.is_null()
                        && (*h).symbol_class as libc::c_int == 106 as libc::c_int
                        && (*h).root.u.def.section
                            == &mut *_bfd_std_section
                                .as_mut_ptr()
                                .offset(1 as libc::c_int as isize) as *mut asection
                    {
                        current_block_53 = 6450597802325118133;
                    } else {
                        current_block_53 = 7990025728955927862;
                    }
                } else {
                    current_block_53 = 7990025728955927862;
                }
                match current_block_53 {
                    ...
                    _ => {
                        n = make_one(
                            ((*def).exports).offset(i as isize),
                            outarch,
                            (*((*def).exports).offset(i as isize)).flag_data == 0,
                        );
                        (*n).archive_next = head;
                        head = n;
                        let ref mut fresh1 = (*((*def).exports).offset(i as isize))
                            .internal_name;
                        *fresh1 = internal;
                    }
                }
    ...
    if ar_head.is_null() || ar_tail.is_null() {
        return;
    }
    ...
    if !bfd_set_archive_head(outarch, head) {
        einfo(b"%X%P: bfd_set_archive_head: %E\n\0" as *const u8 as *const libc::c_char);
    }
    ...
    while !head.is_null() {
        let mut n_0: *mut bfd = (*head).archive_next;
        bfd_close(head);
        head = n_0;
    }
}
#[no_mangle]
pub unsafe extern "C" fn pe_process_import_defs(
    mut output_bfd: *mut bfd,
    mut linfo: *mut bfd_link_info,
) {
    let mut i: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    let mut module: *mut def_file_module = 0 as *mut def_file_module;
    let mut imp: *mut def_file_import = 0 as *mut def_file_import;
    ...
    module = (*pe_def_file).modules;
    while !module.is_null() {
        let mut do_this_dll: libc::c_int = 0 as libc::c_int;
        i = 0 as libc::c_int;
        while i < (*pe_def_file).num_imports
            && (*imp.offset(i as isize)).module != module
        {
            i += 1;
            i;
        }
        if !(i >= (*pe_def_file).num_imports) {
            dll_filename = ((*module).name).as_mut_ptr();
            dll_symname = xstrdup(((*module).name).as_mut_ptr());
            j = 0 as libc::c_int;
            while *dll_symname.offset(j as isize) != 0 {
                if _sch_istable[(*dll_symname.offset(j as isize) as libc::c_int
                    & 0xff as libc::c_int) as usize] as libc::c_int
                    & _sch_isalnum as libc::c_int as libc::c_ushort as libc::c_int == 0
                {
                    *dll_symname.offset(j as isize) = '_' as i32 as libc::c_char;
                }
                j += 1;
                j;
            }
            while i < (*pe_def_file).num_imports
                && (*imp.offset(i as isize)).module == module
            {
                let mut exp: def_file_export = def_file_export {
                    name: 0 as *mut libc::c_char,
                    internal_name: 0 as *mut libc::c_char,
                    its_name: 0 as *mut libc::c_char,
                    ordinal: 0,
                    hint: 0,
                    flag_private: 0,
                    flag_constant: 0,
                ...
                let mut blhe: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
                let mut lead_at: libc::c_int = (*(*imp.offset(i as isize)).internal_name
                    as libc::c_int == '@' as i32) as libc::c_int;
                let mut len: size_t = strlen((*imp.offset(i as isize)).internal_name);
                let mut name: *mut libc::c_char = xmalloc(
                    len
                        .wrapping_add(2 as libc::c_int as libc::c_ulong)
                        .wrapping_add(6 as libc::c_int as libc::c_ulong),
                ) as *mut libc::c_char;
                let mut include_jmp_stub: bool = 0 as libc::c_int != 0;
                let mut is_cdecl: bool = 0 as libc::c_int != 0;
                let mut is_undef: bool = 0 as libc::c_int != 0;
                if lead_at == 0
                    && (strchr((*imp.offset(i as isize)).internal_name, '@' as i32))
                        .is_null()
                {
                    is_cdecl = 1 as libc::c_int != 0;
                }
                if lead_at != 0 {
                    sprintf(
                        name,
                        b"%s\0" as *const u8 as *const libc::c_char,
                        (*imp.offset(i as isize)).internal_name,
                    );
                } else {
                    sprintf(
                        name,
                            ...
                            != bfd_link_hash_undefined as libc::c_int
                {
                    if lead_at != 0 {
                        sprintf(
                            name,
                            b"%s%s\0" as *const u8 as *const libc::c_char,
                            b"__imp_\0" as *const u8 as *const libc::c_char,
                            (*imp.offset(i as isize)).internal_name,
                        );
                    } else {
                        sprintf(
                    ...
                    if !blhe.is_null() {
                        is_undef = (*blhe).type_0() as libc::c_int
                            == bfd_link_hash_undefined as libc::c_int;
                    }
                } else {
                    include_jmp_stub = 1 as libc::c_int != 0;
                    is_undef = (*blhe).type_0() as libc::c_int
                        == bfd_link_hash_undefined as libc::c_int;
                }
                if is_cdecl as libc::c_int != 0
                    && (blhe.is_null()
                        || !blhe.is_null()
                            && (*blhe).type_0() as libc::c_int
                                != bfd_link_hash_undefined as libc::c_int)
                ...
                free(name as *mut libc::c_void);
                if is_undef {
                    let mut one: *mut bfd = 0 as *mut bfd;
                    if do_this_dll == 0 {
                        let mut ar_head: *mut bfd = make_head(output_bfd);
                        add_bfd_to_link(ar_head, bfd_get_filename(ar_head), linfo);
                        do_this_dll = 1 as libc::c_int;
                    }
                    exp.internal_name = (*imp.offset(i as isize)).internal_name;
                    exp.name = (*imp.offset(i as isize)).name;
                    exp.its_name = (*imp.offset(i as isize)).its_name;
                    exp.ordinal = (*imp.offset(i as isize)).ordinal;
                    exp
                        .hint = if exp.ordinal >= 0 as libc::c_int {
                        exp.ordinal
                    } else {
                        0 as libc::c_int
                    };
                    exp.flag_private = 0 as libc::c_int as libc::c_char;
                    exp.flag_constant = 0 as libc::c_int as libc::c_char;
                    exp.flag_data = (*imp.offset(i as isize)).data as libc::c_char;
                    exp
                        .flag_noname = (if !(exp.name).is_null() {
                        0 as libc::c_int
                    } else {
                        1 as libc::c_int
                    }) as libc::c_char;
                    one = make_one(
                        &mut exp,
                        output_bfd,
                        exp.flag_data == 0 && include_jmp_stub as libc::c_int != 0,
                    );
            ...
            if do_this_dll != 0 {
                let mut ar_tail: *mut bfd = make_tail(output_bfd);
                add_bfd_to_link(ar_tail, bfd_get_filename(ar_tail), linfo);
            }
            free(dll_symname as *mut libc::c_void);
        }
        module = (*module).next;
    }
    while undef_count != 0 {
        undef_count -= 1;
        undef_count;
        free((*udef_table.offset(undef_count as isize)).key as *mut libc::c_void);
    }
    free(udef_table as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn pe_implied_import_dll(
    mut filename: *const libc::c_char,
) -> bool {
    let mut dll: *mut bfd = 0 as *mut bfd;
    let mut pe_header_offset: bfd_vma = 0;
    let mut opthdr_ofs: bfd_vma = 0;
    let mut num_entries: bfd_vma = 0;
    let mut i: bfd_vma = 0;
    let mut export_rva: bfd_vma = 0;
    let mut export_size: bfd_vma = 0;
    let mut nsections: bfd_vma = 0;
    let mut secptr: bfd_vma = 0;
    let mut expptr: bfd_vma = 0;
    let mut exp_funcbase: bfd_vma = 0;
    let mut expdata: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut erva: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut name_rvas: bfd_vma = 0;
    let mut nexp: bfd_vma = 0;
    let mut dllname: *const libc::c_char = 0 as *const libc::c_char;
    let mut data_start: bfd_vma = 1 as libc::c_int as bfd_vma;
    let mut data_end: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut rdata_start: bfd_vma = 1 as libc::c_int as bfd_vma;
    let mut rdata_end: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut bss_start: bfd_vma = 1 as libc::c_int as bfd_vma;
    let mut bss_end: bfd_vma = 0 as libc::c_int as bfd_vma;
    ...
    if !bfd_check_format(dll, bfd_object) {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: %s: this doesn't appear to be a DLL\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            filename,
    ...
    pe_header_offset = pe_get32(dll, 0x3c as libc::c_int) as bfd_vma;
    opthdr_ofs = pe_header_offset
        .wrapping_add(4 as libc::c_int as libc::c_ulong)
        .wrapping_add(20 as libc::c_int as libc::c_ulong);
    num_entries = pe_get32(
        dll,
        opthdr_ofs.wrapping_add(92 as libc::c_int as libc::c_ulong) as libc::c_int,
    ) as bfd_vma;
    if num_entries < 1 as libc::c_int as libc::c_ulong {
        return 0 as libc::c_int != 0;
    }
    export_rva = pe_get32(
        dll,
        opthdr_ofs.wrapping_add(96 as libc::c_int as libc::c_ulong) as libc::c_int,
    ) as bfd_vma;
    export_size = pe_get32(
        dll,
        opthdr_ofs.wrapping_add(100 as libc::c_int as libc::c_ulong) as libc::c_int,
    ) as bfd_vma;
    if export_size == 0 as libc::c_int as libc::c_ulong {
        return 0 as libc::c_int != 0;
    }
    nsections = pe_get16(
        dll,
    ...
    expptr = 0 as libc::c_int as bfd_vma;
    i = 0 as libc::c_int as bfd_vma;
    while i < nsections {
        let mut sname: [libc::c_char; 8] = [0; 8];
        let mut secptr1: bfd_vma = secptr
            .wrapping_add((40 as libc::c_int as libc::c_ulong).wrapping_mul(i));
        let mut vaddr: bfd_vma = pe_get32(
            dll,
            secptr1.wrapping_add(12 as libc::c_int as libc::c_ulong) as libc::c_int,
        ) as bfd_vma;
        let mut vsize: bfd_vma = pe_get32(
            dll,
            secptr1.wrapping_add(16 as libc::c_int as libc::c_ulong) as libc::c_int,
        ) as bfd_vma;
        let mut fptr: bfd_vma = pe_get32(
            dll,
            secptr1.wrapping_add(20 as libc::c_int as libc::c_ulong) as libc::c_int,
        ) as bfd_vma;
        bfd_seek(dll, secptr1 as file_ptr, 0 as libc::c_int);
        bfd_bread(
            sname.as_mut_ptr() as *mut libc::c_void,
            8 as libc::c_int as bfd_size_type,
            dll,
        );
        if vaddr <= export_rva && vaddr.wrapping_add(vsize) > export_rva {
            expptr = fptr.wrapping_add(export_rva.wrapping_sub(vaddr));
            if export_rva.wrapping_add(export_size) > vaddr.wrapping_add(vsize) {
                export_size = vsize.wrapping_sub(export_rva.wrapping_sub(vaddr));
            }
            break;
        } else {
            i = i.wrapping_add(1);
    ...
    i = 0 as libc::c_int as bfd_vma;
    while i < nsections {
        let mut secptr1_0: bfd_vma = secptr
            .wrapping_add((40 as libc::c_int as libc::c_ulong).wrapping_mul(i));
        let mut vsize_0: bfd_vma = pe_get32(
            dll,
            secptr1_0.wrapping_add(8 as libc::c_int as libc::c_ulong) as libc::c_int,
        ) as bfd_vma;
        let mut vaddr_0: bfd_vma = pe_get32(
            dll,
            secptr1_0.wrapping_add(12 as libc::c_int as libc::c_ulong) as libc::c_int,
        ) as bfd_vma;
        let mut flags: bfd_vma = pe_get32(
            dll,
            secptr1_0.wrapping_add(36 as libc::c_int as libc::c_ulong) as libc::c_int,
        ) as bfd_vma;
        let mut sec_name: [libc::c_char; 9] = [0; 9];
        sec_name[8 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
        bfd_seek(
            dll,
            secptr1_0 as file_ptr + 0 as libc::c_int as libc::c_long,
            0 as libc::c_int,
        );
        bfd_bread(
            sec_name.as_mut_ptr() as *mut libc::c_void,
            8 as libc::c_int as bfd_size_type,
            dll,
        );
        if strcmp(sec_name.as_mut_ptr(), b".data\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        {
            data_start = vaddr_0;
            data_end = vaddr_0.wrapping_add(vsize_0);
            if pe_dll_extra_pe_debug != 0 {
                printf(
                    b"%s %s: 0x%08lx-0x%08lx (0x%08lx)\n\0" as *const u8
                        as *const libc::c_char,
                    (*::core::mem::transmute::<
                        &[u8; 22],
                        &[libc::c_char; 22],
                    >(b"pe_implied_import_dll\0"))
                        .as_ptr(),
                    sec_name.as_mut_ptr(),
                    vaddr_0,
                    vaddr_0.wrapping_add(vsize_0),
                    flags,
                );
            }
        } else if strcmp(
        ...
        {
            rdata_start = vaddr_0;
            rdata_end = vaddr_0.wrapping_add(vsize_0);
            if pe_dll_extra_pe_debug != 0 {
                printf(
                    b"%s %s: 0x%08lx-0x%08lx (0x%08lx)\n\0" as *const u8
                        as *const libc::c_char,
        ...
        {
            bss_start = vaddr_0;
            bss_end = vaddr_0.wrapping_add(vsize_0);
            if pe_dll_extra_pe_debug != 0 {
                printf(
                    b"%s %s: 0x%08lx-0x%08lx (0x%08lx)\n\0" as *const u8
                        as *const libc::c_char,
    ...
    expdata = xmalloc(export_size) as *mut libc::c_uchar;
    bfd_seek(dll, expptr as file_ptr, 0 as libc::c_int);
    bfd_bread(expdata as *mut libc::c_void, export_size, dll);
    erva = (expdata as *mut libc::c_char).offset(-(export_rva as isize));
    if pe_def_file.is_null() {
        pe_def_file = def_file_empty();
    }
    nexp = pe_as32(expdata.offset(24 as libc::c_int as isize) as *mut libc::c_void)
        as bfd_vma;
    name_rvas = pe_as32(expdata.offset(32 as libc::c_int as isize) as *mut libc::c_void)
        as bfd_vma;
    exp_funcbase = pe_as32(
        expdata.offset(28 as libc::c_int as isize) as *mut libc::c_void,
    ) as bfd_vma;
    dllname = erva
        .offset(
            pe_as32(expdata.offset(12 as libc::c_int as isize) as *mut libc::c_void)
                as isize,
        );
    if !(def_get_module(pe_def_file, dllname)).is_null() {
        if pe_dll_extra_pe_debug != 0 {
            printf(
    ...
    from = def_file_add_import_from(
        pe_def_file,
        nexp as libc::c_int,
        erva
            .offset(
                pe_as32(erva.offset(name_rvas as isize) as *mut libc::c_void) as isize,
            ),
        dllname,
        0 as libc::c_int,
        0 as *const libc::c_char,
    ...
    if from >= 0 as libc::c_int {
        i = 0 as libc::c_int as bfd_vma;
        while i < nexp {
            let mut name_rva: bfd_vma = pe_as32(
                erva
                    .offset(name_rvas as isize)
                    .offset(i.wrapping_mul(4 as libc::c_int as libc::c_ulong) as isize)
                    as *mut libc::c_void,
            ) as bfd_vma;
            let mut imp: *mut def_file_import = 0 as *mut def_file_import;
            let mut func_rva: bfd_vma = pe_as32(
                erva
                    .offset(exp_funcbase as isize)
                    .offset(i.wrapping_mul(4 as libc::c_int as libc::c_ulong) as isize)
                    as *mut libc::c_void,
            ) as bfd_vma;
            let is_data: libc::c_int = (func_rva >= data_start && func_rva < data_end
                || func_rva >= rdata_start && func_rva < rdata_end
                || func_rva >= bss_start && func_rva < bss_end) as libc::c_int;
            imp = def_file_add_import_at(
                pe_def_file,
                (from as libc::c_ulong).wrapping_add(i) as libc::c_int,
                erva.offset(name_rva as isize),
                dllname,
                i as libc::c_int,
                0 as *const libc::c_char,
                0 as *const libc::c_char,
            ...
            if pe_dll_extra_pe_debug != 0 {
                printf(
                    b"%s dll-name: %s sym: %s addr: 0x%lx %s\n\0" as *const u8
                        as *const libc::c_char,
                    (*::core::mem::transmute::<
                        &[u8; 22],
                        &[libc::c_char; 22],
    ...
    i = 0 as libc::c_int as bfd_vma;
    while i < nexp {
        let mut name_rva_0: bfd_vma = pe_as32(
            erva
                .offset(name_rvas as isize)
                .offset(i.wrapping_mul(4 as libc::c_int as libc::c_ulong) as isize)
                as *mut libc::c_void,
        ) as bfd_vma;
        let mut imp_0: *mut def_file_import = 0 as *mut def_file_import;
        let mut func_rva_0: bfd_vma = pe_as32(
            erva
                .offset(exp_funcbase as isize)
                .offset(i.wrapping_mul(4 as libc::c_int as libc::c_ulong) as isize)
                as *mut libc::c_void,
        ) as bfd_vma;
        let mut is_data_0: libc::c_int = 0 as libc::c_int;
        if !startswith(
            erva.offset(name_rva_0 as isize),
            b"__nm_\0" as *const u8 as *const libc::c_char,
        ) {
            let mut is_dup: libc::c_int = 0 as libc::c_int;
            is_data_0 = (func_rva_0 >= data_start && func_rva_0 < data_end
                || func_rva_0 >= rdata_start && func_rva_0 < rdata_end
                || func_rva_0 >= bss_start && func_rva_0 < bss_end) as libc::c_int;
            imp_0 = def_file_add_import(
                pe_def_file,
                erva.offset(name_rva_0 as isize),
                dllname,
                i as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn pe_dll_build_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    ...
    {
        if pe_dll_enable_reloc_section != 0 {
            build_filler_bfd(0 as libc::c_int);
            pe_output_file_set_long_section_names(filler_bfd);
        }
        return;
    }
    generate_edata(abfd, info);
    build_filler_bfd(1 as libc::c_int);
    pe_output_file_set_long_section_names(filler_bfd);
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn pe_dll_fill_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    ...
    if (*info).type_0() as libc::c_int == type_dll as libc::c_int {
        (*(*abfd).tdata.pe_obj_data).dll = 1 as libc::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn pe_exe_fill_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    pe_dll_id_target(bfd_get_target(abfd));
    pe_output_file_set_long_section_names(abfd);
    image_base = (*(*abfd).tdata.pe_obj_data).pe_opthdr.ImageBase;
    generate_reloc(abfd, info);
    if reloc_sz > 0 as libc::c_int as libc::c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn pe_find_data_imports(
    mut symhead: *const libc::c_char,
    mut cb: Option::<
        unsafe extern "C" fn(
            *mut arelent,
            *mut asection,
    ...
    if namelen == 0 as libc::c_int as libc::c_ulong {
        return;
    }
    if link_info.pei386_runtime_pseudo_reloc == 2 as libc::c_int {
        import_hash = xmalloc(::core::mem::size_of::<bfd_hash_table>() as libc::c_ulong)
            as *mut bfd_hash_table;
        if !bfd_hash_table_init(
            ...
            ::core::mem::size_of::<bfd_hash_entry>() as libc::c_ulong as libc::c_uint,
        ) {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%F%P: bfd_hash_table_init failed: %E\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        ...
        import_hash = 0 as *mut bfd_hash_table;
    }
    buf = xmalloc(
    ...
    name = buf.offset(32 as libc::c_int as isize);
    let mut current_block_46: u64;
    undef = (*link_info.hash).undefs;
    while !undef.is_null() {
        if (*undef).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int {
            let mut sym: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
            let mut impname: *mut libc::c_char = 0 as *mut libc::c_char;
            if pe_dll_extra_pe_debug != 0 {
                printf(
                    b"%s:%s\n\0" as *const u8 as *const libc::c_char,
                    (*::core::mem::transmute::<
            ...
            memcpy(
                impname as *mut libc::c_void,
                b"__imp_\0" as *const u8 as *const libc::c_char as *const libc::c_void,
                (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
            ...
            if !sym.is_null()
                && (*sym).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
            {
                if !import_hash.is_null() {
                    bfd_hash_lookup(
                        import_hash,
                        (*undef).root.string,
                        1 as libc::c_int != 0,
                    ...
                    current_block_46 = 4090602189656566074;
                } else {
                    let mut b: *mut bfd = (*(*sym).u.def.section).owner;
                    ...
                    nsyms = bfd_get_symcount(b) as libc::c_int;
                    i = 0 as libc::c_int;
                    while i < nsyms {
                        if strncmp((**symbols.offset(i as isize)).name, symhead, headlen)
                            == 0 as libc::c_int
                        {
                            if pe_dll_extra_pe_debug != 0 {
                                printf(
                                    b"->%s\n\0" as *const u8 as *const libc::c_char,
                                    (**symbols.offset(i as isize)).name,
                                );
                            }
                            symname = ((**symbols.offset(i as isize)).name)
                                .offset(headlen as isize);
                            break;
                        } else {
                            i += 1;
                            i;
                    ...
                    if !symname.is_null() {
                        pe_walk_relocs(
                            ...
                            name,
                            symname,
                            0 as *mut bfd_hash_table,
                            cb,
                        );
                        current_block_46 = 4090602189656566074;
                    } else {
                        current_block_46 = 1054647088692577877;
                    }
                }
                match current_block_46 {
                    1054647088692577877 => {}
                    _ => {
                        (*undef).set_type_0(bfd_link_hash_defweak);
                        (*undef).u.def.value = (*sym).u.def.value;
                        (*undef).u.def.section = (*sym).u.def.section;
                        (*undef).root.string = (*sym).root.string;
                        if link_info.pei386_auto_import == -(1 as libc::c_int) {
                            static mut warned: bool = 0 as libc::c_int != 0;
                            info_msg(
                                dcgettext(
                                    0 as *const libc::c_char,
                                    b"Info: resolving %s by linking to %s (auto-import)\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                name,
                            ...
                            if !warned {
                                einfo(
                                    dcgettext(
                                        0 as *const libc::c_char,
                                        b"%P: warning: auto-importing has been activated without --enable-auto-import specified on the command line; this should work unless it involves constant data structures referencing symbols from auto-imported DLLs\n\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                );
    ...
    if !import_hash.is_null() {
        pe_walk_relocs(&mut link_info, name, 0 as *const libc::c_char, import_hash, cb);
        bfd_hash_table_free(import_hash);
        free(import_hash as *mut libc::c_void);
    }
    free(buf as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn pe_create_import_fixup(
    mut rel: *mut arelent,
    mut s: *mut asection,
    mut addend: bfd_vma,
    ...
    let mut fixup_name: *const libc::c_char = make_import_fixup_mark(rel, name);
    let mut b: *mut bfd = 0 as *mut bfd;
    if link_info.pei386_runtime_pseudo_reloc != 2 as libc::c_int {
        let mut name_thunk_sym: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
        let mut thname: *mut libc::c_char = name
            .offset(
                -((::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize),
            );
        memcpy(
            thname as *mut libc::c_void,
            b"__nm_thnk_\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong),
        );
        name_thunk_sym = bfd_link_hash_lookup(
            link_info.hash,
            thname,
            0 as libc::c_int != 0,
            0 as libc::c_int != 0,
        ...
        if !(!name_thunk_sym.is_null()
            && (*name_thunk_sym).type_0() as libc::c_int
                == bfd_link_hash_defined as libc::c_int)
        {
            b = make_singleton_name_thunk(name, link_info.output_bfd);
            add_bfd_to_link(b, bfd_get_filename(b), &mut link_info);
            config.text_read_only = 0 as libc::c_int != 0;
            (*link_info.output_bfd).flags &= !(0x80 as libc::c_int) as libc::c_uint;
        }
        if addend == 0 as libc::c_int as libc::c_ulong
            || link_info.pei386_runtime_pseudo_reloc == 1 as libc::c_int
        {
            b = make_import_fixup_entry(name, fixup_name, symname, link_info.output_bfd);
            add_bfd_to_link(b, bfd_get_filename(b), &mut link_info);
        }
    }
    if addend != 0 as libc::c_int as libc::c_ulong
        ...
        || link_info.pei386_runtime_pseudo_reloc == 2 as libc::c_int
    {
        if pe_dll_extra_pe_debug != 0 {
            printf(
                b"creating runtime pseudo-reloc entry for %s (addend=%d)\n\0"
                    as *const u8 as *const libc::c_char,
                fixup_name,
                addend as libc::c_int,
            );
        }
        b = make_runtime_pseudo_reloc(
            name,
            fixup_name,
            addend,
            (*(*rel).howto).bitsize() as bfd_vma,
            link_info.output_bfd,
        );
        add_bfd_to_link(b, bfd_get_filename(b), &mut link_info);
        let fresh2 = runtime_pseudo_relocs_created;
        runtime_pseudo_relocs_created = runtime_pseudo_relocs_created + 1;
        if fresh2 == 0 as libc::c_int {
            b = pe_create_runtime_relocator_reference(link_info.output_bfd);
            add_bfd_to_link(b, bfd_get_filename(b), &mut link_info);
        }
    } else if addend != 0 as libc::c_int as libc::c_ulong {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: %C: variable '%pT' can't be auto-imported; please read the documentation for ld's --enable-auto-import for details\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*s).owner,
...
#[no_mangle]
pub unsafe extern "C" fn pe_bfd_is_dll(mut abfd: *mut bfd) -> bool {
    return bfd_get_format(abfd) as libc::c_uint
        == bfd_object as libc::c_int as libc::c_uint
        && (*(*abfd).tdata.coff_obj_data).pe != 0
        && (*(*abfd).tdata.pe_obj_data).dll != 0;
}
#[no_mangle]
pub unsafe extern "C" fn pe_output_file_set_long_section_names(mut abfd: *mut bfd) {
    if pe_use_coff_long_section_names < 0 as libc::c_int {
        return;
    }
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_set_long_section_names)
        .expect("non-null function pointer")(abfd, pe_use_coff_long_section_names)
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: error: can't use long section names on this arch\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
unsafe extern "C" fn add_bfd_to_link(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut linfo: *mut bfd_link_info,
) {
    let mut fake_file: *mut lang_input_statement_type = 0
        as *mut lang_input_statement_type;
    fake_file = lang_add_input_file(
        name,
    ...
    if !(Some(
        ((*(*abfd).xvec)._bfd_link_add_symbols).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, linfo)
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: add symbols %s: %E\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
        );
...
static mut image_base: bfd_vma = 0;
static mut filler_bfd: *mut bfd = 0 as *const bfd as *mut bfd;
static mut edata_s: *mut bfd_section = 0 as *const bfd_section as *mut bfd_section;
static mut reloc_s: *mut bfd_section = 0 as *const bfd_section as *mut bfd_section;
static mut edata_d: *mut libc::c_uchar = 0 as *const libc::c_uchar as *mut libc::c_uchar;
static mut reloc_d: *mut libc::c_uchar = 0 as *const libc::c_uchar as *mut libc::c_uchar;
static mut edata_sz: size_t = 0;
static mut reloc_sz: size_t = 0;
static mut runtime_pseudo_relocs_created: libc::c_int = 0 as libc::c_int;
static mut runtime_pseudp_reloc_v2_init: bool = 0 as libc::c_int != 0;
static mut autofilter_symbollist_generic: [autofilter_entry_type; 7] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 7];
static mut autofilter_symbollist_i386: [autofilter_entry_type; 21] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 21];
static mut pe_detail_list: [pe_details_type; 7] = unsafe {
    [
        {
            let mut init = pe_details_type {
                target_name: b"pei-i386\0" as *const u8 as *const libc::c_char,
                object_target: b"pe-i386\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 7 as libc::c_int as libc::c_uint,
                pe_arch: 1 as libc::c_int,
                bfd_arch: bfd_arch_i386 as libc::c_int,
                underscored: 1 as libc::c_int != 0,
                autofilter_symbollist: autofilter_symbollist_i386.as_ptr(),
            };
            init
        },
        {
            let mut init = pe_details_type {
                target_name: b"pei-i386\0" as *const u8 as *const libc::c_char,
                object_target: b"pe-bigobj-i386\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 7 as libc::c_int as libc::c_uint,
                pe_arch: 1 as libc::c_int,
                bfd_arch: bfd_arch_i386 as libc::c_int,
                underscored: 1 as libc::c_int != 0,
        ...
        {
            let mut init = pe_details_type {
                target_name: b"pei-shl\0" as *const u8 as *const libc::c_char,
                object_target: b"pe-shl\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 16 as libc::c_int as libc::c_uint,
                pe_arch: 2 as libc::c_int,
                bfd_arch: bfd_arch_sh as libc::c_int,
                underscored: 1 as libc::c_int != 0,
                autofilter_symbollist: autofilter_symbollist_generic.as_ptr(),
            };
            init
        },
        {
            let mut init = pe_details_type {
                target_name: b"pei-mips\0" as *const u8 as *const libc::c_char,
                object_target: b"pe-mips\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 34 as libc::c_int as libc::c_uint,
                pe_arch: 3 as libc::c_int,
                bfd_arch: bfd_arch_mips as libc::c_int,
                underscored: 0 as libc::c_int != 0,
                autofilter_symbollist: autofilter_symbollist_generic.as_ptr(),
            };
            init
        },
        {
            let mut init = pe_details_type {
                target_name: b"pei-arm-little\0" as *const u8 as *const libc::c_char,
                object_target: b"pe-arm-little\0" as *const u8 as *const libc::c_char,
                imagebase_reloc: 11 as libc::c_int as libc::c_uint,
                pe_arch: 4 as libc::c_int,
                bfd_arch: bfd_arch_arm as libc::c_int,
                underscored: 1 as libc::c_int != 0,
                autofilter_symbollist: autofilter_symbollist_generic.as_ptr(),
            };
            init
        ...
        {
            let mut init = pe_details_type {
                target_name: b"pei-arm-wince-little\0" as *const u8
                    as *const libc::c_char,
                object_target: b"pe-arm-wince-little\0" as *const u8
                    as *const libc::c_char,
                imagebase_reloc: 2 as libc::c_int as libc::c_uint,
                pe_arch: 5 as libc::c_int,
                bfd_arch: bfd_arch_arm as libc::c_int,
                underscored: 0 as libc::c_int != 0,
                autofilter_symbollist: autofilter_symbollist_generic.as_ptr(),
            };
        ...
        },
        {
            let mut init = pe_details_type {
                ...
                object_target: 0 as *const libc::c_char,
                imagebase_reloc: 0 as libc::c_int as libc::c_uint,
                pe_arch: 0 as libc::c_int,
                bfd_arch: 0 as libc::c_int,
                underscored: 0 as libc::c_int != 0,
                autofilter_symbollist: 0 as *const autofilter_entry_type,
            };
            init
        },
    ]
};
static mut pe_details: *const pe_details_type = 0 as *const pe_details_type;
static mut autofilter_liblist: [autofilter_entry_type; 15] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 15];
unsafe extern "C" fn libnamencmp(
    mut libname: *const libc::c_char,
    mut afptr: *const autofilter_entry_type,
) -> libc::c_int {
    if filename_ncmp(libname, (*afptr).name, (*afptr).len as size_t) != 0 {
        return -(1 as libc::c_int);
    }
    libname = libname.offset((*afptr).len as isize);
    if *libname.offset(0 as libc::c_int as isize) as libc::c_int == '-' as i32 {
        libname = libname.offset(1);
        if _sch_istable[(*libname as libc::c_int & 0xff as libc::c_int) as usize]
        ...
        loop {
            libname = libname.offset(1);
            if !(*libname as libc::c_int != '.' as i32) {
                break;
            }
            if *libname == 0 {
                return -(1 as libc::c_int);
    ...
    } else if *libname.offset(0 as libc::c_int as isize) as libc::c_int != '.' as i32 {
        return -(1 as libc::c_int)
    }
    return 0 as libc::c_int;
}
static mut autofilter_objlist: [autofilter_entry_type; 11] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 11];
static mut autofilter_symbolprefixlist: [autofilter_entry_type; 7] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 7];
static mut autofilter_symbolsuffixlist: [autofilter_entry_type; 3] = [autofilter_entry_type {
    name: 0 as *const libc::c_char,
    len: 0,
}; 3];
unsafe extern "C" fn reloc_sort(
    mut va: *const libc::c_void,
    mut vb: *const libc::c_void,
) -> libc::c_int {
    let mut a: *const reloc_data_type = va as *const reloc_data_type;
    let mut b: *const reloc_data_type = vb as *const reloc_data_type;
    if (*a).vma > (*b).vma {
        return 1 as libc::c_int;
    }
    if (*a).vma < (*b).vma {
...
unsafe extern "C" fn pe_export_sort(
    mut va: *const libc::c_void,
    mut vb: *const libc::c_void,
) -> libc::c_int {
    let mut a: *const def_file_export = va as *const def_file_export;
    let mut b: *const def_file_export = vb as *const def_file_export;
    let mut an: *mut libc::c_char = (*a).name;
    let mut bn: *mut libc::c_char = (*b).name;
    if !((*a).its_name).is_null() {
        an = (*a).its_name;
    }
    if !((*b).its_name).is_null() {
        bn = (*b).its_name;
    }
    return strcmp(an, bn);
}
static mut exported_symbol_offsets: *mut bfd_vma = 0 as *const bfd_vma as *mut bfd_vma;
static mut exported_symbol_sections: *mut *mut bfd_section = 0 as *const *mut bfd_section
    as *mut *mut bfd_section;
static mut export_table_size: libc::c_int = 0;
static mut count_exported: libc::c_int = 0;
static mut count_exported_byname: libc::c_int = 0;
static mut count_with_ordinals: libc::c_int = 0;
static mut dll_name: *const libc::c_char = 0 as *const libc::c_char;
static mut min_ordinal: libc::c_int = 0;
static mut max_ordinal: libc::c_int = 0;
static mut exported_symbols: *mut libc::c_int = 0 as *const libc::c_int
    as *mut libc::c_int;
static mut excludes: *mut exclude_list_struct = 0 as *const exclude_list_struct
    as *mut exclude_list_struct;
unsafe extern "C" fn is_import(mut n: *const libc::c_char) -> bool {
    return startswith(n, b"__imp_\0" as *const u8 as *const libc::c_char);
}
unsafe extern "C" fn auto_export(
    mut abfd: *mut bfd,
    mut d: *mut def_file,
    mut n: *const libc::c_char,
) -> libc::c_int {
    let mut key: def_file_export = def_file_export {
        name: 0 as *mut libc::c_char,
        internal_name: 0 as *mut libc::c_char,
        its_name: 0 as *mut libc::c_char,
        ordinal: 0,
    ...
    let mut ex: *mut exclude_list_struct = 0 as *mut exclude_list_struct;
    let mut afptr: *const autofilter_entry_type = 0 as *const autofilter_entry_type;
    let mut libname: *const libc::c_char = 0 as *const libc::c_char;
    if !abfd.is_null() && !((*abfd).my_archive).is_null() {
        libname = lbasename(bfd_get_filename((*abfd).my_archive));
    }
    key.its_name = n as *mut libc::c_char;
    key.name = key.its_name;
    if (*d).num_exports != 0 as libc::c_int
        && !(bsearch(
            &mut key as *mut def_file_export as *const libc::c_void,
            (*d).exports as *const libc::c_void,
            (*d).num_exports as size_t,
    ...
    if pe_dll_do_default_excludes != 0 {
        let mut p: *const libc::c_char = 0 as *const libc::c_char;
        let mut len: libc::c_int = 0;
        if pe_dll_extra_pe_debug != 0 {
            printf(
                b"considering exporting: %s, abfd=%p, abfd->my_arc=%p\n\0" as *const u8
                    as *const libc::c_char,
                n,
                abfd,
                (*abfd).my_archive,
        ...
        if !libname.is_null() {
            afptr = autofilter_liblist.as_ptr();
            while !((*afptr).name).is_null() {
                if libnamencmp(libname, afptr) == 0 as libc::c_int {
                    return 0 as libc::c_int;
                }
                afptr = afptr.offset(1);
                afptr;
            }
        }
        if !abfd.is_null()
            && {
                p = lbasename(bfd_get_filename(abfd));
                !p.is_null()
            }
        {
            afptr = autofilter_objlist.as_ptr();
            while !((*afptr).name).is_null() {
                if strcmp(p, (*afptr).name) == 0 as libc::c_int {
                    return 0 as libc::c_int;
                }
                afptr = afptr.offset(1);
                afptr;
        ...
        while !((*afptr).name).is_null() {
            if strcmp(n, (*afptr).name) == 0 as libc::c_int {
                return 0 as libc::c_int;
            }
            afptr = afptr.offset(1);
            afptr;
        }
        afptr = autofilter_symbolprefixlist.as_ptr();
        while !((*afptr).name).is_null() {
            if strncmp(n, (*afptr).name, (*afptr).len as libc::c_ulong)
                == 0 as libc::c_int
            {
                return 0 as libc::c_int;
            }
        ...
        len = strlen(n) as libc::c_int;
        afptr = autofilter_symbolsuffixlist.as_ptr();
        while !((*afptr).name).is_null() {
            if len >= (*afptr).len
                && strncmp(
                    n.offset(len as isize).offset(-((*afptr).len as isize)),
                    (*afptr).name,
                    ((*afptr).len + 1 as libc::c_int) as libc::c_ulong,
                ) == 0 as libc::c_int
            {
                return 0 as libc::c_int;
            }
    ...
    ex = excludes;
    while !ex.is_null() {
        if (*ex).type_0 as libc::c_uint == EXCLUDELIBS as libc::c_int as libc::c_uint {
            if !libname.is_null()
                && (filename_cmp(libname, (*ex).string) == 0 as libc::c_int
                    || strcasecmp(
        ...
        } else if (*ex).type_0 as libc::c_uint
            == EXCLUDEFORIMPLIB as libc::c_int as libc::c_uint
        {
            if filename_cmp(bfd_get_filename(abfd), (*ex).string) == 0 as libc::c_int {
                return 0 as libc::c_int;
            }
        } else if strcmp(n, (*ex).string) == 0 as libc::c_int {
            return 0 as libc::c_int
        }
        ex = (*ex).next;
    }
...
unsafe extern "C" fn process_def_file_and_drectve(
    ...
    let mut blhe: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut b: *mut bfd = 0 as *mut bfd;
    let mut s: *mut bfd_section = 0 as *mut bfd_section;
    let mut e: *mut def_file_export = 0 as *mut def_file_export;
    let mut resort_needed: bool = false;
    if pe_def_file.is_null() {
        pe_def_file = def_file_empty();
    }
    b = (*info).input_bfds;
    while !b.is_null() {
        s = bfd_get_section_by_name(
            b,
            b".drectve\0" as *const u8 as *const libc::c_char,
        );
        if !s.is_null() {
            let mut size: libc::c_long = (*s).size as libc::c_long;
            let mut buf: *mut libc::c_char = xmalloc(size as size_t)
                as *mut libc::c_char;
            ...
            def_file_add_directive(pe_def_file, buf, size as libc::c_int);
            free(buf as *mut libc::c_void);
        }
        b = (*b).link.next;
    }
    if !((*pe_def_file).aligncomms).is_null() {
        let mut ac: *mut def_file_aligncomm = (*pe_def_file).aligncomms;
        while !ac.is_null() {
            let mut sym_hash: *mut coff_link_hash_entry = 0 as *mut coff_link_hash_entry;
            sym_hash = bfd_link_hash_lookup(
                &mut (*((*info).hash as *mut coff_link_hash_table)).root,
                (*ac).symbol_name,
                0 as libc::c_int != 0,
                0 as libc::c_int != 0,
            ...
            if !sym_hash.is_null()
                && ((*sym_hash).root).type_0() as libc::c_int
                    == bfd_link_hash_common as libc::c_int
                && (*(*sym_hash).root.u.c.p).alignment_power < (*ac).alignment
            {
                (*(*sym_hash).root.u.c.p).alignment_power = (*ac).alignment;
            }
            ac = (*ac).next;
    ...
    if ((*info).type_0() as libc::c_int == type_pde as libc::c_int
        || (*info).type_0() as libc::c_int == type_pie as libc::c_int)
        && (*pe_def_file).num_exports == 0 as libc::c_int
        && (pe_dll_export_everything == 0 || pe_dll_exclude_all_symbols != 0)
    {
        return;
    }
    if (pe_dll_export_everything != 0 || (*pe_def_file).num_exports == 0 as libc::c_int)
        && pe_dll_exclude_all_symbols == 0
    {
        b = (*info).input_bfds;
        while !b.is_null() {
            let mut symbols: *mut *mut asymbol = 0 as *mut *mut asymbol;
            ...
            j = 0 as libc::c_int;
            while j < nsyms {
                let mut would_export: bool = (**symbols.offset(j as isize)).section
                    != &mut *_bfd_std_section
                        .as_mut_ptr()
                        .offset(1 as libc::c_int as isize) as *mut asection
                    && ((**symbols.offset(j as isize)).flags
                        & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
                        || (**symbols.offset(j as isize)).flags
                            == 0 as libc::c_int as libc::c_uint);
                if !(link_info.version_info).is_null()
                    && would_export as libc::c_int != 0
                {
                    would_export = !bfd_hide_sym_by_version(
                        link_info.version_info,
                        (**symbols.offset(j as isize)).name,
                    );
                }
                if would_export {
                    let mut sn: *const libc::c_char = (**symbols.offset(j as isize))
                        .name;
                    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
                    if !is_import(sn) {
                        name = xmalloc(
                            (strlen(b"__imp_\0" as *const u8 as *const libc::c_char))
                                .wrapping_add(strlen(sn))
                                .wrapping_add(1 as libc::c_int as libc::c_ulong),
                        ) as *mut libc::c_char;
                        sprintf(
                            name,
                        ...
                        {
                            if (*pe_details).underscored as libc::c_int != 0
                                && *sn as libc::c_int == '_' as i32
                            {
                                sn = sn.offset(1);
                                sn;
                            }
                            if auto_export(b, pe_def_file, sn) != 0 {
                                let mut is_dup: libc::c_int = 0 as libc::c_int;
                                let mut p: *mut def_file_export = 0 as *mut def_file_export;
                                p = def_file_add_export(
                                    pe_def_file,
                                    sn,
                                    0 as *const libc::c_char,
                                    -(1 as libc::c_int),
                                ...
                                if is_dup == 0 {
                                    (*p)
                                        .flag_data = ((**symbols.offset(j as isize)).flags
    ...
    resort_needed = 0 as libc::c_int != 0;
    if pe_dll_kill_ats != 0 {
        i = 0 as libc::c_int;
        while i < (*pe_def_file).num_exports {
            if *((*((*pe_def_file).exports).offset(i as isize)).name)
                .offset(0 as libc::c_int as isize) as libc::c_int != '?' as i32
                && !(strchr(
                    (*((*pe_def_file).exports).offset(i as isize)).name,
                    '@' as i32,
                ))
                    .is_null()
            {
                let mut lead_at: libc::c_int = (*(*((*pe_def_file).exports)
                    .offset(i as isize))
                    .name as libc::c_int == '@' as i32) as libc::c_int;
                let mut tmp: *mut libc::c_char = xstrdup(
                    ((*((*pe_def_file).exports).offset(i as isize)).name)
                        .offset(lead_at as isize),
                );
                let mut tmp_at: *mut libc::c_char = strrchr(tmp, '@' as i32);
                if !tmp_at.is_null() {
                    *tmp_at = 0 as libc::c_int as libc::c_char;
                } else {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: cannot export %s: invalid export name\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*((*pe_def_file).exports).offset(i as isize)).name,
                ...
                let ref mut fresh3 = (*((*pe_def_file).exports).offset(i as isize)).name;
                *fresh3 = tmp;
                resort_needed = 1 as libc::c_int != 0;
            }
            i += 1;
            i;
        }
    ...
    if resort_needed {
        qsort(
            (*pe_def_file).exports as *mut libc::c_void,
            (*pe_def_file).num_exports as size_t,
            ::core::mem::size_of::<def_file_export>() as libc::c_ulong,
            Some(
                pe_export_sort
                    as unsafe extern "C" fn(
    ...
    if pe_dll_stdcall_aliases != 0 {
        i = 0 as libc::c_int;
        while i < (*pe_def_file).num_exports {
            if !is_import((*((*pe_def_file).exports).offset(i as isize)).name) {
                if !(strchr(
                    (*((*pe_def_file).exports).offset(i as isize)).name,
                    '@' as i32,
                ))
                    .is_null()
                {
                    let mut is_dup_0: libc::c_int = 1 as libc::c_int;
                    let mut lead_at_0: libc::c_int = (*(*((*pe_def_file).exports)
                        .offset(i as isize))
                        .name as libc::c_int == '@' as i32) as libc::c_int;
                    let mut tmp_0: *mut libc::c_char = xstrdup(
                        ((*((*pe_def_file).exports).offset(i as isize)).name)
                            .offset(lead_at_0 as isize),
                    );
                    *strchr(tmp_0, '@' as i32) = 0 as libc::c_int as libc::c_char;
                    if auto_export(0 as *mut bfd, pe_def_file, tmp_0) != 0 {
                        def_file_add_export(
                            pe_def_file,
                            tmp_0,
                            (*((*pe_def_file).exports).offset(i as isize)).internal_name,
                            -(1 as libc::c_int),
                            0 as *const libc::c_char,
                            &mut is_dup_0,
                        );
    ...
    while i < (*pe_def_file).num_exports {
        if i > 0 as libc::c_int
            && strcmp(
                (*e.offset(i as isize)).name,
                (*e.offset((i - 1 as libc::c_int) as isize)).name,
            ) == 0 as libc::c_int
        {
            if (*e.offset((j - 1 as libc::c_int) as isize)).ordinal
                != -(1 as libc::c_int)
                && (*e.offset(i as isize)).ordinal != -(1 as libc::c_int)
                && (*e.offset((j - 1 as libc::c_int) as isize)).ordinal
                    != (*e.offset(i as isize)).ordinal
            {
                if pe_dll_warn_dup_exports != 0 {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: error, duplicate EXPORT with ordinals: %s (%d vs %d)\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*e.offset((j - 1 as libc::c_int) as isize)).name,
                        (*e.offset((j - 1 as libc::c_int) as isize)).ordinal,
                        (*e.offset(i as isize)).ordinal,
                    );
                }
            } else if pe_dll_warn_dup_exports != 0 {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: warning, duplicate EXPORT: %s\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    (*e.offset((j - 1 as libc::c_int) as isize)).name,
            ...
            if (*e.offset(i as isize)).ordinal != -(1 as libc::c_int) {
                (*e.offset((j - 1 as libc::c_int) as isize))
                    .ordinal = (*e.offset(i as isize)).ordinal;
            }
            let ref mut fresh4 = (*e.offset((j - 1 as libc::c_int) as isize))
                .flag_private;
            *fresh4 = (*fresh4 as libc::c_int
                | (*e.offset(i as isize)).flag_private as libc::c_int) as libc::c_char;
            let ref mut fresh5 = (*e.offset((j - 1 as libc::c_int) as isize))
                .flag_constant;
            *fresh5 = (*fresh5 as libc::c_int
                | (*e.offset(i as isize)).flag_constant as libc::c_int) as libc::c_char;
            let ref mut fresh6 = (*e.offset((j - 1 as libc::c_int) as isize))
                .flag_noname;
            *fresh6 = (*fresh6 as libc::c_int
                | (*e.offset(i as isize)).flag_noname as libc::c_int) as libc::c_char;
            let ref mut fresh7 = (*e.offset((j - 1 as libc::c_int) as isize)).flag_data;
            *fresh7 = (*fresh7 as libc::c_int
                | (*e.offset(i as isize)).flag_data as libc::c_int) as libc::c_char;
            free((*e.offset(i as isize)).name as *mut libc::c_void);
            free((*e.offset(i as isize)).internal_name as *mut libc::c_void);
            free((*e.offset(i as isize)).its_name as *mut libc::c_void);
        } else {
            if i != j {
                *e.offset(j as isize) = *e.offset(i as isize);
            }
            j += 1;
            j;
        }
    ...
    exported_symbol_offsets = xmalloc(
        ((*pe_def_file).num_exports as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<bfd_vma>() as libc::c_ulong),
    ) as *mut bfd_vma;
    exported_symbol_sections = xmalloc(
        ((*pe_def_file).num_exports as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut bfd_section>() as libc::c_ulong),
    ) as *mut *mut bfd_section;
    memset(
        exported_symbol_sections as *mut libc::c_void,
        0 as libc::c_int,
        ((*pe_def_file).num_exports as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut bfd_section>() as libc::c_ulong),
    );
    max_ordinal = 0 as libc::c_int;
    min_ordinal = 65536 as libc::c_int;
    count_exported = 0 as libc::c_int;
    count_exported_byname = 0 as libc::c_int;
    count_with_ordinals = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < (*pe_def_file).num_exports {
        let mut int_name: *mut libc::c_char = (*((*pe_def_file).exports)
            .offset(i as isize))
            .internal_name;
        let mut name_0: *mut libc::c_char = 0 as *mut libc::c_char;
        lang_add_gc_name(int_name);
        name_0 = xmalloc(
            (strlen(int_name)).wrapping_add(2 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        if (*pe_details).underscored as libc::c_int != 0
            && *int_name.offset(0 as libc::c_int as isize) as libc::c_int != '@' as i32
        {
            *name_0 = '_' as i32 as libc::c_char;
            strcpy(name_0.offset(1 as libc::c_int as isize), int_name);
            lang_add_gc_name(xstrdup(name_0));
        } else {
            strcpy(name_0, int_name);
        }
        blhe = bfd_link_hash_lookup(
            (*info).hash,
            name_0,
        ...
        if !blhe.is_null()
            && ((*blhe).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
                || (*blhe).type_0() as libc::c_int
                    == bfd_link_hash_common as libc::c_int)
        {
            count_exported += 1;
            count_exported;
            if (*((*pe_def_file).exports).offset(i as isize)).flag_noname == 0 {
                count_exported_byname += 1;
                count_exported_byname;
            }
            if (*blhe).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int {
                let ref mut fresh8 = *exported_symbol_sections.offset(i as isize);
                *fresh8 = (*blhe).u.def.section;
            } else {
                let ref mut fresh9 = *exported_symbol_sections.offset(i as isize);
                *fresh9 = (*(*blhe).u.c.p).section;
            }
            if (*((*pe_def_file).exports).offset(i as isize)).ordinal
                != -(1 as libc::c_int)
            {
                if max_ordinal < (*((*pe_def_file).exports).offset(i as isize)).ordinal {
                    max_ordinal = (*((*pe_def_file).exports).offset(i as isize)).ordinal;
                }
                if min_ordinal > (*((*pe_def_file).exports).offset(i as isize)).ordinal {
                    min_ordinal = (*((*pe_def_file).exports).offset(i as isize)).ordinal;
                }
                count_with_ordinals += 1;
                count_with_ordinals;
            }
        } else if !(strchr(int_name, '.' as i32)).is_null() {
            count_exported += 1;
            count_exported;
            if (*((*pe_def_file).exports).offset(i as isize)).flag_noname == 0 {
                count_exported_byname += 1;
            ...
            (*((*pe_def_file).exports).offset(i as isize))
                .flag_forward = 1 as libc::c_int as libc::c_char;
            if (*((*pe_def_file).exports).offset(i as isize)).ordinal
                != -(1 as libc::c_int)
            {
                if max_ordinal < (*((*pe_def_file).exports).offset(i as isize)).ordinal {
        ...
        } else if !blhe.is_null()
            && (*blhe).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int
        {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: cannot export %s: symbol not defined\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                int_name,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: cannot export %s: symbol wrong type (%d vs %d)\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                int_name,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: cannot export %s: symbol not found\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                int_name,
...
unsafe extern "C" fn build_filler_bfd(mut include_edata: libc::c_int) {
    let mut filler_file: *mut lang_input_statement_type = 0
        as *mut lang_input_statement_type;
    filler_file = lang_add_input_file(
        b"dll stuff\0" as *const u8 as *const libc::c_char,
        lang_input_file_is_fake_enum,
        0 as *const libc::c_char,
    );
    filler_bfd = bfd_create(
        b"dll stuff\0" as *const u8 as *const libc::c_char,
        link_info.output_bfd,
    );
    (*filler_file).the_bfd = filler_bfd;
    if filler_bfd.is_null()
        || !(Some(
            ((*(*filler_bfd).xvec)._bfd_set_arch_mach)
        ...
        if edata_s.is_null()
            || !bfd_set_section_flags(
                ...
                (0x100 as libc::c_int | 0x1 as libc::c_int | 0x2 as libc::c_int
                    | 0x200000 as libc::c_int | 0x4000 as libc::c_int) as flagword,
            )
        {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: can not create .edata section: %E\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        ...
        )
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: can not create .reloc section: %E\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
unsafe extern "C" fn generate_edata(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
    ...
    let mut dlnp: *const libc::c_char = 0 as *const libc::c_char;
    if !((*pe_def_file).name).is_null() {
        ...
        dlnp = dll_name;
        while *dlnp != 0 {
            if *dlnp as libc::c_int == '\\' as i32 || *dlnp as libc::c_int == '/' as i32
                || *dlnp as libc::c_int == ':' as i32
            {
                dll_name = dlnp.offset(1 as libc::c_int as isize);
            }
            dlnp = dlnp.offset(1);
            dlnp;
        }
    }
    if count_with_ordinals != 0 && max_ordinal > count_exported {
        if min_ordinal > max_ordinal - count_exported + 1 as libc::c_int {
            min_ordinal = max_ordinal - count_exported + 1 as libc::c_int;
        }
    } else {
        min_ordinal = 1 as libc::c_int;
        max_ordinal = count_exported;
    }
    export_table_size = max_ordinal - min_ordinal + 1 as libc::c_int;
    exported_symbols = xmalloc(
        (export_table_size as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<libc::c_int>() as libc::c_ulong),
    ) as *mut libc::c_int;
    i = 0 as libc::c_int;
    while i < export_table_size {
        *exported_symbols.offset(i as isize) = -(1 as libc::c_int);
        i += 1;
        i;
    }
    i = 0 as libc::c_int;
    while i < (*pe_def_file).num_exports {
        if !(*exported_symbol_sections.offset(i as isize)).is_null()
            || (*((*pe_def_file).exports).offset(i as isize)).flag_forward as libc::c_int
                != 0
        {
            if (*((*pe_def_file).exports).offset(i as isize)).ordinal
                != -(1 as libc::c_int)
            {
                let mut ei: libc::c_int = (*((*pe_def_file).exports).offset(i as isize))
                    .ordinal - min_ordinal;
                let mut pi: libc::c_int = *exported_symbols.offset(ei as isize);
                if pi != -(1 as libc::c_int) {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%X%P: error: ordinal used twice: %d (%s vs %s)\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*((*pe_def_file).exports).offset(i as isize)).ordinal,
                        (*((*pe_def_file).exports).offset(i as isize)).name,
                        (*((*pe_def_file).exports).offset(pi as isize)).name,
                    );
                }
                *exported_symbols.offset(ei as isize) = i;
            }
            if !((*((*pe_def_file).exports).offset(i as isize)).its_name).is_null() {
                name_table_size = (name_table_size as libc::c_ulong)
                    .wrapping_add(
                        (strlen((*((*pe_def_file).exports).offset(i as isize)).its_name))
                            .wrapping_add(1 as libc::c_int as libc::c_ulong),
                    ) as libc::c_int as libc::c_int;
            } else {
                name_table_size = (name_table_size as libc::c_ulong)
                    .wrapping_add(
                        (strlen((*((*pe_def_file).exports).offset(i as isize)).name))
                            .wrapping_add(1 as libc::c_int as libc::c_ulong),
                    ) as libc::c_int as libc::c_int;
            }
        }
        if (*((*pe_def_file).exports).offset(i as isize)).flag_forward != 0 {
            name_table_size = (name_table_size as libc::c_ulong)
                .wrapping_add(
                    (strlen(
                        (*((*pe_def_file).exports).offset(i as isize)).internal_name,
    ...
    while i < (*pe_def_file).num_exports {
        if (!(*exported_symbol_sections.offset(i as isize)).is_null()
            ...
            && (*((*pe_def_file).exports).offset(i as isize)).ordinal
                == -(1 as libc::c_int)
        {
            while *exported_symbols.offset((next_ordinal - min_ordinal) as isize)
                != -(1 as libc::c_int)
            {
                next_ordinal += 1;
                next_ordinal;
            }
            *exported_symbols.offset((next_ordinal - min_ordinal) as isize) = i;
            (*((*pe_def_file).exports).offset(i as isize)).ordinal = next_ordinal;
        }
        i += 1;
        i;
    }
    if max_ordinal > 65535 as libc::c_int || next_ordinal > 65535 as libc::c_int {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: error: export ordinal too large: %d\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            if max_ordinal > next_ordinal { max_ordinal } else { next_ordinal },
        );
    }
    edata_sz = ((40 as libc::c_int + 4 as libc::c_int * export_table_size
        + 4 as libc::c_int * count_exported_byname
        + 2 as libc::c_int * count_exported_byname + name_table_size) as libc::c_ulong)
        .wrapping_add(strlen(dll_name))
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
}
unsafe extern "C" fn fill_exported_offsets(
    ...
    while i < (*pe_def_file).num_exports {
        let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
        name = xmalloc(
            (strlen((*((*pe_def_file).exports).offset(i as isize)).internal_name))
                .wrapping_add(2 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        if (*pe_details).underscored as libc::c_int != 0
            && *(*((*pe_def_file).exports).offset(i as isize)).internal_name
                as libc::c_int != '@' as i32
        {
            *name = '_' as i32 as libc::c_char;
            ...
            strcpy(name, (*((*pe_def_file).exports).offset(i as isize)).internal_name);
        }
        blhe = bfd_link_hash_lookup(
            (*info).hash,
            name,
        ...
        if !blhe.is_null()
            && (*blhe).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
        {
            *exported_symbol_offsets.offset(i as isize) = (*blhe).u.def.value;
        }
        free(name as *mut libc::c_void);
        i += 1;
        i;
...
unsafe extern "C" fn fill_edata(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
    let mut s: libc::c_int = 0;
    let mut hint: libc::c_int = 0;
    let mut edirectory: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut eaddresses: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut enameptrs: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut eordinals: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut enamestr: *mut libc::c_char = 0 as *mut libc::c_char;
    edata_d = xmalloc(edata_sz) as *mut libc::c_uchar;
    edirectory = edata_d;
    eaddresses = edirectory.offset(40 as libc::c_int as isize);
    enameptrs = eaddresses.offset((4 as libc::c_int * export_table_size) as isize);
    eordinals = enameptrs.offset((4 as libc::c_int * count_exported_byname) as isize);
    enamestr = (eordinals as *mut libc::c_char)
        .offset((2 as libc::c_int * count_exported_byname) as isize);
    memset(edata_d as *mut libc::c_void, 0 as libc::c_int, edata_sz);
    if (*(*abfd).tdata.pe_obj_data).timestamp == -(1 as libc::c_int) {
        (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
            ...
            edata_d.offset(4 as libc::c_int as isize) as *mut libc::c_void,
        );
    } else {
        (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
            .expect(
    ...
    if (*pe_def_file).version_major != -(1 as libc::c_int) {
        (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            (*pe_def_file).version_major as bfd_vma,
            edata_d.offset(8 as libc::c_int as isize) as *mut libc::c_void,
        );
        (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            (*pe_def_file).version_minor as bfd_vma,
            edata_d.offset(10 as libc::c_int as isize) as *mut libc::c_void,
        );
    }
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        ...
        ((enamestr as *mut libc::c_uchar).offset_from(edata_d) as libc::c_long
            as libc::c_ulong)
            .wrapping_add((*(*edata_s).output_section).vma)
            .wrapping_sub(image_base),
        edata_d.offset(12 as libc::c_int as isize) as *mut libc::c_void,
    );
    strcpy(enamestr, dll_name);
    enamestr = enamestr
        .offset(
            (strlen(enamestr)).wrapping_add(1 as libc::c_int as libc::c_ulong) as isize,
        );
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        min_ordinal as bfd_vma,
        edata_d.offset(16 as libc::c_int as isize) as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        export_table_size as bfd_vma,
        edata_d.offset(20 as libc::c_int as isize) as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        count_exported_byname as bfd_vma,
        edata_d.offset(24 as libc::c_int as isize) as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        (eaddresses.offset_from(edata_d) as libc::c_long as libc::c_ulong)
            .wrapping_add((*(*edata_s).output_section).vma)
            .wrapping_sub(image_base),
        edata_d.offset(28 as libc::c_int as isize) as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        (enameptrs.offset_from(edata_d) as libc::c_long as libc::c_ulong)
            .wrapping_add((*(*edata_s).output_section).vma)
            .wrapping_sub(image_base),
        edata_d.offset(32 as libc::c_int as isize) as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        (eordinals.offset_from(edata_d) as libc::c_long as libc::c_ulong)
            .wrapping_add((*(*edata_s).output_section).vma)
            .wrapping_sub(image_base),
        edata_d.offset(36 as libc::c_int as isize) as *mut libc::c_void,
    );
    fill_exported_offsets(abfd, info);
    hint = 0 as libc::c_int;
    s = 0 as libc::c_int;
    while s < (*pe_def_file).num_exports {
        let mut ssec: *mut bfd_section = *exported_symbol_sections.offset(s as isize);
        if (*((*pe_def_file).exports).offset(s as isize)).ordinal != -(1 as libc::c_int)
            && ((*((*pe_def_file).exports).offset(s as isize)).flag_forward
                as libc::c_int != 0 || !ssec.is_null())
        {
            let mut ord: libc::c_int = (*((*pe_def_file).exports).offset(s as isize))
                .ordinal;
            if (*((*pe_def_file).exports).offset(s as isize)).flag_forward != 0 {
                (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    )(
                    ((enamestr as *mut libc::c_uchar).offset_from(edata_d)
                        as libc::c_long as libc::c_ulong)
                        .wrapping_add((*(*edata_s).output_section).vma)
                        .wrapping_sub(image_base),
                    eaddresses.offset((4 as libc::c_int * (ord - min_ordinal)) as isize)
                        as *mut libc::c_void,
                );
                strcpy(
                    enamestr,
                    (*((*pe_def_file).exports).offset(s as isize)).internal_name,
                );
                enamestr = enamestr
                    .offset(
                        (strlen(
                ...
                let mut srva: bfd_vma = (*exported_symbol_offsets.offset(s as isize))
                    .wrapping_add((*(*ssec).output_section).vma)
                    .wrapping_add((*ssec).output_offset);
                (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    )(
                    srva.wrapping_sub(image_base),
                    eaddresses.offset((4 as libc::c_int * (ord - min_ordinal)) as isize)
                        as *mut libc::c_void,
                );
            }
            if (*((*pe_def_file).exports).offset(s as isize)).flag_noname == 0 {
                let mut ename: *mut libc::c_char = (*((*pe_def_file).exports)
                    .offset(s as isize))
                    .name;
                if !((*((*pe_def_file).exports).offset(s as isize)).its_name).is_null() {
                    ename = (*((*pe_def_file).exports).offset(s as isize)).its_name;
                }
                (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    ...
                    ((enamestr as *mut libc::c_uchar).offset_from(edata_d)
                        ...
                        .wrapping_add((*(*edata_s).output_section).vma)
                        .wrapping_sub(image_base),
                    enameptrs as *mut libc::c_void,
                );
                enameptrs = enameptrs.offset(4 as libc::c_int as isize);
                ...
                (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    )((ord - min_ordinal) as bfd_vma, eordinals as *mut libc::c_void);
                eordinals = eordinals.offset(2 as libc::c_int as isize);
                let fresh10 = hint;
                hint = hint + 1;
                (*((*pe_def_file).exports).offset(s as isize)).hint = fresh10;
            }
        }
        s += 1;
        s;
...
static mut current_sec: *mut bfd_section = 0 as *const bfd_section as *mut bfd_section;
unsafe extern "C" fn pe_walk_relocs(
    mut info: *mut bfd_link_info,
    mut name: *mut libc::c_char,
    mut symname: *const libc::c_char,
    mut import_hash: *mut bfd_hash_table,
    mut cb: Option::<
        unsafe extern "C" fn(
            *mut arelent,
            *mut asection,
    ...
    while !b.is_null() {
        ...
        while !s.is_null() {
            ...
            let mut relsize_0: libc::c_int = 0;
            let mut nrelocs: libc::c_int = 0;
            let mut i: libc::c_int = 0;
            let mut flags: libc::c_int = bfd_section_flags(s) as libc::c_int;
            ...
            {
                current_sec = s;
                relsize_0 = bfd_get_reloc_upper_bound(b, s) as libc::c_int;
                relocs = xmalloc(relsize_0 as size_t) as *mut *mut arelent;
                nrelocs = bfd_canonicalize_reloc(b, s, relocs, symbols) as libc::c_int;
                i = 0 as libc::c_int;
                while i < nrelocs {
                    let mut sym: *mut bfd_symbol = *(**relocs.offset(i as isize))
                        .sym_ptr_ptr;
                    if !import_hash.is_null() {
                        if !(bfd_hash_lookup(
                            import_hash,
                            ...
                            .is_null()
                        {
                            ...
                            cb
                                .expect(
                                    "non-null function pointer",
                                )(*relocs.offset(i as isize), s, name, symname);
                        }
                    } else if strcmp(name, (*sym).name) == 0 as libc::c_int {
                        cb
                            .expect(
                                "non-null function pointer",
                            )(*relocs.offset(i as isize), s, name, symname);
...
unsafe extern "C" fn generate_reloc(mut abfd: *mut bfd, mut info: *mut bfd_link_info) {
    let mut reloc_data: *mut reloc_data_type = 0 as *mut reloc_data_type;
    let mut total_relocs: libc::c_int = 0 as libc::c_int;
    let mut i: libc::c_int = 0;
    let mut sec_page: bfd_vma = -(1 as libc::c_int) as bfd_vma;
    let mut page_ptr: bfd_vma = 0;
    let mut page_count: bfd_vma = 0;
    let mut bi: libc::c_int = 0;
    let mut b: *mut bfd = 0 as *mut bfd;
    let mut s: *mut bfd_section = 0 as *mut bfd_section;
    if reloc_s.is_null()
        || (*reloc_s).output_section
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
    {
        return;
    }
    total_relocs = 0 as libc::c_int;
    b = (*info).input_bfds;
    while !b.is_null() {
        s = (*b).sections;
        while !s.is_null() {
            total_relocs = (total_relocs as libc::c_uint).wrapping_add((*s).reloc_count)
                as libc::c_int as libc::c_int;
            s = (*s).next;
        }
        b = (*b).link.next;
    ...
    reloc_data = xmalloc(
        (total_relocs as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<reloc_data_type>() as libc::c_ulong),
    ) as *mut reloc_data_type;
    total_relocs = 0 as libc::c_int;
    bi = 0 as libc::c_int;
    bi = 0 as libc::c_int;
    b = (*info).input_bfds;
    while !b.is_null() {
        ...
        s = (*b).sections;
        while !s.is_null() {
            let mut sec_vma: bfd_vma = ((*(*s).output_section).vma)
                .wrapping_add((*s).output_offset);
            let mut symbols: *mut *mut asymbol = 0 as *mut *mut asymbol;
            if !((*(*s).output_section).flags & 0x2 as libc::c_int as libc::c_uint == 0)
            {
                if !((*s).output_section
                    == &mut *_bfd_std_section
                        .as_mut_ptr()
                        .offset(2 as libc::c_int as isize) as *mut asection)
                {
                    if !((*(*s).output_section).vma == 0 as libc::c_int as libc::c_ulong)
                    {
                        if !bfd_generic_link_read_symbols(b) {
                            einfo(
                                dcgettext(
                        ...
                        while i < nrelocs {
                            if pe_dll_extra_pe_debug != 0 {
                                let mut sym: *mut bfd_symbol = *(**relocs
                                    .offset(i as isize))
                                    .sym_ptr_ptr;
                                printf(
                                    b"rel: %s\n\0" as *const u8 as *const libc::c_char,
                            ...
                            if (*(**relocs.offset(i as isize)).howto).pc_relative() == 0
                                && (*(**relocs.offset(i as isize)).howto).type_0
                                    != (*pe_details).imagebase_reloc
                            {
                                let mut sym_0: *mut bfd_symbol = *(**relocs
                                    .offset(i as isize))
                                    .sym_ptr_ptr;
                                let mut blhe: *const bfd_link_hash_entry = bfd_wrapped_link_hash_lookup(
                                    abfd,
                                    info,
                                    (*sym_0).name,
                                    0 as libc::c_int != 0,
                                    ...
                                    == ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
                                {
                                    ...
                                    {
                                        let mut h: *mut coff_link_hash_entry = 0
                                            as *mut coff_link_hash_entry;
                                        let mut h2: *mut coff_link_hash_entry = 0
                                            as *mut coff_link_hash_entry;
                                        h = blhe as *mut coff_link_hash_entry;
                                        if (*h).symbol_class as libc::c_int != 105 as libc::c_int
                                            || (*h).numaux as libc::c_int != 1 as libc::c_int
                                        {
                                            current_block_41 = 2232869372362427478;
                                        } else {
                                            h2 = *((*(*(*h).auxbfd).tdata.coff_obj_data).sym_hashes)
                                                .offset((*(*h).aux).x_sym.x_tagndx.l as isize);
                                            if h2.is_null()
                                                || ((*h2).root).type_0() as libc::c_int
                                                    == bfd_link_hash_undefined as libc::c_int
                                                || (*h2).root.u.def.section
                                                    == &mut *_bfd_std_section
                                                        .as_mut_ptr()
                                                        .offset(2 as libc::c_int as isize) as *mut asection
                                            {
                                ...
                                } else if bfd_is_abs_section(
                                    (*(*sym_0).section).output_section,
                                ) {
                                    if strcmp(
                                        (*s).name,
                                    ...
                                    && ldexp_is_final_sym_absolute(blhe) as libc::c_int != 0
                                    && ((*blhe).linker_def() == 0
                                        || strcmp(
                                            (*sym_0).name,
                                ...
                                match current_block_41 {
                                    2232869372362427478 => {}
                                    _ => {
                                        (*reloc_data.offset(total_relocs as isize))
                                            .vma = sec_vma
                                            .wrapping_add((**relocs.offset(i as isize)).address);
                                        (*reloc_data.offset(total_relocs as isize))
                                            .idx = total_relocs;
                                        if (*reloc_data.offset(total_relocs as isize)).vma
                                            >= (*(*reloc_s).output_section).vma
                                        {
                                            einfo(
                                                dcgettext(
                                                    0 as *const libc::c_char,
                                                    b"%P: base relocation for section `%s' above .reloc section\n\0"
                                                        as *const u8 as *const libc::c_char,
                                                    5 as libc::c_int,
                                                ),
                                        ...
                                        match (*(**relocs.offset(i as isize)).howto).bitsize()
                                            as libc::c_int * 1000 as libc::c_int
                                            | (*(**relocs.offset(i as isize)).howto).rightshift()
                                                as libc::c_int
                                        {
                                            32000 => {
                                                (*reloc_data.offset(total_relocs as isize))
                                                ...
                                                total_relocs += 1;
                                                total_relocs;
                                                current_block_40 = 6528285054092551010;
                                            }
                                            16000 => {
                                                (*reloc_data.offset(total_relocs as isize))
                                            ...
                                            16016 => {
                                                ...
                                                (*reloc_data.offset(total_relocs as isize))
                                                    .extra = 0 as libc::c_int as libc::c_short;
                                                total_relocs += 1;
                                                total_relocs;
                                                current_block_40 = 6528285054092551010;
                                            }
                                            ...
                                            24002 => {
                                                if (*(**relocs.offset(i as isize)).howto).type_0
                                                    == 0 as libc::c_int as libc::c_uint
                                                    || (*(**relocs.offset(i as isize)).howto).type_0
                                                        == 5 as libc::c_int as libc::c_uint
                                                {
                                                    ...
                                                    current_block_40 = 17164410695122137243;
                                                }
                                            }
                                            _ => {
                                                current_block_40 = 17164410695122137243;
                                        ...
                                        match current_block_40 {
                                            17164410695122137243 => {
                                                einfo(
                                                    dcgettext(
                                                        0 as *const libc::c_char,
                                                        b"%X%P: error: %d-bit reloc in dll\n\0" as *const u8
                                                            as *const libc::c_char,
                                                        5 as libc::c_int,
                                                    ),
                                                    (*(**relocs.offset(i as isize)).howto).bitsize()
                                                        as libc::c_int,
                                                );
                                            }
                                            _ => {}
    ...
    qsort(
        reloc_data as *mut libc::c_void,
        total_relocs as size_t,
        ::core::mem::size_of::<reloc_data_type>() as libc::c_ulong,
        Some(
            reloc_sort
                as unsafe extern "C" fn(
                    *const libc::c_void,
    ...
    i = 0 as libc::c_int;
    while i < total_relocs {
        let mut this_page: bfd_vma = (*reloc_data.offset(i as isize)).vma
            >> 12 as libc::c_int;
        if this_page != sec_page {
            reloc_sz = reloc_sz.wrapping_add(3 as libc::c_int as libc::c_ulong)
                & !(3 as libc::c_int) as libc::c_ulong;
            reloc_sz = (reloc_sz as libc::c_ulong)
        ...
        if (*reloc_data.offset(i as isize)).type_0 as libc::c_int == 4 as libc::c_int {
            reloc_sz = (reloc_sz as libc::c_ulong)
                .wrapping_add(2 as libc::c_int as libc::c_ulong) as size_t as size_t;
        }
        i += 1;
    ...
    reloc_sz = reloc_sz.wrapping_add(3 as libc::c_int as libc::c_ulong)
        & !(3 as libc::c_int) as libc::c_ulong;
    reloc_d = xmalloc(reloc_sz) as *mut libc::c_uchar;
    sec_page = -(1 as libc::c_int) as bfd_vma;
    reloc_sz = 0 as libc::c_int as size_t;
    page_ptr = -(1 as libc::c_int) as bfd_vma;
    page_count = 0 as libc::c_int as bfd_vma;
    i = 0 as libc::c_int;
    while i < total_relocs {
        let mut rva: bfd_vma = ((*reloc_data.offset(i as isize)).vma)
            .wrapping_sub(image_base);
        let mut this_page_0: bfd_vma = rva & !(0xfff as libc::c_int) as libc::c_ulong;
        if this_page_0 != sec_page {
            while reloc_sz & 3 as libc::c_int as libc::c_ulong != 0 {
                let fresh11 = reloc_sz;
                reloc_sz = reloc_sz.wrapping_add(1);
                *reloc_d.offset(fresh11 as isize) = 0 as libc::c_int as libc::c_uchar;
            }
            if page_ptr != -(1 as libc::c_int) as bfd_vma {
                (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    )(
                    reloc_sz.wrapping_sub(page_ptr),
                    reloc_d.offset(page_ptr as isize).offset(4 as libc::c_int as isize)
                        as *mut libc::c_void,
                );
            }
            (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(this_page_0, reloc_d.offset(reloc_sz as isize) as *mut libc::c_void);
            page_ptr = reloc_sz;
            reloc_sz = (reloc_sz as libc::c_ulong)
                .wrapping_add(8 as libc::c_int as libc::c_ulong) as size_t as size_t;
            sec_page = this_page_0;
            page_count = 0 as libc::c_int as bfd_vma;
        }
        (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
            .expect(
            ...
            (rva & 0xfff as libc::c_int as libc::c_ulong)
                .wrapping_add(
                    (((*reloc_data.offset(i as isize)).type_0 as libc::c_int)
                        << 12 as libc::c_int) as libc::c_ulong,
                ),
            reloc_d.offset(reloc_sz as isize) as *mut libc::c_void,
        );
        reloc_sz = (reloc_sz as libc::c_ulong)
            .wrapping_add(2 as libc::c_int as libc::c_ulong) as size_t as size_t;
        if (*reloc_data.offset(i as isize)).type_0 as libc::c_int == 4 as libc::c_int {
            (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
                ...
                (*reloc_data.offset(i as isize)).extra as bfd_vma,
                reloc_d.offset(reloc_sz as isize) as *mut libc::c_void,
            );
            reloc_sz = (reloc_sz as libc::c_ulong)
                .wrapping_add(2 as libc::c_int as libc::c_ulong) as size_t as size_t;
    ...
    while reloc_sz & 3 as libc::c_int as libc::c_ulong != 0 {
        let fresh12 = reloc_sz;
        reloc_sz = reloc_sz.wrapping_add(1);
        *reloc_d.offset(fresh12 as isize) = 0 as libc::c_int as libc::c_uchar;
    }
    if page_ptr != -(1 as libc::c_int) as bfd_vma {
        (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
...
unsafe extern "C" fn quoteput(
    mut s: *mut libc::c_char,
    mut f: *mut FILE,
    mut needs_quotes: libc::c_int,
) {
...
static mut symtab: *mut *mut asymbol = 0 as *const *mut asymbol as *mut *mut asymbol;
static mut symptr: libc::c_int = 0;
static mut tmp_seq: libc::c_int = 0;
static mut dll_filename: *const libc::c_char = 0 as *const libc::c_char;
static mut dll_symname: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
unsafe extern "C" fn quick_section(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    ...
    bfd_set_section_flags(
        sec,
        (flags | 0x1 as libc::c_int | 0x2 as libc::c_int | 0x200000 as libc::c_int)
            as flagword,
    );
    bfd_set_section_alignment(sec, align as libc::c_uint);
    ...
    let fresh13 = symptr;
    symptr = symptr + 1;
    let ref mut fresh14 = *symtab.offset(fresh13 as isize);
    *fresh14 = sym;
    (*sym).name = (*sec).name;
    (*sym).section = sec;
    (*sym).flags = ((1 as libc::c_int) << 0 as libc::c_int) as flagword;
    (*sym).value = 0 as libc::c_int as symvalue;
    return sec;
}
unsafe extern "C" fn quick_symbol(
    mut abfd: *mut bfd,
    mut n1: *const libc::c_char,
    mut n2: *const libc::c_char,
    mut n3: *const libc::c_char,
    mut sec: *mut asection,
    mut flags: libc::c_int,
    mut addr: libc::c_int,
) {
    ...
    let mut name: *mut libc::c_char = xmalloc(
        (strlen(n1))
            .wrapping_add(strlen(n2))
            .wrapping_add(strlen(n3))
            .wrapping_add(1 as libc::c_int as libc::c_ulong),
    ) as *mut libc::c_char;
    strcpy(name, n1);
    strcat(name, n2);
    ...
    (*sym).name = name;
    (*sym).section = sec;
    (*sym).flags = flags as flagword;
    (*sym).value = addr as symvalue;
    let fresh15 = symptr;
    symptr = symptr + 1;
    let ref mut fresh16 = *symtab.offset(fresh15 as isize);
    *fresh16 = sym;
}
static mut reltab: *mut arelent = 0 as *const arelent as *mut arelent;
static mut relcount: libc::c_int = 0 as libc::c_int;
static mut relsize: libc::c_int = 0 as libc::c_int;
unsafe extern "C" fn quick_reloc(
    mut abfd: *mut bfd,
    mut address: bfd_size_type,
    mut which_howto: libc::c_int,
    mut symidx: libc::c_int,
) {
    if relcount >= relsize - 1 as libc::c_int {
        relsize += 10 as libc::c_int;
        if !reltab.is_null() {
            reltab = xrealloc(
                reltab as *mut libc::c_void,
                (relsize as libc::c_ulong)
    ...
    (*reltab.offset(relcount as isize)).address = address;
    (*reltab.offset(relcount as isize)).addend = 0 as libc::c_int as bfd_vma;
    let ref mut fresh17 = (*reltab.offset(relcount as isize)).howto;
    *fresh17 = bfd_reloc_type_lookup(abfd, which_howto as bfd_reloc_code_real_type);
    let ref mut fresh18 = (*reltab.offset(relcount as isize)).sym_ptr_ptr;
    *fresh18 = symtab.offset(symidx as isize);
    relcount += 1;
    relcount;
}
unsafe extern "C" fn save_relocs(mut sec: *mut asection) {
    let mut i: libc::c_int = 0;
    (*sec).relocation = reltab;
    (*sec).reloc_count = relcount as libc::c_uint;
    (*sec)
        .orelocation = xmalloc(
        ((relcount + 1 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut arelent>() as libc::c_ulong),
    ) as *mut *mut reloc_cache_entry;
    i = 0 as libc::c_int;
    while i < relcount {
        let ref mut fresh19 = *((*sec).orelocation).offset(i as isize);
        *fresh19 = ((*sec).relocation).offset(i as isize);
        i += 1;
        i;
    }
    let ref mut fresh20 = *((*sec).orelocation).offset(relcount as isize);
    *fresh20 = 0 as *mut reloc_cache_entry;
    (*sec).flags |= 0x4 as libc::c_int as libc::c_uint;
    reltab = 0 as *mut arelent;
    relsize = 0 as libc::c_int;
    relcount = relsize;
}
unsafe extern "C" fn make_head(mut parent: *mut bfd) -> *mut bfd {
    let mut id2: *mut asection = 0 as *mut asection;
    let mut id5: *mut asection = 0 as *mut asection;
    let mut id4: *mut asection = 0 as *mut asection;
    let mut d2: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d5: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d4: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut oname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    oname = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_char;
    sprintf(oname, b"d%06d.o\0" as *const u8 as *const libc::c_char, tmp_seq);
    tmp_seq += 1;
    tmp_seq;
    ...
    (Some(((*(*abfd).xvec)._bfd_set_arch_mach).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        abfd,
        (*pe_details).bfd_arch as bfd_architecture,
        0 as libc::c_int as libc::c_ulong,
    );
    symptr = 0 as libc::c_int;
    symtab = xmalloc(
    ...
    quick_symbol(
        ...
        dll_symname,
        b"_iname\0" as *const u8 as *const libc::c_char,
        &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize),
        (1 as libc::c_int) << 1 as libc::c_int,
        0 as libc::c_int,
    );
    bfd_set_section_size(id2, 20 as libc::c_int as bfd_size_type);
    d2 = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_uchar;
    (*id2).contents = d2;
    memset(
    ...
    if pe_use_nul_prefixed_import_tables != 0 {
        let ref mut fresh21 = *d2.offset(16 as libc::c_int as isize);
        *fresh21 = 4 as libc::c_int as libc::c_uchar;
        *d2.offset(0 as libc::c_int as isize) = *fresh21;
    }
    quick_reloc(
        abfd,
        0 as libc::c_int as bfd_size_type,
        BFD_RELOC_RVA as libc::c_int,
        2 as libc::c_int,
    );
    quick_reloc(
        abfd,
        12 as libc::c_int as bfd_size_type,
        BFD_RELOC_RVA as libc::c_int,
        4 as libc::c_int,
    );
    quick_reloc(
    ...
    save_relocs(id2);
    if pe_use_nul_prefixed_import_tables != 0 {
        bfd_set_section_size(id5, 4 as libc::c_int as bfd_size_type);
    } else {
        bfd_set_section_size(id5, 0 as libc::c_int as bfd_size_type);
    }
    d5 = xmalloc(4 as libc::c_int as size_t) as *mut libc::c_uchar;
    (*id5).contents = d5;
    memset(d5 as *mut libc::c_void, 0 as libc::c_int, 4 as libc::c_int as libc::c_ulong);
    if pe_use_nul_prefixed_import_tables != 0 {
        bfd_set_section_size(id4, 4 as libc::c_int as bfd_size_type);
    } else {
        bfd_set_section_size(id4, 0 as libc::c_int as bfd_size_type);
    }
    d4 = xmalloc(4 as libc::c_int as size_t) as *mut libc::c_uchar;
    (*id4).contents = d4;
    memset(d4 as *mut libc::c_void, 0 as libc::c_int, 4 as libc::c_int as libc::c_ulong);
    bfd_set_symtab(abfd, symtab, symptr as libc::c_uint);
...
unsafe extern "C" fn make_tail(mut parent: *mut bfd) -> *mut bfd {
    let mut id4: *mut asection = 0 as *mut asection;
    let mut id5: *mut asection = 0 as *mut asection;
    let mut id7: *mut asection = 0 as *mut asection;
    let mut d4: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d5: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d7: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut len: libc::c_int = 0;
    let mut oname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    oname = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_char;
    ...
    id7 = quick_section(
        abfd,
        b".idata$7\0" as *const u8 as *const libc::c_char,
        0x100 as libc::c_int,
        2 as libc::c_int,
    );
    quick_symbol(
    ...
    (*id5).contents = d5;
    memset(d5 as *mut libc::c_void, 0 as libc::c_int, 4 as libc::c_int as libc::c_ulong);
    len = (strlen(dll_filename)).wrapping_add(1 as libc::c_int as libc::c_ulong)
        as libc::c_int;
    if len & 1 as libc::c_int != 0 {
        len += 1;
        len;
    }
    bfd_set_section_size(id7, len as bfd_size_type);
    d7 = xmalloc(len as size_t) as *mut libc::c_uchar;
    (*id7).contents = d7;
    strcpy(d7 as *mut libc::c_char, dll_filename);
    *d7.offset((len - 1 as libc::c_int) as isize) = 0 as libc::c_int as libc::c_uchar;
    bfd_set_symtab(abfd, symtab, symptr as libc::c_uint);
    bfd_set_section_contents(
        abfd,
        id4,
...
static mut jmp_ix86_bytes: [libc::c_uchar; 8] = [
...
static mut jmp_sh_bytes: [libc::c_uchar; 12] = [
...
static mut jmp_mips_bytes: [libc::c_uchar; 16] = [
    0 as libc::c_int as libc::c_uchar,
    0 as libc::c_int as libc::c_uchar,
...
static mut jmp_arm_bytes: [libc::c_uchar; 12] = [
    0 as libc::c_int as libc::c_uchar,
...
unsafe extern "C" fn make_one(
    mut exp: *mut def_file_export,
    mut parent: *mut bfd,
    mut include_jmp_stub: bool,
) -> *mut bfd {
    let mut tx: *mut asection = 0 as *mut asection;
    let mut id7: *mut asection = 0 as *mut asection;
    let mut id5: *mut asection = 0 as *mut asection;
    let mut id4: *mut asection = 0 as *mut asection;
    let mut id6: *mut asection = 0 as *mut asection;
    let mut td: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d7: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d5: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d4: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut d6: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut len: libc::c_int = 0;
    let mut oname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    let mut jmp_bytes: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut jmp_byte_count: libc::c_int = 0 as libc::c_int;
    if include_jmp_stub {
        match (*pe_details).pe_arch {
            1 => {
                jmp_bytes = jmp_ix86_bytes.as_ptr();
                jmp_byte_count = ::core::mem::size_of::<[libc::c_uchar; 8]>()
                    as libc::c_ulong as libc::c_int;
            }
            2 => {
                jmp_bytes = jmp_sh_bytes.as_ptr();
                jmp_byte_count = ::core::mem::size_of::<[libc::c_uchar; 12]>()
                    as libc::c_ulong as libc::c_int;
            }
            3 => {
                jmp_bytes = jmp_mips_bytes.as_ptr();
                jmp_byte_count = ::core::mem::size_of::<[libc::c_uchar; 16]>()
                    as libc::c_ulong as libc::c_int;
            }
            4 | 5 => {
                jmp_bytes = jmp_arm_bytes.as_ptr();
                jmp_byte_count = ::core::mem::size_of::<[libc::c_uchar; 12]>()
                    as libc::c_ulong as libc::c_int;
            }
            _ => {
                ld_abort(
                    ...
                    (*::core::mem::transmute::<
                        &[u8; 47],
                        &[libc::c_char; 47],
                    >(b"bfd *make_one(def_file_export *, bfd *, _Bool)\0"))
                        .as_ptr(),
                );
            }
        }
    ...
    tx = quick_section(
        ...
        0x10 as libc::c_int | 0x100 as libc::c_int | 0x8 as libc::c_int,
        2 as libc::c_int,
    );
    id7 = quick_section(
        abfd,
    ...
    if *(*exp).internal_name as libc::c_int == '@' as i32 {
        quick_symbol(
            abfd,
            if (*pe_details).underscored as libc::c_int != 0 {
                b"__head_\0" as *const u8 as *const libc::c_char
    ...
    if pe_dll_compat_implib != 0 {
        quick_symbol(
            abfd,
            b"___imp_\0" as *const u8 as *const libc::c_char,
            (*exp).internal_name,
            b"\0" as *const u8 as *const libc::c_char,
            id5,
            (1 as libc::c_int) << 1 as libc::c_int,
    ...
    if include_jmp_stub {
        bfd_set_section_size(tx, jmp_byte_count as bfd_size_type);
        td = xmalloc(jmp_byte_count as size_t) as *mut libc::c_uchar;
        (*tx).contents = td;
        memcpy(
            td as *mut libc::c_void,
            jmp_bytes as *const libc::c_void,
            jmp_byte_count as libc::c_ulong,
        );
        match (*pe_details).pe_arch {
            1 => {
                quick_symbol(
                    abfd,
                    b"\0" as *const u8 as *const libc::c_char,
                    b"@feat.00\0" as *const u8 as *const libc::c_char,
                    b"\0" as *const u8 as *const libc::c_char,
                    &mut *_bfd_std_section
                        .as_mut_ptr()
            ...
            3 => {
                quick_reloc(
                    abfd,
                    0 as libc::c_int as bfd_size_type,
                    BFD_RELOC_HI16_S as libc::c_int,
                    2 as libc::c_int,
                );
                quick_reloc(
                    abfd,
                    0 as libc::c_int as bfd_size_type,
                    BFD_RELOC_LO16 as libc::c_int,
                    0 as libc::c_int,
                );
                quick_reloc(
                    abfd,
        ...
        bfd_set_section_size(tx, 0 as libc::c_int as bfd_size_type);
    }
    bfd_set_section_size(id7, 4 as libc::c_int as bfd_size_type);
    d7 = xmalloc(4 as libc::c_int as size_t) as *mut libc::c_uchar;
    (*id7).contents = d7;
    memset(d7 as *mut libc::c_void, 0 as libc::c_int, 4 as libc::c_int as libc::c_ulong);
    quick_reloc(
        abfd,
        0 as libc::c_int as bfd_size_type,
        BFD_RELOC_RVA as libc::c_int,
    ...
    if (*exp).flag_noname != 0 {
        *d5.offset(0 as libc::c_int as isize) = (*exp).ordinal as libc::c_uchar;
        *d5
            .offset(
                1 as libc::c_int as isize,
            ) = ((*exp).ordinal >> 8 as libc::c_int) as libc::c_uchar;
        *d5
            .offset(
    ...
    memset(d4 as *mut libc::c_void, 0 as libc::c_int, 4 as libc::c_int as libc::c_ulong);
    if (*exp).flag_noname != 0 {
        *d4.offset(0 as libc::c_int as isize) = (*exp).ordinal as libc::c_uchar;
        *d4
            .offset(
                1 as libc::c_int as isize,
            ) = ((*exp).ordinal >> 8 as libc::c_int) as libc::c_uchar;
    ...
    if (*exp).flag_noname != 0 {
        len = 0 as libc::c_int;
        bfd_set_section_size(id6, 0 as libc::c_int as bfd_size_type);
    } else {
        let mut ord: libc::c_int = 0;
        if !((*exp).its_name).is_null() {
            len = (2 as libc::c_int as libc::c_ulong)
                .wrapping_add(strlen((*exp).its_name))
                .wrapping_add(1 as libc::c_int as libc::c_ulong) as libc::c_int;
        } else {
            len = (2 as libc::c_int as libc::c_ulong)
                .wrapping_add(strlen((*exp).name))
                .wrapping_add(1 as libc::c_int as libc::c_ulong) as libc::c_int;
        }
        if len & 1 as libc::c_int != 0 {
            len += 1;
        ...
        bfd_set_section_size(id6, len as bfd_size_type);
        d6 = xmalloc(len as size_t) as *mut libc::c_uchar;
        (*id6).contents = d6;
        memset(d6 as *mut libc::c_void, 0 as libc::c_int, len as libc::c_ulong);
        ord = if (*exp).ordinal >= 0 as libc::c_int {
            (*exp).ordinal
        } else {
            (*exp).hint
        };
        *d6.offset(0 as libc::c_int as isize) = ord as libc::c_uchar;
        *d6
            .offset(
                1 as libc::c_int as isize,
            ) = (ord >> 8 as libc::c_int) as libc::c_uchar;
        if !((*exp).its_name).is_null() {
            strcpy(
                (d6 as *mut libc::c_char).offset(2 as libc::c_int as isize),
                (*exp).its_name,
            );
        } else {
            strcpy(
    ...
    if include_jmp_stub {
        bfd_set_section_contents(
            abfd,
            tx,
            td as *const libc::c_void,
            0 as libc::c_int as file_ptr,
            jmp_byte_count as bfd_size_type,
        );
    }
    bfd_set_section_contents(
        abfd,
...
unsafe extern "C" fn make_singleton_name_thunk(
    mut import: *const libc::c_char,
    mut parent: *mut bfd,
) -> *mut bfd {
    let mut id4: *mut asection = 0 as *mut asection;
    let mut d4: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    ...
    let mut abfd: *mut bfd = 0 as *mut bfd;
    oname = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_char;
    sprintf(oname, b"nmth%06d.o\0" as *const u8 as *const libc::c_char, tmp_seq);
    tmp_seq += 1;
    tmp_seq;
    abfd = bfd_create(oname, parent);
    bfd_find_target((*pe_details).object_target, abfd);
    ...
    quick_symbol(
        abfd,
        b"__nm_thnk_\0" as *const u8 as *const libc::c_char,
        import,
        b"\0" as *const u8 as *const libc::c_char,
        id4,
        (1 as libc::c_int) << 1 as libc::c_int,
    ...
    bfd_set_section_size(id4, (4 as libc::c_int * 2 as libc::c_int) as bfd_size_type);
    d4 = xmalloc((4 as libc::c_int * 2 as libc::c_int) as size_t) as *mut libc::c_uchar;
    (*id4).contents = d4;
    memset(
        d4 as *mut libc::c_void,
        0 as libc::c_int,
    ...
    bfd_set_section_contents(
        ...
        d4 as *const libc::c_void,
        0 as libc::c_int as file_ptr,
        (4 as libc::c_int * 2 as libc::c_int) as bfd_size_type,
    );
    bfd_make_readable(abfd);
    return abfd;
}
unsafe extern "C" fn make_import_fixup_mark(
    mut rel: *mut arelent,
    mut name: *mut libc::c_char,
) -> *const libc::c_char {
    static mut counter: libc::c_uint = 0;
    let mut sym: *mut bfd_symbol = *(*rel).sym_ptr_ptr;
    let mut abfd: *mut bfd = bfd_asymbol_bfd(sym);
    let mut bh: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut fixup_name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut buf: [libc::c_char; 26] = [0; 26];
    let mut prefix_len: size_t = 0;
    let fresh22 = counter;
    counter = counter.wrapping_add(1);
    sprintf(buf.as_mut_ptr(), b"__fu%d_\0" as *const u8 as *const libc::c_char, fresh22);
    prefix_len = strlen(buf.as_mut_ptr());
    fixup_name = name.offset(-(prefix_len as isize));
    memcpy(
        fixup_name as *mut libc::c_void,
...
unsafe extern "C" fn make_import_fixup_entry(
    mut name: *const libc::c_char,
    mut fixup_name: *const libc::c_char,
    mut symname: *const libc::c_char,
    mut parent: *mut bfd,
) -> *mut bfd {
    let mut id2: *mut asection = 0 as *mut asection;
    ...
    let mut abfd: *mut bfd = 0 as *mut bfd;
    oname = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_char;
    sprintf(oname, b"fu%06d.o\0" as *const u8 as *const libc::c_char, tmp_seq);
    tmp_seq += 1;
    tmp_seq;
    abfd = bfd_create(oname, parent);
    bfd_find_target((*pe_details).object_target, abfd);
...
unsafe extern "C" fn make_runtime_pseudo_reloc(
    mut name: *const libc::c_char,
    mut fixup_name: *const libc::c_char,
    mut addend: bfd_vma,
    mut bitsize: bfd_vma,
    ...
    let mut rt_rel: *mut asection = 0 as *mut asection;
    let mut rt_rel_d: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut oname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    let mut size: bfd_size_type = 0;
    oname = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_char;
    sprintf(oname, b"rtr%06d.o\0" as *const u8 as *const libc::c_char, tmp_seq);
    tmp_seq += 1;
    tmp_seq;
    abfd = bfd_create(oname, parent);
    bfd_find_target((*pe_details).object_target, abfd);
    ...
    symptr = 0 as libc::c_int;
    symtab = xmalloc(size) as *mut *mut asymbol;
    rt_rel = quick_section(
        abfd,
        b".rdata_runtime_pseudo_reloc\0" as *const u8 as *const libc::c_char,
        0x100 as libc::c_int,
        2 as libc::c_int,
    );
    quick_symbol(
    ...
    if link_info.pei386_runtime_pseudo_reloc == 2 as libc::c_int {
        size = 12 as libc::c_int as bfd_size_type;
        if !runtime_pseudp_reloc_v2_init {
            size = (size as libc::c_ulong)
                .wrapping_add(12 as libc::c_int as libc::c_ulong) as bfd_size_type
                as bfd_size_type;
            runtime_pseudp_reloc_v2_init = 1 as libc::c_int != 0;
        }
        quick_symbol(
            abfd,
            b"__imp_\0" as *const u8 as *const libc::c_char,
        ...
        rt_rel_d = xmalloc(size) as *mut libc::c_uchar;
        (*rt_rel).contents = rt_rel_d;
        memset(rt_rel_d as *mut libc::c_void, 0 as libc::c_int, size);
        quick_reloc(
            abfd,
            size.wrapping_sub(8 as libc::c_int as libc::c_ulong),
            BFD_RELOC_RVA as libc::c_int,
            1 as libc::c_int,
        );
        quick_reloc(
            abfd,
            size.wrapping_sub(12 as libc::c_int as libc::c_ulong),
            BFD_RELOC_RVA as libc::c_int,
            2 as libc::c_int,
        );
        (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
            ...
            bitsize,
            rt_rel_d
                .offset(size.wrapping_sub(4 as libc::c_int as libc::c_ulong) as isize)
                as *mut libc::c_void,
        );
        if size != 12 as libc::c_int as libc::c_ulong {
            (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                ...
                rt_rel_d.offset(8 as libc::c_int as isize) as *mut libc::c_void,
            );
        }
        save_relocs(rt_rel);
        bfd_set_symtab(abfd, symtab, symptr as libc::c_uint);
        bfd_set_section_contents(
            abfd,
            rt_rel,
            rt_rel_d as *const libc::c_void,
            0 as libc::c_int as file_ptr,
            size,
        );
    } else {
        bfd_set_section_size(rt_rel, 8 as libc::c_int as bfd_size_type);
        rt_rel_d = xmalloc(8 as libc::c_int as size_t) as *mut libc::c_uchar;
        (*rt_rel).contents = rt_rel_d;
        memset(
            rt_rel_d as *mut libc::c_void,
            0 as libc::c_int,
            8 as libc::c_int as libc::c_ulong,
        );
        (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect("non-null function pointer")(addend, rt_rel_d as *mut libc::c_void);
        quick_reloc(
            abfd,
            4 as libc::c_int as bfd_size_type,
            BFD_RELOC_RVA as libc::c_int,
...
unsafe extern "C" fn pe_create_runtime_relocator_reference(
    mut parent: *mut bfd,
) -> *mut bfd {
    let mut extern_rt_rel: *mut asection = 0 as *mut asection;
    let mut extern_rt_rel_d: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut oname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    oname = xmalloc(20 as libc::c_int as size_t) as *mut libc::c_char;
    sprintf(oname, b"ertr%06d.o\0" as *const u8 as *const libc::c_char, tmp_seq);
    tmp_seq += 1;
    tmp_seq;
    abfd = bfd_create(oname, parent);
    bfd_find_target((*pe_details).object_target, abfd);
    ...
    quick_symbol(
        ...
        b"\0" as *const u8 as *const libc::c_char,
        if (*pe_details).underscored as libc::c_int != 0 {
            b"__pei386_runtime_relocator\0" as *const u8 as *const libc::c_char
        } else {
            b"_pei386_runtime_relocator\0" as *const u8 as *const libc::c_char
        },
        b"\0" as *const u8 as *const libc::c_char,
        &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize),
        0 as libc::c_int,
    ...
    bfd_set_section_size(extern_rt_rel, 4 as libc::c_int as bfd_size_type);
    extern_rt_rel_d = xcalloc(1 as libc::c_int as size_t, 4 as libc::c_int as size_t)
        as *mut libc::c_uchar;
    ...
    bfd_set_section_contents(
        abfd,
        extern_rt_rel,
        extern_rt_rel_d as *const libc::c_void,
        0 as libc::c_int as file_ptr,
        4 as libc::c_int as bfd_size_type,
    );
    bfd_make_readable(abfd);
...
static mut undef_count: libc::c_int = 0 as libc::c_int;
static mut udef_table: *mut key_value = 0 as *const key_value as *mut key_value;
unsafe extern "C" fn undef_sort_cmp(
    mut l1: *const libc::c_void,
    mut r1: *const libc::c_void,
) -> libc::c_int {
    let mut l: *const key_value = l1 as *const key_value;
    let mut r: *const key_value = r1 as *const key_value;
    return strcmp((*l).key, (*r).key);
}
unsafe extern "C" fn pe_find_cdecl_alias_match(
    mut linfo: *mut bfd_link_info,
    mut name: *mut libc::c_char,
) -> *mut bfd_link_hash_entry {
    let mut current_block: u64;
    let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut kv: *mut key_value = 0 as *mut key_value;
    let mut key: key_value = key_value {
        key: 0 as *mut libc::c_char,
        oname: 0 as *const libc::c_char,
    };
    let mut at: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut lname: *mut libc::c_char = xmalloc(
        (strlen(name)).wrapping_add(3 as libc::c_int as libc::c_ulong),
    ) as *mut libc::c_char;
    strcpy(lname, name);
    at = strchr(
        lname
            .offset(
                (*lname.offset(0 as libc::c_int as isize) as libc::c_int == '@' as i32)
                    as libc::c_int as isize,
            ),
        '@' as i32,
    );
    if !at.is_null() {
        *at.offset(1 as libc::c_int as isize) = 0 as libc::c_int as libc::c_char;
    }
    key.key = lname;
    kv = bsearch(
        &mut key as *mut key_value as *const libc::c_void,
        udef_table as *const libc::c_void,
        undef_count as size_t,
        ::core::mem::size_of::<key_value>() as libc::c_ulong,
        Some(
            undef_sort_cmp
                as unsafe extern "C" fn(
                    *const libc::c_void,
    ...
    if !kv.is_null() {
        ...
        if (*h).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int {
            current_block = 7727554788023354967;
        } else {
    ...
    match current_block {
        17216689946888361452 => {
            if *lname.offset(0 as libc::c_int as isize) as libc::c_int == '?' as i32 {
                current_block = 1028199541578876898;
            } else if !at.is_null()
                || *lname.offset(0 as libc::c_int as isize) as libc::c_int == '@' as i32
            {
                if *lname.offset(0 as libc::c_int as isize) as libc::c_int == '@' as i32
                    ...
                    if (*pe_details).underscored {
                        *lname
                        ...
                        memmove(
                            ...
                            lname.offset(1 as libc::c_int as isize)
                ...
                strcat(lname, b"@\0" as *const u8 as *const libc::c_char);
                key.key = lname;
                kv = bsearch(
                    &mut key as *mut key_value as *const libc::c_void,
                    udef_table as *const libc::c_void,
                ...
                match current_block {
                    7727554788023354967 => {}
                    _ => {
                        if *lname.offset(0 as libc::c_int as isize) as libc::c_int
                            == '_' as i32
                            && (*pe_details).underscored as libc::c_int != 0
                        {
                            *lname
                                .offset(
                                    0 as libc::c_int as isize,
            ...
            match current_block {
                7727554788023354967 => {}
                _ => {
                    h = 0 as *mut bfd_link_hash_entry;
                }
            }
        }
        _ => {}
...
unsafe extern "C" fn pe_undef_fill(
    ...
    if (*h).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int {
        let mut at: *mut libc::c_char = 0 as *mut libc::c_char;
        let ref mut fresh23 = (*udef_table.offset(undef_count as isize)).key;
        *fresh23 = xstrdup((*h).root.string);
        at = strchr(
            ((*udef_table.offset(undef_count as isize)).key)
                .offset(
                    (*((*udef_table.offset(undef_count as isize)).key)
                        .offset(0 as libc::c_int as isize) as libc::c_int == '@' as i32)
                        as libc::c_int as isize,
        ...
        let ref mut fresh24 = (*udef_table.offset(undef_count as isize)).oname;
        *fresh24 = (*h).root.string;
        undef_count += 1;
        undef_count;
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn pe_create_undef_table() {
    undef_count = 0 as libc::c_int;
    ...
    udef_table = xmalloc(
        (undef_count as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<key_value>() as libc::c_ulong),
    ) as *mut key_value;
    undef_count = 0 as libc::c_int;
    bfd_link_hash_traverse(
        link_info.hash,
...
unsafe extern "C" fn pe_get16(
    mut abfd: *mut bfd,
    mut where_0: libc::c_int,
) -> libc::c_uint {
    let mut b: [libc::c_uchar; 2] = [0; 2];
    bfd_seek(abfd, where_0 as file_ptr, 0 as libc::c_int);
    bfd_bread(
        b.as_mut_ptr() as *mut libc::c_void,
        2 as libc::c_int as bfd_size_type,
        abfd,
    );
    return (b[0 as libc::c_int as usize] as libc::c_int
        + ((b[1 as libc::c_int as usize] as libc::c_int) << 8 as libc::c_int))
        as libc::c_uint;
}
unsafe extern "C" fn pe_get32(
    mut abfd: *mut bfd,
    mut where_0: libc::c_int,
) -> libc::c_uint {
    ...
    return ((b[0 as libc::c_int as usize] as libc::c_int
        + ((b[1 as libc::c_int as usize] as libc::c_int) << 8 as libc::c_int)
        + ((b[2 as libc::c_int as usize] as libc::c_int) << 16 as libc::c_int))
        as libc::c_uint)
        .wrapping_add(
            (b[3 as libc::c_int as usize] as libc::c_uint) << 24 as libc::c_int,
        );
}
unsafe extern "C" fn pe_as32(mut ptr: *mut libc::c_void) -> libc::c_uint {
    let mut b: *mut libc::c_uchar = ptr as *mut libc::c_uchar;
    return ((*b.offset(0 as libc::c_int as isize) as libc::c_int
        + ((*b.offset(1 as libc::c_int as isize) as libc::c_int) << 8 as libc::c_int)
        + ((*b.offset(2 as libc::c_int as isize) as libc::c_int) << 16 as libc::c_int))
        as libc::c_uint)
        .wrapping_add(
            (*b.offset(3 as libc::c_int as isize) as libc::c_uint) << 24 as libc::c_int,
        );
}
unsafe extern "C" fn run_static_initializers() {
    autofilter_symbollist_generic = [
        {
            let mut init = autofilter_entry_type {
                name: b"_NULL_IMPORT_DESCRIPTOR\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"DllMain\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"DllMainCRTStartup\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_DllMainCRTStartup\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_pei386_runtime_relocator\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"do_pseudo_reloc\0" as *const u8 as *const libc::c_char,
    ...
    autofilter_symbollist_i386 = [
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"cygwin_crt0\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"DllMain@12\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"DllEntryPoint@0\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"DllMainCRTStartup@12\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_cygwin_dll_entry@12\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_cygwin_crt0_common@8\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_cygwin_noncygwin_dll_entry@12\0" as *const u8
                    as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 31]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        },
        {
            let mut init = autofilter_entry_type {
                name: b"cygwin_attach_dll\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 18]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"cygwin_premain0\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"cygwin_premain1\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"cygwin_premain2\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"cygwin_premain3\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 16]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"impure_ptr\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_impure_ptr\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 12]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_fmode\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"__dso_handle\0" as *const u8 as *const libc::c_char,
    ...
    autofilter_liblist = [
        {
            let mut init = autofilter_entry_type {
                name: b"libcegcc\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libcygwin\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libgcc\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libgcc_s\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libstdc++\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libmingw32\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libmingwex\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libg2c\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libsupc++\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libobjc\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libgcj\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libmsvcrt\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libmsvcrt-os\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 13]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"libucrtbase\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 12]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
    ...
    autofilter_objlist = [
        {
            let mut init = autofilter_entry_type {
                name: b"crt0.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"crt1.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"crt2.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"dllcrt1.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"dllcrt2.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"gcrt0.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"gcrt1.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"gcrt2.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"crtbegin.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"crtend.o\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
    ...
    autofilter_symbolprefixlist = [
        {
            let mut init = autofilter_entry_type {
                name: b"__rtti_\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"__builtin_\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 11]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"__nm_\0" as *const u8 as *const libc::c_char,
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_head_\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_IMPORT_DESCRIPTOR_\0" as *const u8 as *const libc::c_char,
    ...
    autofilter_symbolsuffixlist = [
        {
            let mut init = autofilter_entry_type {
                name: b"_iname\0" as *const u8 as *const libc::c_char,
                len: (::core::mem::size_of::<[libc::c_char; 7]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int,
            };
            init
        ...
        {
            let mut init = autofilter_entry_type {
                name: b"_NULL_THUNK_DATA\0" as *const u8 as *const libc::c_char,
