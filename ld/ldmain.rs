...
extern "C" {
    ...
    fn bfd_hash_set_default_size(_: libc::c_ulong) -> libc::c_ulong;
    fn bfd_cache_close_all() -> bool;
    ...
    fn bfd_set_assert_handler(_: bfd_assert_handler_type) -> bfd_assert_handler_type;
    ...
    fn bfd_set_default_target(name: *const libc::c_char) -> bool;
    ...
    fn add_cref(_: *const libc::c_char, _: *mut bfd, _: *mut asection, _: bfd_vma);
    fn setlocale(
        __category: libc::c_int,
        __locale: *const libc::c_char,
    ) -> *mut libc::c_char;
    fn handle_asneeded_cref(_: *mut bfd, _: notice_asneeded_action) -> bool;
    fn output_cref(_: *mut FILE);
    fn check_nocrossrefs();
    ...
    fn ldexp_init();
    fn ldexp_finish();
    static mut nocrossref_list: *mut lang_nocrossrefs;
    static mut lang_has_input_file: bool;
    static mut delete_output_file_on_failure: bool;
    fn lang_init();
    fn lang_finish();
    fn lang_map();
    fn lang_final();
    ...
    fn lang_get_output_target() -> *const libc::c_char;
    fn ldlang_ctf_acquire_strings(_: *mut elf_strtab_hash);
    fn ldlang_ctf_new_dynsym(symidx: libc::c_int, _: *mut elf_internal_sym);
    fn ldlang_write_ctf_late();
    fn ldlang_override_segment_assignment(
        _: *mut bfd_link_info,
        _: *mut bfd,
        _: *mut asection,
        _: *mut asection,
    ...
    fn parse_args(_: libc::c_uint, _: *mut *mut libc::c_char);
    fn ldfile_add_arch(_: *const libc::c_char);
    fn ldfile_open_script_file(name: *const libc::c_char);
    fn ldfile_open_default_command_file(name: *const libc::c_char);
    fn ldemul_after_parse();
    fn ldemul_before_parse();
    fn ldemul_choose_target(
        _: libc::c_int,
        _: *mut *mut libc::c_char,
    ) -> *mut libc::c_char;
    fn ldemul_choose_mode(_: *mut libc::c_char);
    fn ldemul_get_script(isfile: *mut libc::c_int) -> *mut libc::c_char;
    fn ldemul_set_symbols();
    fn ldctor_add_set_entry(
    ...
    static mut no_more_claiming: bool;
    fn plugin_load_plugins();
    fn plugin_maybe_claim(_: *mut lang_input_statement_type);
    fn plugin_call_cleanup();
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dependency_file {
    pub next: *mut dependency_file,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct warning_callback_info {
    pub found: bool,
    pub warning: *const libc::c_char,
    pub symbol: *const libc::c_char,
    pub asymbols: *mut *mut asymbol,
}
#[inline]
...
#[no_mangle]
pub static mut sort_section: sort_type = none;
#[no_mangle]
pub static mut command_line: args_type = args_type {
    force_common_definition: false,
    embedded_relocs: false,
    force_exe_suffix: false,
    cref: false,
    warn_mismatch: false,
    warn_search_mismatch: false,
    check_section_addresses: 0,
    accept_unknown_input_arch: false,
    out_implib_filename: 0 as *const libc::c_char as *mut libc::c_char,
    print_output_format: false,
    print_memory_usage: false,
    force_group_allocation: false,
    endian: ENDIAN_UNSET,
    interpreter: 0 as *const libc::c_char as *mut libc::c_char,
    soname: 0 as *const libc::c_char as *mut libc::c_char,
    rpath: 0 as *const libc::c_char as *mut libc::c_char,
    rpath_link: 0 as *const libc::c_char as *mut libc::c_char,
    filter_shlib: 0 as *const libc::c_char as *mut libc::c_char,
    auxiliary_filters: 0 as *const *mut libc::c_char as *mut *mut libc::c_char,
    version_exports_section: 0 as *const libc::c_char as *mut libc::c_char,
    default_script: 0 as *const libc::c_char as *mut libc::c_char,
};
#[no_mangle]
pub static mut saved_script_handle: *mut FILE = 0 as *const FILE as *mut FILE;
#[no_mangle]
pub static mut config: ld_config_type = ld_config_type {
    magic_demand_paged: false,
    make_executable: false,
    has_shared: false,
    build_constructors: false,
    warn_constructors: false,
    warn_common: false,
    warn_once: false,
    orphan_handling: orphan_handling_place,
    warn_multiple_gp: false,
    warn_section_align: false,
    fatal_warnings: false,
    sort_common: sort_none,
    text_read_only: false,
    stats: false,
    unique_orphan_sections: false,
    only_cmd_line_lib_dirs: false,
    sane_expr: false,
    separate_code: false,
    rpath_separator: 0,
    map_filename: 0 as *const libc::c_char as *mut libc::c_char,
    map_file: 0 as *const FILE as *mut FILE,
    dependency_file: 0 as *const libc::c_char as *mut libc::c_char,
    split_by_reloc: 0,
    split_by_file: 0,
    hash_table_size: 0,
    print_map_discarded: false,
    ctf_variables: false,
    ctf_share_duplicated: false,
};
#[no_mangle]
pub static mut force_make_executable: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub static mut program_name: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
#[no_mangle]
pub static mut ld_sysroot: *const libc::c_char = 0 as *const libc::c_char;
#[no_mangle]
pub static mut ld_canon_sysroot: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
#[no_mangle]
pub static mut ld_canon_sysroot_len: libc::c_int = 0;
#[no_mangle]
pub static mut previous_script_handle: *mut FILE = 0 as *const FILE as *mut FILE;
#[no_mangle]
pub static mut default_target: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
#[no_mangle]
pub static mut trace_files: libc::c_uint = 0;
#[no_mangle]
pub static mut verbose: bool = false;
#[no_mangle]
pub static mut version_printed: bool = false;
#[no_mangle]
pub static mut demangling: bool = false;
#[no_mangle]
pub static mut g_switch_value: libc::c_int = 8 as libc::c_int;
#[no_mangle]
pub static mut output_filename: *const libc::c_char = b"a.out\0" as *const u8
    as *const libc::c_char;
#[no_mangle]
pub static mut link_info: bfd_link_info = bfd_link_info {
    type_0_symbolic_nocopyreloc_export_dynamic_create_default_symver_gc_sections_gc_keep_exported_notice_all_lto_plugin_active_lto_all_symbols_read_strip_discarded_dynamic_data_resolve_section_groups_big_endian_strip_discard_elf_stt_common_common_skip_ar_symbols_unresolved_syms_in_objects_unresolved_syms_in_shared_libs_warn_unresolved_syms_static_link_keep_memory_emitrelocations_relro_separate_code_eh_frame_hdr_type_textrel_check_emit_hash_emit_gnu_hash_reduce_memory_overheads_traditional_format_combreloc_default_imported_symver_new_dtags_no_ld_generated_unwind_info_task_link_allow_multiple_definition_prohibit_multiple_definition_absolute_warn_multiple_definition_allow_undefined_version_dynamic_execstack_noexecstack_optimize_print_gc_sections_warn_alternate_em_user_phdrs_load_phdrs_check_relocs_after_open_input_nointerp_inhibit_common_definition_has_map_file_non_contiguous_regions_non_contiguous_regions_warnings_unique_symbol: [0; 9],
    wrap_char: 0,
    path_separator: 0,
    compress_debug: COMPRESS_DEBUG_NONE,
    stacksize: 0,
    disable_target_specific_optimizations: 0,
    callbacks: 0 as *const bfd_link_callbacks,
    hash: 0 as *const bfd_link_hash_table as *mut bfd_link_hash_table,
    keep_hash: 0 as *const bfd_hash_table as *mut bfd_hash_table,
    notice_hash: 0 as *const bfd_hash_table as *mut bfd_hash_table,
    wrap_hash: 0 as *const bfd_hash_table as *mut bfd_hash_table,
    ignore_hash: 0 as *const bfd_hash_table as *mut bfd_hash_table,
    output_bfd: 0 as *const bfd as *mut bfd,
    out_implib_bfd: 0 as *const bfd as *mut bfd,
    input_bfds: 0 as *const bfd as *mut bfd,
    input_bfds_tail: 0 as *const *mut bfd as *mut *mut bfd,
    create_object_symbols_section: 0 as *const asection as *mut asection,
    gc_sym_list: 0 as *const bfd_sym_chain as *mut bfd_sym_chain,
    base_file: 0 as *const libc::c_void as *mut libc::c_void,
    init_function: 0 as *const libc::c_char,
    fini_function: 0 as *const libc::c_char,
    relax_pass: 0,
    relax_trip: 0,
    extern_protected_data: 0,
    dynamic_undefined_weak: 0,
    pei386_auto_import: 0,
    pei386_runtime_pseudo_reloc: 0,
    spare_dynamic_tags: 0,
    flags: 0,
    flags_1: 0,
    gnu_flags_1: 0,
    start_stop_gc: 0,
    start_stop_visibility: 0,
    maxpagesize: 0,
    commonpagesize: 0,
    relro_start: 0,
    relro_end: 0,
    dynamic_list: 0 as *const bfd_elf_dynamic_list as *mut bfd_elf_dynamic_list,
    version_info: 0 as *const bfd_elf_version_tree as *mut bfd_elf_version_tree,
};
#[no_mangle]
pub static mut overflow_cutoff_limit: libc::c_int = 10 as libc::c_int;
#[no_mangle]
pub static mut error_handling_script: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
#[no_mangle]
pub unsafe extern "C" fn add_ysym(mut name: *const libc::c_char) {
    if (link_info.notice_hash).is_null() {
        link_info
            .notice_hash = xmalloc(
            ::core::mem::size_of::<bfd_hash_table>() as libc::c_ulong,
        ...
        .is_null()
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: bfd_hash_lookup failed: %E\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
#[no_mangle]
pub unsafe extern "C" fn add_wrap(mut name: *const libc::c_char) {
    if (link_info.wrap_hash).is_null() {
        link_info
            .wrap_hash = xmalloc(
            ::core::mem::size_of::<bfd_hash_table>() as libc::c_ulong,
        ) as *mut bfd_hash_table;
...
#[no_mangle]
pub unsafe extern "C" fn add_ignoresym(
    mut info: *mut bfd_link_info,
    mut name: *const libc::c_char,
) {
    if ((*info).ignore_hash).is_null() {
        (*info)
            .ignore_hash = xmalloc(
            ::core::mem::size_of::<bfd_hash_table>() as libc::c_ulong,
        ) as *mut bfd_hash_table;
...
#[no_mangle]
pub unsafe extern "C" fn add_keepsyms_file(mut filename: *const libc::c_char) {
    let mut file: *mut FILE = 0 as *mut FILE;
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut bufsize: size_t = 0;
    let mut c: libc::c_int = 0;
    if link_info.strip() as libc::c_int == strip_some as libc::c_int {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: error: duplicate retain-symbols-file\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    link_info
        .keep_hash = xmalloc(::core::mem::size_of::<bfd_hash_table>() as libc::c_ulong)
        as *mut bfd_hash_table;
    ...
    while c != -(1 as libc::c_int) {
        while _sch_istable[(c & 0xff as libc::c_int) as usize] as libc::c_int
        ...
        if c != -(1 as libc::c_int) {
            ...
            while _sch_istable[(c & 0xff as libc::c_int) as usize] as libc::c_int
                ...
                && c != -(1 as libc::c_int)
            {
                *buf.offset(len as isize) = c as libc::c_char;
                ...
                if len >= bufsize {
                    bufsize = (bufsize as libc::c_ulong)
                        ...
                        as size_t;
                    buf = xrealloc(buf as *mut libc::c_void, bufsize)
                        as *mut libc::c_char;
                }
                c = getc(file);
            }
            *buf.offset(len as isize) = '\0' as i32 as libc::c_char;
                ...
                .is_null()
            {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P: bfd_hash_lookup for insertion failed: %E\n\0"
    ...
    if link_info.strip() as libc::c_int != strip_none as libc::c_int {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: `-retain-symbols-file' overrides `-s' and `-S'\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    link_info.set_strip(strip_some);
    fclose(file);
}
#[no_mangle]
pub unsafe extern "C" fn track_dependency_files(mut filename: *const libc::c_char) {
    let mut dep: *mut dependency_file = xmalloc(
        ::core::mem::size_of::<dependency_file>() as libc::c_ulong,
    ) as *mut dependency_file;
    (*dep).name = xstrdup(filename);
    (*dep).next = 0 as *mut dependency_file;
    if dependency_files.is_null() {
...
unsafe extern "C" fn get_sysroot(
    mut argc: libc::c_int,
    ...
    while i < argc {
        if startswith(
            *argv.offset(i as isize),
            b"--sysroot=\0" as *const u8 as *const libc::c_char,
        ) {
            path = (*argv.offset(i as isize))
                .offset(
                    strlen(b"--sysroot=\0" as *const u8 as *const libc::c_char) as isize,
                );
        }
        i += 1;
        i;
    ...
    if path.is_null() {
        path = get_relative_sysroot(
            b"/usr/local/bin\0" as *const u8 as *const libc::c_char,
        );
    }
    if path.is_null() {
        path = get_relative_sysroot(
            b"/usr/local/x86_64-pc-linux-gnu/bin\0" as *const u8 as *const libc::c_char,
        );
    }
    if path.is_null() {
    ...
    if (*path as libc::c_int == '/' as i32
        || *path as libc::c_int == '\\' as i32 && 0 as libc::c_int != 0)
        && *path.offset(1 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
    {
        path = b"\0" as *const u8 as *const libc::c_char;
    }
    return path;
}
unsafe extern "C" fn get_emulation(
    mut argc: libc::c_int,
    mut argv: *mut *mut libc::c_char,
) -> *mut libc::c_char {
    let mut emulation: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: libc::c_int = 0;
    emulation = getenv(b"LDEMULATION\0" as *const u8 as *const libc::c_char);
    if emulation.is_null() {
        emulation = b"elf_x86_64\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char;
    }
    i = 1 as libc::c_int;
    while i < argc {
            ...
            *argv.offset(i as isize),
                ...
                as libc::c_int == '\0' as i32
            {
                if i < argc - 1 as libc::c_int {
                    emulation = *argv.offset((i + 1 as libc::c_int) as isize);
                    i += 1;
                    i;
                } else {
                    einfo(
                ...
                *argv.offset(i as isize),
                ...
                || strcmp(
                    *argv.offset(i as isize),
                    b"-mips32r3\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                || strcmp(
                    *argv.offset(i as isize),
                    b"-mips32r5\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                || strcmp(
                    *argv.offset(i as isize),
                ...
                || strcmp(
                    *argv.offset(i as isize),
                    b"-mips64r3\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                || strcmp(
                    *argv.offset(i as isize),
                    b"-mips64r5\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int
                || strcmp(
                    *argv.offset(i as isize),
                ...
                ) == 0 as libc::c_int)
            {
                if !(strcmp(
                    *argv.offset(i as isize),
                    b"-m486\0" as *const u8 as *const libc::c_char,
                ) == 0 as libc::c_int)
                {
                    emulation = &mut *(*argv.offset(i as isize))
...
unsafe extern "C" fn add_archive_element(
    mut info: *mut bfd_link_info,
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut subsbfd: *mut *mut bfd,
) -> bool {
    let mut input: *mut lang_input_statement_type = 0 as *mut lang_input_statement_type;
    let mut parent: *mut lang_input_statement_type = 0 as *mut lang_input_statement_type;
    let mut orig_input: lang_input_statement_type = lang_input_statement_type {
        header: lang_statement_header_type {
            next: 0 as *mut lang_statement_union,
            type_0: lang_address_statement_enum,
        },
        filename: 0 as *const libc::c_char,
        local_sym_name: 0 as *const libc::c_char,
        extra_search_path: 0 as *const libc::c_char,
        the_bfd: 0 as *mut bfd,
        the_ctf: 0 as *mut ctf_archive_t,
        section_flag_list: 0 as *mut flag_info,
        next: 0 as *mut lang_input_statement_struct,
        next_real_file: 0 as *mut lang_input_statement_struct,
        target: 0 as *const libc::c_char,
        flags: lang_input_statement_flags {
            ...
            c2rust_padding: [0; 6],
            pushed: 0 as *mut lang_input_statement_flags,
        },
    };
    input = xcalloc(
    ...
    (*input).header.type_0 = lang_input_statement_enum;
    ...
    if link_info.lto_plugin_active() != 0 {
        ...
        if ((*input).flags).claimed() != 0 {
            if no_more_claiming {
                if verbose {
                    info_msg(
                        b"%pI: no new IR symbols to claim\n\0" as *const u8
                            as *const libc::c_char,
                        &mut orig_input as *mut lang_input_statement_type,
                    );
                }
                ((*input).flags).set_claimed(0 as libc::c_int as libc::c_uint);
                return 0 as libc::c_int != 0;
            }
            ((*input).flags).set_claim_archive(1 as libc::c_int as libc::c_uint);
            *subsbfd = (*input).the_bfd;
        }
    }
    if link_info.input_bfds_tail == &mut (*(*input).the_bfd).link.next as *mut *mut bfd
        || !((*(*input).the_bfd).link.next).is_null()
    {
        free(input as *mut libc::c_void);
        bfd_set_error(bfd_error_malformed_archive);
        return 0 as libc::c_int != 0;
    }
    parent = bfd_usrdata((*abfd).my_archive) as *mut lang_input_statement_type;
    if !parent.is_null() && ((*parent).flags).reload() == 0 {
        (*parent).next = input;
    }
    ...
    if !(config.map_file).is_null() {
        ...
        let mut from: *mut bfd = 0 as *mut bfd;
        ...
        if h.is_null() && (*info).pei386_auto_import != 0
            && startswith(name, b"__imp_\0" as *const u8 as *const libc::c_char)
                as libc::c_int != 0
        {
            h = bfd_link_hash_lookup(
                (*info).hash,
        ...
        if ((*abfd).my_archive).is_null()
            || bfd_is_thin_archive((*abfd).my_archive) as libc::c_int != 0
        {
            minfo(b"%s\0" as *const u8 as *const libc::c_char, bfd_get_filename(abfd));
            len = strlen(bfd_get_filename(abfd)) as libc::c_int;
        } else {
            minfo(
            ...
            len = (strlen(bfd_get_filename((*abfd).my_archive)))
                .wrapping_add(strlen(bfd_get_filename(abfd)))
                .wrapping_add(2 as libc::c_int as libc::c_ulong) as libc::c_int;
        }
        if len >= 29 as libc::c_int {
            print_nl();
            len = 0 as libc::c_int;
        }
        ...
        if !from.is_null() {
            minfo(b"%pB \0" as *const u8 as *const libc::c_char, from);
        }
        if !h.is_null() {
            minfo(b"(%pT)\n\0" as *const u8 as *const libc::c_char, (*h).root.string);
        } else {
            minfo(b"(%s)\n\0" as *const u8 as *const libc::c_char, name);
        }
    }
    if verbose as libc::c_int != 0 || trace_files > 1 as libc::c_int as libc::c_uint
        || trace_files != 0
            && bfd_is_thin_archive((*orig_input.the_bfd).my_archive) as libc::c_int != 0
    {
        info_msg(
...
unsafe extern "C" fn multiple_definition(
    mut info: *mut bfd_link_info,
    ...
    let mut oval: bfd_vma = 0;
    if (*info).allow_multiple_definition() != 0 {
        return;
    }
    match (*h).type_0() as libc::c_int {
        3 => {
        ...
        6 => {
            osec = &mut *_bfd_std_section.as_mut_ptr().offset(3 as libc::c_int as isize)
                as *mut asection;
            oval = 0 as libc::c_int as bfd_vma;
            obfd = 0 as *mut bfd;
        }
        _ => {
            ld_abort(
                b"./ldmain.c\0" as *const u8 as *const libc::c_char,
                1043 as libc::c_int,
                (*::core::mem::transmute::<
                    &[u8; 107],
                    &[libc::c_char; 107],
                >(
                    b"void multiple_definition(struct bfd_link_info *, struct bfd_link_hash_entry *, bfd *, asection *, bfd_vma)\0",
                ))
                    .as_ptr(),
            );
        }
    ...
    if (*h).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
        && bfd_is_abs_section(osec) as libc::c_int != 0
        && bfd_is_abs_section(nsec) as libc::c_int != 0 && nval == oval
    {
        return;
    }
    if (*info).prohibit_multiple_definition_absolute() == 0
        && (!((*osec).output_section).is_null() && !bfd_is_abs_section(osec)
            && bfd_is_abs_section((*osec).output_section) as libc::c_int != 0
            || !((*nsec).output_section).is_null() && !bfd_is_abs_section(nsec)
                && bfd_is_abs_section((*nsec).output_section) as libc::c_int != 0)
    {
        return;
    }
    name = (*h).root.string;
    ...
    if (*info).warn_multiple_definition() != 0 {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: %C: warning: multiple definition of `%pT'\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            nbfd,
        ...
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: %C: multiple definition of `%pT'\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            nbfd,
    ...
    if !obfd.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"; %D: first defined here\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            obfd,
            osec,
    ...
    if link_info.disable_target_specific_optimizations == 0 as libc::c_int {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: disabling relaxation; it will not work with multiple definitions\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
unsafe extern "C" fn multiple_common(
    ...
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut obfd: *mut bfd = 0 as *mut bfd;
    let mut otype: bfd_link_hash_type = bfd_link_hash_new;
    let mut osize: bfd_vma = 0;
    if !config.warn_common {
        return;
    }
    name = (*h).root.string;
    otype = (*h).type_0();
    if otype as libc::c_uint == bfd_link_hash_common as libc::c_int as libc::c_uint {
        obfd = (*(*(*h).u.c.p).section).owner;
        osize = (*h).u.c.size;
    } else if otype as libc::c_uint
        == bfd_link_hash_defined as libc::c_int as libc::c_uint
        || otype as libc::c_uint == bfd_link_hash_defweak as libc::c_int as libc::c_uint
    {
        obfd = (*(*h).u.def.section).owner;
        osize = 0 as libc::c_int as bfd_vma;
    } else {
        obfd = 0 as *mut bfd;
        osize = 0 as libc::c_int as bfd_vma;
    }
    if ntype as libc::c_uint == bfd_link_hash_defined as libc::c_int as libc::c_uint
        || ntype as libc::c_uint == bfd_link_hash_defweak as libc::c_int as libc::c_uint
        || ntype as libc::c_uint == bfd_link_hash_indirect as libc::c_int as libc::c_uint
    {
        if !(otype as libc::c_uint
            == bfd_link_hash_common as libc::c_int as libc::c_uint)
        {
            info_assert(
                b"./ldmain.c\0" as *const u8 as *const libc::c_char,
        ...
        if !obfd.is_null() {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: definition of `%pT' overriding common from %pB\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                nbfd,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: definition of `%pT' overriding common\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                nbfd,
        ...
        == bfd_link_hash_defined as libc::c_int as libc::c_uint
        || otype as libc::c_uint == bfd_link_hash_defweak as libc::c_int as libc::c_uint
        || otype as libc::c_uint == bfd_link_hash_indirect as libc::c_int as libc::c_uint
    {
        if !(ntype as libc::c_uint
            == bfd_link_hash_common as libc::c_int as libc::c_uint)
        {
            info_assert(
                b"./ldmain.c\0" as *const u8 as *const libc::c_char,
        ...
        if !obfd.is_null() {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: common of `%pT' overridden by definition from %pB\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                nbfd,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: common of `%pT' overridden by definition\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                nbfd,
        ...
        if osize > nsize {
            if !obfd.is_null() {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %pB: warning: common of `%pT' overridden by larger common from %pB\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    nbfd,
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %pB: warning: common of `%pT' overridden by larger common\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    nbfd,
            ...
            if !obfd.is_null() {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %pB: warning: common of `%pT' overriding smaller common from %pB\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    nbfd,
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %pB: warning: common of `%pT' overriding smaller common\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    nbfd,
        ...
        } else if !obfd.is_null() {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB and %pB: warning: multiple common of `%pT'\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                nbfd,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: multiple common of `%pT'\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                nbfd,
...
unsafe extern "C" fn add_to_set(
    ...
    if config.warn_constructors {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%P: warning: global constructor %s used\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*h).root.string,
    ...
    ldctor_add_set_entry(h, reloc, 0 as *const libc::c_char, section, value);
    if (*h).type_0() as libc::c_int == bfd_link_hash_new as libc::c_int {
        (*h).set_type_0(bfd_link_hash_undefined);
        (*h).u.undef.abfd = abfd;
    }
}
unsafe extern "C" fn constructor_callback(
    mut info: *mut bfd_link_info,
    ...
    let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut set_name: [libc::c_char; 15] = [0; 15];
    if config.warn_constructors {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
    ...
    if (bfd_reloc_type_lookup((*info).output_bfd, BFD_RELOC_CTOR)).is_null()
        && ((*info).type_0() as libc::c_int == type_relocatable as libc::c_int
            || (bfd_reloc_type_lookup(abfd, BFD_RELOC_CTOR)).is_null())
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: BFD backend error: BFD_RELOC_CTOR unsupported\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    }
    s = set_name.as_mut_ptr();
    if bfd_get_symbol_leading_char(abfd) as libc::c_int != '\0' as i32 {
        let fresh0 = s;
        s = s.offset(1);
        *fresh0 = bfd_get_symbol_leading_char(abfd);
    }
    if constructor {
        strcpy(s, b"__CTOR_LIST__\0" as *const u8 as *const libc::c_char);
    } else {
        strcpy(s, b"__DTOR_LIST__\0" as *const u8 as *const libc::c_char);
    }
    h = bfd_link_hash_lookup(
        (*info).hash,
        set_name.as_mut_ptr(),
...
unsafe extern "C" fn warning_callback(
    ...
    if !config.warn_multiple_gp
        && strcmp(
            warning,
            b"using multiple gp values\0" as *const u8 as *const libc::c_char,
        ) == 0 as libc::c_int
    {
        return;
    }
    if !section.is_null() {
        ...
        b = (*info).input_bfds;
        while !b.is_null() {
            if b != abfd && symbol_warning(warning, symbol, b) as libc::c_int != 0 {
                return;
            }
            b = (*b).link.next;
        }
...
unsafe extern "C" fn warning_find_reloc(
    mut abfd: *mut bfd,
    mut sec: *mut asection,
    mut iarg: *mut libc::c_void,
) {
    let mut info: *mut warning_callback_info = iarg as *mut warning_callback_info;
    ...
    let mut pend: *mut *mut arelent = 0 as *mut *mut arelent;
    if (*info).found {
        return;
    }
    ...
    if relsize < 0 as libc::c_int as libc::c_long {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: %pB: could not read relocs: %E\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
    ...
    p = relpp;
    pend = p.offset(relcount as isize);
    while p < pend && !(*p).is_null() {
        let mut q: *mut arelent = *p;
        if !((*q).sym_ptr_ptr).is_null() && !(*(*q).sym_ptr_ptr).is_null()
            && strcmp(bfd_asymbol_name(*(*q).sym_ptr_ptr), (*info).symbol)
                == 0 as libc::c_int
        {
            einfo(
                b"%P: %C: %s%s\n\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn undefined_symbol(
    mut info: *mut bfd_link_info,
    mut name: *const libc::c_char,
    mut abfd: *mut bfd,
    mut section: *mut asection,
    ...
    static mut error_name: *mut libc::c_char = 0 as *const libc::c_char
        as *mut libc::c_char;
    static mut error_count: libc::c_uint = 0;
    if !((*info).ignore_hash).is_null()
        && !(bfd_hash_lookup(
            (*info).ignore_hash,
            name,
    ...
    if !error_name.is_null() && strcmp(name, error_name) == 0 as libc::c_int {
        error_count = error_count.wrapping_add(1);
        error_count;
    } else {
        error_count = 0 as libc::c_int as libc::c_uint;
        free(error_name as *mut libc::c_void);
        error_name = xstrdup(name);
    }
    if !error_handling_script.is_null() && error_count < 5 as libc::c_int as libc::c_uint
    {
        let mut argv: [*mut libc::c_char; 4] = [0 as *mut libc::c_char; 4];
        let mut res: *const libc::c_char = 0 as *const libc::c_char;
        let mut status: libc::c_int = 0;
        let mut err: libc::c_int = 0;
        argv[0 as libc::c_int as usize] = error_handling_script;
        argv[1 as libc::c_int
            as usize] = b"undefined-symbol\0" as *const u8 as *const libc::c_char
            as *mut libc::c_char;
        argv[2 as libc::c_int as usize] = name as *mut libc::c_char;
        argv[3 as libc::c_int as usize] = 0 as *mut libc::c_char;
        if verbose {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: About to run error handling script '%s' with arguments: '%s' '%s'\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                argv[0 as libc::c_int as usize],
                argv[1 as libc::c_int as usize],
                argv[2 as libc::c_int as usize],
            );
        }
        res = pex_one(
            0x2 as libc::c_int,
            ...
            argv.as_mut_ptr(),
            b"error handling script\0" as *const u8 as *const libc::c_char,
            0 as *const libc::c_char,
            0 as *const libc::c_char,
            &mut status,
            &mut err,
        ...
        if !res.is_null() {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: Failed to run error handling script '%s', reason: \0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                error_handling_script,
    ...
    if !section.is_null() {
        if error_count < 5 as libc::c_int as libc::c_uint {
            if error {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%X%P: %C: undefined reference to `%pT'\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    abfd,
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %C: warning: undefined reference to `%pT'\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    abfd,
        ...
        } else if error_count == 5 as libc::c_int as libc::c_uint {
            if error {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%X%P: %D: more undefined references to `%pT' follow\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    abfd,
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%P: %D: warning: more undefined references to `%pT' follow\n\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    abfd,
            ...
            einfo(b"%X\0" as *const u8 as *const libc::c_char);
        }
    } else if error_count < 5 as libc::c_int as libc::c_uint {
        if error {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: %pB: undefined reference to `%pT'\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: undefined reference to `%pT'\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
        ...
        if error {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%X%P: %pB: more undefined references to `%pT' follow\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
            ...
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: %pB: warning: more undefined references to `%pT' follow\n\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
...
unsafe extern "C" fn reloc_overflow(
    mut info: *mut bfd_link_info,
    ...
    if overflow_cutoff_limit == -(1 as libc::c_int) {
        return;
    }
    einfo(b"%X%H:\0" as *const u8 as *const libc::c_char, abfd, section, address);
    if overflow_cutoff_limit >= 0 as libc::c_int
        && {
            let fresh1 = overflow_cutoff_limit;
            overflow_cutoff_limit = overflow_cutoff_limit - 1;
        ...
        }
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b" additional relocation overflows omitted from the output\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if !entry.is_null() {
        while (*entry).type_0() as libc::c_int == bfd_link_hash_indirect as libc::c_int
            || (*entry).type_0() as libc::c_int == bfd_link_hash_warning as libc::c_int
        {
        ...
        match (*entry).type_0() as libc::c_int {
            1 | 2 => {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b" relocation truncated to fit: %s against undefined symbol `%pT'\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    reloc_name,
            ...
            3 | 4 => {
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b" relocation truncated to fit: %s against symbol `%pT' defined in %pA section in %pB\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    reloc_name,
            ...
            _ => {
                ld_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 139],
                    >(
                        b"void reloc_overflow(struct bfd_link_info *, struct bfd_link_hash_entry *, const char *, const char *, bfd_vma, bfd *, asection *, bfd_vma)\0",
                    ))
                        .as_ptr(),
                );
            }
        ...
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b" relocation truncated to fit: %s against `%pT'\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            reloc_name,
    ...
    if addend != 0 as libc::c_int as libc::c_ulong {
        einfo(b"+%v\0" as *const u8 as *const libc::c_char, addend);
    }
    einfo(b"\n\0" as *const u8 as *const libc::c_char);
}
...
unsafe extern "C" fn unattached_reloc(
    ...
    einfo(
        dcgettext(
            0 as *const libc::c_char,
            b"%X%H: reloc refers to symbol `%pT' which is not being output\n\0"
                as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        abfd,
...
unsafe extern "C" fn notice(
    ...
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    if h.is_null() {
        if command_line.cref as libc::c_int != 0 || !nocrossref_list.is_null() {
            return handle_asneeded_cref(abfd, value as notice_asneeded_action);
        }
        return 1 as libc::c_int != 0;
    }
    name = (*h).root.string;
    if !((*info).notice_hash).is_null()
        && !(bfd_hash_lookup(
            (*info).notice_hash,
            name,
            0 as libc::c_int != 0,
...
static mut link_callbacks: bfd_link_callbacks = unsafe {
    {
        let mut init = bfd_link_callbacks {
            add_archive_element: Some(
                add_archive_element
                    as unsafe extern "C" fn(
                        *mut bfd_link_info,
                        *mut bfd,
            ...
            einfo: Some(einfo as unsafe extern "C" fn(*const libc::c_char, ...) -> ()),
            info: Some(info_msg as unsafe extern "C" fn(*const libc::c_char, ...) -> ()),
            minfo: Some(minfo as unsafe extern "C" fn(*const libc::c_char, ...) -> ()),
            override_segment_assignment: Some(
            ...
            examine_strtab: Some(
                ldlang_ctf_acquire_strings
                    as unsafe extern "C" fn(*mut elf_strtab_hash) -> (),
            ),
            ctf_new_symbol: None,
            ctf_new_dynsym: Some(
                ldlang_ctf_new_dynsym
                    as unsafe extern "C" fn(libc::c_int, *mut elf_internal_sym) -> (),
            ),
            emit_ctf: Some(ldlang_write_ctf_late as unsafe extern "C" fn() -> ()),
        };
        init
    }
};
static mut default_bfd_assert_handler: bfd_assert_handler_type = None;
static mut default_bfd_error_handler: bfd_error_handler_type = None;
static mut dependency_files: *mut dependency_file = 0 as *const dependency_file
    as *mut dependency_file;
static mut dependency_files_tail: *mut dependency_file = 0 as *const dependency_file
    as *mut dependency_file;
unsafe extern "C" fn write_dependency_file() {
    let mut out: *mut FILE = 0 as *mut FILE;
    let mut dep: *mut dependency_file = 0 as *mut dependency_file;
    out = fopen(config.dependency_file, b"w\0" as *const u8 as *const libc::c_char);
    if out.is_null() {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: cannot open dependency file %s: %E\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
    ...
    fprintf(out, b"%s:\0" as *const u8 as *const libc::c_char, output_filename);
    dep = dependency_files;
    while !dep.is_null() {
        fprintf(out, b" \\\n  %s\0" as *const u8 as *const libc::c_char, (*dep).name);
        dep = (*dep).next;
    }
    fprintf(out, b"\n\0" as *const u8 as *const libc::c_char);
    dep = dependency_files;
    while !dep.is_null() {
        fprintf(out, b"\n%s:\n\0" as *const u8 as *const libc::c_char, (*dep).name);
        dep = (*dep).next;
    }
    fclose(out);
}
unsafe extern "C" fn ld_cleanup() {
    bfd_cache_close_all();
    plugin_call_cleanup();
    if !output_filename.is_null() && delete_output_file_on_failure as libc::c_int != 0 {
        unlink_if_ordinary(output_filename);
    }
}
unsafe extern "C" fn ld_bfd_assert_handler(
    mut fmt: *const libc::c_char,
    mut bfdver: *const libc::c_char,
    mut file: *const libc::c_char,
    mut line: libc::c_int,
) {
    config.make_executable = 0 as libc::c_int != 0;
    (Some(default_bfd_assert_handler.expect("non-null function pointer")))
        .expect("non-null function pointer")(fmt, bfdver, file, line);
}
unsafe extern "C" fn ld_bfd_error_handler(
    mut fmt: *const libc::c_char,
    ...
    (Some(default_bfd_error_handler.expect("non-null function pointer")))
        .expect("non-null function pointer")(fmt, ap.as_va_list());
}
unsafe fn main_0(
    mut argc: libc::c_int,
    mut argv: *mut *mut libc::c_char,
    ...
    let mut emulation: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut start_time: libc::c_long = get_run_time();
    ...
    textdomain(b"ld\0" as *const u8 as *const libc::c_char);
        ...
        != ::core::mem::size_of::<bfd_section>() as libc::c_ulong
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: fatal error: libbfd ABI mismatch\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    default_bfd_assert_handler = bfd_set_assert_handler(
        Some(
            ld_bfd_assert_handler
                as unsafe extern "C" fn(
                    *const libc::c_char,
                    *const libc::c_char,
                    *const libc::c_char,
    ...
    default_bfd_error_handler = bfd_set_error_handler(
        Some(
            ld_bfd_error_handler
                as unsafe extern "C" fn(*const libc::c_char, ::core::ffi::VaList) -> (),
        ),
    );
    xatexit(Some(ld_cleanup as unsafe extern "C" fn() -> ()));
    ld_sysroot = get_sysroot(argc, argv);
    if *ld_sysroot != 0 {
        ld_canon_sysroot = lrealpath(ld_sysroot);
    }
    if !ld_canon_sysroot.is_null() {
        ld_canon_sysroot_len = strlen(ld_canon_sysroot) as libc::c_int;
        if ld_canon_sysroot_len > 0 as libc::c_int
            && (*ld_canon_sysroot
                .offset((ld_canon_sysroot_len - 1 as libc::c_int) as isize)
                    ...
                    as libc::c_int == '\\' as i32 && 0 as libc::c_int != 0)
        {
            ...
            *ld_canon_sysroot
                .offset(ld_canon_sysroot_len as isize) = '\0' as i32 as libc::c_char;
        }
    } else {
        ld_canon_sysroot_len = -(1 as libc::c_int);
    }
    if !bfd_set_default_target(
        b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char,
    ) {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%X%P: can't set BFD default target to `%s': %E\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char,
    ...
    config.rpath_separator = ':' as i32 as libc::c_char;
    config.split_by_reloc = -(1 as libc::c_int) as libc::c_uint;
    config.split_by_file = -(1 as libc::c_int) as bfd_size_type;
    config.make_executable = 1 as libc::c_int != 0;
    ...
    command_line.warn_mismatch = 1 as libc::c_int != 0;
    command_line.warn_search_mismatch = 1 as libc::c_int != 0;
    command_line.check_section_addresses = -(1 as libc::c_int) as libc::c_schar;
    demangling = (getenv(b"COLLECT_NO_DEMANGLE\0" as *const u8 as *const libc::c_char))
        .is_null();
    link_info.set_allow_undefined_version(1 as libc::c_int as libc::c_uint);
    link_info.set_keep_memory(1 as libc::c_int as libc::c_uint);
    link_info.set_combreloc(1 as libc::c_int as libc::c_uint);
    link_info.set_strip_discarded(1 as libc::c_int as libc::c_uint);
    link_info
        .set_prohibit_multiple_definition_absolute(0 as libc::c_int as libc::c_uint);
    ...
    link_info.callbacks = &mut link_callbacks;
    link_info.input_bfds_tail = &mut link_info.input_bfds;
    link_info.init_function = b"_init\0" as *const u8 as *const libc::c_char;
    link_info.fini_function = b"_fini\0" as *const u8 as *const libc::c_char;
    link_info.relax_pass = 1 as libc::c_int;
    link_info.extern_protected_data = -(1 as libc::c_int);
    link_info.dynamic_undefined_weak = -(1 as libc::c_int);
    link_info.pei386_auto_import = -(1 as libc::c_int);
    link_info.spare_dynamic_tags = 5 as libc::c_int as libc::c_uint;
    link_info.path_separator = ':' as i32 as libc::c_char;
    ...
    ldfile_add_arch(b"\0" as *const u8 as *const libc::c_char);
    ...
    ldexp_init();
    ldemul_before_parse();
    lang_has_input_file = 0 as libc::c_int != 0;
    parse_args(argc as libc::c_uint, argv);
    if config.hash_table_size != 0 as libc::c_int as libc::c_ulong {
        bfd_hash_set_default_size(config.hash_table_size);
    }
    plugin_load_plugins();
    ldemul_set_symbols();
    if saved_script_handle.is_null() && !(command_line.default_script).is_null() {
        ldfile_open_script_file(command_line.default_script);
        parser_input = input_script;
        yyparse();
    }
    if saved_script_handle.is_null() {
        let mut isfile: libc::c_int = 0;
        let mut s: *mut libc::c_char = ldemul_get_script(&mut isfile);
        if isfile != 0 {
            ...
            lex_redirect(
                ...
                dcgettext(
                    0 as *const libc::c_char,
                    b"built in linker script\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
    ...
    if verbose {
        if !saved_script_handle.is_null() {
            info_msg(
                dcgettext(
                    0 as *const libc::c_char,
                    b"using external linker script:\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            ...
            info_msg(
                dcgettext(
                    0 as *const libc::c_char,
                    b"using internal linker script:\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        ...
        if !saved_script_handle.is_null() {
            static mut ld_bufsz: libc::c_int = 8193 as libc::c_int;
            let mut n: size_t = 0;
            let mut buf: *mut libc::c_char = xmalloc(ld_bufsz as size_t)
                as *mut libc::c_char;
            ...
            loop {
                n = fread(
                    ...
                    (ld_bufsz - 1 as libc::c_int) as libc::c_ulong,
                    saved_script_handle,
                );
                ...
                *buf.offset(n as isize) = 0 as libc::c_int as libc::c_char;
                info_msg(b"%s\0" as *const u8 as *const libc::c_char, buf);
            }
            rewind(saved_script_handle);
            free(buf as *mut libc::c_void);
        } else {
            let mut isfile_0: libc::c_int = 0;
            info_msg(ldemul_get_script(&mut isfile_0));
        }
        info_msg(
            b"\n==================================================\n\0" as *const u8
                as *const libc::c_char,
    ...
    if command_line.force_group_allocation as libc::c_int != 0
        || !(link_info.type_0() as libc::c_int == type_relocatable as libc::c_int)
    {
        link_info.set_resolve_section_groups(1 as libc::c_int as libc::c_uint);
    } else {
        link_info.set_resolve_section_groups(0 as libc::c_int as libc::c_uint);
    }
    ...
    lang_final();
    if argc == 2 as libc::c_int && version_printed as libc::c_int != 0 {
        xexit(0 as libc::c_int);
    }
    if link_info.inhibit_common_definition() as libc::c_int != 0
        && !(link_info.type_0() as libc::c_int == type_dll as libc::c_int)
    {
        einfo(
            dcgettext(
                0 as *const libc::c_char,
                b"%F%P: --no-define-common may not be used without -shared\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if !lang_has_input_file {
        if version_printed as libc::c_int != 0
            || command_line.print_output_format as libc::c_int != 0
        {
            xexit(0 as libc::c_int);
        }
        einfo(
    ...
    if !(config.map_filename).is_null() {
        if strcmp(config.map_filename, b"-\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        {
            ...
            if (config.map_file).is_null() {
                ...
                einfo(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"%F%P: cannot open map file %s: %E\n\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    config.map_filename,
        ...
        link_info.set_has_map_file(1 as libc::c_int as libc::c_uint);
    }
    lang_process();
    if link_info.type_0() as libc::c_int == type_relocatable as libc::c_int {
        (*link_info.output_bfd).flags &= !(0x2 as libc::c_int) as libc::c_uint;
    } else {
        (*link_info.output_bfd).flags |= 0x2 as libc::c_int as libc::c_uint;
    }
    if link_info.compress_debug as libc::c_uint
        & COMPRESS_DEBUG as libc::c_int as libc::c_uint != 0
    {
        (*link_info.output_bfd).flags |= 0x4000 as libc::c_int as libc::c_uint;
        if link_info.compress_debug as libc::c_uint
            == COMPRESS_DEBUG_GABI_ZLIB as libc::c_int as libc::c_uint
        {
            (*link_info.output_bfd).flags |= 0x20000 as libc::c_int as libc::c_uint;
        }
    }
    ldwrite();
    if !(config.map_file).is_null() {
    ...
    if command_line.cref {
        output_cref(if !(config.map_file).is_null() { config.map_file } else { stdout });
    }
    if !nocrossref_list.is_null() {
        check_nocrossrefs();
    }
    ...
    ldexp_finish();
    lang_finish();
    if !(config.dependency_file).is_null() {
    ...
    if !config.make_executable && !force_make_executable {
        if verbose {
            einfo(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%P: link errors found, deleting executable `%s'\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                output_filename,
        ...
        if !(link_info.type_0() as libc::c_int == type_relocatable as libc::c_int)
            && command_line.force_exe_suffix as libc::c_int != 0
        {
            let mut len: libc::c_int = strlen(output_filename) as libc::c_int;
                    ...
                    ) != 0 as libc::c_int
            {
                ...
                let bsize: libc::c_int = 4096 as libc::c_int;
                let mut buf_0: *mut libc::c_char = xmalloc(bsize as size_t)
                    as *mut libc::c_char;
                let mut l: libc::c_int = 0;
                let mut dst_name: *mut libc::c_char = xmalloc(
                    (len + 5 as libc::c_int) as size_t,
                ) as *mut libc::c_char;
                strcpy(dst_name, output_filename);
                strcat(dst_name, b".exe\0" as *const u8 as *const libc::c_char);
                src = fopen(output_filename, b"r\0" as *const u8 as *const libc::c_char);
                dst = fopen(dst_name, b"w\0" as *const u8 as *const libc::c_char);
                if src.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: unable to open for source of copy `%s'\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        output_filename,
                ...
                if dst.is_null() {
                    einfo(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"%F%P: unable to open for destination of copy `%s'\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        dst_name,
                ...
                loop {
                    ...
                    let mut done: libc::c_int = fwrite(
    ...
    if config.stats {
        ...
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"%s: total time in link: %ld.%06ld\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            program_name,
    ...
    output_filename = 0 as *const libc::c_char;
    xexit(0 as libc::c_int);
}
...
unsafe extern "C" fn symbol_warning(
    mut warning: *const libc::c_char,
    mut symbol: *const libc::c_char,
    mut abfd: *mut bfd,
) -> bool {
    let mut cinfo: warning_callback_info = warning_callback_info {
        found: false,
        warning: 0 as *const libc::c_char,
        symbol: 0 as *const libc::c_char,
        asymbols: 0 as *mut *mut asymbol,
    };
    ...
    bfd_map_over_sections(
        ...
        &mut cinfo as *mut warning_callback_info as *mut libc::c_void,
    );
    return cinfo.found;
}
pub fn main() {
