extern "C" {
    ...
    static mut input_from_string: bool;
    fn symbol_same_p(_: *mut symbolS, _: *mut symbolS) -> libc::c_int;
    ...
    fn frag_offset_fixed_p(_: *const fragS, _: *const fragS, _: *mut offsetT) -> bool;
    fn snapshot_symbol(
        _: *mut *mut symbolS,
        _: *mut valueT,
        _: *mut segT,
    ...
    fn symbol_mark_used(_: *mut symbolS);
    ...
    fn i386_operator(
        ...
        operands: libc::c_uint,
        _: *mut libc::c_char,
    ) -> operatorT;
    static mut is_end_of_line: [libc::c_char; 0];
    fn S_GET_SEGMENT(_: *mut symbolS) -> segT;
    fn symbol_clone_if_forward_ref(_: *mut symbolS, _: libc::c_int) -> *mut symbolS;
    fn md_operand(_: *mut expressionS);
    ...
    static mut symbols_case_sensitive: libc::c_int;
    ...
    fn i386_need_index_operator() -> libc::c_int;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct expr_symbol_line {
    pub next: *mut expr_symbol_line,
    pub sym: *mut symbolS,
    pub file: *const libc::c_char,
    pub line: libc::c_uint,
}
pub const _sch_isalnum: C2RustUnnamed_23 = 140;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const _sch_isbasic: C2RustUnnamed_23 = 3088;
pub const _sch_iscppsp: C2RustUnnamed_23 = 3072;
pub const _sch_isgraph: C2RustUnnamed_23 = 172;
pub const _sch_isidnum: C2RustUnnamed_23 = 516;
pub const _sch_isalpha: C2RustUnnamed_23 = 136;
pub const _sch_isnvsp: C2RustUnnamed_23 = 2048;
pub const _sch_isvsp: C2RustUnnamed_23 = 1024;
pub const _sch_isidst: C2RustUnnamed_23 = 512;
pub const _sch_isxdigit: C2RustUnnamed_23 = 256;
pub const _sch_isupper: C2RustUnnamed_23 = 128;
pub const _sch_isspace: C2RustUnnamed_23 = 64;
pub const _sch_ispunct: C2RustUnnamed_23 = 32;
pub const _sch_isprint: C2RustUnnamed_23 = 16;
pub const _sch_islower: C2RustUnnamed_23 = 8;
pub const _sch_isdigit: C2RustUnnamed_23 = 4;
pub const _sch_iscntrl: C2RustUnnamed_23 = 2;
pub const _sch_isblank: C2RustUnnamed_23 = 1;
#[no_mangle]
pub static mut generic_floating_point_number: FLONUM_TYPE = FLONUM_TYPE {
...
#[no_mangle]
pub static mut generic_bignum: [LITTLENUM_TYPE; 26] = [0; 26];
#[no_mangle]
pub unsafe extern "C" fn get_symbol_name(
    mut ilp_return: *mut *mut libc::c_char,
) -> libc::c_char {
    ...
    *ilp_return = input_line_pointer;
    ...
    c = *fresh0;
    if *lex_type.as_mut_ptr().offset(c as libc::c_uchar as isize) as libc::c_int
        & 2 as libc::c_int != 0
        || input_from_string as libc::c_int != 0 && c as libc::c_int == '\u{1}' as i32
    {
        loop {
            ...
            input_line_pointer = input_line_pointer.offset(1);
            c = *fresh1;
            if !(*lex_type.as_mut_ptr().offset(c as libc::c_uchar as isize)
        ...
        let mut backslash_seen: bool = false;
        *ilp_return = input_line_pointer;
        loop {
            backslash_seen = c as libc::c_int == '\\' as i32;
            let fresh3 = input_line_pointer;
            input_line_pointer = input_line_pointer.offset(1);
            c = *fresh3;
            if !(c as libc::c_int != 0 as libc::c_int
                && (c as libc::c_int != '"' as i32
                    || backslash_seen as libc::c_int != 0))
            {
                break;
            }
        }
        if c as libc::c_int == 0 as libc::c_int {
            as_warn(
                dcgettext(
                    ...
                    b"missing closing '\"'\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        }
...
#[no_mangle]
pub unsafe extern "C" fn restore_line_pointer(mut c: libc::c_char) -> libc::c_char {
...
#[no_mangle]
pub unsafe extern "C" fn expr_begin() {
    expr_set_precedence();
    let mut e: expressionS = expressionS {
    ...
    e.set_X_op(O_max);
    if e.X_op() as libc::c_int == O_max as libc::c_int {} else {
        as_abort(
            ...
            (*::core::mem::transmute::<
                &[u8; 22],
                &[libc::c_char; 22],
            >(b"void expr_begin(void)\0"))
                .as_ptr(),
        );
    };
}
#[no_mangle]
pub unsafe extern "C" fn expr_set_precedence() {
    op_rank[O_multiply as libc::c_int as usize] = 8 as libc::c_int as operator_rankT;
    op_rank[O_divide as libc::c_int as usize] = 8 as libc::c_int as operator_rankT;
    op_rank[O_modulus as libc::c_int as usize] = 8 as libc::c_int as operator_rankT;
}
#[no_mangle]
pub unsafe extern "C" fn expr_set_rank(mut op: operatorT, mut rank: operator_rankT) {
    if op as libc::c_uint >= O_md1 as libc::c_int as libc::c_uint
        && (op as libc::c_ulong)
            < (::core::mem::size_of::<[operator_rankT; 62]>() as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<operator_rankT>() as libc::c_ulong)
    {} else {
        as_abort(
            b"expr.c\0" as *const u8 as *const libc::c_char,
            1583 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 46],
                &[libc::c_char; 46],
            >(b"void expr_set_rank(operatorT, operator_rankT)\0"))
                .as_ptr(),
        );
    };
    op_rank[op as usize] = rank;
}
#[no_mangle]
pub unsafe extern "C" fn add_to_result(
    mut resultP: *mut expressionS,
    mut amount: offsetT,
    mut rhs_highbit: libc::c_int,
) {
    let mut ures: valueT = (*resultP).X_add_number as valueT;
    let mut uamount: valueT = amount as valueT;
    (*resultP)
        .X_add_number = ((*resultP).X_add_number as libc::c_ulong).wrapping_add(uamount)
        as offsetT as offsetT;
    (*resultP).set_X_extrabit((*resultP).X_extrabit() ^ rhs_highbit as libc::c_uint);
    if ures.wrapping_add(uamount) < ures {
        (*resultP)
            .set_X_extrabit((*resultP).X_extrabit() ^ 1 as libc::c_int as libc::c_uint);
    }
}
#[no_mangle]
pub unsafe extern "C" fn subtract_from_result(
    mut resultP: *mut expressionS,
    mut amount: offsetT,
    mut rhs_highbit: libc::c_int,
) {
    ...
    let mut uamount: valueT = amount as valueT;
    (*resultP)
        .X_add_number = ((*resultP).X_add_number as libc::c_ulong).wrapping_sub(uamount)
        as offsetT as offsetT;
    (*resultP).set_X_extrabit((*resultP).X_extrabit() ^ rhs_highbit as libc::c_uint);
    if ures < uamount {
        (*resultP)
...
pub unsafe extern "C" fn expr(
    mut rankarg: libc::c_int,
    mut resultP: *mut expressionS,
    mut mode: expr_mode,
) -> segT {
    let mut current_block: u64;
    let mut rank: operator_rankT = rankarg as operator_rankT;
    let mut retval: segT = 0 as *mut asection;
    let mut right: expressionS = expressionS {
        X_add_symbol: 0 as *mut symbolS,
        X_op_symbol: 0 as *mut symbolS,
        X_add_number: 0,
        X_op_X_unsigned_X_extrabit: [0; 2],
    ...
    let mut op_left: operatorT = O_illegal;
    let mut op_right: operatorT = O_illegal;
    let mut op_chars: libc::c_int = 0;
    if rank as libc::c_int == 0 as libc::c_int {
        dot_value = frag_now_fix();
        dot_frag = frag_now;
    }
    retval = operand(resultP, mode);
    op_left = operatorf(&mut op_chars);
    while op_left as libc::c_uint != O_illegal as libc::c_int as libc::c_uint
        && op_rank[op_left as libc::c_int as usize] as libc::c_int > rank as libc::c_int
    {
        let mut rightseg: segT = 0 as *mut asection;
        let mut frag_off: offsetT = 0;
        input_line_pointer = input_line_pointer.offset(op_chars as isize);
        right.X_md = 0 as libc::c_int as libc::c_ushort;
        rightseg = expr(
            op_rank[op_left as libc::c_int as usize] as libc::c_int,
            &mut right,
            mode,
        );
        if right.X_op() as libc::c_int == O_absent as libc::c_int {
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
                    b"missing operand; zero assumed\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            right.set_X_op(O_constant);
            right.X_add_number = 0 as libc::c_int as offsetT;
            right.X_add_symbol = 0 as *mut symbolS;
            right.X_op_symbol = 0 as *mut symbolS;
        }
        if op_left as libc::c_uint == O_index as libc::c_int as libc::c_uint {
            if *input_line_pointer as libc::c_int != ']' as i32 {
                as_bad(b"missing right bracket\0" as *const u8 as *const libc::c_char);
            } else {
                input_line_pointer = input_line_pointer.offset(1);
                input_line_pointer;
                if *input_line_pointer as libc::c_int == ' ' as i32 {
        ...
        op_right = operatorf(&mut op_chars);
        if (*resultP).X_op() as libc::c_int == O_big as libc::c_int {
            if (*resultP).X_add_number > 0 as libc::c_int as libc::c_long {
                as_warn(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"left operand is a bignum; integer 0 assumed\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
                ...
                as_warn(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"left operand is a float; integer 0 assumed\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
            }
            (*resultP).set_X_op(O_constant);
            (*resultP).X_add_number = 0 as libc::c_int as offsetT;
            (*resultP).X_add_symbol = 0 as *mut symbolS;
            (*resultP).X_op_symbol = 0 as *mut symbolS;
        }
        if right.X_op() as libc::c_int == O_big as libc::c_int {
            if right.X_add_number > 0 as libc::c_int as libc::c_long {
                as_warn(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"right operand is a bignum; integer 0 assumed\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
                ...
                as_warn(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"right operand is a float; integer 0 assumed\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
        ...
        if mode as libc::c_uint == expr_defer as libc::c_int as libc::c_uint
            && (!((*resultP).X_add_symbol).is_null()
                && S_IS_FORWARD_REF((*resultP).X_add_symbol) != 0
                || !(right.X_add_symbol).is_null()
                    && S_IS_FORWARD_REF(right.X_add_symbol) != 0)
        {
            current_block = 598815825925440019;
        } else if op_left as libc::c_uint == O_add as libc::c_int as libc::c_uint
            && right.X_op() as libc::c_int == O_constant as libc::c_int
            && (0 as libc::c_int != 0
                || (*resultP).X_op() as libc::c_int != O_register as libc::c_int)
        {
            add_to_result(
                resultP,
                right.X_add_number,
                right.X_extrabit() as libc::c_int,
            );
            current_block = 6528931666172833996;
        } else if op_left as libc::c_uint == O_subtract as libc::c_int as libc::c_uint
            && right.X_op() as libc::c_int == O_symbol as libc::c_int
            && (*resultP).X_op() as libc::c_int == O_symbol as libc::c_int
            && retval == rightseg
            && (rightseg
                ...
                && rightseg != reg_section && rightseg != expr_section
                && S_FORCE_RELOC((*resultP).X_add_symbol, 0 as libc::c_int) == 0
                && S_FORCE_RELOC(right.X_add_symbol, 0 as libc::c_int) == 0
        ...
        {
            let mut symval_diff: offsetT = (S_GET_VALUE((*resultP).X_add_symbol))
                .wrapping_sub(S_GET_VALUE(right.X_add_symbol)) as offsetT;
            ...
            subtract_from_result(
                resultP,
                frag_off / ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_long,
                0 as libc::c_int,
            );
            add_to_result(
                resultP,
                symval_diff,
                (symval_diff < 0 as libc::c_int as libc::c_long) as libc::c_int,
            );
            (*resultP).set_X_op(O_constant);
            (*resultP).X_add_symbol = 0 as *mut symbolS;
            current_block = 6528931666172833996;
                ...
                || (*resultP).X_op() as libc::c_int != O_register as libc::c_int)
        {
            ...
            && (*resultP).X_op() as libc::c_int == O_constant as libc::c_int
            && (0 as libc::c_int != 0
                || right.X_op() as libc::c_int != O_register as libc::c_int)
        {
            (*resultP).set_X_op(right.X_op());
            ...
            retval = rightseg;
            current_block = 6528931666172833996;
        } else if (*resultP).X_op() as libc::c_int == O_constant as libc::c_int
            && right.X_op() as libc::c_int == O_constant as libc::c_int
        {
            let mut v: offsetT = right.X_add_number;
            if v == 0 as libc::c_int as libc::c_long
                && (op_left as libc::c_uint == O_divide as libc::c_int as libc::c_uint
                    || op_left as libc::c_uint
                        ...
                        == O_right_shift as libc::c_int as libc::c_uint)
            {
                ...
                v = 0 as libc::c_int as offsetT;
                (*resultP).X_add_number = v;
            }
            match op_left as libc::c_uint {
                10 => {
                    current_block = 2218556641513425916;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                                as libc::c_int as offsetT;
                        }
                        12864716150927550649 => {
                            (*resultP).X_add_number /= v;
                        }
                        7859767626630018609 => {
                            (*resultP).X_add_number %= v;
                        ...
                        7076257097338395937 => {
                            (*resultP)
                                .X_add_number = (((*resultP).X_add_number as valueT)
                                << v as valueT) as offsetT;
                        }
                        1620961189109966469 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number as valueT
                        ...
                        18243158887264191832 => {
                            (*resultP).X_add_number |= !v;
                        }
                        9609989243947815934 => {
                            (*resultP).X_add_number ^= v;
                        }
                        14895139683101752912 => {
                            (*resultP).X_add_number &= v;
                        }
                        6663839831822004786 => {
                            subtract_from_result(resultP, v, 0 as libc::c_int);
                        }
                        4241088642441362809 => {
                            (*resultP)
                                .X_add_number = if (*resultP).X_add_number == v {
                                !(0 as libc::c_int as offsetT)
                            } else {
                                0 as libc::c_int as libc::c_long
                            };
                        }
                        11296257470710583152 => {
                            (*resultP)
                                .X_add_number = if (*resultP).X_add_number != v {
                                !(0 as libc::c_int as offsetT)
                            } else {
                ...
                11 => {
                    current_block = 12864716150927550649;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                12 => {
                    current_block = 7859767626630018609;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                13 => {
                    current_block = 7076257097338395937;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                14 => {
                    current_block = 1620961189109966469;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                15 => {
                    current_block = 3117122678041835581;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                16 => {
                    current_block = 18243158887264191832;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                18 => {
                    current_block = 14895139683101752912;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                20 => {
                    current_block = 6663839831822004786;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                21 => {
                    current_block = 4241088642441362809;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                22 => {
                    current_block = 11296257470710583152;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                23 => {
                    current_block = 8171683440070716847;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                24 => {
                    current_block = 6536964308660225164;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                25 => {
                    current_block = 9418574336266311745;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                26 => {
                    current_block = 4254403235892609335;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                27 => {
                    current_block = 8931029296085427623;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
                ...
                28 => {
                    current_block = 8411380133641586159;
                    match current_block {
                        8411380133641586159 => {
                            (*resultP)
                                .X_add_number = ((*resultP).X_add_number != 0 || v != 0)
        ...
        } else if (*resultP).X_op() as libc::c_int == O_symbol as libc::c_int
            && right.X_op() as libc::c_int == O_symbol as libc::c_int
            && (op_left as libc::c_uint == O_add as libc::c_int as libc::c_uint
                || op_left as libc::c_uint == O_subtract as libc::c_int as libc::c_uint
                || (*resultP).X_add_number == 0 as libc::c_int as libc::c_long
                    && right.X_add_number == 0 as libc::c_int as libc::c_long)
        {
            (*resultP).set_X_op(op_left);
            (*resultP).X_op_symbol = right.X_add_symbol;
            if op_left as libc::c_uint == O_add as libc::c_int as libc::c_uint {
                add_to_result(
                    resultP,
                    right.X_add_number,
                    right.X_extrabit() as libc::c_int,
                );
            } else if op_left as libc::c_uint
                    ...
                    && (retval
                        ...
                        && retval
                            != &mut *_bfd_std_section
                                .as_mut_ptr()
                                .offset(1 as libc::c_int as isize) as *mut asection
                        && retval != reg_section && retval != expr_section)
                    && S_FORCE_RELOC((*resultP).X_add_symbol, 0 as libc::c_int) == 0
                    && S_FORCE_RELOC(right.X_add_symbol, 0 as libc::c_int) == 0
                {
                    retval = &mut *_bfd_std_section
                        .as_mut_ptr()
                        .offset(2 as libc::c_int as isize) as *mut asection;
                    rightseg = &mut *_bfd_std_section
                        .as_mut_ptr()
                        .offset(2 as libc::c_int as isize) as *mut asection;
                }
            }
        ...
        match current_block {
            598815825925440019 => {
                ...
                (*resultP).X_op_symbol = make_expr_symbol(&mut right);
                (*resultP).set_X_op(op_left);
                (*resultP).X_add_number = 0 as libc::c_int as offsetT;
                (*resultP).set_X_unsigned(1 as libc::c_int as libc::c_uint);
                (*resultP).set_X_extrabit(0 as libc::c_int as libc::c_uint);
            }
            _ => {}
        }
        if retval != rightseg {
                                ...
                                .offset(2 as libc::c_int as isize) as *mut asection)
                        {
                                ...
                                == O_subtract as libc::c_int as libc::c_uint)
                            {
                                as_bad(
                                    dcgettext(
                                        0 as *const libc::c_char,
                                        b"operation combines symbols in different segments\0"
    ...
    if !((*resultP).X_add_symbol).is_null() {
        symbol_mark_used((*resultP).X_add_symbol);
    }
    if rank as libc::c_int == 0 as libc::c_int
        && mode as libc::c_uint == expr_evaluate as libc::c_int as libc::c_uint
    {
        resolve_expression(resultP);
    }
    return if (*resultP).X_op() as libc::c_int == O_constant as libc::c_int {
        &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut asection
    } else {
        retval
...
#[no_mangle]
pub unsafe extern "C" fn resolve_expression(
    mut expressionP: *mut expressionS,
) -> libc::c_int {
    let mut final_val: valueT = (*expressionP).X_add_number as valueT;
    let mut add_symbol: *mut symbolS = (*expressionP).X_add_symbol;
    let mut orig_add_symbol: *mut symbolS = add_symbol;
    let mut op_symbol: *mut symbolS = (*expressionP).X_op_symbol;
    let mut op: operatorT = (*expressionP).X_op();
    let mut left: valueT = 0;
    let mut right: valueT = 0;
    let mut seg_left: segT = 0 as *mut asection;
    let mut seg_right: segT = 0 as *mut asection;
    let mut frag_left: *mut fragS = 0 as *mut fragS;
    let mut frag_right: *mut fragS = 0 as *mut fragS;
    let mut frag_off: offsetT = 0;
    let mut current_block_74: u64;
    match op as libc::c_uint {
        2 | 5 => {
            left = 0 as libc::c_int as valueT;
        }
        3 | 4 => {
            if snapshot_symbol(&mut add_symbol, &mut left, &mut seg_left, &mut frag_left)
                == 0
            {
        ...
        7 | 8 | 9 => {
            ...
            if op as libc::c_uint == O_logical_not as libc::c_int as libc::c_uint {
                left = (left == 0) as libc::c_int as valueT;
            } else if op as libc::c_uint == O_uminus as libc::c_int as libc::c_uint {
        ...
        | 26 | 27 | 28 => {
            ...
            if op as libc::c_uint == O_add as libc::c_int as libc::c_uint {
                if seg_right
                    == &mut *_bfd_std_section
                        ...
                        .offset(2 as libc::c_int as isize) as *mut asection
                {
                    final_val = (final_val as libc::c_ulong).wrapping_add(right)
                        as valueT as valueT;
                    op = O_symbol;
                    current_block_74 = 5700653730392116747;
                } else if seg_left
                    == &mut *_bfd_std_section
                        .as_mut_ptr()
                        .offset(2 as libc::c_int as isize) as *mut asection
                {
                    final_val = (final_val as libc::c_ulong).wrapping_add(left) as valueT
                        as valueT;
                    left = right;
                    seg_left = seg_right;
                    ...
                    current_block_74 = 7427571413727699167;
                }
                ...
                if seg_right
                    == &mut *_bfd_std_section
                        ...
                        .offset(2 as libc::c_int as isize) as *mut asection
                {
                    final_val = (final_val as libc::c_ulong).wrapping_sub(right)
                        as valueT as valueT;
                    op = O_symbol;
                    current_block_74 = 5700653730392116747;
                } else {
            ...
            match current_block_74 {
                5700653730392116747 => {}
                _ => {
                    frag_off = 0 as libc::c_int as offsetT;
                    if !(seg_left
                        == &mut *_bfd_std_section
                            .as_mut_ptr()
                            .offset(2 as libc::c_int as isize) as *mut asection
                        && seg_right
                            == &mut *_bfd_std_section
                                .as_mut_ptr()
                                .offset(2 as libc::c_int as isize) as *mut asection)
                        && !(op as libc::c_uint == O_eq as libc::c_int as libc::c_uint
                            || op as libc::c_uint == O_ne as libc::c_int as libc::c_uint)
                        && !((op as libc::c_uint
                            == O_subtract as libc::c_int as libc::c_uint
                            ...
                            || op as libc::c_uint == O_gt as libc::c_int as libc::c_uint)
                            && seg_left == seg_right
                            && (finalize_syms != 0
                                || frag_offset_fixed_p(frag_left, frag_right, &mut frag_off)
                                    as libc::c_int != 0
                                || op as libc::c_uint == O_gt as libc::c_int as libc::c_uint
                                    && frag_gtoffset_p(
                                        left,
                        ...
                        if seg_left
                            ...
                            || seg_right
                                == &mut *_bfd_std_section
                                    .as_mut_ptr()
                                    .offset(2 as libc::c_int as isize) as *mut asection
                                && right == 0 as libc::c_int as libc::c_ulong
                        {
                            if op as libc::c_uint
                                == O_bit_exclusive_or as libc::c_int as libc::c_uint
                                || op as libc::c_uint
                                    == O_bit_inclusive_or as libc::c_int as libc::c_uint
                            {
                                if !(seg_right
                                    == &mut *_bfd_std_section
                                        .as_mut_ptr()
                                    ...
                                    == O_right_shift as libc::c_int as libc::c_uint
                            {
                                    ...
                                    && left == 0 as libc::c_int as libc::c_ulong)
                                {
                                    ...
                                    current_block_74 = 13660591889533726445;
                                }
                            } else {
                                if op as libc::c_uint
                                    != O_multiply as libc::c_int as libc::c_uint
                                    && op as libc::c_uint
                                        != O_bit_or_not as libc::c_int as libc::c_uint
                                    && op as libc::c_uint
                                        != O_bit_and as libc::c_int as libc::c_uint
                                {
                                    return 0 as libc::c_int;
                                }
                                current_block_74 = 13660591889533726445;
                            ...
                            && seg_left
                                == &mut *_bfd_std_section
                                    .as_mut_ptr()
                                    .offset(2 as libc::c_int as isize) as *mut asection
                            && left == 1 as libc::c_int as libc::c_ulong
                        {
                            seg_left = seg_right;
                            left = right;
                            add_symbol = op_symbol;
                            ...
                            == O_multiply as libc::c_int as libc::c_uint
                            || op as libc::c_uint
                                == O_divide as libc::c_int as libc::c_uint)
                            && seg_right
                                == &mut *_bfd_std_section
                                    .as_mut_ptr()
                                    .offset(2 as libc::c_int as isize) as *mut asection
                            && right == 1 as libc::c_int as libc::c_ulong
                        {
                            op = O_symbol;
                            current_block_74 = 5700653730392116747;
                        } else if !(left == right
                    ...
                    match current_block_74 {
                        ...
                        _ => {
                            ...
                            match op as libc::c_uint {
                                19 => {
                                    left = (left as libc::c_ulong).wrapping_add(right) as valueT
                                        as valueT;
                                }
                                20 => {
                                    left = (left as libc::c_ulong).wrapping_sub(right) as valueT
                                        as valueT;
                                }
                                10 => {
                                    left = (left as libc::c_ulong).wrapping_mul(right) as valueT
                                        as valueT;
                                }
                                11 => {
                                    ...
                                    left = (left as offsetT / right as offsetT) as valueT;
                                }
                                12 => {
                                    if right == 0 as libc::c_int as libc::c_ulong {
                                        return 0 as libc::c_int;
                                ...
                                21 | 22 => {
                                    left = if left == right && seg_left == seg_right
                                        && (finalize_syms != 0 || frag_left == frag_right)
                                        && (seg_left
                                            != &mut *_bfd_std_section
                                                .as_mut_ptr()
                                                .offset(1 as libc::c_int as isize) as *mut asection
                                    ...
                                    if op as libc::c_uint == O_ne as libc::c_int as libc::c_uint
                                    {
                                        left = !left;
                                    }
                                }
                                23 => {
                                    left = if (left as offsetT) < right as offsetT {
                                        !(0 as libc::c_int as valueT)
                                    } else {
                                        0 as libc::c_int as libc::c_ulong
                                    };
                                ...
                                27 => {
                                    left = (left != 0 && right != 0) as libc::c_int as valueT;
                                }
                                28 => {
                                    left = (left != 0 || right != 0) as libc::c_int as valueT;
                                }
                                _ => {
                                    as_abort(
                                        ...
                                        (*::core::mem::transmute::<
                                            &[u8; 38],
                                            &[libc::c_char; 38],
                                        >(b"int resolve_expression(expressionS *)\0"))
                                            .as_ptr(),
                                    );
                                }
                            }
    ...
    if op as libc::c_uint == O_symbol as libc::c_int as libc::c_uint {
        if seg_left
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
        {
            op = O_constant;
        } else if seg_left == reg_section
            && final_val == 0 as libc::c_int as libc::c_ulong
        {
            op = O_register;
        } else if symbol_same_p(add_symbol, orig_add_symbol) == 0 {
            final_val = (final_val as libc::c_ulong).wrapping_add(left) as valueT
                as valueT;
        }
        (*expressionP).X_add_symbol = add_symbol;
    }
    (*expressionP).set_X_op(op);
    if op as libc::c_uint == O_constant as libc::c_int as libc::c_uint
        || op as libc::c_uint == O_register as libc::c_int as libc::c_uint
    {
        final_val = (final_val as libc::c_ulong).wrapping_add(left) as valueT as valueT;
    }
    (*expressionP).X_add_number = final_val as offsetT;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn make_expr_symbol(
    mut expressionP: *mut expressionS,
) -> *mut symbolS {
    let mut zero: expressionS = expressionS {
        X_add_symbol: 0 as *mut symbolS,
        X_op_symbol: 0 as *mut symbolS,
        X_add_number: 0,
        X_op_X_unsigned_X_extrabit: [0; 2],
    ...
    let mut n: *mut expr_symbol_line = 0 as *mut expr_symbol_line;
    if (*expressionP).X_op() as libc::c_int == O_symbol as libc::c_int
        && (*expressionP).X_add_number == 0 as libc::c_int as libc::c_long
    {
        return (*expressionP).X_add_symbol;
    }
    if (*expressionP).X_op() as libc::c_int == O_big as libc::c_int {
        if (*expressionP).X_add_number > 0 as libc::c_int as libc::c_long {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
        ...
        zero.set_X_op(O_constant);
        zero.X_add_number = 0 as libc::c_int as offsetT;
        zero.set_X_unsigned(0 as libc::c_int as libc::c_uint);
        zero.set_X_extrabit(0 as libc::c_int as libc::c_uint);
        clean_up_expression(&mut zero);
        expressionP = &mut zero;
    }
    symbolP = symbol_create(
        b"L0\x01\0" as *const u8 as *const libc::c_char,
        if (*expressionP).X_op() as libc::c_int == O_constant as libc::c_int {
            &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
        } else if (*expressionP).X_op() as libc::c_int == O_register as libc::c_int {
            reg_section
        } else {
            expr_section
        },
    ...
    n = xmalloc(::core::mem::size_of::<expr_symbol_line>() as libc::c_ulong)
        as *mut expr_symbol_line;
    (*n).sym = symbolP;
    (*n).file = as_where(&mut (*n).line);
    (*n).next = expr_symbol_lines;
    expr_symbol_lines = n;
    return symbolP;
}
#[no_mangle]
pub unsafe extern "C" fn current_location(mut expressionp: *mut expressionS) {
    if now_seg
        == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut asection
    {
        (*expressionp).set_X_op(O_constant);
        (*expressionp).X_add_number = abs_section_offset as offsetT;
    } else {
        (*expressionp).set_X_op(O_symbol);
        (*expressionp).X_add_symbol = &mut dot_symbol;
        (*expressionp).X_add_number = 0 as libc::c_int as offsetT;
    };
}
#[no_mangle]
pub unsafe extern "C" fn generic_bignum_to_int64() -> uint64_t {
    return (((generic_bignum[3 as libc::c_int as usize] as uint64_t
        & 0xffff as libc::c_int as libc::c_ulong) << 16 as libc::c_int
        | generic_bignum[2 as libc::c_int as usize] as uint64_t
            & 0xffff as libc::c_int as libc::c_ulong) << 16 as libc::c_int
        | generic_bignum[1 as libc::c_int as usize] as uint64_t
            & 0xffff as libc::c_int as libc::c_ulong) << 16 as libc::c_int
        | generic_bignum[0 as libc::c_int as usize] as uint64_t
            & 0xffff as libc::c_int as libc::c_ulong;
}
#[no_mangle]
pub unsafe extern "C" fn generic_bignum_to_int32() -> uint32_t {
    return (generic_bignum[1 as libc::c_int as usize] as uint32_t
        & 0xffff as libc::c_int as libc::c_uint) << 16 as libc::c_int
        | generic_bignum[0 as libc::c_int as usize] as uint32_t
            & 0xffff as libc::c_int as libc::c_uint;
}
#[no_mangle]
pub static mut literal_prefix_dollar_hex: bool = 0 as libc::c_int != 0;
#[no_mangle]
pub unsafe extern "C" fn get_single_number() -> libc::c_uint {
    ...
    operand(&mut exp, expr_normal);
    return exp.X_add_number as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn expr_symbol_where(
    mut sym: *mut symbolS,
    mut pfile: *mut *const libc::c_char,
    mut pline: *mut libc::c_uint,
) -> libc::c_int {
    let mut l: *mut expr_symbol_line = 0 as *mut expr_symbol_line;
    l = expr_symbol_lines;
    while !l.is_null() {
        if (*l).sym == sym {
            *pfile = (*l).file;
...
#[no_mangle]
pub unsafe extern "C" fn expr_build_uconstant(mut value: offsetT) -> *mut symbolS {
    let mut e: expressionS = expressionS {
        X_add_symbol: 0 as *mut symbolS,
        X_op_symbol: 0 as *mut symbolS,
        X_add_number: 0,
    ...
    e.set_X_unsigned(1 as libc::c_int as libc::c_uint);
    e.set_X_extrabit(0 as libc::c_int as libc::c_uint);
    return make_expr_symbol(&mut e);
}
#[no_mangle]
pub unsafe extern "C" fn expr_build_dot() -> *mut symbolS {
    let mut e: expressionS = expressionS {
        X_add_symbol: 0 as *mut symbolS,
        X_op_symbol: 0 as *mut symbolS,
        X_add_number: 0,
    ...
    current_location(&mut e);
    return symbol_clone_if_forward_ref(make_expr_symbol(&mut e), 0 as libc::c_int);
}
unsafe extern "C" fn clean_up_expression(mut expressionP: *mut expressionS) {
    let mut current_block_2: u64;
    match (*expressionP).X_op() as libc::c_int {
        0 | 1 => {
            (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
            current_block_2 = 12086842323387539843;
        }
        6 | 2 | 5 => {
            current_block_2 = 12086842323387539843;
        }
        3 | 7 | 8 => {
            current_block_2 = 15275504483753031639;
        }
        _ => {
    ...
    match current_block_2 {
        12086842323387539843 => {
            (*expressionP).X_add_symbol = 0 as *mut symbolS;
            current_block_2 = 15275504483753031639;
        }
        _ => {}
    }
    match current_block_2 {
        15275504483753031639 => {
            (*expressionP).X_op_symbol = 0 as *mut symbolS;
        }
        _ => {}
    };
}
static mut expr_symbol_lines: *mut expr_symbol_line = 0 as *const expr_symbol_line
    as *mut expr_symbol_line;
unsafe extern "C" fn symbol_lookup_or_make(
    mut name: *const libc::c_char,
    mut start: bool,
) -> *mut symbolS {
    static mut seen: [*mut *mut symbolS; 2] = [0 as *const *mut symbolS
        as *mut *mut symbolS; 2];
    static mut nr_seen: [libc::c_uint; 2] = [0; 2];
    let mut buf: *mut libc::c_char = concat(
        if start as libc::c_int != 0 {
            b".startof.\0" as *const u8 as *const libc::c_char
        } else {
    ...
    while i < nr_seen[start as usize] {
        symbolP = *(seen[start as usize]).offset(i as isize);
        if symbolP.is_null() {
            break;
        }
        name = S_GET_NAME(symbolP);
        if (if symbols_case_sensitive != 0 {
            strcasecmp(buf, name)
        } else {
            strcmp(buf, name)
        }) == 0 as libc::c_int
    ...
    free(buf as *mut libc::c_void);
    if i >= nr_seen[start as usize] {
        let mut nr: libc::c_uint = i
            .wrapping_add(1 as libc::c_int as libc::c_uint)
            .wrapping_mul(2 as libc::c_int as libc::c_uint);
        seen[start
            as usize] = xrealloc(
            seen[start as usize] as *mut libc::c_void,
            (::core::mem::size_of::<*mut symbolS>() as libc::c_ulong)
                .wrapping_mul(nr as libc::c_ulong),
        ) as *mut *mut symbolS;
        nr_seen[start as usize] = nr;
        memset(
            &mut *(*seen.as_mut_ptr().offset(start as isize))
                .offset(i.wrapping_add(1 as libc::c_int as libc::c_uint) as isize)
                as *mut *mut symbolS as *mut libc::c_void,
            0 as libc::c_int,
            (nr.wrapping_sub(i).wrapping_sub(1 as libc::c_int as libc::c_uint)
                as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<*mut symbolS>() as libc::c_ulong),
        );
    }
    let ref mut fresh4 = *(seen[start as usize]).offset(i as isize);
    *fresh4 = symbolP;
    return symbolP;
}
unsafe extern "C" fn floating_constant(mut expressionP: *mut expressionS) {
    ...
    if error_code != 0 {
        if error_code == 2 as libc::c_int {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"bad floating-point constant: exponent overflow\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            ...
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"bad floating-point constant: unknown error code=%d\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                error_code,
    ...
    (*expressionP).set_X_op(O_big);
    (*expressionP).X_add_number = -(1 as libc::c_int) as offsetT;
}
unsafe extern "C" fn integer_constant(
    ...
    let mut c: libc::c_char = 0;
    let mut number: valueT = 0;
    let mut digit: libc::c_short = 0;
    let mut maxdig: libc::c_short = 0 as libc::c_int as libc::c_short;
    let mut too_many_digits: libc::c_int = 0 as libc::c_int;
    ...
    if *is_end_of_line.as_mut_ptr().offset(*input_line_pointer as libc::c_uchar as isize)
        != 0
    {
        (*expressionP).set_X_op(O_absent);
        return;
    }
    if (0 as libc::c_int != 0 || 0 as libc::c_int != 0) && radix == 0 as libc::c_int {
        let mut flt: libc::c_int = 0 as libc::c_int;
        suffix = input_line_pointer;
        while _sch_istable[(*suffix as libc::c_int & 0xff as libc::c_int) as usize]
            as libc::c_int & _sch_isalnum as libc::c_int as libc::c_ushort as libc::c_int
            != 0
        {
            if *suffix as libc::c_int == 'e' as i32
                || *suffix as libc::c_int == 'E' as i32
            {
                flt = 1 as libc::c_int;
            }
        ...
        if suffix == input_line_pointer {
            ...
            suffix = suffix.offset(-1);
            c = *suffix;
            c = _sch_toupper[(c as libc::c_int & 0xff as libc::c_int) as usize]
                as libc::c_char;
            if (if 0 as libc::c_int != 0 && 1 as libc::c_int != 0 {
            ...
            }) == 'B' as i32
            {
                ...
                radix = 10 as libc::c_int;
            } else if c as libc::c_int == 'O' as i32 || c as libc::c_int == 'Q' as i32 {
                radix = 8 as libc::c_int;
            } else if c as libc::c_int == 'H' as i32 {
                radix = 16 as libc::c_int;
            } else if *suffix.offset(1 as libc::c_int as isize) as libc::c_int
                == '.' as i32 || c as libc::c_int == 'E' as i32 || flt != 0
            {
    ...
    match radix {
        2 => {
            maxdig = 2 as libc::c_int as libc::c_short;
            too_many_digits = 64 as libc::c_int + 1 as libc::c_int;
        }
        8 => {
            radix = 8 as libc::c_int;
            maxdig = radix as libc::c_short;
            too_many_digits = (64 as libc::c_int + 2 as libc::c_int) / 3 as libc::c_int
                + 1 as libc::c_int;
        }
        16 => {
            radix = 16 as libc::c_int;
            maxdig = radix as libc::c_short;
            too_many_digits = (64 as libc::c_int + 3 as libc::c_int) / 4 as libc::c_int
                + 1 as libc::c_int;
        }
        10 => {
            radix = 10 as libc::c_int;
            maxdig = radix as libc::c_short;
            too_many_digits = (64 as libc::c_int + 11 as libc::c_int) / 4 as libc::c_int;
        }
        _ => {}
    }
    ...
    input_line_pointer = input_line_pointer.offset(1);
    c = *fresh5;
    number = 0 as libc::c_int as valueT;
    loop {
        digit = _hex_value[c as libc::c_uchar as usize] as libc::c_uint as libc::c_short;
        if !((digit as libc::c_int) < maxdig as libc::c_int) {
            break;
        }
        number = number
    ...
    small = ((input_line_pointer.offset_from(start) as libc::c_long
        - 1 as libc::c_int as libc::c_long) < too_many_digits as libc::c_long)
        as libc::c_int;
    if radix == 16 as libc::c_int && c as libc::c_int == '_' as i32 {
        let mut num_little_digits: libc::c_int = 0 as libc::c_int;
        let mut i: libc::c_int = 0;
        input_line_pointer = start;
        c = '_' as i32 as libc::c_char;
        while c as libc::c_int == '_' as i32 {
            ...
            c = *fresh7;
            loop {
                digit = _hex_value[c as libc::c_uchar as usize] as libc::c_uint
                    as libc::c_short;
                if !((digit as libc::c_int) < maxdig as libc::c_int) {
                    break;
                }
                ...
                ndigit += 1;
                ndigit;
                let fresh8 = input_line_pointer;
                input_line_pointer = input_line_pointer.offset(1);
                c = *fresh8;
            }
            if ndigit > 8 as libc::c_int {
                as_bad(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"a bignum with underscores may not have more than 8 hex digits in any word\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
            }
            i = if (num_little_digits + 1 as libc::c_int)
                < 20 as libc::c_int - 1 as libc::c_int
            {
                num_little_digits + 1 as libc::c_int
            } else {
                20 as libc::c_int - 1 as libc::c_int
            };
            while i >= 2 as libc::c_int {
                generic_bignum[i
                    as usize] = generic_bignum[(i - 2 as libc::c_int) as usize];
                i -= 1;
                i;
            }
            generic_bignum[0 as libc::c_int
                as usize] = (number & 0xffffffff as libc::c_uint as libc::c_ulong)
                as LITTLENUM_TYPE;
            generic_bignum[1 as libc::c_int
                as usize] = (number >> 16 as libc::c_int) as LITTLENUM_TYPE;
            num_little_digits += 2 as libc::c_int;
        }
        if num_little_digits > 20 as libc::c_int - 1 as libc::c_int {
            num_little_digits = 20 as libc::c_int - 1 as libc::c_int;
        }
        if num_little_digits >= 4 as libc::c_int {} else {
            as_abort(
                b"expr.c\0" as *const u8 as *const libc::c_char,
                447 as libc::c_int,
                (*::core::mem::transmute::<
                    &[u8; 42],
                    &[libc::c_char; 42],
                >(b"void integer_constant(int, expressionS *)\0"))
                    .as_ptr(),
            );
        };
        if num_little_digits != 8 as libc::c_int {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"a bignum with underscores must have exactly 4 words\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        }
        while generic_bignum[(num_little_digits - 1 as libc::c_int) as usize]
            as libc::c_int == 0 as libc::c_int && num_little_digits > 1 as libc::c_int
        {
            num_little_digits -= 1;
            num_little_digits;
        }
        if num_little_digits <= 2 as libc::c_int {
            number = generic_bignum_to_int32() as valueT;
            small = 1 as libc::c_int;
        } else if num_little_digits <= 4 as libc::c_int {
            number = generic_bignum_to_int64();
            small = 1 as libc::c_int;
        } else {
            small = 0 as libc::c_int;
            number = num_little_digits as valueT;
        }
    } else if small == 0 {
        let mut leader: *mut LITTLENUM_TYPE = 0 as *mut LITTLENUM_TYPE;
        let mut pointer: *mut LITTLENUM_TYPE = 0 as *mut LITTLENUM_TYPE;
        let mut carry: libc::c_long = 0;
        leader = generic_bignum.as_mut_ptr();
        generic_bignum[0 as libc::c_int as usize] = 0 as libc::c_int as LITTLENUM_TYPE;
        generic_bignum[1 as libc::c_int as usize] = 0 as libc::c_int as LITTLENUM_TYPE;
        generic_bignum[2 as libc::c_int as usize] = 0 as libc::c_int as LITTLENUM_TYPE;
        generic_bignum[3 as libc::c_int as usize] = 0 as libc::c_int as LITTLENUM_TYPE;
        input_line_pointer = start;
        let fresh9 = input_line_pointer;
        input_line_pointer = input_line_pointer.offset(1);
        c = *fresh9;
        loop {
            carry = _hex_value[c as libc::c_uchar as usize] as libc::c_uint
                as libc::c_long;
            if !(carry < maxdig as libc::c_long) {
                break;
            }
            pointer = generic_bignum.as_mut_ptr();
            while pointer <= leader {
                let mut work: libc::c_long = 0;
                work = carry + (radix * *pointer as libc::c_int) as libc::c_long;
                *pointer = (work & 0xffff as libc::c_int as libc::c_long)
                    as LITTLENUM_TYPE;
            ...
            if carry != 0 {
                        ...
                        .offset(-(1 as libc::c_int as isize))
                {
                    ...
                    *leader = carry as LITTLENUM_TYPE;
                }
            }
            let fresh10 = input_line_pointer;
            input_line_pointer = input_line_pointer.offset(1);
            c = *fresh10;
        }
        if leader < generic_bignum.as_mut_ptr().offset(2 as libc::c_int as isize) {
            number = generic_bignum_to_int32() as valueT;
            small = 1 as libc::c_int;
        } else if leader < generic_bignum.as_mut_ptr().offset(4 as libc::c_int as isize)
        {
            number = generic_bignum_to_int64();
            small = 1 as libc::c_int;
        } else {
            number = (leader.offset_from(generic_bignum.as_mut_ptr()) as libc::c_long
                + 1 as libc::c_int as libc::c_long) as valueT;
        }
    }
    if (0 as libc::c_int != 0 || 0 as libc::c_int != 0) && !suffix.is_null()
        && input_line_pointer.offset(-(1 as libc::c_int as isize)) == suffix
    {
        let fresh11 = input_line_pointer;
        input_line_pointer = input_line_pointer.offset(1);
        c = *fresh11;
    }
    if 1 as libc::c_int != 0
        && (c as libc::c_int == 'U' as i32 || c as libc::c_int == 'u' as i32)
    {
        let fresh12 = input_line_pointer;
        input_line_pointer = input_line_pointer.offset(1);
        c = *fresh12;
    }
    while c as libc::c_int == 'L' as i32 || c as libc::c_int == 'l' as i32 {
        let fresh13 = input_line_pointer;
        input_line_pointer = input_line_pointer.offset(1);
        c = *fresh13;
    }
    if small != 0 {
        if 1 as libc::c_int != 0 && c as libc::c_int == 'b' as i32 {
            name = fb_label_name(
                number as libc::c_int as libc::c_long,
                0 as libc::c_int as libc::c_long,
            );
            symbolP = symbol_find(name);
            if !symbolP.is_null() && S_IS_DEFINED(symbolP) != 0 {
                (*expressionP).set_X_op(O_symbol);
                ...
                as_bad(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"backward ref to unknown label \"%d:\"\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
            ...
            (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
        } else if 1 as libc::c_int != 0 && c as libc::c_int == 'f' as i32 {
            name = fb_label_name(
                number as libc::c_int as libc::c_long,
            ...
            (*expressionP).X_add_symbol = symbolP;
            (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
        } else if 0 as libc::c_int != 0 && c as libc::c_int == '$' as i32 {
            if dollar_label_defined(number as libc::c_long) != 0 {
                name = dollar_label_name(number as libc::c_long, 0 as libc::c_int);
                symbolP = symbol_find(name);
            } else {
                name = dollar_label_name(number as libc::c_long, 1 as libc::c_int);
                symbolP = symbol_find_or_make(name);
            }
            (*expressionP).set_X_op(O_symbol);
            (*expressionP).X_add_symbol = symbolP;
            ...
            (*expressionP).set_X_op(O_constant);
            (*expressionP).X_add_number = number as offsetT;
            input_line_pointer = input_line_pointer.offset(-1);
            input_line_pointer;
        }
    } else {
...
unsafe extern "C" fn mri_char_constant(mut expressionP: *mut expressionS) {
    let mut i: libc::c_int = 0;
    if *input_line_pointer as libc::c_int == '\'' as i32
    ...
    i = 20 as libc::c_int - 1 as libc::c_int;
    while i >= 0 as libc::c_int {
        let mut j: libc::c_int = 0;
        generic_bignum[i as usize] = 0 as libc::c_int as LITTLENUM_TYPE;
        j = 0 as libc::c_int;
        while j < (1 as libc::c_int) << 1 as libc::c_int {
            if *input_line_pointer as libc::c_int == '\'' as i32 {
            ...
            generic_bignum[i
                as usize] = ((generic_bignum[i as usize] as libc::c_int)
                << 8 as libc::c_int) as LITTLENUM_TYPE;
            generic_bignum[i
                as usize] = (generic_bignum[i as usize] as libc::c_int
                + *input_line_pointer as libc::c_int) as LITTLENUM_TYPE;
            input_line_pointer = input_line_pointer.offset(1);
            input_line_pointer;
            j += 1;
            j;
        }
        if i < 20 as libc::c_int - 1 as libc::c_int {
            while j < (1 as libc::c_int) << 1 as libc::c_int {
                generic_bignum[i
                    as usize] = ((generic_bignum[i as usize] as libc::c_int)
                    << 8 as libc::c_int) as LITTLENUM_TYPE;
    ...
    if i < 0 as libc::c_int {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"character constant too large\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        i = 0 as libc::c_int;
    ...
    if i > 0 as libc::c_int {
        ...
        c = 20 as libc::c_int - i;
        j_0 = 0 as libc::c_int;
        while j_0 < c {
            generic_bignum[j_0 as usize] = generic_bignum[(i + j_0) as usize];
            j_0 += 1;
            j_0;
        }
        i = c;
    ...
    if i > 2 as libc::c_int {
        (*expressionP).set_X_op(O_big);
        (*expressionP).X_add_number = i as offsetT;
    } else {
        (*expressionP).set_X_op(O_constant);
        if i < 2 as libc::c_int {
            (*expressionP)
                .X_add_number = (generic_bignum[0 as libc::c_int as usize] as libc::c_int
                & 0xffff as libc::c_int) as offsetT;
        } else {
            (*expressionP)
                .X_add_number = ((generic_bignum[1 as libc::c_int as usize]
                as libc::c_int & 0xffff as libc::c_int) << 16 as libc::c_int
                | generic_bignum[0 as libc::c_int as usize] as libc::c_int
                    & 0xffff as libc::c_int) as offsetT;
        }
    }
    input_line_pointer = input_line_pointer.offset(1);
...
unsafe extern "C" fn operand(
    ...
    (*expressionP).set_X_unsigned(1 as libc::c_int as libc::c_uint);
    (*expressionP).set_X_extrabit(0 as libc::c_int as libc::c_uint);
    if *input_line_pointer as libc::c_int == ' ' as i32 {
        input_line_pointer = input_line_pointer.offset(1);
        input_line_pointer;
    } else {};
    ...
    input_line_pointer = input_line_pointer.offset(1);
    c = *fresh14;
    if *is_end_of_line.as_mut_ptr().offset(c as libc::c_uchar as isize) != 0 {
        current_block = 15726365437402333975;
    } else {
        match c as libc::c_int {
            49 | 50 | 51 | 52 | 53 | 54 | 55 | 56 | 57 => {
                current_block = 2923295998460255815;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
                            .offset(*input_line_pointer as libc::c_uchar as isize)
                            as libc::c_int & 1 as libc::c_int == 0
                        {
                            ...
                            && *lex_type
                                .as_mut_ptr()
                                .offset(
                                    *input_line_pointer.offset(8 as libc::c_int as isize)
                            ...
                            || strncasecmp(
                                ...
                                && *lex_type
                                    .as_mut_ptr()
                                    .offset(
                                        *input_line_pointer.offset(7 as libc::c_int as isize)
                                            as libc::c_uchar as isize,
                                    ) as libc::c_int & 1 as libc::c_int == 0
                        {
                            ...
                            start = (*input_line_pointer
                                ...
                                || *input_line_pointer.offset(1 as libc::c_int as isize)
                                    as libc::c_int == 'T' as i32) as libc::c_int;
                            ...
                            if *input_line_pointer as libc::c_int != '(' as i32 {
                                as_bad(
                                    dcgettext(
                                        0 as *const libc::c_char,
                                        b"syntax error in .startof. or .sizeof.\0" as *const u8
                                            as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                );
                                ...
                                if *name == 0 {
                                    as_bad(
                                        dcgettext(
                                            0 as *const libc::c_char,
                                            b"expected symbol name\0" as *const u8
                                                as *const libc::c_char,
                                            5 as libc::c_int,
                                        ),
                                    );
                                    ...
                                    (*expressionP).set_X_op(O_symbol);
                                    (*expressionP)
                                        .X_add_symbol = symbol_lookup_or_make(name, start != 0);
                                    (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
                                    *input_line_pointer = c;
                                    if *input_line_pointer as libc::c_int == '"' as i32 {
                                        input_line_pointer = input_line_pointer.offset(1);
                            ...
                            current_block = 5105534928348863581;
                        }
                    }
                    1050295914971629968 => {
                        if literal_prefix_dollar_hex {
                            if *input_line_pointer as libc::c_int == 'L' as i32 {
                                current_block = 5105534928348863581;
                            } else {
                                integer_constant(16 as libc::c_int, expressionP);
                                current_block = 1948584361000433526;
                            }
                        } else {
                            current_block = 5105534928348863581;
                    ...
                    6010581226542848721 => {
                        if 0 as libc::c_int == 0 {
                            ...
                            input_line_pointer = input_line_pointer.offset(1);
                            (*expressionP).X_add_number = *fresh15 as offsetT;
                        } else {
                            mri_char_constant(expressionP);
                        }
                        current_block = 1948584361000433526;
                    }
                    14591056799634966724 => {
                        if 0 as libc::c_int != 0 || 0 as libc::c_int != 0 {
                            let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
                            s = input_line_pointer;
                            while _hex_value[*s as libc::c_uchar as usize]
                                as libc::c_uint != 99 as libc::c_int as libc::c_uint
                            {
                                s = s.offset(1);
                                s;
                            }
                                ...
                                || *input_line_pointer as libc::c_int == '.' as i32
                            {
                                input_line_pointer = input_line_pointer.offset(-1);
                                input_line_pointer;
                                integer_constant(0 as libc::c_int, expressionP);
                                current_block = 1948584361000433526;
                            } else {
                                ...
                                match c as libc::c_int {
                                    111 | 79 | 113 | 81 | 56 | 57 => {
                                        if 0 as libc::c_int != 0 || 0 as libc::c_int != 0 {
                                            ...
                                            current_block = 1576839159241780801;
                                        }
                                    }
                                    120 | 88 => {
                                        input_line_pointer = input_line_pointer.offset(1);
                                    ...
                                    98 => {
                                                ...
                                                as libc::c_int != '1' as i32
                                        {
                                            input_line_pointer = input_line_pointer.offset(-1);
                                            input_line_pointer;
                                            integer_constant(10 as libc::c_int, expressionP);
                                            current_block = 1948584361000433526;
                                        } else {
                                            current_block = 12680922000129779508;
                                        }
                                    }
                                    66 => {
                                        current_block = 12680922000129779508;
                                    ...
                                    102 => {
                                        let mut is_label: libc::c_int = 1 as libc::c_int;
                                        if *is_end_of_line
                                            .as_mut_ptr()
                                            .offset(
                                                *input_line_pointer.offset(1 as libc::c_int as isize)
                                            ...
                                            && !(strchr(FLT_CHARS.as_ptr(), 'f' as i32)).is_null()
                                        {
                                            let mut cp: *mut libc::c_char = input_line_pointer
                                                .offset(1 as libc::c_int as isize);
                                            atof_generic(
                                                &mut cp,
                                                b".\0" as *const u8 as *const libc::c_char,
                                            ...
                                            is_label = (cp
                                                == input_line_pointer.offset(1 as libc::c_int as isize)
                                                || cp
                                                    == input_line_pointer.offset(2 as libc::c_int as isize)
                                                    && (*cp.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                                        == '-' as i32
                                                        || *cp.offset(-(1 as libc::c_int) as isize) as libc::c_int
                                                            == '+' as i32) || *cp as libc::c_int == 'f' as i32
                                                || *cp as libc::c_int == 'b' as i32) as libc::c_int;
                                        }
                                        if is_label != 0 {
                                            input_line_pointer = input_line_pointer.offset(-1);
                                            input_line_pointer;
                                            ...
                                            current_block = 16776685093005531848;
                                        }
                                    }
                                    100 | 68 => {
                                        current_block = 16776685093005531848;
                                    }
                                    70 | 114 | 101 | 69 | 103 | 71 => {
                                        current_block = 1291354905256079193;
                                    }
                                    36 | _ => {
                                        current_block = 1576839159241780801;
                                    }
                                        ...
                                        match current_block {
                                            ...
                                            12680922000129779508 => {
                                                        ...
                                                        as libc::c_int == '1' as i32
                                                {
                                                    input_line_pointer = input_line_pointer.offset(1);
                                                    input_line_pointer;
                                                    integer_constant(2 as libc::c_int, expressionP);
                                                    current_block = 1948584361000433526;
                                                } else {
                                                    if 0 as libc::c_int != 0 || 0 as libc::c_int != 0 {
                                                        input_line_pointer = input_line_pointer.offset(1);
                                                ...
                                                match current_block {
                                                    1576839159241780801 => {
                                                        if c as libc::c_int != 0
                                                            && !(strchr(FLT_CHARS.as_ptr(), c as libc::c_int)).is_null()
                                                        {
                                                            input_line_pointer = input_line_pointer.offset(1);
                                                            input_line_pointer;
                                                            floating_constant(expressionP);
                                                            (*expressionP)
                                                                .X_add_number = -(_sch_tolower[(c as libc::c_int
                                                                & 0xff as libc::c_int) as usize] as libc::c_int) as offsetT;
                                                        } else {
                                                            (*expressionP).set_X_op(O_constant);
                                                            (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
                                                        }
                    ...
                    1026693477428821124 => {
                        if i386_need_index_operator() != 0 {
                            current_block = 12178979298162571590;
                        } else {
                            current_block = 17995319288793786602;
                        }
                    }
                    12255340648165522132 => {
                        if *lex_type.as_mut_ptr().offset(c as libc::c_uchar as isize)
                            as libc::c_int & 2 as libc::c_int != 0
                        {
                            current_block = 5105534928348863581;
                        } else {
                            current_block = 9880686229356789897;
                        }
                    }
                    _ => {}
                }
                match current_block {
                    ...
                    _ => {
                        match current_block {
                            12178979298162571590 => {
                                if *lex_type
                                    .as_mut_ptr()
                                    .offset(c as libc::c_uchar as isize) as libc::c_int
                                    & 2 as libc::c_int != 0 || c as libc::c_int == '"' as i32
                                {
                                    current_block = 5105534928348863581;
                                } else {
                                    (*expressionP).set_X_op(O_absent);
                                    ...
                                    if (*expressionP).X_op() as libc::c_int
                                        == O_absent as libc::c_int
                                    {
                                        input_line_pointer = input_line_pointer.offset(1);
                                        input_line_pointer;
                                        as_bad(
                            ...
                            17995319288793786602 => {
                                segment = expr(0 as libc::c_int, expressionP, mode);
                                if c as libc::c_int == '(' as i32
                                    && *input_line_pointer as libc::c_int != ')' as i32
                                    || c as libc::c_int == '[' as i32
                                        && *input_line_pointer as libc::c_int != ']' as i32
                                {
                                    if *input_line_pointer != 0 {
                                        as_bad(
                                            dcgettext(
                                                0 as *const libc::c_char,
                                                b"found '%c', expected: '%c'\0" as *const u8
                                                    as *const libc::c_char,
                                                5 as libc::c_int,
                                            ),
                                        ...
                                        as_bad(
                                            dcgettext(
                                                0 as *const libc::c_char,
                                                b"missing '%c'\0" as *const u8 as *const libc::c_char,
                                                5 as libc::c_int,
                                            ),
                                            if c as libc::c_int == '(' as i32 {
                                                ')' as i32
                            ...
                            _ => {
                                match current_block {
                                    5105534928348863581 => {
                                        ...
                                        input_line_pointer;
                                        c = get_symbol_name(&mut name);
                                        let mut op: operatorT = i386_operator(
                                            name,
                                        ...
                                        match op as libc::c_uint {
                                            ...
                                            0 => {
                                                as_bad(
                                                    dcgettext(
                                                        0 as *const libc::c_char,
                                                        b"invalid use of operator \"%s\"\0" as *const u8
                                                            as *const libc::c_char,
                                                        5 as libc::c_int,
                                                    ),
                                                    name,
                                        ...
                                        match current_block {
                                            ...
                                            _ => {
                                                if op as libc::c_uint
                                                    ...
                                                    && op as libc::c_uint
                                                        != O_illegal as libc::c_int as libc::c_uint
                                                {
                                                    restore_line_pointer(c);
                                                    expr(9 as libc::c_int, expressionP, mode);
                                                    (*expressionP).X_add_symbol = make_expr_symbol(expressionP);
                                                    (*expressionP).X_op_symbol = 0 as *mut symbolS;
                                                    (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
                                                    (*expressionP).set_X_op(op);
                                                } else if i386_parse_name(name, expressionP, &mut c) != 0 {
                                                    restore_line_pointer(c);
                                                } else {
                                                    symbolP = symbol_find_or_make(name);
                                                    segment = S_GET_SEGMENT(symbolP);
                                                    if mode as libc::c_uint
                                                        != expr_defer as libc::c_int as libc::c_uint
                                                        && segment
                                                            == &mut *_bfd_std_section
                                                                .as_mut_ptr()
                                                                .offset(2 as libc::c_int as isize) as *mut asection
                                                        && S_FORCE_RELOC(symbolP, 0 as libc::c_int) == 0
                                                    {
                                                        (*expressionP).set_X_op(O_constant);
                                                        (*expressionP)
                                                            .X_add_number = S_GET_VALUE(symbolP) as offsetT;
                                                    } else if mode as libc::c_uint
                                                        != expr_defer as libc::c_int as libc::c_uint
                                                        && segment == reg_section
                                                    {
                                                        (*expressionP).set_X_op(O_register);
                                                        (*expressionP)
                                                            .X_add_number = S_GET_VALUE(symbolP) as offsetT;
                                                    } else {
                                                        (*expressionP).set_X_op(O_symbol);
                                ...
                                match current_block {
                                    ...
                                    _ => {
                                            ...
                                            == O_constant as libc::c_int
                                        {
                                            if c as libc::c_int == '-' as i32 {
                                                (*expressionP)
                                                    .X_add_number = ((*expressionP).X_add_number as addressT)
                                                    .wrapping_neg() as offsetT;
                                                (*expressionP)
                                                    .set_X_unsigned(0 as libc::c_int as libc::c_uint);
                                                if (*expressionP).X_add_number != 0 {
                                                    (*expressionP)
                                                        .set_X_extrabit(
                                                            (*expressionP).X_extrabit()
                                                                ^ 1 as libc::c_int as libc::c_uint,
                                                        );
                                                }
                                            } else if c as libc::c_int == '~' as i32
                                                || c as libc::c_int == '"' as i32
                                            {
                                                ...
                                                (*expressionP)
                                                    .X_add_number = ((*expressionP).X_add_number == 0)
                                                    as libc::c_int as offsetT;
                                                (*expressionP)
                                                    .set_X_unsigned(1 as libc::c_int as libc::c_uint);
                                                (*expressionP)
                                                    .set_X_extrabit(0 as libc::c_int as libc::c_uint);
                                            }
                                        } else if (*expressionP).X_op() as libc::c_int
                                            == O_big as libc::c_int
                                            && (*expressionP).X_add_number
                                                <= 0 as libc::c_int as libc::c_long
                                            && c as libc::c_int == '-' as i32
                                            && (generic_floating_point_number.sign as libc::c_int
                                                == '+' as i32
                                                || generic_floating_point_number.sign as libc::c_int
                                                    == 'P' as i32)
                                        {
                                            if generic_floating_point_number.sign as libc::c_int
                                                == '+' as i32
                                            {
                                                ...
                                                > 0 as libc::c_int as libc::c_long
                                        {
                                            ...
                                            {
                                                i = 0 as libc::c_int;
                                                while (i as libc::c_long) < (*expressionP).X_add_number {
                                                    generic_bignum[i
                                                        as usize] = !(generic_bignum[i as usize] as libc::c_int)
                                                        as LITTLENUM_TYPE;
                                                    i += 1;
                                                ...
                                                {
                                                    (*expressionP).X_add_number = 20 as libc::c_int as offsetT;
                                                    while (i as libc::c_long) < (*expressionP).X_add_number {
                                                        generic_bignum[i
                                                            as usize] = !(0 as libc::c_int as LITTLENUM_TYPE
                                                            as libc::c_int) as LITTLENUM_TYPE;
                                                        i += 1;
                                                        i;
                                                    }
                                                }
                                                if c as libc::c_int == '-' as i32 {
                                                    ...
                                                    while (i as libc::c_long) < (*expressionP).X_add_number {
                                                        ...
                                                        if generic_bignum[i as usize] != 0 {
                                                            break;
                                                        }
                                                        i += 1;
                                                        i;
                                                ...
                                                i = 0 as libc::c_int;
                                                while (i as libc::c_long) < (*expressionP).X_add_number {
                                                    if generic_bignum[i as usize] as libc::c_int
                                                        != 0 as libc::c_int
                                                    {
                                                        break;
                                                    }
                                                ...
                                                (*expressionP)
                                                    .X_add_number = (i as libc::c_long
                                                    >= (*expressionP).X_add_number) as libc::c_int as offsetT;
                                                (*expressionP).set_X_op(O_constant);
                                                (*expressionP)
                                                    .set_X_unsigned(1 as libc::c_int as libc::c_uint);
                                                (*expressionP)
                                            ...
                                            != O_illegal as libc::c_int
                                            && (*expressionP).X_op() as libc::c_int
                                                != O_absent as libc::c_int
                                        {
                                            if c as libc::c_int != '+' as i32 {
                                                (*expressionP).X_add_symbol = make_expr_symbol(expressionP);
                                                if c as libc::c_int == '-' as i32 {
                                                    (*expressionP).set_X_op(O_uminus);
                                                } else if c as libc::c_int == '~' as i32
                                                    || c as libc::c_int == '"' as i32
                                                {
                                                    (*expressionP).set_X_op(O_bit_not);
                                                } else {
                                                    (*expressionP).set_X_op(O_logical_not);
                                                }
                                                (*expressionP).X_add_number = 0 as libc::c_int as offsetT;
                                            }
                                        } else {
                                            as_warn(
                                                dcgettext(
                                                    0 as *const libc::c_char,
                                                    b"Unary operator %c ignored because bad operand follows\0"
                                                        as *const u8 as *const libc::c_char,
                                                    5 as libc::c_int,
                                                ),
                                                c as libc::c_int,
            ...
            48 => {
                current_block = 14591056799634966724;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
            ...
            91 => {
                current_block = 1026693477428821124;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
            ...
            39 => {
                current_block = 6010581226542848721;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
            ...
            126 => {
                current_block = 12255340648165522132;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
            ...
            36 => {
                current_block = 1050295914971629968;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
            ...
            46 => {
                current_block = 14440267993914068418;
                match current_block {
                    14440267993914068418 => {
                        if *lex_type
                            .as_mut_ptr()
    ...
    if !((*expressionP).X_add_symbol).is_null() {
        symbol_mark_used((*expressionP).X_add_symbol);
    }
    if mode as libc::c_uint != expr_defer as libc::c_int as libc::c_uint {
        (*expressionP)
            .X_add_symbol = symbol_clone_if_forward_ref(
            (*expressionP).X_add_symbol,
            0 as libc::c_int,
        );
        (*expressionP)
            .X_op_symbol = symbol_clone_if_forward_ref(
            (*expressionP).X_op_symbol,
            0 as libc::c_int,
        );
    }
    match (*expressionP).X_op() as libc::c_int {
        3 => return S_GET_SEGMENT((*expressionP).X_add_symbol),
        5 => return reg_section,
        _ => {
...
static mut op_encoding: [operatorT; 256] = [
    O_illegal,
    O_illegal,
    O_illegal,
    O_illegal,
...
static mut op_rank: [operator_rankT; 62] = [
    0 as libc::c_int as operator_rankT,
    0 as libc::c_int as operator_rankT,
    0 as libc::c_int as operator_rankT,
    0 as libc::c_int as operator_rankT,
    0 as libc::c_int as operator_rankT,
    0 as libc::c_int as operator_rankT,
    0 as libc::c_int as operator_rankT,
    9 as libc::c_int as operator_rankT,
    9 as libc::c_int as operator_rankT,
    9 as libc::c_int as operator_rankT,
    8 as libc::c_int as operator_rankT,
    8 as libc::c_int as operator_rankT,
    8 as libc::c_int as operator_rankT,
    8 as libc::c_int as operator_rankT,
    8 as libc::c_int as operator_rankT,
    7 as libc::c_int as operator_rankT,
    7 as libc::c_int as operator_rankT,
    7 as libc::c_int as operator_rankT,
    7 as libc::c_int as operator_rankT,
    5 as libc::c_int as operator_rankT,
    5 as libc::c_int as operator_rankT,
    4 as libc::c_int as operator_rankT,
    4 as libc::c_int as operator_rankT,
    4 as libc::c_int as operator_rankT,
    4 as libc::c_int as operator_rankT,
    4 as libc::c_int as operator_rankT,
    4 as libc::c_int as operator_rankT,
    3 as libc::c_int as operator_rankT,
    2 as libc::c_int as operator_rankT,
    1 as libc::c_int as operator_rankT,
    0,
    0,
    0,
    0,
...
#[inline]
unsafe extern "C" fn operatorf(mut num_chars: *mut libc::c_int) -> operatorT {
    let mut c: libc::c_int = 0;
    let mut ret: operatorT = O_illegal;
    c = *input_line_pointer as libc::c_int & 0xff as libc::c_int;
    *num_chars = 1 as libc::c_int;
    if *is_end_of_line.as_mut_ptr().offset(c as isize) != 0 {
        return O_illegal;
    }
    if *lex_type.as_mut_ptr().offset(c as libc::c_uchar as isize) as libc::c_int
        & 2 as libc::c_int != 0
    {
        let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut ec: libc::c_char = get_symbol_name(&mut name);
        ret = i386_operator(name, 2 as libc::c_int as libc::c_uint, &mut ec);
        's_68: {
            ...
            *input_line_pointer = ec;
            *num_chars = input_line_pointer.offset_from(name) as libc::c_long
                as libc::c_int;
            input_line_pointer = name;
            return ret;
        }
    ...
    match c {
        43 | 45 => return op_encoding[c as usize],
        60 => {
            match *input_line_pointer.offset(1 as libc::c_int as isize) as libc::c_int {
                60 => {
                    ret = O_left_shift;
                }
                62 => {
                ...
                _ => return op_encoding[c as usize],
            }
            *num_chars = 2 as libc::c_int;
            return ret;
        }
        61 => {
            if *input_line_pointer.offset(1 as libc::c_int as isize) as libc::c_int
        ...
        _ => {
            ret = op_encoding[c as usize];
            if ret as libc::c_uint == O_illegal as libc::c_int as libc::c_uint {
                let mut start: *mut libc::c_char = input_line_pointer;
                ret = i386_operator(
                    0 as *const libc::c_char,
                ...
                if ret as libc::c_uint != O_illegal as libc::c_int as libc::c_uint {
                    *num_chars = input_line_pointer.offset_from(start) as libc::c_long
                        as libc::c_int;
                }
                input_line_pointer = start;
            }
...
unsafe extern "C" fn run_static_initializers() {
    generic_floating_point_number = {
        let mut init = FLONUM_STRUCT {
            low: &mut *generic_bignum.as_mut_ptr().offset(6 as libc::c_int as isize)
                as *mut LITTLENUM_TYPE,
            high: &mut *generic_bignum
                .as_mut_ptr()
                .offset(
                    (20 as libc::c_int + 6 as libc::c_int - 1 as libc::c_int) as isize,
                ) as *mut LITTLENUM_TYPE,
