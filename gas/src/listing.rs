extern "C" {
    ...
    fn as_where_physical(_: *mut libc::c_uint) -> *const libc::c_char;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct list_info_struct {
    pub frag: *mut fragS,
    pub line: libc::c_uint,
    pub file: *mut file_info_type,
    pub line_contents: *mut libc::c_char,
    pub next: *mut list_info_struct,
    pub hll_file: *mut file_info_type,
    pub hll_line: libc::c_uint,
    pub messages: *mut list_message,
    pub last_message: *mut list_message,
    pub edict: edict_enum,
    pub edict_arg: *mut libc::c_char,
    pub debugging: libc::c_int,
}
pub type edict_enum = libc::c_uint;
pub const EDICT_EJECT: edict_enum = 6;
pub const EDICT_NOLIST_NEXT: edict_enum = 5;
pub const EDICT_LIST: edict_enum = 4;
pub const EDICT_NOLIST: edict_enum = 3;
pub const EDICT_TITLE: edict_enum = 2;
pub const EDICT_SBTTL: edict_enum = 1;
pub const EDICT_NONE: edict_enum = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct list_message {
    pub message: *mut libc::c_char,
    pub next: *mut list_message,
}
pub type file_info_type = file_info_struct;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct file_info_struct {
    pub next: *mut file_info_struct,
    pub filename: *mut libc::c_char,
    pub pos: libc::c_long,
    pub linenum: libc::c_uint,
    pub at_end: libc::c_int,
}
...
pub type fixS = fix;
pub type list_info_type = list_info_struct;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct cached_line {
    pub file: *mut file_info_type,
    pub line: libc::c_uint,
    pub buffer: [libc::c_char; 100],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tm {
...
#[no_mangle]
pub unsafe extern "C" fn listing_warning(mut message: *const libc::c_char) {
    listing_message(
        dcgettext(
...
#[no_mangle]
pub unsafe extern "C" fn listing_title(mut depth: libc::c_int) {
    let mut quoted: libc::c_int = 0;
    let mut start: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut ttl: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    while *input_line_pointer != 0 {
        if if quoted != 0 {
            (*input_line_pointer as libc::c_int == '"' as i32) as libc::c_int
        } else {
            *is_end_of_line
                .as_mut_ptr()
        ...
        {
            if listing != 0 {
                length = input_line_pointer.offset_from(start) as libc::c_long
                    as libc::c_uint;
                ttl = xmemdup0(start, length as size_t);
                (*listing_tail)
                    .edict = (if depth != 0 {
                    EDICT_SBTTL as libc::c_int
                } else {
                    EDICT_TITLE as libc::c_int
                }) as edict_enum;
            ...
            return;
        } else if *input_line_pointer as libc::c_int == '\n' as i32 {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"new line in title\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
            demand_empty_rest_of_line();
...
#[no_mangle]
pub unsafe extern "C" fn listing_source_line(mut line: libc::c_uint) {
    if listing != 0 {
        new_frag();
...
#[no_mangle]
pub unsafe extern "C" fn listing_source_file(mut file: *const libc::c_char) {
    if listing != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn listing_psize(mut width_only: libc::c_int) {
    if width_only == 0 {
        paper_height = get_absolute_expression() as libc::c_int;
        if paper_height < 0 as libc::c_int || paper_height > 1000 as libc::c_int {
            paper_height = 0 as libc::c_int;
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
                    b"strange paper height, set to no form\0" as *const u8
    ...
    if exp.X_op() as libc::c_int == O_constant as libc::c_int {
        let mut new_width: offsetT = exp.X_add_number;
        if new_width > 7 as libc::c_int as libc::c_long {
            paper_width = new_width as libc::c_int;
        } else {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"new paper width is too small\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        ...
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"bad or irreducible expression for paper width\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        ...
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"missing expression for paper width\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
#[no_mangle]
pub static mut listing_rhs_width: libc::c_int = 100 as libc::c_int;
#[no_mangle]
pub static mut listing_lhs_width: libc::c_int = 0;
#[no_mangle]
pub static mut listing_lhs_cont_lines: libc::c_int = 4 as libc::c_int;
#[no_mangle]
pub static mut listing_lhs_width_second: libc::c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn listing_print(
    mut name: *mut libc::c_char,
    mut argv: *mut *mut libc::c_char,
) {
    let mut using_stdout: libc::c_int = 0;
    title = b"\0" as *const u8 as *const libc::c_char;
    subtitle = b"\0" as *const u8 as *const libc::c_char;
    if name.is_null() {
        list_file = stdout;
        using_stdout = 1 as libc::c_int;
    } else {
        list_file = fopen(name, b"w\0" as *const u8 as *const libc::c_char);
        if !list_file.is_null() {
            using_stdout = 0 as libc::c_int;
        } else {
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
    ...
    if listing & 4 as libc::c_int != 0 {
        paper_height = 0 as libc::c_int;
    }
    if listing & 128 as libc::c_int != 0 {
        listing_general_info(argv);
    }
    if listing & 1 as libc::c_int != 0 {
    ...
    if using_stdout == 0 {
        if fclose(list_file) == -(1 as libc::c_int) {
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
    ...
    if !last_open_file.is_null() {
        fclose(last_open_file);
    }
}
#[no_mangle]
pub unsafe extern "C" fn listing_prev_line() {
    let mut l: *mut list_info_type = 0 as *mut list_info_type;
    let mut f: *mut fragS = 0 as *mut fragS;
    if head.is_null() || head == listing_tail {
        return;
    }
    new_frag();
    l = head;
    while (*l).next != listing_tail {
        l = (*l).next;
    }
...
#[no_mangle]
pub unsafe extern "C" fn listing_newline(mut ps: *mut libc::c_char) {
    let mut file: *const libc::c_char = 0 as *const libc::c_char;
    let mut line: libc::c_uint = 0;
    static mut last_line: libc::c_uint = 0xffff as libc::c_int as libc::c_uint;
    static mut last_file: *const libc::c_char = 0 as *const libc::c_char;
    let mut new_i: *mut list_info_type = 0 as *mut list_info_type;
    if listing == 0 as libc::c_int {
        return;
    }
    if now_seg
    ...
    if listing & 16 as libc::c_int != 0 as libc::c_int && !listing_tail.is_null()
        && (*listing_tail).debugging == 0
    {
        let mut segname: *const libc::c_char = 0 as *const libc::c_char;
        segname = bfd_section_name(now_seg as *const asection);
        if startswith(segname, b".debug\0" as *const u8 as *const libc::c_char)
            as libc::c_int != 0
            || startswith(segname, b".line\0" as *const u8 as *const libc::c_char)
                as libc::c_int != 0
        {
            (*listing_tail).debugging = 1 as libc::c_int;
        }
    }
    if listing & 8 as libc::c_int != 0 {
        file = as_where(&mut line);
    } else {
        file = as_where_physical(&mut line);
    }
    if ps.is_null() {
        if line == last_line
            && !(!last_file.is_null() && !file.is_null()
                && filename_cmp(file, last_file) != 0)
        {
            return;
        }
        new_i = xmalloc(::core::mem::size_of::<list_info_type>() as libc::c_ulong)
            as *mut list_info_type;
        if strcmp(
            file,
            dcgettext(
                0 as *const libc::c_char,
        ...
        ) == 0 as libc::c_int && !input_line_pointer.is_null()
        {
            let mut copy: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut src: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut dest: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut len: libc::c_int = 0;
            let mut seen_quote: libc::c_int = 0 as libc::c_int;
            let mut seen_slash: libc::c_int = 0 as libc::c_int;
            copy = input_line_pointer;
            while *copy as libc::c_int != 0
                && (seen_quote != 0
                    || *is_end_of_line
                        .as_mut_ptr()
                        .offset(*copy as libc::c_uchar as isize) as libc::c_int
                        != 1 as libc::c_int)
            {
                if seen_slash != 0 {
                    seen_slash = 0 as libc::c_int;
                } else if *copy as libc::c_int == '\\' as i32 {
                    seen_slash = 1 as libc::c_int;
                } else if *copy as libc::c_int == '"' as i32 {
                    seen_quote = (seen_quote == 0) as libc::c_int;
                }
                copy = copy.offset(1);
                copy;
            }
            len = (copy.offset_from(input_line_pointer) as libc::c_long
            ...
            *dest = 0 as libc::c_int as libc::c_char;
            ...
            (*new_i).line_contents = 0 as *mut libc::c_char;
        }
    } else {
        new_i = xmalloc(::core::mem::size_of::<list_info_type>() as libc::c_ulong)
            as *mut list_info_type;
    ...
    (*new_i).next = 0 as *mut libc::c_void as *mut list_info_type;
    (*new_i).messages = 0 as *mut list_message;
    (*new_i).last_message = 0 as *mut list_message;
    (*new_i).edict = EDICT_NONE;
    (*new_i).hll_file = 0 as *mut libc::c_void as *mut file_info_type;
    (*new_i).hll_line = 0 as libc::c_int as libc::c_uint;
    (*new_i).debugging = 0 as libc::c_int;
    new_frag();
    if listing & 16 as libc::c_int != 0 as libc::c_int {
        let mut segname_0: *const libc::c_char = 0 as *const libc::c_char;
        segname_0 = bfd_section_name(now_seg as *const asection);
        if startswith(segname_0, b".debug\0" as *const u8 as *const libc::c_char)
            as libc::c_int != 0
            || startswith(segname_0, b".line\0" as *const u8 as *const libc::c_char)
                as libc::c_int != 0
        {
            (*new_i).debugging = 1 as libc::c_int;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn listing_list(mut on: libc::c_int) {
    if listing != 0 {
        match on {
            0 => {
                if (*listing_tail).edict as libc::c_uint
                    == EDICT_LIST as libc::c_int as libc::c_uint
                {
            ...
            1 => {
                if (*listing_tail).edict as libc::c_uint
                    == EDICT_NOLIST as libc::c_int as libc::c_uint
                    || (*listing_tail).edict as libc::c_uint
                        == EDICT_NOLIST_NEXT as libc::c_int as libc::c_uint
                {
                    (*listing_tail).edict = EDICT_NONE;
                } else {
            ...
            _ => {
                as_abort(
                    b"listing.c\0" as *const u8 as *const libc::c_char,
                    1487 as libc::c_int,
                    (*::core::mem::transmute::<
                        &[u8; 23],
                        &[libc::c_char; 23],
                    >(b"void listing_list(int)\0"))
                        .as_ptr(),
                );
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn listing_file(mut name: *const libc::c_char) {
    fn_0 = name;
}
#[no_mangle]
pub unsafe extern "C" fn listing_error(mut message: *const libc::c_char) {
    listing_message(
        dcgettext(
            0 as *const libc::c_char,
...
#[no_mangle]
pub static mut listing_tail: *mut list_info_struct = 0 as *const list_info_struct
    as *mut list_info_struct;
static mut file_info_head: *mut file_info_type = 0 as *const file_info_type
    as *mut file_info_type;
static mut last_open_file_info: *mut file_info_type = 0 as *const file_info_type
    as *mut file_info_type;
static mut last_open_file: *mut FILE = 0 as *const FILE as *mut FILE;
static mut head: *mut list_info_struct = 0 as *const list_info_struct
    as *mut list_info_struct;
static mut paper_width: libc::c_int = 200 as libc::c_int;
static mut paper_height: libc::c_int = 60 as libc::c_int;
static mut list_file: *mut FILE = 0 as *const FILE as *mut FILE;
static mut data_buffer: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
unsafe extern "C" fn listing_message(
    mut name: *const libc::c_char,
    mut message: *const libc::c_char,
) {
    if !listing_tail.is_null() {
        let mut n: *mut libc::c_char = concat(
            name,
            message,
            0 as *mut libc::c_void as *mut libc::c_char,
        );
        let mut lm: *mut list_message = xmalloc(
            ::core::mem::size_of::<list_message>() as libc::c_ulong,
        ) as *mut list_message;
        (*lm).message = n;
        (*lm).next = 0 as *mut list_message;
        if !((*listing_tail).last_message).is_null() {
...
unsafe extern "C" fn file_info(
    mut file_name: *const libc::c_char,
) -> *mut file_info_type {
    let mut p: *mut file_info_type = file_info_head;
    while !p.is_null() {
        if filename_cmp((*p).filename, file_name) == 0 as libc::c_int {
            return p;
        }
        p = (*p).next;
    }
    p = xmalloc(::core::mem::size_of::<file_info_type>() as libc::c_ulong)
        as *mut file_info_type;
    (*p).next = file_info_head;
    file_info_head = p;
    (*p).filename = xstrdup(file_name);
    (*p).pos = 0 as libc::c_int as libc::c_long;
    (*p).linenum = 0 as libc::c_int as libc::c_uint;
    (*p).at_end = 0 as libc::c_int;
    return p;
}
unsafe extern "C" fn new_frag() {
    frag_wane(frag_now);
    frag_new(0 as libc::c_int as size_t);
}
unsafe extern "C" fn listing_page(mut list: *mut list_info_type) {
    if (eject != 0 || on_page >= paper_height as libc::c_uint)
        && paper_height != 0 as libc::c_int
    {
        let mut c: libc::c_uint = 10 as libc::c_int as libc::c_uint;
        let mut had_title: libc::c_int = 0 as libc::c_int;
        let mut had_subtitle: libc::c_int = 0 as libc::c_int;
        page = page.wrapping_add(1);
        page;
        while c != 0 as libc::c_int as libc::c_uint && !list.is_null() {
            if (*list).edict as libc::c_uint
                == EDICT_SBTTL as libc::c_int as libc::c_uint && had_subtitle == 0
            {
                had_subtitle = 1 as libc::c_int;
                subtitle = (*list).edict_arg;
            }
            if (*list).edict as libc::c_uint
                == EDICT_TITLE as libc::c_int as libc::c_uint && had_title == 0
            {
                had_title = 1 as libc::c_int;
        ...
        if page > 1 as libc::c_int as libc::c_uint {
            fprintf(list_file, b"\x0C\0" as *const u8 as *const libc::c_char);
        }
        fprintf(
            list_file,
            b"%s %s \t\t\tpage %d\n\0" as *const u8 as *const libc::c_char,
            b"GAS LISTING\0" as *const u8 as *const libc::c_char,
            fn_0,
            page,
        );
        fprintf(list_file, b"%s\n\0" as *const u8 as *const libc::c_char, title);
        fprintf(list_file, b"%s\n\0" as *const u8 as *const libc::c_char, subtitle);
        on_page = 3 as libc::c_int as libc::c_uint;
        eject = 0 as libc::c_int as libc::c_uint;
    }
}
unsafe extern "C" fn calc_hex(mut list: *mut list_info_type) -> libc::c_uint {
    let mut data_buffer_size: libc::c_int = 0;
    let mut first: *mut list_info_type = list;
    let mut address: libc::c_uint = !(0 as libc::c_int as libc::c_uint);
    let mut frag: *mut fragS = 0 as *mut fragS;
    let mut frag_ptr: *mut fragS = 0 as *mut fragS;
    let mut octet_in_frag: libc::c_uint = 0;
    frag = (*list).frag;
    while !frag.is_null() && (*frag).line != list {
        frag = (*frag).fr_next;
    }
    frag_ptr = frag;
    data_buffer_size = 0 as libc::c_int;
    while !frag_ptr.is_null() && (*frag_ptr).line == first {
        octet_in_frag = 0 as libc::c_int as libc::c_uint;
        while (octet_in_frag as libc::c_ulong) < (*frag_ptr).fr_fix
            && data_buffer_size
                < (4 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
                    * listing_lhs_width
                    + (4 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
                        * listing_lhs_width_second * listing_lhs_cont_lines
                    + 20 as libc::c_int - 3 as libc::c_int
        {
            if address == !(0 as libc::c_int as libc::c_uint) {
            ...
            sprintf(
                data_buffer.offset(data_buffer_size as isize),
                b"%02X\0" as *const u8 as *const libc::c_char,
                *((*frag_ptr).fr_literal).as_mut_ptr().offset(octet_in_frag as isize)
                    as libc::c_int & 0xff as libc::c_int,
            );
            data_buffer_size += 2 as libc::c_int;
            octet_in_frag = octet_in_frag.wrapping_add(1);
            octet_in_frag;
        }
        if (*frag_ptr).fr_type as libc::c_uint == rs_fill as libc::c_int as libc::c_uint
        {
            let mut var_rep_max: libc::c_uint = octet_in_frag;
            let mut var_rep_idx: libc::c_uint = octet_in_frag;
            while (octet_in_frag as libc::c_ulong)
                < ((*frag_ptr).fr_fix)
                    .wrapping_add(
                        ((*frag_ptr).fr_var * (*frag_ptr).fr_offset) as libc::c_ulong,
                    )
                && data_buffer_size
                    < (4 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
                        * listing_lhs_width
                        ...
                        + 20 as libc::c_int - 3 as libc::c_int
            {
                ...
                sprintf(
                    data_buffer.offset(data_buffer_size as isize),
                    b"%02X\0" as *const u8 as *const libc::c_char,
                    *((*frag_ptr).fr_literal).as_mut_ptr().offset(var_rep_idx as isize)
                        as libc::c_int & 0xff as libc::c_int,
                );
                data_buffer_size += 2 as libc::c_int;
                var_rep_idx = var_rep_idx.wrapping_add(1);
                var_rep_idx;
                octet_in_frag = octet_in_frag.wrapping_add(1);
                octet_in_frag;
                if var_rep_idx as libc::c_ulong
                    >= ((*frag_ptr).fr_fix)
                        .wrapping_add((*frag_ptr).fr_var as libc::c_ulong)
                {
    ...
    *data_buffer.offset(data_buffer_size as isize) = '\0' as i32 as libc::c_char;
    return address;
}
unsafe extern "C" fn print_lines(
    mut list: *mut list_info_type,
    mut lineno: libc::c_uint,
    mut string: *const libc::c_char,
    mut address: libc::c_uint,
) {
    let mut idx: libc::c_uint = 0;
    let mut nchars: libc::c_uint = 0;
    let mut lines: libc::c_uint = 0;
    let mut octet_in_word: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut src: *mut libc::c_char = data_buffer;
    let mut cur: libc::c_int = 0;
    let mut msg: *mut list_message = 0 as *mut list_message;
    listing_page(list);
    nchars = ((4 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
        * listing_lhs_width) as libc::c_uint;
    if address == !(0 as libc::c_int as libc::c_uint) {
        fprintf(list_file, b"% 4d     \0" as *const u8 as *const libc::c_char, lineno);
        idx = 0 as libc::c_int as libc::c_uint;
        while idx < nchars {
            fprintf(list_file, b" \0" as *const u8 as *const libc::c_char);
            idx = idx.wrapping_add(1);
            idx;
        }
        emit_line(
            0 as *mut list_info_type,
            b"\t%s\n\0" as *const u8 as *const libc::c_char,
            if !string.is_null() {
                string
            } else {
    ...
    if had_errors() != 0 {
        ...
        fprintf(
            list_file,
            b"% 4d %04x \0" as *const u8 as *const libc::c_char,
            lineno,
            address,
        );
    }
    idx = 0 as libc::c_int as libc::c_uint;
    cur = 0 as libc::c_int;
    while *src.offset(cur as isize) as libc::c_int != 0 && idx < nchars {
        ...
        fprintf(
            ...
            *src.offset((offset + 1 as libc::c_int) as isize) as libc::c_int,
        );
        cur += 2 as libc::c_int;
        octet_in_word = octet_in_word.wrapping_add(1);
        octet_in_word;
        if octet_in_word == 4 as libc::c_int as libc::c_uint {
            fprintf(list_file, b" \0" as *const u8 as *const libc::c_char);
            idx = idx.wrapping_add(1);
            idx;
            octet_in_word = 0 as libc::c_int as libc::c_uint;
        }
        idx = idx.wrapping_add(2 as libc::c_int as libc::c_uint);
    }
    while idx < nchars {
        fprintf(list_file, b" \0" as *const u8 as *const libc::c_char);
        idx = idx.wrapping_add(1);
    ...
    while lines < listing_lhs_cont_lines as libc::c_uint
        && *src.offset(cur as isize) as libc::c_int != 0
    {
        nchars = ((4 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int)
            * listing_lhs_width_second - 1 as libc::c_int) as libc::c_uint;
        idx = 0 as libc::c_int as libc::c_uint;
        fprintf(list_file, b"% 4d      \0" as *const u8 as *const libc::c_char, lineno);
        while *src.offset(cur as isize) as libc::c_int != 0 && idx < nchars {
            ...
            fprintf(
                list_file,
                b"%c%c\0" as *const u8 as *const libc::c_char,
                *src.offset(offset_0 as isize) as libc::c_int,
                *src.offset((offset_0 + 1 as libc::c_int) as isize) as libc::c_int,
            );
            cur += 2 as libc::c_int;
            idx = idx.wrapping_add(2 as libc::c_int as libc::c_uint);
            octet_in_word = octet_in_word.wrapping_add(1);
...
unsafe extern "C" fn list_symbol_table() {
    extern "C" {
        #[link_name = "symbol_rootP"]
        static mut symbol_rootP_0: *mut symbolS;
    }
    let mut got_some: libc::c_int = 0 as libc::c_int;
    let mut ptr: *mut symbolS = 0 as *mut symbolS;
    eject = 1 as libc::c_int as libc::c_uint;
    listing_page(0 as *mut list_info_type);
    ptr = symbol_rootP;
    while !ptr.is_null() {
        if S_GET_SEGMENT(ptr)
            != &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
            && S_GET_SEGMENT(ptr)
                != &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize)
                    as *mut asection && S_GET_SEGMENT(ptr) != reg_section
            && S_GET_SEGMENT(ptr) != expr_section
            || S_GET_SEGMENT(ptr)
                == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                    as *mut asection
        {
            if !(symbol_section_p(ptr) != 0) {
                if !(S_GET_NAME(ptr)).is_null() {
                    let mut buf: [libc::c_char; 30] = [0; 30];
                    let mut fmt: [libc::c_char; 8] = [0; 8];
                    let mut val: valueT = S_GET_VALUE(ptr);
                    if ::core::mem::size_of::<valueT>() as libc::c_ulong
                    ...
                    } else if ::core::mem::size_of::<valueT>() as libc::c_ulong
                        <= ::core::mem::size_of::<libc::c_ulong>() as libc::c_ulong
                    {
                        sprintf(
                            fmt.as_mut_ptr(),
                            b"%%0%lulx\0" as *const u8 as *const libc::c_char,
                            (::core::mem::size_of::<valueT>() as libc::c_ulong)
                                .wrapping_mul(2 as libc::c_int as libc::c_ulong),
                        );
                        sprintf(buf.as_mut_ptr(), fmt.as_mut_ptr(), val);
                    } else if ::core::mem::size_of::<valueT>() as libc::c_ulong
                        > 4 as libc::c_int as libc::c_ulong
                    {
                        sprintf(
                        ...
                        as_abort(
                            ...
                            (*::core::mem::transmute::<
                                &[u8; 29],
                                &[libc::c_char; 29],
                            >(b"void list_symbol_table(void)\0"))
                                .as_ptr(),
                        );
                    }
                    if got_some == 0 {
                        ...
                        on_page = on_page.wrapping_add(1);
                        on_page;
                        got_some = 1 as libc::c_int;
                    }
                    if !(symbol_get_frag(ptr)).is_null()
                        && !((*symbol_get_frag(ptr)).line).is_null()
                    {
                        fprintf(
                            list_file,
                            b"%20s:%-5d  %s:%s %s\n\0" as *const u8
                            ...
                            bfd_section_name(S_GET_SEGMENT(ptr) as *const asection),
                            buf.as_mut_ptr(),
                            S_GET_NAME(ptr),
                        );
                    } else {
    ...
    emit_line(0 as *mut list_info_type, b"\n\0" as *const u8 as *const libc::c_char);
    got_some = 0 as libc::c_int;
    ptr = symbol_rootP;
    while !ptr.is_null() {
        if !(S_GET_NAME(ptr)).is_null()
            && strlen(S_GET_NAME(ptr)) != 0 as libc::c_int as libc::c_ulong
        {
            if S_GET_SEGMENT(ptr)
                == &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize)
                    as *mut asection
    ...
    if got_some == 0 {
        emit_line(
            0 as *mut list_info_type,
            b"NO UNDEFINED SYMBOLS\n\0" as *const u8 as *const libc::c_char,
        );
    }
}
unsafe extern "C" fn debugging_pseudo(
    mut list: *mut list_info_type,
    mut line: *const libc::c_char,
) -> libc::c_int {
    static mut in_debug: libc::c_int = 0;
    let mut was_debug: libc::c_int = 0;
    if (*list).debugging != 0 {
        in_debug = 1 as libc::c_int;
        return 1 as libc::c_int;
    }
    was_debug = in_debug;
    in_debug = 0 as libc::c_int;
    while _sch_istable[(*line as libc::c_int & 0xff as libc::c_int) as usize]
    ...
    if *line as libc::c_int != '.' as i32 {
        if was_debug != 0 && *line as libc::c_int == '\0' as i32
            && !((*list).next).is_null() && (*(*list).next).debugging != 0
        {
            in_debug = 1 as libc::c_int;
            return 1 as libc::c_int;
        }
    ...
    line = line.offset(1);
    line;
    if startswith(line, b"def\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"val\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"scl\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"line\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"endef\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"ln\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"type\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"size\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"dim\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"tag\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"stabs\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    if startswith(line, b"stabn\0" as *const u8 as *const libc::c_char) {
        return 1 as libc::c_int;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn listing_listing(mut _name: *mut libc::c_char) {
    ...
    let mut show_listing: libc::c_int = 1 as libc::c_int;
    let mut width: libc::c_uint = 0;
    buffer = xmalloc(
        (::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
            .wrapping_mul(listing_rhs_width as libc::c_ulong),
    ) as *mut libc::c_char;
    data_buffer = xmalloc(
        (::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
            .wrapping_mul(
    ...
    list = (*head).next;
    while !list.is_null() {
        let mut list_line: libc::c_uint = 0;
        width = (if listing_rhs_width > paper_width {
            paper_width
        } else {
            listing_rhs_width
        }) as libc::c_uint;
        list_line = (*list).line;
        match (*list).edict as libc::c_uint {
            4 => {
                list_line = list_line.wrapping_sub(1);
                list_line;
            }
            3 => {
                show_listing -= 1;
            ...
            5 => {
                if show_listing == 0 as libc::c_int {
                    list_line = list_line.wrapping_sub(1);
                    list_line;
                }
            }
            ...
            _ => {
                as_abort(
                    ...
                    (*::core::mem::transmute::<
                        &[u8; 29],
                        &[libc::c_char; 29],
                    >(b"void listing_listing(char *)\0"))
                        .as_ptr(),
                );
            }
        }
        if show_listing <= 0 as libc::c_int {
            while (*(*list).file).linenum < list_line && (*(*list).file).at_end == 0 {
                p = buffer_line((*list).file, buffer, width);
            }
        }
        if (*list).edict as libc::c_uint == EDICT_LIST as libc::c_int as libc::c_uint
            || (*list).edict as libc::c_uint
                == EDICT_NOLIST_NEXT as libc::c_int as libc::c_uint
                && show_listing == 0 as libc::c_int
        {
            list_line = list_line.wrapping_add(1);
            list_line;
            show_listing += 1;
            show_listing;
        }
        if show_listing > 0 as libc::c_int {
            if !((*list).hll_file).is_null() {
                current_hll_file = (*list).hll_file;
            }
            if !current_hll_file.is_null() && (*list).hll_line != 0
                && listing & 8 as libc::c_int != 0
            {
                print_source(current_hll_file, list, width);
            }
            if !((*list).line_contents).is_null() {
                if !(listing & 16 as libc::c_int != 0
                    && debugging_pseudo(list, (*list).line_contents) != 0)
                {
                    print_lines(
                        list,
                        if (*(*list).file).linenum == 0 as libc::c_int as libc::c_uint {
                            (*list).line
                        } else {
                            (*(*list).file).linenum
                        },
                ...
                free((*list).line_contents as *mut libc::c_void);
                (*list).line_contents = 0 as *mut libc::c_char;
            } else {
                while (*(*list).file).linenum < list_line && (*(*list).file).at_end == 0
                {
            ...
            if (*list).edict as libc::c_uint
                == EDICT_EJECT as libc::c_int as libc::c_uint
            {
                eject = 1 as libc::c_int as libc::c_uint;
            }
        }
    ...
    free(data_buffer as *mut libc::c_void);
    data_buffer = 0 as *mut libc::c_char;
}
unsafe extern "C" fn buffer_line(
    mut file: *mut file_info_type,
    ...
    if last_open_file_info.is_null() || file != last_open_file_info {
        if !last_open_file.is_null() {
            (*last_open_file_info).pos = ftell(last_open_file);
            fclose(last_open_file);
        }
        last_open_file_info = file;
        last_open_file = fopen(
            (*file).filename,
            b"r\0" as *const u8 as *const libc::c_char,
        );
        if last_open_file.is_null() {
            (*file).at_end = 1 as libc::c_int;
            return b"\0" as *const u8 as *const libc::c_char;
        }
        if (*file).pos != 0 {
            fseek(last_open_file, (*file).pos, 0 as libc::c_int);
        }
    }
    ...
    if c == '\r' as i32 || c == '\n' as i32 {
        let mut next: libc::c_int = fgetc(last_open_file);
        if c == '\r' as i32 && next != '\n' as i32
            || c == '\n' as i32 && next != '\r' as i32
        {
    ...
    if c == -(1 as libc::c_int) {
        (*file).at_end = 1 as libc::c_int;
        if count.wrapping_add(3 as libc::c_int as libc::c_uint) < size {
            let fresh3 = p;
            p = p.offset(1);
    ...
    (*file).linenum = ((*file).linenum).wrapping_add(1);
    (*file).linenum;
    let fresh6 = p;
    p = p.offset(1);
...
unsafe extern "C" fn rebuffer_line(
    mut file: *mut file_info_type,
    ...
    let mut count: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut current_line: libc::c_uint = 0;
    let mut p: *mut libc::c_char = buffer;
    let mut pos: libc::c_long = 0;
    let mut pos2: libc::c_long = 0;
    let mut c: libc::c_int = 0;
    let mut found: bool = 0 as libc::c_int != 0;
    if file.is_null() || buffer.is_null() || size <= 1 as libc::c_int as libc::c_uint
    ...
    pos2 = pos;
    if pos < 3 as libc::c_int as libc::c_long {
        return;
    }
    current_line = (*file).linenum;
    size = size.wrapping_sub(1 as libc::c_int as libc::c_uint);
    *buffer.offset(size as isize) = 0 as libc::c_int as libc::c_char;
    current_line = current_line.wrapping_add(1);
    current_line;
    while pos2 > 0 as libc::c_int as libc::c_long && !found {
        let mut ptr: *mut libc::c_char = 0 as *mut libc::c_char;
        pos2 = if size as libc::c_long > pos2 {
            0 as libc::c_int as libc::c_long
        } else {
            pos2 - size as libc::c_long
        };
        fseek(last_open_file, pos2, 0 as libc::c_int);
        if fread(
        ...
        ptr = buffer.offset(size as isize);
        while ptr >= buffer {
            if *ptr as libc::c_int == '\n' as i32 {
                current_line = current_line.wrapping_sub(1);
                current_line;
                if current_line == linenum {
                    found = 1 as libc::c_int != 0;
                    pos2 += ptr.offset_from(buffer) as libc::c_long;
                    if ptr.offset(1 as libc::c_int as isize)
                        == buffer.offset(size as isize)
                    {
                        pos2 += 1;
                        pos2;
                        if fgetc(last_open_file) == '\r' as i32 {
                            pos2 += 1;
                            pos2;
                        }
                    } else {
    ...
    *fresh8 = 0 as libc::c_int as libc::c_char;
    fseek(last_open_file, pos, 0 as libc::c_int);
}
static mut fn_0: *const libc::c_char = 0 as *const libc::c_char;
static mut eject: libc::c_uint = 0;
static mut page: libc::c_uint = 0;
static mut title: *const libc::c_char = 0 as *const libc::c_char;
static mut subtitle: *const libc::c_char = 0 as *const libc::c_char;
static mut on_page: libc::c_uint = 0;
unsafe extern "C" fn emit_line(
    mut list: *mut list_info_type,
    ...
    args_0 = args.clone();
    vfprintf(list_file, format, args_0.as_va_list());
    on_page = on_page.wrapping_add(1);
    on_page;
    listing_page(list);
}
unsafe extern "C" fn print_source(
    mut current_file: *mut file_info_type,
    mut list: *mut list_info_type,
    mut width: libc::c_uint,
) {
    static mut cached_lines: [cached_line; 3] = [cached_line {
        file: 0 as *const file_info_type as *mut file_info_type,
        line: 0,
        buffer: [0; 100],
    }; 3];
    static mut next_free_line: libc::c_int = 0 as libc::c_int;
    let mut cache: *mut cached_line = 0 as *mut cached_line;
    if (*current_file).linenum > (*list).hll_line
        && (*list).hll_line > 0 as libc::c_int as libc::c_uint
    {
        let mut i: libc::c_int = 0;
        i = 0 as libc::c_int;
        while i < 3 as libc::c_int {
            if cached_lines[i as usize].file == current_file
                && cached_lines[i as usize].line == (*list).hll_line
            {
                cache = cached_lines.as_mut_ptr().offset(i as isize);
                break;
            } else {
                i += 1;
                i;
        ...
        if i == 3 as libc::c_int {
            cache = cached_lines.as_mut_ptr().offset(next_free_line as isize);
            next_free_line += 1;
            next_free_line;
            if next_free_line == 3 as libc::c_int {
                next_free_line = 0 as libc::c_int;
            }
    ...
    if (*current_file).at_end == 0 {
        let mut num_lines_shown: libc::c_int = 0 as libc::c_int;
        while (*current_file).linenum < (*list).hll_line && (*current_file).at_end == 0 {
            let mut p: *const libc::c_char = 0 as *const libc::c_char;
            cache = cached_lines.as_mut_ptr().offset(next_free_line as isize);
            (*cache).file = current_file;
            (*cache)
                .line = ((*current_file).linenum)
                .wrapping_add(1 as libc::c_int as libc::c_uint);
            (*cache)
                .buffer[0 as libc::c_int as usize] = 0 as libc::c_int as libc::c_char;
            p = buffer_line(current_file, ((*cache).buffer).as_mut_ptr(), width);
            if num_lines_shown == 0 as libc::c_int {
                next_free_line += 1;
                next_free_line;
                if next_free_line == 3 as libc::c_int {
                    next_free_line = 0 as libc::c_int;
...
unsafe extern "C" fn print_timestamp() {
    ...
    let mut timestamp: *mut tm = 0 as *mut tm;
    let mut stampstr: [libc::c_char; 30] = [0; 30];
    timestamp = localtime(&now);
    strftime(
        stampstr.as_mut_ptr(),
        30 as libc::c_int as size_t,
        b"%Y-%m-%dT%H:%M:%S.000%z\0" as *const u8 as *const libc::c_char,
        timestamp,
    );
    fprintf(
        list_file,
...
unsafe extern "C" fn print_single_option(
    mut opt: *mut libc::c_char,
    mut pos: *mut libc::c_int,
) {
    let mut opt_len: libc::c_int = strlen(opt) as libc::c_int;
...
unsafe extern "C" fn print_options(mut argv: *mut *mut libc::c_char) {
    let mut field_name: *const libc::c_char = dcgettext(
        0 as *const libc::c_char,
        b"\n options passed\t: \0" as *const u8 as *const libc::c_char,
        5 as libc::c_int,
    );
    let mut pos: libc::c_int = strlen(field_name) as libc::c_int;
    let mut p: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    fputs(field_name, list_file);
    p = &mut *argv.offset(1 as libc::c_int as isize) as *mut *mut libc::c_char;
    while !(*p).is_null() {
        if **p as libc::c_int == '-' as i32 {
            if strcmp(*p, b"-o\0" as *const u8 as *const libc::c_char)
                == 0 as libc::c_int
            {
                if !(*p.offset(1 as libc::c_int as isize)).is_null() {
                    p = p.offset(1);
                    p;
                }
            } else if !(strcmp(*p, b"-v\0" as *const u8 as *const libc::c_char)
                == 0 as libc::c_int)
            {
                print_single_option(*p, &mut pos);
            }
        }
        p = p.offset(1);
        p;
...
unsafe extern "C" fn listing_general_info(mut argv: *mut *mut libc::c_char) {
    eject = 1 as libc::c_int as libc::c_uint;
    listing_page(0 as *mut list_info_type);
    fprintf(
        list_file,
        dcgettext(
            0 as *const libc::c_char,
            b" GNU assembler version %s (%s)\n\t using BFD version %s.\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"\n input file    \t: %s\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        fn_0,
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"\n output file   \t: %s\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        out_file_name,
    );
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b"\n target        \t: %s\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        b"x86_64-pc-linux-gnu\0" as *const u8 as *const libc::c_char,
    );
...
unsafe extern "C" fn run_static_initializers() {
    listing_lhs_width = if 4 as libc::c_int > 4 as libc::c_int {
        1 as libc::c_int
    } else {
        4 as libc::c_int / 4 as libc::c_int
    };
    listing_lhs_width_second = if 4 as libc::c_int > 4 as libc::c_int {
        1 as libc::c_int
    } else {
        4 as libc::c_int / 4 as libc::c_int
    };
