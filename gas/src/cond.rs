extern "C" {
    ...
    fn mri_comment_field(_: *mut libc::c_char) -> *mut libc::c_char;
    fn mri_comment_end(_: *mut libc::c_char, _: libc::c_int);
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct conditional_frame {
    pub if_file_line: file_line,
    pub else_file_line: file_line,
    pub previous_cframe: *mut conditional_frame,
    pub else_seen: libc::c_int,
    pub ignoring: libc::c_int,
    pub dead_tree: libc::c_int,
    pub macro_nest: libc::c_int,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct file_line {
...
#[no_mangle]
pub static mut cond_obstack: obstack = obstack {
    chunk_size: 0,
...
#[no_mangle]
pub unsafe extern "C" fn ignore_input() -> libc::c_int {
    ...
    } else if *s.offset(-(1 as libc::c_int) as isize) as libc::c_int != '.' as i32 {
        return (!current_cframe.is_null() && (*current_cframe).ignoring != 0)
            as libc::c_int
    }
    if (*s.offset(0 as libc::c_int as isize) as libc::c_int == 'i' as i32
        ...
        || (*s.offset(0 as libc::c_int as isize) as libc::c_int == 'e' as i32
            || *s.offset(0 as libc::c_int as isize) as libc::c_int == 'E' as i32)
            && (strncasecmp(
                s,
                ...
                || strncasecmp(
                    s,
                    b"endc\0" as *const u8 as *const libc::c_char,
                    4 as libc::c_int as libc::c_ulong,
                ) == 0)
    {
        return 0 as libc::c_int;
    }
    return (!current_cframe.is_null() && (*current_cframe).ignoring != 0) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn cond_finish_check(mut nest: libc::c_int) {
    if !current_cframe.is_null() && (*current_cframe).macro_nest >= nest {
        if nest >= 0 as libc::c_int {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"end of macro inside conditional\0" as *const u8
            ...
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"end of file inside conditional\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        ...
        as_bad_where(
            (*current_cframe).if_file_line.file,
            (*current_cframe).if_file_line.line,
            dcgettext(
                0 as *const libc::c_char,
                b"here is the start of the unterminated conditional\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        if (*current_cframe).else_seen != 0 {
            as_bad_where(
                ...
                dcgettext(
                    0 as *const libc::c_char,
                    b"here is the \"else\" of the unterminated conditional\0"
...
#[no_mangle]
pub unsafe extern "C" fn cond_exit_macro(mut nest: libc::c_int) {
    while !current_cframe.is_null() && (*current_cframe).macro_nest >= nest {
        let mut hold: *mut conditional_frame = 0 as *mut conditional_frame;
        hold = current_cframe;
        current_cframe = (*current_cframe).previous_cframe;
        let mut __o: *mut obstack = &mut cond_obstack;
        let mut __obj: *mut libc::c_void = hold as *mut libc::c_void;
...
pub unsafe extern "C" fn s_else(mut arg: libc::c_int) {
    if current_cframe.is_null() {
    ...
    } else if (*current_cframe).else_seen != 0 {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"duplicate \".else\"\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        as_bad_where(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"here is the previous \".else\"\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        as_bad_where(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"here is the previous \".if\"\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    } else {
        (*current_cframe)
            .else_file_line
            .file = as_where(&mut (*current_cframe).else_file_line.line);
        (*current_cframe)
            .ignoring = (*current_cframe).dead_tree
            | ((*current_cframe).ignoring == 0) as libc::c_int;
        if listing & 32 as libc::c_int != 0 as libc::c_int
            && (((*current_cframe).previous_cframe).is_null()
                || (*(*current_cframe).previous_cframe).ignoring == 0)
        {
            if (*current_cframe).ignoring == 0 {
                listing_list(1 as libc::c_int);
            } else {
                listing_list(2 as libc::c_int);
            }
        }
        (*current_cframe).else_seen = 1 as libc::c_int;
    }
    if flag_mri != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn s_elseif(mut arg: libc::c_int) {
    if current_cframe.is_null() {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"\".elseif\" without matching \".if\"\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        ...
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"\".elseif\" after \".else\"\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        as_bad_where(
        ...
        (*current_cframe)
            .else_file_line
            .file = as_where(&mut (*current_cframe).else_file_line.line);
        (*current_cframe).dead_tree |= ((*current_cframe).ignoring == 0) as libc::c_int;
        (*current_cframe).ignoring = (*current_cframe).dead_tree;
    }
    if current_cframe.is_null() || (*current_cframe).ignoring != 0 {
        while *is_end_of_line
            .as_mut_ptr()
            .offset(*input_line_pointer as libc::c_uchar as isize) == 0
        {
        ...
        let mut operand: expressionS = expressionS {
        ...
        expr(0 as libc::c_int, &mut operand, expr_evaluate);
        if operand.X_op() as libc::c_int != O_constant as libc::c_int {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"non-constant expression in \".elseif\" statement\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
        }
        match arg as operatorT as libc::c_uint {
            21 => {
                t = (operand.X_add_number == 0 as libc::c_int as libc::c_long)
                    as libc::c_int;
            }
            22 => {
                t = (operand.X_add_number != 0 as libc::c_int as libc::c_long)
            ...
            _ => {
                as_abort(
                    b"cond.c\0" as *const u8 as *const libc::c_char,
                    360 as libc::c_int,
                    (*::core::mem::transmute::<
                        &[u8; 19],
                        &[libc::c_char; 19],
                    >(b"void s_elseif(int)\0"))
                        .as_ptr(),
                );
            }
        }
        (*current_cframe)
            .ignoring = ((*current_cframe).dead_tree != 0 || t == 0) as libc::c_int;
    }
    if listing & 32 as libc::c_int != 0 as libc::c_int
        && (((*current_cframe).previous_cframe).is_null()
            || (*(*current_cframe).previous_cframe).ignoring == 0)
...
pub unsafe extern "C" fn s_endif(mut arg: libc::c_int) {
    ...
    if current_cframe.is_null() {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"\".endif\" without \".if\"\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    } else {
        if listing & 32 as libc::c_int != 0 as libc::c_int
            && (*current_cframe).ignoring != 0
            && (((*current_cframe).previous_cframe).is_null()
                || (*(*current_cframe).previous_cframe).ignoring == 0)
        {
            listing_list(1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn s_if(mut arg: libc::c_int) {
    let mut operand: expressionS = expressionS {
        X_add_symbol: 0 as *mut symbolS,
        X_op_symbol: 0 as *mut symbolS,
        X_add_number: 0,
    ...
    let mut cframe: conditional_frame = conditional_frame {
        if_file_line: file_line {
            file: 0 as *const libc::c_char,
            line: 0,
        },
        else_file_line: file_line {
            file: 0 as *const libc::c_char,
            line: 0,
        },
        previous_cframe: 0 as *mut conditional_frame,
        else_seen: 0,
        ignoring: 0,
        dead_tree: 0,
        macro_nest: 0,
    ...
    if !current_cframe.is_null() && (*current_cframe).ignoring != 0 {
        operand.X_add_number = 0 as libc::c_int as offsetT;
        while *is_end_of_line
            .as_mut_ptr()
            .offset(*input_line_pointer as libc::c_uchar as isize) == 0
        {
        ...
        if operand.X_op() as libc::c_int != O_constant as libc::c_int {
            as_bad(
                dcgettext(
                    0 as *const libc::c_char,
                    b"non-constant expression in \".if\" statement\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
            );
    ...
    match arg as operatorT as libc::c_uint {
        ...
        23 => {
            t = (operand.X_add_number < 0 as libc::c_int as libc::c_long) as libc::c_int;
        }
        24 => {
            t = (operand.X_add_number <= 0 as libc::c_int as libc::c_long)
                as libc::c_int;
    ...
    initialize_cframe(&mut cframe);
    cframe.ignoring = (cframe.dead_tree != 0 || t == 0) as libc::c_int;
    current_cframe = ({
        let mut __h: *mut obstack = &mut cond_obstack as *mut obstack;
        let mut __o: *mut obstack = __h;
        let mut __len: size_t = ::core::mem::size_of::<conditional_frame>()
            as libc::c_ulong;
        if ({
    ...
    memcpy(
        ...
        &mut cframe as *mut conditional_frame as *const libc::c_void,
        ::core::mem::size_of::<conditional_frame>() as libc::c_ulong,
    );
    if listing & 32 as libc::c_int != 0 as libc::c_int && cframe.ignoring != 0
        && ((cframe.previous_cframe).is_null()
...
#[no_mangle]
pub unsafe extern "C" fn s_ifb(mut test_blank: libc::c_int) {
    let mut cframe: conditional_frame = conditional_frame {
        if_file_line: file_line {
            file: 0 as *const libc::c_char,
            line: 0,
    ...
    if cframe.dead_tree != 0 {
        cframe.ignoring = 1 as libc::c_int;
    } else {
        let mut is_eol: libc::c_int = 0;
        if *input_line_pointer as libc::c_int == ' ' as i32 {
            input_line_pointer = input_line_pointer.offset(1);
            input_line_pointer;
        } else {};
        ...
        cframe.ignoring = (test_blank == (is_eol == 0) as libc::c_int) as libc::c_int;
    }
    current_cframe = ({
        let mut __h: *mut obstack = &mut cond_obstack as *mut obstack;
        let mut __o: *mut obstack = __h;
...
#[no_mangle]
pub unsafe extern "C" fn s_ifc(mut arg: libc::c_int) {
    let mut stop: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut stopc: libc::c_char = 0 as libc::c_int as libc::c_char;
    ...
    s1 = get_mri_string(',' as i32, &mut len1);
    if *input_line_pointer as libc::c_int != ',' as i32 {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"bad format for ifc or ifnc\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    } else {
    ...
    s2 = get_mri_string(';' as i32, &mut len2);
    res = (len1 == len2 && strncmp(s1, s2, len1 as libc::c_ulong) == 0 as libc::c_int)
        as libc::c_int;
    initialize_cframe(&mut cframe);
    cframe.ignoring = (cframe.dead_tree != 0 || res ^ arg == 0) as libc::c_int;
    current_cframe = ({
        let mut __h: *mut obstack = &mut cond_obstack as *mut obstack;
        let mut __o: *mut obstack = __h;
        let mut __len: size_t = ::core::mem::size_of::<conditional_frame>()
...
#[no_mangle]
pub unsafe extern "C" fn s_ifdef(mut test_defined: libc::c_int) {
    ...
    if *lex_type.as_mut_ptr().offset(*name as libc::c_uchar as isize) as libc::c_int
        & 2 as libc::c_int == 0 && *name as libc::c_int != '"' as i32
    {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"invalid identifier for \".ifdef\"\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if cframe.dead_tree != 0 {
        ...
        let mut is_defined: libc::c_int = 0;
        is_defined = (!symbolP.is_null()
            && (S_IS_DEFINED(symbolP) != 0 || symbol_equated_p(symbolP) != 0)
            && S_GET_SEGMENT(symbolP) != reg_section) as libc::c_int;
        cframe.ignoring = (test_defined ^ is_defined == 0) as libc::c_int;
    }
    current_cframe = ({
        let mut __h: *mut obstack = &mut cond_obstack as *mut obstack;
...
#[no_mangle]
pub unsafe extern "C" fn s_ifeqs(mut arg: libc::c_int) {
    let mut s1: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut s2: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut len1: libc::c_int = 0;
    let mut len2: libc::c_int = 0;
    ...
    s1 = demand_copy_C_string(&mut len1);
    if *input_line_pointer as libc::c_int == ' ' as i32 {
        input_line_pointer = input_line_pointer.offset(1);
        input_line_pointer;
    } else {};
    if *input_line_pointer as libc::c_int != ',' as i32 {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b".ifeqs syntax error\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        ignore_rest_of_line();
    ...
    input_line_pointer = input_line_pointer.offset(1);
    input_line_pointer;
    s2 = demand_copy_C_string(&mut len2);
    res = (len1 == len2 && strncmp(s1, s2, len1 as libc::c_ulong) == 0 as libc::c_int)
        as libc::c_int;
    initialize_cframe(&mut cframe);
    cframe.ignoring = (cframe.dead_tree != 0 || res ^ arg == 0) as libc::c_int;
...
unsafe extern "C" fn initialize_cframe(mut cframe: *mut conditional_frame) {
    memset(
        cframe as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<conditional_frame>() as libc::c_ulong,
    );
    (*cframe).if_file_line.file = as_where(&mut (*cframe).if_file_line.line);
    (*cframe).previous_cframe = current_cframe;
    (*cframe)
        .dead_tree = (!current_cframe.is_null() && (*current_cframe).ignoring != 0)
        as libc::c_int;
    (*cframe).macro_nest = macro_nest;
}
unsafe extern "C" fn get_mri_string(
    mut terminator: libc::c_int,
    ...
    if *input_line_pointer as libc::c_int == '\'' as i32 {
        ...
        while *input_line_pointer as libc::c_int != terminator
            && *is_end_of_line
                .as_mut_ptr()
                .offset(*input_line_pointer as libc::c_uchar as isize) == 0
        {
    ...
    *len = s.offset_from(ret) as libc::c_long as libc::c_int;
    return ret;
}
static mut current_cframe: *mut conditional_frame = 0 as *const conditional_frame
    as *mut conditional_frame;
