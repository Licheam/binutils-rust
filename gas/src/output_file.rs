extern "C" {
    ...
    fn i386_arch() -> bfd_architecture;
    fn i386_mach() -> libc::c_ulong;
...
#[no_mangle]
pub static mut stdoutput: *mut bfd = 0 as *const bfd as *mut bfd;
#[no_mangle]
pub unsafe extern "C" fn output_file_close(mut filename: *const libc::c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn output_file_create(mut name: *const libc::c_char) {
        ...
        && *name.offset(1 as libc::c_int as isize) as libc::c_int == '\0' as i32
    {
        as_fatal(
            dcgettext(
                ...
                b"can't open a bfd on stdout %s\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
        );
    } else {
        stdoutput = bfd_openw(name, i386_target_format());
        if stdoutput.is_null() {
            let mut err: bfd_error_type = bfd_get_error();
                ...
                == bfd_error_invalid_target as libc::c_int as libc::c_uint
            {
                as_fatal(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"selected target format '%s' unknown\0" as *const u8
    ...
    (Some(((*(*stdoutput).xvec)._bfd_set_arch_mach).expect("non-null function pointer")))
        .expect("non-null function pointer")(stdoutput, i386_arch(), i386_mach());
    if flag_traditional_format != 0 {
        (*stdoutput).flags |= 0x400 as libc::c_int as libc::c_uint;
    }
}
