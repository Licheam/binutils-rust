extern "C" {
    ...
    static mut cpu_arch_tune: processor_type;
    static mut cpu_arch_isa: processor_type;
    static mut cpu_arch_isa_flags: i386_cpu_flags;
...
#[no_mangle]
pub unsafe extern "C" fn frag_now_fix() -> addressT {
    if (*now_seg).flags
...
#[no_mangle]
pub unsafe extern "C" fn frag_now_fix_octets() -> addressT {
    if now_seg
    ...
    return ((*frchain_now).frch_obstack.next_free as *mut libc::c_void
        as *mut libc::c_char)
        .offset_from(((*frag_now).fr_literal).as_mut_ptr()) as libc::c_long as addressT;
}
#[no_mangle]
pub unsafe extern "C" fn frag_append_1_char(mut datum: libc::c_int) {
    frag_alloc_check(&mut (*frchain_now).frch_obstack);
    if ({
        let mut __o1: *const obstack = &mut (*frchain_now).frch_obstack as *mut obstack;
    ...
    let mut __o: *mut obstack = &mut (*frchain_now).frch_obstack;
    if ({
    ...
    *fresh0 = datum as libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn frag_new(mut old_frags_var_max_size: size_t) {
    let mut former_last_fragP: *mut fragS = 0 as *mut fragS;
    let mut frchP: *mut frchainS = 0 as *mut frchainS;
    if (*frchain_now).frch_last == frag_now {} else {
        as_abort(
            b"frags.c\0" as *const u8 as *const libc::c_char,
            165 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 22],
                &[libc::c_char; 22],
            >(b"void frag_new(size_t)\0"))
                .as_ptr(),
        );
    };
    (*frag_now).fr_fix = frag_now_fix_octets();
    if (*frag_now).fr_fix >= old_frags_var_max_size {} else {
        as_abort(
            b"frags.c\0" as *const u8 as *const libc::c_char,
            169 as libc::c_int,
            (*::core::mem::transmute::<
    ...
    (*frag_now)
        .fr_fix = ((*frag_now).fr_fix as libc::c_ulong)
        .wrapping_sub(old_frags_var_max_size) as valueT as valueT;
    if (*frag_now).fr_type as libc::c_uint != 0 as libc::c_int as libc::c_uint {} else {
        as_abort(
            b"frags.c\0" as *const u8 as *const libc::c_char,
            172 as libc::c_int,
            (*::core::mem::transmute::<
    ...
    let mut __o1: *mut obstack = &mut (*frchain_now).frch_obstack;
    ...
    if !former_last_fragP.is_null() {} else {
        as_abort(
            b"frags.c\0" as *const u8 as *const libc::c_char,
            180 as libc::c_int,
            (*::core::mem::transmute::<
    ...
    if former_last_fragP == frag_now {} else {
        as_abort(
            b"frags.c\0" as *const u8 as *const libc::c_char,
            181 as libc::c_int,
            (*::core::mem::transmute::<
    ...
    frag_now = frag_alloc(&mut (*frchP).frch_obstack);
    (*frag_now).fr_file = as_where(&mut (*frag_now).fr_line);
    ...
    (*frag_now).fr_next = 0 as *mut frag;
}
#[no_mangle]
pub unsafe extern "C" fn frag_alloc(mut ob: *mut obstack) -> *mut fragS {
    let mut ptr: *mut fragS = 0 as *mut fragS;
    let mut oalign: libc::c_int = 0;
    ({
        let mut __h: *mut obstack = ob;
        let mut __o: *mut obstack = __h;
        let mut __len: size_t = 0 as libc::c_int as size_t;
        if ({
            let mut __o1: *const obstack = __o;
    ...
    ptr = ({
        let mut __h: *mut obstack = ob;
        let mut __o: *mut obstack = __h;
        let mut __len: size_t = (zero_address_frag.fr_literal)
            .as_mut_ptr()
            .offset_from(&mut zero_address_frag as *mut fragS as *mut libc::c_char)
            as libc::c_long as size_t;
        if ({
            let mut __o1: *const obstack = __o;
            ((*__o1).chunk_limit).offset_from((*__o1).next_free) as libc::c_long
...
#[no_mangle]
pub unsafe extern "C" fn frag_wane(mut fragP: *mut fragS) {
    (*fragP).fr_type = rs_fill;
    (*fragP).fr_offset = 0 as libc::c_int as offsetT;
    (*fragP).fr_var = 0 as libc::c_int as offsetT;
}
#[no_mangle]
pub unsafe extern "C" fn frag_init() {
    zero_address_frag.fr_type = rs_fill;
    predefined_address_frag.fr_type = rs_fill;
}
#[no_mangle]
pub unsafe extern "C" fn frag_grow(mut nchars: size_t) {
    if ({
        let mut __o1: *const obstack = &mut (*frchain_now).frch_obstack as *mut obstack;
        ((*__o1).chunk_limit).offset_from((*__o1).next_free) as libc::c_long as size_t
    }) < nchars
    {
        let mut oldc: size_t = 0;
        let mut newc: size_t = 0;
        if nchars < 0x10000 as libc::c_int as libc::c_ulong {
            newc = (2 as libc::c_int as libc::c_ulong).wrapping_mul(nchars);
        } else {
            newc = nchars.wrapping_add(0x10000 as libc::c_int as libc::c_ulong);
        }
        newc = (newc as libc::c_ulong)
            .wrapping_add(
                (zero_address_frag.fr_literal)
                    .as_mut_ptr()
                    .offset_from(
...
#[no_mangle]
pub unsafe extern "C" fn frag_more(mut nchars: size_t) -> *mut libc::c_char {
    let mut retval: *mut libc::c_char = 0 as *mut libc::c_char;
    frag_alloc_check(&mut (*frchain_now).frch_obstack);
    frag_grow(nchars);
    retval = (*frchain_now).frch_obstack.next_free as *mut libc::c_void
        as *mut libc::c_char;
    (*frchain_now)
        .frch_obstack
        .next_free = ((*frchain_now).frch_obstack.next_free).offset(nchars as isize);
    return retval;
}
#[no_mangle]
pub unsafe extern "C" fn frag_align(
    mut alignment: libc::c_int,
    mut fill_character: libc::c_int,
    mut max: libc::c_int,
) {
    if now_seg
        == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut asection
    {
        let mut new_off: addressT = 0;
        let mut mask: addressT = 0;
        mask = !(0 as libc::c_int as addressT) << alignment;
        new_off = abs_section_offset.wrapping_add(!mask) & mask;
        if max == 0 as libc::c_int
            || new_off.wrapping_sub(abs_section_offset) <= max as addressT
        {
        ...
        p = frag_var(
            ...
            1 as libc::c_int as size_t,
            max as relax_substateT,
            0 as *mut symbolS,
            alignment as offsetT,
            0 as *mut libc::c_char,
        );
        *p = fill_character as libc::c_char;
    };
}
#[no_mangle]
pub unsafe extern "C" fn frag_var(
    mut type_0: relax_stateT,
    mut max_chars: size_t,
    mut var: size_t,
    mut subtype: relax_substateT,
    mut symbol: *mut symbolS,
    mut offset: offsetT,
    mut opcode: *mut libc::c_char,
) -> *mut libc::c_char {
    let mut retval: *mut libc::c_char = 0 as *mut libc::c_char;
    frag_grow(max_chars);
    retval = (*frchain_now).frch_obstack.next_free as *mut libc::c_void
    ...
    (*frchain_now)
        .frch_obstack
        .next_free = ((*frchain_now).frch_obstack.next_free).offset(max_chars as isize);
    frag_var_init(type_0, max_chars, var, subtype, symbol, offset, opcode);
    return retval;
}
#[no_mangle]
pub unsafe extern "C" fn frag_align_pattern(
    mut alignment: libc::c_int,
    mut fill_pattern: *const libc::c_char,
    mut n_fill: size_t,
    mut max: libc::c_int,
) {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    memcpy(p as *mut libc::c_void, fill_pattern as *const libc::c_void, n_fill);
}
#[no_mangle]
pub unsafe extern "C" fn frag_align_code(
    mut alignment: libc::c_int,
    mut max: libc::c_int,
) {
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    p = frag_var(
        rs_align_code,
        (if alignment != 0 {
            ((1 as libc::c_int) << alignment) - 1 as libc::c_int
        } else {
            1 as libc::c_int
        }) as size_t,
        1 as libc::c_int as size_t,
    ...
    *p = 0x90 as libc::c_int as libc::c_char;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn frag_offset_fixed_p(
    mut frag1: *const fragS,
    mut frag2: *const fragS,
    mut offset: *mut offsetT,
) -> bool {
    let mut frag: *const fragS = 0 as *const fragS;
    let mut off: offsetT = 0;
    off = ((*frag1).fr_address).wrapping_sub((*frag2).fr_address) as offsetT;
    if frag1 == frag2 {
        *offset = off;
        return 1 as libc::c_int != 0;
    }
    frag = frag1;
    while (*frag).fr_type as libc::c_uint == rs_fill as libc::c_int as libc::c_uint {
        off = (off as libc::c_ulong)
            .wrapping_add(
                ((*frag).fr_fix)
                    .wrapping_add(((*frag).fr_offset * (*frag).fr_var) as libc::c_ulong),
...
#[no_mangle]
pub unsafe extern "C" fn frag_offset_ignore_align_p(
    mut frag1: *const fragS,
    mut frag2: *const fragS,
    mut offset: *mut offsetT,
) -> bool {
    ...
    frag = frag1;
    while (*frag).fr_type as libc::c_uint == rs_fill as libc::c_int as libc::c_uint
        || (*frag).fr_type as libc::c_uint == rs_align as libc::c_int as libc::c_uint
        || (*frag).fr_type as libc::c_uint
            == rs_align_code as libc::c_int as libc::c_uint
        || (*frag).fr_type as libc::c_uint
            == rs_align_test as libc::c_int as libc::c_uint
    {
        if (*frag).fr_type as libc::c_uint == rs_fill as libc::c_int as libc::c_uint {
            off = (off as libc::c_ulong)
                .wrapping_add(
                    ((*frag).fr_fix)
                        .wrapping_add(
                            ((*frag).fr_offset * (*frag).fr_var) as libc::c_ulong,
                        ),
                ) as offsetT as offsetT;
        }
        frag = (*frag).fr_next;
...
#[no_mangle]
pub unsafe extern "C" fn frag_gtoffset_p(
    mut off2: valueT,
    mut frag2: *const fragS,
    mut off1: valueT,
    mut frag1: *const fragS,
    ...
    let mut frag: *const fragS = frag1;
    let mut delta: offsetT = off2.wrapping_sub(off1) as offsetT;
    loop {
        delta = (delta as libc::c_ulong).wrapping_add((*frag).fr_fix) as offsetT
            as offsetT;
        frag = (*frag).fr_next;
        if frag == frag2 {
    ...
    *offset = off2
        ...
        .wrapping_mul(((1 as libc::c_int) << 0 as libc::c_int) as libc::c_ulong)
        as offsetT;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn get_frag_count() -> libc::c_int {
    return totalfrags;
}
#[no_mangle]
pub unsafe extern "C" fn clear_frag_count() {
    totalfrags = 0 as libc::c_int;
}
static mut totalfrags: libc::c_int = 0;
unsafe extern "C" fn frag_alloc_check(mut ob: *const obstack) {
    if (*ob).chunk_size == 0 as libc::c_int as libc::c_ulong {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"attempt to allocate data in absolute section\0" as *const u8
    ...
    if !mri_common_symbol.is_null() {
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"attempt to allocate data in common section\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
...
unsafe extern "C" fn frag_var_init(
    mut type_0: relax_stateT,
    mut max_chars: size_t,
    mut var: size_t,
    mut subtype: relax_substateT,
    ...
    (*frag_now).fr_var = var as offsetT;
    (*frag_now).fr_type = type_0;
    (*frag_now).fr_subtype = subtype;
    (*frag_now).fr_symbol = symbol;
    (*frag_now).fr_offset = offset;
    (*frag_now).fr_opcode = opcode;
    (*frag_now).tc_frag_data.u.padding_fragP = 0 as *mut fragS;
    (*frag_now).tc_frag_data.padding_address = 0 as libc::c_int as addressT;
    (*frag_now).tc_frag_data.isa = cpu_arch_isa;
    (*frag_now).tc_frag_data.isa_flags = cpu_arch_isa_flags;
    (*frag_now).tc_frag_data.tune = cpu_arch_tune;
    (*frag_now).tc_frag_data.max_bytes = max_chars as libc::c_uint;
    (*frag_now).tc_frag_data.length = 0 as libc::c_int as libc::c_uchar;
    (*frag_now).tc_frag_data.last_length = 0 as libc::c_int as libc::c_uchar;
    (*frag_now).tc_frag_data.max_prefix_length = 0 as libc::c_int as libc::c_uchar;
    (*frag_now).tc_frag_data.prefix_length = 0 as libc::c_int as libc::c_uchar;
    (*frag_now).tc_frag_data.default_prefix = 0 as libc::c_int as libc::c_uchar;
    (*frag_now).tc_frag_data.cmp_size = 0 as libc::c_int as libc::c_uchar;
    ((*frag_now).tc_frag_data).set_classified(0 as libc::c_int as libc::c_uint);
    ((*frag_now).tc_frag_data).set_branch_type(0 as libc::c_int as libc::c_uint);
    ((*frag_now).tc_frag_data).set_mf_type(0 as libc::c_int as libc::c_uint);
    (*frag_now).fr_file = as_where(&mut (*frag_now).fr_line);
    frag_new(max_chars);
}
