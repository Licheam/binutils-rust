extern "C" {
    ...
    static mut use_gnu_debug_info_extensions: libc::c_int;
    ...
    fn obj_elf_init_stab_section(_: segT);
    ...
    fn get_absolute_expression_and_terminator(
        val_pointer: *mut libc::c_long,
    ) -> libc::c_char;
...
#[no_mangle]
pub static mut outputting_stabs_line_debug: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn get_stab_string_offset(
    mut string: *const libc::c_char,
    mut stabstr_secname: *const libc::c_char,
    mut free_stabstr_secname: bool,
) -> libc::c_uint {
    let mut length: libc::c_uint = 0;
    let mut retval: libc::c_uint = 0;
    let mut save_seg: segT = 0 as *mut asection;
    let mut save_subseg: subsegT = 0;
    ...
    if 1 as libc::c_int == 0 {
        as_abort(
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 71],
            >(
                b"unsigned int get_stab_string_offset(const char *, const char *, _Bool)\0",
            ))
                .as_ptr(),
        );
    }
    length = strlen(string) as libc::c_uint;
    save_seg = now_seg;
    save_subseg = now_subseg;
    seg = subseg_new(stabstr_secname, 0 as libc::c_int);
    if free_stabstr_secname as libc::c_int != 0 && (*seg).name != stabstr_secname {
        free(stabstr_secname as *mut libc::c_char as *mut libc::c_void);
    }
    retval = (*(bfd_section_userdata(seg as *const asection) as *mut segment_info_type))
        .stabu
        .stab_string_size as libc::c_uint;
    if retval <= 0 as libc::c_int as libc::c_uint {
        p = frag_more(1 as libc::c_int as size_t);
        *p = 0 as libc::c_int as libc::c_char;
        let ref mut fresh0 = (*(bfd_section_userdata(seg as *const asection)
            as *mut segment_info_type))
            .stabu
            .stab_string_size;
        *fresh0 = 1 as libc::c_int as libc::c_ulong;
        retval = *fresh0 as libc::c_uint;
    ...
    if length > 0 as libc::c_int as libc::c_uint {
        p = frag_more(length.wrapping_add(1 as libc::c_int as libc::c_uint) as size_t);
        strcpy(p, string);
        ...
        *fresh1 = (*fresh1)
        ...
        retval = 0 as libc::c_int as libc::c_uint;
    }
    subseg_set(save_seg, save_subseg);
    return retval;
}
#[no_mangle]
pub unsafe extern "C" fn stabs_generate_asm_file() {
    let mut file: *const libc::c_char = 0 as *const libc::c_char;
    let mut lineno: libc::c_uint = 0;
    file = as_where(&mut lineno);
    if use_gnu_debug_info_extensions != 0 {
        let mut dir: *const libc::c_char = 0 as *const libc::c_char;
        let mut dir2: *mut libc::c_char = 0 as *mut libc::c_char;
        ...
        generate_asm_file(N_SO as libc::c_int, dir2);
        free(dir2 as *mut libc::c_void);
        free(dir as *mut libc::c_char as *mut libc::c_void);
    }
    generate_asm_file(N_SO as libc::c_int, file);
}
#[no_mangle]
pub unsafe extern "C" fn s_stab(mut what: libc::c_int) {
    s_stab_generic(
        what,
...
#[no_mangle]
pub unsafe extern "C" fn stabs_generate_asm_lineno() {
    static mut label_count: libc::c_int = 0;
    let mut file: *const libc::c_char = 0 as *const libc::c_char;
    let mut lineno: libc::c_uint = 0;
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut sym: [libc::c_char; 30] = [0; 30];
    static mut prev_lineno: libc::c_uint = -(1 as libc::c_int) as libc::c_uint;
    static mut prev_file: *mut libc::c_char = 0 as *const libc::c_char
        as *mut libc::c_char;
    file = as_where(&mut lineno);
    if prev_file.is_null() {
        prev_file = xstrdup(file);
        prev_lineno = lineno;
    } else if lineno == prev_lineno && filename_cmp(file, prev_file) == 0 as libc::c_int
    {
        return
    } else {
        prev_lineno = lineno;
        if filename_cmp(file, prev_file) != 0 as libc::c_int {
            free(prev_file as *mut libc::c_void);
            prev_file = xstrdup(file);
        }
    }
    outputting_stabs_line_debug = 1 as libc::c_int;
    generate_asm_file(N_SOL as libc::c_int, file);
    sprintf(
        sym.as_mut_ptr(),
        b"%sL%d\0" as *const u8 as *const libc::c_char,
            ...
            (::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
                .wrapping_mul(
                    (100 as libc::c_int as libc::c_ulong)
                        .wrapping_add(strlen(current_function_label)),
                ),
        ) as *mut libc::c_char;
        sprintf(
            buf,
    ...
    s_stab('n' as i32);
    restore_ilp();
    colon(sym.as_mut_ptr());
    outputting_stabs_line_debug = 0 as libc::c_int;
    free(buf as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn stabs_generate_asm_func(
    mut funcname: *const libc::c_char,
    mut startlabname: *const libc::c_char,
) {
    static mut void_emitted_p: bool = 0 as libc::c_int != 0;
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut lineno: libc::c_uint = 0;
    if !void_emitted_p {
        temp_ilp(
            b"\"void:t1=1\",128,0,0,0\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
        s_stab('s' as i32);
        restore_ilp();
        void_emitted_p = 1 as libc::c_int != 0;
    }
    as_where(&mut lineno);
    if asprintf(
        &mut buf as *mut *mut libc::c_char,
        b"\"%s:F1\",%d,0,%d,%s\0" as *const u8 as *const libc::c_char,
        funcname,
        N_FUN as libc::c_int,
    ...
    in_dot_func_p = 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn stabs_generate_asm_endfunc(
    ...
    sprintf(
        sym.as_mut_ptr(),
        b"%sendfunc%d\0" as *const u8 as *const libc::c_char,
        b"L0\x01\0" as *const u8 as *const libc::c_char,
        label_count,
    );
    label_count += 1;
    ...
    if asprintf(
        &mut buf as *mut *mut libc::c_char,
        b"\"\",%d,0,0,%s-%s\0" as *const u8 as *const libc::c_char,
        N_FUN as libc::c_int,
        sym.as_mut_ptr(),
        startlabname,
    ) == -(1 as libc::c_int)
    ...
    restore_ilp();
    free(buf as *mut libc::c_void);
    in_dot_func_p = 0 as libc::c_int != 0;
    current_function_label = 0 as *const libc::c_char;
}
#[no_mangle]
pub unsafe extern "C" fn s_xstab(mut what: libc::c_int) {
    let mut length: libc::c_int = 0;
    let mut stab_secname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut stabstr_secname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut stab_secname_obstack_end: *mut libc::c_char = 0 as *mut libc::c_char;
    stab_secname = demand_copy_C_string(&mut length);
    stab_secname_obstack_end = notes.next_free as *mut libc::c_void as *mut libc::c_char;
    ...
    if *input_line_pointer as libc::c_int == ',' as i32 {
        ...
        as_bad(
            dcgettext(
                0 as *const libc::c_char,
                b"comma missing in .xstabs\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        ignore_rest_of_line();
    ...
    stabstr_secname = concat(
        stab_secname,
        b"str\0" as *const u8 as *const libc::c_char,
        0 as *mut libc::c_void as *mut libc::c_char,
    );
    s_stab_generic(what, stab_secname, stabstr_secname, stab_secname_obstack_end);
}
unsafe extern "C" fn generate_asm_file(
    ...
    let mut sym: [libc::c_char; 30] = [0; 30];
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut tmp: *const libc::c_char = file;
    let mut file_endp: *const libc::c_char = file.offset(strlen(file) as isize);
    let mut bufp: *mut libc::c_char = 0 as *mut libc::c_char;
    if !last_file.is_null() && filename_cmp(last_file, file) == 0 as libc::c_int {
        return;
    }
    sprintf(
        sym.as_mut_ptr(),
        b"%sF%d\0" as *const u8 as *const libc::c_char,
        b"L0\x01\0" as *const u8 as *const libc::c_char,
        label_count,
    );
    label_count += 1;
        ...
        (::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
            .wrapping_mul(
                (2 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(strlen(file))
                    .wrapping_add(strlen(sym.as_mut_ptr()))
    ...
    *fresh2 = '"' as i32 as libc::c_char;
    while tmp < file_endp {
        let mut bslash: *const libc::c_char = strchr(tmp, '\\' as i32);
        let mut len: size_t = (if !bslash.is_null() {
            bslash.offset_from(tmp) as libc::c_long + 1 as libc::c_int as libc::c_long
        } else {
            file_endp.offset_from(tmp) as libc::c_long
        }) as size_t;
        memcpy(bufp as *mut libc::c_void, tmp as *const libc::c_void, len);
        tmp = tmp.offset(len as isize);
        bufp = bufp.offset(len as isize);
        if !bslash.is_null() {
            let fresh3 = bufp;
            bufp = bufp.offset(1);
...
static mut in_dot_func_p: bool = 0 as libc::c_int != 0;
static mut current_function_label: *const libc::c_char = 0 as *const libc::c_char;
unsafe extern "C" fn s_stab_generic(
    mut what: libc::c_int,
    mut stab_secname: *const libc::c_char,
    mut stabstr_secname: *const libc::c_char,
    mut stab_secname_obstack_end: *const libc::c_char,
) {
    let mut longint: libc::c_long = 0;
    let mut string: *const libc::c_char = 0 as *const libc::c_char;
    let mut saved_string_obstack_end: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut type_0: libc::c_int = 0;
    let mut other: libc::c_int = 0;
    let mut desc: libc::c_int = 0;
    if what != 's' as i32 {
        string = b"\0" as *const u8 as *const libc::c_char;
        saved_string_obstack_end = 0 as *mut libc::c_char;
    } else {
        let mut length: libc::c_int = 0;
        string = demand_copy_C_string(&mut length);
        if string.is_null() {
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
                    b".stab%c: missing string\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                what,
            );
        ...
        saved_string_obstack_end = notes.next_free as *mut libc::c_void
            as *mut libc::c_char;
        if *input_line_pointer as libc::c_int == ' ' as i32 {
            input_line_pointer = input_line_pointer.offset(1);
            input_line_pointer;
        ...
        if *input_line_pointer as libc::c_int == ',' as i32 {
            ...
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
                    b".stab%c: missing comma\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                what,
            );
    ...
    if get_absolute_expression_and_terminator(&mut longint) as libc::c_int != ',' as i32
    {
        as_warn(
            dcgettext(
                0 as *const libc::c_char,
    ...
    other = longint as libc::c_int;
    desc = get_absolute_expression() as libc::c_int;
    if desc > 0xffff as libc::c_int || desc < -(0x8000 as libc::c_int) {
        as_warn(
            dcgettext(
                0 as *const libc::c_char,
                b".stab%c: description field '%x' too big, try a different debug format\0"
    ...
    if what == 's' as i32 || what == 'n' as i32 {
        if *input_line_pointer as libc::c_int != ',' as i32 {
            as_warn(
                dcgettext(
                    0 as *const libc::c_char,
    ...
    if listing != 0 {
        match type_0 {
            68 => {
                listing_source_line(desc as libc::c_uint);
            }
            100 | 132 => {
    ...
    let mut saved_seg: segT = now_seg;
    let mut saved_subseg: subsegT = now_subseg;
    let mut saved_frag: *mut fragS = frag_now;
    let mut dot: valueT = 0;
    let mut seg: segT = 0 as *mut asection;
    let mut stroff: libc::c_uint = 0;
    let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
    static mut cached_sec: segT = 0 as *const asection as *mut asection;
    dot = frag_now_fix();
    if !cached_sec.is_null()
        && strcmp((*cached_sec).name, stab_secname) == 0 as libc::c_int
    {
        seg = cached_sec;
        subseg_set(seg, 0 as libc::c_int);
    } else {
        seg = subseg_new(stab_secname, 0 as libc::c_int);
        cached_sec = seg;
    }
    if (*(bfd_section_userdata(seg as *const asection) as *mut segment_info_type))
        .hadone() == 0
    {
        bfd_set_section_flags(
            seg,
            (0x8 as libc::c_int | 0x4 as libc::c_int | 0x2000 as libc::c_int) as flagword,
        );
        obj_elf_init_stab_section(seg);
        let ref mut fresh4 = *(bfd_section_userdata(seg as *const asection)
            as *mut segment_info_type);
        (*fresh4).set_hadone(1 as libc::c_int as libc::c_uint);
    }
    stroff = get_stab_string_offset(
        string,
        stabstr_secname,
        !stab_secname_obstack_end.is_null(),
    );
    if !saved_string_obstack_end.is_null()
        && saved_string_obstack_end
            == notes.next_free as *mut libc::c_void as *mut libc::c_char
    {
        let mut __o: *mut obstack = &mut notes;
        let mut __obj: *mut libc::c_void = string as *mut libc::c_void;
    ...
    if (*seg).name != stab_secname && !stab_secname_obstack_end.is_null()
        && stab_secname_obstack_end
            == notes.next_free as *mut libc::c_void as *const libc::c_char
    {
        let mut __o_0: *mut obstack = &mut notes;
        let mut __obj_0: *mut libc::c_void = stab_secname as *mut libc::c_void;
    ...
    p = frag_more(8 as libc::c_int as size_t);
    ...
    if what == 's' as i32 || what == 'n' as i32 {
        cons(4 as libc::c_int);
        input_line_pointer = input_line_pointer.offset(-1);
        input_line_pointer;
    } else {
        let mut symbol: *mut symbolS = 0 as *mut symbolS;
