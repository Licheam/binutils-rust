extern "C" {
    ...
    fn ar_emul_default_parse_arg(_: *mut libc::c_char) -> bool;
    fn ar_emul_default_replace(_: *mut *mut bfd, _: *mut bfd, _: bool) -> bool;
    fn ar_emul_default_append(_: *mut *mut bfd, _: *mut bfd, _: bool, _: bool) -> bool;
    fn ar_emul_default_usage(_: *mut FILE);
}
...
#[no_mangle]
pub static mut bin_vanilla_emulation: bin_emulation_xfer_struct = unsafe {
    {
        let mut init = bin_emulation_xfer_struct {
            ar_usage: Some(
                ar_emul_default_usage as unsafe extern "C" fn(*mut FILE) -> (),
            ),
            ar_append: Some(
                ar_emul_default_append
                    as unsafe extern "C" fn(*mut *mut bfd, *mut bfd, bool, bool) -> bool,
            ),
            ar_replace: Some(
                ar_emul_default_replace
                    as unsafe extern "C" fn(*mut *mut bfd, *mut bfd, bool) -> bool,
            ),
            ar_parse_arg: Some(
                ar_emul_default_parse_arg
                    as unsafe extern "C" fn(*mut libc::c_char) -> bool,
            ),
        };
        init
    }
