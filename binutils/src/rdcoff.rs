extern "C" {
    ...
    fn bfd_coff_get_syment(
        _: *mut bfd,
        _: *mut bfd_symbol,
        _: *mut internal_syment,
    ) -> bool;
    fn bfd_coff_get_auxent(
        _: *mut bfd,
        _: *mut bfd_symbol,
        _: libc::c_int,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_types {
    pub slots: *mut coff_slots,
    pub basic: [debug_type; 17],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_slots {
    pub next: *mut coff_slots,
    pub slots: [debug_type; 16],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_symbols {
    pub syms: *mut *mut asymbol,
    pub symcount: libc::c_long,
    pub symno: libc::c_long,
    pub coff_symno: libc::c_long,
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn parse_coff(
    mut abfd: *mut bfd,
    mut syms: *mut *mut asymbol,
    mut symcount: libc::c_long,
    mut dhandle: *mut libc::c_void,
) -> bool {
    let mut symbols: coff_symbols = coff_symbols {
        syms: 0 as *mut *mut asymbol,
        symcount: 0,
        symno: 0,
        coff_symno: 0,
    };
    let mut types: coff_types = coff_types {
        slots: 0 as *mut coff_slots,
        basic: [0 as *mut debug_type_s; 17],
    };
    let mut i: libc::c_int = 0;
    let mut next_c_file: libc::c_long = 0;
    let mut fnname: *const libc::c_char = 0 as *const libc::c_char;
    let mut fnclass: libc::c_int = 0;
    let mut fntype: libc::c_int = 0;
    let mut fnend: bfd_vma = 0;
    let mut linenos: *mut alent = 0 as *mut alent;
    let mut within_function: bool = false;
    let mut this_coff_symno: libc::c_long = 0;
    symbols.syms = syms;
    symbols.symcount = symcount;
    symbols.symno = 0 as libc::c_int as libc::c_long;
    symbols.coff_symno = 0 as libc::c_int as libc::c_long;
    types.slots = 0 as *mut coff_slots;
    i = 0 as libc::c_int;
    while i <= 16 as libc::c_int {
        types.basic[i as usize] = 0 as *mut libc::c_void as debug_type;
        i += 1;
        i;
    }
    next_c_file = -(1 as libc::c_int) as libc::c_long;
    fnname = 0 as *const libc::c_char;
    fnclass = 0 as libc::c_int;
    fntype = 0 as libc::c_int;
    fnend = 0 as libc::c_int as bfd_vma;
    linenos = 0 as *mut alent;
    within_function = 0 as libc::c_int != 0;
    while symbols.symno < symcount {
        let mut sym: *mut asymbol = 0 as *mut asymbol;
        let mut name: *const libc::c_char = 0 as *const libc::c_char;
        let mut syment: internal_syment = internal_syment {
            _n: C2RustUnnamed_17 {
                _n_name: [0; 8],
            },
            n_value: 0,
        ...
        let mut auxent: internal_auxent = internal_auxent {
        ...
        let mut paux: *mut internal_auxent = 0 as *mut internal_auxent;
        let mut type_0: debug_type = 0 as *mut debug_type_s;
        sym = *syms.offset(symbols.symno as isize);
        if !bfd_coff_get_syment(abfd, sym, &mut syment) {
            non_fatal(
                dcgettext(
                    0 as *const libc::c_char,
                    b"bfd_coff_get_syment failed: %s\0" as *const u8
        ...
        symbols.symno;
        symbols.coff_symno
            += (1 as libc::c_int + syment.n_numaux as libc::c_int) as libc::c_long;
        if syment.n_numaux as libc::c_int == 0 as libc::c_int {
            paux = 0 as *mut internal_auxent;
        } else {
            if !bfd_coff_get_auxent(abfd, sym, 0 as libc::c_int, &mut auxent) {
                non_fatal(
                    dcgettext(
                        0 as *const libc::c_char,
                        b"bfd_coff_get_auxent failed: %s\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    bfd_errmsg(bfd_get_error()),
        ...
        if this_coff_symno == next_c_file
            && syment.n_sclass as libc::c_int != 103 as libc::c_int
        {
            if !debug_set_filename(
                dhandle,
        ...
        match syment.n_sclass as libc::c_int {
            255 | 5 | 7 | 14 | 104 | 105 | 106 => {
                current_block_103 = 7072655752890836508;
            }
            103 => {
                next_c_file = syment.n_value as libc::c_long;
            ...
            3 => {
                if syment.n_type as libc::c_int == 0 as libc::c_int {
                    current_block_103 = 7072655752890836508;
                } else {
                    current_block_103 = 8473538439393646959;
                }
            }
            127 | 2 => {
                current_block_103 = 8473538439393646959;
            ...
            101 => {
                if strcmp(name, b".bf\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                    if fnname.is_null() {
                        non_fatal(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%ld: .bf without preceding function\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            this_coff_symno,
                    ...
                    type_0 = parse_coff_type(
                        abfd,
                        &mut symbols,
                        &mut types,
                        this_coff_symno,
                        ((fntype >> (*(*abfd).tdata.coff_obj_data).local_n_tshift)
                            as libc::c_uint
                            & !(*(*abfd).tdata.coff_obj_data).local_n_btmask
                            | fntype as libc::c_uint
                                & (*(*abfd).tdata.coff_obj_data).local_n_btmask)
                            as libc::c_int,
                        paux,
                        0 as libc::c_int != 0,
                    ...
                    if !linenos.is_null() {
                        ...
                        if syment.n_numaux as libc::c_int == 0 as libc::c_int {
                            ...
                            base = auxent.x_sym.x_misc.x_lnsz.x_lnno as libc::c_int
                                - 1 as libc::c_int;
                        }
                        addr = bfd_section_vma(bfd_asymbol_section(sym));
                        linenos = linenos.offset(1);
                        linenos;
                        while (*linenos).line_number != 0 as libc::c_int as libc::c_uint
                        {
                            if !debug_record_line(
                                dhandle,
                                ((*linenos).line_number).wrapping_add(base as libc::c_uint)
                                    as libc::c_ulong,
                                ((*linenos).u.offset).wrapping_add(addr),
                            ) {
                                return 0 as libc::c_int != 0;
                            }
                            linenos = linenos.offset(1);
                    ...
                    fnclass = 0 as libc::c_int;
                    fntype = 0 as libc::c_int;
                    within_function = 1 as libc::c_int != 0;
                } else if strcmp(name, b".ef\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                    if !within_function {
                        non_fatal(
            ...
            100 => {
                if strcmp(name, b".bb\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
                    if !debug_start_block(dhandle, bfd_asymbol_value(sym)) {
                        return 0 as libc::c_int != 0;
                    }
                } else if strcmp(name, b".eb\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
                {
        ...
        match current_block_103 {
            8473538439393646959 => {
                if syment.n_type as libc::c_ulong
                    & (*(*abfd).tdata.coff_obj_data).local_n_tmask as libc::c_ulong
                    == (2 as libc::c_int as libc::c_ulong)
                        << (*(*abfd).tdata.coff_obj_data).local_n_btshft
                {
                    fnname = name;
                    fnclass = syment.n_sclass as libc::c_int;
                    fntype = syment.n_type as libc::c_int;
                    if syment.n_numaux as libc::c_int > 0 as libc::c_int {
                        fnend = (bfd_asymbol_value(sym))
                            .wrapping_add(auxent.x_sym.x_misc.x_fsize as libc::c_ulong);
                    } else {
                        fnend = 0 as libc::c_int as bfd_vma;
                    }
                    linenos = (Some(
                        ((*(*abfd).xvec)._get_lineno).expect("non-null function pointer"),
                    ))
...
unsafe extern "C" fn coff_get_slot(
    mut types: *mut coff_types,
    mut indx: libc::c_long,
) -> *mut debug_type {
    let mut pps: *mut *mut coff_slots = 0 as *mut *mut coff_slots;
    pps = &mut (*types).slots;
    if indx / 16 as libc::c_int as libc::c_long > 1000 as libc::c_int as libc::c_long {
        fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"Excessively large slot index: %lx\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            indx,
    ...
    while indx >= 16 as libc::c_int as libc::c_long {
        if (*pps).is_null() {
            *pps = xmalloc(::core::mem::size_of::<coff_slots>() as libc::c_ulong)
                as *mut coff_slots;
            memset(
                *pps as *mut libc::c_void,
                0 as libc::c_int,
                ::core::mem::size_of::<coff_slots>() as libc::c_ulong,
            );
        }
        pps = &mut (**pps).next;
        indx -= 16 as libc::c_int as libc::c_long;
    }
    if (*pps).is_null() {
        *pps = xmalloc(::core::mem::size_of::<coff_slots>() as libc::c_ulong)
            as *mut coff_slots;
    ...
    return ((**pps).slots).as_mut_ptr().offset(indx as isize);
}
unsafe extern "C" fn parse_coff_type(
    mut abfd: *mut bfd,
    ...
    let mut type_0: debug_type = 0 as *mut debug_type_s;
    if ntype as libc::c_uint & !(*(*abfd).tdata.coff_obj_data).local_n_btmask
        != 0 as libc::c_int as libc::c_uint
    {
        let mut newtype: libc::c_int = 0;
        newtype = ((ntype >> (*(*abfd).tdata.coff_obj_data).local_n_tshift)
            as libc::c_uint & !(*(*abfd).tdata.coff_obj_data).local_n_btmask
            | ntype as libc::c_uint & (*(*abfd).tdata.coff_obj_data).local_n_btmask)
            as libc::c_int;
        if ntype as libc::c_ulong
            & (*(*abfd).tdata.coff_obj_data).local_n_tmask as libc::c_ulong
                ...
                << (*(*abfd).tdata.coff_obj_data).local_n_btshft
        {
            ...
            type_0 = debug_make_pointer_type(dhandle, type_0);
        } else if ntype as libc::c_ulong
            & (*(*abfd).tdata.coff_obj_data).local_n_tmask as libc::c_ulong
            == (2 as libc::c_int as libc::c_ulong)
                << (*(*abfd).tdata.coff_obj_data).local_n_btshft
        {
            ...
            type_0 = debug_make_function_type(
                dhandle,
                type_0,
                ...
                << (*(*abfd).tdata.coff_obj_data).local_n_btshft
        {
            ...
            if pauxent.is_null() {
                ...
                let mut dim: *mut libc::c_ushort = 0 as *mut libc::c_ushort;
                let mut i: libc::c_int = 0;
                dim = ((*pauxent).x_sym.x_fcnary.x_ary.x_dimen).as_mut_ptr();
                n = *dim.offset(0 as libc::c_int as isize) as libc::c_int;
                i = 0 as libc::c_int;
                while *dim as libc::c_int != 0 as libc::c_int
                    && i < 4 as libc::c_int - 1 as libc::c_int
                {
                    *dim = *dim.offset(1 as libc::c_int as isize);
                    i += 1;
                    i;
                    dim = dim.offset(1);
                    dim;
                }
                *dim = 0 as libc::c_int as libc::c_ushort;
            }
            type_0 = parse_coff_type(
                abfd,
                symbols,
            ...
            type_0 = debug_make_array_type(
                dhandle,
                type_0,
                parse_coff_base_type(
                    abfd,
                    symbols,
                    types,
                    coff_symno,
                ...
                (n - 1 as libc::c_int) as bfd_signed_vma,
                0 as libc::c_int != 0,
            );
        } else {
            non_fatal(
                dcgettext(
                    0 as *const libc::c_char,
                    b"parse_coff_type: Bad type code 0x%x\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ntype,
    ...
    if !pauxent.is_null()
        && (*pauxent).x_sym.x_tagndx.l > 0 as libc::c_int as libc::c_long
    {
    ...
    if !useaux {
        pauxent = 0 as *mut internal_auxent;
    }
    return parse_coff_base_type(
        abfd,
        symbols,
        types,
        coff_symno,
...
unsafe extern "C" fn parse_coff_base_type(
    mut abfd: *mut bfd,
    mut symbols: *mut coff_symbols,
    mut types: *mut coff_types,
    mut coff_symno: libc::c_long,
    ...
    let mut set_basic: bool = false;
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    let mut slot: *mut debug_type = 0 as *mut debug_type;
    if ntype >= 0 as libc::c_int && ntype <= 16 as libc::c_int
        && !((*types).basic[ntype as usize]).is_null()
    {
        return (*types).basic[ntype as usize];
    }
    set_basic = 1 as libc::c_int != 0;
    ...
    match ntype {
        ...
        16 => {
            ret = debug_make_float_type(dhandle, 12 as libc::c_int as libc::c_uint);
        ...
        8 => {
            if pauxent.is_null() {
                ret = debug_make_struct_type(
                    dhandle,
                    1 as libc::c_int != 0,
                    0 as libc::c_int as bfd_vma,
                    0 as *mut libc::c_void as *mut debug_field,
                );
            } else {
                ret = parse_coff_struct_type(
                    abfd,
                    symbols,
                    types,
                    ntype,
    ...
    if set_basic as libc::c_int != 0 && ntype >= 0 as libc::c_int
        && ntype <= 16 as libc::c_int
    {
        (*types).basic[ntype as usize] = ret;
    }
    return ret;
}
unsafe extern "C" fn parse_coff_struct_type(
    mut abfd: *mut bfd,
    mut symbols: *mut coff_symbols,
    mut types: *mut coff_types,
    mut ntype: libc::c_int,
    ...
    while !done && (*symbols).coff_symno < symend
        && (*symbols).symno < (*symbols).symcount
    {
        ...
        let mut psubaux: *mut internal_auxent = 0 as *mut internal_auxent;
        let mut bitpos: bfd_vma = 0 as libc::c_int as bfd_vma;
        let mut bitsize: bfd_vma = 0 as libc::c_int as bfd_vma;
        sym = *((*symbols).syms).offset((*symbols).symno as isize);
        if !bfd_coff_get_syment(abfd, sym, &mut syment) {
            non_fatal(
                dcgettext(
                    0 as *const libc::c_char,
        ...
        (*symbols).coff_symno
            += (1 as libc::c_int + syment.n_numaux as libc::c_int) as libc::c_long;
        if syment.n_numaux as libc::c_int == 0 as libc::c_int {
            psubaux = 0 as *mut internal_auxent;
        } else {
            if !bfd_coff_get_auxent(abfd, sym, 0 as libc::c_int, &mut auxent) {
                non_fatal(
                    dcgettext(
        ...
        match syment.n_sclass as libc::c_int {
            8 | 11 => {
                bitpos = (8 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(bfd_asymbol_value(sym));
                bitsize = 0 as libc::c_int as bfd_vma;
            }
            18 => {
                bitpos = bfd_asymbol_value(sym);
                bitsize = auxent.x_sym.x_misc.x_lnsz.x_size as bfd_vma;
            }
            102 => {
        ...
        if !done {
            ...
            let mut f: debug_field = 0 as *mut debug_field_s;
            ftype = parse_coff_type(
                abfd,
                symbols,
                types,
                this_coff_symno,
            ...
            if count + 1 as libc::c_int >= alloc {
                alloc += 10 as libc::c_int;
                fields = xrealloc(
                    fields as *mut libc::c_void,
                    (alloc as libc::c_ulong)
                        .wrapping_mul(
                            ::core::mem::size_of::<debug_field>() as libc::c_ulong,
                        ),
                ) as *mut debug_field;
            }
            let ref mut fresh0 = *fields.offset(count as isize);
            *fresh0 = f;
            count += 1;
            count;
        }
    }
    let ref mut fresh1 = *fields.offset(count as isize);
    *fresh1 = 0 as *mut libc::c_void as debug_field;
    return debug_make_struct_type(
        dhandle,
        ntype == 8 as libc::c_int,
        (*pauxent).x_sym.x_misc.x_lnsz.x_size as bfd_vma,
        fields,
    );
}
unsafe extern "C" fn parse_coff_enum_type(
    ...
    let mut vals: *mut bfd_signed_vma = 0 as *mut bfd_signed_vma;
    let mut count: libc::c_int = 0;
    let mut done: bool = false;
    symend = (*pauxent).x_sym.x_fcnary.x_fcn.x_endndx.l;
    alloc = 10 as libc::c_int;
        ...
        && (*symbols).symno < (*symbols).symcount
    {
        ...
        match syment.n_sclass as libc::c_int {
            16 => {
                ...
                let ref mut fresh2 = *names.offset(count as isize);
                *fresh2 = bfd_asymbol_name(sym);
                *vals.offset(count as isize) = bfd_asymbol_value(sym) as bfd_signed_vma;
                count += 1;
                count;
            }
            102 => {
    ...
    let ref mut fresh3 = *names.offset(count as isize);
...
unsafe extern "C" fn parse_coff_symbol(
    ...
    mut sym: *mut asymbol,
    mut coff_symno: libc::c_long,
    mut psyment: *mut internal_syment,
    mut dhandle: *mut libc::c_void,
    mut type_0: debug_type,
    mut within_function: bool,
) -> bool {
    match (*psyment).n_sclass as libc::c_int {
        1 => {
            if !debug_record_variable(
                dhandle,
                bfd_asymbol_name(sym),
                type_0,
                DEBUG_LOCAL,
        ...
        3 => {
            if !debug_record_variable(
                ...
                bfd_asymbol_name(sym),
                type_0,
                (if within_function as libc::c_int != 0 {
                    DEBUG_LOCAL_STATIC as libc::c_int
                } else {
                    DEBUG_STATIC as libc::c_int
                }) as debug_var_kind,
                bfd_asymbol_value(sym),
            ) {
                return 0 as libc::c_int != 0;
        ...
        13 => {
            type_0 = debug_name_type(dhandle, bfd_asymbol_name(sym), type_0);
            if type_0.is_null() {
                return 0 as libc::c_int != 0;
            }
        }
        10 | 12 | 15 => {
            let mut slot: *mut debug_type = 0 as *mut debug_type;
            type_0 = debug_tag_type(dhandle, bfd_asymbol_name(sym), type_0);
            if type_0.is_null() {
                return 0 as libc::c_int != 0;
            }
            slot = coff_get_slot(types, coff_symno);
...
unsafe extern "C" fn external_coff_symbol_p(mut sym_class: libc::c_int) -> bool {
    match sym_class {
        2 | 127 => return 1 as libc::c_int != 0,
        _ => {}
    }
    return 0 as libc::c_int != 0;
}
