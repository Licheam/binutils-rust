extern "C" {
    ...
    fn finish_stab(_: *mut libc::c_void, _: *mut libc::c_void) -> bool;
    fn parse_stab(
        _: *mut libc::c_void,
        _: *mut libc::c_void,
        _: libc::c_int,
...
pub struct C2RustUnnamed_5 {
    pub secname: *const libc::c_char,
    pub strsecname: *const libc::c_char,
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn read_debugging_info(
    mut abfd: *mut bfd,
    mut syms: *mut *mut asymbol,
    mut symcount: libc::c_long,
    mut no_messages: bool,
) -> *mut libc::c_void {
    ...
    if read_section_stabs_debugging_info(abfd, syms, symcount, dhandle, &mut found) {
        if bfd_get_flavour(abfd) as libc::c_uint
            == bfd_target_aout_flavour as libc::c_int as libc::c_uint
        {
            if !read_symbol_stabs_debugging_info(
                abfd,
                syms,
                symcount,
                dhandle,
                ...
                current_block = 2113022028194984931;
            } else {
                            ...
                            if !no_messages {
                                non_fatal(
                                    dcgettext(
                                        ...
                                        b"%s: no recognized debugging information\0" as *const u8
...
unsafe extern "C" fn read_section_stabs_debugging_info(
    mut abfd: *mut bfd,
    mut syms: *mut *mut asymbol,
    mut symcount: libc::c_long,
    ...
    static mut names: [C2RustUnnamed_5; 3] = [
        {
            let mut init = C2RustUnnamed_5 {
                secname: b".stab\0" as *const u8 as *const libc::c_char,
                strsecname: b".stabstr\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_5 {
                secname: b"LC_SYMTAB.stabs\0" as *const u8 as *const libc::c_char,
                strsecname: b"LC_SYMTAB.stabstr\0" as *const u8 as *const libc::c_char,
            };
            init
        },
        {
            let mut init = C2RustUnnamed_5 {
                secname: b"$GDB_SYMBOLS$\0" as *const u8 as *const libc::c_char,
                strsecname: b"$GDB_STRINGS$\0" as *const u8 as *const libc::c_char,
            };
            init
        },
    ];
    let mut i: libc::c_uint = 0;
    let mut shandle: *mut libc::c_void = 0 as *mut libc::c_void;
    *pfound = 0 as libc::c_int != 0;
    shandle = 0 as *mut libc::c_void;
    i = 0 as libc::c_int as libc::c_uint;
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[C2RustUnnamed_5; 3]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<C2RustUnnamed_5>() as libc::c_ulong)
    {
        ...
        sec = bfd_get_section_by_name(abfd, names[i as usize].secname);
        strsec = bfd_get_section_by_name(abfd, names[i as usize].strsecname);
        if !sec.is_null() && !strsec.is_null() {
            let mut stabsize: bfd_size_type = 0;
            let mut strsize: bfd_size_type = 0;
            let mut stabs: *mut bfd_byte = 0 as *mut bfd_byte;
            ...
            stabs = xmalloc(stabsize) as *mut bfd_byte;
            if !bfd_get_section_contents(
                abfd,
                sec,
                stabs as *mut libc::c_void,
                ...
                fprintf(
                    ...
                    bfd_get_filename(abfd),
                    names[i as usize].secname,
                    bfd_errmsg(bfd_get_error()),
                );
                free(shandle);
                free(stabs as *mut libc::c_void);
                return 0 as libc::c_int != 0;
            }
            strsize = bfd_section_size(strsec);
            strings = xmalloc(strsize.wrapping_add(1 as libc::c_int as libc::c_ulong))
                as *mut bfd_byte;
            if !bfd_get_section_contents(
                abfd,
                strsec,
            ...
            *strings.offset(strsize as isize) = 0 as libc::c_int as bfd_byte;
            if shandle.is_null() {
                shandle = start_stab(
                    dhandle,
                    abfd,
            ...
            *pfound = 1 as libc::c_int != 0;
            ...
            next_stroff = 0 as libc::c_int as bfd_size_type;
            stab = stabs;
            while stab
                <= stabs.offset(stabsize as isize).offset(-(12 as libc::c_int as isize))
            {
                ...
                strx = (Some(
                    ...
                    .expect("non-null function pointer")(stab as *const libc::c_void)
                    as libc::c_uint;
                type_0 = (*(stab.offset(4 as libc::c_int as isize)
                    as *const libc::c_uchar) as bfd_vma
                    & 0xff as libc::c_int as libc::c_ulong) as libc::c_int;
                other = (*(stab.offset(5 as libc::c_int as isize)
                    as *const libc::c_uchar) as bfd_vma
                    & 0xff as libc::c_int as libc::c_ulong) as libc::c_int;
                desc = (Some(
                ...
                if type_0 == 0 as libc::c_int {
                    stroff = next_stroff;
                    next_stroff = (next_stroff as libc::c_ulong).wrapping_add(value)
                        as bfd_size_type as bfd_size_type;
                } else {
                    let mut len: size_t = 0;
                    let mut f: *mut libc::c_char = 0 as *mut libc::c_char;
                    let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
                    if stroff.wrapping_add(strx as libc::c_ulong) >= strsize {
                        fprintf(
                            stderr,
                            dcgettext(
                                0 as *const libc::c_char,
                                b"%s: %s: stab entry %ld is corrupt, strx = 0x%x, type = %d\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            bfd_get_filename(abfd),
                            names[i as usize].secname,
                            stab.offset_from(stabs) as libc::c_long
                                / 12 as libc::c_int as libc::c_long,
                            strx,
                            type_0,
                        );
                    } else {
                        s = (strings as *mut libc::c_char)
                            .offset(stroff as isize)
                            .offset(strx as isize);
                        ...
                        loop {
                            ...
                            if !(len > 0 as libc::c_int as libc::c_ulong
                                ...
                                && stab.offset(12 as libc::c_int as isize)
                                    < stabs.offset(stabsize as isize))
                            {
                                break;
                            }
                            ...
                            strx = stroff
                                .wrapping_add(
                                    (Some(
                                        ...
                                        .expect(
                                            "non-null function pointer",
                                        )(stab as *const libc::c_void),
                                ) as libc::c_uint;
                            if strx as libc::c_ulong >= strsize {
                                fprintf(
                                    stderr,
                                    dcgettext(
                                        0 as *const libc::c_char,
                                        b"%s: %s: stab entry %ld is corrupt\n\0" as *const u8
                                            as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    bfd_get_filename(abfd),
                                ...
                                s = concat(
                                    s,
                                    (strings as *mut libc::c_char).offset(strx as isize),
                        ...
                        save_stab(type_0, desc, value, s);
                        if !parse_stab(dhandle, shandle, type_0, desc, value, s) {
                            stab_context();
                            free_saved_stabs();
                            free(f as *mut libc::c_void);
                            free(shandle);
...
unsafe extern "C" fn read_symbol_stabs_debugging_info(
    mut abfd: *mut bfd,
    mut syms: *mut *mut asymbol,
    mut symcount: libc::c_long,
    mut dhandle: *mut libc::c_void,
    ...
    let mut symend: *mut *mut asymbol = 0 as *mut *mut asymbol;
    shandle = 0 as *mut libc::c_void;
    symend = syms.offset(symcount as isize);
    ps = syms;
    while ps < symend {
        let mut i: symbol_info = symbol_info {
            value: 0,
            type_0: 0,
        ...
        (Some(
            ((*(*abfd).xvec)._bfd_get_symbol_info).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(abfd, *ps, &mut i);
        if i.type_0 as libc::c_int == '-' as i32 {
            ...
            *pfound = 1 as libc::c_int != 0;
            s = i.name;
            if s.is_null() || strlen(s) < 1 as libc::c_int as libc::c_ulong {
                return 0 as libc::c_int != 0;
            }
            f = 0 as *mut libc::c_char;
            while strlen(s) > 0 as libc::c_int as libc::c_ulong
                && *s
                    .offset(
                        (strlen(s)).wrapping_sub(1 as libc::c_int as libc::c_ulong)
                            as isize,
                    ) as libc::c_int == '\\' as i32
                && ps.offset(1 as libc::c_int as isize) < symend
            {
                ...
                *sc
                    .offset(
                        (strlen(sc)).wrapping_sub(1 as libc::c_int as libc::c_ulong)
                            as isize,
            ...
            save_stab(
                i.stab_type as libc::c_int,
                i.stab_desc as libc::c_int,
                i.value,
                s,
            );
            if !parse_stab(
...
unsafe extern "C" fn save_stab(
    mut type_0: libc::c_int,
    mut desc: libc::c_int,
    mut value: bfd_vma,
    mut string: *const libc::c_char,
) {
    free(saved_stabs[saved_stabs_index as usize].string as *mut libc::c_void);
    saved_stabs[saved_stabs_index as usize].type_0 = type_0;
    saved_stabs[saved_stabs_index as usize].desc = desc;
    saved_stabs[saved_stabs_index as usize].value = value;
    saved_stabs[saved_stabs_index as usize].string = xstrdup(string);
    saved_stabs_index = (saved_stabs_index + 1 as libc::c_int) % 16 as libc::c_int;
}
unsafe extern "C" fn stab_context() {
    let mut i: libc::c_int = 0;
    fprintf(
        stderr,
        dcgettext(
            0 as *const libc::c_char,
            b"Last stabs entries before error:\n\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        stderr,
        b"n_type n_desc n_value  string\n\0" as *const u8 as *const libc::c_char,
    );
    i = saved_stabs_index;
    loop {
        let mut stabp: *mut saved_stab = 0 as *mut saved_stab;
        stabp = saved_stabs.as_mut_ptr().offset(i as isize);
        if !((*stabp).string).is_null() {
            let mut s: *const libc::c_char = 0 as *const libc::c_char;
            s = bfd_get_stab_name((*stabp).type_0);
            if !s.is_null() {
                fprintf(stderr, b"%-6s\0" as *const u8 as *const libc::c_char, s);
            } else if (*stabp).type_0 == 0 as libc::c_int {
                fprintf(stderr, b"HdrSym\0" as *const u8 as *const libc::c_char);
            } else {
                fprintf(
                    stderr,
            ...
            if (*stabp).type_0 != 0 as libc::c_int {
                fprintf(
                    stderr,
        ...
        i = (i + 1 as libc::c_int) % 16 as libc::c_int;
        if !(i != saved_stabs_index) {
            break;
        }
    };
}
unsafe extern "C" fn free_saved_stabs() {
    let mut i: libc::c_int = 0;
    i = 0 as libc::c_int;
    while i < 16 as libc::c_int {
        free(saved_stabs[i as usize].string as *mut libc::c_void);
        saved_stabs[i as usize].string = 0 as *mut libc::c_char;
        i += 1;
        i;
    }
    saved_stabs_index = 0 as libc::c_int;
}
static mut saved_stabs: [saved_stab; 16] = [saved_stab {
    type_0: 0,
    desc: 0,
    value: 0,
    string: 0 as *const libc::c_char as *mut libc::c_char,
}; 16];
static mut saved_stabs_index: libc::c_int = 0;
