extern "C" {
    ...
    fn mode_string(_: libc::c_ulong, _: *mut libc::c_char);
}
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_archive_filename(
    mut abfd: *const bfd,
) -> *const libc::c_char {
    static mut curr: size_t = 0 as libc::c_int as size_t;
    static mut buf: *mut libc::c_char = 0 as *const libc::c_char as *mut libc::c_char;
    let mut needed: size_t = 0;
    if !abfd.is_null() {} else {
        __assert_fail(
            b"abfd != NULL\0" as *const u8 as *const libc::c_char,
            b"bucomm.c\0" as *const u8 as *const libc::c_char,
            649 as libc::c_int as libc::c_uint,
            (*::core::mem::transmute::<
                &[u8; 50],
                &[libc::c_char; 50],
            >(b"const char *bfd_get_archive_filename(const bfd *)\0"))
                .as_ptr(),
        );
    }
    'c_10015: {
    ...
    if needed > curr {
        ...
        curr = needed.wrapping_add(needed >> 1 as libc::c_int);
        buf = xmalloc(curr) as *mut libc::c_char;
    }
    sprintf(
        buf,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_nonfatal(mut string: *const libc::c_char) {
    let mut errmsg: *const libc::c_char = 0 as *const libc::c_char;
    let mut err: bfd_error = bfd_get_error();
    if err as libc::c_uint == bfd_error_no_error as libc::c_int as libc::c_uint {
        errmsg = dcgettext(
            0 as *const libc::c_char,
            b"cause of error unknown\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        );
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_nonfatal_message(
    mut filename: *const libc::c_char,
    mut abfd: *const bfd,
    mut section: *const asection,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_fatal(mut string: *const libc::c_char) -> ! {
    bfd_nonfatal(string);
...
pub unsafe extern "C" fn fatal(mut format: *const libc::c_char, mut args: ...) -> ! {
    let mut args_0: ::core::ffi::VaListImpl;
    args_0 = args.clone();
    report(format, args_0.as_va_list());
    xexit(1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn non_fatal(mut format: *const libc::c_char, mut args: ...) {
    let mut args_0: ::core::ffi::VaListImpl;
    args_0 = args.clone();
    report(format, args_0.as_va_list());
}
#[no_mangle]
pub unsafe extern "C" fn set_default_bfd_target() {
    let mut target: *const libc::c_char = b"x86_64-pc-linux-gnu\0" as *const u8
        as *const libc::c_char;
    if !bfd_set_default_target(target) {
        fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"can't set BFD default target to `%s': %s\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            target,
...
#[no_mangle]
pub unsafe extern "C" fn list_matching_formats(mut p: *mut *mut libc::c_char) {
    fflush(stdout);
    fprintf(
        stderr,
        dcgettext(
            0 as *const libc::c_char,
            b"%s: Matching formats:\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        program_name,
    );
    while !(*p).is_null() {
        let fresh0 = p;
        p = p.offset(1);
        fprintf(stderr, b" %s\0" as *const u8 as *const libc::c_char, *fresh0);
    }
    fputc('\n' as i32, stderr);
}
#[no_mangle]
pub unsafe extern "C" fn list_supported_targets(
    mut name: *const libc::c_char,
    mut f: *mut FILE,
) {
    let mut t: libc::c_int = 0;
    let mut targ_names: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    if name.is_null() {
        fprintf(
            f,
            dcgettext(
                0 as *const libc::c_char,
                b"Supported targets:\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    } else {
    ...
    t = 0 as libc::c_int;
    while !(*targ_names.offset(t as isize)).is_null() {
        fprintf(
            f,
            b" %s\0" as *const u8 as *const libc::c_char,
            *targ_names.offset(t as isize),
        );
        t += 1;
        t;
    }
    fprintf(f, b"\n\0" as *const u8 as *const libc::c_char);
    free(targ_names as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn list_supported_architectures(
    mut name: *const libc::c_char,
    mut f: *mut FILE,
) {
    let mut arch: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    let mut arches: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    if name.is_null() {
        fprintf(
            f,
            dcgettext(
                0 as *const libc::c_char,
                b"Supported architectures:\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    } else {
        fprintf(
            ...
            dcgettext(
                0 as *const libc::c_char,
                b"%s: supported architectures:\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            name,
        );
    }
    arches = bfd_arch_list();
    arch = arches;
    while !(*arch).is_null() {
        fprintf(f, b" %s\0" as *const u8 as *const libc::c_char, *arch);
        arch = arch.offset(1);
        arch;
    }
    fprintf(f, b"\n\0" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn display_info() -> libc::c_int {
    let mut arg: display_target = display_target {
        filename: 0 as *mut libc::c_char,
        error: 0,
        count: 0,
        alloc: 0,
        info: 0 as *mut C2RustUnnamed_5,
    };
    printf(
        dcgettext(
            0 as *const libc::c_char,
            b"BFD header file version %s\n\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
        b"(GNU Binutils) 2.37\0" as *const u8 as *const libc::c_char,
    );
    display_target_list(&mut arg);
    if arg.error == 0 {
        display_target_tables(&mut arg);
    }
    return arg.error;
}
#[no_mangle]
pub unsafe extern "C" fn print_arelt_descr(
    mut file: *mut FILE,
    mut abfd: *mut bfd,
    mut verbose: bool,
    mut offsets: bool,
    ...
    if verbose {
        ...
        {
            let mut modebuf: [libc::c_char; 11] = [0; 11];
            let mut timebuf: [libc::c_char; 40] = [0; 40];
            let mut when: time_t = buf.st_mtim.tv_sec;
            let mut ctime_result: *const libc::c_char = ctime(&mut when)
                as *const libc::c_char;
            let mut size: bfd_size_type = 0;
            if ctime_result.is_null() {
                sprintf(
                    timebuf.as_mut_ptr(),
                    dcgettext(
                        0 as *const libc::c_char,
                        b"<time data corrupt>\0" as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                );
            } else {
                sprintf(
                    timebuf.as_mut_ptr(),
                    b"%.12s %.4s\0" as *const u8 as *const libc::c_char,
                    ctime_result.offset(4 as libc::c_int as isize),
                    ctime_result.offset(20 as libc::c_int as isize),
                );
            }
            mode_string(buf.st_mode as libc::c_ulong, modebuf.as_mut_ptr());
            modebuf[10 as libc::c_int as usize] = '\0' as i32 as libc::c_char;
            size = buf.st_size as bfd_size_type;
            fprintf(
                file,
                b"%s %ld/%ld %6lu %s \0" as *const u8 as *const libc::c_char,
                modebuf.as_mut_ptr().offset(1 as libc::c_int as isize),
                buf.st_uid as libc::c_long,
                buf.st_gid as libc::c_long,
                size,
                timebuf.as_mut_ptr(),
            );
        }
    }
    fprintf(file, b"%s\0" as *const u8 as *const libc::c_char, bfd_get_filename(abfd));
    if offsets {
        if bfd_is_thin_archive(abfd) as libc::c_int != 0 && (*abfd).proxy_origin != 0 {
            fprintf(
                file,
                b" 0x%lx\0" as *const u8 as *const libc::c_char,
                (*abfd).proxy_origin,
            );
        } else if !bfd_is_thin_archive(abfd) && (*abfd).origin != 0 {
            fprintf(
                file,
                b" 0x%lx\0" as *const u8 as *const libc::c_char,
                (*abfd).origin,
...
#[no_mangle]
pub unsafe extern "C" fn make_tempname(
    mut filename: *const libc::c_char,
    mut ofd: *mut libc::c_int,
) -> *mut libc::c_char {
    let mut tmpname: *mut libc::c_char = template_in_dir(filename);
...
#[no_mangle]
pub unsafe extern "C" fn make_tempdir(
    mut filename: *const libc::c_char,
) -> *mut libc::c_char {
    let mut tmpname: *mut libc::c_char = template_in_dir(filename);
...
#[no_mangle]
pub unsafe extern "C" fn parse_vma(
    mut s: *const libc::c_char,
    mut arg: *const libc::c_char,
) -> bfd_vma {
    let mut ret: bfd_vma = 0;
    let mut end: *const libc::c_char = 0 as *const libc::c_char;
    ret = bfd_scan_vma(s, &mut end, 0 as libc::c_int);
    if *end as libc::c_int != '\0' as i32 {
        fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"%s: bad number: %s\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            arg,
            s,
...
#[no_mangle]
pub unsafe extern "C" fn get_file_size(mut file_name: *const libc::c_char) -> off_t {
    ...
    if stat(file_name, &mut statbuf) < 0 as libc::c_int {
        if *__errno_location() == 2 as libc::c_int {
            ...
            non_fatal(
                dcgettext(
                    0 as *const libc::c_char,
                    b"Warning: could not locate '%s'.  reason: %s\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                file_name,
        ...
        == 0o40000 as libc::c_int as libc::c_uint
    {
        non_fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"Warning: '%s' is a directory\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            file_name,
        );
        ...
        == 0o100000 as libc::c_int as libc::c_uint)
    {
        non_fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"Warning: '%s' is not an ordinary file\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            file_name,
        );
    } else if statbuf.st_size < 0 as libc::c_int as libc::c_long {
        non_fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"Warning: '%s' has negative size, probably it is too large\0"
...
#[no_mangle]
pub unsafe extern "C" fn is_valid_archive_path(
    mut pathname: *const libc::c_char,
) -> bool {
    let mut n: *const libc::c_char = pathname;
    if *n.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
        || *n.offset(0 as libc::c_int as isize) as libc::c_int == '\\' as i32
            && 0 as libc::c_int != 0
        || *n.offset(0 as libc::c_int as isize) as libc::c_int != 0
    ...
    while *n != 0 {
        if *n as libc::c_int == '.' as i32
            ...
            && {
                ...
                *n == 0
                    || (*n as libc::c_int == '/' as i32
                        || *n as libc::c_int == '\\' as i32 && 0 as libc::c_int != 0)
            }
        {
            return 0 as libc::c_int != 0;
        }
        while *n as libc::c_int != 0
            && !(*n as libc::c_int == '/' as i32
                || *n as libc::c_int == '\\' as i32 && 0 as libc::c_int != 0)
        {
            n = n.offset(1);
...
pub static mut program_name: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
unsafe extern "C" fn endian_string(mut endian: bfd_endian) -> *const libc::c_char {
    match endian as libc::c_uint {
        0 => {
            return dcgettext(
                0 as *const libc::c_char,
        ...
        _ => {
            return dcgettext(
                0 as *const libc::c_char,
                b"endianness unknown\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            );
        }
    };
}
unsafe extern "C" fn do_display_target(
    mut targ: *const bfd_target,
    mut data: *mut libc::c_void,
) -> libc::c_int {
    let mut param: *mut display_target = data as *mut display_target;
    let mut abfd: *mut bfd = 0 as *mut bfd;
    let mut amt: size_t = 0;
    (*param).count += 1 as libc::c_int;
    amt = ((*param).count as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<C2RustUnnamed_5>() as libc::c_ulong);
    if (*param).alloc < amt {
        let mut size: size_t = ((if (*param).count < 64 as libc::c_int {
            64 as libc::c_int
        } else {
            (*param).count
        }) as libc::c_ulong)
        ...
        (*param)
            .info = xrealloc((*param).info as *mut libc::c_void, size)
            as *mut C2RustUnnamed_5;
        memset(
            ((*param).info as *mut libc::c_char).offset((*param).alloc as isize)
                as *mut libc::c_void,
            0 as libc::c_int,
            size.wrapping_sub((*param).alloc),
        );
        (*param).alloc = size;
    }
    let ref mut fresh1 = (*((*param).info)
        .offset(((*param).count - 1 as libc::c_int) as isize))
        .name;
    *fresh1 = (*targ).name;
    printf(
        dcgettext(
    ...
    if abfd.is_null() {
        ...
        let mut a: bfd_architecture = bfd_arch_unknown;
        a = (bfd_arch_obscure as libc::c_int + 1 as libc::c_int) as bfd_architecture;
        while (a as libc::c_uint) < bfd_arch_last as libc::c_int as libc::c_uint {
            if (Some(
                ((*(*abfd).xvec)._bfd_set_arch_mach).expect("non-null function pointer"),
            ))
                .expect(
                    "non-null function pointer",
                )(abfd, a, 0 as libc::c_int as libc::c_ulong)
            {
                printf(
                    b"  %s\n\0" as *const u8 as *const libc::c_char,
                    bfd_printable_arch_mach(a, 0 as libc::c_int as libc::c_ulong),
                );
                (*((*param).info).offset(((*param).count - 1 as libc::c_int) as isize))
                    .arch[(a as libc::c_uint)
                    .wrapping_sub(bfd_arch_obscure as libc::c_int as libc::c_uint)
...
unsafe extern "C" fn display_target_list(mut arg: *mut display_target) {
    (*arg).filename = make_temp_file(0 as *const libc::c_char);
    (*arg).error = 0 as libc::c_int;
    (*arg).count = 0 as libc::c_int;
    (*arg).alloc = 0 as libc::c_int as size_t;
    (*arg).info = 0 as *mut C2RustUnnamed_5;
    ...
    unlink((*arg).filename);
    free((*arg).filename as *mut libc::c_void);
}
unsafe extern "C" fn do_info_size(
    mut targ: libc::c_int,
    mut width: libc::c_int,
    mut arg: *const display_target,
) -> libc::c_int {
    while targ < (*arg).count {
        width = (width as libc::c_ulong)
            .wrapping_sub(
                (strlen((*((*arg).info).offset(targ as isize)).name))
...
unsafe extern "C" fn do_info_header(
    mut targ: libc::c_int,
    mut stop_targ: libc::c_int,
    mut arg: *const display_target,
) {
    while targ != stop_targ {
        ...
        printf(
            b"%s \0" as *const u8 as *const libc::c_char,
            (*((*arg).info).offset(fresh2 as isize)).name,
        );
    }
}
unsafe extern "C" fn do_info_row(
    mut targ: libc::c_int,
    mut stop_targ: libc::c_int,
    mut a: bfd_architecture,
    mut arg: *const display_target,
) {
    while targ != stop_targ {
        if (*((*arg).info).offset(targ as isize))
            .arch[(a as libc::c_uint)
            .wrapping_sub(bfd_arch_obscure as libc::c_int as libc::c_uint)
            .wrapping_sub(1 as libc::c_int as libc::c_uint) as usize] != 0
        {
            fputs((*((*arg).info).offset(targ as isize)).name, stdout);
        } else {
            let mut l: libc::c_int = strlen((*((*arg).info).offset(targ as isize)).name)
                as libc::c_int;
            loop {
                let fresh3 = l;
                l = l - 1;
...
unsafe extern "C" fn display_target_tables(mut arg: *const display_target) {
    let mut columns: *const libc::c_char = 0 as *const libc::c_char;
    let mut width: libc::c_int = 0;
    let mut start_targ: libc::c_int = 0;
    let mut stop_targ: libc::c_int = 0;
    let mut arch: bfd_architecture = bfd_arch_unknown;
    let mut longest_arch: libc::c_int = 0 as libc::c_int;
    arch = (bfd_arch_obscure as libc::c_int + 1 as libc::c_int) as bfd_architecture;
    while (arch as libc::c_uint) < bfd_arch_last as libc::c_int as libc::c_uint {
        let mut s: *const libc::c_char = bfd_printable_arch_mach(
            arch,
    ...
    if width == 0 as libc::c_int {
        width = 80 as libc::c_int;
    }
    start_targ = 0 as libc::c_int;
    while start_targ < (*arg).count {
        stop_targ = do_info_size(
            start_targ,
            width - longest_arch - 1 as libc::c_int,
            arg,
        );
        printf(
            b"\n%*s\0" as *const u8 as *const libc::c_char,
            longest_arch + 1 as libc::c_int,
        ...
        while (arch as libc::c_uint) < bfd_arch_last as libc::c_int as libc::c_uint {
            if strcmp(
                bfd_printable_arch_mach(arch, 0 as libc::c_int as libc::c_ulong),
        ...
        start_targ = stop_targ;
    }
}
unsafe extern "C" fn template_in_dir(
    ...
    if !slash.is_null() {
        len = slash.offset_from(path) as libc::c_long as size_t;
        tmpname = xmalloc(
            len
                .wrapping_add(
        ...
        memcpy(tmpname as *mut libc::c_void, path as *const libc::c_void, len);
        let fresh4 = len;
        len = len.wrapping_add(1);
        *tmpname.offset(fresh4 as isize) = '/' as i32 as libc::c_char;
    } else {
        tmpname = xmalloc(::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong)
            as *mut libc::c_char;
        len = 0 as libc::c_int as size_t;
    }
    memcpy(
        tmpname.offset(len as isize) as *mut libc::c_void,
        b"stXXXXXX\0" as *const u8 as *const libc::c_char as *const libc::c_void,
        ::core::mem::size_of::<[libc::c_char; 9]>() as libc::c_ulong,
    );
    return tmpname;
}
