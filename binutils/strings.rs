...
static mut address_radix: libc::c_int = 0;
static mut string_min: libc::c_int = 0;
...
static mut encoding: libc::c_char = 0;
static mut encoding_bytes: libc::c_int = 0;
static mut output_separator: *mut libc::c_char = 0 as *const libc::c_char
    as *mut libc::c_char;
static mut long_options: [option; 12] = [
    ...
    {
        let mut init = option {
            name: b"include-all-whitespace\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 'w' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"output-separator\0" as *const u8 as *const libc::c_char,
            has_arg: 1 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 's' as i32,
        };
...
unsafe extern "C" fn strings_file(mut file: *mut libc::c_char) -> bool {
    ...
    if stat(file, &mut st) < 0 as libc::c_int {
    ...
    if !datasection_only || !strings_object_file(file) {
        ...
        if fclose(stream) == -(1 as libc::c_int) {
            fprintf(stderr, b"%s: \0" as *const u8 as *const libc::c_char, program_name);
            perror(file);
            return 0 as libc::c_int != 0;
        }
...
unsafe extern "C" fn print_strings(
    ...
    mut stop_point: libc::c_int,
    mut magiccount: libc::c_int,
    mut magic: *mut libc::c_char,
) {
    let mut buf: *mut libc::c_char = xmalloc(
        (::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
            .wrapping_mul((string_min + 1 as libc::c_int) as libc::c_ulong),
    ) as *mut libc::c_char;
    's_6: loop {
        ...
        '_tryline: loop {
            if stop_point != 0 && address >= stop_point as libc::c_long {
                break 's_6;
            }
            start = address;
            i = 0 as libc::c_int;
            loop {
                ...
                c = get_char(stream, &mut address, &mut magiccount, &mut magic);
                if c == -(1 as libc::c_int) as libc::c_long {
                    free(buf as *mut libc::c_void);
                    return;
                }
                if !(c >= 0 as libc::c_int as libc::c_long
                    && c <= 255 as libc::c_int as libc::c_long
                    && (c == '\t' as i32 as libc::c_long
                        || _sch_istable[(c & 0xff as libc::c_int as libc::c_long)
                            as usize] as libc::c_int
                            & _sch_isprint as libc::c_int as libc::c_ushort
                                as libc::c_int != 0
                        || encoding as libc::c_int == 'S' as i32
                            && c > 127 as libc::c_int as libc::c_long
                        || include_all_whitespace as libc::c_int != 0
                            && _sch_istable[(c & 0xff as libc::c_int as libc::c_long)
                                as usize] as libc::c_int
                                & _sch_isspace as libc::c_int as libc::c_ushort
                                    as libc::c_int != 0))
                {
                    unget_part_char(c, &mut address, &mut magiccount, &mut magic);
                    break;
                } else {
        ...
        if print_addresses {
            match address_radix {
                8 => {
                    if ::core::mem::size_of::<file_ptr>() as libc::c_ulong
                        > ::core::mem::size_of::<libc::c_long>() as libc::c_ulong
                    {
                        printf(
                            b"%7llo \0" as *const u8 as *const libc::c_char,
                            start as libc::c_ulonglong,
                        );
                    } else {
                        printf(
                ...
                10 => {
                    ...
                    {
                        printf(
                            b"%7llu \0" as *const u8 as *const libc::c_char,
                            start as libc::c_ulonglong,
                        );
                    } else {
                        printf(b"%7ld \0" as *const u8 as *const libc::c_char, start);
                    }
                }
                16 => {
                    if ::core::mem::size_of::<file_ptr>() as libc::c_ulong
                    ...
                    {
                        printf(
                            b"%7llx \0" as *const u8 as *const libc::c_char,
                            start as libc::c_ulonglong,
                        );
                    } else {
                        printf(
        ...
        *buf.offset(i as isize) = '\0' as i32 as libc::c_char;
        ...
        loop {
            ...
            if !(c >= 0 as libc::c_int as libc::c_long
                && c <= 255 as libc::c_int as libc::c_long
                && (c == '\t' as i32 as libc::c_long
                    || _sch_istable[(c & 0xff as libc::c_int as libc::c_long) as usize]
                        as libc::c_int
...
unsafe fn main_0(
    ...
    let mut files_given: bool = 0 as libc::c_int != 0;
    let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut numeric_opt: libc::c_int = 0 as libc::c_int;
    ...
    string_min = 4 as libc::c_int;
    include_all_whitespace = 0 as libc::c_int != 0;
    print_addresses = 0 as libc::c_int != 0;
    print_filenames = 0 as libc::c_int != 0;
    datasection_only = 0 as libc::c_int != 0;
    target = 0 as *mut libc::c_char;
    encoding = 's' as i32 as libc::c_char;
    output_separator = 0 as *mut libc::c_char;
    loop {
        optc = getopt_long(
            argc,
            argv,
            b"adfhHn:wot:e:T:s:Vv0123456789\0" as *const u8 as *const libc::c_char,
        ...
        match optc {
            ...
            100 => {
                datasection_only = 1 as libc::c_int != 0;
            }
            102 => {
                print_filenames = 1 as libc::c_int != 0;
            }
            72 | 104 => {
                usage(stdout, 0 as libc::c_int);
            }
            110 => {
                string_min = strtoul(optarg, &mut s, 0 as libc::c_int) as libc::c_int;
                if !s.is_null() && *s as libc::c_int != 0 as libc::c_int {
                    fatal(
                        dcgettext(
                            0 as *const libc::c_char,
                            b"invalid integer argument %s\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        optarg,
            ...
            119 => {
                include_all_whitespace = 1 as libc::c_int != 0;
            }
            111 => {
                print_addresses = 1 as libc::c_int != 0;
                address_radix = 8 as libc::c_int;
            }
            116 => {
                print_addresses = 1 as libc::c_int != 0;
                ...
                match *optarg.offset(0 as libc::c_int as isize) as libc::c_int {
                    ...
                    100 => {
                        address_radix = 10 as libc::c_int;
                    }
                    120 => {
                        address_radix = 16 as libc::c_int;
                    }
                    _ => {
                        usage(stderr, 1 as libc::c_int);
                    }
            ...
            101 => {
                ...
                encoding = *optarg.offset(0 as libc::c_int as isize);
            }
            115 => {
                output_separator = optarg;
            }
            86 | 118 => {
                print_version(b"strings\0" as *const u8 as *const libc::c_char);
            }
            63 => {
                usage(stderr, 1 as libc::c_int);
            }
    ...
    if numeric_opt != 0 as libc::c_int {
        string_min = strtoul(
            (*argv.offset((numeric_opt - 1 as libc::c_int) as isize))
        ...
        if !s.is_null() && *s as libc::c_int != 0 as libc::c_int {
            fatal(
                dcgettext(
                    0 as *const libc::c_char,
                    b"invalid integer argument %s\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                (*argv.offset((numeric_opt - 1 as libc::c_int) as isize))
                    .offset(1 as libc::c_int as isize),
    ...
    if string_min < 1 as libc::c_int {
        fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"invalid minimum string length %d\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            string_min,
    ...
    match encoding as libc::c_int {
        83 | 115 => {
            encoding_bytes = 1 as libc::c_int;
        }
        98 | 108 => {
            encoding_bytes = 2 as libc::c_int;
        }
        66 | 76 => {
            encoding_bytes = 4 as libc::c_int;
        }
        _ => {
            usage(stderr, 1 as libc::c_int);
        }
    ...
    if optind >= argc {
        ...
        while optind < argc {
            ...
            ) == 0 as libc::c_int
            {
                ...
                files_given = 1 as libc::c_int != 0;
                exit_status
                    |= !strings_file(*argv.offset(optind as isize)) as libc::c_int;
            }
            optind += 1;
            optind;
        }
...
unsafe extern "C" fn strings_a_section(
    ...
    if sectsize == 0 as libc::c_int as libc::c_ulong {
        return;
    }
    if !bfd_malloc_and_get_section(abfd, sect, &mut mem) {
        non_fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"%s: Reading section %s failed: %s\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            filename,
    ...
    *got_a_section = 1 as libc::c_int != 0;
    print_strings(
        filename,
        0 as *mut FILE,
        (*sect).filepos,
        0 as libc::c_int,
        sectsize as libc::c_int,
        mem as *mut libc::c_char,
    );
    free(mem as *mut libc::c_void);
}
unsafe extern "C" fn strings_object_file(mut file: *const libc::c_char) -> bool {
    ...
    got_a_section = 0 as libc::c_int != 0;
    s = (*abfd).sections;
    while !s.is_null() {
        strings_a_section(abfd, s, file, &mut got_a_section);
        s = (*s).next;
    }
    if !bfd_close(abfd) {
        bfd_nonfatal(file);
...
unsafe extern "C" fn get_char(
    ...
    mut magiccount: *mut libc::c_int,
    mut magic: *mut *mut libc::c_char,
) -> libc::c_long {
    let mut c: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    let mut r: libc::c_long = 0 as libc::c_int as libc::c_long;
    i = 0 as libc::c_int;
    ...
    match encoding as libc::c_int {
        108 => {
            r = (r & 0xff as libc::c_int as libc::c_long) << 8 as libc::c_int
                | (r & 0xff00 as libc::c_int as libc::c_long) >> 8 as libc::c_int;
        }
        76 => {
            r = (r & 0xff as libc::c_int as libc::c_long) << 24 as libc::c_int
                | (r & 0xff00 as libc::c_int as libc::c_long) << 8 as libc::c_int
                | (r & 0xff0000 as libc::c_int as libc::c_long) >> 8 as libc::c_int
                | (r & 0xff000000 as libc::c_uint as libc::c_long) >> 24 as libc::c_int;
        }
        _ => {}
    }
    return r;
...
unsafe extern "C" fn unget_part_char(
    ...
    static mut tmp: [libc::c_char; 4] = [0; 4];
    if encoding_bytes > 1 as libc::c_int {
        *address -= (encoding_bytes - 1 as libc::c_int) as libc::c_long;
        if *magiccount == 0 as libc::c_int {
            match encoding as libc::c_int {
                98 => {
                    tmp[0 as libc::c_int
                        as usize] = (c & 0xff as libc::c_int as libc::c_long)
                        as libc::c_char;
                    *magiccount = 1 as libc::c_int;
                }
                108 => {
                    tmp[0 as libc::c_int
                        as usize] = (c >> 8 as libc::c_int
                        & 0xff as libc::c_int as libc::c_long) as libc::c_char;
                    *magiccount = 1 as libc::c_int;
                }
                66 => {
                    tmp[0 as libc::c_int
                        as usize] = (c >> 16 as libc::c_int
                        & 0xff as libc::c_int as libc::c_long) as libc::c_char;
                    tmp[1 as libc::c_int
                        as usize] = (c >> 8 as libc::c_int
                        & 0xff as libc::c_int as libc::c_long) as libc::c_char;
                ...
                76 => {
                    ...
                    tmp[1 as libc::c_int
                        ...
                        & 0xff as libc::c_int as libc::c_long) as libc::c_char;
                    tmp[2 as libc::c_int
                        as usize] = (c >> 24 as libc::c_int
                        & 0xff as libc::c_int as libc::c_long) as libc::c_char;
                    *magiccount = 3 as libc::c_int;
                }
                _ => {}
            }
            *magic = tmp.as_mut_ptr();
        } else {
            *magic = (*magic).offset(-((encoding_bytes - 1 as libc::c_int) as isize));
            *magiccount += encoding_bytes - 1 as libc::c_int;
        }
    }
}
pub fn main() {
