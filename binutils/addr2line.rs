...
static mut with_addresses: bool = false;
static mut with_functions: bool = false;
static mut do_demangle: bool = false;
static mut pretty_print: bool = false;
static mut base_names: bool = false;
static mut demangle_flags: libc::c_int = (1 as libc::c_int) << 0 as libc::c_int
    | (1 as libc::c_int) << 1 as libc::c_int;
static mut naddr: libc::c_int = 0;
static mut addr: *mut *mut libc::c_char = 0 as *const *mut libc::c_char
    as *mut *mut libc::c_char;
static mut syms: *mut *mut asymbol = 0 as *const *mut asymbol as *mut *mut asymbol;
static mut long_options: [option; 16] = [
    {
        let mut init = option {
            name: b"addresses\0" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = option {
            name: b"basenames\0" as *const u8 as *const libc::c_char,
            has_arg: 0 as libc::c_int,
            flag: 0 as *const libc::c_int as *mut libc::c_int,
            val: 's' as i32,
        };
    ...
    {
        let mut init = option {
            name: b"exe\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn usage(mut stream: *mut FILE, mut status: libc::c_int) {
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b" Convert addresses into line number/file name pairs.\n\0" as *const u8
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b" If no addresses are specified on the command line, they will be read from stdin\n\0"
...
unsafe extern "C" fn slurp_symtab(mut abfd: *mut bfd) {
    let mut storage: libc::c_long = 0;
    let mut symcount: libc::c_long = 0;
    let mut dynamic: bool = 0 as libc::c_int != 0;
    if bfd_get_file_flags(abfd) & 0x10 as libc::c_int as libc::c_uint
    ...
    if symcount == 0 as libc::c_int as libc::c_long && !dynamic
        && {
            storage = (Some(
                ((*(*abfd).xvec)._bfd_get_dynamic_symtab_upper_bound)
                    .expect("non-null function pointer"),
                ...
                .expect("non-null function pointer")(abfd);
            storage > 0 as libc::c_int as libc::c_long
        }
    {
...
unsafe extern "C" fn find_offset_in_section(
    mut abfd: *mut bfd,
    mut section: *mut asection,
) {
    let mut size: bfd_size_type = 0;
...
unsafe extern "C" fn translate_addresses(
    ...
    let mut read_stdin: libc::c_int = (naddr == 0 as libc::c_int) as libc::c_int;
    loop {
        if read_stdin != 0 {
            let mut addr_hex: [libc::c_char; 100] = [0; 100];
            if (fgets(
                addr_hex.as_mut_ptr(),
            ...
            let fresh0 = addr;
            addr = addr.offset(1);
            pc = bfd_scan_vma(*fresh0, 0 as *mut *const libc::c_char, 16 as libc::c_int);
        }
            ...
            == bfd_target_elf_flavour as libc::c_int as libc::c_uint
        {
            ...
            let mut sign: bfd_vma = (1 as libc::c_int as bfd_vma)
                << (*(*bed).s).arch_size as libc::c_int - 1 as libc::c_int;
            pc
                &= (sign << 1 as libc::c_int)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong);
            if (*bed).sign_extend_vma() != 0 {
                pc = (pc ^ sign).wrapping_sub(sign);
            }
        }
        if with_addresses {
            printf(b"0x\0" as *const u8 as *const libc::c_char);
            bfd_fprintf_vma(abfd, stdout as *mut libc::c_void, pc);
            if pretty_print {
        ...
        if !found {
            ...
            loop {
                ...
                if base_names as libc::c_int != 0 && !filename.is_null() {
                    let mut h: *mut libc::c_char = 0 as *mut libc::c_char;
                    h = strrchr(filename, '/' as i32);
                    if !h.is_null() {
                        filename = h.offset(1 as libc::c_int as isize);
                    }
                }
                printf(
                ...
                if !unwind_inlines {
                    ...
                    found = (Some(
                        ...
                        .expect(
                            "non-null function pointer",
                        )(abfd, &mut filename, &mut functionname, &mut line);
                }
                if !found {
                    break;
                }
                if pretty_print {
                    printf(
                        dcgettext(
                            0 as *const libc::c_char,
                            b" (inlined by) \0" as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                    );
                }
...
static mut discriminator: libc::c_uint = 0;
...
unsafe extern "C" fn process_file(
    ...
    if get_file_size(file_name) < 1 as libc::c_int as libc::c_long {
    ...
    if bfd_check_format(abfd, bfd_archive) {
        fatal(
            dcgettext(
                0 as *const libc::c_char,
                b"%s: cannot get addresses from archive\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            file_name,
    ...
    if !section_name.is_null() {
        ...
        if section.is_null() {
            fatal(
                dcgettext(
                    0 as *const libc::c_char,
                    b"%s: cannot find section %s\0" as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                file_name,
                section_name,
...
unsafe fn main_0(
    ...
    loop {
        c = getopt_long(
            argc,
            argv,
            b"ab:Ce:rRsfHhij:pVv\0" as *const u8 as *const libc::c_char,
        ...
        match c {
            0 => {}
            97 => {
                with_addresses = 1 as libc::c_int != 0;
            }
            98 => {
                target = optarg;
            }
            ...
            115 => {
                base_names = 1 as libc::c_int != 0;
            }
            102 => {
                with_functions = 1 as libc::c_int != 0;
            }
            112 => {
                pretty_print = 1 as libc::c_int != 0;
            }
            118 | 86 => {
                print_version(b"addr2line\0" as *const u8 as *const libc::c_char);
            }
            104 | 72 => {
    ...
    if file_name.is_null() {
        file_name = b"a.out\0" as *const u8 as *const libc::c_char;
    }
    addr = argv.offset(optind as isize);
    naddr = argc - optind;
