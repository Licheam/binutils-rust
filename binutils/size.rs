...
extern "C" {
    ...
    fn bfd_core_file_failing_command(abfd: *mut bfd) -> *const libc::c_char;
...
pub const hex: C2RustUnnamed_5 = 2;
pub const octal: C2RustUnnamed_5 = 1;
pub const decimal: C2RustUnnamed_5 = 0;
pub type output_format = libc::c_uint;
pub const FORMAT_GNU: output_format = 2;
pub const FORMAT_SYSV: output_format = 1;
pub const FORMAT_BERKLEY: output_format = 0;
#[inline]
...
static mut radix: C2RustUnnamed_5 = decimal;
static mut selected_output_format: output_format = FORMAT_BERKLEY;
static mut show_version: libc::c_int = 0 as libc::c_int;
static mut show_help: libc::c_int = 0 as libc::c_int;
static mut show_totals: libc::c_int = 0 as libc::c_int;
static mut show_common: libc::c_int = 0 as libc::c_int;
static mut common_size: bfd_size_type = 0;
static mut total_bsssize: bfd_size_type = 0;
static mut total_datasize: bfd_size_type = 0;
static mut total_textsize: bfd_size_type = 0;
static mut return_code: libc::c_int = 0 as libc::c_int;
static mut target: *mut libc::c_char = 0 as *const libc::c_char as *mut libc::c_char;
unsafe extern "C" fn display_file(mut filename: *mut libc::c_char) {
...
unsafe extern "C" fn rprint_number(mut width: libc::c_int, mut num: bfd_size_type) {
    let mut buffer: [libc::c_char; 40] = [0; 40];
    sprintf(
        buffer.as_mut_ptr(),
        if radix as libc::c_uint == decimal as libc::c_int as libc::c_uint {
            b"%lu\0" as *const u8 as *const libc::c_char
        } else if radix as libc::c_uint == octal as libc::c_int as libc::c_uint {
    ...
    printf(b"%*s\0" as *const u8 as *const libc::c_char, width, buffer.as_mut_ptr());
}
unsafe extern "C" fn print_sizes(mut file: *mut bfd) {
    if show_common != 0 {
        calculate_common_size(file);
    }
    if selected_output_format as libc::c_uint
        == FORMAT_SYSV as libc::c_int as libc::c_uint
    {
...
unsafe extern "C" fn usage(mut stream: *mut FILE, mut status: libc::c_int) {
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b" Displays the sizes of sections inside binary files\n\0" as *const u8
    ...
    fprintf(
        ...
        dcgettext(
            0 as *const libc::c_char,
            b" If no input file(s) are specified, a.out is assumed\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    fprintf(
        ...
        b"berkeley\0" as *const u8 as *const libc::c_char,
    );
    ...
    [
        {
            let mut init = option {
                ...
                flag: &show_common as *const libc::c_int as *mut libc::c_int,
                val: 1 as libc::c_int,
            };
            init
        },
        ...
        },
        {
            let mut init = option {
                ...
                has_arg: 1 as libc::c_int,
                flag: 0 as *const libc::c_int as *mut libc::c_int,
                val: 200 as libc::c_int + 1 as libc::c_int,
            };
            init
        },
        {
            let mut init = option {
                ...
                has_arg: 1 as libc::c_int,
                flag: 0 as *const libc::c_int as *mut libc::c_int,
                val: 200 as libc::c_int + 1 as libc::c_int + 1 as libc::c_int,
            };
            init
        },
        {
            let mut init = option {
                ...
                has_arg: 0 as libc::c_int,
                flag: &show_totals as *const libc::c_int as *mut libc::c_int,
                val: 1 as libc::c_int,
            };
            init
        },
...
unsafe fn main_0(
    ...
    loop {
        c = getopt_long(
            argc,
            argv,
            b"ABGHhVvdfotx\0" as *const u8 as *const libc::c_char,
        ...
        match c {
                ...
                match *optarg as libc::c_int {
                    ...
                    _ => {
                        non_fatal(
                            dcgettext(
                                0 as *const libc::c_char,
                                b"invalid argument to --format: %s\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            optarg,
            ...
            201 => {
                temp = atol(optarg) as libc::c_int;
                match temp {
                    10 => {
                        radix = decimal;
                    }
    ...
    if show_version != 0 {
        print_version(b"size\0" as *const u8 as *const libc::c_char);
    }
    if show_help != 0 {
    ...
    if optind == argc {
        ...
        while optind < argc {
            let fresh0 = optind;
            optind = optind + 1;
            display_file(*argv.offset(fresh0 as isize));
        }
    }
    if show_totals != 0
        && (selected_output_format as libc::c_uint
            == FORMAT_BERKLEY as libc::c_int as libc::c_uint
            || selected_output_format as libc::c_uint
                == FORMAT_GNU as libc::c_int as libc::c_uint)
    {
        let mut total: bfd_size_type = total_textsize
            .wrapping_add(total_datasize)
            .wrapping_add(total_bsssize);
        let mut col_width: libc::c_int = if selected_output_format as libc::c_uint
            == FORMAT_BERKLEY as libc::c_int as libc::c_uint
        {
            7 as libc::c_int
        } else {
        ...
        let mut sep_char: libc::c_char = (if selected_output_format as libc::c_uint
            == FORMAT_BERKLEY as libc::c_int as libc::c_uint
        {
            '\t' as i32
        } else {
        ...
        putchar(sep_char as libc::c_int);
        ...
        {
            printf(
                if radix as libc::c_uint == octal as libc::c_int as libc::c_uint {
                    b"%7lo\t%7lx\0" as *const u8 as *const libc::c_char
                } else {
                    b"%7lu\t%7lx\0" as *const u8 as *const libc::c_char
                },
                total,
                total,
            );
...
unsafe extern "C" fn calculate_common_size(mut abfd: *mut bfd) {
    let mut syms: *mut *mut asymbol = 0 as *mut *mut asymbol;
    let mut storage: libc::c_long = 0;
    let mut symcount: libc::c_long = 0;
    common_size = 0 as libc::c_int as bfd_size_type;
    if bfd_get_file_flags(abfd)
        & (0x2 as libc::c_int | 0x40 as libc::c_int | 0x10 as libc::c_int)
            as libc::c_uint != 0x10 as libc::c_int as libc::c_uint
    {
        return;
    }
    storage = (Some(
    ...
    if storage != 0 {
        syms = xmalloc(storage as size_t) as *mut *mut asymbol;
    }
    symcount = (Some(
    ...
    loop {
        ...
        let mut sym: *mut asymbol = *syms.offset(symcount as isize);
        if bfd_is_com_section((*sym).section) as libc::c_int != 0
            && (*sym).flags & ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_uint
                == 0 as libc::c_int as libc::c_uint
        {
            common_size = (common_size as libc::c_ulong).wrapping_add((*sym).value)
                as bfd_size_type as bfd_size_type;
        }
    }
    free(syms as *mut libc::c_void);
}
unsafe extern "C" fn display_bfd(mut abfd: *mut bfd) {
        ...
        == bfd_error_file_ambiguously_recognized as libc::c_int as libc::c_uint
    {
        ...
        return_code = 3 as libc::c_int;
        return;
    }
    if bfd_check_format_matches(abfd, bfd_core, &mut matching) {
        let mut core_cmd: *const libc::c_char = 0 as *const libc::c_char;
        print_sizes(abfd);
        fputs(b" (core file\0" as *const u8 as *const libc::c_char, stdout);
        core_cmd = bfd_core_file_failing_command(abfd);
        if !core_cmd.is_null() {
            printf(b" invoked as %s\0" as *const u8 as *const libc::c_char, core_cmd);
        }
        puts(b")\n\0" as *const u8 as *const libc::c_char);
        return;
    }
...
unsafe extern "C" fn display_archive(mut file: *mut bfd) {
    let mut arfile: *mut bfd = 0 as *mut libc::c_void as *mut bfd;
    let mut last_arfile: *mut bfd = 0 as *mut libc::c_void as *mut bfd;
    loop {
...
unsafe extern "C" fn size_number(mut num: bfd_size_type) -> libc::c_int {
    let mut buffer: [libc::c_char; 40] = [0; 40];
    sprintf(
        buffer.as_mut_ptr(),
        if radix as libc::c_uint == decimal as libc::c_int as libc::c_uint {
    ...
    return strlen(buffer.as_mut_ptr()) as libc::c_int;
}
static mut bsssize: bfd_size_type = 0;
...
unsafe extern "C" fn berkeley_or_gnu_sum(
    ...
    flags = bfd_section_flags(sec as *const asection);
    if flags & 0x1 as libc::c_int as libc::c_uint == 0 as libc::c_int as libc::c_uint {
        return;
    }
    size = bfd_section_size(sec as *const asection);
    if flags & 0x10 as libc::c_int as libc::c_uint != 0 as libc::c_int as libc::c_uint
        || selected_output_format as libc::c_uint
            == FORMAT_BERKLEY as libc::c_int as libc::c_uint
            && flags & 0x8 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
    {
        textsize = (textsize as libc::c_ulong).wrapping_add(size) as bfd_size_type
            as bfd_size_type;
    } else if flags & 0x100 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        datasize = (datasize as libc::c_ulong).wrapping_add(size) as bfd_size_type
            as bfd_size_type;
    } else {
        bsssize = (bsssize as libc::c_ulong).wrapping_add(size) as bfd_size_type
            as bfd_size_type;
    };
}
unsafe extern "C" fn print_berkeley_or_gnu_format(mut abfd: *mut bfd) {
    static mut files_seen: libc::c_int = 0 as libc::c_int;
    let mut total: bfd_size_type = 0;
    let mut col_width: libc::c_int = if selected_output_format as libc::c_uint
        == FORMAT_BERKLEY as libc::c_int as libc::c_uint
    {
        7 as libc::c_int
    ...
    bsssize = 0 as libc::c_int as bfd_size_type;
    datasize = 0 as libc::c_int as bfd_size_type;
    textsize = 0 as libc::c_int as bfd_size_type;
    bfd_map_over_sections(
        abfd,
        Some(
            berkeley_or_gnu_sum
                as unsafe extern "C" fn(*mut bfd, sec_ptr, *mut libc::c_void) -> (),
        ),
        0 as *mut libc::c_void,
    );
    bsssize = (bsssize as libc::c_ulong).wrapping_add(common_size) as bfd_size_type
        as bfd_size_type;
    let fresh1 = files_seen;
    ...
    if fresh1 == 0 as libc::c_int {
            ...
            == FORMAT_BERKLEY as libc::c_int as libc::c_uint
        {
            puts(
                if radix as libc::c_uint == octal as libc::c_int as libc::c_uint {
                    b"   text\t   data\t    bss\t    oct\t    hex\tfilename\0"
                        as *const u8 as *const libc::c_char
                } else {
                    b"   text\t   data\t    bss\t    dec\t    hex\tfilename\0"
                        as *const u8 as *const libc::c_char
                },
            );
        } else {
            puts(
                b"      text       data        bss      total filename\0" as *const u8
                    as *const libc::c_char,
            );
        }
    }
    total = textsize.wrapping_add(datasize).wrapping_add(bsssize);
    if show_totals != 0 {
        total_textsize = (total_textsize as libc::c_ulong).wrapping_add(textsize)
            as bfd_size_type as bfd_size_type;
        total_datasize = (total_datasize as libc::c_ulong).wrapping_add(datasize)
            as bfd_size_type as bfd_size_type;
        total_bsssize = (total_bsssize as libc::c_ulong).wrapping_add(bsssize)
            as bfd_size_type as bfd_size_type;
    }
    ...
    if !((*abfd).my_archive).is_null() {
        printf(
            b" (ex %s)\0" as *const u8 as *const libc::c_char,
            bfd_get_filename((*abfd).my_archive),
        );
    }
}
#[no_mangle]
pub static mut svi_total: bfd_size_type = 0 as libc::c_int as bfd_size_type;
#[no_mangle]
pub static mut svi_maxvma: bfd_vma = 0 as libc::c_int as bfd_vma;
#[no_mangle]
pub static mut svi_namelen: libc::c_int = 0 as libc::c_int;
#[no_mangle]
pub static mut svi_vmalen: libc::c_int = 0 as libc::c_int;
#[no_mangle]
...
unsafe extern "C" fn sysv_internal_sizer(
    ...
    if !bfd_is_abs_section(sec as *const asection)
        && !bfd_is_com_section(sec as *const asection)
        && !bfd_is_und_section(sec as *const asection)
    {
        let mut size: bfd_size_type = bfd_section_size(sec as *const asection);
        let mut namelen: libc::c_int = strlen(bfd_section_name(sec as *const asection))
            as libc::c_int;
        if namelen > svi_namelen {
            svi_namelen = namelen;
        }
        svi_total = (svi_total as libc::c_ulong).wrapping_add(size) as bfd_size_type
            as bfd_size_type;
        if bfd_section_vma(sec as *const asection) > svi_maxvma {
            svi_maxvma = bfd_section_vma(sec as *const asection);
        }
    }
}
unsafe extern "C" fn sysv_one_line(
    mut name: *const libc::c_char,
    mut size: bfd_size_type,
    mut vma: bfd_vma,
) {
    printf(b"%-*s   \0" as *const u8 as *const libc::c_char, svi_namelen, name);
...
unsafe extern "C" fn sysv_internal_printer(
        ...
        && !bfd_is_und_section(sec as *const asection)
    {
        ...
        svi_total = (svi_total as libc::c_ulong).wrapping_add(size) as bfd_size_type
            as bfd_size_type;
        sysv_one_line(
            bfd_section_name(sec as *const asection),
            size,
            bfd_section_vma(sec as *const asection),
        );
    }
}
unsafe extern "C" fn print_sysv_format(mut file: *mut bfd) {
    svi_total = 0 as libc::c_int as bfd_size_type;
    svi_maxvma = 0 as libc::c_int as bfd_vma;
    svi_namelen = 0 as libc::c_int;
    bfd_map_over_sections(
        file,
        Some(
            sysv_internal_sizer
    ...
    if show_common != 0 {
        if svi_namelen
            < ::core::mem::size_of::<[libc::c_char; 6]>() as libc::c_ulong as libc::c_int
                - 1 as libc::c_int
        {
            svi_namelen = (::core::mem::size_of::<[libc::c_char; 6]>() as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int;
        }
        svi_total = (svi_total as libc::c_ulong).wrapping_add(common_size)
            as bfd_size_type as bfd_size_type;
    }
    svi_vmalen = size_number(svi_maxvma);
    if (svi_vmalen as size_t)
        < (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
    {
        svi_vmalen = (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int;
    }
    svi_sizelen = size_number(svi_total);
    if (svi_sizelen as size_t)
        < (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
    {
        svi_sizelen = (::core::mem::size_of::<[libc::c_char; 5]>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong) as libc::c_int;
    }
    svi_total = 0 as libc::c_int as bfd_size_type;
    printf(b"%s  \0" as *const u8 as *const libc::c_char, bfd_get_filename(file));
    if !((*file).my_archive).is_null() {
        printf(
            b" (ex %s)\0" as *const u8 as *const libc::c_char,
            bfd_get_filename((*file).my_archive),
        );
    }
    printf(
        b":\n%-*s   %*s   %*s\n\0" as *const u8 as *const libc::c_char,
