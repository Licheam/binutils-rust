...
#[no_mangle]
pub static mut _bfd_elf32_size_info: elf_size_info = unsafe {
    {
        let mut init = elf_size_info {
            sizeof_ehdr: ::core::mem::size_of::<Elf32_External_Ehdr>() as libc::c_ulong
                as libc::c_uchar,
            sizeof_phdr: ::core::mem::size_of::<Elf32_External_Phdr>() as libc::c_ulong
                as libc::c_uchar,
            sizeof_shdr: ::core::mem::size_of::<Elf32_External_Shdr>() as libc::c_ulong
                as libc::c_uchar,
            sizeof_rel: ::core::mem::size_of::<Elf32_External_Rel>() as libc::c_ulong
                as libc::c_uchar,
            sizeof_rela: ::core::mem::size_of::<Elf32_External_Rela>() as libc::c_ulong
                as libc::c_uchar,
            sizeof_sym: ::core::mem::size_of::<Elf32_External_Sym>() as libc::c_ulong
                as libc::c_uchar,
            sizeof_dyn: ::core::mem::size_of::<Elf32_External_Dyn>() as libc::c_ulong
                as libc::c_uchar,
            ...
            arch_size: 32 as libc::c_int as libc::c_uchar,
            log_file_align: 2 as libc::c_int as libc::c_uchar,
            elfclass: 1 as libc::c_int as libc::c_uchar,
            ...
            write_shdrs_and_ehdr: Some(
                bfd_elf32_write_shdrs_and_ehdr as unsafe extern "C" fn(*mut bfd) -> bool,
            ),
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut current_block: u64;
    let mut x_ehdr: Elf32_External_Ehdr = Elf32_External_Ehdr {
        e_ident: [0; 16],
        e_type: [0; 2],
        e_machine: [0; 2],
        e_version: [0; 4],
    ...
    let mut x_shdr: Elf32_External_Shdr = Elf32_External_Shdr {
        sh_name: [0; 4],
        sh_type: [0; 4],
        sh_flags: [0; 4],
        sh_addr: [0; 4],
    ...
    if bfd_bread(
        &mut x_ehdr as *mut Elf32_External_Ehdr as *mut libc::c_void,
    ...
    ) != ::core::mem::size_of::<Elf32_External_Ehdr>() as libc::c_ulong
    {
        ...
        {
            current_block = 889041205731758577;
        } else {
            current_block = 14111107354313396392;
        }
    } else if !elf_file_p(&mut x_ehdr)
        || x_ehdr.e_ident[6 as libc::c_int as usize] as libc::c_int != 1 as libc::c_int
        || x_ehdr.e_ident[4 as libc::c_int as usize] as libc::c_int != 1 as libc::c_int
    {
        current_block = 889041205731758577;
    } else {
        match x_ehdr.e_ident[5 as libc::c_int as usize] as libc::c_int {
            2 => {
                current_block = 8523962292470516494;
                match current_block {
                    4117946787504750285 => {
                    ...
                    _ => {
                            ...
                            .expect("non-null function pointer")(abfd)
                        {
                                ...
                                && (*i_ehdrp).e_shnum != 0 as libc::c_int as libc::c_uint
                            {
                                ...
                                if (*(*ebd).s).arch_size as libc::c_int != 32 as libc::c_int
                                {
                                    current_block = 889041205731758577;
                                                ...
                                                && (*ebd).elf_osabi != 0 as libc::c_int
                                            {
                                                        ...
                                                        as libc::c_ulong
                                                {
                                                        ...
                                                        != 0 as libc::c_int
                                                    {
                                                        ...
                                                        &mut x_shdr as *mut Elf32_External_Shdr
                                                            as *mut libc::c_void,
                                                        ::core::mem::size_of::<Elf32_External_Shdr>()
                                                            as libc::c_ulong,
                                                        abfd,
                                                                ...
                                                                if (*i_ehdrp).e_phnum == 0 as libc::c_int as libc::c_uint {
                                                                    ...
                                                                    if filesize != 0 as libc::c_int as libc::c_ulong
                                                                        && (*i_ehdrp).e_phnum as libc::c_ulong
                                                                            > filesize
                                                                                .wrapping_div(
                                                                                    ::core::mem::size_of::<Elf32_External_Phdr>()
                                                                                        as libc::c_ulong,
                                                                                )
                                                                    {
                                                                        current_block = 889041205731758577;
                                                                                ...
                                                                                ) != (*i_ehdrp).e_phnum as libc::c_ulong
                                                                        {
                                                                            ...
                                                                            ) != 0 as libc::c_int
                                                                            {
                                                                                ...
                                                                                loop {
                                                                                    ...
                                                                                    let mut x_phdr: Elf32_External_Phdr = Elf32_External_Phdr {
                                                                                        p_type: [0; 4],
                                                                                        p_offset: [0; 4],
                                                                                        p_vaddr: [0; 4],
                                                                                        p_paddr: [0; 4],
                                                                                    ...
                                                                                    if bfd_bread(
                                                                                        &mut x_phdr as *mut Elf32_External_Phdr
                                                                                            as *mut libc::c_void,
                                                                                        ::core::mem::size_of::<Elf32_External_Phdr>()
                                                                                            as libc::c_ulong,
                                                                                        abfd,
                                                                                    ...
                                                                                    bfd_elf32_swap_phdr_in(abfd, &mut x_phdr, i_phdr);
                                                                                    if (*i_phdr).p_align
            ...
            1 => {
                current_block = 4117946787504750285;
                match current_block {
                    4117946787504750285 => {
                        if !bfd_header_little_endian(abfd) {
                            current_block = 889041205731758577;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_phdr_in(
    mut abfd: *mut bfd,
    mut src: *const Elf32_External_Phdr,
...
unsafe extern "C" fn elf_swap_shdr_in(
    mut abfd: *mut bfd,
    mut src: *const Elf32_External_Shdr,
...
unsafe extern "C" fn elf_swap_ehdr_in(
    mut abfd: *mut bfd,
    mut src: *const Elf32_External_Ehdr,
...
#[inline]
unsafe extern "C" fn elf_file_p(mut x_ehdrp: *mut Elf32_External_Ehdr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_core_file_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut current_block: u64;
    let mut x_ehdr: Elf32_External_Ehdr = Elf32_External_Ehdr {
        e_ident: [0; 16],
        e_type: [0; 2],
    ...
    ) != ::core::mem::size_of::<Elf32_External_Ehdr>() as libc::c_ulong
    {
        if bfd_get_error() as libc::c_uint
            != bfd_error_system_call as libc::c_int as libc::c_uint
        {
            current_block = 14660865908701317136;
        } else {
            current_block = 5445638664226550553;
        }
    } else if !elf_file_p(&mut x_ehdr) {
        current_block = 14660865908701317136;
        ...
        != 1 as libc::c_int
    {
        ...
        match x_ehdr.e_ident[5 as libc::c_int as usize] as libc::c_int {
            2 => {
                current_block = 18118495340503429063;
                match current_block {
                    12961653857168622400 => {
                                                        ...
                                                        ) != 0 as libc::c_int
                                                        {
                                                            ...
                                                            if i_phdrp.is_null() {
                                                                ...
                                                                loop {
                                                                    ...
                                                                    let mut x_phdr_0: Elf32_External_Phdr = Elf32_External_Phdr {
                                                                        p_type: [0; 4],
                                                                        p_offset: [0; 4],
                                                                        p_vaddr: [0; 4],
                                                                        p_paddr: [0; 4],
                                                                    ...
                                                                    if bfd_bread(
                                                                        &mut x_phdr_0 as *mut Elf32_External_Phdr
                                                                            as *mut libc::c_void,
                                                                        ::core::mem::size_of::<Elf32_External_Phdr>()
                                                                            as libc::c_ulong,
                                                                        abfd,
            ...
            1 => {
                current_block = 12961653857168622400;
                match current_block {
                    12961653857168622400 => {
                        if !bfd_little_endian(abfd) {
                            current_block = 14660865908701317136;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_core_file_failing_command(
    mut abfd: *mut bfd,
) -> *mut libc::c_char {
    return (*(*(*abfd).tdata.elf_obj_data).core).command;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_core_file_failing_signal(
    mut abfd: *mut bfd,
) -> libc::c_int {
    return (*(*(*abfd).tdata.elf_obj_data).core).signal;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_core_file_matches_executable_p(
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_core_file_pid(mut abfd: *mut bfd) -> libc::c_int {
    return (*(*(*abfd).tdata.elf_obj_data).core).pid;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf32_core_find_build_id(
    mut abfd: *mut bfd,
    mut offset: bfd_vma,
) -> bool {
    let mut current_block: u64;
    ...
    if !(bfd_seek(abfd, offset as file_ptr, 0 as libc::c_int) != 0 as libc::c_int) {
        ...
        ) != ::core::mem::size_of::<Elf32_External_Ehdr>() as libc::c_ulong
        {
            if bfd_get_error() as libc::c_uint
                != bfd_error_system_call as libc::c_int as libc::c_uint
            {
                current_block = 7236749888790516408;
            } else {
                current_block = 9942789566315647406;
            }
        } else if !elf_file_p(&mut x_ehdr)
                ...
                != 1 as libc::c_int
        {
            ...
            match x_ehdr.e_ident[5 as libc::c_int as usize] as libc::c_int {
                2 => {
                    current_block = 7383486463484743178;
                    match current_block {
                        3488827681473298960 => {
                            if !bfd_header_little_endian(abfd) {
                                current_block = 7236749888790516408;
                ...
                1 => {
                    current_block = 3488827681473298960;
                    match current_block {
                        3488827681473298960 => {
                            if !bfd_header_little_endian(abfd) {
                                current_block = 7236749888790516408;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_symbol_in(
    mut abfd: *mut bfd,
    mut psrc: *const libc::c_void,
    mut pshn: *const libc::c_void,
    mut dst: *mut Elf_Internal_Sym,
) -> bool {
    let mut src: *const Elf32_External_Sym = psrc as *const Elf32_External_Sym;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_symbol_out(
    mut abfd: *mut bfd,
    ...
    let mut dst: *mut Elf32_External_Sym = cdst as *mut Elf32_External_Sym;
        ...
        if shndx.is_null() {
            _bfd_abort(
                ...
                (*::core::mem::transmute::<
                    ...
                    &[libc::c_char; 80],
                >(
                    b"void bfd_elf32_swap_symbol_out(bfd *, const Elf_Internal_Sym *, void *, void *)\0",
                ))
                    .as_ptr(),
            );
        }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_reloc_in(
    mut abfd: *mut bfd,
    mut s: *const bfd_byte,
    mut dst: *mut Elf_Internal_Rela,
) {
    let mut src: *const Elf32_External_Rel = s as *const Elf32_External_Rel;
    (*dst)
        .r_offset = (Some(
        ((*(*abfd).xvec).bfd_h_getx32).expect("non-null function pointer"),
    ))
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_reloc_out(
    mut abfd: *mut bfd,
    mut src: *const Elf_Internal_Rela,
    mut d: *mut bfd_byte,
) {
    let mut dst: *mut Elf32_External_Rel = d as *mut Elf32_External_Rel;
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_reloca_in(
    mut abfd: *mut bfd,
    mut s: *const bfd_byte,
    mut dst: *mut Elf_Internal_Rela,
) {
    let mut src: *const Elf32_External_Rela = s as *const Elf32_External_Rela;
    (*dst)
        .r_offset = (Some(
        ((*(*abfd).xvec).bfd_h_getx32).expect("non-null function pointer"),
    ))
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_reloca_out(
    mut abfd: *mut bfd,
    mut src: *const Elf_Internal_Rela,
    mut d: *mut bfd_byte,
) {
    let mut dst: *mut Elf32_External_Rela = d as *mut Elf32_External_Rela;
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )((*src).r_offset, ((*dst).r_offset).as_mut_ptr() as *mut libc::c_void);
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_phdr_out(
    mut abfd: *mut bfd,
    mut src: *const Elf_Internal_Phdr,
    mut dst: *mut Elf32_External_Phdr,
) {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_dyn_in(
    mut abfd: *mut bfd,
    mut p: *const libc::c_void,
    mut dst: *mut Elf_Internal_Dyn,
) {
    let mut src: *const Elf32_External_Dyn = p as *const Elf32_External_Dyn;
    (*dst)
        .d_tag = (Some(
        ((*(*abfd).xvec).bfd_h_getx32).expect("non-null function pointer"),
    ))
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_swap_dyn_out(
    mut abfd: *mut bfd,
    mut src: *const Elf_Internal_Dyn,
    mut p: *mut libc::c_void,
) {
    let mut dst: *mut Elf32_External_Dyn = p as *mut Elf32_External_Dyn;
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_slurp_symbol_table(
    mut abfd: *mut bfd,
    ...
    symcount = ((*hdr).sh_size)
        .wrapping_div(::core::mem::size_of::<Elf32_External_Sym>() as libc::c_ulong);
    if symcount == 0 as libc::c_int as libc::c_ulong {
        ...
        {
            bfd_set_error(bfd_error_file_too_big);
            current_block = 4956404650980354465;
        } else {
                        ...
                        loop {
                            ...
                            match (*isym).st_info as libc::c_int & 0xf as libc::c_int {
                                ...
                                5 => {
                                    ...
                                    current_block_64 = 485150676298279155;
                                }
                                1 => {
                                    current_block_64 = 485150676298279155;
                                }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_write_shdrs_and_ehdr(mut abfd: *mut bfd) -> bool {
    let mut x_ehdr: Elf32_External_Ehdr = Elf32_External_Ehdr {
        e_ident: [0; 16],
        e_type: [0; 2],
        e_machine: [0; 2],
    ...
    let mut i_ehdrp: *mut Elf_Internal_Ehdr = 0 as *mut Elf_Internal_Ehdr;
    let mut x_shdrp: *mut Elf32_External_Shdr = 0 as *mut Elf32_External_Shdr;
    ...
    amt = ::core::mem::size_of::<Elf32_External_Ehdr>() as libc::c_ulong;
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bwrite(
            &mut x_ehdr as *mut Elf32_External_Ehdr as *const libc::c_void,
            amt,
            abfd,
        ) != amt
    {
    ...
    amt = (*i_ehdrp).e_shnum as size_t;
    amt = (amt as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<Elf32_External_Shdr>() as libc::c_ulong)
        as size_t as size_t;
    if ::core::mem::size_of::<Elf32_External_Shdr>() as libc::c_ulong
        != 0 as libc::c_int as libc::c_ulong
        && amt
            .wrapping_div(::core::mem::size_of::<Elf32_External_Shdr>() as libc::c_ulong)
            != (*i_ehdrp).e_shnum as libc::c_ulong
    {
        bfd_set_error(bfd_error_no_memory);
        return 0 as libc::c_int != 0;
    }
    x_shdrp = bfd_alloc(abfd, amt) as *mut Elf32_External_Shdr;
    if x_shdrp.is_null() {
        return 0 as libc::c_int != 0;
    }
...
unsafe extern "C" fn elf_swap_shdr_out(
    ...
    mut dst: *mut Elf32_External_Shdr,
) {
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
...
unsafe extern "C" fn elf_swap_ehdr_out(
    ...
    mut dst: *mut Elf32_External_Ehdr,
) {
    let mut tmp: libc::c_uint = 0;
    let mut signed_vma: libc::c_int = (*((*(*abfd).xvec).backend_data
        as *const elf_backend_data))
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_write_out_phdrs(
    mut abfd: *mut bfd,
    ...
    loop {
        ...
        let mut extphdr: Elf32_External_Phdr = Elf32_External_Phdr {
            p_type: [0; 4],
            p_offset: [0; 4],
            p_vaddr: [0; 4],
            p_paddr: [0; 4],
        ...
        bfd_elf32_swap_phdr_out(abfd, phdr, &mut extphdr);
        if bfd_bwrite(
            &mut extphdr as *mut Elf32_External_Phdr as *const libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_checksum_contents(
    mut abfd: *mut bfd,
    mut process: Option::<
    ...
    while count < num {
        ...
        bfd_elf32_swap_phdr_out(abfd, &mut *i_phdrp.offset(count as isize), &mut x_phdr);
        (Some(process.expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            &mut x_phdr as *mut Elf32_External_Phdr as *const libc::c_void,
            ::core::mem::size_of::<Elf32_External_Phdr>() as libc::c_ulong,
            arg,
        );
        count = count.wrapping_add(1);
    ...
    while count < num {
        ...
        (Some(process.expect("non-null function pointer")))
            ...
            &mut x_shdr as *mut Elf32_External_Shdr as *const libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_write_relocs(
    mut abfd: *mut bfd,
    ...
    if (*rela_hdr).sh_type == 4 as libc::c_int as libc::c_uint {
        ...
        extsize = ::core::mem::size_of::<Elf32_External_Rela>() as libc::c_ulong;
        ...
        extsize = ::core::mem::size_of::<Elf32_External_Rel>() as libc::c_ulong;
    } else {
        _bfd_abort(
            b"./elfcode.h\0" as *const u8 as *const libc::c_char,
            946 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 55],
                &[libc::c_char; 55],
            >(b"void bfd_elf32_write_relocs(bfd *, asection *, void *)\0"))
                .as_ptr(),
        );
    }
    ...
    while idx < (*sec).reloc_count {
        ...
        src_rela
            .r_info = ((n as libc::c_uint) << 8 as libc::c_int)
            .wrapping_add((*(*ptr).howto).type_0 & 0xff as libc::c_int as libc::c_uint)
            as bfd_vma;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf32_slurp_reloc_table(
    mut abfd: *mut bfd,
...
unsafe extern "C" fn elf_slurp_reloc_table_from_section(
    ...
    loop {
        ...
        if entsize as libc::c_ulong
            == ::core::mem::size_of::<Elf32_External_Rela>() as libc::c_ulong
        {
            bfd_elf32_swap_reloca_in(abfd, native_relocs, &mut rela);
        } else {
            bfd_elf32_swap_reloc_in(abfd, native_relocs, &mut rela);
        }
        if (*abfd).flags & (0x2 as libc::c_int | 0x40 as libc::c_int) as libc::c_uint
        ...
        if rela.r_info >> 8 as libc::c_int == 0 as libc::c_int as libc::c_ulong {
            (*relent)
                .sym_ptr_ptr = _bfd_std_section[2 as libc::c_int as usize]
                .symbol_ptr_ptr;
        } else if rela.r_info >> 8 as libc::c_int > symcount as libc::c_ulong {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                ...
                asect,
                i,
                (rela.r_info >> 8 as libc::c_int) as libc::c_long,
            );
            ...
            ps = symbols
                .offset((rela.r_info >> 8 as libc::c_int) as isize)
        ...
        if !res || ((*relent).howto).is_null() {
            current_block = 13327001151263588442;
            break;
        }
        i = i.wrapping_add(1);
        i;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf32_bfd_from_remote_memory(
    mut templ: *mut bfd,
    ...
    let mut x_phdrs: *mut Elf32_External_Phdr = 0 as *mut Elf32_External_Phdr;
    ...
    err = target_read_memory
        ...
        ehdr_vma,
        &mut x_ehdr as *mut Elf32_External_Ehdr as *mut bfd_byte,
        ::core::mem::size_of::<Elf32_External_Ehdr>() as libc::c_ulong,
    );
    if err != 0 {
        bfd_set_error(bfd_error_system_call);
    ...
    if (::core::mem::size_of::<Elf32_External_Phdr>() as libc::c_ulong)
    ...
    x_phdrs = bfd_malloc(amt) as *mut Elf32_External_Phdr;
    if x_phdrs.is_null() {
        return 0 as *mut bfd;
    }
    err = target_read_memory
        ...
        (i_ehdr.e_phnum as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<Elf32_External_Phdr>() as libc::c_ulong),
    );
    if err != 0 {
    ...
    i_phdrs = &mut *x_phdrs.offset(i_ehdr.e_phnum as isize) as *mut Elf32_External_Phdr
        as *mut Elf_Internal_Phdr;
    ...
    if high_offset < shdr_end {
        memset(
            &mut x_ehdr.e_shoff as *mut [libc::c_uchar; 4] as *mut libc::c_void,
            0 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn elf32_r_info(mut sym: bfd_vma, mut type_0: bfd_vma) -> bfd_vma {
    return (((sym as libc::c_uint) << 8 as libc::c_int) as libc::c_ulong)
        .wrapping_add(type_0 & 0xff as libc::c_int as libc::c_ulong);
}
#[no_mangle]
pub unsafe extern "C" fn elf32_r_sym(mut r_info: bfd_vma) -> bfd_vma {
    return r_info >> 8 as libc::c_int;
}
