...
unsafe extern "C" fn elf32_generic_link_add_symbols(
    mut abfd: *mut bfd,
...
static mut elf32_bed: elf_backend_data = elf_backend_data {
...
#[no_mangle]
pub static mut elf32_be_vec: bfd_target = bfd_target {
    name: 0 as *const libc::c_char,
...
#[no_mangle]
pub static mut elf32_le_vec: bfd_target = bfd_target {
    name: 0 as *const libc::c_char,
    flavour: bfd_target_unknown_flavour,
    byteorder: BFD_ENDIAN_BIG,
    header_byteorder: BFD_ENDIAN_BIG,
...
unsafe extern "C" fn run_static_initializers() {
    ...
    elf32_be_vec = {
        let mut init = bfd_target {
            name: b"elf32-big\0" as *const u8 as *const libc::c_char,
            ...
            alternative_target: &elf32_le_vec,
            backend_data: &elf32_bed as *const elf_backend_data as *const libc::c_void,
        };
        init
    };
    elf32_le_vec = {
        let mut init = bfd_target {
            name: b"elf32-little\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_elf_flavour,
            ...
            alternative_target: &elf32_be_vec,
            backend_data: &elf32_bed as *const elf_backend_data as *const libc::c_void,
        };
        init
    };
