...
static mut global_syms: [asymbol; 4] = [asymbol {
    the_bfd: 0 as *mut bfd,
    name: 0 as *const libc::c_char,
    value: 0,
    flags: 0,
    section: 0 as *mut bfd_section,
    udata: C2RustUnnamed_9 {
        p: 0 as *mut libc::c_void,
    },
}; 4];
#[no_mangle]
pub static mut _bfd_std_section: [asection; 4] = [asection {
    name: 0 as *const libc::c_char,
    id: 0,
    section_id: 0,
    index: 0,
    ...
    relax_count: 0,
    output_offset: 0,
    output_section: 0 as *mut bfd_section,
    alignment_power: 0,
    ...
    owner: 0 as *mut bfd,
    symbol: 0 as *mut bfd_symbol,
    symbol_ptr_ptr: 0 as *mut *mut bfd_symbol,
    map_head: C2RustUnnamed_3 {
        link_order: 0 as *mut bfd_link_order,
    },
    map_tail: C2RustUnnamed_3 {
        link_order: 0 as *mut bfd_link_order,
    },
    already_assigned: 0 as *mut bfd_section,
}; 4];
#[no_mangle]
pub unsafe extern "C" fn bfd_section_hash_newfunc(
    ...
    if !entry.is_null() {
        memset(
            &mut (*(entry as *mut section_hash_entry)).section as *mut asection
                as *mut libc::c_void,
            0 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_new_section_hook(
    mut abfd: *mut bfd,
    ...
    if ((*newsect).symbol).is_null() {
        return 0 as libc::c_int != 0;
    }
    (*(*newsect).symbol).name = (*newsect).name;
    (*(*newsect).symbol).value = 0 as libc::c_int as symvalue;
    (*(*newsect).symbol).section = newsect;
    (*(*newsect).symbol).flags = ((1 as libc::c_int) << 8 as libc::c_int) as flagword;
    (*newsect).symbol_ptr_ptr = &mut (*newsect).symbol;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub static mut _bfd_section_id: libc::c_uint = 0x10 as libc::c_int as libc::c_uint;
unsafe extern "C" fn bfd_section_init(
    mut abfd: *mut bfd,
    mut newsect: *mut asection,
) -> *mut asection {
    ...
    (*newsect).owner = abfd;
    if !(Some(((*(*abfd).xvec)._new_section_hook).expect("non-null function pointer")))
        .expect("non-null function pointer")(abfd, newsect)
    {
        return 0 as *mut asection;
    }
    _bfd_section_id = _bfd_section_id.wrapping_add(1);
    _bfd_section_id;
    (*abfd).section_count = ((*abfd).section_count).wrapping_add(1);
    (*abfd).section_count;
    bfd_section_list_append(abfd, newsect);
    return newsect;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_section_list_clear(mut abfd: *mut bfd) {
    ...
    memset(
        (*abfd).section_htab.table as *mut libc::c_void,
        0 as libc::c_int,
        ((*abfd).section_htab.size as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<*mut bfd_hash_entry>() as libc::c_ulong),
    );
    (*abfd).section_htab.count = 0 as libc::c_int as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_get_section_by_name(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
) -> *mut asection {
    let mut sh: *mut section_hash_entry = 0 as *mut section_hash_entry;
    if name.is_null() {
        return 0 as *mut asection;
    }
    sh = bfd_hash_lookup(
        &mut (*abfd).section_htab,
        name,
        0 as libc::c_int != 0,
        0 as libc::c_int != 0,
    ) as *mut section_hash_entry;
    if !sh.is_null() {
        return &mut (*sh).section;
    }
    return 0 as *mut asection;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_get_next_section_by_name(
    mut ibfd: *mut bfd,
    ...
    sh = (sec as *mut libc::c_char).offset(-(24 as libc::c_ulong as isize))
        as *mut section_hash_entry;
    hash = (*sh).root.hash;
    name = (*sec).name;
    sh = (*sh).root.next as *mut section_hash_entry;
    while !sh.is_null() {
        if (*sh).root.hash == hash && strcmp((*sh).root.string, name) == 0 as libc::c_int
        {
            return &mut (*sh).section;
        }
        sh = (*sh).root.next as *mut section_hash_entry;
    ...
    if !ibfd.is_null() {
        loop {
            ...
            let mut s: *mut asection = bfd_get_section_by_name(ibfd, name);
            if !s.is_null() {
                return s;
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_linker_section(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
) -> *mut asection {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_section_by_name_if(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut operation: Option::<
        unsafe extern "C" fn(*mut bfd, *mut asection, *mut libc::c_void) -> bool,
    >,
    mut user_storage: *mut libc::c_void,
) -> *mut asection {
    let mut sh: *mut section_hash_entry = 0 as *mut section_hash_entry;
    let mut hash: libc::c_ulong = 0;
    if name.is_null() {
    ...
    while !sh.is_null() {
        if (*sh).root.hash == hash && strcmp((*sh).root.string, name) == 0 as libc::c_int
            && (Some(operation.expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(abfd, &mut (*sh).section, user_storage) as libc::c_int != 0
        {
            return &mut (*sh).section;
        }
        sh = (*sh).root.next as *mut section_hash_entry;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_unique_section_name(
    mut abfd: *mut bfd,
    mut templat: *const libc::c_char,
    mut count: *mut libc::c_int,
) -> *mut libc::c_char {
    let mut num: libc::c_int = 0;
    let mut len: libc::c_uint = 0;
    let mut sname: *mut libc::c_char = 0 as *mut libc::c_char;
    len = strlen(templat) as libc::c_uint;
    sname = bfd_malloc(
        len.wrapping_add(8 as libc::c_int as libc::c_uint) as bfd_size_type,
    ) as *mut libc::c_char;
    if sname.is_null() {
    ...
    loop {
        if num > 999999 as libc::c_int {
            _bfd_abort(
                b"section.c\0" as *const u8 as *const libc::c_char,
                1065 as libc::c_int,
                (*::core::mem::transmute::<
                    &[u8; 62],
                    &[libc::c_char; 62],
                >(b"char *bfd_get_unique_section_name(bfd *, const char *, int *)\0"))
                    .as_ptr(),
            );
        }
        let fresh0 = num;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_make_section_old_way(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
) -> *mut asection {
    ...
    if strcmp(name, b"*ABS*\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int {
        newsect = &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut asection;
    } else if strcmp(name, b"*COM*\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        newsect = &mut *_bfd_std_section.as_mut_ptr().offset(0 as libc::c_int as isize)
            as *mut asection;
    } else if strcmp(name, b"*UND*\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        newsect = &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize)
            as *mut asection;
    } else if strcmp(name, b"*IND*\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
    {
        newsect = &mut *_bfd_std_section.as_mut_ptr().offset(3 as libc::c_int as isize)
            as *mut asection;
    } else {
        let mut sh: *mut section_hash_entry = 0 as *mut section_hash_entry;
        sh = bfd_hash_lookup(
        ...
        newsect = &mut (*sh).section;
        if !((*newsect).name).is_null() {
            return newsect;
        }
        (*newsect).name = name;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_make_section_anyway_with_flags(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut flags: flagword,
) -> *mut asection {
    ...
    newsect = &mut (*sh).section;
    if !((*newsect).name).is_null() {
        let mut new_sh: *mut section_hash_entry = 0 as *mut section_hash_entry;
        new_sh = bfd_section_hash_newfunc(
        ...
        (*new_sh).root = (*sh).root;
        (*sh).root.next = &mut (*new_sh).root;
        newsect = &mut (*new_sh).section;
    }
    (*newsect).flags = flags;
    (*newsect).name = name;
    return bfd_section_init(abfd, newsect);
...
#[no_mangle]
pub unsafe extern "C" fn bfd_make_section_anyway(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
) -> *mut asection {
    return bfd_make_section_anyway_with_flags(abfd, name, 0 as libc::c_int as flagword);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_make_section_with_flags(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut flags: flagword,
) -> *mut asection {
    let mut sh: *mut section_hash_entry = 0 as *mut section_hash_entry;
    let mut newsect: *mut asection = 0 as *mut asection;
    if abfd.is_null() || name.is_null() || (*abfd).output_has_begun() as libc::c_int != 0
    {
        bfd_set_error(bfd_error_invalid_operation);
        return 0 as *mut asection;
    }
    if strcmp(name, b"*ABS*\0" as *const u8 as *const libc::c_char) == 0 as libc::c_int
        || strcmp(name, b"*COM*\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"*UND*\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"*IND*\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
        return 0 as *mut asection;
    }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_make_section(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
) -> *mut asection {
    return bfd_make_section_with_flags(abfd, name, 0 as libc::c_int as flagword);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_section_flags(
...
#[no_mangle]
pub unsafe extern "C" fn bfd_rename_section(
    mut sec: *mut asection,
    ...
    bfd_hash_rename(&mut (*(*sec).owner).section_htab, newname, &mut (*sh).root);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_map_over_sections(
    mut abfd: *mut bfd,
    mut operation: Option::<
    ...
    while !sect.is_null() {
        (Some(operation.expect("non-null function pointer")))
            .expect("non-null function pointer")(abfd, sect, user_storage);
        i = i.wrapping_add(1);
        i;
        sect = (*sect).next;
    }
    if i != (*abfd).section_count {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 79],
            >(
                b"void bfd_map_over_sections(bfd *, void (*)(bfd *, asection *, void *), void *)\0",
            ))
                .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_sections_find_if(
    mut abfd: *mut bfd,
    mut operation: Option::<
        unsafe extern "C" fn(*mut bfd, *mut asection, *mut libc::c_void) -> bool,
    >,
    ...
    sect = (*abfd).sections;
    while !sect.is_null() {
        if (Some(operation.expect("non-null function pointer")))
            .expect("non-null function pointer")(abfd, sect, user_storage)
        {
            break;
        }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_section_size(
    mut sec: *mut asection,
    mut val: bfd_size_type,
) -> bool {
    if ((*sec).owner).is_null() || (*(*sec).owner).output_has_begun() as libc::c_int != 0
    {
        bfd_set_error(bfd_error_invalid_operation);
        return 0 as libc::c_int != 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
    ...
    if bfd_section_flags(section as *const asection)
    ...
    sz = (*section).size;
    if offset as bfd_size_type > sz || count > sz.wrapping_sub(offset as libc::c_ulong)
        || count != count
    {
    ...
    if !((*section).contents).is_null()
        && location
            != ((*section).contents).offset(offset as isize) as *const libc::c_void
    {
        memcpy(
            ((*section).contents).offset(offset as isize) as *mut libc::c_void,
            location,
            count,
        );
    }
    if (Some(
        ((*(*abfd).xvec)._bfd_set_section_contents).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, section, location, offset, count)
    {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
    ...
    if (*section).flags & 0x80 as libc::c_int as libc::c_uint != 0 {
        memset(location, 0 as libc::c_int, count);
        return 1 as libc::c_int != 0;
    }
    if (*abfd).direction() as libc::c_int != write_direction as libc::c_int
    ...
    if (*section).flags & 0x4000 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        if ((*section).contents).is_null() {
            (*section).flags &= !(0x4000 as libc::c_int) as libc::c_uint;
            bfd_set_error(bfd_error_invalid_operation);
            return 0 as libc::c_int != 0;
        }
        memmove(
    ...
    return (Some(
        ((*(*abfd).xvec)._bfd_get_section_contents).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, section, location, offset, count);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_malloc_and_get_section(
    mut abfd: *mut bfd,
    mut sec: sec_ptr,
    mut buf: *mut *mut bfd_byte,
) -> bool {
    *buf = 0 as *mut bfd_byte;
    ...
    global_syms = [
        {
            let mut init = bfd_symbol {
                the_bfd: 0 as *mut bfd,
                name: b"*COM*\0" as *const u8 as *const libc::c_char,
        ...
        },
        {
            let mut init = bfd_symbol {
                the_bfd: 0 as *mut bfd,
                name: b"*UND*\0" as *const u8 as *const libc::c_char,
                value: 0 as libc::c_int as symvalue,
                flags: ((1 as libc::c_int) << 8 as libc::c_int) as flagword,
                section: &mut *_bfd_std_section
                    .as_mut_ptr()
        ...
        },
        {
            let mut init = bfd_symbol {
                the_bfd: 0 as *mut bfd,
                name: b"*IND*\0" as *const u8 as *const libc::c_char,
                value: 0 as libc::c_int as symvalue,
                flags: ((1 as libc::c_int) << 8 as libc::c_int) as flagword,
                section: &mut *_bfd_std_section
                    .as_mut_ptr()
                    .offset(3 as libc::c_int as isize) as *mut asection,
                udata: C2RustUnnamed_9 {
                    p: 0 as *mut libc::c_void,
                },
            };
    ...
    _bfd_std_section = [
        {
            let mut init = bfd_section {
                ...
                constructor_chain: 0 as *mut relent_chain,
                owner: 0 as *mut bfd,
                symbol: &*global_syms.as_ptr().offset(0 as libc::c_int as isize)
                    as *const asymbol as *mut bfd_symbol,
                symbol_ptr_ptr: &mut (*_bfd_std_section
                    .as_mut_ptr()
        ...
        },
        {
            let mut init = bfd_section {
                ...
                c2rust_padding: [0; 1],
                name: b"*UND*\0" as *const u8 as *const libc::c_char,
                id: 1 as libc::c_int as libc::c_uint,
                section_id: 0 as libc::c_int as libc::c_uint,
                index: 0 as libc::c_int as libc::c_uint,
                next: 0 as *mut bfd_section,
                prev: 0 as *mut bfd_section,
                ...
                constructor_chain: 0 as *mut relent_chain,
                owner: 0 as *mut bfd,
                symbol: &*global_syms.as_ptr().offset(1 as libc::c_int as isize)
                    as *const asymbol as *mut bfd_symbol,
                symbol_ptr_ptr: &mut (*_bfd_std_section
                    .as_mut_ptr()
        ...
        },
        {
            let mut init = bfd_section {
                ...
                c2rust_padding: [0; 1],
                name: b"*ABS*\0" as *const u8 as *const libc::c_char,
                id: 2 as libc::c_int as libc::c_uint,
                section_id: 0 as libc::c_int as libc::c_uint,
                index: 0 as libc::c_int as libc::c_uint,
                next: 0 as *mut bfd_section,
                prev: 0 as *mut bfd_section,
                ...
                constructor_chain: 0 as *mut relent_chain,
                owner: 0 as *mut bfd,
                symbol: &*global_syms.as_ptr().offset(2 as libc::c_int as isize)
                    as *const asymbol as *mut bfd_symbol,
                symbol_ptr_ptr: &mut (*_bfd_std_section
                    .as_mut_ptr()
        ...
        },
        {
            let mut init = bfd_section {
                ...
                c2rust_padding: [0; 1],
                name: b"*IND*\0" as *const u8 as *const libc::c_char,
                id: 3 as libc::c_int as libc::c_uint,
                section_id: 0 as libc::c_int as libc::c_uint,
                index: 0 as libc::c_int as libc::c_uint,
                next: 0 as *mut bfd_section,
                prev: 0 as *mut bfd_section,
                ...
                constructor_chain: 0 as *mut relent_chain,
                owner: 0 as *mut bfd,
                symbol: &*global_syms.as_ptr().offset(3 as libc::c_int as isize)
                    as *const asymbol as *mut bfd_symbol,
                symbol_ptr_ptr: &mut (*_bfd_std_section
                    .as_mut_ptr()
