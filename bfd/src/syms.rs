...
pub struct indexentry {
    pub val: bfd_vma,
    pub stab: *mut bfd_byte,
    pub str_0: *mut bfd_byte,
    pub directory_name: *mut libc::c_char,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct stab_find_info {
    pub stabsec: *mut asection,
    pub strsec: *mut asection,
    pub stabs: *mut bfd_byte,
    pub strs: *mut bfd_byte,
    pub indextable: *mut indexentry,
    pub indextablesize: libc::c_int,
    pub cached_indexentry: *mut indexentry,
    pub cached_offset: bfd_vma,
    pub cached_stab: *mut bfd_byte,
    pub cached_file_name: *mut libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_is_local_label(
    mut abfd: *mut bfd,
    mut sym: *mut asymbol,
) -> bool {
    if (*sym).flags
    ...
    return (Some(
        ((*(*abfd).xvec)._bfd_is_local_label_name).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, (*sym).name);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_symtab(
    mut abfd: *mut bfd,
    mut location: *mut *mut asymbol,
    mut symcount: libc::c_uint,
) -> bool {
    if (*abfd).format() as libc::c_int != bfd_object as libc::c_int
        || ((*abfd).direction() as libc::c_int == read_direction as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn bfd_print_symbol_vandf(
    mut abfd: *mut bfd,
    mut arg: *mut libc::c_void,
    mut symbol: *mut asymbol,
) {
    let mut file: *mut FILE = arg as *mut FILE;
    let mut type_0: flagword = (*symbol).flags;
    if !((*symbol).section).is_null() {
        bfd_fprintf_vma(
            abfd,
            file as *mut libc::c_void,
            ((*symbol).value).wrapping_add((*(*symbol).section).vma),
        );
    } else {
    ...
    fprintf(
        file,
        b" %c%c%c%c%c%c%c\0" as *const u8 as *const libc::c_char,
        if type_0 & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint != 0 {
            if type_0 & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0 {
                '!' as i32
            } else {
                'l' as i32
            }
        } else if type_0 & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
        {
            'g' as i32
        } else if type_0 & ((1 as libc::c_int) << 23 as libc::c_int) as libc::c_uint != 0
        {
            'u' as i32
        } else {
            ' ' as i32
        },
        if type_0 & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint != 0 {
            'w' as i32
        } else {
            ' ' as i32
        },
        if type_0 & ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_uint != 0 {
            'C' as i32
        } else {
            ' ' as i32
        },
        if type_0 & ((1 as libc::c_int) << 12 as libc::c_int) as libc::c_uint != 0 {
            'W' as i32
        } else {
            ' ' as i32
        },
        if type_0 & ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint != 0 {
            'I' as i32
        } else if type_0 & ((1 as libc::c_int) << 22 as libc::c_int) as libc::c_uint != 0
        {
            'i' as i32
        } else {
            ' ' as i32
        },
        if type_0 & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint != 0 {
            'd' as i32
        } else if type_0 & ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_uint != 0
        {
            'D' as i32
        } else {
            ' ' as i32
        },
        if type_0 & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint != 0 {
            'F' as i32
        } else if type_0 & ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint != 0
        {
            'f' as i32
        } else if type_0 & ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint != 0
        {
            'O' as i32
        } else {
            ' ' as i32
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_make_empty_symbol(
    mut abfd: *mut bfd,
) -> *mut asymbol {
    let mut amt: size_t = ::core::mem::size_of::<asymbol>() as libc::c_ulong;
    let mut new_symbol: *mut asymbol = bfd_zalloc(abfd, amt) as *mut asymbol;
    if !new_symbol.is_null() {
        (*new_symbol).the_bfd = abfd;
    }
    return new_symbol;
}
static mut stt: [section_to_type; 5] = [
    {
        let mut init = section_to_type {
            section: b".drectve\0" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = section_to_type {
            section: b".edata\0" as *const u8 as *const libc::c_char,
            type_0: 'e' as i32 as libc::c_char,
        };
        init
    },
    {
        let mut init = section_to_type {
            section: b".idata\0" as *const u8 as *const libc::c_char,
            type_0: 'i' as i32 as libc::c_char,
        };
        init
    },
    {
        let mut init = section_to_type {
            section: b".pdata\0" as *const u8 as *const libc::c_char,
            type_0: 'p' as i32 as libc::c_char,
        };
        init
    },
    {
        let mut init = section_to_type {
            section: 0 as *const libc::c_char,
            type_0: 0 as libc::c_int as libc::c_char,
        };
        init
    },
];
unsafe extern "C" fn coff_section_type(mut s: *const libc::c_char) -> libc::c_char {
    let mut t: *const section_to_type = 0 as *const section_to_type;
    t = &*stt.as_ptr().offset(0 as libc::c_int as isize) as *const section_to_type;
    while !((*t).section).is_null() {
        let mut len: size_t = strlen((*t).section);
        if strncmp(s, (*t).section, len) == 0 as libc::c_int
            && !(memchr(
                b".$0123456789\0" as *const u8 as *const libc::c_char
                    as *const libc::c_void,
                *s.offset(len as isize) as libc::c_int,
...
unsafe extern "C" fn decode_section_type(
    mut section: *const bfd_section,
) -> libc::c_char {
    ...
    if (*section).flags & 0x20 as libc::c_int as libc::c_uint != 0 {
        ...
        } else if (*section).flags & 0x400000 as libc::c_int as libc::c_uint != 0 {
    ...
    if (*section).flags & 0x100 as libc::c_int as libc::c_uint != 0
        && (*section).flags & 0x8 as libc::c_int as libc::c_uint != 0
    {
        return 'n' as i32 as libc::c_char;
    }
    return '?' as i32 as libc::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_decode_symclass(mut symbol: *mut asymbol) -> libc::c_int {
    let mut c: libc::c_char = 0;
    if symbol.is_null() || ((*symbol).section).is_null() {
        return '?' as i32;
    }
    if !((*symbol).section).is_null()
        && bfd_is_com_section((*symbol).section) as libc::c_int != 0
    {
        if (*(*symbol).section).flags & 0x400000 as libc::c_int as libc::c_uint != 0 {
            return 'c' as i32
        } else {
            return 'C' as i32
        }
    ...
    if (*symbol).flags & ((1 as libc::c_int) << 22 as libc::c_int) as libc::c_uint != 0 {
        return 'i' as i32;
    }
    if (*symbol).flags & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint != 0 {
        if (*symbol).flags & ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint
            != 0
        {
            return 'V' as i32
        } else {
    ...
    if (*symbol).flags & ((1 as libc::c_int) << 23 as libc::c_int) as libc::c_uint != 0 {
        return 'u' as i32;
    }
    if (*symbol).flags
        & ((1 as libc::c_int) << 1 as libc::c_int
    ...
    } else if !((*symbol).section).is_null() {
    ...
    if (*symbol).flags & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_is_undefined_symclass(mut symclass: libc::c_int) -> bool {
    return symclass == 'U' as i32 || symclass == 'w' as i32 || symclass == 'v' as i32;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_symbol_info(
    mut symbol: *mut asymbol,
    mut ret: *mut symbol_info,
) {
    (*ret).type_0 = bfd_decode_symclass(symbol) as libc::c_char;
    if bfd_is_undefined_symclass((*ret).type_0 as libc::c_int) {
        (*ret).value = 0 as libc::c_int as symvalue;
    } else {
        (*ret).value = ((*symbol).value).wrapping_add((*(*symbol).section).vma);
    }
    (*ret).name = (*symbol).name;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_read_minisymbols(
    mut abfd: *mut bfd,
    mut dynamic: bool,
    ...
    if !(storage < 0 as libc::c_int as libc::c_long) {
        ...
        syms = bfd_malloc(storage as bfd_size_type) as *mut *mut asymbol;
        if !syms.is_null() {
            if dynamic {
                symcount = (Some(
            ...
            if !(symcount < 0 as libc::c_int as libc::c_long) {
                if symcount == 0 as libc::c_int as libc::c_long {
                    ...
                    *minisymsp = syms as *mut libc::c_void;
                    *sizep = ::core::mem::size_of::<*mut asymbol>() as libc::c_ulong
                        as libc::c_uint;
                }
                return symcount;
            }
...
unsafe extern "C" fn cmpindexentry(
    mut a: *const libc::c_void,
    mut b: *const libc::c_void,
) -> libc::c_int {
    let mut contestantA: *const indexentry = a as *const indexentry;
    let mut contestantB: *const indexentry = b as *const indexentry;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_stab_section_find_nearest_line(
    mut abfd: *mut bfd,
    mut symbols: *mut *mut asymbol,
    mut section: *mut asection,
    mut offset: bfd_vma,
    mut pfound: *mut bool,
    mut pfilename: *mut *const libc::c_char,
    mut pfnname: *mut *const libc::c_char,
    mut pline: *mut libc::c_uint,
    mut pinfo: *mut *mut libc::c_void,
) -> bool {
    let mut info: *mut stab_find_info = 0 as *mut stab_find_info;
    let mut stabsize: bfd_size_type = 0;
    let mut strsize: bfd_size_type = 0;
    let mut stab: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut str: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut nul_fun: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut nul_str: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut stroff: bfd_size_type = 0;
    let mut indexentry: *mut indexentry = 0 as *mut indexentry;
    let mut file_name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut directory_name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut saw_line: bool = false;
    let mut saw_func: bool = false;
    *pfound = 0 as libc::c_int != 0;
    *pfilename = bfd_get_filename(abfd);
    *pfnname = 0 as *const libc::c_char;
    *pline = 0 as libc::c_int as libc::c_uint;
    info = *pinfo as *mut stab_find_info;
    if !info.is_null() {
        if ((*info).stabsec).is_null() || ((*info).strsec).is_null() {
            return 1 as libc::c_int != 0;
        }
        stabsize = if (*(*info).stabsec).rawsize != 0 {
            (*(*info).stabsec).rawsize
        } else {
            (*(*info).stabsec).size
        };
        strsize = if (*(*info).strsec).rawsize != 0 {
            (*(*info).strsec).rawsize
        } else {
            (*(*info).strsec).size
        };
        ...
        let mut function_name: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut amt: bfd_size_type = ::core::mem::size_of::<stab_find_info>()
            as libc::c_ulong;
        info = bfd_zalloc(abfd, amt) as *mut stab_find_info;
        if info.is_null() {
            return 0 as libc::c_int != 0;
        }
        (*info)
            .stabsec = bfd_get_section_by_name(
            abfd,
            b".stab\0" as *const u8 as *const libc::c_char,
        );
        (*info)
            .strsec = bfd_get_section_by_name(
            abfd,
        ...
        if ((*info).stabsec).is_null() || ((*info).strsec).is_null() {
            (*info)
                .stabsec = bfd_get_section_by_name(
                abfd,
                b"$GDB_SYMBOLS$\0" as *const u8 as *const libc::c_char,
            );
            (*info)
                .strsec = bfd_get_section_by_name(
                abfd,
                b"$GDB_STRINGS$\0" as *const u8 as *const libc::c_char,
            );
            if ((*info).stabsec).is_null() || ((*info).strsec).is_null() {
                *pinfo = info as *mut libc::c_void;
                return 1 as libc::c_int != 0;
            }
        }
        stabsize = if (*(*info).stabsec).rawsize != 0 {
        ...
        (*info).stabs = bfd_alloc(abfd, stabsize) as *mut bfd_byte;
        (*info).strs = bfd_alloc(abfd, strsize) as *mut bfd_byte;
        if ((*info).stabs).is_null() || ((*info).strs).is_null() {
            return 0 as libc::c_int != 0;
        }
        if !bfd_get_section_contents(
            abfd,
            (*info).stabsec,
            (*info).stabs as *mut libc::c_void,
        ...
        *((*info).strs)
            .offset(
                strsize.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize,
        ...
        if reloc_vector.is_null() && reloc_size != 0 as libc::c_int as libc::c_long {
            return 0 as libc::c_int != 0;
        }
        ...
        if reloc_count > 0 as libc::c_int as libc::c_long {
            let mut pr: *mut *mut arelent = 0 as *mut *mut arelent;
            pr = reloc_vector;
            while !(*pr).is_null() {
                ...
                r = *pr;
                if !((*(*r).howto).dst_mask == 0 as libc::c_int as libc::c_ulong) {
                    octets = ((*r).address)
                        .wrapping_mul(
                            bfd_octets_per_byte(abfd, 0 as *const asection)
                                as libc::c_ulong,
                        );
                    if (*(*r).howto).rightshift() as libc::c_int != 0 as libc::c_int
                        || (*(*r).howto).size() as libc::c_int != 2 as libc::c_int
                        || (*(*r).howto).bitsize() as libc::c_int != 32 as libc::c_int
                        || (*(*r).howto).pc_relative() as libc::c_int != 0
                        || (*(*r).howto).bitpos() as libc::c_int != 0 as libc::c_int
                        || (*(*r).howto).dst_mask
                            != 0xffffffff as libc::c_uint as libc::c_ulong
                        || octets.wrapping_add(4 as libc::c_int as libc::c_ulong)
                            > stabsize
                    {
                        _bfd_error_handler(
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"unsupported .stab relocation\0" as *const u8
                    ...
                    val = (Some(
                        ...
                        ((*info).stabs).offset(octets as isize) as *const libc::c_void,
                    );
                    ...
                    (Some(
                        ...
                        val,
                        ((*info).stabs).offset(octets as isize) as *mut libc::c_void,
                    );
                }
                pr = pr.offset(1);
                pr;
        ...
        free(reloc_vector as *mut libc::c_void);
        (*info).indextablesize = 0 as libc::c_int;
        nul_fun = 0 as *mut bfd_byte;
        stab = (*info).stabs;
        while stab < ((*info).stabs).offset(stabsize as isize) {
            if *stab.offset(4 as libc::c_int as isize) as libc::c_int
                == N_SO as libc::c_int as bfd_byte as libc::c_int
            {
                if !nul_fun.is_null() {
                    (*info).indextablesize += 1;
                    (*info).indextablesize;
                }
                if (Some(
                    ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
                    ...
                    .expect(
                        "non-null function pointer",
                    )(stab.offset(0 as libc::c_int as isize) as *const libc::c_void)
                    == 0 as libc::c_int as libc::c_ulong
                {
                    ...
                    if stab
                        ...
                        < ((*info).stabs).offset(stabsize as isize)
                        && *stab
                            .offset(12 as libc::c_int as isize)
                            .offset(4 as libc::c_int as isize) as libc::c_int
                            == N_SO as libc::c_int as bfd_byte as libc::c_int
                    {
                        stab = stab.offset(12 as libc::c_int as isize);
                    }
                }
            } else if *stab.offset(4 as libc::c_int as isize) as libc::c_int
                == N_FUN as libc::c_int as bfd_byte as libc::c_int
                && (Some(
                    ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
                ))
                    .expect(
        ...
        if (*info).indextablesize == 0 as libc::c_int {
            return 1 as libc::c_int != 0;
        }
        (*info).indextablesize += 1;
        (*info).indextablesize;
        amt = (*info).indextablesize as bfd_size_type;
        amt = (amt as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<indexentry>() as libc::c_ulong)
            as bfd_size_type as bfd_size_type;
        (*info).indextable = bfd_alloc(abfd, amt) as *mut indexentry;
        if ((*info).indextable).is_null() {
            return 0 as libc::c_int != 0;
        }
        file_name = 0 as *mut libc::c_char;
        directory_name = 0 as *mut libc::c_char;
        nul_fun = 0 as *mut bfd_byte;
        stroff = 0 as libc::c_int as bfd_size_type;
        i = 0 as libc::c_int;
        stab = (*info).stabs;
        str = (*info).strs;
        nul_str = str;
        while i < (*info).indextablesize
            && stab < ((*info).stabs).offset(stabsize as isize)
        {
            match *stab.offset(4 as libc::c_int as isize) as libc::c_int {
                0 => {
                    if !((((*info).strs).offset(strsize as isize).offset_from(str)
                        as libc::c_long as bfd_size_type) < stroff)
                    {
                        str = str.offset(stroff as isize);
                        stroff = (Some(
                            ...
                            stab.offset(8 as libc::c_int as isize) as *const libc::c_void,
                        );
                    }
                }
                100 => {
                    if !nul_fun.is_null() {
                        (*((*info).indextable).offset(i as isize))
                            .val = (Some(
                            ((*(*abfd).xvec).bfd_getx32)
                                .expect("non-null function pointer"),
                        ))
                            ...
                            nul_fun.offset(8 as libc::c_int as isize)
                                as *const libc::c_void,
                        );
                        let ref mut fresh0 = (*((*info).indextable).offset(i as isize))
                            .stab;
                        *fresh0 = nul_fun;
                        let ref mut fresh1 = (*((*info).indextable).offset(i as isize))
                            .str_0;
                        *fresh1 = nul_str;
                        let ref mut fresh2 = (*((*info).indextable).offset(i as isize))
                            .directory_name;
                        *fresh2 = directory_name;
                        let ref mut fresh3 = (*((*info).indextable).offset(i as isize))
                            .file_name;
                        *fresh3 = file_name;
                        let ref mut fresh4 = (*((*info).indextable).offset(i as isize))
                            .function_name;
                        *fresh4 = 0 as *mut libc::c_char;
                        (*((*info).indextable).offset(i as isize)).idx = i;
                        i += 1;
                        i;
                    }
                    directory_name = 0 as *mut libc::c_char;
                    file_name = (str as *mut libc::c_char)
                        .offset(
                            (Some(
                                ((*(*abfd).xvec).bfd_getx32)
                                    .expect("non-null function pointer"),
                                ...
                                stab.offset(0 as libc::c_int as isize)
                                    as *const libc::c_void,
                            ) as isize,
                        );
                    if file_name == str as *mut libc::c_char {
                        file_name = 0 as *mut libc::c_char;
                        nul_fun = 0 as *mut bfd_byte;
                    } else {
                        nul_fun = stab;
                        nul_str = str;
                        if file_name
                            >= ((*info).strs as *mut libc::c_char)
                                .offset(strsize as isize)
                            || file_name < str as *mut libc::c_char
                        {
                            file_name = 0 as *mut libc::c_char;
                        }
                ...
                132 => {
                    ...
                    if file_name
                        >= ((*info).strs as *mut libc::c_char).offset(strsize as isize)
                        || file_name < str as *mut libc::c_char
                    {
                        file_name = 0 as *mut libc::c_char;
                    }
                ...
                36 => {
                    function_name = (str as *mut libc::c_char)
                        .offset(
                            (Some(
                                ((*(*abfd).xvec).bfd_getx32)
                                    .expect("non-null function pointer"),
                    ...
                    if !(function_name == str as *mut libc::c_char) {
                        if function_name
                            >= ((*info).strs as *mut libc::c_char)
                                .offset(strsize as isize)
                            || function_name < str as *mut libc::c_char
                        {
                            function_name = 0 as *mut libc::c_char;
                        }
                        nul_fun = 0 as *mut bfd_byte;
                        (*((*info).indextable).offset(i as isize))
                            .val = (Some(
                        ...
                        let ref mut fresh5 = (*((*info).indextable).offset(i as isize))
                            .stab;
                        *fresh5 = stab;
                        let ref mut fresh6 = (*((*info).indextable).offset(i as isize))
                            .str_0;
                        *fresh6 = str;
                        let ref mut fresh7 = (*((*info).indextable).offset(i as isize))
                            .directory_name;
                        *fresh7 = directory_name;
                        let ref mut fresh8 = (*((*info).indextable).offset(i as isize))
                            .file_name;
                        *fresh8 = file_name;
                        let ref mut fresh9 = (*((*info).indextable).offset(i as isize))
                            .function_name;
                        *fresh9 = function_name;
                        (*((*info).indextable).offset(i as isize)).idx = i;
                        i += 1;
                        i;
                    }
        ...
        if !nul_fun.is_null() {
            (*((*info).indextable).offset(i as isize))
                ...
                .expect(
                    "non-null function pointer",
                )(nul_fun.offset(8 as libc::c_int as isize) as *const libc::c_void);
            let ref mut fresh10 = (*((*info).indextable).offset(i as isize)).stab;
            *fresh10 = nul_fun;
            let ref mut fresh11 = (*((*info).indextable).offset(i as isize)).str_0;
            *fresh11 = nul_str;
            let ref mut fresh12 = (*((*info).indextable).offset(i as isize))
                .directory_name;
            *fresh12 = directory_name;
            let ref mut fresh13 = (*((*info).indextable).offset(i as isize)).file_name;
            *fresh13 = file_name;
            let ref mut fresh14 = (*((*info).indextable).offset(i as isize))
                .function_name;
        ...
        (*((*info).indextable).offset(i as isize)).val = -(1 as libc::c_int) as bfd_vma;
        let ref mut fresh15 = (*((*info).indextable).offset(i as isize)).stab;
        *fresh15 = ((*info).stabs).offset(stabsize as isize);
        let ref mut fresh16 = (*((*info).indextable).offset(i as isize)).str_0;
        *fresh16 = str;
        let ref mut fresh17 = (*((*info).indextable).offset(i as isize)).directory_name;
        *fresh17 = 0 as *mut libc::c_char;
        let ref mut fresh18 = (*((*info).indextable).offset(i as isize)).file_name;
        *fresh18 = 0 as *mut libc::c_char;
        let ref mut fresh19 = (*((*info).indextable).offset(i as isize)).function_name;
        *fresh19 = 0 as *mut libc::c_char;
        ...
        qsort(
            (*info).indextable as *mut libc::c_void,
            i as size_t,
            ::core::mem::size_of::<indexentry>() as libc::c_ulong,
            Some(
                cmpindexentry
    ...
    offset = (offset as libc::c_ulong).wrapping_add(bfd_section_vma(section)) as bfd_vma
        as bfd_vma;
    if !((*info).cached_indexentry).is_null() && offset >= (*info).cached_offset
        && offset < (*((*info).cached_indexentry).offset(1 as libc::c_int as isize)).val
    {
        ...
        let mut mid: libc::c_long = -(1 as libc::c_int) as libc::c_long;
        indexentry = 0 as *mut indexentry;
        low = 0 as libc::c_int as libc::c_long;
        high = ((*info).indextablesize - 1 as libc::c_int) as libc::c_long;
        while low != high {
            mid = (high + low) / 2 as libc::c_int as libc::c_long;
            if offset >= (*((*info).indextable).offset(mid as isize)).val
                && offset
                    < (*((*info).indextable)
                        .offset((mid + 1 as libc::c_int as libc::c_long) as isize))
                        .val
            {
                indexentry = &mut *((*info).indextable).offset(mid as isize)
                    as *mut indexentry;
                break;
            } else if (*((*info).indextable).offset(mid as isize)).val > offset {
                high = mid;
            } else {
                low = mid + 1 as libc::c_int as libc::c_long;
            }
        }
        if indexentry.is_null() {
            return 1 as libc::c_int != 0;
        }
        stab = ((*indexentry).stab).offset(12 as libc::c_int as isize);
        file_name = (*indexentry).file_name;
    }
    directory_name = (*indexentry).directory_name;
    str = (*indexentry).str_0;
    saw_line = 0 as libc::c_int != 0;
    saw_func = 0 as libc::c_int != 0;
    while stab < (*indexentry.offset(1 as libc::c_int as isize)).stab {
        ...
        match *stab.offset(4 as libc::c_int as isize) as libc::c_int {
            ...
            68 | 70 | 72 => {
                val_0 = (if !((*indexentry).function_name).is_null() {
                    (*indexentry).val
                } else {
                    0 as libc::c_int as libc::c_ulong
                })
                ...
                if !saw_line || val_0 <= offset {
                    *pline = (Some(
                        ((*(*abfd).xvec).bfd_getx16).expect("non-null function pointer"),
                    ))
                        .expect(
                            "non-null function pointer",
                        )(stab.offset(6 as libc::c_int as isize) as *const libc::c_void)
                        as libc::c_uint;
                    (*info).cached_stab = stab;
                    (*info).cached_offset = val_0;
                ...
                saw_line = 1 as libc::c_int != 0;
            }
            36 | 100 => {
                if saw_func as libc::c_int != 0 || saw_line as libc::c_int != 0 {
                    done = 1 as libc::c_int != 0;
                }
                saw_func = 1 as libc::c_int != 0;
            }
            _ => {}
        }
        if done {
    ...
    *pfound = 1 as libc::c_int != 0;
    if file_name.is_null()
        || (*file_name.offset(0 as libc::c_int as isize) as libc::c_int == '/' as i32
            || *file_name.offset(0 as libc::c_int as isize) as libc::c_int == '\\' as i32
                && 0 as libc::c_int != 0
            || *file_name.offset(0 as libc::c_int as isize) as libc::c_int != 0
                && *file_name.offset(1 as libc::c_int as isize) as libc::c_int
                    == ':' as i32 && 0 as libc::c_int != 0) || directory_name.is_null()
    {
        *pfilename = file_name;
    } else {
        ...
        if ((*info).filename).is_null()
            || filename_ncmp((*info).filename, directory_name, dirlen)
                != 0 as libc::c_int
            || filename_cmp(((*info).filename).offset(dirlen as isize), file_name)
                != 0 as libc::c_int
        {
            let mut len: size_t = 0;
            len = (strlen(file_name)).wrapping_add(1 as libc::c_int as libc::c_ulong);
            (*info)
                .filename = bfd_alloc(abfd, dirlen.wrapping_add(len))
                as *mut libc::c_char;
            if ((*info).filename).is_null() {
                return 0 as libc::c_int != 0;
            }
            memcpy(
                (*info).filename as *mut libc::c_void,
                directory_name as *const libc::c_void,
                dirlen,
            );
            memcpy(
                ((*info).filename).offset(dirlen as isize) as *mut libc::c_void,
    ...
    if !((*indexentry).function_name).is_null() {
        let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
        s = strchr((*indexentry).function_name, ':' as i32);
        if !s.is_null() {
