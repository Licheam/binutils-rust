...
extern "C" {
    ...
    fn bfd_hash_replace(
        _: *mut bfd_hash_table,
        old: *mut bfd_hash_entry,
        nw: *mut bfd_hash_entry,
    );
    fn bfd_hash_newfunc(
    ...
    fn bfd_get_relocated_section_contents(
        _: *mut bfd,
        _: *mut bfd_link_info,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct generic_link_hash_table {
    pub root: bfd_link_hash_table,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct generic_link_hash_entry {
    pub root: bfd_link_hash_entry,
    pub written: bool,
    pub sym: *mut asymbol,
}
pub const MWARN: link_action = 16;
pub const WARN: link_action = 17;
pub const REFC: link_action = 19;
pub const CYCLE: link_action = 18;
pub const WARNC: link_action = 20;
pub const SET: link_action = 15;
pub type link_row = libc::c_uint;
pub const SET_ROW: link_row = 7;
pub const WARN_ROW: link_row = 6;
pub const INDR_ROW: link_row = 5;
pub const COMMON_ROW: link_row = 4;
pub const DEFW_ROW: link_row = 3;
pub const DEF_ROW: link_row = 2;
pub const UNDEFW_ROW: link_row = 1;
pub const UNDEF_ROW: link_row = 0;
pub const IND: link_action = 13;
pub const CIND: link_action = 14;
pub const MDEF: link_action = 11;
pub const MIND: link_action = 12;
pub const CREF: link_action = 7;
pub const BIG: link_action = 10;
pub const REF: link_action = 6;
pub const COM: link_action = 5;
pub const DEFW: link_action = 4;
pub type link_action = libc::c_uint;
pub const NOACT: link_action = 9;
pub const CDEF: link_action = 8;
pub const DEF: link_action = 3;
pub const WEAK: link_action = 2;
pub const UND: link_action = 1;
pub const FAIL: link_action = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct generic_write_global_symbol_info {
    pub info: *mut bfd_link_info,
    pub output_bfd: *mut bfd,
    pub psymalloc: *mut size_t,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[inline]
unsafe extern "C" fn bfd_is_ind_section(mut sec: *const asection) -> bool {
    return sec
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_link_hash_newfunc(
    ...
    if entry.is_null() {
        entry = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<bfd_link_hash_entry>() as libc::c_ulong
                as libc::c_uint,
    ...
    if !entry.is_null() {
        let mut h: *mut bfd_link_hash_entry = entry as *mut bfd_link_hash_entry;
        memset(
            (&mut (*h).root as *mut bfd_hash_entry as *mut libc::c_char)
                .offset(
                    ::core::mem::size_of::<bfd_hash_entry>() as libc::c_ulong as isize,
                ) as *mut libc::c_void,
            0 as libc::c_int,
            (::core::mem::size_of::<bfd_link_hash_entry>() as libc::c_ulong)
                .wrapping_sub(::core::mem::size_of::<bfd_hash_entry>() as libc::c_ulong),
        );
    }
    return entry;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_link_hash_table_init(
    mut table: *mut bfd_link_hash_table,
    mut abfd: *mut bfd,
    mut newfunc: Option::<
        unsafe extern "C" fn(
            *mut bfd_hash_entry,
    ...
    if !((*abfd).is_linker_output() == 0 && ((*abfd).link.hash).is_null()) {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            469 as libc::c_int,
        );
    }
    (*table).undefs = 0 as *mut bfd_link_hash_entry;
    (*table).undefs_tail = 0 as *mut bfd_link_hash_entry;
    (*table).type_0 = bfd_link_generic_hash_table;
    ret = bfd_hash_table_init(&mut (*table).table, newfunc, entsize);
    if ret {
        (*table)
            .hash_table_free = Some(
            _bfd_generic_link_hash_table_free as unsafe extern "C" fn(*mut bfd) -> (),
        );
        (*abfd).link.hash = table;
        (*abfd).set_is_linker_output(1 as libc::c_int as libc::c_uint);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_link_hash_lookup(
    mut table: *mut bfd_link_hash_table,
    mut string: *const libc::c_char,
    mut create: bool,
    mut copy: bool,
    ...
    let mut ret: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    if table.is_null() || string.is_null() {
        return 0 as *mut bfd_link_hash_entry;
    }
    ret = bfd_hash_lookup(&mut (*table).table, string, create, copy)
        as *mut bfd_link_hash_entry;
    if follow as libc::c_int != 0 && !ret.is_null() {
        while (*ret).type_0() as libc::c_int == bfd_link_hash_indirect as libc::c_int
            || (*ret).type_0() as libc::c_int == bfd_link_hash_warning as libc::c_int
        {
            ret = (*ret).u.i.link;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_wrapped_link_hash_lookup(
    mut abfd: *mut bfd,
    ...
    if !((*info).wrap_hash).is_null() {
        ...
        let mut prefix: libc::c_char = '\0' as i32 as libc::c_char;
        l = string;
        if *l as libc::c_int == bfd_get_symbol_leading_char(abfd) as libc::c_int
            || *l as libc::c_int == (*info).wrap_char as libc::c_int
        {
            prefix = *l;
            l = l.offset(1);
            l;
            ...
            .is_null()
        {
            ...
            n = bfd_malloc(amt) as *mut libc::c_char;
            if n.is_null() {
                return 0 as *mut bfd_link_hash_entry;
            }
            *n.offset(0 as libc::c_int as isize) = prefix;
            *n.offset(1 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
            strcat(n, b"__wrap_\0" as *const u8 as *const libc::c_char);
            strcat(n, l);
        ...
        if *l as libc::c_int == '_' as i32
            && startswith(l, b"__real_\0" as *const u8 as *const libc::c_char)
                as libc::c_int != 0
            && !(bfd_hash_lookup(
                (*info).wrap_hash,
                l
                ...
                .is_null()
        {
            let mut n_0: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut h_0: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
            amt = (strlen(
                l
                    .offset(
                        ::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong
            ...
            n_0 = bfd_malloc(amt) as *mut libc::c_char;
            if n_0.is_null() {
                return 0 as *mut bfd_link_hash_entry;
            }
            *n_0.offset(0 as libc::c_int as isize) = prefix;
            *n_0.offset(1 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
            strcat(
                n_0,
                l
                    .offset(
...
#[no_mangle]
pub unsafe extern "C" fn unwrap_hash_lookup(
    mut info: *mut bfd_link_info,
    mut input_bfd: *mut bfd,
    mut h: *mut bfd_link_hash_entry,
) -> *mut bfd_link_hash_entry {
    let mut l: *const libc::c_char = (*h).root.string;
    if *l as libc::c_int == bfd_get_symbol_leading_char(input_bfd) as libc::c_int
        || *l as libc::c_int == (*info).wrap_char as libc::c_int
    {
        l = l.offset(1);
        l;
    }
    if startswith(l, b"__wrap_\0" as *const u8 as *const libc::c_char) {
        l = l
            .offset(
                (::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong)
            ...
            .is_null()
        {
                ...
                ) != (*h).root.string
            {
                ...
                l;
                save = *l;
                *(l as *mut libc::c_char) = *(*h).root.string;
            }
            h = bfd_link_hash_lookup(
                (*info).hash,
                l,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_link_hash_traverse(
    mut htab: *mut bfd_link_hash_table,
    mut func: Option::<
    ...
    ((*htab).table).set_frozen(1 as libc::c_int as libc::c_uint);
    i = 0 as libc::c_int as libc::c_uint;
    's_7: while i < (*htab).table.size {
        let mut p: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
        p = *((*htab).table.table).offset(i as isize) as *mut bfd_link_hash_entry;
        while !p.is_null() {
            if !(Some(func.expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(
                if (*p).type_0() as libc::c_int == bfd_link_hash_warning as libc::c_int {
                    (*p).u.i.link
                } else {
                    p
                },
            ...
            p = (*p).root.next as *mut bfd_link_hash_entry;
        }
        i = i.wrapping_add(1);
        i;
    }
    ((*htab).table).set_frozen(0 as libc::c_int as libc::c_uint);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_link_add_undef(
    mut table: *mut bfd_link_hash_table,
    mut h: *mut bfd_link_hash_entry,
) {
    if !((*h).u.undef.next).is_null() {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            682 as libc::c_int,
        );
    }
    if !((*table).undefs_tail).is_null() {
        (*(*table).undefs_tail).u.undef.next = h;
    }
    if ((*table).undefs).is_null() {
        (*table).undefs = h;
    }
    (*table).undefs_tail = h;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_link_repair_undef_list(
    mut table: *mut bfd_link_hash_table,
) {
    let mut pun: *mut *mut bfd_link_hash_entry = 0 as *mut *mut bfd_link_hash_entry;
    pun = &mut (*table).undefs;
    while !(*pun).is_null() {
        let mut h: *mut bfd_link_hash_entry = *pun;
        if (*h).type_0() as libc::c_int == bfd_link_hash_new as libc::c_int
            || (*h).type_0() as libc::c_int == bfd_link_hash_undefweak as libc::c_int
        {
            *pun = (*h).u.undef.next;
            (*h).u.undef.next = 0 as *mut bfd_link_hash_entry;
            if !(h == (*table).undefs_tail) {
                continue;
            }
            if pun == &mut (*table).undefs as *mut *mut bfd_link_hash_entry {
                (*table).undefs_tail = 0 as *mut bfd_link_hash_entry;
            } else {
                (*table)
                    .undefs_tail = (pun as *mut libc::c_char)
                    .offset(
                        -((&mut (*h).u.undef.next as *mut *mut bfd_link_hash_entry
                            as *mut libc::c_char)
                            .offset_from(h as *mut libc::c_char) as libc::c_long
                            as isize),
                    ) as *mut bfd_link_hash_entry;
            }
            break;
        } else {
            pun = &mut (*h).u.undef.next;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_hash_newfunc(
    mut entry: *mut bfd_hash_entry,
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
) -> *mut bfd_hash_entry {
    if entry.is_null() {
        entry = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<generic_link_hash_entry>() as libc::c_ulong
                as libc::c_uint,
        ) as *mut bfd_hash_entry;
        if entry.is_null() {
            return entry;
    ...
    if !entry.is_null() {
        let mut ret: *mut generic_link_hash_entry = 0 as *mut generic_link_hash_entry;
        ret = entry as *mut generic_link_hash_entry;
        (*ret).written = 0 as libc::c_int != 0;
        (*ret).sym = 0 as *mut asymbol;
    }
    return entry;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_hash_table_create(
    mut abfd: *mut bfd,
) -> *mut bfd_link_hash_table {
    let mut ret: *mut generic_link_hash_table = 0 as *mut generic_link_hash_table;
    let mut amt: size_t = ::core::mem::size_of::<generic_link_hash_table>()
        as libc::c_ulong;
    ret = bfd_malloc(amt) as *mut generic_link_hash_table;
    if ret.is_null() {
        return 0 as *mut bfd_link_hash_table;
    }
    if !_bfd_link_hash_table_init(
        &mut (*ret).root,
        abfd,
        Some(
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_hash_table_free(mut obfd: *mut bfd) {
    let mut ret: *mut generic_link_hash_table = 0 as *mut generic_link_hash_table;
    if !((*obfd).is_linker_output() as libc::c_int != 0
        && !((*obfd).link.hash).is_null())
    {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            787 as libc::c_int,
    ...
    ret = (*obfd).link.hash as *mut generic_link_hash_table;
    bfd_hash_table_free(&mut (*ret).root.table);
    free(ret as *mut libc::c_void);
    (*obfd).link.hash = 0 as *mut bfd_link_hash_table;
    (*obfd).set_is_linker_output(0 as libc::c_int as libc::c_uint);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_generic_link_read_symbols(mut abfd: *mut bfd) -> bool {
    if (bfd_get_outsymbols(abfd)).is_null() {
        ...
        (*abfd)
            .outsymbols = bfd_alloc(abfd, symsize as bfd_size_type)
            as *mut *mut bfd_symbol;
        if (bfd_get_outsymbols(abfd)).is_null()
            && symsize != 0 as libc::c_int as libc::c_long
        {
            return 0 as libc::c_int != 0;
        }
        symcount = (Some(
            ...
            .expect("non-null function pointer")(abfd, bfd_get_outsymbols(abfd));
...
unsafe extern "C" fn generic_link_add_object_symbols(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    let mut symcount: bfd_size_type = 0;
    let mut outsyms: *mut *mut bfd_symbol = 0 as *mut *mut bfd_symbol;
    if !bfd_generic_link_read_symbols(abfd) {
        return 0 as libc::c_int != 0;
    }
    symcount = (*abfd).symcount as bfd_size_type;
    outsyms = (*abfd).outsymbols;
    return generic_link_add_symbol_list(abfd, info, symcount, outsyms);
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_add_archive_symbols(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut checkfn: Option::<
        unsafe extern "C" fn(
    ...
    's_53: loop {
        let mut arsyms: *mut carsym = 0 as *mut carsym;
        let mut arsym_end: *mut carsym = 0 as *mut carsym;
        let mut arsym: *mut carsym = 0 as *mut carsym;
        let mut indx: libc::c_uint = 0;
        let mut last_ar_offset: file_ptr = -(1 as libc::c_int) as file_ptr;
        let mut needed: bool = 0 as libc::c_int != 0;
        let mut element: *mut bfd = 0 as *mut bfd;
        loop_0 = 0 as libc::c_int != 0;
        arsyms = (*(*abfd).tdata.aout_ar_data).symdefs;
        arsym_end = arsyms.offset((*(*abfd).tdata.aout_ar_data).symdef_count as isize);
        arsym = arsyms;
        indx = 0 as libc::c_int as libc::c_uint;
        while arsym < arsym_end {
            let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
            let mut undefs_tail: *mut bfd_link_hash_entry = 0
                as *mut bfd_link_hash_entry;
            if !(*included.offset(indx as isize) != 0) {
                if needed as libc::c_int != 0 && (*arsym).file_offset == last_ar_offset {
                    *included.offset(indx as isize) = 1 as libc::c_int as libc::c_uchar;
                } else {
                    if ((*arsym).name).is_null() {
                        current_block = 2610133569117037248;
                        break 's_53;
                    }
                    h = bfd_link_hash_lookup(
                        (*info).hash,
                    ...
                    if h.is_null() && (*info).pei386_auto_import != 0
                        && startswith(
                            (*arsym).name,
                        ...
                        ) as libc::c_int != 0
                    {
                        h = bfd_link_hash_lookup(
                            (*info).hash,
                            ((*arsym).name).offset(6 as libc::c_int as isize),
                            0 as libc::c_int != 0,
                            0 as libc::c_int != 0,
                            1 as libc::c_int != 0,
                        );
                    ...
                    if !h.is_null() {
                                ...
                                != bfd_link_hash_common as libc::c_int
                        {
                            ...
                            {
                                *included
                                    .offset(indx as isize) = 1 as libc::c_int as libc::c_uchar;
                            }
                        } else {
                            ...
                            if !(Some(checkfn.expect("non-null function pointer")))
                                .expect(
                                    "non-null function pointer",
                                )(element, info, h, (*arsym).name, &mut needed)
                            {
                                current_block = 2610133569117037248;
                                break 's_53;
                            }
                            if needed {
                                ...
                                loop {
                                    *included
                                    ...
                                    mark;
                                    if !((*arsyms.offset(mark as isize)).file_offset
                                        == last_ar_offset)
                                    {
                                        break;
                                    }
...
unsafe extern "C" fn generic_link_check_archive_element(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut h: *mut bfd_link_hash_entry,
    ...
    let mut ppend: *mut *mut asymbol = 0 as *mut *mut asymbol;
    *pneeded = 0 as libc::c_int != 0;
    if !bfd_generic_link_read_symbols(abfd) {
        return 0 as libc::c_int != 0;
    }
    pp = (*abfd).outsymbols;
    ppend = pp.offset((*abfd).symcount as isize);
    while pp < ppend {
        let mut p: *mut asymbol = 0 as *mut asymbol;
        p = *pp;
                ...
                == 0 as libc::c_int as libc::c_uint)
        {
            ...
            if !(h.is_null()
                || (*h).type_0() as libc::c_int != bfd_link_hash_undefined as libc::c_int
                    && (*h).type_0() as libc::c_int
                        != bfd_link_hash_common as libc::c_int)
            {
                if !bfd_is_com_section((*p).section)
                        ...
                        && ((*h).u.undef.abfd).is_null()
                {
                    *pneeded = 1 as libc::c_int != 0;
                    if !(Some(
                        ...
                        .expect(
                            "non-null function pointer",
                        )(info, abfd, bfd_asymbol_name(p), &mut abfd)
                    {
                        return 0 as libc::c_int != 0;
                    }
                    return (Some(
                        ((*(*abfd).xvec)._bfd_link_add_symbols)
                            .expect("non-null function pointer"),
                    ))
                ...
                {
                    let mut symbfd: *mut bfd = 0 as *mut bfd;
                    let mut size: bfd_vma = 0;
                    let mut power: libc::c_uint = 0;
                    symbfd = (*h).u.undef.abfd;
                    (*h).set_type_0(bfd_link_hash_common);
                    (*h)
                        .u
                        .c
                        .p = bfd_hash_allocate(
                    ...
                    ) as *mut bfd_link_hash_common_entry;
                    if ((*h).u.c.p).is_null() {
                        return 0 as libc::c_int != 0;
                    }
                    ...
                    (*h).u.c.size = size;
                    power = bfd_log2(size);
                    if power > 4 as libc::c_int as libc::c_uint {
                    ...
                    {
                        (*(*h).u.c.p)
                            .section = bfd_make_section_old_way(
                            symbfd,
                    ...
                    (*(*(*h).u.c.p).section).flags |= 0x1 as libc::c_int as libc::c_uint;
                } else if bfd_asymbol_value(p) > (*h).u.c.size {
...
unsafe extern "C" fn generic_link_add_symbol_list(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut symbol_count: bfd_size_type,
    mut symbols: *mut *mut asymbol,
) -> bool {
    let mut pp: *mut *mut asymbol = 0 as *mut *mut asymbol;
    let mut ppend: *mut *mut asymbol = 0 as *mut *mut asymbol;
    pp = symbols;
    ppend = symbols.offset(symbol_count as isize);
    while pp < ppend {
        let mut p: *mut asymbol = 0 as *mut asymbol;
        p = *pp;
        if (*p).flags
            & ((1 as libc::c_int) << 13 as libc::c_int
                ...
                | (1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
            || bfd_is_und_section(bfd_asymbol_section(p)) as libc::c_int != 0
            || bfd_is_com_section(bfd_asymbol_section(p)) as libc::c_int != 0
            || bfd_is_ind_section(bfd_asymbol_section(p)) as libc::c_int != 0
        {
            let mut name: *const libc::c_char = 0 as *const libc::c_char;
            let mut string: *const libc::c_char = 0 as *const libc::c_char;
            let mut h: *mut generic_link_hash_entry = 0 as *mut generic_link_hash_entry;
            let mut bh: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
            name = bfd_asymbol_name(p);
            string = name;
            if ((*p).flags & ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
                || bfd_is_ind_section((*p).section) as libc::c_int != 0)
                && pp.offset(1 as libc::c_int as isize) < ppend
            {
                pp = pp.offset(1);
                pp;
            ...
            h = bh as *mut generic_link_hash_entry;
            if (*p).flags & ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
                && (h.is_null()
                    || ((*h).root).type_0() as libc::c_int
                        == bfd_link_hash_new as libc::c_int)
            {
                (*p).udata.p = 0 as *mut libc::c_void;
            } else {
                ...
                (*p).udata.p = h as *mut libc::c_void;
            }
        }
        pp = pp.offset(1);
        pp;
...
static mut link_action: [[link_action; 8]; 8] = [
...
unsafe extern "C" fn hash_entry_bfd(mut h: *mut bfd_link_hash_entry) -> *mut bfd {
    while (*h).type_0() as libc::c_int == bfd_link_hash_warning as libc::c_int {
        h = (*h).u.i.link;
    }
    match (*h).type_0() as libc::c_int {
        1 | 2 => return (*h).u.undef.abfd,
        3 | 4 => return (*(*h).u.def.section).owner,
        5 => return (*(*(*h).u.c.p).section).owner,
        _ => return 0 as *mut bfd,
    };
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_add_one_symbol(
    mut info: *mut bfd_link_info,
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut flags: flagword,
    ...
    mut copy: bool,
    mut collect: bool,
    mut hashp: *mut *mut bfd_link_hash_entry,
) -> bool {
    let mut row: link_row = UNDEF_ROW;
    let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    let mut inh: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
    ...
    if bfd_is_ind_section(section) as libc::c_int != 0
        || flags & ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
    {
        row = INDR_ROW;
        inh = bfd_wrapped_link_hash_lookup(
            abfd,
            info,
            string,
            1 as libc::c_int != 0,
    ...
    } else if flags & ((1 as libc::c_int) << 12 as libc::c_int) as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        row = WARN_ROW;
    } else if flags & ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        row = SET_ROW;
    } else if bfd_is_und_section(section) {
        if flags & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        {
            row = UNDEFW_ROW;
        } else {
    ...
    } else if flags & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        row = DEFW_ROW;
        ...
        if !((*info).type_0() as libc::c_int == type_relocatable as libc::c_int)
            && *name.offset(0 as libc::c_int as isize) as libc::c_int == '_' as i32
    ...
    if !hashp.is_null() && !(*hashp).is_null() {
        h = *hashp;
    } else {
        if row as libc::c_uint == UNDEF_ROW as libc::c_int as libc::c_uint
            || row as libc::c_uint == UNDEFW_ROW as libc::c_int as libc::c_uint
        {
        ...
        if h.is_null() {
            if !hashp.is_null() {
                *hashp = 0 as *mut bfd_link_hash_entry;
            }
            return 0 as libc::c_int != 0;
        }
    }
    if (*info).notice_all() as libc::c_int != 0
        || !((*info).notice_hash).is_null()
            && !(bfd_hash_lookup(
                (*info).notice_hash,
                name,
                0 as libc::c_int != 0,
                ...
                .is_null()
    {
        if !(Some(((*(*info).callbacks).notice).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(info, h, inh, abfd, section, value, flags)
        {
            return 0 as libc::c_int != 0;
        }
    }
    ...
    loop {
        let mut action: link_action = FAIL;
        let mut prev: libc::c_int = 0;
        prev = (*h).type_0() as libc::c_int;
        if (*h).ldscript_def() != 0 {
            prev = bfd_link_hash_undefined as libc::c_int;
        }
        cycle = 0 as libc::c_int != 0;
        action = link_action[row as libc::c_int as usize][prev as usize];
        ...
        match action as libc::c_uint {
            0 => {
                _bfd_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 174],
                    >(
                        b"_Bool _bfd_generic_link_add_one_symbol(struct bfd_link_info *, bfd *, const char *, flagword, asection *, bfd_vma, const char *, _Bool, _Bool, struct bfd_link_hash_entry **)\0",
                    ))
                        .as_ptr(),
                );
            }
            9 => {
                current_block_182 = 10975999085361321042;
            }
            1 => {
            ...
            8 => {
                ...
                (Some(
                    ((*(*info).callbacks).multiple_common)
                        .expect("non-null function pointer"),
                ))
                    .expect(
                        "non-null function pointer",
                    )(info, h, abfd, bfd_link_hash_defined, 0 as libc::c_int as bfd_vma);
                current_block_182 = 14126090490457861375;
            }
            3 | 4 => {
                current_block_182 = 14126090490457861375;
            }
            5 => {
                ...
                (*h)
                    ...
                    .p = bfd_hash_allocate(
                    &mut (*(*info).hash).table,
                    ::core::mem::size_of::<bfd_link_hash_common_entry>() as libc::c_ulong
                        as libc::c_uint,
                ) as *mut bfd_link_hash_common_entry;
                if ((*h).u.c.p).is_null() {
                    return 0 as libc::c_int != 0;
                        ...
                        .offset(0 as libc::c_int as isize) as *mut asection
                {
                    ...
                    (*(*h).u.c.p)
                        .section = bfd_make_section_old_way(abfd, (*section).name);
                    (*(*(*h).u.c.p).section).flags |= 0x1 as libc::c_int as libc::c_uint;
                } else {
                    (*(*h).u.c.p).section = section;
                }
                (*h).set_linker_def(0 as libc::c_int as libc::c_uint);
                (*h).set_ldscript_def(0 as libc::c_int as libc::c_uint);
                current_block_182 = 10975999085361321042;
            }
            6 => {
                if ((*h).u.undef.next).is_null() && (*(*info).hash).undefs_tail != h {
                    (*h).u.undef.next = h;
                }
                current_block_182 = 10975999085361321042;
            }
            10 => {
                ...
                if value > (*h).u.c.size {
                    let mut power_0: libc::c_uint = 0;
                    (*h).u.c.size = value;
                    power_0 = bfd_log2(value);
                    if power_0 > 4 as libc::c_int as libc::c_uint {
                        power_0 = 4 as libc::c_int as libc::c_uint;
                    }
                    (*(*h).u.c.p).alignment_power = power_0;
                    if section
                        == &mut *_bfd_std_section
                            .as_mut_ptr()
                            .offset(0 as libc::c_int as isize) as *mut asection
            ...
            12 => {
                if (*(*h).u.i.link).type_0() as libc::c_int
                    == bfd_link_hash_defweak as libc::c_int
                {
                    h = (*h).u.i.link;
                    cycle = 1 as libc::c_int != 0;
                    current_block_182 = 10975999085361321042;
                } else if strcmp((*(*h).u.i.link).root.string, string)
                    == 0 as libc::c_int
                {
                    current_block_182 = 10975999085361321042;
                } else {
                    current_block_182 = 2160748548890476216;
                }
            }
            11 => {
                current_block_182 = 2160748548890476216;
            ...
            14 => {
                ...
                current_block_182 = 7542517625116355092;
            }
            13 => {
                current_block_182 = 7542517625116355092;
            }
            15 => {
                (Some(
                    ((*(*info).callbacks).add_to_set).expect("non-null function pointer"),
                ))
                    .expect(
                        "non-null function pointer",
                    )(info, h, BFD_RELOC_CTOR, abfd, section, value);
                current_block_182 = 10975999085361321042;
            }
            20 => {
                if !((*h).u.i.warning).is_null()
                        ...
                        == 0 as libc::c_int as libc::c_uint
                {
                    ...
                    (*h).u.i.warning = 0 as *const libc::c_char;
                }
                current_block_182 = 4669440980677013693;
            }
            18 => {
                current_block_182 = 4669440980677013693;
            }
            ...
            17 => {
                if (*info).lto_plugin_active() == 0
                    && (!((*h).u.undef.next).is_null()
                        || (*(*info).hash).undefs_tail == h)
                    || (*h).non_ir_ref_regular() as libc::c_int != 0
                    || (*h).non_ir_ref_dynamic() as libc::c_int != 0
                {
                    (Some(
                        ((*(*info).callbacks).warning)
                            .expect("non-null function pointer"),
                    ...
                    current_block_182 = 10445752435246325618;
                }
            }
            16 => {
                current_block_182 = 10445752435246325618;
        ...
        match current_block_182 {
            ...
            7542517625116355092 => {
                if (*inh).type_0() as libc::c_int
                    == bfd_link_hash_indirect as libc::c_int && (*inh).u.i.link == h
                {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB: indirect symbol `%s' to `%s' is a loop\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        abfd,
                ...
                if (*inh).type_0() as libc::c_int == bfd_link_hash_new as libc::c_int {
                    (*inh).set_type_0(bfd_link_hash_undefined);
                ...
                (*h).set_type_0(bfd_link_hash_indirect);
                (*h).u.i.link = inh;
            }
            14126090490457861375 => {
                let mut oldtype: bfd_link_hash_type = bfd_link_hash_new;
                oldtype = (*h).type_0();
                if action as libc::c_uint == DEFW as libc::c_int as libc::c_uint {
                    (*h).set_type_0(bfd_link_hash_defweak);
                } else {
                    (*h).set_type_0(bfd_link_hash_defined);
                }
                (*h).u.def.section = section;
                (*h).u.def.value = value;
                (*h).set_linker_def(0 as libc::c_int as libc::c_uint);
                (*h).set_ldscript_def(0 as libc::c_int as libc::c_uint);
                if collect as libc::c_int != 0
                    && *name.offset(0 as libc::c_int as isize) as libc::c_int
                        == '_' as i32
                {
                    let mut s: *const libc::c_char = 0 as *const libc::c_char;
                    s = name.offset(1 as libc::c_int as isize);
                    while *s as libc::c_int == '_' as i32 {
                        s = s.offset(1);
                        s;
                    }
                    if *s.offset(0 as libc::c_int as isize) as libc::c_int == 'G' as i32
                        && startswith(
                            s,
                            b"GLOBAL_\0" as *const u8 as *const libc::c_char,
                        ) as libc::c_int != 0
                    {
                                    ...
                                    ) as libc::c_int
                        {
                            if oldtype as libc::c_uint
                                == bfd_link_hash_defweak as libc::c_int as libc::c_uint
                            {
                                _bfd_abort(
                                    b"linker.c\0" as *const u8 as *const libc::c_char,
                                    1554 as libc::c_int,
            ...
            2160748548890476216 => {
                (Some(
                    ...
                    .expect("non-null function pointer")(info, h, abfd, section, value);
            }
            10445752435246325618 => {
                let mut sub: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
                sub = (Some(
                    ((*(*info).hash).table.newfunc).expect("non-null function pointer"),
                ))
                    .expect(
                        "non-null function pointer",
                    )(
                ...
                *sub = *h;
                (*sub).set_type_0(bfd_link_hash_warning);
                (*sub).u.i.link = h;
                if !copy {
                    ...
                    memcpy(w as *mut libc::c_void, string as *const libc::c_void, len);
                    (*sub).u.i.warning = w;
                }
                bfd_hash_replace(
                    &mut (*(*info).hash).table,
                    h as *mut bfd_hash_entry,
                    sub as *mut bfd_hash_entry,
                );
                if !hashp.is_null() {
                    *hashp = sub;
                }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_final_link(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    ...
    let mut outsymalloc: size_t = 0;
    let mut wginfo: generic_write_global_symbol_info = generic_write_global_symbol_info {
        info: 0 as *mut bfd_link_info,
        output_bfd: 0 as *mut bfd,
        psymalloc: 0 as *mut size_t,
    };
    (*abfd).outsymbols = 0 as *mut *mut bfd_symbol;
    (*abfd).symcount = 0 as libc::c_int as libc::c_uint;
    outsymalloc = 0 as libc::c_int as size_t;
    o = (*abfd).sections;
    while !o.is_null() {
    ...
    sub = (*info).input_bfds;
    while !sub.is_null() {
        if !_bfd_generic_link_output_symbols(abfd, sub, info, &mut outsymalloc) {
            return 0 as libc::c_int != 0;
        }
        sub = (*sub).link.next;
    }
    ...
    wginfo.psymalloc = &mut outsymalloc;
    bfd_link_hash_traverse(
        &mut (*((*info).hash as *mut generic_link_hash_table)).root,
        ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(
                    *mut generic_link_hash_entry,
                    *mut libc::c_void,
                ) -> bool,
            >,
            Option::<
        ...
        &mut wginfo as *mut generic_write_global_symbol_info as *mut libc::c_void,
    );
    if !generic_add_output_symbol(abfd, &mut outsymalloc, 0 as *mut asymbol) {
        return 0 as libc::c_int != 0;
    }
    if (*info).type_0() as libc::c_int == type_relocatable as libc::c_int {
        o = (*abfd).sections;
        while !o.is_null() {
            ...
            while !p.is_null() {
                    ...
                    == bfd_indirect_link_order as libc::c_int as libc::c_uint
                {
                    ...
                    relocs = bfd_malloc(relsize as bfd_size_type) as *mut *mut arelent;
                    if relocs.is_null() && relsize != 0 as libc::c_int as libc::c_long {
                        return 0 as libc::c_int != 0;
                    }
                    ...
                    if !(reloc_count as libc::c_ulong
                        == (*input_section).reloc_count as libc::c_ulong)
                    {
                        bfd_assert(
                            b"linker.c\0" as *const u8 as *const libc::c_char,
                            1903 as libc::c_int,
                    ...
                    (*o)
                        .reloc_count = ((*o).reloc_count as libc::c_long + reloc_count)
                        as libc::c_uint;
                }
                p = (*p).next;
            }
            if (*o).reloc_count > 0 as libc::c_int as libc::c_uint {
                ...
                (*o).orelocation = bfd_alloc(abfd, amt) as *mut *mut reloc_cache_entry;
                if ((*o).orelocation).is_null() {
                    return 0 as libc::c_int != 0;
                }
    ...
    while !o.is_null() {
        ...
        while !p.is_null() {
            match (*p).type_0 as libc::c_uint {
                ...
                1 => {
                    if !default_indirect_link_order(
                        abfd,
                        info,
                        o,
                        p,
...
unsafe extern "C" fn generic_add_output_symbol(
    mut output_bfd: *mut bfd,
    mut psymalloc: *mut size_t,
    mut sym: *mut asymbol,
) -> bool {
    if bfd_get_symcount(output_bfd) as libc::c_ulong >= *psymalloc {
        let mut newsyms: *mut *mut asymbol = 0 as *mut *mut asymbol;
        let mut amt: bfd_size_type = 0;
        if *psymalloc == 0 as libc::c_int as libc::c_ulong {
            *psymalloc = 124 as libc::c_int as size_t;
        } else {
            *psymalloc = (*psymalloc as libc::c_ulong)
        ...
        amt = (amt as libc::c_ulong)
            ...
            as bfd_size_type as bfd_size_type;
        newsyms = bfd_realloc(bfd_get_outsymbols(output_bfd) as *mut libc::c_void, amt)
            as *mut *mut asymbol;
        if newsyms.is_null() {
            return 0 as libc::c_int != 0;
        }
    ...
    let ref mut fresh0 = *((*output_bfd).outsymbols)
        .offset((*output_bfd).symcount as isize);
    *fresh0 = sym;
    if !sym.is_null() {
        (*output_bfd).symcount = ((*output_bfd).symcount).wrapping_add(1);
        (*output_bfd).symcount;
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_output_symbols(
    mut output_bfd: *mut bfd,
    mut input_bfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut psymalloc: *mut size_t,
) -> bool {
    let mut sym_ptr: *mut *mut asymbol = 0 as *mut *mut asymbol;
    let mut sym_end: *mut *mut asymbol = 0 as *mut *mut asymbol;
    if !bfd_generic_link_read_symbols(input_bfd) {
        return 0 as libc::c_int != 0;
    }
    if !((*info).create_object_symbols_section).is_null() {
        let mut sec: *mut asection = 0 as *mut asection;
        sec = (*input_bfd).sections;
        while !sec.is_null() {
            if (*sec).output_section == (*info).create_object_symbols_section {
                let mut newsym: *mut asymbol = 0 as *mut asymbol;
                newsym = (Some(
                    ((*(*input_bfd).xvec)._bfd_make_empty_symbol)
                        .expect("non-null function pointer"),
                ))
                    .expect("non-null function pointer")(input_bfd);
                if newsym.is_null() {
                    return 0 as libc::c_int != 0;
                }
                (*newsym).name = bfd_get_filename(input_bfd);
                (*newsym).value = 0 as libc::c_int as symvalue;
                (*newsym)
                    .flags = ((1 as libc::c_int) << 0 as libc::c_int
                    | (1 as libc::c_int) << 14 as libc::c_int) as flagword;
                (*newsym).section = sec;
    ...
    sym_end = sym_ptr.offset((*input_bfd).symcount as isize);
    while sym_ptr < sym_end {
        let mut sym: *mut asymbol = 0 as *mut asymbol;
        let mut h: *mut generic_link_hash_entry = 0 as *mut generic_link_hash_entry;
        let mut output: bool = false;
        h = 0 as *mut generic_link_hash_entry;
        sym = *sym_ptr;
        if (*sym).flags
            & ((1 as libc::c_int) << 13 as libc::c_int
                | (1 as libc::c_int) << 12 as libc::c_int
            ...
            || bfd_is_ind_section(bfd_asymbol_section(sym)) as libc::c_int != 0
        {
            if !((*sym).udata.p).is_null() {
                h = (*sym).udata.p as *mut generic_link_hash_entry;
            } else if (*sym).flags
                ...
                != 0 as libc::c_int as libc::c_uint
            {
                ...
                h = bfd_wrapped_link_hash_lookup(
                    ...
                    0 as libc::c_int != 0,
                    1 as libc::c_int != 0,
                ) as *mut generic_link_hash_entry;
            } else {
                h = bfd_link_hash_lookup(
                    &mut (*((*info).hash as *mut generic_link_hash_table)).root,
                    bfd_asymbol_name(sym),
            ...
            if !h.is_null() {
                ...
                match ((*h).root).type_0() as libc::c_int {
                    1 => {
                        current_block_50 = 13678349939556791712;
                    }
                    2 => {
                        (*sym).flags
                            |= ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
                    ...
                    6 => {
                        h = (*h).root.u.i.link as *mut generic_link_hash_entry;
                        current_block_50 = 7138335370820640504;
                    }
                    3 => {
                        current_block_50 = 7138335370820640504;
                    }
                    ...
                    0 | _ => {
                        _bfd_abort(
                            ...
                            (*::core::mem::transmute::<
                                ...
                                &[libc::c_char; 87],
                            >(
                                b"_Bool _bfd_generic_link_output_symbols(bfd *, bfd *, struct bfd_link_info *, size_t *)\0",
                            ))
                                .as_ptr(),
                        );
                    }
        ...
        if (*sym).flags & ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint
            == 0 as libc::c_int as libc::c_uint
            && ((*info).strip() as libc::c_int == strip_all as libc::c_int
                || (*info).strip() as libc::c_int == strip_some as libc::c_int
                    && (bfd_hash_lookup(
                        (*info).keep_hash,
                        bfd_asymbol_name(sym),
                        0 as libc::c_int != 0,
            ...
            != 0 as libc::c_int as libc::c_uint
        {
            if bfd_asymbol_bfd(sym) == input_bfd
                && (*sym).flags
                    ...
                    != 0 as libc::c_int as libc::c_uint
            {
                output = 1 as libc::c_int != 0;
            } else {
                output = 0 as libc::c_int != 0;
            }
        } else if (*sym).flags & ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        {
            output = 1 as libc::c_int != 0;
        } else if bfd_is_ind_section((*sym).section) {
            output = 0 as libc::c_int != 0;
        } else if (*sym).flags & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        {
            if (*info).strip() as libc::c_int == strip_none as libc::c_int {
                output = 1 as libc::c_int != 0;
            } else {
                output = 0 as libc::c_int != 0;
            }
        } else if bfd_is_und_section((*sym).section) as libc::c_int != 0
            || bfd_is_com_section((*sym).section) as libc::c_int != 0
        {
            output = 0 as libc::c_int != 0;
        } else if (*sym).flags & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        {
            if (*sym).flags & ((1 as libc::c_int) << 12 as libc::c_int) as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
            {
                output = 0 as libc::c_int != 0;
            } else {
                let mut current_block_74: u64;
                match (*info).discard() as libc::c_int {
                    0 => {
                        output = 1 as libc::c_int != 0;
                                ...
                                & 0x800000 as libc::c_int as libc::c_uint == 0
                        {
                            ...
                            current_block_74 = 8186932200199541501;
                        }
                    }
                    2 => {
                        current_block_74 = 8186932200199541501;
        ...
        } else if (*sym).flags == 0 as libc::c_int as libc::c_uint
            && (*(*(*sym).section).owner).flags & 0x10000 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
        {
            output = 0 as libc::c_int != 0;
        } else {
...
unsafe extern "C" fn set_symbol_from_hash(
    mut sym: *mut asymbol,
    mut h: *mut bfd_link_hash_entry,
) {
    match (*h).type_0() as libc::c_int {
        ...
        _ => {
            _bfd_abort(
                ...
                (*::core::mem::transmute::<
                    ...
                    &[libc::c_char; 67],
                >(
                    b"void set_symbol_from_hash(asymbol *, struct bfd_link_hash_entry *)\0",
                ))
                    .as_ptr(),
            );
        }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_link_write_global_symbol(
    mut h: *mut generic_link_hash_entry,
    mut data: *mut libc::c_void,
) -> bool {
    let mut wginfo: *mut generic_write_global_symbol_info = data
        as *mut generic_write_global_symbol_info;
    let mut sym: *mut asymbol = 0 as *mut asymbol;
    if (*h).written {
        return 1 as libc::c_int != 0;
    }
    (*h).written = 1 as libc::c_int != 0;
    if (*(*wginfo).info).strip() as libc::c_int == strip_all as libc::c_int
        || (*(*wginfo).info).strip() as libc::c_int == strip_some as libc::c_int
            && (bfd_hash_lookup(
                (*(*wginfo).info).keep_hash,
                (*h).root.root.string,
                0 as libc::c_int != 0,
                0 as libc::c_int != 0,
            ))
    ...
    if !((*h).sym).is_null() {
        ...
        sym = (Some(
            ((*(*(*wginfo).output_bfd).xvec)._bfd_make_empty_symbol)
                .expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")((*wginfo).output_bfd);
        if sym.is_null() {
            return 0 as libc::c_int != 0;
        }
        (*sym).name = (*h).root.root.string;
        (*sym).flags = 0 as libc::c_int as flagword;
    }
    set_symbol_from_hash(sym, &mut (*h).root);
    ...
    if !generic_add_output_symbol((*wginfo).output_bfd, (*wginfo).psymalloc, sym) {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 86],
            >(
                b"_Bool _bfd_generic_link_write_global_symbol(struct generic_link_hash_entry *, void *)\0",
            ))
                .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_reloc_link_order(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut sec: *mut asection,
    ...
    if !((*info).type_0() as libc::c_int == type_relocatable as libc::c_int) {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                ...
                &[libc::c_char; 104],
            >(
                b"_Bool _bfd_generic_reloc_link_order(bfd *, struct bfd_link_info *, asection *, struct bfd_link_order *)\0",
            ))
                .as_ptr(),
        );
    }
    ...
    r = bfd_alloc(abfd, ::core::mem::size_of::<arelent>() as libc::c_ulong)
        as *mut arelent;
    if r.is_null() {
        return 0 as libc::c_int != 0;
    }
        ...
        == bfd_section_reloc_link_order as libc::c_int as libc::c_uint
    {
        ...
        (*r).sym_ptr_ptr = &mut (*h).sym;
    }
    if (*(*r).howto).partial_inplace() == 0 {
        ...
        size = bfd_get_reloc_size((*r).howto) as bfd_size_type;
        ...
        loc = ((*link_order).offset)
            .wrapping_mul(bfd_octets_per_byte(abfd, sec) as libc::c_ulong) as file_ptr;
        ok = bfd_set_section_contents(abfd, sec, buf as *const libc::c_void, loc, size);
        free(buf as *mut libc::c_void);
        if !ok {
            return 0 as libc::c_int != 0;
        }
        (*r).addend = 0 as libc::c_int as bfd_vma;
    }
    let ref mut fresh1 = *((*sec).orelocation).offset((*sec).reloc_count as isize);
    *fresh1 = r;
    (*sec).reloc_count = ((*sec).reloc_count).wrapping_add(1);
    (*sec).reloc_count;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_new_link_order(
    mut abfd: *mut bfd,
    mut section: *mut asection,
) -> *mut bfd_link_order {
    let mut amt: size_t = ::core::mem::size_of::<bfd_link_order>() as libc::c_ulong;
    let mut new_lo: *mut bfd_link_order = 0 as *mut bfd_link_order;
    new_lo = bfd_zalloc(abfd, amt) as *mut bfd_link_order;
    if new_lo.is_null() {
        return 0 as *mut bfd_link_order;
    }
    (*new_lo).type_0 = bfd_undefined_link_order;
    if !((*section).map_tail.link_order).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_default_link_order(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut sec: *mut asection,
    mut link_order: *mut bfd_link_order,
) -> bool {
    match (*link_order).type_0 as libc::c_uint {
        1 => {
            return default_indirect_link_order(
                abfd,
                info,
                sec,
                link_order,
        ...
        2 => return default_data_link_order(abfd, info, sec, link_order),
        0 | 3 | 4 | _ => {
            _bfd_abort(
                b"linker.c\0" as *const u8 as *const libc::c_char,
                2469 as libc::c_int,
                (*::core::mem::transmute::<
                    ...
                    &[libc::c_char; 98],
                >(
                    b"_Bool _bfd_default_link_order(bfd *, struct bfd_link_info *, asection *, struct bfd_link_order *)\0",
                ))
                    .as_ptr(),
            );
        }
...
unsafe extern "C" fn default_data_link_order(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut sec: *mut asection,
    mut link_order: *mut bfd_link_order,
    ...
    let mut size: bfd_size_type = 0;
    let mut fill_size: size_t = 0;
    let mut fill: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut loc: file_ptr = 0;
    let mut result: bool = false;
    if !((*sec).flags & 0x100 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint)
    {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
    ...
    fill_size = (*link_order).u.data.size as size_t;
    if fill_size == 0 as libc::c_int as libc::c_ulong {
        fill = ((*(*abfd).arch_info).fill)
            .expect(
                "non-null function pointer",
            )(
            size,
        ...
        fill = bfd_malloc(size) as *mut bfd_byte;
        if fill.is_null() {
            return 0 as libc::c_int != 0;
        }
        p = fill;
        if fill_size == 1 as libc::c_int as libc::c_ulong {
            memset(
                ...
                *((*link_order).u.data.contents).offset(0 as libc::c_int as isize)
                    as libc::c_int,
                size,
            );
        } else {
            loop {
                memcpy(
                    p as *mut libc::c_void,
                    (*link_order).u.data.contents as *const libc::c_void,
                    fill_size,
                );
                p = p.offset(fill_size as isize);
                size = (size as libc::c_ulong).wrapping_sub(fill_size) as bfd_size_type
                    as bfd_size_type;
                if !(size >= fill_size) {
                    break;
                }
    ...
    loc = ((*link_order).offset)
        .wrapping_mul(bfd_octets_per_byte(abfd, sec) as libc::c_ulong) as file_ptr;
    result = bfd_set_section_contents(abfd, sec, fill as *const libc::c_void, loc, size);
    if fill != (*link_order).u.data.contents {
        free(fill as *mut libc::c_void);
    }
    return result;
}
unsafe extern "C" fn default_indirect_link_order(
    mut output_bfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut output_section: *mut asection,
    mut link_order: *mut bfd_link_order,
    mut generic_linker: bool,
) -> bool {
    let mut current_block: u64;
    let mut input_section: *mut asection = 0 as *mut asection;
    let mut input_bfd: *mut bfd = 0 as *mut bfd;
    ...
    let mut loc: file_ptr = 0;
    if !((*output_section).flags & 0x100 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint)
    {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
    ...
    input_bfd = (*input_section).owner;
    if (*input_section).size == 0 as libc::c_int as libc::c_ulong {
        return 1 as libc::c_int != 0;
    }
    if !((*input_section).output_section == output_section) {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            2562 as libc::c_int,
        );
    }
    if !((*input_section).output_offset == (*link_order).offset) {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            2563 as libc::c_int,
        );
    }
    if !((*input_section).size == (*link_order).size) {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            2564 as libc::c_int,
        );
    ...
    if (*info).type_0() as libc::c_int == type_relocatable as libc::c_int
        && (*input_section).reloc_count > 0 as libc::c_int as libc::c_uint
        && ((*output_section).orelocation).is_null()
    {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"attempt to do relocatable link with %s input and %s output\0"
    ...
    if !generic_linker {
        ...
        let mut symppend: *mut *mut asymbol = 0 as *mut *mut asymbol;
        if !bfd_generic_link_read_symbols(input_bfd) {
            return 0 as libc::c_int != 0;
        }
        sympp = (*input_bfd).outsymbols;
        symppend = sympp.offset((*input_bfd).symcount as isize);
        while sympp < symppend {
            let mut sym: *mut asymbol = 0 as *mut asymbol;
            let mut h: *mut bfd_link_hash_entry = 0 as *mut bfd_link_hash_entry;
            sym = *sympp;
            if (*sym).flags
            ...
            {
                if !((*sym).udata.p).is_null() {
                    h = (*sym).udata.p as *mut bfd_link_hash_entry;
                } else if bfd_is_und_section(bfd_asymbol_section(sym)) {
                    h = bfd_wrapped_link_hash_lookup(
                        output_bfd,
                        info,
    ...
    if (*output_section).flags
        ...
        && (*input_section).size != 0 as libc::c_int as libc::c_ulong
    {
        if (*output_bfd).output_has_begun() == 0 {
            if !bfd_set_section_contents(
                ...
                current_block = 7217793385600312838;
            } else {
        ...
        match current_block {
            ...
            _ => {
                ...
                if !((*input_section).output_offset == 0 as libc::c_int as libc::c_ulong)
                {
                    bfd_assert(
                        b"linker.c\0" as *const u8 as *const libc::c_char,
                        2648 as libc::c_int,
        ...
        sec_size = if (*input_section).rawsize > (*input_section).size {
            (*input_section).rawsize
        } else {
            (*input_section).size
        };
        contents = bfd_malloc(sec_size) as *mut bfd_byte;
        if contents.is_null() && sec_size != 0 as libc::c_int as libc::c_ulong {
            current_block = 7217793385600312838;
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_count_link_order_relocs(
    mut link_order: *mut bfd_link_order,
) -> libc::c_uint {
...
static mut _bfd_section_already_linked_table: bfd_hash_table = bfd_hash_table {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_section_already_linked_table_traverse(
    mut func: Option::<
        unsafe extern "C" fn(
    ...
    bfd_hash_traverse(
        &mut _bfd_section_already_linked_table,
        ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(
                    *mut bfd_section_already_linked_hash_entry,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_section_already_linked_table_lookup(
    mut name: *const libc::c_char,
) -> *mut bfd_section_already_linked_hash_entry {
    return bfd_hash_lookup(
        &mut _bfd_section_already_linked_table,
        name,
        1 as libc::c_int != 0,
        0 as libc::c_int != 0,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_section_already_linked_table_insert(
    mut already_linked_list: *mut bfd_section_already_linked_hash_entry,
    mut sec: *mut asection,
) -> bool {
    let mut l: *mut bfd_section_already_linked = 0 as *mut bfd_section_already_linked;
    l = bfd_hash_allocate(
        &mut _bfd_section_already_linked_table,
        ::core::mem::size_of::<bfd_section_already_linked>() as libc::c_ulong
            as libc::c_uint,
    ) as *mut bfd_section_already_linked;
    if l.is_null() {
        return 0 as libc::c_int != 0;
    }
    (*l).sec = sec;
...
unsafe extern "C" fn already_linked_newfunc(
    ...
    let mut ret: *mut bfd_section_already_linked_hash_entry = bfd_hash_allocate(
        table,
        ::core::mem::size_of::<bfd_section_already_linked_hash_entry>() as libc::c_ulong
            as libc::c_uint,
    ) as *mut bfd_section_already_linked_hash_entry;
    if ret.is_null() {
        return 0 as *mut bfd_hash_entry;
    }
    (*ret).entry = 0 as *mut bfd_section_already_linked;
    return &mut (*ret).root;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_section_already_linked_table_init() -> bool {
    return bfd_hash_table_init_n(
        &mut _bfd_section_already_linked_table,
        Some(
...
#[no_mangle]
pub unsafe extern "C" fn bfd_section_already_linked_table_free() {
    bfd_hash_table_free(&mut _bfd_section_already_linked_table);
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_handle_already_linked(
    mut sec: *mut asection,
    mut l: *mut bfd_section_already_linked,
    mut info: *mut bfd_link_info,
) -> bool {
    match (*sec).flags & 0xc0000 as libc::c_int as libc::c_uint {
        0 => {
            if (*(*sec).owner).lto_output() as libc::c_int != 0
        ...
        262144 => {
            ((*(*info).callbacks).einfo)
                ...
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: ignoring duplicate section `%pA'\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                (*sec).owner,
        ...
        524288 => {
            if !((*(*(*l).sec).owner).flags & 0x10000 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint)
            {
                if (*sec).size != (*(*l).sec).size {
                    ((*(*info).callbacks).einfo)
                        ...
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB: duplicate section `%pA' has different size\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*sec).owner,
        ...
        786432 => {
                ...
                != 0 as libc::c_int as libc::c_uint)
            {
                if (*sec).size != (*(*l).sec).size {
                ...
                } else if (*sec).size != 0 as libc::c_int as libc::c_ulong {
                    let mut sec_contents: *mut bfd_byte = 0 as *mut bfd_byte;
                    let mut l_sec_contents: *mut bfd_byte = 0 as *mut bfd_byte;
                    if !bfd_malloc_and_get_section(
                        ...
                        ((*(*info).callbacks).einfo)
                            ...
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"%pB: could not read contents of section `%pA'\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            (*sec).owner,
                    ...
                    } else if !bfd_malloc_and_get_section(
                        (*(*l).sec).owner,
                        (*l).sec,
                        &mut l_sec_contents,
                    ) {
                        ...
                        sec_contents as *const libc::c_void,
                        l_sec_contents as *const libc::c_void,
                        (*sec).size,
                    ) != 0 as libc::c_int
                    {
                        ((*(*info).callbacks).einfo)
                            ...
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"%pB: duplicate section `%pA' has different contents\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            (*sec).owner,
                    ...
                    free(sec_contents as *mut libc::c_void);
                    free(l_sec_contents as *mut libc::c_void);
                }
            }
        }
        _ => {
            _bfd_abort(
                ...
                (*::core::mem::transmute::<
                    ...
                    &[libc::c_char; 106],
                >(
                    b"_Bool _bfd_handle_already_linked(asection *, struct bfd_section_already_linked *, struct bfd_link_info *)\0",
                ))
                    .as_ptr(),
            );
        }
...
pub unsafe extern "C" fn _bfd_generic_section_already_linked(
    ...
    let mut already_linked_list: *mut bfd_section_already_linked_hash_entry = 0
        as *mut bfd_section_already_linked_hash_entry;
    if (*sec).flags & 0x20000 as libc::c_int as libc::c_uint
        == 0 as libc::c_int as libc::c_uint
    {
        return 0 as libc::c_int != 0;
    }
    if (*sec).flags & 0x2000000 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        return 0 as libc::c_int != 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_nearby_section(
    mut obfd: *mut bfd,
    mut s: *mut asection,
    mut addr: bfd_vma,
) -> *mut bfd_section {
    let mut next: *mut asection = 0 as *mut asection;
    let mut prev: *mut asection = 0 as *mut asection;
    let mut best: *mut asection = 0 as *mut asection;
    prev = (*s).prev;
    while !prev.is_null() {
        if (*prev).flags & 0x8000 as libc::c_int as libc::c_uint
            == 0 as libc::c_int as libc::c_uint
    ...
    while !next.is_null() {
        if (*next).flags & 0x8000 as libc::c_int as libc::c_uint
            == 0 as libc::c_int as libc::c_uint
    ...
    if prev.is_null() {
        if next.is_null() {
            best = &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection;
        }
    } else if next.is_null() {
        best = prev;
    } else if ((*prev).flags ^ (*next).flags)
        & (0x1 as libc::c_int | 0x400 as libc::c_int | 0x2 as libc::c_int)
            as libc::c_uint != 0 as libc::c_int as libc::c_uint
    {
        if ((*next).flags ^ (*s).flags)
            & (0x1 as libc::c_int | 0x400 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
            || (*prev).flags & 0x2 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
                && (*next).flags & 0x2 as libc::c_int as libc::c_uint
                    == 0 as libc::c_int as libc::c_uint
        {
            best = prev;
        }
    } else if ((*prev).flags ^ (*next).flags) & 0x8 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        if ((*next).flags ^ (*s).flags) & 0x8 as libc::c_int as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        {
            best = prev;
        }
    } else if ((*prev).flags ^ (*next).flags) & 0x10 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        if ((*next).flags ^ (*s).flags) & 0x10 as libc::c_int as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
        {
            best = prev;
        }
    } else if addr < (*next).vma {
        best = prev;
    }
    return best;
}
unsafe extern "C" fn fix_syms(
    mut h: *mut bfd_link_hash_entry,
    mut data: *mut libc::c_void,
) -> bool {
    let mut obfd: *mut bfd = data as *mut bfd;
    if (*h).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
        || (*h).type_0() as libc::c_int == bfd_link_hash_defweak as libc::c_int
    {
        let mut s: *mut asection = (*h).u.def.section;
        if !s.is_null() && !((*s).output_section).is_null()
            && (*(*s).output_section).flags & 0x8000 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
            && bfd_section_removed_from_list(obfd, (*s).output_section) as libc::c_int
                != 0
        {
            let mut op: *mut asection = 0 as *mut asection;
            (*h)
                .u
                .def
                .value = ((*h).u.def.value as libc::c_ulong)
                .wrapping_add(
                    ((*s).output_offset).wrapping_add((*(*s).output_section).vma),
                ) as bfd_vma as bfd_vma;
            op = _bfd_nearby_section(obfd, (*s).output_section, (*h).u.def.value);
            (*h)
                .u
                .def
                .value = ((*h).u.def.value as libc::c_ulong).wrapping_sub((*op).vma)
                as bfd_vma as bfd_vma;
            (*h).u.def.section = op;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_fix_excluded_sec_syms(
    mut obfd: *mut bfd,
    mut info: *mut bfd_link_info,
) {
    bfd_link_hash_traverse(
...
pub unsafe extern "C" fn bfd_generic_define_common_symbol(
    ...
    let mut alignment: bfd_vma = 0;
    let mut size: bfd_vma = 0;
    let mut section: *mut asection = 0 as *mut asection;
    if !(!h.is_null()
        && (*h).type_0() as libc::c_int == bfd_link_hash_common as libc::c_int)
    {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            3100 as libc::c_int,
    ...
    if power_of_two != 0 {
        ...
        alignment = 1 as libc::c_int as bfd_vma;
    }
    if !(alignment != 0 as libc::c_int as libc::c_ulong
        && alignment & alignment.wrapping_neg() == alignment)
    {
        bfd_assert(
            b"linker.c\0" as *const u8 as *const libc::c_char,
            3114 as libc::c_int,
    ...
    (*section)
        .size = ((*section).size as libc::c_ulong)
        .wrapping_add(alignment.wrapping_sub(1 as libc::c_int as libc::c_ulong))
        as bfd_size_type as bfd_size_type;
    (*section).size &= alignment.wrapping_neg();
    ...
    (*section)
        .size = ((*section).size as libc::c_ulong).wrapping_add(size) as bfd_size_type
        as bfd_size_type;
    (*section).flags |= 0x1 as libc::c_int as libc::c_uint;
    (*section).flags &= !(0x1000 as libc::c_int | 0x100 as libc::c_int) as libc::c_uint;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
...
pub unsafe extern "C" fn bfd_generic_define_start_stop(
    ...
    if !h.is_null() && (*h).ldscript_def() == 0
        && ((*h).type_0() as libc::c_int == bfd_link_hash_undefined as libc::c_int
            || (*h).type_0() as libc::c_int == bfd_link_hash_undefweak as libc::c_int)
    {
        (*h).set_type_0(bfd_link_hash_defined);
        (*h).u.def.section = sec;
        (*h).u.def.value = 0 as libc::c_int as bfd_vma;
        return h;
    }
    return 0 as *mut bfd_link_hash_entry;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_find_version_for_sym(
    mut verdefs: *mut bfd_elf_version_tree,
    mut sym_name: *const libc::c_char,
    mut hide: *mut bool,
) -> *mut bfd_elf_version_tree {
    let mut t: *mut bfd_elf_version_tree = 0 as *mut bfd_elf_version_tree;
    let mut local_ver: *mut bfd_elf_version_tree = 0 as *mut bfd_elf_version_tree;
    let mut global_ver: *mut bfd_elf_version_tree = 0 as *mut bfd_elf_version_tree;
    let mut exist_ver: *mut bfd_elf_version_tree = 0 as *mut bfd_elf_version_tree;
    let mut star_local_ver: *mut bfd_elf_version_tree = 0 as *mut bfd_elf_version_tree;
    let mut star_global_ver: *mut bfd_elf_version_tree = 0 as *mut bfd_elf_version_tree;
    local_ver = 0 as *mut bfd_elf_version_tree;
    global_ver = 0 as *mut bfd_elf_version_tree;
    star_local_ver = 0 as *mut bfd_elf_version_tree;
    star_global_ver = 0 as *mut bfd_elf_version_tree;
    exist_ver = 0 as *mut bfd_elf_version_tree;
    t = verdefs;
    while !t.is_null() {
        if !((*t).globals.list).is_null() {
            ...
            loop {
                d = (Some(((*t).match_0).expect("non-null function pointer")))
                    .expect("non-null function pointer")(&mut (*t).globals, d, sym_name);
                if d.is_null() {
                    break;
                }
                if (*d).literal() as libc::c_int != 0
                    || strcmp((*d).pattern, b"*\0" as *const u8 as *const libc::c_char)
                        != 0 as libc::c_int
                {
                    global_ver = t;
                } else {
                ...
                (*d).set_script(1 as libc::c_int as libc::c_uint);
                if (*d).literal() != 0 {
                    break;
                }
            }
        ...
        if !((*t).locals.list).is_null() {
            let mut d_0: *mut bfd_elf_version_expr = 0 as *mut bfd_elf_version_expr;
            loop {
                d_0 = (Some(((*t).match_0).expect("non-null function pointer")))
                    .expect(
                        "non-null function pointer",
                    )(&mut (*t).locals, d_0, sym_name);
                if d_0.is_null() {
                    break;
                }
                if (*d_0).literal() as libc::c_int != 0
                    || strcmp((*d_0).pattern, b"*\0" as *const u8 as *const libc::c_char)
                        != 0 as libc::c_int
                {
                    local_ver = t;
                } else {
    ...
    if global_ver.is_null() && local_ver.is_null() {
        global_ver = star_global_ver;
    }
    if !global_ver.is_null() {
        *hide = exist_ver == global_ver;
        return global_ver;
    }
    if local_ver.is_null() {
    ...
    return 0 as *mut bfd_elf_version_tree;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_hide_sym_by_version(
    mut verdefs: *mut bfd_elf_version_tree,
    mut sym_name: *const libc::c_char,
) -> bool {
    let mut hidden: bool = 0 as libc::c_int != 0;
    bfd_find_version_for_sym(verdefs, sym_name, &mut hidden);
    return hidden;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_link_check_relocs(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    return (Some(
        ((*(*abfd).xvec)._bfd_link_check_relocs).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, info);
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_verify_endian_match(
    mut ibfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
            ...
            != BFD_ENDIAN_UNKNOWN as libc::c_int as libc::c_uint
    {
        if bfd_big_endian(ibfd) {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: compiled for a big endian system and target is little endian\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ibfd,
            ...
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: compiled for a little endian system and target is big endian\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ibfd,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_nolink_bfd_link_hash_table_create(
    mut abfd: *mut bfd,
) -> *mut bfd_link_hash_table {
    return _bfd_ptr_bfd_null_error(abfd) as *mut bfd_link_hash_table;
}
#[no_mangle]
