...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct bfd_strtab_hash {
    pub table: bfd_hash_table,
    pub size: bfd_size_type,
    pub first: *mut strtab_hash_entry,
    pub last: *mut strtab_hash_entry,
    pub length_field_size: libc::c_char,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct strtab_hash_entry {
    pub root: bfd_hash_entry,
    pub index: bfd_size_type,
    pub next: *mut strtab_hash_entry,
}
static mut primes: [libc::c_ulong; 28] = [0; 28];
unsafe extern "C" fn higher_prime_number(mut n: libc::c_ulong) -> libc::c_ulong {
    let mut low: *const libc::c_ulong = &*primes
        .as_ptr()
        .offset(0 as libc::c_int as isize) as *const libc::c_ulong;
    let mut high: *const libc::c_ulong = &*primes
        .as_ptr()
        .offset(
            (::core::mem::size_of::<[libc::c_ulong; 28]>() as libc::c_ulong)
                .wrapping_div(::core::mem::size_of::<libc::c_ulong>() as libc::c_ulong)
                as isize,
        ) as *const libc::c_ulong;
    while low != high {
        let mut mid: *const libc::c_ulong = low
            .offset(
                (high.offset_from(low) as libc::c_long
                    / 2 as libc::c_int as libc::c_long) as isize,
            );
        if n >= *mid {
            low = mid.offset(1 as libc::c_int as isize);
        } else {
            high = mid;
        }
    }
...
static mut bfd_default_hash_table_size: libc::c_ulong = 4051 as libc::c_int
    as libc::c_ulong;
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_table_init_n(
    ...
    let mut alloc: libc::c_ulong = 0;
    alloc = size as libc::c_ulong;
    alloc = alloc
        .wrapping_mul(::core::mem::size_of::<*mut bfd_hash_entry>() as libc::c_ulong);
    if alloc.wrapping_div(::core::mem::size_of::<*mut bfd_hash_entry>() as libc::c_ulong)
        != size as libc::c_ulong
    {
        bfd_set_error(bfd_error_no_memory);
        return 0 as libc::c_int != 0;
    }
    (*table).memory = objalloc_create() as *mut libc::c_void;
    if ((*table).memory).is_null() {
        bfd_set_error(bfd_error_no_memory);
        return 0 as libc::c_int != 0;
    }
    (*table)
        ...
        let mut __len: libc::c_ulong = alloc;
    ...
    memset((*table).table as *mut libc::c_void, 0 as libc::c_int, alloc);
    (*table).size = size;
    (*table).entsize = entsize;
    (*table).count = 0 as libc::c_int as libc::c_uint;
    (*table).set_frozen(0 as libc::c_int as libc::c_uint);
    (*table).newfunc = newfunc;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_table_init(
    mut table: *mut bfd_hash_table,
    mut newfunc: Option::<
        unsafe extern "C" fn(
            *mut bfd_hash_entry,
    ...
    return bfd_hash_table_init_n(
        ...
        newfunc,
        entsize,
        bfd_default_hash_table_size as libc::c_uint,
    );
}
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_table_free(mut table: *mut bfd_hash_table) {
    objalloc_free((*table).memory as *mut objalloc);
    (*table).memory = 0 as *mut libc::c_void;
}
#[inline]
unsafe extern "C" fn bfd_hash_hash(
    ...
    if string.is_null() {
        bfd_assert(b"hash.c\0" as *const u8 as *const libc::c_char, 438 as libc::c_int);
    }
    ...
    len = (s.offset_from(string as *const libc::c_uchar) as libc::c_long
...
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_lookup(
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
    mut create: bool,
    mut copy: bool,
    ...
    let mut hash: libc::c_ulong = 0;
    let mut hashp: *mut bfd_hash_entry = 0 as *mut bfd_hash_entry;
    let mut len: libc::c_uint = 0;
    let mut _index: libc::c_uint = 0;
    hash = bfd_hash_hash(string, &mut len);
    _index = hash.wrapping_rem((*table).size as libc::c_ulong) as libc::c_uint;
    hashp = *((*table).table).offset(_index as isize);
    while !hashp.is_null() {
        if (*hashp).hash == hash && strcmp((*hashp).string, string) == 0 as libc::c_int {
            return hashp;
        }
        hashp = (*hashp).next;
    }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_insert(
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
    mut hash: libc::c_ulong,
) -> *mut bfd_hash_entry {
    let mut hashp: *mut bfd_hash_entry = 0 as *mut bfd_hash_entry;
    let mut _index: libc::c_uint = 0;
    hashp = (Some(((*table).newfunc).expect("non-null function pointer")))
        .expect("non-null function pointer")(0 as *mut bfd_hash_entry, table, string);
    if hashp.is_null() {
        return 0 as *mut bfd_hash_entry;
    }
    (*hashp).string = string;
    (*hashp).hash = hash;
    _index = hash.wrapping_rem((*table).size as libc::c_ulong) as libc::c_uint;
    (*hashp).next = *((*table).table).offset(_index as isize);
    let ref mut fresh1 = *((*table).table).offset(_index as isize);
    *fresh1 = hashp;
    (*table).count = ((*table).count).wrapping_add(1);
    (*table).count;
    if (*table).frozen() == 0
        && (*table).count
            > ((*table).size)
    ...
    {
        let mut newsize: libc::c_ulong = higher_prime_number(
            (*table).size as libc::c_ulong,
        );
        let mut newtable: *mut *mut bfd_hash_entry = 0 as *mut *mut bfd_hash_entry;
        let mut hi: libc::c_uint = 0;
        let mut alloc: libc::c_ulong = newsize
            .wrapping_mul(
        ...
        {
            (*table).set_frozen(1 as libc::c_int as libc::c_uint);
            return hashp;
        }
        newtable = ({
            let mut __o: *mut objalloc = (*table).memory as *mut objalloc;
        ...
        memset(newtable as *mut libc::c_void, 0 as libc::c_int, alloc);
        hi = 0 as libc::c_int as libc::c_uint;
        while hi < (*table).size {
            while !(*((*table).table).offset(hi as isize)).is_null() {
                let mut chain: *mut bfd_hash_entry = *((*table).table)
                    .offset(hi as isize);
                let mut chain_end: *mut bfd_hash_entry = chain;
                while !((*chain_end).next).is_null()
                    && (*(*chain_end).next).hash == (*chain).hash
                {
                    chain_end = (*chain_end).next;
                }
                let ref mut fresh2 = *((*table).table).offset(hi as isize);
                *fresh2 = (*chain_end).next;
                _index = ((*chain).hash).wrapping_rem(newsize) as libc::c_uint;
                (*chain_end).next = *newtable.offset(_index as isize);
                let ref mut fresh3 = *newtable.offset(_index as isize);
                *fresh3 = chain;
            }
        ...
        (*table).size = newsize as libc::c_uint;
    }
    return hashp;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_rename(
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
    mut ent: *mut bfd_hash_entry,
) {
    let mut _index: libc::c_uint = 0;
    let mut pph: *mut *mut bfd_hash_entry = 0 as *mut *mut bfd_hash_entry;
    _index = ((*ent).hash).wrapping_rem((*table).size as libc::c_ulong) as libc::c_uint;
    pph = &mut *((*table).table).offset(_index as isize) as *mut *mut bfd_hash_entry;
    while !(*pph).is_null() {
        if *pph == ent {
            break;
        }
    ...
    if (*pph).is_null() {
        _bfd_abort(
            b"hash.c\0" as *const u8 as *const libc::c_char,
            580 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 85],
                &[libc::c_char; 85],
            >(
                b"void bfd_hash_rename(struct bfd_hash_table *, const char *, struct bfd_hash_entry *)\0",
            ))
                .as_ptr(),
        );
    }
    *pph = (*ent).next;
    (*ent).string = string;
    (*ent).hash = bfd_hash_hash(string, 0 as *mut libc::c_uint);
    _index = ((*ent).hash).wrapping_rem((*table).size as libc::c_ulong) as libc::c_uint;
    (*ent).next = *((*table).table).offset(_index as isize);
    let ref mut fresh4 = *((*table).table).offset(_index as isize);
    *fresh4 = ent;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_replace(
    mut table: *mut bfd_hash_table,
    mut old: *mut bfd_hash_entry,
    mut nw: *mut bfd_hash_entry,
) {
    let mut _index: libc::c_uint = 0;
    let mut pph: *mut *mut bfd_hash_entry = 0 as *mut *mut bfd_hash_entry;
    _index = ((*old).hash).wrapping_rem((*table).size as libc::c_ulong) as libc::c_uint;
    pph = &mut *((*table).table).offset(_index as isize) as *mut *mut bfd_hash_entry;
    while !(*pph).is_null() {
        if *pph == old {
            *pph = nw;
    ...
    _bfd_abort(
        ...
        (*::core::mem::transmute::<
            ...
            &[libc::c_char; 97],
        >(
            b"void bfd_hash_replace(struct bfd_hash_table *, struct bfd_hash_entry *, struct bfd_hash_entry *)\0",
        ))
            .as_ptr(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_allocate(
    mut table: *mut bfd_hash_table,
    mut size: libc::c_uint,
) -> *mut libc::c_void {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_traverse(
    mut table: *mut bfd_hash_table,
    mut func: Option::<
    ...
    's_7: while i < (*table).size {
        let mut p: *mut bfd_hash_entry = 0 as *mut bfd_hash_entry;
        p = *((*table).table).offset(i as isize);
        while !p.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_hash_set_default_size(
    mut hash_size: libc::c_ulong,
) -> libc::c_ulong {
    let mut silly_size: libc::c_ulong = (if ::core::mem::size_of::<size_t>()
    ...
    } else if hash_size != 0 as libc::c_int as libc::c_ulong {
        hash_size = hash_size.wrapping_sub(1);
        hash_size;
    }
    hash_size = higher_prime_number(hash_size);
    if !(hash_size != 0 as libc::c_int as libc::c_ulong) {
        bfd_assert(b"hash.c\0" as *const u8 as *const libc::c_char, 677 as libc::c_int);
    }
    bfd_default_hash_table_size = hash_size;
    return bfd_default_hash_table_size;
}
unsafe extern "C" fn strtab_hash_newfunc(
    mut entry: *mut bfd_hash_entry,
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
) -> *mut bfd_hash_entry {
    let mut ret: *mut strtab_hash_entry = entry as *mut strtab_hash_entry;
    if ret.is_null() {
        ret = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<strtab_hash_entry>() as libc::c_ulong as libc::c_uint,
        ) as *mut strtab_hash_entry;
    }
    if ret.is_null() {
        return 0 as *mut bfd_hash_entry;
    }
    ret = bfd_hash_newfunc(ret as *mut bfd_hash_entry, table, string)
        as *mut strtab_hash_entry;
    if !ret.is_null() {
        (*ret).index = -(1 as libc::c_int) as bfd_size_type;
        (*ret).next = 0 as *mut strtab_hash_entry;
    }
    return ret as *mut bfd_hash_entry;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_stringtab_init() -> *mut bfd_strtab_hash {
    let mut table: *mut bfd_strtab_hash = 0 as *mut bfd_strtab_hash;
    let mut amt: size_t = ::core::mem::size_of::<bfd_strtab_hash>() as libc::c_ulong;
    table = bfd_malloc(amt) as *mut bfd_strtab_hash;
    if table.is_null() {
        return 0 as *mut bfd_strtab_hash;
    }
    ...
    (*table).first = 0 as *mut strtab_hash_entry;
    (*table).last = 0 as *mut strtab_hash_entry;
    (*table).length_field_size = 0 as libc::c_int as libc::c_char;
    return table;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_xcoff_stringtab_init(
    mut isxcoff64: bool,
) -> *mut bfd_strtab_hash {
    let mut ret: *mut bfd_strtab_hash = 0 as *mut bfd_strtab_hash;
    ret = _bfd_stringtab_init();
    if !ret.is_null() {
        (*ret)
            .length_field_size = (if isxcoff64 as libc::c_int != 0 {
            4 as libc::c_int
        } else {
            2 as libc::c_int
        }) as libc::c_char;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_stringtab_free(mut table: *mut bfd_strtab_hash) {
    bfd_hash_table_free(&mut (*table).table);
    free(table as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_stringtab_add(
    mut tab: *mut bfd_strtab_hash,
    mut str: *const libc::c_char,
    mut hash: bool,
    mut copy: bool,
) -> bfd_size_type {
    let mut entry: *mut strtab_hash_entry = 0 as *mut strtab_hash_entry;
    if hash {
        entry = bfd_hash_lookup(&mut (*tab).table, str, 1 as libc::c_int != 0, copy)
            as *mut strtab_hash_entry;
        if entry.is_null() {
            return -(1 as libc::c_int) as bfd_size_type;
        }
    } else {
        entry = bfd_hash_allocate(
            &mut (*tab).table,
        ...
        if !copy {
            ...
            n = bfd_hash_allocate(&mut (*tab).table, len as libc::c_uint)
                as *mut libc::c_char;
            if n.is_null() {
                return -(1 as libc::c_int) as bfd_size_type;
            }
            memcpy(n as *mut libc::c_void, str as *const libc::c_void, len);
            (*entry).root.string = n;
        }
        (*entry).index = -(1 as libc::c_int) as bfd_size_type;
        (*entry).next = 0 as *mut strtab_hash_entry;
    }
    if (*entry).index == -(1 as libc::c_int) as bfd_size_type {
        (*entry).index = (*tab).size;
        (*tab)
            .size = ((*tab).size as libc::c_ulong)
            .wrapping_add((strlen(str)).wrapping_add(1 as libc::c_int as libc::c_ulong))
            as bfd_size_type as bfd_size_type;
        (*entry)
            .index = ((*entry).index as libc::c_ulong)
            .wrapping_add((*tab).length_field_size as libc::c_ulong) as bfd_size_type
            as bfd_size_type;
        (*tab)
            .size = ((*tab).size as libc::c_ulong)
            .wrapping_add((*tab).length_field_size as libc::c_ulong) as bfd_size_type
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_stringtab_size(
    mut tab: *mut bfd_strtab_hash,
) -> bfd_size_type {
    return (*tab).size;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_stringtab_emit(
    mut abfd: *mut bfd,
    mut tab: *mut bfd_strtab_hash,
) -> bool {
    let mut entry: *mut strtab_hash_entry = 0 as *mut strtab_hash_entry;
    ...
    while !entry.is_null() {
        ...
        if (*tab).length_field_size as libc::c_int == 4 as libc::c_int {
            let mut buf: [bfd_byte; 4] = [0; 4];
            (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(len, buf.as_mut_ptr() as *mut libc::c_void);
            if bfd_bwrite(
        ...
        } else if (*tab).length_field_size as libc::c_int == 2 as libc::c_int {
            let mut buf_0: [bfd_byte; 2] = [0; 2];
            (Some(((*(*abfd).xvec).bfd_putx16).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(len, buf_0.as_mut_ptr() as *mut libc::c_void);
            if bfd_bwrite(
        ...
        if bfd_bwrite(str as *mut libc::c_void, len, abfd) != len {
            return 0 as libc::c_int != 0;
        }
        entry = (*entry).next;
    }
...
unsafe extern "C" fn run_static_initializers() {
    primes = [
        ...
        251 as libc::c_int as libc::c_ulong,
        509 as libc::c_int as libc::c_ulong,
        1021 as libc::c_int as libc::c_ulong,
        2039 as libc::c_int as libc::c_ulong,
        4093 as libc::c_int as libc::c_ulong,
        8191 as libc::c_int as libc::c_ulong,
        16381 as libc::c_int as libc::c_ulong,
        32749 as libc::c_int as libc::c_ulong,
        65521 as libc::c_int as libc::c_ulong,
        131071 as libc::c_int as libc::c_ulong,
        262139 as libc::c_int as libc::c_ulong,
        524287 as libc::c_int as libc::c_ulong,
        1048573 as libc::c_int as libc::c_ulong,
        2097143 as libc::c_int as libc::c_ulong,
        4194301 as libc::c_int as libc::c_ulong,
        8388593 as libc::c_int as libc::c_ulong,
        16777213 as libc::c_int as libc::c_ulong,
        33554393 as libc::c_int as libc::c_ulong,
        67108859 as libc::c_int as libc::c_ulong,
        134217689 as libc::c_int as libc::c_ulong,
        268435399 as libc::c_int as libc::c_ulong,
        536870909 as libc::c_int as libc::c_ulong,
        1073741789 as libc::c_int as libc::c_ulong,
        2147483647 as libc::c_int as libc::c_ulong,
        (2147483647 as libc::c_int as libc::c_ulong)
            .wrapping_add(2147483644 as libc::c_int as libc::c_ulong),
    ];
}
#[used]
