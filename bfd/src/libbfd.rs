...
#[no_mangle]
pub unsafe extern "C" fn bfd_malloc(mut size: bfd_size_type) -> *mut libc::c_void {
    let mut ptr: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut sz: size_t = size;
    if size != sz || sz > -(1 as libc::c_int) as size_t >> 1 as libc::c_int {
        bfd_set_error(bfd_error_no_memory);
        return 0 as *mut libc::c_void;
    }
    ptr = malloc(if sz != 0 { sz } else { 1 as libc::c_int as libc::c_ulong });
    if ptr.is_null() {
        bfd_set_error(bfd_error_no_memory);
    }
    return ptr;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_realloc(
    mut ptr: *mut libc::c_void,
    ...
    ret = realloc(ptr, if sz != 0 { sz } else { 1 as libc::c_int as libc::c_ulong });
    if ret.is_null() {
        bfd_set_error(bfd_error_no_memory);
    }
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_realloc_or_free(
    mut ptr: *mut libc::c_void,
    mut size: bfd_size_type,
) -> *mut libc::c_void {
    let mut ret: *mut libc::c_void = 0 as *mut libc::c_void;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_zmalloc(mut size: bfd_size_type) -> *mut libc::c_void {
    let mut ptr: *mut libc::c_void = bfd_malloc(size);
    if !ptr.is_null() {
        memset(
            ptr,
            0 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_write_bigendian_4byte_int(
    mut abfd: *mut bfd,
    mut i: libc::c_uint,
) -> bool {
    let mut buffer: [bfd_byte; 4] = [0; 4];
    bfd_putb32(i as bfd_vma, buffer.as_mut_ptr() as *mut libc::c_void);
    return bfd_bwrite(
...
#[no_mangle]
pub unsafe extern "C" fn bfd_getb16(mut p: *const libc::c_void) -> bfd_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    return ((*addr.offset(0 as libc::c_int as isize) as libc::c_int) << 8 as libc::c_int
        | *addr.offset(1 as libc::c_int as isize) as libc::c_int) as bfd_vma;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl16(mut p: *const libc::c_void) -> bfd_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    return ((*addr.offset(1 as libc::c_int as isize) as libc::c_int) << 8 as libc::c_int
        | *addr.offset(0 as libc::c_int as isize) as libc::c_int) as bfd_vma;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getb_signed_16(
    ...
    return (((*addr.offset(0 as libc::c_int as isize) as libc::c_int) << 8 as libc::c_int
        ...
        .wrapping_sub(0x8000 as libc::c_int as libc::c_ulong) as bfd_signed_vma;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl_signed_16(
    mut p: *const libc::c_void,
) -> bfd_signed_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    return (((*addr.offset(1 as libc::c_int as isize) as libc::c_int) << 8 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn bfd_putb16(mut data: bfd_vma, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
        ) = (data >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
        as bfd_byte;
    *addr
        .offset(
            1 as libc::c_int as isize,
        ) = (data & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_putl16(mut data: bfd_vma, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_putb24(mut data: bfd_vma, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
        ) = (data >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
        as bfd_byte;
    *addr
        .offset(
            1 as libc::c_int as isize,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_putl24(mut data: bfd_vma, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_getb24(mut p: *const libc::c_void) -> bfd_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: libc::c_ulong = 0;
    v = (*addr.offset(0 as libc::c_int as isize) as libc::c_ulong) << 16 as libc::c_int;
    v |= (*addr.offset(1 as libc::c_int as isize) as libc::c_ulong) << 8 as libc::c_int;
    v |= *addr.offset(2 as libc::c_int as isize) as libc::c_ulong;
    return v;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl24(mut p: *const libc::c_void) -> bfd_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: libc::c_ulong = 0;
    v = *addr.offset(0 as libc::c_int as isize) as libc::c_ulong;
    v |= (*addr.offset(1 as libc::c_int as isize) as libc::c_ulong) << 8 as libc::c_int;
    v |= (*addr.offset(2 as libc::c_int as isize) as libc::c_ulong) << 16 as libc::c_int;
    return v;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getb32(mut p: *const libc::c_void) -> bfd_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: libc::c_ulong = 0;
    v = (*addr.offset(0 as libc::c_int as isize) as libc::c_ulong) << 24 as libc::c_int;
    v |= (*addr.offset(1 as libc::c_int as isize) as libc::c_ulong) << 16 as libc::c_int;
    v |= (*addr.offset(2 as libc::c_int as isize) as libc::c_ulong) << 8 as libc::c_int;
    v |= *addr.offset(3 as libc::c_int as isize) as libc::c_ulong;
    return v;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl32(mut p: *const libc::c_void) -> bfd_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: libc::c_ulong = 0;
    v = *addr.offset(0 as libc::c_int as isize) as libc::c_ulong;
    v |= (*addr.offset(1 as libc::c_int as isize) as libc::c_ulong) << 8 as libc::c_int;
    v |= (*addr.offset(2 as libc::c_int as isize) as libc::c_ulong) << 16 as libc::c_int;
    v |= (*addr.offset(3 as libc::c_int as isize) as libc::c_ulong) << 24 as libc::c_int;
    return v;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getb_signed_32(
    mut p: *const libc::c_void,
) -> bfd_signed_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: libc::c_ulong = 0;
    ...
    v |= (*addr.offset(2 as libc::c_int as isize) as libc::c_ulong) << 8 as libc::c_int;
    v |= *addr.offset(3 as libc::c_int as isize) as libc::c_ulong;
    return (v ^ 0x80000000 as libc::c_uint as libc::c_ulong)
        .wrapping_sub(0x80000000 as libc::c_uint as libc::c_ulong) as bfd_signed_vma;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl_signed_32(
    mut p: *const libc::c_void,
) -> bfd_signed_vma {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: libc::c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_getb64(mut p: *const libc::c_void) -> bfd_uint64_t {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: bfd_uint64_t = 0;
    v = *addr.offset(0 as libc::c_int as isize) as bfd_uint64_t;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(1 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(2 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(3 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(4 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(5 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(6 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(7 as libc::c_int as isize) as libc::c_ulong;
    return v;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl64(mut p: *const libc::c_void) -> bfd_uint64_t {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: bfd_uint64_t = 0;
    v = *addr.offset(7 as libc::c_int as isize) as bfd_uint64_t;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(6 as libc::c_int as isize) as libc::c_ulong;
    v <<= 8 as libc::c_int;
    v |= *addr.offset(5 as libc::c_int as isize) as libc::c_ulong;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_getb_signed_64(mut p: *const libc::c_void) -> bfd_int64_t {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: bfd_uint64_t = 0;
    v = *addr.offset(0 as libc::c_int as isize) as bfd_uint64_t;
    v <<= 8 as libc::c_int;
    ...
    v <<= 8 as libc::c_int;
    v |= *addr.offset(7 as libc::c_int as isize) as libc::c_ulong;
    return (v ^ (1 as libc::c_int as bfd_uint64_t) << 63 as libc::c_int)
        .wrapping_sub((1 as libc::c_int as bfd_uint64_t) << 63 as libc::c_int)
        as bfd_int64_t;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_getl_signed_64(mut p: *const libc::c_void) -> bfd_int64_t {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut v: bfd_uint64_t = 0;
    v = *addr.offset(7 as libc::c_int as isize) as bfd_uint64_t;
    v <<= 8 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_putb32(mut data: bfd_vma, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
        ) = (data >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_ulong)
        as bfd_byte;
    *addr
        .offset(
            1 as libc::c_int as isize,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_putl32(mut data: bfd_vma, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_putb64(mut data: bfd_uint64_t, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            0 as libc::c_int as isize,
        ) = (data >> 7 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            1 as libc::c_int as isize,
        ) = (data >> 6 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            2 as libc::c_int as isize,
        ) = (data >> 5 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            3 as libc::c_int as isize,
        ) = (data >> 4 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            4 as libc::c_int as isize,
        ) = (data >> 3 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            5 as libc::c_int as isize,
        ) = (data >> 2 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            6 as libc::c_int as isize,
        ) = (data >> 1 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
    *addr
        .offset(
            7 as libc::c_int as isize,
        ) = (data >> 0 as libc::c_int * 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_ulong) as bfd_byte;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_putl64(mut data: bfd_uint64_t, mut p: *mut libc::c_void) {
    let mut addr: *mut bfd_byte = p as *mut bfd_byte;
    *addr
        .offset(
            7 as libc::c_int as isize,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_put_bits(
    mut data: bfd_uint64_t,
    ...
    if bits % 8 as libc::c_int != 0 as libc::c_int {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                &[u8; 52],
                &[libc::c_char; 52],
            >(b"void bfd_put_bits(bfd_uint64_t, void *, int, _Bool)\0"))
                .as_ptr(),
        );
    }
    bytes = bits / 8 as libc::c_int;
    i = 0 as libc::c_int;
    while i < bytes {
        let mut addr_index: libc::c_int = if big_p as libc::c_int != 0 {
            bytes - i - 1 as libc::c_int
        } else {
            i
        };
        *addr
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_bits(
    mut p: *const libc::c_void,
    mut bits: libc::c_int,
    mut big_p: bool,
) -> bfd_uint64_t {
    let mut addr: *const bfd_byte = p as *const bfd_byte;
    let mut data: bfd_uint64_t = 0;
    let mut i: libc::c_int = 0;
    let mut bytes: libc::c_int = 0;
    if bits % 8 as libc::c_int != 0 as libc::c_int {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                &[u8; 52],
                &[libc::c_char; 52],
            >(b"bfd_uint64_t bfd_get_bits(const void *, int, _Bool)\0"))
                .as_ptr(),
        );
    }
    data = 0 as libc::c_int as bfd_uint64_t;
    bytes = bits / 8 as libc::c_int;
    i = 0 as libc::c_int;
    while i < bytes {
        let mut addr_index: libc::c_int = if big_p as libc::c_int != 0 {
        ...
        data = data << 8 as libc::c_int
            | *addr.offset(addr_index as isize) as libc::c_ulong;
        i += 1;
        i;
    }
    return data;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_get_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
    ...
    if (*section).compress_status() as libc::c_int != 0 as libc::c_int {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: unable to get decompressed section %pA\0" as *const u8
    ...
    if (*abfd).direction() as libc::c_int != write_direction as libc::c_int
        && (*section).rawsize != 0 as libc::c_int as libc::c_ulong
    {
        sz = (*section).rawsize;
    } else {
        sz = (*section).size;
    ...
    if (offset as libc::c_ulong).wrapping_add(count) < count
        || (offset as libc::c_ulong).wrapping_add(count) > sz
        || !((*abfd).my_archive).is_null() && !bfd_is_thin_archive((*abfd).my_archive)
            && ((*section).filepos as ufile_ptr)
...
pub unsafe extern "C" fn _bfd_generic_get_section_contents_in_window(
    ...
    _bfd_abort(
        ...
        (*::core::mem::transmute::<
            ...
            &[libc::c_char; 105],
        >(
            b"_Bool _bfd_generic_get_section_contents_in_window(bfd *, sec_ptr, bfd_window *, file_ptr, bfd_size_type)\0",
        ))
            .as_ptr(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_generic_set_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_log2(mut x: bfd_vma) -> libc::c_uint {
    let mut result: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    if x <= 1 as libc::c_int as libc::c_ulong {
        return result;
    }
    x = x.wrapping_sub(1);
    x;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_generic_is_local_label_name(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
) -> bool {
    let mut locals_prefix: libc::c_char = (if bfd_get_symbol_leading_char(abfd)
    ...
    return *name.offset(0 as libc::c_int as isize) as libc::c_int
        == locals_prefix as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_warn_deprecated(
    mut what: *const libc::c_char,
    mut file: *const libc::c_char,
    mut line: libc::c_int,
    mut func: *const libc::c_char,
) {
    static mut mask: size_t = 0 as libc::c_int as size_t;
    if !(func as size_t) & !mask != 0 {
        fflush(stdout);
        if !func.is_null() {
            fprintf(
                stderr,
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"Deprecated %s called at %s line %d in %s\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                what,
...
pub unsafe extern "C" fn _bfd_read_unsigned_leb128(
    ...
    num_read = 0 as libc::c_int as libc::c_uint;
    loop {
        byte = (*(buf as *const libc::c_uchar) as bfd_vma
        ...
        {
            result |= (byte as bfd_vma & 0x7f as libc::c_int as libc::c_ulong) << shift;
...
pub unsafe extern "C" fn _bfd_safe_read_leb128(
    ...
    let mut result: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut shift: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut byte: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
    let mut data: *mut bfd_byte = *ptr;
    while data < end as *mut bfd_byte {
        byte = (*(data as *const libc::c_uchar) as bfd_vma
            & 0xff as libc::c_int as libc::c_ulong) as libc::c_uchar;
        data = data.offset(1);
        data;
        if (shift as libc::c_ulong)
            < (8 as libc::c_int as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<bfd_vma>() as libc::c_ulong)
        {
            result |= ((byte as libc::c_int & 0x7f as libc::c_int) as bfd_vma) << shift;
            shift = shift.wrapping_add(7 as libc::c_int as libc::c_uint);
        }
    ...
    *ptr = data;
    ...
    {
        result |= ((1 as libc::c_int as bfd_vma) << shift).wrapping_neg();
    }
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_read_signed_leb128(
    ...
    if (shift as libc::c_ulong)
        ...
        && byte as libc::c_int & 0x40 as libc::c_int != 0
    {
        result |= (-(1 as libc::c_int) as bfd_vma) << shift;
    }
    *bytes_read_ptr = num_read;
    return result as bfd_signed_vma;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_write_unsigned_leb128(
    mut p: *mut bfd_byte,
    ...
    loop {
        ...
        c = (val & 0x7f as libc::c_int as libc::c_ulong) as bfd_byte;
        val >>= 7 as libc::c_int;
        if val != 0 {
