...
static mut bfd_k1om_arch_intel_syntax: bfd_arch_info_type = unsafe {
    {
        let mut init = bfd_arch_info {
            ...
            arch: bfd_arch_k1om,
            mach: ((1 as libc::c_int) << 6 as libc::c_int
                | (1 as libc::c_int) << 0 as libc::c_int) as libc::c_ulong,
            arch_name: b"k1om:intel\0" as *const u8 as *const libc::c_char,
            printable_name: b"k1om:intel\0" as *const u8 as *const libc::c_char,
            ...
            max_reloc_offset_into_insn: 9 as libc::c_int,
        };
        init
    }
};
#[no_mangle]
pub static mut bfd_k1om_arch: bfd_arch_info_type = unsafe {
    {
        let mut init = bfd_arch_info {
            bits_per_word: 64 as libc::c_int,
            bits_per_address: 64 as libc::c_int,
            bits_per_byte: 8 as libc::c_int,
            arch: bfd_arch_k1om,
            mach: ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong,
            arch_name: b"k1om\0" as *const u8 as *const libc::c_char,
            printable_name: b"k1om\0" as *const u8 as *const libc::c_char,
            section_align_power: 3 as libc::c_int as libc::c_uint,
            the_default: 1 as libc::c_int != 0,
            compatible: Some(
                bfd_default_compatible
            ...
            next: &bfd_k1om_arch_intel_syntax as *const bfd_arch_info_type,
            max_reloc_offset_into_insn: 9 as libc::c_int,
        };
        init
    }
