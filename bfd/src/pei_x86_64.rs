...
extern "C" {
    ...
    fn bfd_cache_close(abfd: *mut bfd) -> bool;
    ...
    fn _bfd_pex64i_swap_debugdir_in(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    );
    fn _bfd_pex64i_slurp_codeview_record(
        abfd: *mut bfd,
        where_0: file_ptr,
        length: libc::c_ulong,
        cvinfo: *mut CODEVIEW_INFO,
    ) -> *mut CODEVIEW_INFO;
    fn _bfd_pex64i_only_swap_filehdr_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    ...
    fn coff_real_object_p(
        _: *mut bfd,
        _: libc::c_uint,
        _: *mut internal_filehdr,
        _: *mut internal_aouthdr,
    ) -> bfd_cleanup;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct external_PEI_IMAGE_hdr {
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct pex64_runtime_function {
    pub rva_BeginAddress: bfd_vma,
    pub rva_EndAddress: bfd_vma,
    pub rva_UnwindData: bfd_vma,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct external_pex64_runtime_function {
    pub rva_BeginAddress: [bfd_byte; 4],
    pub rva_EndAddress: [bfd_byte; 4],
    pub rva_UnwindData: [bfd_byte; 4],
}
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct pex64_unwind_info {
    pub SizeOfBlock: bfd_vma,
    pub Version: bfd_byte,
    pub Flags: bfd_byte,
    pub SizeOfPrologue: bfd_vma,
    pub CountOfCodes: bfd_vma,
    #[bitfield(name = "FrameRegister", ty = "libc::c_uint", bits = "0..=3")]
    pub FrameRegister: [u8; 1],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 7],
    pub FrameOffset: bfd_vma,
    pub sizeofUnwindCodes: bfd_vma,
    pub rawUnwindCodes: *mut bfd_byte,
    pub rawUnwindCodesEnd: *mut bfd_byte,
    pub rva_ExceptionHandler: bfd_vma,
    pub rva_BeginAddress: bfd_vma,
    pub rva_EndAddress: bfd_vma,
    pub rva_UnwindData: bfd_vma,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct external_pex64_unwind_info {
    pub Version_Flags: bfd_byte,
    pub SizeOfPrologue: bfd_byte,
    pub CountOfCodes: bfd_byte,
    pub FrameRegisterOffset: bfd_byte,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct pex64_paps {
    pub obj: *mut libc::c_void,
    pub pdata_count: libc::c_uint,
}
pub type asection_ptr = *mut asection;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct pe_ILF_vars {
    pub abfd: *mut bfd,
    pub data: *mut bfd_byte,
    pub bim: *mut bfd_in_memory,
    pub magic: libc::c_ushort,
    pub reltab: *mut arelent,
    pub relcount: libc::c_uint,
    pub sym_cache: *mut coff_symbol_type,
    pub sym_ptr: *mut coff_symbol_type,
    pub sym_index: libc::c_uint,
    pub sym_table: *mut libc::c_uint,
    pub table_ptr: *mut libc::c_uint,
    pub native_syms: *mut combined_entry_type,
    pub native_ptr: *mut combined_entry_type,
    pub sym_ptr_table: *mut *mut coff_symbol_type,
    pub sym_ptr_ptr: *mut *mut coff_symbol_type,
    pub sec_index: libc::c_uint,
    pub string_table: *mut libc::c_char,
    pub string_ptr: *mut libc::c_char,
    pub end_string_ptr: *mut libc::c_char,
    pub esym_table: *mut external_syment,
    pub esym_ptr: *mut external_syment,
    pub int_reltab: *mut internal_reloc,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct jump_table {
    pub magic: libc::c_ushort,
    pub data: [libc::c_uchar; 32],
    pub size: libc::c_uint,
    pub offset: libc::c_uint,
}
#[inline]
...
static mut pex_regs: [*const libc::c_char; 16] = [
...
unsafe extern "C" fn pex64_get_runtime_function(
    mut abfd: *mut bfd,
    mut rf: *mut pex64_runtime_function,
    mut data: *const libc::c_void,
) {
    let mut ex_rf: *const external_pex64_runtime_function = data
        as *const external_pex64_runtime_function;
    (*rf)
        .rva_BeginAddress = (Some(
        ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
    ))
        .expect(
            "non-null function pointer",
        )(((*ex_rf).rva_BeginAddress).as_ptr() as *const libc::c_void);
    (*rf)
        .rva_EndAddress = (Some(
        ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
    ))
        .expect(
            "non-null function pointer",
        )(((*ex_rf).rva_EndAddress).as_ptr() as *const libc::c_void);
    (*rf)
        .rva_UnwindData = (Some(
        ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
    ))
        .expect(
            "non-null function pointer",
        )(((*ex_rf).rva_UnwindData).as_ptr() as *const libc::c_void);
}
unsafe extern "C" fn pex64_get_unwind_info(
    mut abfd: *mut bfd,
    mut ui: *mut pex64_unwind_info,
    mut data: *mut libc::c_void,
    mut data_end: *mut libc::c_void,
) -> bool {
    let mut ex_ui: *mut external_pex64_unwind_info = data
        as *mut external_pex64_unwind_info;
    let mut ex_dta: *mut bfd_byte = data as *mut bfd_byte;
    let mut ex_dta_end: *mut bfd_byte = data_end as *mut bfd_byte;
    memset(
        ui as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<pex64_unwind_info>() as libc::c_ulong,
    );
    if ex_dta >= ex_dta_end || ex_dta.offset(4 as libc::c_int as isize) >= ex_dta_end {
        return 0 as libc::c_int != 0;
    }
    (*ui)
        .Version = ((*ex_ui).Version_Flags as libc::c_int & 7 as libc::c_int)
        as bfd_byte;
    (*ui)
        .Flags = ((*ex_ui).Version_Flags as libc::c_int >> 3 as libc::c_int
        & 0x1f as libc::c_int) as bfd_byte;
    (*ui).SizeOfPrologue = (*ex_ui).SizeOfPrologue as bfd_vma;
    (*ui).CountOfCodes = (*ex_ui).CountOfCodes as bfd_vma;
    (*ui)
        .set_FrameRegister(
            ((*ex_ui).FrameRegisterOffset as libc::c_int & 0xf as libc::c_int)
                as libc::c_uint,
        );
    (*ui)
        .FrameOffset = ((*ex_ui).FrameRegisterOffset as libc::c_int >> 4 as libc::c_int
        & 0xf as libc::c_int) as bfd_vma;
    (*ui)
        .sizeofUnwindCodes = (((*ui).CountOfCodes)
        .wrapping_add(1 as libc::c_int as libc::c_ulong)
        & !(1 as libc::c_int) as libc::c_ulong)
        .wrapping_mul(2 as libc::c_int as libc::c_ulong);
    (*ui)
        .SizeOfBlock = ((*ui).sizeofUnwindCodes)
        .wrapping_add(4 as libc::c_int as libc::c_ulong);
    (*ui).rawUnwindCodes = ex_dta.offset(4 as libc::c_int as isize);
    (*ui).rawUnwindCodesEnd = ex_dta_end;
    ex_dta = ex_dta.offset((*ui).SizeOfBlock as isize);
    if ex_dta >= ex_dta_end {
        return 0 as libc::c_int != 0;
    }
    match (*ui).Flags as libc::c_int {
        4 => {
            if ex_dta.offset(12 as libc::c_int as isize) >= ex_dta_end {
                return 0 as libc::c_int != 0;
            }
            (*ui)
                .rva_BeginAddress = (Some(
                ...
                .expect(
                    "non-null function pointer",
                )(ex_dta.offset(0 as libc::c_int as isize) as *const libc::c_void);
            (*ui)
                .rva_EndAddress = (Some(
                ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
            ))
                .expect(
                    "non-null function pointer",
                )(ex_dta.offset(4 as libc::c_int as isize) as *const libc::c_void);
            (*ui)
                .rva_UnwindData = (Some(
                ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
            ))
                .expect(
                    "non-null function pointer",
                )(ex_dta.offset(8 as libc::c_int as isize) as *const libc::c_void);
            (*ui)
                .SizeOfBlock = ((*ui).SizeOfBlock as libc::c_ulong)
                .wrapping_add(12 as libc::c_int as libc::c_ulong) as bfd_vma as bfd_vma;
            return 1 as libc::c_int != 0;
        }
        1 | 2 | 3 => {
            if ex_dta.offset(4 as libc::c_int as isize) >= ex_dta_end {
                return 0 as libc::c_int != 0;
            }
            (*ui)
                .rva_ExceptionHandler = (Some(
                ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
            ))
                .expect("non-null function pointer")(ex_dta as *const libc::c_void);
            (*ui)
                .SizeOfBlock = ((*ui).SizeOfBlock as libc::c_ulong)
...
unsafe extern "C" fn pex64_xdata_print_uwd_codes(
    mut file: *mut FILE,
    mut abfd: *mut bfd,
    mut ui: *mut pex64_unwind_info,
    mut rf: *mut pex64_runtime_function,
    ...
    let mut save_allowed: libc::c_int = 0;
    if (*ui).CountOfCodes == 0 as libc::c_int as libc::c_ulong
        || ((*ui).rawUnwindCodes).is_null()
    {
        return;
    }
    save_allowed = 1 as libc::c_int;
    i = 0 as libc::c_int as libc::c_uint;
    if ((*ui).rawUnwindCodes).offset(1 as libc::c_int as isize)
        >= (*ui).rawUnwindCodesEnd
    {
        fprintf(
            file,
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"warning: corrupt unwind data\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
        return;
    }
    if (*ui).Version as libc::c_int == 2 as libc::c_int
        && *((*ui).rawUnwindCodes).offset(1 as libc::c_int as isize) as libc::c_int
            & 0xf as libc::c_int == 6 as libc::c_int
    {
        let mut func_size: libc::c_uint = ((*rf).rva_EndAddress)
            .wrapping_sub((*rf).rva_BeginAddress) as libc::c_uint;
        if ((*ui).rawUnwindCodes)
            .offset(1 as libc::c_int as isize)
            .offset(
                ((*ui).CountOfCodes).wrapping_mul(2 as libc::c_int as libc::c_ulong)
                    as isize,
            ) >= (*ui).rawUnwindCodesEnd
        {
            fprintf(
        ...
        fprintf(
            file,
            b"\tv2 epilog (length: %02x) at pc+:\0" as *const u8 as *const libc::c_char,
            *((*ui).rawUnwindCodes).offset(0 as libc::c_int as isize) as libc::c_int,
        );
        if *((*ui).rawUnwindCodes).offset(1 as libc::c_int as isize) as libc::c_int
            >> 4 as libc::c_int & 0xf as libc::c_int != 0
        {
            fprintf(
                file,
                ...
                func_size
                    .wrapping_sub(
                        *((*ui).rawUnwindCodes).offset(0 as libc::c_int as isize)
                            as libc::c_uint,
                    ),
            );
        }
        i = i.wrapping_add(1);
        i;
        while (i as libc::c_ulong) < (*ui).CountOfCodes {
            let mut dta: *const bfd_byte = ((*ui).rawUnwindCodes)
                .offset((2 as libc::c_int as libc::c_uint).wrapping_mul(i) as isize);
            let mut off: libc::c_uint = 0;
            if *dta.offset(1 as libc::c_int as isize) as libc::c_int & 0xf as libc::c_int
                != 6 as libc::c_int
            {
                break;
            }
            off = (*dta.offset(0 as libc::c_int as isize) as libc::c_int
                | (*dta.offset(1 as libc::c_int as isize) as libc::c_int
                    >> 4 as libc::c_int & 0xf as libc::c_int) << 8 as libc::c_int)
                as libc::c_uint;
            if off == 0 as libc::c_int as libc::c_uint {
                fprintf(file, b" [pad]\0" as *const u8 as *const libc::c_char);
            } else {
                fprintf(
                    file,
                    b" 0x%x\0" as *const u8 as *const libc::c_char,
                    func_size.wrapping_sub(off),
                );
            }
            i = i.wrapping_add(1);
            i;
    ...
    if ((*ui).rawUnwindCodes)
        ...
        .offset(
            ((*ui).CountOfCodes).wrapping_mul(2 as libc::c_int as libc::c_ulong) as isize,
        ) >= (*ui).rawUnwindCodesEnd
    {
        fprintf(
            file,
    ...
    while (i as libc::c_ulong) < (*ui).CountOfCodes {
        let mut dta_0: *const bfd_byte = ((*ui).rawUnwindCodes)
            .offset((2 as libc::c_int as libc::c_uint).wrapping_mul(i) as isize);
        let mut info: libc::c_uint = (*dta_0.offset(1 as libc::c_int as isize)
            as libc::c_int >> 4 as libc::c_int & 0xf as libc::c_int) as libc::c_uint;
        let mut unexpected: libc::c_int = 0 as libc::c_int;
        fprintf(
            file,
            b"\t  pc+0x%02x: \0" as *const u8 as *const libc::c_char,
            *dta_0.offset(0 as libc::c_int as isize) as libc::c_uint,
        );
        match *dta_0.offset(1 as libc::c_int as isize) as libc::c_int
            & 0xf as libc::c_int
        {
            0 => {
                fprintf(
                    file,
                    b"push %s\0" as *const u8 as *const libc::c_char,
                    pex_regs[info as usize],
                );
            }
            1 => {
                if info == 0 as libc::c_int as libc::c_uint {
                    if dta_0.offset(4 as libc::c_int as isize)
                        > (*ui).rawUnwindCodesEnd as *const bfd_byte
                    {
                        fprintf(
                            file,
                            dcgettext(
                    ...
                    tmp = ((Some(
                        ...
                        dta_0.offset(2 as libc::c_int as isize) as *const libc::c_void,
                    ))
                        .wrapping_mul(8 as libc::c_int as libc::c_ulong) as libc::c_uint;
                    i = i.wrapping_add(1);
                    i;
                } else {
                    if dta_0.offset(6 as libc::c_int as isize)
                        > (*ui).rawUnwindCodesEnd as *const bfd_byte
                    {
                        fprintf(
                            file,
                ...
                fprintf(
                    file,
                    b"alloc large area: rsp = rsp - 0x%x\0" as *const u8
                        as *const libc::c_char,
                    tmp,
                );
            }
            2 => {
                fprintf(
                    file,
                    b"alloc small area: rsp = rsp - 0x%x\0" as *const u8
                        as *const libc::c_char,
                    info
            ...
            3 => {
                fprintf(
                    file,
                    b"FPReg: %s = rsp + 0x%x (info = 0x%x)\0" as *const u8
                        as *const libc::c_char,
                    pex_regs[(*ui).FrameRegister() as usize],
                    ((*ui).FrameOffset as libc::c_uint)
                        .wrapping_mul(16 as libc::c_int as libc::c_uint),
                    info,
                );
                unexpected = ((*ui).FrameRegister() as libc::c_int == 0 as libc::c_int)
                    as libc::c_int;
                save_allowed = 0 as libc::c_int;
            }
            4 => {
                if dta_0.offset(4 as libc::c_int as isize)
                    > (*ui).rawUnwindCodesEnd as *const bfd_byte
                ...
                fprintf(
                    file,
                    b"save %s at rsp + 0x%x\0" as *const u8 as *const libc::c_char,
                    pex_regs[info as usize],
                    tmp,
                );
                unexpected = (save_allowed == 0) as libc::c_int;
            }
            5 => {
                if dta_0.offset(6 as libc::c_int as isize)
                    > (*ui).rawUnwindCodesEnd as *const bfd_byte
            ...
            6 => {
                if (*ui).Version as libc::c_int == 1 as libc::c_int {
                    if dta_0.offset(4 as libc::c_int as isize)
                        > (*ui).rawUnwindCodesEnd as *const bfd_byte
                    {
                        fprintf(
                    ...
                    fprintf(
                        file,
                        b"save mm%u at rsp + 0x%x\0" as *const u8 as *const libc::c_char,
                        info,
                        tmp,
                    );
                    unexpected = (save_allowed == 0) as libc::c_int;
                } else if (*ui).Version as libc::c_int == 2 as libc::c_int {
                    fprintf(
                        file,
                        b"epilog %02x %01x\0" as *const u8 as *const libc::c_char,
                        *dta_0.offset(0 as libc::c_int as isize) as libc::c_int,
                        info,
                    );
                    unexpected = 1 as libc::c_int;
                }
            }
            7 => {
                if dta_0.offset(6 as libc::c_int as isize)
            ...
            8 => {
                ...
                tmp = ((Some(
                    ...
                    .wrapping_mul(16 as libc::c_int as libc::c_ulong) as libc::c_uint;
                i = i.wrapping_add(1);
                i;
                fprintf(
                    file,
                    b"save xmm%u at rsp + 0x%x\0" as *const u8 as *const libc::c_char,
                    info,
                    tmp,
                );
                unexpected = (save_allowed == 0) as libc::c_int;
            ...
            10 => {
                fprintf(
                    file,
                    b"interrupt entry (SS, old RSP, EFLAGS, CS, RIP\0" as *const u8
                        as *const libc::c_char,
                );
                if info == 0 as libc::c_int as libc::c_uint {
                    fprintf(file, b")\0" as *const u8 as *const libc::c_char);
                } else if info == 1 as libc::c_int as libc::c_uint {
                    fprintf(file, b",ErrorCode)\0" as *const u8 as *const libc::c_char);
                } else {
                    fprintf(
                        file,
            ...
            _ => {
                fprintf(
                    ...
                    *dta_0.offset(1 as libc::c_int as isize) as libc::c_int
                        & 0xf as libc::c_int,
                );
            }
        }
        if unexpected != 0 {
            fprintf(file, b" [Unexpected!]\0" as *const u8 as *const libc::c_char);
        }
        fputc('\n' as i32, file);
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn pex64_get_section_by_rva(
    mut abfd: *mut bfd,
    mut addr: bfd_vma,
    mut sec_name: *const libc::c_char,
) -> *mut asection {
    let mut section: *mut asection = bfd_get_section_by_name(abfd, sec_name);
    let mut vsize: bfd_vma = 0;
    ...
    if datasize == 0 || vsize > addr || vsize.wrapping_add(datasize) < addr {
        return 0 as *mut asection;
    }
    return section;
}
unsafe extern "C" fn pex64_dump_xdata(
    mut file: *mut FILE,
    mut abfd: *mut bfd,
    mut xdata_section: *mut asection,
    mut xdata: *mut bfd_byte,
    mut endx: *mut bfd_vma,
    mut rf: *mut pex64_runtime_function,
) {
    let mut vaddr: bfd_vma = 0;
    let mut end_addr: bfd_vma = 0;
    let mut addr: bfd_vma = (*rf).rva_UnwindData;
    let mut sec_size: bfd_size_type = if (*xdata_section).rawsize
        > 0 as libc::c_int as libc::c_ulong
    {
        (*xdata_section).rawsize
    } else {
        (*xdata_section).size
    };
    let mut ui: pex64_unwind_info = pex64_unwind_info {
        SizeOfBlock: 0,
        Version: 0,
        Flags: 0,
        SizeOfPrologue: 0,
        ...
        FrameOffset: 0,
        sizeofUnwindCodes: 0,
        rawUnwindCodes: 0 as *mut bfd_byte,
        rawUnwindCodesEnd: 0 as *mut bfd_byte,
        rva_ExceptionHandler: 0,
        rva_BeginAddress: 0,
        rva_EndAddress: 0,
        rva_UnwindData: 0,
    };
    vaddr = ((*xdata_section).vma)
        .wrapping_sub((*(*abfd).tdata.pe_obj_data).pe_opthdr.ImageBase);
    addr = (addr as libc::c_ulong).wrapping_sub(vaddr) as bfd_vma as bfd_vma;
    if addr >= sec_size {
        fprintf(
            file,
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"warning: xdata section corrupt\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
        );
    ...
    if !endx.is_null() {
        end_addr = (*endx.offset(0 as libc::c_int as isize)).wrapping_sub(vaddr);
    ...
    if !pex64_get_unwind_info(
        abfd,
        &mut ui,
        xdata.offset(addr as isize) as *mut libc::c_void,
        xdata.offset(end_addr as isize) as *mut libc::c_void,
    ) {
        fprintf(
            file,
            dcgettext(
    ...
    if ui.Version as libc::c_int != 1 as libc::c_int
        && ui.Version as libc::c_int != 2 as libc::c_int
    {
        let mut i: libc::c_uint = 0;
        fprintf(
            file,
            b"\tVersion %u (unknown).\n\0" as *const u8 as *const libc::c_char,
            ui.Version as libc::c_uint,
        );
        i = 0 as libc::c_int as libc::c_uint;
        while addr < end_addr {
            if i & 15 as libc::c_int as libc::c_uint == 0 as libc::c_int as libc::c_uint
            {
                fprintf(file, b"\t  %03x:\0" as *const u8 as *const libc::c_char, i);
            }
            fprintf(
                file,
                b" %02x\0" as *const u8 as *const libc::c_char,
                *xdata.offset(addr as isize) as libc::c_int,
            );
            if i & 15 as libc::c_int as libc::c_uint == 15 as libc::c_int as libc::c_uint
            {
                fprintf(file, b"\n\0" as *const u8 as *const libc::c_char);
            }
            addr = (addr as libc::c_ulong)
                .wrapping_add(1 as libc::c_int as libc::c_ulong) as bfd_vma as bfd_vma;
            i = i.wrapping_add(1);
            i;
        }
        if i & 15 as libc::c_int as libc::c_uint != 0 as libc::c_int as libc::c_uint {
    ...
    fprintf(
        file,
        b"\tVersion: %d, Flags: \0" as *const u8 as *const libc::c_char,
        ui.Version as libc::c_int,
    );
    match ui.Flags as libc::c_int {
        0 => {
            fprintf(file, b"none\0" as *const u8 as *const libc::c_char);
        }
        1 => {
            fprintf(file, b"UNW_FLAG_EHANDLER\0" as *const u8 as *const libc::c_char);
        }
        2 => {
            fprintf(file, b"UNW_FLAG_UHANDLER\0" as *const u8 as *const libc::c_char);
        }
        3 => {
            fprintf(
                file,
                b"UNW_FLAG_EHANDLER | UNW_FLAG_UHANDLER\0" as *const u8
                    as *const libc::c_char,
            );
        }
        4 => {
            fprintf(file, b"UNW_FLAG_CHAININFO\0" as *const u8 as *const libc::c_char);
        }
        _ => {
            fprintf(
                file,
                b"unknown flags value 0x%x\0" as *const u8 as *const libc::c_char,
                ui.Flags as libc::c_uint,
            );
        }
    }
    fputc('\n' as i32, file);
    fprintf(
        file,
        b"\tNbr codes: %u, \0" as *const u8 as *const libc::c_char,
        ui.CountOfCodes as libc::c_uint,
    );
    fprintf(
        file,
        b"Prologue size: 0x%02x, Frame offset: 0x%x, \0" as *const u8
            as *const libc::c_char,
        ui.SizeOfPrologue as libc::c_uint,
        ui.FrameOffset as libc::c_uint,
    );
    fprintf(
        file,
        b"Frame reg: %s\n\0" as *const u8 as *const libc::c_char,
        if ui.FrameRegister() as libc::c_int == 0 as libc::c_int {
    ...
    if (ui.rawUnwindCodes)
        .offset(
            (ui.CountOfCodes).wrapping_mul(2 as libc::c_int as libc::c_ulong) as isize,
        ) > xdata.offset((*xdata_section).size as isize)
    {
        fprintf(
            file,
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"Too many unwind codes (%ld)\n\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            ui.CountOfCodes as libc::c_long,
        );
    } else {
        pex64_xdata_print_uwd_codes(file, abfd, &mut ui, rf);
    }
    match ui.Flags as libc::c_int {
        1 | 2 | 3 => {
            fprintf(file, b"\tHandler: \0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                (ui.rva_ExceptionHandler)
                    .wrapping_add((*(*abfd).tdata.pe_obj_data).pe_opthdr.ImageBase),
            );
            fprintf(file, b".\n\0" as *const u8 as *const libc::c_char);
        }
        4 => {
            fprintf(file, b"\tChain: start: \0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                ui.rva_BeginAddress,
            );
            fprintf(file, b", end: \0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                ui.rva_EndAddress,
            );
            fprintf(file, b"\n\t unwind data: \0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                ui.rva_UnwindData,
    ...
    addr = (addr as libc::c_ulong).wrapping_add(ui.SizeOfBlock) as bfd_vma as bfd_vma;
    if addr < end_addr {
        let mut i_0: libc::c_uint = 0;
        fprintf(file, b"\tUser data:\n\0" as *const u8 as *const libc::c_char);
        i_0 = 0 as libc::c_int as libc::c_uint;
        while addr < end_addr {
            if i_0 & 15 as libc::c_int as libc::c_uint
                == 0 as libc::c_int as libc::c_uint
            {
                fprintf(file, b"\t  %03x:\0" as *const u8 as *const libc::c_char, i_0);
            }
            fprintf(
                file,
                b" %02x\0" as *const u8 as *const libc::c_char,
        ...
        if i_0 & 15 as libc::c_int as libc::c_uint != 0 as libc::c_int as libc::c_uint {
            fprintf(file, b"\n\0" as *const u8 as *const libc::c_char);
        }
    }
}
unsafe extern "C" fn sort_xdata_arr(
    mut l: *const libc::c_void,
    mut r: *const libc::c_void,
) -> libc::c_int {
    let mut lp: *const bfd_vma = l as *const bfd_vma;
    let mut rp: *const bfd_vma = r as *const bfd_vma;
    if *lp == *rp {
        return 0 as libc::c_int;
    }
    return if *lp < *rp { -(1 as libc::c_int) } else { 1 as libc::c_int };
}
unsafe extern "C" fn pex64_bfd_print_pdata_section(
    mut abfd: *mut bfd,
    mut vfile: *mut libc::c_void,
    mut pdata_section: *mut asection,
) -> bool {
    let mut file: *mut FILE = vfile as *mut FILE;
    let mut pdata: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut xdata: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut xdata_section: *mut asection = 0 as *mut asection;
    let mut xdata_base: bfd_vma = 0;
    let mut i: bfd_size_type = 0;
    let mut datasize: bfd_size_type = 0;
    let mut stop: bfd_size_type = 0;
    let mut prev_beginaddress: bfd_vma = -(1 as libc::c_int) as bfd_vma;
    let mut prev_unwinddata_rva: bfd_vma = -(1 as libc::c_int) as bfd_vma;
    let mut imagebase: bfd_vma = 0;
    let mut onaline: libc::c_int = 3 as libc::c_int * 4 as libc::c_int;
    let mut seen_error: libc::c_int = 0 as libc::c_int;
    let mut xdata_arr: *mut bfd_vma = 0 as *mut bfd_vma;
    let mut xdata_arr_cnt: libc::c_int = 0;
    let mut virt_size_is_zero: bool = 0 as libc::c_int != 0;
    if pdata_section.is_null()
        || ((*pdata_section).used_by_bfd as *mut coff_section_tdata).is_null()
        || ((*((*pdata_section).used_by_bfd as *mut coff_section_tdata)).tdata
            as *mut pei_section_tdata)
            .is_null()
    {
        return 1 as libc::c_int != 0;
    }
    stop = (*((*((*pdata_section).used_by_bfd as *mut coff_section_tdata)).tdata
        as *mut pei_section_tdata))
        .virt_size;
    if stop.wrapping_rem(onaline as libc::c_ulong) != 0 as libc::c_int as libc::c_ulong {
        fprintf(
            ...
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"Warning: %s section size (%ld) is not a multiple of %d\n\0"
    ...
    if datasize == 0 as libc::c_int as libc::c_ulong {
        if stop != 0 {
            fprintf(
                ...
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"Warning: %s section size is zero\n\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                (*pdata_section).name,
    ...
    if stop == 0 as libc::c_int as libc::c_ulong
        && strcmp(
            (*(*abfd).xvec).name,
    ...
    {
        stop = datasize;
        virt_size_is_zero = 1 as libc::c_int != 0;
    } else if datasize < stop {
        fprintf(
            file,
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"Warning: %s section size (%ld) is smaller than virtual size (%ld)\n\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            (*pdata_section).name,
    ...
    fprintf(
        ...
        dcgettext(
            b"bfd\0" as *const u8 as *const libc::c_char,
            b"vma:\t\t\tBeginAddress\t EndAddress\t  UnwindData\n\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
    );
    if bfd_malloc_and_get_section(abfd, pdata_section, &mut pdata) {
        xdata_arr = xmalloc(
            (::core::mem::size_of::<bfd_vma>() as libc::c_ulong)
                .wrapping_mul(
                    stop
                        .wrapping_div(onaline as libc::c_ulong)
                        .wrapping_add(1 as libc::c_int as libc::c_ulong),
                ),
        ) as *mut bfd_vma;
        xdata_arr_cnt = 0 as libc::c_int;
        if strcmp(
            (*(*abfd).xvec).name,
        ...
        ) == 0 as libc::c_int
        {
            ...
            imagebase = 0 as libc::c_int as bfd_vma;
        }
        i = 0 as libc::c_int as bfd_size_type;
        while i < stop {
            let mut rf: pex64_runtime_function = pex64_runtime_function {
                rva_BeginAddress: 0,
                rva_EndAddress: 0,
                rva_UnwindData: 0,
            };
            if i.wrapping_add((3 as libc::c_int * 4 as libc::c_int) as libc::c_ulong)
                > stop
            {
                break;
            }
            pex64_get_runtime_function(
                abfd,
                &mut rf,
                &mut *pdata.offset(i as isize) as *mut bfd_byte as *const libc::c_void,
            );
            if rf.rva_BeginAddress == 0 as libc::c_int as libc::c_ulong
                && rf.rva_EndAddress == 0 as libc::c_int as libc::c_ulong
                && rf.rva_UnwindData == 0 as libc::c_int as libc::c_ulong
            {
                break;
            }
            fputc(' ' as i32, file);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                i.wrapping_add((*pdata_section).vma),
            );
            fprintf(file, b":\t\0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                imagebase.wrapping_add(rf.rva_BeginAddress),
            );
            fprintf(file, b" \0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                imagebase.wrapping_add(rf.rva_EndAddress),
            );
            fprintf(file, b" \0" as *const u8 as *const libc::c_char);
            fprintf(
                file,
                b"%016lx\0" as *const u8 as *const libc::c_char,
                imagebase.wrapping_add(rf.rva_UnwindData),
            );
            fprintf(file, b"\n\0" as *const u8 as *const libc::c_char);
            if i != 0 as libc::c_int as libc::c_ulong
                && rf.rva_BeginAddress <= prev_beginaddress
            {
                seen_error = 1 as libc::c_int;
                fprintf(
                    file,
                    b"  has %s begin address as predecessor\n\0" as *const u8
                        as *const libc::c_char,
                    if rf.rva_BeginAddress < prev_beginaddress {
                        b"smaller\0" as *const u8 as *const libc::c_char
                    } else {
            ...
            if prev_beginaddress & 0x80000000 as libc::c_uint as libc::c_ulong
                != 0 as libc::c_int as libc::c_ulong
            {
                seen_error = 1 as libc::c_int;
                fprintf(
                    file,
                    b"  has negative begin address\n\0" as *const u8
                        as *const libc::c_char,
                );
            }
            if rf.rva_EndAddress & 0x80000000 as libc::c_uint as libc::c_ulong
                != 0 as libc::c_int as libc::c_ulong
            {
                seen_error = 1 as libc::c_int;
                fprintf(
                    file,
                    b"  has negative end address\n\0" as *const u8 as *const libc::c_char,
                );
            }
            if rf.rva_UnwindData & 0x80000000 as libc::c_uint as libc::c_ulong
                != 0 as libc::c_int as libc::c_ulong
            {
                seen_error = 1 as libc::c_int;
                fprintf(
                    file,
                    b"  has negative unwind address\n\0" as *const u8
                        as *const libc::c_char,
                );
            } else if rf.rva_UnwindData != 0
                && !(rf.rva_UnwindData & 1 as libc::c_int as libc::c_ulong
                    != 0 as libc::c_int as libc::c_ulong)
                || virt_size_is_zero as libc::c_int != 0
            {
                let fresh0 = xdata_arr_cnt;
                xdata_arr_cnt = xdata_arr_cnt + 1;
                *xdata_arr.offset(fresh0 as isize) = rf.rva_UnwindData;
            }
            i = (i as libc::c_ulong).wrapping_add(onaline as libc::c_ulong)
                as bfd_size_type as bfd_size_type;
        }
        if !(seen_error != 0) {
            let fresh1 = xdata_arr_cnt;
            xdata_arr_cnt = xdata_arr_cnt + 1;
            *xdata_arr.offset(fresh1 as isize) = !(0 as libc::c_int as bfd_vma);
            if xdata_arr_cnt > 1 as libc::c_int {
                qsort(
                    xdata_arr as *mut libc::c_void,
                    xdata_arr_cnt as size_t,
                    ::core::mem::size_of::<bfd_vma>() as libc::c_ulong,
                    Some(
                        sort_xdata_arr
            ...
            xdata_base = *xdata_arr.offset(0 as libc::c_int as isize);
            if strcmp(
                (*pdata_section).name,
                b".pdata\0" as *const u8 as *const libc::c_char,
            ) != 0 as libc::c_int
            {
                let mut len: size_t = strlen((*pdata_section).name);
                let mut xdata_name: *mut libc::c_char = xmalloc(
                    len.wrapping_add(1 as libc::c_int as libc::c_ulong),
                ) as *mut libc::c_char;
                xdata_name = memcpy(
                    xdata_name as *mut libc::c_void,
                    (*pdata_section).name as *const libc::c_void,
                    len.wrapping_add(1 as libc::c_int as libc::c_ulong),
                ) as *mut libc::c_char;
                if len > 1 as libc::c_int as libc::c_ulong {
                    *xdata_name
                        .offset(1 as libc::c_int as isize) = 'x' as i32 as libc::c_char;
                }
                xdata_section = pex64_get_section_by_rva(abfd, xdata_base, xdata_name);
                free(xdata_name as *mut libc::c_void);
            }
            if xdata_section.is_null() {
                xdata_section = pex64_get_section_by_rva(
                    abfd,
                    xdata_base,
                    b".xdata\0" as *const u8 as *const libc::c_char,
                );
            }
            if xdata_section.is_null() && xdata_base != 0 {
                xdata_section = pex64_get_section_by_rva(
                    abfd,
                    xdata_base,
            ...
            if !(xdata_section.is_null()
                || !bfd_malloc_and_get_section(abfd, xdata_section, &mut xdata))
            {
                prev_unwinddata_rva = -(1 as libc::c_int) as bfd_vma;
                i = 0 as libc::c_int as bfd_size_type;
                while i < stop {
                    let mut rf_0: pex64_runtime_function = pex64_runtime_function {
                        rva_BeginAddress: 0,
                        rva_EndAddress: 0,
                        rva_UnwindData: 0,
                    };
                    if i
                        .wrapping_add(
                            (3 as libc::c_int * 4 as libc::c_int) as libc::c_ulong,
                        ) > stop
                    {
                        break;
                    }
                    pex64_get_runtime_function(
                        abfd,
                        &mut rf_0,
                        &mut *pdata.offset(i as isize) as *mut bfd_byte
                            as *const libc::c_void,
                    );
                    if rf_0.rva_BeginAddress == 0 as libc::c_int as libc::c_ulong
                        && rf_0.rva_EndAddress == 0 as libc::c_int as libc::c_ulong
                        && rf_0.rva_UnwindData == 0 as libc::c_int as libc::c_ulong
                    {
                        break;
                    }
                    if i == 0 as libc::c_int as libc::c_ulong {
                    ...
                    fprintf(
                        file,
                        b"%016lx\0" as *const u8 as *const libc::c_char,
                        (rf_0.rva_UnwindData).wrapping_add(imagebase),
                    );
                    if prev_unwinddata_rva == rf_0.rva_UnwindData {
                        fprintf(
                            file,
                            b" also used for function at \0" as *const u8
                                as *const libc::c_char,
                        );
                        fprintf(
                            file,
                            b"%016lx\0" as *const u8 as *const libc::c_char,
                            (rf_0.rva_BeginAddress).wrapping_add(imagebase),
                        );
                        fputc('\n' as i32, file);
                    } else {
                        prev_unwinddata_rva = rf_0.rva_UnwindData;
                        fprintf(
                            file,
                            b" (rva: %08x): \0" as *const u8 as *const libc::c_char,
                            rf_0.rva_UnwindData as libc::c_uint,
                        );
                        fprintf(
                            file,
                            b"%016lx\0" as *const u8 as *const libc::c_char,
                        ...
                        fprintf(
                            file,
                            b"%016lx\0" as *const u8 as *const libc::c_char,
                            (rf_0.rva_EndAddress).wrapping_add(imagebase),
                        );
                        fputc('\n' as i32, file);
                        if rf_0.rva_UnwindData != 0 as libc::c_int as libc::c_ulong
                            || virt_size_is_zero as libc::c_int != 0
                        {
                            if rf_0.rva_UnwindData & 1 as libc::c_int as libc::c_ulong
                                != 0 as libc::c_int as libc::c_ulong
                            {
                                let mut altent: bfd_vma = rf_0.rva_UnwindData
                                    & !(1 as libc::c_int) as libc::c_ulong;
                                let mut pdata_vma: bfd_vma = bfd_section_vma(pdata_section);
                                let mut arf: pex64_runtime_function = pex64_runtime_function {
                                    rva_BeginAddress: 0,
                                    rva_EndAddress: 0,
                                    rva_UnwindData: 0,
                                };
                                fprintf(
                                    file,
                                    b"\t shares information with \0" as *const u8
                                        as *const libc::c_char,
                                );
                                altent = (altent as libc::c_ulong).wrapping_add(imagebase)
                                    as bfd_vma as bfd_vma;
                                if altent >= pdata_vma
                                    && altent
                                        .wrapping_sub(pdata_vma)
                                        .wrapping_add(
                                            (3 as libc::c_int * 4 as libc::c_int) as libc::c_ulong,
                                        ) <= stop
                                {
                                    pex64_get_runtime_function(
                                        abfd,
                                        &mut arf,
                                        &mut *pdata.offset(altent.wrapping_sub(pdata_vma) as isize)
                                            as *mut bfd_byte as *const libc::c_void,
                                    );
                                    fprintf(
                                        file,
                                        b"pdata element at 0x\0" as *const u8 as *const libc::c_char,
                                    );
                                    fprintf(
                                        file,
                                        b"%016lx\0" as *const u8 as *const libc::c_char,
                                    ...
                                    fprintf(
                                        file,
                                        b"unknown pdata element\0" as *const u8
                                            as *const libc::c_char,
                                    );
                                }
                                fprintf(file, b".\n\0" as *const u8 as *const libc::c_char);
                            } else {
                                let mut p: *mut bfd_vma = 0 as *mut bfd_vma;
                                p = bsearch(
                                    &mut rf_0.rva_UnwindData as *mut bfd_vma
                                        as *const libc::c_void,
                                    xdata_arr as *const libc::c_void,
                                    xdata_arr_cnt as size_t,
                                    ::core::mem::size_of::<bfd_vma>() as libc::c_ulong,
                                    Some(
                                        sort_xdata_arr
                                ...
                                while *p.offset(0 as libc::c_int as isize)
                                    <= rf_0.rva_UnwindData
                                {
                                    p = p.offset(1);
                                    p;
    ...
    free(xdata_arr as *mut libc::c_void);
    free(xdata as *mut libc::c_void);
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn pex64_print_all_pdata_sections(
    mut abfd: *mut bfd,
    mut pdata: *mut asection,
    mut arg: *mut libc::c_void,
) {
    let mut paps: *mut pex64_paps = arg as *mut pex64_paps;
    if startswith((*pdata).name, b".pdata\0" as *const u8 as *const libc::c_char) {
        if pex64_bfd_print_pdata_section(abfd, (*paps).obj, pdata) {
            (*paps).pdata_count = ((*paps).pdata_count).wrapping_add(1);
            (*paps).pdata_count;
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn pex64_bfd_print_pdata(
    mut abfd: *mut bfd,
    mut vfile: *mut libc::c_void,
) -> bool {
    let mut pdata_section: *mut asection = bfd_get_section_by_name(
        abfd,
        b".pdata\0" as *const u8 as *const libc::c_char,
    );
    let mut paps: pex64_paps = pex64_paps {
    ...
    paps.obj = vfile;
    paps.pdata_count = 0 as libc::c_int as libc::c_uint;
    bfd_map_over_sections(
        ...
        &mut paps as *mut pex64_paps as *mut libc::c_void,
    );
    return paps.pdata_count != 0 as libc::c_int as libc::c_uint;
}
...
unsafe extern "C" fn coff_compute_section_file_positions(mut abfd: *mut bfd) -> bool {
    ...
    if !((*(*abfd).tdata.coff_obj_data).link_info).is_null()
        || !((*abfd).tdata.pe_obj_data).is_null()
            && (*(*abfd).tdata.pe_obj_data).pe_opthdr.FileAlignment != 0
    {
        page_size = (*(*abfd).tdata.pe_obj_data).pe_opthdr.FileAlignment as libc::c_int;
        if page_size == 0 as libc::c_int {
            page_size = 1 as libc::c_int;
        }
        if page_size < 0 as libc::c_int {
            ...
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: page size is too large (0x%x)\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
    ...
    let mut section_list: *mut *mut asection = 0 as *mut *mut asection;
    let mut i: libc::c_uint = 0;
    let mut amt: bfd_size_type = 0;
    if (*(*abfd).tdata.pe_obj_data).pe_opthdr.SectionAlignment
    ...
    amt = (::core::mem::size_of::<*mut asection_0>() as libc::c_ulong)
        .wrapping_mul(
            count.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong,
        );
    section_list = bfd_malloc(amt) as *mut *mut asection;
    if section_list.is_null() {
        return 0 as libc::c_int != 0;
    }
    i = 0 as libc::c_int as libc::c_uint;
    current = (*abfd).sections;
    while !current.is_null() {
        let ref mut fresh2 = *section_list.offset(i as isize);
        *fresh2 = current;
        i = i.wrapping_add(1);
        i;
        current = (*current).next;
    }
    let ref mut fresh3 = *section_list.offset(i as isize);
    *fresh3 = 0 as *mut asection;
    qsort(
        section_list as *mut libc::c_void,
        count as size_t,
    ...
    (*abfd).sections = 0 as *mut bfd_section;
    (*abfd).section_last = 0 as *mut bfd_section;
    i = 0 as libc::c_int as libc::c_uint;
    while i < count {
        current = *section_list.offset(i as isize);
        bfd_section_list_append(abfd, current);
        if (*current).size == 0 as libc::c_int as libc::c_ulong {
            (*current).target_index = 1 as libc::c_int;
        } else {
            let fresh4 = target_index;
            target_index = target_index.wrapping_add(1);
            (*current).target_index = fresh4 as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
    }
    free(section_list as *mut libc::c_void);
    if target_index
        >= (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_max_nscns
    {
    ...
    current = (*abfd).sections;
    while !current.is_null() {
        if ((*current).used_by_bfd as *mut coff_section_tdata).is_null() {
            let mut amt_0: size_t = ::core::mem::size_of::<coff_section_tdata>()
                as libc::c_ulong;
            (*current).used_by_bfd = bfd_zalloc(abfd, amt_0);
            if ((*current).used_by_bfd).is_null() {
                return 0 as libc::c_int != 0;
            }
        }
        if ((*((*current).used_by_bfd as *mut coff_section_tdata)).tdata
            as *mut pei_section_tdata)
            .is_null()
        {
            let mut amt_1: size_t = ::core::mem::size_of::<pei_section_tdata>()
                as libc::c_ulong;
            let ref mut fresh5 = (*((*current).used_by_bfd as *mut coff_section_tdata))
                .tdata;
            *fresh5 = bfd_zalloc(abfd, amt_1);
            if ((*((*current).used_by_bfd as *mut coff_section_tdata)).tdata).is_null() {
                return 0 as libc::c_int != 0;
            }
        }
        if (*((*((*current).used_by_bfd as *mut coff_section_tdata)).tdata
            as *mut pei_section_tdata))
            .virt_size == 0 as libc::c_int as libc::c_ulong
        {
            (*((*((*current).used_by_bfd as *mut coff_section_tdata)).tdata
                as *mut pei_section_tdata))
        ...
        if !((*current).flags & 0x100 as libc::c_int as libc::c_uint == 0) {
            ...
            if !((*current).size == 0 as libc::c_int as libc::c_ulong) {
                ...
                (*current)
                    .size = ((*current).size)
                    .wrapping_add(page_size as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    & -page_size as libc::c_ulong;
                sofar = (sofar as libc::c_ulong).wrapping_add((*current).size)
                    as file_ptr as file_ptr;
                if (*abfd).flags & 0x2 as libc::c_int as libc::c_uint
                    == 0 as libc::c_int as libc::c_uint
                {
                    ...
                    sofar = (sofar as libc::c_ulong)
                        .wrapping_add(((*current).size).wrapping_sub(old_size))
                        as file_ptr as file_ptr;
                } else {
                    old_sofar = sofar;
                    sofar = (if (sofar as bfd_vma)
                ...
                if (*((*((*current).used_by_bfd as *mut coff_section_tdata)).tdata
                    ...
                    .virt_size < (*current).size
                {
                    align_adjust = 1 as libc::c_int != 0;
                }
...
unsafe extern "C" fn coff_apply_checksum(mut abfd: *mut bfd) -> bool {
    let mut computed: libc::c_uint = 0;
    let mut checksum: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut peheader: libc::c_uint = 0;
    let mut pelength: libc::c_uint = 0;
    if bfd_seek(abfd, 0x3c as libc::c_int as file_ptr, 0 as libc::c_int)
        != 0 as libc::c_int
    {
        return 0 as libc::c_int != 0;
    }
    if !coff_read_word(abfd, &mut peheader, &mut pelength) {
        return 0 as libc::c_int != 0;
    }
    if bfd_seek(
        abfd,
        peheader.wrapping_add(0x58 as libc::c_int as libc::c_uint) as file_ptr,
        0 as libc::c_int,
    ) != 0 as libc::c_int
    {
        return 0 as libc::c_int != 0;
    ...
    bfd_bwrite(
        &mut checksum as *mut libc::c_uint as *const libc::c_void,
        4 as libc::c_int as bfd_size_type,
        abfd,
    );
    if bfd_seek(abfd, peheader as file_ptr, 0 as libc::c_int) != 0 as libc::c_int {
        return 0 as libc::c_int != 0;
    }
    computed = coff_compute_checksum(abfd, &mut pelength);
    checksum = computed.wrapping_add(pelength);
    if bfd_seek(
        abfd,
        peheader.wrapping_add(0x58 as libc::c_int as libc::c_uint) as file_ptr,
        0 as libc::c_int,
...
unsafe extern "C" fn coff_write_object_contents(mut abfd: *mut bfd) -> bool {
    ...
    let mut hasdebug: bool = 0 as libc::c_int != 0;
    ...
    while !current.is_null() {
        ...
        let mut is_reloc_section: bool = 0 as libc::c_int != 0;
        if strcmp((*current).name, b".reloc\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        {
            is_reloc_section = 1 as libc::c_int != 0;
            hasrelocs = 1 as libc::c_int != 0;
            (*(*abfd).tdata.pe_obj_data).has_reloc_section = 1 as libc::c_int;
        }
        ...
        {
            section
                .s_paddr = (*((*((*current).used_by_bfd as *mut coff_section_tdata))
        ...
        if (*current).flags & 0x2000 as libc::c_int as libc::c_uint
            != 0 as libc::c_int as libc::c_uint && !is_reloc_section
        {
            hasdebug = 1 as libc::c_int != 0;
        }
        section
        ...
        if section.s_size == 0 as libc::c_int as libc::c_ulong {
            internal_f.f_nscns = (internal_f.f_nscns).wrapping_sub(1);
            internal_f.f_nscns;
        } else {
            ...
            != 0 as libc::c_int as libc::c_uint
        {
            ...
            if i < count {
                ...
                if psym != psymsec {
                    ...
                    pcopy = psym;
                    while pcopy > psymsec {
                        let ref mut fresh6 = *pcopy.offset(0 as libc::c_int as isize);
                        *fresh6 = *pcopy.offset(-(1 as libc::c_int) as isize);
    ...
    if !hasdebug {
        internal_f
            .f_flags = (internal_f.f_flags as libc::c_int | 0x200 as libc::c_int)
            as libc::c_ushort;
    }
    if (*(*abfd).tdata.pe_obj_data).real_flags & 0x20 as libc::c_int as libc::c_uint != 0
    {
        internal_f
            .f_flags = (internal_f.f_flags as libc::c_int | 0x20 as libc::c_int)
            as libc::c_ushort;
    }
    memset(
...
unsafe extern "C" fn coff_slurp_line_table(
    ...
    while counter < (*asect).lineno_count {
        let mut dst: internal_lineno = internal_lineno {
            l_addr: C2RustUnnamed_37 { l_symndx: 0 },
            l_lnno: 0,
        };
        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ...
            if !func_table.is_null() {
                ...
                while i < (*asect).lineno_count {
                        ...
                        == 0 as libc::c_int as libc::c_uint
                    {
                        let fresh7 = p;
                        p = p.offset(1);
                        *fresh7 = &mut *lineno_cache.offset(i as isize) as *mut alent;
                    }
                    i = i.wrapping_add(1);
                    i;
                }
            ...
            match (*src).u.syment.n_sclass as libc::c_int {
                ...
                0 => {
                        ...
                        && (*src).u.syment.n_scnum == 0 as libc::c_int
                    {
                        ...
                        current_block_71 = 10478926259245052503;
                    }
                }
                106 => {
                    current_block_71 = 9980879814619195298;
                }
                5 | 7 | 14 | 21 | _ => {
                    current_block_71 = 10478926259245052503;
                }
...
unsafe extern "C" fn coff_compute_checksum(
    mut abfd: *mut bfd,
    mut pelength: *mut libc::c_uint,
) -> libc::c_uint {
    let mut more_data: bool = false;
    let mut filepos: file_ptr = 0;
    let mut value: libc::c_uint = 0;
    let mut total: libc::c_uint = 0;
    total = 0 as libc::c_int as libc::c_uint;
    *pelength = 0 as libc::c_int as libc::c_uint;
    filepos = 0 as libc::c_int as file_ptr;
    loop {
        if bfd_seek(abfd, filepos, 0 as libc::c_int) != 0 as libc::c_int {
            return 0 as libc::c_int as libc::c_uint;
        }
        more_data = coff_read_word(abfd, &mut value, pelength);
        total = total.wrapping_add(value);
        total = 0xffff as libc::c_int as libc::c_uint
            & total.wrapping_add(total >> 0x10 as libc::c_int);
        filepos += 2 as libc::c_int as libc::c_long;
        if !more_data {
            break;
        }
    }
    return 0xffff as libc::c_int as libc::c_uint
        & total.wrapping_add(total >> 0x10 as libc::c_int);
}
unsafe extern "C" fn coff_canonicalize_reloc(
    ...
    if (*section).flags & 0x80 as libc::c_int as libc::c_uint != 0 {
        ...
        loop {
            let fresh11 = count;
            count = count.wrapping_add(1);
            if !(fresh11 < (*section).reloc_count) {
                break;
            }
            let fresh12 = tblptr;
...
unsafe extern "C" fn coff_set_alignment_hook(
        ...
        .is_null()
    {
        ...
        let ref mut fresh14 = (*((*section).used_by_bfd as *mut coff_section_tdata))
            .tdata;
        *fresh14 = bfd_zalloc(abfd, amt);
...
unsafe extern "C" fn coff_read_word(
    mut abfd: *mut bfd,
    ...
    if status == 1 as libc::c_int {
        *value = b[0 as libc::c_int as usize] as libc::c_uint;
    } else {
        *value = (b[0 as libc::c_int as usize] as libc::c_int
            + ((b[1 as libc::c_int as usize] as libc::c_int) << 8 as libc::c_int))
            as libc::c_uint;
    }
    *pelength = (*pelength).wrapping_add(status as libc::c_uint);
    return 1 as libc::c_int != 0;
}
...
unsafe extern "C" fn sort_by_secaddr(
    mut arg1: *const libc::c_void,
    mut arg2: *const libc::c_void,
) -> libc::c_int {
    let mut a: *const asection = *(arg1 as *mut *const asection);
    let mut b: *const asection = *(arg2 as *mut *const asection);
    if (*a).vma < (*b).vma {
        return -(1 as libc::c_int)
    } else if (*a).vma > (*b).vma {
        return 1 as libc::c_int
...
static mut coff_section_alignment_table: [coff_section_alignment_entry; 12] = [coff_section_alignment_entry {
...
unsafe extern "C" fn coff_new_section_hook(
    ...
    let ref mut fresh15 = (*(&mut (*(*section).symbol).the_bfd as *mut *mut bfd
        as *mut coff_symbol_type))
        .native;
    *fresh15 = native;
        ...
        if isym.n_scnum == (*section).target_index {
            ...
            if symname.is_null() {
                ...
                match seen_state {
                        ...
                        match current_block {
                            ...
                            7950979517761538108 => {
                                ...
                                ) != 0 as libc::c_int
                                {
                                    ...
                                    current_block = 10749101994363483477;
                                }
                            }
                            _ => {}
                        }
                        match current_block {
                            ...
                            _ => {
                                ...
                                amt = ::core::mem::size_of::<coff_comdat_info>()
                                    as libc::c_ulong;
                                let ref mut fresh16 = (*((*section).used_by_bfd
                                    as *mut coff_section_tdata))
                                    .comdat;
                                *fresh16 = bfd_alloc(abfd, amt) as *mut coff_comdat_info;
                                ...
                                let ref mut fresh17 = (*(*((*section).used_by_bfd
                                    as *mut coff_section_tdata))
                                    .comdat)
                                    .name;
                                *fresh17 = newname;
                    ...
                    2 => {
                        current_block = 7950979517761538108;
                        match current_block {
                            8236137900636309791 => {
                                let mut aux: internal_auxent = internal_auxent {
                                    x_sym: C2RustUnnamed_23 {
...
unsafe extern "C" fn pe_bfd_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut buffer: [bfd_byte; 6] = [0; 6];
    let mut dos_hdr: external_DOS_hdr = external_DOS_hdr {
        e_magic: [0; 2],
        e_cblp: [0; 2],
        e_cp: [0; 2],
        e_crlc: [0; 2],
    ...
    let mut image_hdr: external_PEI_IMAGE_hdr = external_PEI_IMAGE_hdr {
        nt_signature: [0; 4],
        f_magic: [0; 2],
        f_nscns: [0; 2],
        f_timdat: [0; 4],
    ...
    let mut opt_hdr_size: bfd_size_type = 0;
    let mut offset: file_ptr = 0;
    let mut result: bfd_cleanup = None;
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bread(
    ...
    if (Some(((*(*abfd).xvec).bfd_h_getx32).expect("non-null function pointer")))
        ...
        == 0xffff0000 as libc::c_uint as libc::c_ulong
        && (Some(((*(*abfd).xvec).bfd_h_getx16).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            buffer.as_mut_ptr().offset(4 as libc::c_int as isize) as *const libc::c_void,
        ) == 0 as libc::c_int as libc::c_ulong
    {
    ...
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bread(
            &mut dos_hdr as *mut external_DOS_hdr as *mut libc::c_void,
            ::core::mem::size_of::<external_DOS_hdr>() as libc::c_ulong,
            abfd,
        ) != ::core::mem::size_of::<external_DOS_hdr>() as libc::c_ulong
    {
        if bfd_get_error() as libc::c_uint
    ...
    if (Some(((*(*abfd).xvec).bfd_h_getx16).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )((dos_hdr.e_magic).as_mut_ptr() as *const libc::c_void)
        != 0x5a4d as libc::c_int as libc::c_ulong
    {
        bfd_set_error(bfd_error_wrong_format);
        return None;
    }
    offset = (Some(((*(*abfd).xvec).bfd_h_getx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )((dos_hdr.e_lfanew).as_mut_ptr() as *const libc::c_void) as file_ptr;
    if bfd_seek(abfd, offset, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bread(
            &mut image_hdr as *mut external_PEI_IMAGE_hdr as *mut libc::c_void,
            ::core::mem::size_of::<external_PEI_IMAGE_hdr>() as libc::c_ulong,
            abfd,
        ) != ::core::mem::size_of::<external_PEI_IMAGE_hdr>() as libc::c_ulong
    {
        if bfd_get_error() as libc::c_uint
    ...
    if (Some(((*(*abfd).xvec).bfd_h_getx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )((image_hdr.nt_signature).as_mut_ptr() as *const libc::c_void)
        != 0x4550 as libc::c_int as libc::c_ulong
    {
        bfd_set_error(bfd_error_wrong_format);
        return None;
    }
    ...
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ...
        || internal_f.f_opthdr as libc::c_uint
            > (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_aoutsz
    {
        bfd_set_error(bfd_error_wrong_format);
        return None;
    }
    memcpy(
        (internal_f.pe.dos_message).as_mut_ptr() as *mut libc::c_void,
        (dos_hdr.dos_message).as_mut_ptr() as *const libc::c_void,
        ::core::mem::size_of::<[libc::c_uint; 16]>() as libc::c_ulong,
    );
    opt_hdr_size = internal_f.f_opthdr as bfd_size_type;
    if opt_hdr_size != 0 as libc::c_int as libc::c_ulong {
        let mut amt: bfd_size_type = opt_hdr_size;
        let mut opthdr: *mut libc::c_void = 0 as *mut libc::c_void;
        if amt < ::core::mem::size_of::<PEPAOUTHDR>() as libc::c_ulong {
            amt = ::core::mem::size_of::<PEPAOUTHDR>() as libc::c_ulong;
        }
        opthdr = _bfd_alloc_and_read(abfd, amt, opt_hdr_size) as *mut libc::c_void;
        if opthdr.is_null() {
            return None;
        }
        if amt > opt_hdr_size {
            memset(
                opthdr.offset(opt_hdr_size as isize),
                0 as libc::c_int,
                amt.wrapping_sub(opt_hdr_size),
            );
        }
...
unsafe extern "C" fn pe_bfd_read_buildid(mut abfd: *mut bfd) {
    ...
    if dataoff >= (*section).size || size > ((*section).size).wrapping_sub(dataoff) {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: error: debug data ends beyond end of debug directory\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
            ...
            )
    {
        ...
        if idd.Type == 2 as libc::c_int as libc::c_ulong {
            ...
            if !(_bfd_pex64i_slurp_codeview_record(
                ...
                .is_null()
            {
                let mut build_id: *mut bfd_build_id = bfd_alloc(
                    abfd,
                    (::core::mem::size_of::<bfd_build_id>() as libc::c_ulong)
                        .wrapping_add((*cvinfo).SignatureLength as libc::c_ulong),
                ) as *mut bfd_build_id;
                if !build_id.is_null() {
                    (*build_id).size = (*cvinfo).SignatureLength as bfd_size_type;
                    memcpy(
                        ((*build_id).data).as_mut_ptr() as *mut libc::c_void,
                        ((*cvinfo).Signature).as_mut_ptr() as *const libc::c_void,
                        (*cvinfo).SignatureLength as libc::c_ulong,
                    );
...
unsafe extern "C" fn pe_ILF_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut buffer: [bfd_byte; 14] = [0; 14];
    let mut ptr: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut symbol_name: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut source_dll: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut machine: libc::c_uint = 0;
    let mut size: bfd_size_type = 0;
    let mut ordinal: libc::c_uint = 0;
    let mut types: libc::c_uint = 0;
    let mut magic: libc::c_uint = 0;
    if bfd_bread(
        buffer.as_mut_ptr() as *mut libc::c_void,
        14 as libc::c_int as bfd_size_type,
        abfd,
    ...
    machine = (Some(((*(*abfd).xvec).bfd_h_getx16).expect("non-null function pointer")))
        .expect("non-null function pointer")(ptr as *const libc::c_void) as libc::c_uint;
    ptr = ptr.offset(2 as libc::c_int as isize);
    magic = 0 as libc::c_int as libc::c_uint;
    match machine {
        34404 => {
            magic = 0x8664 as libc::c_int as libc::c_uint;
        }
        0 | 388 | 644 | 512 | 332 | 354 | 358 | 360 | 614 | 870 | 1126 | 418 | 422 | 448
        | 450 => {}
        496 | _ => {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: unrecognised machine type (0x%x) in Import Library Format archive\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
    ...
    if magic == 0 as libc::c_int as libc::c_uint {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: recognised but unhandled machine type (0x%x) in Import Library Format archive\0"
                    as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
    ...
    if size == 0 as libc::c_int as libc::c_ulong {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: size field is zero in Import Library Format header\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
    ...
    ordinal = (Some(((*(*abfd).xvec).bfd_h_getx16).expect("non-null function pointer")))
        .expect("non-null function pointer")(ptr as *const libc::c_void) as libc::c_uint;
    ptr = ptr.offset(2 as libc::c_int as isize);
    types = (Some(((*(*abfd).xvec).bfd_h_getx16).expect("non-null function pointer")))
        .expect("non-null function pointer")(ptr as *const libc::c_void) as libc::c_uint;
    ptr = _bfd_alloc_and_read(abfd, size, size);
    if ptr.is_null() {
        return None;
    }
    symbol_name = ptr as *mut libc::c_char;
    source_dll = symbol_name
        .offset(
            strnlen(symbol_name, size.wrapping_sub(1 as libc::c_int as libc::c_ulong))
                as isize,
        )
        .offset(1 as libc::c_int as isize);
    if *ptr.offset(size.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
        as libc::c_int != 0 as libc::c_int
        || (source_dll as *mut bfd_byte).offset_from(ptr) as libc::c_long
            as bfd_size_type >= size
    {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: string not null terminated in ILF object file\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
        ...
        bfd_set_error(bfd_error_malformed_archive);
        bfd_release(abfd, ptr as *mut libc::c_void);
        return None;
    }
    if !pe_ILF_build_a_bfd(abfd, magic, symbol_name, source_dll, ordinal, types) {
        bfd_release(abfd, ptr as *mut libc::c_void);
        return None;
    }
...
#[no_mangle]
pub static mut x86_64_pei_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"pei-x86-64\0" as *const u8 as *const libc::c_char,
            ...
            _bfd_check_format: [
                ...
                Some(pe_bfd_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(
            ...
            backend_data: &bfd_coff_pei_swap_table as *const bfd_coff_backend_data
...
unsafe extern "C" fn coff_swap_filehdr_in(
    ...
    let mut filehdr_src: *mut external_PEI_IMAGE_hdr = src
        as *mut external_PEI_IMAGE_hdr;
...
unsafe extern "C" fn coff_swap_scnhdr_in(
    ...
    (*scnhdr_int).s_nreloc = 0 as libc::c_int as libc::c_ulong;
...
unsafe extern "C" fn pe_mkobject_hook(
    ...
    if !aouthdr.is_null() {
        (*pe).pe_opthdr = (*(aouthdr as *mut internal_aouthdr)).pe;
    }
    memcpy(
...
unsafe extern "C" fn pe_ILF_make_a_symbol_reloc(
    mut vars: *mut pe_ILF_vars,
    mut address: bfd_vma,
    mut reloc: bfd_reloc_code_real_type,
    mut sym: *mut *mut bfd_symbol,
    mut sym_index: libc::c_uint,
) {
    let mut entry: *mut arelent = 0 as *mut arelent;
    let mut internal: *mut internal_reloc = 0 as *mut internal_reloc;
    entry = ((*vars).reltab).offset((*vars).relcount as isize);
    internal = ((*vars).int_reltab).offset((*vars).relcount as isize);
    (*entry).address = address;
    (*entry).addend = 0 as libc::c_int as bfd_vma;
    (*entry).howto = bfd_reloc_type_lookup((*vars).abfd, reloc);
    (*entry).sym_ptr_ptr = sym;
    (*internal).r_vaddr = address;
    (*internal).r_symndx = sym_index as libc::c_long;
    (*internal).r_type = (*(*entry).howto).type_0 as libc::c_ushort;
    (*vars).relcount = ((*vars).relcount).wrapping_add(1);
    (*vars).relcount;
    if !((*vars).relcount <= 8 as libc::c_int as libc::c_uint) {
        bfd_assert(
            b"./peicode.h\0" as *const u8 as *const libc::c_char,
            496 as libc::c_int,
        );
    }
}
...
unsafe extern "C" fn pe_ILF_build_a_bfd(
    mut abfd: *mut bfd,
    mut magic: libc::c_uint,
    mut symbol_name: *mut libc::c_char,
    mut source_dll: *mut libc::c_char,
    mut ordinal: libc::c_uint,
    mut types: libc::c_uint,
) -> bool {
    let mut i: libc::c_int = 0;
    let mut current_block: u64;
    let mut ptr: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut vars: pe_ILF_vars = pe_ILF_vars {
        abfd: 0 as *mut bfd,
        data: 0 as *mut bfd_byte,
        bim: 0 as *mut bfd_in_memory,
        magic: 0,
        reltab: 0 as *mut arelent,
        relcount: 0,
        sym_cache: 0 as *mut coff_symbol_type,
        sym_ptr: 0 as *mut coff_symbol_type,
        sym_index: 0,
        sym_table: 0 as *mut libc::c_uint,
        table_ptr: 0 as *mut libc::c_uint,
        native_syms: 0 as *mut combined_entry_type,
        native_ptr: 0 as *mut combined_entry_type,
        sym_ptr_table: 0 as *mut *mut coff_symbol_type,
        sym_ptr_ptr: 0 as *mut *mut coff_symbol_type,
        sec_index: 0,
        string_table: 0 as *mut libc::c_char,
        string_ptr: 0 as *mut libc::c_char,
        end_string_ptr: 0 as *mut libc::c_char,
        esym_table: 0 as *mut external_syment,
        esym_ptr: 0 as *mut external_syment,
        int_reltab: 0 as *mut internal_reloc,
    };
    let mut internal_f: internal_filehdr = internal_filehdr {
        pe: internal_extra_pe_filehdr {
            e_magic: 0,
    ...
    let mut import_type: libc::c_uint = 0;
    let mut import_name_type: libc::c_uint = 0;
    let mut id4: asection_ptr = 0 as *mut asection;
    let mut id5: asection_ptr = 0 as *mut asection;
    let mut id6: asection_ptr = 0 as asection_ptr;
    let mut text: asection_ptr = 0 as asection_ptr;
    let mut imp_sym: *mut *mut coff_symbol_type = 0 as *mut *mut coff_symbol_type;
    let mut imp_index: libc::c_uint = 0;
    let mut alignment: intptr_t = 0;
    import_type = types & 0x3 as libc::c_int as libc::c_uint;
    import_name_type = (types & 0x1c as libc::c_int as libc::c_uint) >> 2 as libc::c_int;
    match import_type {
        0 | 1 => {}
        2 => {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: unhandled import type; %x\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
        ...
        _ => {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: unrecognized import type; %x\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
    ...
    match import_name_type {
        0 | 1 | 2 | 3 => {}
        _ => {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: unrecognized import name type; %x\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
    ...
    ptr = bfd_zmalloc(
        ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
            .wrapping_mul(::core::mem::size_of::<coff_symbol_type>() as libc::c_ulong)
            .wrapping_add(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
            ...
            .wrapping_add(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
                        ::core::mem::size_of::<combined_entry_type>() as libc::c_ulong,
                    ),
            )
            .wrapping_add(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
                        ::core::mem::size_of::<*mut coff_symbol_type>() as libc::c_ulong,
                    ),
            )
            .wrapping_add(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
            ...
            .wrapping_add(
                (strlen(symbol_name))
                    ...
                    .wrapping_add(strlen(source_dll))
                    .wrapping_add((6 as libc::c_int * 9 as libc::c_int) as libc::c_ulong)
                    .wrapping_add(4 as libc::c_int as libc::c_ulong),
            )
            .wrapping_add((5 as libc::c_int * 4 as libc::c_int) as libc::c_ulong)
            .wrapping_add((2 as libc::c_int * 4 as libc::c_int) as libc::c_ulong)
            .wrapping_add((2 as libc::c_int * 4 as libc::c_int) as libc::c_ulong)
            .wrapping_add(
                (2 as libc::c_int as libc::c_ulong)
                    .wrapping_add(strlen(symbol_name))
                    .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    .wrapping_add(1 as libc::c_int as libc::c_ulong),
            )
            .wrapping_add(
            ...
            .wrapping_add(
                (6 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(
                        ::core::mem::size_of::<coff_section_tdata>() as libc::c_ulong,
                    ),
            )
    ...
    (*vars.bim).buffer = ptr;
    (*vars.bim)
        .size = ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<coff_symbol_type>() as libc::c_ulong)
        .wrapping_add(
            ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
        ...
        .wrapping_add(32 as libc::c_int as libc::c_ulong);
    if !ptr.is_null() {
        vars.sym_cache = ptr as *mut coff_symbol_type;
        vars.sym_ptr = ptr as *mut coff_symbol_type;
        vars.sym_index = 0 as libc::c_int as libc::c_uint;
        ptr = ptr
            .offset(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
                        ::core::mem::size_of::<coff_symbol_type>() as libc::c_ulong,
                    ) as isize,
            );
        vars.sym_table = ptr as *mut libc::c_uint;
        vars.table_ptr = ptr as *mut libc::c_uint;
        ptr = ptr
            .offset(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
        ...
        vars.native_syms = ptr as *mut combined_entry_type;
        vars.native_ptr = ptr as *mut combined_entry_type;
        ptr = ptr
            .offset(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
        ...
        vars.sym_ptr_table = ptr as *mut *mut coff_symbol_type;
        vars.sym_ptr_ptr = ptr as *mut *mut coff_symbol_type;
        ptr = ptr
            .offset(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
        ...
        vars.esym_table = ptr as *mut external_syment;
        vars.esym_ptr = ptr as *mut external_syment;
        ptr = ptr
            .offset(
                ((2 as libc::c_int + 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(
        ...
        vars.reltab = ptr as *mut arelent;
        vars.relcount = 0 as libc::c_int as libc::c_uint;
        ptr = ptr
            .offset(
                (8 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(::core::mem::size_of::<arelent>() as libc::c_ulong)
        ...
        vars.int_reltab = ptr as *mut internal_reloc;
        ptr = ptr
            .offset(
                (8 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(
        ...
        vars.string_table = ptr as *mut libc::c_char;
        vars.string_ptr = (ptr as *mut libc::c_char).offset(4 as libc::c_int as isize);
        ptr = ptr
            .offset(
                (strlen(symbol_name))
                    .wrapping_mul(2 as libc::c_int as libc::c_ulong)
        ...
        vars.end_string_ptr = ptr as *mut libc::c_char;
        alignment = ::core::mem::align_of::<coff_section_tdata>() as libc::c_ulong
            as intptr_t;
        ptr = (ptr as intptr_t + alignment - 1 as libc::c_int as libc::c_long
            & -alignment) as *mut bfd_byte;
        vars.data = ptr;
        vars.abfd = abfd;
        vars.sec_index = 0 as libc::c_int as libc::c_uint;
        vars.magic = magic as libc::c_ushort;
        id4 = pe_ILF_make_a_section(
            &mut vars,
            b".idata$4\0" as *const u8 as *const libc::c_char,
            (2 as libc::c_int * 4 as libc::c_int) as libc::c_uint,
            0 as libc::c_int as flagword,
        );
        id5 = pe_ILF_make_a_section(
            &mut vars,
            b".idata$5\0" as *const u8 as *const libc::c_char,
            (2 as libc::c_int * 4 as libc::c_int) as libc::c_uint,
            0 as libc::c_int as flagword,
        );
        if !(id4.is_null() || id5.is_null()) {
            if import_name_type == 0 as libc::c_int as libc::c_uint {
                if ordinal == 0 as libc::c_int as libc::c_uint {
                    current_block = 12450829475184839541;
                } else {
                    *((*id4).contents as *mut libc::c_uint)
                        .offset(0 as libc::c_int as isize) = ordinal;
                    *((*id4).contents as *mut libc::c_uint)
                        .offset(1 as libc::c_int as isize) = 0x80000000 as libc::c_uint;
                    *((*id5).contents as *mut libc::c_uint)
                        .offset(0 as libc::c_int as isize) = ordinal;
                    *((*id5).contents as *mut libc::c_uint)
                        .offset(1 as libc::c_int as isize) = 0x80000000 as libc::c_uint;
                ...
                let mut symbol: *mut libc::c_char = 0 as *mut libc::c_char;
                ...
                if id6.is_null() {
                    ...
                    symbol = symbol_name;
                    if import_name_type != 1 as libc::c_int as libc::c_uint {
                        let mut c: libc::c_char = *symbol
                            .offset(0 as libc::c_int as isize);
                        if c as libc::c_int == '_' as i32
                            && (*(*abfd).xvec).symbol_leading_char as libc::c_int
                                != 0 as libc::c_int || c as libc::c_int == '@' as i32
                    ...
                    len = strlen(symbol) as libc::c_uint;
                    if import_name_type == 3 as libc::c_int as libc::c_uint {
                        let mut at: *mut libc::c_char = strchr(symbol, '@' as i32);
                        if !at.is_null() {
                            len = at.offset_from(symbol) as libc::c_long as libc::c_uint;
                        }
                    }
                    *((*id6).contents)
                        .offset(
                            0 as libc::c_int as isize,
                        ) = (ordinal & 0xff as libc::c_int as libc::c_uint)
                        as libc::c_uchar;
                    *((*id6).contents)
                        .offset(
                            1 as libc::c_int as isize,
                        ) = (ordinal >> 8 as libc::c_int) as libc::c_uchar;
                    memcpy(
                        ((*id6).contents as *mut libc::c_char)
                    ...
                    *((*id6).contents)
                        .offset(
                            len.wrapping_add(2 as libc::c_int as libc::c_uint) as isize,
                        ) = '\0' as i32 as libc::c_uchar;
                    current_block = 9859671972921157070;
                }
            }
            match current_block {
                12450829475184839541 => {}
                _ => {
                    if import_name_type != 0 as libc::c_int as libc::c_uint {
                        pe_ILF_make_a_reloc(
                            &mut vars,
                        ...
                        pe_ILF_save_relocs(&mut vars, id4);
                        pe_ILF_make_a_reloc(
                            &mut vars,
                            0 as libc::c_int as bfd_vma,
                            BFD_RELOC_RVA,
                        ...
                        pe_ILF_save_relocs(&mut vars, id5);
                    }
                    ...
                    imp_sym = (vars.sym_ptr_ptr).offset(-(1 as libc::c_int as isize));
                    imp_index = (vars.sym_index)
                        .wrapping_sub(1 as libc::c_int as libc::c_uint);
                    match import_type {
                        0 => {
                            i = (::core::mem::size_of::<[jump_table; 2]>()
                                as libc::c_ulong)
                                .wrapping_div(
                                    ::core::mem::size_of::<jump_table>() as libc::c_ulong,
                                ) as libc::c_int;
                            loop {
                                let fresh18 = i;
                                i = i - 1;
                                ...
                                if jtab[i as usize].size == 0 as libc::c_int as libc::c_uint
                                {
                                    continue;
                                }
                                if jtab[i as usize].magic as libc::c_uint == magic {
                                    break;
                                }
                            }
                            if i < 0 as libc::c_int {
                                _bfd_abort(
                                    ...
                                    (*::core::mem::transmute::<
                                        ...
                                        &[libc::c_char; 90],
                                    >(
                                        b"_Bool pe_ILF_build_a_bfd(bfd *, unsigned int, char *, char *, unsigned int, unsigned int)\0",
                                    ))
                                        .as_ptr(),
                                );
                            }
                            text = pe_ILF_make_a_section(
                                &mut vars,
                                b".text\0" as *const u8 as *const libc::c_char,
                                jtab[i as usize].size,
                                0x10 as libc::c_int as flagword,
                            );
                            if text.is_null() {
                                current_block = 12450829475184839541;
                            } else {
                                memcpy(
                                    (*text).contents as *mut libc::c_void,
                                    (jtab[i as usize].data).as_ptr() as *const libc::c_void,
                                    jtab[i as usize].size as libc::c_ulong,
                                );
                                if magic == 0x8664 as libc::c_int as libc::c_uint {
                                    pe_ILF_make_a_symbol_reloc(
                                        &mut vars,
                                        jtab[i as usize].offset as bfd_vma,
                                        BFD_RELOC_32_PCREL,
                                        imp_sym as *mut *mut asymbol,
                                        imp_index,
                                    );
                                } else {
                                    pe_ILF_make_a_symbol_reloc(
                                ...
                                pe_ILF_save_relocs(&mut vars, text);
                    ...
                    match current_block {
                        ...
                        _ => {
                            memset(
                                &mut internal_f as *mut internal_filehdr
                                    as *mut libc::c_void,
                                0 as libc::c_int,
                                ::core::mem::size_of::<internal_filehdr>() as libc::c_ulong,
                            );
                            internal_f.f_magic = magic as libc::c_ushort;
                            internal_f.f_symptr = 0 as libc::c_int as bfd_vma;
                            internal_f.f_nsyms = 0 as libc::c_int as libc::c_long;
                            internal_f
                                .f_flags = (0x100 as libc::c_int | 0x4 as libc::c_int)
                                as libc::c_ushort;
                                ...
                                ))
                            {
                                if !(((*((*(*abfd).xvec).backend_data
                                    ...
                                    .is_null()
                                {
                                    (*(*abfd).tdata.coff_obj_data).pe = 1 as libc::c_int;
                                    bfd_cache_close(abfd);
                                    (*abfd).iostream = vars.bim as *mut libc::c_void;
                                    (*abfd).flags |= 0x800 as libc::c_int as libc::c_uint;
                                    (*abfd).iovec = &_bfd_memory_iovec;
                                    (*abfd).where_0 = 0 as libc::c_int as ufile_ptr;
                                    (*abfd).origin = 0 as libc::c_int as ufile_ptr;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .sym_filepos = 0 as libc::c_int as file_ptr;
                                    match import_type {
                                        0 => {
                                            pe_ILF_make_a_symbol(
                                                &mut vars,
                                                ...
                                                text,
                                                ((1 as libc::c_int) << 10 as libc::c_int
                                                    | (1 as libc::c_int) << 3 as libc::c_int) as flagword,
                                            );
                                        }
                                        1 => {}
                                        _ => {
                                    ...
                                    ptr = strrchr(source_dll, '.' as i32) as *mut bfd_byte;
                                    if !ptr.is_null() {
                                        *ptr = 0 as libc::c_int as bfd_byte;
                                    }
                                    pe_ILF_make_a_symbol(
                                        &mut vars,
                                        b"__IMPORT_DESCRIPTOR_\0" as *const u8
                                            as *const libc::c_char,
                                        source_dll,
                                        0 as asection_ptr,
                                        0 as libc::c_int as flagword,
                                    ...
                                    if !ptr.is_null() {
                                        *ptr = '.' as i32 as bfd_byte;
                                    }
                                    (*(*abfd).tdata.coff_obj_data).symbols = vars.sym_cache;
                                    (*abfd).symcount = vars.sym_index;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .raw_syments = vars.native_syms;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .raw_syment_count = vars.sym_index as libc::c_ulong;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .external_syms = vars.esym_table as *mut libc::c_void;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .keep_syms = 1 as libc::c_int != 0;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .conversion_table = vars.sym_table;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .conv_table_size = vars.sym_index as libc::c_int;
                                    (*(*abfd).tdata.coff_obj_data).strings = vars.string_table;
                                    (*(*abfd).tdata.coff_obj_data)
                                        .keep_strings = 1 as libc::c_int != 0;
    ...
    free((*vars.bim).buffer as *mut libc::c_void);
    free(vars.bim as *mut libc::c_void);
    return 0 as libc::c_int != 0;
}
static mut jtab: [jump_table; 2] = [
    {
        let mut init = jump_table {
    ...
    {
        let mut init = jump_table {
            magic: 0 as libc::c_int as libc::c_ushort,
            data: [
                0 as libc::c_int as libc::c_uchar,
                0,
                0,
...
unsafe extern "C" fn pe_ILF_make_a_section(
    mut vars: *mut pe_ILF_vars,
    mut name: *const libc::c_char,
    mut size: libc::c_uint,
    mut extra_flags: flagword,
) -> asection_ptr {
    let mut sec: asection_ptr = 0 as *mut asection;
    let mut flags: flagword = 0;
    let mut alignment: intptr_t = 0;
    sec = bfd_make_section_old_way((*vars).abfd, name);
    if sec.is_null() {
        return 0 as asection_ptr;
    }
    ...
    if !(((*vars).data).offset(size as isize)
        < ((*(*vars).bim).buffer).offset((*(*vars).bim).size as isize))
    {
        bfd_assert(
            b"./peicode.h\0" as *const u8 as *const libc::c_char,
            638 as libc::c_int,
    ...
    bfd_set_section_size(sec, size as bfd_size_type);
    (*sec).contents = (*vars).data;
    let fresh19 = (*vars).sec_index;
    (*vars).sec_index = ((*vars).sec_index).wrapping_add(1);
    (*sec).target_index = fresh19 as libc::c_int;
    (*vars).data = ((*vars).data).offset(size as isize);
    if size & 1 as libc::c_int as libc::c_uint != 0 {
        (*vars).data = ((*vars).data).offset(-1);
        (*vars).data;
    }
    alignment = ::core::mem::align_of::<coff_section_tdata>() as libc::c_ulong
        as intptr_t;
    (*vars)
        .data = ((*vars).data as intptr_t + alignment - 1 as libc::c_int as libc::c_long
        & -alignment) as *mut bfd_byte;
    (*sec).used_by_bfd = (*vars).data as *mut coff_section_tdata as *mut libc::c_void;
    (*vars)
        .data = ((*vars).data)
        .offset(::core::mem::size_of::<coff_section_tdata>() as libc::c_ulong as isize);
    if !((*vars).data <= ((*(*vars).bim).buffer).offset((*(*vars).bim).size as isize)) {
        bfd_assert(
            b"./peicode.h\0" as *const u8 as *const libc::c_char,
            672 as libc::c_int,
        );
    ...
    (*((*sec).used_by_bfd as *mut coff_section_tdata))
        .i = ((*vars).sym_index).wrapping_sub(1 as libc::c_int as libc::c_uint);
    return sec;
}
unsafe extern "C" fn pe_ILF_make_a_symbol(
    mut vars: *mut pe_ILF_vars,
    mut prefix: *const libc::c_char,
    mut symbol_name: *const libc::c_char,
    mut section: asection_ptr,
    mut extra_flags: flagword,
) {
    let mut sym: *mut coff_symbol_type = 0 as *mut coff_symbol_type;
    let mut ent: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut esym: *mut external_syment = 0 as *mut external_syment;
    let mut sclass: libc::c_ushort = 0;
    if extra_flags & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint != 0 {
        sclass = 3 as libc::c_int as libc::c_ushort;
    } else {
        sclass = 2 as libc::c_int as libc::c_ushort;
    }
    if !((*vars).sym_index < (2 as libc::c_int + 6 as libc::c_int) as libc::c_uint) {
        bfd_assert(
            b"./peicode.h\0" as *const u8 as *const libc::c_char,
            567 as libc::c_int,
        );
    ...
    if section.is_null() {
        section = &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize)
            as *mut asection;
    }
    (Some(((*(*(*vars).abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        ((*vars).string_ptr).offset_from((*vars).string_table) as libc::c_long
            as bfd_vma,
        ((*esym).e.e.e_offset).as_mut_ptr() as *mut libc::c_void,
    );
    (Some(((*(*(*vars).abfd).xvec).bfd_h_putx16).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        (*section).target_index as bfd_vma,
        ((*esym).e_scnum).as_mut_ptr() as *mut libc::c_void,
    );
    (*esym).e_sclass[0 as libc::c_int as usize] = sclass as libc::c_char;
    (*ent).u.syment.n_sclass = sclass as libc::c_uchar;
    (*ent).u.syment.n_scnum = (*section).target_index;
    (*ent).u.syment._n._n_n._n_offset = sym as bfd_hostptr_t;
    (*ent).is_sym = 1 as libc::c_int != 0;
    (*sym).symbol.the_bfd = (*vars).abfd;
    (*sym).symbol.name = (*vars).string_ptr;
    (*sym)
        .symbol
        .flags = ((1 as libc::c_int) << 1 as libc::c_int
        | (1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint | extra_flags;
    (*sym).symbol.section = section;
    (*sym).native = ent;
    *(*vars).table_ptr = (*vars).sym_index;
    *(*vars).sym_ptr_ptr = sym;
    (*vars).sym_index = ((*vars).sym_index).wrapping_add(1);
    (*vars).sym_index;
    (*vars).sym_ptr = ((*vars).sym_ptr).offset(1);
    (*vars).sym_ptr;
    (*vars).sym_ptr_ptr = ((*vars).sym_ptr_ptr).offset(1);
    (*vars).sym_ptr_ptr;
    (*vars).table_ptr = ((*vars).table_ptr).offset(1);
    (*vars).table_ptr;
    (*vars).native_ptr = ((*vars).native_ptr).offset(1);
    (*vars).native_ptr;
    (*vars).esym_ptr = ((*vars).esym_ptr).offset(1);
    (*vars).esym_ptr;
    (*vars)
        .string_ptr = ((*vars).string_ptr)
        .offset(
            (strlen(symbol_name))
                .wrapping_add(strlen(prefix))
                .wrapping_add(1 as libc::c_int as libc::c_ulong) as isize,
        );
    if !((*vars).string_ptr < (*vars).end_string_ptr) {
        bfd_assert(
            b"./peicode.h\0" as *const u8 as *const libc::c_char,
            612 as libc::c_int,
        );
...
unsafe extern "C" fn pe_ILF_save_relocs(
    mut vars: *mut pe_ILF_vars,
    mut sec: asection_ptr,
) {
    if ((*sec).used_by_bfd as *mut coff_section_tdata).is_null() {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                &[u8; 53],
                &[libc::c_char; 53],
            >(b"void pe_ILF_save_relocs(pe_ILF_vars *, asection_ptr)\0"))
                .as_ptr(),
        );
    }
    let ref mut fresh20 = (*((*sec).used_by_bfd as *mut coff_section_tdata)).relocs;
    *fresh20 = (*vars).int_reltab;
    (*((*sec).used_by_bfd as *mut coff_section_tdata))
        .keep_relocs = 1 as libc::c_int != 0;
    (*sec).relocation = (*vars).reltab;
    (*sec).reloc_count = (*vars).relcount;
    (*sec).flags |= 0x4 as libc::c_int as libc::c_uint;
    (*vars).reltab = ((*vars).reltab).offset((*vars).relcount as isize);
    (*vars).int_reltab = ((*vars).int_reltab).offset((*vars).relcount as isize);
    (*vars).relcount = 0 as libc::c_int as libc::c_uint;
    if !(((*vars).int_reltab as *mut bfd_byte) < (*vars).string_table as *mut bfd_byte) {
        bfd_assert(
            b"./peicode.h\0" as *const u8 as *const libc::c_char,
            533 as libc::c_int,
        );
...
unsafe extern "C" fn pe_ILF_make_a_reloc(
    mut vars: *mut pe_ILF_vars,
    mut address: bfd_vma,
    mut reloc: bfd_reloc_code_real_type,
    mut sec: asection_ptr,
    ...
    pe_ILF_make_a_symbol_reloc(
        ...
        reloc,
        (*sec).symbol_ptr_ptr,
        (*((*sec).used_by_bfd as *mut coff_section_tdata)).i,
    );
}
static mut bfd_coff_pei_swap_table: bfd_coff_backend_data = unsafe {
    {
        let mut init = bfd_coff_backend_data {
            ...
            _bfd_filhsz: 152 as libc::c_int as libc::c_uint,
            ...
            _bfd_coff_long_section_names: 0 as libc::c_int != 0,
...
unsafe extern "C" fn run_static_initializers() {
    coff_section_alignment_table_size = (::core::mem::size_of::<
        [coff_section_alignment_entry; 12],
    >() as libc::c_ulong)
        .wrapping_div(
