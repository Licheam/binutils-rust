...
extern "C" {
    ...
    fn bfd_arch_list() -> *mut *const libc::c_char;
    ...
    static elf32_be_vec: bfd_target;
    static elf32_le_vec: bfd_target;
    static elf64_be_vec: bfd_target;
    static elf64_le_vec: bfd_target;
    static i386_elf32_vec: bfd_target;
    static i386_pe_vec: bfd_target;
    static i386_pei_vec: bfd_target;
    static iamcu_elf32_vec: bfd_target;
    static k1om_elf64_vec: bfd_target;
    static l1om_elf64_vec: bfd_target;
    static plugin_vec: bfd_target;
    static x86_64_elf32_vec: bfd_target;
    static x86_64_elf64_vec: bfd_target;
    static x86_64_pe_vec: bfd_target;
    static x86_64_pe_big_vec: bfd_target;
    static x86_64_pei_vec: bfd_target;
    static srec_vec: bfd_target;
    static symbolsrec_vec: bfd_target;
    static verilog_vec: bfd_target;
    static tekhex_vec: bfd_target;
    static binary_vec: bfd_target;
    static ihex_vec: bfd_target;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct targmatch {
    pub triplet: *const libc::c_char,
    pub vector: *const bfd_target,
}
static mut _bfd_target_vector: [*const bfd_target; 23] = unsafe {
    [
        &x86_64_elf64_vec as *const bfd_target,
        &i386_elf32_vec as *const bfd_target,
        &iamcu_elf32_vec as *const bfd_target,
        &x86_64_elf32_vec as *const bfd_target,
        &i386_pei_vec as *const bfd_target,
        &x86_64_pe_vec as *const bfd_target,
        &x86_64_pei_vec as *const bfd_target,
        &l1om_elf64_vec as *const bfd_target,
        &k1om_elf64_vec as *const bfd_target,
        &elf64_le_vec as *const bfd_target,
        &elf64_be_vec as *const bfd_target,
        &elf32_le_vec as *const bfd_target,
        &elf32_be_vec as *const bfd_target,
        &x86_64_pe_big_vec as *const bfd_target,
        &i386_pe_vec as *const bfd_target,
        &srec_vec as *const bfd_target,
        &symbolsrec_vec as *const bfd_target,
        &verilog_vec as *const bfd_target,
        &tekhex_vec as *const bfd_target,
        &binary_vec as *const bfd_target,
        &ihex_vec as *const bfd_target,
        &plugin_vec as *const bfd_target,
        0 as *const bfd_target,
    ]
};
#[no_mangle]
pub static mut bfd_target_vector: *const *const bfd_target = unsafe {
    _bfd_target_vector.as_ptr()
};
#[no_mangle]
pub static mut bfd_default_vector: [*const bfd_target; 2] = unsafe {
    [&x86_64_elf64_vec as *const bfd_target, 0 as *const bfd_target]
};
static mut _bfd_associated_vector: [*const bfd_target; 1] = [0 as *const bfd_target];
#[no_mangle]
pub static mut bfd_associated_vector: *const *const bfd_target = unsafe {
    _bfd_associated_vector.as_ptr()
};
#[no_mangle]
pub static mut _bfd_target_vector_entries: size_t = 0;
static mut bfd_target_match: [targmatch; 43] = unsafe {
    [
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-elf*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-rtems*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-genode*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-nto*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-aros*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-dicos*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-dragonfly*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-netbsdelf*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-netbsd*-gnu*\0" as *const u8
        ...
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-knetbsd*-gnu\0" as *const u8
                    as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        ...
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-netbsdpe*\0" as *const u8 as *const libc::c_char,
                vector: &i386_pe_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-openbsd*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-linux-*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-redox*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-dicos*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-elf*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-rtems*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-fuchsia\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-genode*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-dragonfly*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-netbsd*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-openbsd*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-linux-*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-mingw*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-pe\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-pep\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-cygwin\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_pe_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-rdos*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"x86_64-*-redox*\0" as *const u8 as *const libc::c_char,
                vector: &x86_64_elf64_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-lynxos*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-gnu*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-moss*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-beospe*\0" as *const u8 as *const libc::c_char,
                vector: &i386_pe_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-beoself*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-beos*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-interix*\0" as *const u8 as *const libc::c_char,
                vector: &i386_pei_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-rdos*\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-mingw32*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-cygwin*\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-winnt\0" as *const u8 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"i[3-7]86-*-pe\0" as *const u8 as *const libc::c_char,
                vector: &i386_pe_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: b"ia16-*-elf\0" as *const u8 as *const libc::c_char,
                vector: &i386_elf32_vec as *const bfd_target,
            };
            init
        },
        {
            let mut init = targmatch {
                triplet: 0 as *const libc::c_char,
                vector: 0 as *const bfd_target,
            };
            init
        },
...
unsafe extern "C" fn find_target(mut name: *const libc::c_char) -> *const bfd_target {
    let mut target: *const *const bfd_target = 0 as *const *const bfd_target;
    let mut match_0: *const targmatch = 0 as *const targmatch;
    target = &*bfd_target_vector.offset(0 as libc::c_int as isize)
        as *const *const bfd_target;
    while !(*target).is_null() {
        if strcmp(name, (**target).name) == 0 as libc::c_int {
            return *target;
        }
        target = target.offset(1);
        target;
    }
    match_0 = &*bfd_target_match.as_ptr().offset(0 as libc::c_int as isize)
        as *const targmatch;
    while !((*match_0).triplet).is_null() {
        if fnmatch((*match_0).triplet, name, 0 as libc::c_int) == 0 as libc::c_int {
            while ((*match_0).vector).is_null() {
                match_0 = match_0.offset(1);
                match_0;
            }
            return (*match_0).vector;
        }
        match_0 = match_0.offset(1);
        match_0;
    }
    bfd_set_error(bfd_error_invalid_target);
    return 0 as *const bfd_target;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_default_target(mut name: *const libc::c_char) -> bool {
    let mut target: *const bfd_target = 0 as *const bfd_target;
    if !(bfd_default_vector[0 as libc::c_int as usize]).is_null()
        && strcmp(name, (*bfd_default_vector[0 as libc::c_int as usize]).name)
            == 0 as libc::c_int
    {
    ...
    bfd_default_vector[0 as libc::c_int as usize] = target;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_find_target(
    mut target_name: *const libc::c_char,
    mut abfd: *mut bfd,
) -> *const bfd_target {
    let mut targname: *const libc::c_char = 0 as *const libc::c_char;
    let mut target: *const bfd_target = 0 as *const bfd_target;
    if !target_name.is_null() {
        targname = target_name;
    } else {
        targname = getenv(b"GNUTARGET\0" as *const u8 as *const libc::c_char);
    }
    if targname.is_null()
        || strcmp(targname, b"default\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
        if !(bfd_default_vector[0 as libc::c_int as usize]).is_null() {
            target = bfd_default_vector[0 as libc::c_int as usize];
        } else {
            target = *bfd_target_vector.offset(0 as libc::c_int as isize);
        }
        if !abfd.is_null() {
    ...
    if !abfd.is_null() {
        (*abfd).set_target_defaulted(0 as libc::c_int as libc::c_uint);
    }
...
unsafe extern "C" fn _bfd_find_arch_match(
    mut tname: *const libc::c_char,
    mut arch: *mut *const libc::c_char,
    mut def_target_arch: *mut *const libc::c_char,
) -> bool {
    if arch.is_null() {
        return 0 as libc::c_int != 0;
    }
    while !(*arch).is_null() {
        let mut in_a: *const libc::c_char = strstr(*arch, tname);
        let mut end_ch: libc::c_char = (if !in_a.is_null() {
            *in_a.offset(strlen(tname) as isize) as libc::c_int
        } else {
            0 as libc::c_int
        }) as libc::c_char;
        if !in_a.is_null()
            && (in_a == *arch
                || *in_a.offset(-(1 as libc::c_int) as isize) as libc::c_int
                    == ':' as i32) && end_ch as libc::c_int == 0 as libc::c_int
        {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_target_info(
    mut target_name: *const libc::c_char,
    mut abfd: *mut bfd,
    mut is_bigendian: *mut bool,
    mut underscoring: *mut libc::c_int,
    mut def_target_arch: *mut *const libc::c_char,
) -> *const bfd_target {
    let mut target_vec: *const bfd_target = 0 as *const bfd_target;
    if !is_bigendian.is_null() {
        *is_bigendian = 0 as libc::c_int != 0;
    }
    if !underscoring.is_null() {
        *underscoring = -(1 as libc::c_int);
    }
    if !def_target_arch.is_null() {
        *def_target_arch = 0 as *const libc::c_char;
    }
    ...
    if !is_bigendian.is_null() {
        *is_bigendian = (*target_vec).byteorder as libc::c_uint
            == BFD_ENDIAN_BIG as libc::c_int as libc::c_uint;
    }
    if !underscoring.is_null() {
        *underscoring = (*target_vec).symbol_leading_char as libc::c_int
            & 0xff as libc::c_int;
    }
    if !def_target_arch.is_null() {
        let mut tname: *const libc::c_char = (*target_vec).name;
        let mut arches: *mut *const libc::c_char = bfd_arch_list();
        if !arches.is_null() && !tname.is_null() {
            let mut hyp: *mut libc::c_char = strchr(tname, '-' as i32);
            if !hyp.is_null() {
                hyp = hyp.offset(1);
                tname = hyp;
                if !_bfd_find_arch_match(tname, arches, def_target_arch) {
                    let mut new_tname: [libc::c_char; 50] = [0; 50];
                    strcpy(new_tname.as_mut_ptr(), hyp);
                    loop {
                        hyp = strrchr(new_tname.as_mut_ptr(), '-' as i32);
                        if hyp.is_null() {
                            break;
                        }
                        *hyp = 0 as libc::c_int as libc::c_char;
                        if _bfd_find_arch_match(
                            new_tname.as_mut_ptr(),
                            arches,
                            def_target_arch,
                        ) {
                            break;
        ...
        free(arches as *mut libc::c_void);
    }
    return target_vec;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_target_list() -> *mut *const libc::c_char {
    let mut vec_length: libc::c_int = 0 as libc::c_int;
    let mut amt: size_t = 0;
    let mut target: *const *const bfd_target = 0 as *const *const bfd_target;
    let mut name_list: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    let mut name_ptr: *mut *const libc::c_char = 0 as *mut *const libc::c_char;
    target = &*bfd_target_vector.offset(0 as libc::c_int as isize)
        as *const *const bfd_target;
    while !(*target).is_null() {
        vec_length += 1;
    ...
    amt = ((vec_length + 1 as libc::c_int) as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<*mut *mut libc::c_char>() as libc::c_ulong);
    name_list = bfd_malloc(amt) as *mut *const libc::c_char;
    name_ptr = name_list;
    ...
    while !(*target).is_null() {
        if target
            == &*bfd_target_vector.offset(0 as libc::c_int as isize)
                as *const *const bfd_target
            || *target != *bfd_target_vector.offset(0 as libc::c_int as isize)
        {
            let fresh0 = name_ptr;
    ...
    *name_ptr = 0 as *const libc::c_char;
    return name_list;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_iterate_over_targets(
    mut func: Option::<
    ...
    while !(*target).is_null() {
        if func.expect("non-null function pointer")(*target, data) != 0 {
            return *target;
        }
        target = target.offset(1);
        target;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_flavour_name(
    mut flavour: bfd_flavour,
) -> *const libc::c_char {
    match flavour as libc::c_uint {
        0 => return b"unknown file format\0" as *const u8 as *const libc::c_char,
        1 => return b"a.out\0" as *const u8 as *const libc::c_char,
        2 => return b"COFF\0" as *const u8 as *const libc::c_char,
        3 => return b"ECOFF\0" as *const u8 as *const libc::c_char,
        4 => return b"XCOFF\0" as *const u8 as *const libc::c_char,
        5 => return b"ELF\0" as *const u8 as *const libc::c_char,
        6 => return b"Tekhex\0" as *const u8 as *const libc::c_char,
        7 => return b"Srec\0" as *const u8 as *const libc::c_char,
        8 => return b"Verilog\0" as *const u8 as *const libc::c_char,
        9 => return b"Ihex\0" as *const u8 as *const libc::c_char,
        10 => return b"SOM\0" as *const u8 as *const libc::c_char,
        11 => return b"OS9K\0" as *const u8 as *const libc::c_char,
        12 => return b"Versados\0" as *const u8 as *const libc::c_char,
        13 => return b"MSDOS\0" as *const u8 as *const libc::c_char,
        14 => return b"Ovax\0" as *const u8 as *const libc::c_char,
        15 => return b"Evax\0" as *const u8 as *const libc::c_char,
        16 => return b"mmo\0" as *const u8 as *const libc::c_char,
        17 => return b"MACH_O\0" as *const u8 as *const libc::c_char,
        18 => return b"PEF\0" as *const u8 as *const libc::c_char,
        19 => return b"PEF_XLIB\0" as *const u8 as *const libc::c_char,
        20 => return b"SYM\0" as *const u8 as *const libc::c_char,
        _ => {}
    }
    _bfd_abort(
        b"./targets.c\0" as *const u8 as *const libc::c_char,
        1806 as libc::c_int,
        (*::core::mem::transmute::<
            &[u8; 47],
            &[libc::c_char; 47],
        >(b"const char *bfd_flavour_name(enum bfd_flavour)\0"))
            .as_ptr(),
    );
}
unsafe extern "C" fn run_static_initializers() {
    _bfd_target_vector_entries = (::core::mem::size_of::<[*const bfd_target; 23]>()
        as libc::c_ulong)
        .wrapping_div(::core::mem::size_of::<*const bfd_target>() as libc::c_ulong);
}
#[used]
