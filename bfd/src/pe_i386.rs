...
extern "C" {
    ...
    fn _bfd_pe_only_swap_filehdr_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
...
#[no_mangle]
pub static mut i386_pe_big_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"pe-bigobj-i386\0" as *const u8 as *const libc::c_char,
        ...
        if isym.n_scnum == (*section).target_index {
            ...
            if symname.is_null() {
                ...
                match seen_state {
                        ...
                        match current_block {
                            ...
                            5878467013460477898 => {
                                ...
                                ) != 0 as libc::c_int
                                {
                                    ...
                                    current_block = 11991184731706313675;
                                }
                            }
                            _ => {}
                        }
                    ...
                    2 => {
                        current_block = 5878467013460477898;
                        match current_block {
                            8236137900636309791 => {
                                let mut aux: internal_auxent = internal_auxent {
                                    x_sym: C2RustUnnamed_23 {
...
static mut coff_section_alignment_table: [coff_section_alignment_entry; 9] = [coff_section_alignment_entry {
    name: 0 as *const libc::c_char,
    comparison_length: 0,
...
unsafe extern "C" fn coff_slurp_line_table(
    ...
    while counter < (*asect).lineno_count {
        let mut dst: internal_lineno = internal_lineno {
            l_addr: C2RustUnnamed_35 { l_symndx: 0 },
            l_lnno: 0,
        };
        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ...
            match (*src).u.syment.n_sclass as libc::c_int {
                ...
                0 => {
                        ...
                        && (*src).u.syment.n_scnum == 0 as libc::c_int
                    {
                        ...
                        current_block_71 = 9821107291673659861;
                    }
                }
                106 => {
                    current_block_71 = 9133369314816263045;
                }
                5 | 7 | 14 | 21 | _ => {
                    current_block_71 = 9821107291673659861;
                }
...
#[no_mangle]
pub static mut i386_pe_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"pe-i386\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_coff_flavour,
            byteorder: BFD_ENDIAN_LITTLE,
            header_byteorder: BFD_ENDIAN_LITTLE,
            object_flags: (0x1 as libc::c_int | 0x2 as libc::c_int | 0x4 as libc::c_int
...
unsafe extern "C" fn run_static_initializers() {
    ...
    coff_section_alignment_table_size = (::core::mem::size_of::<
        [coff_section_alignment_entry; 9],
    >() as libc::c_ulong)
        .wrapping_div(
