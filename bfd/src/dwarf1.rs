...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dwarf1_debug {
    pub abfd: *mut bfd,
    pub syms: *mut *mut asymbol,
    pub lastUnit: *mut dwarf1_unit,
    pub debug_section: *mut bfd_byte,
    pub debug_section_end: *mut bfd_byte,
    pub line_section: *mut bfd_byte,
    pub line_section_end: *mut bfd_byte,
    pub currentDie: *mut bfd_byte,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dwarf1_unit {
    pub prev: *mut dwarf1_unit,
    pub name: *mut libc::c_char,
    pub low_pc: libc::c_ulong,
    pub high_pc: libc::c_ulong,
    pub has_stmt_list: libc::c_int,
    pub stmt_list_offset: libc::c_ulong,
    pub first_child: *mut bfd_byte,
    pub line_count: libc::c_ulong,
    pub linenumber_table: *mut linenumber,
    pub func_list: *mut dwarf1_func,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct dwarf1_func {
    pub prev: *mut dwarf1_func,
    pub name: *mut libc::c_char,
    pub low_pc: libc::c_ulong,
    pub high_pc: libc::c_ulong,
}
...
pub struct die_info {
    ...
    pub sibling: libc::c_ulong,
    pub low_pc: libc::c_ulong,
    pub high_pc: libc::c_ulong,
    pub stmt_list_offset: libc::c_ulong,
    pub name: *mut libc::c_char,
    pub has_stmt_list: libc::c_int,
    pub tag: libc::c_ushort,
}
pub const TAG_entry_point: dwarf_tag = 3;
pub const TAG_inlined_subroutine: dwarf_tag = 29;
pub const TAG_subroutine: dwarf_tag = 20;
pub const TAG_global_subroutine: dwarf_tag = 6;
pub const AT_name: dwarf_attribute = 56;
pub const FORM_STRING: dwarf_form = 8;
pub const FORM_BLOCK4: dwarf_form = 4;
pub const FORM_BLOCK2: dwarf_form = 3;
pub const AT_high_pc: dwarf_attribute = 289;
pub const AT_low_pc: dwarf_attribute = 273;
pub const FORM_ADDR: dwarf_form = 1;
pub const FORM_DATA8: dwarf_form = 7;
pub const AT_stmt_list: dwarf_attribute = 262;
pub const AT_sibling: dwarf_attribute = 18;
pub const FORM_REF: dwarf_form = 2;
pub const FORM_DATA4: dwarf_form = 6;
pub const FORM_DATA2: dwarf_form = 5;
pub const TAG_padding: dwarf_tag = 0;
pub const TAG_compile_unit: dwarf_tag = 17;
pub type dwarf_tag = libc::c_uint;
pub const TAG_class_template: dwarf_tag = 32771;
pub const TAG_function_template: dwarf_tag = 32770;
pub const TAG_namelist: dwarf_tag = 32769;
pub const TAG_format_label: dwarf_tag = 32768;
pub const TAG_with_stmt: dwarf_tag = 34;
pub const TAG_subrange_type: dwarf_tag = 33;
pub const TAG_set_type: dwarf_tag = 32;
pub const TAG_ptr_to_member_type: dwarf_tag = 31;
pub const TAG_module: dwarf_tag = 30;
pub const TAG_inheritance: dwarf_tag = 28;
pub const TAG_common_inclusion: dwarf_tag = 27;
pub const TAG_common_block: dwarf_tag = 26;
pub const TAG_variant: dwarf_tag = 25;
pub const TAG_unspecified_parameters: dwarf_tag = 24;
pub const TAG_union_type: dwarf_tag = 23;
pub const TAG_typedef: dwarf_tag = 22;
pub const TAG_subroutine_type: dwarf_tag = 21;
pub const TAG_structure_type: dwarf_tag = 19;
pub const TAG_string_type: dwarf_tag = 18;
pub const TAG_reference_type: dwarf_tag = 16;
pub const TAG_pointer_type: dwarf_tag = 15;
pub const TAG_member: dwarf_tag = 13;
pub const TAG_local_variable: dwarf_tag = 12;
pub const TAG_lexical_block: dwarf_tag = 11;
pub const TAG_label: dwarf_tag = 10;
pub const TAG_global_variable: dwarf_tag = 7;
pub const TAG_formal_parameter: dwarf_tag = 5;
pub const TAG_enumeration_type: dwarf_tag = 4;
pub const TAG_class_type: dwarf_tag = 2;
pub const TAG_array_type: dwarf_tag = 1;
pub type dwarf_form = libc::c_uint;
pub type dwarf_attribute = libc::c_uint;
pub const AT_body_end: dwarf_attribute = 32849;
pub const AT_body_begin: dwarf_attribute = 32833;
pub const AT_src_coords: dwarf_attribute = 32822;
pub const AT_mac_info: dwarf_attribute = 32806;
pub const AT_src_info: dwarf_attribute = 32790;
pub const AT_sf_names: dwarf_attribute = 32774;
pub const AT_virtual: dwarf_attribute = 776;
pub const AT_upper_bound_data8: dwarf_attribute = 759;
pub const AT_upper_bound_data4: dwarf_attribute = 758;
pub const AT_upper_bound_data2: dwarf_attribute = 757;
pub const AT_upper_bound_ref: dwarf_attribute = 754;
pub const AT_stride_size: dwarf_attribute = 742;
pub const AT_start_scope: dwarf_attribute = 710;
pub const AT_abstract_origin: dwarf_attribute = 690;
pub const AT_return_addr: dwarf_attribute = 675;
pub const AT_pure_virtual: dwarf_attribute = 664;
pub const AT_public: dwarf_attribute = 648;
pub const AT_prototyped: dwarf_attribute = 632;
pub const AT_protected: dwarf_attribute = 616;
pub const AT_program: dwarf_attribute = 568;
pub const AT_producer: dwarf_attribute = 600;
pub const AT_private: dwarf_attribute = 584;
pub const AT_lower_bound_data8: dwarf_attribute = 551;
pub const AT_lower_bound_data4: dwarf_attribute = 550;
pub const AT_lower_bound_data2: dwarf_attribute = 549;
pub const AT_lower_bound_ref: dwarf_attribute = 546;
pub const AT_is_optional: dwarf_attribute = 536;
pub const AT_inline: dwarf_attribute = 520;
pub const AT_friends: dwarf_attribute = 499;
pub const AT_default_value_string: dwarf_attribute = 488;
pub const AT_default_value_data8: dwarf_attribute = 487;
pub const AT_default_value_data4: dwarf_attribute = 486;
pub const AT_default_value_data2: dwarf_attribute = 485;
pub const AT_default_value_addr: dwarf_attribute = 481;
pub const AT_containing_type: dwarf_attribute = 466;
pub const AT_const_value_block4: dwarf_attribute = 452;
pub const AT_const_value_block2: dwarf_attribute = 451;
pub const AT_const_value_data8: dwarf_attribute = 455;
pub const AT_const_value_data4: dwarf_attribute = 454;
pub const AT_const_value_data2: dwarf_attribute = 453;
pub const AT_const_value_string: dwarf_attribute = 456;
pub const AT_comp_dir: dwarf_attribute = 440;
pub const AT_common_reference: dwarf_attribute = 418;
pub const AT_string_length: dwarf_attribute = 403;
pub const AT_discr_value: dwarf_attribute = 355;
pub const AT_discr: dwarf_attribute = 338;
pub const AT_member: dwarf_attribute = 322;
pub const AT_language: dwarf_attribute = 310;
pub const AT_element_list: dwarf_attribute = 244;
pub const AT_bit_size: dwarf_attribute = 214;
pub const AT_bit_offset: dwarf_attribute = 197;
pub const AT_byte_size: dwarf_attribute = 182;
pub const AT_subscr_data: dwarf_attribute = 163;
pub const AT_ordering: dwarf_attribute = 149;
pub const AT_mod_u_d_type: dwarf_attribute = 131;
pub const AT_user_def_type: dwarf_attribute = 114;
pub const AT_mod_fund_type: dwarf_attribute = 99;
pub const AT_fund_type: dwarf_attribute = 85;
pub const AT_location: dwarf_attribute = 35;
unsafe extern "C" fn alloc_dwarf1_unit(
    mut stash: *mut dwarf1_debug,
) -> *mut dwarf1_unit {
    let mut amt: size_t = ::core::mem::size_of::<dwarf1_unit>() as libc::c_ulong;
    let mut x: *mut dwarf1_unit = bfd_zalloc((*stash).abfd, amt) as *mut dwarf1_unit;
    if !x.is_null() {
...
unsafe extern "C" fn alloc_dwarf1_func(
    mut stash: *mut dwarf1_debug,
    mut aUnit: *mut dwarf1_unit,
) -> *mut dwarf1_func {
    let mut amt: size_t = ::core::mem::size_of::<dwarf1_func>() as libc::c_ulong;
    let mut x: *mut dwarf1_func = bfd_zalloc((*stash).abfd, amt) as *mut dwarf1_func;
    if !x.is_null() {
...
unsafe extern "C" fn parse_die(
    mut abfd: *mut bfd,
    mut aDieInfo: *mut die_info,
    mut aDiePtr: *mut bfd_byte,
    mut aDiePtrEnd: *mut bfd_byte,
) -> bool {
    let mut this_die: *mut bfd_byte = aDiePtr;
    let mut xptr: *mut bfd_byte = this_die;
    memset(
        aDieInfo as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<die_info>() as libc::c_ulong,
    );
    if xptr.offset(4 as libc::c_int as isize) > aDiePtrEnd {
    ...
    (*aDieInfo)
        ...
        .expect("non-null function pointer")(xptr as *const libc::c_void);
    xptr = xptr.offset(4 as libc::c_int as isize);
    if (*aDieInfo).length == 0 as libc::c_int as libc::c_ulong
        || this_die.offset((*aDieInfo).length as isize) > aDiePtrEnd
    {
        return 0 as libc::c_int != 0;
    }
    aDiePtrEnd = this_die.offset((*aDieInfo).length as isize);
    if (*aDieInfo).length < 6 as libc::c_int as libc::c_ulong {
        (*aDieInfo).tag = TAG_padding as libc::c_int as libc::c_ushort;
        return 1 as libc::c_int != 0;
    }
    if xptr.offset(2 as libc::c_int as isize) > aDiePtrEnd {
        return 0 as libc::c_int != 0;
    }
    (*aDieInfo)
        .tag = (Some(((*(*abfd).xvec).bfd_getx16).expect("non-null function pointer")))
        .expect("non-null function pointer")(xptr as *const libc::c_void)
        as libc::c_ushort;
    xptr = xptr.offset(2 as libc::c_int as isize);
    while xptr.offset(2 as libc::c_int as isize) <= aDiePtrEnd {
        let mut block_len: libc::c_uint = 0;
        let mut attr: libc::c_ushort = 0;
        attr = (Some(((*(*abfd).xvec).bfd_getx16).expect("non-null function pointer")))
            .expect("non-null function pointer")(xptr as *const libc::c_void)
            as libc::c_ushort;
        xptr = xptr.offset(2 as libc::c_int as isize);
        match attr as libc::c_int & 0xf as libc::c_int {
            5 => {
                xptr = xptr.offset(2 as libc::c_int as isize);
            }
            6 | 2 => {
                if xptr.offset(4 as libc::c_int as isize) <= aDiePtrEnd {
                    if attr as libc::c_int == AT_sibling as libc::c_int {
                        (*aDieInfo)
                            .sibling = (Some(
                            ...
                            )(xptr as *const libc::c_void);
                    } else if attr as libc::c_int == AT_stmt_list as libc::c_int {
                        (*aDieInfo)
                            .stmt_list_offset = (Some(
                            ((*(*abfd).xvec).bfd_getx32)
                                .expect("non-null function pointer"),
                        ))
                            .expect(
                        ...
                        (*aDieInfo).has_stmt_list = 1 as libc::c_int;
                    }
                }
                xptr = xptr.offset(4 as libc::c_int as isize);
            }
            7 => {
                xptr = xptr.offset(8 as libc::c_int as isize);
            }
            1 => {
                if xptr.offset(4 as libc::c_int as isize) <= aDiePtrEnd {
                    if attr as libc::c_int == AT_low_pc as libc::c_int {
                        (*aDieInfo)
                            .low_pc = (Some(
                            ((*(*abfd).xvec).bfd_getx32)
                                .expect("non-null function pointer"),
                    ...
                    } else if attr as libc::c_int == AT_high_pc as libc::c_int {
                        (*aDieInfo)
                            .high_pc = (Some(
                            ((*(*abfd).xvec).bfd_getx32)
                                .expect("non-null function pointer"),
            ...
            3 => {
                if xptr.offset(2 as libc::c_int as isize) <= aDiePtrEnd {
                    block_len = (Some(
                        ...
                        .expect("non-null function pointer")(xptr as *const libc::c_void)
                        as libc::c_uint;
                    if xptr.offset(block_len as isize) > aDiePtrEnd
                        || xptr.offset(block_len as isize) < xptr
                    {
                        return 0 as libc::c_int != 0;
                    }
                    xptr = xptr.offset(block_len as isize);
                }
                xptr = xptr.offset(2 as libc::c_int as isize);
            }
            4 => {
            ...
            8 => {
                if attr as libc::c_int == AT_name as libc::c_int {
                    (*aDieInfo).name = xptr as *mut libc::c_char;
                }
                xptr = xptr
                    .offset(
                        (strnlen(
                            xptr as *mut libc::c_char,
                            aDiePtrEnd.offset_from(xptr) as libc::c_long as size_t,
                        ))
...
unsafe extern "C" fn parse_line_table(
    mut stash: *mut dwarf1_debug,
    mut aUnit: *mut dwarf1_unit,
) -> bool {
    let mut xptr: *mut bfd_byte = 0 as *mut bfd_byte;
    if ((*stash).line_section).is_null() {
        let mut msec: *mut asection = 0 as *mut asection;
        let mut size: bfd_size_type = 0;
        msec = bfd_get_section_by_name(
            (*stash).abfd,
        ...
        size = if (*msec).rawsize != 0 { (*msec).rawsize } else { (*msec).size };
        (*stash)
            .line_section = bfd_simple_get_relocated_section_contents(
            (*stash).abfd,
            msec,
            0 as *mut bfd_byte,
            (*stash).syms,
        ...
        (*stash).line_section_end = ((*stash).line_section).offset(size as isize);
    }
    xptr = ((*stash).line_section).offset((*aUnit).stmt_list_offset as isize);
    if xptr.offset(8 as libc::c_int as isize) <= (*stash).line_section_end {
        let mut eachLine: libc::c_ulong = 0;
        let mut tblend: *mut bfd_byte = 0 as *mut bfd_byte;
        let mut base: libc::c_ulong = 0;
        let mut amt: bfd_size_type = 0;
        tblend = xptr
            .offset(
                (Some(
                    ((*(*(*stash).abfd).xvec).bfd_getx32)
                        .expect("non-null function pointer"),
                ))
                    .expect("non-null function pointer")(xptr as *const libc::c_void)
                    as isize,
        ...
        xptr = xptr.offset(4 as libc::c_int as isize);
        base = (Some(
            ((*(*(*stash).abfd).xvec).bfd_getx32).expect("non-null function pointer"),
        ))
            .expect("non-null function pointer")(xptr as *const libc::c_void);
        xptr = xptr.offset(4 as libc::c_int as isize);
        (*aUnit)
            .line_count = (tblend.offset_from(xptr) as libc::c_long
            / 10 as libc::c_int as libc::c_long) as libc::c_ulong;
        amt = (::core::mem::size_of::<linenumber>() as libc::c_ulong)
            .wrapping_mul((*aUnit).line_count);
        (*aUnit).linenumber_table = bfd_alloc((*stash).abfd, amt) as *mut linenumber;
        if ((*aUnit).linenumber_table).is_null() {
            return 0 as libc::c_int != 0;
        }
        eachLine = 0 as libc::c_int as libc::c_ulong;
        while eachLine < (*aUnit).line_count {
            if xptr.offset(10 as libc::c_int as isize) > (*stash).line_section_end {
                (*aUnit).line_count = eachLine;
                break;
            } else {
                (*((*aUnit).linenumber_table).offset(eachLine as isize))
                    .linenumber = (Some(
                    ((*(*(*stash).abfd).xvec).bfd_getx32)
                        .expect("non-null function pointer"),
                ))
                ...
                xptr = xptr.offset(4 as libc::c_int as isize);
                eachLine = eachLine.wrapping_add(1);
                eachLine;
            }
        }
    }
...
unsafe extern "C" fn parse_functions_in_unit(
    mut stash: *mut dwarf1_debug,
    mut aUnit: *mut dwarf1_unit,
) -> bool {
    let mut eachDie: *mut bfd_byte = 0 as *mut bfd_byte;
    if !((*aUnit).first_child).is_null() {
        eachDie = (*aUnit).first_child;
        while eachDie < (*stash).debug_section_end {
            let mut eachDieInfo: die_info = die_info {
                length: 0,
                sibling: 0,
                low_pc: 0,
                high_pc: 0,
            ...
            if eachDieInfo.tag as libc::c_int == TAG_global_subroutine as libc::c_int
                || eachDieInfo.tag as libc::c_int == TAG_subroutine as libc::c_int
                || eachDieInfo.tag as libc::c_int
                    == TAG_inlined_subroutine as libc::c_int
                || eachDieInfo.tag as libc::c_int == TAG_entry_point as libc::c_int
            {
                let mut aFunc: *mut dwarf1_func = alloc_dwarf1_func(stash, aUnit);
                if aFunc.is_null() {
                    return 0 as libc::c_int != 0;
                }
            ...
            if !(eachDieInfo.sibling != 0) {
                break;
            }
            eachDie = ((*stash).debug_section).offset(eachDieInfo.sibling as isize);
        }
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn dwarf1_unit_find_nearest_line(
    mut stash: *mut dwarf1_debug,
    mut aUnit: *mut dwarf1_unit,
    ...
    let mut line_p: libc::c_int = 0 as libc::c_int;
    let mut func_p: libc::c_int = 0 as libc::c_int;
    if (*aUnit).low_pc <= addr && addr < (*aUnit).high_pc {
        if (*aUnit).has_stmt_list != 0 {
            let mut i: libc::c_ulong = 0;
            let mut eachFunc: *mut dwarf1_func = 0 as *mut dwarf1_func;
            if ((*aUnit).linenumber_table).is_null() {
                if !parse_line_table(stash, aUnit) {
                    return 0 as libc::c_int != 0;
                }
            }
            if ((*aUnit).func_list).is_null() {
                if !parse_functions_in_unit(stash, aUnit) {
                    return 0 as libc::c_int != 0;
                }
            }
            i = 0 as libc::c_int as libc::c_ulong;
            while i < (*aUnit).line_count {
                if (*((*aUnit).linenumber_table).offset(i as isize)).addr <= addr
                    && addr
                        < (*((*aUnit).linenumber_table)
                            .offset(
                            ...
                            .addr
                {
                    ...
                    *linenumber_ptr = (*((*aUnit).linenumber_table).offset(i as isize))
                        .linenumber as libc::c_uint;
                    line_p = 1 as libc::c_int;
                    break;
                } else {
                    i = i.wrapping_add(1);
                    i;
    ...
    return line_p != 0 || func_p != 0;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_dwarf1_find_nearest_line(
    mut abfd: *mut bfd,
    ...
    let mut stash: *mut dwarf1_debug = (*(*abfd).tdata.elf_obj_data)
        .dwarf1_find_line_info;
    let mut eachUnit: *mut dwarf1_unit = 0 as *mut dwarf1_unit;
    let mut addr: libc::c_ulong = offset.wrapping_add((*section).vma);
    *filename_ptr = 0 as *const libc::c_char;
    *functionname_ptr = 0 as *const libc::c_char;
    *linenumber_ptr = 0 as libc::c_int as libc::c_uint;
    if stash.is_null() {
        let mut msec: *mut asection = 0 as *mut asection;
        let mut size: bfd_size_type = ::core::mem::size_of::<dwarf1_debug>()
            as libc::c_ulong;
        (*(*abfd).tdata.elf_obj_data)
            .dwarf1_find_line_info = bfd_zalloc(abfd, size) as *mut dwarf1_debug;
        ...
        size = if (*msec).rawsize != 0 { (*msec).rawsize } else { (*msec).size };
        (*stash)
            .debug_section = bfd_simple_get_relocated_section_contents(
            abfd,
            msec,
            0 as *mut bfd_byte,
            symbols,
        );
        if ((*stash).debug_section).is_null() {
            return 0 as libc::c_int != 0;
        }
        (*stash).debug_section_end = ((*stash).debug_section).offset(size as isize);
    ...
    eachUnit = (*stash).lastUnit;
    while !eachUnit.is_null() {
        ...
        eachUnit = (*eachUnit).prev;
    }
    while (*stash).currentDie < (*stash).debug_section_end {
        let mut aDieInfo: die_info = die_info {
            length: 0,
            sibling: 0,
            low_pc: 0,
            high_pc: 0,
        ...
        if aDieInfo.tag as libc::c_int == TAG_compile_unit as libc::c_int {
            let mut aUnit: *mut dwarf1_unit = alloc_dwarf1_unit(stash);
            if aUnit.is_null() {
                return 0 as libc::c_int != 0;
            }
            ...
            if aDieInfo.sibling != 0
                && ((*stash).currentDie).offset(aDieInfo.length as isize)
                    < (*stash).debug_section_end
                && ((*stash).currentDie).offset(aDieInfo.length as isize)
                    != ((*stash).debug_section).offset(aDieInfo.sibling as isize)
            {
                (*aUnit)
                    .first_child = ((*stash).currentDie)
                    .offset(aDieInfo.length as isize);
            } else {
                (*aUnit).first_child = 0 as *mut bfd_byte;
            }
            if (*aUnit).low_pc <= addr && addr < (*aUnit).high_pc {
                return dwarf1_unit_find_nearest_line(
                    stash,
        ...
        if aDieInfo.sibling != 0 as libc::c_int as libc::c_ulong {
            (*stash)
                .currentDie = ((*stash).debug_section).offset(aDieInfo.sibling as isize);
        } else {
            (*stash).currentDie = ((*stash).currentDie).offset(aDieInfo.length as isize);
        }
    }
    return 0 as libc::c_int != 0;
}
