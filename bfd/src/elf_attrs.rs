...
pub const Tag_compatibility: C2RustUnnamed_23 = 32;
pub const Tag_Symbol: C2RustUnnamed_23 = 3;
pub const Tag_Section: C2RustUnnamed_23 = 2;
pub const Tag_File: C2RustUnnamed_23 = 1;
pub const Tag_NULL: C2RustUnnamed_23 = 0;
#[inline]
unsafe extern "C" fn bfd_get_flavour(mut abfd: *const bfd) -> bfd_flavour {
    return (*(*abfd).xvec).flavour;
}
unsafe extern "C" fn uleb128_size(mut i: libc::c_uint) -> libc::c_int {
    let mut size: libc::c_int = 0;
    size = 1 as libc::c_int;
    while i >= 0x80 as libc::c_int as libc::c_uint {
        i >>= 7 as libc::c_int;
        size += 1;
        size;
    }
...
unsafe extern "C" fn is_default_attr(mut attr: *mut obj_attribute) -> bool {
    if (*attr).type_0 & (1 as libc::c_int) << 3 as libc::c_int != 0 {
        return 1 as libc::c_int != 0;
    }
    if (*attr).type_0 & (1 as libc::c_int) << 0 as libc::c_int != 0
        && (*attr).i != 0 as libc::c_int as libc::c_uint
    {
        return 0 as libc::c_int != 0;
    }
    if (*attr).type_0 & (1 as libc::c_int) << 1 as libc::c_int != 0
        && !((*attr).s).is_null() && *(*attr).s as libc::c_int != 0
    {
        return 0 as libc::c_int != 0;
    }
    if (*attr).type_0 & (1 as libc::c_int) << 2 as libc::c_int != 0 {
        return 0 as libc::c_int != 0;
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn obj_attr_size(
    mut tag: libc::c_uint,
    mut attr: *mut obj_attribute,
) -> bfd_vma {
    let mut size: bfd_vma = 0;
    if is_default_attr(attr) {
        return 0 as libc::c_int as bfd_vma;
    }
    size = uleb128_size(tag) as bfd_vma;
    if (*attr).type_0 & (1 as libc::c_int) << 0 as libc::c_int != 0 {
        size = (size as libc::c_ulong)
            .wrapping_add(uleb128_size((*attr).i) as libc::c_ulong) as bfd_vma
            as bfd_vma;
    }
    if (*attr).type_0 & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        size = (size as libc::c_ulong)
            .wrapping_add(
                (strlen((*attr).s)).wrapping_add(1 as libc::c_int as libc::c_ulong),
            ) as bfd_vma as bfd_vma;
    }
    return size;
}
unsafe extern "C" fn vendor_obj_attr_name(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
) -> *const libc::c_char {
    return if vendor == 0 as libc::c_int {
        (*((*(*abfd).xvec).backend_data as *const elf_backend_data)).obj_attrs_vendor
    } else {
        b"gnu\0" as *const u8 as *const libc::c_char
    };
}
unsafe extern "C" fn vendor_obj_attr_size(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
) -> bfd_vma {
    let mut size: bfd_vma = 0;
    let mut attr: *mut obj_attribute = 0 as *mut obj_attribute;
    let mut list: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    let mut i: libc::c_int = 0;
    let mut vendor_name: *const libc::c_char = vendor_obj_attr_name(abfd, vendor);
    if vendor_name.is_null() {
        return 0 as libc::c_int as bfd_vma;
    }
    attr = ((*(*abfd).tdata.elf_obj_data).known_obj_attributes[vendor as usize])
        .as_mut_ptr();
    size = 0 as libc::c_int as bfd_vma;
    i = 2 as libc::c_int;
    while i < 71 as libc::c_int {
        size = (size as libc::c_ulong)
            .wrapping_add(
                obj_attr_size(i as libc::c_uint, &mut *attr.offset(i as isize)),
            ) as bfd_vma as bfd_vma;
        i += 1;
        i;
    }
    list = (*(*abfd).tdata.elf_obj_data).other_obj_attributes[vendor as usize];
    while !list.is_null() {
        size = (size as libc::c_ulong)
            .wrapping_add(obj_attr_size((*list).tag, &mut (*list).attr)) as bfd_vma
            as bfd_vma;
        list = (*list).next;
    }
    return if size != 0 {
        size.wrapping_add(10 as libc::c_int as libc::c_ulong)
            .wrapping_add(strlen(vendor_name))
    } else {
        0 as libc::c_int as libc::c_ulong
    };
}
#[no_mangle]
pub unsafe extern "C" fn bfd_elf_obj_attr_size(mut abfd: *mut bfd) -> bfd_vma {
    let mut size: bfd_vma = 0;
    size = vendor_obj_attr_size(abfd, 0 as libc::c_int);
    size = (size as libc::c_ulong)
        .wrapping_add(vendor_obj_attr_size(abfd, 1 as libc::c_int)) as bfd_vma
        as bfd_vma;
    return if size != 0 {
...
unsafe extern "C" fn write_uleb128(
    mut p: *mut bfd_byte,
    mut val: libc::c_uint,
) -> *mut bfd_byte {
    let mut c: bfd_byte = 0;
    loop {
        c = (val & 0x7f as libc::c_int as libc::c_uint) as bfd_byte;
        val >>= 7 as libc::c_int;
        if val != 0 {
            c = (c as libc::c_int | 0x80 as libc::c_int) as bfd_byte;
        }
        let fresh0 = p;
        p = p.offset(1);
        *fresh0 = c;
...
unsafe extern "C" fn write_obj_attribute(
    mut p: *mut bfd_byte,
    mut tag: libc::c_uint,
    mut attr: *mut obj_attribute,
) -> *mut bfd_byte {
    ...
    if (*attr).type_0 & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        ...
        len = (strlen((*attr).s)).wrapping_add(1 as libc::c_int as libc::c_ulong)
            as libc::c_int;
        memcpy(
            p as *mut libc::c_void,
            (*attr).s as *const libc::c_void,
            len as libc::c_ulong,
        );
...
unsafe extern "C" fn vendor_set_obj_attr_contents(
    mut abfd: *mut bfd,
    ...
    let mut i: libc::c_int = 0;
    let mut vendor_name: *const libc::c_char = vendor_obj_attr_name(abfd, vendor);
    let mut vendor_length: size_t = (strlen(vendor_name))
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
    p = contents;
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect("non-null function pointer")(size, p as *mut libc::c_void);
    p = p.offset(4 as libc::c_int as isize);
    memcpy(p as *mut libc::c_void, vendor_name as *const libc::c_void, vendor_length);
    p = p.offset(vendor_length as isize);
    let fresh1 = p;
    p = p.offset(1);
    *fresh1 = Tag_File as libc::c_int as bfd_byte;
    (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        size.wrapping_sub(4 as libc::c_int as libc::c_ulong).wrapping_sub(vendor_length),
        p as *mut libc::c_void,
    );
    p = p.offset(4 as libc::c_int as isize);
    attr = ((*(*abfd).tdata.elf_obj_data).known_obj_attributes[vendor as usize])
    ...
    i = 2 as libc::c_int;
    while i < 71 as libc::c_int {
        let mut tag: libc::c_uint = i as libc::c_uint;
        if ((*((*(*abfd).xvec).backend_data as *const elf_backend_data)).obj_attrs_order)
            .is_some()
        {
            tag = ((*((*(*abfd).xvec).backend_data as *const elf_backend_data))
                .obj_attrs_order)
                .expect("non-null function pointer")(i) as libc::c_uint;
        }
        p = write_obj_attribute(p, tag, &mut *attr.offset(tag as isize));
        i += 1;
        i;
    }
    list = (*(*abfd).tdata.elf_obj_data).other_obj_attributes[vendor as usize];
    while !list.is_null() {
        p = write_obj_attribute(p, (*list).tag, &mut (*list).attr);
        list = (*list).next;
    }
}
#[no_mangle]
pub unsafe extern "C" fn bfd_elf_set_obj_attr_contents(
    mut abfd: *mut bfd,
    mut contents: *mut bfd_byte,
    mut size: bfd_vma,
) {
    let mut p: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut vendor: libc::c_int = 0;
    let mut my_size: bfd_vma = 0;
    p = contents;
    let fresh2 = p;
    p = p.offset(1);
    *fresh2 = 'A' as i32 as bfd_byte;
    my_size = 1 as libc::c_int as bfd_vma;
    vendor = 0 as libc::c_int;
    while vendor <= 1 as libc::c_int {
        let mut vendor_size: bfd_vma = vendor_obj_attr_size(abfd, vendor);
        if vendor_size != 0 {
            vendor_set_obj_attr_contents(abfd, p, vendor_size, vendor);
        }
        p = p.offset(vendor_size as isize);
        my_size = (my_size as libc::c_ulong).wrapping_add(vendor_size) as bfd_vma
            as bfd_vma;
        vendor += 1;
        vendor;
    }
    if size != my_size {
        _bfd_abort(
            b"elf-attrs.c\0" as *const u8 as *const libc::c_char,
            227 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 63],
                &[libc::c_char; 63],
            >(b"void bfd_elf_set_obj_attr_contents(bfd *, bfd_byte *, bfd_vma)\0"))
                .as_ptr(),
        );
    }
}
unsafe extern "C" fn elf_new_obj_attr(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
) -> *mut obj_attribute {
    let mut attr: *mut obj_attribute = 0 as *mut obj_attribute;
    let mut list: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    let mut p: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    let mut lastp: *mut *mut obj_attribute_list = 0 as *mut *mut obj_attribute_list;
    if tag < 71 as libc::c_int as libc::c_uint {
        attr = &mut *(*((*(*abfd).tdata.elf_obj_data).known_obj_attributes)
            .as_mut_ptr()
            .offset(vendor as isize))
            .as_mut_ptr()
            .offset(tag as isize) as *mut obj_attribute;
    } else {
        list = bfd_alloc(
            abfd,
            ::core::mem::size_of::<obj_attribute_list>() as libc::c_ulong,
        ) as *mut obj_attribute_list;
        memset(
        ...
        (*list).tag = tag;
        lastp = &mut *((*(*abfd).tdata.elf_obj_data).other_obj_attributes)
            .as_mut_ptr()
            .offset(vendor as isize) as *mut *mut obj_attribute_list;
        p = *lastp;
        while !p.is_null() {
            if tag < (*p).tag {
                break;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf_get_obj_attr_int(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
) -> libc::c_int {
    let mut p: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    if tag < 71 as libc::c_int as libc::c_uint {
        return (*(*abfd).tdata.elf_obj_data)
            .known_obj_attributes[vendor as usize][tag as usize]
            .i as libc::c_int
    } else {
        p = (*(*abfd).tdata.elf_obj_data).other_obj_attributes[vendor as usize];
        while !p.is_null() {
            if tag == (*p).tag {
                return (*p).attr.i as libc::c_int;
            }
            if tag < (*p).tag {
                break;
            }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf_add_obj_attr_int(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
    mut i: libc::c_uint,
    ...
    (*attr).type_0 = _bfd_elf_obj_attrs_arg_type(abfd, vendor, tag);
    (*attr).i = i;
}
unsafe extern "C" fn elf_attr_strdup(
    mut abfd: *mut bfd,
    ...
    if !end.is_null() {
        len = strnlen(s, end.offset_from(s) as libc::c_long as size_t);
    } else {
        len = strlen(s);
    }
    p = bfd_alloc(abfd, len.wrapping_add(1 as libc::c_int as libc::c_ulong))
        as *mut libc::c_char;
    if !p.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_attr_strdup(
    mut abfd: *mut bfd,
    mut s: *const libc::c_char,
) -> *mut libc::c_char {
    return elf_attr_strdup(abfd, s, 0 as *const libc::c_char);
}
unsafe extern "C" fn elf_add_obj_attr_string(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
    mut s: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf_add_obj_attr_string(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
    mut s: *const libc::c_char,
) {
    elf_add_obj_attr_string(abfd, vendor, tag, s, 0 as *const libc::c_char);
}
unsafe extern "C" fn elf_add_obj_attr_int_string(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
    mut i: libc::c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_elf_add_obj_attr_int_string(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
    mut i: libc::c_uint,
    ...
    elf_add_obj_attr_int_string(abfd, vendor, tag, i, s, 0 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_copy_obj_attributes(
    mut ibfd: *mut bfd,
    mut obfd: *mut bfd,
) {
    let mut in_attr: *mut obj_attribute = 0 as *mut obj_attribute;
    let mut out_attr: *mut obj_attribute = 0 as *mut obj_attribute;
    let mut list: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    let mut i: libc::c_int = 0;
    let mut vendor: libc::c_int = 0;
    ...
    vendor = 0 as libc::c_int;
    while vendor <= 1 as libc::c_int {
        in_attr = &mut *(*((*(*ibfd).tdata.elf_obj_data).known_obj_attributes)
            .as_mut_ptr()
            .offset(vendor as isize))
            .as_mut_ptr()
            .offset(2 as libc::c_int as isize) as *mut obj_attribute;
        out_attr = &mut *(*((*(*obfd).tdata.elf_obj_data).known_obj_attributes)
            .as_mut_ptr()
            .offset(vendor as isize))
            .as_mut_ptr()
            .offset(2 as libc::c_int as isize) as *mut obj_attribute;
        i = 2 as libc::c_int;
        while i < 71 as libc::c_int {
            (*out_attr).type_0 = (*in_attr).type_0;
            (*out_attr).i = (*in_attr).i;
            if !((*in_attr).s).is_null() && *(*in_attr).s as libc::c_int != 0 {
                (*out_attr).s = _bfd_elf_attr_strdup(obfd, (*in_attr).s);
            }
            in_attr = in_attr.offset(1);
            in_attr;
            out_attr = out_attr.offset(1);
            out_attr;
            i += 1;
            i;
        }
        list = (*(*ibfd).tdata.elf_obj_data).other_obj_attributes[vendor as usize];
        while !list.is_null() {
            in_attr = &mut (*list).attr;
            match (*in_attr).type_0
                    ...
                    | (1 as libc::c_int) << 1 as libc::c_int)
            {
                ...
                2 => {
                    bfd_elf_add_obj_attr_string(obfd, vendor, (*list).tag, (*in_attr).s);
                }
                3 => {
                ...
                _ => {
                    _bfd_abort(
                        ...
                        (*::core::mem::transmute::<
                            &[u8; 48],
                            &[libc::c_char; 48],
                        >(b"void _bfd_elf_copy_obj_attributes(bfd *, bfd *)\0"))
                            .as_ptr(),
                    );
                }
            }
...
unsafe extern "C" fn gnu_obj_attrs_arg_type(mut tag: libc::c_uint) -> libc::c_int {
    if tag == Tag_compatibility as libc::c_int as libc::c_uint {
        return 3 as libc::c_int
    } else {
        return if tag & 1 as libc::c_int as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_obj_attrs_arg_type(
    mut abfd: *mut bfd,
    mut vendor: libc::c_int,
    mut tag: libc::c_uint,
) -> libc::c_int {
    match vendor {
        0 => {
            return ((*((*(*abfd).xvec).backend_data as *const elf_backend_data))
                .obj_attrs_arg_type)
                .expect("non-null function pointer")(tag as libc::c_int);
        }
        1 => return gnu_obj_attrs_arg_type(tag),
        _ => {
            _bfd_abort(
                b"elf-attrs.c\0" as *const u8 as *const libc::c_char,
                455 as libc::c_int,
                (*::core::mem::transmute::<
                    &[u8; 58],
                    &[libc::c_char; 58],
                >(b"int _bfd_elf_obj_attrs_arg_type(bfd *, int, unsigned int)\0"))
                    .as_ptr(),
            );
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_parse_attributes(
    mut abfd: *mut bfd,
    mut hdr: *mut Elf_Internal_Shdr,
) {
    let mut contents: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut p: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut p_end: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut std_sec: *const libc::c_char = 0 as *const libc::c_char;
    let mut filesize: ufile_ptr = 0;
    if (*hdr).sh_size == 0 as libc::c_int as libc::c_ulong {
        return;
    }
    filesize = bfd_get_file_size(abfd);
    if filesize != 0 as libc::c_int as libc::c_ulong && (*hdr).sh_size > filesize {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: error: attribute section '%pA' too big: %#llx\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
            (*hdr).bfd_section,
            (*hdr).sh_size as libc::c_longlong,
        );
        bfd_set_error(bfd_error_invalid_operation);
        return;
    }
    contents = bfd_malloc((*hdr).sh_size) as *mut bfd_byte;
    if contents.is_null() {
        return;
    }
    ...
    p = contents;
    p_end = p.offset((*hdr).sh_size as isize);
    std_sec = (*((*(*abfd).xvec).backend_data as *const elf_backend_data))
        .obj_attrs_vendor;
    let fresh3 = p;
    p = p.offset(1);
    if *fresh3 as libc::c_int == 'A' as i32 {
        while p_end.offset_from(p) as libc::c_long >= 4 as libc::c_int as libc::c_long {
            let mut len: size_t = p_end.offset_from(p) as libc::c_long as size_t;
            let mut namelen: size_t = 0;
            let mut section_len: size_t = 0;
            let mut vendor: libc::c_int = 0;
            section_len = (Some(
            ...
            p = p.offset(4 as libc::c_int as isize);
            if section_len == 0 as libc::c_int as libc::c_ulong {
                break;
            }
            if section_len > len {
                section_len = len;
            ...
            if section_len <= 4 as libc::c_int as libc::c_ulong {
                _bfd_error_handler(
                    dcgettext(
                        b"bfd\0" as *const u8 as *const libc::c_char,
                        b"%pB: error: attribute section length too small: %ld\0"
                            as *const u8 as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    abfd,
                    section_len as libc::c_long,
                );
                break;
            } else {
                section_len = (section_len as libc::c_ulong)
                    .wrapping_sub(4 as libc::c_int as libc::c_ulong) as size_t as size_t;
                namelen = (strnlen(p as *mut libc::c_char, section_len))
                    .wrapping_add(1 as libc::c_int as libc::c_ulong);
                if namelen >= section_len {
                    break;
                }
                if !std_sec.is_null()
                    && strcmp(p as *mut libc::c_char, std_sec) == 0 as libc::c_int
                {
                    vendor = 0 as libc::c_int;
                } else if strcmp(
                ...
                {
                    vendor = 1 as libc::c_int;
                } else {
                    p = p.offset(section_len as isize);
                    continue;
                }
                p = p.offset(namelen as isize);
                section_len = (section_len as libc::c_ulong).wrapping_sub(namelen)
                    as size_t as size_t;
                while section_len > 0 as libc::c_int as libc::c_ulong {
                    let mut tag: libc::c_uint = 0;
                    let mut val: libc::c_uint = 0;
                    let mut subsection_len: size_t = 0;
                    let mut end: *mut bfd_byte = 0 as *mut bfd_byte;
                    let mut orig_p: *mut bfd_byte = 0 as *mut bfd_byte;
                    orig_p = p;
                    ...
                    if p_end.offset_from(p) as libc::c_long
                        >= 4 as libc::c_int as libc::c_long
                    {
                        ...
                        section_len = (section_len as libc::c_ulong)
                            .wrapping_sub(subsection_len) as size_t as size_t;
                        end = orig_p.offset(subsection_len as isize);
                        if end < p {
                            break;
                        }
                        match tag {
                            1 => {
                                while p < end {
                                    ...
                                    type_0 = _bfd_elf_obj_attrs_arg_type(abfd, vendor, tag);
                                    match type_0
                                        & ((1 as libc::c_int) << 0 as libc::c_int
                                            | (1 as libc::c_int) << 1 as libc::c_int)
                                    {
                                        ...
                                        _ => {
                                            _bfd_abort(
                                                ...
                                                (*::core::mem::transmute::<
                                                    ...
                                                    &[libc::c_char; 59],
                                                >(
                                                    b"void _bfd_elf_parse_attributes(bfd *, Elf_Internal_Shdr *)\0",
                                                ))
                                                    .as_ptr(),
                                            );
                                        }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_merge_object_attributes(
    mut ibfd: *mut bfd,
    ...
    while vendor <= 1 as libc::c_int {
        in_attr = &mut *(*((*(*ibfd).tdata.elf_obj_data).known_obj_attributes)
            ...
            .offset(vendor as isize))
            .as_mut_ptr()
            .offset(Tag_compatibility as libc::c_int as isize) as *mut obj_attribute;
        out_attr = &mut *(*((*(*obfd).tdata.elf_obj_data).known_obj_attributes)
            .as_mut_ptr()
            .offset(vendor as isize))
            .as_mut_ptr()
            .offset(Tag_compatibility as libc::c_int as isize) as *mut obj_attribute;
        if (*in_attr).i > 0 as libc::c_int as libc::c_uint
            && strcmp((*in_attr).s, b"gnu\0" as *const u8 as *const libc::c_char)
                != 0 as libc::c_int
        {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"error: %pB: object has vendor-specific contents that must be processed by the '%s' toolchain\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ibfd,
        ...
        if (*in_attr).i != (*out_attr).i
            || (*in_attr).i != 0 as libc::c_int as libc::c_uint
                && strcmp((*in_attr).s, (*out_attr).s) != 0 as libc::c_int
        {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"error: %pB: object tag '%d, %s' is incompatible with tag '%d, %s'\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                ibfd,
                (*in_attr).i,
                if !((*in_attr).s).is_null() {
                    (*in_attr).s as *const libc::c_char
                } else {
                    b"\0" as *const u8 as *const libc::c_char
                },
                (*out_attr).i,
                if !((*out_attr).s).is_null() {
                    (*out_attr).s as *const libc::c_char
                } else {
                    b"\0" as *const u8 as *const libc::c_char
                },
            );
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_merge_unknown_attribute_low(
    mut ibfd: *mut bfd,
    mut obfd: *mut bfd,
    mut tag: libc::c_int,
) -> bool {
    let mut in_attr: *mut obj_attribute = 0 as *mut obj_attribute;
    let mut out_attr: *mut obj_attribute = 0 as *mut obj_attribute;
    let mut err_bfd: *mut bfd = 0 as *mut bfd;
    let mut result: bool = 1 as libc::c_int != 0;
    in_attr = ((*(*ibfd).tdata.elf_obj_data)
        .known_obj_attributes[0 as libc::c_int as usize])
        .as_mut_ptr();
    out_attr = ((*(*obfd).tdata.elf_obj_data)
        .known_obj_attributes[0 as libc::c_int as usize])
        .as_mut_ptr();
    if (*out_attr.offset(tag as isize)).i != 0 as libc::c_int as libc::c_uint
        || !((*out_attr.offset(tag as isize)).s).is_null()
    {
        err_bfd = obfd;
    } else if (*in_attr.offset(tag as isize)).i != 0 as libc::c_int as libc::c_uint
        || !((*in_attr.offset(tag as isize)).s).is_null()
    {
        err_bfd = ibfd;
    }
    if !err_bfd.is_null() {
        result = ((*((*(*err_bfd).xvec).backend_data as *const elf_backend_data))
            .obj_attrs_handle_unknown)
            .expect("non-null function pointer")(err_bfd, tag);
    }
    if (*in_attr.offset(tag as isize)).i != (*out_attr.offset(tag as isize)).i
        || ((*in_attr.offset(tag as isize)).s
            == 0 as *mut libc::c_void as *mut libc::c_char) as libc::c_int
            != ((*out_attr.offset(tag as isize)).s
                == 0 as *mut libc::c_void as *mut libc::c_char) as libc::c_int
        || !((*in_attr.offset(tag as isize)).s).is_null()
            && !((*out_attr.offset(tag as isize)).s).is_null()
            && strcmp(
    ...
    {
        (*out_attr.offset(tag as isize)).i = 0 as libc::c_int as libc::c_uint;
        let ref mut fresh4 = (*out_attr.offset(tag as isize)).s;
        *fresh4 = 0 as *mut libc::c_char;
    }
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_merge_unknown_attribute_list(
    mut ibfd: *mut bfd,
    mut obfd: *mut bfd,
) -> bool {
    let mut in_list: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    let mut out_list: *mut obj_attribute_list = 0 as *mut obj_attribute_list;
    let mut out_listp: *mut *mut obj_attribute_list = 0 as *mut *mut obj_attribute_list;
    let mut result: bool = 1 as libc::c_int != 0;
    in_list = (*(*ibfd).tdata.elf_obj_data)
        .other_obj_attributes[0 as libc::c_int as usize];
    out_listp = &mut *((*(*obfd).tdata.elf_obj_data).other_obj_attributes)
        .as_mut_ptr()
        .offset(0 as libc::c_int as isize) as *mut *mut obj_attribute_list;
    out_list = *out_listp;
    while !in_list.is_null() || !out_list.is_null() {
        let mut err_bfd: *mut bfd = 0 as *mut bfd;
        let mut err_tag: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        if !out_list.is_null() && (in_list.is_null() || (*in_list).tag > (*out_list).tag)
        {
            err_bfd = obfd;
            err_tag = (*out_list).tag;
            *out_listp = (*out_list).next;
            out_list = *out_listp;
        } else if !in_list.is_null()
            && (out_list.is_null() || (*in_list).tag < (*out_list).tag)
        {
            err_bfd = ibfd;
            err_tag = (*in_list).tag;
            ...
            if (*in_list).attr.i != (*out_list).attr.i
                || ((*in_list).attr.s == 0 as *mut libc::c_void as *mut libc::c_char)
                    as libc::c_int
                    != ((*out_list).attr.s
                        == 0 as *mut libc::c_void as *mut libc::c_char) as libc::c_int
                || !((*in_list).attr.s).is_null() && !((*out_list).attr.s).is_null()
                    && strcmp((*in_list).attr.s, (*out_list).attr.s) != 0 as libc::c_int
            {
                *out_listp = (*out_list).next;
                out_list = *out_listp;
            } else {
        ...
        if !err_bfd.is_null() {
            result = result as libc::c_int != 0
                && ((*((*(*err_bfd).xvec).backend_data as *const elf_backend_data))
                    .obj_attrs_handle_unknown)
                    .expect("non-null function pointer")(err_bfd, err_tag as libc::c_int)
                    as libc::c_int != 0;
        }
    }
    return result;
