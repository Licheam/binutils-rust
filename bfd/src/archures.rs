...
extern "C" {
    ...
    static bfd_i386_arch: bfd_arch_info_type;
    static bfd_iamcu_arch: bfd_arch_info_type;
    static bfd_k1om_arch: bfd_arch_info_type;
    static bfd_l1om_arch: bfd_arch_info_type;
}
...
static mut bfd_archures_list: [*const bfd_arch_info_type; 5] = unsafe {
    [
        &bfd_i386_arch as *const bfd_arch_info_type,
        &bfd_iamcu_arch as *const bfd_arch_info_type,
        &bfd_l1om_arch as *const bfd_arch_info_type,
        &bfd_k1om_arch as *const bfd_arch_info_type,
        0 as *const bfd_arch_info_type,
    ]
};
#[no_mangle]
pub unsafe extern "C" fn bfd_printable_name(mut abfd: *mut bfd) -> *const libc::c_char {
    return (*(*abfd).arch_info).printable_name;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_scan_arch(
    mut string: *const libc::c_char,
) -> *const bfd_arch_info_type {
    let mut app: *const *const bfd_arch_info_type = 0
        as *const *const bfd_arch_info_type;
    let mut ap: *const bfd_arch_info_type = 0 as *const bfd_arch_info_type;
    app = bfd_archures_list.as_ptr();
    while !(*app).is_null() {
        ap = *app;
        while !ap.is_null() {
            if ((*ap).scan).expect("non-null function pointer")(ap, string) {
                return ap;
            }
            ap = (*ap).next;
        }
    ...
    return 0 as *const bfd_arch_info_type;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_arch_list() -> *mut *const libc::c_char {
    ...
    app = bfd_archures_list.as_ptr();
    while !(*app).is_null() {
        let mut ap_0: *const bfd_arch_info_type = 0 as *const bfd_arch_info_type;
        ap_0 = *app;
        while !ap_0.is_null() {
            *name_ptr = (*ap_0).printable_name;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_arch_get_compatible(
    mut abfd: *const bfd,
    mut bbfd: *const bfd,
    mut accept_unknowns: bool,
) -> *const bfd_arch_info_type {
    let mut ubfd: *const bfd = 0 as *const bfd;
    let mut kbfd: *const bfd = 0 as *const bfd;
    if (*(*abfd).arch_info).arch as libc::c_uint
        == bfd_arch_unknown as libc::c_int as libc::c_uint
    {
        ubfd = abfd;
        kbfd = bbfd;
    } else if (*(*bbfd).arch_info).arch as libc::c_uint
        == bfd_arch_unknown as libc::c_int as libc::c_uint
    {
        ubfd = bbfd;
        kbfd = abfd;
        ...
        return ((*(*abfd).arch_info).compatible)
            .expect("non-null function pointer")((*abfd).arch_info, (*bbfd).arch_info)
    }
    if accept_unknowns as libc::c_int != 0
        || (*ubfd).plugin_format() as libc::c_int == bfd_plugin_yes as libc::c_int
        || strcmp(bfd_get_target(ubfd), b"binary\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
...
#[no_mangle]
pub static mut bfd_default_arch_struct: bfd_arch_info_type = unsafe {
    {
        let mut init = bfd_arch_info {
            ...
            mach: 0 as libc::c_int as libc::c_ulong,
            arch_name: b"unknown\0" as *const u8 as *const libc::c_char,
            printable_name: b"unknown\0" as *const u8 as *const libc::c_char,
            section_align_power: 2 as libc::c_int as libc::c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_arch_info(
    mut abfd: *mut bfd,
    mut arg: *const bfd_arch_info_type,
) {
    (*abfd).arch_info = arg;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_default_set_arch_mach(
    mut abfd: *mut bfd,
    mut arch: bfd_architecture,
    mut mach: libc::c_ulong,
) -> bool {
    (*abfd).arch_info = bfd_lookup_arch(arch, mach);
    if !((*abfd).arch_info).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_arch(mut abfd: *const bfd) -> bfd_architecture {
    return (*(*abfd).arch_info).arch;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_get_mach(mut abfd: *const bfd) -> libc::c_ulong {
    return (*(*abfd).arch_info).mach;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_arch_bits_per_byte(mut abfd: *const bfd) -> libc::c_uint {
    return (*(*abfd).arch_info).bits_per_byte as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_arch_bits_per_address(
    mut abfd: *const bfd,
) -> libc::c_uint {
    return (*(*abfd).arch_info).bits_per_address as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_default_compatible(
    mut a: *const bfd_arch_info_type,
    mut b: *const bfd_arch_info_type,
) -> *const bfd_arch_info_type {
    if (*a).arch as libc::c_uint != (*b).arch as libc::c_uint {
        return 0 as *const bfd_arch_info_type;
    }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_default_scan(
    mut info: *const bfd_arch_info_type,
    mut string: *const libc::c_char,
) -> bool {
    let mut ptr_src: *const libc::c_char = 0 as *const libc::c_char;
    let mut ptr_tst: *const libc::c_char = 0 as *const libc::c_char;
    let mut number: libc::c_ulong = 0;
    let mut arch: bfd_architecture = bfd_arch_unknown;
    let mut printable_name_colon: *const libc::c_char = 0 as *const libc::c_char;
    if strcasecmp(string, (*info).arch_name) == 0 as libc::c_int
        && (*info).the_default as libc::c_int != 0
    {
        return 1 as libc::c_int != 0;
    }
    if strcasecmp(string, (*info).printable_name) == 0 as libc::c_int {
        return 1 as libc::c_int != 0;
    }
    printable_name_colon = strchr((*info).printable_name, ':' as i32);
    if printable_name_colon.is_null() {
        let mut strlen_arch_name: size_t = strlen((*info).arch_name);
        if strncasecmp(string, (*info).arch_name, strlen_arch_name) == 0 as libc::c_int {
            if *string.offset(strlen_arch_name as isize) as libc::c_int == ':' as i32 {
                if strcasecmp(
                    string
                        .offset(strlen_arch_name as isize)
                ...
                string.offset(strlen_arch_name as isize),
                (*info).printable_name,
            ) == 0 as libc::c_int
            {
                return 1 as libc::c_int != 0
    ...
    if !printable_name_colon.is_null() {
        let mut colon_index: size_t = printable_name_colon
            .offset_from((*info).printable_name) as libc::c_long as size_t;
        if strncasecmp(string, (*info).printable_name, colon_index) == 0 as libc::c_int
            && strcasecmp(
                string.offset(colon_index as isize),
                ((*info).printable_name)
                    .offset(colon_index as isize)
                    .offset(1 as libc::c_int as isize),
            ) == 0 as libc::c_int
        {
            return 1 as libc::c_int != 0;
    ...
    while *ptr_src as libc::c_int != 0 && *ptr_tst as libc::c_int != 0 {
        if *ptr_src as libc::c_int != *ptr_tst as libc::c_int {
            break;
        }
        ptr_src = ptr_src.offset(1);
        ptr_src;
        ptr_tst = ptr_tst.offset(1);
        ptr_tst;
    }
    if *ptr_src as libc::c_int == ':' as i32 {
        ptr_src = ptr_src.offset(1);
        ptr_src;
    }
    if *ptr_src as libc::c_int == 0 as libc::c_int {
        return (*info).the_default;
    }
    number = 0 as libc::c_int as libc::c_ulong;
    while _sch_istable[(*ptr_src as libc::c_int & 0xff as libc::c_int) as usize]
        as libc::c_int & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int
        != 0
    {
        number = number
            .wrapping_mul(10 as libc::c_int as libc::c_ulong)
            .wrapping_add(*ptr_src as libc::c_ulong)
    ...
    match number {
        ...
        68010 => {
            arch = bfd_arch_m68k;
            number = 3 as libc::c_int as libc::c_ulong;
        }
        68020 => {
            arch = bfd_arch_m68k;
            number = 4 as libc::c_int as libc::c_ulong;
        }
        68030 => {
            arch = bfd_arch_m68k;
            number = 5 as libc::c_int as libc::c_ulong;
        }
        68040 => {
            arch = bfd_arch_m68k;
            number = 6 as libc::c_int as libc::c_ulong;
        }
        68060 => {
            arch = bfd_arch_m68k;
            number = 7 as libc::c_int as libc::c_ulong;
        }
        68332 => {
            arch = bfd_arch_m68k;
            number = 8 as libc::c_int as libc::c_ulong;
        }
        5200 => {
            arch = bfd_arch_m68k;
            number = 10 as libc::c_int as libc::c_ulong;
        }
        5206 => {
            arch = bfd_arch_m68k;
            number = 12 as libc::c_int as libc::c_ulong;
        }
        5307 => {
            arch = bfd_arch_m68k;
            number = 12 as libc::c_int as libc::c_ulong;
        ...
        5407 => {
            arch = bfd_arch_m68k;
            number = 18 as libc::c_int as libc::c_ulong;
        }
        5282 => {
            arch = bfd_arch_m68k;
            number = 16 as libc::c_int as libc::c_ulong;
        }
        3000 => {
            arch = bfd_arch_mips;
            number = 3000 as libc::c_int as libc::c_ulong;
        }
        4000 => {
            arch = bfd_arch_mips;
            number = 4000 as libc::c_int as libc::c_ulong;
        }
        6000 => {
        ...
        7410 => {
            arch = bfd_arch_sh;
            number = 0x2d as libc::c_int as libc::c_ulong;
        }
        7708 => {
            arch = bfd_arch_sh;
            number = 0x30 as libc::c_int as libc::c_ulong;
        }
        7729 => {
            arch = bfd_arch_sh;
            number = 0x3d as libc::c_int as libc::c_ulong;
        }
        7750 => {
            arch = bfd_arch_sh;
            number = 0x40 as libc::c_int as libc::c_ulong;
        }
        _ => return 0 as libc::c_int != 0,
    }
    if arch as libc::c_uint != (*info).arch as libc::c_uint {
        return 0 as libc::c_int != 0;
    }
    if number != (*info).mach {
        return 0 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_arch_info(
    mut abfd: *mut bfd,
) -> *const bfd_arch_info_type {
    return (*abfd).arch_info;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_lookup_arch(
    mut arch: bfd_architecture,
    ...
    while !(*app).is_null() {
        ap = *app;
        while !ap.is_null() {
            if (*ap).arch as libc::c_uint == arch as libc::c_uint
                && ((*ap).mach == machine
                    || machine == 0 as libc::c_int as libc::c_ulong
                        && (*ap).the_default as libc::c_int != 0)
            {
                return ap;
            }
            ap = (*ap).next;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_printable_arch_mach(
    mut arch: bfd_architecture,
    mut machine: libc::c_ulong,
) -> *const libc::c_char {
    let mut ap: *const bfd_arch_info_type = bfd_lookup_arch(arch, machine);
    if !ap.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_octets_per_byte(
    mut abfd: *const bfd,
    mut sec: *const asection,
) -> libc::c_uint {
    if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint && !sec.is_null()
        && (*sec).flags & 0x40000000 as libc::c_int as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn bfd_arch_mach_octets_per_byte(
    mut arch: bfd_architecture,
    mut mach: libc::c_ulong,
) -> libc::c_uint {
    let mut ap: *const bfd_arch_info_type = bfd_lookup_arch(arch, mach);
    if !ap.is_null() {
        return ((*ap).bits_per_byte / 8 as libc::c_int) as libc::c_uint;
    }
    return 1 as libc::c_int as libc::c_uint;
}
#[no_mangle]
