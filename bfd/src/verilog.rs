...
extern "C" {
    ...
    fn _bfd_bool_bfd_link_false_error(_: *mut bfd, _: *mut bfd_link_info) -> bool;
    ...
    fn _bfd_nolink_sizeof_headers(_: *mut bfd, _: *mut bfd_link_info) -> libc::c_int;
    fn _bfd_nolink_bfd_get_relocated_section_contents(
        _: *mut bfd,
        _: *mut bfd_link_info,
    ...
    fn _bfd_nolink_bfd_relax_section(
        _: *mut bfd,
        _: *mut asection,
        _: *mut bfd_link_info,
        _: *mut bool,
    ) -> bool;
    fn _bfd_nolink_bfd_lookup_section_flags(
        _: *mut bfd_link_info,
        _: *mut flag_info,
        _: *mut asection,
    ) -> bool;
    fn _bfd_nolink_bfd_is_group_section(_: *mut bfd, _: *const asection) -> bool;
    fn _bfd_nolink_bfd_group_name(
        _: *mut bfd,
        _: *const asection,
    ) -> *const libc::c_char;
    fn _bfd_nolink_bfd_discard_group(_: *mut bfd, _: *mut asection) -> bool;
    fn _bfd_nolink_bfd_link_hash_table_create(_: *mut bfd) -> *mut bfd_link_hash_table;
    fn _bfd_nolink_bfd_link_just_syms(_: *mut asection, _: *mut bfd_link_info);
    fn _bfd_nolink_bfd_copy_link_hash_symbol_type(
        _: *mut bfd,
        _: *mut bfd_link_hash_entry,
        _: *mut bfd_link_hash_entry,
    );
    fn _bfd_nolink_bfd_link_split_section(_: *mut bfd, _: *mut bfd_section) -> bool;
    fn _bfd_nolink_section_already_linked(
        _: *mut bfd,
        _: *mut asection,
        _: *mut bfd_link_info,
    ) -> bool;
    fn _bfd_nolink_bfd_define_common_symbol(
        _: *mut bfd,
        _: *mut bfd_link_info,
        _: *mut bfd_link_hash_entry,
    ) -> bool;
    fn _bfd_nolink_bfd_define_start_stop(
        _: *mut bfd_link_info,
        _: *const libc::c_char,
        _: *mut asection,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct verilog_data_struct {
    pub head: *mut verilog_data_list_type,
    pub tail: *mut verilog_data_list_type,
}
pub type verilog_data_list_type = verilog_data_list_struct;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct verilog_data_list_struct {
    pub next: *mut verilog_data_list_struct,
...
pub type tdata_type = verilog_data_struct;
#[inline]
...
#[no_mangle]
pub static mut VerilogDataWidth: libc::c_uint = 1 as libc::c_int as libc::c_uint;
static mut digs: [libc::c_char; 17] = unsafe {
    *::core::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"0123456789ABCDEF\0")
};
unsafe extern "C" fn verilog_set_arch_mach(
    mut abfd: *mut bfd,
...
unsafe extern "C" fn verilog_set_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
    ...
    let mut tdata: *mut tdata_type = (*abfd).tdata.verilog_data;
    let mut entry: *mut verilog_data_list_type = 0 as *mut verilog_data_list_type;
    entry = bfd_alloc(
        abfd,
        ::core::mem::size_of::<verilog_data_list_type>() as libc::c_ulong,
    ) as *mut verilog_data_list_type;
    if entry.is_null() {
        ...
        && (*section).flags & 0x2 as libc::c_int as libc::c_uint != 0
    {
        ...
        (*entry).data = data;
        (*entry).where_0 = ((*section).lma).wrapping_add(offset as libc::c_ulong);
        (*entry).size = bytes_to_do;
        if !((*tdata).tail).is_null() && (*entry).where_0 >= (*(*tdata).tail).where_0 {
            (*(*tdata).tail).next = entry;
            (*entry).next = 0 as *mut verilog_data_list_struct;
            (*tdata).tail = entry;
        } else {
            let mut look: *mut *mut verilog_data_list_type = 0
                as *mut *mut verilog_data_list_type;
            look = &mut (*tdata).head;
...
unsafe extern "C" fn verilog_write_address(
    mut abfd: *mut bfd,
    mut address: bfd_vma,
) -> bool {
    ...
    *fresh0 = '@' as i32 as libc::c_char;
    if address >= (1 as libc::c_int as bfd_vma) << 32 as libc::c_int {
        *dst
            .offset(
                1 as libc::c_int as isize,
            ) = digs[(address >> 56 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
            as usize];
        *dst
            .offset(
                0 as libc::c_int as isize,
            ) = digs[(address >> 56 as libc::c_int >> 4 as libc::c_int
            & 0xf as libc::c_int as libc::c_ulong) as usize];
        dst = dst.offset(2 as libc::c_int as isize);
        *dst
            .offset(
                1 as libc::c_int as isize,
            ) = digs[(address >> 48 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
            as usize];
        *dst
            .offset(
                0 as libc::c_int as isize,
            ) = digs[(address >> 48 as libc::c_int >> 4 as libc::c_int
            & 0xf as libc::c_int as libc::c_ulong) as usize];
        dst = dst.offset(2 as libc::c_int as isize);
        *dst
            .offset(
                1 as libc::c_int as isize,
            ) = digs[(address >> 40 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
            as usize];
        *dst
            .offset(
                0 as libc::c_int as isize,
            ) = digs[(address >> 40 as libc::c_int >> 4 as libc::c_int
            & 0xf as libc::c_int as libc::c_ulong) as usize];
        dst = dst.offset(2 as libc::c_int as isize);
        *dst
            .offset(
                1 as libc::c_int as isize,
            ) = digs[(address >> 32 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
            as usize];
        *dst
            .offset(
                0 as libc::c_int as isize,
            ) = digs[(address >> 32 as libc::c_int >> 4 as libc::c_int
            & 0xf as libc::c_int as libc::c_ulong) as usize];
        dst = dst.offset(2 as libc::c_int as isize);
    }
    *dst
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(address >> 24 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
        as usize];
    *dst
        .offset(
            0 as libc::c_int as isize,
    ...
    *dst
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(address >> 16 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
        as usize];
    *dst
        .offset(
            0 as libc::c_int as isize,
    ...
    *dst
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(address >> 8 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
        as usize];
    *dst
        .offset(
            0 as libc::c_int as isize,
    ...
    *dst
        .offset(
            0 as libc::c_int as isize,
        ) = digs[(address >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
        as usize];
    dst = dst.offset(2 as libc::c_int as isize);
    let fresh1 = dst;
    dst = dst.offset(1);
...
unsafe extern "C" fn verilog_write_record(
    mut abfd: *mut bfd,
    mut data: *const bfd_byte,
    mut end: *const bfd_byte,
) -> bool {
    let mut buffer: [libc::c_char; 52] = [0; 52];
    let mut src: *const bfd_byte = data;
    let mut dst: *mut libc::c_char = buffer.as_mut_ptr();
    let mut wrlen: bfd_size_type = 0;
    if end.offset_from(data) as libc::c_long * 2 as libc::c_int as libc::c_long
        + end.offset_from(data) as libc::c_long / VerilogDataWidth as libc::c_long
        + 2 as libc::c_int as libc::c_long
        > ::core::mem::size_of::<[libc::c_char; 52]>() as libc::c_ulong as libc::c_long
    {
        return 0 as libc::c_int != 0;
    }
    if VerilogDataWidth == 1 as libc::c_int as libc::c_uint {
        ...
        src = data;
        while src < end.offset(-(VerilogDataWidth as isize)) {
            i = VerilogDataWidth.wrapping_sub(1 as libc::c_int as libc::c_uint)
                as libc::c_int;
            while i >= 0 as libc::c_int {
                *dst
                    .offset(
                        1 as libc::c_int as isize,
                    ) = digs[(*src.offset(i as isize) as libc::c_int
                    & 0xf as libc::c_int) as usize];
                *dst
                    .offset(
                        0 as libc::c_int as isize,
                    ) = digs[(*src.offset(i as isize) as libc::c_int >> 4 as libc::c_int
                    & 0xf as libc::c_int) as usize];
                dst = dst.offset(2 as libc::c_int as isize);
                i -= 1;
                i;
            ...
            *fresh4 = ' ' as i32 as libc::c_char;
            src = src.offset(VerilogDataWidth as isize);
        }
        while end > src {
            end = end.offset(-1);
            end;
            *dst
                .offset(
                    1 as libc::c_int as isize,
                ) = digs[(*end as libc::c_int & 0xf as libc::c_int) as usize];
            *dst
                .offset(
                    0 as libc::c_int as isize,
                ) = digs[(*end as libc::c_int >> 4 as libc::c_int & 0xf as libc::c_int)
                as usize];
            dst = dst.offset(2 as libc::c_int as isize);
        }
    } else {
        ...
        while src < end {
            ...
            *dst
            ...
            src = src.offset(1);
            src;
            if src.offset_from(data) as libc::c_long % VerilogDataWidth as libc::c_long
...
unsafe extern "C" fn verilog_write_section(
    ...
    verilog_write_address(abfd, (*list).where_0);
    while (octets_written as libc::c_ulong) < (*list).size {
        ...
        if octets_this_chunk > 16 as libc::c_int as libc::c_uint {
            octets_this_chunk = 16 as libc::c_int as libc::c_uint;
        }
...
unsafe extern "C" fn verilog_write_object_contents(mut abfd: *mut bfd) -> bool {
    let mut tdata: *mut tdata_type = (*abfd).tdata.verilog_data;
    let mut list: *mut verilog_data_list_type = 0 as *mut verilog_data_list_type;
    list = (*tdata).head;
    while !list.is_null() {
...
unsafe extern "C" fn verilog_init() {
...
unsafe extern "C" fn verilog_mkobject(mut abfd: *mut bfd) -> bool {
    ...
    (*tdata).head = 0 as *mut verilog_data_list_type;
    (*tdata).tail = 0 as *mut verilog_data_list_type;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub static mut verilog_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"verilog\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_verilog_flavour,
            ...
            _bfd_set_format: [
                ...
                Some(verilog_mkobject as unsafe extern "C" fn(*mut bfd) -> bool),
                Some(
                    _bfd_bool_bfd_false_error as unsafe extern "C" fn(*mut bfd) -> bool,
                ),
            ...
            _bfd_define_start_stop: Some(
                _bfd_nolink_bfd_define_start_stop
                    as unsafe extern "C" fn(
                        *mut bfd_link_info,
                        *const libc::c_char,
                        *mut asection,
