...
extern "C" {
    ...
    fn bfd_is_section_compressed(abfd: *mut bfd, section: *mut asection) -> bool;
    ...
    fn _bfd_dwarf2_find_symbol_bias(
        _: *mut *mut asymbol,
        _: *mut *mut libc::c_void,
    ) -> bfd_signed_vma;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_reloc_cookie {
    pub rels: *mut internal_reloc,
    pub rel: *mut internal_reloc,
    pub relend: *mut internal_reloc,
    pub symbols: *mut coff_symbol_struct,
    pub abfd: *mut bfd,
    pub sym_hashes: *mut *mut coff_link_hash_entry,
}
pub const decompress: C2RustUnnamed_35 = 2;
pub const compress: C2RustUnnamed_35 = 1;
pub const nothing: C2RustUnnamed_35 = 0;
...
pub type coff_gc_mark_hook_fn = Option::<
    unsafe extern "C" fn(
        *mut asection,
        *mut bfd_link_info,
        *mut internal_reloc,
...
unsafe extern "C" fn make_a_section_from_file(
    mut abfd: *mut bfd,
    mut hdr: *mut internal_scnhdr,
    mut target_index: libc::c_uint,
) -> bool {
    let mut return_section: *mut asection = 0 as *mut asection;
    ...
    if ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ...
        (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_long_section_names as libc::c_int,
    ) as libc::c_int != 0
        && (*hdr).s_name[0 as libc::c_int as usize] as libc::c_int == '/' as i32
    {
        let mut buf: [libc::c_char; 8] = [0; 8];
        let mut strindex: libc::c_long = 0;
        let mut p: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut strings: *const libc::c_char = 0 as *const libc::c_char;
        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_set_long_section_names)
            .expect("non-null function pointer")(abfd, 1 as libc::c_int);
        memcpy(
            buf.as_mut_ptr() as *mut libc::c_void,
            ((*hdr).s_name).as_mut_ptr().offset(1 as libc::c_int as isize)
                as *const libc::c_void,
            (8 as libc::c_int - 1 as libc::c_int) as libc::c_ulong,
        );
        buf[(8 as libc::c_int - 1 as libc::c_int)
            as usize] = '\0' as i32 as libc::c_char;
        strindex = strtol(buf.as_mut_ptr(), &mut p, 10 as libc::c_int);
        if *p as libc::c_int == '\0' as i32
            && strindex >= 0 as libc::c_int as libc::c_long
        {
            strings = _bfd_coff_read_string_table(abfd);
            if strings.is_null() {
                return 0 as libc::c_int != 0;
            }
            if (strindex + 2 as libc::c_int as libc::c_long) as bfd_size_type
                >= (*(*abfd).tdata.coff_obj_data).strings_len
            {
                return 0 as libc::c_int != 0;
            }
            strings = strings.offset(strindex as isize);
            name = bfd_alloc(
                abfd,
                (strlen(strings))
    ...
    if name.is_null() {
        ...
        strncpy(
            name,
            &mut *((*hdr).s_name).as_mut_ptr().offset(0 as libc::c_int as isize)
                as *mut libc::c_char,
            ::core::mem::size_of::<[libc::c_char; 8]>() as libc::c_ulong,
        );
        *name
    ...
    if return_section.is_null() {
        return 0 as libc::c_int != 0;
    }
    (*return_section).vma = (*hdr).s_vaddr;
    (*return_section).lma = (*hdr).s_paddr;
    (*return_section).size = (*hdr).s_size;
    (*return_section).filepos = (*hdr).s_scnptr as file_ptr;
    (*return_section).rel_filepos = (*hdr).s_relptr as file_ptr;
    (*return_section).reloc_count = (*hdr).s_nreloc as libc::c_uint;
    ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_set_alignment_hook)
        .expect(
            "non-null function pointer",
        )(abfd, return_section, hdr as *mut libc::c_void);
    (*return_section).line_filepos = (*hdr).s_lnnoptr as file_ptr;
    (*return_section).lineno_count = (*hdr).s_nlnno as libc::c_uint;
    (*return_section).userdata = 0 as *mut libc::c_void;
    (*return_section).next = 0 as *mut bfd_section;
    (*return_section).target_index = target_index as libc::c_int;
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_styp_to_sec_flags_hook)
        .expect(
            "non-null function pointer",
        )(abfd, hdr as *mut libc::c_void, name, return_section, &mut flags)
    {
        result = 0 as libc::c_int != 0;
    }
    (*return_section).flags = flags;
    if (*return_section).flags & 0x4000000 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        (*return_section).lineno_count = 0 as libc::c_int as libc::c_uint;
    }
    if (*hdr).s_nreloc != 0 as libc::c_int as libc::c_ulong {
        (*return_section).flags |= 0x4 as libc::c_int as libc::c_uint;
    }
    if (*hdr).s_scnptr != 0 as libc::c_int as libc::c_ulong {
        (*return_section).flags |= 0x100 as libc::c_int as libc::c_uint;
    }
    if flags & 0x2000 as libc::c_int as libc::c_uint != 0
        && strlen(name) > 7 as libc::c_int as libc::c_ulong
        && (*name.offset(1 as libc::c_int as isize) as libc::c_int == 'd' as i32
            && *name.offset(6 as libc::c_int as isize) as libc::c_int == '_' as i32
            || strlen(name) > 8 as libc::c_int as libc::c_ulong
                && *name.offset(1 as libc::c_int as isize) as libc::c_int == 'z' as i32
                && *name.offset(7 as libc::c_int as isize) as libc::c_int == '_' as i32)
    {
        let mut action: C2RustUnnamed_35 = nothing;
        ...
        if bfd_is_section_compressed(abfd, return_section) {
            ...
            if (*abfd).flags & 0x4000 as libc::c_int as libc::c_uint != 0
                && (*return_section).size != 0 as libc::c_int as libc::c_ulong
            {
                action = compress;
            }
        }
        match action as libc::c_uint {
            1 => {
                ...
                if (*return_section).compress_status() as libc::c_int == 1 as libc::c_int
                {
                        ...
                        != 'z' as i32
                    {
                        ...
                        new_name = bfd_alloc(
                            abfd,
                            len.wrapping_add(2 as libc::c_int as libc::c_uint)
                                as bfd_size_type,
                        ) as *mut libc::c_char;
                        if new_name.is_null() {
                            return 0 as libc::c_int != 0;
                        ...
                        *new_name
                        ...
                        memcpy(
                            new_name.offset(2 as libc::c_int as isize)
                                as *mut libc::c_void,
            ...
            2 => {
                ...
                if *name.offset(1 as libc::c_int as isize) as libc::c_int == 'z' as i32 {
                    let mut len_0: libc::c_uint = strlen(name) as libc::c_uint;
                    new_name = bfd_alloc(abfd, len_0 as bfd_size_type)
                        as *mut libc::c_char;
                    if new_name.is_null() {
                        return 0 as libc::c_int != 0;
                    }
...
#[no_mangle]
pub unsafe extern "C" fn coff_real_object_p(
    mut abfd: *mut bfd,
    mut nscns: libc::c_uint,
    mut internal_f: *mut internal_filehdr,
    mut internal_a: *mut internal_aouthdr,
) -> bfd_cleanup {
    let mut current_block: u64;
    let mut oflags: flagword = (*abfd).flags;
    let mut ostart: bfd_vma = bfd_get_start_address(abfd);
    let mut tdata: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut tdata_save: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut readsize: bfd_size_type = 0;
    let mut scnhsz: libc::c_uint = 0;
    let mut external_sections: *mut libc::c_char = 0 as *mut libc::c_char;
    if (*internal_f).f_flags as libc::c_int & 0x1 as libc::c_int == 0 {
        (*abfd).flags |= 0x1 as libc::c_int as libc::c_uint;
    }
    if (*internal_f).f_flags as libc::c_int & 0x2 as libc::c_int != 0 {
        (*abfd).flags |= 0x2 as libc::c_int as libc::c_uint;
    }
    if (*internal_f).f_flags as libc::c_int & 0x4 as libc::c_int == 0 {
        (*abfd).flags |= 0x4 as libc::c_int as libc::c_uint;
    }
    if (*internal_f).f_flags as libc::c_int & 0x8 as libc::c_int == 0 {
        (*abfd).flags |= 0x20 as libc::c_int as libc::c_uint;
    }
    if (*internal_f).f_flags as libc::c_int & 0x2 as libc::c_int != 0 as libc::c_int {
        (*abfd).flags |= 0x100 as libc::c_int as libc::c_uint;
    }
    (*abfd).symcount = (*internal_f).f_nsyms as libc::c_uint;
    if (*internal_f).f_nsyms != 0 {
        (*abfd).flags |= 0x10 as libc::c_int as libc::c_uint;
    }
    if !internal_a.is_null() {
        (*abfd).start_address = (*internal_a).entry;
    } else {
        (*abfd).start_address = 0 as libc::c_int as bfd_vma;
    }
    tdata_save = (*abfd).tdata.any;
    tdata = ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_mkobject_hook)
        .expect(
            "non-null function pointer",
        )(abfd, internal_f as *mut libc::c_void, internal_a as *mut libc::c_void);
    if !tdata.is_null() {
        scnhsz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_scnhsz;
        readsize = (nscns as bfd_size_type).wrapping_mul(scnhsz as libc::c_ulong);
        external_sections = _bfd_alloc_and_read(abfd, readsize, readsize)
            as *mut libc::c_char;
        if !external_sections.is_null() {
            if ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ._bfd_coff_set_arch_mach_hook)
                .expect(
                    "non-null function pointer",
                )(abfd, internal_f as *mut libc::c_void)
            {
                if nscns != 0 as libc::c_int as libc::c_uint {
                    ...
                    loop {
                        ...
                        let mut tmp: internal_scnhdr = internal_scnhdr {
                            s_name: [0; 8],
                            s_paddr: 0,
                            s_vaddr: 0,
                            s_size: 0,
                        ...
                        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                            ._bfd_coff_swap_scnhdr_in)
                            .expect(
                                "non-null function pointer",
                            )(
                            abfd,
                            external_sections.offset(i.wrapping_mul(scnhsz) as isize)
                                as *mut libc::c_void,
                            &mut tmp as *mut internal_scnhdr as *mut libc::c_void,
                        );
                        if !make_a_section_from_file(
                            abfd,
                            &mut tmp,
                            i.wrapping_add(1 as libc::c_int as libc::c_uint),
                        ) {
                            current_block = 7610105644716937294;
                            break;
                        }
                        i = i.wrapping_add(1);
                        i;
...
#[no_mangle]
pub unsafe extern "C" fn coff_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut filhsz: bfd_size_type = 0;
    let mut aoutsz: bfd_size_type = 0;
    let mut nscns: libc::c_uint = 0;
    let mut filehdr: *mut libc::c_void = 0 as *mut libc::c_void;
    ...
    filhsz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_filhsz
        as bfd_size_type;
    aoutsz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_aoutsz
        as bfd_size_type;
    filehdr = _bfd_alloc_and_read(abfd, filhsz, filhsz) as *mut libc::c_void;
    if filehdr.is_null() {
    ...
    ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ...
        .expect(
            "non-null function pointer",
        )(abfd, filehdr, &mut internal_f as *mut internal_filehdr as *mut libc::c_void);
    bfd_release(abfd, filehdr);
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_bad_format_hook)
        .expect(
            "non-null function pointer",
        )(abfd, &mut internal_f as *mut internal_filehdr as *mut libc::c_void)
        || internal_f.f_opthdr as libc::c_ulong > aoutsz
    {
        bfd_set_error(bfd_error_wrong_format);
        return None;
    }
    ...
    if internal_f.f_opthdr != 0 {
        let mut opthdr: *mut libc::c_void = 0 as *mut libc::c_void;
        opthdr = _bfd_alloc_and_read(abfd, aoutsz, internal_f.f_opthdr as bfd_size_type)
            as *mut libc::c_void;
        if opthdr.is_null() {
            return None;
        }
        if (internal_f.f_opthdr as libc::c_ulong) < aoutsz {
            memset(
                (opthdr as *mut libc::c_char)
                    .offset(internal_f.f_opthdr as libc::c_int as isize)
                    as *mut libc::c_void,
                0 as libc::c_int,
                aoutsz.wrapping_sub(internal_f.f_opthdr as libc::c_ulong),
            );
        }
        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_swap_aouthdr_in)
            .expect(
                "non-null function pointer",
            )(
            abfd,
    ...
    return coff_real_object_p(
        ...
        nscns,
        &mut internal_f,
        if internal_f.f_opthdr as libc::c_int != 0 as libc::c_int {
            &mut internal_a
        } else {
            0 as *mut libc::c_void as *mut internal_aouthdr
        },
    );
}
#[no_mangle]
pub unsafe extern "C" fn coff_section_from_bfd_index(
    mut abfd: *mut bfd,
    mut section_index: libc::c_int,
) -> *mut bfd_section {
    let mut answer: *mut bfd_section = (*abfd).sections;
    if section_index == -(1 as libc::c_int) {
        return &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut asection;
    }
    if section_index == 0 as libc::c_int {
        return &mut *_bfd_std_section.as_mut_ptr().offset(1 as libc::c_int as isize)
            as *mut asection;
    }
    if section_index == -(2 as libc::c_int) {
        return &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut asection;
    }
...
#[no_mangle]
pub unsafe extern "C" fn coff_get_symtab_upper_bound(
    mut abfd: *mut bfd,
) -> libc::c_long {
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
    ...
    return ((bfd_get_symcount(abfd)).wrapping_add(1 as libc::c_int as libc::c_uint)
        as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<*mut coff_symbol_type>() as libc::c_ulong)
        as libc::c_long;
}
#[no_mangle]
pub unsafe extern "C" fn coff_canonicalize_symtab(
    mut abfd: *mut bfd,
    mut alocation: *mut *mut asymbol,
) -> libc::c_long {
    let mut counter: libc::c_uint = 0;
    let mut symbase: *mut coff_symbol_type = 0 as *mut coff_symbol_type;
    let mut location: *mut *mut coff_symbol_type = alocation
        as *mut *mut coff_symbol_type;
    if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_slurp_symbol_table)
        .expect("non-null function pointer")(abfd)
    {
    ...
    loop {
        ...
        let fresh1 = symbase;
        symbase = symbase.offset(1);
        let fresh2 = location;
        location = location.offset(1);
        *fresh2 = fresh1;
    }
    *location = 0 as *mut coff_symbol_type;
    return bfd_get_symcount(abfd) as libc::c_long;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_internal_syment_name(
    mut abfd: *mut bfd,
        ...
        || (*sym)._n._n_n._n_offset == 0 as libc::c_int as libc::c_ulong
    {
        memcpy(
            ...
            ((*sym)._n._n_name).as_ptr() as *const libc::c_void,
            8 as libc::c_int as libc::c_ulong,
        );
        *buf.offset(8 as libc::c_int as isize) = '\0' as i32 as libc::c_char;
        return buf;
    } else {
        let mut strings: *const libc::c_char = 0 as *const libc::c_char;
        if !((*sym)._n._n_n._n_offset >= 4 as libc::c_int as libc::c_ulong) {
            bfd_assert(
                b"coffgen.c\0" as *const u8 as *const libc::c_char,
                460 as libc::c_int,
            );
        }
        ...
        if (*(*abfd).tdata.coff_obj_data).strings_len > 0 as libc::c_int as libc::c_ulong
            && (*sym)._n._n_n._n_offset >= (*(*abfd).tdata.coff_obj_data).strings_len
        {
            return 0 as *const libc::c_char;
        }
        return strings.offset((*sym)._n._n_n._n_offset as isize);
    };
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_read_internal_relocs(
    mut abfd: *mut bfd,
    mut sec: *mut asection,
    mut cache: bool,
    mut external_relocs: *mut bfd_byte,
    mut require_internal: bool,
    mut internal_relocs: *mut internal_reloc,
) -> *mut internal_reloc {
    let mut current_block: u64;
    let mut relsz: bfd_size_type = 0;
    let mut free_external: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut free_internal: *mut internal_reloc = 0 as *mut internal_reloc;
    let mut erel: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut erel_end: *mut bfd_byte = 0 as *mut bfd_byte;
    ...
    if !((*sec).used_by_bfd as *mut coff_section_tdata).is_null()
        && !((*((*sec).used_by_bfd as *mut coff_section_tdata)).relocs).is_null()
    {
        if !require_internal {
            return (*((*sec).used_by_bfd as *mut coff_section_tdata)).relocs;
        }
        memcpy(
            internal_relocs as *mut libc::c_void,
            (*((*sec).used_by_bfd as *mut coff_section_tdata)).relocs
                as *const libc::c_void,
            ((*sec).reloc_count as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<internal_reloc>() as libc::c_ulong),
        );
        return internal_relocs;
    }
    relsz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_relsz
        as bfd_size_type;
    amt = ((*sec).reloc_count as libc::c_ulong).wrapping_mul(relsz);
    if external_relocs.is_null() {
        free_external = bfd_malloc(amt) as *mut bfd_byte;
        if free_external.is_null() {
            current_block = 12181885546557410871;
        } else {
    ...
    match current_block {
        2979737022853876585 => {
            if !(bfd_seek(abfd, (*sec).rel_filepos, 0 as libc::c_int) != 0 as libc::c_int
                || bfd_bread(external_relocs as *mut libc::c_void, amt, abfd) != amt)
            {
                if internal_relocs.is_null() {
                    amt = (*sec).reloc_count as bfd_size_type;
                    amt = (amt as libc::c_ulong)
                        .wrapping_mul(
                            ::core::mem::size_of::<internal_reloc>() as libc::c_ulong,
                        ) as bfd_size_type as bfd_size_type;
                    free_internal = bfd_malloc(amt) as *mut internal_reloc;
                    if free_internal.is_null() {
                        current_block = 12181885546557410871;
                    } else {
                ...
                match current_block {
                    12181885546557410871 => {}
                    _ => {
                        erel = external_relocs;
                        erel_end = erel
                            .offset(
                                relsz.wrapping_mul((*sec).reloc_count as libc::c_ulong)
                                    as isize,
                            );
                        ...
                        free(free_external as *mut libc::c_void);
                        free_external = 0 as *mut bfd_byte;
                        if cache as libc::c_int != 0 && !free_internal.is_null() {
                            if ((*sec).used_by_bfd as *mut coff_section_tdata).is_null()
                            {
                                amt = ::core::mem::size_of::<coff_section_tdata>()
                                    as libc::c_ulong;
                                (*sec).used_by_bfd = bfd_zalloc(abfd, amt);
                                if ((*sec).used_by_bfd).is_null() {
                                    current_block = 12181885546557410871;
                                } else {
                                    let ref mut fresh3 = (*((*sec).used_by_bfd
                                        as *mut coff_section_tdata))
                                        .contents;
                                    *fresh3 = 0 as *mut bfd_byte;
                            ...
                            match current_block {
                                12181885546557410871 => {}
                                _ => {
                                    let ref mut fresh4 = (*((*sec).used_by_bfd
                                        as *mut coff_section_tdata))
                                        .relocs;
                                    *fresh4 = free_internal;
    ...
    free(free_external as *mut libc::c_void);
    free(free_internal as *mut libc::c_void);
    return 0 as *mut internal_reloc;
}
#[no_mangle]
pub unsafe extern "C" fn coff_count_linenumbers(mut abfd: *mut bfd) -> libc::c_int {
    let mut limit: libc::c_uint = bfd_get_symcount(abfd);
    let mut i: libc::c_uint = 0;
    ...
    if limit == 0 as libc::c_int as libc::c_uint {
        s = (*abfd).sections;
        while !s.is_null() {
            total = (total as libc::c_uint).wrapping_add((*s).lineno_count)
    ...
    s = (*abfd).sections;
    while !s.is_null() {
        if !((*s).lineno_count == 0 as libc::c_int as libc::c_uint) {
            bfd_assert(
                b"coffgen.c\0" as *const u8 as *const libc::c_char,
                592 as libc::c_int,
            );
    ...
    i = 0 as libc::c_int as libc::c_uint;
    while i < limit {
        let mut q_maybe: *mut asymbol = *p;
        if bfd_family_coff(bfd_asymbol_bfd(q_maybe)) {
            let mut q: *mut coff_symbol_type = &mut (*q_maybe).the_bfd as *mut *mut bfd
                as *mut coff_symbol_type;
            if !((*q).lineno).is_null() && !((*(*q).symbol.section).owner).is_null() {
                let mut l: *mut alent = (*q).lineno;
                loop {
                    let mut sec: *mut asection = (*(*q).symbol.section).output_section;
                    if !bfd_is_const_section(sec) {
                        (*sec).lineno_count = ((*sec).lineno_count).wrapping_add(1);
                        (*sec).lineno_count;
                    }
                    total += 1;
                    total;
                    l = l.offset(1);
                    l;
                    if !((*l).line_number != 0 as libc::c_int as libc::c_uint) {
                        break;
                    }
                }
            }
...
unsafe extern "C" fn fixup_symbol_value(
    mut abfd: *mut bfd,
    mut coff_symbol_ptr: *mut coff_symbol_type,
    mut syment: *mut internal_syment,
) {
    if !((*coff_symbol_ptr).symbol.section).is_null()
        && bfd_is_com_section((*coff_symbol_ptr).symbol.section) as libc::c_int != 0
    {
        (*syment).n_scnum = 0 as libc::c_int;
        (*syment).n_value = (*coff_symbol_ptr).symbol.value;
    } else if (*coff_symbol_ptr).symbol.flags
        & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
        && (*coff_symbol_ptr).symbol.flags
            ...
            == 0 as libc::c_int as libc::c_uint
    {
    ...
    } else if !((*coff_symbol_ptr).symbol.section).is_null() {
        (*syment)
            .n_scnum = (*(*(*coff_symbol_ptr).symbol.section).output_section)
            .target_index;
        (*syment)
            .n_value = ((*coff_symbol_ptr).symbol.value)
            .wrapping_add((*(*coff_symbol_ptr).symbol.section).output_offset);
        if (*(*abfd).tdata.coff_obj_data).pe == 0 {
            (*syment)
                .n_value = ((*syment).n_value as libc::c_ulong)
                .wrapping_add(
                    if (*syment).n_sclass as libc::c_int == 20 as libc::c_int {
        ...
        (*syment).n_scnum = -(1 as libc::c_int);
        (*syment).n_value = (*coff_symbol_ptr).symbol.value;
    };
}
#[no_mangle]
pub unsafe extern "C" fn coff_renumber_symbols(
    mut bfd_ptr: *mut bfd,
    mut first_undef: *mut libc::c_int,
) -> bool {
    let mut symbol_count: libc::c_uint = bfd_get_symcount(bfd_ptr);
    let mut symbol_ptr_ptr: *mut *mut asymbol = (*bfd_ptr).outsymbols;
    let mut native_index: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut last_file: *mut internal_syment = 0 as *mut internal_syment;
    let mut symbol_index: libc::c_uint = 0;
    let mut newsyms: *mut *mut asymbol = 0 as *mut *mut asymbol;
    let mut i: libc::c_uint = 0;
    let mut amt: bfd_size_type = 0;
    amt = (::core::mem::size_of::<*mut asymbol>() as libc::c_ulong)
        .wrapping_mul(
            (symbol_count as bfd_size_type)
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
        );
    newsyms = bfd_alloc(bfd_ptr, amt) as *mut *mut asymbol;
    if newsyms.is_null() {
        return 0 as libc::c_int != 0;
    }
    ...
    while i < symbol_count {
        if (**symbol_ptr_ptr.offset(i as isize)).flags
            & ((1 as libc::c_int) << 10 as libc::c_int) as libc::c_uint
            != 0 as libc::c_int as libc::c_uint
            || !bfd_is_und_section((**symbol_ptr_ptr.offset(i as isize)).section)
                && !bfd_is_com_section((**symbol_ptr_ptr.offset(i as isize)).section)
                && ((**symbol_ptr_ptr.offset(i as isize)).flags
        ...
        {
            let fresh5 = newsyms;
            newsyms = newsyms.offset(1);
            *fresh5 = *symbol_ptr_ptr.offset(i as isize);
        }
        i = i.wrapping_add(1);
        i;
    }
    ...
    while i < symbol_count {
                        ...
                        != 0 as libc::c_int as libc::c_uint)
        {
            let fresh6 = newsyms;
            newsyms = newsyms.offset(1);
            *fresh6 = *symbol_ptr_ptr.offset(i as isize);
        }
        i = i.wrapping_add(1);
        i;
    }
    *first_undef = newsyms.offset_from((*bfd_ptr).outsymbols) as libc::c_long
        as libc::c_int;
    i = 0 as libc::c_int as libc::c_uint;
    while i < symbol_count {
        if (**symbol_ptr_ptr.offset(i as isize)).flags
                ...
                as libc::c_int != 0
        {
            let fresh7 = newsyms;
            newsyms = newsyms.offset(1);
            *fresh7 = *symbol_ptr_ptr.offset(i as isize);
        }
        i = i.wrapping_add(1);
        i;
    }
    *newsyms = 0 as *mut libc::c_void as *mut asymbol;
    symbol_ptr_ptr = (*bfd_ptr).outsymbols;
    symbol_index = 0 as libc::c_int as libc::c_uint;
    while symbol_index < symbol_count {
        let mut coff_symbol_ptr: *mut coff_symbol_type = 0 as *mut coff_symbol_type;
        coff_symbol_ptr = if bfd_family_coff(
            bfd_asymbol_bfd(*symbol_ptr_ptr.offset(symbol_index as isize)),
        ) as libc::c_int != 0
            && !((*bfd_asymbol_bfd(*symbol_ptr_ptr.offset(symbol_index as isize)))
                .tdata
                .coff_obj_data)
                .is_null()
        {
            *symbol_ptr_ptr.offset(symbol_index as isize) as *mut coff_symbol_type
        } else {
            0 as *mut coff_symbol_type
        };
        (**symbol_ptr_ptr.offset(symbol_index as isize))
            .udata
            .i = symbol_index as bfd_vma;
        if !coff_symbol_ptr.is_null() && !((*coff_symbol_ptr).native).is_null() {
            let mut s: *mut combined_entry_type = (*coff_symbol_ptr).native;
            ...
            if (*s).u.syment.n_sclass as libc::c_int == 103 as libc::c_int {
                if !last_file.is_null() {
                    (*last_file).n_value = native_index as bfd_vma;
                }
                last_file = &mut (*s).u.syment;
            } else {
                fixup_symbol_value(bfd_ptr, coff_symbol_ptr, &mut (*s).u.syment);
            }
            i_0 = 0 as libc::c_int;
            while i_0 < (*s).u.syment.n_numaux as libc::c_int + 1 as libc::c_int {
                let fresh8 = native_index;
                native_index = native_index.wrapping_add(1);
                (*s.offset(i_0 as isize)).offset = fresh8;
                i_0 += 1;
                i_0;
            }
        } else {
        ...
        symbol_index = symbol_index.wrapping_add(1);
        symbol_index;
    }
    (*(*bfd_ptr).tdata.coff_obj_data).conv_table_size = native_index as libc::c_int;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn coff_mangle_symbols(mut bfd_ptr: *mut bfd) {
    let mut symbol_count: libc::c_uint = bfd_get_symcount(bfd_ptr);
    let mut symbol_ptr_ptr: *mut *mut asymbol = (*bfd_ptr).outsymbols;
    let mut symbol_index: libc::c_uint = 0;
    symbol_index = 0 as libc::c_int as libc::c_uint;
        ...
        if !coff_symbol_ptr.is_null() && !((*coff_symbol_ptr).native).is_null() {
            ...
            if (*s).fix_value() != 0 {
                (*s)
                    .u
                    .syment
                    .n_value = (*((*s).u.syment.n_value as *mut combined_entry_type))
                    .offset as bfd_hostptr_t;
                (*s).set_fix_value(0 as libc::c_int as libc::c_uint);
            }
            if (*s).fix_line() != 0 {
                (*s)
                    .u
                    .syment
                    .n_value = ((*(*(*coff_symbol_ptr).symbol.section).output_section)
                    .line_filepos as libc::c_ulong)
                    .wrapping_add(
                        ((*s).u.syment.n_value)
                            .wrapping_mul(
                                (*((*(*bfd_ptr).xvec).backend_data
                                    as *mut bfd_coff_backend_data))
                ...
                (*coff_symbol_ptr)
                    .symbol
                    .section = coff_section_from_bfd_index(bfd_ptr, -(2 as libc::c_int));
                if (*coff_symbol_ptr).symbol.flags
            ...
            i = 0 as libc::c_int;
            while i < (*s).u.syment.n_numaux as libc::c_int {
                let mut a: *mut combined_entry_type = s
                    .offset(i as isize)
                ...
                if (*a).fix_tag() != 0 {
                    (*a)
                        ...
                        .x_sym
                        .x_tagndx
                        .l = (*(*a).u.auxent.x_sym.x_tagndx.p).offset as libc::c_long;
                    (*a).set_fix_tag(0 as libc::c_int as libc::c_uint);
                }
                if (*a).fix_end() != 0 {
                    (*a)
                        .u
                        ...
                        .x_fcn
                        .x_endndx
                        .l = (*(*a).u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.p).offset
                        as libc::c_long;
                    (*a).set_fix_end(0 as libc::c_int as libc::c_uint);
                }
                if (*a).fix_scnlen() != 0 {
                    (*a)
                        .u
                        ...
                        .x_csect
                        .x_scnlen
                        .l = (*(*a).u.auxent.x_csect.x_scnlen.p).offset
                        as bfd_signed_vma;
                    (*a).set_fix_scnlen(0 as libc::c_int as libc::c_uint);
                }
                i += 1;
                i;
            }
...
unsafe extern "C" fn coff_fix_symbol_name(
    mut abfd: *mut bfd,
    mut symbol: *mut asymbol,
    mut native: *mut combined_entry_type,
    mut string_size_p: *mut bfd_size_type,
    mut debug_string_section_p: *mut *mut asection,
    mut debug_string_size_p: *mut bfd_size_type,
) {
    let mut name_length: libc::c_uint = 0;
    let mut auxent: *mut internal_auxent = 0 as *mut internal_auxent;
    let mut name: *mut libc::c_char = (*symbol).name as *mut libc::c_char;
    if name.is_null() {
        (*symbol).name = b"strange\0" as *const u8 as *const libc::c_char;
        name = (*symbol).name as *mut libc::c_char;
    }
    name_length = strlen(name) as libc::c_uint;
    if !(*native).is_sym {
        bfd_assert(
            b"coffgen.c\0" as *const u8 as *const libc::c_char,
            870 as libc::c_int,
    ...
    if (*native).u.syment.n_sclass as libc::c_int == 103 as libc::c_int
        && (*native).u.syment.n_numaux as libc::c_int > 0 as libc::c_int
    {
        let mut filnmlen: libc::c_uint = 0;
        if (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_force_symnames_in_strings
        {
            (*native)
                ...
                ._n
                ._n_n
                ._n_offset = (*string_size_p)
                .wrapping_add(4 as libc::c_int as libc::c_ulong);
            (*native).u.syment._n._n_n._n_zeroes = 0 as libc::c_int as bfd_hostptr_t;
            *string_size_p = (*string_size_p as libc::c_ulong)
                .wrapping_add(6 as libc::c_int as libc::c_ulong) as bfd_size_type
                as bfd_size_type;
        } else {
            strncpy(
                ((*native).u.syment._n._n_name).as_mut_ptr(),
                b".file\0" as *const u8 as *const libc::c_char,
                8 as libc::c_int as libc::c_ulong,
            );
        }
        if (*native.offset(1 as libc::c_int as isize)).is_sym {
            bfd_assert(
                b"coffgen.c\0" as *const u8 as *const libc::c_char,
                886 as libc::c_int,
            );
        }
        auxent = &mut (*native.offset(1 as libc::c_int as isize)).u.auxent;
        filnmlen = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_filnmlen;
        if (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_long_filenames
        {
            if name_length <= filnmlen {
                strncpy(
                    ((*auxent).x_file.x_fname).as_mut_ptr(),
                    name,
                    filnmlen as libc::c_ulong,
                );
            } else {
                (*auxent)
                    .x_file
                    .x_n
                    .x_offset = (*string_size_p)
                    .wrapping_add(4 as libc::c_int as libc::c_ulong) as libc::c_long;
                (*auxent).x_file.x_n.x_zeroes = 0 as libc::c_int as libc::c_long;
                *string_size_p = (*string_size_p as libc::c_ulong)
                    .wrapping_add(
                        name_length.wrapping_add(1 as libc::c_int as libc::c_uint)
                            as libc::c_ulong,
                    ) as bfd_size_type as bfd_size_type;
            }
        } else {
            ...
            if name_length > filnmlen {
                *name.offset(filnmlen as isize) = '\0' as i32 as libc::c_char;
            }
        }
    } else if name_length <= 8 as libc::c_int as libc::c_uint
        && !(*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_force_symnames_in_strings
    {
        strncpy(
    ...
    } else if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_symname_in_debug)
        .expect("non-null function pointer")(abfd, &mut (*native).u.syment)
    {
        (*native)
            .u
            .syment
        ...
        *string_size_p = (*string_size_p as libc::c_ulong)
        ...
        let mut filepos: file_ptr = 0;
        let mut buf: [bfd_byte; 4] = [0; 4];
        let mut prefix_len: libc::c_int = (*((*(*abfd).xvec).backend_data
            as *mut bfd_coff_backend_data))
            ._bfd_coff_debug_string_prefix_length as libc::c_int;
        if (*debug_string_section_p).is_null() {
            *debug_string_section_p = bfd_get_section_by_name(
                abfd,
                b".debug\0" as *const u8 as *const libc::c_char,
            );
        }
        filepos = bfd_tell(abfd);
        if prefix_len == 4 as libc::c_int {
            (Some(((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(
                name_length.wrapping_add(1 as libc::c_int as libc::c_uint) as bfd_vma,
                buf.as_mut_ptr() as *mut libc::c_void,
            );
        } else {
        ...
        if !bfd_set_section_contents(
            ...
            *debug_string_section_p,
            buf.as_mut_ptr() as *mut libc::c_void,
            *debug_string_size_p as file_ptr,
            prefix_len as bfd_size_type,
        )
            || !bfd_set_section_contents(
                abfd,
                *debug_string_section_p,
                (*symbol).name as *mut libc::c_void,
                (*debug_string_size_p).wrapping_add(prefix_len as libc::c_ulong)
                    as file_ptr,
                (name_length as bfd_size_type)
                    .wrapping_add(1 as libc::c_int as libc::c_ulong),
            )
        {
            _bfd_abort(
                ...
                (*::core::mem::transmute::<
                    ...
                    &[libc::c_char; 114],
                >(
                    b"void coff_fix_symbol_name(bfd *, asymbol *, combined_entry_type *, bfd_size_type *, asection **, bfd_size_type *)\0",
                ))
                    .as_ptr(),
            );
        }
        ...
        (*native)
            ...
            ._n
            ._n_n
            ._n_offset = (*debug_string_size_p)
            .wrapping_add(prefix_len as libc::c_ulong);
        (*native).u.syment._n._n_n._n_zeroes = 0 as libc::c_int as bfd_hostptr_t;
        *debug_string_size_p = (*debug_string_size_p as libc::c_ulong)
            .wrapping_add(
                name_length
                    .wrapping_add(1 as libc::c_int as libc::c_uint)
                    .wrapping_add(prefix_len as libc::c_uint) as libc::c_ulong,
            ) as bfd_size_type as bfd_size_type;
    };
}
unsafe extern "C" fn coff_write_symbol(
    mut abfd: *mut bfd,
    mut symbol: *mut asymbol,
    mut native: *mut combined_entry_type,
    mut written: *mut bfd_vma,
    mut string_size_p: *mut bfd_size_type,
    mut debug_string_section_p: *mut *mut asection,
    mut debug_string_size_p: *mut bfd_size_type,
) -> bool {
    let mut numaux: libc::c_uint = (*native).u.syment.n_numaux as libc::c_uint;
    let mut type_0: libc::c_int = (*native).u.syment.n_type as libc::c_int;
    let mut n_sclass: libc::c_int = (*native).u.syment.n_sclass as libc::c_int;
    let mut output_section: *mut asection = if !((*(*symbol).section).output_section)
        .is_null()
    {
    ...
    if (*native).u.syment.n_sclass as libc::c_int == 103 as libc::c_int {
        (*symbol).flags |= ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
    }
    if (*symbol).flags & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint != 0
        && bfd_is_abs_section((*symbol).section) as libc::c_int != 0
    {
        (*native).u.syment.n_scnum = -(2 as libc::c_int);
    } else if bfd_is_abs_section((*symbol).section) {
        (*native).u.syment.n_scnum = -(1 as libc::c_int);
    } else if bfd_is_und_section((*symbol).section) {
        (*native).u.syment.n_scnum = 0 as libc::c_int;
    } else {
    ...
    ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ...
        abfd,
        &mut (*native).u.syment as *mut internal_syment as *mut libc::c_void,
        buf,
    );
    ...
    if (*native).u.syment.n_numaux as libc::c_int > 0 as libc::c_int {
        let mut auxesz: bfd_size_type = 0;
        let mut j: libc::c_uint = 0;
        auxesz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_auxesz as bfd_size_type;
        buf = bfd_alloc(abfd, auxesz);
        if buf.is_null() {
            return 0 as libc::c_int != 0;
        }
        j = 0 as libc::c_int as libc::c_uint;
        while j < (*native).u.syment.n_numaux as libc::c_uint {
            if (*native.offset(j as isize).offset(1 as libc::c_int as isize)).is_sym {
                bfd_assert(
                    b"coffgen.c\0" as *const u8 as *const libc::c_char,
                    1031 as libc::c_int,
                );
            ...
            ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ...
                abfd,
                &mut (*native.offset(j as isize).offset(1 as libc::c_int as isize))
                    .u
                    .auxent as *mut internal_auxent as *mut libc::c_void,
                type_0,
                n_sclass,
                j as libc::c_int,
                (*native).u.syment.n_numaux as libc::c_int,
                buf,
            );
    ...
    *written = (*written as libc::c_ulong)
        .wrapping_add(
            numaux.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong,
        ) as bfd_vma as bfd_vma;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn coff_write_alien_symbol(
    mut abfd: *mut bfd,
    mut symbol: *mut asymbol,
    mut isym: *mut internal_syment,
    mut iaux: *mut internal_auxent,
    mut written: *mut bfd_vma,
    mut string_size_p: *mut bfd_size_type,
    mut debug_string_section_p: *mut *mut asection,
    mut debug_string_size_p: *mut bfd_size_type,
    ...
    let mut dummy: [combined_entry_type; 2] = [combined_entry_type {
        offset: 0,
        fix_value_fix_tag_fix_end_fix_scnlen_fix_line: [0; 1],
        c2rust_padding: [0; 3],
        u: C2RustUnnamed_16 {
            auxent: internal_auxent {
    ...
    let mut link_info: *mut bfd_link_info = (*(*abfd).tdata.coff_obj_data).link_info;
    let mut ret: bool = false;
    if (link_info.is_null() || (*link_info).strip_discarded() as libc::c_int != 0)
        && !bfd_is_abs_section((*symbol).section)
        && (*(*symbol).section).output_section
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
    {
        (*symbol).name = b"\0" as *const u8 as *const libc::c_char;
        if !isym.is_null() {
            memset(
    ...
    native = dummy.as_mut_ptr();
    (*native).is_sym = 1 as libc::c_int != 0;
    (*native.offset(1 as libc::c_int as isize)).is_sym = 0 as libc::c_int != 0;
    (*native).u.syment.n_type = 0 as libc::c_int as libc::c_ushort;
    (*native).u.syment.n_flags = 0 as libc::c_int as libc::c_ushort;
    (*native).u.syment.n_numaux = 0 as libc::c_int as libc::c_uchar;
    if bfd_is_und_section((*symbol).section) {
        ...
        (*native).u.syment.n_scnum = 0 as libc::c_int;
        (*native).u.syment.n_value = (*symbol).value;
    } else if (*symbol).flags & ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint
        != 0
    {
        (*native).u.syment.n_scnum = -(2 as libc::c_int);
        (*native).u.syment.n_numaux = 1 as libc::c_int as libc::c_uchar;
    } else if (*symbol).flags & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint
        != 0
    {
        (*symbol).name = b"\0" as *const u8 as *const libc::c_char;
        if !isym.is_null() {
        ...
        (*native)
            ...
            .wrapping_add((*(*symbol).section).output_offset);
        if (*(*abfd).tdata.coff_obj_data).pe == 0 {
            (*native)
                .u
                .syment
                .n_value = ((*native).u.syment.n_value as libc::c_ulong)
                .wrapping_add((*output_section).vma) as bfd_vma as bfd_vma;
        }
        let mut c: *mut coff_symbol_type = if bfd_family_coff(bfd_asymbol_bfd(symbol))
            as libc::c_int != 0
            && !((*bfd_asymbol_bfd(symbol)).tdata.coff_obj_data).is_null()
        {
            symbol as *mut coff_symbol_type
        } else {
            0 as *mut coff_symbol_type
        };
        if !c.is_null() {
            (*native)
                .u
                .syment
                .n_flags = (*bfd_asymbol_bfd(&mut (*c).symbol)).flags as libc::c_ushort;
        }
    }
    (*native).u.syment.n_type = 0 as libc::c_int as libc::c_ushort;
    if (*symbol).flags & ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint != 0 {
        (*native).u.syment.n_sclass = 103 as libc::c_int as libc::c_uchar;
    } else if (*symbol).flags & ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
        != 0
    {
        (*native).u.syment.n_sclass = 3 as libc::c_int as libc::c_uchar;
    } else if (*symbol).flags & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
        != 0
    {
        (*native)
            .u
            .syment
            .n_sclass = (if (*(*abfd).tdata.coff_obj_data).pe != 0 {
            105 as libc::c_int
        } else {
            127 as libc::c_int
        }) as libc::c_uchar;
    } else {
        (*native).u.syment.n_sclass = 2 as libc::c_int as libc::c_uchar;
    }
    ret = coff_write_symbol(
        abfd,
        symbol,
        native,
        written,
    ...
    if !iaux.is_null() && (*native).u.syment.n_numaux as libc::c_int != 0 {
        *iaux = (*native.offset(1 as libc::c_int as isize)).u.auxent;
    }
    return ret;
}
unsafe extern "C" fn coff_write_native_symbol(
    mut abfd: *mut bfd,
    mut symbol: *mut coff_symbol_type,
    mut written: *mut bfd_vma,
    mut string_size_p: *mut bfd_size_type,
    mut debug_string_section_p: *mut *mut asection,
    mut debug_string_size_p: *mut bfd_size_type,
) -> bool {
    let mut native: *mut combined_entry_type = (*symbol).native;
    let mut lineno: *mut alent = (*symbol).lineno;
    let mut link_info: *mut bfd_link_info = (*(*abfd).tdata.coff_obj_data).link_info;
    if (link_info.is_null() || (*link_info).strip_discarded() as libc::c_int != 0)
        && !bfd_is_abs_section((*symbol).symbol.section)
        && (*(*symbol).symbol.section).output_section
            == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                as *mut asection
    {
        (*symbol).symbol.name = b"\0" as *const u8 as *const libc::c_char;
        return 1 as libc::c_int != 0;
    }
    if !(*native).is_sym {
        bfd_assert(
    ...
    if !lineno.is_null() && !(*symbol).done_lineno
        && !((*(*symbol).symbol.section).owner).is_null()
    {
        let mut count: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        (*lineno.offset(count as isize)).u.offset = *written;
        if (*native).u.syment.n_numaux != 0 {
            let mut a: *mut internal_auxent = &mut (*native
                .offset(1 as libc::c_int as isize))
                .u
                .auxent;
            (*a)
                ...
                .x_fcnary
                .x_fcn
                .x_lnnoptr = (*(*(*symbol).symbol.section).output_section)
                .moving_line_filepos;
        }
        count = count.wrapping_add(1);
        count;
        while (*lineno.offset(count as isize)).line_number
            != 0 as libc::c_int as libc::c_uint
        {
            let ref mut fresh9 = (*lineno.offset(count as isize)).u.offset;
            *fresh9 = (*fresh9 as libc::c_ulong)
                .wrapping_add(
                    ((*(*(*symbol).symbol.section).output_section).vma)
                        .wrapping_add((*(*symbol).symbol.section).output_offset),
                ) as bfd_vma as bfd_vma;
            count = count.wrapping_add(1);
            count;
        }
        (*symbol).done_lineno = 1 as libc::c_int != 0;
...
pub unsafe extern "C" fn coff_write_symbols(mut abfd: *mut bfd) -> bool {
    let mut string_size: bfd_size_type = 0;
    let mut debug_string_section: *mut asection = 0 as *mut asection;
    let mut debug_string_size: bfd_size_type = 0;
    let mut i: libc::c_uint = 0;
    let mut limit: libc::c_uint = bfd_get_symcount(abfd);
    let mut written: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut p: *mut *mut asymbol = 0 as *mut *mut asymbol;
    string_size = 0 as libc::c_int as bfd_size_type;
    debug_string_section = 0 as *mut asection;
    debug_string_size = 0 as libc::c_int as bfd_size_type;
    if (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
    ...
    if bfd_seek(abfd, (*(*abfd).tdata.coff_obj_data).sym_filepos, 0 as libc::c_int)
        != 0 as libc::c_int
    {
        return 0 as libc::c_int != 0;
    }
    written = 0 as libc::c_int as bfd_vma;
    p = (*abfd).outsymbols;
    i = 0 as libc::c_int as libc::c_uint;
    while i < limit {
        let mut symbol: *mut asymbol = *p;
        let mut c_symbol: *mut coff_symbol_type = if bfd_family_coff(
            bfd_asymbol_bfd(symbol),
        ) as libc::c_int != 0
            && !((*bfd_asymbol_bfd(symbol)).tdata.coff_obj_data).is_null()
        {
            symbol as *mut coff_symbol_type
        ...
        if c_symbol.is_null() || ((*c_symbol).native).is_null() {
            if !coff_write_alien_symbol(
                abfd,
                symbol,
                0 as *mut internal_syment,
                0 as *mut internal_auxent,
                &mut written,
                &mut string_size,
                &mut debug_string_section,
                &mut debug_string_size,
            ) {
                return 0 as libc::c_int != 0;
            }
        } else {
            if ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ...
                .is_some()
            {
                let mut current_error_handler: bfd_error_handler_type = None;
                let mut sym_class: coff_symbol_classification = COFF_SYMBOL_GLOBAL;
                let mut n_sclass: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
                current_error_handler = bfd_set_error_handler(
                    Some(
                        null_error_handler
                ...
                if !(*(*c_symbol).native).is_sym {
                    bfd_assert(
                        b"coffgen.c\0" as *const u8 as *const libc::c_char,
                        1282 as libc::c_int,
                    );
                }
                sym_class = ((*((*(*abfd).xvec).backend_data
                    as *mut bfd_coff_backend_data))
                    ._bfd_coff_classify_symbol)
                    .expect(
                        "non-null function pointer",
                    )(abfd, &mut (*(*c_symbol).native).u.syment);
                bfd_set_error_handler(current_error_handler);
                n_sclass = &mut (*(*c_symbol).native).u.syment.n_sclass;
                if (*symbol).flags
                    & ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint != 0
                {
                    *n_sclass = (if (*(*abfd).tdata.coff_obj_data).pe != 0 {
                    ...
                    && sym_class as libc::c_uint
                        != COFF_SYMBOL_LOCAL as libc::c_int as libc::c_uint
                {
                    *n_sclass = 3 as libc::c_int as libc::c_uchar;
                } else if (*symbol).flags
                    & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint != 0
                    && (sym_class as libc::c_uint
                        != COFF_SYMBOL_GLOBAL as libc::c_int as libc::c_uint
                        || *n_sclass as libc::c_int == 127 as libc::c_int)
                {
                    (*(*c_symbol).native)
                        .u
                        .syment
                        .n_sclass = 2 as libc::c_int as libc::c_uchar;
                }
            }
            if !coff_write_native_symbol(
                abfd,
                c_symbol,
                &mut written,
                &mut string_size,
    ...
    if string_size != 0 as libc::c_int as libc::c_ulong {
        let mut size: libc::c_uint = string_size
            .wrapping_add(4 as libc::c_int as libc::c_ulong) as libc::c_uint;
        let mut buffer: [bfd_byte; 4] = [0; 4];
        (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(size as bfd_vma, buffer.as_mut_ptr() as *mut libc::c_void);
        if bfd_bwrite(
        ...
        if (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_long_section_names
        {
            let mut o_0: *mut asection = 0 as *mut asection;
            o_0 = (*abfd).sections;
            while !o_0.is_null() {
                let mut len_0: size_t = 0;
                len_0 = strlen((*o_0).name);
                if len_0 > 8 as libc::c_int as libc::c_ulong {
                    if bfd_bwrite(
                        (*o_0).name as *const libc::c_void,
        ...
        i = 0 as libc::c_int as libc::c_uint;
        while i < limit {
            let mut q: *mut asymbol = *p;
            let mut name_length: size_t = strlen((*q).name);
            let mut c_symbol_0: *mut coff_symbol_type = if bfd_family_coff(
                bfd_asymbol_bfd(q),
            ) as libc::c_int != 0
                && !((*bfd_asymbol_bfd(q)).tdata.coff_obj_data).is_null()
            {
                q as *mut coff_symbol_type
            } else {
                0 as *mut coff_symbol_type
            };
            let mut maxlen: size_t = 0;
            if c_symbol_0.is_null() || ((*c_symbol_0).native).is_null() {
                maxlen = (if (*((*(*abfd).xvec).backend_data
                    as *mut bfd_coff_backend_data))
                    ._bfd_coff_force_symnames_in_strings as libc::c_int != 0
                {
                    0 as libc::c_int
                } else {
                    8 as libc::c_int
                }) as size_t;
            } else if !(*(*c_symbol_0).native).is_sym {
                maxlen = (if (*((*(*abfd).xvec).backend_data
                    as *mut bfd_coff_backend_data))
                    ._bfd_coff_force_symnames_in_strings as libc::c_int != 0
                {
                ...
                .expect(
                    "non-null function pointer",
                )(abfd, &mut (*(*c_symbol_0).native).u.syment)
            {
                maxlen = name_length;
            } else if (*(*c_symbol_0).native).u.syment.n_sclass as libc::c_int
                == 103 as libc::c_int
                && (*(*c_symbol_0).native).u.syment.n_numaux as libc::c_int
                    > 0 as libc::c_int
            {
                if (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                    ._bfd_coff_force_symnames_in_strings
                {
                    if bfd_bwrite(
                        b".file\0" as *const u8 as *const libc::c_char
                            as *const libc::c_void,
                        6 as libc::c_int as bfd_size_type,
                        abfd,
                ...
                maxlen = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                    ._bfd_filnmlen as size_t;
            } else {
                maxlen = (if (*((*(*abfd).xvec).backend_data
                    as *mut bfd_coff_backend_data))
                    ._bfd_coff_force_symnames_in_strings as libc::c_int != 0
        ...
        let mut size_0: libc::c_uint = 4 as libc::c_int as libc::c_uint;
        let mut buffer_0: [bfd_byte; 4] = [0; 4];
        (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(size_0 as bfd_vma, buffer_0.as_mut_ptr() as *mut libc::c_void);
        if bfd_bwrite(
            buffer_0.as_mut_ptr() as *mut libc::c_void,
    ...
    if !(debug_string_size == 0 as libc::c_int as libc::c_ulong
        || !debug_string_section.is_null()
            && (if debug_string_size
                .wrapping_add(
                    ((1 as libc::c_int) << (*debug_string_section).alignment_power)
                        as libc::c_ulong,
                )
                .wrapping_sub(1 as libc::c_int as libc::c_ulong) >= debug_string_size
            {
                debug_string_size
                    .wrapping_add(
                        (((1 as libc::c_int) << (*debug_string_section).alignment_power)
...
#[no_mangle]
pub unsafe extern "C" fn coff_write_linenumbers(mut abfd: *mut bfd) -> bool {
    let mut s: *mut asection = 0 as *mut asection;
    let mut linesz: bfd_size_type = 0;
    let mut buff: *mut libc::c_void = 0 as *mut libc::c_void;
    linesz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_linesz
        as bfd_size_type;
    ...
    while !s.is_null() {
        if (*s).lineno_count != 0 {
            let mut q: *mut *mut asymbol = (*abfd).outsymbols;
            if bfd_seek(abfd, (*s).line_filepos, 0 as libc::c_int) != 0 as libc::c_int {
                return 0 as libc::c_int != 0;
            }
            while !(*q).is_null() {
                let mut p: *mut asymbol = *q;
                if (*(*p).section).output_section == s {
                    let mut l: *mut alent = (Some(
                        ((*(*(bfd_asymbol_bfd
                            as unsafe extern "C" fn(*const asymbol) -> *mut bfd)(p))
                            .xvec)
                            ._get_lineno)
                            .expect("non-null function pointer"),
                    ))
                        .expect("non-null function pointer")(bfd_asymbol_bfd(p), p);
                    if !l.is_null() {
                        let mut out: internal_lineno = internal_lineno {
                            l_addr: C2RustUnnamed_34 { l_symndx: 0 },
                            l_lnno: 0,
                        };
                        memset(
                            &mut out as *mut internal_lineno as *mut libc::c_void,
                            0 as libc::c_int,
                            ::core::mem::size_of::<internal_lineno>() as libc::c_ulong,
                        );
                        out.l_lnno = 0 as libc::c_int as libc::c_ulong;
                        out.l_addr.l_symndx = (*l).u.offset as bfd_signed_vma;
                        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                        ...
                        if bfd_bwrite(buff, linesz, abfd) != linesz {
                            return 0 as libc::c_int != 0;
                        }
                        l = l.offset(1);
                        l;
                        while (*l).line_number != 0 {
                            out.l_lnno = (*l).line_number as libc::c_ulong;
                            out.l_addr.l_symndx = (*l).u.offset as bfd_signed_vma;
                            ((*((*(*abfd).xvec).backend_data
                                as *mut bfd_coff_backend_data))
                                ._bfd_coff_swap_lineno_out)
...
unsafe extern "C" fn coff_pointerize_aux(
    mut abfd: *mut bfd,
    mut table_base: *mut combined_entry_type,
    mut symbol: *mut combined_entry_type,
    mut indaux: libc::c_uint,
    mut auxent: *mut combined_entry_type,
    mut table_end: *mut combined_entry_type,
) {
    let mut type_0: libc::c_uint = (*symbol).u.syment.n_type as libc::c_uint;
    let mut n_sclass: libc::c_uint = (*symbol).u.syment.n_sclass as libc::c_uint;
    if !(*symbol).is_sym {
        bfd_assert(
            b"coffgen.c\0" as *const u8 as *const libc::c_char,
            1517 as libc::c_int,
    ...
    if n_sclass == 3 as libc::c_int as libc::c_uint
        && type_0 == 0 as libc::c_int as libc::c_uint
    {
        return;
    }
    if n_sclass == 103 as libc::c_int as libc::c_uint {
        return;
    }
    if n_sclass == 112 as libc::c_int as libc::c_uint {
        return;
    }
    if (*auxent).is_sym {
        bfd_assert(
    ...
    if (type_0 as libc::c_ulong
        & (*(*abfd).tdata.coff_obj_data).local_n_tmask as libc::c_ulong
        == (2 as libc::c_int as libc::c_ulong)
            << (*(*abfd).tdata.coff_obj_data).local_n_btshft
        || (n_sclass == 10 as libc::c_int as libc::c_uint
            || n_sclass == 12 as libc::c_int as libc::c_uint
            || n_sclass == 15 as libc::c_int as libc::c_uint)
        || n_sclass == 100 as libc::c_int as libc::c_uint
        || n_sclass == 101 as libc::c_int as libc::c_uint)
        && (*auxent).u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.l
            > 0 as libc::c_int as libc::c_long
        && (*auxent).u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.l
            < (*(*abfd).tdata.coff_obj_data).raw_syment_count as libc::c_long
        && table_base.offset((*auxent).u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.l as isize)
            < table_end
    {
        (*auxent)
            .u
            ...
            .x_endndx
            .p = table_base
            .offset((*auxent).u.auxent.x_sym.x_fcnary.x_fcn.x_endndx.l as isize);
        (*auxent).set_fix_end(1 as libc::c_int as libc::c_uint);
    }
    if ((*auxent).u.auxent.x_sym.x_tagndx.l as libc::c_ulong)
        < (*(*abfd).tdata.coff_obj_data).raw_syment_count
        && table_base.offset((*auxent).u.auxent.x_sym.x_tagndx.l as isize) < table_end
    {
        (*auxent)
            .u
            .auxent
            .x_sym
            .x_tagndx
            .p = table_base.offset((*auxent).u.auxent.x_sym.x_tagndx.l as isize);
        (*auxent).set_fix_tag(1 as libc::c_int as libc::c_uint);
    }
}
unsafe extern "C" fn build_debug_section(
    mut abfd: *mut bfd,
    mut sect_return: *mut *mut asection,
) -> *mut libc::c_char {
    let mut debug_section: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut position: file_ptr = 0;
    let mut sec_size: bfd_size_type = 0;
    let mut sect: *mut asection = bfd_get_section_by_name(
        abfd,
        b".debug\0" as *const u8 as *const libc::c_char,
    );
    if sect.is_null() {
    ...
    if bfd_seek(abfd, (*sect).filepos, 0 as libc::c_int) != 0 as libc::c_int {
        return 0 as *mut libc::c_char;
    }
    sec_size = (*sect).size;
    debug_section = _bfd_alloc_and_read(abfd, sec_size, sec_size) as *mut libc::c_char;
    if debug_section.is_null() {
        return 0 as *mut libc::c_char;
    }
    if bfd_seek(abfd, position, 0 as libc::c_int) != 0 as libc::c_int {
        return 0 as *mut libc::c_char;
    }
    *sect_return = sect;
...
unsafe extern "C" fn copy_name(
    ...
    while len < maxlen {
        if *name.offset(len as isize) as libc::c_int == '\0' as i32 {
            break;
        }
        len = len.wrapping_add(1);
        len;
    }
    newname = bfd_alloc(abfd, len.wrapping_add(1 as libc::c_int as libc::c_ulong))
        as *mut libc::c_char;
    if newname.is_null() {
        return 0 as *mut libc::c_char;
    }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_get_external_symbols(mut abfd: *mut bfd) -> bool {
    let mut symesz: size_t = 0;
    let mut size: size_t = 0;
    let mut syms: *mut libc::c_void = 0 as *mut libc::c_void;
    if !((*(*abfd).tdata.coff_obj_data).external_syms).is_null() {
        return 1 as libc::c_int != 0;
    }
    symesz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_symesz
        as size_t;
    size = (*(*abfd).tdata.coff_obj_data).raw_syment_count;
    size = (size as libc::c_ulong).wrapping_mul(symesz) as size_t as size_t;
    if symesz != 0 as libc::c_int as libc::c_ulong
        && size.wrapping_div(symesz) != (*(*abfd).tdata.coff_obj_data).raw_syment_count
    {
        bfd_set_error(bfd_error_file_truncated);
        return 0 as libc::c_int != 0;
    }
    ...
    syms = _bfd_malloc_and_read(abfd, size, size) as *mut libc::c_void;
    (*(*abfd).tdata.coff_obj_data).external_syms = syms;
    return !syms.is_null();
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_read_string_table(
    mut abfd: *mut bfd,
) -> *const libc::c_char {
    let mut extstrsize: [libc::c_char; 4] = [0; 4];
    let mut strsize: bfd_size_type = 0;
    let mut strings: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut pos: file_ptr = 0;
    let mut filesize: ufile_ptr = 0;
    if !((*(*abfd).tdata.coff_obj_data).strings).is_null() {
        return (*(*abfd).tdata.coff_obj_data).strings;
    }
    if (*(*abfd).tdata.coff_obj_data).sym_filepos == 0 as libc::c_int as libc::c_long {
    ...
    if bfd_bread(
        extstrsize.as_mut_ptr() as *mut libc::c_void,
        ::core::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong,
        abfd,
    ) != ::core::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong
    {
        if bfd_get_error() as libc::c_uint
            != bfd_error_file_truncated as libc::c_int as libc::c_uint
        {
            return 0 as *const libc::c_char;
        }
        strsize = 4 as libc::c_int as bfd_size_type;
    } else {
        strsize = (Some(
            ...
            .expect(
                "non-null function pointer",
            )(extstrsize.as_mut_ptr() as *const libc::c_void);
    }
    filesize = bfd_get_file_size(abfd);
    if strsize < 4 as libc::c_int as libc::c_ulong
        || filesize != 0 as libc::c_int as libc::c_ulong && strsize > filesize
    {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: bad string table size %lu\0" as *const u8 as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
            strsize,
    ...
    strings = bfd_malloc(strsize.wrapping_add(1 as libc::c_int as libc::c_ulong))
        as *mut libc::c_char;
    if strings.is_null() {
        return 0 as *const libc::c_char;
    }
    ...
    if bfd_bread(
        strings.offset(4 as libc::c_int as isize) as *mut libc::c_void,
        strsize.wrapping_sub(4 as libc::c_int as libc::c_ulong),
        abfd,
    ) != strsize.wrapping_sub(4 as libc::c_int as libc::c_ulong)
    {
    ...
    *strings.offset(strsize as isize) = 0 as libc::c_int as libc::c_char;
    return strings;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_free_symbols(mut abfd: *mut bfd) -> bool {
        ...
        && !(*(*abfd).tdata.coff_obj_data).keep_syms
    {
        ...
        (*(*abfd).tdata.coff_obj_data).external_syms = 0 as *mut libc::c_void;
    }
    if !((*(*abfd).tdata.coff_obj_data).strings).is_null()
        && !(*(*abfd).tdata.coff_obj_data).keep_strings
    {
        free((*(*abfd).tdata.coff_obj_data).strings as *mut libc::c_void);
        (*(*abfd).tdata.coff_obj_data).strings = 0 as *mut libc::c_char;
        (*(*abfd).tdata.coff_obj_data).strings_len = 0 as libc::c_int as bfd_size_type;
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn coff_get_normalized_symtab(
    mut abfd: *mut bfd,
) -> *mut coff_ptr_struct {
    let mut internal: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut internal_ptr: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut symbol_ptr: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut internal_end: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut symesz: size_t = 0;
    let mut raw_src: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut raw_end: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut string_table: *const libc::c_char = 0 as *const libc::c_char;
    let mut debug_sec: *mut asection = 0 as *mut asection;
    let mut debug_sec_data: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut size: bfd_size_type = 0;
    if !((*(*abfd).tdata.coff_obj_data).raw_syments).is_null() {
        return (*(*abfd).tdata.coff_obj_data).raw_syments;
    }
    if !_bfd_coff_get_external_symbols(abfd) {
        return 0 as *mut coff_ptr_struct;
    }
    size = (*(*abfd).tdata.coff_obj_data).raw_syment_count;
    if size
        > (-(1 as libc::c_int) as bfd_size_type)
            .wrapping_div(::core::mem::size_of::<combined_entry_type>() as libc::c_ulong)
    {
        return 0 as *mut coff_ptr_struct;
    }
    size = (size as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<combined_entry_type>() as libc::c_ulong)
        as bfd_size_type as bfd_size_type;
    internal = bfd_zalloc(abfd, size) as *mut combined_entry_type;
    if internal.is_null() && size != 0 as libc::c_int as libc::c_ulong {
        return 0 as *mut coff_ptr_struct;
    }
    internal_end = internal
        .offset((*(*abfd).tdata.coff_obj_data).raw_syment_count as isize);
    raw_src = (*(*abfd).tdata.coff_obj_data).external_syms as *mut libc::c_char;
    symesz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_symesz
        as size_t;
    raw_end = raw_src
        .offset(
            ((*(*abfd).tdata.coff_obj_data).raw_syment_count).wrapping_mul(symesz)
                as isize,
        );
    ...
    while raw_src < raw_end {
        ...
        ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ...
            abfd,
            raw_src as *mut libc::c_void,
            &mut (*internal_ptr).u.syment as *mut internal_syment as *mut libc::c_void,
        );
        symbol_ptr = internal_ptr;
        (*internal_ptr).is_sym = 1 as libc::c_int != 0;
        if (*symbol_ptr).u.syment.n_numaux as libc::c_ulong
            > (raw_end.offset(-(1 as libc::c_int as isize)).offset_from(raw_src)
                as libc::c_long as libc::c_ulong)
                .wrapping_div(symesz)
        {
            bfd_release(abfd, internal as *mut libc::c_void);
            return 0 as *mut coff_ptr_struct;
        }
        i = 0 as libc::c_int as libc::c_uint;
        while i < (*symbol_ptr).u.syment.n_numaux as libc::c_uint {
            internal_ptr = internal_ptr.offset(1);
            internal_ptr;
            raw_src = raw_src.offset(symesz as isize);
            ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ...
                abfd,
                raw_src as *mut libc::c_void,
                (*symbol_ptr).u.syment.n_type as libc::c_int,
                (*symbol_ptr).u.syment.n_sclass as libc::c_int,
                i as libc::c_int,
                (*symbol_ptr).u.syment.n_numaux as libc::c_int,
                &mut (*internal_ptr).u.auxent as *mut internal_auxent
                    as *mut libc::c_void,
            );
            (*internal_ptr).is_sym = 0 as libc::c_int != 0;
            coff_pointerize_aux(
                abfd,
                internal,
                symbol_ptr,
    ...
    internal_ptr = internal;
    while internal_ptr < internal_end {
        if !(*internal_ptr).is_sym {
            bfd_assert(
                b"coffgen.c\0" as *const u8 as *const libc::c_char,
                1855 as libc::c_int,
            );
        }
        if (*internal_ptr).u.syment.n_sclass as libc::c_int == 103 as libc::c_int
            && (*internal_ptr).u.syment.n_numaux as libc::c_int > 0 as libc::c_int
        {
            let mut aux: *mut combined_entry_type = internal_ptr
                .offset(1 as libc::c_int as isize);
            if (*aux).is_sym {
                bfd_assert(
                    b"coffgen.c\0" as *const u8 as *const libc::c_char,
            ...
            if (*aux).u.auxent.x_file.x_n.x_zeroes == 0 as libc::c_int as libc::c_long {
                ...
                if (*aux).u.auxent.x_file.x_n.x_offset as bfd_size_type
                    >= (*(*abfd).tdata.coff_obj_data).strings_len
                {
                    (*internal_ptr)
                        .u
                    ...
                    (*internal_ptr)
                        ...
                        ._n
                        ._n_n
                        ._n_offset = string_table
                        .offset((*aux).u.auxent.x_file.x_n.x_offset as isize)
                        as bfd_hostptr_t;
                }
            } else if (*internal_ptr).u.syment.n_numaux as libc::c_int > 1 as libc::c_int
                && (*(*abfd).tdata.coff_obj_data).pe != 0
            {
                (*internal_ptr)
                    ...
                    ._n_offset = copy_name(
                    abfd,
                    ((*aux).u.auxent.x_file.x_fname).as_mut_ptr(),
                    ((*internal_ptr).u.syment.n_numaux as libc::c_ulong)
                        .wrapping_mul(symesz),
                ) as bfd_hostptr_t;
            } else {
                (*internal_ptr)
        ...
        } else if (*internal_ptr).u.syment._n._n_n._n_zeroes
            != 0 as libc::c_int as libc::c_ulong
        {
            let mut i_0: size_t = 0;
            let mut newstring: *mut libc::c_char = 0 as *mut libc::c_char;
            i_0 = 0 as libc::c_int as size_t;
            while i_0 < 8 as libc::c_int as libc::c_ulong {
                if (*internal_ptr).u.syment._n._n_name[i_0 as usize] as libc::c_int
                    == '\0' as i32
                {
                    break;
                }
            ...
            newstring = bfd_zalloc(
                abfd,
                i_0.wrapping_add(1 as libc::c_int as libc::c_ulong),
            ) as *mut libc::c_char;
            if newstring.is_null() {
                return 0 as *mut coff_ptr_struct;
            }
            strncpy(newstring, ((*internal_ptr).u.syment._n._n_name).as_mut_ptr(), i_0);
            (*internal_ptr).u.syment._n._n_n._n_offset = newstring as bfd_hostptr_t;
            (*internal_ptr)
                .u
                .syment
                ._n
                ._n_n
                ._n_zeroes = 0 as libc::c_int as bfd_hostptr_t;
        } else if (*internal_ptr).u.syment._n._n_n._n_offset
            == 0 as libc::c_int as libc::c_ulong
        {
            (*internal_ptr)
                .u
                ...
                ._n
                ._n_n
                ._n_offset = b"\0" as *const u8 as *const libc::c_char as bfd_hostptr_t;
        } else if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_symname_in_debug)
            .expect("non-null function pointer")(abfd, &mut (*internal_ptr).u.syment)
        {
            if string_table.is_null() {
                string_table = _bfd_coff_read_string_table(abfd);
                if string_table.is_null() {
            ...
            if (*internal_ptr).u.syment._n._n_n._n_offset
                >= (*(*abfd).tdata.coff_obj_data).strings_len
                || string_table
                    .offset((*internal_ptr).u.syment._n._n_n._n_offset as isize)
                    < string_table
            {
                (*internal_ptr)
                    .u
            ...
            if debug_sec_data.is_null() {
                debug_sec_data = build_debug_section(abfd, &mut debug_sec);
            }
            if !debug_sec_data.is_null() {
                if debug_sec.is_null() {
                    bfd_assert(
                        b"coffgen.c\0" as *const u8 as *const libc::c_char,
                        1952 as libc::c_int,
                    );
                ...
                (*internal_ptr)
                    ...
                    ._n
                    ._n_n
                    ._n_offset = b"\0" as *const u8 as *const libc::c_char
                    as bfd_hostptr_t;
            }
        }
        internal_ptr = internal_ptr
            .offset((*internal_ptr).u.syment.n_numaux as libc::c_int as isize);
        internal_ptr = internal_ptr.offset(1);
        internal_ptr;
    }
    (*(*abfd).tdata.coff_obj_data).raw_syments = internal;
    if !((*(*abfd).tdata.coff_obj_data).raw_syment_count
        == internal_ptr.offset_from(internal) as libc::c_long as libc::c_uint
            as libc::c_ulong)
    {
        bfd_assert(
            b"coffgen.c\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn coff_get_reloc_upper_bound(
    mut abfd: *mut bfd,
    mut asect: sec_ptr,
) -> libc::c_long {
    if bfd_get_format(abfd) as libc::c_uint != bfd_object as libc::c_int as libc::c_uint
    {
...
#[no_mangle]
pub unsafe extern "C" fn coff_make_empty_symbol(mut abfd: *mut bfd) -> *mut asymbol {
    let mut amt: size_t = ::core::mem::size_of::<coff_symbol_type>() as libc::c_ulong;
    let mut new_symbol: *mut coff_symbol_type = bfd_zalloc(abfd, amt)
        as *mut coff_symbol_type;
    if new_symbol.is_null() {
        return 0 as *mut asymbol;
    }
    (*new_symbol).symbol.section = 0 as *mut bfd_section;
    (*new_symbol).native = 0 as *mut combined_entry_type;
    (*new_symbol).lineno = 0 as *mut lineno_cache_entry;
    (*new_symbol).done_lineno = 0 as libc::c_int != 0;
...
pub unsafe extern "C" fn coff_bfd_make_debug_symbol(
    ...
    (*new_symbol).native = bfd_zalloc(abfd, amt) as *mut combined_entry_type;
    if ((*new_symbol).native).is_null() {
        return 0 as *mut asymbol;
    }
    (*(*new_symbol).native).is_sym = 1 as libc::c_int != 0;
    (*new_symbol)
        .symbol
        .section = &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
        as *mut asection;
    (*new_symbol).symbol.flags = ((1 as libc::c_int) << 2 as libc::c_int) as flagword;
    (*new_symbol).lineno = 0 as *mut lineno_cache_entry;
    (*new_symbol).done_lineno = 0 as libc::c_int != 0;
    (*new_symbol).symbol.the_bfd = abfd;
    return &mut (*new_symbol).symbol;
...
#[no_mangle]
pub unsafe extern "C" fn coff_get_symbol_info(
    mut abfd: *mut bfd,
    mut symbol: *mut asymbol,
    mut ret: *mut symbol_info,
) {
    bfd_symbol_info(symbol, ret);
    if !((*(&mut (*symbol).the_bfd as *mut *mut bfd as *mut coff_symbol_type)).native)
        .is_null()
        && (*(*(&mut (*symbol).the_bfd as *mut *mut bfd as *mut coff_symbol_type))
            .native)
            .fix_value() as libc::c_int != 0
        && (*(*(&mut (*symbol).the_bfd as *mut *mut bfd as *mut coff_symbol_type))
            .native)
            .is_sym as libc::c_int != 0
    {
        (*ret)
            .value = ((*(*(&mut (*symbol).the_bfd as *mut *mut bfd
            as *mut coff_symbol_type))
            .native)
            .u
            .syment
            .n_value)
            .wrapping_sub((*(*abfd).tdata.coff_obj_data).raw_syments as bfd_hostptr_t);
    }
}
#[no_mangle]
pub unsafe extern "C" fn coff_print_symbol(
    mut abfd: *mut bfd,
    ...
    match how as libc::c_uint {
        ...
        1 => {
            fprintf(
                file,
                b"coff %s %s\0" as *const u8 as *const libc::c_char,
                if !((*(&mut (*symbol).the_bfd as *mut *mut bfd
                    as *mut coff_symbol_type))
                    .native)
                    .is_null()
                {
        ...
        2 => {
            if !((*(&mut (*symbol).the_bfd as *mut *mut bfd as *mut coff_symbol_type))
                .native)
                .is_null()
            {
                let mut val: bfd_vma = 0;
                let mut aux: libc::c_uint = 0;
                let mut combined: *mut combined_entry_type = (*(&mut (*symbol).the_bfd
                    as *mut *mut bfd as *mut coff_symbol_type))
                    .native;
                let mut root: *mut combined_entry_type = (*(*abfd).tdata.coff_obj_data)
                    .raw_syments;
                let mut l: *mut lineno_cache_entry = (*(&mut (*symbol).the_bfd
                    as *mut *mut bfd as *mut coff_symbol_type))
                    .lineno;
                fprintf(
                    file,
                    b"[%3ld]\0" as *const u8 as *const libc::c_char,
                    combined.offset_from(root) as libc::c_long,
                );
                if combined < (*(*abfd).tdata.coff_obj_data).raw_syments
                    || combined
                        >= ((*(*abfd).tdata.coff_obj_data).raw_syments)
                            .offset(
                                (*(*abfd).tdata.coff_obj_data).raw_syment_count as isize,
                            )
                {
                    fprintf(
                        file,
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"<corrupt info> %s\0" as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*symbol).name,
                    );
                    ...
                    if (*combined).fix_value() == 0 {
                        val = (*combined).u.syment.n_value;
                    } else {
                        val = ((*combined).u.syment.n_value)
                            .wrapping_sub(root as bfd_hostptr_t);
                    }
                    fprintf(
                        file,
                        b"(sec %2d)(fl 0x%02x)(ty %3x)(scl %3d) (nx %d) 0x\0"
                            as *const u8 as *const libc::c_char,
                        (*combined).u.syment.n_scnum,
                        (*combined).u.syment.n_flags as libc::c_int,
                        (*combined).u.syment.n_type as libc::c_int,
                        (*combined).u.syment.n_sclass as libc::c_int,
                        (*combined).u.syment.n_numaux as libc::c_int,
                    );
                    ...
                    aux = 0 as libc::c_int as libc::c_uint;
                    while aux < (*combined).u.syment.n_numaux as libc::c_uint {
                        let mut auxp: *mut combined_entry_type = combined
                            .offset(aux as isize)
                            .offset(1 as libc::c_int as isize);
                        let mut tagndx: libc::c_long = 0;
                        if (*auxp).is_sym {
                            bfd_assert(
                                b"coffgen.c\0" as *const u8 as *const libc::c_char,
                                2111 as libc::c_int,
                        ...
                        if (*auxp).fix_tag() != 0 {
                            tagndx = ((*auxp).u.auxent.x_sym.x_tagndx.p)
                                .offset_from(root) as libc::c_long;
                        } else {
                        ...
                        if !((*((*(*abfd).xvec).backend_data
                            ...
                            .expect(
                                "non-null function pointer",
                            )(abfd, file, root, combined, auxp, aux)
                        {
                            let mut current_block_35: u64;
                            match (*combined).u.syment.n_sclass as libc::c_int {
                                103 => {
                                    fprintf(
                                        file,
                                        b"File \0" as *const u8 as *const libc::c_char,
                                    );
                                    current_block_35 = 721385680381463314;
                                }
                                112 => {
                                    fprintf(
                                        file,
                                        b"AUX scnlen 0x%lx nreloc %ld\0" as *const u8
                                            as *const libc::c_char,
                                        (*auxp).u.auxent.x_sect.x_scnlen as libc::c_ulong,
                                        (*auxp).u.auxent.x_sect.x_nreloc,
                                    );
                                    current_block_35 = 721385680381463314;
                                }
                                3 => {
                                    if (*combined).u.syment.n_type as libc::c_int
                                        == 0 as libc::c_int
                                    {
                                        fprintf(
                                            file,
                                            b"AUX scnlen 0x%lx nreloc %d nlnno %d\0" as *const u8
                                                as *const libc::c_char,
                                            (*auxp).u.auxent.x_scn.x_scnlen as libc::c_ulong,
                                            (*auxp).u.auxent.x_scn.x_nreloc as libc::c_int,
                                            (*auxp).u.auxent.x_scn.x_nlinno as libc::c_int,
                                        );
                                        if (*auxp).u.auxent.x_scn.x_checksum
                                            != 0 as libc::c_int as libc::c_ulong
                                            || (*auxp).u.auxent.x_scn.x_associated as libc::c_int
                                                != 0 as libc::c_int
                                            || (*auxp).u.auxent.x_scn.x_comdat as libc::c_int
                                                != 0 as libc::c_int
                                        {
                                            fprintf(
                                                file,
                                                b" checksum 0x%lx assoc %d comdat %d\0" as *const u8
                                                    as *const libc::c_char,
                                        ...
                                        current_block_35 = 4808995686804306123;
                                    }
                                }
                                2 | 111 => {
                                    current_block_35 = 4808995686804306123;
                                ...
                                _ => {
                                    current_block_35 = 4062157109411185099;
                                }
                            }
                            match current_block_35 {
                                4808995686804306123 => {
                                    if (*combined).u.syment.n_type as libc::c_ulong
                                        & (*(*abfd).tdata.coff_obj_data).local_n_tmask
                                            as libc::c_ulong
                                        == (2 as libc::c_int as libc::c_ulong)
                                            << (*(*abfd).tdata.coff_obj_data).local_n_btshft
                                    {
                                        let mut next: libc::c_long = 0;
                                        let mut llnos: libc::c_long = 0;
                                        if (*auxp).fix_end() != 0 {
                                        ...
                                        fprintf(
                                            file,
                                            b"AUX tagndx %ld ttlsiz 0x%lx lnnos %ld next %ld\0"
                                                as *const u8 as *const libc::c_char,
                                            tagndx,
                                            (*auxp).u.auxent.x_sym.x_misc.x_fsize as libc::c_ulong,
                                            llnos,
                                            next,
                                        );
                                        current_block_35 = 721385680381463314;
                            ...
                            match current_block_35 {
                                4062157109411185099 => {
                                    fprintf(
                                        file,
                                        b"AUX lnno %d size 0x%x tagndx %ld\0" as *const u8
                                            as *const libc::c_char,
                                        (*auxp).u.auxent.x_sym.x_misc.x_lnsz.x_lnno as libc::c_int,
                                        (*auxp).u.auxent.x_sym.x_misc.x_lnsz.x_size as libc::c_int,
                                        tagndx,
                                    );
                                    if (*auxp).fix_end() != 0 {
                                        fprintf(
                                            file,
                                            b" endndx %ld\0" as *const u8 as *const libc::c_char,
                    ...
                    if !l.is_null() {
                        ...
                        while (*l).line_number != 0 {
                            if (*l).line_number > 0 as libc::c_int as libc::c_uint {
                                fprintf(
                                    file,
                                    b"\n%4d : \0" as *const u8 as *const libc::c_char,
                                    (*l).line_number,
                                );
                                bfd_fprintf_vma(
                                    abfd,
                                    file as *mut libc::c_void,
                                    ((*l).u.offset).wrapping_add((*(*symbol).section).vma),
                                );
                            }
                            l = l.offset(1);
                            l;
                ...
                fprintf(
                    file,
                    b" %-5s %s %s %s\0" as *const u8 as *const libc::c_char,
                    (*(*symbol).section).name,
                    if !((*(&mut (*symbol).the_bfd as *mut *mut bfd
                        as *mut coff_symbol_type))
                        .native)
...
#[no_mangle]
pub unsafe extern "C" fn coff_find_nearest_line_with_names(
    mut abfd: *mut bfd,
    ...
    let mut i: libc::c_uint = 0;
    let mut line_base: libc::c_uint = 0;
    let mut cof: *mut coff_data_type = (*abfd).tdata.coff_obj_data;
    let mut p: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut pend: *mut combined_entry_type = 0 as *mut combined_entry_type;
    let mut l: *mut alent = 0 as *mut alent;
    let mut sec_data: *mut coff_section_tdata = 0 as *mut coff_section_tdata;
    ...
    if !_bfd_stab_section_find_nearest_line(
        ...
        functionname_ptr,
        line_ptr,
        &mut (*(*abfd).tdata.coff_obj_data).line_info,
    ) {
        return 0 as libc::c_int != 0;
    }
    if found {
    ...
    if _bfd_dwarf2_find_nearest_line(
        ...
        debug_sections,
        &mut (*(*abfd).tdata.coff_obj_data).dwarf2_find_line_info,
    ) != 0
    {
        return 1 as libc::c_int != 0;
    }
    sec_data = (*section).used_by_bfd as *mut coff_section_tdata;
    if !((*(*abfd).tdata.coff_obj_data).dwarf2_find_line_info).is_null() {
        let mut bias: bfd_signed_vma = 0 as libc::c_int as bfd_signed_vma;
        if sec_data.is_null() && (*section).owner == abfd {
            amt = ::core::mem::size_of::<coff_section_tdata>() as libc::c_ulong;
            (*section).used_by_bfd = bfd_zalloc(abfd, amt);
            sec_data = (*section).used_by_bfd as *mut coff_section_tdata;
        }
        if !sec_data.is_null() && (*sec_data).saved_bias as libc::c_int != 0 {
            bias = (*sec_data).saved_bias as bfd_signed_vma;
            ...
            if !sec_data.is_null() {
                (*sec_data).saved_bias = 1 as libc::c_int != 0;
                (*sec_data).bias = bias;
            }
        }
        if bias != 0
            && _bfd_dwarf2_find_nearest_line(
                ...
                0 as *mut asymbol,
                section,
                offset.wrapping_add(bias as libc::c_ulong),
                filename_ptr,
                functionname_ptr,
                line_ptr,
                0 as *mut libc::c_uint,
    ...
    *line_ptr = 0 as libc::c_int as libc::c_uint;
    ...
    pend = p.offset((*cof).raw_syment_count as isize);
    while p < pend {
        if !(*p).is_sym {
            bfd_assert(
                b"coffgen.c\0" as *const u8 as *const libc::c_char,
        ...
        if (*p).u.syment.n_sclass as libc::c_int == 103 as libc::c_int {
            break;
        }
        p = p
            .offset((1 as libc::c_int + (*p).u.syment.n_numaux as libc::c_int) as isize);
    }
    if p < pend {
        let mut sec_vma: bfd_vma = 0;
        let mut maxdiff: bfd_vma = 0;
        sec_vma = bfd_section_vma(section);
        *filename_ptr = (*p).u.syment._n._n_n._n_offset as *mut libc::c_char;
        maxdiff = (0 as libc::c_int as bfd_vma)
            .wrapping_sub(1 as libc::c_int as bfd_vma);
        loop {
            let mut file_addr: bfd_vma = 0;
            let mut p2: *mut combined_entry_type = 0 as *mut combined_entry_type;
            p2 = p
                .offset(1 as libc::c_int as isize)
                .offset((*p).u.syment.n_numaux as libc::c_int as isize);
            while p2 < pend {
                if !(*p2).is_sym {
                    bfd_assert(
                        b"coffgen.c\0" as *const u8 as *const libc::c_char,
                ...
                if (*p2).u.syment.n_scnum > 0 as libc::c_int
                    && section
                        == coff_section_from_bfd_index(abfd, (*p2).u.syment.n_scnum)
                {
                    break;
                }
                if (*p2).u.syment.n_sclass as libc::c_int == 103 as libc::c_int {
                    p2 = pend;
                    break;
                } else {
                    p2 = p2
                        .offset(
                            (1 as libc::c_int + (*p2).u.syment.n_numaux as libc::c_int)
                                as isize,
                        );
                }
            }
            ...
            file_addr = (*p2).u.syment.n_value;
            if (*p2).u.syment.n_scnum > 0 as libc::c_int {
                file_addr = (file_addr as libc::c_ulong)
                    .wrapping_add(
                        (*coff_section_from_bfd_index(abfd, (*p2).u.syment.n_scnum)).vma,
                    ) as bfd_vma as bfd_vma;
            }
            if p2 < pend && offset.wrapping_add(sec_vma) >= file_addr
                && offset.wrapping_add(sec_vma).wrapping_sub(file_addr) <= maxdiff
            {
                *filename_ptr = (*p).u.syment._n._n_n._n_offset as *mut libc::c_char;
                maxdiff = offset
                    .wrapping_add(sec_vma)
                    .wrapping_sub((*p2).u.syment.n_value);
            }
            if (*p).u.syment.n_value >= (*cof).raw_syment_count {
                break;
            }
            if p >= ((*cof).raw_syments).offset((*p).u.syment.n_value as isize) {
                break;
            }
            p = ((*cof).raw_syments).offset((*p).u.syment.n_value as isize);
            if !(*p).is_sym
                || (*p).u.syment.n_sclass as libc::c_int != 103 as libc::c_int
            {
                break;
            }
        }
    }
    if (*section).lineno_count == 0 as libc::c_int as libc::c_uint {
        *functionname_ptr = 0 as *const libc::c_char;
        *line_ptr = 0 as libc::c_int as libc::c_uint;
        return 1 as libc::c_int != 0;
    }
    if !sec_data.is_null() && (*sec_data).i > 0 as libc::c_int as libc::c_uint
        && offset >= (*sec_data).offset
    {
        i = (*sec_data).i;
        *functionname_ptr = (*sec_data).function;
        line_base = (*sec_data).line_base as libc::c_uint;
    } else {
        i = 0 as libc::c_int as libc::c_uint;
        line_base = 0 as libc::c_int as libc::c_uint;
    }
    if !((*section).lineno).is_null() {
        let mut last_value: bfd_vma = 0 as libc::c_int as bfd_vma;
        l = &mut *((*section).lineno).offset(i as isize) as *mut alent;
        while i < (*section).lineno_count {
            if (*l).line_number == 0 as libc::c_int as libc::c_uint {
                let mut coff: *mut coff_symbol_type = (*l).u.sym
                    as *mut coff_symbol_type;
                ...
                *functionname_ptr = (*coff).symbol.name;
                ...
                if !((*coff).native).is_null() {
                    let mut s: *mut combined_entry_type = (*coff).native;
                    if !(*s).is_sym {
                        bfd_assert(
                            b"coffgen.c\0" as *const u8 as *const libc::c_char,
                            2441 as libc::c_int,
                    ...
                    s = s
                        .offset(1 as libc::c_int as isize)
                        .offset((*s).u.syment.n_numaux as libc::c_int as isize);
                    if ((s as *mut libc::c_char)
                        .offset_from(
                            (*(*abfd).tdata.coff_obj_data).raw_syments
                                as *mut libc::c_char,
                        ...
                        < ((*(*abfd).tdata.coff_obj_data).raw_syment_count)
                            .wrapping_mul(
                                ::core::mem::size_of::<combined_entry_type>()
                                    as libc::c_ulong,
                            ) && (*s).u.syment.n_scnum == -(2 as libc::c_int)
                    {
                        s = s
                            .offset(1 as libc::c_int as isize)
                            .offset((*s).u.syment.n_numaux as libc::c_int as isize);
                    ...
                    if ((s as *mut libc::c_char)
                        ...
                        < ((*(*abfd).tdata.coff_obj_data).raw_syment_count)
                            .wrapping_mul(
                                ::core::mem::size_of::<combined_entry_type>()
                                    as libc::c_ulong,
                            ) && (*s).u.syment.n_numaux as libc::c_int != 0
                    {
                        let mut a: *mut internal_auxent = &mut (*s
                            .offset(1 as libc::c_int as isize))
                            .u
                            .auxent;
                        line_base = (*a).x_sym.x_misc.x_lnsz.x_lnno as libc::c_uint;
                        *line_ptr = line_base;
                    }
                }
            } else {
        ...
        if i >= (*section).lineno_count
            && last_value != 0 as libc::c_int as libc::c_ulong
            && offset.wrapping_sub(last_value) > 0x100 as libc::c_int as libc::c_ulong
        {
            *functionname_ptr = 0 as *const libc::c_char;
            *line_ptr = 0 as libc::c_int as libc::c_uint;
        }
    ...
    if !sec_data.is_null() {
        ...
        (*sec_data).i = i.wrapping_sub(1 as libc::c_int as libc::c_uint);
        (*sec_data).function = *functionname_ptr;
        (*sec_data).line_base = line_base as libc::c_int;
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn coff_find_nearest_line(
    mut abfd: *mut bfd,
    mut symbols: *mut *mut asymbol,
    mut section: *mut asection,
    mut offset: bfd_vma,
    ...
    return coff_find_nearest_line_with_names(
        abfd,
        symbols,
        section,
        offset,
...
#[no_mangle]
pub unsafe extern "C" fn coff_find_inliner_info(
    mut abfd: *mut bfd,
    mut filename_ptr: *mut *const libc::c_char,
    mut functionname_ptr: *mut *const libc::c_char,
    mut line_ptr: *mut libc::c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn coff_sizeof_headers(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> libc::c_int {
    let mut size: size_t = 0;
    if !((*info).type_0() as libc::c_int == type_relocatable as libc::c_int) {
        size = ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_filhsz)
            .wrapping_add(
                (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                    ._bfd_aoutsz,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_coff_set_symbol_class(
    mut abfd: *mut bfd,
    mut symbol: *mut asymbol,
    mut symbol_class: libc::c_uint,
) -> bool {
    let mut csym: *mut coff_symbol_type = 0 as *mut coff_symbol_type;
    csym = if bfd_family_coff(bfd_asymbol_bfd(symbol)) as libc::c_int != 0
        && !((*bfd_asymbol_bfd(symbol)).tdata.coff_obj_data).is_null()
    {
        symbol as *mut coff_symbol_type
    } else {
    ...
    if csym.is_null() {
        bfd_set_error(bfd_error_invalid_operation);
        return 0 as libc::c_int != 0;
    } else if ((*csym).native).is_null() {
        let mut native: *mut combined_entry_type = 0 as *mut combined_entry_type;
        let mut amt: size_t = ::core::mem::size_of::<combined_entry_type>()
            as libc::c_ulong;
        ...
        (*native).is_sym = 1 as libc::c_int != 0;
        (*native).u.syment.n_type = 0 as libc::c_int as libc::c_ushort;
        (*native).u.syment.n_sclass = symbol_class as libc::c_uchar;
        if bfd_is_und_section((*symbol).section) {
            (*native).u.syment.n_scnum = 0 as libc::c_int;
            (*native).u.syment.n_value = (*symbol).value;
        } else if bfd_is_com_section((*symbol).section) {
            ...
            (*native)
                .u
                .syment
                .n_scnum = (*(*(*symbol).section).output_section).target_index;
            (*native)
                .u
                .syment
                .n_value = ((*symbol).value)
            ...
            if (*(*abfd).tdata.coff_obj_data).pe == 0 {
                (*native)
                    ...
                    .syment
                    .n_value = ((*native).u.syment.n_value as libc::c_ulong)
                    .wrapping_add((*(*(*symbol).section).output_section).vma) as bfd_vma
                    as bfd_vma;
            }
            (*native)
                .u
                .syment
                .n_flags = (*bfd_asymbol_bfd(&mut (*csym).symbol)).flags
                as libc::c_ushort;
        }
        (*csym).native = native;
    } else {
        (*(*csym).native).u.syment.n_sclass = symbol_class as libc::c_uchar;
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_section_already_linked(
    mut abfd: *mut bfd,
    mut sec: *mut asection,
    mut info: *mut bfd_link_info,
) -> bool {
    ...
    let mut s_comdat: *mut coff_comdat_info = 0 as *mut coff_comdat_info;
    ...
    s_comdat = if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_coff_flavour as libc::c_int as libc::c_uint
        && !((*sec).used_by_bfd as *mut coff_section_tdata).is_null()
    {
    ...
    while !l.is_null() {
        let mut l_comdat: *mut coff_comdat_info = 0 as *mut coff_comdat_info;
        l_comdat = if bfd_get_flavour((*(*l).sec).owner) as libc::c_uint
            == bfd_target_coff_flavour as libc::c_int as libc::c_uint
            && !((*(*l).sec).used_by_bfd as *mut coff_section_tdata).is_null()
        {
            (*((*(*l).sec).used_by_bfd as *mut coff_section_tdata)).comdat
        } else {
            0 as *mut coff_comdat_info
        };
        if (s_comdat != 0 as *mut libc::c_void as *mut coff_comdat_info) as libc::c_int
            == (l_comdat != 0 as *mut libc::c_void as *mut coff_comdat_info)
                as libc::c_int && strcmp(name, (*(*l).sec).name) == 0 as libc::c_int
...
unsafe extern "C" fn init_reloc_cookie_rels(
    ...
    if (*sec).reloc_count == 0 as libc::c_int as libc::c_uint {
        (*cookie).rels = 0 as *mut internal_reloc;
        (*cookie).relend = 0 as *mut internal_reloc;
        (*cookie).rel = 0 as *mut internal_reloc;
        return 1 as libc::c_int != 0;
    }
    (*cookie)
        .rels = _bfd_coff_read_internal_relocs(
        abfd,
        sec,
        0 as libc::c_int != 0,
        0 as *mut bfd_byte,
        0 as libc::c_int != 0,
        0 as *mut internal_reloc,
    );
...
unsafe extern "C" fn fini_reloc_cookie_rels(
    ...
    if !((*cookie).rels).is_null()
        && !((*sec).used_by_bfd as *mut coff_section_tdata).is_null()
        && (*((*sec).used_by_bfd as *mut coff_section_tdata)).relocs != (*cookie).rels
    {
...
unsafe extern "C" fn _bfd_coff_gc_mark_rsec(
    mut info: *mut bfd_link_info,
    mut sec: *mut asection,
    mut gc_mark_hook: coff_gc_mark_hook_fn,
    mut cookie: *mut coff_reloc_cookie,
) -> *mut asection {
    let mut h: *mut coff_link_hash_entry = 0 as *mut coff_link_hash_entry;
    h = *((*cookie).sym_hashes).offset((*(*cookie).rel).r_symndx as isize);
    if !h.is_null() {
        ...
        return (Some(gc_mark_hook.expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(sec, info, (*cookie).rel, h, 0 as *mut internal_syment);
    }
    return (Some(gc_mark_hook.expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        ...
        info,
        (*cookie).rel,
        0 as *mut coff_link_hash_entry,
        &mut (*(*((*cookie).symbols)
            .offset(
                *((*(*(*sec).owner).tdata.coff_obj_data).conversion_table)
                    .offset((*(*cookie).rel).r_symndx as isize) as isize,
            ))
            .native)
            .u
            .syment,
...
unsafe extern "C" fn _bfd_coff_gc_mark_reloc(
    mut info: *mut bfd_link_info,
    mut sec: *mut asection,
    mut gc_mark_hook: coff_gc_mark_hook_fn,
    mut cookie: *mut coff_reloc_cookie,
    ...
    if !rsec.is_null() && (*rsec).gc_mark() == 0 {
...
unsafe extern "C" fn _bfd_coff_gc_mark(
    mut info: *mut bfd_link_info,
    mut sec: *mut asection,
    mut gc_mark_hook: coff_gc_mark_hook_fn,
) -> bool {
    ...
    if (*sec).flags & 0x4 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
        && (*sec).reloc_count > 0 as libc::c_int as libc::c_uint
    {
        let mut cookie: coff_reloc_cookie = coff_reloc_cookie {
            rels: 0 as *mut internal_reloc,
            rel: 0 as *mut internal_reloc,
            relend: 0 as *mut internal_reloc,
            symbols: 0 as *mut coff_symbol_struct,
            abfd: 0 as *mut bfd,
            sym_hashes: 0 as *mut *mut coff_link_hash_entry,
        };
        if !init_reloc_cookie_for_section(&mut cookie, info, sec) {
            ret = 0 as libc::c_int != 0;
        } else {
            while cookie.rel < cookie.relend {
                if !_bfd_coff_gc_mark_reloc(info, sec, gc_mark_hook, &mut cookie) {
                    ret = 0 as libc::c_int != 0;
                    break;
                } else {
...
unsafe extern "C" fn coff_gc_sweep_symbol(
    ...
    if (((*h).root).type_0() as libc::c_int == bfd_link_hash_defined as libc::c_int
        ...
        && (*(*h).root.u.def.section).gc_mark() == 0
            ...
            & 0x40 as libc::c_int as libc::c_uint == 0
    {
        ...
        (*h).symbol_class = 106 as libc::c_int as libc::c_uchar;
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn coff_gc_sweep(
    ...
    while !sub.is_null() {
            ...
            != bfd_target_coff_flavour as libc::c_int as libc::c_uint)
        {
            ...
            while !o.is_null() {
                if (*o).flags
                    & (0x2000 as libc::c_int | 0x100000 as libc::c_int) as libc::c_uint
                    != 0 as libc::c_int as libc::c_uint
                    || (*o).flags
                        & (0x1 as libc::c_int | 0x2 as libc::c_int | 0x4 as libc::c_int)
                            as libc::c_uint == 0 as libc::c_int as libc::c_uint
                {
                    (*o).set_gc_mark(1 as libc::c_int as libc::c_uint);
                } else if startswith(
                    (*o).name,
                    ...
                    || startswith(
                        (*o).name,
                        b".xdata\0" as *const u8 as *const libc::c_char,
                    ) as libc::c_int != 0
                    || startswith(
                        (*o).name,
...
unsafe extern "C" fn _bfd_coff_gc_keep(mut info: *mut bfd_link_info) {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_coff_gc_sections(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    let mut sub: *mut bfd = 0 as *mut bfd;
            ...
            != bfd_target_coff_flavour as libc::c_int as libc::c_uint)
        {
            ...
            while !o.is_null() {
                if ((*o).flags
                    ...
                    || startswith(
                        (*o).name,
                        b".vectors\0" as *const u8 as *const libc::c_char,
                    ) as libc::c_int != 0
                    || startswith(
                        (*o).name,
                    ...
                    ) as libc::c_int != 0) && (*o).gc_mark() == 0
                {
                    if !_bfd_coff_gc_mark(
                        info,
                        o,
                        Some(
    ...
    _bfd_coff_gc_mark_extra_sections(
        info,
        Some(
            _bfd_coff_gc_mark_hook
                as unsafe extern "C" fn(
...
#[no_mangle]
pub unsafe extern "C" fn bfd_coff_group_name(
    mut abfd: *mut bfd,
    mut sec: *const asection,
) -> *const libc::c_char {
    let mut ci: *mut coff_comdat_info = if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_coff_flavour as libc::c_int as libc::c_uint
        && !((*sec).used_by_bfd as *mut coff_section_tdata).is_null()
    {
        (*((*sec).used_by_bfd as *mut coff_section_tdata)).comdat
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_close_and_cleanup(mut abfd: *mut bfd) -> bool {
    let mut tdata: *mut coff_tdata = (*abfd).tdata.coff_obj_data;
    if !tdata.is_null() {
        if bfd_get_format(abfd) as libc::c_uint
            == bfd_object as libc::c_int as libc::c_uint
            && bfd_family_coff(abfd) as libc::c_int != 0 && !_bfd_coff_free_symbols(abfd)
        {
            return 0 as libc::c_int != 0;
        }
        if bfd_get_format(abfd) as libc::c_uint
