...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_sym_in(
    mut abfd: *mut bfd,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_sym_out(
    mut abfd: *mut bfd,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_aux_in(
    mut abfd: *mut bfd,
    mut ext1: *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_aux_out(
    mut abfd: *mut bfd,
    mut inp: *mut libc::c_void,
    mut type_0: libc::c_int,
    mut in_class: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_lineno_in(
    mut abfd: *mut bfd,
    mut ext1: *mut libc::c_void,
    mut in1: *mut libc::c_void,
) {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_lineno_out(
    mut abfd: *mut bfd,
    mut inp: *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_aouthdr_in(
    mut abfd: *mut bfd,
    mut aouthdr_ext1: *mut libc::c_void,
    mut aouthdr_int1: *mut libc::c_void,
) {
    let mut src: *mut PEAOUTHDR = aouthdr_ext1 as *mut PEAOUTHDR;
    ...
    (*aouthdr_int)
        ...
        .expect(
            "non-null function pointer",
        )(((*aouthdr_ext).data_start).as_mut_ptr() as *const libc::c_void);
    ...
    if (*aouthdr_int).entry != 0 {
        (*aouthdr_int)
            ...
            as bfd_vma as bfd_vma;
        (*aouthdr_int).entry &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
    if (*aouthdr_int).tsize != 0 {
        (*aouthdr_int)
            .text_start = ((*aouthdr_int).text_start as libc::c_ulong)
            .wrapping_add((*a).ImageBase) as bfd_vma as bfd_vma;
        (*aouthdr_int).text_start &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
    if (*aouthdr_int).dsize != 0 {
        (*aouthdr_int)
            .data_start = ((*aouthdr_int).data_start as libc::c_ulong)
            .wrapping_add((*a).ImageBase) as bfd_vma as bfd_vma;
        (*aouthdr_int).data_start &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
}
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_aouthdr_out(
    mut abfd: *mut bfd,
    ...
    let mut aouthdr_out: *mut PEAOUTHDR = out as *mut PEAOUTHDR;
    ...
    if (*aouthdr_in).tsize != 0 {
        (*aouthdr_in)
            ...
            as bfd_vma as bfd_vma;
        (*aouthdr_in).text_start &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
    if (*aouthdr_in).dsize != 0 {
        (*aouthdr_in)
            .data_start = ((*aouthdr_in).data_start as libc::c_ulong).wrapping_sub(ib)
            as bfd_vma as bfd_vma;
        (*aouthdr_in).data_start &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
    if (*aouthdr_in).entry != 0 {
        (*aouthdr_in)
            .entry = ((*aouthdr_in).entry as libc::c_ulong).wrapping_sub(ib) as bfd_vma
            as bfd_vma;
        (*aouthdr_in).entry &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
    (*aouthdr_in)
    ...
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        ...
        (*aouthdr_in).data_start,
        ((*aouthdr_out).standard.data_start).as_mut_ptr() as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
    ...
    return (28 as libc::c_int + 196 as libc::c_int) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_only_swap_filehdr_out(
    mut abfd: *mut bfd,
    mut in_0: *mut libc::c_void,
    mut out: *mut libc::c_void,
) -> libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pe_only_swap_filehdr_out(
    mut abfd: *mut bfd,
    mut in_0: *mut libc::c_void,
    mut out: *mut libc::c_void,
) -> libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_scnhdr_out(
    mut abfd: *mut bfd,
    mut in_0: *mut libc::c_void,
    mut out: *mut libc::c_void,
) -> libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_debugdir_in(
    mut abfd: *mut bfd,
    mut ext1: *mut libc::c_void,
    mut in1: *mut libc::c_void,
) {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_swap_debugdir_out(
    mut abfd: *mut bfd,
    mut inp: *mut libc::c_void,
    mut extp: *mut libc::c_void,
) -> libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_slurp_codeview_record(
    mut abfd: *mut bfd,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_write_codeview_record(
    mut abfd: *mut bfd,
    mut where_0: file_ptr,
    mut cvinfo: *mut CODEVIEW_INFO,
) -> libc::c_uint {
            ...
            match current_block_75 {
                ...
                _ => {
                    ...
                    while (idx as libc::c_ulong)
                        .wrapping_add(j)
                        .wrapping_add(4 as libc::c_int as libc::c_ulong) <= datasize
                    {
                        ...
                        if member == 0 as libc::c_int as libc::c_ulong {
                            break;
                        }
                        amt = member.wrapping_sub(adj as libc::c_ulong);
                        if member & 0x80000000 as libc::c_uint as libc::c_ulong != 0 {
                            fprintf(
                                file,
                                b"\t%04lx\t %4lu  <none>\0" as *const u8
                                    as *const libc::c_char,
                                member,
                                member & 0x7fffffff as libc::c_int as libc::c_ulong,
                            );
                    ...
                    current_block_75 = 993425571616822999;
                }
            }
        } else {
            current_block_75 = 993425571616822999;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pe_print_ce_compressed_pdata(
    mut abfd: *mut bfd,
    mut vfile: *mut libc::c_void,
) -> bool {
    let mut file: *mut FILE = vfile as *mut FILE;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pe_print_private_bfd_data_common(
    mut abfd: *mut bfd,
    mut vfile: *mut libc::c_void,
) -> bool {
    let mut file: *mut FILE = vfile as *mut FILE;
    ...
    fprintf(file, b"\nBaseOfData\t\t\0" as *const u8 as *const libc::c_char);
    bfd_fprintf_vma(abfd, file as *mut libc::c_void, (*i).BaseOfData);
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pe_bfd_copy_private_bfd_data_common(
    mut ibfd: *mut bfd,
    mut obfd: *mut bfd,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pe_bfd_copy_private_section_data(
    mut ibfd: *mut bfd,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pe_get_symbol_info(
    mut abfd: *mut bfd,
            ...
            loop {
                ...
                if !rsrc_sec.is_null() && !discarded_section(rsrc_sec) {
                    if num_input_rsrc == max_num_input_rsrc {
                        ...
                        if rsrc_sizes.is_null() {
                            current_block = 17792979809271584427;
                            break;
                        }
                    }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_pei_final_link_postscript(
    mut abfd: *mut bfd,
    mut pfinfo: *mut coff_final_link_info,
) -> bool {
    ...
    if !h1.is_null() {
        ...
        (*(*abfd).tdata.pe_obj_data)
            .pe_opthdr
            .DataDirectory[9 as libc::c_int as usize]
            .Size = 0x18 as libc::c_int as libc::c_long;
    }
