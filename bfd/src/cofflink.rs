...
extern "C" {
    ...
    fn _bfd_generic_link_add_archive_symbols(
        _: *mut bfd,
        _: *mut bfd_link_info,
        _: Option::<
            unsafe extern "C" fn(
    ...
    fn _bfd_stringtab_init() -> *mut bfd_strtab_hash;
    fn _bfd_stringtab_free(_: *mut bfd_strtab_hash);
    fn _bfd_stringtab_size(_: *mut bfd_strtab_hash) -> bfd_size_type;
    fn _bfd_stringtab_add(
        _: *mut bfd_strtab_hash,
        _: *const libc::c_char,
        hash: bool,
        copy: bool,
    ) -> bfd_size_type;
    fn _bfd_stringtab_emit(_: *mut bfd, _: *mut bfd_strtab_hash) -> bool;
    ...
    fn coff_write_alien_symbol(
        _: *mut bfd,
        _: *mut asymbol,
        _: *mut internal_syment,
        _: *mut internal_auxent,
        _: *mut bfd_vma,
        _: *mut bfd_size_type,
        _: *mut *mut asection,
        _: *mut bfd_size_type,
    ) -> bool;
    fn _bfd_coff_free_symbols(_: *mut bfd) -> bool;
    fn _bfd_coff_get_external_symbols(_: *mut bfd) -> bool;
    fn _bfd_coff_read_string_table(_: *mut bfd) -> *const libc::c_char;
    fn _bfd_coff_read_internal_relocs(
        _: *mut bfd,
        _: *mut asection,
        _: bool,
        _: *mut bfd_byte,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_debug_merge_element {
    pub next: *mut coff_debug_merge_element,
    pub name: *const libc::c_char,
    pub type_0: libc::c_uint,
    pub tagndx: libc::c_long,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_debug_merge_type {
    pub next: *mut coff_debug_merge_type,
    pub type_class: libc::c_int,
    pub indx: libc::c_long,
    pub elements: *mut coff_debug_merge_element,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct coff_debug_merge_hash_entry {
    pub root: bfd_hash_entry,
    pub types: *mut coff_debug_merge_type,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_link_hash_newfunc(
    mut entry: *mut bfd_hash_entry,
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
) -> *mut bfd_hash_entry {
    let mut ret: *mut coff_link_hash_entry = entry as *mut coff_link_hash_entry;
    if ret.is_null() {
        ret = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<coff_link_hash_entry>() as libc::c_ulong
                as libc::c_uint,
    ...
    ret = _bfd_link_hash_newfunc(ret as *mut bfd_hash_entry, table, string)
        as *mut coff_link_hash_entry;
    if !ret.is_null() {
        (*ret).indx = -(1 as libc::c_int) as libc::c_long;
        (*ret).type_0 = 0 as libc::c_int as libc::c_ushort;
        (*ret).symbol_class = 0 as libc::c_int as libc::c_uchar;
        (*ret).numaux = 0 as libc::c_int as libc::c_char;
        (*ret).auxbfd = 0 as *mut bfd;
        (*ret).aux = 0 as *mut internal_auxent;
    }
    return ret as *mut bfd_hash_entry;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_link_hash_table_init(
    mut table: *mut coff_link_hash_table,
    mut abfd: *mut bfd,
    mut newfunc: Option::<
        unsafe extern "C" fn(
            *mut bfd_hash_entry,
    ...
    memset(
        &mut (*table).stab_info as *mut stab_info as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<stab_info>() as libc::c_ulong,
    );
    return _bfd_link_hash_table_init(&mut (*table).root, abfd, newfunc, entsize);
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_link_hash_table_create(
    mut abfd: *mut bfd,
) -> *mut bfd_link_hash_table {
    let mut ret: *mut coff_link_hash_table = 0 as *mut coff_link_hash_table;
    let mut amt: size_t = ::core::mem::size_of::<coff_link_hash_table>()
        as libc::c_ulong;
    ret = bfd_malloc(amt) as *mut coff_link_hash_table;
    if ret.is_null() {
    ...
    if !_bfd_coff_link_hash_table_init(
        ...
        ::core::mem::size_of::<coff_link_hash_entry>() as libc::c_ulong as libc::c_uint,
    ) {
        free(ret as *mut libc::c_void);
        return 0 as *mut libc::c_void as *mut bfd_link_hash_table;
    }
    return &mut (*ret).root;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_debug_merge_hash_newfunc(
    mut entry: *mut bfd_hash_entry,
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
) -> *mut bfd_hash_entry {
    let mut ret: *mut coff_debug_merge_hash_entry = entry
        as *mut coff_debug_merge_hash_entry;
    if ret.is_null() {
        ret = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<coff_debug_merge_hash_entry>() as libc::c_ulong
                as libc::c_uint,
        ) as *mut coff_debug_merge_hash_entry;
    }
    if ret.is_null() {
    ...
    ret = bfd_hash_newfunc(ret as *mut bfd_hash_entry, table, string)
        as *mut coff_debug_merge_hash_entry;
    if !ret.is_null() {
        (*ret).types = 0 as *mut coff_debug_merge_type;
    }
    return ret as *mut bfd_hash_entry;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_link_add_symbols(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    match bfd_get_format(abfd) as libc::c_uint {
        1 => return coff_link_add_object_symbols(abfd, info),
        2 => {
...
unsafe extern "C" fn coff_link_add_object_symbols(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    ...
    if (*info).keep_memory() == 0 && !_bfd_coff_free_symbols(abfd) {
        return 0 as libc::c_int != 0;
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn coff_link_check_archive_element(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
    ...
    *pneeded = 0 as libc::c_int != 0;
    ...
    if (*(h as *mut coff_link_hash_entry)).indx == -(3 as libc::c_int) as libc::c_long {
        return 1 as libc::c_int != 0;
    }
    if !(Some(
        ((*(*info).callbacks).add_archive_element).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(info, abfd, name, &mut abfd)
    {
        return 1 as libc::c_int != 0;
    }
    *pneeded = 1 as libc::c_int != 0;
    return (Some(
        ((*(*abfd).xvec)._bfd_link_add_symbols).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, info);
}
unsafe extern "C" fn coff_link_add_symbols(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    let mut current_block: u64;
    let mut n_tmask: libc::c_uint = (*(*abfd).tdata.coff_obj_data).local_n_tmask;
    let mut n_btshft: libc::c_uint = (*(*abfd).tdata.coff_obj_data).local_n_btshft;
    let mut n_btmask: libc::c_uint = (*(*abfd).tdata.coff_obj_data).local_n_btmask;
    let mut keep_syms: bool = false;
    let mut default_copy: bool = false;
    let mut symcount: bfd_size_type = 0;
    let mut sym_hash: *mut *mut coff_link_hash_entry = 0
        as *mut *mut coff_link_hash_entry;
    let mut symesz: bfd_size_type = 0;
    let mut esym: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut esym_end: *mut bfd_byte = 0 as *mut bfd_byte;
    ...
    (*(*abfd).tdata.coff_obj_data).keep_syms = 1 as libc::c_int != 0;
    if (*info).keep_memory() != 0 {
        default_copy = 0 as libc::c_int != 0;
    } else {
        default_copy = 1 as libc::c_int != 0;
    }
    amt = symcount
        .wrapping_mul(
            ::core::mem::size_of::<*mut coff_link_hash_entry>() as libc::c_ulong,
        );
    sym_hash = bfd_zalloc(abfd, amt) as *mut *mut coff_link_hash_entry;
    if !sym_hash.is_null() {
        (*(*abfd).tdata.coff_obj_data).sym_hashes = sym_hash;
        symesz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_symesz as bfd_size_type;
        if !(symesz
            == (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ._bfd_auxesz as libc::c_ulong)
        {
            bfd_assert(
                b"cofflink.c\0" as *const u8 as *const libc::c_char,
                275 as libc::c_int,
            );
        }
        esym = (*(*abfd).tdata.coff_obj_data).external_syms as *mut bfd_byte;
        esym_end = esym.offset(symcount.wrapping_mul(symesz) as isize);
        loop {
            if !(esym < esym_end) {
                current_block = 3634396408142324656;
                break;
            }
            let mut sym: internal_syment = internal_syment {
                _n: C2RustUnnamed_17 {
                    _n_name: [0; 8],
                },
                n_value: 0,
            ...
            let mut classification: coff_symbol_classification = COFF_SYMBOL_GLOBAL;
            ...
            ((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ...
                &mut sym as *mut internal_syment as *mut libc::c_void,
            );
            classification = ((*((*(*abfd).xvec).backend_data
                as *mut bfd_coff_backend_data))
                ._bfd_coff_classify_symbol)
                .expect("non-null function pointer")(abfd, &mut sym);
            if classification as libc::c_uint
                != COFF_SYMBOL_LOCAL as libc::c_int as libc::c_uint
            {
                ...
                let mut addit: bool = false;
                let mut discarded: bool = 0 as libc::c_int != 0;
                name = _bfd_coff_internal_syment_name(abfd, &mut sym, buf.as_mut_ptr());
                if name.is_null() {
                    current_block = 6356574419981347799;
                    break;
                }
                copy = default_copy;
                if sym._n._n_n._n_zeroes != 0 as libc::c_int as libc::c_ulong
                    || sym._n._n_n._n_offset == 0 as libc::c_int as libc::c_ulong
                {
                    copy = 1 as libc::c_int != 0;
                }
                value = sym.n_value;
                match classification as libc::c_uint {
                    0 => {
                        ...
                        } else if (*(*abfd).tdata.coff_obj_data).pe == 0 {
                            value = (value as libc::c_ulong).wrapping_sub((*section).vma)
                    ...
                    _ => {
                        _bfd_abort(
                            ...
                            (*::core::mem::transmute::<
                                ...
                                &[libc::c_char; 59],
                            >(
                                b"_Bool coff_link_add_symbols(bfd *, struct bfd_link_info *)\0",
                            ))
                                .as_ptr(),
                        );
                    }
                }
                if sym.n_sclass as libc::c_int == 127 as libc::c_int
                    || (*(*abfd).tdata.coff_obj_data).pe != 0
                        && sym.n_sclass as libc::c_int == 105 as libc::c_int
                {
                    flags = ((1 as libc::c_int) << 7 as libc::c_int) as flagword;
                }
                addit = 1 as libc::c_int != 0;
                        ...
                        != 0 as libc::c_int as libc::c_uint
                {
                    *sym_hash = bfd_link_hash_lookup(
                    ...
                    if !(*sym_hash).is_null() {
                        if (**sym_hash).coff_link_hash_flags as libc::c_int
                                ...
                                != bfd_link_hash_undefweak as libc::c_int
                        {
                            _bfd_error_handler(
                                dcgettext(
                                    ...
                                    b"warning: symbol `%s' is both section and non-section\0"
                        ...
                        addit = 0 as libc::c_int != 0;
                    }
                }
                if (*(*abfd).tdata.coff_obj_data).pe != 0
                    && (classification as libc::c_uint
                        == COFF_SYMBOL_GLOBAL as libc::c_int as libc::c_uint
                        || classification as libc::c_uint
                            == COFF_SYMBOL_PE_SECTION as libc::c_int as libc::c_uint)
                    && !((*section).used_by_bfd as *mut coff_section_tdata).is_null()
                    && !((*((*section).used_by_bfd as *mut coff_section_tdata)).comdat)
                        .is_null()
                    && startswith(name, b"??_\0" as *const u8 as *const libc::c_char)
                        as libc::c_int != 0
                    && strcmp(
                        name,
                        (*(*((*section).used_by_bfd as *mut coff_section_tdata)).comdat)
                    ...
                    ) == 0 as libc::c_int
                {
                    ...
                    if !(*sym_hash).is_null()
                        ...
                        && !((*((*(**sym_hash).root.u.def.section).used_by_bfd
                ...
                if addit {
                    ...
                    if discarded {
                        (**sym_hash).indx = -(3 as libc::c_int) as libc::c_long;
                    }
                }
                if (*(*abfd).tdata.coff_obj_data).pe != 0
                    && flags & ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_uint
                ...
                {
                    (**sym_hash)
                        .coff_link_hash_flags = ((**sym_hash).coff_link_hash_flags
                        as libc::c_int | 0o1 as libc::c_int) as libc::c_ushort;
                }
                if section
                ...
                {
                    (*(**sym_hash).root.u.c.p)
                        .alignment_power = (*((*(*abfd).xvec).backend_data
                        as *mut bfd_coff_backend_data))
                        ._bfd_coff_default_section_alignment_power;
                }
                if bfd_get_flavour((*info).output_bfd) as libc::c_uint
                    == bfd_get_flavour(abfd) as libc::c_uint
                {
                    if (**sym_hash).symbol_class as libc::c_int == 0 as libc::c_int
                        && (**sym_hash).type_0 as libc::c_int == 0 as libc::c_int
                        || sym.n_scnum != 0 as libc::c_int
                                ...
                                != bfd_link_hash_defweak as libc::c_int
                    {
                        ...
                        if sym.n_type as libc::c_int != 0 as libc::c_int {
                            if (**sym_hash).type_0 as libc::c_int != 0 as libc::c_int
                                && (**sym_hash).type_0 as libc::c_int
                                    != sym.n_type as libc::c_int
                                && !(((**sym_hash).type_0 as libc::c_uint & n_tmask)
                                    >> n_btshft
                                    == (sym.n_type as libc::c_uint & n_tmask) >> n_btshft
                                    && ((**sym_hash).type_0 as libc::c_uint & n_btmask
                                        == 0 as libc::c_int as libc::c_uint
                                        || sym.n_type as libc::c_uint & n_btmask
                                            == 0 as libc::c_int as libc::c_uint))
                            {
                                _bfd_error_handler(
                                    dcgettext(
                            ...
                            if sym.n_type as libc::c_uint & n_btmask
                                != 0 as libc::c_int as libc::c_uint
                                || (**sym_hash).type_0 as libc::c_int == 0 as libc::c_int
                            {
                                (**sym_hash).type_0 = sym.n_type;
                            }
                        }
                        (**sym_hash).auxbfd = abfd;
                        if sym.n_numaux as libc::c_int != 0 as libc::c_int {
                            let mut alloc: *mut internal_auxent = 0
                                as *mut internal_auxent;
                            let mut i: libc::c_uint = 0;
                            let mut eaux: *mut bfd_byte = 0 as *mut bfd_byte;
                            let mut iaux: *mut internal_auxent = 0
                                as *mut internal_auxent;
                            (**sym_hash).numaux = sym.n_numaux as libc::c_char;
                            alloc = bfd_hash_allocate(
                                &mut (*(*info).hash).table,
                                (sym.n_numaux as libc::c_ulong)
                                    .wrapping_mul(
                            ...
                            eaux = esym.offset(symesz as isize);
                            iaux = alloc;
                            while i < sym.n_numaux as libc::c_uint {
                                ((*((*(*abfd).xvec).backend_data
                                    ...
                                    abfd,
                                    eaux as *mut libc::c_void,
                                    sym.n_type as libc::c_int,
                                    sym.n_sclass as libc::c_int,
                                    i as libc::c_int,
                                    sym.n_numaux as libc::c_int,
                                    iaux as *mut libc::c_void,
                                );
                                i = i.wrapping_add(1);
                                i;
                                eaux = eaux.offset(symesz as isize);
                                iaux = iaux.offset(1);
                                iaux;
                            }
                            (**sym_hash).aux = alloc;
                ...
                if classification as libc::c_uint
                    == COFF_SYMBOL_PE_SECTION as libc::c_int as libc::c_uint
                    && (**sym_hash).numaux as libc::c_int != 0 as libc::c_int
                {
                    if !((**sym_hash).numaux as libc::c_int == 1 as libc::c_int) {
                        bfd_assert(
                            b"cofflink.c\0" as *const u8 as *const libc::c_char,
                            518 as libc::c_int,
                        );
                    ...
                    if (*section).size == 0 as libc::c_int as libc::c_ulong {
                        (*section)
                            ...
                            .x_scn
                            .x_scnlen as bfd_size_type;
                    }
                }
            }
            esym = esym
                .offset(
                    ((sym.n_numaux as libc::c_int + 1 as libc::c_int) as libc::c_ulong)
                        .wrapping_mul(symesz) as isize,
                );
            sym_hash = sym_hash
                .offset((sym.n_numaux as libc::c_int + 1 as libc::c_int) as isize);
        }
        match current_block {
            6356574419981347799 => {}
            _ => {
                if !((*info).type_0() as libc::c_int == type_relocatable as libc::c_int)
                    && (*info).traditional_format() == 0
                                    ...
                                    || *((*stab).name).offset(5 as libc::c_int as isize)
                                        ...
                                        && _sch_istable[(*((*stab).name)
                                            ...
                                            & _sch_isdigit as libc::c_int as libc::c_ushort
                                                as libc::c_int != 0)
                            {
                                let mut table: *mut coff_link_hash_table = 0
                                    as *mut coff_link_hash_table;
                                let mut secdata: *mut coff_section_tdata = (*stab)
                                    .used_by_bfd as *mut coff_section_tdata;
                                if secdata.is_null() {
                                    amt = ::core::mem::size_of::<coff_section_tdata>()
                                        as libc::c_ulong;
                                    (*stab).used_by_bfd = bfd_zalloc(abfd, amt);
                                    if ((*stab).used_by_bfd).is_null() {
                                        current_block = 6356574419981347799;
                                        break;
                                    }
                                    secdata = (*stab).used_by_bfd as *mut coff_section_tdata;
                                }
                                table = (*info).hash as *mut coff_link_hash_table;
                                if !_bfd_link_section_stabs(
                                    abfd,
                                    &mut (*table).stab_info,
                                    stab,
                                    stabstr,
                                    &mut (*secdata).stab_info,
                                    &mut string_offset,
                                ) {
                                    current_block = 6356574419981347799;
                                    break;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_final_link(
    mut abfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    let mut current_block: u64;
    let mut symesz: bfd_size_type = 0;
    let mut flaginfo: coff_final_link_info = coff_final_link_info {
        info: 0 as *mut bfd_link_info,
        output_bfd: 0 as *mut bfd,
        failed: false,
        global_to_static: false,
        strtab: 0 as *mut bfd_strtab_hash,
        section_info: 0 as *mut coff_link_section_info,
        last_file_index: 0,
        last_file: internal_syment {
            _n: C2RustUnnamed_17 {
                _n_name: [0; 8],
            },
            n_value: 0,
        ...
        debug_merge: coff_debug_merge_hash_table {
            root: bfd_hash_table {
        ...
        internal_syms: 0 as *mut internal_syment,
        sec_ptrs: 0 as *mut *mut asection,
        sym_indices: 0 as *mut libc::c_long,
        outsyms: 0 as *mut bfd_byte,
        linenos: 0 as *mut bfd_byte,
        contents: 0 as *mut bfd_byte,
        external_relocs: 0 as *mut bfd_byte,
        internal_relocs: 0 as *mut internal_reloc,
    };
    let mut debug_merge_allocated: bool = false;
    ...
    let mut max_lineno_count: bfd_size_type = 0;
    let mut max_reloc_count: bfd_size_type = 0;
    let mut max_output_reloc_count: bfd_size_type = 0;
    let mut max_contents_size: bfd_size_type = 0;
    let mut rel_filepos: file_ptr = 0;
    let mut relsz: libc::c_uint = 0;
    let mut line_filepos: file_ptr = 0;
    let mut linesz: libc::c_uint = 0;
    let mut sub: *mut bfd = 0 as *mut bfd;
    let mut external_relocs: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut strbuf: [libc::c_char; 4] = [0; 4];
    let mut amt: bfd_size_type = 0;
    symesz = (*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))._bfd_symesz
        as bfd_size_type;
    flaginfo.info = info;
    flaginfo.output_bfd = abfd;
    flaginfo.strtab = 0 as *mut bfd_strtab_hash;
    flaginfo.section_info = 0 as *mut coff_link_section_info;
    flaginfo.last_file_index = -(1 as libc::c_int) as libc::c_long;
    flaginfo.last_bf_index = -(1 as libc::c_int) as libc::c_long;
    flaginfo.internal_syms = 0 as *mut internal_syment;
    flaginfo.sec_ptrs = 0 as *mut *mut asection;
    flaginfo.sym_indices = 0 as *mut libc::c_long;
    flaginfo.outsyms = 0 as *mut bfd_byte;
    flaginfo.linenos = 0 as *mut bfd_byte;
    flaginfo.contents = 0 as *mut bfd_byte;
    flaginfo.external_relocs = 0 as *mut bfd_byte;
    flaginfo.internal_relocs = 0 as *mut internal_reloc;
    flaginfo.global_to_static = 0 as libc::c_int != 0;
    debug_merge_allocated = 0 as libc::c_int != 0;
    (*(*abfd).tdata.coff_obj_data).link_info = info;
    flaginfo.strtab = _bfd_stringtab_init();
    if !(flaginfo.strtab).is_null() {
        if bfd_hash_table_init(
            &mut flaginfo.debug_merge.root,
            Some(
            ...
            debug_merge_allocated = 1 as libc::c_int != 0;
            if (*abfd).output_has_begun() == 0 {
                if !((*((*(*abfd).xvec).backend_data as *mut bfd_coff_backend_data))
                    ._bfd_coff_compute_section_file_positions)
                    .expect("non-null function pointer")(abfd)
                {
                    current_block = 9225566337344066777;
                } else {
            ...
            match current_block {
                9225566337344066777 => {}
                _ => {
                    rel_filepos = (*(*abfd).tdata.coff_obj_data).relocbase as file_ptr;
                    relsz = (*((*(*abfd).xvec).backend_data
                        as *mut bfd_coff_backend_data))
                        ._bfd_relsz;
                    max_contents_size = 0 as libc::c_int as bfd_size_type;
                    max_lineno_count = 0 as libc::c_int as bfd_size_type;
                    max_reloc_count = 0 as libc::c_int as bfd_size_type;
                    ...
                    loop {
                        ...
                        (*o).lineno_count = 0 as libc::c_int as libc::c_uint;
                        ...
                        while !p.is_null() {
                                ...
                                == bfd_indirect_link_order as libc::c_int as libc::c_uint
                            {
                                ...
                                if (*info).strip() as libc::c_int
                                    == strip_none as libc::c_int
                                    || (*info).strip() as libc::c_int
                                        == strip_some as libc::c_int
                                {
                                    (*o)
                                        .lineno_count = ((*o).lineno_count)
                                        .wrapping_add((*sec).lineno_count);
                                }
                                if (*info).type_0() as libc::c_int
                                    == type_relocatable as libc::c_int
                                {
                                    (*o)
                                        .reloc_count = ((*o).reloc_count)
                                        .wrapping_add((*sec).reloc_count);
                                }
                                ...
                                if (*sec).lineno_count as libc::c_ulong > max_lineno_count {
                                    max_lineno_count = (*sec).lineno_count as bfd_size_type;
                                }
                                if (*sec).reloc_count as libc::c_ulong > max_reloc_count {
                                    max_reloc_count = (*sec).reloc_count as bfd_size_type;
                                }
                                ...
                                && ((*p).type_0 as libc::c_uint
                                    ...
                                    || (*p).type_0 as libc::c_uint
                                        == bfd_symbol_reloc_link_order as libc::c_int
                                            as libc::c_uint)
                            {
                                (*o).reloc_count = ((*o).reloc_count).wrapping_add(1);
                                (*o).reloc_count;
                            }
                            p = (*p).next;
                        }
                        if (*o).reloc_count == 0 as libc::c_int as libc::c_uint {
                            (*o).rel_filepos = 0 as libc::c_int as file_ptr;
                        } else {
                            (*o).flags |= 0x4 as libc::c_int as libc::c_uint;
                            (*o).rel_filepos = rel_filepos;
                            rel_filepos
                                += ((*o).reloc_count).wrapping_mul(relsz) as libc::c_long;
                            if ((*(*abfd).tdata.coff_obj_data).pe != 0
                                || (*(*abfd).tdata.coff_obj_data).go32 as libc::c_int != 0)
                                && (*o).reloc_count >= 0xffff as libc::c_int as libc::c_uint
                            {
                                rel_filepos += relsz as libc::c_long;
                            }
                        }
                        if (*((*(*abfd).xvec).backend_data
                            as *mut bfd_coff_backend_data))
                            ._bfd_coff_long_section_names as libc::c_int != 0
                            && strlen((*o).name) > 8 as libc::c_int as libc::c_ulong
                        {
                            if _bfd_stringtab_add(
                                flaginfo.strtab,
                                (*o).name,
                                0 as libc::c_int != 0,
                                0 as libc::c_int != 0,
                        ...
                        _ => {
                                ...
                                == type_relocatable as libc::c_int
                            {
                                ...
                                amt = (amt as libc::c_ulong)
                                    .wrapping_mul(
                                        ::core::mem::size_of::<coff_link_section_info>()
                                            as libc::c_ulong,
                                    ) as bfd_size_type as bfd_size_type;
                                flaginfo
                                    .section_info = bfd_malloc(amt)
                                    as *mut coff_link_section_info;
                                if (flaginfo.section_info).is_null() {
                                    current_block = 9225566337344066777;
                                } else {
                                    i = 0 as libc::c_int as libc::c_uint;
                                    while i <= (*abfd).section_count {
                                        let ref mut fresh0 = (*(flaginfo.section_info)
                                            .offset(i as isize))
                                            .relocs;
                                        *fresh0 = 0 as *mut internal_reloc;
                                        let ref mut fresh1 = (*(flaginfo.section_info)
                                            .offset(i as isize))
                                            .rel_hashes;
                                        *fresh1 = 0 as *mut *mut coff_link_hash_entry;
                                        i = i.wrapping_add(1);
                                        i;
                                    }
                            ...
                            match current_block {
                                ...
                                _ => {
                                    ...
                                    linesz = (*((*(*abfd).xvec).backend_data
                                        as *mut bfd_coff_backend_data))
                                        ._bfd_linesz;
                                    max_output_reloc_count = 0 as libc::c_int as bfd_size_type;
                                    o = (*abfd).sections;
                                    loop {
                                        if o.is_null() {
                                        ...
                                        if (*o).lineno_count == 0 as libc::c_int as libc::c_uint {
                                            (*o).line_filepos = 0 as libc::c_int as file_ptr;
                                        } else {
                                            (*o).line_filepos = line_filepos;
                                            line_filepos
                                                += ((*o).lineno_count).wrapping_mul(linesz) as libc::c_long;
                                        }
                                        if (*o).reloc_count != 0 as libc::c_int as libc::c_uint {
                                            if !((*info).type_0() as libc::c_int
                                                == type_relocatable as libc::c_int)
                                            ...
                                            amt = (*o).reloc_count as bfd_size_type;
                                            amt = (amt as libc::c_ulong)
                                                .wrapping_mul(
                                                    ::core::mem::size_of::<internal_reloc>() as libc::c_ulong,
                                                ) as bfd_size_type as bfd_size_type;
                                            let ref mut fresh2 = (*(flaginfo.section_info)
                                                .offset((*o).target_index as isize))
                                                .relocs;
                                            *fresh2 = bfd_malloc(amt) as *mut internal_reloc;
                                            amt = (*o).reloc_count as bfd_size_type;
                                            amt = (amt as libc::c_ulong)
                                                .wrapping_mul(
                                                    ::core::mem::size_of::<*mut coff_link_hash_entry>()
                                                        as libc::c_ulong,
                                                ) as bfd_size_type as bfd_size_type;
                                            let ref mut fresh3 = (*(flaginfo.section_info)
                                                .offset((*o).target_index as isize))
                                                .rel_hashes;
                                            *fresh3 = bfd_malloc(amt) as *mut *mut coff_link_hash_entry;
                                            ...
                                            if (*o).reloc_count as libc::c_ulong
                                                > max_output_reloc_count
                                            {
                                                max_output_reloc_count = (*o).reloc_count as bfd_size_type;
                                            }
                                        }
                                        (*o).reloc_count = 0 as libc::c_int as libc::c_uint;
                                        (*o).lineno_count = 0 as libc::c_int as libc::c_uint;
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            ...
                                            while !sub.is_null() {
                                                ...
                                                sz = if bfd_family_coff(sub) as libc::c_int != 0 {
                                                    (*(*sub).tdata.coff_obj_data).raw_syment_count
                                                } else {
                                            ...
                                            amt = max_sym_count
                                                .wrapping_mul(
                                                    ::core::mem::size_of::<internal_syment>() as libc::c_ulong,
                                                );
                                            flaginfo
                                                .internal_syms = bfd_malloc(amt) as *mut internal_syment;
                                            amt = max_sym_count
                                                .wrapping_mul(
                                                    ::core::mem::size_of::<*mut asection>() as libc::c_ulong,
                                                );
                                            flaginfo.sec_ptrs = bfd_malloc(amt) as *mut *mut asection;
                                            amt = max_sym_count
                                                .wrapping_mul(
                                                    ::core::mem::size_of::<libc::c_long>() as libc::c_ulong,
                                                );
                                            flaginfo.sym_indices = bfd_malloc(amt) as *mut libc::c_long;
                                            flaginfo
                                                .outsyms = bfd_malloc(
                                                max_sym_count
                                            ...
                                            amt = max_lineno_count
                                                .wrapping_mul(
                                                    (*((*(*abfd).xvec).backend_data
                                                        as *mut bfd_coff_backend_data))
                                                        ._bfd_linesz as libc::c_ulong,
                                                );
                                            flaginfo.linenos = bfd_malloc(amt) as *mut bfd_byte;
                                            flaginfo
                                                .contents = bfd_malloc(max_contents_size) as *mut bfd_byte;
                                            amt = max_reloc_count.wrapping_mul(relsz as libc::c_ulong);
                                            flaginfo.external_relocs = bfd_malloc(amt) as *mut bfd_byte;
                                            if !((*info).type_0() as libc::c_int
                                                == type_relocatable as libc::c_int)
                                            {
                                                amt = max_reloc_count
                                                ...
                                                flaginfo
                                                    .internal_relocs = bfd_malloc(amt) as *mut internal_reloc;
                                            }
                                            if !((flaginfo.internal_syms).is_null()
                                                && max_sym_count > 0 as libc::c_int as libc::c_ulong
                                                || (flaginfo.sec_ptrs).is_null()
                                                    && max_sym_count > 0 as libc::c_int as libc::c_ulong
                                                || (flaginfo.sym_indices).is_null()
                                                    && max_sym_count > 0 as libc::c_int as libc::c_ulong
                                                || (flaginfo.outsyms).is_null()
                                                || (flaginfo.linenos).is_null()
                                                    && max_lineno_count > 0 as libc::c_int as libc::c_ulong
                                                || (flaginfo.contents).is_null()
                                                    && max_contents_size > 0 as libc::c_int as libc::c_ulong
                                                || (flaginfo.external_relocs).is_null()
                                                    && max_reloc_count > 0 as libc::c_int as libc::c_ulong
                                                || !((*info).type_0() as libc::c_int
                                                    == type_relocatable as libc::c_int)
                                                    && (flaginfo.internal_relocs).is_null()
                                                    && max_reloc_count > 0 as libc::c_int as libc::c_ulong)
                                            {
                                                (*(*abfd).tdata.coff_obj_data)
                                                    .raw_syment_count = 0 as libc::c_int as libc::c_ulong;
                                                if ((*((*(*abfd).xvec).backend_data
                                                    as *mut bfd_coff_backend_data))
                                                ...
                                                match current_block {
                                                    ...
                                                    _ => {
                                                        ...
                                                        's_548: loop {
                                                            ...
                                                            while !p.is_null() {
                                                                        ...
                                                                        as libc::c_int != 0
                                                                {
                                                                    ...
                                                                    if !((*((*(*sub).xvec).backend_data
                                                                        as *mut bfd_coff_backend_data))
                                                                        ._bfd_coff_link_output_has_begun)
                                                                        .expect("non-null function pointer")(sub, &mut flaginfo)
                                                                    {
                                                                        if !_bfd_coff_link_input_bfd(&mut flaginfo, sub) {
                                                                            current_block = 9225566337344066777;
                                                                            break 's_548;
                                                                        }
                                                                        (*sub)
                                                                    ...
                                                                    || (*p).type_0 as libc::c_uint
                                                                        == bfd_symbol_reloc_link_order as libc::c_int
                                                                            as libc::c_uint
                                                                {
                                                                    if !_bfd_coff_reloc_link_order(abfd, &mut flaginfo, o, p) {
                                                                        current_block = 9225566337344066777;
                                                                        break 's_548;
                                                                    }
                                                        ...
                                                        match current_block {
                                                            9225566337344066777 => {}
                                                            _ => {
                                                                if (*flaginfo.info).strip() as libc::c_int
                                                                    != strip_all as libc::c_int
                                                                    && (*flaginfo.info).discard() as libc::c_int
                                                                        != discard_all as libc::c_int
                                                                {
                                                                    ...
                                                                    's_624: loop {
                                                                        ...
                                                                        if !(bfd_family_coff(sub) as libc::c_int != 0
                                                                            || (bfd_get_outsymbols(sub)).is_null())
                                                                        {
                                                                            i_0 = 0 as libc::c_int as libc::c_uint;
                                                                            while i_0 < bfd_get_symcount(sub) {
                                                                                let mut sym: *mut asymbol = *(bfd_get_outsymbols(sub))
                                                                                    .offset(i_0 as isize);
                                                                                ...
                                                                                let mut iaux: internal_auxent = internal_auxent {
                                                                                    x_sym: C2RustUnnamed_23 {
                                                                                        x_tagndx: C2RustUnnamed_30 { l: 0 },
                                                                                        x_misc: C2RustUnnamed_28 {
                                                                                            x_lnsz: C2RustUnnamed_29 {
                                                                                ...
                                                                                let mut string_size: bfd_size_type = 0 as libc::c_int
                                                                                    as bfd_size_type;
                                                                                let mut indx: bfd_size_type = 0;
                                                                                let mut written: bfd_vma = 0 as libc::c_int as bfd_vma;
                                                                                let mut rewrite: bool = 0 as libc::c_int != 0;
                                                                                            ...
                                                                                            == 0)
                                                                                {
                                                                                    if !((*flaginfo.info).strip() as libc::c_int
                                                                                        ...
                                                                                        || ((*flaginfo.info).discard() as libc::c_int
                                                                                            ...
                                                                                            && (*bfd_asymbol_section(sym)).flags
                                                                                                & 0x800000 as libc::c_int as libc::c_uint != 0
                                                                                            && !((*flaginfo.info).type_0() as libc::c_int
                                                                                                == type_relocatable as libc::c_int)
                                                                                            || (*flaginfo.info).discard() as libc::c_int
                                                                                                == discard_l as libc::c_int)
                                                                                            && (Some(
                                                                                                ((*(*sub).xvec)._bfd_is_local_label_name)
                                                                                                    .expect("non-null function pointer"),
                                                                                            ))
                                                                                                .expect(
                                                                                                    "non-null function pointer",
                                                                                                )(sub, bfd_asymbol_name(sym)) as libc::c_int != 0)
                                                                                    {
                                                                                        ...
                                                                                        if !coff_write_alien_symbol(
                                                                                            ...
                                                                                            &mut written,
                                                                                            &mut string_size,
                                                                                            0 as *mut *mut asection,
                                                                                            0 as *mut bfd_size_type,
                                                                                        ) {
                                                                                            current_block = 9225566337344066777;
                                                                                            break 's_624;
                                                                                        }
                                                                                        hash = (*flaginfo.info).traditional_format() == 0;
                                                                                        if string_size >= 6 as libc::c_int as libc::c_ulong
                                                                                            && isym.n_sclass as libc::c_int == 103 as libc::c_int
                                                                                            && isym._n._n_n._n_zeroes == 0
                                                                                            && isym.n_numaux as libc::c_int != 0
                                                                                        {
                                                                                            indx = _bfd_stringtab_add(
                                                                                                flaginfo.strtab,
                                                                                                b".file\0" as *const u8 as *const libc::c_char,
                                                                                                hash,
                                                                                                0 as libc::c_int != 0,
                                                                                            );
                                                                                            if indx == -(1 as libc::c_int) as bfd_size_type {
                                                                                                current_block = 9225566337344066777;
                                                                                                break 's_624;
                                                                                            }
                                                                                            isym
                                                                                                ._n
                                                                                                ._n_n
                                                                                                ._n_offset = (4 as libc::c_int as libc::c_ulong)
                                                                                                .wrapping_add(indx);
                                                                                            ((*((*(*abfd).xvec).backend_data
                                                                                                as *mut bfd_coff_backend_data))
                                                                                                ._bfd_coff_swap_sym_out)
                                                                                                .expect(
                                                                                                    "non-null function pointer",
                                                                                                )(
                                                                                                abfd,
                                                                                                &mut isym as *mut internal_syment as *mut libc::c_void,
                                                                                                flaginfo.outsyms as *mut libc::c_void,
                                                                                            );
                                                                                            if bfd_seek(abfd, pos, 0 as libc::c_int) != 0 as libc::c_int
                                                                                                || bfd_bwrite(
                                                                                                    flaginfo.outsyms as *const libc::c_void,
                                                                                                    symesz,
                                                                                                    abfd,
                                                                                                ) != symesz
                                                                                            {
                                                                                        ...
                                                                                        if string_size != 0 {
                                                                                            ...
                                                                                            if isym.n_sclass as libc::c_int != 103 as libc::c_int {
                                                                                                isym
                                                                                                    ._n
                                                                                                    ._n_n
                                                                                                    ._n_offset = (4 as libc::c_int as libc::c_ulong)
                                                                                                ...
                                                                                                rewrite = 1 as libc::c_int != 0;
                                                                                            } else {
                                                                                                if !(isym.n_numaux as libc::c_int == 1 as libc::c_int) {
                                                                                                    bfd_assert(
                                                                                                        b"cofflink.c\0" as *const u8 as *const libc::c_char,
                                                                                                        965 as libc::c_int,
                                                                                                    );
                                                                                                ...
                                                                                                iaux
                                                                                                    .x_file
                                                                                                    .x_n
                                                                                                    .x_offset = (4 as libc::c_int as libc::c_ulong)
                                                                                                    .wrapping_add(indx) as libc::c_long;
                                                                                                ((*((*(*abfd).xvec).backend_data
                                                                                                    as *mut bfd_coff_backend_data))
                                                                                                    ._bfd_coff_swap_aux_out)
                                                                                                    .expect(
                                                                                                        "non-null function pointer",
                                                                                                    )(
                                                                                                    abfd,
                                                                                                    &mut iaux as *mut internal_auxent as *mut libc::c_void,
                                                                                                    isym.n_type as libc::c_int,
                                                                                                    103 as libc::c_int,
                                                                                                    0 as libc::c_int,
                                                                                                    1 as libc::c_int,
                                                                                                    (flaginfo.outsyms).offset(symesz as isize)
                                                                                                        as *mut libc::c_void,
                                                                                                );
                                                                                                if bfd_seek(
                                                                                                    abfd,
                                                                                                    (pos as libc::c_ulong).wrapping_add(symesz) as file_ptr,
                                                                                                    0 as libc::c_int,
                                                                                                ) != 0 as libc::c_int
                                                                                                    || bfd_bwrite(
                                                                                                        (flaginfo.outsyms).offset(symesz as isize)
                                                                                        ...
                                                                                        if isym.n_sclass as libc::c_int == 103 as libc::c_int {
                                                                                            if flaginfo.last_file_index
                                                                                                != -(1 as libc::c_int) as libc::c_long
                                                                                            {
                                                                                                flaginfo
                                                                                                    .last_file
                                                                                                    .n_value = (*(*abfd).tdata.coff_obj_data).raw_syment_count;
                                                                                                ((*((*(*abfd).xvec).backend_data
                                                                                                    as *mut bfd_coff_backend_data))
                                                                                                    ._bfd_coff_swap_sym_out)
                                                                                                    .expect(
                                                                                                    ...
                                                                                                    abfd,
                                                                                                    &mut flaginfo.last_file as *mut internal_syment
                                                                                                        as *mut libc::c_void,
                                                                                                    flaginfo.outsyms as *mut libc::c_void,
                                                                                                );
                                                                                                pos = ((*(*abfd).tdata.coff_obj_data).sym_filepos
                                                                                                    as libc::c_ulong)
                                                                                                    .wrapping_add(
                                                                                                        (flaginfo.last_file_index as libc::c_ulong)
                                                                                                            .wrapping_mul(symesz),
                                                                                                    ) as file_ptr;
                                                                                                rewrite = 1 as libc::c_int != 0;
                                                                                            }
                                                                                            flaginfo
                                                                                                .last_file_index = (*(*abfd).tdata.coff_obj_data)
                                                                                                .raw_syment_count as libc::c_long;
                                                                                            flaginfo.last_file = isym;
                                                                                        }
                                                                                        if rewrite as libc::c_int != 0
                                                                                            && (bfd_seek(abfd, pos, 0 as libc::c_int)
                                                                                                != 0 as libc::c_int
                                                                                                || bfd_bwrite(
                                                                                                    flaginfo.outsyms as *const libc::c_void,
                                                                                                    symesz,
                                                                                        ...
                                                                                        (*(*abfd).tdata.coff_obj_data)
                                                                                            .raw_syment_count = ((*(*abfd).tdata.coff_obj_data)
                                                                                            .raw_syment_count)
                                                                ...
                                                                match current_block {
                                                                    ...
                                                                    _ => {
                                                                        if ((*((*(*abfd).xvec).backend_data
                                                                            ...
                                                                            .expect("non-null function pointer")(abfd, &mut flaginfo)
                                                                        {
                                                                            bfd_hash_table_free(&mut flaginfo.debug_merge.root);
                                                                            debug_merge_allocated = 0 as libc::c_int != 0;
                                                                            free(flaginfo.internal_syms as *mut libc::c_void);
                                                                            flaginfo.internal_syms = 0 as *mut internal_syment;
                                                                            free(flaginfo.sec_ptrs as *mut libc::c_void);
                                                                            flaginfo.sec_ptrs = 0 as *mut *mut asection;
                                                                            free(flaginfo.sym_indices as *mut libc::c_void);
                                                                            flaginfo.sym_indices = 0 as *mut libc::c_long;
                                                                            free(flaginfo.linenos as *mut libc::c_void);
                                                                            flaginfo.linenos = 0 as *mut bfd_byte;
                                                                            free(flaginfo.contents as *mut libc::c_void);
                                                                            flaginfo.contents = 0 as *mut bfd_byte;
                                                                            free(flaginfo.external_relocs as *mut libc::c_void);
                                                                            flaginfo.external_relocs = 0 as *mut bfd_byte;
                                                                            free(flaginfo.internal_relocs as *mut libc::c_void);
                                                                            flaginfo.internal_relocs = 0 as *mut internal_reloc;
                                                                            if flaginfo.last_file_index
                                                                                != -(1 as libc::c_int) as libc::c_long
                                                                                && flaginfo.last_file.n_value as libc::c_uint
                                                                                    as libc::c_ulong
                                                                                    != (*(*abfd).tdata.coff_obj_data).raw_syment_count
                                                                            {
                                                                                let mut pos_0: file_ptr = 0;
                                                                                flaginfo
                                                                                    .last_file
                                                                                    .n_value = (*(*abfd).tdata.coff_obj_data).raw_syment_count;
                                                                                ((*((*(*abfd).xvec).backend_data
                                                                                ...
                                                                                pos_0 = ((*(*abfd).tdata.coff_obj_data).sym_filepos
                                                                                    as libc::c_ulong)
                                                                                    .wrapping_add(
                                                                                        (flaginfo.last_file_index as libc::c_ulong)
                                                                                            .wrapping_mul(symesz),
                                                                                    ) as file_ptr;
                                                                                if bfd_seek(abfd, pos_0, 0 as libc::c_int)
                                                                                    != 0 as libc::c_int
                                                                                    || bfd_bwrite(
                                                                                        flaginfo.outsyms as *const libc::c_void,
                                                                                        symesz,
                                                                            ...
                                                                            if (*info).task_link() != 0 {
                                                                                flaginfo.failed = 0 as libc::c_int != 0;
                                                                                bfd_link_hash_traverse(
                                                                                    ...
                                                                                    &mut flaginfo as *mut coff_final_link_info
                                                                                        as *mut libc::c_void,
                                                                                );
                                                                                if flaginfo.failed {
                                                                                    current_block = 9225566337344066777;
                                                                            ...
                                                                            match current_block {
                                                                                ...
                                                                                _ => {
                                                                                    ...
                                                                                    if !flaginfo.failed {
                                                                                        free(flaginfo.outsyms as *mut libc::c_void);
                                                                                        flaginfo.outsyms = 0 as *mut bfd_byte;
                                                                                        if (*info).type_0() as libc::c_int
                                                                                            == type_relocatable as libc::c_int
                                                                                            && max_output_reloc_count
                                                                                                > 0 as libc::c_int as libc::c_ulong
                                                                                        {
                                                                                            amt = max_output_reloc_count
                                                                                                .wrapping_mul(relsz as libc::c_ulong);
                                                                                            external_relocs = bfd_malloc(amt) as *mut bfd_byte;
                                                                                            if external_relocs.is_null() {
                                                                                                ...
                                                                                                loop {
                                                                                                    ...
                                                                                                    let mut irel: *mut internal_reloc = 0
                                                                                                        as *mut internal_reloc;
                                                                                                    let mut irelend: *mut internal_reloc = 0
                                                                                                        as *mut internal_reloc;
                                                                                                    let mut rel_hash: *mut *mut coff_link_hash_entry = 0
                                                                                                        as *mut *mut coff_link_hash_entry;
                                                                                                    let mut erel: *mut bfd_byte = 0 as *mut bfd_byte;
                                                                                                    if !((*o).reloc_count == 0 as libc::c_int as libc::c_uint) {
                                                                                                        irel = (*(flaginfo.section_info)
                                                                                                            .offset((*o).target_index as isize))
                                                                                                            .relocs;
                                                                                                        irelend = irel.offset((*o).reloc_count as isize);
                                                                                                        rel_hash = (*(flaginfo.section_info)
                                                                                                            .offset((*o).target_index as isize))
                                                                                                            .rel_hashes;
                                                                                                        ...
                                                                                                        while irel < irelend {
                                                                                                            ...
                                                                                                            ((*((*(*abfd).xvec).backend_data
                                                                                                                as *mut bfd_coff_backend_data))
                                                                                                                ._bfd_coff_swap_reloc_out)
                                                                                                                .expect(
                                                                                                                    "non-null function pointer",
                                                                                                                )(
                                                                                                                abfd,
                                                                                                                irel as *mut libc::c_void,
                                                                                                                erel as *mut libc::c_void,
                                                                                                            );
                                                                                                            irel = irel.offset(1);
                                                                                                            irel;
                                                                                                            rel_hash = rel_hash.offset(1);
                                                                                                            rel_hash;
                                                                                                            erel = erel.offset(relsz as isize);
                                                                                                        }
                                                                                                        if bfd_seek(abfd, (*o).rel_filepos, 0 as libc::c_int)
                                                                                                            != 0 as libc::c_int
                                                                                                        {
                                                                                                            current_block = 9225566337344066777;
                                                                                                            break;
                                                                                                        ...
                                                                                                        if ((*(*abfd).tdata.coff_obj_data).pe != 0
                                                                                                            ...
                                                                                                            && (*o).reloc_count >= 0xffff as libc::c_int as libc::c_uint
                                                                                                        {
                                                                                                            let mut incount: internal_reloc = internal_reloc {
                                                                                                                r_vaddr: 0,
                                                                                                                r_symndx: 0,
                                                                                                                r_type: 0,
                                                                                                                r_size: 0,
                                                                                                            ...
                                                                                                            let mut excount: *mut bfd_byte = bfd_malloc(
                                                                                                                relsz as bfd_size_type,
                                                                                                            ) as *mut bfd_byte;
                                                                                                            memset(
                                                                                                                &mut incount as *mut internal_reloc as *mut libc::c_void,
                                                                                                                0 as libc::c_int,
                                                                                                                ::core::mem::size_of::<internal_reloc>() as libc::c_ulong,
                                                                                                            );
                                                                                                            incount
                                                                                                                .r_vaddr = ((*o).reloc_count)
                                                                                                            ...
                                                                                                            ((*((*(*abfd).xvec).backend_data
                                                                                                                ...
                                                                                                                abfd,
                                                                                                                &mut incount as *mut internal_reloc as *mut libc::c_void,
                                                                                                                excount as *mut libc::c_void,
                                                                                                            );
                                                                                                            if bfd_bwrite(
                                                                                                                excount as *const libc::c_void,
                                                                                                                relsz as bfd_size_type,
                                                                                                                abfd,
                                                                                                            ) != relsz as libc::c_ulong
                                                                                                            {
                                                                                                                current_block = 9225566337344066777;
                                                                                                                break;
                                                                                                            }
                                                                                                            free(excount as *mut libc::c_void);
                                                                                                        }
                                                                                                        if bfd_bwrite(
                                                                                                            external_relocs as *const libc::c_void,
                                                                                                            (relsz as bfd_size_type)
                                                                                                                .wrapping_mul((*o).reloc_count as libc::c_ulong),
                                                                                                            abfd,
                                                                                                        )
                                                                                                            != (relsz as bfd_size_type)
                                                                                                                .wrapping_mul((*o).reloc_count as libc::c_ulong)
                                                                                                ...
                                                                                                match current_block {
                                                                                                    9225566337344066777 => {}
                                                                                                    _ => {
                                                                                                        free(external_relocs as *mut libc::c_void);
                                                                                                        external_relocs = 0 as *mut bfd_byte;
                                                                                        ...
                                                                                        match current_block {
                                                                                            ...
                                                                                            _ => {
                                                                                                if !(flaginfo.section_info).is_null() {
                                                                                                    ...
                                                                                                    while i_1 < (*abfd).section_count {
                                                                                                        free(
                                                                                                            (*(flaginfo.section_info).offset(i_1 as isize)).relocs
                                                                                                                as *mut libc::c_void,
                                                                                                        );
                                                                                                        free(
                                                                                                            (*(flaginfo.section_info).offset(i_1 as isize)).rel_hashes
                                                                                                                as *mut libc::c_void,
                                                                                                        );
                                                                                                        i_1 = i_1.wrapping_add(1);
                                                                                                        i_1;
                                                                                                    }
                                                                                                    free(flaginfo.section_info as *mut libc::c_void);
                                                                                                    flaginfo.section_info = 0 as *mut coff_link_section_info;
                                                                                                }
                                                                                                if !((*((*info).hash as *mut coff_link_hash_table))
                                                                                                    .stab_info
                                                                                                    .stabstr)
                                                                                                    .is_null()
                                                                                                {
                                                                                                    if !_bfd_write_stab_strings(
                                                                                                        abfd,
                                                                                                        &mut (*((*info).hash as *mut coff_link_hash_table))
                                                                                                            .stab_info,
                                                                                                    ) {
                                                                                                        return 0 as libc::c_int != 0;
                                                                                                    }
                                                                                                ...
                                                                                                if (*(*abfd).tdata.coff_obj_data).raw_syment_count
                                                                                                    != 0 as libc::c_int as libc::c_ulong
                                                                                                    || long_section_names as libc::c_int != 0
                                                                                                {
                                                                                                    let mut pos_1: file_ptr = 0;
                                                                                                    pos_1 = ((*(*abfd).tdata.coff_obj_data).sym_filepos
                                                                                                        as libc::c_ulong)
                                                                                                        .wrapping_add(
                                                                                                            ((*(*abfd).tdata.coff_obj_data).raw_syment_count)
                                                                                                                .wrapping_mul(symesz),
                                                                                                        ) as file_ptr;
                                                                                                    if bfd_seek(abfd, pos_1, 0 as libc::c_int)
                                                                                                        != 0 as libc::c_int
                                                                                                    {
                                                                                                        return 0 as libc::c_int != 0;
                                                                                                    }
                                                                                                    (Some(
                                                                                                        ...
                                                                                                        (_bfd_stringtab_size(flaginfo.strtab))
                                                                                                            .wrapping_add(4 as libc::c_int as libc::c_ulong),
                                                                                                        strbuf.as_mut_ptr() as *mut libc::c_void,
                                                                                                    );
                                                                                                    if bfd_bwrite(
                                                                                                        strbuf.as_mut_ptr() as *const libc::c_void,
                                                                                                    ...
                                                                                                    (*(*abfd).tdata.coff_obj_data)
                                                                                                        .strings_written = 1 as libc::c_int != 0;
                                                                                                }
    ...
    if !(flaginfo.section_info).is_null() {
        ...
        while i_2 < (*abfd).section_count {
            free(
                (*(flaginfo.section_info).offset(i_2 as isize)).relocs
                    as *mut libc::c_void,
            );
            free(
                (*(flaginfo.section_info).offset(i_2 as isize)).rel_hashes
                    as *mut libc::c_void,
            );
...
unsafe extern "C" fn dores_com(
    mut ptr: *mut libc::c_char,
    mut output_bfd: *mut bfd,
    mut heap: libc::c_int,
) -> *mut libc::c_char {
    if (*(*output_bfd).tdata.coff_obj_data).pe != 0 {
        let mut val: libc::c_int = strtoul(ptr, &mut ptr, 0 as libc::c_int)
            as libc::c_int;
        if heap != 0 {
            (*(*output_bfd).tdata.pe_obj_data)
                .pe_opthdr
                .SizeOfHeapReserve = val as bfd_vma;
        } else {
            (*(*output_bfd).tdata.pe_obj_data)
                .pe_opthdr
                .SizeOfStackReserve = val as bfd_vma;
        }
        if *ptr.offset(0 as libc::c_int as isize) as libc::c_int == ',' as i32 {
            ...
            if heap != 0 {
                (*(*output_bfd).tdata.pe_obj_data)
                    .pe_opthdr
                    .SizeOfHeapCommit = val as bfd_vma;
            } else {
                (*(*output_bfd).tdata.pe_obj_data)
                    .pe_opthdr
                    .SizeOfStackCommit = val as bfd_vma;
            }
        }
    }
    return ptr;
...
unsafe extern "C" fn process_embedded_commands(
    ...
    let mut copy: *mut bfd_byte = 0 as *mut bfd_byte;
    if sec.is_null() {
        return 1 as libc::c_int;
    }
    if !bfd_malloc_and_get_section(abfd, sec, &mut copy) {
        free(copy as *mut libc::c_void);
        return 0 as libc::c_int;
    }
    e = (copy as *mut libc::c_char).offset((*sec).size as isize);
    s = copy as *mut libc::c_char;
    while s < e {
        if *s.offset(0 as libc::c_int as isize) as libc::c_int != '-' as i32 {
            s = s.offset(1);
            s;
        } else if startswith(s, b"-attr\0" as *const u8 as *const libc::c_char) {
            let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut attribs: *mut libc::c_char = 0 as *mut libc::c_char;
            let mut asec: *mut asection = 0 as *mut asection;
            let mut loop_0: libc::c_int = 1 as libc::c_int;
            let mut had_write: libc::c_int = 0 as libc::c_int;
            let mut had_exec: libc::c_int = 0 as libc::c_int;
            s = s.offset(5 as libc::c_int as isize);
            s = get_name(s, &mut name);
            s = get_name(s, &mut attribs);
            while loop_0 != 0 {
                let fresh4 = attribs;
                attribs = attribs.offset(1);
                match *fresh4 as libc::c_int {
                    87 => {
                        had_write = 1 as libc::c_int;
                    }
                    82 | 83 => {}
                    88 => {
                        had_exec = 1 as libc::c_int;
                    }
                    _ => {
            ...
            if !asec.is_null() {
                ...
                if had_write == 0 {
                    (*asec).flags |= 0x8 as libc::c_int as libc::c_uint;
                }
            }
        } else if startswith(s, b"-heap\0" as *const u8 as *const libc::c_char) {
            s = dores_com(
                s.offset(5 as libc::c_int as isize),
                output_bfd,
                1 as libc::c_int,
            );
        } else if startswith(s, b"-stack\0" as *const u8 as *const libc::c_char) {
            s = dores_com(
                s.offset(6 as libc::c_int as isize),
                output_bfd,
                0 as libc::c_int,
            );
        } else if startswith(s, b"-aligncomm:\0" as *const u8 as *const libc::c_char) {
            s = s.offset(11 as libc::c_int as isize);
        } else {
            s = s.offset(1);
            s;
        }
...
unsafe extern "C" fn mark_relocs(
    mut flaginfo: *mut coff_final_link_info,
    mut input_bfd: *mut bfd,
) {
    let mut a: *mut asection = 0 as *mut asection;
    if bfd_get_file_flags(input_bfd) & 0x10 as libc::c_int as libc::c_uint
        == 0 as libc::c_int as libc::c_uint
    {
        return;
    }
    a = (*input_bfd).sections;
    while !a.is_null() {
        let mut internal_relocs: *mut internal_reloc = 0 as *mut internal_reloc;
        let mut irel: *mut internal_reloc = 0 as *mut internal_reloc;
        let mut irelend: *mut internal_reloc = 0 as *mut internal_reloc;
        if !((*a).flags & 0x4 as libc::c_int as libc::c_uint
            == 0 as libc::c_int as libc::c_uint
            || (*a).reloc_count < 1 as libc::c_int as libc::c_uint
            || (*a).linker_mark() as libc::c_int == 0 as libc::c_int)
        {
            if !((*a).output_section
                == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                    as *mut asection)
            {
                internal_relocs = _bfd_coff_read_internal_relocs(
                    ...
                    (*(*flaginfo).info).type_0() as libc::c_int
                        == type_relocatable as libc::c_int,
                    if (*(*flaginfo).info).type_0() as libc::c_int
                        == type_relocatable as libc::c_int
                    {
                        ((*((*flaginfo).section_info)
                            .offset((*(*a).output_section).target_index as isize))
                            .relocs)
                            .offset((*(*a).output_section).reloc_count as isize)
                    } else {
                ...
                if !internal_relocs.is_null() {
                    ...
                    irelend = irel.offset((*a).reloc_count as isize);
                    while irel < irelend {
                        if ((*irel).r_symndx as libc::c_ulong)
                            < (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
                        {
                            *((*flaginfo).sym_indices)
                                .offset(
                                    (*irel).r_symndx as isize,
                                ) = -(1 as libc::c_int) as libc::c_long;
                        }
                        irel = irel.offset(1);
                        irel;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_link_input_bfd(
    mut flaginfo: *mut coff_final_link_info,
    mut input_bfd: *mut bfd,
) -> bool {
    let mut n_tmask: libc::c_uint = (*(*input_bfd).tdata.coff_obj_data).local_n_tmask;
    let mut n_btshft: libc::c_uint = (*(*input_bfd).tdata.coff_obj_data).local_n_btshft;
    let mut adjust_symndx: Option::<
        unsafe extern "C" fn(
            *mut bfd,
            *mut bfd_link_info,
            *mut bfd,
    ...
    let mut strings: *const libc::c_char = 0 as *const libc::c_char;
    let mut syment_base: bfd_size_type = 0;
    let mut copy: bool = false;
    let mut hash: bool = false;
    let mut isymesz: bfd_size_type = 0;
    let mut osymesz: bfd_size_type = 0;
    let mut linesz: bfd_size_type = 0;
    let mut esym: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut esym_end: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut isymp: *mut internal_syment = 0 as *mut internal_syment;
    let mut secpp: *mut *mut asection = 0 as *mut *mut asection;
    let mut indexp: *mut libc::c_long = 0 as *mut libc::c_long;
    let mut output_index: libc::c_ulong = 0;
    let mut outsym: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut sym_hash: *mut *mut coff_link_hash_entry = 0
        as *mut *mut coff_link_hash_entry;
    let mut o: *mut asection = 0 as *mut asection;
    ...
    isymesz = (*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_symesz as bfd_size_type;
    osymesz = (*((*(*output_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_symesz as bfd_size_type;
    linesz = (*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_linesz as bfd_size_type;
    if !(linesz
    ...
    copy = 0 as libc::c_int != 0;
    if (*(*flaginfo).info).keep_memory() == 0 {
        copy = 1 as libc::c_int != 0;
    }
    hash = 1 as libc::c_int != 0;
    if (*(*flaginfo).info).traditional_format() != 0 {
        hash = 0 as libc::c_int != 0;
    }
    if !_bfd_coff_get_external_symbols(input_bfd) {
        return 0 as libc::c_int != 0;
    }
    esym = (*(*input_bfd).tdata.coff_obj_data).external_syms as *mut bfd_byte;
    esym_end = esym
        .offset(
            ((*(*input_bfd).tdata.coff_obj_data).raw_syment_count).wrapping_mul(isymesz)
                as isize,
        );
    ...
    if (*(*output_bfd).tdata.coff_obj_data).pe != 0
        && process_embedded_commands(output_bfd, (*flaginfo).info, input_bfd) == 0
    {
        return 0 as libc::c_int != 0;
    }
    if ((*(*flaginfo).info).strip() as libc::c_int != strip_none as libc::c_int
        || (*(*flaginfo).info).discard() as libc::c_int != discard_none as libc::c_int)
        && (*(*flaginfo).info).type_0() as libc::c_int == type_relocatable as libc::c_int
    {
        memset(
            indexp as *mut libc::c_void,
            0 as libc::c_int,
            ((*(*input_bfd).tdata.coff_obj_data).raw_syment_count)
    ...
    while esym < esym_end {
        ...
        let mut dont_skip_symbol: bool = false;
        let mut add: libc::c_int = 0;
        ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_swap_sym_in)
            .expect(
                "non-null function pointer",
            )(input_bfd, esym as *mut libc::c_void, isymp as *mut libc::c_void);
        isym = *isymp;
        classification = ((*((*(*input_bfd).xvec).backend_data
            as *mut bfd_coff_backend_data))
            ._bfd_coff_classify_symbol)
            .expect("non-null function pointer")(input_bfd, &mut isym);
        match classification as libc::c_uint {
            0 | 4 | 3 => {
                *secpp = coff_section_from_bfd_index(input_bfd, isym.n_scnum);
            }
            1 => {
                *secpp = &mut *_bfd_std_section
                    .as_mut_ptr()
                    .offset(0 as libc::c_int as isize) as *mut asection;
            }
            2 => {
            ...
            _ => {
                _bfd_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 69],
                    >(
                        b"_Bool _bfd_coff_link_input_bfd(struct coff_final_link_info *, bfd *)\0",
                    ))
                        .as_ptr(),
                );
            }
        ...
        if ((*(*flaginfo).info).strip() as libc::c_int != strip_none as libc::c_int
            || (*(*flaginfo).info).discard() as libc::c_int
                != discard_none as libc::c_int)
            && (*(*flaginfo).info).type_0() as libc::c_int
                == type_relocatable as libc::c_int
        {
            dont_skip_symbol = *indexp != 0;
        } else {
            dont_skip_symbol = 0 as libc::c_int != 0;
        }
        *indexp = -(1 as libc::c_int) as libc::c_long;
        skip = 0 as libc::c_int != 0;
        global = 0 as libc::c_int != 0;
        add = 1 as libc::c_int + isym.n_numaux as libc::c_int;
        if (*(*flaginfo).info).strip() as libc::c_int == strip_all as libc::c_int
            && !dont_skip_symbol
        {
        ...
        if !skip {
            match classification as libc::c_uint {
                0 | 1 | 4 => {
                    global = 1 as libc::c_int != 0;
                    if !(isym.n_type as libc::c_ulong & n_tmask as libc::c_ulong
                        == (2 as libc::c_int as libc::c_ulong) << n_btshft)
                    {
                        skip = 1 as libc::c_int != 0;
                    }
                }
                ...
                3 => {
                    if (*(*flaginfo).info).discard() as libc::c_int
                        == discard_all as libc::c_int && !dont_skip_symbol
                    {
                        skip = 1 as libc::c_int != 0;
                    }
                }
        ...
        if !skip && !dont_skip_symbol && isym.n_sclass as libc::c_int == 3 as libc::c_int
            && isym.n_type as libc::c_int == 0 as libc::c_int
            && isym.n_numaux as libc::c_int > 0 as libc::c_int
            && ((**secpp).output_section
                == &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
                    as *mut asection
                || bfd_section_removed_from_list(output_bfd, (**secpp).output_section)
                    as libc::c_int != 0)
        {
            skip = 1 as libc::c_int != 0;
        }
        if !skip
            && (*(*flaginfo).info).strip() as libc::c_int
                == strip_debugger as libc::c_int && !dont_skip_symbol
            && (isym.n_scnum == -(2 as libc::c_int)
                || isym.n_scnum == -(1 as libc::c_int)
                    && (isym.n_sclass as libc::c_int == 1 as libc::c_int
                        || isym.n_sclass as libc::c_int == 4 as libc::c_int
                        || isym.n_sclass as libc::c_int == 8 as libc::c_int
                        || isym.n_sclass as libc::c_int == 16 as libc::c_int
                        || isym.n_sclass as libc::c_int == 11 as libc::c_int
                        || isym.n_sclass as libc::c_int == 9 as libc::c_int
                        || isym.n_sclass as libc::c_int == 17 as libc::c_int
                        || isym.n_sclass as libc::c_int == 18 as libc::c_int
                        || isym.n_sclass as libc::c_int == 102 as libc::c_int))
        {
            skip = 1 as libc::c_int != 0;
        }
        if !skip
            && ((*(*flaginfo).info).strip() as libc::c_int == strip_some as libc::c_int
                || (*(*flaginfo).info).discard() as libc::c_int
                    == discard_l as libc::c_int)
        {
            let mut name: *const libc::c_char = 0 as *const libc::c_char;
        ...
        if !skip && (*(*flaginfo).info).traditional_format() == 0
            && (isym.n_sclass as libc::c_int == 15 as libc::c_int
                || isym.n_sclass as libc::c_int == 10 as libc::c_int
                || isym.n_sclass as libc::c_int == 12 as libc::c_int)
            && isym.n_numaux as libc::c_int == 1 as libc::c_int
        {
            let mut name_0: *const libc::c_char = 0 as *const libc::c_char;
            let mut buf_0: [libc::c_char; 9] = [0; 9];
            let mut mh: *mut coff_debug_merge_hash_entry = 0
                as *mut coff_debug_merge_hash_entry;
            let mut mt: *mut coff_debug_merge_type = 0 as *mut coff_debug_merge_type;
            ...
            let mut epp: *mut *mut coff_debug_merge_element = 0
                as *mut *mut coff_debug_merge_element;
            let mut esl: *mut bfd_byte = 0 as *mut bfd_byte;
            let mut eslend: *mut bfd_byte = 0 as *mut bfd_byte;
            let mut islp: *mut internal_syment = 0 as *mut internal_syment;
            let mut amt: size_t = 0;
            name_0 = _bfd_coff_internal_syment_name(
                input_bfd,
                &mut isym,
                buf_0.as_mut_ptr(),
            );
            ...
            if *name_0 as libc::c_int == '~' as i32
                || *name_0 as libc::c_int == '.' as i32
                || *name_0 as libc::c_int == '$' as i32
                || *name_0 as libc::c_int
                    == bfd_get_symbol_leading_char(input_bfd) as libc::c_int
                    && (*name_0.offset(1 as libc::c_int as isize) as libc::c_int
                        == '~' as i32
                        || *name_0.offset(1 as libc::c_int as isize) as libc::c_int
                            == '.' as i32
                        || *name_0.offset(1 as libc::c_int as isize) as libc::c_int
                            == '$' as i32)
            {
                name_0 = b"\0" as *const u8 as *const libc::c_char;
            }
            mh = bfd_hash_lookup(
                &mut (*flaginfo).debug_merge.root,
                name_0,
            ...
            amt = ::core::mem::size_of::<coff_debug_merge_type>() as libc::c_ulong;
            mt = bfd_alloc(input_bfd, amt) as *mut coff_debug_merge_type;
            if mt.is_null() {
                return 0 as libc::c_int != 0;
            }
            (*mt).type_class = isym.n_sclass as libc::c_int;
            ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ._bfd_coff_swap_aux_in)
                .expect(
                    "non-null function pointer",
                ...
                input_bfd,
                esym.offset(isymesz as isize) as *mut libc::c_void,
                isym.n_type as libc::c_int,
            ...
            epp = &mut (*mt).elements;
            (*mt).elements = 0 as *mut coff_debug_merge_element;
            islp = isymp.offset(2 as libc::c_int as isize);
            esl = esym
                .offset(
                    (2 as libc::c_int as libc::c_ulong).wrapping_mul(isymesz) as isize,
                );
            eslend = ((*(*input_bfd).tdata.coff_obj_data).external_syms as *mut bfd_byte)
                .offset(
                    (aux.x_sym.x_fcnary.x_fcn.x_endndx.l as libc::c_ulong)
                        .wrapping_mul(isymesz) as isize,
                );
            while esl < eslend {
                let mut elename: *const libc::c_char = 0 as *const libc::c_char;
                let mut elebuf: [libc::c_char; 9] = [0; 9];
                let mut name_copy: *mut libc::c_char = 0 as *mut libc::c_char;
                ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
                    ._bfd_coff_swap_sym_in)
                    .expect(
                        "non-null function pointer",
                    )(input_bfd, esl as *mut libc::c_void, islp as *mut libc::c_void);
                amt = ::core::mem::size_of::<coff_debug_merge_element>()
                    as libc::c_ulong;
                *epp = bfd_alloc(input_bfd, amt) as *mut coff_debug_merge_element;
                if (*epp).is_null() {
                    return 0 as libc::c_int != 0;
                }
                ...
                amt = (strlen(elename)).wrapping_add(1 as libc::c_int as libc::c_ulong);
                name_copy = bfd_alloc(input_bfd, amt) as *mut libc::c_char;
                if name_copy.is_null() {
                    return 0 as libc::c_int != 0;
                }
                strcpy(name_copy, elename);
                (**epp).name = name_copy;
                (**epp).type_0 = (*islp).n_type as libc::c_uint;
                (**epp).tagndx = 0 as libc::c_int as libc::c_long;
                if (*islp).n_numaux as libc::c_int >= 1 as libc::c_int
                    && (*islp).n_type as libc::c_int != 0 as libc::c_int
                    && (*islp).n_sclass as libc::c_int != 102 as libc::c_int
                {
                    let mut eleaux: internal_auxent = internal_auxent {
                        x_sym: C2RustUnnamed_23 {
                            x_tagndx: C2RustUnnamed_30 { l: 0 },
                            x_misc: C2RustUnnamed_28 {
                                x_lnsz: C2RustUnnamed_29 {
                    ...
                    ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
                        ...
                        input_bfd,
                        esl.offset(isymesz as isize) as *mut libc::c_void,
                        (*islp).n_type as libc::c_int,
                        (*islp).n_sclass as libc::c_int,
                        0 as libc::c_int,
                        (*islp).n_numaux as libc::c_int,
                        &mut eleaux as *mut internal_auxent as *mut libc::c_void,
                    );
                    ...
                    if indx > 0 as libc::c_int as libc::c_long
                        && indx
                            < esym
                                .offset_from(
                                    (*(*input_bfd).tdata.coff_obj_data).external_syms
                                        as *mut bfd_byte,
                                ) as libc::c_long / isymesz as libc::c_long
                    {
                        (**epp)
                            .tagndx = *((*flaginfo).sym_indices).offset(indx as isize);
                        if (**epp).tagndx < 0 as libc::c_int as libc::c_long {
                            (**epp).tagndx = 0 as libc::c_int as libc::c_long;
                        }
                    }
                }
                epp = &mut (**epp).next;
                *epp = 0 as *mut coff_debug_merge_element;
                esl = esl
                    .offset(
                        (((*islp).n_numaux as libc::c_int + 1 as libc::c_int)
                            as libc::c_ulong)
                            .wrapping_mul(isymesz) as isize,
                    );
                islp = islp
                    .offset(
                        ((*islp).n_numaux as libc::c_int + 1 as libc::c_int) as isize,
                    );
            }
            if ((*mt).elements).is_null() {
                bfd_release(input_bfd, mt as *mut libc::c_void);
            } else {
                let mut mtl: *mut coff_debug_merge_type = 0
                    as *mut coff_debug_merge_type;
                mtl = (*mh).types;
                while !mtl.is_null() {
                    let mut me: *mut coff_debug_merge_element = 0
                        as *mut coff_debug_merge_element;
                    let mut mel: *mut coff_debug_merge_element = 0
                        as *mut coff_debug_merge_element;
                    if !((*mtl).type_class != (*mt).type_class) {
                        me = (*mt).elements;
                        mel = (*mtl).elements;
                        while !me.is_null() && !mel.is_null() {
                            if strcmp((*me).name, (*mel).name) != 0 as libc::c_int
                                || (*me).type_0 != (*mel).type_0
                        ...
                        if me.is_null() && mel.is_null() {
                            break;
                        }
                    }
                    mtl = (*mtl).next;
                }
                if mtl.is_null() || (*mtl).indx as bfd_size_type >= syment_base {
                    (*mt).indx = output_index as libc::c_long;
                    (*mt).next = (*mh).types;
                    (*mh).types = mt;
                } else {
                    bfd_release(input_bfd, mt as *mut libc::c_void);
                    *indexp = (*mtl).indx;
                    add = (eslend.offset_from(esym) as libc::c_long as libc::c_ulong)
                        .wrapping_div(isymesz) as libc::c_int;
                    skip = 1 as libc::c_int != 0;
                }
            }
        }
        if !skip {
            if isym._n._n_n._n_zeroes == 0 as libc::c_int as libc::c_ulong
                && isym._n._n_n._n_offset != 0 as libc::c_int as libc::c_ulong
            {
                let mut name_1: *const libc::c_char = 0 as *const libc::c_char;
                let mut indx_0: bfd_size_type = 0;
                name_1 = _bfd_coff_internal_syment_name(
                    input_bfd,
                    &mut isym,
                ...
                indx_0 = _bfd_stringtab_add((*flaginfo).strtab, name_1, hash, copy);
                if indx_0 == -(1 as libc::c_int) as bfd_size_type {
                    return 0 as libc::c_int != 0;
                }
                isym
                    ._n
            ...
            match isym.n_sclass as libc::c_int {
                1 | 8 | 102 | 16 | 11 | 12 | 10 | 15 | 13 | 9 | 14 | 4 | 17 | 18 => {
                    current_block_170 = 1918110639124887667;
                }
                101 => {
                    if (*(*input_bfd).tdata.coff_obj_data).pe != 0
                        && memcmp(
                            (isym._n._n_name).as_mut_ptr() as *const libc::c_void,
                            b".bf\0" as *const u8 as *const libc::c_char
                                as *const libc::c_void,
                            ::core::mem::size_of::<[libc::c_char; 4]>() as libc::c_ulong,
                        ) != 0 as libc::c_int && isym.n_scnum > 0 as libc::c_int
                    {
                        isym.n_scnum = (*(**secpp).output_section).target_index;
                        current_block_170 = 1918110639124887667;
                    } else {
                        current_block_170 = 8269756632321503735;
                    }
                }
                103 => {
                    if (*flaginfo).last_file_index != -(1 as libc::c_int) as libc::c_long
                        && (*flaginfo).last_file.n_value != output_index
                    {
                        (*flaginfo).last_file.n_value = output_index;
                        if (*flaginfo).last_file_index as bfd_size_type >= syment_base {
                            ((*((*(*output_bfd).xvec).backend_data
                                as *mut bfd_coff_backend_data))
                                ._bfd_coff_swap_sym_out)
                                .expect(
                                    "non-null function pointer",
                                ...
                                ((*flaginfo).outsyms)
                                    .offset(
                                        ((*flaginfo).last_file_index as libc::c_ulong)
                                            .wrapping_sub(syment_base)
                                            .wrapping_mul(osymesz) as isize,
                                    ) as *mut libc::c_void,
                            );
                        } else {
                            let mut pos: file_ptr = 0;
                            ((*((*(*output_bfd).xvec).backend_data
                                ...
                                &mut (*flaginfo).last_file as *mut internal_syment
                                    as *mut libc::c_void,
                                outsym as *mut libc::c_void,
                            );
                            pos = (*(*output_bfd).tdata.coff_obj_data).sym_filepos;
                            pos = (pos as libc::c_ulong)
                                .wrapping_add(
                                    ((*flaginfo).last_file_index as libc::c_ulong)
                                        .wrapping_mul(osymesz),
                                ) as file_ptr as file_ptr;
                            if bfd_seek(output_bfd, pos, 0 as libc::c_int)
                                != 0 as libc::c_int
                                || bfd_bwrite(
                                    outsym as *const libc::c_void,
                                    osymesz,
                                    output_bfd,
                                ) != osymesz
                            {
                    ...
                    (*flaginfo).last_file_index = output_index as libc::c_long;
                    (*flaginfo).last_file = isym;
                    current_block_170 = 1918110639124887667;
                }
                6 | 5 | 100 | 255 | 0 | 2 | 3 | 104 | 105 | _ => {
                    current_block_170 = 8269756632321503735;
                }
            }
            match current_block_170 {
                8269756632321503735 => {
                    if isym.n_scnum > 0 as libc::c_int {
                        isym.n_scnum = (*(**secpp).output_section).target_index;
                        isym
                            .n_value = (isym.n_value as libc::c_ulong)
                            .wrapping_add((**secpp).output_offset) as bfd_vma as bfd_vma;
                        if (*(*input_bfd).tdata.coff_obj_data).pe == 0 {
                            isym
                                .n_value = (isym.n_value as libc::c_ulong)
                                .wrapping_sub((**secpp).vma) as bfd_vma as bfd_vma;
                        }
                        if (*(*(*flaginfo).output_bfd).tdata.coff_obj_data).pe == 0 {
                            isym
                                .n_value = (isym.n_value as libc::c_ulong)
                                .wrapping_add((*(**secpp).output_section).vma) as bfd_vma
                                as bfd_vma;
                        }
                    }
                }
            ...
            if (*(*flaginfo).info).task_link() as libc::c_int != 0
                && (isym.n_sclass as libc::c_int == 2 as libc::c_int
                    || (isym.n_sclass as libc::c_int == 127 as libc::c_int
                        || (*(*input_bfd).tdata.coff_obj_data).pe != 0
                            && isym.n_sclass as libc::c_int == 105 as libc::c_int))
            {
                isym.n_sclass = 3 as libc::c_int as libc::c_uchar;
            }
            ((*((*(*output_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
                ._bfd_coff_swap_sym_out)
                .expect(
            ...
            *indexp = output_index as libc::c_long;
            if global {
                let mut indx_1: libc::c_long = 0;
                ...
                indx_1 = (esym
                    ...
                    .wrapping_div(isymesz) as libc::c_long;
                h = *((*(*input_bfd).tdata.coff_obj_data).sym_hashes)
                    .offset(indx_1 as isize);
                if h.is_null() {
                    bfd_set_error(bfd_error_bad_value);
                    return 0 as libc::c_int != 0;
                }
                (*h).indx = output_index as libc::c_long;
            }
            output_index = output_index.wrapping_add(add as libc::c_ulong);
            outsym = outsym
                .offset((add as libc::c_ulong).wrapping_mul(osymesz) as isize);
        }
        esym = esym.offset((add as libc::c_ulong).wrapping_mul(isymesz) as isize);
        isymp = isymp.offset(add as isize);
        secpp = secpp.offset(1);
        secpp;
        indexp = indexp.offset(1);
        indexp;
        add -= 1;
        add;
        while add > 0 as libc::c_int {
            let fresh5 = secpp;
            secpp = secpp.offset(1);
            *fresh5 = 0 as *mut asection;
            let fresh6 = indexp;
            indexp = indexp.offset(1);
            *fresh6 = -(1 as libc::c_int) as libc::c_long;
            add -= 1;
            add;
        }
    }
    ...
    while esym < esym_end {
        ...
        add_0 = 1 as libc::c_int + (*isymp).n_numaux as libc::c_int;
        if (*indexp < 0 as libc::c_int as libc::c_long
            || (*indexp as bfd_size_type) < syment_base)
            && ((*sym_hash).is_null() || (**sym_hash).auxbfd != input_bfd)
        {
            esym = esym.offset((add_0 as libc::c_ulong).wrapping_mul(isymesz) as isize);
        } else {
            let mut h_0: *mut coff_link_hash_entry = 0 as *mut coff_link_hash_entry;
            let mut i: libc::c_int = 0;
            h_0 = 0 as *mut coff_link_hash_entry;
            if *indexp < 0 as libc::c_int as libc::c_long {
                h_0 = *sym_hash;
                if !((*isymp).n_numaux as libc::c_int == 0 as libc::c_int
                    || (*h_0).numaux as libc::c_int == 0 as libc::c_int
                    || (*h_0).numaux as libc::c_int == (*isymp).n_numaux as libc::c_int)
                {
                    bfd_assert(
                        b"cofflink.c\0" as *const u8 as *const libc::c_char,
                        1981 as libc::c_int,
            ...
            esym = esym.offset(isymesz as isize);
            if h_0.is_null() {
                outsym = outsym.offset(osymesz as isize);
            }
            i = 0 as libc::c_int;
            while i < (*isymp).n_numaux as libc::c_int && esym < esym_end {
                let mut aux_0: internal_auxent = internal_auxent {
                    x_sym: C2RustUnnamed_23 {
                        x_tagndx: C2RustUnnamed_30 { l: 0 },
                        x_misc: C2RustUnnamed_28 {
                            x_lnsz: C2RustUnnamed_29 {
                ...
                let mut auxp: *mut internal_auxent = 0 as *mut internal_auxent;
                if !h_0.is_null() && !((*h_0).aux).is_null()
                    && (*h_0).numaux as libc::c_int > i
                {
                    auxp = ((*h_0).aux).offset(i as isize);
                } else {
                    ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
                        ._bfd_coff_swap_aux_in)
                        .expect(
                        ...
                        input_bfd,
                        esym as *mut libc::c_void,
                        (*isymp).n_type as libc::c_int,
                        (*isymp).n_sclass as libc::c_int,
                        i,
                        (*isymp).n_numaux as libc::c_int,
                        &mut aux_0 as *mut internal_auxent as *mut libc::c_void,
                    );
                    auxp = &mut aux_0;
                }
                if (*isymp).n_sclass as libc::c_int == 103 as libc::c_int {
                    if (*auxp).x_file.x_n.x_zeroes == 0 as libc::c_int as libc::c_long
                        && (*auxp).x_file.x_n.x_offset
                            != 0 as libc::c_int as libc::c_long
                    {
                        let mut filename: *const libc::c_char = 0 as *const libc::c_char;
                        let mut indx_2: bfd_size_type = 0;
                        if !((*auxp).x_file.x_n.x_offset
                        ...
                        if (*auxp).x_file.x_n.x_offset as bfd_size_type
                            >= (*(*input_bfd).tdata.coff_obj_data).strings_len
                        {
                            filename = dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                            ...
                            filename = strings
                                .offset((*auxp).x_file.x_n.x_offset as isize);
                        }
                        indx_2 = _bfd_stringtab_add(
                            (*flaginfo).strtab,
                            filename,
                            hash,
                            copy,
                        );
                        if indx_2 == -(1 as libc::c_int) as bfd_size_type {
                            return 0 as libc::c_int != 0;
                        }
                        (*auxp)
                            .x_file
                            .x_n
                            .x_offset = (4 as libc::c_int as libc::c_ulong)
                            .wrapping_add(indx_2) as libc::c_long;
                    }
                } else if ((*isymp).n_sclass as libc::c_int != 3 as libc::c_int
                    || (*isymp).n_type as libc::c_int != 0 as libc::c_int)
                    && (*isymp).n_sclass as libc::c_int != 105 as libc::c_int
                {
                    let mut indx_3: libc::c_ulong = 0;
                    if (*isymp).n_type as libc::c_ulong & n_tmask as libc::c_ulong
                        == (2 as libc::c_int as libc::c_ulong) << n_btshft
                        || ((*isymp).n_sclass as libc::c_int == 10 as libc::c_int
                            || (*isymp).n_sclass as libc::c_int == 12 as libc::c_int
                            || (*isymp).n_sclass as libc::c_int == 15 as libc::c_int)
                        || (*isymp).n_sclass as libc::c_int == 100 as libc::c_int
                        || (*isymp).n_sclass as libc::c_int == 101 as libc::c_int
                    {
                        indx_3 = (*auxp).x_sym.x_fcnary.x_fcn.x_endndx.l
                            as libc::c_ulong;
                        if indx_3 > 0 as libc::c_int as libc::c_ulong
                            && indx_3
                                < (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
                        {
                            while (*((*flaginfo).sym_indices).offset(indx_3 as isize)
                                < 0 as libc::c_int as libc::c_long
                                || (*((*flaginfo).sym_indices).offset(indx_3 as isize)
                                    as bfd_size_type) < syment_base)
                                && indx_3
                                    < (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
                            {
                                indx_3 = indx_3.wrapping_add(1);
                                indx_3;
                            }
                            if indx_3
                                >= (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
                            {
                                ...
                                indx_3 = *((*flaginfo).sym_indices).offset(indx_3 as isize)
                                    as libc::c_ulong;
                            }
                            (*auxp)
                                .x_sym
                                ...
                                .x_fcn
                                .x_endndx
                                .l = indx_3 as libc::c_long;
                        }
                    }
                    indx_3 = (*auxp).x_sym.x_tagndx.l as libc::c_ulong;
                    if indx_3 > 0 as libc::c_int as libc::c_ulong
                        && indx_3 < (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
                    {
                        let mut symindx: libc::c_long = 0;
                        symindx = *((*flaginfo).sym_indices).offset(indx_3 as isize);
                        if symindx < 0 as libc::c_int as libc::c_long {
                            (*auxp).x_sym.x_tagndx.l = 0 as libc::c_int as libc::c_long;
                        } else {
                            (*auxp).x_sym.x_tagndx.l = symindx;
                        }
                    }
                    if i == 0 as libc::c_int && h_0.is_null()
                        && (*isymp).n_sclass as libc::c_int == 101 as libc::c_int
                        && ((*isymp)._n._n_n._n_zeroes
                            != 0 as libc::c_int as libc::c_ulong
                            || (*isymp)._n._n_n._n_offset
                                == 0 as libc::c_int as libc::c_ulong)
                        && (*isymp)._n._n_name[0 as libc::c_int as usize] as libc::c_int
                            == '.' as i32
                        && (*isymp)._n._n_name[1 as libc::c_int as usize] as libc::c_int
                            == 'b' as i32
                        && (*isymp)._n._n_name[2 as libc::c_int as usize] as libc::c_int
                            == 'f' as i32
                        && (*isymp)._n._n_name[3 as libc::c_int as usize] as libc::c_int
                            == '\0' as i32
                    {
                        if (*flaginfo).last_bf_index
                            != -(1 as libc::c_int) as libc::c_long
                        {
                            (*flaginfo)
                                .last_bf
                                ...
                                .x_endndx
                                .l = *indexp;
                            if (*flaginfo).last_bf_index as bfd_size_type >= syment_base
                            {
                                let mut auxout: *mut libc::c_void = 0 as *mut libc::c_void;
                                auxout = ((*flaginfo).outsyms)
                                    .offset(
                                        ((*flaginfo).last_bf_index as libc::c_ulong)
                                            .wrapping_sub(syment_base)
                                            .wrapping_mul(osymesz) as isize,
                                    ) as *mut libc::c_void;
                                ((*((*(*output_bfd).xvec).backend_data
                                    ...
                                    output_bfd,
                                    &mut (*flaginfo).last_bf as *mut internal_auxent
                                        as *mut libc::c_void,
                                    (*isymp).n_type as libc::c_int,
                                    (*isymp).n_sclass as libc::c_int,
                                    0 as libc::c_int,
                                ...
                                pos_0 = (*(*output_bfd).tdata.coff_obj_data).sym_filepos;
                                pos_0 = (pos_0 as libc::c_ulong)
                                    .wrapping_add(
                                        ((*flaginfo).last_bf_index as libc::c_ulong)
                                            .wrapping_mul(osymesz),
                                    ) as file_ptr as file_ptr;
                                if bfd_seek(output_bfd, pos_0, 0 as libc::c_int)
                                    != 0 as libc::c_int
                                    || bfd_bwrite(
                                        outsym as *const libc::c_void,
                                        osymesz,
                        ...
                        if (*auxp).x_sym.x_fcnary.x_fcn.x_endndx.l
                            != 0 as libc::c_int as libc::c_long
                        {
                            (*flaginfo)
                                .last_bf_index = -(1 as libc::c_int) as libc::c_long;
                        } else {
                            (*flaginfo).last_bf = *auxp;
                            (*flaginfo)
                                .last_bf_index = (outsym.offset_from((*flaginfo).outsyms)
                                as libc::c_long as libc::c_ulong)
                                .wrapping_div(osymesz)
                                .wrapping_add(syment_base) as libc::c_long;
                        }
                    }
                }
                if h_0.is_null() {
        ...
        indexp = indexp.offset(add_0 as isize);
        isymp = isymp.offset(add_0 as isize);
        sym_hash = sym_hash.offset(add_0 as isize);
    }
    if (*(*flaginfo).info).strip() as libc::c_int == strip_none as libc::c_int
        || (*(*flaginfo).info).strip() as libc::c_int == strip_some as libc::c_int
    {
        ...
        while !o.is_null() {
            ...
            let mut eline: *mut bfd_byte = 0 as *mut bfd_byte;
            let mut elineend: *mut bfd_byte = 0 as *mut bfd_byte;
            let mut oeline: *mut bfd_byte = 0 as *mut bfd_byte;
            let mut skipping: bool = false;
            let mut pos_1: file_ptr = 0;
            let mut amt_0: bfd_size_type = 0;
            if !((*o).lineno_count == 0 as libc::c_int as libc::c_uint
                || (*(*o).output_section).flags & 0x100 as libc::c_int as libc::c_uint
                    == 0 as libc::c_int as libc::c_uint)
            {
                if bfd_seek(input_bfd, (*o).line_filepos, 0 as libc::c_int)
                    != 0 as libc::c_int
                    || bfd_bread(
                        (*flaginfo).linenos as *mut libc::c_void,
                        linesz.wrapping_mul((*o).lineno_count as libc::c_ulong),
                        input_bfd,
                    ) != linesz.wrapping_mul((*o).lineno_count as libc::c_ulong)
                {
                    return 0 as libc::c_int != 0;
                ...
                elineend = eline
                    .offset(
                        linesz.wrapping_mul((*o).lineno_count as libc::c_ulong) as isize,
                    );
                skipping = 0 as libc::c_int != 0;
                while eline < elineend {
                    let mut iline: internal_lineno = internal_lineno {
                    ...
                    ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
                        ...
                        input_bfd,
                        eline as *mut libc::c_void,
                        &mut iline as *mut internal_lineno as *mut libc::c_void,
                    );
                    if iline.l_lnno != 0 as libc::c_int as libc::c_ulong {
                        iline
                            .l_addr
                            .l_paddr = (iline.l_addr.l_paddr as libc::c_ulong)
                            .wrapping_add(offset) as bfd_signed_vma as bfd_signed_vma;
                    } else if iline.l_addr.l_symndx >= 0 as libc::c_int as libc::c_long
                        && (iline.l_addr.l_symndx as libc::c_ulong)
                            < (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
                    {
                        let mut indx_4: libc::c_long = 0;
                        indx_4 = *((*flaginfo).sym_indices)
                            .offset(iline.l_addr.l_symndx as isize);
                        if indx_4 < 0 as libc::c_int as libc::c_long {
                            skipping = 1 as libc::c_int != 0;
                        } else {
                            let mut is: internal_syment = internal_syment {
                                _n: C2RustUnnamed_17 {
                                    _n_name: [0; 8],
                                },
                                n_value: 0,
                            ...
                            let mut ia: internal_auxent = internal_auxent {
                                x_sym: C2RustUnnamed_23 {
                                    x_tagndx: C2RustUnnamed_30 { l: 0 },
                                    x_misc: C2RustUnnamed_28 {
                                        x_lnsz: C2RustUnnamed_29 {
                            ...
                            ((*((*(*output_bfd).xvec).backend_data
                                ...
                                ((*flaginfo).outsyms)
                                    .offset(
                                        (indx_4 as libc::c_ulong)
                                            .wrapping_sub(syment_base)
                                            .wrapping_mul(osymesz) as isize,
                                    ) as *mut libc::c_void,
                                &mut is as *mut internal_syment as *mut libc::c_void,
                            );
                            if (is.n_type as libc::c_ulong & n_tmask as libc::c_ulong
                                == (2 as libc::c_int as libc::c_ulong) << n_btshft
                                || is.n_sclass as libc::c_int == 100 as libc::c_int)
                                && is.n_numaux as libc::c_int >= 1 as libc::c_int
                            {
                                let mut auxptr: *mut libc::c_void = 0 as *mut libc::c_void;
                                ...
                                ((*((*(*output_bfd).xvec).backend_data
                                    ...
                                    output_bfd,
                                    auxptr,
                                    is.n_type as libc::c_int,
                                    is.n_sclass as libc::c_int,
                                    0 as libc::c_int,
                                    is.n_numaux as libc::c_int,
                                    &mut ia as *mut internal_auxent as *mut libc::c_void,
                                );
                                ia
                                    .x_sym
                                    .x_fcnary
                                    ...
                                    .x_lnnoptr = eline
                                    .offset(
                                        ((*(*o).output_section).line_filepos as libc::c_ulong)
                                            .wrapping_add(
                                                ((*(*o).output_section).lineno_count as libc::c_ulong)
                                                    .wrapping_mul(linesz),
                                            ) as isize,
                                    )
                                    .offset_from((*flaginfo).linenos) as libc::c_long;
                                ((*((*(*output_bfd).xvec).backend_data
                                    as *mut bfd_coff_backend_data))
                                    ._bfd_coff_swap_aux_out)
                                    .expect(
                        ...
                        iline.l_addr.l_symndx = indx_4;
                    }
                    if !skipping {
                        ((*((*(*output_bfd).xvec).backend_data
                            as *mut bfd_coff_backend_data))
                            ._bfd_coff_swap_lineno_out)
                            .expect(
                                "non-null function pointer",
                            )(
                            output_bfd,
                            &mut iline as *mut internal_lineno as *mut libc::c_void,
                            oeline as *mut libc::c_void,
                        );
                        oeline = oeline.offset(linesz as isize);
                    }
                    eline = eline.offset(linesz as isize);
                }
                pos_1 = (*(*o).output_section).line_filepos;
                pos_1 = (pos_1 as libc::c_ulong)
                    .wrapping_add(
                        ((*(*o).output_section).lineno_count as libc::c_ulong)
                            .wrapping_mul(linesz),
                    ) as file_ptr as file_ptr;
                amt_0 = oeline.offset_from((*flaginfo).linenos) as libc::c_long
                    as bfd_size_type;
                if bfd_seek(output_bfd, pos_1, 0 as libc::c_int) != 0 as libc::c_int
                    || bfd_bwrite(
                        (*flaginfo).linenos as *const libc::c_void,
                        amt_0,
                        output_bfd,
                    ) != amt_0
                {
                ...
                (*(*o).output_section)
                    .lineno_count = ((*(*o).output_section).lineno_count
                    as libc::c_ulong)
                    .wrapping_add(amt_0.wrapping_div(linesz)) as libc::c_uint
                    as libc::c_uint;
            }
            o = (*o).next;
        }
    ...
    if (*flaginfo).last_file_index != -(1 as libc::c_int) as libc::c_long
        && (*flaginfo).last_file_index as bfd_size_type >= syment_base
    {
        (*flaginfo).last_file.n_value = output_index;
        ((*((*(*output_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_swap_sym_out)
            ...
            output_bfd,
            &mut (*flaginfo).last_file as *mut internal_syment as *mut libc::c_void,
            ((*flaginfo).outsyms)
                .offset(
                    ((*flaginfo).last_file_index as libc::c_ulong)
                        .wrapping_sub(syment_base)
    ...
    if outsym > (*flaginfo).outsyms {
        let mut pos_2: file_ptr = 0;
        let mut amt_1: bfd_size_type = 0;
        pos_2 = ((*(*output_bfd).tdata.coff_obj_data).sym_filepos as libc::c_ulong)
            .wrapping_add(syment_base.wrapping_mul(osymesz)) as file_ptr;
        amt_1 = outsym.offset_from((*flaginfo).outsyms) as libc::c_long as bfd_size_type;
        if bfd_seek(output_bfd, pos_2, 0 as libc::c_int) != 0 as libc::c_int
            || bfd_bwrite((*flaginfo).outsyms as *const libc::c_void, amt_1, output_bfd)
                != amt_1
        {
            return 0 as libc::c_int != 0;
        }
        if !(((*(*output_bfd).tdata.coff_obj_data).raw_syment_count)
            .wrapping_add(
                (outsym.offset_from((*flaginfo).outsyms) as libc::c_long
                    as libc::c_ulong)
                    .wrapping_div(osymesz),
            ) == output_index)
        {
    ...
    adjust_symndx = (*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_adjust_symndx;
    o = (*input_bfd).sections;
    while !o.is_null() {
        let mut contents: *mut bfd_byte = 0 as *mut bfd_byte;
        let mut secdata: *mut coff_section_tdata = 0 as *mut coff_section_tdata;
        if !((*o).linker_mark() == 0) {
                            ...
                            == 0 as libc::c_int as libc::c_uint
                {
                        ...
                        && (*o).reloc_count != 0 as libc::c_int as libc::c_uint
                    {
                        _bfd_error_handler(
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"%pB: relocs in section `%pA', but it has no contents\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            input_bfd,
                    ...
                    secdata = (*o).used_by_bfd as *mut coff_section_tdata;
                    if !secdata.is_null() && !((*secdata).contents).is_null() {
                    ...
                    if (*o).flags & 0x4 as libc::c_int as libc::c_uint
                        != 0 as libc::c_int as libc::c_uint
                    {
                        let mut target_index: libc::c_int = 0;
                        let mut internal_relocs: *mut internal_reloc = 0
                            as *mut internal_reloc;
                        let mut irel: *mut internal_reloc = 0 as *mut internal_reloc;
                        ...
                        internal_relocs = _bfd_coff_read_internal_relocs(
                            ...
                            if (*(*flaginfo).info).type_0() as libc::c_int
                                == type_relocatable as libc::c_int
                            {
                                ((*((*flaginfo).section_info).offset(target_index as isize))
                                    .relocs)
                                    .offset((*(*o).output_section).reloc_count as isize)
                            } else {
                                (*flaginfo).internal_relocs
                            },
                        );
                        ...
                        irel = internal_relocs;
                        while irel
                            < &mut *internal_relocs.offset((*o).reloc_count as isize)
                                as *mut internal_reloc
                        {
                            let mut h_1: *mut coff_link_hash_entry = 0
                                as *mut coff_link_hash_entry;
                            let mut ps: *mut asection = 0 as *mut asection;
                            let mut symndx: libc::c_long = (*irel).r_symndx;
                            if !(symndx < 0 as libc::c_int as libc::c_long) {
                                h_1 = *((*(*input_bfd).tdata.coff_obj_data).sym_hashes)
                                    .offset(symndx as isize);
                                if !h_1.is_null() {
                                    while ((*h_1).root).type_0() as libc::c_int
                                        == bfd_link_hash_indirect as libc::c_int
                                        || ((*h_1).root).type_0() as libc::c_int
                                            == bfd_link_hash_warning as libc::c_int
                                    {
                                        h_1 = (*h_1).root.u.i.link as *mut coff_link_hash_entry;
                                    }
                                    if ((*h_1).root).type_0() as libc::c_int
                                        ...
                                        || ((*h_1).root).type_0() as libc::c_int
                                            == bfd_link_hash_defweak as libc::c_int
                                    {
                                        ps = (*h_1).root.u.def.section;
                                    }
                                    if !ps.is_null() {
                                        if (*ps).flags & 0x8000 as libc::c_int as libc::c_uint != 0
                                        {
                                            (Some(
                        ...
                        if !((*((*(*input_bfd).xvec).backend_data
                            as *mut bfd_coff_backend_data))
                        ...
                        if (*(*flaginfo).info).type_0() as libc::c_int
                            == type_relocatable as libc::c_int
                        {
                            let mut offset_0: bfd_vma = 0;
                            let mut irelend: *mut internal_reloc = 0
                                as *mut internal_reloc;
                            let mut rel_hash: *mut *mut coff_link_hash_entry = 0
                                as *mut *mut coff_link_hash_entry;
                            offset_0 = ((*(*o).output_section).vma)
                                .wrapping_add((*o).output_offset)
                                .wrapping_sub((*o).vma);
                            irel = internal_relocs;
                            irelend = irel.offset((*o).reloc_count as isize);
                            rel_hash = ((*((*flaginfo).section_info)
                                ...
                                .rel_hashes)
                                .offset((*(*o).output_section).reloc_count as isize);
                            let mut current_block_410: u64;
                            while irel < irelend {
                                let mut h_2: *mut coff_link_hash_entry = 0
                                    as *mut coff_link_hash_entry;
                                let mut adjusted: bool = false;
                                *rel_hash = 0 as *mut coff_link_hash_entry;
                                (*irel)
                                    .r_vaddr = ((*irel).r_vaddr as libc::c_ulong)
                                    .wrapping_add(offset_0) as bfd_vma as bfd_vma;
                                if !((*irel).r_symndx
                                    == -(1 as libc::c_int) as libc::c_long)
                                {
                                    if adjust_symndx.is_some() {
                                        if !(Some(
                                            adjust_symndx.expect("non-null function pointer"),
                                        ))
                                            .expect(
                                                "non-null function pointer",
                                            )(
                                        ...
                                        if adjusted {
                                            current_block_410 = 15478008354622132490;
                                        } else {
                                            current_block_410 = 7061416042599702421;
                                        }
                                    } else {
                                        current_block_410 = 7061416042599702421;
                                    }
                                    match current_block_410 {
                                        15478008354622132490 => {}
                                        _ => {
                                            h_2 = *((*(*input_bfd).tdata.coff_obj_data).sym_hashes)
                                                .offset((*irel).r_symndx as isize);
                                            if !h_2.is_null() {
                                                if (*h_2).indx >= 0 as libc::c_int as libc::c_long {
                                                    (*irel).r_symndx = (*h_2).indx;
                                                } else {
                                                    *rel_hash = h_2;
                                                    (*h_2).indx = -(2 as libc::c_int) as libc::c_long;
                                                }
                                            } else {
                                                let mut indx_5: libc::c_long = 0;
                                                indx_5 = *((*flaginfo).sym_indices)
                                                    .offset((*irel).r_symndx as isize);
                                                if indx_5 != -(1 as libc::c_int) as libc::c_long {
                                                    (*irel).r_symndx = indx_5;
                                                } else {
                                                    let mut is_0: *mut internal_syment = 0
                                                        as *mut internal_syment;
                                                    let mut name_2: *const libc::c_char = 0
                                                        as *const libc::c_char;
                                                    let mut buf_1: [libc::c_char; 9] = [0; 9];
                                                    is_0 = ((*flaginfo).internal_syms)
                                                        .offset((*irel).r_symndx as isize);
                                                    name_2 = _bfd_coff_internal_syment_name(
                                                        input_bfd,
                                                        is_0,
                                                        buf_1.as_mut_ptr(),
                                                    );
                                                    ...
                                                    (Some(
                                                        ...
                                                        .expect(
                                                            "non-null function pointer",
                                                        )((*flaginfo).info, name_2, input_bfd, o, (*irel).r_vaddr);
                                                }
                                            }
                                        }
                                    }
                            ...
                            (*(*o).output_section)
                                .reloc_count = ((*(*o).output_section).reloc_count)
                                .wrapping_add((*o).reloc_count);
                        }
                    }
                    if secdata.is_null() || ((*secdata).stab_info).is_null() {
                        let mut loc: file_ptr = ((*o).output_offset)
                            .wrapping_mul(
                                bfd_octets_per_byte(output_bfd, o) as libc::c_ulong,
                            ) as file_ptr;
                    ...
                    } else if !_bfd_write_section_stabs(
                        output_bfd,
                        &mut (*((*(*flaginfo).info).hash as *mut coff_link_hash_table))
                            .stab_info,
                        o,
                        &mut (*secdata).stab_info,
                        contents,
    ...
    if (*(*flaginfo).info).keep_memory() == 0 && !_bfd_coff_free_symbols(input_bfd) {
        return 0 as libc::c_int != 0;
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_write_global_sym(
    mut bh: *mut bfd_hash_entry,
    mut data: *mut libc::c_void,
) -> bool {
    let mut h: *mut coff_link_hash_entry = bh as *mut coff_link_hash_entry;
    let mut flaginfo: *mut coff_final_link_info = data as *mut coff_final_link_info;
    let mut output_bfd: *mut bfd = 0 as *mut bfd;
    let mut isym: internal_syment = internal_syment {
        _n: C2RustUnnamed_17 {
            _n_name: [0; 8],
    ...
    if (*h).indx >= 0 as libc::c_int as libc::c_long {
        return 1 as libc::c_int != 0;
    }
    if (*h).indx != -(2 as libc::c_int) as libc::c_long
        && ((*(*flaginfo).info).strip() as libc::c_int == strip_all as libc::c_int
            || (*(*flaginfo).info).strip() as libc::c_int == strip_some as libc::c_int
                && (bfd_hash_lookup(
                    (*(*flaginfo).info).keep_hash,
                    (*h).root.root.string,
    ...
    match ((*h).root).type_0() as libc::c_int {
        1 => {
            ...
            current_block_31 = 8202393673878014038;
        }
        2 => {
            current_block_31 = 8202393673878014038;
        }
        3 | 4 => {
            ...
            isym
                .n_value = ((*h).root.u.def.value)
                .wrapping_add((*(*h).root.u.def.section).output_offset);
            if (*(*(*flaginfo).output_bfd).tdata.coff_obj_data).pe == 0 {
                isym
                    .n_value = (isym.n_value as libc::c_ulong).wrapping_add((*sec).vma)
                    as bfd_vma as bfd_vma;
            }
            if isym.n_value > 0xffffffff as libc::c_uint as bfd_vma {
                if ((*h).root).linker_def() == 0 {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB: stripping non-representable symbol '%s' (value %lx)\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        output_bfd,
            ...
            current_block_31 = 11932355480408055363;
        }
        5 => {
            isym.n_scnum = 0 as libc::c_int;
        ...
        0 | 7 | _ => {
            _bfd_abort(
                ...
                (*::core::mem::transmute::<
                    ...
                    &[libc::c_char; 66],
                >(
                    b"_Bool _bfd_coff_write_global_sym(struct bfd_hash_entry *, void *)\0",
                ))
                    .as_ptr(),
            );
        }
    ...
    match current_block_31 {
        8202393673878014038 => {
            isym.n_scnum = 0 as libc::c_int;
            isym.n_value = 0 as libc::c_int as bfd_vma;
        }
        _ => {}
    }
    if strlen((*h).root.root.string) <= 8 as libc::c_int as libc::c_ulong {
        strncpy(
            (isym._n._n_name).as_mut_ptr(),
            (*h).root.root.string,
        ...
        if indx == -(1 as libc::c_int) as bfd_size_type {
            (*flaginfo).failed = 1 as libc::c_int != 0;
            return 0 as libc::c_int != 0;
        }
        isym._n._n_n._n_zeroes = 0 as libc::c_int as bfd_hostptr_t;
        isym._n._n_n._n_offset = (4 as libc::c_int as libc::c_ulong).wrapping_add(indx);
    }
    isym.n_sclass = (*h).symbol_class;
    isym.n_type = (*h).type_0;
    if isym.n_sclass as libc::c_int == 0 as libc::c_int {
        isym.n_sclass = 2 as libc::c_int as libc::c_uchar;
    }
    if (*flaginfo).global_to_static {
        if !(isym.n_sclass as libc::c_int == 2 as libc::c_int
            || (isym.n_sclass as libc::c_int == 127 as libc::c_int
                || (*(*output_bfd).tdata.coff_obj_data).pe != 0
                    && isym.n_sclass as libc::c_int == 105 as libc::c_int))
        {
            return 1 as libc::c_int != 0;
        }
    ...
    if !((*(*flaginfo).info).type_0() as libc::c_int == type_dll as libc::c_int
        || (*(*flaginfo).info).type_0() as libc::c_int == type_pie as libc::c_int)
        && !((*(*flaginfo).info).type_0() as libc::c_int
            == type_relocatable as libc::c_int)
        && (isym.n_sclass as libc::c_int == 127 as libc::c_int
            || (*(*(*flaginfo).output_bfd).tdata.coff_obj_data).pe != 0
                && isym.n_sclass as libc::c_int == 105 as libc::c_int)
    {
        isym.n_sclass = 2 as libc::c_int as libc::c_uchar;
    }
    isym.n_numaux = (*h).numaux as libc::c_uchar;
    ((*((*(*output_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_coff_swap_sym_out)
        .expect(
            "non-null function pointer",
    ...
    symesz = (*((*(*output_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
        ._bfd_symesz as bfd_size_type;
    pos = (*(*output_bfd).tdata.coff_obj_data).sym_filepos;
    pos = (pos as libc::c_ulong)
        .wrapping_add(
            ((*(*output_bfd).tdata.coff_obj_data).raw_syment_count).wrapping_mul(symesz),
        ) as file_ptr as file_ptr;
    if bfd_seek(output_bfd, pos, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bwrite((*flaginfo).outsyms as *const libc::c_void, symesz, output_bfd)
            != symesz
    {
        (*flaginfo).failed = 1 as libc::c_int != 0;
        return 0 as libc::c_int != 0;
    }
    (*h).indx = (*(*output_bfd).tdata.coff_obj_data).raw_syment_count as libc::c_long;
    (*(*output_bfd).tdata.coff_obj_data)
        .raw_syment_count = ((*(*output_bfd).tdata.coff_obj_data).raw_syment_count)
        .wrapping_add(1);
    (*(*output_bfd).tdata.coff_obj_data).raw_syment_count;
    i = 0 as libc::c_int as libc::c_uint;
    while i < isym.n_numaux as libc::c_uint {
        let mut auxp: *mut internal_auxent = 0 as *mut internal_auxent;
        auxp = ((*h).aux).offset(i as isize);
        if i == 0 as libc::c_int as libc::c_uint
            && (isym.n_sclass as libc::c_int == 3 as libc::c_int
                || isym.n_sclass as libc::c_int == 106 as libc::c_int)
            && isym.n_type as libc::c_int == 0 as libc::c_int
                    ...
                    == bfd_link_hash_defweak as libc::c_int)
        {
            ...
            sec_0 = (*(*h).root.u.def.section).output_section;
            if !sec_0.is_null() {
                (*auxp).x_scn.x_scnlen = (*sec_0).size as libc::c_long;
                if (*sec_0).reloc_count > 0xffff as libc::c_int as libc::c_uint
                    && ((*(*output_bfd).tdata.coff_obj_data).pe == 0
                        || (*(*flaginfo).info).type_0() as libc::c_int
                            == type_relocatable as libc::c_int)
                {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB: %pA: reloc overflow: %#x > 0xffff\0" as *const u8
                                as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        output_bfd,
                ...
                if (*sec_0).lineno_count > 0xffff as libc::c_int as libc::c_uint
                    && ((*(*output_bfd).tdata.coff_obj_data).pe == 0
                        || (*(*flaginfo).info).type_0() as libc::c_int
                            == type_relocatable as libc::c_int)
                {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB: warning: %pA: line number overflow: %#x > 0xffff\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        output_bfd,
                ...
                (*auxp).x_scn.x_nreloc = (*sec_0).reloc_count as libc::c_ushort;
                (*auxp).x_scn.x_nlinno = (*sec_0).lineno_count as libc::c_ushort;
                (*auxp).x_scn.x_checksum = 0 as libc::c_int as libc::c_ulong;
                (*auxp).x_scn.x_associated = 0 as libc::c_int as libc::c_ushort;
                (*auxp).x_scn.x_comdat = 0 as libc::c_int as libc::c_uchar;
            }
        }
        ((*((*(*output_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_swap_aux_out)
        ...
        if bfd_bwrite((*flaginfo).outsyms as *const libc::c_void, symesz, output_bfd)
            != symesz
        {
            (*flaginfo).failed = 1 as libc::c_int != 0;
            return 0 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_write_task_globals(
    mut h: *mut coff_link_hash_entry,
    mut data: *mut libc::c_void,
) -> bool {
    let mut flaginfo: *mut coff_final_link_info = data as *mut coff_final_link_info;
    let mut rtnval: bool = 1 as libc::c_int != 0;
    let mut save_global_to_static: bool = false;
    if ((*h).root).type_0() as libc::c_int == bfd_link_hash_warning as libc::c_int {
        h = (*h).root.u.i.link as *mut coff_link_hash_entry;
    }
    if (*h).indx < 0 as libc::c_int as libc::c_long {
        match ((*h).root).type_0() as libc::c_int {
            3 | 4 => {
                ...
                (*flaginfo).global_to_static = 1 as libc::c_int != 0;
                rtnval = _bfd_coff_write_global_sym(&mut (*h).root.root, data);
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_reloc_link_order(
    mut output_bfd: *mut bfd,
    mut flaginfo: *mut coff_final_link_info,
    ...
    let mut irel: *mut internal_reloc = 0 as *mut internal_reloc;
    let mut rel_hash_ptr: *mut *mut coff_link_hash_entry = 0
        as *mut *mut coff_link_hash_entry;
    ...
    if (*(*link_order).u.reloc.p).addend != 0 as libc::c_int as libc::c_ulong {
        ...
        rstat = _bfd_relocate_contents(
            howto,
            output_bfd,
            (*(*link_order).u.reloc.p).addend,
            buf,
        );
        match rstat as libc::c_uint {
            ...
            3 => {
                (Some(
                    ...
                    (*howto).name,
                    (*(*link_order).u.reloc.p).addend,
                    0 as *mut libc::c_void as *mut bfd,
                    0 as *mut libc::c_void as *mut asection,
            ...
            4 | _ => {
                _bfd_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 108],
                    >(
                        b"_Bool _bfd_coff_reloc_link_order(bfd *, struct coff_final_link_info *, asection *, struct bfd_link_order *)\0",
                    ))
                        .as_ptr(),
                );
            }
        }
        loc = ((*link_order).offset)
            .wrapping_mul(
    ...
    irel = ((*((*flaginfo).section_info).offset((*output_section).target_index as isize))
        .relocs)
        .offset((*output_section).reloc_count as isize);
    rel_hash_ptr = ((*((*flaginfo).section_info)
        .offset((*output_section).target_index as isize))
        .rel_hashes)
        .offset((*output_section).reloc_count as isize);
    memset(
        irel as *mut libc::c_void,
    ...
    *rel_hash_ptr = 0 as *mut coff_link_hash_entry;
    (*irel).r_vaddr = ((*output_section).vma).wrapping_add((*link_order).offset);
    if (*link_order).type_0 as libc::c_uint
        == bfd_section_reloc_link_order as libc::c_int as libc::c_uint
    {
        _bfd_abort(
        ...
        if !h.is_null() {
            if (*h).indx >= 0 as libc::c_int as libc::c_long {
                ...
                *rel_hash_ptr = h;
                (*irel).r_symndx = 0 as libc::c_int as libc::c_long;
            }
        } else {
            (Some(
                ((*(*(*flaginfo).info).callbacks).unattached_reloc)
    ...
    (*irel).r_type = (*howto).type_0 as libc::c_ushort;
    (*output_section).reloc_count = ((*output_section).reloc_count).wrapping_add(1);
    (*output_section).reloc_count;
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_coff_generic_relocate_section(
    mut output_bfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut input_bfd: *mut bfd,
    ...
    let mut rel: *mut internal_reloc = 0 as *mut internal_reloc;
    let mut relend: *mut internal_reloc = 0 as *mut internal_reloc;
    rel = relocs;
    relend = rel.offset((*input_section).reloc_count as isize);
    let mut current_block_76: u64;
    while rel < relend {
        let mut symndx: libc::c_long = 0;
        let mut h: *mut coff_link_hash_entry = 0 as *mut coff_link_hash_entry;
        let mut sym: *mut internal_syment = 0 as *mut internal_syment;
        ...
        let mut rstat: bfd_reloc_status_type = 0 as bfd_reloc_status_type;
        symndx = (*rel).r_symndx;
        if symndx == -(1 as libc::c_int) as libc::c_long {
            h = 0 as *mut coff_link_hash_entry;
            sym = 0 as *mut internal_syment;
        } else if symndx < 0 as libc::c_int as libc::c_long
            || symndx as libc::c_ulong
                >= (*(*input_bfd).tdata.coff_obj_data).raw_syment_count
        {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB: illegal symbol index %ld in relocs\0" as *const u8
                        as *const libc::c_char,
                    5 as libc::c_int,
                ),
                input_bfd,
            ...
            h = *((*(*input_bfd).tdata.coff_obj_data).sym_hashes)
                .offset(symndx as isize);
            sym = syms.offset(symndx as isize);
        }
        if !sym.is_null() && (*sym).n_scnum != 0 as libc::c_int {
            addend = ((*sym).n_value).wrapping_neg();
        } else {
            addend = 0 as libc::c_int as bfd_vma;
        }
        howto = ((*((*(*input_bfd).xvec).backend_data as *mut bfd_coff_backend_data))
            ._bfd_coff_rtype_to_howto)
            .expect(
                "non-null function pointer",
            )(input_bfd, input_section, rel, h, sym, &mut addend);
        if howto.is_null() {
            return 0 as libc::c_int != 0;
        }
        if (*howto).pc_relative() as libc::c_int != 0
            && (*howto).pcrel_offset() as libc::c_int != 0
        {
            if (*info).type_0() as libc::c_int == type_relocatable as libc::c_int {
                current_block_76 = 14916268686031723178;
            } else {
                if !sym.is_null() && (*sym).n_scnum != 0 as libc::c_int {
                    addend = (addend as libc::c_ulong).wrapping_add((*sym).n_value)
                        as bfd_vma as bfd_vma;
                }
                current_block_76 = 5634871135123216486;
            }
        } else {
            current_block_76 = 5634871135123216486;
        }
        match current_block_76 {
            5634871135123216486 => {
                val = 0 as libc::c_int as bfd_vma;
                ...
                if h.is_null() {
                    if symndx == -(1 as libc::c_int) as libc::c_long {
                        ...
                        sec = *sections.offset(symndx as isize);
                        if bfd_is_abs_section(sec) {
                            current_block_76 = 14916268686031723178;
                        } else {
                            val = ((*(*sec).output_section).vma)
                                .wrapping_add((*sec).output_offset)
                                .wrapping_add((*sym).n_value);
                            if (*(*input_bfd).tdata.coff_obj_data).pe == 0 {
                                val = (val as libc::c_ulong).wrapping_sub((*sec).vma)
                                    as bfd_vma as bfd_vma;
                            }
                            current_block_76 = 5891011138178424807;
                        }
                        ...
                        == bfd_link_hash_undefweak as libc::c_int
                    {
                        ...
                        {
                            let mut h2: *mut coff_link_hash_entry = *((*(*(*h).auxbfd)
                                .tdata
                                .coff_obj_data)
                                .sym_hashes)
                        ...
                        == type_relocatable as libc::c_int)
                    {
                        (Some(
                            ...
                            input_bfd,
                            input_section,
                            ((*rel).r_vaddr).wrapping_sub((*input_section).vma),
                            1 as libc::c_int != 0,
                        );
                ...
                match current_block_76 {
                    ...
                    _ => {
                        if !sec.is_null() && discarded_section(sec) as libc::c_int != 0 {
                            ...
                            if !((*info).base_file).is_null() {
                                if !sym.is_null()
                                    && ((*(*output_bfd).tdata.pe_obj_data).in_reloc_p)
                                        .expect("non-null function pointer")(output_bfd, howto)
                                        as libc::c_int != 0
                                {
                                    let mut addr: bfd_vma = ((*rel).r_vaddr)
                                        .wrapping_sub((*input_section).vma)
                                        .wrapping_add((*input_section).output_offset)
                                        .wrapping_add((*(*input_section).output_section).vma);
                                    if (*(*output_bfd).tdata.coff_obj_data).pe != 0 {
                                        addr = (addr as libc::c_ulong)
                                            .wrapping_sub(
                                                (*(*output_bfd).tdata.pe_obj_data).pe_opthdr.ImageBase,
                                            ) as bfd_vma as bfd_vma;
                                    }
                                    if fwrite(
                                        &mut addr as *mut bfd_vma as *const libc::c_void,
                                        1 as libc::c_int as libc::c_ulong,
                                        ::core::mem::size_of::<bfd_vma>() as libc::c_ulong,
                                        (*info).base_file as *mut FILE,
                                    ) != ::core::mem::size_of::<bfd_vma>() as libc::c_ulong
                                    {
                            ...
                            match rstat as libc::c_uint {
                                ...
                                4 => {
                                    _bfd_error_handler(
                                        dcgettext(
                                            b"bfd\0" as *const u8 as *const libc::c_char,
                                            b"%pB: bad reloc address %#lx in section `%pA'\0"
                                                as *const u8 as *const libc::c_char,
                                            5 as libc::c_int,
                                        ),
                                        input_bfd,
                                ...
                                3 => {
                                    if !(val == 0 as libc::c_int as libc::c_ulong
                                        && addend.wrapping_add(4 as libc::c_int as libc::c_ulong)
                                            == 0 as libc::c_int as libc::c_ulong
                                        && (*sym).n_sclass as libc::c_int == 105 as libc::c_int
                                        && ((*((*(*output_bfd).xvec).backend_data
                                            as *mut bfd_coff_backend_data))
                                            ._bfd_coff_classify_symbol)
                                            .expect("non-null function pointer")(output_bfd, sym)
                                            as libc::c_uint
                                            == COFF_SYMBOL_UNDEFINED as libc::c_int as libc::c_uint)
                                    {
                                        let mut name: *const libc::c_char = 0
                                            as *const libc::c_char;
                                        let mut buf: [libc::c_char; 9] = [0; 9];
                                        if symndx == -(1 as libc::c_int) as libc::c_long {
                                ...
                                _ => {
                                    _bfd_abort(
                                        ...
                                        (*::core::mem::transmute::<
                                            ...
                                            &[libc::c_char; 167],
                                        >(
                                            b"_Bool _bfd_coff_generic_relocate_section(bfd *, struct bfd_link_info *, bfd *, asection *, bfd_byte *, struct internal_reloc *, struct internal_syment *, asection **)\0",
                                        ))
                                            .as_ptr(),
                                    );
                                }
