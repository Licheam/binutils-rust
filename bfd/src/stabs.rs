...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct stab_section_info {
    pub excls: *mut stab_excl_list,
    pub cumulative_skips: *mut bfd_size_type,
    pub stridxs: [bfd_size_type; 1],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct stab_excl_list {
    pub next: *mut stab_excl_list,
    pub offset: bfd_size_type,
    pub val: bfd_vma,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct stab_link_includes_totals {
    pub next: *mut stab_link_includes_totals,
    pub sum_chars: bfd_vma,
    pub num_chars: bfd_vma,
    pub symb: *const libc::c_char,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct stab_link_includes_entry {
    pub root: bfd_hash_entry,
    pub totals: *mut stab_link_includes_totals,
}
...
unsafe extern "C" fn stab_link_includes_newfunc(
    mut entry: *mut bfd_hash_entry,
    mut table: *mut bfd_hash_table,
    mut string: *const libc::c_char,
) -> *mut bfd_hash_entry {
    let mut ret: *mut stab_link_includes_entry = entry as *mut stab_link_includes_entry;
    if ret.is_null() {
        ret = bfd_hash_allocate(
            table,
            ::core::mem::size_of::<stab_link_includes_entry>() as libc::c_ulong
                as libc::c_uint,
        ) as *mut stab_link_includes_entry;
    }
    if ret.is_null() {
    ...
    ret = bfd_hash_newfunc(ret as *mut bfd_hash_entry, table, string)
        as *mut stab_link_includes_entry;
    if !ret.is_null() {
        (*ret).totals = 0 as *mut stab_link_includes_totals;
    }
    return ret as *mut bfd_hash_entry;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_link_section_stabs(
    mut abfd: *mut bfd,
    mut sinfo: *mut stab_info,
    mut stabsec: *mut asection,
    mut stabstrsec: *mut asection,
    mut psecinfo: *mut *mut libc::c_void,
    mut pstring_offset: *mut bfd_size_type,
) -> bool {
    let mut current_block: u64;
    let mut first: bool = false;
    let mut count: bfd_size_type = 0;
    let mut amt: bfd_size_type = 0;
    let mut secinfo: *mut stab_section_info = 0 as *mut stab_section_info;
    let mut stabbuf: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut stabstrbuf: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut sym: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut symend: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut stroff: bfd_size_type = 0;
    let mut next_stroff: bfd_size_type = 0;
    let mut skip: bfd_size_type = 0;
    let mut pstridx: *mut bfd_size_type = 0 as *mut bfd_size_type;
    if (*stabsec).size == 0 as libc::c_int as libc::c_ulong
        || (*stabstrsec).size == 0 as libc::c_int as libc::c_ulong
    {
        return 1 as libc::c_int != 0;
    }
    if ((*stabsec).size).wrapping_rem(12 as libc::c_int as libc::c_ulong)
        != 0 as libc::c_int as libc::c_ulong
    {
        return 1 as libc::c_int != 0;
    }
    if (*stabstrsec).flags & 0x4 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
    if bfd_is_abs_section((*stabsec).output_section) as libc::c_int != 0
        || bfd_is_abs_section((*stabstrsec).output_section) as libc::c_int != 0
    {
        return 1 as libc::c_int != 0;
    }
    first = 0 as libc::c_int != 0;
    if ((*sinfo).stabstr).is_null() {
        let mut flags: flagword = 0;
        first = 1 as libc::c_int != 0;
        (*sinfo).strings = _bfd_stringtab_init();
        if ((*sinfo).strings).is_null() {
            current_block = 981099744983735748;
        } else {
            _bfd_stringtab_add(
                (*sinfo).strings,
            ...
            if !bfd_hash_table_init(
                ...
                flags = (0x100 as libc::c_int | 0x8 as libc::c_int
                    | 0x2000 as libc::c_int | 0x100000 as libc::c_int) as flagword;
                (*sinfo)
                    .stabstr = bfd_make_section_anyway_with_flags(
                    abfd,
    ...
    match current_block {
        15976848397966268834 => {
            count = ((*stabsec).size).wrapping_div(12 as libc::c_int as libc::c_ulong);
            amt = ::core::mem::size_of::<stab_section_info>() as libc::c_ulong;
            amt = (amt as libc::c_ulong)
                .wrapping_add(
                    count
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                        .wrapping_mul(
                            ::core::mem::size_of::<bfd_size_type>() as libc::c_ulong,
                        ),
                ) as bfd_size_type as bfd_size_type;
            *psecinfo = bfd_alloc(abfd, amt);
            if !(*psecinfo).is_null() {
                secinfo = *psecinfo as *mut stab_section_info;
                (*secinfo).excls = 0 as *mut stab_excl_list;
                (*stabsec).rawsize = (*stabsec).size;
                (*secinfo).cumulative_skips = 0 as *mut bfd_size_type;
                memset(
                    ((*secinfo).stridxs).as_mut_ptr() as *mut libc::c_void,
                    0 as libc::c_int,
                    count
                        .wrapping_mul(
                            ::core::mem::size_of::<bfd_size_type>() as libc::c_ulong,
                ...
                if !(!bfd_malloc_and_get_section(abfd, stabsec, &mut stabbuf)
                    || !bfd_malloc_and_get_section(abfd, stabstrsec, &mut stabstrbuf))
                {
                    stroff = 0 as libc::c_int as bfd_size_type;
                    next_stroff = if !pstring_offset.is_null() {
                        *pstring_offset
                    } else {
                        0 as libc::c_int as libc::c_ulong
                    };
                    skip = 0 as libc::c_int as bfd_size_type;
                    symend = stabbuf.offset((*stabsec).size as isize);
                    sym = stabbuf;
                    pstridx = ((*secinfo).stridxs).as_mut_ptr();
                    's_137: loop {
                        if !(sym < symend) {
                            current_block = 14953815020842398287;
                            break;
                        }
                        let mut symstroff: bfd_size_type = 0;
                        let mut type_0: libc::c_int = 0;
                        let mut string: *const libc::c_char = 0 as *const libc::c_char;
                        if !(*pstridx != 0 as libc::c_int as libc::c_ulong) {
                            type_0 = *sym.offset(4 as libc::c_int as isize)
                                as libc::c_int;
                            if type_0 == 0 as libc::c_int {
                                stroff = next_stroff;
                                next_stroff = (next_stroff as libc::c_ulong)
                                    .wrapping_add(
                                        (Some(
                                            ...
                                            sym.offset(8 as libc::c_int as isize) as *const libc::c_void,
                                        ),
                                    ) as bfd_size_type as bfd_size_type;
                                if !pstring_offset.is_null() {
                                    *pstring_offset = next_stroff;
                                }
                                if !first {
                                    *pstridx = -(1 as libc::c_int) as bfd_size_type;
                                    ...
                                    symstroff = stroff
                                        .wrapping_add(
                                            (Some(
                                                ...
                                                sym.offset(0 as libc::c_int as isize) as *const libc::c_void,
                                            ),
                                        );
                                    if symstroff >= (*stabstrsec).size {
                                        _bfd_error_handler(
                                            dcgettext(
                                                ...
                                                b"%pB(%pA+%#lx): stabs entry has invalid string index\0"
                                                    as *const u8 as *const libc::c_char,
                                                5 as libc::c_int,
                                            ),
                                            abfd,
                                            stabsec,
                                            sym.offset_from(stabbuf) as libc::c_long,
                                        );
                                        bfd_set_error(bfd_error_bad_value);
                                        current_block = 981099744983735748;
                                        break;
                                    } else {
                                        string = (stabstrbuf as *mut libc::c_char)
                                            .offset(symstroff as isize);
                                        *pstridx = _bfd_stringtab_add(
                                            (*sinfo).strings,
                                            string,
                                            1 as libc::c_int != 0,
                                            1 as libc::c_int != 0,
                                        );
                                        if type_0 == N_BINCL as libc::c_int {
                                            let mut sum_chars: bfd_vma = 0;
                                            let mut num_chars: bfd_vma = 0;
                                            let mut buf_len: bfd_vma = 0 as libc::c_int as bfd_vma;
                                            let mut symb: *mut libc::c_char = 0 as *mut libc::c_char;
                                            let mut symb_rover: *mut libc::c_char = 0
                                                as *mut libc::c_char;
                                            let mut nest: libc::c_int = 0;
                                            let mut incl_sym: *mut bfd_byte = 0 as *mut bfd_byte;
                                            let mut incl_entry: *mut stab_link_includes_entry = 0
                                                as *mut stab_link_includes_entry;
                                            let mut t: *mut stab_link_includes_totals = 0
                                                as *mut stab_link_includes_totals;
                                            let mut ne: *mut stab_excl_list = 0 as *mut stab_excl_list;
                                            symb_rover = 0 as *mut libc::c_char;
                                            symb = symb_rover;
                                            num_chars = 0 as libc::c_int as bfd_vma;
                                            sum_chars = num_chars;
                                            nest = 0 as libc::c_int;
                                            incl_sym = sym.offset(12 as libc::c_int as isize);
                                            while incl_sym < symend {
                                                let mut incl_type: libc::c_int = 0;
                                                incl_type = *incl_sym.offset(4 as libc::c_int as isize)
                                                    as libc::c_int;
                                                if incl_type == 0 as libc::c_int {
                                                    break;
                                                }
                                                if !(incl_type == N_EXCL as libc::c_int) {
                                                    if incl_type == N_EINCL as libc::c_int {
                                                        if nest == 0 as libc::c_int {
                                                            break;
                                                        }
                                                        nest -= 1;
                                                        nest;
                                                    } else if incl_type == N_BINCL as libc::c_int {
                                                        nest += 1;
                                                        nest;
                                                    } else if nest == 0 as libc::c_int {
                                                        let mut str: *const libc::c_char = 0 as *const libc::c_char;
                                                        str = (stabstrbuf as *mut libc::c_char)
                                                            .offset(stroff as isize)
                                                            .offset(
                                                                (Some(
                                                                    ((*(*abfd).xvec).bfd_getx32)
                                                                        .expect("non-null function pointer"),
                                                                    ...
                                                                    incl_sym.offset(0 as libc::c_int as isize)
                                                        ...
                                                        while *str as libc::c_int != '\0' as i32 {
                                                            if num_chars >= buf_len {
                                                                ...
                                                                symb = bfd_realloc_or_free(
                                                                    symb as *mut libc::c_void,
                                                                    buf_len,
                                                                ) as *mut libc::c_char;
                                                                if symb.is_null() {
                                                                    current_block = 981099744983735748;
                                                                ...
                                                                symb_rover = symb.offset(num_chars as isize);
                                                            }
                                                            let fresh0 = symb_rover;
                                                            symb_rover = symb_rover.offset(1);
                                                            *fresh0 = *str;
                                                            sum_chars = (sum_chars as libc::c_ulong)
                                                                .wrapping_add(*str as libc::c_ulong) as bfd_vma as bfd_vma;
                                                            num_chars = num_chars.wrapping_add(1);
                                                            num_chars;
                                                            if *str as libc::c_int == '(' as i32 {
                                                                str = str.offset(1);
                                                                str;
                                                                while _sch_istable[(*str as libc::c_int
                                                ...
                                                incl_sym = incl_sym.offset(12 as libc::c_int as isize);
                                            }
                                            if !(num_chars
                                                == symb_rover.offset_from(symb) as libc::c_long as bfd_vma)
                                            {
                                                bfd_assert(
                                                    b"stabs.c\0" as *const u8 as *const libc::c_char,
                                                    360 as libc::c_int,
                                                );
                                            }
                                            incl_entry = bfd_hash_lookup(
                                                &mut (*sinfo).includes,
                                                string,
                                                1 as libc::c_int != 0,
                                                1 as libc::c_int != 0,
                                            ) as *mut stab_link_includes_entry;
                                            if incl_entry.is_null() {
                                                current_block = 981099744983735748;
                                                break;
                                            }
                                            t = (*incl_entry).totals;
                                            while !t.is_null() {
                                                if (*t).sum_chars == sum_chars
                                                    ...
                                                    && memcmp(
                                                        (*t).symb as *const libc::c_void,
                                                        symb as *const libc::c_void,
                                                        num_chars,
                                                    ) == 0 as libc::c_int
                                                {
                                                    break;
                                            ...
                                            amt = ::core::mem::size_of::<stab_excl_list>()
                                                as libc::c_ulong;
                                            ne = bfd_alloc(abfd, amt) as *mut stab_excl_list;
                                            if ne.is_null() {
                                                current_block = 981099744983735748;
                                                break;
                                            }
                                            (*ne)
                                                .offset = sym.offset_from(stabbuf) as libc::c_long
                                                as bfd_size_type;
                                            (*ne).val = sum_chars;
                                            (*ne).type_0 = N_BINCL as libc::c_int;
                                            (*ne).next = (*secinfo).excls;
                                            (*secinfo).excls = ne;
                                            if t.is_null() {
                                                t = bfd_hash_allocate(
                                                    &mut (*sinfo).includes,
                                                    ::core::mem::size_of::<stab_link_includes_totals>()
                                                ...
                                                let mut incl_pstridx: *mut bfd_size_type = 0
                                                    as *mut bfd_size_type;
                                                (*ne).type_0 = N_EXCL as libc::c_int;
                                                free(symb as *mut libc::c_void);
                                                nest = 0 as libc::c_int;
                                                incl_sym = sym.offset(12 as libc::c_int as isize);
                                                incl_pstridx = pstridx.offset(1 as libc::c_int as isize);
                                                while incl_sym < symend {
                                                    let mut incl_type_0: libc::c_int = 0;
                                                    incl_type_0 = *incl_sym.offset(4 as libc::c_int as isize)
                                                        as libc::c_int;
                                                    if incl_type_0 == N_EINCL as libc::c_int {
                                                        if nest == 0 as libc::c_int {
                                                            *incl_pstridx = -(1 as libc::c_int) as bfd_size_type;
                                                            skip = skip.wrapping_add(1);
                                                            skip;
                                                            break;
                                                        } else {
                                                    ...
                                                    } else if incl_type_0 == N_BINCL as libc::c_int {
                                                        nest += 1;
                                                        nest;
                                                    } else if !(incl_type_0 == N_EXCL as libc::c_int) {
                                                        if nest == 0 as libc::c_int {
                                                            *incl_pstridx = -(1 as libc::c_int) as bfd_size_type;
                                                            skip = skip.wrapping_add(1);
                                                            skip;
                                                    ...
                                                    incl_sym = incl_sym.offset(12 as libc::c_int as isize);
                                                    incl_pstridx = incl_pstridx.offset(1);
                                                    incl_pstridx;
                                                }
                                            }
                                        }
                        ...
                        sym = sym.offset(12 as libc::c_int as isize);
                        pstridx = pstridx.offset(1);
                        pstridx;
                    }
                    match current_block {
                        981099744983735748 => {}
                        _ => {
                            free(stabbuf as *mut libc::c_void);
                            stabbuf = 0 as *mut bfd_byte;
                            free(stabstrbuf as *mut libc::c_void);
                            stabstrbuf = 0 as *mut bfd_byte;
                            (*stabsec)
                                .size = count
                                .wrapping_sub(skip)
                            ...
                            (*stabstrsec).flags
                                |= (0x8000 as libc::c_int | 0x200000 as libc::c_int)
                                    as libc::c_uint;
                            (*(*sinfo).stabstr)
                                .size = _bfd_stringtab_size((*sinfo).strings);
                            if skip != 0 as libc::c_int as libc::c_ulong {
                                let mut i: bfd_size_type = 0;
                                let mut offset: bfd_size_type = 0;
                                let mut pskips: *mut bfd_size_type = 0
                                    as *mut bfd_size_type;
                                amt = count
                                    .wrapping_mul(
                                        ::core::mem::size_of::<bfd_size_type>() as libc::c_ulong,
                                ...
                                (*secinfo)
                                    .cumulative_skips = bfd_alloc(abfd, amt)
                                    as *mut bfd_size_type;
                                if ((*secinfo).cumulative_skips).is_null() {
                                    current_block = 981099744983735748;
                                } else {
                                    pskips = (*secinfo).cumulative_skips;
                                    pstridx = ((*secinfo).stridxs).as_mut_ptr();
                                    offset = 0 as libc::c_int as bfd_size_type;
                                    i = 0 as libc::c_int as bfd_size_type;
                                    while i < count {
                                        *pskips = offset;
                                        if *pstridx == -(1 as libc::c_int) as bfd_size_type {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_discard_section_stabs(
    mut abfd: *mut bfd,
    mut stabsec: *mut asection,
    ...
    if !((*stabsec).output_section).is_null()
        && bfd_is_abs_section((*stabsec).output_section) as libc::c_int != 0
    {
        return 0 as libc::c_int != 0;
    }
    if psecinfo.is_null() {
    ...
    count = ((*stabsec).rawsize).wrapping_div(12 as libc::c_int as libc::c_ulong);
    secinfo = psecinfo as *mut stab_section_info;
    if bfd_malloc_and_get_section(abfd, stabsec, &mut stabbuf) {
        skip = 0 as libc::c_int as bfd_size_type;
        deleting = -(1 as libc::c_int);
        symend = stabbuf.offset((*stabsec).rawsize as isize);
        ...
        while sym < symend {
            let mut type_0: libc::c_int = 0;
            if !(*pstridx == -(1 as libc::c_int) as bfd_size_type) {
                type_0 = *sym.offset(4 as libc::c_int as isize) as libc::c_int;
                if type_0 == N_FUN as libc::c_int {
                    let mut strx: libc::c_int = (Some(
                    ...
                    if strx == 0 as libc::c_int {
                        ...
                        deleting = -(1 as libc::c_int);
                        current_block_33 = 11050875288958768710;
                    } else {
                        ...
                        if (Some(
                            ...
                            sym.offset(8 as libc::c_int as isize).offset_from(stabbuf)
                                as libc::c_long as bfd_vma,
                            cookie,
                        )
                        {
                            deleting = 1 as libc::c_int;
                        }
                        current_block_33 = 15768484401365413375;
                    }
                } else {
                    current_block_33 = 15768484401365413375;
                }
                match current_block_33 {
                    ...
                    _ => {
                        if deleting == 1 as libc::c_int {
                            *pstridx = -(1 as libc::c_int) as bfd_size_type;
                            skip = skip.wrapping_add(1);
                            skip;
                        } else if deleting == -(1 as libc::c_int) {
                            if type_0 == N_STSYM as libc::c_int
                                || type_0 == N_LCSYM as libc::c_int
                            {
                                if (Some(
                                    reloc_symbol_deleted_p.expect("non-null function pointer"),
                                ))
        ...
        stabbuf = 0 as *mut bfd_byte;
        (*stabsec)
            .size = ((*stabsec).size as libc::c_ulong)
            .wrapping_sub(skip.wrapping_mul(12 as libc::c_int as libc::c_ulong))
            as bfd_size_type as bfd_size_type;
        if (*stabsec).size == 0 as libc::c_int as libc::c_ulong {
            (*stabsec).flags
        ...
        if skip != 0 as libc::c_int as libc::c_ulong {
            let mut i: bfd_size_type = 0;
            let mut offset: bfd_size_type = 0;
            let mut pskips: *mut bfd_size_type = 0 as *mut bfd_size_type;
            if ((*secinfo).cumulative_skips).is_null() {
                amt = count
                    .wrapping_mul(
                        ::core::mem::size_of::<bfd_size_type>() as libc::c_ulong,
                    );
                (*secinfo).cumulative_skips = bfd_alloc(abfd, amt) as *mut bfd_size_type;
                if ((*secinfo).cumulative_skips).is_null() {
                    current_block = 10333200879700491352;
                } else {
        ...
        match current_block {
            10333200879700491352 => {}
            _ => return skip > 0 as libc::c_int as libc::c_ulong,
        }
    }
    free(stabbuf as *mut libc::c_void);
    return 0 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_write_section_stabs(
    ...
    let mut secinfo: *mut stab_section_info = 0 as *mut stab_section_info;
    let mut e: *mut stab_excl_list = 0 as *mut stab_excl_list;
    let mut sym: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut tosym: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut symend: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut pstridx: *mut bfd_size_type = 0 as *mut bfd_size_type;
    secinfo = *psecinfo as *mut stab_section_info;
    if secinfo.is_null() {
        return bfd_set_section_contents(
            output_bfd,
            (*stabsec).output_section,
            contents as *const libc::c_void,
            (*stabsec).output_offset as file_ptr,
            (*stabsec).size,
        );
    }
    e = (*secinfo).excls;
    while !e.is_null() {
        let mut excl_sym: *mut bfd_byte = 0 as *mut bfd_byte;
        if !((*e).offset < (*stabsec).rawsize) {
            bfd_assert(
                b"stabs.c\0" as *const u8 as *const libc::c_char,
                680 as libc::c_int,
            );
        }
        excl_sym = contents.offset((*e).offset as isize);
        (Some(((*(*output_bfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )((*e).val, excl_sym.offset(8 as libc::c_int as isize) as *mut libc::c_void);
        *excl_sym.offset(4 as libc::c_int as isize) = (*e).type_0 as bfd_byte;
        e = (*e).next;
    }
    tosym = contents;
    symend = contents.offset((*stabsec).rawsize as isize);
    sym = contents;
    pstridx = ((*secinfo).stridxs).as_mut_ptr();
    while sym < symend {
        if *pstridx != -(1 as libc::c_int) as bfd_size_type {
            ...
            (Some(
                ...
                *pstridx,
                tosym.offset(0 as libc::c_int as isize) as *mut libc::c_void,
            );
            if *sym.offset(4 as libc::c_int as isize) as libc::c_int == 0 as libc::c_int
            {
                if !(sym == contents) {
                    bfd_assert(
                        b"stabs.c\0" as *const u8 as *const libc::c_char,
                ...
                (Some(
                    ...
                    tosym.offset(8 as libc::c_int as isize) as *mut libc::c_void,
                );
                (Some(
                    ...
                    ((*(*stabsec).output_section).size)
                        .wrapping_div(12 as libc::c_int as libc::c_ulong)
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                    tosym.offset(6 as libc::c_int as isize) as *mut libc::c_void,
                );
            }
            tosym = tosym.offset(12 as libc::c_int as isize);
        }
        sym = sym.offset(12 as libc::c_int as isize);
        pstridx = pstridx.offset(1);
        pstridx;
    }
    if !(tosym.offset_from(contents) as libc::c_long as bfd_size_type == (*stabsec).size)
    {
        bfd_assert(b"stabs.c\0" as *const u8 as *const libc::c_char, 718 as libc::c_int);
    }
    return bfd_set_section_contents(
        output_bfd,
        (*stabsec).output_section,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_write_stab_strings(
    mut output_bfd: *mut bfd,
    mut sinfo: *mut stab_info,
) -> bool {
    ...
    if !(((*(*sinfo).stabstr).output_offset)
        .wrapping_add(_bfd_stringtab_size((*sinfo).strings))
        <= (*(*(*sinfo).stabstr).output_section).size)
    {
        bfd_assert(b"stabs.c\0" as *const u8 as *const libc::c_char, 736 as libc::c_int);
    }
    if bfd_seek(
        output_bfd,
        ((*(*(*sinfo).stabstr).output_section).filepos as libc::c_ulong)
            .wrapping_add((*(*sinfo).stabstr).output_offset) as file_ptr,
        0 as libc::c_int,
    ) != 0 as libc::c_int
    {
        return 0 as libc::c_int != 0;
    ...
    bfd_hash_table_free(&mut (*sinfo).includes);
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn _bfd_stab_section_offset(
    mut stabsec: *mut asection,
    mut psecinfo: *mut libc::c_void,
    mut offset: bfd_vma,
) -> bfd_vma {
    ...
    if offset >= (*stabsec).rawsize {
        return offset.wrapping_sub((*stabsec).rawsize).wrapping_add((*stabsec).size);
    }
    if !((*secinfo).cumulative_skips).is_null() {
        let mut i: bfd_vma = 0;
        i = offset.wrapping_div(12 as libc::c_int as libc::c_ulong);
        if *((*secinfo).stridxs).as_mut_ptr().offset(i as isize)
            == -(1 as libc::c_int) as bfd_size_type
        {
            return -(1 as libc::c_int) as bfd_vma;
        }
        return offset.wrapping_sub(*((*secinfo).cumulative_skips).offset(i as isize));
    }
    return offset;
}
