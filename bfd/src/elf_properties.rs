...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_get_property(
    mut abfd: *mut bfd,
    mut type_0: libc::c_uint,
    mut datasz: libc::c_uint,
) -> *mut elf_property {
    let mut p: *mut elf_property_list = 0 as *mut elf_property_list;
    let mut lastp: *mut *mut elf_property_list = 0 as *mut *mut elf_property_list;
    if bfd_get_flavour(abfd) as libc::c_uint
        != bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        _bfd_abort(
            b"elf-properties.c\0" as *const u8 as *const libc::c_char,
            41 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 71],
                &[libc::c_char; 71],
            >(
                b"elf_property *_bfd_elf_get_property(bfd *, unsigned int, unsigned int)\0",
            ))
                .as_ptr(),
        );
    }
    lastp = &mut (*(*abfd).tdata.elf_obj_data).properties;
    p = *lastp;
    while !p.is_null() {
        if type_0 == (*p).property.pr_type {
            if datasz > (*p).property.pr_datasz {
                (*p).property.pr_datasz = datasz;
            }
            return &mut (*p).property;
        } else {
            if type_0 < (*p).property.pr_type {
                break;
            }
    ...
    p = bfd_alloc(abfd, ::core::mem::size_of::<elf_property_list>() as libc::c_ulong)
        as *mut elf_property_list;
    if p.is_null() {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: out of memory in _bfd_elf_get_property\0" as *const u8
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<elf_property_list>() as libc::c_ulong,
    );
    (*p).property.pr_type = type_0;
    (*p).property.pr_datasz = datasz;
    (*p).next = *lastp;
    *lastp = p;
    return &mut (*p).property;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_parse_gnu_properties(
    mut abfd: *mut bfd,
    ...
    let mut align_size: libc::c_uint = (if (*(*bed).s).elfclass as libc::c_int
        == 2 as libc::c_int
    {
        8 as libc::c_int
    } else {
    ...
    let mut ptr: *mut bfd_byte = (*note).descdata as *mut bfd_byte;
    let mut ptr_end: *mut bfd_byte = ptr.offset((*note).descsz as isize);
    if !((*note).descsz < 8 as libc::c_int as libc::c_ulong
        || ((*note).descsz).wrapping_rem(align_size as libc::c_ulong)
            != 0 as libc::c_int as libc::c_ulong)
    {
        loop {
            ...
            {
                current_block = 1148145590701995339;
                break;
            }
            type_0 = (Some(
                ...
                > ptr_end.offset_from(ptr) as libc::c_long as size_t
            {
                _bfd_error_handler(
                    dcgettext(
                        b"bfd\0" as *const u8 as *const libc::c_char,
                        b"warning: %pB: corrupt GNU_PROPERTY_TYPE (%ld) type (0x%x) datasz: 0x%x\0"
                ...
                (*(*abfd).tdata.elf_obj_data).properties = 0 as *mut elf_property_list;
                return 0 as libc::c_int != 0;
            }
            if type_0 >= 0xc0000000 as libc::c_uint {
                if (*bed).elf_machine_code == 0 as libc::c_int {
                    current_block = 13431092565933809997;
                } else if type_0 < 0xe0000000 as libc::c_uint
                    && ((*bed).parse_gnu_properties).is_some()
                {
                    let mut kind: elf_property_kind = ((*bed).parse_gnu_properties)
                        .expect("non-null function pointer")(abfd, type_0, ptr, datasz);
                    if kind as libc::c_uint
                        == property_corrupt as libc::c_int as libc::c_uint
                    {
                        (*(*abfd).tdata.elf_obj_data)
                            .properties = 0 as *mut elf_property_list;
                        return 0 as libc::c_int != 0;
                    } else if kind as libc::c_uint
                        != property_ignored as libc::c_int as libc::c_uint
                    {
                        current_block = 13431092565933809997;
                    } else {
                ...
                match type_0 {
                    1 => {
                        if datasz != align_size {
                            _bfd_error_handler(
                                dcgettext(
                                    b"bfd\0" as *const u8 as *const libc::c_char,
                                    b"warning: %pB: corrupt stack size: 0x%x\0" as *const u8
                                        as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                abfd,
                        ...
                        if datasz == 8 as libc::c_int as libc::c_uint {
                            (*prop)
                                .u
                                .number = (Some(
                                ((*(*abfd).xvec).bfd_h_getx64)
                    ...
                    2 => {
                        if datasz != 0 as libc::c_int as libc::c_uint {
                            _bfd_error_handler(
                                dcgettext(
                                    b"bfd\0" as *const u8 as *const libc::c_char,
                                    b"warning: %pB: corrupt no copy on protected size: 0x%x\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                abfd,
                                ...
                                && type_0 <= 0xb000ffff as libc::c_uint
                        {
                            if datasz != 4 as libc::c_int as libc::c_uint {
                                _bfd_error_handler(
                                    dcgettext(
                                        b"bfd\0" as *const u8 as *const libc::c_char,
                                        b"error: %pB: <corrupt property (0x%x) size: 0x%x>\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    abfd,
            ...
            match current_block {
                10758786907990354186 => {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"warning: %pB: unsupported GNU_PROPERTY_TYPE (%ld) type: 0x%x\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        abfd,
            ...
            ptr = ptr
                .offset(
                    (datasz
                        .wrapping_add(
                            align_size.wrapping_sub(1 as libc::c_int as libc::c_uint),
                        ) & !align_size.wrapping_sub(1 as libc::c_int as libc::c_uint))
                        as isize,
                );
        }
    ...
    _bfd_error_handler(
        dcgettext(
            b"bfd\0" as *const u8 as *const libc::c_char,
            b"warning: %pB: corrupt GNU_PROPERTY_TYPE (%ld) size: %#lx\0" as *const u8
                as *const libc::c_char,
            5 as libc::c_int,
        ),
        abfd,
...
unsafe extern "C" fn elf_merge_gnu_properties(
    ...
    if ((*bed).merge_gnu_properties).is_some() && pr_type >= 0xc0000000 as libc::c_uint
        && pr_type < 0xe0000000 as libc::c_uint
    {
        return ((*bed).merge_gnu_properties)
            .expect("non-null function pointer")(info, abfd, bbfd, aprop, bprop);
    }
    's_192: {
        match pr_type {
            1 => {
            ...
            _ => {
                ...
                if pr_type >= 0xb0008000 as libc::c_uint
                    && pr_type <= 0xb000ffff as libc::c_uint
                {
                    if !aprop.is_null() && !bprop.is_null() {
                    ...
                    return updated;
                } else if pr_type >= 0xb0000000 as libc::c_uint
                    && pr_type <= 0xb0007fff as libc::c_uint
                {
                    if !aprop.is_null() && !bprop.is_null() {
                        number = (*aprop).u.number as libc::c_uint;
                        (*aprop).u.number = number as libc::c_ulong & (*bprop).u.number;
                ...
                _bfd_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 101],
                    >(
                        b"_Bool elf_merge_gnu_properties(struct bfd_link_info *, bfd *, bfd *, elf_property *, elf_property *)\0",
                    ))
                        .as_ptr(),
                );
            }
        }
        return aprop.is_null();
    }
    return 0 as libc::c_int != 0;
}
unsafe extern "C" fn elf_find_and_remove_property(
    mut listp: *mut *mut elf_property_list,
    mut type_0: libc::c_uint,
    mut rm: bool,
) -> *mut elf_property {
    let mut list: *mut elf_property_list = 0 as *mut elf_property_list;
    list = *listp;
    while !list.is_null() {
        if type_0 == (*list).property.pr_type {
            if rm {
                *listp = (*list).next;
            }
            return &mut (*list).property;
        } else {
            if type_0 < (*list).property.pr_type {
                break;
            }
    ...
    return 0 as *mut elf_property;
}
unsafe extern "C" fn elf_merge_gnu_property_list(
    mut info: *mut bfd_link_info,
    mut first_pbfd: *mut bfd,
    mut abfd: *mut bfd,
    mut listp: *mut *mut elf_property_list,
) {
    let mut p: *mut elf_property_list = 0 as *mut elf_property_list;
    let mut lastp: *mut *mut elf_property_list = 0 as *mut *mut elf_property_list;
    let mut pr: *mut elf_property = 0 as *mut elf_property;
    let mut number_p: bool = false;
    let mut number: bfd_vma = 0 as libc::c_int as bfd_vma;
    lastp = &mut (*(*first_pbfd).tdata.elf_obj_data).properties;
    p = *lastp;
    while !p.is_null() {
        if (*p).property.pr_kind as libc::c_uint
            != property_remove as libc::c_int as libc::c_uint
        {
            if (*p).property.pr_kind as libc::c_uint
                == property_number as libc::c_int as libc::c_uint
            {
                number_p = 1 as libc::c_int != 0;
                number = (*p).property.u.number;
            } else {
                number_p = 0 as libc::c_int != 0;
            }
            pr = elf_find_and_remove_property(
                listp,
                (*p).property.pr_type,
                1 as libc::c_int != 0,
            );
            elf_merge_gnu_properties(info, first_pbfd, abfd, &mut (*p).property, pr);
            if (*p).property.pr_kind as libc::c_uint
                == property_remove as libc::c_int as libc::c_uint
            {
                if (*info).has_map_file() != 0 {
                    if number_p {
                        if !pr.is_null() {
                            ((*(*info).callbacks).minfo)
                                ...
                                dcgettext(
                                    b"bfd\0" as *const u8 as *const libc::c_char,
                                    b"Removed property %W to merge %pB (0x%v) and %pB (0x%v)\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                (*p).property.pr_type as bfd_vma,
                                first_pbfd,
                                number,
                                abfd,
                                (*pr).u.number,
                            ...
                            ((*(*info).callbacks).minfo)
                                ...
                                dcgettext(
                                    b"bfd\0" as *const u8 as *const libc::c_char,
                                    b"Removed property %W to merge %pB (0x%v) and %pB (not found)\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                (*p).property.pr_type as bfd_vma,
                        ...
                        ((*(*info).callbacks).minfo)
                            ...
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"Removed property %W to merge %pB and %pB\n\0" as *const u8
                                    as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            (*p).property.pr_type as bfd_vma,
                        ...
                        ((*(*info).callbacks).minfo)
                            ...
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"Removed property %W to merge %pB and %pB (not found)\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            (*p).property.pr_type as bfd_vma,
                ...
                *lastp = (*p).next;
                ...
                if number_p {
                    if !pr.is_null() {
                            ...
                            || (*p).property.u.number != (*pr).u.number
                        {
                            ((*(*info).callbacks).minfo)
                                ...
                                dcgettext(
                                    b"bfd\0" as *const u8 as *const libc::c_char,
                                    b"Updated property %W (0x%v) to merge %pB (0x%v) and %pB (0x%v)\n\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                (*p).property.pr_type as bfd_vma,
                    ...
                    } else if (*p).property.u.number != number {
                        ((*(*info).callbacks).minfo)
                            .expect(
                                "non-null function pointer",
                            )(
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"Updated property %W (%v) to merge %pB (0x%v) and %pB (not found)\n\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            (*p).property.pr_type as bfd_vma,
    ...
    while !p.is_null() {
        ...
        if elf_merge_gnu_properties(
            info,
            first_pbfd,
            abfd,
            0 as *mut elf_property,
            &mut (*p).property,
        ) {
            if (*p).property.pr_type == 2 as libc::c_int as libc::c_uint {
                (*(*first_pbfd).tdata.elf_obj_data)
                    .set_has_no_copy_on_protected(1 as libc::c_int as libc::c_uint);
            }
            pr = _bfd_elf_get_property(
                first_pbfd,
                (*p).property.pr_type,
                (*p).property.pr_datasz,
            );
            if (*pr).pr_kind as libc::c_uint
                != property_unknown as libc::c_int as libc::c_uint
            {
                _bfd_abort(
                    b"elf-properties.c\0" as *const u8 as *const libc::c_char,
                    465 as libc::c_int,
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 93],
                    >(
                        b"void elf_merge_gnu_property_list(struct bfd_link_info *, bfd *, bfd *, elf_property_list **)\0",
                    ))
                        .as_ptr(),
                );
            }
            *pr = (*p).property;
            ...
            pr = elf_find_and_remove_property(
                &mut (*(*first_pbfd).tdata.elf_obj_data).properties,
                (*p).property.pr_type,
                0 as libc::c_int != 0,
            );
            if pr.is_null() {
                if number_p {
                    ((*(*info).callbacks).minfo)
                        ...
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"Removed property %W to merge %pB (not found) and %pB (0x%v)\n\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        (*p).property.pr_type as bfd_vma,
            ...
            } else if (*pr).pr_kind as libc::c_uint
                != property_remove as libc::c_int as libc::c_uint
            {
                _bfd_abort(
                    b"elf-properties.c\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn elf_get_gnu_property_section_size(
    mut list: *mut elf_property_list,
    mut align_size: libc::c_uint,
) -> bfd_size_type {
    let mut size: bfd_size_type = 0;
    let mut descsz: libc::c_uint = 0;
    descsz = 16 as libc::c_ulong as libc::c_uint;
    descsz = descsz.wrapping_add(3 as libc::c_int as libc::c_uint)
        & (4 as libc::c_int as libc::c_uint).wrapping_neg();
    size = descsz as bfd_size_type;
    while !list.is_null() {
        let mut datasz: libc::c_uint = 0;
        if !((*list).property.pr_kind as libc::c_uint
            == property_remove as libc::c_int as libc::c_uint)
        {
            if (*list).property.pr_type == 1 as libc::c_int as libc::c_uint {
                datasz = align_size;
            } else {
            ...
            size = (size as libc::c_ulong)
                .wrapping_add(
                    ((4 as libc::c_int + 4 as libc::c_int) as libc::c_uint)
                        .wrapping_add(datasz) as libc::c_ulong,
...
unsafe extern "C" fn elf_write_gnu_properties(
    mut abfd: *mut bfd,
    ...
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        ...
        size.wrapping_sub(descsz) as bfd_vma,
        &mut (*e_note).descsz as *mut [libc::c_uchar; 4] as *mut libc::c_void,
    );
    (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
    ...
    while !list.is_null() {
            ...
            == property_remove as libc::c_int as libc::c_uint)
        {
            ...
            (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
                ...
                (*list).property.pr_type as bfd_vma,
                contents.offset(size as isize) as *mut libc::c_void,
            );
            (Some(((*(*abfd).xvec).bfd_h_putx32).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                ...
                datasz as bfd_vma,
                contents.offset(size as isize).offset(4 as libc::c_int as isize)
                    as *mut libc::c_void,
            );
            size = size
                .wrapping_add((4 as libc::c_int + 4 as libc::c_int) as libc::c_uint);
            match (*list).property.pr_kind as libc::c_uint {
                4 => {
                    match datasz {
                        0 => {}
                        4 => {
                            (Some(
                                ...
                                (*list).property.u.number,
                                contents.offset(size as isize) as *mut libc::c_void,
                            );
                        }
                        8 => {
                            (Some(
                                ((*(*abfd).xvec).bfd_h_putx64)
                                    .expect("non-null function pointer"),
                            ))
                                .expect(
                                    "non-null function pointer",
                        ...
                        _ => {
                            _bfd_abort(
                                ...
                                (*::core::mem::transmute::<
                                    ...
                                    &[libc::c_char; 98],
                                >(
                                    b"void elf_write_gnu_properties(bfd *, bfd_byte *, elf_property_list *, unsigned int, unsigned int)\0",
                                ))
                                    .as_ptr(),
                            );
                        }
            ...
            size = size.wrapping_add(datasz);
            size = size
                .wrapping_add(align_size.wrapping_sub(1 as libc::c_int as libc::c_uint))
                & !align_size.wrapping_sub(1 as libc::c_int as libc::c_uint);
        }
        list = (*list).next;
    }
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_link_setup_gnu_properties(
    mut info: *mut bfd_link_info,
) -> *mut bfd {
    let mut abfd: *mut bfd = 0 as *mut bfd;
    let mut first_pbfd: *mut bfd = 0 as *mut bfd;
    let mut list: *mut elf_property_list = 0 as *mut elf_property_list;
    let mut sec: *mut asection = 0 as *mut asection;
    let mut has_properties: bool = 0 as libc::c_int != 0;
    let mut bed: *const elf_backend_data = (*(*(*info).output_bfd).xvec).backend_data
        as *const elf_backend_data;
    let mut elfclass: libc::c_uint = (*(*bed).s).elfclass as libc::c_uint;
    let mut elf_machine_code: libc::c_int = (*bed).elf_machine_code;
    ...
    while !abfd.is_null() {
        if bfd_get_flavour(abfd) as libc::c_uint
            ...
            && !((*(*abfd).tdata.elf_obj_data).properties).is_null()
        {
            has_properties = 1 as libc::c_int != 0;
            if elf_machine_code
                == (*((*(*abfd).xvec).backend_data as *const elf_backend_data))
                    .elf_machine_code
                && elfclass
                    == (*(*((*(*abfd).xvec).backend_data as *const elf_backend_data)).s)
                        .elfclass as libc::c_uint
    ...
    while !abfd.is_null() {
        if abfd != first_pbfd
            && (*abfd).flags
                & (0x40 as libc::c_int | 0x10000 as libc::c_int | 0x1000 as libc::c_int)
                    as libc::c_uint == 0 as libc::c_int as libc::c_uint
        {
            let mut null_ptr: *mut elf_property_list = 0 as *mut elf_property_list;
            let mut listp: *mut *mut elf_property_list = &mut null_ptr;
            if bfd_get_flavour(abfd) as libc::c_uint
                == bfd_target_elf_flavour as libc::c_int as libc::c_uint
            {
                ...
                if !list.is_null()
                    && elf_machine_code
                        == (*((*(*abfd).xvec).backend_data as *const elf_backend_data))
                            .elf_machine_code
                {
                    listp = &mut (*(*abfd).tdata.elf_obj_data).properties;
                }
            } else {
                list = 0 as *mut elf_property_list;
            }
            if !first_pbfd.is_null() {
    ...
    if !first_pbfd.is_null() {
        ...
        let mut align_size: libc::c_uint = (if elfclass
        ...
        if (*info).stacksize > 0 as libc::c_int as libc::c_long {
            let mut p: *mut elf_property = 0 as *mut elf_property;
            let mut stacksize: bfd_vma = (*info).stacksize as bfd_vma;
            p = _bfd_elf_get_property(
                first_pbfd,
                1 as libc::c_int as libc::c_uint,
                align_size,
            );
            if (*p).pr_kind as libc::c_uint
                == property_unknown as libc::c_int as libc::c_uint
            {
        ...
        } else if ((*(*first_pbfd).tdata.elf_obj_data).properties).is_null() {
            (*sec)
                .output_section = &mut *_bfd_std_section
                .as_mut_ptr()
                .offset(2 as libc::c_int as isize) as *mut asection;
        ...
        if ((*bed).fixup_gnu_properties).is_some() {
            ((*bed).fixup_gnu_properties)
                .expect(
                    "non-null function pointer",
                )(info, &mut (*(*first_pbfd).tdata.elf_obj_data).properties);
        }
        if ((*(*first_pbfd).tdata.elf_obj_data).properties).is_null() {
            (*sec)
                .output_section = &mut *_bfd_std_section
                .as_mut_ptr()
                .offset(2 as libc::c_int as isize) as *mut asection;
        ...
        (*sec).size = size;
        contents = bfd_zalloc(first_pbfd, size) as *mut bfd_byte;
        ...
        let ref mut fresh0 = (*((*sec).used_by_bfd as *mut bfd_elf_section_data))
            .this_hdr
            .contents;
        *fresh0 = contents;
        if (*(*first_pbfd).tdata.elf_obj_data).has_no_copy_on_protected() != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_convert_gnu_property_size(
    mut ibfd: *mut bfd,
    mut obfd: *mut bfd,
) -> bfd_size_type {
    let mut align_size: libc::c_uint = 0;
    let mut bed: *const elf_backend_data = 0 as *const elf_backend_data;
    let mut list: *mut elf_property_list = (*(*ibfd).tdata.elf_obj_data).properties;
    bed = (*(*obfd).xvec).backend_data as *const elf_backend_data;
    align_size = (if (*(*bed).s).elfclass as libc::c_int == 2 as libc::c_int {
        8 as libc::c_int
    } else {
        4 as libc::c_int
    }) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_convert_gnu_properties(
    mut ibfd: *mut bfd,
    ...
    let mut contents: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut align_shift: libc::c_uint = 0;
    let mut bed: *const elf_backend_data = 0 as *const elf_backend_data;
    let mut list: *mut elf_property_list = (*(*ibfd).tdata.elf_obj_data).properties;
    bed = (*(*obfd).xvec).backend_data as *const elf_backend_data;
    align_shift = (if (*(*bed).s).elfclass as libc::c_int == 2 as libc::c_int {
        3 as libc::c_int
    } else {
        2 as libc::c_int
    }) as libc::c_uint;
    size = bfd_section_size((*isec).output_section) as libc::c_uint;
    bfd_set_section_alignment((*isec).output_section, align_shift);
    if size as libc::c_ulong > bfd_section_size(isec) {
        contents = bfd_malloc(size as bfd_size_type) as *mut bfd_byte;
        if contents.is_null() {
            return 0 as libc::c_int != 0;
        }
    ...
    *ptr_size = size as bfd_size_type;
    elf_write_gnu_properties(
        ibfd,
        contents,
        list,
        size,
        ((1 as libc::c_int) << align_shift) as libc::c_uint,
    );
    return 1 as libc::c_int != 0;
}
