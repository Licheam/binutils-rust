...
extern "C" {
    ...
    fn _bfd_pei_swap_sym_in(_: *mut bfd, _: *mut libc::c_void, _: *mut libc::c_void);
    fn _bfd_pei_swap_sym_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    fn _bfd_pei_swap_aux_in(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: libc::c_int,
        _: libc::c_int,
    ...
    fn _bfd_pei_swap_lineno_in(_: *mut bfd, _: *mut libc::c_void, _: *mut libc::c_void);
    fn _bfd_pei_swap_lineno_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    fn _bfd_pei_swap_aouthdr_in(_: *mut bfd, _: *mut libc::c_void, _: *mut libc::c_void);
    fn _bfd_pei_swap_aouthdr_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    fn _bfd_pei_swap_scnhdr_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    fn _bfd_pe_print_private_bfd_data_common(_: *mut bfd, _: *mut libc::c_void) -> bool;
    fn _bfd_pe_bfd_copy_private_bfd_data_common(_: *mut bfd, _: *mut bfd) -> bool;
    fn _bfd_pe_get_symbol_info(_: *mut bfd, _: *mut asymbol, _: *mut symbol_info);
    fn _bfd_pei_final_link_postscript(_: *mut bfd, _: *mut coff_final_link_info) -> bool;
    fn _bfd_pei_swap_debugdir_in(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    );
    fn _bfd_pei_slurp_codeview_record(
        abfd: *mut bfd,
        where_0: file_ptr,
        length: libc::c_ulong,
        cvinfo: *mut CODEVIEW_INFO,
    ) -> *mut CODEVIEW_INFO;
    fn _bfd_pei_only_swap_filehdr_out(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut libc::c_void,
    ) -> libc::c_uint;
    fn _bfd_pe_bfd_copy_private_section_data(
        _: *mut bfd,
        _: *mut asection,
        _: *mut bfd,
        _: *mut asection,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct PEAOUTHDR {
    pub standard: AOUTHDR,
    pub ImageBase: [libc::c_char; 4],
    ...
    pub SizeOfStackReserve: [libc::c_char; 4],
    pub SizeOfStackCommit: [libc::c_char; 4],
    pub SizeOfHeapReserve: [libc::c_char; 4],
    pub SizeOfHeapCommit: [libc::c_char; 4],
...
unsafe extern "C" fn coff_i386_rtype_to_howto(
    mut abfd: *mut bfd,
    mut sec: *mut asection,
    ...
    *addendp = 0 as libc::c_int as bfd_vma;
        ...
        && (*sym).n_value != 0 as libc::c_int as libc::c_ulong
    {
        if h.is_null() {
            bfd_assert(
                b"./coff-i386.c\0" as *const u8 as *const libc::c_char,
                472 as libc::c_int,
            );
        }
    }
    ...
    if (*rel).r_type as libc::c_int == 7 as libc::c_int
    ...
    if (*rel).r_type as libc::c_int == 20 as libc::c_int && sym.is_null() {
        *addendp = (*addendp as libc::c_ulong).wrapping_sub((*rel).r_vaddr) as bfd_vma
            as bfd_vma;
    } else if sym.is_null() {
        bfd_assert(
            b"./coff-i386.c\0" as *const u8 as *const libc::c_char,
    ...
    if (*rel).r_type as libc::c_int == 11 as libc::c_int && !sym.is_null() {
...
unsafe extern "C" fn coff_i386_reloc(
    mut abfd: *mut bfd,
    ...
    if bfd_is_com_section((*symbol).section) {
        ...
        {
            diff = -((1 as libc::c_int) << (*howto).size() as libc::c_int) as symvalue;
    ...
    if (*(*reloc_entry).howto).type_0 == 7 as libc::c_int as libc::c_uint
        && !output_bfd.is_null()
        && bfd_get_flavour(output_bfd) as libc::c_uint
            == bfd_target_coff_flavour as libc::c_int as libc::c_uint
    {
        diff = (diff as libc::c_ulong)
            .wrapping_sub((*(*output_bfd).tdata.pe_obj_data).pe_opthdr.ImageBase)
            as symvalue as symvalue;
    }
    if diff != 0 as libc::c_int as libc::c_ulong {
        let mut howto_0: *const reloc_howto_type = (*reloc_entry).howto;
        ...
        if !bfd_reloc_offset_in_range(howto_0, abfd, input_section, octets) {
            return bfd_reloc_outofrange;
        }
        match (*howto_0).size() as libc::c_int {
            0 => {
                let mut x: libc::c_char = (*(addr as *const libc::c_uchar) as bfd_vma
                    & 0xff as libc::c_int as libc::c_ulong) as libc::c_char;
                x = (x as libc::c_ulong & !(*howto_0).dst_mask
                    | (x as libc::c_ulong & (*howto_0).src_mask).wrapping_add(diff)
                        & (*howto_0).dst_mask) as libc::c_char;
            ...
            1 => {
                let mut x_0: libc::c_short = (Some(
                    ...
                    as libc::c_short;
                x_0 = (x_0 as libc::c_ulong & !(*howto_0).dst_mask
                    | (x_0 as libc::c_ulong & (*howto_0).src_mask).wrapping_add(diff)
                        & (*howto_0).dst_mask) as libc::c_short;
            ...
            2 => {
                let mut x_1: libc::c_long = (Some(
                    ...
                    .expect("non-null function pointer")(addr as *const libc::c_void)
                    as libc::c_long;
                x_1 = (x_1 as libc::c_ulong & !(*howto_0).dst_mask
                    | (x_1 as libc::c_ulong & (*howto_0).src_mask).wrapping_add(diff)
                        & (*howto_0).dst_mask) as libc::c_long;
            ...
            _ => {
                _bfd_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 103],
                    >(
                        b"bfd_reloc_status_type coff_i386_reloc(bfd *, arelent *, asymbol *, void *, asection *, bfd *, char **)\0",
                    ))
                        .as_ptr(),
                );
            }
...
unsafe extern "C" fn coff_i386_reloc_type_lookup(
    ...
    match code as libc::c_uint {
        62 => return howto_table.as_ptr().offset(7 as libc::c_int as isize),
        2 => return howto_table.as_ptr().offset(6 as libc::c_int as isize),
        9 => return howto_table.as_ptr().offset(20 as libc::c_int as isize),
...
unsafe extern "C" fn in_reloc_p(
    ...
    return (*howto).pc_relative() == 0
        && (*howto).type_0 != 7 as libc::c_int as libc::c_uint
        && (*howto).type_0 != 11 as libc::c_int as libc::c_uint;
}
unsafe extern "C" fn coff_pe_i386_relocate_section(
    mut output_bfd: *mut bfd,
...
unsafe extern "C" fn coff_i386_is_local_label_name(
    mut abfd: *mut bfd,
        ...
        if isym.n_scnum == (*section).target_index {
            ...
            if symname.is_null() {
                ...
                match seen_state {
                        ...
                        match current_block {
                            ...
                            14985388389832317580 => {
                                ...
                                ) != 0 as libc::c_int
                                {
                                    ...
                                    current_block = 6338244333391193282;
                                }
                            }
                            _ => {}
                        }
                    ...
                    2 => {
                        current_block = 14985388389832317580;
                        match current_block {
                            8236137900636309791 => {
                                let mut aux: internal_auxent = internal_auxent {
                                    x_sym: C2RustUnnamed_23 {
...
unsafe extern "C" fn coff_bad_format_hook(
    ...
    if (*internal_f).f_magic as libc::c_int != 0x14c as libc::c_int
        && (*internal_f).f_magic as libc::c_int
            != 0x14c as libc::c_int ^ 0x4644 as libc::c_int
        && (*internal_f).f_magic as libc::c_int
            != 0x14c as libc::c_int ^ 0xadc4 as libc::c_int
        && (*internal_f).f_magic as libc::c_int
            != 0x14c as libc::c_int ^ 0x7b79 as libc::c_int
        && (*internal_f).f_magic as libc::c_int
            != 0x14c as libc::c_int ^ 0x1993 as libc::c_int
        && (*internal_f).f_magic as libc::c_int != 0x175 as libc::c_int
        && (*internal_f).f_magic as libc::c_int != 0x154 as libc::c_int
        && (*internal_f).f_magic as libc::c_int != 0o415 as libc::c_int
    {
...
static mut coff_section_alignment_table: [coff_section_alignment_entry; 8] = [coff_section_alignment_entry {
    name: 0 as *const libc::c_char,
    comparison_length: 0,
...
unsafe extern "C" fn coff_set_arch_mach_hook(
    ...
    match (*internal_f).f_magic as libc::c_int {
        332 | 340 | 373 | 269 | 18184 | 44168 | 31285 | 6367 => {
            arch = bfd_arch_i386;
        }
        _ => {
...
unsafe extern "C" fn coff_set_flags(
    ...
    match bfd_get_arch(abfd) as libc::c_uint {
        8 => {
            *magicp = 0x14c as libc::c_int as libc::c_uint;
            return 1 as libc::c_int != 0;
        }
        _ => {}
    }
...
unsafe extern "C" fn coff_compute_section_file_positions(mut abfd: *mut bfd) -> bool {
    ...
    let ref mut fresh4 = *section_list.offset(i as isize);
    *fresh4 = 0 as *mut asection;
    qsort(
    ...
    while i < count {
        ...
        if (*current).size == 0 as libc::c_int as libc::c_ulong {
            ...
            let fresh5 = target_index;
            target_index = target_index.wrapping_add(1);
            (*current).target_index = fresh5 as libc::c_int;
        }
        i = i.wrapping_add(1);
        i;
    }
    ...
    while !current.is_null() {
            ...
            .is_null()
        {
            let mut amt_1: size_t = ::core::mem::size_of::<pei_section_tdata>()
                as libc::c_ulong;
            let ref mut fresh6 = (*((*current).used_by_bfd as *mut coff_section_tdata))
                .tdata;
            *fresh6 = bfd_zalloc(abfd, amt_1);
...
unsafe extern "C" fn coff_write_object_contents(mut abfd: *mut bfd) -> bool {
            ...
            != 0 as libc::c_int as libc::c_uint
        {
            ...
            if i < count {
                ...
                if psym != psymsec {
                    ...
                    pcopy = psym;
                    while pcopy > psymsec {
                        let ref mut fresh7 = *pcopy.offset(0 as libc::c_int as isize);
                        *fresh7 = *pcopy.offset(-(1 as libc::c_int) as isize);
    ...
    internal_f
        .f_flags = (internal_f.f_flags as libc::c_int | 0x100 as libc::c_int)
        as libc::c_ushort;
    memset(
    ...
    internal_f
        ...
        as libc::c_ushort;
    internal_a.magic = 0o413 as libc::c_int as libc::c_short;
            ...
            if !func_table.is_null() {
                ...
                while i < (*asect).lineno_count {
                        ...
                        == 0 as libc::c_int as libc::c_uint
                    {
                        let fresh8 = p;
                        p = p.offset(1);
                        *fresh8 = &mut *lineno_cache.offset(i as isize) as *mut alent;
                    }
                    i = i.wrapping_add(1);
                    i;
                }
            ...
            match (*src).u.syment.n_sclass as libc::c_int {
                ...
                0 => {
                        ...
                        && (*src).u.syment.n_scnum == 0 as libc::c_int
                    {
                        ...
                        current_block_71 = 10309386752740900576;
                    }
                }
                106 => {
                    current_block_71 = 9847082639621838898;
                }
                5 | 7 | 14 | 21 | _ => {
                    current_block_71 = 10309386752740900576;
                }
...
unsafe extern "C" fn coff_slurp_reloc_table(
    ...
    while idx < (*asect).reloc_count {
        ...
        let mut coffsym: *mut coff_symbol_type = 0 as *mut libc::c_void
            as *mut coff_symbol_type;
...
unsafe extern "C" fn coff_canonicalize_reloc(
    ...
    if (*section).flags & 0x80 as libc::c_int as libc::c_uint != 0 {
        ...
        loop {
            let fresh12 = count;
            count = count.wrapping_add(1);
            if !(fresh12 < (*section).reloc_count) {
                break;
            }
            let fresh13 = tblptr;
...
unsafe extern "C" fn coff_set_alignment_hook(
        ...
        .is_null()
    {
        ...
        let ref mut fresh15 = (*((*section).used_by_bfd as *mut coff_section_tdata))
            .tdata;
        *fresh15 = bfd_zalloc(abfd, amt);
...
static mut bfd_coff_std_swap_table: bfd_coff_backend_data = unsafe {
    {
        let mut init = bfd_coff_backend_data {
            ...
            _bfd_aoutsz: (28 as libc::c_int + 196 as libc::c_int) as libc::c_uint,
            ...
            _bfd_coff_print_pdata: None,
        };
        init
    }
};
#[no_mangle]
pub static mut i386_pei_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"pei-i386\0" as *const u8 as *const libc::c_char,
            ...
            section_flags: (0x100 as libc::c_int | 0x1 as libc::c_int
                ...
                as flagword,
            symbol_leading_char: '_' as i32 as libc::c_char,
...
unsafe extern "C" fn coff_swap_scnhdr_in(
    ...
    if (*scnhdr_int).s_vaddr != 0 as libc::c_int as libc::c_ulong {
        (*scnhdr_int)
            ...
            as bfd_vma;
        (*scnhdr_int).s_vaddr &= 0xffffffff as libc::c_uint as libc::c_ulong;
    }
...
unsafe extern "C" fn pe_ILF_save_relocs(
    ...
    let ref mut fresh16 = (*((*sec).used_by_bfd as *mut coff_section_tdata)).relocs;
    *fresh16 = (*vars).int_reltab;
...
unsafe extern "C" fn pe_ILF_make_a_section(
    ...
    let fresh17 = (*vars).sec_index;
    (*vars).sec_index = ((*vars).sec_index).wrapping_add(1);
    (*sec).target_index = fresh17 as libc::c_int;
        ...
        if !(id4.is_null() || id5.is_null()) {
            if import_name_type == 0 as libc::c_int as libc::c_uint {
                if ordinal == 0 as libc::c_int as libc::c_uint {
                    current_block = 12929366339349566603;
                } else {
                    *((*id4).contents
                        as *mut libc::c_uint) = ordinal | 0x80000000 as libc::c_uint;
                    *((*id5).contents
                        as *mut libc::c_uint) = ordinal | 0x80000000 as libc::c_uint;
...
unsafe extern "C" fn pe_ILF_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    ...
    match machine {
        332 => {
            magic = 0x14c as libc::c_int as libc::c_uint;
        }
        0 | 388 | 644 | 512 | 34404 | 354 | 358 | 360 | 614 | 870 | 1126 | 418 | 422
        | 448 | 450 => {}
        496 | _ => {
            _bfd_error_handler(
                dcgettext(
...
unsafe extern "C" fn pe_bfd_read_buildid(mut abfd: *mut bfd) {
            ...
            )
    {
        ...
        if idd.Type == 2 as libc::c_int as libc::c_ulong {
            ...
            if !(_bfd_pei_slurp_codeview_record(
                abfd,
...
unsafe extern "C" fn pe_bfd_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    ...
    if opt_hdr_size != 0 as libc::c_int as libc::c_ulong {
        ...
        if amt < ::core::mem::size_of::<PEAOUTHDR>() as libc::c_ulong {
            amt = ::core::mem::size_of::<PEAOUTHDR>() as libc::c_ulong;
        }
...
unsafe extern "C" fn run_static_initializers() {
    howto_table = [
        ...
        },
        {
            let mut init = reloc_howto_struct {
                ...
                name: b"dir32\0" as *const u8 as *const libc::c_char,
            };
            init.set_size(
        ...
        },
        {
            let mut init = reloc_howto_struct {
                ...
                name: b"rva32\0" as *const u8 as *const libc::c_char,
            };
            init.set_size(
                (if (2 as libc::c_int) < 0 as libc::c_int {
                    -(2 as libc::c_int)
        ...
        },
        {
            let mut init = reloc_howto_struct {
                size_bitsize_rightshift_bitpos_complain_on_overflow_negate_pc_relative_partial_inplace_pcrel_offset: [0; 4],
                type_0: 0o10 as libc::c_int as libc::c_uint,
                src_mask: 0 as libc::c_int as bfd_vma,
                dst_mask: 0 as libc::c_int as bfd_vma,
                special_function: None,
                name: 0 as *const libc::c_char,
        ...
        },
        {
            let mut init = reloc_howto_struct {
                size_bitsize_rightshift_bitpos_complain_on_overflow_negate_pc_relative_partial_inplace_pcrel_offset: [0; 4],
                type_0: 0o11 as libc::c_int as libc::c_uint,
                src_mask: 0 as libc::c_int as bfd_vma,
                dst_mask: 0 as libc::c_int as bfd_vma,
                special_function: None,
                name: 0 as *const libc::c_char,
        ...
        },
        {
            let mut init = reloc_howto_struct {
                size_bitsize_rightshift_bitpos_complain_on_overflow_negate_pc_relative_partial_inplace_pcrel_offset: [0; 4],
                type_0: 0o12 as libc::c_int as libc::c_uint,
                src_mask: 0 as libc::c_int as bfd_vma,
                dst_mask: 0 as libc::c_int as bfd_vma,
                special_function: None,
                name: 0 as *const libc::c_char,
        ...
        },
        {
            let mut init = reloc_howto_struct {
                ...
                name: b"secrel32\0" as *const u8 as *const libc::c_char,
            };
            init.set_size(
                (if (2 as libc::c_int) < 0 as libc::c_int {
                    -(2 as libc::c_int)
        ...
        },
        {
            let mut init = reloc_howto_struct {
                size_bitsize_rightshift_bitpos_complain_on_overflow_negate_pc_relative_partial_inplace_pcrel_offset: [0; 4],
                type_0: 0o14 as libc::c_int as libc::c_uint,
                src_mask: 0 as libc::c_int as bfd_vma,
                dst_mask: 0 as libc::c_int as bfd_vma,
                special_function: None,
                name: 0 as *const libc::c_char,
        ...
        },
        {
            let mut init = reloc_howto_struct {
                size_bitsize_rightshift_bitpos_complain_on_overflow_negate_pc_relative_partial_inplace_pcrel_offset: [0; 4],
                type_0: 0o15 as libc::c_int as libc::c_uint,
                src_mask: 0 as libc::c_int as bfd_vma,
                dst_mask: 0 as libc::c_int as bfd_vma,
                special_function: None,
                name: 0 as *const libc::c_char,
        ...
        },
        {
            let mut init = reloc_howto_struct {
                size_bitsize_rightshift_bitpos_complain_on_overflow_negate_pc_relative_partial_inplace_pcrel_offset: [0; 4],
                type_0: 0o16 as libc::c_int as libc::c_uint,
                src_mask: 0 as libc::c_int as bfd_vma,
                dst_mask: 0 as libc::c_int as bfd_vma,
                special_function: None,
                name: 0 as *const libc::c_char,
        ...
        },
        {
            let mut init = reloc_howto_struct {
                ...
                name: b"DISP8\0" as *const u8 as *const libc::c_char,
            };
            init.set_size(
                (if (0 as libc::c_int) < 0 as libc::c_int {
                    -(0 as libc::c_int)
        ...
        },
        {
            let mut init = reloc_howto_struct {
                ...
                name: b"DISP16\0" as *const u8 as *const libc::c_char,
            };
            init.set_size(
                (if (1 as libc::c_int) < 0 as libc::c_int {
                    -(1 as libc::c_int)
        ...
        },
        {
            let mut init = reloc_howto_struct {
                ...
                name: b"DISP32\0" as *const u8 as *const libc::c_char,
            };
            init.set_size(
                (if (2 as libc::c_int) < 0 as libc::c_int {
                    -(2 as libc::c_int)
    ...
    coff_section_alignment_table_size = (::core::mem::size_of::<
        [coff_section_alignment_entry; 8],
    >() as libc::c_ulong)
        .wrapping_div(
