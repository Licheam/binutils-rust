...
unsafe extern "C" fn binary_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    ...
    (*abfd).symcount = 3 as libc::c_int as libc::c_uint;
    ...
    (*sec).vma = 0 as libc::c_int as bfd_vma;
    (*sec).size = statbuf.st_size as bfd_size_type;
    (*sec).filepos = 0 as libc::c_int as file_ptr;
    (*abfd).tdata.any = sec as *mut libc::c_void;
    return Some(_bfd_void_bfd as unsafe extern "C" fn(*mut bfd) -> ());
}
unsafe extern "C" fn binary_get_section_contents(
    mut abfd: *mut bfd,
...
unsafe extern "C" fn mangle_name(
    mut abfd: *mut bfd,
    ...
    size = (strlen(bfd_get_filename(abfd)))
        ...
        .wrapping_add(::core::mem::size_of::<[libc::c_char; 10]>() as libc::c_ulong);
    buf = bfd_alloc(abfd, size) as *mut libc::c_char;
    if buf.is_null() {
        return b"\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    }
    sprintf(
        buf,
        b"_binary_%s_%s\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn binary_canonicalize_symtab(
    mut abfd: *mut bfd,
    mut alocation: *mut *mut asymbol,
) -> libc::c_long {
    let mut sec: *mut asection = (*abfd).tdata.any as *mut asection;
    let mut syms: *mut asymbol = 0 as *mut asymbol;
    let mut i: libc::c_uint = 0;
    let mut amt: size_t = (3 as libc::c_int as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<asymbol>() as libc::c_ulong);
    syms = bfd_alloc(abfd, amt) as *mut asymbol;
    if syms.is_null() {
        return -(1 as libc::c_int) as libc::c_long;
    }
    let ref mut fresh0 = (*syms.offset(0 as libc::c_int as isize)).the_bfd;
    *fresh0 = abfd;
    let ref mut fresh1 = (*syms.offset(0 as libc::c_int as isize)).name;
    *fresh1 = mangle_name(
        abfd,
        b"start\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*syms.offset(0 as libc::c_int as isize)).value = 0 as libc::c_int as symvalue;
    (*syms.offset(0 as libc::c_int as isize))
        .flags = ((1 as libc::c_int) << 1 as libc::c_int) as flagword;
    let ref mut fresh2 = (*syms.offset(0 as libc::c_int as isize)).section;
    *fresh2 = sec;
    let ref mut fresh3 = (*syms.offset(0 as libc::c_int as isize)).udata.p;
    *fresh3 = 0 as *mut libc::c_void;
    let ref mut fresh4 = (*syms.offset(1 as libc::c_int as isize)).the_bfd;
    *fresh4 = abfd;
    let ref mut fresh5 = (*syms.offset(1 as libc::c_int as isize)).name;
    *fresh5 = mangle_name(
        abfd,
        b"end\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*syms.offset(1 as libc::c_int as isize)).value = (*sec).size;
    (*syms.offset(1 as libc::c_int as isize))
        .flags = ((1 as libc::c_int) << 1 as libc::c_int) as flagword;
    let ref mut fresh6 = (*syms.offset(1 as libc::c_int as isize)).section;
    *fresh6 = sec;
    let ref mut fresh7 = (*syms.offset(1 as libc::c_int as isize)).udata.p;
    *fresh7 = 0 as *mut libc::c_void;
    let ref mut fresh8 = (*syms.offset(2 as libc::c_int as isize)).the_bfd;
    *fresh8 = abfd;
    let ref mut fresh9 = (*syms.offset(2 as libc::c_int as isize)).name;
    *fresh9 = mangle_name(
        abfd,
        b"size\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    );
    (*syms.offset(2 as libc::c_int as isize)).value = (*sec).size;
    (*syms.offset(2 as libc::c_int as isize))
        .flags = ((1 as libc::c_int) << 1 as libc::c_int) as flagword;
    let ref mut fresh10 = (*syms.offset(2 as libc::c_int as isize)).section;
    *fresh10 = &mut *_bfd_std_section.as_mut_ptr().offset(2 as libc::c_int as isize)
        as *mut asection;
    let ref mut fresh11 = (*syms.offset(2 as libc::c_int as isize)).udata.p;
    *fresh11 = 0 as *mut libc::c_void;
    i = 0 as libc::c_int as libc::c_uint;
    while i < 3 as libc::c_int as libc::c_uint {
        let fresh12 = syms;
        syms = syms.offset(1);
        let fresh13 = alocation;
...
unsafe extern "C" fn binary_set_section_contents(
    mut abfd: *mut bfd,
    ...
    if (*abfd).output_has_begun() == 0 {
        let mut found_low: bool = false;
        let mut low: bfd_vma = 0;
        let mut s: *mut asection = 0 as *mut asection;
        found_low = 0 as libc::c_int != 0;
        low = 0 as libc::c_int as bfd_vma;
        s = (*abfd).sections;
        while !s.is_null() {
            if (*s).flags
                & (0x100 as libc::c_int | 0x2 as libc::c_int | 0x1 as libc::c_int
                    | 0x200 as libc::c_int) as libc::c_uint
                == (0x100 as libc::c_int | 0x2 as libc::c_int | 0x1 as libc::c_int)
                    as libc::c_uint && (*s).size > 0 as libc::c_int as libc::c_ulong
                && (!found_low || (*s).lma < low)
            {
                low = (*s).lma;
                found_low = 1 as libc::c_int != 0;
            }
            s = (*s).next;
        }
        s = (*abfd).sections;
        while !s.is_null() {
            ...
            (*s)
                .filepos = ((*s).lma)
                .wrapping_sub(low)
                .wrapping_mul(opb as libc::c_ulong) as file_ptr;
            if !((*s).flags
                & (0x100 as libc::c_int | 0x1 as libc::c_int | 0x200 as libc::c_int)
                    as libc::c_uint
                != (0x100 as libc::c_int | 0x1 as libc::c_int) as libc::c_uint
                || (*s).size == 0 as libc::c_int as libc::c_ulong)
            {
                if (*s).filepos < 0 as libc::c_int as libc::c_long {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"warning: writing section `%pA' at huge (ie negative) file offset\0"
    ...
    if (*sec).flags & (0x2 as libc::c_int | 0x1 as libc::c_int) as libc::c_uint
        == 0 as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
    if (*sec).flags & 0x200 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
...
#[no_mangle]
pub static mut binary_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            ...
            object_flags: 0x2 as libc::c_int as flagword,
            section_flags: (0x1 as libc::c_int | 0x2 as libc::c_int | 0x8 as libc::c_int
            ...
            _bfd_check_format: [
                ...
                Some(binary_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
            ],
            _bfd_set_format: [
                ...
                Some(binary_mkobject as unsafe extern "C" fn(*mut bfd) -> bool),
                Some(
                    _bfd_bool_bfd_false_error as unsafe extern "C" fn(*mut bfd) -> bool,
                ),
            ...
            _bfd_write_contents: [
                ...
                Some(_bfd_bool_bfd_true as unsafe extern "C" fn(*mut bfd) -> bool),
                Some(
                    _bfd_bool_bfd_false_error as unsafe extern "C" fn(*mut bfd) -> bool,
                ),
                Some(_bfd_bool_bfd_false_error as unsafe extern "C" fn(*mut bfd) -> bool),
