...
extern "C" {
    ...
    static mut _bfd_section_id: libc::c_uint;
    ...
    static mut bfd_default_vector: [*const bfd_target; 0];
    static bfd_associated_vector: *const *const bfd_target;
    static bfd_default_arch_struct: bfd_arch_info_type;
    static _bfd_target_vector_entries: size_t;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct bfd_preserve {
    pub marker: *mut libc::c_void,
    pub tdata: *mut libc::c_void,
    pub flags: flagword,
    pub arch_info: *const bfd_arch_info,
    pub sections: *mut bfd_section,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_check_format(
    mut abfd: *mut bfd,
    mut format: bfd_format,
) -> bool {
    return bfd_check_format_matches(abfd, format, 0 as *mut *mut *mut libc::c_char);
}
unsafe extern "C" fn bfd_preserve_save(
    mut abfd: *mut bfd,
    mut preserve: *mut bfd_preserve,
    mut cleanup: bfd_cleanup,
) -> bool {
    ...
    (*preserve).marker = bfd_alloc(abfd, 1 as libc::c_int as bfd_size_type);
    (*preserve).build_id = (*abfd).build_id;
    (*preserve).cleanup = cleanup;
    if ((*preserve).marker).is_null() {
        return 0 as libc::c_int != 0;
    }
    return bfd_hash_table_init(
...
unsafe extern "C" fn bfd_reinit(
    mut abfd: *mut bfd,
    mut section_id: libc::c_uint,
    mut cleanup: bfd_cleanup,
) {
    _bfd_section_id = section_id;
    if cleanup.is_some() {
        cleanup.expect("non-null function pointer")(abfd);
    }
    (*abfd).tdata.any = 0 as *mut libc::c_void;
    (*abfd).arch_info = &bfd_default_arch_struct;
    (*abfd).flags
        &= (0x800 as libc::c_int | 0x4000 as libc::c_int | 0x8000 as libc::c_int
            | 0x1000 as libc::c_int | 0x10000 as libc::c_int | 0x20000 as libc::c_int
            | 0x40000 as libc::c_int | 0x80000 as libc::c_int) as libc::c_uint;
    bfd_section_list_clear(abfd);
}
unsafe extern "C" fn bfd_preserve_restore(
    mut abfd: *mut bfd,
    mut preserve: *mut bfd_preserve,
) -> bfd_cleanup {
    ...
    (*preserve).marker = 0 as *mut libc::c_void;
    return (*preserve).cleanup;
}
unsafe extern "C" fn bfd_preserve_finish(
    mut abfd: *mut bfd,
    mut preserve: *mut bfd_preserve,
) {
    if ((*preserve).cleanup).is_some() {
        let mut tdata: *mut libc::c_void = (*abfd).tdata.any;
        (*abfd).tdata.any = (*preserve).tdata;
        ((*preserve).cleanup).expect("non-null function pointer")(abfd);
        (*abfd).tdata.any = tdata;
    }
    bfd_hash_table_free(&mut (*preserve).section_htab);
    (*preserve).marker = 0 as *mut libc::c_void;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_check_format_matches(
    mut abfd: *mut bfd,
    mut format: bfd_format,
    mut matching: *mut *mut *mut libc::c_char,
) -> bool {
    ...
    let mut matching_vector: *mut *const bfd_target = 0 as *mut *const bfd_target;
    let mut save_targ: *const bfd_target = 0 as *const bfd_target;
    let mut right_targ: *const bfd_target = 0 as *const bfd_target;
    let mut ar_right_targ: *const bfd_target = 0 as *const bfd_target;
    let mut match_targ: *const bfd_target = 0 as *const bfd_target;
    let mut match_count: libc::c_int = 0;
    let mut best_count: libc::c_int = 0;
    let mut best_match: libc::c_int = 0;
    let mut ar_match_index: libc::c_int = 0;
    let mut initial_section_id: libc::c_uint = _bfd_section_id;
    let mut preserve: bfd_preserve = bfd_preserve {
        marker: 0 as *mut libc::c_void,
        tdata: 0 as *mut libc::c_void,
        flags: 0,
        arch_info: 0 as *const bfd_arch_info,
        sections: 0 as *mut bfd_section,
        section_last: 0 as *mut bfd_section,
        section_count: 0,
        section_id: 0,
        ...
        build_id: 0 as *const bfd_build_id,
        cleanup: None,
    };
    let mut preserve_match: bfd_preserve = bfd_preserve {
        marker: 0 as *mut libc::c_void,
        tdata: 0 as *mut libc::c_void,
        flags: 0,
        arch_info: 0 as *const bfd_arch_info,
    ...
    let mut cleanup: bfd_cleanup = None;
    if !matching.is_null() {
        *matching = 0 as *mut *mut libc::c_char;
    }
    if !((*abfd).direction() as libc::c_int == read_direction as libc::c_int
        || (*abfd).direction() as libc::c_int == both_direction as libc::c_int)
        || (*abfd).format() as libc::c_uint
            >= bfd_type_end as libc::c_int as libc::c_uint
    {
        bfd_set_error(bfd_error_invalid_operation);
        return 0 as libc::c_int != 0;
    }
    if (*abfd).format() as libc::c_int != bfd_unknown as libc::c_int {
        return (*abfd).format() as libc::c_uint == format as libc::c_uint;
    }
    if !matching.is_null() || !(*bfd_associated_vector).is_null() {
        let mut amt: size_t = 0;
        amt = (::core::mem::size_of::<*const bfd_target>() as libc::c_ulong)
            .wrapping_mul(2 as libc::c_int as libc::c_ulong)
            .wrapping_mul(_bfd_target_vector_entries);
        matching_vector = bfd_malloc(amt) as *mut *const bfd_target;
        if matching_vector.is_null() {
            return 0 as libc::c_int != 0;
        }
    }
    (*abfd).set_format(format);
    save_targ = (*abfd).xvec;
    preserve_match.marker = 0 as *mut libc::c_void;
    if bfd_preserve_save(abfd, &mut preserve, None) {
        if (*abfd).target_defaulted() == 0 {
            if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int)
                != 0 as libc::c_int
            {
                current_block = 283903915969694056;
            } else {
                cleanup = ((*(*abfd).xvec)
                    ._bfd_check_format[(*abfd).format() as libc::c_int as usize])
                    .expect("non-null function pointer")(abfd);
                if cleanup.is_some() {
                    current_block = 8655175403712390717;
                } else if format as libc::c_uint
                    == bfd_archive as libc::c_int as libc::c_uint
                    && save_targ == &binary_vec as *const bfd_target
                {
                    current_block = 7887195754530250859;
                } else {
        ...
        match current_block {
            ...
            _ => {
                match current_block {
                    2668756484064249700 => {
                        right_targ = 0 as *const bfd_target;
                        ar_right_targ = 0 as *const bfd_target;
                        match_targ = 0 as *const bfd_target;
                        best_match = 256 as libc::c_int;
                        best_count = 0 as libc::c_int;
                        match_count = 0 as libc::c_int;
                        ar_match_index = _bfd_target_vector_entries as libc::c_int;
                        ...
                        loop {
                            ...
                            let mut high_water: *mut *mut libc::c_void = 0
                                as *mut *mut libc::c_void;
                            if !(*target == &binary_vec as *const bfd_target
                                || match_count != 0 as libc::c_int
                                    && *target == &plugin_vec as *const bfd_target
                                || (*abfd).target_defaulted() == 0 && *target == save_targ)
                            {
                                bfd_reinit(abfd, initial_section_id, cleanup);
                                if !(preserve_match.marker).is_null() {
                                    high_water = &mut preserve_match.marker;
                                } else {
                                    high_water = &mut preserve.marker;
                                }
                                bfd_release(abfd, *high_water);
                                *high_water = bfd_alloc(
                                    abfd,
                                ...
                                cleanup = ((*(*abfd).xvec)
                                    ._bfd_check_format[(*abfd).format() as libc::c_int
                                    as usize])
                                    .expect("non-null function pointer")(abfd);
                                if cleanup.is_some() {
                                    let mut match_priority: libc::c_int = (*(*abfd).xvec)
                                        .match_priority as libc::c_int;
                                    if *target == &plugin_vec as *const bfd_target {
                                        match_priority = (**target).match_priority as libc::c_int;
                                    }
                                    if (*abfd).format() as libc::c_int
                                        != bfd_archive as libc::c_int
                                        || bfd_has_map(abfd) as libc::c_int != 0
                                            && bfd_get_error() as libc::c_uint
                                                != bfd_error_wrong_object_format as libc::c_int
                                                    as libc::c_uint
                                    {
                                        if (*abfd).xvec
                                            == *bfd_default_vector
                                        ...
                                        if !matching_vector.is_null() {
                                            let ref mut fresh0 = *matching_vector
                                        ...
                                        if !matching_vector.is_null() {
                                            let ref mut fresh1 = *matching_vector
                                                .offset(ar_match_index as isize);
                                            *fresh1 = *target;
                                        }
                                        ar_match_index += 1;
                                        ar_match_index;
                                    ...
                                    if (preserve_match.marker).is_null() {
                                        ...
                                        if !bfd_preserve_save(abfd, &mut preserve_match, cleanup) {
                                            current_block = 283903915969694056;
                                            break;
                                        }
                                        cleanup = None;
                        ...
                        match current_block {
                            ...
                            8655175403712390717 => {}
                            _ => {
                                if best_count == 1 as libc::c_int {
                                    match_count = 1 as libc::c_int;
                                }
                                if match_count == 0 as libc::c_int {
                                            ...
                                            .offset(0 as libc::c_int as isize)
                                    {
                                        ...
                                        match_count = (ar_match_index as libc::c_ulong)
                                            .wrapping_sub(_bfd_target_vector_entries) as libc::c_int;
                                        if !matching_vector.is_null()
                                            && match_count > 1 as libc::c_int
                                        {
                                            memcpy(
                                                matching_vector as *mut libc::c_void,
                                                matching_vector.offset(_bfd_target_vector_entries as isize)
                                                    as *const libc::c_void,
                                                (::core::mem::size_of::<*const bfd_target>()
                                                    as libc::c_ulong)
                                                    .wrapping_mul(match_count as libc::c_ulong),
                                            );
                                        }
                                    }
                                }
                                if match_count > 1 as libc::c_int {
                                    let mut assoc: *const *const bfd_target = bfd_associated_vector;
                                    loop {
                                        let fresh2 = assoc;
                                        assoc = assoc.offset(1);
                                        right_targ = *fresh2;
                                        if right_targ.is_null() {
                                            break;
                                        }
                                        let mut i: libc::c_int = match_count;
                                        loop {
                                            i -= 1;
                                            if !(i >= 0 as libc::c_int) {
                                                break;
                                            }
                                            if *matching_vector.offset(i as isize) == right_targ
                                                && (*right_targ).match_priority as libc::c_int <= best_match
                                            {
                                                break;
                                            }
                                        }
                                    ...
                                    && best_count != match_count
                                {
                                    ...
                                    while i_0 < match_count {
                                        right_targ = *matching_vector.offset(i_0 as isize);
                                        if (*right_targ).match_priority as libc::c_int <= best_match
                                        {
                                            break;
                                        }
                                        i_0 += 1;
                                ...
                                if !(preserve_match.marker).is_null() {
                                    cleanup = bfd_preserve_restore(abfd, &mut preserve_match);
                                }
                                if match_count == 1 as libc::c_int {
                                ...
                                } else if match_count == 0 as libc::c_int {
                                    current_block = 7887195754530250859;
                                } else {
                                    (*abfd).xvec = save_targ;
                                    ...
                                    if !matching.is_null() {
                                        *matching = matching_vector as *mut *mut libc::c_char;
                                        let ref mut fresh3 = *matching_vector
                                            .offset(match_count as isize);
                                        *fresh3 = 0 as *const bfd_target;
                                        loop {
                                            match_count -= 1;
                                            if !(match_count >= 0 as libc::c_int) {
                                                break;
                                            }
                                            let mut name: *const libc::c_char = (**matching_vector
                                                .offset(match_count as isize))
                                                .name;
                                            let ref mut fresh4 = *(&mut *matching_vector
                                                .offset(match_count as isize) as *mut *const bfd_target
                                                as *mut *const libc::c_char);
                                            *fresh4 = name;
                                        }
                                    } else {
                                        free(matching_vector as *mut libc::c_void);
                                    }
                                    if cleanup.is_some() {
                                        cleanup.expect("non-null function pointer")(abfd);
                                    }
                                    if !(preserve_match.marker).is_null() {
                                        bfd_preserve_finish(abfd, &mut preserve_match);
                                    }
                                    bfd_preserve_restore(abfd, &mut preserve);
                                    return 0 as libc::c_int != 0;
                                }
                            }
                        }
                ...
                match current_block {
                    ...
                    _ => {
                        match current_block {
                            ...
                            _ => {
                                if (*abfd).direction() as libc::c_int
                                    == both_direction as libc::c_int
                                {
                                    (*abfd)
                                ...
                                bfd_preserve_finish(abfd, &mut preserve);
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_format(
    mut abfd: *mut bfd,
    mut format: bfd_format,
) -> bool {
    if (*abfd).direction() as libc::c_int == read_direction as libc::c_int
    ...
    (*abfd).set_format(format);
    if !((*(*abfd).xvec)._bfd_set_format[(*abfd).format() as libc::c_int as usize])
        .expect("non-null function pointer")(abfd)
    {
        (*abfd).set_format(bfd_unknown);
        return 0 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn bfd_format_string(
    mut format: bfd_format,
) -> *const libc::c_char {
    if (format as libc::c_int) < bfd_unknown as libc::c_int
        || format as libc::c_int >= bfd_type_end as libc::c_int
    {
    ...
    match format as libc::c_uint {
        ...
        2 => return b"archive\0" as *const u8 as *const libc::c_char,
        3 => return b"core\0" as *const u8 as *const libc::c_char,
