...
extern "C" {
    ...
    fn bfd_getb64(_: *const libc::c_void) -> bfd_uint64_t;
    fn bfd_getb_signed_64(_: *const libc::c_void) -> bfd_int64_t;
    fn bfd_getb32(_: *const libc::c_void) -> bfd_vma;
    fn bfd_getb_signed_32(_: *const libc::c_void) -> bfd_signed_vma;
    fn bfd_getb16(_: *const libc::c_void) -> bfd_vma;
    fn bfd_getb_signed_16(_: *const libc::c_void) -> bfd_signed_vma;
    ...
    fn bfd_generic_group_name(_: *mut bfd, sec: *const asection) -> *const libc::c_char;
    ...
    fn _bfd_generic_make_empty_symbol(_: *mut bfd) -> *mut asymbol;
    ...
    fn _bfd_bool_bfd_asection_bfd_asection_true(
        _: *mut bfd,
        _: *mut asection,
        _: *mut bfd,
        _: *mut asection,
    ...
    fn _bfd_bool_bfd_ptr_true(_: *mut bfd, _: *mut libc::c_void) -> bool;
    ...
    fn _bfd_noarchive_construct_extended_name_table(
        _: *mut bfd,
        _: *mut *mut libc::c_char,
        _: *mut bfd_size_type,
        _: *mut *const libc::c_char,
    ) -> bool;
    fn _bfd_noarchive_truncate_arname(
        _: *mut bfd,
        _: *const libc::c_char,
        _: *mut libc::c_char,
    );
    fn _bfd_noarchive_write_armap(
        _: *mut bfd,
        _: libc::c_uint,
        _: *mut orl,
        _: libc::c_uint,
    ...
    fn _bfd_noarchive_write_ar_hdr(_: *mut bfd, _: *mut bfd) -> bool;
    fn _bfd_noarchive_openr_next_archived_file(_: *mut bfd, _: *mut bfd) -> *mut bfd;
    fn _bfd_noarchive_get_elt_at_index(_: *mut bfd, _: symindex) -> *mut bfd;
    ...
    fn _bfd_nosymbols_get_lineno(_: *mut bfd, _: *mut asymbol) -> *mut alent;
    fn _bfd_nosymbols_find_nearest_line(
        _: *mut bfd,
        _: *mut *mut asymbol,
        _: *mut asection,
        _: bfd_vma,
    ...
    fn _bfd_nosymbols_find_inliner_info(
        _: *mut bfd,
        _: *mut *const libc::c_char,
        _: *mut *const libc::c_char,
        _: *mut libc::c_uint,
    ...
    fn _bfd_norelocs_get_reloc_upper_bound(
        _: *mut bfd,
        _: *mut asection,
    ) -> libc::c_long;
    fn _bfd_norelocs_canonicalize_reloc(
        _: *mut bfd,
        _: *mut asection,
        _: *mut *mut arelent,
        _: *mut *mut asymbol,
    ) -> libc::c_long;
    fn _bfd_norelocs_set_reloc(
        _: *mut bfd,
        _: *mut asection,
        _: *mut *mut arelent,
        _: libc::c_uint,
    );
    fn _bfd_norelocs_bfd_reloc_type_lookup(
        _: *mut bfd,
        _: bfd_reloc_code_real_type,
    ) -> *const reloc_howto_type;
    fn _bfd_norelocs_bfd_reloc_name_lookup(
        _: *mut bfd,
        _: *const libc::c_char,
    ) -> *const reloc_howto_type;
    ...
    fn bfd_generic_is_local_label_name(_: *mut bfd, _: *const libc::c_char) -> bool;
    ...
    fn _bfd_generic_link_hash_table_create(_: *mut bfd) -> *mut bfd_link_hash_table;
    fn _bfd_generic_link_add_symbols(_: *mut bfd, _: *mut bfd_link_info) -> bool;
    ...
    fn _bfd_generic_final_link(_: *mut bfd, _: *mut bfd_link_info) -> bool;
    fn _bfd_generic_link_split_section(_: *mut bfd, _: *mut bfd_section) -> bool;
    fn _bfd_generic_section_already_linked(
        _: *mut bfd,
        _: *mut asection,
        _: *mut bfd_link_info,
    ) -> bool;
    ...
    fn bfd_generic_gc_sections(_: *mut bfd, _: *mut bfd_link_info) -> bool;
    ...
    static bfd_default_arch_struct: bfd_arch_info_type;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct srec_data_struct {
    pub head: *mut srec_data_list_type,
    pub tail: *mut srec_data_list_type,
    pub type_0: libc::c_uint,
    pub symbols: *mut srec_symbol,
    pub symtail: *mut srec_symbol,
    pub csymbols: *mut asymbol,
}
...
pub struct bfd_section {
    ...
    pub map_head: C2RustUnnamed_1,
    pub map_tail: C2RustUnnamed_1,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct srec_symbol {
    pub next: *mut srec_symbol,
    pub name: *const libc::c_char,
    pub val: bfd_vma,
}
pub type srec_data_list_type = srec_data_list_struct;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct srec_data_list_struct {
    pub next: *mut srec_data_list_struct,
...
pub type tdata_type = srec_data_struct;
#[inline]
...
static mut digs: [libc::c_char; 17] = unsafe {
    *::core::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"0123456789ABCDEF\0")
};
#[no_mangle]
pub static mut _bfd_srec_len: libc::c_uint = 16 as libc::c_int as libc::c_uint;
#[no_mangle]
pub static mut _bfd_srec_forceS3: bool = 0 as libc::c_int != 0;
unsafe extern "C" fn srec_init() {
    static mut inited: bool = 0 as libc::c_int != 0;
    if !inited {
        inited = 1 as libc::c_int != 0;
        hex_init();
    }
}
unsafe extern "C" fn srec_mkobject(mut abfd: *mut bfd) -> bool {
    let mut tdata: *mut tdata_type = 0 as *mut tdata_type;
    srec_init();
    tdata = bfd_alloc(abfd, ::core::mem::size_of::<tdata_type>() as libc::c_ulong)
        as *mut tdata_type;
    if tdata.is_null() {
        return 0 as libc::c_int != 0;
    }
    (*abfd).tdata.srec_data = tdata;
    (*tdata).type_0 = 1 as libc::c_int as libc::c_uint;
    (*tdata).head = 0 as *mut srec_data_list_type;
    (*tdata).tail = 0 as *mut srec_data_list_type;
    (*tdata).symbols = 0 as *mut srec_symbol;
    (*tdata).symtail = 0 as *mut srec_symbol;
    (*tdata).csymbols = 0 as *mut asymbol;
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn srec_get_byte(
    mut abfd: *mut bfd,
    mut errorptr: *mut bool,
) -> libc::c_int {
    let mut c: bfd_byte = 0;
    if bfd_bread(
        &mut c as *mut bfd_byte as *mut libc::c_void,
    ...
    ) != 1 as libc::c_int as libc::c_ulong
    {
        ...
        {
            *errorptr = 1 as libc::c_int != 0;
        }
        return -(1 as libc::c_int);
    }
    return c as libc::c_int & 0xff as libc::c_int;
}
unsafe extern "C" fn srec_bad_byte(
    mut abfd: *mut bfd,
    ...
    if c == -(1 as libc::c_int) {
            ...
            & _sch_isprint as libc::c_int as libc::c_ushort as libc::c_int == 0
        {
            sprintf(
                ...
                c as libc::c_uint & 0xff as libc::c_int as libc::c_uint,
            );
        } else {
        ...
        _bfd_error_handler(
            dcgettext(
                ...
                b"%pB:%d: unexpected character `%s' in S-record file\0" as *const u8
...
unsafe extern "C" fn srec_new_symbol(
    mut abfd: *mut bfd,
    mut name: *const libc::c_char,
    mut val: bfd_vma,
) -> bool {
    let mut n: *mut srec_symbol = 0 as *mut srec_symbol;
    n = bfd_alloc(abfd, ::core::mem::size_of::<srec_symbol>() as libc::c_ulong)
        as *mut srec_symbol;
    if n.is_null() {
        return 0 as libc::c_int != 0;
    }
    (*n).name = name;
    (*n).val = val;
    if ((*(*abfd).tdata.srec_data).symbols).is_null() {
        (*(*abfd).tdata.srec_data).symbols = n;
    } else {
        (*(*(*abfd).tdata.srec_data).symtail).next = n;
    }
    (*(*abfd).tdata.srec_data).symtail = n;
    (*n).next = 0 as *mut srec_symbol;
    (*abfd).symcount = ((*abfd).symcount).wrapping_add(1);
    (*abfd).symcount;
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn srec_scan(mut abfd: *mut bfd) -> bool {
    let mut current_block: u64;
    let mut c: libc::c_int = 0;
    let mut lineno: libc::c_uint = 1 as libc::c_int as libc::c_uint;
    let mut error: bool = 0 as libc::c_int != 0;
    ...
    let mut symbuf: *mut libc::c_char = 0 as *mut libc::c_char;
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
    {
        current_block = 17170822686802677852;
    } else {
        current_block = 4644295000439058019;
    }
    '_error_return: loop {
        match current_block {
            17170822686802677852 => {
                free(symbuf as *mut libc::c_void);
                free(buf as *mut libc::c_void);
                return 0 as libc::c_int != 0;
            }
            _ => {
                c = srec_get_byte(abfd, &mut error);
                if c != -(1 as libc::c_int) {
                    if c != 'S' as i32 && c != '\r' as i32 && c != '\n' as i32 {
                    ...
                    match c {
                        ...
                        32 => {
                            loop {
                                ...
                                if c == -(1 as libc::c_int) {
                                    srec_bad_byte(abfd, lineno, c, error);
                                    current_block = 17170822686802677852;
                                    continue '_error_return;
                                } else {
                                    alc = 10 as libc::c_int as bfd_size_type;
                                    symbuf = bfd_malloc(
                                        alc.wrapping_add(1 as libc::c_int as libc::c_ulong),
                                    ) as *mut libc::c_char;
                                    if symbuf.is_null() {
                                        current_block = 17170822686802677852;
                                        continue '_error_return;
                                    ...
                                    *fresh0 = c as libc::c_char;
                                    loop {
                                        c = srec_get_byte(abfd, &mut error);
                                        if !(c != -(1 as libc::c_int)
                                            && _sch_istable[(c & 0xff as libc::c_int) as usize]
                                                as libc::c_int
                                                & _sch_isspace as libc::c_int as libc::c_ushort
                                                    as libc::c_int == 0)
                                        {
                                            break;
                                        }
                                        if p.offset_from(symbuf) as libc::c_long as bfd_size_type
                                            >= alc
                                        {
                                            let mut n: *mut libc::c_char = 0 as *mut libc::c_char;
                                            alc = (alc as libc::c_ulong)
                                                .wrapping_mul(2 as libc::c_int as libc::c_ulong)
                                                as bfd_size_type as bfd_size_type;
                                            n = bfd_realloc(
                                                symbuf as *mut libc::c_void,
                                                alc.wrapping_add(1 as libc::c_int as libc::c_ulong),
                                            ) as *mut libc::c_char;
                                            if n.is_null() {
                                                current_block = 17170822686802677852;
                                            ...
                                            p = n
                                                .offset(p.offset_from(symbuf) as libc::c_long as isize);
                                            symbuf = n;
                                        }
                                        let fresh1 = p;
                                        p = p.offset(1);
                                    ...
                                    if c == -(1 as libc::c_int) {
                                        ...
                                        *fresh2 = '\0' as i32 as libc::c_char;
                                        symname = bfd_alloc(
                                            abfd,
                                            p.offset_from(symbuf) as libc::c_long as bfd_size_type,
                                        ) as *mut libc::c_char;
                                        if symname.is_null() {
                                            current_block = 17170822686802677852;
                                            continue '_error_return;
                                        ...
                                        if c == -(1 as libc::c_int) {
                                            ...
                                            symval = 0 as libc::c_int as bfd_vma;
                                            while _hex_value[c as libc::c_uchar as usize]
                                                as libc::c_uint != 99 as libc::c_int as libc::c_uint
                                            {
                                                symval <<= 4 as libc::c_int;
                                                symval = (symval as libc::c_ulong)
                                                    .wrapping_add(
                                                        _hex_value[c as libc::c_uchar as usize] as libc::c_uint
                                                            as libc::c_ulong,
                        ...
                        83 => {
                            ...
                            let mut hdr: [libc::c_uchar; 3] = [0; 3];
                            let mut bytes: libc::c_uint = 0;
                            let mut min_bytes: libc::c_uint = 0;
                            let mut address: bfd_vma = 0;
                            let mut data: *mut bfd_byte = 0 as *mut bfd_byte;
                            let mut check_sum: libc::c_uchar = 0;
                            pos = bfd_tell(abfd) - 1 as libc::c_int as libc::c_long;
                            if bfd_bread(
                                hdr.as_mut_ptr() as *mut libc::c_void,
                                3 as libc::c_int as bfd_size_type,
                                abfd,
                            ...
                            if !(_hex_value[hdr[1 as libc::c_int as usize] as usize]
                                as libc::c_uint != 99 as libc::c_int as libc::c_uint)
                                || !(_hex_value[hdr[2 as libc::c_int as usize] as usize]
                                    as libc::c_uint != 99 as libc::c_int as libc::c_uint)
                            {
                                if !(_hex_value[hdr[1 as libc::c_int as usize] as usize]
                                    as libc::c_uint != 99 as libc::c_int as libc::c_uint)
                                {
                                    c = hdr[1 as libc::c_int as usize] as libc::c_int;
                                } else {
                                    c = hdr[2 as libc::c_int as usize] as libc::c_int;
                                }
                                srec_bad_byte(abfd, lineno, c, error);
                                current_block = 17170822686802677852;
                            } else {
                                bytes = ((_hex_value[*hdr
                                    .as_mut_ptr()
                                    .offset(1 as libc::c_int as isize)
                                    .offset(0 as libc::c_int as isize) as usize]
                                    as libc::c_uint) << 4 as libc::c_int)
                                    .wrapping_add(
                                        _hex_value[*hdr
                                            .as_mut_ptr()
                                            .offset(1 as libc::c_int as isize)
                                            .offset(1 as libc::c_int as isize) as usize] as libc::c_uint,
                                    );
                                check_sum = bytes as libc::c_uchar;
                                min_bytes = 3 as libc::c_int as libc::c_uint;
                                if hdr[0 as libc::c_int as usize] as libc::c_int
                                    == '2' as i32
                                    || hdr[0 as libc::c_int as usize] as libc::c_int
                                        == '8' as i32
                                {
                                    min_bytes = 4 as libc::c_int as libc::c_uint;
                                } else if hdr[0 as libc::c_int as usize] as libc::c_int
                                    == '3' as i32
                                    || hdr[0 as libc::c_int as usize] as libc::c_int
                                        == '7' as i32
                                {
                                    min_bytes = 5 as libc::c_int as libc::c_uint;
                                }
                                if bytes < min_bytes {
                                    _bfd_error_handler(
                                        dcgettext(
                                            b"bfd\0" as *const u8 as *const libc::c_char,
                                            b"%pB:%d: byte count %d too small\0" as *const u8
                                                as *const libc::c_char,
                                            5 as libc::c_int,
                                        ),
                                        abfd,
                                    ...
                                    if bytes.wrapping_mul(2 as libc::c_int as libc::c_uint)
                                        as libc::c_ulong > bufsize
                                    {
                                        free(buf as *mut libc::c_void);
                                        buf = bfd_malloc(
                                            (bytes as bfd_size_type)
                                                .wrapping_mul(2 as libc::c_int as libc::c_ulong),
                                        ) as *mut bfd_byte;
                                        if buf.is_null() {
                                            current_block = 17170822686802677852;
                                    ...
                                    if bfd_bread(
                                        ...
                                        != bytes.wrapping_mul(2 as libc::c_int as libc::c_uint)
                                            as libc::c_ulong
                                    {
                                        current_block = 17170822686802677852;
                                        continue;
                                    ...
                                    bytes;
                                    address = 0 as libc::c_int as bfd_vma;
                                    data = buf;
                                    match hdr[0 as libc::c_int as usize] as libc::c_int {
                                        48 | 53 => {
                                            sec = 0 as *mut asection;
                                            current_block = 4644295000439058019;
                                            continue;
                                        ...
                                        51 => {
                                            check_sum = (check_sum as libc::c_uint)
                                                .wrapping_add(
                                                    ((_hex_value[*data.offset(0 as libc::c_int as isize)
                                                        as usize] as libc::c_uint) << 4 as libc::c_int)
                                                        .wrapping_add(
                                                            _hex_value[*data.offset(1 as libc::c_int as isize) as usize]
                                                                as libc::c_uint,
                                                        ),
                                                ) as libc::c_uchar as libc::c_uchar;
                                            address = ((_hex_value[*data
                                                .offset(0 as libc::c_int as isize) as usize]
                                                as libc::c_uint) << 4 as libc::c_int)
                                                .wrapping_add(
                                                    _hex_value[*data.offset(1 as libc::c_int as isize) as usize]
                                            ...
                                            bytes = bytes.wrapping_sub(1);
                                            bytes;
                                            current_block = 8641048496587929432;
                                        }
                                        50 => {
                                            current_block = 8641048496587929432;
                                        }
                                        49 => {
                                            current_block = 12956327927085951686;
                                        }
                                        55 => {
                                            check_sum = (check_sum as libc::c_uint)
                                                .wrapping_add(
                                            ...
                                            data = data.offset(2 as libc::c_int as isize);
                                            current_block = 2661018572910322505;
                                        }
                                        56 => {
                                            current_block = 2661018572910322505;
                                        }
                                        57 => {
                                            current_block = 18381830443434021665;
                                        }
                                        _ => {
                                            current_block = 4644295000439058019;
                                            continue;
                                    ...
                                    match current_block {
                                        8641048496587929432 => {
                                            ...
                                            address = address << 8 as libc::c_int
                                                | ((_hex_value[*data.offset(0 as libc::c_int as isize)
                                                    as usize] as libc::c_uint) << 4 as libc::c_int)
                                                    .wrapping_add(
                                                        _hex_value[*data.offset(1 as libc::c_int as isize) as usize]
                                    ...
                                    match current_block {
                                        18381830443434021665 => {
                                            ...
                                            check_sum = (255 as libc::c_int
                                                - (check_sum as libc::c_int & 0xff as libc::c_int))
                                                as libc::c_uchar;
                                            if check_sum as libc::c_uint
                                                != ((_hex_value[*data.offset(0 as libc::c_int as isize)
                                                    as usize] as libc::c_uint) << 4 as libc::c_int)
                                                    .wrapping_add(
                                                        _hex_value[*data.offset(1 as libc::c_int as isize) as usize]
                                                    ...
                                                    )
                                            {
                                                _bfd_error_handler(
                                                    dcgettext(
                                                        b"bfd\0" as *const u8 as *const libc::c_char,
                                                        b"%pB:%d: bad checksum in S-record file\0" as *const u8
                                                            as *const libc::c_char,
                                                        5 as libc::c_int,
                                                    ),
                                                    abfd,
                                        ...
                                        _ => {
                                            ...
                                            if !sec.is_null()
                                                && ((*sec).vma).wrapping_add((*sec).size) == address
                                            {
                                                (*sec)
                                                    .size = ((*sec).size as libc::c_ulong)
                                                    .wrapping_add(bytes as libc::c_ulong) as bfd_size_type
                                                    as bfd_size_type;
                                            } else {
                                                let mut secbuf: [libc::c_char; 20] = [0; 20];
                                                let mut secname: *mut libc::c_char = 0 as *mut libc::c_char;
                                                let mut amt: size_t = 0;
                                                let mut flags: flagword = 0;
                                                sprintf(
                                                    secbuf.as_mut_ptr(),
                                                    b".sec%d\0" as *const u8 as *const libc::c_char,
                                                    (bfd_count_sections(abfd))
                                                        .wrapping_add(1 as libc::c_int as libc::c_uint),
                                                );
                                                amt = (strlen(secbuf.as_mut_ptr()))
                                                    .wrapping_add(1 as libc::c_int as libc::c_ulong);
                                                secname = bfd_alloc(abfd, amt) as *mut libc::c_char;
                                                strcpy(secname, secbuf.as_mut_ptr());
                                                flags = (0x100 as libc::c_int | 0x2 as libc::c_int
                                                    | 0x1 as libc::c_int) as flagword;
                                                ...
                                                (*sec).vma = address;
                                                (*sec).lma = address;
                                                (*sec).size = bytes as bfd_size_type;
                                                (*sec).filepos = pos;
                                            }
...
unsafe extern "C" fn srec_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut tdata_save: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut b: [bfd_byte; 4] = [0; 4];
    srec_init();
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bread(
    ...
    if b[0 as libc::c_int as usize] as libc::c_int != 'S' as i32
        || !(_hex_value[b[1 as libc::c_int as usize] as usize] as libc::c_uint
            != 99 as libc::c_int as libc::c_uint)
        || !(_hex_value[b[2 as libc::c_int as usize] as usize] as libc::c_uint
            != 99 as libc::c_int as libc::c_uint)
        || !(_hex_value[b[3 as libc::c_int as usize] as usize] as libc::c_uint
            != 99 as libc::c_int as libc::c_uint)
    {
    ...
    if !srec_mkobject(abfd) || !srec_scan(abfd) {
        if (*abfd).tdata.any != tdata_save && !((*abfd).tdata.any).is_null() {
            bfd_release(abfd, (*abfd).tdata.any);
        }
        (*abfd).tdata.any = tdata_save;
        return None;
    }
    if (*abfd).symcount > 0 as libc::c_int as libc::c_uint {
        (*abfd).flags |= 0x10 as libc::c_int as libc::c_uint;
    }
    return Some(_bfd_void_bfd as unsafe extern "C" fn(*mut bfd) -> ());
}
unsafe extern "C" fn symbolsrec_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut tdata_save: *mut libc::c_void = 0 as *mut libc::c_void;
    ...
    if b[0 as libc::c_int as usize] as libc::c_int != '$' as i32
        || b[1 as libc::c_int as usize] as libc::c_int != '$' as i32
    {
        bfd_set_error(bfd_error_wrong_format);
        return None;
    }
...
unsafe extern "C" fn srec_read_section(
    mut abfd: *mut bfd,
    ...
    let mut current_block: u64;
    let mut c: libc::c_int = 0;
    let mut sofar: bfd_size_type = 0 as libc::c_int as bfd_size_type;
    let mut error: bool = 0 as libc::c_int != 0;
    let mut buf: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut bufsize: size_t = 0 as libc::c_int as size_t;
    if bfd_seek(abfd, (*section).filepos, 0 as libc::c_int) != 0 as libc::c_int {
        current_block = 7503549093466653267;
    } else {
        ...
        match current_block {
            ...
            _ => {
                ...
                if c != -(1 as libc::c_int) {
                    ...
                    {
                        bfd_assert(
                            b"srec.c\0" as *const u8 as *const libc::c_char,
                            742 as libc::c_int,
                        );
                    }
                    bytes = ((_hex_value[*hdr
                        .as_mut_ptr()
                        .offset(1 as libc::c_int as isize)
                        .offset(0 as libc::c_int as isize) as usize] as libc::c_uint)
                        << 4 as libc::c_int)
                        .wrapping_add(
                            _hex_value[*hdr
                                .as_mut_ptr()
                        ...
                        as libc::c_ulong > bufsize
                    {
                        ...
                        bufsize = bytes.wrapping_mul(2 as libc::c_int as libc::c_uint)
                            as size_t;
                    }
                    if bfd_bread(
                        buf as *mut libc::c_void,
                    ...
                    match hdr[0 as libc::c_int as usize] as libc::c_int {
                        51 => {
                            ...
                            bytes = bytes.wrapping_sub(1);
                            bytes;
                            current_block = 4728492399713828712;
                        }
                        50 => {
                            current_block = 4728492399713828712;
                        }
                        49 => {
                            current_block = 3430690125607600783;
                        }
                        _ => {
                    ...
                    address = address << 8 as libc::c_int
                        | ((_hex_value[*data.offset(0 as libc::c_int as isize) as usize]
                            as libc::c_uint) << 4 as libc::c_int)
                            .wrapping_add(
                                _hex_value[*data.offset(1 as libc::c_int as isize) as usize]
                                    as libc::c_uint,
                    ...
                    data = data.offset(2 as libc::c_int as isize);
                    bytes = bytes.wrapping_sub(2 as libc::c_int as libc::c_uint);
                    if address != ((*section).vma).wrapping_add(sofar) {
                        if sofar != (*section).size {
                            current_block = 7503549093466653267;
                            continue;
                        }
...
unsafe extern "C" fn srec_get_section_contents(
    mut abfd: *mut bfd,
    mut section: *mut asection,
    mut location: *mut libc::c_void,
    mut offset: file_ptr,
    ...
    if (offset as libc::c_ulong).wrapping_add(count) < count
        || (offset as libc::c_ulong).wrapping_add(count) > (*section).size
    {
    ...
    if ((*section).used_by_bfd).is_null() {
        ...
        if !srec_read_section(abfd, section, (*section).used_by_bfd as *mut bfd_byte) {
            return 0 as libc::c_int != 0;
        }
    }
    memcpy(
        location,
        ((*section).used_by_bfd as *mut bfd_byte).offset(offset as isize)
            as *const libc::c_void,
        count,
    );
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn srec_set_arch_mach(
    mut abfd: *mut bfd,
...
unsafe extern "C" fn srec_set_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
    mut location: *const libc::c_void,
    mut offset: file_ptr,
    mut bytes_to_do: bfd_size_type,
) -> bool {
    let mut opb: libc::c_int = bfd_octets_per_byte(abfd, 0 as *const asection)
        as libc::c_int;
    let mut tdata: *mut tdata_type = (*abfd).tdata.srec_data;
    let mut entry: *mut srec_data_list_type = 0 as *mut srec_data_list_type;
    entry = bfd_alloc(
        abfd,
        ::core::mem::size_of::<srec_data_list_type>() as libc::c_ulong,
    ) as *mut srec_data_list_type;
    if entry.is_null() {
        return 0 as libc::c_int != 0;
    }
    if bytes_to_do != 0 && (*section).flags & 0x1 as libc::c_int as libc::c_uint != 0
        && (*section).flags & 0x2 as libc::c_int as libc::c_uint != 0
    {
        let mut data: *mut bfd_byte = 0 as *mut bfd_byte;
        data = bfd_alloc(abfd, bytes_to_do) as *mut bfd_byte;
        if data.is_null() {
            return 0 as libc::c_int != 0;
        }
        memcpy(data as *mut libc::c_void, location, bytes_to_do);
        if _bfd_srec_forceS3 {
            (*tdata).type_0 = 3 as libc::c_int as libc::c_uint;
        } else if !(((*section).lma)
            .wrapping_add(
                (offset as libc::c_ulong)
                    .wrapping_add(bytes_to_do)
            ...
            <= 0xffff as libc::c_int as libc::c_ulong)
        {
            if ((*section).lma)
                ...
                && (*tdata).type_0 <= 2 as libc::c_int as libc::c_uint
            {
                (*tdata).type_0 = 2 as libc::c_int as libc::c_uint;
            } else {
                (*tdata).type_0 = 3 as libc::c_int as libc::c_uint;
        ...
        (*entry)
            .where_0 = ((*section).lma)
            .wrapping_add((offset / opb as libc::c_long) as libc::c_ulong);
        (*entry).size = bytes_to_do;
        if !((*tdata).tail).is_null() && (*entry).where_0 >= (*(*tdata).tail).where_0 {
            (*(*tdata).tail).next = entry;
            (*entry).next = 0 as *mut srec_data_list_struct;
            (*tdata).tail = entry;
        } else {
            let mut look: *mut *mut srec_data_list_type = 0
                as *mut *mut srec_data_list_type;
            look = &mut (*tdata).head;
            while !(*look).is_null() && (**look).where_0 < (*entry).where_0 {
                look = &mut (**look).next;
            }
            (*entry).next = *look;
            *look = entry;
...
unsafe extern "C" fn srec_write_record(
    mut abfd: *mut bfd,
    mut type_0: libc::c_uint,
    mut address: bfd_vma,
    mut data: *const bfd_byte,
    mut end: *const bfd_byte,
) -> bool {
    let mut buffer: [libc::c_char; 516] = [0; 516];
    let mut check_sum: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut src: *const bfd_byte = data;
    let mut dst: *mut libc::c_char = buffer.as_mut_ptr();
    let mut length: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut wrlen: bfd_size_type = 0;
    let fresh4 = dst;
    dst = dst.offset(1);
    *fresh4 = 'S' as i32 as libc::c_char;
    let fresh5 = dst;
    dst = dst.offset(1);
    *fresh5 = ('0' as i32 as libc::c_uint).wrapping_add(type_0) as libc::c_char;
    length = dst;
    ...
    match type_0 {
        3 | 7 => {
            *dst
                ...
                ) = digs[(address >> 24 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            *dst
                .offset(
                    0 as libc::c_int as isize,
                ) = digs[(address >> 24 as libc::c_int >> 4 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            check_sum = (check_sum as libc::c_ulong)
                .wrapping_add(
                    address >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_ulong,
                ) as libc::c_uint as libc::c_uint;
            dst = dst.offset(2 as libc::c_int as isize);
            current_block_23 = 821905187581955673;
        }
        8 | 2 => {
            current_block_23 = 821905187581955673;
        }
        9 | 1 | 0 => {
            current_block_23 = 5310516696238440932;
        }
        _ => {
    ...
    match current_block_23 {
        821905187581955673 => {
            *dst
                .offset(
                    1 as libc::c_int as isize,
                ) = digs[(address >> 16 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            *dst
                .offset(
                    0 as libc::c_int as isize,
                ) = digs[(address >> 16 as libc::c_int >> 4 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            check_sum = (check_sum as libc::c_ulong)
                .wrapping_add(
                    address >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_ulong,
                ) as libc::c_uint as libc::c_uint;
            dst = dst.offset(2 as libc::c_int as isize);
            current_block_23 = 5310516696238440932;
        }
    ...
    match current_block_23 {
        5310516696238440932 => {
            *dst
                .offset(
                    1 as libc::c_int as isize,
                ) = digs[(address >> 8 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            *dst
                .offset(
                    0 as libc::c_int as isize,
                ) = digs[(address >> 8 as libc::c_int >> 4 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            check_sum = (check_sum as libc::c_ulong)
                .wrapping_add(
                    address >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_ulong,
                ) as libc::c_uint as libc::c_uint;
            dst = dst.offset(2 as libc::c_int as isize);
            *dst
                .offset(
                    1 as libc::c_int as isize,
                ) = digs[(address & 0xf as libc::c_int as libc::c_ulong) as usize];
            *dst
                .offset(
                    0 as libc::c_int as isize,
                ) = digs[(address >> 4 as libc::c_int
                & 0xf as libc::c_int as libc::c_ulong) as usize];
            check_sum = (check_sum as libc::c_ulong)
                .wrapping_add(address & 0xff as libc::c_int as libc::c_ulong)
                as libc::c_uint as libc::c_uint;
            dst = dst.offset(2 as libc::c_int as isize);
        }
        _ => {}
    ...
    while src < end {
        *dst
            .offset(
                1 as libc::c_int as isize,
            ) = digs[(*src as libc::c_int & 0xf as libc::c_int) as usize];
        *dst
            .offset(
                0 as libc::c_int as isize,
            ) = digs[(*src as libc::c_int >> 4 as libc::c_int & 0xf as libc::c_int)
            as usize];
        check_sum = check_sum
            .wrapping_add((*src as libc::c_int & 0xff as libc::c_int) as libc::c_uint);
        dst = dst.offset(2 as libc::c_int as isize);
        src = src.offset(1);
        src;
    }
    *length
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(dst.offset_from(length) as libc::c_long
        / 2 as libc::c_int as libc::c_long & 0xf as libc::c_int as libc::c_long)
        as usize];
    *length
        .offset(
            0 as libc::c_int as isize,
        ) = digs[(dst.offset_from(length) as libc::c_long
        / 2 as libc::c_int as libc::c_long >> 4 as libc::c_int
        & 0xf as libc::c_int as libc::c_long) as usize];
    check_sum = (check_sum as libc::c_long
        + (dst.offset_from(length) as libc::c_long / 2 as libc::c_int as libc::c_long
            & 0xff as libc::c_int as libc::c_long)) as libc::c_uint;
    check_sum &= 0xff as libc::c_int as libc::c_uint;
    check_sum = (255 as libc::c_int as libc::c_uint).wrapping_sub(check_sum);
    *dst
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(check_sum & 0xf as libc::c_int as libc::c_uint) as usize];
    *dst
        .offset(
            0 as libc::c_int as isize,
        ) = digs[(check_sum >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_uint)
        as usize];
    check_sum = check_sum.wrapping_add(check_sum & 0xff as libc::c_int as libc::c_uint);
    dst = dst.offset(2 as libc::c_int as isize);
    let fresh6 = dst;
    dst = dst.offset(1);
    ...
    *fresh7 = '\n' as i32 as libc::c_char;
    wrlen = dst.offset_from(buffer.as_mut_ptr()) as libc::c_long as bfd_size_type;
    return bfd_bwrite(buffer.as_mut_ptr() as *mut libc::c_void, wrlen, abfd) == wrlen;
}
unsafe extern "C" fn srec_write_header(mut abfd: *mut bfd) -> bool {
    let mut len: libc::c_uint = strlen(bfd_get_filename(abfd)) as libc::c_uint;
    if len > 40 as libc::c_int as libc::c_uint {
        len = 40 as libc::c_int as libc::c_uint;
    }
    return srec_write_record(
        abfd,
        0 as libc::c_int as libc::c_uint,
        0 as libc::c_int as bfd_vma,
        bfd_get_filename(abfd) as *mut bfd_byte,
        (bfd_get_filename(abfd) as *mut bfd_byte).offset(len as isize),
    );
}
unsafe extern "C" fn srec_write_section(
    mut abfd: *mut bfd,
    mut tdata: *mut tdata_type,
    mut list: *mut srec_data_list_type,
) -> bool {
    let mut octets_written: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut location: *mut bfd_byte = (*list).data;
    if _bfd_srec_len == 0 as libc::c_int as libc::c_uint {
        _bfd_srec_len = 1 as libc::c_int as libc::c_uint;
    } else if _bfd_srec_len
        > (0xff as libc::c_int as libc::c_uint)
            .wrapping_sub((*tdata).type_0)
            .wrapping_sub(2 as libc::c_int as libc::c_uint)
    {
        _bfd_srec_len = (0xff as libc::c_int as libc::c_uint)
            .wrapping_sub((*tdata).type_0)
            .wrapping_sub(2 as libc::c_int as libc::c_uint);
    }
    while (octets_written as libc::c_ulong) < (*list).size {
        let mut address: bfd_vma = 0;
        let mut octets_this_chunk: libc::c_uint = ((*list).size)
            .wrapping_sub(octets_written as libc::c_ulong) as libc::c_uint;
        if octets_this_chunk > _bfd_srec_len {
            octets_this_chunk = _bfd_srec_len;
        }
        address = ((*list).where_0)
            .wrapping_add(
                octets_written
                    .wrapping_div(bfd_octets_per_byte(abfd, 0 as *const asection))
                    as libc::c_ulong,
            );
        if !srec_write_record(
            abfd,
            (*tdata).type_0,
            address,
            location,
            location.offset(octets_this_chunk as isize),
        ) {
            return 0 as libc::c_int != 0;
        }
        octets_written = octets_written.wrapping_add(octets_this_chunk);
        location = location.offset(octets_this_chunk as isize);
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn srec_write_terminator(
    mut abfd: *mut bfd,
    mut tdata: *mut tdata_type,
) -> bool {
    return srec_write_record(
        abfd,
        (10 as libc::c_int as libc::c_uint).wrapping_sub((*tdata).type_0),
        (*abfd).start_address,
        0 as *const bfd_byte,
        0 as *const bfd_byte,
    );
}
unsafe extern "C" fn srec_write_symbols(mut abfd: *mut bfd) -> bool {
    let mut i: libc::c_int = 0;
    let mut count: libc::c_int = bfd_get_symcount(abfd) as libc::c_int;
    if count != 0 {
        let mut len: bfd_size_type = 0;
        let mut table: *mut *mut asymbol = bfd_get_outsymbols(abfd);
        ...
        if bfd_bwrite(
            ...
            || bfd_bwrite(bfd_get_filename(abfd) as *const libc::c_void, len, abfd)
                != len
            || bfd_bwrite(
        ...
        i = 0 as libc::c_int;
        while i < count {
            let mut s: *mut asymbol = *table.offset(i as isize);
            if !bfd_is_local_label(abfd, s)
                && (*s).flags & ((1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint
                    == 0 as libc::c_int as libc::c_uint && !((*s).section).is_null()
                && !((*(*s).section).output_section).is_null()
            {
                ...
                if bfd_bwrite(
                    ...
                    || bfd_bwrite((*s).name as *const libc::c_void, len, abfd) != len
                {
                    return 0 as libc::c_int != 0;
                }
                sprintf(
                    ...
                    ((*s).value)
                        .wrapping_add((*(*(*s).section).output_section).lma)
                        .wrapping_add((*(*s).section).output_offset),
                );
                p = buf.as_mut_ptr().offset(2 as libc::c_int as isize);
                while *p.offset(0 as libc::c_int as isize) as libc::c_int == '0' as i32
                ...
                len = strlen(p);
                *p.offset(len as isize) = '\r' as i32 as libc::c_char;
                *p
                    .offset(
                ...
                *p = ' ' as i32 as libc::c_char;
                len = (len as libc::c_ulong)
                    .wrapping_add(4 as libc::c_int as libc::c_ulong) as bfd_size_type
                    as bfd_size_type;
                if bfd_bwrite(p as *const libc::c_void, len, abfd) != len {
                    return 0 as libc::c_int != 0;
                }
            }
            i += 1;
        ...
        if bfd_bwrite(
            b"$$ \r\n\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            5 as libc::c_int as bfd_size_type,
            abfd,
...
unsafe extern "C" fn internal_srec_write_object_contents(
    mut abfd: *mut bfd,
    mut symbols: libc::c_int,
) -> bool {
    let mut tdata: *mut tdata_type = (*abfd).tdata.srec_data;
    let mut list: *mut srec_data_list_type = 0 as *mut srec_data_list_type;
    if symbols != 0 {
...
unsafe extern "C" fn srec_write_object_contents(mut abfd: *mut bfd) -> bool {
    return internal_srec_write_object_contents(abfd, 0 as libc::c_int);
}
unsafe extern "C" fn symbolsrec_write_object_contents(mut abfd: *mut bfd) -> bool {
...
unsafe extern "C" fn srec_get_symtab_upper_bound(mut abfd: *mut bfd) -> libc::c_long {
...
unsafe extern "C" fn srec_canonicalize_symtab(
    mut abfd: *mut bfd,
    mut alocation: *mut *mut asymbol,
) -> libc::c_long {
    let mut symcount: bfd_size_type = bfd_get_symcount(abfd) as bfd_size_type;
    let mut csymbols: *mut asymbol = 0 as *mut asymbol;
    let mut i: libc::c_uint = 0;
    csymbols = (*(*abfd).tdata.srec_data).csymbols;
    if csymbols.is_null() && symcount != 0 as libc::c_int as libc::c_ulong {
        let mut c: *mut asymbol = 0 as *mut asymbol;
        let mut s: *mut srec_symbol = 0 as *mut srec_symbol;
        csymbols = bfd_alloc(
            abfd,
            symcount.wrapping_mul(::core::mem::size_of::<asymbol>() as libc::c_ulong),
        ) as *mut asymbol;
        if csymbols.is_null() {
            return -(1 as libc::c_int) as libc::c_long;
        }
        (*(*abfd).tdata.srec_data).csymbols = csymbols;
        s = (*(*abfd).tdata.srec_data).symbols;
        c = csymbols;
        while !s.is_null() {
            (*c).the_bfd = abfd;
            (*c).name = (*s).name;
            (*c).value = (*s).val;
            (*c).flags = ((1 as libc::c_int) << 1 as libc::c_int) as flagword;
            (*c)
                .section = &mut *_bfd_std_section
                .as_mut_ptr()
                .offset(2 as libc::c_int as isize) as *mut asection;
            (*c).udata.p = 0 as *mut libc::c_void;
            s = (*s).next;
            c = c.offset(1);
            c;
        }
    ...
    while (i as libc::c_ulong) < symcount {
        let fresh8 = csymbols;
        csymbols = csymbols.offset(1);
        let fresh9 = alocation;
        alocation = alocation.offset(1);
        *fresh9 = fresh8;
        i = i.wrapping_add(1);
        i;
    }
    *alocation = 0 as *mut asymbol;
...
unsafe extern "C" fn srec_print_symbol(
    mut abfd: *mut bfd,
    mut afile: *mut libc::c_void,
    mut symbol: *mut asymbol,
    mut how: bfd_print_symbol_type,
) {
    let mut file: *mut FILE = afile as *mut FILE;
...
#[no_mangle]
pub static mut srec_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"srec\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_srec_flavour,
            byteorder: BFD_ENDIAN_UNKNOWN,
            header_byteorder: BFD_ENDIAN_UNKNOWN,
            object_flags: (0x1 as libc::c_int | 0x2 as libc::c_int | 0x4 as libc::c_int
                ...
                | 0x80 as libc::c_int | 0x100 as libc::c_int) as flagword,
            section_flags: (0x10 as libc::c_int | 0x20 as libc::c_int
                | 0x40 as libc::c_int | 0x100 as libc::c_int | 0x1 as libc::c_int
                | 0x2 as libc::c_int | 0x4 as libc::c_int) as flagword,
            symbol_leading_char: 0 as libc::c_int as libc::c_char,
            ar_pad_char: ' ' as i32 as libc::c_char,
            ar_max_namelen: 16 as libc::c_int as libc::c_uchar,
            match_priority: 0 as libc::c_int as libc::c_uchar,
            keep_unused_section_symbols: 1 as libc::c_int != 0,
            bfd_getx64: Some(
                bfd_getb64 as unsafe extern "C" fn(*const libc::c_void) -> bfd_uint64_t,
            ),
            ...
            bfd_putx64: Some(
                bfd_putb64 as unsafe extern "C" fn(bfd_uint64_t, *mut libc::c_void) -> (),
            ),
            bfd_getx32: Some(
                bfd_getb32 as unsafe extern "C" fn(*const libc::c_void) -> bfd_vma,
            ),
            ...
            bfd_putx32: Some(
                bfd_putb32 as unsafe extern "C" fn(bfd_vma, *mut libc::c_void) -> (),
            ),
            bfd_getx16: Some(
                bfd_getb16 as unsafe extern "C" fn(*const libc::c_void) -> bfd_vma,
            ),
            ...
            bfd_putx16: Some(
                bfd_putb16 as unsafe extern "C" fn(bfd_vma, *mut libc::c_void) -> (),
            ),
            bfd_h_getx64: Some(
                bfd_getb64 as unsafe extern "C" fn(*const libc::c_void) -> bfd_uint64_t,
            ),
            ...
            _bfd_check_format: [
                ...
                Some(srec_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
            ],
            _bfd_set_format: [
                ...
                Some(srec_mkobject as unsafe extern "C" fn(*mut bfd) -> bool),
            ...
            _bfd_write_contents: [
                ...
                Some(
                    srec_write_object_contents as unsafe extern "C" fn(*mut bfd) -> bool,
                ),
                Some(
            ...
            _close_and_cleanup: Some(
                _bfd_archive_close_and_cleanup as unsafe extern "C" fn(*mut bfd) -> bool,
            ),
            ...
            _get_reloc_upper_bound: Some(
                _bfd_norelocs_get_reloc_upper_bound
                    as unsafe extern "C" fn(*mut bfd, *mut asection) -> libc::c_long,
            ),
            _bfd_canonicalize_reloc: Some(
                _bfd_norelocs_canonicalize_reloc
                    as unsafe extern "C" fn(
                        *mut bfd,
                        *mut asection,
                        *mut *mut arelent,
...
#[no_mangle]
pub static mut symbolsrec_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"symbolsrec\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_srec_flavour,
            byteorder: BFD_ENDIAN_UNKNOWN,
            header_byteorder: BFD_ENDIAN_UNKNOWN,
            object_flags: (0x1 as libc::c_int | 0x2 as libc::c_int | 0x4 as libc::c_int
            ...
            _bfd_check_format: [
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(
                    symbolsrec_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup,
                ),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
            ],
