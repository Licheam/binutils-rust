...
extern "C" {
    ...
    fn bfd_putb64(_: bfd_uint64_t, _: *mut libc::c_void);
    ...
    fn _bfd_elf_convert_gnu_property_size(_: *mut bfd, _: *mut bfd) -> bfd_size_type;
    fn _bfd_elf_convert_gnu_properties(
        _: *mut bfd,
        _: *mut asection,
        _: *mut bfd,
        _: *mut *mut bfd_byte,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_tdata {
    pub reloc_filepos: file_ptr,
    pub sym_filepos: file_ptr,
    pub text_start: libc::c_ulong,
    pub text_end: libc::c_ulong,
    pub gp: bfd_vma,
    pub gp_size: libc::c_uint,
    pub gprmask: libc::c_ulong,
    pub fprmask: libc::c_ulong,
    pub cprmask: [libc::c_ulong; 4],
    pub debug_info: ecoff_debug_info,
    pub raw_syments: *mut libc::c_void,
    pub canonical_symbols: *mut ecoff_symbol_struct,
    pub sym_hashes: *mut *mut ecoff_link_hash_entry,
    pub symndx_to_section: *mut *mut asection,
    pub linker: bool,
    pub issued_multiple_gp_warning: bool,
    pub find_line_info: *mut ecoff_find_line,
    pub rdata_in_text: bool,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_find_line {
    pub find_buffer: *mut libc::c_char,
    pub fdrtab_len: libc::c_long,
    pub fdrtab: *mut ecoff_fdrtab_entry,
    pub cache: C2RustUnnamed_19,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_19 {
    pub sect: *mut asection,
    pub start: bfd_vma,
    pub stop: bfd_vma,
    pub filename: *const libc::c_char,
    pub functionname: *const libc::c_char,
    pub line_num: libc::c_uint,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_fdrtab_entry {
    pub base_addr: bfd_vma,
    pub fdr: *mut FDR,
}
pub type FDR = fdr;
#[derive(Copy, Clone, BitfieldStruct)]
...
pub struct fdr {
    pub adr: bfd_vma,
    pub rss: libc::c_long,
    pub issBase: libc::c_long,
    pub cbSs: bfd_vma,
    pub isymBase: libc::c_long,
    pub csym: libc::c_long,
    pub ilineBase: libc::c_long,
    pub cline: libc::c_long,
    pub ioptBase: libc::c_long,
    pub copt: libc::c_long,
    pub ipdFirst: libc::c_ushort,
    pub cpd: libc::c_short,
    pub iauxBase: libc::c_long,
    pub caux: libc::c_long,
    pub rfdBase: libc::c_long,
    pub crfd: libc::c_long,
    #[bitfield(name = "lang", ty = "libc::c_uint", bits = "0..=4")]
    #[bitfield(name = "fMerge", ty = "libc::c_uint", bits = "5..=5")]
    #[bitfield(name = "fReadin", ty = "libc::c_uint", bits = "6..=6")]
    #[bitfield(name = "fBigendian", ty = "libc::c_uint", bits = "7..=7")]
    #[bitfield(name = "glevel", ty = "libc::c_uint", bits = "8..=9")]
    #[bitfield(name = "reserved", ty = "libc::c_uint", bits = "10..=31")]
    pub lang_fMerge_fReadin_fBigendian_glevel_reserved: [u8; 4],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 4],
    pub cbLineOffset: bfd_vma,
    pub cbLine: bfd_vma,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_link_hash_entry {
    pub root: bfd_link_hash_entry,
    pub indx: libc::c_long,
    pub abfd: *mut bfd,
    pub esym: EXTR,
    pub written: libc::c_char,
    pub small: libc::c_char,
}
pub type EXTR = ecoff_extr;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct ecoff_extr {
    #[bitfield(name = "jmptbl", ty = "libc::c_uint", bits = "0..=0")]
    #[bitfield(name = "cobol_main", ty = "libc::c_uint", bits = "1..=1")]
    #[bitfield(name = "weakext", ty = "libc::c_uint", bits = "2..=2")]
    #[bitfield(name = "reserved", ty = "libc::c_uint", bits = "3..=15")]
    pub jmptbl_cobol_main_weakext_reserved: [u8; 2],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 2],
    pub ifd: libc::c_int,
    pub asym: SYMR,
...
pub struct SYMR {
    pub iss: libc::c_long,
    pub value: bfd_vma,
    #[bitfield(name = "st", ty = "libc::c_uint", bits = "0..=5")]
    #[bitfield(name = "sc", ty = "libc::c_uint", bits = "6..=10")]
    #[bitfield(name = "reserved", ty = "libc::c_uint", bits = "11..=11")]
    #[bitfield(name = "index", ty = "libc::c_uint", bits = "12..=31")]
    pub st_sc_reserved_index: [u8; 4],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 4],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_symbol_struct {
    pub symbol: asymbol,
    pub fdr: *mut FDR,
    pub local: bool,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_debug_info {
    pub symbolic_header: HDRR,
    pub line: *mut libc::c_uchar,
    pub external_dnr: *mut libc::c_void,
    pub external_pdr: *mut libc::c_void,
    pub external_sym: *mut libc::c_void,
    pub external_opt: *mut libc::c_void,
    pub external_aux: *mut aux_ext,
    pub ss: *mut libc::c_char,
    pub ssext: *mut libc::c_char,
    pub external_fdr: *mut libc::c_void,
    pub external_rfd: *mut libc::c_void,
    pub external_ext: *mut libc::c_void,
    pub ssext_end: *mut libc::c_char,
    pub external_ext_end: *mut libc::c_void,
    pub ifdmap: *mut RFDT,
    pub fdr: *mut FDR,
}
pub type RFDT = libc::c_long;
#[derive(Copy, Clone)]
#[repr(C)]
pub union aux_ext {
    pub a_ti: tir_ext,
    pub a_rndx: rndx_ext,
    pub a_dnLow: [libc::c_uchar; 4],
    pub a_dnHigh: [libc::c_uchar; 4],
    pub a_isym: [libc::c_uchar; 4],
    pub a_iss: [libc::c_uchar; 4],
    pub a_width: [libc::c_uchar; 4],
    pub a_count: [libc::c_uchar; 4],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct rndx_ext {
    pub r_bits: [libc::c_uchar; 4],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tir_ext {
    pub t_bits1: [libc::c_uchar; 1],
    pub t_tq45: [libc::c_uchar; 1],
    pub t_tq01: [libc::c_uchar; 1],
    pub t_tq23: [libc::c_uchar; 1],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct HDRR {
    ...
    pub ilineMax: libc::c_long,
    pub cbLine: bfd_vma,
    pub cbLineOffset: bfd_vma,
    pub idnMax: libc::c_long,
    pub cbDnOffset: bfd_vma,
    pub ipdMax: libc::c_long,
    pub cbPdOffset: bfd_vma,
    pub isymMax: libc::c_long,
    pub cbSymOffset: bfd_vma,
    pub ioptMax: libc::c_long,
    pub cbOptOffset: bfd_vma,
    pub iauxMax: libc::c_long,
    pub cbAuxOffset: bfd_vma,
    pub issMax: libc::c_long,
    pub cbSsOffset: bfd_vma,
    pub issExtMax: libc::c_long,
    pub cbSsExtOffset: bfd_vma,
    pub ifdMax: libc::c_long,
    pub cbFdOffset: bfd_vma,
    pub crfd: libc::c_long,
    pub cbRfdOffset: bfd_vma,
    pub iextMax: libc::c_long,
    pub cbExtOffset: bfd_vma,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub union internal_auxent {
    pub x_sym: C2RustUnnamed_30,
    pub x_file: C2RustUnnamed_28,
    pub x_scn: C2RustUnnamed_27,
    pub x_tv: C2RustUnnamed_26,
    pub x_csect: C2RustUnnamed_21,
    pub x_sect: C2RustUnnamed_20,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct C2RustUnnamed_30 {
    pub x_tagndx: C2RustUnnamed_37,
    pub x_misc: C2RustUnnamed_35,
    pub x_fcnary: C2RustUnnamed_31,
    pub x_tvndx: libc::c_ushort,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union C2RustUnnamed_31 {
    pub x_fcn: C2RustUnnamed_33,
    pub x_ary: C2RustUnnamed_32,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ecoff_debug_swap {
    pub sym_magic: libc::c_int,
    pub debug_align: bfd_size_type,
    pub external_hdr_size: bfd_size_type,
    pub external_dnr_size: bfd_size_type,
    pub external_pdr_size: bfd_size_type,
    pub external_sym_size: bfd_size_type,
    pub external_opt_size: bfd_size_type,
    pub external_fdr_size: bfd_size_type,
    pub external_rfd_size: bfd_size_type,
    pub external_ext_size: bfd_size_type,
    pub swap_hdr_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut HDRR) -> (),
    >,
    pub swap_dnr_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut DNR) -> (),
    >,
    pub swap_pdr_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut PDR) -> (),
    >,
    pub swap_sym_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut SYMR) -> (),
    >,
    pub swap_opt_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut OPTR) -> (),
    >,
    pub swap_fdr_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut FDR) -> (),
    >,
    pub swap_rfd_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut RFDT) -> (),
    >,
    pub swap_ext_in: Option::<
        unsafe extern "C" fn(*mut bfd, *mut libc::c_void, *mut EXTR) -> (),
    >,
    pub swap_tir_in: Option::<
        unsafe extern "C" fn(libc::c_int, *const tir_ext, *mut TIR) -> (),
    >,
    pub swap_rndx_in: Option::<
        unsafe extern "C" fn(libc::c_int, *const rndx_ext, *mut RNDXR) -> (),
    >,
    pub swap_hdr_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const HDRR, *mut libc::c_void) -> (),
    >,
    pub swap_dnr_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const DNR, *mut libc::c_void) -> (),
    >,
    pub swap_pdr_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const PDR, *mut libc::c_void) -> (),
    >,
    pub swap_sym_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const SYMR, *mut libc::c_void) -> (),
    >,
    pub swap_opt_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const OPTR, *mut libc::c_void) -> (),
    >,
    pub swap_fdr_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const FDR, *mut libc::c_void) -> (),
    >,
    pub swap_rfd_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const RFDT, *mut libc::c_void) -> (),
    >,
    pub swap_ext_out: Option::<
        unsafe extern "C" fn(*mut bfd, *const EXTR, *mut libc::c_void) -> (),
    >,
    pub swap_tir_out: Option::<
        unsafe extern "C" fn(libc::c_int, *const TIR, *mut tir_ext) -> (),
    >,
    pub swap_rndx_out: Option::<
        unsafe extern "C" fn(libc::c_int, *const RNDXR, *mut rndx_ext) -> (),
    >,
    pub read_debug_info: Option::<
        unsafe extern "C" fn(*mut bfd, *mut asection, *mut ecoff_debug_info) -> bool,
    >,
}
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct RNDXR {
    #[bitfield(name = "rfd", ty = "libc::c_uint", bits = "0..=11")]
    #[bitfield(name = "index", ty = "libc::c_uint", bits = "12..=31")]
    pub rfd_index: [u8; 4],
}
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct TIR {
    #[bitfield(name = "fBitfield", ty = "libc::c_uint", bits = "0..=0")]
    #[bitfield(name = "continued", ty = "libc::c_uint", bits = "1..=1")]
    #[bitfield(name = "bt", ty = "libc::c_uint", bits = "2..=7")]
    #[bitfield(name = "tq4", ty = "libc::c_uint", bits = "8..=11")]
    #[bitfield(name = "tq5", ty = "libc::c_uint", bits = "12..=15")]
    #[bitfield(name = "tq0", ty = "libc::c_uint", bits = "16..=19")]
    #[bitfield(name = "tq1", ty = "libc::c_uint", bits = "20..=23")]
    #[bitfield(name = "tq2", ty = "libc::c_uint", bits = "24..=27")]
    #[bitfield(name = "tq3", ty = "libc::c_uint", bits = "28..=31")]
    pub fBitfield_continued_bt_tq4_tq5_tq0_tq1_tq2_tq3: [u8; 4],
}
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct OPTR {
    #[bitfield(name = "ot", ty = "libc::c_uint", bits = "0..=7")]
    #[bitfield(name = "value", ty = "libc::c_uint", bits = "8..=31")]
    pub ot_value: [u8; 4],
    pub rndx: RNDXR,
...
pub struct pdr {
    pub adr: bfd_vma,
    pub isym: libc::c_long,
    pub iline: libc::c_long,
    pub regmask: libc::c_long,
    pub regoffset: libc::c_long,
    pub iopt: libc::c_long,
    pub fregmask: libc::c_long,
    pub fregoffset: libc::c_long,
    pub frameoffset: libc::c_long,
    pub framereg: libc::c_short,
    pub pcreg: libc::c_short,
    pub lnLow: libc::c_long,
    pub lnHigh: libc::c_long,
    pub cbLineOffset: bfd_vma,
    #[bitfield(name = "gp_prologue", ty = "libc::c_uint", bits = "0..=7")]
    #[bitfield(name = "gp_used", ty = "libc::c_uint", bits = "8..=8")]
    #[bitfield(name = "reg_frame", ty = "libc::c_uint", bits = "9..=9")]
    #[bitfield(name = "prof", ty = "libc::c_uint", bits = "10..=10")]
    #[bitfield(name = "reserved", ty = "libc::c_uint", bits = "11..=23")]
    #[bitfield(name = "localoff", ty = "libc::c_uint", bits = "24..=31")]
    pub gp_prologue_gp_used_reg_frame_prof_reserved_localoff: [u8; 4],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 4],
}
#[derive(Copy, Clone)]
...
pub union _bfd_doprnt_args {
    ...
    pub ld: f128::f128,
    pub p: *mut libc::c_void,
    pub type_0: C2RustUnnamed_43,
}
pub type C2RustUnnamed_43 = libc::c_uint;
pub const Ptr: C2RustUnnamed_43 = 6;
pub const LongDouble: C2RustUnnamed_43 = 5;
pub const Double: C2RustUnnamed_43 = 4;
pub const LongLong: C2RustUnnamed_43 = 3;
pub const Long: C2RustUnnamed_43 = 2;
pub const Int: C2RustUnnamed_43 = 1;
pub const Bad: C2RustUnnamed_43 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub union C2RustUnnamed_45 {
    pub fde: C2RustUnnamed_48,
    pub cie: C2RustUnnamed_46,
}
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct C2RustUnnamed_46 {
    pub u: C2RustUnnamed_47,
...
pub const _sch_isdigit: C2RustUnnamed_49 = 4;
pub type bfd_assert_handler_type = Option::<
    unsafe extern "C" fn(
        *const libc::c_char,
        *const libc::c_char,
        *const libc::c_char,
...
>;
pub const _sch_isalpha: C2RustUnnamed_49 = 136;
pub const _sch_isxdigit: C2RustUnnamed_49 = 256;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const _sch_isbasic: C2RustUnnamed_49 = 3088;
pub const _sch_iscppsp: C2RustUnnamed_49 = 3072;
pub const _sch_isgraph: C2RustUnnamed_49 = 172;
pub const _sch_isidnum: C2RustUnnamed_49 = 516;
pub const _sch_isalnum: C2RustUnnamed_49 = 140;
pub const _sch_isnvsp: C2RustUnnamed_49 = 2048;
pub const _sch_isvsp: C2RustUnnamed_49 = 1024;
pub const _sch_isidst: C2RustUnnamed_49 = 512;
pub const _sch_isupper: C2RustUnnamed_49 = 128;
pub const _sch_isspace: C2RustUnnamed_49 = 64;
pub const _sch_ispunct: C2RustUnnamed_49 = 32;
pub const _sch_isprint: C2RustUnnamed_49 = 16;
pub const _sch_islower: C2RustUnnamed_49 = 8;
pub const _sch_iscntrl: C2RustUnnamed_49 = 2;
pub const _sch_isblank: C2RustUnnamed_49 = 1;
#[inline]
...
#[inline]
unsafe extern "C" fn bfd_get_section_limit(
    mut abfd: *const bfd,
...
static mut bfd_error: bfd_error_type = bfd_error_no_error;
static mut input_bfd: *mut bfd = 0 as *const bfd as *mut bfd;
static mut input_error: bfd_error_type = bfd_error_no_error;
#[no_mangle]
pub static mut bfd_errmsgs: [*const libc::c_char; 23] = [
    b"no error\0" as *const u8 as *const libc::c_char,
    b"system call error\0" as *const u8 as *const libc::c_char,
    b"invalid bfd target\0" as *const u8 as *const libc::c_char,
    b"file in wrong format\0" as *const u8 as *const libc::c_char,
    b"archive object file in wrong format\0" as *const u8 as *const libc::c_char,
    b"invalid operation\0" as *const u8 as *const libc::c_char,
    b"memory exhausted\0" as *const u8 as *const libc::c_char,
    b"no symbols\0" as *const u8 as *const libc::c_char,
    b"archive has no index; run ranlib to add one\0" as *const u8 as *const libc::c_char,
    b"no more archived files\0" as *const u8 as *const libc::c_char,
    b"malformed archive\0" as *const u8 as *const libc::c_char,
    b"DSO missing from command line\0" as *const u8 as *const libc::c_char,
    b"file format not recognized\0" as *const u8 as *const libc::c_char,
    b"file format is ambiguous\0" as *const u8 as *const libc::c_char,
    b"section has no contents\0" as *const u8 as *const libc::c_char,
    b"nonrepresentable section on output\0" as *const u8 as *const libc::c_char,
    b"symbol needs debug section which does not exist\0" as *const u8
        as *const libc::c_char,
    b"bad value\0" as *const u8 as *const libc::c_char,
    b"file truncated\0" as *const u8 as *const libc::c_char,
    b"file too big\0" as *const u8 as *const libc::c_char,
    b"sorry, cannot handle this file\0" as *const u8 as *const libc::c_char,
    b"error reading %s: %s\0" as *const u8 as *const libc::c_char,
    b"#<invalid error code>\0" as *const u8 as *const libc::c_char,
];
#[no_mangle]
pub unsafe extern "C" fn bfd_get_error() -> bfd_error_type {
    return bfd_error;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_error(mut error_tag: bfd_error_type) {
    bfd_error = error_tag;
    if bfd_error as libc::c_uint >= bfd_error_on_input as libc::c_int as libc::c_uint {
        _bfd_abort(
            b"bfd.c\0" as *const u8 as *const libc::c_char,
            748 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 35],
                &[libc::c_char; 35],
            >(b"void bfd_set_error(bfd_error_type)\0"))
                .as_ptr(),
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_input_error(
    mut input: *mut bfd,
    mut error_tag: bfd_error_type,
) {
    bfd_error = bfd_error_on_input;
    input_bfd = input;
    input_error = error_tag;
    if input_error as libc::c_uint >= bfd_error_on_input as libc::c_int as libc::c_uint {
        _bfd_abort(
            b"bfd.c\0" as *const u8 as *const libc::c_char,
            774 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 48],
                &[libc::c_char; 48],
            >(b"void bfd_set_input_error(bfd *, bfd_error_type)\0"))
                .as_ptr(),
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn bfd_errmsg(
    mut error_tag: bfd_error_type,
) -> *const libc::c_char {
    if error_tag as libc::c_uint == bfd_error_on_input as libc::c_int as libc::c_uint {
        let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
        let mut msg: *const libc::c_char = bfd_errmsg(input_error);
        if asprintf(
            &mut buf as *mut *mut libc::c_char,
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                bfd_errmsgs[error_tag as usize],
                5 as libc::c_int,
            ),
    ...
    if error_tag as libc::c_uint == bfd_error_system_call as libc::c_int as libc::c_uint
    {
        return xstrerror(*__errno_location());
    }
    if error_tag as libc::c_uint
        > bfd_error_invalid_error_code as libc::c_int as libc::c_uint
    {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_perror(mut message: *const libc::c_char) {
    fflush(stdout);
    if message.is_null() || *message as libc::c_int == '\0' as i32 {
        fprintf(
            stderr,
...
static mut _bfd_error_program_name: *const libc::c_char = 0 as *const libc::c_char;
unsafe extern "C" fn _bfd_doprnt(
    mut stream: *mut FILE,
    mut format: *const libc::c_char,
    mut args: *mut _bfd_doprnt_args,
) -> libc::c_int {
    let mut ptr: *const libc::c_char = format;
    let mut specifier: [libc::c_char; 128] = [0; 128];
    let mut total_printed: libc::c_int = 0 as libc::c_int;
    let mut arg_count: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    while *ptr as libc::c_int != '\0' as i32 {
        let mut result: libc::c_int = 0;
        if *ptr as libc::c_int != '%' as i32 {
            let mut end: *mut libc::c_char = strchr(ptr, '%' as i32);
            if !end.is_null() {
                result = fprintf(
                    stream,
            ...
            ptr = ptr.offset(result as isize);
        } else if *ptr.offset(1 as libc::c_int as isize) as libc::c_int == '%' as i32 {
            fputc('%' as i32, stream);
            result = 1 as libc::c_int;
            ptr = ptr.offset(2 as libc::c_int as isize);
        } else {
            let mut sptr: *mut libc::c_char = specifier.as_mut_ptr();
            let mut wide_width: libc::c_int = 0 as libc::c_int;
            let mut short_width: libc::c_int = 0 as libc::c_int;
            let mut arg_no: libc::c_uint = 0;
            let fresh0 = ptr;
            ptr = ptr.offset(1);
            let fresh1 = sptr;
            sptr = sptr.offset(1);
            *fresh1 = *fresh0;
            arg_no = (1 as libc::c_uint).wrapping_neg();
            if *ptr as libc::c_int != '0' as i32
                && _sch_istable[(*ptr as libc::c_int & 0xff as libc::c_int) as usize]
                    as libc::c_int
                    & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
                && *ptr.offset(1 as libc::c_int as isize) as libc::c_int == '$' as i32
            {
                arg_no = (*ptr as libc::c_int - '1' as i32) as libc::c_uint;
                ptr = ptr.offset(2 as libc::c_int as isize);
            }
            while !(strchr(
                b"-+ #0'I\0" as *const u8 as *const libc::c_char,
                *ptr as libc::c_int,
            ))
                .is_null()
            {
            ...
            if *ptr as libc::c_int == '*' as i32 {
                ...
                let mut arg_index: libc::c_uint = 0;
                ptr = ptr.offset(1);
                ptr;
                arg_index = arg_count;
                if *ptr as libc::c_int != '0' as i32
                    ...
                    && *ptr.offset(1 as libc::c_int as isize) as libc::c_int
                        == '$' as i32
                {
                    arg_index = (*ptr as libc::c_int - '1' as i32) as libc::c_uint;
                    ptr = ptr.offset(2 as libc::c_int as isize);
                }
                value = abs((*args.offset(arg_index as isize)).i);
                arg_count = arg_count.wrapping_add(1);
                arg_count;
                sptr = sptr
                    .offset(
                        sprintf(sptr, b"%d\0" as *const u8 as *const libc::c_char, value)
                            as isize,
                    );
            } else {
                while _sch_istable[(*ptr as libc::c_int & 0xff as libc::c_int) as usize]
                    as libc::c_int
                    & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int != 0
                {
                    let fresh4 = ptr;
            ...
            if *ptr as libc::c_int == '.' as i32 {
                ...
                *fresh7 = *fresh6;
                if *ptr as libc::c_int == '*' as i32 {
                    ...
                    let mut arg_index_0: libc::c_uint = 0;
                    ptr = ptr.offset(1);
                    ptr;
                    arg_index_0 = arg_count;
                    if *ptr as libc::c_int != '0' as i32
                        && _sch_istable[(*ptr as libc::c_int & 0xff as libc::c_int)
                        ...
                        && *ptr.offset(1 as libc::c_int as isize) as libc::c_int
                            == '$' as i32
                    {
                        arg_index_0 = (*ptr as libc::c_int - '1' as i32) as libc::c_uint;
                        ptr = ptr.offset(2 as libc::c_int as isize);
                    }
                    value_0 = abs((*args.offset(arg_index_0 as isize)).i);
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                    sptr = sptr
                        .offset(
                    ...
                    while _sch_istable[(*ptr as libc::c_int & 0xff as libc::c_int)
                        as usize] as libc::c_int
                        & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int
                        != 0
                    {
                    ...
                    _ => {
                        _bfd_abort(
                            ...
                            (*::core::mem::transmute::<
                                ...
                                &[libc::c_char; 64],
                            >(
                                b"int _bfd_doprnt(FILE *, const char *, union _bfd_doprnt_args *)\0",
                            ))
                                .as_ptr(),
                        );
                    }
            ...
            *sptr = '\0' as i32 as libc::c_char;
            if (arg_no as libc::c_int) < 0 as libc::c_int {
                arg_no = arg_count;
            }
            match *ptr.offset(-(1 as libc::c_int) as isize) as libc::c_int {
                100 | 105 | 111 | 117 | 120 | 88 | 99 => {
                    if short_width != 0 {
                        let mut value_1: libc::c_int = (*args.offset(arg_no as isize)).i;
                        result = fprintf(stream, specifier.as_mut_ptr(), value_1);
                    } else {
                        match wide_width {
                            0 => {
                                let mut value_2: libc::c_int = (*args
                                    .offset(arg_no as isize))
                                    .i;
                                result = fprintf(stream, specifier.as_mut_ptr(), value_2);
                            }
                            1 => {
                                let mut value_3: libc::c_long = (*args
                                    .offset(arg_no as isize))
                                    .l;
                                result = fprintf(stream, specifier.as_mut_ptr(), value_3);
                            }
                            2 | _ => {
                                let mut value_4: libc::c_longlong = (*args
                                    .offset(arg_no as isize))
                                    .ll;
                                result = fprintf(stream, specifier.as_mut_ptr(), value_4);
                            }
                        }
                    }
                }
                102 | 101 | 69 | 103 | 71 => {
                    if wide_width == 0 as libc::c_int {
                        let mut value_5: libc::c_double = (*args.offset(arg_no as isize))
                            .d;
                        result = fprintf(stream, specifier.as_mut_ptr(), value_5);
                    } else {
                        let mut value_6: f128::f128 = (*args.offset(arg_no as isize)).ld;
                        result = fprintf(stream, specifier.as_mut_ptr(), value_6);
                    }
                }
                115 => {
                    let mut value_7: *mut libc::c_char = (*args.offset(arg_no as isize))
                        .p as *mut libc::c_char;
                    result = fprintf(stream, specifier.as_mut_ptr(), value_7);
                }
                112 => {
                    if *ptr as libc::c_int == 'A' as i32 {
                        ...
                        let mut ci: *mut coff_comdat_info = 0 as *mut coff_comdat_info;
                        ptr = ptr.offset(1);
                        ptr;
                        sec = (*args.offset(arg_no as isize)).p as *mut asection;
                        if sec.is_null() {
                            _bfd_abort(
                                b"bfd.c\0" as *const u8 as *const libc::c_char,
                                1085 as libc::c_int,
                        ...
                        if !abfd.is_null()
                            ...
                            && !((*((*sec).used_by_bfd as *mut bfd_elf_section_data))
                                .next_in_group)
                                .is_null()
                            && (*sec).flags & 0x2000000 as libc::c_int as libc::c_uint
                                == 0 as libc::c_int as libc::c_uint
                        {
                            group = (*((*sec).used_by_bfd as *mut bfd_elf_section_data))
                                .group
                                .name;
                        } else if !abfd.is_null()
                            && bfd_get_flavour(abfd) as libc::c_uint
                    ...
                    } else if *ptr as libc::c_int == 'B' as i32 {
                        let mut abfd_0: *mut bfd = 0 as *mut bfd;
                        ptr = ptr.offset(1);
                        ptr;
                        abfd_0 = (*args.offset(arg_no as isize)).p as *mut bfd;
                        if abfd_0.is_null() {
                            _bfd_abort(
                                b"bfd.c\0" as *const u8 as *const libc::c_char,
                                1111 as libc::c_int,
                        ...
                        } else if !((*abfd_0).my_archive).is_null()
                            && !bfd_is_thin_archive((*abfd_0).my_archive)
                        {
                            result = fprintf(
                                stream,
                                b"%s(%s)\0" as *const u8 as *const libc::c_char,
                                bfd_get_filename((*abfd_0).my_archive),
                                bfd_get_filename(abfd_0),
                            );
                        } else {
                            result = fprintf(
                                stream,
                        ...
                        let mut value_8: *mut libc::c_void = (*args
                            .offset(arg_no as isize))
                            .p;
                        result = fprintf(stream, specifier.as_mut_ptr(), value_8);
                    }
                }
                _ => {
                    _bfd_abort(
...
unsafe extern "C" fn _bfd_doprnt_scan(
    mut format: *const libc::c_char,
    mut args: *mut _bfd_doprnt_args,
) -> libc::c_uint {
    let mut ptr: *const libc::c_char = format;
    ...
    while *ptr as libc::c_int != '\0' as i32 {
        if *ptr as libc::c_int != '%' as i32 {
            ...
            if *ptr as libc::c_int == '*' as i32 {
                ...
                if arg_index >= 9 as libc::c_int as libc::c_uint {
                    _bfd_abort(
                        b"bfd.c\0" as *const u8 as *const libc::c_char,
                        1186 as libc::c_int,
                        (*::core::mem::transmute::<
                            ...
                            &[libc::c_char; 70],
                        >(
                            b"unsigned int _bfd_doprnt_scan(const char *, union _bfd_doprnt_args *)\0",
                        ))
                            .as_ptr(),
                    );
                }
                (*args.offset(arg_index as isize)).type_0 = Int;
                arg_count = arg_count.wrapping_add(1);
                arg_count;
            } else {
                while _sch_istable[(*ptr as libc::c_int & 0xff as libc::c_int) as usize]
            ...
            if *ptr as libc::c_int == '.' as i32 {
                ...
                if *ptr as libc::c_int == '*' as i32 {
                    ...
                    if arg_index_0 >= 9 as libc::c_int as libc::c_uint {
                        _bfd_abort(
                            b"bfd.c\0" as *const u8 as *const libc::c_char,
                            1211 as libc::c_int,
                            (*::core::mem::transmute::<
                    ...
                    (*args.offset(arg_index_0 as isize)).type_0 = Int;
                    arg_count = arg_count.wrapping_add(1);
                    arg_count;
                } else {
                    while _sch_istable[(*ptr as libc::c_int & 0xff as libc::c_int)
            ...
            arg_type = Bad as libc::c_int;
            match *ptr.offset(-(1 as libc::c_int) as isize) as libc::c_int {
                100 | 105 | 111 | 117 | 120 | 88 | 99 => {
                    if short_width != 0 {
                        arg_type = Int as libc::c_int;
                    } else {
                        match wide_width {
                            0 => {
                                arg_type = Int as libc::c_int;
                            ...
                            1 => {
                                arg_type = Long as libc::c_int;
                            }
                            2 | _ => {
                                arg_type = LongLong as libc::c_int;
                            }
                        }
                    }
                }
                102 | 101 | 69 | 103 | 71 => {
                    if wide_width == 0 as libc::c_int {
                        arg_type = Double as libc::c_int;
                    } else {
                        arg_type = LongDouble as libc::c_int;
                    }
                }
                115 => {
                    arg_type = Ptr as libc::c_int;
                }
                112 => {
                    if *ptr as libc::c_int == 'A' as i32
                        || *ptr as libc::c_int == 'B' as i32
                    {
                        ptr = ptr.offset(1);
                        ptr;
                    }
            ...
            if arg_no >= 9 as libc::c_int as libc::c_uint {
                _bfd_abort(
                    b"bfd.c\0" as *const u8 as *const libc::c_char,
                    1299 as libc::c_int,
                    (*::core::mem::transmute::<
            ...
            (*args.offset(arg_no as isize)).type_0 = arg_type as C2RustUnnamed_43;
            arg_count = arg_count.wrapping_add(1);
            arg_count;
        }
    }
...
unsafe extern "C" fn error_handler_internal(
    mut fmt: *const libc::c_char,
    mut ap: ::core::ffi::VaList,
) {
    let mut i: libc::c_uint = 0;
    let mut arg_count: libc::c_uint = 0;
    let mut args: [_bfd_doprnt_args; 9] = [_bfd_doprnt_args { i: 0 }; 9];
    i = 0 as libc::c_int as libc::c_uint;
    while (i as libc::c_ulong)
        < (::core::mem::size_of::<[_bfd_doprnt_args; 9]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<_bfd_doprnt_args>() as libc::c_ulong)
    {
        args[i as usize].type_0 = Bad;
        i = i.wrapping_add(1);
        i;
    }
    arg_count = _bfd_doprnt_scan(fmt, args.as_mut_ptr());
    i = 0 as libc::c_int as libc::c_uint;
    while i < arg_count {
        match args[i as usize].type_0 as libc::c_uint {
            1 => {
                args[i as usize].i = ap.arg::<libc::c_int>();
            }
            2 => {
                args[i as usize].l = ap.arg::<libc::c_long>();
            }
            3 => {
                args[i as usize].ll = ap.arg::<libc::c_longlong>();
            }
            4 => {
            ...
            _ => {
                _bfd_abort(
                    ...
                    (*::core::mem::transmute::<
                        ...
                        &[libc::c_char; 66],
                    >(
                        b"void error_handler_internal(const char *, struct __va_list_tag *)\0",
                    ))
                        .as_ptr(),
                );
            }
    ...
    fflush(stdout);
    if !_bfd_error_program_name.is_null() {
        fprintf(
            stderr,
            b"%s: \0" as *const u8 as *const libc::c_char,
        ...
        fprintf(stderr, b"BFD: \0" as *const u8 as *const libc::c_char);
    }
    _bfd_doprnt(stderr, fmt, args.as_mut_ptr());
    fputc('\n' as i32, stderr);
    fflush(stderr);
}
static mut _bfd_error_internal: bfd_error_handler_type = unsafe {
    Some(
        error_handler_internal
            as unsafe extern "C" fn(*const libc::c_char, ::core::ffi::VaList) -> (),
    )
};
#[no_mangle]
pub unsafe extern "C" fn _bfd_error_handler(
    mut fmt: *const libc::c_char,
    mut args: ...
) {
    let mut ap: ::core::ffi::VaListImpl;
    ap = args.clone();
    _bfd_error_internal.expect("non-null function pointer")(fmt, ap.as_va_list());
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_error_handler(
    mut pnew: bfd_error_handler_type,
) -> bfd_error_handler_type {
    let mut pold: bfd_error_handler_type = None;
    pold = _bfd_error_internal;
    _bfd_error_internal = pnew;
    return pold;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_error_program_name(mut name: *const libc::c_char) {
    _bfd_error_program_name = name;
}
unsafe extern "C" fn _bfd_default_assert_handler(
    mut bfd_formatmsg: *const libc::c_char,
    mut bfd_version: *const libc::c_char,
    mut bfd_file: *const libc::c_char,
    mut bfd_line: libc::c_int,
) {
    _bfd_error_handler(bfd_formatmsg, bfd_version, bfd_file, bfd_line);
}
static mut _bfd_assert_handler: bfd_assert_handler_type = unsafe {
    Some(
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_assert_handler(
    mut pnew: bfd_assert_handler_type,
) -> bfd_assert_handler_type {
    let mut pold: bfd_assert_handler_type = None;
    pold = _bfd_assert_handler;
    _bfd_assert_handler = pnew;
    return pold;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_get_reloc_upper_bound(
    mut abfd: *mut bfd,
    mut asect: sec_ptr,
) -> libc::c_long {
    if (*abfd).format() as libc::c_int != bfd_object as libc::c_int {
        bfd_set_error(bfd_error_invalid_operation);
        return -(1 as libc::c_int) as libc::c_long;
    }
    return (Some(
        ((*(*abfd).xvec)._get_reloc_upper_bound).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, asect);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_canonicalize_reloc(
    mut abfd: *mut bfd,
    mut asect: sec_ptr,
    mut location: *mut *mut arelent,
    ...
    return (Some(
        ((*(*abfd).xvec)._bfd_canonicalize_reloc).expect("non-null function pointer"),
    ))
        .expect("non-null function pointer")(abfd, asect, location, symbols);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_set_file_flags(
    mut abfd: *mut bfd,
    mut flags: flagword,
) -> bool {
    if (*abfd).format() as libc::c_int != bfd_object as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_assert(
    mut file: *const libc::c_char,
    mut line: libc::c_int,
) {
    (Some(_bfd_assert_handler.expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(
        dcgettext(
            b"bfd\0" as *const u8 as *const libc::c_char,
            b"BFD %s assertion fail %s:%d\0" as *const u8 as *const libc::c_char,
            5 as libc::c_int,
        ),
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_abort(
    mut file: *const libc::c_char,
    mut line: libc::c_int,
    ...
    if !fn_0.is_null() {
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"BFD %s internal error, aborting at %s:%d in %s\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            b"(GNU Binutils) 2.37\0" as *const u8 as *const libc::c_char,
        ...
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"BFD %s internal error, aborting at %s:%d\n\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            b"(GNU Binutils) 2.37\0" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_arch_size(mut abfd: *mut bfd) -> libc::c_int {
    if (*(*abfd).xvec).flavour as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        return (*(*((*(*abfd).xvec).backend_data as *const elf_backend_data)).s)
            .arch_size as libc::c_int;
    }
    return if bfd_arch_bits_per_address(abfd) > 32 as libc::c_int as libc::c_uint {
        64 as libc::c_int
    } else {
        32 as libc::c_int
    };
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_sign_extend_vma(mut abfd: *mut bfd) -> libc::c_int {
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
    if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        return (*((*(*abfd).xvec).backend_data as *const elf_backend_data))
            .sign_extend_vma() as libc::c_int;
    }
    name = bfd_get_target(abfd);
    if startswith(name, b"coff-go32\0" as *const u8 as *const libc::c_char)
        as libc::c_int != 0
        || strcmp(name, b"pe-i386\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"pei-i386\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"pe-x86-64\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"pei-x86-64\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"pe-arm-wince-little\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"pei-arm-wince-little\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"aixcoff-rs6000\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        || strcmp(name, b"aix5coff64-rs6000\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
        return 1 as libc::c_int;
    }
    if startswith(name, b"mach-o\0" as *const u8 as *const libc::c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_start_address(
    mut abfd: *mut bfd,
    mut vma: bfd_vma,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_gp_size(mut abfd: *mut bfd) -> libc::c_uint {
    if (*abfd).format() as libc::c_int == bfd_object as libc::c_int {
        if (*(*abfd).xvec).flavour as libc::c_uint
            == bfd_target_ecoff_flavour as libc::c_int as libc::c_uint
        {
            return (*(*abfd).tdata.ecoff_obj_data).gp_size
        } else if (*(*abfd).xvec).flavour as libc::c_uint
            == bfd_target_elf_flavour as libc::c_int as libc::c_uint
        {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_set_gp_size(mut abfd: *mut bfd, mut i: libc::c_uint) {
    if (*abfd).format() as libc::c_int != bfd_object as libc::c_int {
        return;
    }
    if (*(*abfd).xvec).flavour as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_get_gp_value(mut abfd: *mut bfd) -> bfd_vma {
    if abfd.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_set_gp_value(mut abfd: *mut bfd, mut v: bfd_vma) {
    if abfd.is_null() {
        _bfd_abort(
            b"bfd.c\0" as *const u8 as *const libc::c_char,
            1850 as libc::c_int,
            (*::core::mem::transmute::<
                &[u8; 39],
                &[libc::c_char; 39],
            >(b"void _bfd_set_gp_value(bfd *, bfd_vma)\0"))
                .as_ptr(),
        );
    }
    if (*abfd).format() as libc::c_int != bfd_object as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_scan_vma(
    mut string: *const libc::c_char,
    mut end: *mut *const libc::c_char,
    mut base: libc::c_int,
) -> bfd_vma {
    let mut value: bfd_vma = 0;
    let mut cutoff: bfd_vma = 0;
    ...
    {
        return strtoul(string, end as *mut *mut libc::c_char, base);
    }
    if ::core::mem::size_of::<bfd_vma>() as libc::c_ulong
        <= ::core::mem::size_of::<libc::c_ulonglong>() as libc::c_ulong
    {
        return strtoull(string, end as *mut *mut libc::c_char, base) as bfd_vma;
    }
    if base == 0 as libc::c_int {
        if *string.offset(0 as libc::c_int as isize) as libc::c_int == '0' as i32 {
            if *string.offset(1 as libc::c_int as isize) as libc::c_int == 'x' as i32
    ...
    if base == 16 as libc::c_int
        ...
        && (*string.offset(1 as libc::c_int as isize) as libc::c_int == 'x' as i32
            || *string.offset(1 as libc::c_int as isize) as libc::c_int == 'X' as i32)
        && _sch_istable[(*string.offset(2 as libc::c_int as isize) as libc::c_int
    ...
    cutoff = (!(0 as libc::c_int as bfd_vma)).wrapping_div(base as bfd_vma);
    cutlim = (!(0 as libc::c_int as bfd_vma)).wrapping_rem(base as bfd_vma)
        as libc::c_uint;
    value = 0 as libc::c_int as bfd_vma;
    overflow = 0 as libc::c_int;
    loop {
        let mut digit: libc::c_uint = 0;
        digit = *string as libc::c_uint;
        if _sch_istable[(digit & 0xff as libc::c_int as libc::c_uint) as usize]
            as libc::c_int & _sch_isdigit as libc::c_int as libc::c_ushort as libc::c_int
            != 0
        {
            digit = digit.wrapping_sub('0' as i32 as libc::c_uint);
        } else {
            if !(_sch_istable[(digit & 0xff as libc::c_int as libc::c_uint) as usize]
                as libc::c_int
            ...
            digit = (_sch_toupper[(digit & 0xff as libc::c_int as libc::c_uint) as usize]
                as libc::c_int - 'A' as i32 + 10 as libc::c_int) as libc::c_uint;
        }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_relocated_section_contents(
    mut abfd: *mut bfd,
    ...
    let mut abfd2: *mut bfd = 0 as *mut bfd;
    let mut fn_0: Option::<
        unsafe extern "C" fn(
            *mut bfd,
            *mut bfd_link_info,
    ...
    fn_0 = (*(*abfd2).xvec)._bfd_get_relocated_section_contents;
    return (Some(fn_0.expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(abfd, link_info, link_order, data, relocatable, symbols);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_record_phdr(
    mut abfd: *mut bfd,
    mut type_0: libc::c_ulong,
    mut flags_valid: bool,
    mut flags: flagword,
    mut at_valid: bool,
    mut at: bfd_vma,
    mut includes_filehdr: bool,
    mut includes_phdrs: bool,
    mut count: libc::c_uint,
    mut secs: *mut *mut asection,
) -> bool {
    ...
    (*m).p_type = type_0;
    (*m).p_flags = flags as libc::c_ulong;
    (*m).p_paddr = at.wrapping_mul(opb as libc::c_ulong);
    (*m).set_p_flags_valid(flags_valid as libc::c_uint);
    (*m).set_p_paddr_valid(at_valid as libc::c_uint);
    (*m).set_includes_filehdr(includes_filehdr as libc::c_uint);
    (*m).set_includes_phdrs(includes_phdrs as libc::c_uint);
    (*m).count = count;
    if count > 0 as libc::c_int as libc::c_uint {
        memcpy(
            ((*m).sections).as_mut_ptr() as *mut libc::c_void,
            secs as *const libc::c_void,
            (count as libc::c_ulong)
                .wrapping_mul(::core::mem::size_of::<*mut asection>() as libc::c_ulong),
        );
    }
    pm = &mut (*(*(*abfd).tdata.elf_obj_data).o).seg_map;
    while !(*pm).is_null() {
        pm = &mut (**pm).next;
    }
    *pm = m;
...
unsafe extern "C" fn is32bit(mut abfd: *mut bfd) -> bool {
    if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        let mut bed: *const elf_backend_data = (*(*abfd).xvec).backend_data
            as *const elf_backend_data;
        return (*(*bed).s).elfclass as libc::c_int == 1 as libc::c_int;
    }
    return bfd_arch_bits_per_address(abfd) <= 32 as libc::c_int as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_sprintf_vma(
    mut abfd: *mut bfd,
    ...
    if is32bit(abfd) {
        sprintf(
            ...
            value & 0xffffffff as libc::c_uint as libc::c_ulong,
        );
        return;
    }
    sprintf(buf, b"%016lx\0" as *const u8 as *const libc::c_char, value);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_fprintf_vma(
    mut abfd: *mut bfd,
    ...
    fprintf(stream as *mut FILE, b"%016lx\0" as *const u8 as *const libc::c_char, value);
}
#[no_mangle]
pub unsafe extern "C" fn bfd_alt_mach_code(
    mut abfd: *mut bfd,
    mut alternative: libc::c_int,
) -> bool {
    if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        ...
        match alternative {
            0 => {
                code = (*((*(*abfd).xvec).backend_data as *const elf_backend_data))
                    .elf_machine_code;
            }
            1 => {
                code = (*((*(*abfd).xvec).backend_data as *const elf_backend_data))
        ...
        (*((*(*abfd).tdata.elf_obj_data).elf_header).as_mut_ptr())
            .e_machine = code as libc::c_ushort;
        return 1 as libc::c_int != 0;
    }
    return 0 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_emul_get_maxpagesize(
    mut emul: *const libc::c_char,
) -> bfd_vma {
    let mut target: *const bfd_target = 0 as *const bfd_target;
    target = bfd_find_target(emul, 0 as *mut bfd);
    if !target.is_null()
        && (*target).flavour as libc::c_uint
            == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        return (*((*target).backend_data as *const elf_backend_data)).maxpagesize;
    }
    return 0 as libc::c_int as bfd_vma;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_emul_get_commonpagesize(
    mut emul: *const libc::c_char,
    mut relro: bool,
) -> bfd_vma {
    let mut target: *const bfd_target = 0 as *const bfd_target;
            ...
            == bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        ...
        bed = (*target).backend_data as *const elf_backend_data;
        if relro { return (*bed).relropagesize } else { return (*bed).commonpagesize }
    }
    return 0 as libc::c_int as bfd_vma;
}
#[no_mangle]
pub unsafe extern "C" fn bfd_demangle(
    mut abfd: *mut bfd,
    ...
    let mut suf: *const libc::c_char = 0 as *const libc::c_char;
    let mut pre_len: size_t = 0;
    let mut skip_lead: bool = false;
    skip_lead = !abfd.is_null() && *name as libc::c_int != '\0' as i32
        && bfd_get_symbol_leading_char(abfd) as libc::c_int == *name as libc::c_int;
    if skip_lead {
        name = name.offset(1);
        name;
    }
    ...
    pre_len = name.offset_from(pre) as libc::c_long as size_t;
    alloc = 0 as *mut libc::c_char;
    suf = strchr(name, '@' as i32);
    if !suf.is_null() {
        alloc = bfd_malloc(
            (suf.offset_from(name) as libc::c_long + 1 as libc::c_int as libc::c_long)
                as bfd_size_type,
        ) as *mut libc::c_char;
        if alloc.is_null() {
        ...
        memcpy(
            ...
            suf.offset_from(name) as libc::c_long as libc::c_ulong,
        );
        *alloc
            .offset(
                suf.offset_from(name) as libc::c_long as isize,
    ...
    if res.is_null() {
        if skip_lead {
            let mut len: size_t = (strlen(pre))
                .wrapping_add(1 as libc::c_int as libc::c_ulong);
            alloc = bfd_malloc(len) as *mut libc::c_char;
            if alloc.is_null() {
                return 0 as *mut libc::c_char;
            }
            memcpy(alloc as *mut libc::c_void, pre as *const libc::c_void, len);
            return alloc;
        }
        return 0 as *mut libc::c_char;
    }
    if pre_len != 0 as libc::c_int as libc::c_ulong || !suf.is_null() {
        let mut len_0: size_t = 0;
        let mut suf_len: size_t = 0;
        let mut final_0: *mut libc::c_char = 0 as *mut libc::c_char;
        len_0 = strlen(res);
        if suf.is_null() {
            suf = res.offset(len_0 as isize);
        }
        suf_len = (strlen(suf)).wrapping_add(1 as libc::c_int as libc::c_ulong);
        final_0 = bfd_malloc(pre_len.wrapping_add(len_0).wrapping_add(suf_len))
            as *mut libc::c_char;
        if !final_0.is_null() {
            memcpy(final_0 as *mut libc::c_void, pre as *const libc::c_void, pre_len);
            memcpy(
                final_0.offset(pre_len as isize) as *mut libc::c_void,
                res as *const libc::c_void,
                len_0,
            );
            memcpy(
                final_0.offset(pre_len as isize).offset(len_0 as isize)
                    as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn bfd_update_compression_header(
    mut abfd: *mut bfd,
    mut contents: *mut bfd_byte,
    mut sec: *mut asection,
) {
    if (*abfd).flags & 0x4000 as libc::c_int as libc::c_uint
        == 0 as libc::c_int as libc::c_uint
    {
        _bfd_abort(
            b"bfd.c\0" as *const u8 as *const libc::c_char,
            ...
            (*::core::mem::transmute::<
                &[u8; 66],
                &[libc::c_char; 66],
            >(b"void bfd_update_compression_header(bfd *, bfd_byte *, asection *)\0"))
                .as_ptr(),
        );
    }
    let mut current_block_20: u64;
    match bfd_get_flavour(abfd) as libc::c_uint {
        5 => {
            if (*abfd).flags & 0x20000 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
            {
                let mut bed: *const elf_backend_data = (*(*abfd).xvec).backend_data
                    as *const elf_backend_data;
                let mut esd: *mut bfd_elf_section_data = (*sec).used_by_bfd
                    as *mut bfd_elf_section_data;
                let ref mut fresh14 = (*((*sec).used_by_bfd
                    as *mut bfd_elf_section_data))
                    .this_hdr
                    .sh_flags;
                *fresh14 |= ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_ulong;
                if (*(*bed).s).elfclass as libc::c_int == 1 as libc::c_int {
                    let mut echdr: *mut Elf32_External_Chdr = contents
                        as *mut Elf32_External_Chdr;
                    (Some(
                        ...
                        &mut (*echdr).ch_type as *mut [libc::c_uchar; 4]
                            as *mut libc::c_void,
                    );
                    (Some(
                        ((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer"),
                        ...
                        (*sec).size,
                        &mut (*echdr).ch_size as *mut [libc::c_uchar; 4]
                            as *mut libc::c_void,
                    );
                    (Some(
                        ((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer"),
                        ...
                        ((1 as libc::c_int) << (*sec).alignment_power) as bfd_vma,
                        &mut (*echdr).ch_addralign as *mut [libc::c_uchar; 4]
                            as *mut libc::c_void,
                    );
                    bfd_set_section_alignment(sec, 2 as libc::c_int as libc::c_uint);
                    (*esd).this_hdr.sh_addralign = 4 as libc::c_int as bfd_vma;
                } else {
                    let mut echdr_0: *mut Elf64_External_Chdr = contents
                        as *mut Elf64_External_Chdr;
                    (Some(
                        ((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer"),
                    ))
                        .expect(
                        ...
                        1 as libc::c_int as bfd_vma,
                        &mut (*echdr_0).ch_type as *mut [libc::c_uchar; 4]
                            as *mut libc::c_void,
                    );
                    (Some(
                        ((*(*abfd).xvec).bfd_putx32).expect("non-null function pointer"),
                        ...
                        &mut (*echdr_0).ch_reserved as *mut [libc::c_uchar; 4]
                            as *mut libc::c_void,
                    );
                    (Some(
                        ((*(*abfd).xvec).bfd_putx64).expect("non-null function pointer"),
                    ))
                        .expect(
                            "non-null function pointer",
                        )(
                        (*sec).size,
                        &mut (*echdr_0).ch_size as *mut [libc::c_uchar; 8]
                            as *mut libc::c_void,
                    );
                    (Some(
                        ((*(*abfd).xvec).bfd_putx64).expect("non-null function pointer"),
                        ...
                        ((1 as libc::c_int) << (*sec).alignment_power) as bfd_uint64_t,
                        &mut (*echdr_0).ch_addralign as *mut [libc::c_uchar; 8]
                            as *mut libc::c_void,
                    );
                    bfd_set_section_alignment(sec, 3 as libc::c_int as libc::c_uint);
                    (*esd).this_hdr.sh_addralign = 8 as libc::c_int as bfd_vma;
                }
                current_block_20 = 15904375183555213903;
            } else {
                let ref mut fresh15 = (*((*sec).used_by_bfd
                    as *mut bfd_elf_section_data))
                    .this_hdr
                    .sh_flags;
                *fresh15 &= !((1 as libc::c_int) << 11 as libc::c_int) as libc::c_ulong;
                current_block_20 = 6528395852510133772;
            }
        }
        _ => {
            current_block_20 = 6528395852510133772;
    ...
    match current_block_20 {
        6528395852510133772 => {
            memcpy(
                ...
                b"ZLIB\0" as *const u8 as *const libc::c_char as *const libc::c_void,
            ...
            bfd_set_section_alignment(sec, 0 as libc::c_int as libc::c_uint);
        }
        _ => {}
    };
}
#[no_mangle]
pub unsafe extern "C" fn bfd_check_compression_header(
    mut abfd: *mut bfd,
    mut contents: *mut bfd_byte,
    mut sec: *mut asection,
    mut uncompressed_size: *mut bfd_size_type,
    mut uncompressed_alignment_power: *mut libc::c_uint,
) -> bool {
    if bfd_get_flavour(abfd) as libc::c_uint
        == bfd_target_elf_flavour as libc::c_int as libc::c_uint
        && (*((*sec).used_by_bfd as *mut bfd_elf_section_data)).this_hdr.sh_flags
            ...
            != 0 as libc::c_int as libc::c_ulong
    {
        ...
        if (*(*bed).s).elfclass as libc::c_int == 1 as libc::c_int {
            ...
            chdr
                ...
                &mut (*echdr).ch_type as *mut [libc::c_uchar; 4] as *const libc::c_void,
            ) as libc::c_uint;
            chdr
                .ch_size = (Some(
                ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
                ...
                &mut (*echdr).ch_size as *mut [libc::c_uchar; 4] as *const libc::c_void,
            );
            chdr
                .ch_addralign = (Some(
                ((*(*abfd).xvec).bfd_getx32).expect("non-null function pointer"),
            ...
            chdr
                ...
                &mut (*echdr_0).ch_type as *mut [libc::c_uchar; 4] as *const libc::c_void,
            ) as libc::c_uint;
            chdr
                .ch_size = (Some(
                ...
                &mut (*echdr_0).ch_size as *mut [libc::c_uchar; 8] as *const libc::c_void,
            );
            chdr
                .ch_addralign = (Some(
                ((*(*abfd).xvec).bfd_getx64).expect("non-null function pointer"),
        ...
        if chdr.ch_type == 1 as libc::c_int as libc::c_uint
            && chdr.ch_addralign
                == chdr.ch_addralign & (chdr.ch_addralign).wrapping_neg()
        {
...
#[no_mangle]
pub unsafe extern "C" fn bfd_get_compression_header_size(
    mut abfd: *mut bfd,
    mut sec: *mut asection,
) -> libc::c_int {
    if bfd_get_flavour(abfd) as libc::c_uint
    ...
    {
        if sec.is_null() {
            if (*abfd).flags & 0x20000 as libc::c_int as libc::c_uint == 0 {
                return 0 as libc::c_int;
            }
        } else if (*((*sec).used_by_bfd as *mut bfd_elf_section_data)).this_hdr.sh_flags
            & ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_ulong == 0
        {
            return 0 as libc::c_int
        }
...
#[no_mangle]
pub unsafe extern "C" fn bfd_convert_section_size(
    mut ibfd: *mut bfd,
    mut isec: sec_ptr,
    mut obfd: *mut bfd,
    mut size: bfd_size_type,
) -> bfd_size_type {
    let mut hdr_size: bfd_size_type = 0;
    ...
    if (*(*((*(*ibfd).xvec).backend_data as *const elf_backend_data)).s).elfclass
        as libc::c_int
        == (*(*((*(*obfd).xvec).backend_data as *const elf_backend_data)).s).elfclass
            as libc::c_int
    {
        return size;
    }
    ...
    if (*ibfd).flags & 0x8000 as libc::c_int as libc::c_uint != 0 {
        return size;
    }
    hdr_size = bfd_get_compression_header_size(ibfd, isec) as bfd_size_type;
    if hdr_size == 0 as libc::c_int as libc::c_ulong {
        return size;
    }
    if hdr_size == ::core::mem::size_of::<Elf32_External_Chdr>() as libc::c_ulong {
        return size
            .wrapping_sub(::core::mem::size_of::<Elf32_External_Chdr>() as libc::c_ulong)
            .wrapping_add(::core::mem::size_of::<Elf64_External_Chdr>() as libc::c_ulong)
    } else {
        return size
            .wrapping_sub(::core::mem::size_of::<Elf64_External_Chdr>() as libc::c_ulong)
            .wrapping_add(::core::mem::size_of::<Elf32_External_Chdr>() as libc::c_ulong)
    };
}
#[no_mangle]
pub unsafe extern "C" fn bfd_convert_section_contents(
    mut ibfd: *mut bfd,
    mut isec: sec_ptr,
    mut obfd: *mut bfd,
    mut ptr: *mut *mut bfd_byte,
    mut ptr_size: *mut bfd_size_type,
) -> bool {
    let mut contents: *mut bfd_byte = 0 as *mut bfd_byte;
    let mut ihdr_size: bfd_size_type = 0;
    let mut ohdr_size: bfd_size_type = 0;
    ...
    let mut use_memmove: bool = false;
    if bfd_get_flavour(ibfd) as libc::c_uint
        != bfd_target_elf_flavour as libc::c_int as libc::c_uint
        || bfd_get_flavour(obfd) as libc::c_uint
            != bfd_target_elf_flavour as libc::c_int as libc::c_uint
    ...
    if startswith(
        ...
        return _bfd_elf_convert_gnu_properties(ibfd, isec, obfd, ptr, ptr_size);
    }
    if (*ibfd).flags & 0x8000 as libc::c_int as libc::c_uint != 0 {
        return 1 as libc::c_int != 0;
    }
    ihdr_size = bfd_get_compression_header_size(ibfd, isec) as bfd_size_type;
    if ihdr_size == 0 as libc::c_int as libc::c_ulong {
        return 1 as libc::c_int != 0;
    }
    if ihdr_size > bfd_get_section_limit(ibfd, isec as *const asection) {
        return 0 as libc::c_int != 0;
    }
    contents = *ptr;
    if ihdr_size == ::core::mem::size_of::<Elf32_External_Chdr>() as libc::c_ulong {
        let mut echdr: *mut Elf32_External_Chdr = contents as *mut Elf32_External_Chdr;
        chdr
            .ch_type = (Some(
            ((*(*ibfd).xvec).bfd_getx32).expect("non-null function pointer"),
        ))
            .expect(
                "non-null function pointer",
            )(&mut (*echdr).ch_type as *mut [libc::c_uchar; 4] as *const libc::c_void)
        ...
        chdr
            ...
            &mut (*echdr).ch_addralign as *mut [libc::c_uchar; 4] as *const libc::c_void,
        );
        ohdr_size = ::core::mem::size_of::<Elf64_External_Chdr>() as libc::c_ulong;
        use_memmove = 0 as libc::c_int != 0;
    } else if ihdr_size != ::core::mem::size_of::<Elf64_External_Chdr>() as libc::c_ulong
    {
        return 0 as libc::c_int != 0
    } else {
        let mut echdr_0: *mut Elf64_External_Chdr = contents as *mut Elf64_External_Chdr;
        chdr
            .ch_type = (Some(
            ((*(*ibfd).xvec).bfd_getx32).expect("non-null function pointer"),
        ))
        ...
        chdr
            .ch_size = (Some(
            ((*(*ibfd).xvec).bfd_getx64).expect("non-null function pointer"),
        ))
            .expect(
                "non-null function pointer",
            )(&mut (*echdr_0).ch_size as *mut [libc::c_uchar; 8] as *const libc::c_void);
        ...
        ohdr_size = ::core::mem::size_of::<Elf32_External_Chdr>() as libc::c_ulong;
        use_memmove = 1 as libc::c_int != 0;
    }
    size = (bfd_section_size(isec as *const asection))
        .wrapping_sub(ihdr_size)
        .wrapping_add(ohdr_size);
    if !use_memmove {
    ...
    if ohdr_size == ::core::mem::size_of::<Elf32_External_Chdr>() as libc::c_ulong {
        let mut echdr_1: *mut Elf32_External_Chdr = contents as *mut Elf32_External_Chdr;
        (Some(((*(*obfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            1 as libc::c_int as bfd_vma,
            &mut (*echdr_1).ch_type as *mut [libc::c_uchar; 4] as *mut libc::c_void,
        );
        (Some(((*(*obfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            ...
            chdr.ch_size,
            &mut (*echdr_1).ch_size as *mut [libc::c_uchar; 4] as *mut libc::c_void,
        );
        (Some(((*(*obfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            ...
            chdr.ch_addralign,
            &mut (*echdr_1).ch_addralign as *mut [libc::c_uchar; 4] as *mut libc::c_void,
        );
    } else {
        let mut echdr_2: *mut Elf64_External_Chdr = contents as *mut Elf64_External_Chdr;
        (Some(((*(*obfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            )(
            1 as libc::c_int as bfd_vma,
            &mut (*echdr_2).ch_type as *mut [libc::c_uchar; 4] as *mut libc::c_void,
        );
        (Some(((*(*obfd).xvec).bfd_putx32).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            ...
            0 as libc::c_int as bfd_vma,
            &mut (*echdr_2).ch_reserved as *mut [libc::c_uchar; 4] as *mut libc::c_void,
        );
        (Some(((*(*obfd).xvec).bfd_putx64).expect("non-null function pointer")))
            ...
            chdr.ch_size,
            &mut (*echdr_2).ch_size as *mut [libc::c_uchar; 8] as *mut libc::c_void,
        );
        (Some(((*(*obfd).xvec).bfd_putx64).expect("non-null function pointer")))
            .expect(
                "non-null function pointer",
            ...
            chdr.ch_addralign,
            &mut (*echdr_2).ch_addralign as *mut [libc::c_uchar; 8] as *mut libc::c_void,
        );
    }
    if use_memmove {
        memmove(
            contents.offset(ohdr_size as isize) as *mut libc::c_void,
            (*ptr).offset(ihdr_size as isize) as *const libc::c_void,
            size.wrapping_sub(ohdr_size),
        );
    } else {
        memcpy(
            contents.offset(ohdr_size as isize) as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_get_link_info(mut abfd: *mut bfd) -> *mut bfd_link_info {
    if bfd_get_flavour(abfd) as libc::c_uint
        != bfd_target_elf_flavour as libc::c_int as libc::c_uint
    {
        return 0 as *mut bfd_link_info;
    }
