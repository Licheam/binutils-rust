...
extern "C" {
    ...
    fn bfd_default_reloc_type_lookup(
        abfd: *mut bfd,
    ...
    fn _bfd_elf_reloc_type_class(
        _: *const bfd_link_info,
        _: *const asection,
        _: *const Elf_Internal_Rela,
    ) -> elf_reloc_type_class;
    fn bfd_elf_make_object(_: *mut bfd) -> bool;
    ...
    fn _bfd_elf_get_synthetic_symtab(
        _: *mut bfd,
        _: libc::c_long,
        _: *mut *mut asymbol,
        _: libc::c_long,
    ...
    fn _bfd_elf_omit_section_dynsym_default(
        _: *mut bfd,
        _: *mut bfd_link_info,
        _: *mut asection,
    ) -> bool;
    ...
    fn bfd_elf64_object_p(_: *mut bfd) -> bfd_cleanup;
    fn bfd_elf64_core_file_p(_: *mut bfd) -> bfd_cleanup;
    fn bfd_elf64_core_file_failing_command(_: *mut bfd) -> *mut libc::c_char;
    fn bfd_elf64_core_file_failing_signal(_: *mut bfd) -> libc::c_int;
    fn bfd_elf64_core_file_matches_executable_p(_: *mut bfd, _: *mut bfd) -> bool;
    fn bfd_elf64_core_file_pid(_: *mut bfd) -> libc::c_int;
    fn _bfd_elf64_core_find_build_id(_: *mut bfd, _: bfd_vma) -> bool;
    ...
    fn _bfd_elf64_bfd_from_remote_memory(
        templ: *mut bfd,
        ehdr_vma: bfd_vma,
        size: bfd_size_type,
    ...
    static _bfd_elf64_size_info: elf_size_info;
}
...
static mut dummy: reloc_howto_type = reloc_howto_type {
    type_0: 0,
...
unsafe extern "C" fn check_for_relocs(
    mut abfd: *mut bfd,
    mut o: *mut asection,
    mut failed: *mut libc::c_void,
) {
    if (*o).flags & 0x4 as libc::c_int as libc::c_uint
        != 0 as libc::c_int as libc::c_uint
    {
        let mut ehdrp: *mut Elf_Internal_Ehdr = 0 as *mut Elf_Internal_Ehdr;
        ehdrp = ((*(*abfd).tdata.elf_obj_data).elf_header).as_mut_ptr();
        _bfd_error_handler(
            dcgettext(
                b"bfd\0" as *const u8 as *const libc::c_char,
                b"%pB: Relocations in generic ELF (EM: %d)\0" as *const u8
                    as *const libc::c_char,
                5 as libc::c_int,
            ),
            abfd,
            (*ehdrp).e_machine as libc::c_int,
        );
        bfd_set_error(bfd_error_wrong_format);
        *(failed as *mut bool) = 1 as libc::c_int != 0;
    }
}
unsafe extern "C" fn elf64_generic_link_add_symbols(
    mut abfd: *mut bfd,
...
static mut elf64_bed: elf_backend_data = elf_backend_data {
...
#[no_mangle]
pub static mut elf64_be_vec: bfd_target = bfd_target {
    name: 0 as *const libc::c_char,
...
#[no_mangle]
pub static mut elf64_le_vec: bfd_target = bfd_target {
    name: 0 as *const libc::c_char,
    flavour: bfd_target_unknown_flavour,
    byteorder: BFD_ENDIAN_BIG,
    header_byteorder: BFD_ENDIAN_BIG,
...
unsafe extern "C" fn run_static_initializers() {
    ...
    elf64_bed = {
        let mut init = elf_backend_data {
            ...
            c2rust_padding: [0; 4],
            arch: bfd_arch_unknown,
            target_id: GENERIC_ELF_DATA,
            target_os: is_normal,
            elf_machine_code: 0 as libc::c_int,
            elf_osabi: 0 as libc::c_int,
            maxpagesize: 0x1 as libc::c_int as bfd_vma,
            minpagesize: 0x1 as libc::c_int as bfd_vma,
            commonpagesize: 0x1 as libc::c_int as bfd_vma,
            relropagesize: 0x1 as libc::c_int as bfd_vma,
            ...
            s: &_bfd_elf64_size_info,
            special_sections: 0 as *const bfd_elf_special_section,
            got_header_size: 0 as libc::c_int as bfd_vma,
            got_elt_size: Some(
        ...
        init.set_may_use_rel_p(0 as libc::c_int as libc::c_uint);
        init.set_may_use_rela_p((0 as libc::c_int == 0) as libc::c_int as libc::c_uint);
        ...
        init.set_dtrel_excludes_plt(0 as libc::c_int as libc::c_uint);
        init.set_sign_extend_vma(0 as libc::c_int as libc::c_uint);
        init.set_want_got_plt(0 as libc::c_int as libc::c_uint);
        init.set_plt_readonly(0 as libc::c_int as libc::c_uint);
        init.set_want_plt_sym(0 as libc::c_int as libc::c_uint);
        init.set_plt_not_loaded(0 as libc::c_int as libc::c_uint);
        init.set_plt_alignment(2 as libc::c_int as libc::c_uint);
        init.set_can_gc_sections(0 as libc::c_int as libc::c_uint);
        init.set_can_refcount(0 as libc::c_int as libc::c_uint);
        init.set_want_got_sym(1 as libc::c_int as libc::c_uint);
        init.set_want_dynbss(1 as libc::c_int as libc::c_uint);
        init.set_want_dynrelro(0 as libc::c_int as libc::c_uint);
        ...
        init.set_caches_rawsize(0 as libc::c_int as libc::c_uint);
        init.set_extern_protected_data(0 as libc::c_int as libc::c_uint);
        init.set_always_renumber_dynsyms(0 as libc::c_int as libc::c_uint);
        init.set_linux_prpsinfo32_ugid16(0 as libc::c_int as libc::c_uint);
        init.set_linux_prpsinfo64_ugid16(0 as libc::c_int as libc::c_uint);
        init
    };
    elf64_be_vec = {
        let mut init = bfd_target {
            name: b"elf64-big\0" as *const u8 as *const libc::c_char,
            ...
            match_priority: (if bfd_arch_unknown as libc::c_int
            ...
            _bfd_check_format: [
                ...
                Some(
                    bfd_elf64_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup,
                ),
                Some(
            ...
            _bfd_set_format: [
                ...
                Some(bfd_elf_make_object as unsafe extern "C" fn(*mut bfd) -> bool),
            ...
            _core_file_pid: Some(
                bfd_elf64_core_file_pid as unsafe extern "C" fn(*mut bfd) -> libc::c_int,
            ),
            ...
            alternative_target: &elf64_le_vec,
            backend_data: &elf64_bed as *const elf_backend_data as *const libc::c_void,
        };
        init
    };
    elf64_le_vec = {
        let mut init = bfd_target {
            name: b"elf64-little\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_elf_flavour,
            ...
            alternative_target: &elf64_be_vec,
            backend_data: &elf64_bed as *const elf_backend_data as *const libc::c_void,
        };
        init
    };
