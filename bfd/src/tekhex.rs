...
extern "C" {
    ...
    pub type flag_info;
    pub type tekhex_asymbol_struct;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tekhex_data_struct {
    pub head: *mut tekhex_data_list_type,
    pub type_0: libc::c_uint,
    pub symbols: *mut tekhex_symbol_struct,
    pub data: *mut data_struct,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct data_struct {
    pub chunk_data: [libc::c_uchar; 8192],
    pub chunk_init: [libc::c_uchar; 256],
    pub vma: bfd_vma,
    pub next: *mut data_struct,
}
pub type bfd_vma = libc::c_ulong;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tekhex_symbol_struct {
    pub symbol: asymbol,
    pub prev: *mut tekhex_symbol_struct,
}
...
pub type tekhex_data_list_type = tekhex_data_list_struct;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct tekhex_data_list_struct {
    pub data: *mut libc::c_uchar,
    pub where_0: bfd_vma,
    pub size: bfd_size_type,
    pub next: *mut tekhex_data_list_struct,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct artdata {
...
pub type tekhex_symbol_type = tekhex_symbol_struct;
pub type tdata_type = tekhex_data_struct;
#[inline]
...
static mut sum_block: [libc::c_char; 256] = [0; 256];
unsafe extern "C" fn tekhex_init() {
    ...
    if !inited {
        ...
        while i < 10 as libc::c_int as libc::c_uint {
            let fresh0 = val;
            val = val + 1;
            sum_block[i.wrapping_add('0' as i32 as libc::c_uint)
                as usize] = fresh0 as libc::c_char;
            i = i.wrapping_add(1);
            i;
        }
        ...
        while i <= 'Z' as i32 as libc::c_uint {
            let fresh1 = val;
            val = val + 1;
            sum_block[i as usize] = fresh1 as libc::c_char;
            i = i.wrapping_add(1);
            i;
        }
        let fresh2 = val;
        val = val + 1;
        sum_block['$' as i32 as usize] = fresh2 as libc::c_char;
        let fresh3 = val;
        val = val + 1;
        sum_block['%' as i32 as usize] = fresh3 as libc::c_char;
        let fresh4 = val;
        val = val + 1;
        sum_block['.' as i32 as usize] = fresh4 as libc::c_char;
        let fresh5 = val;
        val = val + 1;
        sum_block['_' as i32 as usize] = fresh5 as libc::c_char;
        i = 'a' as i32 as libc::c_uint;
        while i <= 'z' as i32 as libc::c_uint {
            let fresh6 = val;
            val = val + 1;
            sum_block[i as usize] = fresh6 as libc::c_char;
            i = i.wrapping_add(1);
            i;
        }
    }
...
unsafe extern "C" fn getvalue(
    mut srcp: *mut *mut libc::c_char,
    mut valuep: *mut bfd_vma,
    mut endp: *mut libc::c_char,
) -> bool {
    let mut src: *mut libc::c_char = *srcp;
    let mut value: bfd_vma = 0 as libc::c_int as bfd_vma;
    let mut len: libc::c_uint = 0;
    if src >= endp {
        return 0 as libc::c_int != 0;
    }
    if !(_hex_value[*src as libc::c_uchar as usize] as libc::c_uint
    ...
    let fresh7 = src;
    src = src.offset(1);
    len = _hex_value[*fresh7 as libc::c_uchar as usize] as libc::c_uint;
    ...
    loop {
        ...
        value = value << 4 as libc::c_int
            | _hex_value[*fresh9 as libc::c_uchar as usize] as libc::c_uint
                as libc::c_ulong;
    }
    *srcp = src;
    *valuep = value;
    return len == (1 as libc::c_uint).wrapping_neg();
}
unsafe extern "C" fn getsym(
    mut dstp: *mut libc::c_char,
    mut srcp: *mut *mut libc::c_char,
    mut lenp: *mut libc::c_uint,
    mut endp: *mut libc::c_char,
) -> bool {
    let mut src: *mut libc::c_char = *srcp;
    let mut i: libc::c_uint = 0;
    ...
    let fresh10 = src;
    src = src.offset(1);
    len = _hex_value[*fresh10 as libc::c_uchar as usize] as libc::c_uint;
    if len == 0 as libc::c_int as libc::c_uint {
        len = 16 as libc::c_int as libc::c_uint;
    }
    i = 0 as libc::c_int as libc::c_uint;
    while i < len && src.offset(i as isize) < endp {
        *dstp.offset(i as isize) = *src.offset(i as isize);
        i = i.wrapping_add(1);
        i;
    }
    *dstp.offset(i as isize) = 0 as libc::c_int as libc::c_char;
    *srcp = src.offset(i as isize);
    *lenp = len;
    return i == len;
}
unsafe extern "C" fn find_chunk(
    mut abfd: *mut bfd,
    mut vma: bfd_vma,
    mut create: bool,
) -> *mut data_struct {
    let mut d: *mut data_struct = (*(*abfd).tdata.tekhex_data).data;
    vma &= !(0x1fff as libc::c_int) as libc::c_ulong;
    while !d.is_null() && (*d).vma != vma {
        d = (*d).next;
    }
    if d.is_null() && create as libc::c_int != 0 {
        d = bfd_zalloc(abfd, ::core::mem::size_of::<data_struct>() as libc::c_ulong)
            as *mut data_struct;
        if d.is_null() {
            return 0 as *mut data_struct;
        }
...
unsafe extern "C" fn insert_byte(
    mut abfd: *mut bfd,
    mut value: libc::c_int,
    mut addr: bfd_vma,
) {
    if value != 0 as libc::c_int {
        let mut d: *mut data_struct = find_chunk(abfd, addr, 1 as libc::c_int != 0);
        (*d)
            .chunk_data[(addr & 0x1fff as libc::c_int as libc::c_ulong)
            as usize] = value as libc::c_uchar;
        (*d)
            .chunk_init[(addr & 0x1fff as libc::c_int as libc::c_ulong)
            .wrapping_div(32 as libc::c_int as libc::c_ulong)
            as usize] = 1 as libc::c_int as libc::c_uchar;
    }
}
unsafe extern "C" fn first_phase(
    mut abfd: *mut bfd,
    mut type_0: libc::c_int,
    mut src: *mut libc::c_char,
    mut src_end: *mut libc::c_char,
) -> bool {
    let mut section: *mut asection = 0 as *mut asection;
    let mut alt_section: *mut asection = 0 as *mut asection;
    let mut len: libc::c_uint = 0;
    let mut val: bfd_vma = 0;
    let mut sym: [libc::c_char; 17] = [0; 17];
    match type_0 {
        54 => {
            let mut addr: bfd_vma = 0;
            if !getvalue(&mut src, &mut addr, src_end) {
                return 0 as libc::c_int != 0;
            }
            while *src as libc::c_int != 0
                && src < src_end.offset(-(1 as libc::c_int as isize))
            {
                insert_byte(
                    abfd,
                    ((_hex_value[*src.offset(0 as libc::c_int as isize) as libc::c_uchar
                        as usize] as libc::c_uint) << 4 as libc::c_int)
                        .wrapping_add(
                            _hex_value[*src.offset(1 as libc::c_int as isize)
                                as libc::c_uchar as usize] as libc::c_uint,
                        ) as libc::c_int,
                    addr,
                );
        ...
        51 => {
            if !getsym(sym.as_mut_ptr(), &mut src, &mut len, src_end) {
                return 0 as libc::c_int != 0;
            }
            section = bfd_get_section_by_name(abfd, sym.as_mut_ptr());
            if section.is_null() {
                let mut n: *mut libc::c_char = bfd_alloc(
                    abfd,
            ...
            alt_section = 0 as *mut asection;
            while src < src_end && *src as libc::c_int != 0 {
                match *src as libc::c_int {
                    49 => {
                        src = src.offset(1);
                        src;
                        if !getvalue(&mut src, &mut (*section).vma, src_end) {
                            return 0 as libc::c_int != 0;
                        }
                        if !getvalue(&mut src, &mut val, src_end) {
                            return 0 as libc::c_int != 0;
                        }
                        if val < (*section).vma {
                            val = (*section).vma;
                        }
                        (*section).size = val.wrapping_sub((*section).vma);
                        if (*section).size & 0x80000000 as libc::c_uint as libc::c_ulong
                            != 0
                        {
                            return 0 as libc::c_int != 0;
                        }
                    ...
                    48 | 50 | 51 | 52 | 54 | 55 | 56 => {
                        let mut amt: size_t = ::core::mem::size_of::<
                            tekhex_symbol_type,
                        >() as libc::c_ulong;
                        let mut new_symbol: *mut tekhex_symbol_type = bfd_alloc(
                            abfd,
                            amt,
                        ) as *mut tekhex_symbol_type;
                        let mut stype: libc::c_char = *src;
                        ...
                        if ((*new_symbol).symbol.name).is_null() {
                            return 0 as libc::c_int != 0;
                        }
                        memcpy(
                            (*new_symbol).symbol.name as *mut libc::c_char
                                as *mut libc::c_void,
                            sym.as_mut_ptr() as *const libc::c_void,
                        ...
                        if stype as libc::c_int <= '4' as i32 {
                            (*new_symbol)
                                .symbol
                        ...
                        if stype as libc::c_int == '2' as i32
                            || stype as libc::c_int == '6' as i32
                        {
                            (*new_symbol)
                                .symbol
                        ...
                        } else if stype as libc::c_int == '3' as i32
                            || stype as libc::c_int == '7' as i32
                        {
                            if (*section).flags & 0x20 as libc::c_int as libc::c_uint
                                == 0 as libc::c_int as libc::c_uint
                            {
                                (*section).flags |= 0x10 as libc::c_int as libc::c_uint;
                            } else {
                                if alt_section.is_null() {
                                    alt_section = bfd_get_next_section_by_name(
                                        0 as *mut bfd,
                                        section,
                                    );
                                }
                                if alt_section.is_null() {
                                    alt_section = bfd_make_section_anyway_with_flags(
                                        abfd,
                                        (*section).name,
                                        (*section).flags & !(0x20 as libc::c_int) as libc::c_uint
                        ...
                        } else if stype as libc::c_int == '4' as i32
                            || stype as libc::c_int == '8' as i32
                        {
                            if (*section).flags & 0x10 as libc::c_int as libc::c_uint
                                == 0 as libc::c_int as libc::c_uint
                            {
                                (*section).flags |= 0x20 as libc::c_int as libc::c_uint;
                            } else {
                        ...
                        (*new_symbol).symbol.value = val.wrapping_sub((*section).vma);
                    }
...
unsafe extern "C" fn pass_over(
    ...
    let mut chars_on_line: libc::c_uint = 0;
    let mut is_eof: bool = 0 as libc::c_int != 0;
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
    {
        return 0 as libc::c_int != 0;
    }
    while !is_eof {
        let mut src: [libc::c_char; 255] = [0; 255];
        ...
        while !is_eof && *src.as_mut_ptr() as libc::c_int != '%' as i32 {
            is_eof = bfd_bread(
                src.as_mut_ptr() as *mut libc::c_void,
                1 as libc::c_int as bfd_size_type,
                abfd,
        ...
        type_0 = src[2 as libc::c_int as usize];
        if !(_hex_value[src[0 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_uint != 99 as libc::c_int as libc::c_uint)
            || !(_hex_value[src[1 as libc::c_int as usize] as libc::c_uchar as usize]
                as libc::c_uint != 99 as libc::c_int as libc::c_uint)
        {
            break;
        }
        chars_on_line = ((_hex_value[src[0 as libc::c_int as usize] as libc::c_uchar
            as usize] as libc::c_uint) << 4 as libc::c_int)
            .wrapping_add(
                _hex_value[src[1 as libc::c_int as usize] as libc::c_uchar as usize]
                    as libc::c_uint,
        ...
        if chars_on_line >= 0xff as libc::c_int as libc::c_uint {
            return 0 as libc::c_int != 0;
        }
        if bfd_bread(
            src.as_mut_ptr() as *mut libc::c_void,
            chars_on_line as bfd_size_type,
            abfd,
        ) != chars_on_line as libc::c_ulong
        {
            return 0 as libc::c_int != 0;
        }
        src[chars_on_line as usize] = 0 as libc::c_int as libc::c_char;
        if !func
            .expect(
            ...
            src.as_mut_ptr(),
            src.as_mut_ptr().offset(chars_on_line as isize),
        )
        {
            return 0 as libc::c_int != 0;
        }
...
unsafe extern "C" fn tekhex_canonicalize_symtab(
    mut abfd: *mut bfd,
    mut table: *mut *mut asymbol,
) -> libc::c_long {
    let mut p: *mut tekhex_symbol_type = (*(*abfd).tdata.tekhex_data).symbols;
    let mut c: libc::c_uint = bfd_get_symcount(abfd);
    let ref mut fresh11 = *table.offset(c as isize);
    *fresh11 = 0 as *mut asymbol;
    while !p.is_null() {
        c = c.wrapping_sub(1);
        let ref mut fresh12 = *table.offset(c as isize);
        *fresh12 = &mut (*p).symbol;
        p = (*p).prev;
    }
    return bfd_get_symcount(abfd) as libc::c_long;
}
unsafe extern "C" fn tekhex_get_symtab_upper_bound(mut abfd: *mut bfd) -> libc::c_long {
    return (((*abfd).symcount).wrapping_add(1 as libc::c_int as libc::c_uint)
        as libc::c_ulong)
        .wrapping_mul(
            ::core::mem::size_of::<*mut tekhex_asymbol_struct>() as libc::c_ulong,
        ) as libc::c_long;
}
unsafe extern "C" fn tekhex_mkobject(mut abfd: *mut bfd) -> bool {
    ...
    (*tdata).head = 0 as *mut tekhex_data_list_type;
    (*tdata).symbols = 0 as *mut tekhex_symbol_struct;
    (*tdata).data = 0 as *mut data_struct;
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn tekhex_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut b: [libc::c_char; 4] = [0; 4];
    tekhex_init();
    if bfd_seek(abfd, 0 as libc::c_int as file_ptr, 0 as libc::c_int) != 0 as libc::c_int
        || bfd_bread(
    ...
    if b[0 as libc::c_int as usize] as libc::c_int != '%' as i32
        || !(_hex_value[b[1 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_uint != 99 as libc::c_int as libc::c_uint)
        || !(_hex_value[b[2 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_uint != 99 as libc::c_int as libc::c_uint)
        || !(_hex_value[b[3 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_uint != 99 as libc::c_int as libc::c_uint)
    {
        return None;
    }
...
unsafe extern "C" fn move_section_contents(
    mut abfd: *mut bfd,
    mut section: *mut asection,
    mut locationp: *const libc::c_void,
    mut offset: file_ptr,
    mut count: bfd_size_type,
    mut get: bool,
) {
    let mut addr: bfd_vma = 0;
    let mut location: *mut libc::c_char = locationp as *mut libc::c_char;
    let mut prev_number: bfd_vma = 1 as libc::c_int as bfd_vma;
    let mut d: *mut data_struct = 0 as *mut data_struct;
    if !(offset == 0 as libc::c_int as libc::c_long) {
        bfd_assert(
            b"tekhex.c\0" as *const u8 as *const libc::c_char,
            638 as libc::c_int,
        );
    }
    addr = (*section).vma;
    while count != 0 as libc::c_int as libc::c_ulong {
        let mut chunk_number: bfd_vma = addr & !(0x1fff as libc::c_int as bfd_vma);
        let mut low_bits: bfd_vma = addr & 0x1fff as libc::c_int as libc::c_ulong;
        let mut must_write: bool = !get && *location as libc::c_int != 0 as libc::c_int;
        if chunk_number != prev_number || d.is_null() && must_write as libc::c_int != 0 {
            d = find_chunk(abfd, chunk_number, must_write);
            prev_number = chunk_number;
        }
        if get {
            if !d.is_null() {
                *location = (*d).chunk_data[low_bits as usize] as libc::c_char;
            } else {
                *location = 0 as libc::c_int as libc::c_char;
            }
        } else if must_write {
            (*d).chunk_data[low_bits as usize] = *location as libc::c_uchar;
            (*d)
                .chunk_init[low_bits.wrapping_div(32 as libc::c_int as libc::c_ulong)
                as usize] = 1 as libc::c_int as libc::c_uchar;
        }
...
unsafe extern "C" fn tekhex_get_section_contents(
    mut abfd: *mut bfd,
    mut section: *mut asection,
    mut locationp: *mut libc::c_void,
    mut offset: file_ptr,
    mut count: bfd_size_type,
) -> bool {
    if (*section).flags & (0x2 as libc::c_int | 0x1 as libc::c_int) as libc::c_uint != 0
    {
...
unsafe extern "C" fn tekhex_set_arch_mach(
    mut abfd: *mut bfd,
    mut arch: bfd_architecture,
    mut machine: libc::c_ulong,
) -> bool {
    return bfd_default_set_arch_mach(abfd, arch, machine) as libc::c_int != 0
        || arch as libc::c_uint == bfd_arch_unknown as libc::c_int as libc::c_uint;
}
unsafe extern "C" fn tekhex_set_section_contents(
    mut abfd: *mut bfd,
    mut section: sec_ptr,
    mut locationp: *const libc::c_void,
    mut offset: file_ptr,
...
unsafe extern "C" fn writevalue(mut dst: *mut *mut libc::c_char, mut value: bfd_vma) {
    let mut p: *mut libc::c_char = *dst;
    let mut len: libc::c_int = 0;
    let mut shift: libc::c_int = 0;
    len = 8 as libc::c_int;
    shift = 28 as libc::c_int;
    while shift != 0 {
        if value >> shift & 0xf as libc::c_int as libc::c_ulong != 0 {
            let fresh13 = p;
            p = p.offset(1);
            *fresh13 = (len + '0' as i32) as libc::c_char;
            while len != 0 {
                let fresh14 = p;
                p = p.offset(1);
                *fresh14 = digs[(value >> shift & 0xf as libc::c_int as libc::c_ulong)
                    as usize];
    ...
    let fresh15 = p;
    p = p.offset(1);
    *fresh15 = '1' as i32 as libc::c_char;
    let fresh16 = p;
    p = p.offset(1);
    *fresh16 = '0' as i32 as libc::c_char;
    *dst = p;
}
unsafe extern "C" fn writesym(
    mut dst: *mut *mut libc::c_char,
    mut sym: *const libc::c_char,
) {
    let mut p: *mut libc::c_char = *dst;
    let mut len: libc::c_int = (if !sym.is_null() {
        strlen(sym)
    } else {
    ...
    if len >= 16 as libc::c_int {
        ...
        *fresh17 = '0' as i32 as libc::c_char;
        ...
        let fresh18 = p;
        p = p.offset(1);
        *fresh18 = '1' as i32 as libc::c_char;
        sym = b"$\0" as *const u8 as *const libc::c_char;
        len = 1 as libc::c_int;
    } else {
        let fresh19 = p;
        p = p.offset(1);
        *fresh19 = digs[len as usize];
    }
    loop {
        let fresh20 = len;
        len = len - 1;
...
unsafe extern "C" fn out(
    ...
    let mut front: [libc::c_char; 6] = [0; 6];
    let mut wrlen: bfd_size_type = 0;
    front[0 as libc::c_int as usize] = '%' as i32 as libc::c_char;
    *front
        .as_mut_ptr()
        .offset(1 as libc::c_int as isize)
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(end.offset_from(start) as libc::c_long
        + 5 as libc::c_int as libc::c_long & 0xf as libc::c_int as libc::c_long)
        as usize];
    *front
        .as_mut_ptr()
        .offset(1 as libc::c_int as isize)
        ...
        + 5 as libc::c_int as libc::c_long >> 4 as libc::c_int
        & 0xf as libc::c_int as libc::c_long) as usize];
    front[3 as libc::c_int as usize] = type_0 as libc::c_char;
    s = start;
    while s < end {
        sum += sum_block[*s as libc::c_uchar as usize] as libc::c_int;
        s = s.offset(1);
        s;
    }
    sum
        += sum_block[front[1 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_int;
    sum
        += sum_block[front[2 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_int;
    sum
        += sum_block[front[3 as libc::c_int as usize] as libc::c_uchar as usize]
            as libc::c_int;
    *front
        .as_mut_ptr()
        .offset(4 as libc::c_int as isize)
        .offset(1 as libc::c_int as isize) = digs[(sum & 0xf as libc::c_int) as usize];
    *front
        .as_mut_ptr()
        .offset(4 as libc::c_int as isize)
        .offset(
            0 as libc::c_int as isize,
        ) = digs[(sum >> 4 as libc::c_int & 0xf as libc::c_int) as usize];
    if bfd_bwrite(
        front.as_mut_ptr() as *const libc::c_void,
    ...
    ) != 6 as libc::c_int as libc::c_ulong
    {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                &[u8; 37],
                &[libc::c_char; 37],
            >(b"void out(bfd *, int, char *, char *)\0"))
                .as_ptr(),
        );
    }
    *end.offset(0 as libc::c_int as isize) = '\n' as i32 as libc::c_char;
    wrlen = (end.offset_from(start) as libc::c_long + 1 as libc::c_int as libc::c_long)
        as bfd_size_type;
    if bfd_bwrite(start as *const libc::c_void, wrlen, abfd) != wrlen {
        _bfd_abort(
            b"tekhex.c\0" as *const u8 as *const libc::c_char,
            796 as libc::c_int,
            (*::core::mem::transmute::<
...
unsafe extern "C" fn tekhex_write_object_contents(mut abfd: *mut bfd) -> bool {
    ...
    let mut d: *mut data_struct = 0 as *mut data_struct;
    tekhex_init();
    d = (*(*abfd).tdata.tekhex_data).data;
    while !d.is_null() {
        let mut low: libc::c_int = 0;
        let mut addr: libc::c_int = 0;
        addr = 0 as libc::c_int;
        while addr < 0x1fff as libc::c_int + 1 as libc::c_int {
            if (*d).chunk_init[(addr / 32 as libc::c_int) as usize] != 0 {
                let mut dst: *mut libc::c_char = buffer.as_mut_ptr();
                writevalue(&mut dst, (addr as libc::c_ulong).wrapping_add((*d).vma));
                low = 0 as libc::c_int;
                while low < 32 as libc::c_int {
                    *dst
                        .offset(
                            1 as libc::c_int as isize,
                        ) = digs[((*d).chunk_data[(addr + low) as usize] as libc::c_int
                ...
                out(abfd, '6' as i32, buffer.as_mut_ptr(), dst);
            }
            addr += 32 as libc::c_int;
        }
        d = (*d).next;
    }
    s = (*abfd).sections;
    while !s.is_null() {
        let mut dst_0: *mut libc::c_char = buffer.as_mut_ptr();
        writesym(&mut dst_0, (*s).name);
        let fresh23 = dst_0;
        dst_0 = dst_0.offset(1);
        *fresh23 = '1' as i32 as libc::c_char;
        writevalue(&mut dst_0, (*s).vma);
        writevalue(&mut dst_0, ((*s).vma).wrapping_add((*s).size));
        out(abfd, '3' as i32, buffer.as_mut_ptr(), dst_0);
        s = (*s).next;
    }
    if !((*abfd).outsymbols).is_null() {
        p = (*abfd).outsymbols;
        while !(*p).is_null() {
            let mut section_code: libc::c_int = bfd_decode_symclass(*p);
            if section_code != '?' as i32 {
                let mut sym: *mut asymbol = *p;
                let mut dst_1: *mut libc::c_char = buffer.as_mut_ptr();
                writesym(&mut dst_1, (*(*sym).section).name);
                match section_code {
                    65 => {
                        let fresh24 = dst_1;
                        dst_1 = dst_1.offset(1);
                        *fresh24 = '2' as i32 as libc::c_char;
                    }
                    97 => {
                        let fresh25 = dst_1;
                        dst_1 = dst_1.offset(1);
                        *fresh25 = '6' as i32 as libc::c_char;
                    }
                    68 | 66 | 79 => {
                        let fresh26 = dst_1;
                        dst_1 = dst_1.offset(1);
                        *fresh26 = '4' as i32 as libc::c_char;
                    }
                    100 | 98 | 111 => {
                        let fresh27 = dst_1;
                        dst_1 = dst_1.offset(1);
                        *fresh27 = '8' as i32 as libc::c_char;
                    }
                    84 => {
                        let fresh28 = dst_1;
                        dst_1 = dst_1.offset(1);
                        *fresh28 = '3' as i32 as libc::c_char;
                    }
                    116 => {
                        let fresh29 = dst_1;
                        dst_1 = dst_1.offset(1);
                        *fresh29 = '7' as i32 as libc::c_char;
                    }
                    67 | 85 => {
                ...
                writesym(&mut dst_1, (*sym).name);
                writevalue(
                    &mut dst_1,
                    ((*sym).value).wrapping_add((*(*sym).section).vma),
                );
                out(abfd, '3' as i32, buffer.as_mut_ptr(), dst_1);
            }
            p = p.offset(1);
            p;
        }
    ...
    if bfd_bwrite(
        ...
        9 as libc::c_int as bfd_size_type,
        abfd,
    ) != 9 as libc::c_int as libc::c_ulong
    {
        _bfd_abort(
            ...
            (*::core::mem::transmute::<
                &[u8; 42],
                &[libc::c_char; 42],
            >(b"_Bool tekhex_write_object_contents(bfd *)\0"))
                .as_ptr(),
        );
    }
    return 1 as libc::c_int != 0;
...
unsafe extern "C" fn tekhex_make_empty_symbol(mut abfd: *mut bfd) -> *mut asymbol {
    let mut amt: size_t = ::core::mem::size_of::<tekhex_symbol_struct>()
        as libc::c_ulong;
    let mut new_symbol: *mut tekhex_symbol_type = bfd_zalloc(abfd, amt)
        as *mut tekhex_symbol_type;
    if new_symbol.is_null() {
        return 0 as *mut asymbol;
    }
    (*new_symbol).symbol.the_bfd = abfd;
    (*new_symbol).prev = 0 as *mut tekhex_symbol_struct;
...
unsafe extern "C" fn tekhex_print_symbol(
    mut abfd: *mut bfd,
    ...
    match how as libc::c_uint {
        ...
        2 => {
            let mut section_name: *const libc::c_char = (*(*symbol).section).name;
...
#[no_mangle]
pub static mut tekhex_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"tekhex\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_tekhex_flavour,
            byteorder: BFD_ENDIAN_UNKNOWN,
            header_byteorder: BFD_ENDIAN_UNKNOWN,
            object_flags: (0x2 as libc::c_int | 0x10 as libc::c_int | 0x4 as libc::c_int
            ...
            _bfd_check_format: [
                ...
                Some(tekhex_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
            ],
            _bfd_set_format: [
                ...
                Some(tekhex_mkobject as unsafe extern "C" fn(*mut bfd) -> bool),
