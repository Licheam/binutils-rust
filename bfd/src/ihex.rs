...
extern "C" {
    ...
    fn _bfd_long_bfd_0(_: *mut bfd) -> libc::c_long;
    ...
    fn _bfd_nosymbols_print_symbol(
        _: *mut bfd,
        _: *mut libc::c_void,
        _: *mut asymbol,
        _: bfd_print_symbol_type,
    );
    fn _bfd_nosymbols_get_symbol_info(_: *mut bfd, _: *mut asymbol, _: *mut symbol_info);
    ...
    fn _bfd_nosymbols_bfd_is_local_label_name(
        _: *mut bfd,
        _: *const libc::c_char,
    ) -> bool;
    ...
    fn _bfd_nosymbols_read_minisymbols(
        _: *mut bfd,
        _: bool,
        _: *mut *mut libc::c_void,
        _: *mut libc::c_uint,
    ) -> libc::c_long;
    fn _bfd_nosymbols_minisymbol_to_symbol(
        _: *mut bfd,
        _: bool,
        _: *const libc::c_void,
        _: *mut asymbol,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ihex_data_struct {
    pub head: *mut ihex_data_list,
    pub tail: *mut ihex_data_list,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ihex_data_list {
    pub next: *mut ihex_data_list,
...
unsafe extern "C" fn ihex_mkobject(mut abfd: *mut bfd) -> bool {
    let mut tdata: *mut ihex_data_struct = 0 as *mut ihex_data_struct;
    tdata = bfd_alloc(abfd, ::core::mem::size_of::<ihex_data_struct>() as libc::c_ulong)
        as *mut ihex_data_struct;
    if tdata.is_null() {
        return 0 as libc::c_int != 0;
    }
    (*abfd).tdata.ihex_data = tdata;
    (*tdata).head = 0 as *mut ihex_data_list;
    (*tdata).tail = 0 as *mut ihex_data_list;
    return 1 as libc::c_int != 0;
}
#[inline]
unsafe extern "C" fn ihex_get_byte(
    mut abfd: *mut bfd,
...
unsafe extern "C" fn ihex_bad_byte(
    mut abfd: *mut bfd,
    ...
    if c == -(1 as libc::c_int) {
        ...
        _bfd_error_handler(
            dcgettext(
                ...
                b"%pB:%d: unexpected character `%s' in Intel Hex file\0" as *const u8
...
unsafe extern "C" fn ihex_scan(mut abfd: *mut bfd) -> bool {
    let mut current_block: u64;
    let mut segbase: bfd_vma = 0;
    let mut extbase: bfd_vma = 0;
        ...
        != 0 as libc::c_int)
    {
        ...
        's_43: loop {
            ...
            if c == '\n' as i32 {
                ...
                current_block = 38838652953807237;
                break;
            } else {
                let mut pos: file_ptr = 0;
                let mut hdr: [libc::c_uchar; 8] = [0; 8];
                let mut i: libc::c_uint = 0;
                let mut len: libc::c_uint = 0;
                let mut addr: bfd_vma = 0;
                let mut type_0: libc::c_uint = 0;
                let mut chars: libc::c_uint = 0;
                let mut chksum: libc::c_uint = 0;
                ...
                while i < 8 as libc::c_int as libc::c_uint {
                    if !(_hex_value[hdr[i as usize] as usize] as libc::c_uint
                        != 99 as libc::c_int as libc::c_uint)
                    {
                        ihex_bad_byte(
                            abfd,
                            lineno,
                            hdr[i as usize] as libc::c_int,
                            error,
                        );
                        current_block = 38838652953807237;
                        break 's_43;
                ...
                len = ((_hex_value[hdr[0 as libc::c_int as usize] as usize]
                    as libc::c_uint) << 4 as libc::c_int)
                    .wrapping_add(
                        _hex_value[hdr[1 as libc::c_int as usize] as usize]
                            as libc::c_uint,
                    );
                addr = (((_hex_value[*hdr
                    .as_mut_ptr()
                ...
                if chars as libc::c_ulong >= bufsize {
                    buf = bfd_realloc(buf as *mut libc::c_void, chars as bfd_size_type)
                        as *mut bfd_byte;
                    if buf.is_null() {
                        current_block = 38838652953807237;
                        break;
                    }
                    bufsize = chars as size_t;
                }
                if bfd_bread(buf as *mut libc::c_void, chars as bfd_size_type, abfd)
                    != chars as libc::c_ulong
                {
                    current_block = 38838652953807237;
                    break;
                }
                i = 0 as libc::c_int as libc::c_uint;
                while i < chars {
                    if !(_hex_value[*buf.offset(i as isize) as usize] as libc::c_uint
                        != 99 as libc::c_int as libc::c_uint)
                    {
                        ihex_bad_byte(
                            abfd,
                ...
                chksum = (len as libc::c_ulong)
                    .wrapping_add(addr)
                    .wrapping_add(addr >> 8 as libc::c_int)
                    .wrapping_add(type_0 as libc::c_ulong) as libc::c_uint;
                i = 0 as libc::c_int as libc::c_uint;
                while i < len {
                    chksum = chksum
                        .wrapping_add(
                ...
                if chksum.wrapping_neg() & 0xff as libc::c_int as libc::c_uint
                    != ((_hex_value[*buf
                        .offset(
                            (2 as libc::c_int as libc::c_uint).wrapping_mul(i) as isize,
                        )
                        ...
                        )
                {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB:%u: bad checksum in Intel Hex file (expected %u, found %u)\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        abfd,
                        lineno,
                        chksum.wrapping_neg() & 0xff as libc::c_int as libc::c_uint,
                        ((_hex_value[*buf
                            .offset(
                                (2 as libc::c_int as libc::c_uint).wrapping_mul(i) as isize,
                            )
                    ...
                    match type_0 {
                        0 => {
                            if !sec.is_null()
                                && ((*sec).vma).wrapping_add((*sec).size)
                                    == extbase.wrapping_add(segbase).wrapping_add(addr)
                            {
                                (*sec)
                                    .size = ((*sec).size as libc::c_ulong)
                                    .wrapping_add(len as libc::c_ulong) as bfd_size_type
                                    as bfd_size_type;
                            } else {
                                ...
                                (*sec)
                                    .vma = extbase.wrapping_add(segbase).wrapping_add(addr);
                                (*sec)
                                    .lma = extbase.wrapping_add(segbase).wrapping_add(addr);
                                (*sec).size = len as bfd_size_type;
                                (*sec).filepos = pos;
                            }
                        }
                        1 => {
                            if (*abfd).start_address == 0 as libc::c_int as libc::c_ulong
                            {
                        ...
                        2 => {
                            if len != 2 as libc::c_int as libc::c_uint {
                                _bfd_error_handler(
                                    dcgettext(
                                        b"bfd\0" as *const u8 as *const libc::c_char,
                                        b"%pB:%u: bad extended address record length in Intel Hex file\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    abfd,
                                ...
                                segbase = ((((_hex_value[*buf
                                    .offset(0 as libc::c_int as isize) as usize]
                                    as libc::c_uint) << 4 as libc::c_int)
                                    .wrapping_add(
                                        _hex_value[*buf.offset(1 as libc::c_int as isize) as usize]
                                            as libc::c_uint,
                                    ) << 8 as libc::c_int)
                                    .wrapping_add(
                                        ((_hex_value[*buf
                        ...
                        3 => {
                            if len != 4 as libc::c_int as libc::c_uint {
                                _bfd_error_handler(
                                    dcgettext(
                                        b"bfd\0" as *const u8 as *const libc::c_char,
                                        b"%pB:%u: bad extended start address length in Intel Hex file\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    abfd,
                                ...
                                (*abfd)
                                    .start_address = ((*abfd).start_address as libc::c_ulong)
                                    .wrapping_add(
                                        ((((_hex_value[*buf.offset(0 as libc::c_int as isize)
                        ...
                        4 => {
                            if len != 2 as libc::c_int as libc::c_uint {
                                _bfd_error_handler(
                                    dcgettext(
                                        b"bfd\0" as *const u8 as *const libc::c_char,
                                        b"%pB:%u: bad extended linear address record length in Intel Hex file\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    abfd,
                        ...
                        5 => {
                                ...
                                && len != 4 as libc::c_int as libc::c_uint
                            {
                                _bfd_error_handler(
                                    dcgettext(
                                        b"bfd\0" as *const u8 as *const libc::c_char,
                                        b"%pB:%u: bad extended linear start address length in Intel Hex file\0"
                                            as *const u8 as *const libc::c_char,
                                        5 as libc::c_int,
                                    ),
                                    abfd,
                        ...
                        _ => {
                            _bfd_error_handler(
                                dcgettext(
                                    b"bfd\0" as *const u8 as *const libc::c_char,
                                    b"%pB:%u: unrecognized ihex type %u in Intel Hex file\0"
                                        as *const u8 as *const libc::c_char,
                                    5 as libc::c_int,
                                ),
                                abfd,
...
unsafe extern "C" fn ihex_object_p(mut abfd: *mut bfd) -> bfd_cleanup {
    let mut tdata_save: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut b: [bfd_byte; 9] = [0; 9];
    let mut i: libc::c_uint = 0;
    let mut type_0: libc::c_uint = 0;
    ihex_init();
    ...
    while i < 9 as libc::c_int as libc::c_uint {
        if !(_hex_value[b[i as usize] as usize] as libc::c_uint
            != 99 as libc::c_int as libc::c_uint)
        {
            bfd_set_error(bfd_error_wrong_format);
            return None;
...
unsafe extern "C" fn ihex_read_section(
    mut abfd: *mut bfd,
    ...
    if !(bfd_seek(abfd, (*section).filepos, 0 as libc::c_int) != 0 as libc::c_int) {
        ...
        loop {
            ...
            if !(c == ':' as i32) {
                bfd_assert(
                    b"ihex.c\0" as *const u8 as *const libc::c_char,
                    569 as libc::c_int,
                );
            }
            if bfd_bread(
            ...
            {
                current_block = 13763989449062165837;
                break;
            }
            len = ((_hex_value[hdr[0 as libc::c_int as usize] as usize] as libc::c_uint)
                << 4 as libc::c_int)
                .wrapping_add(
                    _hex_value[hdr[1 as libc::c_int as usize] as usize] as libc::c_uint,
                );
            type_0 = ((_hex_value[*hdr
                .as_mut_ptr()
                .offset(6 as libc::c_int as isize)
            ...
            if type_0 != 0 as libc::c_int as libc::c_uint {
                _bfd_error_handler(
                    dcgettext(
                        b"bfd\0" as *const u8 as *const libc::c_char,
                        b"%pB: internal error in ihex_read_section\0" as *const u8
                            as *const libc::c_char,
                        5 as libc::c_int,
                    ),
                    abfd,
                ...
                if len.wrapping_mul(2 as libc::c_int as libc::c_uint) as libc::c_ulong
                    > bufsize
                {
                    buf = bfd_realloc(
                    ...
                    bufsize = len.wrapping_mul(2 as libc::c_int as libc::c_uint)
                        as size_t;
                }
                if bfd_bread(
                    buf as *mut libc::c_void,
                    (len as bfd_size_type)
                        .wrapping_mul(2 as libc::c_int as libc::c_ulong),
                    abfd,
                ) != len.wrapping_mul(2 as libc::c_int as libc::c_uint) as libc::c_ulong
                {
                    current_block = 13763989449062165837;
                    break;
                }
                ...
                if p.offset_from(contents) as libc::c_long as bfd_size_type
                    >= (*section).size
                {
                    free(buf as *mut libc::c_void);
                    return 1 as libc::c_int != 0;
            ...
            _ => {
                    ...
                    < (*section).size
                {
                    _bfd_error_handler(
                        dcgettext(
                            b"bfd\0" as *const u8 as *const libc::c_char,
                            b"%pB: bad section length in ihex_read_section\0"
                                as *const u8 as *const libc::c_char,
                            5 as libc::c_int,
                        ),
                        abfd,
...
unsafe extern "C" fn ihex_get_section_contents(
    mut abfd: *mut bfd,
    mut section: *mut asection,
    ...
    if ((*section).used_by_bfd).is_null() {
        ...
        if !ihex_read_section(abfd, section, (*section).used_by_bfd as *mut bfd_byte) {
            return 0 as libc::c_int != 0;
        }
    }
    memcpy(
...
unsafe extern "C" fn ihex_set_section_contents(
    mut abfd: *mut bfd,
    mut section: *mut asection,
    ...
    let mut n: *mut ihex_data_list = 0 as *mut ihex_data_list;
    ...
    if count == 0 as libc::c_int as libc::c_ulong
        ...
        || (*section).flags & 0x2 as libc::c_int as libc::c_uint
            == 0 as libc::c_int as libc::c_uint
    {
        return 1 as libc::c_int != 0;
    }
    n = bfd_alloc(abfd, ::core::mem::size_of::<ihex_data_list>() as libc::c_ulong)
        as *mut ihex_data_list;
    if n.is_null() {
        return 0 as libc::c_int != 0;
    }
    data = bfd_alloc(abfd, count) as *mut bfd_byte;
    if data.is_null() {
        return 0 as libc::c_int != 0;
    }
    memcpy(data as *mut libc::c_void, location, count);
    (*n).data = data;
    (*n).where_0 = ((*section).lma).wrapping_add(offset as libc::c_ulong);
    (*n).size = count;
    tdata = (*abfd).tdata.ihex_data;
    if !((*tdata).tail).is_null() && (*n).where_0 >= (*(*tdata).tail).where_0 {
        (*(*tdata).tail).next = n;
        (*n).next = 0 as *mut ihex_data_list;
        (*tdata).tail = n;
    } else {
        let mut pp: *mut *mut ihex_data_list = 0 as *mut *mut ihex_data_list;
        pp = &mut (*tdata).head;
        while !(*pp).is_null() && (**pp).where_0 < (*n).where_0 {
            pp = &mut (**pp).next;
        }
        (*n).next = *pp;
        *pp = n;
...
unsafe extern "C" fn ihex_write_record(
    mut abfd: *mut bfd,
    mut count: size_t,
    ...
    *buf
        ...
        ) = digs[(count >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_ulong)
        as usize];
    *buf
        .as_mut_ptr()
        .offset(1 as libc::c_int as isize)
        ...
        ) = digs[(count & 0xf as libc::c_int as libc::c_ulong) as usize];
    *buf
        .as_mut_ptr()
        .offset(3 as libc::c_int as isize)
        .offset(
            0 as libc::c_int as isize,
        ) = digs[((addr >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
        >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_uint) as usize];
    *buf
        .as_mut_ptr()
        .offset(3 as libc::c_int as isize)
        .offset(
    ...
    *buf
        ...
        .offset(
            0 as libc::c_int as isize,
        ) = digs[((addr & 0xff as libc::c_int as libc::c_uint) >> 4 as libc::c_int
        & 0xf as libc::c_int as libc::c_uint) as usize];
    *buf
        .as_mut_ptr()
        .offset(5 as libc::c_int as isize)
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(addr & 0xff as libc::c_int as libc::c_uint
        & 0xf as libc::c_int as libc::c_uint) as usize];
    *buf
        .as_mut_ptr()
        .offset(7 as libc::c_int as isize)
        .offset(
            0 as libc::c_int as isize,
        ) = digs[(type_0 >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_uint)
        as usize];
    *buf
        .as_mut_ptr()
        .offset(7 as libc::c_int as isize)
        .offset(
            1 as libc::c_int as isize,
        ) = digs[(type_0 & 0xf as libc::c_int as libc::c_uint) as usize];
    chksum = count
        .wrapping_add(addr as libc::c_ulong)
        .wrapping_add((addr >> 8 as libc::c_int) as libc::c_ulong)
        .wrapping_add(type_0 as libc::c_ulong) as libc::c_uint;
    i = 0 as libc::c_int as libc::c_uint;
    p = buf.as_mut_ptr().offset(9 as libc::c_int as isize);
    while (i as libc::c_ulong) < count {
        *p
            .offset(
                0 as libc::c_int as isize,
            ) = digs[(*data as libc::c_int >> 4 as libc::c_int & 0xf as libc::c_int)
            as usize];
        *p
            .offset(
                1 as libc::c_int as isize,
            ) = digs[(*data as libc::c_int & 0xf as libc::c_int) as usize];
        chksum = chksum.wrapping_add(*data as libc::c_uint);
        i = i.wrapping_add(1);
        i;
    ...
    *p
        .offset(
            0 as libc::c_int as isize,
        ) = digs[((chksum.wrapping_neg() & 0xff as libc::c_int as libc::c_uint)
        >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_uint) as usize];
    *p
        .offset(
            1 as libc::c_int as isize,
        ...
        & 0xf as libc::c_int as libc::c_uint) as usize];
    *p.offset(2 as libc::c_int as isize) = '\r' as i32 as libc::c_char;
    *p.offset(3 as libc::c_int as isize) = '\n' as i32 as libc::c_char;
    total = (9 as libc::c_int as libc::c_ulong)
        .wrapping_add(count.wrapping_mul(2 as libc::c_int as libc::c_ulong))
        .wrapping_add(4 as libc::c_int as libc::c_ulong);
    if bfd_bwrite(buf.as_mut_ptr() as *const libc::c_void, total, abfd) != total {
        return 0 as libc::c_int != 0;
    }
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn ihex_write_object_contents(mut abfd: *mut bfd) -> bool {
    let mut segbase: bfd_vma = 0;
    let mut extbase: bfd_vma = 0;
    let mut l: *mut ihex_data_list = 0 as *mut ihex_data_list;
    segbase = 0 as libc::c_int as bfd_vma;
    extbase = 0 as libc::c_int as bfd_vma;
    l = (*(*abfd).tdata.ihex_data).head;
    while !l.is_null() {
        let mut where_0: bfd_vma = 0;
        let mut p: *mut bfd_byte = 0 as *mut bfd_byte;
        let mut count: bfd_size_type = 0;
        where_0 = (*l).where_0;
        if where_0 > 0xffffffff as libc::c_uint as libc::c_ulong
            && where_0.wrapping_add(0x80000000 as libc::c_uint as libc::c_ulong)
                > 0xffffffff as libc::c_uint as libc::c_ulong
        {
            _bfd_error_handler(
                dcgettext(
                    b"bfd\0" as *const u8 as *const libc::c_char,
                    b"%pB 64-bit address %#lx out of range for Intel Hex file\0"
                        as *const u8 as *const libc::c_char,
                    5 as libc::c_int,
                ),
                abfd,
        ...
        where_0 &= 0xffffffff as libc::c_uint as libc::c_ulong;
        p = (*l).data;
        count = (*l).size;
        while count > 0 as libc::c_int as libc::c_ulong {
            let mut now: size_t = 0;
            let mut rec_addr: libc::c_uint = 0;
            now = count;
            if count > 16 as libc::c_int as libc::c_ulong {
                now = 16 as libc::c_int as size_t;
            }
            if where_0 < extbase || where_0.wrapping_sub(extbase) < segbase
                || where_0.wrapping_sub(extbase).wrapping_sub(segbase)
                    > 0xffff as libc::c_int as libc::c_ulong
            {
                let mut addr: [bfd_byte; 2] = [0; 2];
                if extbase == 0 as libc::c_int as libc::c_ulong
                    && where_0 <= 0xfffff as libc::c_int as libc::c_ulong
                {
                    segbase = where_0 & 0xf0000 as libc::c_int as libc::c_ulong;
                    addr[0 as libc::c_int
                        as usize] = ((segbase >> 12 as libc::c_int) as bfd_byte
                        as libc::c_int & 0xff as libc::c_int) as bfd_byte;
                    addr[1 as libc::c_int
                        as usize] = ((segbase >> 4 as libc::c_int) as bfd_byte
                        as libc::c_int & 0xff as libc::c_int) as bfd_byte;
                    if !ihex_write_record(
                        abfd,
                    ...
                    if segbase != 0 as libc::c_int as libc::c_ulong {
                        addr[0 as libc::c_int as usize] = 0 as libc::c_int as bfd_byte;
                        addr[1 as libc::c_int as usize] = 0 as libc::c_int as bfd_byte;
                        if !ihex_write_record(
                            abfd,
                            2 as libc::c_int as size_t,
                            0 as libc::c_int as libc::c_uint,
                    ...
                    extbase = where_0 & 0xffff0000 as libc::c_uint as libc::c_ulong;
                    if where_0
                        > extbase.wrapping_add(0xffff as libc::c_int as libc::c_ulong)
                    {
                        _bfd_error_handler(
                            dcgettext(
                                b"bfd\0" as *const u8 as *const libc::c_char,
                                b"%pB: address %#lx out of range for Intel Hex file\0"
                                    as *const u8 as *const libc::c_char,
                                5 as libc::c_int,
                            ),
                            abfd,
                    ...
                    addr[0 as libc::c_int
                        as usize] = ((extbase >> 24 as libc::c_int) as bfd_byte
                        as libc::c_int & 0xff as libc::c_int) as bfd_byte;
                    addr[1 as libc::c_int
                        as usize] = ((extbase >> 16 as libc::c_int) as bfd_byte
                        as libc::c_int & 0xff as libc::c_int) as bfd_byte;
                    if !ihex_write_record(
                        abfd,
                        2 as libc::c_int as size_t,
            ...
            rec_addr = where_0.wrapping_sub(extbase.wrapping_add(segbase))
                as libc::c_uint;
            if (rec_addr as libc::c_ulong).wrapping_add(now)
                > 0xffff as libc::c_int as libc::c_ulong
            {
                now = (0x10000 as libc::c_int as libc::c_uint).wrapping_sub(rec_addr)
                    as size_t;
            }
            if !ihex_write_record(
                abfd,
            ...
            where_0 = (where_0 as libc::c_ulong).wrapping_add(now) as bfd_vma as bfd_vma;
            p = p.offset(now as isize);
            count = (count as libc::c_ulong).wrapping_sub(now) as bfd_size_type
                as bfd_size_type;
        }
        l = (*l).next;
    }
    if (*abfd).start_address != 0 as libc::c_int as libc::c_ulong {
        ...
        let mut startbuf: [bfd_byte; 4] = [0; 4];
        start = (*abfd).start_address;
        if start <= 0xfffff as libc::c_int as libc::c_ulong {
            startbuf[0 as libc::c_int
                as usize] = (((start & 0xf0000 as libc::c_int as libc::c_ulong)
                >> 12 as libc::c_int) as bfd_byte as libc::c_int & 0xff as libc::c_int)
                as bfd_byte;
            startbuf[1 as libc::c_int as usize] = 0 as libc::c_int as bfd_byte;
            startbuf[2 as libc::c_int
                as usize] = ((start >> 8 as libc::c_int) as bfd_byte as libc::c_int
                & 0xff as libc::c_int) as bfd_byte;
            startbuf[3 as libc::c_int
                as usize] = (start as bfd_byte as libc::c_int & 0xff as libc::c_int)
                as bfd_byte;
            if !ihex_write_record(
                abfd,
            ...
            startbuf[0 as libc::c_int
                as usize] = ((start >> 24 as libc::c_int) as bfd_byte as libc::c_int
                & 0xff as libc::c_int) as bfd_byte;
            startbuf[1 as libc::c_int
                as usize] = ((start >> 16 as libc::c_int) as bfd_byte as libc::c_int
                & 0xff as libc::c_int) as bfd_byte;
            startbuf[2 as libc::c_int
                as usize] = ((start >> 8 as libc::c_int) as bfd_byte as libc::c_int
                & 0xff as libc::c_int) as bfd_byte;
...
unsafe extern "C" fn ihex_set_arch_mach(
    mut abfd: *mut bfd,
...
#[no_mangle]
pub static mut ihex_vec: bfd_target = unsafe {
    {
        let mut init = bfd_target {
            name: b"ihex\0" as *const u8 as *const libc::c_char,
            flavour: bfd_target_ihex_flavour,
            byteorder: BFD_ENDIAN_UNKNOWN,
            header_byteorder: BFD_ENDIAN_UNKNOWN,
            object_flags: 0 as libc::c_int as flagword,
            ...
            _bfd_check_format: [
                ...
                Some(ihex_object_p as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
                Some(_bfd_dummy_target as unsafe extern "C" fn(*mut bfd) -> bfd_cleanup),
            ],
            _bfd_set_format: [
                ...
                Some(ihex_mkobject as unsafe extern "C" fn(*mut bfd) -> bool),
            ...
            _bfd_write_contents: [
                ...
                Some(
                    ihex_write_object_contents as unsafe extern "C" fn(*mut bfd) -> bool,
                ),
                Some(
            ...
            _bfd_get_symtab_upper_bound: Some(
                _bfd_long_bfd_0 as unsafe extern "C" fn(*mut bfd) -> libc::c_long,
            ),
