...
extern "C" {
    ...
    fn _bfd_elf_add_dynamic_entry(_: *mut bfd_link_info, _: bfd_vma, _: bfd_vma) -> bool;
    fn bfd_elf_link_record_dynamic_symbol(
        _: *mut bfd_link_info,
        _: *mut elf_link_hash_entry,
    ) -> bool;
    fn _bfd_elf_add_dynamic_tags(_: *mut bfd, _: *mut bfd_link_info, _: bool) -> bool;
}
...
unsafe extern "C" fn elf_vxworks_gott_symbol_p(
    mut abfd: *mut bfd,
    ...
    if leading != 0 {
        if *name as libc::c_int != leading as libc::c_int {
            return 0 as libc::c_int != 0;
        }
        name = name.offset(1);
        name;
    }
    return strcmp(name, b"__GOTT_BASE__\0" as *const u8 as *const libc::c_char)
        == 0 as libc::c_int
        || strcmp(name, b"__GOTT_INDEX__\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_add_symbol_hook(
    mut abfd: *mut bfd,
    ...
    if ((*info).type_0() as libc::c_int == type_dll as libc::c_int
        ...
        || (*abfd).flags & 0x40 as libc::c_int as libc::c_uint != 0)
        && elf_vxworks_gott_symbol_p(abfd, *namep) as libc::c_int != 0
    {
        (*sym)
            .st_info = (((2 as libc::c_int) << 4 as libc::c_int)
            + ((*sym).st_info as libc::c_int & 0xf as libc::c_int & 0xf as libc::c_int))
            as libc::c_uchar;
        *flagsp |= ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_create_dynamic_sections(
    mut dynobj: *mut bfd,
    mut info: *mut bfd_link_info,
    mut srelplt2_out: *mut *mut asection,
) -> bool {
        ...
        || (*info).type_0() as libc::c_int == type_pie as libc::c_int)
    {
        s = bfd_make_section_anyway_with_flags(
            dynobj,
            if (*bed).default_use_rela_p() as libc::c_int != 0 {
                b".rela.plt.unloaded\0" as *const u8 as *const libc::c_char
            } else {
                b".rel.plt.unloaded\0" as *const u8 as *const libc::c_char
            },
            (0x100 as libc::c_int | 0x4000 as libc::c_int | 0x8 as libc::c_int
    ...
    if !((*htab).hgot).is_null() {
        (*(*htab).hgot).indx = -(2 as libc::c_int) as libc::c_long;
        (*(*htab).hgot)
            .set_other(
                (*(*htab).hgot).other()
                    & !(-(1 as libc::c_int) & 0x3 as libc::c_int) as libc::c_uint,
            );
        (*(*htab).hgot).set_forced_local(0 as libc::c_int as libc::c_uint);
        if !bfd_elf_link_record_dynamic_symbol(info, (*htab).hgot) {
            return 0 as libc::c_int != 0;
        }
    }
    if !((*htab).hplt).is_null() {
        (*(*htab).hplt).indx = -(2 as libc::c_int) as libc::c_long;
        (*(*htab).hplt).set_type_0(2 as libc::c_int as libc::c_uint);
    }
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_link_output_symbol_hook(
    ...
    if !h.is_null()
        ...
        && elf_vxworks_gott_symbol_p((*h).root.u.undef.abfd, name) as libc::c_int != 0
    {
        (*sym)
...
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_emit_relocs(
    ...
    if (*output_bfd).flags & (0x40 as libc::c_int | 0x2 as libc::c_int) as libc::c_uint
        != 0
    {
        ...
        let mut hash_ptr: *mut *mut elf_link_hash_entry = 0
        ...
        irelaend = irela
            .offset(
                (if (*input_rel_hdr).sh_entsize > 0 as libc::c_int as libc::c_ulong {
                    ...
                    .wrapping_mul((*(*bed).s).int_rels_per_ext_rel as libc::c_ulong)
                    as isize,
            );
        hash_ptr = rel_hash;
        while irela < irelaend {
            if !(*hash_ptr).is_null() && (**hash_ptr).def_dynamic() as libc::c_int != 0
                && (**hash_ptr).def_regular() == 0
                && (((**hash_ptr).root).type_0() as libc::c_int
                    == bfd_link_hash_defined as libc::c_int
                    || ((**hash_ptr).root).type_0() as libc::c_int
                        == bfd_link_hash_defweak as libc::c_int)
                && !((*(**hash_ptr).root.u.def.section).output_section).is_null()
            {
                j = 0 as libc::c_int;
                while j < (*(*bed).s).int_rels_per_ext_rel as libc::c_int {
                    let mut sec: *mut asection = (**hash_ptr).root.u.def.section;
                    let mut this_idx: libc::c_int = (*(*sec).output_section)
                        .target_index;
                    (*irela.offset(j as isize))
                        .r_info = (((this_idx as libc::c_uint) << 8 as libc::c_int)
                        as libc::c_ulong)
                        .wrapping_add(
                            (*irela.offset(j as isize)).r_info
                                & 0xff as libc::c_int as libc::c_ulong
                                & 0xff as libc::c_int as libc::c_ulong,
                        );
                    let ref mut fresh0 = (*irela.offset(j as isize)).r_addend;
                    *fresh0 = (*fresh0 as libc::c_ulong)
                        .wrapping_add((**hash_ptr).root.u.def.value) as bfd_vma
                        as bfd_vma;
                    let ref mut fresh1 = (*irela.offset(j as isize)).r_addend;
                    *fresh1 = (*fresh1 as libc::c_ulong)
                        .wrapping_add((*sec).output_offset) as bfd_vma as bfd_vma;
                    j += 1;
                    j;
                }
                *hash_ptr = 0 as *mut elf_link_hash_entry;
            }
            irela = irela
                .offset((*(*bed).s).int_rels_per_ext_rel as libc::c_int as isize);
            hash_ptr = hash_ptr.offset(1);
            hash_ptr;
        }
    }
    return _bfd_elf_link_output_relocs(
        output_bfd,
        input_section,
        input_rel_hdr,
        internal_relocs,
...
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_final_write_processing(mut abfd: *mut bfd) -> bool {
    ...
    if !sec.is_null() {
        ...
        if !sec.is_null() {
            (*d)
                .this_hdr
                .sh_info = (*((*sec).used_by_bfd as *mut bfd_elf_section_data)).this_idx
                as libc::c_uint;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_add_dynamic_entries(
    mut output_bfd: *mut bfd,
    mut info: *mut bfd_link_info,
) -> bool {
    if !(bfd_get_section_by_name(
        output_bfd,
        b".tls_data\0" as *const u8 as *const libc::c_char,
    ))
        .is_null()
    {
        if !_bfd_elf_add_dynamic_entry(
            info,
            0x60000010 as libc::c_int as bfd_vma,
            0 as libc::c_int as bfd_vma,
        )
            || !_bfd_elf_add_dynamic_entry(
                info,
                0x60000011 as libc::c_int as bfd_vma,
                0 as libc::c_int as bfd_vma,
            )
            || !_bfd_elf_add_dynamic_entry(
                info,
                0x60000015 as libc::c_int as bfd_vma,
                0 as libc::c_int as bfd_vma,
            )
        {
            return 0 as libc::c_int != 0;
        ...
        .is_null()
    {
        if !_bfd_elf_add_dynamic_entry(
            info,
            0x60000012 as libc::c_int as bfd_vma,
            0 as libc::c_int as bfd_vma,
        )
            || !_bfd_elf_add_dynamic_entry(
                info,
                0x60000013 as libc::c_int as bfd_vma,
                0 as libc::c_int as bfd_vma,
            )
        {
            return 0 as libc::c_int != 0;
...
#[no_mangle]
pub unsafe extern "C" fn elf_vxworks_finish_dynamic_entry(
    mut output_bfd: *mut bfd,
    mut dyn_0: *mut Elf_Internal_Dyn,
) -> bool {
    let mut sec: *mut asection = 0 as *mut asection;
    match (*dyn_0).d_tag {
        1610612752 => {
        ...
        1610612757 => {
            ...
            (*dyn_0)
                .d_un
                .d_val = (1 as libc::c_int as bfd_size_type)
...
#[no_mangle]
pub unsafe extern "C" fn _bfd_elf_maybe_vxworks_add_dynamic_tags(
    mut output_bfd: *mut bfd,
    mut info: *mut bfd_link_info,
    mut need_dynamic_reloc: bool,
) -> bool {
    let mut htab: *mut elf_link_hash_table = elf_hash_table(info);
    return _bfd_elf_add_dynamic_tags(output_bfd, info, need_dynamic_reloc) as libc::c_int
        != 0
        && (!(*htab).dynamic_sections_created
            || (*htab).target_os as libc::c_uint
                != is_vxworks as libc::c_int as libc::c_uint
            || elf_vxworks_add_dynamic_entries(output_bfd, info) as libc::c_int != 0);
}
