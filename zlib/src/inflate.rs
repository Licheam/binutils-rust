    ...
    if version.is_null()
        || *version.offset(0 as libc::c_int as isize) as libc::c_int
            != (*::core::mem::transmute::<
                &[u8; 7],
                &[libc::c_char; 7],
            >(b"1.2.11\0"))[0 as libc::c_int as usize] as libc::c_int
        || stream_size
...
pub unsafe extern "C" fn inflate(
    ...
    's_88: loop {
        match (*state).mode as libc::c_uint {
            ...
            16184 => {
                current_block = 8859673096994480615;
            }
            16185 => {
                current_block = 6719835490618109877;
            }
            16186 => {
                current_block = 1983324216492344030;
            }
            16187 => {
                current_block = 14810393233801378707;
            }
            16188 => {
                current_block = 15122934545865511827;
            }
            16189 => {
                ...
                bits = 0 as libc::c_int as libc::c_uint;
                (*state).mode = DICT;
                current_block = 14784267242764242964;
            }
            16190 => {
                current_block = 14784267242764242964;
            }
            16191 => {
                current_block = 6858736582928243458;
            }
            16192 => {
                current_block = 16121398815872613243;
            }
            16193 => {
            ...
            16195 => {
                current_block = 9435680486103088226;
            }
            16196 => {
            ...
            16199 => {
                current_block = 7973908356816991203;
            }
            16200 => {
                current_block = 12137158289932513117;
            }
            16201 => {
                current_block = 10693419682170471142;
            }
            16202 => {
                current_block = 6198430992841073810;
            }
            16203 => {
                current_block = 16164727852643858567;
            }
            16204 => {
                current_block = 12649432025279279878;
            }
            16205 => {
            ...
            16208 => {
                current_block = 3780243885837375023;
            }
            16209 => {
                ret = -(3 as libc::c_int);
                break;
                    ...
                    && left >= 258 as libc::c_int as libc::c_uint
                {
                            ...
                            == 0 as libc::c_int
                    {
                        ...
                        loop {
                            ...
                            next = next.offset(1);
                            hold = hold
                                .wrapping_add((*fresh25 as libc::c_ulong) << bits);
                            bits = bits.wrapping_add(8 as libc::c_int as libc::c_uint);
                        }
        ...
        match current_block {
            ...
            15122934545865511827 => {
                if (*state).flags & 0x200 as libc::c_int != 0 {
                    ...
                    if (*state).wrap & 4 as libc::c_int != 0
                        && hold
                            != (*state).check & 0xffff as libc::c_int as libc::c_ulong
                    {
                        (*strm)
    ...
    if (*state).wrap & 4 as libc::c_int != 0 && out != 0 {
        (*state)
            .check = if (*state).flags != 0 {
            crc32((*state).check, ((*strm).next_out).offset(-(out as isize)), out)
        } else {
            adler32((*state).check, ((*strm).next_out).offset(-(out as isize)), out)
        };
        (*strm).adler = (*state).check;
    }
    (*strm)
