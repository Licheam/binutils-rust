            ...
            + 1 as libc::c_int
    {
        ...
        if !(n > max_code) {
            ...
            (*s)
                ...
                .wrapping_add(
                    (f as ulg)
                        .wrapping_mul((bits + xbits) as libc::c_uint as libc::c_ulong),
                ) as ulg as ulg;
            if !stree.is_null() {
                (*s)
            ...
            if (*tree.offset(m as isize)).dl.len as libc::c_uint != bits as libc::c_uint
            {
                (*s)
                    ...
                    .wrapping_add(
                        (bits as ulg)
                            .wrapping_sub(
                                (*tree.offset(m as isize)).dl.len as libc::c_ulong,
                            )
                            .wrapping_mul(
                                (*tree.offset(m as isize)).fc.freq as libc::c_ulong,
                            ),
                    ) as ulg as ulg;
    ...
    (*s)
        ...
        .wrapping_add(
            (3 as libc::c_int as libc::c_ulong)
                .wrapping_mul(
                    (max_blindex as ulg).wrapping_add(1 as libc::c_int as libc::c_ulong),
                )
...
pub unsafe extern "C" fn _tr_stored_block(
    ...
    *((*s).pending_buf)
    ...
    (*s)
        .pending = ((*s).pending as libc::c_ulong).wrapping_add(stored_len) as ulg
        as ulg;
}
#[no_mangle]
