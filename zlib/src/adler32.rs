...
pub unsafe extern "C" fn adler32_z(
    ...
    if len == 1 as libc::c_int as libc::c_ulong {
        adler = (adler as libc::c_ulong)
            ...
            as uLong as uLong;
        if adler >= 65521 as libc::c_uint as libc::c_ulong {
            adler = (adler as libc::c_ulong)
                .wrapping_sub(65521 as libc::c_uint as libc::c_ulong) as uLong as uLong;
        }
    ...
    while len >= 5552 as libc::c_int as libc::c_ulong {
        len = (len as libc::c_ulong).wrapping_sub(5552 as libc::c_int as libc::c_ulong)
        ...
        adler = (adler as libc::c_ulong)
            .wrapping_rem(65521 as libc::c_uint as libc::c_ulong) as uLong as uLong;
        sum2 = sum2.wrapping_rem(65521 as libc::c_uint as libc::c_ulong);
    }
    if len != 0 {
...
unsafe extern "C" fn adler32_combine_(
    ...
    len2 %= 65521 as libc::c_uint as libc::c_long;
