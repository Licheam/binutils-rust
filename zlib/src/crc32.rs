...
pub unsafe extern "C" fn crc32_z(
    ...
    while len >= 8 as libc::c_int as libc::c_ulong {
        ...
        crc = crc_table[0 as libc::c_int
            ...
            & 0xff as libc::c_int) as usize] as libc::c_ulong ^ crc >> 8 as libc::c_int;
        let fresh1 = buf;
        buf = buf.offset(1);
        crc = crc_table[0 as libc::c_int
    ...
    if len != 0 {
        loop {
            ...
            crc = crc_table[0 as libc::c_int
                ...
                & 0xff as libc::c_int) as usize] as libc::c_ulong
                ^ crc >> 8 as libc::c_int;
...
unsafe extern "C" fn crc32_little(
    ...
    while len != 0 && buf as ptrdiff_t & 3 as libc::c_int as libc::c_long != 0 {
        ...
        c = crc_table[0 as libc::c_int
            ...
            & 0xff as libc::c_int as libc::c_uint) as usize] ^ c >> 8 as libc::c_int;
        len = len.wrapping_sub(1);
        len;
    }
    ...
    while len >= 32 as libc::c_int as libc::c_ulong {
        ...
        c = crc_table[3 as libc::c_int
            ...
            ^ crc_table[1 as libc::c_int
                ...
                as usize]
            ^ crc_table[0 as libc::c_int as usize][(c >> 24 as libc::c_int) as usize];
        len = (len as libc::c_ulong).wrapping_sub(32 as libc::c_int as libc::c_ulong)
            as z_size_t as z_size_t;
    }
...
unsafe extern "C" fn crc32_big(
    ...
    c = (crc as z_crc_t >> 24 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
        .wrapping_add(
            crc as z_crc_t >> 8 as libc::c_int & 0xff00 as libc::c_int as libc::c_uint,
        )
        .wrapping_add(
            (crc as z_crc_t & 0xff00 as libc::c_int as libc::c_uint) << 8 as libc::c_int,
        )
        .wrapping_add(
            (crc as z_crc_t & 0xff as libc::c_int as libc::c_uint) << 24 as libc::c_int,
        );
    c = !c;
    while len != 0 && buf as ptrdiff_t & 3 as libc::c_int as libc::c_long != 0 {
        let fresh20 = buf;
    ...
    if len != 0 {
        loop {
            ...
            buf = buf.offset(1);
            c = crc_table[4 as libc::c_int
                as usize][(c >> 24 as libc::c_int ^ *fresh30 as libc::c_uint) as usize]
                ^ c << 8 as libc::c_int;
            len = len.wrapping_sub(1);
            if !(len != 0) {
                break;
